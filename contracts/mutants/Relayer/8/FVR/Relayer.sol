...
contract Relayer is ILayerZeroRelayer, ReentrancyGuard, OwnableUpgradeable, Proxied {
    ...
    function setApprovedAddress(address _relayerAddress, bool _approve) external onlyOwner {
    ...
    function _getPrices(uint16 _dstChainId, uint16 _outboundProofType, address, bytes memory _adapterParameters) public view returns (uint basePrice, uint pricePerByte) {
