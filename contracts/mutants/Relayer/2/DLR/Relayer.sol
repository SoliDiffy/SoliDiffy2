...
contract Relayer is ILayerZeroRelayer, ReentrancyGuard, OwnableUpgradeable, Proxied {
    ...
    function _getPrices(uint16 _dstChainId, uint16 _outboundProofType, address, bytes storage _adapterParameters) internal view returns (uint basePrice, uint pricePerByte) {
        ...
        DstPrice memory dstPrice = dstPriceLookup[_dstChainId];
