...
contract UniV3LiquidityAMO_V2_old is Owned {
    ...
    // Increase liquidity
    function increaseLiquidity(uint256 _token_id, address _collat_addr, uint256 _amountCollateral, uint256 _amountFrax) public onlyByOwnGovCust returns (uint128, uint256, uint256) {
