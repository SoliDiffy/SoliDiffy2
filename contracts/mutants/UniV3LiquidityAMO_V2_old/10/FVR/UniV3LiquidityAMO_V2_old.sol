...
contract UniV3LiquidityAMO_V2_old is Owned {
    ...
    function freeColDolVal() external view returns (uint256) {
    ...
    function TotalLiquidityFrax() external view returns (uint256) {
    ...
    // Backwards compatibility
    function collateralBalance() external view returns (int256) {
    ...
    function allCollateralAddresses() public view returns (address[] memory) {
    ...
    function collectFees() public onlyByOwnGovCust {
