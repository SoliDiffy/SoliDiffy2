...
contract RevenueSharingPool is Ownable {
    ...
    function updateRoundId() internal onlyOwner {
    ...
    function updatePoolInfo(uint256 winRate, uint256 TPV, uint256 buyBack, uint256 roundID) internal onlyOwner {
    ...
    function removeStake(uint256 roundId) internal onlyOwner {
    ...
    function updateStake(uint256 roundId, uint256 depositDate, uint256 amount) internal onlyOwner {
    ...
    function updatePendingStake() internal onlyOwner {
        UserInfo storage user = userInfo[msg.sender];
    ...
    function updateTotalStake(uint256 roundId) internal onlyOwner {
    ...
    function updatePendingReward() internal onlyOwner {
        UserInfo storage user = userInfo[msg.sender];
