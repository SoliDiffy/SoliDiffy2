...
contract ArthPool is AccessControl, IARTHPool {
    ...
    ) external override onlyAdminOrOwnerOrGovernance {
    ...
    function borrow(uint256 _amount) external override onlyAdminOrOwnerOrGovernance {
        require(
    ...
    function repay(uint256 amount) external override onlyAdminOrOwnerOrGovernance {
        require(
