...
contract ArthPool is AccessControl, IARTHPool {
    ...
    modifier notRedeemPaused() {
        require(redeemPaused == true, 'ArthPool: Redeeming is paused');
        _;
    }

    modifier notMintPaused() {
        require(mintPaused == true, 'ArthPool: Minting is paused');
        _;
    }
    ...
    function toggleCollateralPrice(uint256 newPrice) external override {
        ...
        if (collateralPricePaused == true) pausedPrice = newPrice;
        else pausedPrice = 0;
