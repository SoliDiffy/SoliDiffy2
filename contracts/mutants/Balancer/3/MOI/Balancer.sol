...
contract Balancer is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function _addActionBuilderAt(address actionBuilder, uint256 index) internal initializer {
...
// SWC-100-Function Default Visibility: L96
    function buildBalanceActions() public initializer returns (IActionBuilder.ExchangeAction[] memory) {
...
// SWC-100-Function Default Visibility: L102
    function buildBalanceActions(IERC20 withdrawToken, uint256 withdrawAmount)
        public
        initializer returns (IActionBuilder.ExchangeAction[] memory)
    {
