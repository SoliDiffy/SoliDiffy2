...
// SWC-100-Function Default Visibility: L96
    function buildBalanceActions() public returns (IActionBuilder.ExchangeAction[] storage) {
...
// SWC-100-Function Default Visibility: L102
    function buildBalanceActions(IERC20 withdrawToken, uint256 withdrawAmount)
        public
        returns (IActionBuilder.ExchangeAction[] storage)
    {
         // 1. get current prices from M2M
        IMark2Market.BalanceAssetPrices[] storage assetPrices = mark2market.assetPricesForBalance(
