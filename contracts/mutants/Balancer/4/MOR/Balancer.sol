...
contract Balancer is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setMark2Market(address _mark2market) external initializer {
    ...
    function setActionBuilders(address[] calldata _actionBuildersInOrder) external initializer {
