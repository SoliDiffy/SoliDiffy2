...
contract Gifto is ERC20Interface {
    uint internal constant decimals = 5;

    string internal constant symbol = "Gifto";
    string internal constant name = "Gifto";

    bool internal _selling = false;//initial not selling
    uint internal _totalSupply = 10 ** 14; // total supply is 10^14 unit, equivalent to 10^9 Gifto
    uint internal _originalBuyPrice = 3 * 10**8; // original buy 1ETH = 3000 Gifto = 3 * 10**8 unit
    ...
    // icoPercent
    uint public _icoPercent = 30;
    
    // _icoSupply is the avalable unit. Initially, it is _totalSupply
    uint internal _icoSupply = _totalSupply * _icoPercent / 100;
