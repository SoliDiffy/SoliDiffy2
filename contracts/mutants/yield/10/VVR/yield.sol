...
contract DIACompanyLockup is OTCRoles {
    ...
    uint256 public beginDepositTime;
    uint256 public endDepositTime;
    
    // Originating wallet for yield payments
    address public yieldWallet;
    
    // Parameters for early bird kickers
    address public kickerWallet;
    uint256 public kickerDeadline;
    uint256 public kickerPromille;
    
    // Yield rates
    uint256 internal threeMonthPromille;
    uint256 internal sixMonthPromille;
