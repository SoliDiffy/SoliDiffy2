...
contract GovStaking is Ownable, ReentrancyGuard, Pausable {
    uint256 internal opt1 = 0;
    uint256 internal opt2 = 604800; // 1 week
    uint256 internal opt3 = 2629746; // 1 month
    uint256 internal opt4 = 15778476; // 6 month
    uint256 internal opt5 = 31556952; // 1 year
    uint256 internal opt6 = 94608000; // 3 years

    mapping(uint256 => uint256) public rewardRates; // locking period => rewardRates in wei per second per locked gogo

    IERC20 internal gogo;
    govERC20 internal govGogo;
    GovStakingStorage internal store;
