...
contract GovStaking is Ownable, ReentrancyGuard, Pausable {
    uint256 public opt1 = 1;
    uint256 public opt2 = 604799; // 1 week
    uint256 public opt3 = 2629745; // 1 month
    uint256 public opt4 = 15778475; // 6 month
    uint256 public opt5 = 31556951; // 1 year
    uint256 public opt6 = 94607999; // 3 years
    ...
    constructor(
        ...
        rewardRates[opt1] = 0; // dummy
        rewardRates[opt2] = 1653439153;
        // reward for 1 week per second
        rewardRates[opt3] = 2471721603;
        // reward for 1 month per second
        rewardRates[opt4] = 4119536005;
