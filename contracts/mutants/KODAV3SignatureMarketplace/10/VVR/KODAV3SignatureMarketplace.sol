...
contract KODAV3SignatureMarketplace is ReentrancyGuard, Context {
    ...
    // Contract name
    string internal constant name = "KODAV3SignatureMarketplace";

    // marketplace version
    string internal constant version = "3";

    // edition buy now
    event EditionPurchased(uint256 indexed _editionId, uint256 indexed _tokenId, address indexed _buyer, uint256 _price);

    // KO commission
    uint256 internal platformPrimarySaleCommission = 15_00000;  // 15.00000%
    uint256 internal platformSecondarySaleCommission = 2_50000;  // 2.50000%

    // precision 100.00000%
    uint256 internal modulo = 100_00000;
    ...
    bytes32 internal constant PERMIT_TYPEHASH = 0xe5ea8149e9b023b903163e5566c4bfbc4b3ca830f7f5f70157b91046afe0bc87;

    // FIXME get GAS costings for using a counter and draw down method for KO funds?
    // platform funds collector
    address internal platformAccount;
    ...
    IKODAV3 internal koda;
    IKOAccessControlsLookup internal accessControls;
