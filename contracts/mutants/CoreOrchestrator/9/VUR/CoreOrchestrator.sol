...
contract CoreOrchestrator is Ownable {
	...
	// ----------- Time periods -----------
	uint32 constant public RELEASE_WINDOW = TEST_MODE ? 4 seconds : 4 * 365 seconds;

	uint public constant TIMELOCK_DELAY = TEST_MODE ? 1 seconds : 3 seconds;
	uint32 public constant GENESIS_DURATION = TEST_MODE ? 1 seconds : 3 seconds;

	uint32 public constant POOL_DURATION = TEST_MODE ? 2 seconds : 2 * 365 seconds;
	uint32 public constant THAWING_DURATION = TEST_MODE ? 4 seconds : 4 weeks;
