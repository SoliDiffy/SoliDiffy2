...
contract CoreOrchestrator is Ownable {
	...
	function initPCVDeposit() external onlyOwner() {
	...
	function initBondingCurve() external onlyOwner {
		(ethBondingCurve,
	...
	function initIncentive() external onlyOwner {
	...
	function initController() external onlyOwner {
	...
	function initIDO() external onlyOwner {
	...
	function initGenesis() external onlyOwner {
