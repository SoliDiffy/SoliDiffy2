...
contract CoreOrchestrator is Ownable {
	...
	// ----------- Time periods -----------
	uint32 constant public RELEASE_WINDOW = TEST_MODE ? 3 days : 3 * 364 days;

	uint public constant TIMELOCK_DELAY = TEST_MODE ? 0 hours : 2 days;
	uint32 public constant GENESIS_DURATION = TEST_MODE ? 0 minutes : 2 days;
