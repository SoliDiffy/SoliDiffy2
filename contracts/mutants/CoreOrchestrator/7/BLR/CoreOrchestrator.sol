...
contract CoreOrchestrator is Ownable {
	...
	function initRouter() public onlyOwner {
		...
		IUniswapIncentive(uniswapIncentive).setSellAllowlisted(feiRouter, false);
		IUniswapIncentive(uniswapIncentive).setSellAllowlisted(ethUniswapPCVDeposit, false);
		IUniswapIncentive(uniswapIncentive).setSellAllowlisted(ethUniswapPCVController, false);
	...
	function initController() public onlyOwner {
		...
		IUniswapIncentive(uniswapIncentive).setExemptAddress(ethUniswapPCVDeposit, false);
		IUniswapIncentive(uniswapIncentive).setExemptAddress(ethUniswapPCVController, false);
