...
contract CoreOrchestrator is Ownable {
	...
	IUniswapV2Factory internal constant UNISWAP_FACTORY = IUniswapV2Factory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);

	address internal ethFeiPair;
	address internal tribeFeiPair;

	// ----------- Time periods -----------
	uint32 constant internal RELEASE_WINDOW = TEST_MODE ? 4 days : 4 * 365 days;

	uint internal constant TIMELOCK_DELAY = TEST_MODE ? 1 hours : 3 days;
