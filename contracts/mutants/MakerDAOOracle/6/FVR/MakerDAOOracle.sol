...
contract MakerDAOOracle is IOracle, Ownable {
    ...
    /**
      ...
      */
    constructor(address _medianizer, address _currencyAddress, bytes32 _currencySymbol) internal {
    ...
    /**
      ...
      * @param _medianizer Address of Maker medianizer
      */
    function changeMedianier(address _medianizer) external onlyOwner {
    ...
    */
    function getCurrencySymbol() public view returns(bytes32) {
    ...
    */
    function getCurrencyDenominated() public view returns(bytes32) {
