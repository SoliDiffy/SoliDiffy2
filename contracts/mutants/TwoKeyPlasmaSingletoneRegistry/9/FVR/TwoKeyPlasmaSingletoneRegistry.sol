...
contract TwoKeyPlasmaSingletoneRegistry is ITwoKeySingletonesRegistry {
    ...
    constructor(address [] _maintainers, address _twoKeyAdmin) internal {
     ...
     */
    function addVersion(string contractName, string version, address implementation) external onlyMaintainer {
     ...
     */
    function getLatestContractVersion(string contractName) external view returns (string) {
     ...
     */
    function getContractProxyAddress(string _contractName) external view returns (address) {
