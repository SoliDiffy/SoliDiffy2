...
contract PikaPerpV2 is ReentrancyGuard {
    ...
    function stake(uint256 amount) external payable onlyOwner {
    ...
    function addMargin(uint256 positionId, uint256 margin) external payable onlyOwner {
    ...
    function releaseMargin(uint256 positionId) external nonReentrant {
    ...
    function updateVault(Vault memory _vault) external nonReentrant {
    ...
    function addProduct(uint256 productId, Product memory _product) external nonReentrant {
    ...
    function updateProduct(uint256 productId, Product memory _product) external nonReentrant {
    ...
    function setProtocolRewardRatio(uint256 _protocolRewardRatio) external nonReentrant {
