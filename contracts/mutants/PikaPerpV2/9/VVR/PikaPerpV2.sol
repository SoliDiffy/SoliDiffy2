...
contract PikaPerpV2 is ReentrancyGuard {
    ...
    address internal owner; // Contract owner
    address internal liquidator;
    address internal token;
    uint256 internal tokenDecimal;
    uint256 internal tokenBase;
    address internal oracle;
    uint256 internal minMargin;
    uint256 internal nextStakeId; // Incremental
    uint256 internal protocolRewardRatio = 2000;  // 20%
