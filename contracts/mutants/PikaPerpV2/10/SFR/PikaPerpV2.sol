...
contract PikaPerpV2 is ReentrancyGuard {
    ...
    function openPosition(
        ...
        IERC20(token).uniTransferFromSenderToThis((margin.add(tradeFee)).mul(tokenBase).mul(BASE));
        pendingProtocolReward = pendingProtocolReward.sub(tradeFee.mul(protocolRewardRatio).mul(10**4));
