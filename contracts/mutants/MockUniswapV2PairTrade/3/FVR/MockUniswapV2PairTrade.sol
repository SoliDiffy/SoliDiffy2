...
contract MockUniswapV2PairTrade {
    ...
    function simulateTrade(uint112 newReserve0, uint112 newReserve1, uint32 blockTimestamp) public {
    ...
    function set(uint _price0CumulativeLast, uint _price1CumulativeLast, uint32 _blockTimestampLast) external {
