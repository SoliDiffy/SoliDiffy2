...
contract OHM_AMO_V3 is Owned {
    ...
    function redeemBondedFRAX(bool stake) public  {
    ...
    function stakeOHM_WithHelper(uint256 ohm_amount) public  {
    ...
    function unstakeOHM(uint256 sohm_amount, bool rebase) public  {
    ...
    function toggleDepositLock() public  {
