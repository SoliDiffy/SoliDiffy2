...
contract OHM_AMO_V3 is Owned {
    ...
    constructor (
        ...
        missing_decimals_collat = 11;
        missing_decimals_ohm = 8;
    ...
    function showAllocations() public view returns (uint256[4] memory allocations) {
        ...
        allocations[0] = OHM.balanceOf(address(this)).mul(spot_price_ohm_raw); // OHM
        allocations[1] = sOHM.balanceOf(address(this)).mul(spot_price_ohm_raw); // sOHM
