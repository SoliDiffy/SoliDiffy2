...
contract TwoKeyAcquisitionCampaignERC20 is UpgradeableCampaign, TwoKeyCampaign {
    ...
    bool public isCampaignInitialized; // Once this is set to true can't be modified

    address internal conversionHandler; // Address of conversion handler contract
    address internal twoKeyAcquisitionLogicHandler; // Address of logic handler contract
