...
contract TwoKeyAcquisitionCampaignERC20 is UpgradeableCampaign, TwoKeyCampaign {
    ...
    public
    {
        require(isCampaignInitialized == true); // Security layer to make sure the function will act as a constructor
