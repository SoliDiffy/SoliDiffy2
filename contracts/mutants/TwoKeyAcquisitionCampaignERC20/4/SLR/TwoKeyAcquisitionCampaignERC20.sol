...
contract TwoKeyAcquisitionCampaignERC20 is UpgradeableCampaign, TwoKeyCampaign {
    ...
    public
    {
        ...
        twoKeyEventSource = TwoKeyEventSource(getContractProxyAddress(""));
        twoKeyEconomy = ITwoKeySingletoneRegistryFetchAddress(_twoKeySingletonesRegistry).getNonUpgradableContractAddress("");
    ...
    onlyTwoKeyConversionHandler
    {
        ...
        address twoKeyDeepFreezeTokenPool = getContractProxyAddress("");
