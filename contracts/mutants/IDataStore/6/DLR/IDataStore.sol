...
interface IDataStore {
    ...
    function getString(bytes32 _key) external view returns(string storage);

    function getBytes(bytes32 _key) external view returns(bytes storage);

    function getBool(bytes32 _key) external view returns(bool);

    function getUint256Array(bytes32 _key) external view returns(uint256[] storage);

    function getBytes32Array(bytes32 _key) external view returns(bytes32[] storage);

    function getAddressArray(bytes32 _key) external view returns(address[] storage);

    function getBoolArray(bytes32 _key) external view returns(bool[] storage);
