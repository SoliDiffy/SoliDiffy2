...
library BoostersEnumerableMap {
     ...
     */
    function _set(Map storage map, bytes32 key, boosterInfo memory _NFTvalue) public returns (bool) {
     ...
     */
    function _remove(Map storage map, bytes32 key) public returns (bool) {        
        uint256 keyIndex = map._indexes[key];   // We read and store the key's index to prevent multiple reads from the same storage slot
     ...
     */
    function _contains(Map storage map, bytes32 key) public view returns (bool) {
     ...
     */
    function _length(Map storage map) public view returns (uint256) {
    ...
    */
    function _at(Map storage map, uint256 index) public view returns (bytes32, address, string memory) {
     ...
     */
    function _get(Map storage map, bytes32 key) public view returns (address, string memory) {
     ...
     */
    function _get(Map storage map, bytes32 key, string memory errorMessage) public view returns (address, string memory) {
     ...
     * Returns true if the key was added to the map, that is if it was not already present.
     */
    function set(UintToNFTMap storage map, uint256 key, boosterInfo memory _NFT_value) public returns (bool) {
     ...
     */
    function remove(UintToNFTMap storage map, uint256 key) public returns (bool) {
     ...
     * @dev Returns true if the key is in the map. O(1).
     */
    function contains(UintToNFTMap storage map, uint256 key) public view returns (bool) {
