...
contract Erc20Vault is Vault {
     ...
     */
    function deposit(bytes calldata depositTx) public {
    ...
    */
    function withdraw(address payable receiver, address token, uint256 amount) public onlyFromNonQuarantinedExitGame {
