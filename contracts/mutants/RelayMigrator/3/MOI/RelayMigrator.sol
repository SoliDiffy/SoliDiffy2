...
contract RelayMigrator is Ownable {
   ...
   * completed.
   */
  function deploySmartWallets() external onlyOwner {
    require(
      registrationCompleted,
   ...
   */
  function migrateRelayContractsToSmartWallets() external onlyOwner {
    require(
      migrationStarted,
   ...
   * the relay contract.
   */
  function batchExecuteTransactions(RelayCall[] memory relayCalls) public onlyOwner {
