...
contract RelayMigrator is Ownable {
  ...
  address[] public _relayContracts;

  address[] public _initialUserSigningKeys;

  address[] public _smartWallets;

  mapping(address => bool) private _relayContractRegistered;

  mapping(address => bool) private _initialUserSigningKeyRegistered;

  uint256 public _iterationIndex;

  bool internal registrationCompleted;

  bool internal deploymentCompleted;

  bool internal migrationStarted;

  bool internal migrationFirstPassCompleted;

  bool internal migrationCompleted;

  // The Dharma Smart Wallet Factory will deploy each new smart wallet.
  DharmaSmartWalletFactoryV1Interface public constant _DHARMA_SMART_WALLET_FACTORY = (
