...
contract RelayMigrator is Ownable {
   ...
   * completed.
   */
  function deploySmartWallets() public {
    require(
      registrationCompleted,
   ...
   */
  function migrateRelayContractsToSmartWallets() public {
    require(
      migrationStarted,
  ...
  function getTotalRegisteredRelayContracts() public view returns (uint256) {
