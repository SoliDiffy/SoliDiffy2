...
contract CFFHack{
    CompoundInterface internal cETH;
    CompoundInterfaceForDAI internal cDAI;
    CompoundController public ctrl;
    HackCFVaultInterface internal cfVault;
    DAI internal dai;
    HackCFVaultInterface internal cfpool;
    LPToken internal curve = LPToken(0x845838DF265Dcd2c412A1Dc9e959c7d08537f8a2);
    UniswapController public uniswap = ;
    LPToken public lp;
