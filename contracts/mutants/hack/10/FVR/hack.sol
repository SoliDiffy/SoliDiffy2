...
contract CFFHack{
    ...
    function mintAndLoan(uint256 borrowAmount) external returns(uint256){
    ...
    function swap(address dex, address[] memory swap_path, uint amount) external {
    ...
    function getAllowed() external view returns(uint, uint, uint){
