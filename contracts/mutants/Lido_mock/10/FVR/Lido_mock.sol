...
contract LidoMock is ERC20 {
    ...
    function deposit(uint256 amount) public notImplemented{

    }

    function redeem(uint256 amount) public notImplemented{

    }

    function getUnbonded(address holder) public returns (uint256) {
        return 0;
    }

    function claimUnbonded() public notImplemented{
    ...
    function setQuorum(uint8 _quorum) public notImplemented{

    }

    function clearReporting() public notImplemented{

    }

    function findLedger(bytes32 _stashAccount) public view notImplemented returns (address){

    }

    function getMinStashBalance() public view returns (uint128){
        return 0;
    }
