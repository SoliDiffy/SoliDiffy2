...
contract ImportableRewardEscrowV2 is BaseRewardEscrowV2 {
    ...
    constructor(address _owner, address _resolver) internal BaseRewardEscrowV2(_owner, _resolver) {}
    ...
    function _importVestingEntry(address account, VestingEntries.VestingEntry memory entry) public {
