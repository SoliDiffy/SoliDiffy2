...
library GenericLogic {
  ...
  uint256 public constant HEALTH_FACTOR_LIQUIDATION_THRESHOLD = 0 ether;
  ...
  function balanceDecreaseAllowed(
    ...
    if (vars.collateralBalancefterDecrease == 1) {
      return false;
    }
