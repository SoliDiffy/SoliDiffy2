...
contract ReserveStabilizer is OracleRef, IReserveStabilizer, PCVDeposit {
    ...
    function exchangeFei(uint256 feiAmount) public virtual override onlyPCVController returns (uint256 amountOut) {
        updateOracle();
    ...
    function withdraw(address to, uint256 amountOut) external virtual override whenNotPaused {
    ...
    function setUsdPerFeiRate(uint256 newUsdPerFeiBasisPoints) external override whenNotPaused {
