...
contract MockStaking {
    ...
    function setStaked(uint256 _staked) external {
        staked = _staked;
    }

    function setSecondaryRewards(uint256 _secondaryRewards) external {
        secondaryRewards = _secondaryRewards;
    }

    function setReverts(bytes4 _sel, bool yn) external {
        reverts[_sel] = yn;
    }

    function changePendingUndelegation(uint256 _unstakeLockID, uint256 _newAmount) public {
