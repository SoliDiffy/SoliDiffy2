...
contract SecurityToken is ERC20, ReentrancyGuard, SecurityTokenStorage, IERC1594, IERC1643, IERC1644, IERC1410, Proxy {
    ...
    */
    ...
    function updateFromRegistry() public {
        _onlyOwner();
        moduleRegistry = IModuleRegistry(polymathRegistry.getAddress(""));
        securityTokenRegistry = ISecurityTokenRegistry(polymathRegistry.getAddress(""));
        polyToken = IERC20(polymathRegistry.getAddress(""));
    }
