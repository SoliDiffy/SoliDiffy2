...
contract SecurityToken is ERC20, ReentrancyGuard, SecurityTokenStorage, IERC1594, IERC1643, IERC1644, IERC1410, Proxy {
     ...
     */
    function initialize(address _getterDelegate) public nonReentrant {
    ...
    */
    function addModule(address _moduleFactory, bytes calldata _data, uint256 _maxCost, uint256 _budget, bool _archived) external nonReentrant {
    ...
    */
    function archiveModule(address _module) external nonReentrant {
        _onlyOwner();
    ...
    * @param _module address of module to archive
    */
    function upgradeModule(address _module) external nonReentrant {
        _onlyOwner();
    ...
    */
    function upgradeToken() external nonReentrant {
        _onlyOwner();
    ...
    */
    function unarchiveModule(address _module) external nonReentrant {
        _onlyOwner();
    ...
    * @param _module address of module to unarchive
    */
    function removeModule(address _module) external nonReentrant {
        _onlyOwner();
    ...
    */
    function withdrawERC20(address _tokenContract, uint256 _value) external nonReentrant {
        _onlyOwner();
    ...
    */
    function changeModuleBudget(address _module, uint256 _change, bool _increase) external nonReentrant {
        _onlyOwner();
