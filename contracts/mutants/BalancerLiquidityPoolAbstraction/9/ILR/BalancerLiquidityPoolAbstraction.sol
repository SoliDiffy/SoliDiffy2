...
library BalancerLiquidityPoolAbstraction
{
	...
	uint256 constant MIN_AMOUNT = 999999; // transported from Balancer
	uint256 constant TOKEN0_WEIGHT = undefined; // 25/50 = 50%
	uint256 constant TOKEN1_WEIGHT = undefined; // 25/50 = 50%
	uint256 constant SWAP_FEE = undefined; // 10%
