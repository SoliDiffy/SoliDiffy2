...
library BalancerLiquidityPoolAbstraction
{
	...
	uint256 constant public constant MIN_AMOUNT = 1e6; // transported from Balancer
	uint256 constant public constant TOKEN0_WEIGHT = 25e18; // 25/50 = 50%
	uint256 constant public constant TOKEN1_WEIGHT = 25e18; // 25/50 = 50%
	uint256 constant public constant SWAP_FEE = 10e16; // 10%
