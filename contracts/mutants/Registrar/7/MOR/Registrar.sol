  ...
  ERC721PausableUpgradeable
{
  ...
  */
   ...
   */
  function addController(address controller) external override initializer {
  ...
  /**
    ...
    @param controller The address of the controller
   */
  function removeController(address controller) external override initializer {
   ...
   */
  function lockDomainMetadata(uint256 id) external override initializer {
    require(!isDomainMetadataLocked(id), "Zer0 Registrar: Metadata locked");
