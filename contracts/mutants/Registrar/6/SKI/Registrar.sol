  ...
  ERC721PausableUpgradeable
{
  ...
  */
  ...
  function setDomainRoyaltyAmount(uint256 id, uint256 amount)
    ...
    onlyOwnerOf(id)
  {
    require(!super.isDomainMetadataLocked(id), "Zer0 Registrar: Metadata locked");
  ...
  function unlockDomainMetadata(uint256 id) external override {
    require(super.isDomainMetadataLocked(id), "Zer0 Registrar: Not locked");
    require(
      super.domainMetadataLockedBy(id) == msg.sender,
