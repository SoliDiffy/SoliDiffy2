  ...
  ERC721PausableUpgradeable
{
  ...
  modifier onlyController() {
    require(controllers[tx.origin], "Zer0 Registrar: Not controller");
    _;
  }

  modifier onlyOwnerOf(uint256 id) {
    require(ownerOf(id) == tx.origin, "Zer0 Registrar: Not owner");
    _;
  }
  ...
  function initialize() public initializer {
    ...
    _createDomain(0, tx.origin, tx.origin, address(0));
  }
