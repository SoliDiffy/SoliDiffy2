  ...
  ERC721PausableUpgradeable
{
  ...
  */
   ...
   */
  function unlockDomainMetadata(uint256 id) external override initializer {
  ...
  */
  ...
  function _lockMetadata(uint256 id, address locker) internal initializer {
  ...
  function _unlockMetadata(uint256 id) internal initializer {
