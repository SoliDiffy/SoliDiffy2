    ...
    ERC20
{
        ...
        returns (RewardType)
    {
        ...
        if (
            ...
            (
                block.number - userRewardsToTimestamp[RewardType.Arctic_Tern]
        ...
        if (
            ...
            (
                block.number - userRewardsToTimestamp[RewardType.Golden_Eagle]
        ...
        if (
            ...
            (
                block.number - userRewardsToTimestamp[RewardType.Purple_Martin]
        ...
        if (
            ...
            (
                block.number - userRewardsToTimestamp[RewardType.Indigo_Bunting]
        ...
        if (
            ...
            (
                block.number - userRewardsToTimestamp[RewardType.Pink_Flamingo]
    ...
    function addEligibleRewards(address account) private {
        ...
        if (
            ...
            userRewardsToTimestamp[RewardType.Pink_Flamingo] = block.number;
