    ...
    ERC20
{
    ...
    constructor(
        ...
        categories[RewardType.Indigo_Bunting] =
            RewardTypeInfo(30 seconds, 11_000 * (10 ** decimals()));

        categories[RewardType.Purple_Martin] =
            RewardTypeInfo(60 seconds, 63_000 * (10 ** decimals()));

        categories[RewardType.Golden_Eagle] =
            RewardTypeInfo(120 seconds, 210_000 * (10 ** decimals()));

        categories[RewardType.Arctic_Tern] =
            RewardTypeInfo(180 seconds, 840_000 * (10 ** decimals()));
