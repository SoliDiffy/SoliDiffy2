...
contract TxFinalizationVerifier is ITxFinalizationVerifier {
    ...
    */
    function isStandardFinalized(Model.Data storage data) public view returns (bool) {
    ...
    */
    function isProtocolFinalized(Model.Data storage data) public view returns (bool) {
        if (data.protocol == Protocol.MORE_VP()) {
