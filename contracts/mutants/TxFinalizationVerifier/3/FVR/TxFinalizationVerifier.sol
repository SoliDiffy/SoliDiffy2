...
contract TxFinalizationVerifier is ITxFinalizationVerifier {
    ...
    */
    function isStandardFinalized(Model.Data memory data) external view returns (bool) {
    ...
    */
    function isProtocolFinalized(Model.Data memory data) external view returns (bool) {
        if (data.protocol == Protocol.MORE_VP()) {
    ...
    function checkInclusionProof(Model.Data memory data) public view returns (bool) {
