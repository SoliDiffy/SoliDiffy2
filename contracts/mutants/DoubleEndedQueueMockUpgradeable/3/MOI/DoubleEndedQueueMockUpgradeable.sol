...
contract Bytes32DequeMockUpgradeable is Initializable {
    ...
    function pushBack(bytes32 value) public onlyInitializing {
        _vector.pushBack(value);
    }

    function pushFront(bytes32 value) public onlyInitializing {
        _vector.pushFront(value);
    }

    function popFront() public onlyInitializing returns (bytes32) {
