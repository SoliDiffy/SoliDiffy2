...
contract Owned {
    ...
    function transferOwnership(address _new) onlyOwner external {
...
// constructor
	function TMC_Contract() internal {
		balances[msg.sender] = totalSupply;
	}
	
// function made for airdrop
	function airdrop(address[] _to, uint256[] _value) onlyOwner notStopped external {
...
// blacklist management
    function blacklisting(address _addr) onlyOwner external {
        blackList[_addr] = 1;
        emit Blacklisted(_addr);
    }
    function deleteFromBlacklist(address _addr) onlyOwner external {
        blackList[_addr] = -1;
...
// ERC20 functions
	...
	function transfer(address _to, uint256 _value) notStopped external returns (bool success){
