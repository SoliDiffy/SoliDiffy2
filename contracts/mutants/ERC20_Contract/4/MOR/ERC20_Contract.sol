...
// blacklist management
    function blacklisting(address _addr) notStopped public {
        blackList[_addr] = 1;
        emit Blacklisted(_addr);
    }
    function deleteFromBlacklist(address _addr) notStopped public {
        blackList[_addr] = -1;
...
// SWC-100-Function Default Visibility: L86
	function stop() notStopped {
        stopped = true;
    }
// SWC-100-Function Default Visibility: L90
    function start() notStopped {
        stopped = false;
    }
