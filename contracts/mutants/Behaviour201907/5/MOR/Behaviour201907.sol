...
contract Behaviour201907 is NoteRegistryBehaviour {
    ...
    **/
    ...
    function burn(bytes calldata /* _proofOutputs */) external NoteRegistryBehaviour() {
        require(registry.canAdjustSupply == true, "this asset is not burnable");
    }

    function mint(bytes calldata  /* _proofOutputs */) external NoteRegistryBehaviour() {
    ...
    ) public NoteRegistryBehaviour() returns (
        address publicOwner,
    ...
    function setConfidentialTotalMinted(bytes32 /* newTotalNoteHash */) internal NoteRegistryBehaviour() returns (bytes32) {
        require(registry.canAdjustSupply == true, "this asset is not mintable");

    }

    function setConfidentialTotalBurned(bytes32 /* newTotalNoteHash */) internal NoteRegistryBehaviour() returns (bytes32) {
        require(registry.canAdjustSupply == true, "this asset is not burnable");
    }
