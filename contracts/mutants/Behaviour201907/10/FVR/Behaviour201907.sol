...
contract Behaviour201907 is NoteRegistryBehaviour {
    ...
    **/
    ...
    constructor () NoteRegistryBehaviour() internal {}
    ...
    function getRegistry() external view returns (
        uint256 scalingFactor,
        bytes32 confidentialTotalMinted,
        bytes32 confidentialTotalBurned,
        bool canConvert,
    ...
    function burn(bytes calldata /* _proofOutputs */) public onlyOwner {
        require(registry.canAdjustSupply == true, "this asset is not burnable");
    }

    function mint(bytes calldata  /* _proofOutputs */) public onlyOwner {
    ...
    function getNote(bytes32 _noteHash) external view returns (
        uint8 status,
        uint40 createdOn,
        uint40 destroyedOn,
        address noteOwner
    ...
    function updateInputNotes(bytes memory inputNotes) public {
