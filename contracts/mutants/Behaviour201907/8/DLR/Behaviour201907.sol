...
contract Behaviour201907 is NoteRegistryBehaviour {
    ...
    **/
    ...
    function getNote(bytes32 _noteHash) public view returns (
        ...
        Note memory notePtr = registry.notes[_noteHash];
        assembly {
    ...
    function updateInputNotes(bytes storage inputNotes) internal {
    ...
    function updateOutputNotes(bytes storage outputNotes) internal {
