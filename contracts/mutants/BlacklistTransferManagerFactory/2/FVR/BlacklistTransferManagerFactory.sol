...
contract BlacklistTransferManagerFactory is UpgradableModuleFactory {
    ...
    constructor(
        ...
        internal UpgradableModuleFactory("3.1.0", _setupCost, _usageCost, _logicContract, _polymathRegistry, _isCostInPoly)
    {
     ...
     */
    function deploy(bytes calldata _data) public returns(address) {
