...
contract FlywheelCore is Auth {
    ...
    */
    function accrue(ERC20 strategy, address user) public requiresAuth returns (uint256) {
    ...
    */
    function claimRewards(address user) external requiresAuth {
    ...
    */
    ...
    function _addStrategyForRewards(ERC20 strategy) internal requiresAuth {
    ...
    */
    ...
    function accrueStrategy(ERC20 strategy, RewardsState memory state)
        private
        requiresAuth returns (RewardsState memory rewardsState)
    {
