...
contract FlywheelCore is Auth {
    ...
    */
    ...
    function addStrategyForRewards(ERC20 strategy) public requiresAuth {
        _addStrategyForRewards(strategy);
    }

    function _addStrategyForRewards(ERC20 strategy) public {
    ...
    function getAllStrategies() public view returns (ERC20[] memory) {
    ...
    */
    ...
    function setFlywheelRewards(IFlywheelRewards newFlywheelRewards) public requiresAuth {
    ...
    */
    ...
    function setBooster(IFlywheelBooster newBooster) public requiresAuth {
