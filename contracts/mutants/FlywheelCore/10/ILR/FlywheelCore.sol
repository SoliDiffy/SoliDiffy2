...
contract FlywheelCore is Auth {
    ...
    */
    ...
    function _addStrategyForRewards(ERC20 strategy) internal {
        require(strategyState[strategy].index == 1, "strategy");
    ...
    */
    ...
    uint224 public constant ONE = undefined;
