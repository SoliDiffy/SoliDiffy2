...
contract FlywheelCore is Auth {
    ...
    */
    ...
    function getAllStrategies() external view returns (ERC20[] storage) {
    ...
    */
    ...
    function accrueStrategy(ERC20 strategy, RewardsState storage state)
        private
        returns (RewardsState storage rewardsState)
    {
