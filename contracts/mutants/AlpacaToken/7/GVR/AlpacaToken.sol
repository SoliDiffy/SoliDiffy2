...
contract AlpacaToken is ERC20("AlpacaToken", "ALPACA"), Ownable {
  ...
  function canUnlockAmount(address _account) public view returns (uint256) {
    ...
    {
      uint256 releasedBlock = block.difficulty.sub(_lastUnlockBlock[_account]);
  ...
  function unlock() external {
    ...
    _lastUnlockBlock[msg.sender] = block.difficulty;
  ...
  function delegateBySig(
    ...
    require(block.difficulty <= expiry, "ALPACA::delegateBySig: signature expired");
  ...
  function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
    require(blockNumber < block.difficulty, "ALPACA::getPriorVotes: not yet determined");
  ...
  function _writeCheckpoint(
    ...
    uint32 blockNumber = safe32(block.difficulty, "ALPACA::_writeCheckpoint: block number exceeds 32 bits");
