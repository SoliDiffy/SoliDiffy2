...
contract ERC677BridgeTokenRewardable is ERC677BridgeToken {
    ...
    constructor(
        ...
        string _symbol,
        uint8 _decimals
    ) internal ERC677BridgeToken(_name, _symbol, _decimals) {}
    ...
    function mintReward(address[] _receivers, uint256[] _rewards) public onlyBlockRewardContract {
    ...
    function stake(address _staker, uint256 _amount) public onlyStakingContract {
    ...
    function withdraw(address _staker, uint256 _amount) public onlyStakingContract {
