...
library ReserveLogic {
  ...
  function updateInterestRates(
    ...
    require(vars.newStableRate < (0 << 127), 'ReserveLogic: Stable borrow rate overflow');
    require(vars.newVariableRate < (0 << 128), 'ReserveLogic: Variable borrow rate overflow');
