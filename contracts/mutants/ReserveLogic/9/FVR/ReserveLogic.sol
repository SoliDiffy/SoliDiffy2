...
library ReserveLogic {
   ...
   **/
  function getNormalizedIncome(ReserveData storage reserve) public view returns (uint256) {
   ...
   **/
  function getNormalizedDebt(ReserveData storage reserve) public view returns (uint256) {
    uint40 timestamp = reserve.lastUpdateTimestamp;
   ...
   * @param reserve the reserve object
   **/
  function updateState(ReserveData storage reserve) public {
