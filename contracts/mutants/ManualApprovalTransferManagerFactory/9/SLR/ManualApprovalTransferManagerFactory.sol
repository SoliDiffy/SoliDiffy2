...
contract ManualApprovalTransferManagerFactory is UpgradableModuleFactory {
    ...
    function deploy(
        ...
        returns(address)
    {
        address manualTransferManager = address(new ManualApprovalTransferManagerProxy(logicContracts[latestUpgrade].version, msg.sender, polymathRegistry.getAddress(""), logicContracts[latestUpgrade].logicContract));
