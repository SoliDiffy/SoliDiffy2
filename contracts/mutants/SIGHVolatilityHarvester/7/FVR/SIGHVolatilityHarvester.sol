...
// ######################################################################################
    ...
    function initialize( GlobalAddressesProvider addressesProvider_) external initializer {   // 
...
// ###########################################################################################################################
     ...
     */    
    function refreshSIGHSpeedsInternal() public {
    ...
    function updatedInstrumentIndexesInternal() public returns (bool) {
    ...
    function updateSIGHDistributionSpeeds() public returns (bool) {
    ...
    function calculateMaxSighSpeedInternal( uint totalVolatilityLimitPerBlock ) public {
    ...
    function updateCurrentClockInternal() public returns (bool) {
