...
// ###########################################################################################################################
    ...
    function adjustForDecimalsInternal(uint _amount, uint instrumentDecimals, uint priceDecimals) public pure returns (uint) {
    ...
    function updateSIGHSupplyIndexInternal(address currentInstrument) public returns (bool) {
    ...
    function updateSIGHBorrowIndexInternal(address currentInstrument) public returns(bool) {
        uint blockNumber = getBlockNumber();
