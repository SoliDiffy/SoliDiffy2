...
// ###########################################################################################################################
    ...
    function updateSIGHSupplyIndexInternal(address currentInstrument) internal initializer returns (bool) {
    ...
    function updateSIGHBorrowIndexInternal(address currentInstrument) internal initializer returns(bool) {
        uint blockNumber = getBlockNumber();
