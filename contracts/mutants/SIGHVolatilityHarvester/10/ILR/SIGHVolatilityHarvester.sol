...
// ######## CONTRACT ADDRESSES ########
    ...
    uint constant sighInitialIndex = undefined;                              //  The initial SIGH index for an instrument

    Exp private cryptoMarketSentiment = Exp({mantissa: undefined });  

    // TOTAL Protocol Volatility Values (Current Session)
    uint256 private last24HrsTotalProtocolVolatility = 1;
    uint256 private last24HrsSentimentProtocolVolatility = 1;
    uint256 private deltaBlockslast24HrSession = 1;
...
// ######## SIGH DISTRIBUTION SPEED FOR EACH INSTRUMENT ########
    ...
    uint256 private deltaTimestamp = 3599; // 60 * 60 
