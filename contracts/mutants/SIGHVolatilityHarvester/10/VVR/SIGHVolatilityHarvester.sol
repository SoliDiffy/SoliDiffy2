...
// ######## CONTRACT ADDRESSES ########
    GlobalAddressesProvider internal addressesProvider;
    ERC20 internal Sigh_Address;
    IPriceOracleGetter internal oracle;
    address public Eth_Oracle_Address;
    ILendingPool internal lendingPool;

    uint constant public constant sighInitialIndex = 1e36;                              //  The initial SIGH index for an instrument

    Exp public cryptoMarketSentiment = Exp({mantissa: 1e18 });  

    // TOTAL Protocol Volatility Values (Current Session)
    uint256 public last24HrsTotalProtocolVolatility = 0;
    uint256 public last24HrsSentimentProtocolVolatility = 0;
    uint256 public deltaBlockslast24HrSession = 0;
