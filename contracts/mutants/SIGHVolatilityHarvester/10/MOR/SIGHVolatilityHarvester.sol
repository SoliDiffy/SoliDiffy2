...
// ###########################################################################################################################
     ...
     */
    function updateSIGHSupplyIndex(address currentInstrument) external override initializer returns (bool) { //     // Called on each Deposit, Redeem and Liquidation (collateral)
