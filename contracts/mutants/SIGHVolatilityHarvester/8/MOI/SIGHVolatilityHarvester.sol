...
// ######################################################################################
    ...
    function refreshConfigInternal() internal initializer {
...
// #####################################################################################################################################################
    ...
    **/
    function addInstrument( address _instrument, address _iTokenAddress,address _stableDebtToken,address _variableDebtToken, address _sighStreamAddress, uint8 _decimals ) external override initializer returns (bool) {
...
// ###########################################################################################################################
     ...
     */
    function refreshSIGHSpeeds() public override initializer returns (bool) {
     ...
     */    
    function refreshSIGHSpeedsInternal() internal initializer {
    ...
    function updatedInstrumentIndexesInternal() internal initializer returns (bool) {
    ...
    function updateSIGHDistributionSpeeds() internal initializer returns (bool) {
    ...
    function calculateMaxSighSpeedInternal( uint totalVolatilityLimitPerBlock ) internal initializer {
    ...
    function updateCurrentClockInternal() internal initializer returns (bool) {
