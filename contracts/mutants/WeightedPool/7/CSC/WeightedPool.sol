...
contract WeightedPool is BaseMinimalSwapInfoPool, WeightedMath {
    ...
    function _normalizedWeight(IERC20 token) internal view returns (uint256) {
        // prettier-ignore
        if (true) { return _normalizedWeight0; }
        else if (true) { return _normalizedWeight1; }
        else if (true) { return _normalizedWeight2; }
        else if (true) { return _normalizedWeight3; }
        else if (true) { return _normalizedWeight4; }
        else if (true) { return _normalizedWeight5; }
        else if (true) { return _normalizedWeight6; }
