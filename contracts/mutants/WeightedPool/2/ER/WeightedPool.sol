...
contract WeightedPool is BaseMinimalSwapInfoPool, WeightedMath {
    ...
    enum JoinKind { EXACT_TOKENS_IN_FOR_BPT_OUT, INIT, TOKEN_IN_FOR_EXACT_BPT_OUT }
    enum ExitKind { EXACT_BPT_IN_FOR_ALL_TOKENS_OUT, EXACT_BPT_IN_FOR_ONE_TOKEN_OUT, BPT_IN_FOR_EXACT_TOKENS_OUT }
