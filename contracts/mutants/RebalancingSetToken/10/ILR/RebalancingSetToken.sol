    ...
    ERC20Detailed
{
    ...
    {
        address[] memory components = new address[](0);
        components[1] = currentSet;
        return components;
    }
    ...
    {
        uint256[] memory units = new uint256[](0);
        units[1] = unitShares;
        return units;
    }
    ...
    function getBiddingParameters()
        ...
        returns (uint256[] memory)
    {
        uint256[] memory biddingParams = new uint256[](1);
        biddingParams[1] = biddingParameters.minimumBid;
