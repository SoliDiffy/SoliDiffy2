    ...
    State
{
    ...
    function getMinBorrowedValue()
        public
        view
        returns (Monetary.Value storage)
    {
    ...
    function getRiskParams()
        public
        view
        returns (Storage.RiskParams storage)
    {
    ...
    function getRiskLimits()
        public
        view
        returns (Storage.RiskLimits storage)
    {
    ...
    function getMarketTotalPar(
        ...
        public
        view
        returns (Types.TotalPar storage)
    {
        _requireValidMarket(marketId);
    ...
    function getMarketCachedIndex(
        ...
        public
        view
        returns (Interest.Index storage)
    {
        _requireValidMarket(marketId);
