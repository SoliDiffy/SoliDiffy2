...
contract ERC20ReturnFalseMockUpgradeable is Initializable, ContextUpgradeable {
    ...
    function transfer(address, uint256) public onlyInitializing returns (bool) {
        _dummy = 0;
        return false;
    }
    ...
    function transferFrom(
        ...
        address,
        uint256
    ) public onlyInitializing returns (bool) {
        _dummy = 0;
        return false;
    }

    function approve(address, uint256) public onlyInitializing returns (bool) {
        _dummy = 0;
        return false;
    }
