...
contract ProfileRegistry is Ownable, Pausable {
    ...
    function AddValidator(address _validator, int8 _level) whenNotPaused onlySonm public returns (address){
        require(_level > 0);
    ...
    function RemoveValidator(address _validator) whenNotPaused onlySonm public returns (address){
        require(GetValidatorLevel(_validator) > 0);
