...
interface ILendingPair {
    ...
    function addCollateralTo(uint256 amount, address to) external ;
    ...
    function addAssetTo(uint256 amount, address to) external ;
    function addAssetFromBento(uint256 amount) external ;
    function addAssetFromBentoTo(uint256 amount, address to) external ;
