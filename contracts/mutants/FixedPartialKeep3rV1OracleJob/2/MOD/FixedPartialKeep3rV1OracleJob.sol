...
contract FixedPartialKeep3rV1OracleJob is UtilsReady, Keep3r, IPartialKeep3rV1OracleJob {
  ...
  constructor() public Keep3r(0x1cEB5cB57C4D4E2b2433641b95Dd330A33185A44) UtilsReady() {
  ...
  function work(address _pair) public override onlyKeeper notPaused returns (uint256 _credits) {
