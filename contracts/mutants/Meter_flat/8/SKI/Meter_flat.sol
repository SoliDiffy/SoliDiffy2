...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        super._beforeTokenTransfer(account, address(0), amount);
...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
     ...
     */
    function grantRole(bytes32 role, address account) public virtual override onlyRole(super.getRoleAdmin(role)) {
     ...
     * - the caller must have ``role``'s admin role.
     */
    function revokeRole(bytes32 role, address account) public virtual override onlyRole(super.getRoleAdmin(role)) {
    ...
    function _setRoleAdmin(bytes32 role, bytes32 adminRole) internal virtual {
        emit RoleAdminChanged(role, super.getRoleAdmin(role), adminRole);
