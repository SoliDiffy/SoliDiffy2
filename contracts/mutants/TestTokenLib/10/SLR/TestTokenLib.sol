...
contract TestTokenLib {
  ...
  function beforeAll(){
    address ia = new TokenLibTestContract(this, "", "", 18, 100, true);
  ...
  function testAllowanceFunction(){
    ...
    Assert.equal(expectedAllowance,20,"");
  }
