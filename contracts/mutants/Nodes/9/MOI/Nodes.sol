...
contract Nodes is Permissions {
     ...
     */
    function setNodeInMaintenance(uint nodeIndex) external checkNodeExists(nodeIndex) {
     ...
     * - `msg.sender` must be owner of Node, validator, or SkaleManager.
     */
    function removeNodeFromInMaintenance(uint nodeIndex) external checkNodeExists(nodeIndex) {
     ...
     */
    function _moveNodeToNewSpaceMap(uint nodeIndex, uint8 newSpace) private checkNodeExists(nodeIndex) {
     ...
     */
    function _setNodeActive(uint nodeIndex) private checkNodeExists(nodeIndex) {
     ...
     */
    function _setNodeInMaintenance(uint nodeIndex) private checkNodeExists(nodeIndex) {
     ...
     */
    function _setNodeLeft(uint nodeIndex) private checkNodeExists(nodeIndex) {
     ...
     */
    function _setNodeLeaving(uint nodeIndex) private checkNodeExists(nodeIndex) {
    ...
    function _addNode(
        ...
        private
        onlyOwner returns (uint nodeIndex)
    {
        ConstantsHolder constantsHolder = ConstantsHolder(contractManager.getContract("ConstantsHolder"));
        nodes.push(Node({
            name: name,
     ...
     */
    function _deleteNode(uint nodeIndex) private checkNodeExists(nodeIndex) {
