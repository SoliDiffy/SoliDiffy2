...
abstract contract SelectorTokenGasLimitConnector is Ownable, BasicAMBMediator {
     ...
     */
    function setGasLimitManager(address _manager) public onlyOwner {
     ...
     */
    function gasLimitManager() external view returns (SelectorTokenGasLimitManager) {
     ...
     * @param _manager address of gas limit manager contract.
     */
    function _setGasLimitManager(address _manager) public {
     ...
     */
    function _chooseRequestGasLimit(bytes memory _data) public view returns (uint256) {
