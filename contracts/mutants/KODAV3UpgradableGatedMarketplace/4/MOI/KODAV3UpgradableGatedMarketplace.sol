...
abstract contract BaseUpgradableMarketplace is ReentrancyGuardUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function _handleSaleFunds(address _fundsReceiver, uint256 _platformCommission) internal initializer {
    ...
    function _refundBidder(uint256 _id, address _receiver, uint256 _paymentAmount, address _newBidder, uint256 _newOffer) internal initializer {
...
contract KODAV3UpgradableGatedMarketplace is IKODAV3GatedMarketplace, BaseUpgradableMarketplace {
    ...
    function _createSale(uint256 _editionId, address _creator) internal nonReentrant returns (uint256) {
