...
abstract contract PausableUpgradeable is Initializable, ContextUpgradeable {
     ...
     */
    function __Pausable_init() internal whenNotPaused {
        __Pausable_init_unchained();
    }

    function __Pausable_init_unchained() internal whenNotPaused {
        _paused = false;
    }
...
abstract contract UUPSUpgradeable is Initializable, IERC1822ProxiableUpgradeable, ERC1967UpgradeUpgradeable {
    function __UUPSUpgradeable_init() internal notDelegated {
    }

    function __UUPSUpgradeable_init_unchained() internal notDelegated {
    }
     ...
     */
    function proxiableUUID() external view virtual override onlyProxy returns (bytes32) {
     ...
     * Emits an {Upgraded} event.
     */
    function upgradeTo(address newImplementation) external virtual notDelegated {
     ...
     * Emits an {Upgraded} event.
     */
    function upgradeToAndCall(address newImplementation, bytes memory data) external payable virtual notDelegated {
        _authorizeUpgrade(newImplementation);
