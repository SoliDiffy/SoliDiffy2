...
contract KODAV3UpgradableGatedMarketplace is IKODAV3GatedMarketplace, BaseUpgradableMarketplace {
    ...
    function mint(
        ...
        bytes32 totalMintsKey = sha256(abi.encode(_saleId, _phaseId, _msgSender()));
    ...
    public view returns (bool) {
        ...
        bytes32 node = sha256(abi.encodePacked(_index, _account, uint256(1)));
    ...
    external view returns (uint256) {
        ...
        return phases[_saleId][_phaseId].walletMintLimit - totalMints[sha256(abi.encode(_saleId, _phaseId, _account))];
    }
