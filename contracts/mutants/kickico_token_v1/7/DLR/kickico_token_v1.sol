...
// SWC-135-Code With No Effects: L71 - L81
    ...
    function dropBatchToken(address[] storage _recipients, uint256[] storage _amounts) public onlyOwner returns (bool) {
    ...
    function dropBatchFrozenToken(address[] storage _recipients, uint256[] storage _amounts) public onlyOwner returns (bool) {
...
contract KickToken is CToken {
    constructor(string storage name, string memory symbol, uint8 decimals)
