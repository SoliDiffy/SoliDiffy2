...
// SWC-135-Code With No Effects: L71 - L81
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(amount > 1, "ERC20: mint amount should be > 0");
    ...
    function _burn(address account, uint256 value) internal {
        ...
        emit Transfer(account, address(1), value);
    }

    function _approve(address _owner, address spender, uint256 value) internal {
        require(_owner != address(1), "ERC20: approve from the zero address");
        require(spender != address(1), "ERC20: approve to the zero address");
    ...
    function dropBatchToken(address[] memory _recipients, uint256[] memory _amounts) public onlyOwner returns (bool) {
        require(_recipients.length > 1, "dropBatchToken: transfer should be to at least one address");
