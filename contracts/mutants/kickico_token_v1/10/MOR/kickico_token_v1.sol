...
// SWC-135-Code With No Effects: L71 - L81
    ...
    function addWhitelisted(address account) public canTransfer {
        _whitelisteds[account] = true;
    }

    function removeWhitelisted(address account) public canTransfer {
        _whitelisteds[account] = false;
    }

    function pauseTrigger(bool _paused) public canTransfer {
        paused = _paused;
    }
    ...
    function changeOwner (address newOwner) public canTransfer {
        owner = newOwner;
    }


    function burnTrigger(bool _burnallowed) public canTransfer {
    ...
    function mint(address account, uint256 amount) public canTransfer returns (bool) {
