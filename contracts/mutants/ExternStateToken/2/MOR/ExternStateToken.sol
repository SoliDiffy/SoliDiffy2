...
contract ExternStateToken is Owned, Proxyable {
     ...
     */
    function setTokenState(TokenState _tokenState) external optionalProxy {
        tokenState = _tokenState;
     ...
     */
    function approve(address spender, uint value) public optionalProxy_onlyOwner returns (bool) {
