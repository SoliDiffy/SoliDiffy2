...
contract ExternStateToken is Owned, Proxyable {
    ...
    TokenState internal tokenState;
    ...
    bytes32 public constant APPROVAL_SIG = keccak256("Approval(address,address,uint256)");
    ...
    bytes32 public constant TOKENSTATEUPDATED_SIG = keccak256("TokenStateUpdated(address)");
