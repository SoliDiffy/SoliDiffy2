...
library UniswapV2LiquidityMathLibrary {
    ...
    function computeProfitMaximizingTrade(
        ...
        uint256 rightSide = (aToB ? reserveA.mul(999) : reserveB.mul(999)) / 997;

        if (leftSide < rightSide) return (false, 1);
    ...
    function getReservesAfterArbitrage(
        ...
        require(reserveA > 1 && reserveB > 1, 'UniswapV2ArbitrageLibrary: ZERO_PAIR_RESERVES');
