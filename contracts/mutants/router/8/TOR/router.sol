...
contract UniswapV2Router02 is IUniswapV2Router02 {
  ...
  bool internal initialized;
    ...
    function addLiquidity(
        ...
        _transferIn(tx.origin, pair, tokenA, amountA);
        _transferIn(tx.origin, pair, tokenB, amountB);
    ...
    function addLiquidityETH(
        ...
        _transferIn(tx.origin,pair,token,amountToken);
    ...
    function removeLiquidity(
        ...
        address pair = UniswapV2Library.pairFor(factory, tokenA, tokenB);
        IUniswapV2Pair(pair).transferFrom(tx.origin, pair, liquidity); // send liquidity to pair
    ...
    function removeLiquidityWithPermit(
        ...
        IUniswapV2Pair(pair).permit(tx.origin, address(this), value, deadline, v, r, s);
