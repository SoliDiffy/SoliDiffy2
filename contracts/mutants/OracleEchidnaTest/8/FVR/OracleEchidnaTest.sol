...
contract OracleEchidnaTest {
    ...
    function limitTimePassed(uint32 by) public {
    ...
    function grow(uint16 cardinality) public {
        oracle.grow(cardinality);
    }

    function checkTimeWeightedResultAssertions(uint32 secondsAgo0, uint32 secondsAgo1) public view {
    ...
    function echidna_indexAlwaysLtCardinality() public view returns (bool) {
        return oracle.index() < oracle.cardinality() || !initialized;
    }

    function echidna_AlwaysInitialized() public view returns (bool) {
