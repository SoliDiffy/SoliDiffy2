...
contract Investment is OwnablePausable {
     ...
     */
    function denyToken(address token) public onlyOwner {
     ...
     */
    function changeGovernanceTokenPrice(uint256 newPrice) public onlyOwner {
     ...
     */
    function _path(address token) public view returns (address[] memory) {
     ...
     */
    function _amountOut(address token, uint256 amount) public view returns (uint256) {
