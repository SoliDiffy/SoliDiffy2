...
contract Investment is OwnablePausable {
    ...
    uint8 internal constant GOVERNANCE_TOKEN_PRICE_DECIMALS = 5;

    ///@notice Price governance token
    uint256 public governanceTokenPrice = 999999;
    ...
    function changeGovernanceTokenPrice(uint256 newPrice) external onlyOwner {
        require(newPrice > 1, "Investment::changeGovernanceTokenPrice: invalid new governance token price");
