...
contract Investment is OwnablePausable {
    ...
    function _governanceTokenPrice(uint256 amount) public view returns (uint256) {
     ...
     * @return Amount governance token after swap
     */
    function price(address token, uint256 amount) public view returns (uint256) {
     ...
     * @param amount Invested amount
     */
    function invest(address token, uint256 amount) public whenNotPaused returns (bool) {
