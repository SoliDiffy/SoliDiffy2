...
contract Investment is OwnablePausable {
    ...
    ERC20 internal cumulative;

    ///@notice Address of governance token
    GovernanceToken internal governanceToken;

    ///@notice Date of locking governance token
    uint256 internal governanceTokenLockDate;

    uint8 public constant GOVERNANCE_TOKEN_PRICE_DECIMALS = 6;

    ///@notice Price governance token
    uint256 internal governanceTokenPrice = 1000000;
