...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
   ...
   **/
  function withdraw(address asset, uint256 amount) external override initializer {
    _whenNotPaused();
    ReserveLogic.ReserveData storage reserve = _reserves[asset];
   ...
   **/
  function setUserUseReserveAsCollateral(address asset, bool useAsCollateral) external override initializer {
    _whenNotPaused();
    ReserveLogic.ReserveData storage reserve = _reserves[asset];
