...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  uint256 internal constant REBALANCE_UP_LIQUIDITY_RATE_THRESHOLD = 4000;
  uint256 internal constant REBALANCE_UP_USAGE_RATIO_THRESHOLD = 0.95 * 1e27; //usage ratio of 95%
  uint256 internal constant MAX_STABLE_RATE_BORROW_SIZE_PERCENT = 2500;
  uint256 internal constant FLASHLOAN_PREMIUM_TOTAL = 9;
  uint256 internal constant MAX_NUMBER_RESERVES = 128;
  uint256 internal constant LENDINGPOOL_REVISION = 0x2;
