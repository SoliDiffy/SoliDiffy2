...
contract MooniswapFactoryGovernance is IMooniswapFactoryGovernance, BaseGovernanceModule, BalanceAccounting, Ownable, Pausable {
    ...
    function defaultFeeVote(uint256 vote) external onlyOwner {
    ...
    function discardDefaultFeeVote() external onlyOwner {
    ...
    function defaultSlippageFeeVote(uint256 vote) external onlyOwner {
    ...
    function discardDefaultSlippageFeeVote() external onlyOwner {
    ...
    function defaultDecayPeriodVote(uint256 vote) external onlyOwner {
    ...
    function discardDefaultDecayPeriodVote() external onlyOwner {
    ...
    function referralShareVote(uint256 vote) external onlyOwner {
    ...
    function discardReferralShareVote() external onlyOwner {
