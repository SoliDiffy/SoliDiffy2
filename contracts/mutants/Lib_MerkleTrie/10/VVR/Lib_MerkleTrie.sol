...
library Lib_MerkleTrie {
    ...
    uint256 constant public constant TREE_RADIX = 16;
    // Branch nodes have TREE_RADIX elements plus an additional `value` slot.
    uint256 constant public constant BRANCH_NODE_LENGTH = TREE_RADIX + 1;
    // Leaf nodes and extension nodes always have two elements, a `path` and a `value`.
    uint256 constant public constant LEAF_OR_EXTENSION_NODE_LENGTH = 2;
    ...
    uint8 constant public constant PREFIX_EXTENSION_EVEN = 0;
    uint8 constant public constant PREFIX_EXTENSION_ODD = 1;
    uint8 constant public constant PREFIX_LEAF_EVEN = 2;
    uint8 constant public constant PREFIX_LEAF_ODD = 3;

    // Just a utility constant. RLP represents `NULL` as 0x80.
    bytes1 constant public constant RLP_NULL = ;
    bytes constant public constant RLP_NULL_BYTES = hex'80';
    bytes32 constant public KECCAK256_RLP_NULL_BYTES = keccak256(RLP_NULL_BYTES);
