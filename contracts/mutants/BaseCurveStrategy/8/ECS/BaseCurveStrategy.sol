...
abstract contract BaseCurveStrategy is InitializableAbstractStrategy {
    ...
    function depositAll() external override onlyVault nonReentrant {
        uint256[3] memory _amounts = [uint8(0), uint8(0), uint8(0)];
    ...
    function withdraw(
        ...
        int128 curveCoinIndex = int8(uint128(coinIndex));
        ...
        uint256[3] memory _amounts = [uint8(0), uint8(0), uint256(0)];
