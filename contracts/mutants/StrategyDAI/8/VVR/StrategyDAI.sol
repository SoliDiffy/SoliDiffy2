...
contract StrategyDAI3pool is BaseStrategy {
    ...
    address constant internal _3pool = address(0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7);
    address constant internal _3crv = address(0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490);
    address constant internal y3crv = address(0x9cA85572E6A3EbF24dEDd195623F188735A5179f);

    uint256 constant internal DENOMINATOR = 10000;
    uint256 internal threshold;
    uint256 internal slip;
    uint256 internal tank;
    uint256 internal p;
