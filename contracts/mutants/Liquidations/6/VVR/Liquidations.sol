...
contract Liquidations is Owned, MixinSystemSettings, ILiquidations {
    ...
    bytes32 public constant CONTRACT_ETERNALSTORAGE_LIQUIDATIONS = "EternalStorageLiquidations";
    ...
    // Storage keys
    bytes32 internal constant LIQUIDATION_DEADLINE = "LiquidationDeadline";
