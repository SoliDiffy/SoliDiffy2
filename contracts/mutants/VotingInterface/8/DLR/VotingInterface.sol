...
abstract contract VotingInterface {
    ...
    function getPendingRequests()
        ...
        view
        virtual
        returns (VotingAncillaryInterface.PendingRequestAncillary[] storage);
    ...
    function retrieveRewards(
        ...
        uint256 roundId,
        PendingRequest[] storage toRetrieve
    ) public virtual returns (FixedPoint.Unsigned storage);
     ...
     */
    function setInflationRate(FixedPoint.Unsigned storage newInflationRate) public virtual;
     ...
     */
    function setGatPercentage(FixedPoint.Unsigned storage newGatPercentage) public virtual;
