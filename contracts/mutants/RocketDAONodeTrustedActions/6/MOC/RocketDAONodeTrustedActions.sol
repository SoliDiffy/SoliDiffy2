...
contract RocketDAONodeTrustedActions is RocketBase, RocketDAONodeTrustedActionsInterface {
    ...
    function actionJoin() override external onlyLatestContract("rocketDAONodeTrustedActions", address(this)) onlyRegisteredNode(msg.sender) {
    ...
    function actionJoinRequired(address _nodeAddress) override external onlyLatestContract("rocketDAONodeTrusted", msg.sender) onlyRegisteredNode(_nodeAddress) {
    ...
    function actionLeave(address _rplBondRefundAddress) override external onlyLatestContract("rocketDAONodeTrustedActions", address(this)) onlyTrustedNode(msg.sender) {
        // Load contracts
    ...
    function actionKick(address _nodeAddress, uint256 _rplFine) override external onlyLatestContract("rocketDAONodeTrustedProposals", msg.sender) onlyTrustedNode(_nodeAddress) {
        // Load contracts
        RocketVaultInterface rocketVault = RocketVaultInterface(getContractAddress("rocketVault"));
        RocketDAONodeTrustedInterface rocketDAONode = RocketDAONodeTrustedInterface(getContractAddress("rocketDAONodeTrusted"));
    ...
    function actionChallengeMake(address _nodeAddress) override external onlyTrustedNode(_nodeAddress) onlyLatestContract("rocketDAONodeTrustedActions", address(this)) onlyRegisteredNode(msg.sender) payable {
        // Load contracts
        RocketDAONodeTrustedInterface rocketDAONode = RocketDAONodeTrustedInterface(getContractAddress("rocketDAONodeTrusted"));
        RocketDAONodeTrustedSettingsMembersInterface rocketDAONodeTrustedSettingsMembers = RocketDAONodeTrustedSettingsMembersInterface(getContractAddress("rocketDAONodeTrustedSettingsMembers"));
    ...
    function actionChallengeDecide(address _nodeAddress) override external onlyTrustedNode(_nodeAddress) onlyLatestContract("rocketDAONodeTrustedActions", address(this)) onlyRegisteredNode(msg.sender) {
        // Load contracts
        RocketDAONodeTrustedSettingsMembersInterface rocketDAONodeTrustedSettingsMembers = RocketDAONodeTrustedSettingsMembersInterface(getContractAddress("rocketDAONodeTrustedSettingsMembers"));
