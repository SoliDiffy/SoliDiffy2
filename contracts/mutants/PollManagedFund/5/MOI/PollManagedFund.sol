...
contract PollManagedFund is Fund, DateTime, ITokenEventListener {
    ...
    function canWithdraw() public onlyOwner returns(bool) {
        if(
     ...
     */
    function onTokenTransfer(address _from, address /*_to*/, uint256 _value) public onlyOwner {
     ...
     */
    function updateMinVotedTokens(uint256 _minVotedTokensPerc) internal onlyOwner {
    ...
    function onTapPollFinish(bool agree, uint256 _tap) external onlyOwner {
    ...
    function onRefundPollFinish(bool agree) external onlyOwner {
