...
contract PollManagedFund is Fund, DateTime, ITokenEventListener {
    uint256 internal constant TAP_POLL_DURATION = 3 days;
    uint256 internal constant REFUND_POLL_DURATION = 7 days;
    uint256 internal constant MAX_VOTED_TOKEN_PERC = 10;

    TapPoll internal tapPoll;
    RefundPoll internal refundPoll;

    uint256 internal minVotedTokensPerc = 0;
    uint256 internal secondRefundPollDate = 0;
    bool internal isWithdrawEnabled = true;
