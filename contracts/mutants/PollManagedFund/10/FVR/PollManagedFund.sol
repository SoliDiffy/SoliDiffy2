...
contract PollManagedFund is Fund, DateTime, ITokenEventListener {
     ...
     */
    function updateMinVotedTokens(uint256 _minVotedTokensPerc) public {
    ...
    // Tap poll
    function createTapPoll(uint8 tapIncPerc) external onlyOwner {
    ...
    function onTapPollFinish(bool agree, uint256 _tap) public {
    ...
    // Refund poll
    function checkRefundPollDate() public view returns(bool) {
    ...
    function createRefundPoll() external onlyTokenHolder {
        require(state == FundState.TeamWithdraw);
    ...
    function onRefundPollFinish(bool agree) public {
