...
contract MainStorage is ProxyStorage {
    uint256 public constant LAYOUT_LENGTH = 2**64;

    address public escapeVerifierAddress; // NOLINT: constable-states.

    // Global dex-frozen flag.
    bool public stateFrozen; // NOLINT: constable-states.

    // Time when unFreeze can be successfully called (UNFREEZE_DELAY after freeze).
    uint256 public unFreezeTime; // NOLINT: constable-states.
    ...
    uint256 public escapesUsedCount; // NOLINT: constable-states.
    ...
    uint256 public sequenceNumber; // NOLINT: constable-states uninitialized-state.

    // Validium Vaults Tree Root & Height.
    uint256 public validiumVaultRoot; // NOLINT: constable-states uninitialized-state.
    uint256 public validiumTreeHeight; // NOLINT: constable-states uninitialized-state.

    // Order Tree Root & Height.
    uint256 public orderRoot; // NOLINT: constable-states uninitialized-state.
    uint256 public orderTreeHeight; // NOLINT: constable-states uninitialized-state.
