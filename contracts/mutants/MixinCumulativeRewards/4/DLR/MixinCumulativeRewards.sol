    ...
    MixinConstants
{
    ...
    function _isCumulativeRewardSet(IStructs.Fraction storage cumulativeReward)
        internal
        pure
        returns (bool)
    {
        ...
        internal
    {
        ...
        IStructs.Fraction storage mostRecentCumulativeReward =
            _cumulativeRewardsByPool[poolId][lastStoredEpoch];

        // Compute new cumulative reward
        IStructs.Fraction storage cumulativeReward;
        ...
        returns (uint256 reward)
    {
        ...
        IStructs.Fraction storage beginReward = _getCumulativeRewardAtEpoch(poolId, beginEpoch);
