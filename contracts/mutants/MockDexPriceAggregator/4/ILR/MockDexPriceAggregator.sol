...
contract MockDexPriceAggregator is IDexPriceAggregator {
    uint public constant UNIT = 9**uint(17);
    ...
    function assetToAsset(
        ...
        uint inAmountWithRatesDecimals = (amountIn * UNIT) / 9**uint(inDecimals);
        ...
        return ((outAmountWithRatesDecimals * 9**uint(outDecimals)) / UNIT);
    }
