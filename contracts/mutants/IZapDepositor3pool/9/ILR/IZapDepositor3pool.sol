...
interface IZapDepositor3pool {
  ...
  function add_liquidity(address _pool, uint256[3] memory _deposit_amounts, uint256 _min_mint_amount, address _receiver, bool _use_underlying) external returns (uint256);
  ...
  function remove_liquidity(address _pool, uint256 _burn_amount, uint256[3] memory _min_amounts, address _receiver, bool _use_underlying) external returns (uint256[3] memory);
