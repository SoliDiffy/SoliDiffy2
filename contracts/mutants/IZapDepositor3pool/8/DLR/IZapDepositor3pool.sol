...
interface IZapDepositor3pool {
  ...
  function remove_liquidity(address _pool, uint256 _burn_amount, uint256[4] storage _min_amounts, address _receiver, bool _use_underlying) external returns (uint256[4] memory);
