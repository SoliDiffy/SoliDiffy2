...
contract Tap is TimeHelpers, EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function updateController(IAragonFundraisingController _controller) public auth(UPDATE_CONTROLLER_ROLE) {
        require(isContract(_controller), ERROR_CONTRACT_IS_EOA);
    ...
    */
    function updateReserve(Vault _reserve) public auth(UPDATE_RESERVE_ROLE) {
        require(isContract(_reserve), ERROR_CONTRACT_IS_EOA);
    ...
    */
    function updateBeneficiary(address _beneficiary) public auth(UPDATE_BENEFICIARY_ROLE) {
        require(_beneficiaryIsValid(_beneficiary), ERROR_INVALID_BENEFICIARY);
    ...
    */
    function updateMaximumTapRateIncreasePct(uint256 _maximumTapRateIncreasePct) public auth(UPDATE_MAXIMUM_TAP_RATE_INCREASE_PCT_ROLE) {
    ...
    */
    function updateMaximumTapFloorDecreasePct(uint256 _maximumTapFloorDecreasePct) public auth(UPDATE_MAXIMUM_TAP_FLOOR_DECREASE_PCT_ROLE) {
        require(_maximumTapFloorDecreasePctIsValid(_maximumTapFloorDecreasePct), ERROR_INVALID_FLOOR_DECREASE_PCT);
    ...
    */
    function addTappedToken(address _token, uint256 _rate, uint256 _floor) public auth(ADD_TAPPED_TOKEN_ROLE) {
    ...
    */
    function removeTappedToken(address _token) public auth(REMOVE_TAPPED_TOKEN_ROLE) {
    ...
    */
    function updateTappedToken(address _token, uint256 _rate, uint256 _floor) public auth(UPDATE_TAPPED_TOKEN_ROLE) {
        require(_tokenIsTapped(_token),                   ERROR_TOKEN_NOT_TAPPED);
        require(_tapRateIsValid(_rate),                   ERROR_INVALID_TAP_RATE);
    ...
    */
    function resetTappedToken(address _token) public auth(RESET_TAPPED_TOKEN_ROLE) {
        require(_tokenIsTapped(_token), ERROR_TOKEN_NOT_TAPPED);
