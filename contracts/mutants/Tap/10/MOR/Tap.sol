...
contract Tap is TimeHelpers, EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function updateController(IAragonFundraisingController _controller) external onlyInit {
        require(isContract(_controller), ERROR_CONTRACT_IS_EOA);
    ...
    */
    function updateReserve(Vault _reserve) external onlyInit {
        require(isContract(_reserve), ERROR_CONTRACT_IS_EOA);
    ...
    */
    function updateBeneficiary(address _beneficiary) external onlyInit {
        require(_beneficiaryIsValid(_beneficiary), ERROR_INVALID_BENEFICIARY);
    ...
    */
    function updateMaximumTapRateIncreasePct(uint256 _maximumTapRateIncreasePct) external onlyInit {
    ...
    */
    function updateMaximumTapFloorDecreasePct(uint256 _maximumTapFloorDecreasePct) external onlyInit {
        require(_maximumTapFloorDecreasePctIsValid(_maximumTapFloorDecreasePct), ERROR_INVALID_FLOOR_DECREASE_PCT);
    ...
    */
    function addTappedToken(address _token, uint256 _rate, uint256 _floor) external onlyInit {
    ...
    */
    function removeTappedToken(address _token) external onlyInit {
    ...
    */
    function updateTappedToken(address _token, uint256 _rate, uint256 _floor) external onlyInit {
        require(_tokenIsTapped(_token),                   ERROR_TOKEN_NOT_TAPPED);
        require(_tapRateIsValid(_rate),                   ERROR_INVALID_TAP_RATE);
    ...
    */
    function resetTappedToken(address _token) external onlyInit {
        require(_tokenIsTapped(_token), ERROR_TOKEN_NOT_TAPPED);
