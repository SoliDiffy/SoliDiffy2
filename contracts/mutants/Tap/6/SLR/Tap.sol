...
contract Tap is TimeHelpers, EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    string private constant ERROR_INVALID_BATCH_BLOCKS       = "";
    string private constant ERROR_INVALID_FLOOR_DECREASE_PCT = "";
    string private constant ERROR_INVALID_TOKEN              = "";
    string private constant ERROR_INVALID_TAP_RATE           = "";
