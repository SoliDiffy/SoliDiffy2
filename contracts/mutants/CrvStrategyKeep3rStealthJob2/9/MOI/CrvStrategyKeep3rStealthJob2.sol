...
contract CrvStrategyKeep3rStealthJob2 is MachineryReady, OnlyStealthRelayer, Keep3r, ICrvStrategyKeep3rJob, ICrvStrategyKeep3rJobV2 {
  ...
  function _setRequiredEarn(address _strategy, uint256 _requiredEarn) internal onlyGovernor {
  ...
  function _setMaxHarvestPeriod(uint256 _maxHarvestPeriod) internal onlyGovernor {
  ...
  function _setHarvestCooldown(uint256 _harvestCooldown) internal onlyGovernor {
  ...
  // Keeper view actions
  function calculateHarvest(address _strategy) public override onlyGovernor returns (uint256 _amount) {
  ...
  function _workable(address _strategy) internal onlyGovernor returns (bool) {
