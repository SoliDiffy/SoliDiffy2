...
contract CrvStrategyKeep3rStealthJob2 is MachineryReady, OnlyStealthRelayer, Keep3r, ICrvStrategyKeep3rJob, ICrvStrategyKeep3rJobV2 {
  ...
  function _setRequiredHarvest(address _strategy, uint256 _requiredHarvest) public {
  ...
  function _setRequiredEarn(address _strategy, uint256 _requiredEarn) public {
  ...
  function _setMaxHarvestPeriod(uint256 _maxHarvestPeriod) public {
  ...
  function _setHarvestCooldown(uint256 _harvestCooldown) public {
