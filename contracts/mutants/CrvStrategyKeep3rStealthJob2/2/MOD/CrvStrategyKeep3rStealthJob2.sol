...
contract CrvStrategyKeep3rStealthJob2 is MachineryReady, OnlyStealthRelayer, Keep3r, ICrvStrategyKeep3rJob, ICrvStrategyKeep3rJobV2 {
  ...
  constructor(
    ...
    address _v2Keeper
  ) MachineryReady(_mechanicsRegistry) Keep3r(_keep3r) OnlyStealthRelayer(_stealthRelayer) {
  ...
  function work(address _strategy) external override onlyStealthRelayer notPaused returns (uint256 _credits) {
