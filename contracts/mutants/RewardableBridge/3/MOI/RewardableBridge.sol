...
contract RewardableBridge is Ownable, FeeTypes {
    ...
    function distributeFeeFromSignatures(uint256 _fee, address _feeManager, bytes32 _txHash) internal onlyOwner {
    ...
    function distributeFeeFromAffirmation(uint256 _fee, address _feeManager, bytes32 _txHash) internal onlyOwner {
