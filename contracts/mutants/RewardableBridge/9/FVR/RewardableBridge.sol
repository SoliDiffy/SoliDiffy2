...
contract RewardableBridge is Ownable, FeeTypes {
    ...
    function _setFee(address _feeManager, uint256 _fee, bytes32 _feeType) public {
    ...
    function calculateFee(uint256 _value, bool _recover, address _impl, bytes32 _feeType) public view returns(uint256) {
        uint256 fee;
    ...
    function distributeFeeFromSignatures(uint256 _fee, address _feeManager, bytes32 _txHash) public {
    ...
    function distributeFeeFromAffirmation(uint256 _fee, address _feeManager, bytes32 _txHash) public {
