...
contract BabySwapFee is Ownable {
    ...
    address internal constant hole = 0x000000000000000000000000000000000000dEaD;
    address internal immutable bottle;
    address internal immutable vault;
    IBabyRouter internal immutable router;
    IBabyFactory internal immutable factory;
    address internal immutable WBNB;
    address internal immutable BABY;
