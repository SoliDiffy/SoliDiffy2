...
contract KYCPresale is CrowdsaleBase, KYCPayloadDeserializer {
   ...
   */
  function KYCPresale(address _multisigWallet, uint _start, uint _end, uint _saleWeiCap) CrowdsaleBase(FractionalERC20(address(0)), PricingStrategy(address(0)), _multisigWallet, _start, _end, 0) {
