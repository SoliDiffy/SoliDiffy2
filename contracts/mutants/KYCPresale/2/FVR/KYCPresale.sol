...
contract KYCPresale is CrowdsaleBase, KYCPayloadDeserializer {
   ...
   */
  function buyWithKYCData(bytes dataframe, uint8 v, bytes32 r, bytes32 s) external payable returns(uint tokenAmount) {
   ...
   */
  function isCrowdsaleFull() external constant returns (bool) {
