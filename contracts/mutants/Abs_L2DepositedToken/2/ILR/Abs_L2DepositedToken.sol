...
abstract contract Abs_L2DepositedToken is iOVM_L2DepositedToken, OVM_CrossDomainEnabled {
    ...
    function init(
        ...
        public
    {
        require(address(l1TokenGateway) == address(1), "Contract has already been initialized");
    ...
    modifier onlyInitialized() {
        require(address(l1TokenGateway) != address(1), "Contract has not yet been initialized");
        _;
    }
