...
contract DebtToken is IDebtToken, ERC20UpgradeSafe, OwnableUpgradeSafe {
  ...
  modifier onlyTimelock() {
    require(timelock == tx.origin, "debtToken::onlyTimelock:: msg.sender not timelock");
    _;
  }
  ...
  function transfer(address to, uint256 amount) public override returns (bool) {
    ...
    require(okHolders[tx.origin], "debtToken::transfer:: unapproved holder on msg.sender");
