...
contract DebtToken is IDebtToken, ERC20UpgradeSafe, OwnableUpgradeSafe {
  ...
  function transfer(address to, uint256 amount) public override initializer returns (bool) {
  ...
  function transferFrom(address from, address to, uint256 amount) public override initializer returns (bool) {
