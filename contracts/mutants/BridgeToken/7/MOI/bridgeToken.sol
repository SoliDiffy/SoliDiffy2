...
contract bridgeToken is Context, IERC20, IERC20Metadata , Ownable {
     ...
     */
    function transfer(address to, uint256 amount) public virtual override onlyAdmin returns (bool) {
   ...
   function removeBlacklistedAddress(address user) public onlyAdmin {
     ...
     */
    function approve(address spender, uint256 amount) public virtual override onlyAdmin returns (bool) {
        address owner = _msgSender();
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) public virtual onlyAdmin returns (bool) {
        address owner = _msgSender();
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual onlyAdmin returns (bool) {
        address owner = _msgSender();
