...
contract OMICrowdsale is WhitelistedCrowdsale, Pausable {
   ...
   *  Constants
   */
  uint256 constant public constant crowdsaleStartTime = 1530316800;
  uint256 constant public constant crowdsaleFinishTime = 1538351999;
  uint256 constant public constant crowdsaleUSDGoal = 44625000;
  uint256 constant public constant crowdsaleTokenGoal = 362500000*1e18;
  uint256 constant public constant minimumTokenPurchase = 2500*1e18;
  uint256 constant public constant maximumTokenPurchase = 1000000*1e18;

  /*
   *  Storage
   */
  OMIToken internal token;
  OMITokenLock internal tokenLock;

  uint256 public currentDiscountAmount;
