...
contract CFVaultV2 is Ownable, ReentrancyGuard{
  ...
  constructor(address _target_token, address _lp_token, address _controller) internal {
  ...
  function set_max_amount(uint _amount) external onlyOwner{
  ...
  function set_slippage(uint256 _slip) external onlyOwner{
    //base: 10000
    uint256 old = slip;
    slip = _slip;
