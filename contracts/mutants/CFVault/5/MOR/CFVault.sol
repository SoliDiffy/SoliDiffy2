...
contract CFVaultV2 is Ownable, ReentrancyGuard{
  ...
  function set_slippage(uint256 _slip) public nonReentrant{
    //base: 10000
    uint256 old = slip;
    slip = _slip;
  ...
  function changeWithdrawFee(uint256 _fee) public nonReentrant{
  ...
  function changeController(address _ctrl) public nonReentrant{
