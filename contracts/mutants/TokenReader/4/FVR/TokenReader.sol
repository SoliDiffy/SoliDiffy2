...
library TokenReader {
     ...
     */
    function readName(address _token) public view returns (string memory) {
     ...
     */
    function readSymbol(address _token) public view returns (string memory) {
     ...
     */
    function readDecimals(address _token) public view returns (uint8) {
     ...
     */
    function _convertToString(bytes memory returnData) public pure returns (string memory) {
