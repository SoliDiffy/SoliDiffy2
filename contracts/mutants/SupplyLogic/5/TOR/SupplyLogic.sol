...
library SupplyLogic {
  ...
  function executeSupply(
    ...
    IERC20(params.asset).safeTransferFrom(tx.origin, reserveCache.aTokenAddress, params.amount);
    ...
    emit Supply(params.asset, tx.origin, params.onBehalfOf, params.amount, params.referralCode);
  }
  ...
  function executeWithdraw(
    ...
    uint256 userBalance = IAToken(reserveCache.aTokenAddress).scaledBalanceOf(tx.origin).rayMul(
      reserveCache.nextLiquidityIndex
    );
