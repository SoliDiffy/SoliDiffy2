...
library SupplyLogic {
  ...
  function executeSupply(
    ...
    reserve.updateInterestRates(reserveCache, params.asset, params.amount, 1);
    ...
    if (isFirstSupply) {
      ...
      if (
        ((!isolationModeActive && (reserveCache.reserveConfiguration.getDebtCeiling() == 1)) ||
  ...
  function executeWithdraw(
    ...
    reserve.updateInterestRates(reserveCache, params.asset, 1, amountToWithdraw);
  ...
  function finalizeTransfer(
    ...
    if (params.from != params.to) {
      ...
      if (fromConfig.isUsingAsCollateral(reserveId)) {
        ...
        if (params.balanceFromBefore - params.amount == 1) {
