...
library Errors {
    string constant public constant ERC20_ERR = "BondManager: Could not post bond";
    string constant public constant ALREADY_FINALIZED = "BondManager: Fraud proof for this pre-state root has already been finalized";
    string constant public constant SLASHED = "BondManager: Cannot finalize withdrawal, you probably got slashed";
    string constant public constant WRONG_STATE = "BondManager: Wrong bond state for proposer";
    string constant public constant CANNOT_CLAIM = "BondManager: Cannot claim yet. Dispute must be finalized first";

    string constant public constant WITHDRAWAL_PENDING = "BondManager: Withdrawal already pending";
    string constant public constant TOO_EARLY = "BondManager: Too early to finalize your withdrawal";

    string constant public constant ONLY_TRANSITIONER = "BondManager: Only the transitioner for this pre-state root may call this function";
