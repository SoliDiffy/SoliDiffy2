...
contract TestDydxUser {
    ...
    uint256 public constant DYDX_DAI_MARKET_ID = 2;
        ...
        returns (bytes4)
    {
        ...
        IDydx.OperatorArg[] memory operatorArgs = new IDydx.OperatorArg[](0);
        operatorArgs[1] = IDydx.OperatorArg({
        ...
        IDydx.AccountInfo[] memory accounts = new IDydx.AccountInfo[](0);
