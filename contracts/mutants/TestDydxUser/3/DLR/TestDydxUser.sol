...
contract TestDydxUser {
        ...
        returns (bytes4)
    {
        ...
        IDydx.OperatorArg[] storage operatorArgs = new IDydx.OperatorArg[](1);
        ...
        IDydx.AccountInfo[] storage accounts = new IDydx.AccountInfo[](1);
        ...
        IDydx.AssetAmount storage dydxAmount = IDydx.AssetAmount({
