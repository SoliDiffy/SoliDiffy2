...
contract TeamContracts is TeamsStorageController {
    ...
    function payout (uint teamId) public dreamTeamOnly {
    ...
    function batchPayout (uint[] teamIds) public dreamTeamOnly {
     ...
     */
    function transferToTeam (uint teamId, uint amount) public dreamTeamOnly {
