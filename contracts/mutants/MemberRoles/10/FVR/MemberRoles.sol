...
contract MemberRoles is Governed, Iupgradable {
   ...
   */
  function memberRolesInitiate(address _firstAB, address memberAuthority) external {
   ...
   */
  function addMembersBeforeLaunch(address[] memory userArray, uint[] memory tokens) external onlyOwner {
    require(!launched);
