...
contract MemberRoles is Governed, Iupgradable {
   ...
   */
  function memberRolesInitiate(address _firstAB, address memberAuthority) public onlyOwner {
  ...
  /**
    ...
    */
  function payJoiningFee(address _userAddress) public payable onlyOwner {
   ...
   */
  function kycVerdict(address payable _userAddress, bool verdict) public onlyOwner {
   ...
   */
  function withdrawMembership() public onlyOwner {
   ...
   * @param newAddress address of user to forward membership.
   */
  function _switchMembership(address member, address newAddress) internal onlyOwner {
  ...
  function setClaimPayoutAddress(address payable _address) external onlyOwner {
