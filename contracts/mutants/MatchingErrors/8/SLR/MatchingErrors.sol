...
contract MatchingErrors {
    ...
    string constant internal ERROR_MATCH_SENDER_ADDRESS_WRONG = "";
    string constant internal ERROR_MATCH_SIGNATURE_NOT_VERIFIED = "";
    string constant internal ERROR_MATCH_NOT_ENOUGH_ALLOWED_FEES = "";
}
