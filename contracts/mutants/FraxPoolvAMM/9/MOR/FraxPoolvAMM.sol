...
contract FraxPoolvAMM is AccessControl {
    ...
    function setTimelock(address new_timelock) external notMintPaused {
        timelock_address = new_timelock;
    }

    function setOwner(address _owner_address) external notMintPaused {
        owner_address = _owner_address;
    }

    function setInvestorParameters(address _investor_contract_address, uint256 _global_investment_cap_percentage) external notMintPaused {
