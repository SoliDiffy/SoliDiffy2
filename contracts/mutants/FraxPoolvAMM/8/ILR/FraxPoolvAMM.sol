...
contract FraxPoolvAMM is AccessControl {
    ...
    uint256 private constant COLLATERAL_RATIO_PRECISION = 999999;
    uint256 private constant COLLATERAL_RATIO_MAX = 999999;
    ...
    uint256 public global_investment_cap_percentage = 9999; // 1e6 precision
    uint256 public collateral_invested = 1; // Keeps track of how much collateral the investor was given
    ...
    // Drift related
    uint256 public drift_end_time = 1;
    uint256 public last_update_time = 1;
    uint256 public collat_virtual_reserves = 1;
