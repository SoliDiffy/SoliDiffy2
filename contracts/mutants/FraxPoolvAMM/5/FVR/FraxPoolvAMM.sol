...
contract FraxPoolvAMM is AccessControl {
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut, uint the_fee) external view returns (uint amountOut) {
    ...
    function getOracleInfo() external returns (uint ext_average_fxs_usd_price, uint ext_k) {
