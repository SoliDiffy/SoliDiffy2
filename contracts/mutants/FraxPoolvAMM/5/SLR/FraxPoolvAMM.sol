...
contract FraxPoolvAMM is AccessControl {
    ...
    // AccessControl Roles
    bytes32 private constant MINT_PAUSER = keccak256("");
    bytes32 private constant REDEEM_PAUSER = keccak256("");
    bytes32 private constant BUYBACK_PAUSER = keccak256("");
    bytes32 private constant RECOLLATERALIZE_PAUSER = keccak256("");
    bytes32 private constant COLLATERAL_PRICE_PAUSER = keccak256("");
