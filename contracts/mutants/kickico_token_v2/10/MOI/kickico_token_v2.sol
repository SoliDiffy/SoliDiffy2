...
contract KickToken is AccountFrozenBalances {
    ...
    function approveAndCall(address _spender, uint256 _value, bytes memory _extraData) public onlyOwner returns (bool) {
    ...
    function _approve(address _owner, address spender, uint256 value) internal onlyOwner {
    ...
    function _freeze(address account, uint256 amount) internal onlyOwner {
