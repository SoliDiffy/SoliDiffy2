...
contract KickToken is AccountFrozenBalances {
    ...
    function addWhitelisted(address account) public onlyPendingOwner {
        _whitelisted[account] = true;
    }

    function removeWhitelisted(address account) public onlyPendingOwner {
        _whitelisted[account] = false;
    }

    function pauseTrigger() public onlyPendingOwner {
        paused = !paused;
    }
    ...
    function addToMinters(address account) public onlyPendingOwner {
        _minters[account] = true;
    }

    function removeFromMinters(address account) public onlyPendingOwner {
    ...
    function addToMelters(address account) public onlyPendingOwner {
        _melters[account] = true;
    }

    function removeFromMelters(address account) public onlyPendingOwner {
