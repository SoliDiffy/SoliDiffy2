...
//    SWC-116-Block values as a proxy for time:L76、105、145
     ...
     */
    function cancelOrder(bytes32 _orderId) external whenNotPaused {
     ...
     */
    function cancelExpiredOrders(bytes32[] memory _orderIds) external whenNotPaused {
     ...
     */
    function _cancelOrder(Order storage _order) private whenNotPaused {
     ...
     * @param _orderId Order id
     */
    function _removeOpenOrder(bytes32 _orderId) internal whenNotPaused {
     ...
     * @param _order Order struct object
     */
    function _addOpenOrder(Order storage _order) private whenNotPaused {
