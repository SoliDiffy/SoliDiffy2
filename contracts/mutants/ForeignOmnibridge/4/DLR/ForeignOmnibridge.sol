...
contract ForeignOmnibridge is BasicOmnibridge, GasLimitManager {
    ...
    function bridgeSpecificActionsOnTokenTransfer(
        ...
        bytes storage data = _prepareMessage(nativeTokenAddress(_token), _token, _receiver, _value, _data);
     ...
     */
    function _passMessage(bytes storage _data, bool _useOracleLane) internal override returns (bytes32) {
        (_useOracleLane);
