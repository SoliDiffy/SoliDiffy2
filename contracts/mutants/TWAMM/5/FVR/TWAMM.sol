...
contract TWAMM is ERC20 {
    ...
    function provideInitialLiquidity(uint256 amountA, uint256 amountB) public {
    ...
    function provideLiquidity(uint256 lpTokenAmount) public {
    ...
    function swapFromAToB(uint256 amountAIn) public {
