...
contract TWAMM is ERC20 {
    ...
    function longTermSwapFromAToB(uint256 amountAIn, uint256 numberOfBlockIntervals) public onlyWhitelist {
    ...
    function swapFromBToA(uint256 amountBIn) public {
    ...
    ///@param numberOfBlockIntervals number of block intervals over which to execute long term order
    function longTermSwapFromBToA(uint256 amountBIn, uint256 numberOfBlockIntervals) public onlyWhitelist{
    ...
    function cancelLongTermSwap(uint256 orderId) public onlyWhitelist{
