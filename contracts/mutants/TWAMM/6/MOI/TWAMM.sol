...
contract TWAMM is ERC20 {
    ...
    function disableWhitelist() public onlyWhitelist {
    ...
    function provideInitialLiquidity(uint256 amountA, uint256 amountB) external onlyWhitelist {
    ...
    function provideLiquidity(uint256 lpTokenAmount) external onlyWhitelist {
    ...
    function removeLiquidity(uint256 lpTokenAmount) external onlyWhitelist {
    ...
    function swapFromAToB(uint256 amountAIn) external onlyWhitelist {
    ...
    function swapFromBToA(uint256 amountBIn) external onlyWhitelist {
