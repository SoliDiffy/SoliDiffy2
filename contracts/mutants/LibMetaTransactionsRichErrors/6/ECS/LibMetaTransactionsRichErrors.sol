...
library LibMetaTransactionsRichErrors {
        ...
        returns (bytes memory)
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("InvalidMetaTransactionsArrayLengthsError(uint256,uint256)")),
            mtxCount,
            signatureCount
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("MetaTransactionUnsupportedFunctionError(bytes32,bytes4)")),
            mtxHash,
            selector
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("MetaTransactionWrongSenderError(bytes32,address,address)")),
            mtxHash,
            sender,
            expectedSender
        );
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("MetaTransactionExpiredError(bytes32,uint256,uint256)")),
            mtxHash,
            time,
            expirationTime
        );
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("MetaTransactionGasPriceError(bytes32,uint256,uint256,uint256)")),
            mtxHash,
            gasPrice,
            minGasPrice,
            maxGasPrice
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("MetaTransactionInsufficientEthError(bytes32,uint256,uint256)")),
            mtxHash,
            ethBalance,
            ethRequired
        );
