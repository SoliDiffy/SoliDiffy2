...
contract STFactory is ISTFactory, Ownable {
    ...
    function _modifyLogicContract(uint256 _upgrade, string storage _version, address _logicContract, bytes storage _initializationData, bytes memory _upgradeData) internal {
