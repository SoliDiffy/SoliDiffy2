...
contract STFactory is ISTFactory, Ownable {
     ...
     */
    function setLogicContract(string calldata _version, address _logicContract, bytes calldata _initializationData, bytes calldata _upgradeData) public onlyOwner {
     ...
     * @param _upgradeData Data to be passed in call to upgradeToAndCall when a token upgrades its module
     */
    function updateLogicContract(uint256 _upgrade, string calldata _version, address _logicContract, bytes calldata _initializationData, bytes calldata _upgradeData) public onlyOwner {
    ...
    function _modifyLogicContract(uint256 _upgrade, string memory _version, address _logicContract, bytes memory _initializationData, bytes memory _upgradeData) public {
     ...
     */
    function upgradeToken(uint8 _maxModuleType) public {
     ...
     */
    function updateDefaultTransferManager(address _transferManagerFactory) public onlyOwner {
     ...
     */
    function updateDefaultDataStore(address _dataStoreFactory) public onlyOwner {
        // NB - setting this to address(0) means don't deploy a default TM
