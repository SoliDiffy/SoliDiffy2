...
contract STFactory is ISTFactory, Ownable {
    ...
    function _modifyLogicContract(uint256 _upgrade, string memory _version, address _logicContract, bytes memory _initializationData, bytes memory _upgradeData) internal onlyOwner {
     ...
     */
    function upgradeToken(uint8 _maxModuleType) external onlyOwner {
