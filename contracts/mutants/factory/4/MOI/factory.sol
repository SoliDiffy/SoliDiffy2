...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function initialize(address _token0, address _token1, address _router) external lock {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private lock returns (bool feeOn) {
