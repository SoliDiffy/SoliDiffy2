...
// #############################
    ...
    function initialize(GlobalAddressesProvider _globalAddressesProvider) public onlySIGHFinanceManager {
...
// #################################################
    ...
    function beginDrippingFromSIGHSpeedController() external initializer returns (bool) {
    ...
    // TESTED
    function updateSighVolatilityDistributionSpeedInSIGHSpeedController(uint newSpeed_) external initializer returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
    ...
    // TESTED
    function supportNewProtocolInSIGHSpeedController( address newProtocolAddress, uint sighSpeedRatio ) external initializer returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
    ...
    // TESTED
    function updateProtocolStateInSIGHSpeedController(address protocolAddress_, bool isSupported_, uint newRatio_) external initializer returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
...
// #####################################################
    ...
    function refreshSIGHVolatilityHarvesterConfig() external initializer  {
    ...
    function updateInstrumentConfigVolatilityHarvester(address instrument_,  uint _bearSentiment,uint _bullSentiment, bool _isSIGHMechanismActivated ) external initializer returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
    ...
    function updateSIGHSpeed_VolatilityHarvester(uint newSighSpeed) external initializer returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
    ...
    function updateStakingSpeed_VolatilityHarvester(address instrument_, uint newStakingSpeed) external initializer returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
