...
// #############################
    ...
    function initialize(GlobalAddressesProvider _globalAddressesProvider) external initializer {
...
// #################################################
    ...
    function beginDrippingFromSIGHSpeedController() public onlySIGHFinanceManager returns (bool) {
    ...
    // TESTED
    function updateSighVolatilityDistributionSpeedInSIGHSpeedController(uint newSpeed_) public onlySIGHFinanceManager returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
    ...
    // TESTED
    function supportNewProtocolInSIGHSpeedController( address newProtocolAddress, uint sighSpeedRatio ) public onlySIGHFinanceManager returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
    ...
    // TESTED
    function updateProtocolStateInSIGHSpeedController(address protocolAddress_, bool isSupported_, uint newRatio_) public onlySIGHFinanceManager returns (bool) {
        ISIGHSpeedController sigh_speed_Controller = ISIGHSpeedController( globalAddressesProvider.getSIGHSpeedController() );
...
// #####################################################
    ...
    function refreshSIGHVolatilityHarvesterConfig() public onlySIGHFinanceManager  {
    ...
    function updateInstrumentConfigVolatilityHarvester(address instrument_,  uint _bearSentiment,uint _bullSentiment, bool _isSIGHMechanismActivated ) public onlySIGHFinanceManager returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
    ...
    function updateSIGHSpeed_VolatilityHarvester(uint newSighSpeed) public onlySIGHFinanceManager returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
    ...
    function updateStakingSpeed_VolatilityHarvester(address instrument_, uint newStakingSpeed) public onlySIGHFinanceManager returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
    ...
    function UpdateCryptoMarketSentiment_VolatilityHarvester( uint maxVolatilityProtocolLimit_) public onlySIGHFinanceManager returns (bool) {
        ISIGHVolatilityHarvester sigh_volatility_harvester = ISIGHVolatilityHarvester( globalAddressesProvider.getSIGHVolatilityHarvester() );
