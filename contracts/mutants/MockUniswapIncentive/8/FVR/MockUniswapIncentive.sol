...
contract MockUniswapIncentive is MockIncentive {
    ...
    function updateOracle() public pure returns(bool) {
        return true;
    }

    function setExemptAddress(address account, bool _isExempt) public {}

    function getBuyIncentive(uint amount) public pure returns(uint,        
        uint32 weight,
    ...
    function getSellPenalty(uint amount) public pure returns(uint,    
        Decimal.D256 memory initialDeviation,
        Decimal.D256 memory finalDeviation) 
    {
