...
contract EtherWrapper is Owned, Pausable, MixinResolver, MixinSystemSettings, IEtherWrapper {
    ...
    function distributeFees() external notPaused {
    ...
    function _mint(uint amountIn) internal notPaused {
    ...
    function _burn(uint principal, uint amountIn) internal notPaused {
