...
contract SetTest is DSTest {
    ...
    function testSetBridge() public {
        ...
        uint256 depositAmountDai = 999999999;
        uint256 depositAmountDpi = 1999999999;
        uint256 depositAmountEth = undefined; // 1 ETH

        _setTokenBalance(address(dai), address(rollupProcessor), depositAmountDai, 1);
        _setTokenBalance(address(dpi), address(rollupProcessor), depositAmountDpi, 1);
    ...
    function testIssueSetForExactToken() public {
        ...
        uint256 depositAmountDai = undefined; // $1000
        _setTokenBalance(address(dai), address(rollupProcessor), depositAmountDai, 1);
