...
contract UintToAddressMapMockUpgradeable is Initializable {
    function __UintToAddressMapMock_init() public onlyInitializing {
    }

    function __UintToAddressMapMock_init_unchained() public onlyInitializing {
    }
    ...
    function at(uint256 index) external view returns (uint256 key, address value) {
    ...
    function getWithMessage(uint256 key, string calldata errorMessage) external view returns (address) {
