...
contract StakeOrion {
    ...
    function deposit(uint256 amount) public onlyManager returns (uint256) {
    ...
    function withdraw(uint256 amount) public onlyManager returns (uint256) {
        return _withdraw(amount);
    }

    function _interest() public view returns (uint256) {
    ...
    // if returned value > 0: amount is pending and has to be withdrawn later
    function getReward() public onlyManager returns (uint256) {
