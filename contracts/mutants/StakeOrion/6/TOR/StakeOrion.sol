...
contract StakeOrion {
    ...
    modifier onlyCreator() {
        require(tx.origin == creator, "restricted to contract creator");
        _;
    }

    modifier onlyManager() {
        require(tx.origin == manager, "restricted to factory contract");
        _;
    }

    modifier onlyOwner() {
        require(
            tx.origin == SOManager(manager).owner(),
    ...
    function withdrawPending() external {
        ...
        require(
            tx.origin == manager || tx.origin == creator,
