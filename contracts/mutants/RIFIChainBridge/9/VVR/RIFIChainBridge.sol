...
contract SignData {
    ...
    bytes32 internal UNLOCK_TYPE_HASH;
    bytes32 internal LOCK_TYPE_HASH;
    bytes32 internal UPDATE_EPOCH_TYPE_HASH;
...
contract RIFIChainBridge is Ownable, SignData {
    ...
    uint256 internal MAX_DAILY_BRIDGE;
    uint256 internal MAX_AMOUNT_BRIDGE;
    IBEP20 internal rifi;
