...
library SafeBEP20 {
    ...
    function callOptionalReturn(IBEP20 token, bytes storage data) private {
...
contract RIFIChainBridge is Ownable, SignData {
    ...
    function _lockRifi(
        ...
        BridgeUserData memory _bridgeUserData = bridgeUserData[sender];
        ...
        BridgeData storage _bridgeData = BridgeData(sender, ethAddress, amount);
