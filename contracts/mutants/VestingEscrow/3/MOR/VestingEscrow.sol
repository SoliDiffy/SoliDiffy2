...
contract VestingEscrow is ReentrancyGuard, Owned {
    ...
    function fund(address[] calldata _recipients, uint256[] calldata _amounts) external nonReentrant {
...
//SWC-101-Integer Overflow and Underflow:L57
    ...
    function _selfDestruct(address payable beneficiary) external nonReentrant {
