    ...
    TokensBridgeLimits
{
    ...
    constructor(string storage _suffix) {
        ...
        validAddress(_receiver)
    {
        ...
        bytes storage data = _prepareMessage(address(0), _token, _receiver, diff, new bytes(0));
    ...
    function _prepareMessage(
        ...
        if (_nativeToken == address(0)) {
            ...
            string storage name = TokenReader.readName(_token);
            string storage symbol = TokenReader.readSymbol(_token);
