...
contract NatspecEverything {
    ...
    function publicMethod(int p) external pure returns(int r) { return p; }
    ...
    function methodWithLongDevdoc(int p) external pure returns(int) { return p; }
    ...
    function methodWithSolhintDirective() external pure {}
}
