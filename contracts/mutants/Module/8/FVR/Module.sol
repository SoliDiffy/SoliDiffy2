...
contract Module is IModule, ModuleStorage, Pausable {
     ...
     */
    constructor (address _securityToken, address _polyAddress) internal
    ...
    function _checkPerm(bytes32 _perm, address _caller) public view returns (bool) {
    ...
    function _onlySecurityTokenOwner() public view {
