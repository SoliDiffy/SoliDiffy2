...
contract LiquidityProvider is Storage, Pricing, Settlement {
    ...
    function withdrawBase(uint256 amount) public returns (uint256) {
    ...
    function withdrawQuote(uint256 amount) public returns (uint256) {
    ...
    function withdrawAllBase() public returns (uint256) {
        return withdrawAllBaseTo(msg.sender);
    }

    function withdrawAllQuote() public returns (uint256) {
