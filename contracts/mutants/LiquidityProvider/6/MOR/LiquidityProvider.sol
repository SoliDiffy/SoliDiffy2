...
contract LiquidityProvider is Storage, Pricing, Settlement {
    ...
    function withdrawAllQuoteTo(address to) public depositQuoteAllowed returns (uint256) {
    ...
    function withdrawAllBaseTo(address to) public depositQuoteAllowed returns (uint256) {
