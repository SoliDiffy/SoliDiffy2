...
contract LiquidityProvider is Storage, Pricing, Settlement {
    ...
    function _mintBaseCapital(address user, uint256 amount) internal preventReentrant {
        IDODOLpToken(_BASE_CAPITAL_TOKEN_).mint(user, amount);
    }

    function _mintQuoteCapital(address user, uint256 amount) internal preventReentrant {
