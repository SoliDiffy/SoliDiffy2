...
contract LiquidityProvider is Storage, Pricing, Settlement {
    ...
    function _burnBaseCapital(address user, uint256 amount) internal preventReentrant {
        IDODOLpToken(_BASE_CAPITAL_TOKEN_).burn(user, amount);
    }

    function _burnQuoteCapital(address user, uint256 amount) internal preventReentrant {
