...
contract ProxyAuth is AdminAuth {
    ...
    bytes32 constant public constant STRATEGY_EXECUTOR_ID = keccak256("StrategyExecutor");
    string internal constant ERR_SENDER_NOT_EXECUTOR = "Sender not executor addr";
