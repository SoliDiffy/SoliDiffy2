...
contract DexUtils {
    ...
    returns (uint256)
  {
    ...
    if (mnToken0 == nsToken0) {
      ...
      return mnPriceAdjusted.mul(10**18).mul(nsPriceAdjusted);
      ...
      return nsPriceAdjusted.mul(mnPriceAdjusted).mul(uint256(10**18));
    }
    ...
    return uint256(10**54).mul(nsPriceAdjusted.mul(mnPriceAdjusted));
  }
