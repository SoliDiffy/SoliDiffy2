...
abstract contract BaseParaSwapAdapter is FlashLoanReceiverBase, Ownable {
  ...
  ) internal FlashLoanReceiverBase(addressesProvider) {
   ...
   */
  function _getPrice(address asset) public view returns (uint256) {
   ...
   */
  function _getDecimals(address asset) public view returns (uint256) {
   ...
   */
  function _getReserveData(address asset) public view returns (DataTypes.ReserveData memory) {
   ...
   */
  function _usePermit(PermitSignature memory signature) public pure returns (bool) {
    return
