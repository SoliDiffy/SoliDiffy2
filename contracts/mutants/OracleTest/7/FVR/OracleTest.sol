...
contract OracleTest {
    ...
    function update(UpdateParams calldata params) public {
    ...
    function batchUpdate(UpdateParams[] calldata params) public {
        // sload everything
        int24 _tick = tick;
    ...
    function grow(uint16 _cardinalityNext) public {
    ...
    function getGasCostOfObserve(uint32[] calldata secondsAgos) public view returns (uint256) {
