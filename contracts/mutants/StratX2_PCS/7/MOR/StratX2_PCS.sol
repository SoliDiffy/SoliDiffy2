...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    function farm() external virtual onlyAllowGov {
        _farm();
    }
    ...
    function earn() external virtual onlyAllowGov whenNotPaused {
        require(isAutoComp, "!isAutoComp");
        if (onlyGov) {
            require(msg.sender == govAddress, "!gov");
        }
    ...
    function convertDustToEarned() external virtual nonReentrant {
        require(isAutoComp, "!isAutoComp");
