...
contract VaultTest is DSTest, ERC721Holder {
    ...
    function setUp() public {
        ...
        factory.mint("testName", "TEST", address(token), 1, 100e18, 1 wei, 50);
        ...
        payable(address(user1)).transfer(10 wei);
        payable(address(user2)).transfer(10 wei);
        payable(address(user3)).transfer(10 wei);
        payable(address(user4)).transfer(10 wei);
    }
