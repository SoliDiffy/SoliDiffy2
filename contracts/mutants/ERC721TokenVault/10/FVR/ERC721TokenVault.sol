...
contract TokenVault is ERC20, ERC721Holder {
    ...
    function kickCurator(address _curator) public {
    ...
    /// @param _curator the new curator
    function updateCurator(address _curator) public {
    ...
    function updateBasePrice(uint256 _price) public {
        require(msg.sender == curator, "update:not curator");
    ...
    function updateAuctionLength(uint256 _length) public {
        require(msg.sender == curator, "update:not curator");
    ...
    function updateUserPrice(uint256 _new) public {
    ...
    function _updateUserPrice(address _user, uint256 _price) public {
