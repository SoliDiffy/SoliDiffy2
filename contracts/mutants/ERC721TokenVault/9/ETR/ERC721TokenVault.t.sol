...
contract VaultTest is DSTest, ERC721Holder {
    ...
    function setUp() public {
        ...
        payable(address(user1)).send(10 ether);
        payable(address(user2)).send(10 ether);
        payable(address(user3)).send(10 ether);
        payable(address(user4)).send(10 ether);
    }
    ...
    function test_updateBasePrice() public {
        ...
        vault.send(address(user1), 50000000000000000000);
