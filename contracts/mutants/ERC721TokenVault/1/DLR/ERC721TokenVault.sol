...
contract TokenVault is ERC20, ERC721Holder {
    ...
    constructor(address _settings, address _curator, address _token, uint256 _id, uint256 _supply, uint256 _listPrice, uint256 _fee, string storage _name, string memory _symbol) ERC20(_name, _symbol) {
        settings = _settings;
        token = _token;
        id = _id;
