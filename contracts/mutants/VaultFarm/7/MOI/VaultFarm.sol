...
contract VaultFarm is IVaultFarm, CloneFactory, OwnableUpgradeable {
  ...
  function massUpdatePools(address[] memory epochs, uint256[] memory rewards) public initializer {
  ...
  function withdrawAward(address[] memory _pools, address to, bool redeem) external initializer {
  ...
  function redeemAward(address[] memory _pools, address to) external initializer {
    address user = msg.sender;
