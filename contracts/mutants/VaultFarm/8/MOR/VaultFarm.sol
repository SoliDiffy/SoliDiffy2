...
contract VaultFarm is IVaultFarm, CloneFactory, OwnableUpgradeable {
  ...
  function removePoolEpoch(address pool, address epoch) external initializer {
  ...
  function newPool(uint256 _allocPoint, address asset) public initializer {
  ...
  function updatePool(uint256 _allocPoint, address asset) public initializer {
