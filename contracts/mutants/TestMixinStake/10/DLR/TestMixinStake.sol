    ...
    TestStakingNoWETH
{
    ...
    function setOwnerStakeByStatus(
        ...
        IStructs.StoredBalance storage stake
    )
        public
    {
    ...
    function _increaseCurrentAndNextBalance(
        IStructs.StoredBalance memory balancePtr,
        uint256 amount
    )
        internal
    {
    ...
    function _loadCurrentBalance(IStructs.StoredBalance memory balancePtr)
        internal
        view
    ...
    function _getPtrSlot(IStructs.StoredBalance memory ptr)
        private
        pure
