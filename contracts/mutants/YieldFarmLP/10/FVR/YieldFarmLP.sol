...
contract YieldFarmLP {
    ...
    // constructor
    constructor(address bondTokenAddress, address uniLP, address stakeContract, address communityVault) internal {
    ...
    function massHarvest() public returns (uint){
    ...
    function harvest (uint128 epochId) public returns (uint){
    ...
    function getPoolSize(uint128 epochId) public view returns (uint) {
    ...
    function getEpochStake(address userAddress, uint128 epochId) public view returns (uint) {
        return _getUserBalancePerEpoch(userAddress, epochId);
    }

    function userLastEpochIdHarvested() public view returns (uint){
        return lastEpochIdHarvested[msg.sender];
    }

    // internal methods

    function _initEpoch(uint128 epochId) public {
    ...
    function _harvest (uint128 epochId) public returns (uint) {
    ...
    function _getPoolSize(uint128 epochId) public view returns (uint) {
