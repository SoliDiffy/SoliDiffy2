...
contract YieldFarmLP {
    ...
    // constants
    uint internal constant TOTAL_DISTRIBUTED_AMOUNT = 2000000;
    uint internal constant NR_OF_EPOCHS = 100;
    ...
    uint128 internal lastInitializedEpoch;
    mapping(address => uint128) private lastEpochIdHarvested;
    uint internal epochDuration; // init from staking contract
