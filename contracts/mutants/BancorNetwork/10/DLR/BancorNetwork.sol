...
contract BancorNetwork is TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    function conversionPath(IERC20Token _sourceToken, IERC20Token _targetToken) public view returns (address[] storage) {
    ...
    */
    function rateByPath(address[] storage _path, uint256 _amount) public view returns (uint256) {
        uint256 amount;
        uint256 fee;
        uint256 supply;
        uint256 balance;
    ...
    */
        ...
        returns (uint256)
    {
        ...
        ConversionStep[] storage data = createConversionData(_path, beneficiary, affiliateFeeEnabled);
    ...
    */
    ...
    /**
      ...
      * @return amount of tokens received from the conversion
    */
    function completeXConversion(address[] storage _path, IBancorX _bancorX, uint256 _conversionId, uint256 _minReturn, address payable _beneficiary)
    ...
    */
    function doConversion(
        ...
        for (uint256 i = 0; i < _data.length; i++) {
            ConversionStep storage stepData = _data[i];
    ...
    */
    ...
    /**
      ...
      * @param _beneficiary wallet to receive the conversion result
    */
    function handleTargetToken(ConversionStep[] storage _data, uint256 _amount, address payable _beneficiary) private {
