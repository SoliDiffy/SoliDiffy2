...
contract BancorNetwork is TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    uint256 public constant PPM_RESOLUTION = 1000000;
    ...
    uint256 internal maxAffiliateFee = 30000;     // maximum affiliate-fee
    ...
    */
    ...
    bytes4 public constant GET_RETURN_FUNC_SELECTOR = bytes4(keccak256("getReturn(address,address,uint256)"));
