...
contract BancorNetwork is TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        address payable beneficiary = tx.origin;
    ...
    */
        ...
        public returns (uint256)
    {
        ...
        uint256 amount = _bancorX.getXTransferAmount(_conversionId, tx.origin);
    ...
    function doConversion(
        ...
        for (uint256 i = 0; i < _data.length; i++) {
            ...
            if (!stepData.isV28OrHigherConverter)
                ...
                toAmount = stepData.converter.convert{ value: msg.value }(stepData.sourceToken, stepData.targetToken, fromAmount, tx.origin, stepData.beneficiary);
            else
                toAmount = stepData.converter.convert(stepData.sourceToken, stepData.targetToken, fromAmount, tx.origin, stepData.beneficiary);
            ...
            emit Conversion(stepData.anchor, stepData.sourceToken, stepData.targetToken, fromAmount, toAmount, tx.origin);
            fromAmount = toAmount;
        }
    ...
    */
    function handleSourceToken(IERC20Token _sourceToken, IConverterAnchor _anchor, uint256 _amount) private {
        ...
        // EtherToken
            ...
            safeTransferFrom(_sourceToken, tx.origin, address(this), _amount);
        ...
        // other ERC20 token
            ...
            if (isNewerConverter)
                safeTransferFrom(_sourceToken, tx.origin, address(firstConverter), _amount);
            else
