...
contract BancorNetwork is TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    function doConversion(
        ...
        address _affiliateAccount,
        uint256 _affiliateFee
    ) private ownerOnly returns (uint256) {
        uint256 toAmount;
    ...
    /**
      ...
      * @param _amount      amount to convert from, in the source token
    */
    function handleSourceToken(IERC20Token _sourceToken, IConverterAnchor _anchor, uint256 _amount) private ownerOnly {
    ...
    /**
      ...
      * @param _beneficiary wallet to receive the conversion result
    */
    function handleTargetToken(ConversionStep[] memory _data, uint256 _amount, address payable _beneficiary) private ownerOnly {
    ...
    */
    function ensureAllowance(IERC20Token _token, address _spender, uint256 _value) private ownerOnly {
    ...
    */
    ...
    /**
      * @dev deprecated, backward compatibility
    */
    function convert(address[] memory _path, uint256 _amount, uint256 _minReturn) public payable ownerOnly returns (uint256) {
    ...
    */
    ...
    /**
      * @dev deprecated, backward compatibility
    */
    function convertFor(address[] memory _path, uint256 _amount, uint256 _minReturn, address payable _beneficiary) public payable ownerOnly returns (uint256) {
