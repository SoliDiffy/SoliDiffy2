...
contract BancorNetwork is TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    ...
    bytes4 private constant GET_RETURN_FUNC_SELECTOR = bytes4(sha256("getReturn(address,address,uint256)"));
    ...
    bytes4 private constant IS_V28_OR_HIGHER_FUNC_SELECTOR = bytes4(sha256("isV28OrHigher()"));
