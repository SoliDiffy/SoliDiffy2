...
contract ERC20V2Factory is InitializableOwnable {
    ...
    function createStdERC20(
        ...
        uint8 decimals
    ) public payable returns (address newERC20) {
    ...
    function createCustomERC20(
        ...
        address teamAccount,
        bool isMintable
    ) public payable returns (address newCustomERC20) {
        require(msg.value >= _CREATE_FEE_, "CREATE_FEE_NOT_ENOUGH");
    ...
    // ============ Ownable =============
    function changeCreateFee(uint256 newFee) public onlyOwner {
        _CREATE_FEE_ = newFee;
    ...
    function updateStdTemplate(address newStdTemplate) public onlyOwner {
        _ERC20_TEMPLATE_ = newStdTemplate;
        emit ChangeStdTemplate(newStdTemplate);
    }

    function updateCustomTemplate(address newCustomTemplate) public onlyOwner {
