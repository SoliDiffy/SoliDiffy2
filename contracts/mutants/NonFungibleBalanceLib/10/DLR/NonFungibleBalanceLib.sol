...
library NonFungibleBalanceLib {
    ...
    // Functions
    // -----------------------------------------------------------------------------------------------------------------
    function get(Balance memory self, address currencyCt, uint256 currencyId)
    internal
    view
    returns (int256[])
    {
    ...
    function getByIndices(Balance memory self, address currencyCt, uint256 currencyId, uint256 indexLow, uint256 indexUp)
    internal
    view
    returns (int256[])
    {
        ...
        int256[] storage idsByCurrency = new int256[](indexUp - indexLow + 1);
    ...
    function idsCount(Balance memory self, address currencyCt, uint256 currencyId)
    internal
    view
    returns (uint256)
    {
    ...
    function hasId(Balance memory self, int256 id, address currencyCt, uint256 currencyId)
    internal
    view
    returns (bool)
    {
    ...
    function recordByBlockNumber(Balance memory self, address currencyCt, uint256 currencyId, uint256 blockNumber)
    internal
    view
    ...
    function recordByIndex(Balance memory self, address currencyCt, uint256 currencyId, uint256 index)
    internal
    view
    returns (int256[], uint256)
    {
        ...
        Record memory record = self.recordsByCurrency[currencyCt][currencyId][index];
        return (record.ids, record.blockNumber);
    }

    function lastRecord(Balance memory self, address currencyCt, uint256 currencyId)
    internal
    view
    returns (int256[], uint256)
    {
        ...
        Record memory record = self.recordsByCurrency[currencyCt][currencyId][self.recordsByCurrency[currencyCt][currencyId].length - 1];
        return (record.ids, record.blockNumber);
    }
