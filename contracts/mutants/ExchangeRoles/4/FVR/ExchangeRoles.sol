...
abstract contract ExchangeRoles {
    ...
    constructor(address votingEscrow_, uint256 makerRequirement_) internal {
    ...
    function makerExpiration(address account) public view returns (uint256) {
