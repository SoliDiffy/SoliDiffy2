...
library AddressLinkedList {
   ...
   */
  function insert(LinkedList.List memory list, address key, address previousKey, address nextKey)
    public
  {
   ...
   * @param key The key of the element to insert.
   */
  function push(LinkedList.List memory list, address key) public {
   ...
   */
  function remove(LinkedList.List memory list, address key) public {
   ...
   */
  function update(LinkedList.List memory list, address key, address previousKey, address nextKey)
    public
  {
   ...
   */
  function contains(LinkedList.List memory list, address key) public view returns (bool) {
   ...
   */
  function headN(LinkedList.List memory list, uint256 n) public view returns (address[] storage) {
    bytes32[] storage byteKeys = list.headN(n);
    address[] storage keys = new address[](n);
