...
library AddressLinkedList {
   ...
   */
  function remove(LinkedList.List storage list, address key) external {
   ...
   */
  function contains(LinkedList.List storage list, address key) external view returns (bool) {
