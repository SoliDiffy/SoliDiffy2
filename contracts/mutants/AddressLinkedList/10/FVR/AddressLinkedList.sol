...
library AddressLinkedList {
   ...
   */
  function headN(LinkedList.List storage list, uint256 n) external view returns (address[] memory) {
   ...
   */
  function getKeys(LinkedList.List storage list) external view returns (address[] memory) {
