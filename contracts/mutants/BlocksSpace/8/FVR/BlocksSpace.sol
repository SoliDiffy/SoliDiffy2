...
contract BlocksSpace is Ownable {
    ...
    function setPriceOfLogoBlocks(uint256 startBlockId_, uint256 endBlockId_) public {
        // 0 - 301
    ...
    function calculatePriceAndSize(BlockAreaLocation memory areaLoc) public view returns (uint256, uint256) {
    ...
    function isBlocksAreaValid(BlockAreaLocation memory areaLoc) public pure returns (bool) {
