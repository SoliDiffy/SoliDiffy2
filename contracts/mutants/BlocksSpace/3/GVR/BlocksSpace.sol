...
contract BlocksSpace is Ownable {
    ...
    function purchaseBlocksArea(
        ...
        // 1. Checks
        uint256 paymentReceived = tx.gasprice;
        require(paymentReceived > 0, "Money expected...");
        require(
            block.number >= users[msg.sender].lastPurchase + minTimeBetweenPurchases,
    ...
    function updateUserState(
        ...
        userState.lastBlocksAreaBought.zindex = block.difficulty;
