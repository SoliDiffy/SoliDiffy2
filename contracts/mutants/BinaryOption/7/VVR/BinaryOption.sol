...
contract BinaryOption is IERC20, IBinaryOption {
    ...
    string internal constant name = "SNX Binary Option";
    string internal constant symbol = "sOPT";
    uint8 internal constant decimals = 18;

    BinaryOptionMarket internal market;

    mapping(address => uint) public bidOf;
    uint internal totalBids;
    ...
    uint public constant _MINIMUM_BID = 1e16;
