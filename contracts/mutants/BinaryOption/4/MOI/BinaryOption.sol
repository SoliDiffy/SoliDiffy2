...
contract BinaryOption is IERC20, IBinaryOption {
    ...
    function _transfer(
        ...
        address _to,
        uint _value
    ) internal onlyMarket returns (bool success) {
    ...
    function transfer(address _to, uint _value) external onlyMarket returns (bool success) {
    ...
    function transferFrom(
        ...
        address _to,
        uint _value
    ) external onlyMarket returns (bool success) {
    ...
    function approve(address _spender, uint _value) external onlyMarket returns (bool success) {
