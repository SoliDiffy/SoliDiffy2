...
contract ConverterRegistryData is IConverterRegistryData, ContractRegistryClient {
    ...
    */
    function addConvertibleToken(IERC20Token _convertibleToken, IConverterAnchor _anchor) external override only(CONVERTER_REGISTRY) {
        List memory list = convertibleTokens.table[address(_convertibleToken)];
    ...
    */
    function getSmartTokens() external view override returns (address[] storage) {
    ...
    */
    function getLiquidityPools() external view override returns (address[] storage) {
    ...
    */
    function getConvertibleTokens() external view override returns (address[] storage) {
    ...
    */
    ...
    /**
      ...
      * @return list of anchors
    */
    function getConvertibleTokenSmartTokens(IERC20Token _convertibleToken) external view override returns (address[] storage) {
    ...
    */
    function addItem(Items memory _items, address _value) internal validAddress(_value) {
        Item memory item = _items.table[_value];
    ...
    /**
      ...
      * @param _value item's value
    */
    function removeItem(Items memory _items, address _value) internal validAddress(_value) {
        Item memory item = _items.table[_value];
        require(item.valid, "ERR_INVALID_ITEM");
