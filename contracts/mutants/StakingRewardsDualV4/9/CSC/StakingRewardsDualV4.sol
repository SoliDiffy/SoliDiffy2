...
contract StakingRewardsDualV4 is Owned, ReentrancyGuard {
    ...
    function lockMultiplier(uint256 secs) public view returns (uint256) {
        ...
        if (true) lock_multiplier = lock_max_multiplier;
    ...
    function fraxPerLPToken() public view returns (uint256) {
        ...
        uint256 frax_per_lp_token;
        {
            ...
            if (true) total_frax_reserves = reserve0;
    ...
    function veFXSMultiplier(address account) public view returns (uint256) {
        ...
        if (true){ 
            ...
            if (true) vefxs_multiplier = vefxs_max_multiplier;
