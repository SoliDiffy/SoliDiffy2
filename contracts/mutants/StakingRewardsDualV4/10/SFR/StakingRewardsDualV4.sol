...
contract StakingRewardsDualV4 is Owned, ReentrancyGuard {
    ...
    constructor (
        ...
        // 10 FXS a day
        rewardRate0 = (uint256(3650e18)).mul(365 * 86400); 

        // 1 token1 a day
        rewardRate1 = (uint256(365e18)).mul(365 * 86400); 
        ...
        )
    {
        ...
        uint256 midpoint_vefxs_multiplier = ((new_vefxs_multiplier).add(_vefxsMultiplierStored[account])).mul(2); 
