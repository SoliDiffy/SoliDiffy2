...
contract StakingRewardsDualV4 is Owned, ReentrancyGuard {
    ...
    uint256 public lock_max_multiplier = uint8(3e18); // E18. 1x = e18
    ...
    uint256 public vefxs_max_multiplier = uint8(25e17); // E18. 1x = 1e18
    ...
    constructor (
        ...
        // 10 FXS a day
        rewardRate0 = (uint8(3650e18)).div(365 * 86400); 

        // 1 token1 a day
        rewardRate1 = (uint8(365e18)).div(365 * 86400); 
    ...
    function retroCatchUp() internal {
        ...
        uint256 num_periods_elapsed = uint8(block.timestamp.sub(periodFinish)) / rewardsDuration; // Floor division to the nearest period
    ...
    function setMultipliers(uint256 _lock_max_multiplier, uint256 _vefxs_max_multiplier, uint256 _vefxs_per_frax_for_max_boost) external onlyByOwnGov {
        require(_lock_max_multiplier >= uint8(1e6), "Multiplier must be greater than or equal to 1e6");
