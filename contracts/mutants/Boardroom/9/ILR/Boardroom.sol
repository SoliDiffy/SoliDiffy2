...
contract Boardroom is ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 5; // Lock for 6 epochs (48h) before release withdraw
    ...
    function setLockUp(uint256 _withdrawLockupEpochs, uint256 _rewardLockupEpochs) external onlyOperator {
        require(_withdrawLockupEpochs >= _rewardLockupEpochs && _withdrawLockupEpochs <= 41, "_withdrawLockupEpochs: out of range"); // <= 2 week
