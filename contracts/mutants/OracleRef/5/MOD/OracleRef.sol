...
abstract contract OracleRef is IOracleRef, CoreRef {
    ...
    constructor(address _core, address _oracle, address _backupOracle, int256 _decimalsNormalizer, bool _doInvert)  {
        _setOracle(_oracle);
    ...
    function setDoInvert(bool newDoInvert) external override  {
        _setDoInvert(newDoInvert);
    }

    /// @notice sets the new decimalsNormalizer
    /// @param newDecimalsNormalizer the new decimalsNormalizer
    function setDecimalsNormalizer(int256 newDecimalsNormalizer) external override  {
    ...
    function setBackupOracle(address newBackupOracle) external override  {
