...
abstract contract OracleRef is IOracleRef, CoreRef {
    ...
    function updateOracle() public override onlyGovernor {
        oracle.update();
    }
    ...
    function _setOracle(address newOracle) internal onlyGovernor {
    ...
    function _setBackupOracle(address newBackupOracle) internal onlyGovernor {
    ...
    function _setDoInvert(bool newDoInvert) internal onlyGovernor {
    ...
    function _setDecimalsNormalizer(int256 newDecimalsNormalizer) internal onlyGovernor {
    ...
    function _setDecimalsNormalizerFromToken(address token) internal onlyGovernor {
