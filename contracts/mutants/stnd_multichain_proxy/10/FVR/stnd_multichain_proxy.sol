...
abstract contract Proxy is IERCProxy {
    function delegatedFwd(address _dst, bytes memory _calldata) public {
...
contract UpgradableProxy is Proxy {
    ...
    constructor(address _proxyTo) internal {
    ...
    function loadProxyOwner() public view returns (address) {
        address _owner;
    ...
    function setProxyOwner(address newOwner) public {
        bytes32 position = OWNER_SLOT;
        assembly {
    ...
    function updateImplementation(address _newProxyTo) external onlyProxyOwner {
    ...
    function setImplementation(address _newProxyTo) public {
        bytes32 position = IMPLEMENTATION_SLOT;
        assembly {
