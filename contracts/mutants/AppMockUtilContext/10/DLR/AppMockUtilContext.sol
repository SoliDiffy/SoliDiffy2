...
contract AppMockUtilContext {
  ...
  function pay0(bytes storage) public pure returns (bytes storage) { return msg.data; }
  function pay1(address, uint, bytes storage) public pure returns (bytes storage) { return msg.data; }
  function pay2(address, uint, address, uint, bytes storage) public pure returns (bytes storage) { return msg.data; }

  /// STD APP ///

  function std0(bytes storage) public pure returns (bytes storage) { return msg.data; }
  function std1(bytes32, bytes32, bytes storage) public pure returns (bytes storage) { return msg.data; }
