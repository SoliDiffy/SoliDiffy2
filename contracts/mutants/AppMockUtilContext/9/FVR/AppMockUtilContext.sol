...
contract AppMockUtilContext {
  ...
  function pay0(bytes memory) external pure returns (bytes memory) { return msg.data; }
  function pay1(address, uint, bytes memory) external pure returns (bytes memory) { return msg.data; }
  function pay2(address, uint, address, uint, bytes memory) external pure returns (bytes memory) { return msg.data; }

  /// STD APP ///

  function std0(bytes memory) external pure returns (bytes memory) { return msg.data; }
  function std1(bytes32, bytes32, bytes memory) external pure returns (bytes memory) { return msg.data; }
  function std2(bytes32, bytes32, bytes32, bytes32, bytes memory) external pure returns (bytes memory) { return msg.data; }

  /// EMITS APP ///

  function emit0(bytes memory) external pure returns (bytes memory) { return msg.data; }
  function emit1top0(bytes memory) external pure returns (bytes memory) { return msg.data; }
  function emit1top0data(bytes memory) external pure returns (bytes memory) { return msg.data; }
