...
contract StrategyCmpndDaiV1 is DSTestDefiBase {
    ...
    function testFail_cmpnd_dai_v1_onlyKeeper_leverage() external {
    ...
    function testFail_cmpnd_dai_v1_onlyKeeper_deleverage() external {
        _getERC20(want, 100e18);
        uint256 _want = IERC20(want).balanceOf(address(this));
        IERC20(want).approve(address(pickleJar), _want);
        pickleJar.deposit(_want);
    ...
    function test_cmpnd_dai_v1_comp_accrued() external {
    ...
    function test_cmpnd_dai_v1_comp_sync() external {
        _getERC20(want, 1000000e18);
        uint256 _want = IERC20(want).balanceOf(address(this));
        IERC20(want).approve(address(pickleJar), _want);
        pickleJar.deposit(_want);
    ...
    function test_cmpnd_dai_v1_leverage() external {
        _getERC20(want, 100e18);
        uint256 _want = IERC20(want).balanceOf(address(this));
        IERC20(want).approve(address(pickleJar), _want);
        pickleJar.deposit(_want);
    ...
    function test_cmpnd_dai_v1_deleverage() external {
        _getERC20(want, 100e18);
        uint256 _want = IERC20(want).balanceOf(address(this));
        IERC20(want).approve(address(pickleJar), _want);
        pickleJar.deposit(_want);
    ...
    function test_cmpnd_dai_v1_withdrawSome() external {
        _getERC20(want, 100e18);
        uint256 _want = IERC20(want).balanceOf(address(this));
        IERC20(want).approve(address(pickleJar), _want);
        pickleJar.deposit(_want);
    ...
    function test_cmpnd_dai_v1_withdrawAll() external {
        _getERC20(want, 100e18);
