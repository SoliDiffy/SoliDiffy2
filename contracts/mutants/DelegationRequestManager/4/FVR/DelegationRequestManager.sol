...
contract DelegationRequestManager is Permissions {
    ...
    function cancelRequest(uint delegationId, address holderAddress) public allow("DelegationService") {
        TokenState tokenState = TokenState(
            contractManager.getContract("TokenState")
        );
        DelegationController delegationController = DelegationController(
    ...
    function acceptRequest(uint delegationId, address validatorAddress) public allow("DelegationService") {
        TokenState tokenState = TokenState(
            contractManager.getContract("TokenState")
        );
        DelegationController delegationController = DelegationController(
