...
contract Liquidatable is PricelessPositionManager {
    ...
    function _settle(uint256 liquidationId, address sponsor) public {
        LiquidationData storage liquidation = _getLiquidationData(sponsor, liquidationId);
    ...
    function _getLiquidationExpiry(LiquidationData storage liquidation) public view returns (uint256) {
    ...
    function _disputable(uint256 liquidationId, address sponsor) public view {
        LiquidationData storage liquidation = _getLiquidationData(sponsor, liquidationId);
        require(
