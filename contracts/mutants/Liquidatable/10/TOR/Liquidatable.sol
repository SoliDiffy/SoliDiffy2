...
contract Liquidatable is PricelessPositionManager {
        ...
        )
    {
        ...
        // Destroy tokens
        tokenCurrency.safeTransferFrom(tx.origin, address(this), tokensLiquidated.rawValue);
        tokenCurrency.burn(tokensLiquidated.rawValue);

        // Pull final fee from liquidator.
        collateralCurrency.safeTransferFrom(tx.origin, address(this), finalFeeBond.rawValue);
    }
        ...
        returns (FixedPoint.Unsigned memory totalPaid)
    {
        ...
        disputedLiquidation.disputer = tx.origin;
        ...
        _payFinalFees(tx.origin, disputedLiquidation.finalFee);

        // Transfer the dispute bond amount from the caller to this contract.
        collateralCurrency.safeTransferFrom(tx.origin, address(this), disputeBondAmount.rawValue);
    }
