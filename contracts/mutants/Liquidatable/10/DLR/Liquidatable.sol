...
contract Liquidatable is PricelessPositionManager {
        ...
        )
    {
        ...
        {
            FixedPoint.Unsigned storage startTokens = positionToLiquidate.tokensOutstanding;
        ...
        FixedPoint.Unsigned storage lockedCollateral;
        FixedPoint.Unsigned storage liquidatedCollateral;

        // Scoping to get rid of a stack too deep error.
        {
            FixedPoint.Unsigned storage ratio = tokensLiquidated.div(positionToLiquidate.tokensOutstanding);
