...
abstract contract AvailabilityVerifiers is MainStorage, LibConstants, MApprovalChain {
    ...
    function isAvailabilityVerifier(address verifierAddress) public view returns (bool) {
    ...
    function announceAvailabilityVerifierRemovalIntent(address verifier) public {
        announceRemovalIntent(availabilityVerifiersChain, verifier, VERIFIER_REMOVAL_DELAY);
    }

    function removeAvailabilityVerifier(address verifier) public {
