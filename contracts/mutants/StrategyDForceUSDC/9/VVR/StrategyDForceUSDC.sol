...
contract StrategyDForceUSDC {
  ...
  address internal constant want = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // USDC
  address internal constant dusdc = address(0x16c9cF62d8daC4a38FB50Ae5fa5d51E9170F3179);
  address internal constant pool = address(0xB71dEFDd6240c45746EC58314a01dd6D833fD3b5);
  address internal constant df = address(0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0);
  address internal constant uni = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
  address internal constant weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // used for df <> weth <> usdc route

  uint256 internal performanceFee = 5000;
  uint256 internal constant performanceMax = 10000;

  uint256 internal withdrawalFee = 500;
