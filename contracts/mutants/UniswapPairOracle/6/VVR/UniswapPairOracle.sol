...
contract UniswapPairOracle {
    ...
    uint internal PERIOD = 3600; // 1 hour TWAP (time-weighted average price)
    uint internal CONSULT_LENIENCY = 120; // Used for being able to consult past the period end
    bool internal ALLOW_STALE_CONSULTS = false; // If false, consult() will fail if the TWAP is stale
