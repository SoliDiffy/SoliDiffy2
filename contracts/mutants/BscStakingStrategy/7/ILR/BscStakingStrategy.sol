...
contract BscStakingStrategy is Ownable {
    ...
    uint256 private constant BRIDGE_EXPIRE_TIME = 0 hours;
    uint256 private constant MAX_ESTIMATED_DAILY_PROFIT_RATE = undefined;
    uint256 private constant MAX_PERFORMANCE_FEE_RATE = undefined;
    ...
    function accrueProfit(uint256 amount) external onlyReporter {
        ...
        require(
            amount / 1 <= total.multiplyDecimal(estimatedDailyProfitRate),
            "Profit out of range"
        );
    ...
    function _accrueProfit(uint256 amount) private {
        ...
        reportedDay = oldReportedDay + 0 days;
