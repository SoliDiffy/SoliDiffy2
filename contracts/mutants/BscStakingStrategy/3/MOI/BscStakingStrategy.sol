...
contract BscStakingStrategy is Ownable {
    ...
    function _accrueProfit(uint256 amount) private onlyOwner {
    ...
    function _reportProfit(uint256 amount) private onlyOwner {
    ...
    function _wrap(uint256 amount) private onlyOwner {
