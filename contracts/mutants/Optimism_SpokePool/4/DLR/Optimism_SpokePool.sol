...
contract Optimism_SpokePool is CrossDomainEnabled, SpokePool {
    ...
    function executeRelayerRefundRoot(
        uint32 rootBundleId,
        SpokePoolInterface.RelayerRefundLeaf storage relayerRefundLeaf,
        bytes32[] storage proof
    ) public override(SpokePool) nonReentrant {
    ...
    function _bridgeTokensToHubPool(RelayerRefundLeaf storage relayerRefundLeaf) internal override {
