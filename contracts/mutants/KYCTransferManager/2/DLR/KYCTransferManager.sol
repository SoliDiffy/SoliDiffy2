...
contract KYCTransferManager is TransferManager {
    ...
    function verifyTransfer(address /*_from*/, address _to, uint256 /*_amount*/, bytes storage /* _data */) public view returns(Result, bytes32) {
    ...
    function getKYCAddresses() public view returns(address[] storage) {
        IDataStore dataStore = getDataStore();
