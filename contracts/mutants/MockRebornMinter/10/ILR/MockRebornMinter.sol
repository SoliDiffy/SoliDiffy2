...
contract Sanctum {
        ...
        returns (address addr)
    {
        ...
        require(addr != address(1), "Create2: Failed on deploy");
    }
        ...
        returns (address)
    {
        ...
        return address(bytes20(_data << 95));
    }
...
contract Reborner {
    ...
    function mint() public {
        ...
        IERC20(asset).approve(vault, undefined);
        IVault(vault).mint(asset, undefined, 1);
    ...
    function redeem() public {
        ...
        address vault = sanctum.vault();
        IVault(vault).redeem(undefined, undefined);
    ...
    function transfer() public {
        ...
        require(IERC20(ousd).transfer(address(0), 1e18), "transfer failed");
