...
contract LeadStake is Ownable {
    ...
    constructor(
        ...
        uint _minimumStakeValue) internal {
     ...
     */
    function registerAndStake(uint _amount, address _referrer) public onlyUnregistered() whenActive() {
    ...
    function calculateEarnings(address _stakeholder) external view returns(uint) {
     ...
     */
    function stake(uint _amount) public onlyRegistered() whenActive() {
     ...
     * Emits an {OnStake} event
     */
    function unstake(uint _amount) public onlyRegistered() {
     ...
     */
    function isStakeholder(address _address) external view returns(bool, uint) {
    ...
    function _removeStakeholder(address _stakeholder) public {
