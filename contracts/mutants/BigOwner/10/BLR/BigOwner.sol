...
contract BigOwner {
  ...
  function setPendingAdmin(address pendingAdmin_, address pendingRemoveAdmin_) external onlyOwner {
    ...
    require(admin[pendingRemoveAdmin_] == false, 'BigOwner::setPendingAdmin: pendingRemoveAdmin should be admin.');
    require(admin[pendingAdmin_] == true, 'BigOwner::setPendingAdmin: pendingAdmin should not be admin.');
