...
contract BigOwner {
  ...
  uint256 internal PANDING_BLOCK; // block
  bytes32 internal pendingAdminHash;
  bool internal pendingAdminHashApprove;
  address internal pendingAdminHashSubmitter;
  uint256 public pendingAdminHashSubmitBlock;
