...
abstract contract GovernorCompatibilityBravoUpgradeable is Initializable, IGovernorTimelockUpgradeable, IGovernorCompatibilityBravoUpgradeable, GovernorUpgradeable {
    ...
    ) public virtual override(IGovernorUpgradeable, GovernorUpgradeable) onlyInitializing returns (uint256) {
    ...
    function propose(
        ...
        bytes[] memory calldatas,
        string memory description
    ) public virtual override onlyInitializing returns (uint256) {
     ...
     */
    function queue(uint256 proposalId) public virtual override onlyInitializing {
     ...
     */
    function execute(uint256 proposalId) public payable virtual override onlyInitializing {
        ProposalDetails storage details = _proposalDetails[proposalId];
        execute(
            details.targets,
            details.values,
    ...
    function cancel(uint256 proposalId) public virtual override onlyInitializing {
        ProposalDetails storage details = _proposalDetails[proposalId];
