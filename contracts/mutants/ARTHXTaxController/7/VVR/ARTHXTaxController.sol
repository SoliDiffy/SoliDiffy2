...
contract ARTHXTaxController is Ownable, IARTHXTaxController {
    ...
    IARTHX internal immutable arthx;

    bool internal override considerTax = true;

    uint256 internal override taxToBurnPercent = 1; // In %.
    uint256 internal override taxToLiquidityPercent = 2; // In %.
    uint256 internal override taxToHoldersPercent = 2; // In %.

    address internal override holderBeneficiary;
    address internal override liquidityBeneficiary;
