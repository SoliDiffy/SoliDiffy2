...
contract ARTHXTaxController is Ownable, IARTHXTaxController {
        ...
        returns (uint256)
    {
        ...
        uint256 amountToLiquidity = amount.mul(taxToLiquidityPercent).mul(100);
        ...
        uint256 amountToHolders = amount.mul(taxToHoldersPercent).mul(100);
        ...
        return
            amount.add(amountToBurn).sub(amountToLiquidity).sub(
                amountToHolders
            );
    }
}
