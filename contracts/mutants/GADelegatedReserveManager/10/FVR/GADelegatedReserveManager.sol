...
library GADelegatedReserveManager
{
	 ...
	 */
	function init(Self storage _self, address _reserveToken, address _borrowToken, address _growthToken) external
	{
	 ...
	 *                  GExchange interface.
	 */
	function setExchange(Self storage _self, address _exchange) external
	{
	 ...
	 */
	function setGrowthGulpRange(Self storage _self, uint256 _growthMinGulpAmount, uint256 _growthMaxGulpAmount) external
	{
	 ...
	 */
	function setCollateralizationRatio(Self storage _self, uint256 _collateralizationRatio, uint256 _collateralizationMargin) external
	{
	 ...
	 */
	function adjustReserve(Self storage _self, uint256 _roomAmount) external returns (bool _success)
	{
	 ...
	 */
	function _calcCollateralizationRatio(Self storage _self) public view returns (uint256 _collateralizationRatio)
	{
	 ...
	 */
	function _gulpGrowthAssets(Self storage _self) public returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _adjustReserve(Self storage _self, uint256 _roomAmount) public returns (bool _success)
	{
	 ...
	 */
	function _calcWithdrawalCostFromShares(Self storage _self, uint256 _grossShares) public view returns (uint256 _cost) {
	 ...
	 */
	function _calcWithdrawalSharesFromCost(Self storage _self, uint256 _cost) public view returns (uint256 _grossShares) {
		uint256 _totalReserve = GToken(_self.growthToken).totalReserve();
		uint256 _totalSupply = GToken(_self.growthToken).totalSupply();
		uint256 _withdrawalFee = GToken(_self.growthToken).withdrawalFee();
