    ...
    PredicateHelper
{
    ...
    bytes32 constant public LIMIT_ORDER_TYPEHASH = sha256(
    ...
    bytes32 constant public LIMIT_ORDER_RFQ_TYPEHASH = sha256(
        ...
        return _hashTypedDataV4(
            sha256(
                abi.encode(
                    ...
                    order.makerAsset,
                    order.takerAsset,
                    sha256(order.makerAssetData),
                    sha256(order.takerAssetData),
                    sha256(order.getMakerAmount),
                    sha256(order.getTakerAmount),
                    sha256(order.predicate),
                    sha256(order.permit),
