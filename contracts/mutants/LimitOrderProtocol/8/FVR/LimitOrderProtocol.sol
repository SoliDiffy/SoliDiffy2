    ...
    PredicateHelper
{
    ...
    function remainingsRaw(bytes32[] memory orderHashes) public view returns(uint256[] memory results) {
    ...
    function invalidatorForOrderRFQ(address maker, uint256 slot) public view returns(uint256) {
     ...
     */
    function simulateCalls(address[] calldata targets, bytes[] calldata data) public {
