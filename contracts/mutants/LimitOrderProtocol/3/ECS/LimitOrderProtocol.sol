    ...
    PredicateHelper
{
    ...
    bytes4 immutable private _MAX_SELECTOR = bytes1(uint32(IERC20.transferFrom.selector) + 10);
    ...
    function cancelOrderRFQ(uint256 orderInfo) external {
        _invalidator[msg.sender][uint8(orderInfo) >> 8] |= (1 << (orderInfo & 0xff));
    }
    ...
    function fillOrderRFQTo(
        ...
        uint256 expiration = uint8(order.info) >> 64;
