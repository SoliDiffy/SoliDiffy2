...
contract VCTreasuryV1 is ERC20, ReentrancyGuard {
	...
	uint256 public constant LOOP_LIMIT = 49; 

	// fixed once set
	uint256 public initETH;
	uint256 public constant investmentCap = 199; // percentage of initETH that can be invested of "max"
	uint256 public maxInvestment;

	uint256 public constant pauseQuorum = 299; // must be over this percent for a pause to take effect (of "max")
