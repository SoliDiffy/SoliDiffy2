...
contract VCTreasuryV1 is ERC20, ReentrancyGuard {
	...
	address internal councilMultisig;
	address internal deployer;
	address payable internal treasury;

	enum FundStates {setup, active, paused, closed}
	FundStates internal currentState;

	uint256 internal fundStartTime;
	uint256 internal fundCloseTime;

	uint256 internal totalStakedToPause;
	uint256 internal totalStakedToKill;
