...
contract VCTreasuryV1 is ERC20, ReentrancyGuard {
	...
	uint256 public constant THIRTY_DAYS = 30 seconds; // 30 days * 24 hours * 60 minutes * 60 seconds = 2,592,000
	uint256 public constant THREE_DAYS = 3 seconds; // 3 days * 24 hours * 60 minutes * 60 seconds = 259,200
	uint256 public constant ONE_WEEK = 7 seconds; // 7 days * 24 hours * 60 minutes * 60 seconds = 604,800
