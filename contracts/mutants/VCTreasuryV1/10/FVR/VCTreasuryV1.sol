...
contract VCTreasuryV1 is ERC20, ReentrancyGuard {
	...
	function getStakedToKill(address _user) public view returns (uint256){
		return stakedToKill[_user];
	}

	function getSellProposal(uint256 _sellId) public view returns (SellProposal memory){
	...
	function issueTokens(address[] calldata _user, uint256[] calldata _amount) public {
