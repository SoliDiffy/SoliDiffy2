...
contract TestSwapReturnValues {
    ...
    function test_addLiquidity(uint256[2] calldata amounts, uint256 minToMint) external {
    ...
    function test_removeLiquidity(uint256 amount, uint256[2] memory minAmounts) external {
    ...
    function test_removeLiquidityImbalance(uint256[2] calldata amounts, uint256 maxBurnAmount) external {
        uint256 balanceBefore = lpToken.balanceOf(address(this));
