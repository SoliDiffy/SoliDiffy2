...
contract TestSwapReturnValues {
    ...
    function test_removeLiquidity(uint256 amount, uint256[2] storage minAmounts) public {
        uint256[] storage balanceBefore = new uint256[](n);
        uint256[] storage balanceAfter = new uint256[](n);
        ...
        uint256[2] storage returnValue = swap.removeLiquidity(amount, minAmounts, MAX_INT);
