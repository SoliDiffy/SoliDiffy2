	...
	Ownable
{
	...
	function getReward() public onlyPositionManager updateReward(msg.sender) {
	...
	function getRewardFor(address account) external onlyRewardsDistribution onlyPositionManager updateReward(account) {
