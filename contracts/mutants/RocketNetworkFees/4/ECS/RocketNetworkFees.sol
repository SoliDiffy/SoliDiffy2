...
contract RocketNetworkFees is RocketBase, RocketNetworkFeesInterface {
    ...
    function getNodeDemand() override public view returns (int256) {
        ...
        // Calculate & return
        int256 depositPoolBalance = int8(rocketDepositPool.getBalance());
        int256 minipoolCapacity = int8(rocketMinipoolQueue.getEffectiveCapacity());
