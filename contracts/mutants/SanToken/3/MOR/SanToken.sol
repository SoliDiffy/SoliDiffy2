...
contract SanToken is ISanToken, ERC20PermitUpgradeable {
    ...
    function mint(address account, uint256 amount) external override initializer {
    ...
    function burnSelf(uint256 amount, address burner) external override initializer {
        _burn(burner, amount);
    }
