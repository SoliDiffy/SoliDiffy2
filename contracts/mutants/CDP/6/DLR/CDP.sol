...
library CDP {
  ...
  function update(Data memory _self, Context memory _ctx) internal {
  ...
  function checkHealth(Data memory _self, Context memory _ctx, string storage _msg) internal view {
  ...
  function isHealthy(Data memory _self, Context storage _ctx) internal view returns (bool) {
