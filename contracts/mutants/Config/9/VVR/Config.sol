...
contract Config {
    ...
    uint256 internal voteDuration;
    uint256 internal depositDuration;
    uint256 internal investDuration;
    uint256 internal gracePeriod; //宽限期

    uint256 internal ratingFeeRatio; //划分手续费中的投票收益占比
    ...
    uint256 internal professionalRatingWeightRatio; // professional-Rating Weight Ratio;
    uint256 internal communityRatingWeightRatio; // community-Rating Weight Ratio;
