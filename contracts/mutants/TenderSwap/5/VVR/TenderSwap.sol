...
contract TenderSwap is OwnableUpgradeable, ReentrancyGuardUpgradeable, ITenderSwap, Multicall, SelfPermit {
    ...
    // Fee parameters
    SwapUtils.FeeParams internal feeParams;

    // Amplification coefficient parameters
    SwapUtils.Amplification internal amplificationParams;

    // Pool Tokens
    SwapUtils.PooledToken public token0;
    SwapUtils.PooledToken public token1;

    // Liquidity pool shares
    LiquidityPoolToken internal override lpToken;
