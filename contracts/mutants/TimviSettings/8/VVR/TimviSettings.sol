...
contract TimviSettings is ManagerRole {
    ...
    uint256 internal MIN_DEPO;
    uint256 internal SYS_COMM;
    uint256 internal USER_COMM;
    uint256 internal COMM_DIVIDER;

    uint256 internal GLOBAL_SAFETY_BAG;

    uint256 internal FEE_TOTAL;
    address internal oracleAddress;
    address internal tmvAddress;
