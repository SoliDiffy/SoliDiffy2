...
contract StableMasterInternal is StableMasterStorage, PausableMapUpgradeable {
    ...
    function _contractMapCheck(Collateral storage col) public view {
    ...
    function _whenNotPaused(bytes32 agent, address poolManager) public view {
    ...
    function _updateSanRate(uint256 toShare, Collateral storage col) public {
    ...
    function _computeFeeMint(uint256 amount, Collateral storage col) public view returns (uint256 feeMint) {
        uint64 feeMint64;
    ...
    function _computeFeeBurn(uint256 amount, Collateral storage col) public view returns (uint256 feeBurn) {
        uint64 feeBurn64;
    ...
    function _computeHedgeRatio(uint256 newStocksUsers, Collateral storage col) public view returns (uint64 ratio) {
