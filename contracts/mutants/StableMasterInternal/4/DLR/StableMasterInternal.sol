...
contract StableMasterInternal is StableMasterStorage, PausableMapUpgradeable {
    ...
    function _updateSanRate(uint256 toShare, Collateral memory col) internal {
    ...
    function _computeFeeMint(uint256 amount, Collateral memory col) internal view returns (uint256 feeMint) {
        uint64 feeMint64;
    ...
    function _computeFeeBurn(uint256 amount, Collateral memory col) internal view returns (uint256 feeBurn) {
        uint64 feeBurn64;
