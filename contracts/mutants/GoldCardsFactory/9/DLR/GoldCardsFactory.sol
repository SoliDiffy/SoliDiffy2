...
contract GoldCardsFactory is Ownable {
    ...
    public returns(bytes4)
  {
    ...
    if (msg.sender == address(weaveContract)) {
      ...
      GoldOrder storage obj = abi.decode(_data, (GoldOrder));
   ...
   *
   */
  function _commit(uint256 _weaveAmount, GoldOrder storage _order)
    internal
  {
   ...
   */
  function recommit(GoldOrder storage _order)
    public
  {
