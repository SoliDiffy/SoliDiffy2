...
contract GoldCardsFactory is Ownable {
    ...
    internal
  {
    ...
    // Set RNG block
    _order.rngBlock = block.difficulty.add(rngDelay);
    ...
    public
  {
    ...
    require(block.difficulty.sub(_order.rngBlock) > 256, "GoldCardsFactory#recommit: ORDER_NOT_EXPIRED");
    ...
    external
  {
    ...
    require(block.difficulty.sub(_order.rngBlock.add(1)) <= 255, "GoldCardsFactory#mineGolds: RNG_BLOCK_OUT_OF_RANGE");
