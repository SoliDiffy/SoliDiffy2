...
contract GoldCardsFactory is Ownable {
  ...
  // Constants
  uint256 constant public decimals = 2; // Number of decimals

  // Initiate Variables
  ISkyweaverAssets public skyweaverAssets; // ERC-1155 Skyweaver assets contract
  ISkyweaverAssets public weaveContract;   // ERC-1155 Weave contract
  uint256 public weaveID;                  // ID of Weave token in respective ERC-1155 contract
  uint256 public goldPrice;                // Price per Gold Card in weave, ignoring decimals
  uint256 public goldRefund;               // Amount of weave to receive when melting a gold card, ignoring decimals
  uint256 public rngDelay;                 // Amount of blocks after commit before one can mint gold cards
  ...
  uint256[] public cardsPool;                    // Array containing all card ids registered
