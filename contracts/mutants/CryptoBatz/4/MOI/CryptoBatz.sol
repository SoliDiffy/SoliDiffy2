  ...
  SutterTreasury
{
  ...
  function buyPublic(uint256 numberOfTokens) external payable onlyOwner {
  ...
  function mintAncientBatz(address to, uint256 ancientBatzId) external onlyOwner {
  ...
  function mint(address to, uint256 numberOfTokens) private onlyOwner {
