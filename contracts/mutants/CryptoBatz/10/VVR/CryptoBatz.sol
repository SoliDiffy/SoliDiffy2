  ...
  SutterTreasury
{
  ...
  uint32 internal constant MAX_OWNER_RESERVE = 101;
  uint32 internal constant ANCIENT_BATZ_SUPPLY = 99;
  ...
  PresaleConfig internal presaleConfig;
  DutchAuctionConfig internal dutchAuctionConfig;

  string internal baseURI;
  address internal whitelistSigner;
  address internal ancientBatzMinter;

  uint256 internal PROVENANCE_HASH;
  uint256 internal randomizedStartIndex;
