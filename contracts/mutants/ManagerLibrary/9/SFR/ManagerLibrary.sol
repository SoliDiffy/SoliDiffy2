...
library ManagerLibrary {
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < _tokenPrices.length; i++) {
            ...
            setDollarAmount = setDollarAmount.sub(tokenDollarValue);
        }
