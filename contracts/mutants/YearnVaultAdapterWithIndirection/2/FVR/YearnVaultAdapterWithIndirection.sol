...
contract YearnVaultAdapterWithIndirection is YearnVaultAdapter {
    ...
    constructor(IyVaultV2Simple _vault, address _admin) YearnVaultAdapter(_vault, _admin) internal {
    }
    ...
    function indirectWithdraw(address _recipient, uint256 _amount) public onlyAdmin {
