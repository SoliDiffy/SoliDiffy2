...
contract OwnableContract {
    ...
    function transferOwnership(address _pendingOwner) public onlyPendingOwner {
        emit NewPendingOwner(pendingOwner, _pendingOwner);
        pendingOwner = _pendingOwner;
    }

    function renounceOwnership() public virtual onlyPendingOwner {
    ...
    function setAdmin(address newAdmin) public onlyPendingOwner {
