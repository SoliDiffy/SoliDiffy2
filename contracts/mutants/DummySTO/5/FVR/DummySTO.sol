...
contract DummySTO is DummySTOStorage, STO {
     ...
     */
    function configure(uint256 _startTime, uint256 _endTime, uint256 _cap, string memory _someString) external onlyFactory {
     ...
     */
    function generateTokens(address _investor, uint256 _amount) external withPerm(ADMIN) {
     ...
     */
    function getNumberInvestors() external view returns(uint256) {
