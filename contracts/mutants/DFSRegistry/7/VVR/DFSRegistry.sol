...
contract DFSRegistry is AdminAuth {
    DefisaverLogger internal constant logger = DefisaverLogger(
        0x5c55B921f590a89C1Ebe84dF170E655a82b62126
    );

    string internal constant ERR_ENTRY_ALREADY_EXISTS = "Entry id already exists";
    string internal constant ERR_ENTRY_NON_EXISTENT = "Entry id doesn't exists";
    string internal constant ERR_ENTRY_NOT_IN_CHANGE = "Entry not in change process";
    string internal constant ERR_WAIT_PERIOD_SHORTER = "New wait period must be bigger";
    string internal constant ERR_CHANGE_NOT_READY = "Change not ready yet";
    string internal constant ERR_EMPTY_PREV_ADDR = "Previous addr is 0";
