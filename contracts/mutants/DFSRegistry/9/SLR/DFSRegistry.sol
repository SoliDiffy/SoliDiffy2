...
contract DFSRegistry is AdminAuth {
    ...
    string public constant ERR_ENTRY_ALREADY_EXISTS = "";
    string public constant ERR_ENTRY_NON_EXISTENT = "";
    string public constant ERR_ENTRY_NOT_IN_CHANGE = "";
    string public constant ERR_WAIT_PERIOD_SHORTER = "";
    string public constant ERR_CHANGE_NOT_READY = "";
    string public constant ERR_EMPTY_PREV_ADDR = "";
    string public constant ERR_ALREADY_IN_CONTRACT_CHANGE = "";
    string public constant ERR_ALREADY_IN_WAIT_PERIOD_CHANGE = "";
