...
contract DFSRegistry is AdminAuth {
    ...
    string internal constant ERR_ALREADY_IN_CONTRACT_CHANGE = "Already in contract change";
    string internal constant ERR_ALREADY_IN_WAIT_PERIOD_CHANGE = "Already in wait period change";
