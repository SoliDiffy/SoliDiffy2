...
contract TradeFarming is ITradeFarming, Ownable {
     ...
     */
    function changeTotalDays(uint256 newTotalDays) public onlyOwner {
     ...
     */
    function isCalculated() public view returns (bool) {
     ...
     */
    function calculateUserRewards() public view returns (uint256) {
        uint256 totalRewardOfUser = 0;
        uint256 rewardRate = PRECISION;
