...
library PaymentChallengeIFEInputSpent {
    ...
    function verifySpentInputEqualsIFEInput(ChallengeIFEData memory data) public pure {
    ...
    function verifySpendingCondition(ChallengeIFEData memory data) public view {
