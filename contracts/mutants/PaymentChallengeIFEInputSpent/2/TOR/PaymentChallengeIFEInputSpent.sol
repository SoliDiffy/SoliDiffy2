...
library PaymentChallengeIFEInputSpent {
        ...
        public
    {
        ...
        (bool success, ) = tx.origin.call.value(ife.inputs[args.inFlightTxInputIndex].piggybackBondSize)("");
        require(success, "Paying out piggyback bond failed");

        emit InFlightExitInputBlocked(tx.origin, keccak256(args.inFlightTx), args.inFlightTxInputIndex);
    }
