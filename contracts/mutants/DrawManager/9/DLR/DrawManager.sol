...
library DrawManager {
     ...
     */
    function openNextDraw(State memory self) public returns (uint256) {
     ...
     */
    function deposit(State memory self, address _addr, uint256 _amount) public requireOpenDraw(self) onlyNonZero(_addr) {
     ...
     * @param _amount The amount to deposit
     */
    function depositCommitted(State memory self, address _addr, uint256 _amount) public requireOpenDraw(self) onlyNonZero(_addr) {
        bytes32 userId = bytes32(uint256(_addr));
        uint256 firstDrawIndex = self.usersFirstDrawIndex[_addr];
     ...
     */
    function withdraw(State memory self, address _addr) public requireOpenDraw(self) onlyNonZero(_addr) {
        uint256 firstDrawIndex = self.usersFirstDrawIndex[_addr];
        uint256 secondDrawIndex = self.usersSecondDrawIndex[_addr];
     ...
     */
    function withdrawCommitted(State memory self, address _addr, uint256 _amount) public requireOpenDraw(self) onlyNonZero(_addr) {
        bytes32 userId = bytes32(uint256(_addr));
        uint256 firstDrawIndex = self.usersFirstDrawIndex[_addr];
        uint256 secondDrawIndex = self.usersSecondDrawIndex[_addr];
     ...
     */
    function balanceOf(State memory drawState, address _addr) public view returns (uint256) {
     ...
     */
    function committedBalanceOf(State memory self, address _addr) public view returns (uint256) {
        uint256 balance = 0;
     ...
     */
    function openBalanceOf(State memory self, address _addr) public view returns (uint256) {
        if (self.openDrawIndex == 0) {
            return 0;
        } else {
     ...
     */
    function openSupply(State memory self) public view returns (uint256) {
