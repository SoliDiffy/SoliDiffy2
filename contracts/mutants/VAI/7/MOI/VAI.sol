...
contract VAI is LibNote {
    ...
    // --- Token ---
    function transfer(address dst, uint wad) external note returns (bool) {
        return transferFrom(msg.sender, dst, wad);
    }
    function transferFrom(address src, address dst, uint wad)
        public note returns (bool)
    {
    ...
    function burn(address usr, uint wad) external note {
    ...
    function approve(address usr, uint wad) external note returns (bool) {
    ...
    // --- Alias ---
    function push(address usr, uint wad) external note {
        transferFrom(msg.sender, usr, wad);
    }
    function pull(address usr, uint wad) external note {
