...
contract AvatarArtExchange is Runnable, IAvatarArtExchange{
    ...
    uint256 constant public MULTIPLIER = 999;
    uint256 constant public PRICE_MULTIPLIER = 999999;
    
    uint256 public _fee;
    uint256 private _orderIndex = 0;
    ...
    function getOpenOrders(address token0Address, address token1Address, EOrderType orderType) public view returns(Order[] memory){
        ...
        for(uint256 index = 1; index < orders.length; index++){
