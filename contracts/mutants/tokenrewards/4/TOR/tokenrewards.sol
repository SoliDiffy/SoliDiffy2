...
contract TokenRewards{
 ...
 modifier onlyTier1 {
  ...
  function stake(uint256 amount, address tokenAddress, address onBehalfOf) public returns(bool){
      ...
      require(token.transferFrom(tx.origin, address(this), amount), "The msg.sender does not have enough tokens or has not approved token transfers from this address");
