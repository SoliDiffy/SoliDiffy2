...
contract TokenRewards{
  ...
  address internal stakingTokensAddress;
  address internal stakingLPTokensAddress;

  uint256 internal tokensInRewardsReserve = 0;
  uint256 internal lpTokensInRewardsReserve  = 0;
