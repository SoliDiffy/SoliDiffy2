...
contract TokenRewards{
 ...
 modifier onlyTier1 {
  ...
  function unstakeAndClaimDelegated(address onBehalfOf, address tokenAddress, address recipient) public onlyOwner returns (uint256) {
    ...
    function adminEmergencyWithdrawTokens(address token, uint amount, address payable destination) public onlyTier1 returns(bool) {
