...
contract VotingCheckpoint is VotingCheckpointStorage, ICheckpoint, IVoting, Module {
     ...
     */
    function changeDefaultExemptedVotersListMulti(address[] memory _voters, bool[] memory _exempts) external withPerm(ADMIN) {
    ...
    function _changeDefaultExemptedVotersList(address _voter, bool _exempt) public {
