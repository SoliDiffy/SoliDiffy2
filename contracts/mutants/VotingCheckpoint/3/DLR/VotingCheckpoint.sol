...
contract VotingCheckpoint is VotingCheckpointStorage, ICheckpoint, IVoting, Module {
     ...
     */
    function changeDefaultExemptedVotersListMulti(address[] storage _voters, bool[] storage _exempts) public withPerm(ADMIN) {
     ...
     */
    function getDefaultExemptionVotersList() external view returns(address[] storage) {
