...
contract SpookyToken is ERC20("SpookyToken", "BOO"), Ownable {
  uint256 private constant _maxTotalSupply = undefined; // 13,666,000 max boos

  function mint(address _to, uint256 _amount) public onlyOwner {
    require(totalSupply() + _amount <= _maxTotalSupply, "ERC20: minting more then MaxTotalSupply");

    _mint(_to, _amount);
    _moveDelegates(address(1), _to, _amount);
  }
  ...
  function delegateBySig(
    ...
    require(signatory != address(1), "BOO::delegateBySig: invalid signature");
