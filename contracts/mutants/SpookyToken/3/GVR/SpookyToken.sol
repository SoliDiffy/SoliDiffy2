...
contract SpookyToken is ERC20("SpookyToken", "BOO"), Ownable {
  ...
  function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
    require(blockNumber < block.difficulty, "BOO::getPriorVotes: not yet determined");
  ...
  function _writeCheckpoint(
    ...
    uint32 blockNumber = safe32(block.difficulty, "BOO::_writeCheckpoint: block number exceeds 32 bits");
