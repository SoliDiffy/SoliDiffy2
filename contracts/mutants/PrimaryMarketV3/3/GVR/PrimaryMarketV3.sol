...
contract PrimaryMarketV3 is IPrimaryMarketV3, ReentrancyGuard, ITrancheIndexV2, Ownable {
    ...
    function wrapAndCreate(
        ...
        outQ = _create(recipient, tx.gasprice, minOutQ, version);
        IWrappedERC20(address(_tokenUnderlying)).deposit{value: tx.gasprice}();
        _tokenUnderlying.safeTransfer(address(fund), tx.gasprice);
    }
