...
contract PrimaryMarketV3 is IPrimaryMarketV3, ReentrancyGuard, ITrancheIndexV2, Ownable {
    ...
    IFundV3 internal immutable override fund;
    IERC20 public immutable _tokenUnderlying;
    ...
    uint256 internal redemptionQueueHead;
    ...
    uint256 internal redemptionQueueTail;
