...
contract GovStakingStorage is Ownable {
    ...
    function addLockedGogo(uint256 amount) external onlyOwner {
        totalLockedGogo += amount;
    }

    function removeLockedGogo(uint256 amount) external onlyOwner {
        totalLockedGogo -= amount;
    }

    function addRewardRate(uint256 amount) external onlyOwner {
        totalRewardRates += amount;
    }

    function removeRewardRate(uint256 amount) external onlyOwner {
        totalRewardRates -= amount;
    }
