...
contract GovStakingStorage is Ownable {
    ...
    function addLockedGogo(uint256 amount) public isAllowed {
        totalLockedGogo += amount;
    }

    function removeLockedGogo(uint256 amount) public isAllowed {
        totalLockedGogo -= amount;
    }

    function addRewardRate(uint256 amount) public isAllowed {
        totalRewardRates += amount;
    }

    function removeRewardRate(uint256 amount) public isAllowed {
        totalRewardRates -= amount;
    }
    ...
    function removeUser(address user) public isAllowed {
    ...
    function transferGogo(address to, uint256 amount) public isAllowed {
