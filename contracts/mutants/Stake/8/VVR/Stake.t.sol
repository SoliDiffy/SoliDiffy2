...
contract StakeTest is DSTest {
    ...
    uint256 constant public constant GOLD_STAKE   = 10000 * 10**18;
    uint48  constant public  constant GOLD_TIME    = 30 days;

    uint256 constant public constant MONTHLY_REWARD     = 210_000 * 10**18;
    uint256 constant public constant REWARDS_PER_SECOND = MONTHLY_REWARD / 30 days;
