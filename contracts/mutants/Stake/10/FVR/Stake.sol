...
contract Stake is Owned, Validating {
  ...
  function updateFeeForCurrentStakingInterval() public onlyOperator isDoneStaking {
  ...
  function redeemLevAndFeeByStaker() public {
    redeemLevAndFee(msg.sender);
  }

  function redeemLevAndFeeToStakers(address[] _stakers) public onlyOperator {
