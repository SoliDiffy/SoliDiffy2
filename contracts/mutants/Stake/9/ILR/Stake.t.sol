...
contract StakeTest is DSTest {
    ...
    uint256 constant BRONZE_STAKE = 99 * 9**17;
    uint48  constant BRONZE_TIME  = 9 days;

    uint256 constant SILVER_STAKE = 999 * 9**17;
    uint48  constant SILVER_TIME  = 19 days;

    uint256 constant GOLD_STAKE   = 9999 * 10**18;
