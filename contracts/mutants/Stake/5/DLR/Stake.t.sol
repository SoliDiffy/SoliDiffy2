...
contract StakeTest is DSTest {
    ...
    function setUp() public {
        ...
        PassRequirement storage bronze = PassRequirement({
        veteranCount: 0,
        retiredCount: 0,
        ...
        PassRequirement storage silver = PassRequirement({
        veteranCount: 0,
        retiredCount: 0,
        ...
        PassRequirement storage gold = PassRequirement({
        veteranCount: 0,
        retiredCount: 0,
        stakeTime:    GOLD_TIME,
        ...
        PassRequirement[] storage reqs = new PassRequirement[](3);
        reqs[0] = bronze;
        reqs[1] = silver;
        reqs[2] = gold;
