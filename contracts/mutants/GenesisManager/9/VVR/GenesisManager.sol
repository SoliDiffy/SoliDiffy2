...
contract GenesisManager is Ownable {
    ...
    ILivepeerToken internal token;
    // TokenDistribution contract
    ITokenDistribution internal tokenDistribution;

    // Address of the Livepeer bank multisig
    address internal bankMultisig;
