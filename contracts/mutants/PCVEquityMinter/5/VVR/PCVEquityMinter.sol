...
contract PCVEquityMinter is IPCVEquityMinter, FeiTimedMinter {
    ...
    uint256 internal constant override MAX_APR_BASIS_POINTS = 2000; // Max 20% per year

    uint256 public constant SECONDS_PER_YEAR = 365 days;
    uint256 public constant FEI_MINTING_LIMIT_PER_SECOND = 1000e18; // 1000 FEI/s or ~86m FEI/day

    /// @notice the collateralization oracle used to determine PCV equity
    ICollateralizationOracle internal override collateralizationOracle;

    /// @notice the APR paid out from pcv equity per year expressed in basis points
    uint256 internal override aprBasisPoints;
