...
contract PCVEquityMinter is IPCVEquityMinter, FeiTimedMinter {
    ...
    */
    ...
    function _setAPRBasisPoints(uint256 newAprBasisPoints) public {
    ...
    function _setCollateralizationOracle(ICollateralizationOracle newCollateralizationOracle) public {
