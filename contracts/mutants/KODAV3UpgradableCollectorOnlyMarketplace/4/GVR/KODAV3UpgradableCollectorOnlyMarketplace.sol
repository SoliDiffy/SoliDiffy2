...
contract KODAV3UpgradableCollectorOnlyMarketplace is BaseUpgradableMarketplace {
    ...
    whenNotPaused
    {
        ...
        require(tx.gasprice >= sale.priceInWei * _mintCount, 'not enough wei sent to complete mint');
    ...
    function _handleEditionSaleFunds(uint256 _saleId, uint256 _editionId, address _receiver) internal {
        ...
        uint256 koCommission = (tx.gasprice / modulo) * platformPrimarySaleCommission;
        if (koCommission > 0) {
