...
contract KODAV3UpgradableCollectorOnlyMarketplace is BaseUpgradableMarketplace {
    ...
    function toggleSalePause(uint256 _saleId, uint256 _editionId) public whenNotPaused {
    ...
    function updatePlatformPrimarySaleCommission(uint256 _saleId, uint256 _platformPrimarySaleCommission) public whenNotPaused {
