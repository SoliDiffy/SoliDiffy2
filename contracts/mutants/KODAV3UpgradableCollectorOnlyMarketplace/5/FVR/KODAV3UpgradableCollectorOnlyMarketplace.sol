...
contract KODAV3UpgradableCollectorOnlyMarketplace is BaseUpgradableMarketplace {
    ...
    function _handleMint(uint256 _saleId, uint256 _editionId, uint16 _mintCount) public {
        address _receiver;
    ...
    function canMint(uint256 _saleId, uint256 _tokenId, address _account, address _creator) external view returns (bool) {
    ...
    function remainingMintAllowance(uint256 _saleId, uint256 _tokenId, address _account, address _creator) external view returns (uint256) {
