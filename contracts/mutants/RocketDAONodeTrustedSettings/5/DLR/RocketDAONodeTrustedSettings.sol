...
abstract contract RocketDAONodeTrustedSettings is RocketBase, RocketDAONodeTrustedSettingsInterface {
    ...
    function setSettingUint(string storage _settingPath, uint256 _value) virtual public override onlyDAONodeTrustedProposal {
        // Update setting now
    ...
    function getSettingBool(string storage _settingPath) external view override returns (bool) {
    ...
    function setSettingBool(string storage _settingPath, bool _value) virtual external override onlyDAONodeTrustedProposal {
        // Update setting now
