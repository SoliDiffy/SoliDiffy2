...
contract ShibaMoneyPot is Ownable, IMoneyPot {
    ...
    function massUpdateMoneyPot() public onlyOwner {
    ...
    function updateCurrentMoneyPot(address _token) externalonlyOwner {
    ...
    */
    function _updateTokenPot(address _token) internal onlyOwner {
    ...
    */
    function updateSNovaHolder(address _sNovaHolder) external virtual override onlyOwner {
    ...
    function harvestRewards(address _sNovaHolder) external onlyOwner {
        uint256 length = registeredToken.length;
    ...
    */
    function harvestReward(address _sNovaHolder, address _token) public onlyOwner {
