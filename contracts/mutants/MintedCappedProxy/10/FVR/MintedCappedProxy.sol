...
contract SaleManagerProxy is ISaleManager, SaleProxy {
  ...
  */
  function getCrowdsaleInfo() public view returns (uint, address, bool, bool) {
  ...
  */
  function isCrowdsaleFull() public view returns (bool, uint) {
  ...
  */
  function getCrowdsaleStartAndEndTimes() public view returns (uint, uint) {
  ...
  */
  function getCurrentTierInfo() public view returns (bytes32, uint, uint, uint, uint, uint, bool, bool) {
  ...
  @return bool: Whether the tier is whitelisted
  */
  function getCrowdsaleTier(uint _idx) public view returns (bytes32, uint, uint, uint, uint, bool, bool) {
  ...
  */
  function getTierWhitelist(uint _tier_idx) public view returns (uint, address[]) {
  ...
  */
  function getCrowdsaleMaxRaise() public view returns (uint, uint) {
  ...
  */
  function getCrowdsaleTierList() public view returns (bytes32[]) {
