...
contract Zunami is Context, Ownable, ERC20 {
    ...
    event PendingDepositEvent(address depositor, uint256[2] amounts);
    event Deposited(address depositor, uint256[2] amounts, uint256 lpShares);
    event Withdrawn(address withdrawer, uint256[2] amounts, uint256 lpShares);
