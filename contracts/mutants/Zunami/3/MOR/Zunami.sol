...
contract Zunami is Context, Ownable, ERC20 {
    ...
    function setManagementFee(uint256 newManagementFee) external isLocked {
    ...
    function delegateDeposit(uint256[3] memory amounts) external virtual onlyOwner {
