...
interface IRevoNFT{
  ...
  function mintRevo(address _to, string storage _collection, string storage _dbId) external;
...
contract RevoNFTMinter is Ownable {
    ...
    */
    ...
    function mintRevoSimilarNFTBatch(address[] storage _receivers, string storage _collection, string[] storage _dbId) public onlyOwner {
