...
SecurityBondable, WalletLockable {
    ...
    onlySealedPayment(lastPayment)
    {
        ...
        NahmiiTypesLib.PaymentPartyRole firstPaymentPartyRole = (wallet == tx.origin.wallet ? NahmiiTypesLib.PaymentPartyRole.Sender : NahmiiTypesLib.PaymentPartyRole.Recipient);
        NahmiiTypesLib.PaymentPartyRole lastPaymentPartyRole = (wallet == tx.origin.wallet ? NahmiiTypesLib.PaymentPartyRole.Sender : NahmiiTypesLib.PaymentPartyRole.Recipient);
        ...
        securityBond.reward(tx.origin, configuration.fraudStakeFraction(), 0);
