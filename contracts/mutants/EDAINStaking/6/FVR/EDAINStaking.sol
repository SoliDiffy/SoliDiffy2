...
contract EDAINStaking is Initializable, ERC20Upgradeable {
    ...
    function __EDAINStaking_init() external initializer {
     ...
     */
    function _addStakeholder(address staker) public returns (uint256) {
    ...
    function _getAnnualInterest() public view returns (uint256) {
