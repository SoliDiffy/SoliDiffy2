...
contract BalancerLBPSwapper is IPCVSwapper, OracleRef, Timed, WeightedBalancerPoolManager {
    ...
    */
    ...
    function setMinTokenSpent(uint256 newMinTokenSpentBalance) external WeightedBalancerPoolManager() {
    ...
    function setReceivingAddress(address newTokenReceivingAddress) external override WeightedBalancerPoolManager() {
