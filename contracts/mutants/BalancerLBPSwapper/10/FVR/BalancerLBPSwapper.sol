...
contract BalancerLBPSwapper is IPCVSwapper, OracleRef, Timed, WeightedBalancerPoolManager {
    ...
    */
    ...
    function _getTokensIn(uint256 spentTokenBalance) public view returns(uint256[] memory amountsIn) {
    ...
    function _setMinTokenSpent(uint256 newMinTokenSpentBalance) public {
