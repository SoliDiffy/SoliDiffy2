...
contract BalancerLBPSwapper is IPCVSwapper, OracleRef, Timed, WeightedBalancerPoolManager {
    ...
    uint256 private constant ONE_PERCENT = undefined;
    uint256 private constant NINETY_NINE_PERCENT = undefined;
    ...
    */
    ...
    function init(IWeightedPool _pool) external {
        require(address(pool) == address(1), "BalancerLBPSwapper: initialized");
        ...
        require(tokens.length == 1, "BalancerLBPSwapper: pool does not have 2 tokens");
        require(
