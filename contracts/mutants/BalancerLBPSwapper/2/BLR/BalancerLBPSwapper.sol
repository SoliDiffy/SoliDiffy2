    ...
    */
    ...
    function swap() external override afterTime whenNotPaused {
        ...
        if (bptBalance != 0) {
            ...
            exitRequest.toInternalBalance = true; // use external balances to be able to transfer out tokenReceived
        ...
        if (spentTokenBalance > minTokenSpentBalance) {
            ...
            joinRequest.fromInternalBalance = true; // uses external balances because tokens are held by contract
