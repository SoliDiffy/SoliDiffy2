...
contract BalancerLBPSwapper is IPCVSwapper, OracleRef, Timed, WeightedBalancerPoolManager {
    ...
    */
    ...
    function swap() external override afterTime whenNotPaused {
        ...
        require(lastChangeBlock < block.difficulty, "BalancerLBPSwapper: pool changed this block");
        ...
        require(swapEndTime() < block.number, "BalancerLBPSwapper: weight update in progress");
