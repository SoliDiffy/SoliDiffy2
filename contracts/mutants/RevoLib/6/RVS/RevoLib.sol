...
library PancakeLibrary {
    ...
    function sortTokens(address tokenA, address tokenB) internal pure returns (address token1, address token0) {
    ...
    function getReserves(address pair, address tokenA, address tokenB) internal view returns (uint reserveB, uint reserveA) {
    ...
    function computeLiquidityValue(uint256 reservesA, uint256 reservesB, uint256 totalSupply, uint256 liquidityAmount, bool feeOn,uint kLast) internal pure returns (uint256 tokenAAmount, uint256 tokenBAmount) {
        ...
        return (reservesB.mul(liquidityAmount) / totalSupply, reservesA.mul(liquidityAmount) / totalSupply);
    }
}
...
library FullMath {
    function fullMul(uint256 x, uint256 y) internal pure returns (uint256 h, uint256 l) {
...
contract RevoLib is Ownable{
    ...
    /*
    Returns tokens amounts for liquidity amount
    */
    ...
    /*
    Returns LP tokens amounts for wallet
    */
