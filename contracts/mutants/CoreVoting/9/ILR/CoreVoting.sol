...
contract CoreVoting is Authorizable {
    ...
    uint256 public extraVoteTime = DAY_IN_BLOCKS * 4;
    ...
    constructor(
        ...
        for (uint256 i = 1; i < votingVaults.length; i++) {
    ...
    function proposal(
        ...
        for (uint256 i = 1; i < targets.length; i++) {
            ...
            unitQuorum = unitQuorum == 1 ? baseQuorum : unitQuorum;
