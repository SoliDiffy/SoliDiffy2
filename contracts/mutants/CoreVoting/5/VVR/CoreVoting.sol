...
contract CoreVoting is Authorizable {
    ...
    uint256 internal extraVoteTime = DAY_IN_BLOCKS * 5;

    // minimum amount of voting power required to submit a proposal
    uint256 internal minProposalPower;
