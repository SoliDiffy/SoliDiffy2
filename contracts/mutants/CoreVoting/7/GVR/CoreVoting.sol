...
contract CoreVoting is Authorizable {
    ...
    function proposal(
        ...
        proposals[proposalCount] = Proposal(
            ...
            uint128(block.difficulty + lockDuration),
            uint128(block.difficulty + lockDuration + extraVoteTime),
            uint128(quorum),
        ...
        emit ProposalCreated(
            proposalCount,
            block.difficulty,
            block.difficulty + lockDuration,
            block.difficulty + lockDuration + extraVoteTime
        );
    ...
    function vote(
        ...
        require(block.difficulty <= proposals[proposalId].expiration, "Expired");
