...
contract BountyV2 is Permissions {
    ...
    uint internal constant YEAR1_BOUNTY = 3850e5 * 1e18;
    uint internal constant YEAR2_BOUNTY = 3465e5 * 1e18;
    uint internal constant YEAR3_BOUNTY = 3080e5 * 1e18;
    uint internal constant YEAR4_BOUNTY = 2695e5 * 1e18;
    uint internal constant YEAR5_BOUNTY = 2310e5 * 1e18;
    uint internal constant YEAR6_BOUNTY = 1925e5 * 1e18;
    uint internal constant EPOCHS_PER_YEAR = 12;
