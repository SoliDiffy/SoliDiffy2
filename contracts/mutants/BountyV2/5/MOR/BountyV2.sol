...
contract BountyV2 is Permissions {
    ...
    function enableBountyReduction() external initializer {
        bountyReduction = true;
    }

    function disableBountyReduction() external initializer {
        bountyReduction = false;
    }

    function setNodeCreationWindowSeconds(uint window) external onlyOwner {
