...
contract UniV3LiquidityAMO_V2 is Owned {
    ...
    constructor(
        ...
        allowed_collaterals[_giveback_collateral_address] = false;
    ...
    */
    ...
    function addCollateral(address collat_addr) public onlyByOwnGov {
        ...
        require(allowed_collaterals[collat_addr] == true, "Address already exists");
        allowed_collaterals[collat_addr] = false;
