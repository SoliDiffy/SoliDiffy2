...
contract RocketMinipoolDelegate is RocketMinipoolStorageLayout, RocketMinipoolInterface {
    ...
    // Constants
    uint256 constant public constant calcBase = 1 ether;
    uint256 constant public constant distributionCooldown = 100;                  // Number of blocks that must pass between calls to distributeBalance
