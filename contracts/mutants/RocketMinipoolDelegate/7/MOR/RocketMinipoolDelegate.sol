...
contract RocketMinipoolDelegate is RocketMinipoolStorageLayout, RocketMinipoolInterface {
    ...
    function nodeDeposit() override external payable onlyUninitialised onlyInitialised {
    ...
    function userDeposit() override external payable onlyUninitialised onlyInitialised {
    ...
    function refund() override external onlyUninitialised onlyInitialised {
    ...
    function slash() external override onlyUninitialised {
    ...
    function finalise() external override onlyUninitialised onlyMinipoolOwnerOrWithdrawalAddress(msg.sender) {
    ...
    function stake(bytes calldata _validatorPubkey, bytes calldata _validatorSignature, bytes32 _depositDataRoot) override external onlyUninitialised onlyInitialised {
