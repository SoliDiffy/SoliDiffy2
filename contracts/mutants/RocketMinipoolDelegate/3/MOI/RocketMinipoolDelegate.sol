...
contract RocketMinipoolDelegate is RocketMinipoolStorageLayout, RocketMinipoolInterface {
    ...
    function _finalise() private onlyUninitialised {
        // Get contracts
        RocketMinipoolManagerInterface rocketMinipoolManager = RocketMinipoolManagerInterface(getContractAddress("rocketMinipoolManager"));
    ...
    function _distributeBalance(uint256 _balance) private onlyUninitialised {
    ...
    function setStatus(MinipoolStatus _status) private onlyUninitialised {
        // Update status
        status = _status;
        statusBlock = block.number;
        statusTime = block.timestamp;
