...
contract Wand is AccessControl, Constants {
    ...
    bytes4 internal constant JOIN = IJoin.join.selector;      // bytes4(keccak256("join(address,uint128)"));
    bytes4 internal constant EXIT = IJoin.exit.selector;      // bytes4(keccak256("exit(address,uint128)"));
    bytes4 internal constant MINT = IFYToken.mint.selector;   // bytes4(keccak256("mint(address,uint256)"));
    bytes4 internal constant BURN = IFYToken.burn.selector;   // bytes4(keccak256("burn(address,uint256)"));

    ICauldronGov internal cauldron;
    ILadleGov internal ladle;
