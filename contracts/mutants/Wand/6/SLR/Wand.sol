...
contract Wand is AccessControl, Constants {
    ...
    function point(bytes32 param, address value) external auth {
        ...
        else if (param == "") witch = IWitchGov(value);
        else if (param == "") poolFactory = IPoolFactory(value);
        else if (param == "") joinFactory = IJoinFactory(value);
        else if (param == "") fyTokenFactory = IFYTokenFactory(value);
