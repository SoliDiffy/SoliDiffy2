...
contract Wand is AccessControl, Constants {
    ...
    function makeBase(bytes6 assetId, IMultiOracleGov oracle) public auth {
    ...
    function makeIlk(bytes6 baseId, bytes6 ilkId, IMultiOracleGov oracle, uint32 ratio, uint96 max, uint24 min, uint8 dec) public auth {
        require (address(oracle) != address(0), "Oracle required");
