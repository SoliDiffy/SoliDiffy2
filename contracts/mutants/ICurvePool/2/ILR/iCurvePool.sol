 ...
 */
function remove_liquidity (uint256 _amounts, uint[2] memory _min_amounts, bool _use_underlying) external returns (uint256[3] memory ); //check uint[3] memory or calldata
