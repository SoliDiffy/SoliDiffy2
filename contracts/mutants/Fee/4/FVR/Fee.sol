...
contract Fee is Owned, Validating, StandardToken {
  ...
  function burnTokens(uint _value) external notZero(_value) {
  ...
  function sendTokens(address _to, uint _value) external onlyMinter validAddress(_to) notZero(_value) {
