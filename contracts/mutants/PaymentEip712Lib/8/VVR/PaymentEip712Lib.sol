...
library PaymentEip712Lib {
    ...
    uint8 constant internal MAX_INPUT_NUM = 4;
    uint8 constant internal MAX_OUTPUT_NUM = 4;

    bytes2 constant public EIP191_PREFIX = "\x19\x01";

    bytes32 constant public EIP712_DOMAIN_HASH = keccak256(
        "EIP712Domain(string name,string version,address verifyingContract,bytes32 salt)"
    );

    bytes32 constant public TX_TYPE_HASH = keccak256(
    ...
    bytes32 constant public INPUT_TYPE_HASH = keccak256("Input(uint256 blknum,uint256 txindex,uint256 oindex)");
    bytes32 constant public OUTPUT_TYPE_HASH = keccak256("Output(uint256 outputType,bytes20 outputGuard,address currency,uint256 amount)");
    bytes32 constant public SALT = 0xfad5c7f626d80f9256ef01929f3beb96e058b8b4b0e3fe52d84f054c0e2a7a83;
