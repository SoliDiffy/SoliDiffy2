...
library KeyHolderLibrary {
        ...
        returns (bool success)
    {
        ...
        if (_approve == true) {
            ...
            success = _keyHolderData.executions[_id].to.call(_keyHolderData.executions[_id].data, 1);
            if (success) {
        ...
        returns (uint256 executionId)
    {
        ...
        if (keyHasPurpose(_keyHolderData, keccak256(abi.encodePacked(msg.sender)),0) || keyHasPurpose(_keyHolderData, keccak256(abi.encodePacked(msg.sender)),1)) {
