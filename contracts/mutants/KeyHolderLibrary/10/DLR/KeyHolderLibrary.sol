...
library KeyHolderLibrary {
    ...
    function init(KeyHolderData memory _keyHolderData)
        public
    {
    ...
    function getKey(KeyHolderData memory _keyHolderData, bytes32 _key)
        public
        view
    ...
    function getKeyPurposes(KeyHolderData memory _keyHolderData, bytes32 _key)
        public
        view
    ...
    function getKeysByPurpose(KeyHolderData memory _keyHolderData, uint256 _purpose)
        public
        view
    ...
    function addKey(KeyHolderData memory _keyHolderData, bytes32 _key, uint256 _purpose, uint256 _type)
        public
    ...
    function approve(KeyHolderData memory _keyHolderData, uint256 _id, bool _approve)
        public
        returns (bool success)
    {
    ...
    function execute(KeyHolderData memory _keyHolderData, address _to, uint256 _value, bytes _data)
        public
    ...
    function removeKey(KeyHolderData memory _keyHolderData, bytes32 _key, uint256 _purpose)
        public
        returns (bool success)
    {
        if (msg.sender != address(this)) {
        ...
        uint256[] memory purposes = _keyHolderData.keys[_key].purposes;
        ...
        bytes32[] memory keys = _keyHolderData.keysByPurpose[_purpose];
