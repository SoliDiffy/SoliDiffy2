...
contract FXSOracleWrapper is Owned {
    ...
    function setChainlinkFXSUSDOracle(address _chainlink_fxs_usd_oracle) public onlyByOwnGov {
        priceFeedFXSUSD = AggregatorV3Interface(_chainlink_fxs_usd_oracle);
        chainlink_fxs_usd_decimals = priceFeedFXSUSD.decimals();
    }

    function setChainlinkETHUSDOracle(address _chainlink_eth_usd_oracle) public onlyByOwnGov {
