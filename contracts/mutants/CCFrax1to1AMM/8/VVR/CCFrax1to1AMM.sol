...
contract CCFrax1to1AMM is Owned, ReentrancyGuard {
    ...
    // Instances
    ERC20 internal canFRAX;
    ComboOracle internal combo_oracle; // Standardizes prices ultimately from Chainlink
    CrossChainBridgeBacker internal cc_bridge_backer;
    ...
    // Swap token info
    address[] internal swap_tokens_array;
    ...
    // Misc
    uint256 internal price_tolerance = 50000; // E6. 5000 = .995 to 1.005
