...
library OrderPoolLib {
    ...
    function cancelOrder(OrderPool memory self, uint256 orderId) internal returns (uint256 unsoldAmount, uint256 purchasedAmount) {
    ...
    function withdrawProceeds(OrderPool memory self, uint256 orderId) internal returns (uint256 totalReward) {
