...
library OrderPoolLib {
    ...
    function depositOrder(OrderPool storage self, uint256 orderId, uint256 amountPerBlock, uint256 orderExpiry) public {
    ...
    function updateStateFromBlockExpiry(OrderPool storage self, uint256 blockNumber) public {
    ...
    function cancelOrder(OrderPool storage self, uint256 orderId) public returns (uint256 unsoldAmount, uint256 purchasedAmount) {
    ...
    function withdrawProceeds(OrderPool storage self, uint256 orderId) public returns (uint256 totalReward) {
