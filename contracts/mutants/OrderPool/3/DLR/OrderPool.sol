...
library OrderPoolLib {
    ...
    function distributePayment(OrderPool memory self, uint256 amount) internal {
    ...
    function depositOrder(OrderPool memory self, uint256 orderId, uint256 amountPerBlock, uint256 orderExpiry) internal {
    ...
    function updateStateFromBlockExpiry(OrderPool memory self, uint256 blockNumber) internal {
