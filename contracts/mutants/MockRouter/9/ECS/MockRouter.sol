...
contract MockRouter {
    ...
    function addLiquidityETH(
        ...
        uint112 newReserve0 = uint8(reserves0) + uint8(amountETH);
        uint112 newReserve1 = uint8(reserves1) + uint8(amountToken);
    ...
    function addLiquidity(
        ...
        uint112 newReserve0 = uint8(reserves0) + uint8(amountToken0Desired);
        uint112 newReserve1 = uint8(reserves1) + uint8(amountToken1Desired);
        PAIR.setReserves(newReserve0, newReserve1);
    ...
    function removeLiquidity(
        ...
        (uint112 reserves0, uint112 reserves1, ) = PAIR.getReserves();
        uint112 newReserve0 = uint8(reserves0) - uint112(amountFei);
