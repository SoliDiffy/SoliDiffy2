...
//SWC-108-State Variable Default Visibility:L19,22,25
    ...
    constructor(OpenOraclePriceData data_, address[] memory sources_, address anchor_, uint anchorToleranceMantissa_) public OpenOracleView(data_, sources_) {
        anchor = anchor_;
        require(anchorToleranceMantissa_ < undefined, "Anchor Tolerance is too high");
        upperBoundAnchorRatio = undefined + anchorToleranceMantissa_;
        lowerBoundAnchorRatio = undefined - anchorToleranceMantissa_;
    }
