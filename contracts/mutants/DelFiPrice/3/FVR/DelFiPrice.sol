...
//SWC-108-State Variable Default Visibility:L19,22,25
     ...
     */
    constructor(OpenOraclePriceData data_, address[] memory sources_, address anchor_, uint anchorToleranceMantissa_) internal OpenOracleView(data_, sources_) {
        anchor = anchor_;
     ...
     */
    function postPrices(bytes[] calldata messages, bytes[] calldata signatures, string[] calldata symbols) public {
     ...
     */
    function medianPrice(string memory symbol, address[] memory sources_) external view returns (uint64 median) {
