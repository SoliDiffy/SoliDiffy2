...
contract MockSynthetix is ISynthetix {
    ...
    function setSubtractSourceAmount(uint256 _amount) public {
        subtractSourceAmount = _amount;
    }

    function setSubtractOutputAmount(uint256 _amount) public {
    ...
    function getOrSetToken(bytes32 _currencyKey) external returns(MockToken) {
