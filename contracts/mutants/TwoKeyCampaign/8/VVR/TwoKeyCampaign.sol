...
contract TwoKeyCampaign is ArcERC20 {
	...
	TwoKeyEventSource public twoKeyEventSource; // Address of TwoKeyEventSource contract

	address public twoKeySingletonesRegistry; // Address of Registry of all singleton contracts
	address public twoKeyEconomy; // Address of twoKeyEconomy contract
    ...
    bool public mustConvertToReferr;
