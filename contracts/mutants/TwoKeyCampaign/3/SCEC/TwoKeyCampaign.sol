...
contract TwoKeyCampaign is ArcERC20 {
	...
	returns (address[],address[],uint8[],address)
	{
		...
		return (keys, influencers, weights, old_address);
	}
	...
	{
        return (maxReferralRewardPercent, conversionQuota, isKYCRequired);
    }
	...
	returns (uint,uint)
	{
        return (contractorTotalProceeds, contractorBalance);
    }
