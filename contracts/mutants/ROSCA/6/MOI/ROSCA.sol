...
contract ROSCA {
  ...
  function addMember(address newMember) internal roscaNotEnded {
  ...
  function cleanUpPreviousRound() internal roscaNotEnded {
  ...
  function recalculateTotalFees() roscaNotEnded {
  ...
  function swapWinner(
    uint256 winnerIndex, bool winnerSelectedThroughBid, uint256 indexToSwap) internal roscaNotEnded {
  ...
  function removeFees(uint256 amount) internal roscaNotEnded returns (uint256) {
   ...
   */
  function getContractNetBalance() external constant roscaNotEnded returns(uint256) {
