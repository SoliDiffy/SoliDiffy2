...
contract ROSCA {
  ...
  /**
    ...
    */
  function startRound() onlyFromMember external {
   ...
   */
  function contribute() payable onlyFromForeperson roscaNotEnded onlyIfEscapeHatchInactive external {
   ...
   */
  function bid(uint256 bidInWei) onlyFromForeperson roscaNotEnded onlyIfEscapeHatchInactive external {
   ...
   */
  function withdraw() roscaNotEnded onlyIfEscapeHatchInactive external returns(bool success) {
  ...
  function getParticipantBalance(address user) roscaNotEnded external constant returns(int256) {
   ...
   */
  function endOfROSCARetrieveSurplus() roscaNotEnded roscaEnded external returns (bool) {
   ...
   * does the bookeeping of that round.
   */
  function endOfROSCARetrieveFees() roscaNotEnded roscaEnded external returns (bool) {
   ...
   */
  function enableEscapeHatch() roscaNotEnded external {
   ...
   */
  function activateEscapeHatch() roscaNotEnded external {
   ...
   */
  function emergencyWithdrawal() roscaNotEnded onlyIfEscapeHatchActive {
