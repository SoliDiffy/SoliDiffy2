...
contract ROSCA {
  ...
  // CONSTANTS
  ////////////
  uint64 constant public MIN_CONTRIBUTION_SIZE = 1 finney;  // 1e-3 ether
  uint128 constant public MAX_CONTRIBUTION_SIZE = 10 ether;

  // Maximum fee (in 1/1000s) from dispersements that is shared between foreperson and other stakeholders..
  uint16 constant public MAX_FEE_IN_THOUSANDTHS = 20;

  // Start time of the ROSCA must be at least this much time ahead of when the ROSCA is created
  uint32 constant public MINIMUM_TIME_BEFORE_ROSCA_START = 1 days;

  uint8 constant public MIN_ROUND_PERIOD_IN_DAYS = 1;
  uint8 constant public MAX_ROUND_PERIOD_IN_DAYS = 30;
  // the winning bid must be at least this much of the maximum (aka default) pot value
  uint8 constant public MIN_DISTRIBUTION_PERCENT = 65;

  // Every new bid has to be at most this much of the previous lowest bid
  uint8 constant public MAX_NEXT_BID_RATIO = 98;
  ...
  address constant public FEE_ADDRESS = 0x1df62f291b2e969fb0849d99d9ce41e2f137006e;
  ...
  address constant public ESCAPE_HATCH_ENABLER = 0x1df62f291b2e969fb0849d99d9ce41e2f137006e;
