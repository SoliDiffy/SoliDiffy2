...
contract ROSCA {
  ...
  /**
    ...
    */
  function startRound() roscaNotEnded public {
  ...
  function cleanUpPreviousRound() public {
  ...
  function swapWinner(
    uint256 winnerIndex, bool winnerSelectedThroughBid, uint256 indexToSwap) public {
  ...
  function removeFees(uint256 amount) public returns (uint256) {
   ...
   */
  function contribute() payable onlyFromMember roscaNotEnded onlyIfEscapeHatchInactive public {
   ...
   */
  function bid(uint256 bidInWei) onlyFromMember roscaNotEnded onlyIfEscapeHatchInactive public {
   ...
   */
  function withdraw() onlyFromMember onlyIfEscapeHatchInactive public returns(bool success) {
  ...
  function getParticipantBalance(address user) onlyFromMember public constant returns(int256) {
   ...
   */
  function getContractNetBalance() public constant returns(uint256) {
