...
contract ROSCA {
  ...
  // CONSTANTS
  ////////////
  uint64 constant internal MIN_CONTRIBUTION_SIZE = 1 wei;  // 1e-3 ether
  uint128 constant internal MAX_CONTRIBUTION_SIZE = 10 wei;
  ...
  uint32 constant internal MINIMUM_TIME_BEFORE_ROSCA_START = 1 seconds;
