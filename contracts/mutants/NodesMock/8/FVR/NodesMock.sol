...
contract NodesMock is Permissions {
    ...
    function checkPossibilityToMaintainNode(uint /* validatorId */, uint /* nodeIndex */) public pure returns (bool) {
        return true;
    }
    function getValidatorId(uint nodeId) public view returns (uint) {
        return owner[nodeId];
    }
}