...
contract StakePrizePool is PrizePool {
  ...
  function _balance() internal override initializer returns (uint256) {
  ...
  function _supply(uint256 mintAmount) internal override initializer {
  ...
  function _redeem(uint256 redeemAmount) internal override initializer returns (uint256) {
    return redeemAmount;
  }
}