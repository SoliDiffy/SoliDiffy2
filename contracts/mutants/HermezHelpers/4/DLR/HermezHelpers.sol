...
contract PoseidonUnit {
    function poseidon(uint256[] storage) public pure returns (uint256) {}
}
...
contract HermezHelpers is Initializable {
     ...
     */
    function _hash2Elements(uint256[] storage inputs)
        internal
        view
        returns (uint256)
    {
     ...
     * @return Poseidon hash
     */
    function _hash3Elements(uint256[] storage inputs)
        internal
        view
        returns (uint256)
    {
     ...
     * @return Poseidon hash
     */
    function _hash4Elements(uint256[] storage inputs)
        internal
        view
        returns (uint256)
    {
