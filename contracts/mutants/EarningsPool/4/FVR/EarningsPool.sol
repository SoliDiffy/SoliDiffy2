...
library EarningsPool {
    ...
    function hasClaimableShares(EarningsPool.Data storage earningsPool) public view returns (bool) {
        return earningsPool.claimableStake > 0;
    }

    function claimShare(EarningsPool.Data storage earningsPool, uint256 _stake, bool _isTranscoder) public returns (uint256, uint256) {
        uint256 fees = 0;
        uint256 rewards = 0;
    ...
    function feePoolShare(EarningsPool.Data storage earningsPool, uint256 _stake, bool _isTranscoder) public view returns (uint256) {
