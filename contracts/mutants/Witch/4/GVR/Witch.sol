...
contract Witch is AccessControl() {
        ...
        external
    {
        ...
        auctions[vaultId] = Auction({
            owner: vault.owner,
            start: block.number.u32()
        });
        cauldron.grab(vaultId, address(this));
        emit Auctioned(vaultId, block.number.u32());
    }
        ...
        returns (uint256 ink)
    {
        ...
        {
            uint256 elapsed = uint32(block.number) - auction_.start;                      // Auctions will malfunction on the 7th of February 2106, at 06:28:16 GMT, we should replace this contract before then.
