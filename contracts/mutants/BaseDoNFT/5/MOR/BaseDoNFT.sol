...
contract BaseDoNFT is OwnableContract,ReentrancyGuard,ERC721,IBaseDoNFT {
    ...
    function setIsOnlyNow(bool v) public nonReentrant {
        isOnlyNow = v;
    }
    ...
    function mintWNft(uint256 oid) public onlyAdmin virtual returns(uint256 tid) {
    ...
    function mint(
        ...
        uint64 end,
        address to
    ) public onlyAdmin nonReentrant returns(uint256 tid){
    ...
    function setMaxDuration(uint64 v) public nonReentrant{
        maxDuration = v;
    }
