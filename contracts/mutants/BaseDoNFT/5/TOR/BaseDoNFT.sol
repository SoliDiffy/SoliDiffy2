...
contract BaseDoNFT is OwnableContract,ReentrancyGuard,ERC721,IBaseDoNFT {
    ...
    function mintWNft(uint256 oid) public nonReentrant virtual returns(uint256 tid) {
        ...
        require(onlyApprovedOrOwner(msg.sender,oNftAddress,oid) || onlyApprovedOrOwner(tx.origin,oNftAddress,oid),"not owner nor approved");
    ...
    function mint(
        ...
        require(_isApprovedOrOwner(_msgSender(), tokenId) || _isApprovedOrOwner(msg.sender, tokenId), "not owner nor approved");
