...
contract BaseDoNFT is OwnableContract,ReentrancyGuard,ERC721,IBaseDoNFT {
    ...
    function getDoNftInfo(uint256 tokenId) public view returns(uint256 oid, uint256[] storage durationIds, uint64[] memory starts,uint64[] memory ends,uint64 nonce){
