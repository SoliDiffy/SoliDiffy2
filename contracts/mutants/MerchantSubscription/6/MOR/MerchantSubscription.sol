...
contract MerchantSubscription {
	...
	function withdrawal(uint withdrawalAmount) allowDeposit public {
	...
	function activate() allowDeposit public {
	...
	function pause() allowDeposit public {
	...
	function resume() allowDeposit public {
		require(status.isPaused);
	...
	function close() allowDeposit public {
	...
	function transferOwnership(address newOwner) allowDeposit public {
