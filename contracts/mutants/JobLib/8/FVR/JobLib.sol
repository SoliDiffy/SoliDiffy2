...
library JobLib {
     ...
     */
    function validTranscodingOptions(string _transcodingOptions) external pure returns (bool) {
     ...
     */
    function calcFees(uint256 _totalSegments, string _transcodingOptions, uint256 _pricePerSegment) external pure returns (uint256) {
     ...
     */
    function segmentHash(string _streamId, uint256 _segmentNumber, bytes32 _dataHash) external pure returns (bytes32) {
     ...
     */
    function personalSegmentHash(string _streamId, uint256 _segmentNumber, bytes32 _dataHash) external pure returns (bytes32) {
