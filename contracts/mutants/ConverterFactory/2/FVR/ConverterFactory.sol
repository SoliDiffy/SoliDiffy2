...
contract ConverterFactory is IConverterFactory, Owned {
    ...
    */
    function registerTypedConverterFactory(ITypedConverterFactory _factory) external ownerOnly {
    ...
    */
    function registerTypedConverterAnchorFactory(ITypedConverterAnchorFactory _factory) external ownerOnly {
