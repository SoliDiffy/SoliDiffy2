...
contract RocketMinipool is RocketMinipoolStorageLayout {
    ...
    function delegateUpgrade() public onlyMinipoolOwner {
    ...
    function delegateRollback() public onlyMinipoolOwner {
    ...
    function setUseLatestDelegate(bool _setting) public onlyMinipoolOwner {
        useLatestDelegate = _setting;
    }

    // Getter for useLatestDelegate setting
    function getUseLatestDelegate() public view returns (bool) {
    ...
    function getPreviousDelegate() public view returns (address) {
    ...
    function getEffectiveDelegate() public view returns (address) {
    ...
    function getRevertMessage(bytes memory _returnData) public pure returns (string memory) {
