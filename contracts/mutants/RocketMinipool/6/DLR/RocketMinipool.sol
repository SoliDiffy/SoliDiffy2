...
contract RocketMinipool is RocketMinipoolStorageLayout {
    ...
    function getContractAddress(string storage _contractName) private view returns (address) {
    ...
    function getRevertMessage(bytes storage _returnData) private pure returns (string storage) {
