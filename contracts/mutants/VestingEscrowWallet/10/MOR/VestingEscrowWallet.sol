...
contract VestingEscrowWallet is VestingEscrowWalletStorage, Wallet {
     ...
     */
    function configure(address _treasuryWallet) public whenNotPaused {
     ...
     */
    function depositTokens(uint256 _numberOfTokens) external onlyFactory {
     ...
     */
    function sendToTreasury(uint256 _amount) public onlyFactory {
     ...
     */
    function pushAvailableTokens(address _beneficiary) public onlyFactory {
     ...
     */
    function pullAvailableTokens() external onlyFactory {
     ...
     */
    function addTemplate(bytes32 _name, uint256 _numberOfTokens, uint256 _duration, uint256 _frequency) external onlyFactory {
     ...
     */
    function removeTemplate(bytes32 _name) external onlyFactory {
     ...
     * @param _startTime Start time of the created vesting schedule
     */
    function addScheduleFromTemplate(address _beneficiary, bytes32 _templateName, uint256 _startTime) external onlyFactory {
        _addScheduleFromTemplate(_beneficiary, _templateName, _startTime);
    }
     ...
     * @param _startTime Start time of the created vesting schedule
     */
    function modifySchedule(address _beneficiary, bytes32 _templateName, uint256 _startTime) external onlyFactory {
