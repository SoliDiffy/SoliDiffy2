...
//        Get all the influencers
    ...
    returns (uint,uint,uint,uint[],address)
    {
        ...
        return (referrerPlasmaAddressToCounterOfConversions[_referrerAddress], referrerBalance, referrerPlasma2TotalEarnings2key[_referrerAddress], earnings, _referrerAddress);
    }
    ...
    returns (uint256[], uint256[])
    {
        ...
        return (referrersTotalEarningsPlasmaBalance, referrersPendingPlasmaBalance);
    }
    ...
    {
        return (campaignGoal,campaignStartTime, campaignEndTime, minDonationAmountWei, maxDonationAmountWei);
    }
