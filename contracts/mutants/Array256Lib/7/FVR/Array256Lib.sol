...
library Array256Lib {
  ...
  function sumElements(uint256[] storage self) external view returns(uint256 sum) {
    assembly {
  ...
  function getMax(uint256[] storage self) external view returns(uint256 maxValue) {
    assembly {
      mstore(0x60,self_slot)
  ...
  function getMin(uint256[] storage self) external view returns(uint256 minValue) {
    assembly {
      mstore(0x60,self_slot)
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint256[] storage self) external {
