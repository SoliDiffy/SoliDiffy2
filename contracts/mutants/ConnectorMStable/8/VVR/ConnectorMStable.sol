...
contract ConnectorMStable is IConnector, AccessControl {
    ...
    bytes32 internal constant PORTFOLIO_MANAGER = keccak256("PORTFOLIO_MANAGER");
    bytes32 internal constant TOKEN_EXCHANGER = keccak256("TOKEN_EXCHANGER");

    Vault internal vault;
    IMasset internal mUsdToken;
    ISavingsContractV2 internal imUsdToken;
    IBoostedVaultWithLockup internal vimUsdToken;
    address internal mtaToken;
    address internal wMaticToken;
