...
contract MockCurve3pool is MockERC20 {
  ...
  function add_liquidity(uint256[3] storage amounts, uint256 min_mint_amount) public {
  ...
  function remove_liquidity(uint256 _amount, uint256[2] storage min_amounts) public {
