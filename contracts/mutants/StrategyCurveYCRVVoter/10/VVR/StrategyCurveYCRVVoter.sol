...
contract StrategyCurveYCRVVoter {
    ...
    address constant internal want = address(0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8);
    address constant internal pool = address(0xFA712EE4788C042e2B7BB55E6cb8ec569C4530c1);
    ...
    address constant internal ydai = address(0x16de59092dAE5CcF4A1E6439D611fd0653f0Bd01);
    address constant internal curve = address(0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51);
    
    uint internal keepCRV = 1000;
