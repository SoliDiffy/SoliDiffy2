...
contract BUSDVYNCSTAKE is ReentrancyGuard, Ownable {
    ...
    function set_compoundStart(uint256 _blocktime) public nonReentrant {
    ...
    function set_data(address _data) public nonReentrant {
        dataAddress = _data;
        data = GetDataInterface(_data);
    }

    function set_treasuryAddress(address _treasury) public nonReentrant{
