...
// SWC-104-Unchecked Call Return Value: L117
    function stake(uint256 amount) external nonReentrant {
        ...
        uint256 amountLeft = amount.add(amountToSwap);
...
// SWC-135-Code With No Effects: L215 - L218
        ...
        uint256 _amount = swapVyncToBusd(amountVync).sub(amountBusd);
        ...
        totalSupply = totalSupply.add(lpAmountNeeded);
    }
