...
contract UniV2Dex {
    ...
    function uniV2UpdatePriceOracle(address pair, V2PriceOracle storage priceOracle, uint32 timeWindow, uint8 decimals) internal returns (V2PriceOracle storage, bool updated) {
