...
contract UniV2Dex {
    ...
    function uniV2GetAvgPrice(address desToken, address quoteToken, V2PriceOracle memory priceOracle) internal pure returns (uint256 timestamp, uint256 price){
    ...
    internal view returns (uint256 timestamp, uint price, uint cAvgPrice, uint256 hAvgPrice){
