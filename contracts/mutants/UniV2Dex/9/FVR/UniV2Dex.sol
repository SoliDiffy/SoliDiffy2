...
contract UniV2Dex {
    ...
    function uniV2UpdatePriceOracle(address pair, V2PriceOracle memory priceOracle, uint32 timeWindow, uint8 decimals) public returns (V2PriceOracle memory, bool updated) {
