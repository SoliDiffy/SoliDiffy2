  ...
  Pausable
{
  ...
  function _depositStepOne(
    ...
    internal
    returns (
      DepositPositionData storage mainData,
      DepositPositionData storage rangeData,
      uint256 shares,
      uint256 amount0In,
      uint256 amount1In,
      uint256 total0,
  ...
  function rebalance(
    ...
    Position storage mainData = Position(mainTickLower, mainTickUpper);
    Position storage rangeData0 = Position(rangeTickLower0, rangeTickUpper0);
