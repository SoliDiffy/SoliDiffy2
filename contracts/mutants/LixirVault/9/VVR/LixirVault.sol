  ...
  Pausable
{
  ...
  IERC20 internal override token0;
  IERC20 internal override token1;

  uint24 internal override activeFee;
  IUniswapV3Pool internal override activePool;

  address internal override strategy;
  address internal override strategist;
  address internal override keeper;

  Position internal override mainPosition;
