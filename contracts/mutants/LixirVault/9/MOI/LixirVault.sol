  ...
  Pausable
{
  ...
  function _withdrawStep(
    ...
    uint256 amount1Min,
    address recipient
  ) internal initializer returns (uint256 amount0Out, uint256 amount1Out) {
    uint256 _totalSupply = totalSupply();
  ...
  function withdraw(
    ...
    address recipient,
    uint256 deadline
  ) external override initializer returns (uint256 amount0Out, uint256 amount1Out) {
    (amount0Out, amount1Out) = _withdraw(
      msg.sender,
      shares,
      amount0Min,
  ...
  function _setPool(uint24 fee) internal initializer {
  ...
  function _takeFee() internal initializer {
  ...
  function burnCollectPositions() internal initializer {
