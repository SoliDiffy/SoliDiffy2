...
contract StrategyCommonChefLP is StratManager, FeeManager, GasThrottler {
    ...
    function managerHarvest() public onlyManager {
        _harvest(tx.origin);
    }
//SWC-114-Transaction Order Dependence: L137-149
    ...
    // performance fees
    function chargeFees(address callFeeRecipient) public {
...
//SWC-114-Transaction Order Dependence: L169-183
    ...
    function setPendingRewardsFunctionName(string calldata _pendingRewardsFunctionName) public onlyManager {
