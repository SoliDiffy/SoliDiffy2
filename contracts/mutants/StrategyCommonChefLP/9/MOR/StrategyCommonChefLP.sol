...
contract StrategyCommonChefLP is StratManager, FeeManager, GasThrottler {
    ...
    function deposit() public gasThrottle {
    ...
    function harvest() external whenNotPaused virtual {
        _harvest(tx.origin);
    }

    function harvest(address callFeeRecipient) external whenNotPaused virtual {
        _harvest(callFeeRecipient);
    }

    function managerHarvest() external whenNotPaused {
        _harvest(tx.origin);
    }
//SWC-114-Transaction Order Dependence: L137-149
    // compounds earnings and charges performance fee
    function _harvest(address callFeeRecipient) internal gasThrottle {
...
//SWC-114-Transaction Order Dependence: L169-183
    ...
    function setPendingRewardsFunctionName(string calldata _pendingRewardsFunctionName) external whenNotPaused {
    ...
    function setHarvestOnDeposit(bool _harvestOnDeposit) external whenNotPaused {
    ...
    function setShouldGasThrottle(bool _shouldGasThrottle) external whenNotPaused {
