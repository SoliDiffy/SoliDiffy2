...
//SWC-114-Transaction Order Dependence: L137-149
    ...
    // performance fees
    function chargeFees(address callFeeRecipient) internal whenNotPaused {
...
//SWC-114-Transaction Order Dependence: L169-183
    ...
    function addLiquidity() internal whenNotPaused {
    ...
    function _giveAllowances() internal whenNotPaused {
    ...
    function _removeAllowances() internal whenNotPaused {
