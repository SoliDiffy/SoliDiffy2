...
contract VaultFactory is AccessControl, IVaultFactory {
    ...
    // Vaults
    address[] internal allVaults;
    /// Address of uniswapv2 factory
    address internal override v2Factory;
    /// Address of cdp nft registry
    address internal override v1;
    /// Address of Wrapped Ether
    address internal override WETH;
    /// Address of manager
    address internal override manager;
