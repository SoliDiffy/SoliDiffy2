...
contract ExchangeService {
    ...
    constructor(ISettings _settings) internal {
        admin = msg.sender;
    ...
    function withdrawSystemETH(address payable _beneficiary) public onlyAdmin {
    ...
    function reclaimERC20(address _token, address _beneficiary) public onlyAdmin {
        require(_beneficiary != address(0), "Zero address, be careful");
    ...
    /// @dev Sets commission.
    function setCommission(uint256 _value) public onlyAdmin {
    ...
    function setMinEther(uint256 _value) public onlyAdmin {
    ...
    /// @dev Closes an Ask.
    function close(uint256 _id) public onlyOwner(_id) {
