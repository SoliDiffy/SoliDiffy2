...
contract PrimaryMarket is IPrimaryMarket, ReentrancyGuard, ITrancheIndex, Ownable {
    ...
    uint256 public constant MAX_REDEMPTION_FEE_RATE = 0.01e18;
    uint256 public constant MAX_SPLIT_FEE_RATE = 0.01e18;
    uint256 public constant MAX_MERGE_FEE_RATE = 0.01e18;

    uint256 internal immutable guardedLaunchStart;
    uint256 internal guardedLaunchTotalCap;
    uint256 internal guardedLaunchIndividualCap;
    mapping(address => uint256) public guardedLaunchCreations;

    IFund internal fund;

    uint256 internal redemptionFeeRate;
    uint256 internal splitFeeRate;
    uint256 internal mergeFeeRate;
