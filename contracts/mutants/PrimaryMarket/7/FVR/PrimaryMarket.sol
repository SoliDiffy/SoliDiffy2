...
contract PrimaryMarket is IPrimaryMarket, ReentrancyGuard, ITrancheIndex, Ownable {
    ...
    function create(uint256 underlying) public nonReentrant onlyActive {
    ...
    function redeem(uint256 shares) public onlyActive {
    ...
    function split(uint256 inM) public onlyActive {
        require(
    ...
    function merge(uint256 inA) public onlyActive {
        (uint256 weightA, uint256 weightB) = fund.trancheWeights();
