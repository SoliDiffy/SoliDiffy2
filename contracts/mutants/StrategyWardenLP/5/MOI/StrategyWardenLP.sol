...
contract StrategyWardenLP is OwnableUpgradeable, PausableUpgradeable {
    ...
    function withdraw(uint256 _amount) external initializer returns (uint256) {
    ...
    // performance fees
    function chargeFees(uint256 feeAmountOutMin) internal initializer {
    ...
    function addLiquidity(uint256 amountOutMin) internal initializer {
    ...
    function _giveAllowances() internal initializer {
    ...
    function _removeAllowances() internal initializer {
