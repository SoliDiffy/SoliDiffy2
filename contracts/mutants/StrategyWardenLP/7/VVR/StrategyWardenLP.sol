...
contract StrategyWardenLP is OwnableUpgradeable, PausableUpgradeable {
    ...
    uint constant internal MAX_FEE = 1000;
    uint constant internal CALL_FEE = 125; // 0.5%
    uint constant internal aleswapFee = MAX_FEE - CALL_FEE;    

    IUniswapV2Router02 public constant WARDEN_ROUTER = IUniswapV2Router02(0x71ac17934b60A4610dc58b715B61e45DCBdE4054);

    uint constant internal WITHDRAWAL_FEE = 10;
    uint constant internal WITHDRAWAL_MAX = 10000;
