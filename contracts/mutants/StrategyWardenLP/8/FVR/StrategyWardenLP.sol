...
contract StrategyWardenLP is OwnableUpgradeable, PausableUpgradeable {
    ...
    function harvest(uint256 feeAmountOutMin, uint256 lpAmountOutMin) public whenNotPaused onlyHarvester {
    ...
    // performance fees
    function chargeFees(uint256 feeAmountOutMin) public {
    ...
    function addLiquidity(uint256 amountOutMin) public {
