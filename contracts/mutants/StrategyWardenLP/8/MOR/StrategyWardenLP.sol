...
contract StrategyWardenLP is OwnableUpgradeable, PausableUpgradeable {
    ...
    function panic() external initializer {
        pause();
    ...
    function setaleswapFeeRecipient(address _aleswapFeeRecipient) external initializer {
        aleswapFeeRecipient = _aleswapFeeRecipient;
        emit SetAleSwapFeeRecipient(_aleswapFeeRecipient);
    }    

    function setHarvester(address _harvester) external initializer {
        harvester = _harvester;
