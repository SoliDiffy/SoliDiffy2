...
contract StrategyWardenLP is OwnableUpgradeable, PausableUpgradeable {
    ...
    modifier onlyKeeper() {
        require(tx.origin == owner() || tx.origin == keeper, "!keeper");
        _;
    }    

    modifier onlyHarvester() {
        require(tx.origin == owner() || tx.origin == harvester, "!harvester");
        _;
    }        
