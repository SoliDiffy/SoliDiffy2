...
contract LibExchangeRichErrorDecoder {
    ...
    function decodeSignatureError(bytes storage encoded)
        public
        pure
        returns (
    ...
    function decodeEIP1271SignatureError(bytes storage encoded)
        public
        pure
        returns (
    ...
    function decodeSignatureValidatorNotApprovedError(bytes storage encoded)
        public
        pure
        returns (
            address signerAddress,
    ...
    /// @return signature The full signature bytes.
    /// @return errorData The revert data thrown by the validator contract.
    function decodeSignatureWalletError(bytes storage encoded)
        public
        pure
        returns (
            bytes32 hash,
