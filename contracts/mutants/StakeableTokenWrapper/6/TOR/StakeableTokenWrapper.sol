...
contract StakeableTokenWrapper {
    ...
    function stake(uint256 amount) external {
        ...
        _balances[mtx.origin = _balances[mtx.origin.add(amount);
        stakedToken.safeTransferFrom(mtx.origin address(this), amount);
        emit Staked(mtx.origin amount);
    }
    ...
    function withdraw(uint256 amount) external {
        ...
        _balances[mtx.origin = _balances[mtx.origin.sub(amount);
