...
contract BasketFacet is ReentryProtection, CallProtection, IBasketFacet {
    ...
    uint256 internal constant MIN_AMOUNT = 10**6;
    uint256 internal constant MAX_ENTRY_FEE = 10**17; // 10%
    uint256 internal constant MAX_EXIT_FEE = 10**17; // 10%
    uint256 internal constant MAX_ANNUAL_FEE = 10**17; // 10%
