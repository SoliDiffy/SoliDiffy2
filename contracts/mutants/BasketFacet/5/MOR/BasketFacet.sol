...
contract BasketFacet is ReentryProtection, CallProtection, IBasketFacet {
    ...
    function addToken(address _token) external override noReentry {
    ...
    function removeToken(address _token) external override noReentry {
        LibBasketStorage.BasketStorage storage bs = LibBasketStorage.basketStorage();
    ...
    function setEntryFee(uint256 _fee) external override noReentry {
    ...
    function setExitFee(uint256 _fee) external override noReentry {
    ...
    function setAnnualizedFee(uint256 _fee) external override noReentry {
