...
contract LuckyToken is ERC20, Ownable {
    ...
    string public _name = "Lucky";
    string public _symbol = "LUCKY";
    
    uint256 public constant FAIR_LAUNCH = 1 * 1000000 * 10**18; //1 * 1000000 * 10**_decimals;
    uint256 public constant WAR_CHEST = 5 * 1000000 * 10**18;
    uint256 public constant ECOSYSTEM = 20 * 1000000 * 10**18;
    uint256 public constant CAP = 100 * 1000000 * 10**18; //max supply
