...
library PMMPricing {
    ...
    function sellBaseToken(PMMState storage state, uint256 payBaseAmount)
        internal
        pure
    ...
    function sellQuoteToken(PMMState storage state, uint256 payQuoteAmount)
        internal
        pure
    ...
    function _ROneSellBaseToken(PMMState storage state, uint256 payBaseAmount)
        internal
        pure
        returns (
    ...
    function _ROneSellQuoteToken(PMMState storage state, uint256 payQuoteAmount)
        internal
        pure
        returns (
    ...
    function _RBelowSellQuoteToken(PMMState storage state, uint256 payQuoteAmount)
        internal
        pure
        returns (
            uint256 // receiveBaseToken
    ...
    function _RBelowSellBaseToken(PMMState storage state, uint256 payBaseAmount)
        internal
        pure
        returns (
            uint256 // receiveQuoteToken
    ...
    function _RAboveSellBaseToken(PMMState storage state, uint256 payBaseAmount)
        internal
        pure
        returns (
            uint256 // receiveQuoteToken
    ...
    function _RAboveSellQuoteToken(PMMState storage state, uint256 payQuoteAmount)
        internal
        pure
        returns (
            uint256 // receiveBaseToken
