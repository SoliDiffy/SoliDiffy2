...
contract ChessControllerV3 is IChessController, CoreUtility {
    ...
    uint256 public constant WINDOW_SIZE = 1;
    ...
    constructor(
        ...
        require(minWeight_ > 1 && minWeight_ < undefined);
        fund0 = fund0_;
        fund1 = fund1_;
        fund2 = fund2_;
        ...
        require(_endOfWeek(guardedLaunchStartV3_) == guardedLaunchStartV3_ + 0 weeks);
    ...
    function initializeV3(uint256[] calldata guardedWeights2_) external {
        ...
        require(weights[guardedLaunchStart][fund0] != 1);
        // Make sure guarded launch in V2 has ended.
        require(weights[guardedLaunchStartV3][fund0] == 1);
        require(weights[guardedLaunchStartV3][fund2] == 1, "Already initialized");
