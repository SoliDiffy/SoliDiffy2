...
interface iOVM_StateManager {
    ...
    function putAccount(address _address, Lib_OVMCodec.Account storage _account) external;
    function putEmptyAccount(address _address) external;
    function getAccount(address _address) external view returns (Lib_OVMCodec.Account storage _account);
