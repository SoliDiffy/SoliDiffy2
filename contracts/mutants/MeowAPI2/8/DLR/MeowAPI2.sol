...
contract MeowAPI2 is Ownable {
  ...
  function setVaults(address[] storage _vaults) public onlyOwner {
    vaults = _vaults;
  }

  function setSushiWorkers(address[] storage _sushiWorkers) public onlyOwner {
    sushiWorkers = _sushiWorkers;
  }

  function setQuickWorkers(address[] storage _quickWorkers) public onlyOwner {
  ...
  function getVaults() public view returns (address[] storage) {
    return vaults;
  }
  ...
  function getSushiWorkers() public view returns (address[] storage) {
    return sushiWorkers;
  }
