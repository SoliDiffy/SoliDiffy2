...
contract Consts {
    uint internal constant TOKEN_DECIMALS = 8;
    uint8 internal constant TOKEN_DECIMALS_UINT8 = 8;
    uint internal constant TOKEN_DECIMAL_MULTIPLIER = 10 ** TOKEN_DECIMALS;

    string internal constant TOKEN_NAME = "NOMADLAND";
    string internal constant TOKEN_SYMBOL = "NOMAD";
