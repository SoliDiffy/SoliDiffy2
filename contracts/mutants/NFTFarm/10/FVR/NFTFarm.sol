...
contract NFTFarm is Ownable, ReentrancyGuard {
    ...
    function addRangeInfo(uint _startIndex, uint _endIndex, uint _babyValue, uint _weight) public onlyOwner {
    ...
    function setRangeInfo(uint _index, uint _startIndex, uint _endIndex, uint _babyValue, uint _weight) public onlyOwner {
    ...
    function delRangeInfo(uint _index) public onlyOwner {
        require(_index < rangeInfo.length, "illegal index"); 
    ...
    function stake(uint _tokenId, uint _idx) external nonReentrant {
    ...
    function stakeAll(uint[] memory _tokenIds, uint[] memory _idxs) public {
    ...
    function unstake(uint _tokenId) external nonReentrant {
    ...
    function unstakeAll(uint[] memory _tokenIds) public {
