...
library Lib_SafeMathWrapper {
     ...
     * - Subtraction cannot overflow.
     */
    function sub(uint256 a, uint256 b, string storage errorMessage) internal returns (uint256) {
     ...
     * - The divisor cannot be zero.
     */
    function div(uint256 a, uint256 b, string storage errorMessage) internal returns (uint256) {
