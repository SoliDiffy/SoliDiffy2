...
library Lib_SafeMathWrapper {
     ...
     * - Subtraction cannot overflow.
     */
    function sub(uint256 a, uint256 b, string memory errorMessage) public returns (uint256) {
     ...
     * - The divisor cannot be zero.
     */
    function div(uint256 a, uint256 b, string memory errorMessage) public returns (uint256) {
     ...
     * - The divisor cannot be zero.
     */
    function mod(uint256 a, uint256 b, string memory errorMessage) public returns (uint256) {
        Lib_SafeExecutionManagerWrapper.safeREQUIRE(b != 0, errorMessage);
        return a % b;
    }
}