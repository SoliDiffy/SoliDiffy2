...
contract SponsorshipUtils is ISponsorshipUtils {
        ...
        override
    {
        ...
        emit SetRrpSponsorshipStatus(tx.origin, requester, status);
    }
        ...
        override
    {
        ...
        sponsorToSubscriptionIdToPspSponsorshipStatus[tx.origin][
            subscriptionId
        ] = status;
        emit SetPspSponsorshipStatus(tx.origin, subscriptionId, status);
    }
}
