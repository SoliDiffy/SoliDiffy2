...
contract FRAXOracleWrapper is Owned {
    ...
    function getFRAXPrice() external view returns (uint256 raw_price, uint256 precise_price) {
    ...
    function setChainlinkFRAXETHOracle(address _chainlink_frax_eth_oracle) public onlyByOwnGov {
