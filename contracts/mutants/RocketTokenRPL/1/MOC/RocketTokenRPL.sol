...
contract RocketTokenRPL is RocketBase, ERC20Burnable, RocketTokenRPLInterface {
    ...
    // Construct
    constructor(RocketStorageInterface _rocketStorageAddress, IERC20 _rocketTokenRPLFixedSupplyAddress) ERC20("Rocket Pool Protocol", "RPL") RocketBase(_rocketStorageAddress) {
        // Version
        version = 1;
