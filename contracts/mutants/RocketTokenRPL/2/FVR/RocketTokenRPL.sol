...
contract RocketTokenRPL is RocketBase, ERC20Burnable, RocketTokenRPLInterface {
    ...
    */
    ...
    function _getInflationIntervalsPassed(uint256 _inflationLastCalcTime) public view returns(uint256) {
    ...
    */
    ...
    function _inflationCalculate(uint256 _intervalsSinceLastMint) public view returns (uint256) {
