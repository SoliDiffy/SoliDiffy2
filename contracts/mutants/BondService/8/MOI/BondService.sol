...
//SWC-108-State Variable Default Visibility:L18
    ...
    function changeDeposit(uint256 _id, uint256 _deposit) internal singleOwner(_id) {
    ...
    function changePercent(uint256 _id, uint256 _percent) internal singleOwner(_id) {
    ...
    function changeExpiration(uint256 _id, uint256 _expiration) internal singleOwner(_id) {
    ...
    function changeYearFee(uint256 _id, uint256 _yearFee) internal singleOwner(_id) {
