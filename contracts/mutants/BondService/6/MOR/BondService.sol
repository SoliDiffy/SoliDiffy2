...
//SWC-108-State Variable Default Visibility:L18
    ...
    /// @param _id A Bond ID.
    function takeBuyRequest(uint256 _id) external payable singleOwner(_id) {
    ...
    /// @param _id A Bond ID.
    function finish(uint256 _id) external singleOwner(_id) {
    ...
    /// @param _id A Bond ID.
    function expire(uint256 _id) external singleOwner(_id) {
