...
contract OKLGAtomicSwapInstance is OKLGProduct {
  ...
  function setActiveState(bool _isActive) public {
    require(
  ...
  function setTargetTokenDecimals(uint8 _decimals) public onlyOwner {
  ...
  function setMinimumGasForOperation(uint256 _amountGas) public onlyOwner {
