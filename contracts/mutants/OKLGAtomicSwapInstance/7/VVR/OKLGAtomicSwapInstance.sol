...
contract OKLGAtomicSwapInstance is OKLGProduct {
  IERC20Decimals public _token;

  address internal tokenOwner;
  address payable internal oracleAddress;
  uint256 internal maxSwapAmount;
  uint8 internal targetTokenDecimals;
  uint256 internal minimumGasForOperation = 2 * 10**15; // 2 finney (0.002 ETH)
