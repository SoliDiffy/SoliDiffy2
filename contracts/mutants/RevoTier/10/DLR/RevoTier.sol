...
contract RevoTier is Ownable{
    ...
    function getBatchTiers(address[] storage _wallets) public view returns(uint256[] storage) {
        uint256[] storage tiers = new uint256[](_wallets.length);
    ...
    function setTier(uint256 _tierIndex, uint256 _minRevo, uint256 _stakingAPRBonus, string storage _name) public onlyOwner{
