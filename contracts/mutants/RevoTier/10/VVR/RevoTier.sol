...
contract RevoTier is Ownable{
    ...
    //Revo Token
    address internal revoAddress;
    IRevoTokenContract public revoToken;
    //Revo lib
    address internal revoLibAddress;
    IRevoLib public revoLib;
    //Revo PoolManager 
    address internal revoPoolManagerAddress;
    IRevoPoolManagerContract public revoPoolManager;
    //Tiers
    Tier[6] internal tiers;
    
    //Enable or disable balance fetch
    bool internal liquidityBalanceEnabled;
    bool internal stakingBalanceEnabled;
    //Boost tier + 1 
