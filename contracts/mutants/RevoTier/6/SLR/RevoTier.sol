...
contract RevoTier is Ownable{
    ...
    constructor(address _revoLibAddress, address _revoPoolManager, address _revoNFTToken) {
        ...
        //Tiers
        setTier(0, 1000000000000000000000, 0,  "");
        setTier(1, 2500000000000000000000, 25, "");
        setTier(2, 5000000000000000000000, 50, "");
        setTier(3, 10000000000000000000000, 60, "");
        setTier(4, 25000000000000000000000, 70, "");
        setTier(5, 100000000000000000000000, 80, "");
    }
