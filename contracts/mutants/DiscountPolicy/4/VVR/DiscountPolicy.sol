...
contract DiscountPolicy is Manageable, IDiscountPolicy {
    ...
    //
    // Storage data
    uint256 internal minTokens;           // minimum token amount for getting discount
    uint256 internal minPoolBalance;      // minimum discount pool balance that enables discounts
    uint256 internal discountsInPool;     // 1/discountsInPool is a share of pool for a single discount
    uint256 internal maxDiscountPermille; // maximum discount permile [0-1000] 
