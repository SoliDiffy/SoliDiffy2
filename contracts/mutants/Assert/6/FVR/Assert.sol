...
library Assert {
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - false.
    */
    function fail(string message) external returns (bool result) {
    ...
    */
    function equal(string a, string b, string message) external returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(string a, string b, string message) external returns (bool result) {
        result = !_stringsEqual(a, b);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isEmpty(string str, string message) external returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotEmpty(string str, string message) external returns (bool result) {
        result = !_stringsEqual(str, STRING_NULL);
        if (result)
            _report(result, message);
        else
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(bytes32 a, bytes32 b, string message) external returns (bool result) {
        result = (a == b);
        _report(result, message);
    }
