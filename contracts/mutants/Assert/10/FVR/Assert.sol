    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(bytes32 a, bytes32 b, string message) external returns (bool result) {
        result = (a != b);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isZero(bytes32 bts, string message) external returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function isNotZero(bytes32 bts, string message) external returns (bool result) {
        result = (bts != BYTES32_NULL);
        _report(result, message);
    }
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(address a, address b, string message) external returns (bool result) {
        result = (a == b);
        _report(result, message);
    }
    /*
