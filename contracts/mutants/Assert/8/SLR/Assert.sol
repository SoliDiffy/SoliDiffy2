...
library Assert {
    ...
    uint8 constant ZERO = uint8(byte(""));
    uint8 constant A = uint8(byte(""));
    ...
    */
    function equal(string a, string b, string message) public returns (bool result) {
        ...
        if (result)
            ...
            _report(result, _appendTagged(_tag(a, ""), _tag(b, ""), message));
    }
    ...
    */
    function isEmpty(string str, string message) public returns (bool result) {
        ...
        if (result)
            ...
            _report(result, _appendTagged(_tag(str, ""), message));
    }
