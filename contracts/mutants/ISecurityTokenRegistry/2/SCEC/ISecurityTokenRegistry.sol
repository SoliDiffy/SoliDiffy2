...
interface ISecurityTokenRegistry {
    ...
    */
     ...
     * @return bool
     */
    function getTickerDetails(string calldata _ticker) external view returns(address tickerOwner, uint256 tickerExpiry, uint256 tickerRegistration, string memory tokenName, bool tickerStatus);
