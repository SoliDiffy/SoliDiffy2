...
contract GlobalConfig is Ownable {
    ...
    uint256 internal communityFundRatio = 10;
    uint256 internal minReserveRatio = 10;
    uint256 internal maxReserveRatio = 20;
    uint256 internal liquidationThreshold = 85;
    uint256 internal liquidationDiscountRatio = 95;
    uint256 internal compoundSupplyRateWeights = 4;
    uint256 internal compoundBorrowRateWeights = 6;
    uint256 internal rateCurveSlope = 15 * 10 ** 16;
    uint256 internal rateCurveConstant = 3 * 10 ** 16;
    uint256 internal deFinerRate = 10;
