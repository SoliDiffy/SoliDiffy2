...
contract GlobalConfig is Ownable {
     ...
     */
    function updateCommunityFundRatio(uint256 _communityFundRatio) public onlyOwner {
     ...
     */
    function updateMinReserveRatio(uint256 _minReserveRatio) public onlyOwner {
     ...
     */
    function updateMaxReserveRatio(uint256 _maxReserveRatio) public onlyOwner {
