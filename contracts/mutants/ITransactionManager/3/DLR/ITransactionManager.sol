...
interface ITransactionManager {
  ...
  ) external returns (TransactionData storage);

  function cancel(TransactionData calldata txData, bytes calldata signature) external returns (TransactionData storage);
}
