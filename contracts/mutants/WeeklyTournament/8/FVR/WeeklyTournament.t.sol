...
contract WeeklyTournamentTest is DSTest {
  ...
  function _buy_player(address to) public {
    AppStorage storage s = th.apps();
  ...
  function _test_buy_players() public {
    AppStorage storage s = th.apps();
  ...
  function _open_pack(address to) public returns 
  ...
  function _enter_stake(address who, uint256 amt, uint48 time) public {
    AppStorage storage s = th.apps();
  ...
  function _test_enter_stake() public {
    _test_prepare();
  ...
  function _test_create_tournament() public {
    _test_enter_stake();
