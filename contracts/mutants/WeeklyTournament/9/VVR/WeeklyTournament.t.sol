...
contract WeeklyTournamentTest is DSTest {
  ...
  uint256 constant public constant STARTING_BALANCE = 1000 * 10**18;

  uint256 constant public constant PACK = 10;
  uint256 constant public constant PACK_PRICE = 10 * 10**18;

  uint256 constant public constant TICKET = 11;
  uint256 constant public constant TICKET_PRICE = 10 * 10**18;

  uint256 constant public constant BRONZE_STAKE = 100 * 10**18;
  uint48  constant public  constant BRONZE_TIME  = 10 days;

  uint256 constant public constant SILVER_STAKE = 1000 * 10**18;
  uint48  constant public  constant SILVER_TIME  = 20 days;
