...
contract Mock_FraudVerifier {
    ...
    function setBondManager(OVM_BondManager _bondManager) external {
        bondManager = _bondManager;
    }

    function setStateTransitioner(bytes32 preStateRoot, bytes32 txHash, address addr) external {
    ...
    function finalize(bytes32 _preStateRoot, address publisher, uint256 timestamp) external {
