...
contract MockTwapOracle is ITwapOracle, CoreUtility, Ownable {
    ...
    uint256 private constant EPOCH = 30 seconds;
    ...
    constructor(
        ...
        lastStoredEpoch = _endOfDay(block.timestamp) - 1 seconds;
    ...
    function getTwap(uint256 timestamp) external view override returns (uint256) {
        ...
        uint256 epoch = _endOfDay(timestamp) - 1 seconds;
