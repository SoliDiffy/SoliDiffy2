...
library GCFormulae
{
	 ...
	 */
	function _calcCostFromUnderlyingCost(uint256 _underlyingCost, uint256 _exchangeRate) public pure returns (uint256 _cost)
	{
	 ...
	 */
	function _calcUnderlyingCostFromCost(uint256 _cost, uint256 _exchangeRate) public pure returns (uint256 _underlyingCost)
	{
	 ...
	 */
	function _calcDepositSharesFromUnderlyingCost(uint256 _underlyingCost, uint256 _totalReserve, uint256 _totalSupply, uint256 _depositFee, uint256 _exchangeRate) public pure returns (uint256 _netShares, uint256 _feeShares)
	{
	 ...
	 */
	function _calcDepositUnderlyingCostFromShares(uint256 _netShares, uint256 _totalReserve, uint256 _totalSupply, uint256 _depositFee, uint256 _exchangeRate) public pure returns (uint256 _underlyingCost, uint256 _feeShares)
	{
		uint256 _cost;
