...
contract SwapsUser is State, SwapsEvents, FeesHelper {
    ...
    function _loanSwap(
        ...
        internal
        returns (uint256 sourceToDestSwapRate, uint256 destTokenAmountReceived, uint256 sourceTokenAmountUsed)
    {
        ...
        returns (uint256, uint256)
    {
        ...
        return (sourceTokenAmountUsed, destTokenAmountReceived);
    }
