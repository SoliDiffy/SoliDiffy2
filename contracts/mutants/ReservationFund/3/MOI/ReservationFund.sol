...
contract ReservationFund is ICrowdsaleReservationFund, Ownable, SafeMath {
    ...
    function contributionsOf(address contributor) external onlyOwner returns(uint256) {
    ...
    function canCompleteContribution(address contributor) external onlyOwner returns(bool) {
    ...
    function completeContribution(address contributor) external onlyOwner {
