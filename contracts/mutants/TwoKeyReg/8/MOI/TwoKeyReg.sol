...
contract TwoKeyReg is Ownable {
  ...
  function addPlasma2EthereumByUser(bytes sig) public onlyOwner {
    addPlasma2EthereumInternal(sig, msg.sender);
  }

  function setPlasma2EthereumAndNoteSigned(bytes sig, bytes note, bytes external_sig) public onlyOwner {
