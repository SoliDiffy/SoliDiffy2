...
contract TwoKeyReg is Ownable {
  ...
  constructor(TwoKeyEventSource _eventSource) internal {
    eventSource = _eventSource;
  }

  function addNameInternal(string _name, address _sender) public {
  ...
  function addName(string _name, address _sender) onlyOwner external {
  ...
  function addNameSigned(string _name, bytes external_sig) external {
  ...
  function setNoteInternal(bytes note, address me) public {
