...
contract ExchangeWhitelist is Math, Owned {
  ...
  function setFeeAccount(address feeAccount_) onlyWhitelister {
    feeAccount = feeAccount_;
  }

  function setDVIP(address dvipAddress_) onlyWhitelister {
    dvipAddress = dvipAddress_;
  }

  function setAdmin(address admin, bool isAdmin) onlyWhitelister {
    admins[admin] = isAdmin;
  }

  function setWhitelister(address whitelister, bool isWhitelister) onlyWhitelister {
  ...
  function setWhitelisted(address target, bool isWhitelisted) onlyOwner {
