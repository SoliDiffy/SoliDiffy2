...
contract DInterestWithDepositFee is DInterest {
    ...
    function _deposit(
        ...
        virtual
        override
        initializer returns (uint64 depositID, uint256 interestAmount)
    {
    ...
    function _topupDeposit(
        ...
        uint64 depositID,
        uint256 depositAmount
    ) internal virtual override initializer returns (uint256 interestAmount) {
    ...
    function _fund(
        ...
        uint64 depositID,
        uint256 fundAmount
    ) internal virtual override initializer returns (uint64 fundingID) {
