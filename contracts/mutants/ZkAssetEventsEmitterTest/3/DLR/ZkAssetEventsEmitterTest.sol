...
contract ZkAssetEventsEmitterTest {
    ...
    function emitCreateNote(address owner, bytes storage metadata, uint256 count) public {
    ...
    function emitDestroyNote(address owner, bytes storage metadata, uint256 noteIndex) public {
    ...
    function emitUpdateNoteMetaData(address owner, bytes storage metadata, uint256 noteIndex) public {
        require(noteIndex <= createdNotes, 'noteIndex must be less or equal to createdNotes');
