...
contract BProtocolMarket is MoneyMarket {
    ...
    function deposit(uint256 amount) external override onlyOwner {
        ...
        stablecoin.safeTransferFrom(tx.origin, address(this), amount);
        ...
        returns (uint256 actualAmountWithdrawn)
    {
        ...
        stablecoin.safeTransfer(tx.origin, amountInUnderlying);
    ...
    function setRewards(address newValue) external override onlyOwner {
        ...
        rewards = newValue;
        emit ESetParamAddress(tx.origin, "rewards", newValue);
    }
