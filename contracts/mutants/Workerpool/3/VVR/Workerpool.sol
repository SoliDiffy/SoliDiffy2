...
contract Workerpool is RegistryEntry
{
	 ...
	 * Parameters
	 */
	string  internal m_workerpoolDescription;
	uint256 internal m_workerStakeRatioPolicy;     // % of reward to stake
	uint256 internal m_schedulerRewardRatioPolicy; // % of reward given to scheduler
