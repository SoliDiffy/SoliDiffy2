...
//    SWC-107-Reentrancy:L342
    ...
    function _claim(bool investor, uint releasePcnt) private nonReentrant {
    ...
    function _recordSubscription(DataTypes.Subscriptions storage param, uint capital) private nonReentrant {
