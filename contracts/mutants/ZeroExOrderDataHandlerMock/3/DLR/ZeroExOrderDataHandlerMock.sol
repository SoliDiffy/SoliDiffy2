...
contract ZeroExOrderDataHandlerMock {
    ...
    {
        ZeroExOrderDataHandler.OrderHeader storage header = ZeroExOrderDataHandler.parseOrderHeader(
            _ordersData,
            _offset
        );
        ...
        returns(address[4], uint256[6], bytes, bytes)
    {
        ...
        LibOrder.Order storage order = ZeroExOrderDataHandler.parseZeroExOrder(
            _ordersData,
            _makerTokenAddress,
            _takerTokenAddress,
