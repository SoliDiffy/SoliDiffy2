...
contract ECDH {
    ...
    function publicKey(uint256 privKey) external pure returns (uint256 qy, uint256 qx) {
        uint256 x;
        uint256 y;
        uint256 z;
        (x, y, z) = ecMul(
    ...
    function ecAdd(
        ...
        public
        pure
        returns (uint256 z3, uint256 x3, uint256 y3)
    {
        uint256 ln;
        uint256 lz;
        uint256 da;
