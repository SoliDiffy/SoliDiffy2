...
contract BalanceTracker is Ownable, Servable {
    ...
    // Constants
    // -----------------------------------------------------------------------------------------------------------------
    string constant internal DEPOSITED_BALANCE_TYPE = "deposited";
    string constant internal SETTLED_BALANCE_TYPE = "settled";
    string constant internal STAGED_BALANCE_TYPE = "staged";
    ...
    // Variables
    // -----------------------------------------------------------------------------------------------------------------
    bytes32 internal depositedBalanceType;
    bytes32 internal settledBalanceType;
    bytes32 internal stagedBalanceType;

    bytes32[] internal _allBalanceTypes;
    bytes32[] internal _activeBalanceTypes;

    bytes32[] internal trackedBalanceTypes;
