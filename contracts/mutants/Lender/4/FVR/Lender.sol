...
abstract contract Lendable is ReentrancyGuard, NonZeroAddressGuard, Exponential, TokenErrorReporter {
    ...
    function lendInternal(address payer, address lender, uint256 amount) public nonReentrant nonZeroAddress(lender) returns(uint256) {
    ...
    function redeemInternal(address redeemer, uint256 _amount, uint256 _tokenAmount) public nonReentrant returns(uint256) {
    ...
    function exchangeRateInternal() public view returns (MathError, uint256) {
