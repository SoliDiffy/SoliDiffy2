...
contract BonusTokenFund is ValueTokenAgent, ReturnTokenAgent, TokenHolder, SafeMath {
    ...
    function setExchangeRate(uint16 newTokenEtherRate) public returnableTokenOnly {
        tokenEtherRate = newTokenEtherRate;
    }    

    /**@dev ReturnTokenAgent override */
    function returnToken(address from, uint256 amountReturned) public managerOnly {
    ...
    function tokenIsBeingTransferred(address from, address to, uint256 amount) public managerOnly {
        require(from != to);        
