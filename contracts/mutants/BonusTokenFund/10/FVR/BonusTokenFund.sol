...
contract BonusTokenFund is ValueTokenAgent, ReturnTokenAgent, TokenHolder, SafeMath {
    ...
    function tokensSinceLastUpdate(address holder) public constant returns (uint256) {
    ...
    function totalTokenPoints() public constant returns (uint256) {
    ...
    function issueBonusTokens(address holder) public {
        updateHolder(holder);
