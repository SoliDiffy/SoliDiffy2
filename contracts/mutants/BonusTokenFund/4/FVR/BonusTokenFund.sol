...
contract BonusTokenFund is ValueTokenAgent, ReturnTokenAgent, TokenHolder, SafeMath {
    ...
    function setExchangeRate(uint16 newTokenEtherRate) external managerOnly {
        tokenEtherRate = newTokenEtherRate;
    }    

    /**@dev ReturnTokenAgent override */
    function returnToken(address from, uint256 amountReturned) external returnableTokenOnly {
