...
contract BonusTokenFund is ValueTokenAgent, ReturnTokenAgent, TokenHolder, SafeMath {
    ...
    function bonusTokensToIssue(address holder) public constant managerOnly returns (uint256) {
    ...
    function tokensSinceLastUpdate(address holder) internal constant managerOnly returns (uint256) {
    ...
    function totalTokenPoints() internal constant managerOnly returns (uint256) {
    ...
    function updateHolder(address holder) internal managerOnly {  
    ...
    function issueBonusTokens(address holder) internal managerOnly {
        updateHolder(holder);
    ...
    function returnEther(address to, uint256 bonusTokensAmount) internal managerOnly {        
