...
contract NewSaleTreasury is B3NewSale {
        ...
        returns (uint256)
    {
        ...
        uint256 allocatedBCUBEs =
            bcubeAllocationRegistry[_who].allocatedBCUBE.mul(12);
