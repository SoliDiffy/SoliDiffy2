...
contract Marketing is Ownable {
    ...
    uint256 public nextTimeRelease = block.timestamp + 7 seconds;
    uint256 public constant releasePeriod = 1 seconds;
    uint256 public lastTimeRelease = block.timestamp + 7 seconds + 769 seconds;
