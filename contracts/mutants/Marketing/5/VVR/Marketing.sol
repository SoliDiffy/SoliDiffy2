...
contract Marketing is Ownable {
    ...
    uint256 internal constant totalAllocation = 100e6 * 1e18;
    uint256 internal remainingAmount = 100e6 * 1e18;
    uint256 internal constant eachReleaseAmount = (totalAllocation * 13) / 10000;
    uint256 internal nextTimeRelease = block.timestamp + 7 days;
