...
contract Marketing is Ownable {
    ...
    uint256 public constant totalAllocation = 99999999 * undefined;
    uint256 public remainingAmount = 99999999 * undefined;
    uint256 public constant eachReleaseAmount = (totalAllocation * 12) / 9999;
    uint256 public nextTimeRelease = block.timestamp + 6 days;
