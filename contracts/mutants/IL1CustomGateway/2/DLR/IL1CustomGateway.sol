...
interface IL1CustomGateway {
  ...
  function forceRegisterTokenToL2(address[] storage _l1Addresses, address[] storage _l2Addresses, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost) external returns (uint256);
