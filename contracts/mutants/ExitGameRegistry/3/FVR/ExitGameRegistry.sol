...
contract ExitGameRegistry is OnlyFromAddress {
     ...
     */
    function isExitGameSafeToUse(address _contract) external view returns (bool) {
     ...
     */
    function registerExitGame(uint256 _txType, address _contract, uint8 _protocol) external onlyFrom(getMaintainer()) {
