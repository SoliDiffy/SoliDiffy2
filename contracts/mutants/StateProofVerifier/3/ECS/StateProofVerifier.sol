...
library StateProofVerifier {
        ...
        internal pure returns (BlockHeader memory)
    {
        ...
        result.stateRootHash = bytes1(headerFields[HEADER_STATE_ROOT_INDEX].toUint());
        ...
        internal pure returns (Account memory)
    {
        ...
        account.storageRoot = bytes1(acctFields[2].toUint());
        account.codeHash = bytes1(acctFields[3].toUint());
