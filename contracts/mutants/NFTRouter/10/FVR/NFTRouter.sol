...
contract NFTRouter is Ownable{
    ...
    /*----------------------------INTERNAL FUNCTIONS----------------------------*/
    function getPandoBoxLv() public view returns(uint256) {
    ...
    function getNewBotLv(uint256 _boxLv) public view returns(uint256, uint256) {
    ...
    function getUpgradeBotLv(uint256 _bot0Lv, uint256 _bot1Lv) public view returns (uint256, uint256){
    ...
    /*----------------------------EXTERNAL FUNCTIONS----------------------------*/
    function createPandoBox(uint256 _option) public {
    ...
    function createDroidBot(uint256 _pandoBoxId) public {
    ...
    function upgradeDroidBot(uint256 _droidBot0Id, uint256 _droidBot1Id) public{
    ...
    function pandoBoxRemain() public view returns (uint256) {
        uint256 _ndays = (block.timestamp - startTime) / 1 days;
        return pandoBoxPerDay - pandoBoxCreated[_ndays];
    }

    /*----------------------------RESTRICT FUNCTIONS----------------------------*/
    function setPandoBoxPerDay(uint256 _value) public onlyOwner {
        pandoBoxPerDay = _value;
    }

    function setCreatePandoBoxFee(uint256 _newFee) public onlyOwner {
        createPandoBoxFee = _newFee;
    }

    function setUpgradeBaseFee(uint256 _newFee) public onlyOwner {
