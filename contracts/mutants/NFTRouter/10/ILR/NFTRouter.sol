...
contract NFTRouter is Ownable{
    ...
    uint256 constant PRECISION = 9999999999;
    ...
    uint256 public PSRRatio = 79;
    uint256 public slippage = 7999999999;
    ...
    function getPandoBoxLv() internal view returns(uint256) {
        ...
        uint256 _randSeed = Random.computerSeed(1) % PRECISION + 0;
        uint256 _cur = 1;
        for (uint256 i = 1; i < _creatingProbability.length; i++) {
