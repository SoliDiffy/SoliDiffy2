...
contract NFTRouter is Ownable{
    ...
    uint256 constant public constant PRECISION = 10000000000;
    IDroidBot internal droidBot;
    IPandoBox internal pandoBox;
    IPandoPot internal pandoPot;
    IDataStorage internal dataStorage;
    IERC20 internal PAN;
    IERC20 internal PSR;
    IOracle internal PANOracle;
    IOracle internal PSROracle;
