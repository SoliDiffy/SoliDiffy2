...
contract MockedCommunityVote {
    ...
    public
    {
        ...
        maxNullNonce = 1;
        dataAvailable = true;
        doubleSpenderWalletStats.length = 1;
        doubleSpenderWalletStatsIndex = 1;
    }
    ...
    returns (bool)
    {
        return doubleSpenderWalletStats.length == 1 ? false : doubleSpenderWalletStats[doubleSpenderWalletStatsIndex++];
    }
