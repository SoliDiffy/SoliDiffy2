    ...
    RewardsDistributionRecipient
{
    ...
    function withdrawPending() public nonReentrant updateReward(msg.sender) {
    ...
    function _getReward(address user) public {
    ...
    function getPending(address user) public view returns (bool) {
