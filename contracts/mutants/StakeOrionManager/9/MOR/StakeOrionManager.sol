    ...
    RewardsDistributionRecipient
{
    ...
    function withdrawPending() external onlyPoolManager updateReward(msg.sender) {
        StakeOrion(userContracts[msg.sender]).withdrawPending();
    }

    /* ========== REWARDS ========== */

    function getReward() public onlyPoolManager updateReward(msg.sender) {
    ...
    function setFeeReceiver(address newFeeReceiver) external nonReentrant {
