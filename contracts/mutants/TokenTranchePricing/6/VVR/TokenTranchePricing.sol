...
contract TokenTranchePricing is Ownable {
  ...
  uint public constant amount_offset = 0;
  uint public constant start_offset = 1;
  uint public constant end_offset = 2;
  uint public constant price_offset = 3;
  uint public constant tranche_size = 4;

  Tranche[] internal tranches;
