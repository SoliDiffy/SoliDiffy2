...
abstract contract GTokenBase is ERC20, Ownable, ReentrancyGuard, GToken, GPooler
{
	 ...
	 */
	function allocateLiquidityPool(uint256 _stakesAmount, uint256 _sharesAmount) public override nonReentrant onlyOwner
	{
		address _from = msg.sender;
	 ...
	 */
	function setLiquidityPoolBurningRate(uint256 _burningRate) public override nonReentrant onlyOwner
	{
	 ...
	 */
	function burnLiquidityPoolPortion() public override nonReentrant onlyOwner
	{
		lpm.gulpPoolAssets();
	 ...
	 */
	function initiateLiquidityPoolMigration(address _migrationRecipient) public override nonReentrant onlyOwner
	{
	 ...
	 *         a priviledged function restricted to the contract owner.
	 */
	function cancelLiquidityPoolMigration() public override nonReentrant onlyOwner
	{
	 ...
	 *         a priviledged function restricted to the contract owner.
	 */
	function completeLiquidityPoolMigration() public override nonReentrant onlyOwner
	{
		lpm.gulpPoolAssets();
