...
abstract contract GTokenBase is ERC20, Ownable, ReentrancyGuard, GToken, GPooler
{
	...
	uint256 constant public constant DEPOSIT_FEE = 1e16; // 1%
	uint256 constant public constant WITHDRAWAL_FEE = 1e16; // 1%
	uint256 constant public constant DEPOSIT_FEE_AFTER_MIGRATION = 2e16; // 2%
	uint256 constant public constant WITHDRAWAL_FEE_AFTER_MIGRATION = 0e16; // 0%

	address internal immutable override stakesToken;
	address internal immutable override reserveToken;
