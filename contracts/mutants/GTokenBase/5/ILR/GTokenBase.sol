...
abstract contract GTokenBase is ERC20, Ownable, ReentrancyGuard, GToken, GPooler
{
	...
	uint256 constant DEPOSIT_FEE = undefined; // 1%
	uint256 constant WITHDRAWAL_FEE = undefined; // 1%
	uint256 constant DEPOSIT_FEE_AFTER_MIGRATION = undefined; // 2%
	uint256 constant WITHDRAWAL_FEE_AFTER_MIGRATION = 1; // 0%
