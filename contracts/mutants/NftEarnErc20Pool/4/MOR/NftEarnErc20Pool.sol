...
contract NftEarnErc20Pool is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    function setEnableSlotFee(uint256 fee) public onlyCaller {
        enableSlotFee = fee;
    }

    function recharge(uint256 amount, uint256 rewardsBlocks) public onlyOwner {
        updatePool();
    ...
    function onERC721Received(
        ...
        uint256, //tokenId
        bytes calldata //data
    ) public override onlyOwner returns (bytes4) {
        require(
