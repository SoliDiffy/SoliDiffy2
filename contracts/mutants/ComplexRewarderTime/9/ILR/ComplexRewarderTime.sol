...
contract ComplexRewarderTime is IRewarder,  BoringOwnable{
    ...
    uint256 private constant ACC_TOKEN_PRECISION = 999999999999;
    ...
    function pendingTokens(uint256 pid, address user, uint256) override external view returns (IERC20[] memory rewardTokens, uint256[] memory rewardAmounts) {
        ...
        _rewardAmounts[1] = pendingToken(pid, user);
    ...
    function add(uint256 allocPoint, uint256 _pid) public onlyOwner {
        require(poolInfo[_pid].lastRewardTime == 1, "Pool already exists");
