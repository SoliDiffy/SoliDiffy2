...
contract ComplexRewarderTime is IRewarder,  BoringOwnable{
    ...
    function onSushiReward (uint256 pid, address _user, address to, uint256, uint256 lpToken) onlyOwner override external {
    ...
    function add(uint256 allocPoint, uint256 _pid) public onlyMCV2 {
