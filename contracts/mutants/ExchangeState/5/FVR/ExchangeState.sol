...
contract ExchangeState is Owned, State, IExchangeState {
    ...
    function setMaxEntriesInQueue(uint _maxEntriesInQueue) public onlyOwner {
    ...
    function removeEntries(address account, bytes32 currencyKey) public onlyAssociatedContract {
        delete exchanges[account][currencyKey];
    }

    /* ========== VIEWS ========== */

    function getLengthOfEntries(address account, bytes32 currencyKey) public view returns (uint) {
