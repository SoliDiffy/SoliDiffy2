...
contract ExchangeState is Owned, State, IExchangeState {
    ...
    function setMaxEntriesInQueue(uint _maxEntriesInQueue) external onlyAssociatedContract {
    ...
    function removeEntries(address account, bytes32 currencyKey) external onlyOwner {
