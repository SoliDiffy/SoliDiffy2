...
contract Scientist is  ReentrancyGuard {
  ...
  uint256 internal constant PERCENT_RESOLUTION = 10000;
  ...
  uint256 internal constant MINIMUM_COLLATERALIZATION_LIMIT = 1000000000000000000;
  ...
  /// IMPORTANT: This constant is a raw FixedPointMath.uq192x64 value and assumes a resolution of 64 bits. If the
  ///            resolution for the FixedPointMath library changes this constant must change as well.
  uint256 internal constant MAXIMUM_COLLATERALIZATION_LIMIT = 4000000000000000000;
  ...
  IMintableERC20 internal xtoken;
