...
contract Scientist is  ReentrancyGuard {
  ...
  function setPendingGovernance(address _pendingGovernance) external expectInitialized {
  ...
  function setSentinel(address _sentinel) external expectInitialized {
  ...
  function setTransmuter(address _transmuter) external expectInitialized {
  ...
  function setFlushActivator(uint256 _flushActivator) external expectInitialized {
  ...
  function setRewards(address _rewards) external expectInitialized {
  ...
  function setHarvestFee(uint256 _harvestFee) external expectInitialized {
  ...
  function setCollateralizationLimit(uint256 _limit) external expectInitialized {
  ...
  /// @dev Set oracle.
  function setOracleAddress(address Oracle, uint256 peg) external expectInitialized {
  ...
  function initialize(IVaultAdapter _adapter) external expectInitialized {
