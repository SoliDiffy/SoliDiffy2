...
contract Scientist is  ReentrancyGuard {
  ...
  function setPendingGovernance(address _pendingGovernance) public onlyGov {
  ...
  function setSentinel(address _sentinel) public onlyGov {
  ...
  function setTransmuter(address _transmuter) public onlyGov {
  ...
  function setFlushActivator(uint256 _flushActivator) public onlyGov {
  ...
  function setRewards(address _rewards) public onlyGov {
  ...
  function setHarvestFee(uint256 _harvestFee) public onlyGov {
