...
contract Scientist is  ReentrancyGuard {
  ...
  function acceptGovernance() external  onlyGov {
  ...
  function setEmergencyExit(bool _emergencyExit) external onlyGov {
  ...
  ///
  /// @return the amount of tokens flushed to the active vault.
  function flushActiveVault() internal onlyGov returns (uint256) {
  ...
  function _distributeToTransmuter(uint256 amount) internal onlyGov {
  ...
  function _expectCaller(address _expectedCaller) internal onlyGov {
  ...
  function _updateActiveVault(IVaultAdapter _adapter) internal onlyGov {
  ...
  ///
  /// @return the amount of funds that were recalled from the vault to this contract and the decreased vault value.
  function _recallFunds(uint256 _vaultId, uint256 _amount) internal onlyGov returns (uint256, uint256) {
  ...
  function _withdrawFundsTo(address _recipient, uint256 _amount) internal onlyGov returns (uint256, uint256) {
