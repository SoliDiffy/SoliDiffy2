...
library Array16Lib {
  ...
  function sumElements(uint16[] memory self) public view returns(uint256 sum) {
    uint256 term;
    uint8 remainder;
  ...
  function getMax(uint16[] memory self) public view returns(uint16 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint16[] memory self) public view returns(uint16 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  function indexOf(uint16[] memory self, uint16 value, bool isSorted)
           public
           view
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint16[] memory self) public {
  ...
  /// @param self Storage array containing uint256 type variables
  function uniq(uint16[] memory self) public returns (uint256 length) {
    bool contains;
    uint256 index;
