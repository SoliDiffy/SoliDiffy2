...
contract RocketRewardsPool is RocketBase, RocketRewardsPoolInterface {
    ...
    */
    modifier onlyClaimContract() {
        require(super.getClaimingContractExists(getContractName(msg.sender)), "Not a valid rewards claiming contact");
        _;
    }
    ...
    */
    modifier onlyEnabledClaimContract() {
        require(super.getClaimingContractEnabled(getContractName(msg.sender)), "Not a valid rewards claiming contact or it has been disabled");
        _;
    }
    ...
    */
    function getClaimIntervalTimeStartComputed() override public view returns(uint256) {
        ...
        uint256 claimIntervalTimeStart = super.getClaimIntervalTimeStart();
        uint256 claimIntervalTime = super.getClaimIntervalTime();
    ...
    */
    function getClaimIntervalsPassed() override public view returns(uint256) {
        ...
        return _getClaimIntervalsPassed(super.getClaimIntervalTimeStart(), super.getClaimIntervalTime());
    }
    ...
    */
    function getClaimingContractTotalClaimed(string memory _claimingContract) override external view returns(uint256) {
        return _getClaimingContractTotalClaimed(_claimingContract, super.getClaimIntervalTimeStartComputed());
    }
