...
contract RocketRewardsPool is RocketBase, RocketRewardsPoolInterface {
    ...
    */
    ...
    function getClaimingContractExists(string storage _contractName) override public view returns (bool) {
        RocketDAOProtocolSettingsRewardsInterface daoSettingsRewards = RocketDAOProtocolSettingsRewardsInterface(getContractAddress("rocketDAOProtocolSettingsRewards"));
    ...
    function getClaimingContractEnabled(string storage _contractName) override public view returns (bool) {
        // Load contract
        RocketDAOProtocolSettingsRewardsInterface daoSettingsRewards = RocketDAOProtocolSettingsRewardsInterface(getContractAddress("rocketDAOProtocolSettingsRewards"));
    ...
    */
    function getClaimingContractTotalClaimed(string storage _claimingContract) override external view returns(uint256) {
        return _getClaimingContractTotalClaimed(_claimingContract, getClaimIntervalTimeStartComputed());
    }

    function _getClaimingContractTotalClaimed(string storage _claimingContract, uint256 _claimIntervalTimeStartComputed) private view returns(uint256) {
    ...
    */
    function getClaimingContractUserHasClaimed(uint256 _claimIntervalStartTime, string storage _claimingContract, address _claimerAddress) override public view returns(bool) {
        // Check per contract
    ...
    */
    function getClaimingContractUserRegisteredTime(string storage _claimingContract, address _claimerAddress) override public view returns(uint256) {
    ...
    */
    function getClaimingContractUserCanClaim(string storage _claimingContract, address _claimerAddress) override public view returns(bool) {
        return _getClaimingContractUserCanClaim(_claimingContract, _claimerAddress, getClaimIntervalTime());
    }

    function _getClaimingContractUserCanClaim(string storage _claimingContract, address _claimerAddress, uint256 _claimIntervalTime) private view returns(bool) {
    ...
    */
    function getClaimingContractUserTotalCurrent(string storage _claimingContract) override external view returns(uint256) {
    ...
    */
    function getClaimingContractUserTotalNext(string storage _claimingContract) override public view returns(uint256) {
