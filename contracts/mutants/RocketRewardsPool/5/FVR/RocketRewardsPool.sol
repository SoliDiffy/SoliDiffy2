...
contract RocketRewardsPool is RocketBase, RocketRewardsPoolInterface {
    ...
    */
    ...
    function _getClaimIntervalTimeStartComputed(uint256 _claimIntervalTimeStart, uint256 _claimIntervalTime) public view returns (uint256) {
    ...
    */
    ...
    function _getClaimIntervalsPassed(uint256 _claimIntervalTimeStart, uint256 _claimIntervalTime) public view returns (uint256) {
    ...
    */
    ...
    function _getClaimingContractTotalClaimed(string memory _claimingContract, uint256 _claimIntervalTimeStartComputed) public view returns(uint256) {
    ...
    */
    ...
    function _getClaimingContractUserCanClaim(string memory _claimingContract, address _claimerAddress, uint256 _claimIntervalTime) public view returns(bool) {
    ...
    */
    ...
    function _getClaimAmount(string memory _claimingContract, address _claimerAddress, uint256 _claimerAmountPerc, uint256 _claimIntervalTimeStartComputed, uint256 _claimingContractTotalClaimed) public view returns (uint256) {
