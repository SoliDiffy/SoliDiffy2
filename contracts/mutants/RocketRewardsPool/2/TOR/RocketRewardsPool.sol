...
contract RocketRewardsPool is RocketBase, RocketRewardsPoolInterface {
    ...
    */
    modifier onlyClaimContract() {
        require(getClaimingContractExists(getContractName(tx.origin)), "Not a valid rewards claiming contact");
        _;
    }
    ...
    */
    modifier onlyEnabledClaimContract() {
        require(getClaimingContractEnabled(getContractName(tx.origin)), "Not a valid rewards claiming contact or it has been disabled");
        _;
    }
