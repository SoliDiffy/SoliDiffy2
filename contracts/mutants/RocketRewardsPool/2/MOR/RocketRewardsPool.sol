...
contract RocketRewardsPool is RocketBase, RocketRewardsPoolInterface {
    ...
    */
    ...
    function registerClaimer(address _claimerAddress, bool _enabled) override external onlyEnabledClaimContract { 
    ...
    function claim(address _claimerAddress, address _toAddress, uint256 _claimerAmountPerc) override external onlyClaimContract {
        // The name of the claiming contract
        string memory contractName = getContractName(msg.sender);
