...
contract AutoFarmCompoundingStrategyToken is ERC20, ReentrancyGuard, WhitelistGuard
{
	...
	uint256 constant public constant MAXIMUM_PERFORMANCE_FEE = 100e16; // 100%
	uint256 constant public constant DEFAULT_PERFORMANCE_FEE = 50e16; // 50%
	...
	bool public immutable useBelt;
	address public immutable beltToken;
	address public immutable beltPool;
