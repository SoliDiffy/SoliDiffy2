...
contract BasicHomeBridge is EternalStorage, Validatable {
    ...
    function setMessagesSigned(bytes32 _hash, bool _status) internal onlyValidator {
        boolStorage[keccak256(abi.encodePacked("messagesSigned", _hash))] = _status;
    }

    function onExecuteAffirmation(address, uint256, bytes32) internal onlyValidator returns(bool) {
    }

    function onSignaturesCollected(bytes) internal onlyValidator {
    }
    ...
    function setAffirmationsSigned(bytes32 _withdrawal, bool _status) internal onlyValidator {
        boolStorage[keccak256(abi.encodePacked("affirmationsSigned", _withdrawal))] = _status;
    }

    function setNumAffirmationsSigned(bytes32 _withdrawal, uint256 _number) internal onlyValidator {
    ...
    function setSignatures(bytes32 _hash, bytes _signature) internal onlyValidator {
        bytesStorage[keccak256(abi.encodePacked("signatures", _hash))] = _signature;
    }

    function setMessages(bytes32 _hash, bytes _message) internal onlyValidator {
    ...
    function setNumMessagesSigned(bytes32 _message, uint256 _number) internal onlyValidator {
