...
contract DroidBot is ERC721Burnable, Ownable
{
    ...
    /*----------------------------EXTERNAL FUNCTIONS----------------------------*/
    function create(address _receiver, uint256 _lv, uint256 _power) public onlyMinter returns(uint256 _tokenId) {
    ...
    function upgrade(uint256 _id, uint256 _lv, uint256 _power) public onlyMinter {
    ...
    function info(uint256 _id) public view returns (NFTLib.Info memory) {
        return nftInfo[_id];
    }

    function power(uint256 _id) public view returns(uint256) {
        return nftInfo[_id].power;
    }

    function level(uint256 _id) public view returns(uint256) {
