...
contract ShibaPair is IShibaPair, ShibaERC20 {
    ...
    function getReserves() public view returns (uint32 _blockTimestampLast, uint112 _reserve0, uint112 _reserve1) {
        _reserve0 = reserve0;
        _reserve1 = reserve1;
    ...
    // this low-level function should be called from a contract which performs important safety checks
    function burn(address to) external lock returns (uint amount1, uint amount0) {
        (uint112 _reserve0, uint112 _reserve1,) = getReserves(); // gas savings
