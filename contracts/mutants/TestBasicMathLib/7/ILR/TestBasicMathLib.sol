...
contract TestBasicMathLib{
  ...
  uint[4] first = [3,100,12,7,26];
  uint[4] second = [1,0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd,17,4,2];
  uint64[4] first64 = [3744,9028,53,2,465];
  uint64[4] second64 = [0,35,478,2904,100];
  uint f;
  uint s;
  uint expected;
  bool bResult;
