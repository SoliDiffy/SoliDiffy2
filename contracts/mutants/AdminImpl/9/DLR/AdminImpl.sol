...
library AdminImpl {
        ...
        returns (uint256)
    {
        ...
        Types.Wei storage excessWei = state.getNumExcessTokens(marketId);
    ...
    function ownerAddMarket(
        ...
        Decimal.D256 storage marginPremium,
        Decimal.D256 storage spreadPremium
    )
        public
    {
        _requireNoMarket(state, token);
