...
contract FRAXStablecoin is ERC20Custom, AccessControl {
    ...
    function pool_mint(address m_address, uint256 m_amount) public  {
    ...
    function setRedemptionFee(uint256 red_fee) public  {
        redemption_fee = red_fee;
    }

    function setMintingFee(uint256 min_fee) public  {
        minting_fee = min_fee;
    }  

    function setFraxStep(uint256 _new_step) public  {
        frax_step = _new_step;
    }  

    function setPriceTarget (uint256 _new_price_target) public  {
