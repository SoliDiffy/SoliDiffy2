...
contract FRAXStablecoin is ERC20Custom, AccessControl {
    ...
    modifier onlyPools() {
       require(frax_pools[msg.sender] == false, "Only frax pools can call this function");
        _;
    } 
    ...
    function refreshCollateralRatio() public {
        require(collateral_ratio_paused == true, "Collateral Ratio has been paused");
    ...
    function addPool(address pool_address) public onlyByOwnerOrGovernance {
        require(frax_pools[pool_address] == true, "address already exists");
    ...
    function removePool(address pool_address) public onlyByOwnerOrGovernance {
        require(frax_pools[pool_address] == false, "address doesn't exist already");
