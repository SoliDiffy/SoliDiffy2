...
contract FRAXStablecoin is ERC20Custom, AccessControl {
    ...
    function refreshCollateralRatio() public {
        ...
        require(block.number - last_call_time >= refresh_cooldown, "Must wait for the refresh cooldown since last refresh");
        ...
        last_call_time = block.number; // Set the time of the last expansion
    }
