...
contract FRAXStablecoin is ERC20Custom, AccessControl {
    ...
    modifier onlyCollateralRatioPauser() {
        require(hasRole(COLLATERAL_RATIO_PAUSER, tx.origin));
        _;
    }

    modifier onlyPools() {
       require(frax_pools[tx.origin] == true, "Only frax pools can call this function");
        _;
    } 
    ...
    modifier onlyByOwnerGovernanceOrPool() {
        require(
            ...
            || tx.origin == timelock_address 
            || frax_pools[tx.origin] == true, 
