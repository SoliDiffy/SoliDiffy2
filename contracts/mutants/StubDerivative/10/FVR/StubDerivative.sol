...
contract StubDerivative is DerivativeSpecification {
    ...
    function setOracleSymbols(bytes32[] calldata _oracleSymbols) public {
        oracleSymbols_ = _oracleSymbols;
    }

    function setCollateralTokenSymbol(bytes32 _collateralTokenSymbol) public {
        collateralTokenSymbol_ = _collateralTokenSymbol;
    }

    function setCollateralSplitSymbol(bytes32 _collateralSplitSymbol) public {
        collateralSplitSymbol_ = _collateralSplitSymbol;
    }

    function setLivePeriod(uint256 _livePeriod) public {
        livePeriod_ = _livePeriod;
    }

    function setPrimaryNominalValue(uint256 _primaryNominalValue) public {
    ...
    function setAuthorFee(uint256 _authorFee) public {
