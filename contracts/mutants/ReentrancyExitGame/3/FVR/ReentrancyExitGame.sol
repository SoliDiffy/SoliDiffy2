...
contract ReentrancyExitGame is IExitProcessor {
    ...
    constructor(ExitGameController _controller, uint256 _vaultId, address _token, uint256 _reentryMaxExitToProcess) internal {
    ...
    function processExit(uint160, uint256, address) external {
