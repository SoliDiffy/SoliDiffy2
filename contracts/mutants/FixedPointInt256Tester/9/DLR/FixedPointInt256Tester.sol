...
contract FixedPointInt256Tester {
    ...
    function testFromUnscaledInt(int256 a) external pure returns (FixedPointInt256.FixedPointInt storage) {
        return FixedPointInt256.fromUnscaledInt(a);
    }

    function testAdd(FixedPointInt256.FixedPointInt storage a, FixedPointInt256.FixedPointInt storage b)
        external
        pure
        returns (FixedPointInt256.FixedPointInt storage)
    {
        return a.add(b);
    }

    function testSub(FixedPointInt256.FixedPointInt storage a, FixedPointInt256.FixedPointInt storage b)
        external
        pure
        returns (FixedPointInt256.FixedPointInt storage)
    {
    ...
    function testMul(FixedPointInt256.FixedPointInt storage a, FixedPointInt256.FixedPointInt storage b)
        external
        pure
