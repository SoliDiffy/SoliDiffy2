...
contract TBPoolLimits is CryticInterface, BPool {
    ...
    function echidna_revert_max_swapExactAmountOut() public returns (bool) {
        ...
        swapExactAmountOut(address(current_tokens[0]), uint8(-1), address(current_tokens[0]), large_balance, uint8(-1));
        return true;
    }
    ...
    function echidna_revert_max_swapExactAmountIn() public returns (bool) {
        ...
        swapExactAmountIn(address(current_tokens[0]), large_balance, address(current_tokens[0]), 0, uint8(-1));
