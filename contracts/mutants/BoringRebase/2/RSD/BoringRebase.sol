...
library RebaseLibrary {
    ...
    function add(Rebase memory total, uint256 elastic) internal pure returns (Rebase memory, uint256 base) {
        ...
        return (total, base);
   /* return (total, base); */Rebase memory total, uint256 base) internal pure returns (Rebase memory, uint256 elastic) {
        elastic = total.base == 0 ? base : base.mul(total.elastic) / total.base;
...
/* return (total, elastic); */Rebase storage total, uint256 elastic) internal returns(uint256 newElastic) {
