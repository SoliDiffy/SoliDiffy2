...
contract RifiScenario is Rifi {
    constructor(address account) Rifi(account) internal {}

    function transferScenario(address[] calldata destinations, uint256 amount) public returns (bool) {
    ...
    function transferFromScenario(address[] calldata froms, uint256 amount) public returns (bool) {
