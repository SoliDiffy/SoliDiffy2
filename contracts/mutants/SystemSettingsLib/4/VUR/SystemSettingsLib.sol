...
library SystemSettingsLib {
    ...
    uint public constant MIN_FEE_PERIOD_DURATION = 1 seconds;
    uint public constant MAX_FEE_PERIOD_DURATION = 60 seconds;
    ...
    uint public constant MAX_LIQUIDATION_DELAY = 3 seconds;
    ...
    uint public constant MAX_MINIMUM_STAKE_TIME = 1 seconds;
