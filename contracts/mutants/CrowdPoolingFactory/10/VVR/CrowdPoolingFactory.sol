...
contract CrowdPoolingFactory is InitializableOwnable {
    ...
    address internal immutable _DVM_FACTORY_;
    address internal immutable _DEFAULT_MT_FEE_RATE_MODEL_;
    address internal immutable _DEFAULT_PERMISSION_MANAGER_;
    address internal _CP_TEMPLATE_;
    address internal _DEFAULT_MAINTAINER_;

    // ============ Settings =============

    uint256 internal _CAP_RATIO_ = 50; 
    uint256 internal _FREEZE_DURATION_ =  30 days;
    uint256 internal _CALM_DURATION_ = 0;
    uint256 internal _VEST_DURATION_ = 0;
