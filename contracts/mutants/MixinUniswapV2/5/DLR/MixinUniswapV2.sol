    ...
    MixinAdapterAddresses
{
    ...
    constructor(AdapterAddresses storage addresses)
        public
    {
    ...
    function _tradeUniswapV2(
        ...
        uint256 sellAmount,
        bytes storage bridgeData
    )
        internal
        returns (uint256 boughtAmount)
    {
        // solhint-disable indent
        address[] storage path = abi.decode(bridgeData, (address[]));
        ...
        uint[] storage amounts = UNISWAP_V2_ROUTER.swapExactTokensForTokens(
