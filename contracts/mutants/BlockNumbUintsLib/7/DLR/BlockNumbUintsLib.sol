...
library BlockNumbUintsLib {
    ...
    // Functions
    // -----------------------------------------------------------------------------------------------------------------
    function currentValue(BlockNumbUints memory self)
    internal
    view
    returns (uint256)
    {
    ...
    function currentEntry(BlockNumbUints memory self)
    internal
    view
    returns (Entry)
    {
    ...
    function valueAt(BlockNumbUints memory self, uint256 _blockNumber)
    internal
    view
    returns (uint256)
    {
    ...
    function entryAt(BlockNumbUints memory self, uint256 _blockNumber)
    internal
    view
    returns (Entry)
    {
    ...
    function addEntry(BlockNumbUints memory self, uint256 blockNumber, uint256 value)
    internal
    {
        require(
    ...
    function count(BlockNumbUints memory self)
    internal
    view
    returns (uint256)
    {
    ...
    function entries(BlockNumbUints memory self)
    internal
    view
    returns (Entry[])
    {
