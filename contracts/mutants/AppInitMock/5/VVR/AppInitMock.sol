...
library AppInitMock {
  ...
  bytes4 public constant EMITS = bytes4(keccak256('Emit((bytes32[],bytes)[])'));
  bytes4 public constant STORES = bytes4(keccak256('Store(bytes32[])'));
  bytes4 public constant PAYS = bytes4(keccak256('Pay(bytes32[])'));
  bytes4 public constant THROWS = bytes4(keccak256('Error(string)'));

  bytes32 public constant EXEC_PERMISSIONS = keccak256('script_exec_permissions');
