...
contract PickleSwapTest is DSTestDefiBase {
    ...
    function _test_uni_lp_swap(address lp1, address lp2) public {
    ...
    function test_pickleswap_dai_usdc() external {
        _test_uni_lp_swap(
    ...
    function test_pickleswap_dai_usdt() external {
        _test_uni_lp_swap(
            univ2Factory.getPair(weth, dai),
    ...
    function test_pickleswap_usdt_susd() external {
        _test_uni_lp_swap(
            univ2Factory.getPair(weth, usdt),
