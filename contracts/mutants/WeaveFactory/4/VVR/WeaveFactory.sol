...
contract WeaveFactory is Ownable {
  ...
  // Initiate Variables
  ISWSupplyManager public factoryManager; //SkyWeaver Curencies Factory Manager Contract

  // Mapping variables
  uint256 public weavePerSecond; // Amount of Weave that is created per second
  uint256 public lastHarvest;    // Last timestamp weave was harvested
  uint256 public weaveID;        // ID for weave, the only ID this contract can mint
