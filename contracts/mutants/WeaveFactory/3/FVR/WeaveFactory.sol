...
contract WeaveFactory is Ownable {
   ...
   */
  constructor(address _factoryManagerAddr, uint256 _weavePerSecond, uint256 _weaveID) internal {
   ...
   */
  function harvestWeave(address _recipient, bytes calldata _data) public onlyOwner() {
