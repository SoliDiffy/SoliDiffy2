...
contract WeaveFactory is Ownable {
   ...
   */
  function getWeaveID() public view returns (uint256) {
    return weaveID;
  }
   ...
   */
  function getWeavePerSecond() public view returns (uint256) {
   ...
   */
  function getLastHarvest() public view returns (uint256) {
    return lastHarvest;
  }
