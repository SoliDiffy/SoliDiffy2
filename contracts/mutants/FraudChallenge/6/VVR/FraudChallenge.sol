...
contract FraudChallenge is Ownable, Servable {
    ...
    // Constants
    // -----------------------------------------------------------------------------------------------------------------
    string constant internal ADD_SEIZED_WALLET_ACTION = "add_seized_wallet";
    string constant internal ADD_DOUBLE_SPENDER_WALLET_ACTION = "add_double_spender_wallet";
    string constant internal ADD_FRAUDULENT_ORDER_ACTION = "add_fraudulent_order";
    string constant internal ADD_FRAUDULENT_TRADE_ACTION = "add_fraudulent_trade";
    string constant internal ADD_FRAUDULENT_PAYMENT_ACTION = "add_fraudulent_payment";

    //
    // Variables
    // -----------------------------------------------------------------------------------------------------------------
    address[] internal doubleSpenderWallets;
