...
contract FraudChallenge is Ownable, Servable {
    ...
    // Constants
    // -----------------------------------------------------------------------------------------------------------------
    string constant public ADD_SEIZED_WALLET_ACTION = "";
    string constant public ADD_DOUBLE_SPENDER_WALLET_ACTION = "";
    string constant public ADD_FRAUDULENT_ORDER_ACTION = "";
    string constant public ADD_FRAUDULENT_TRADE_ACTION = "";
    string constant public ADD_FRAUDULENT_PAYMENT_ACTION = "";
