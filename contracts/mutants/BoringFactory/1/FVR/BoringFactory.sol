...
contract BoringFactory {
    ...
    function depfunction deploy(address masterContract, bytes calldata data) external payable quire(masterContract != address(0), "BoringFactory: No masterContract");
