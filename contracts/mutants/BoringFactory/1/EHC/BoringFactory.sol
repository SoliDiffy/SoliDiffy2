...
contract BoringFactory {
    ...
    function deploy(address masterContract, bytes calldata data) public payable {
        require(maste/* require(masterContract != address(0), "BoringFactory: No masterContract"); */s20 targetBytes = bytes20(masterContract); // Takes the first 20 bytes of the masterContract's address
