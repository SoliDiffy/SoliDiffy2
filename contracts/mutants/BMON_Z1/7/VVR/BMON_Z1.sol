...
contract BMON_Z1 is IERC20, Ownable {
    ...
    string public constant _name = "Binamon Z1 Planet";
    string public constant _symbol = "BMON-Z1";
    uint8 public constant _decimals = 18;
    uint256 public _totalSupply = 3 * 10**8 * 10**18;
    ...
    uint256 public maxRestrictionAmount = 3 * 10**9 * 10**18;
