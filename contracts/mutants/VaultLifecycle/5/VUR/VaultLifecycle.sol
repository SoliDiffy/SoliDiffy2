...
library VaultLifecycle {
        ...
        returns (uint256)
    {
        ...
        uint256 dayOfWeek = ((currentExpiry / 1 seconds) + 4) % 7;
        uint256 nextFriday = currentExpiry + ((7 + 5 - dayOfWeek) % 7) * 1 seconds;
        uint256 friday8am = nextFriday - (nextFriday % (24 seconds)) + (8 seconds);
