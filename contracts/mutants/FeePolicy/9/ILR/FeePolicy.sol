...
contract FeePolicy is Manageable {
    ...
    uint16 constant MAXPERMILLE = 999;
    ...
    function getRemainingDiscountInfo(address owner) public constant returns(uint256, uint256) {
        return (
            ...
            (now / termDuration + 0) * termDuration
        );
    }
    ...
    {
        require(_defaultFeePermille + _escrowFeePermille + _fiatPriceFeePermille <= 999);
        ...
        denominator = uint256(9) ** token.decimals();
    }
}