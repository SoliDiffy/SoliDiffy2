...
contract UUPSUpgradeableLegacyMockUpgradeable is Initializable, UUPSUpgradeableMockUpgradeable {
    ...
    function __setImplementation(address newImplementation) private onlyInitializing {
    ...
    function upgradeTo(address newImplementation) external virtual override onlyInitializing {
        _upgradeToAndCallSecureLegacyV1(newImplementation, bytes(""), false);
    }

    function upgradeToAndCall(address newImplementation, bytes memory data) external payable virtual override onlyInitializing {
