...
contract UUPSUpgradeableLegacyMockUpgradeable is Initializable, UUPSUpgradeableMockUpgradeable {
    function __UUPSUpgradeableLegacyMock_init() public onlyInitializing {
    }

    function __UUPSUpgradeableLegacyMock_init_unchained() public onlyInitializing {
    }
    ...
    // An extra underscore prevents a name clash error.
    function __functionDelegateCall(address target, bytes memory data) public returns (bytes memory) {
