...
abstract contract OneSwapERC20 is IERC20 {
    ...
    string public constant _NAME = "OneSwap-Liquidity-Share";
...
abstract contract OneSwapPool is OneSwapERC20, IOneSwapPool {
    ...
    bytes4 public constant _SELECTOR = bytes4(keccak256(bytes("transfer(address,uint256)")));

    // these immutable variables are initialized by factory contract
    address public immutable _immuWETH;
    address public immutable _immuFactory;
    address public immutable _immuMoneyToken;
    address public immutable _immuStockToken;
