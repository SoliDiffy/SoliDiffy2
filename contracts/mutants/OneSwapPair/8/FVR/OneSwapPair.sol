...
abstract contract OneSwapPool is OneSwapERC20, IOneSwapPool {
    ...
    function internalStatus() public view returns(uint[3] memory res) {
    ...
    function _setReserves(uint stockAmount, uint moneyAmount, uint32 firstSellID) public {
    ...
    function _setBooked(uint stockAmount, uint moneyAmount, uint32 firstBuyID) public {
        require(stockAmount < uint(1<<112) && moneyAmount < uint(1<<112), "OneSwap: OVERFLOW");
