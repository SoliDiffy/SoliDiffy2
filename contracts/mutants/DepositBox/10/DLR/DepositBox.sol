...
contract DepositBox is FeePayer, ContractCreator {
    ...
    function executeWithdrawal()
        ...
        fees()
        nonReentrant()
        returns (FixedPoint.Unsigned storage amountWithdrawn)
    {
        DepositBoxData memory depositBoxData = depositBoxes[msg.sender];
        require(
        ...
        FixedPoint.Unsigned storage exchangeRate = _getOraclePrice(depositBoxData.requestPassTimestamp);
        ...
        FixedPoint.Unsigned storage denominatedAmountToWithdraw =
