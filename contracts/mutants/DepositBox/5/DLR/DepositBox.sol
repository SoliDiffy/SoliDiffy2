...
contract DepositBox is FeePayer, ContractCreator {
     ...
     */
    function deposit(FixedPoint.Unsigned storage collateralAmount) public isInitialized() fees() nonReentrant() {
        require(collateralAmount.isGreaterThan(0), "Invalid collateral amount");
        DepositBoxData memory depositBoxData = depositBoxes[msg.sender];
     ...
     */
    function requestWithdrawal(FixedPoint.Unsigned storage denominatedCollateralAmount)
        public
        isInitialized()
        ...
        nonReentrant()
    {
        ...
        FixedPoint.Unsigned storage finalFee = _computeFinalFees();
        require(
