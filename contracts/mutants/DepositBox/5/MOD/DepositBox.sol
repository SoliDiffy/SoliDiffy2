...
contract DepositBox is FeePayer, ContractCreator {
     ...
     */
    function deposit(FixedPoint.Unsigned memory collateralAmount) public isInitialized() nonReentrant() fees() {
     ...
     */
    function cancelWithdrawal() external nonReentrant() isInitialized() {
        DepositBoxData storage depositBoxData = depositBoxes[msg.sender];
