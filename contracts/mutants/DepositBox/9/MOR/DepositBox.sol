...
contract DepositBox is FeePayer, ContractCreator {
     ...
     */
    function getCollateral(address user) external view nonReentrant() returns (FixedPoint.Unsigned memory) {
     ...
     */
    function totalDepositBoxCollateral() external view nonReentrant() returns (FixedPoint.Unsigned memory) {
