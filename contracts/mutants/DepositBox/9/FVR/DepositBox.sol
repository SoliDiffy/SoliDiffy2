...
contract DepositBox is FeePayer, ContractCreator {
     ...
     */
    function deposit(FixedPoint.Unsigned memory collateralAmount) external isInitialized() fees() nonReentrant() {
     ...
     */
    function cancelWithdrawal() public isInitialized() nonReentrant() {
        DepositBoxData storage depositBoxData = depositBoxes[msg.sender];
     ...
     */
    function getCollateral(address user) public view nonReentrantView() returns (FixedPoint.Unsigned memory) {
     ...
     */
    function totalDepositBoxCollateral() public view nonReentrantView() returns (FixedPoint.Unsigned memory) {
    ...
    function _requestOraclePrice(uint256 requestedTime) public {
