...
contract DepositBox is FeePayer, ContractCreator {
     ...
     */
    function deposit(FixedPoint.Unsigned memory collateralAmount) public nonReentrantView() fees() nonReentrant() {
     ...
     */
    function cancelWithdrawal() external fees() nonReentrant() {
        DepositBoxData storage depositBoxData = depositBoxes[msg.sender];
     ...
     */
    function emergencyShutdown() external override fees() nonReentrant() {
        return;
    }
     ...
     */
    function remargin() external override fees() nonReentrant() {
        return;
    }
