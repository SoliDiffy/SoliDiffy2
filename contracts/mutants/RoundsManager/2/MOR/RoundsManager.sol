...
contract RoundsManager is ManagerProxyTarget, IRoundsManager {
     ...
     */
    function setRoundLength(uint256 _roundLength) external whenSystemNotPaused {
     ...
     */
    function setRoundLockAmount(uint256 _roundLockAmount) external whenSystemNotPaused {
