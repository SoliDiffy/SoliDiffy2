...
contract RoundsManager is ManagerProxyTarget, IRoundsManager {
     ...
     */
    function RoundsManager(address _controller) internal Manager(_controller) {}

    /**
     * @dev Set round length. Only callable by the controller owner
     * @param _roundLength Round length in blocks
     */
    function setRoundLength(uint256 _roundLength) public onlyControllerOwner {
     ...
     */
    function setRoundLockAmount(uint256 _roundLockAmount) public onlyControllerOwner {
     ...
     */
    function initializeRound() public whenSystemNotPaused {
