...
contract MockCurvePool {
        ...
        external
    {
        ...
        IERC20(lpToken).transfer(tx.origin, sum);
    }
    ...
    function remove_liquidity_one_coin(
        ...
        IERC20(lpToken).transferFrom(tx.origin, address(this), _amount);
        ...
        IERC20(coins[uint128(_index)]).transfer(tx.origin, amount);
        ...
        public
    {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            IERC20(coins[i]).transfer(tx.origin, amount);
