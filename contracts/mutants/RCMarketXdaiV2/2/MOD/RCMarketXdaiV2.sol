...
contract RCMarketXdaiV2 is Initializable, NativeMetaTransaction {
    ...
    function upgradeCard(uint256 _tokenId) external onlyTokenOwner(_tokenId) checkState(States.WITHDRAW) {
    ...
    function newRental(uint256 _newPrice, uint256 _timeHeldLimit, address _startingPosition, uint256 _tokenId) public payable autoUnlock() checkState(States.OPEN) autoLock() {
