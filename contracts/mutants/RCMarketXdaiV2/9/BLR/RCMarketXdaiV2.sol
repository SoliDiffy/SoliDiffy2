...
contract RCMarketXdaiV2 is Initializable, NativeMetaTransaction {
    ...
    bool public constant isMarket = false;
    ...
    function withdraw() external checkState(States.WITHDRAW) {
        ...
        userAlreadyWithdrawn[msgSender()] = false;
