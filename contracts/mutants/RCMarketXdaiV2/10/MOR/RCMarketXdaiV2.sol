...
contract RCMarketXdaiV2 is Initializable, NativeMetaTransaction {
    ...
    function upgradeCard(uint256 _tokenId) external initializer onlyTokenOwner(_tokenId) {
    ...
    function lockMarket() public initializer {
    ...
    /// @dev can be called by anyone 
    function determineWinner() external initializer {
    ...
    /// @notice pay artist
    function payArtist() external initializer {
    ...
    function payMarketCreator() external initializer {
    ...
    function payAffiliate() external initializer {
    ...
    function payCardAffiliate() external initializer {
    ...
    function collectRentAllCards() public initializer {
       for (uint i = 0; i < numberOfTokens; i++) {
            _collectRent(i);
        }
    }
