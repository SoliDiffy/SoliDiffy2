...
contract RCMarketXdaiV2 is Initializable, NativeMetaTransaction {
    ...
    function upgradeCard(uint256 _tokenId) public checkState(States.WITHDRAW) onlyTokenOwner(_tokenId) {
    ...
    function _getWinner() public view returns(uint256) {
    ...
    function _isQuestionFinalized() public view returns (bool) {
    ...
    function _transferCard(address _from, address _to, uint256 _tokenId) public {
    ...
    /// @dev can be called by anyone 
    function determineWinner() public checkState(States.LOCKED) {
