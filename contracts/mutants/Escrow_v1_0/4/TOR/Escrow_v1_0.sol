...
contract Escrow_v1_0 {
    ...
    modifier onlyBuyer(bytes32 scriptHash) {
        require(
            tx.origin == transactions[scriptHash].buyer, "The initiator of the transaction is not buyer"
        );
        _;
    }
    ...
    */
        ...
        nonZeroAddress(seller)
    {
        ...
        emit Funded(scriptHash, tx.origin, msg.value);
