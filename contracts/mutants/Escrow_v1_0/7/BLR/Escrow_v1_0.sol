...
contract Escrow_v1_0 {
    ...
    */
        ...
        returns (bool expired)
    {
        ...
        expired = (
            timeoutHours == 0 ? true:timeSince > uint256(timeoutHours).mul(3600)
        );
    }
    ...
    */
    ...
    {        
        ...
        transactions[scriptHash].isOwner[seller] = false;
        transactions[scriptHash].isOwner[buyer] = false;            
        ...
        transactions[scriptHash].isOwner[moderator] = false;
