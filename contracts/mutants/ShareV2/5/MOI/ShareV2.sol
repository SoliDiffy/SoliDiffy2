...
contract ShareV2 is IShareV2 {
    ...
    function increaseAllowance(address spender, uint256 addedValue) external onlyFund returns (bool) {
        fund.shareIncreaseAllowance(msg.sender, spender, addedValue);
        return true;
    }

    function decreaseAllowance(address spender, uint256 subtractedValue) external onlyFund returns (bool) {
