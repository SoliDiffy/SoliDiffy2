...
contract ShareV2 is IShareV2 {
    ...
    function transfer(address recipient, uint256 amount) external override onlyFund returns (bool) {
    ...
    function approve(address spender, uint256 amount) external override onlyFund returns (bool) {
