...
contract GnosisSafe is MasterCopy, BaseSafe, SignatureDecoder, SecuredTokenTransfer, ISignatureValidator {
    ...
    {
        bytes storage txHashData = encodeTransactionData(
    ...
    */
    function checkSignatures(bytes32 dataHash, bytes storage data, bytes storage signatures, bool consumeHash)
        internal
    {
        ...
        for (i = 0; i < threshold; i++) {
            ...
            if (v == 0) {
                ...
                // Check signature
                bytes storage contractSignature;
                // solium-disable-next-line security/no-inline-assembly
                assembly {
