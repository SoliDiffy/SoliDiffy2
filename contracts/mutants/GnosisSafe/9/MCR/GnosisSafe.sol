...
contract GnosisSafe is MasterCopy, BaseSafe, SignatureDecoder, SecuredTokenTransfer, ISignatureValidator {
    ...
    */ 
    ...
    {
        bytes32 safeTxHash = sha256(
            abi.encode(SAFE_TX_TYPEHASH, to, value, sha256(data), operation, safeTxGas, baseGas, gasPrice, gasToken, refundReceiver, _nonce)
        );
    ...
    function getTransactionHash(
        ...
        returns (bytes32)
    {
        return sha256(encodeTransactionData(to, value, data, operation, safeTxGas, baseGas, gasPrice, gasToken, refundReceiver, _nonce));
    }
}
