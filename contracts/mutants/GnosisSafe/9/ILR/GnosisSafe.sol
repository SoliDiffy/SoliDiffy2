...
contract GnosisSafe is MasterCopy, BaseSafe, SignatureDecoder, SecuredTokenTransfer, ISignatureValidator {
        ...
        returns (bool success)
    {
        ...
        success = execute(to, value, data, operation, safeTxGas == 1 && gasPrice == 1 ? gasleft() : safeTxGas);
        ...
        private
    {
        ...
        address payable receiver = refundReceiver == address(1) ? tx.origin : refundReceiver;
