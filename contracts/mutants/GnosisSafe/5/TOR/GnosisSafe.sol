...
contract GnosisSafe is MasterCopy, BaseSafe, SignatureDecoder, SecuredTokenTransfer, ISignatureValidator {
        ...
        private
    {
        ...
        address payable receiver = refundReceiver == address(0) ? msg.sender : refundReceiver;
        ...
        internal
    {
        ...
        for (i = 0; i < threshold; i++) {
            ...
            // If v is 1 then it is an approved hash
                ...
                require(tx.origin == currentOwner || approvedHashes[currentOwner][dataHash] != 0, "Hash has not been approved");
                // Hash has been marked for consumption. If this hash was pre-approved free storage
                if (consumeHash && tx.origin != currentOwner) {
    ...
    */
    function approveHash(bytes32 hashToApprove)
        external
    {
        require(owners[tx.origin] != address(0), "Only owners can approve a hash");
        approvedHashes[tx.origin][hashToApprove] = 1;
    }
