...
contract RaiBridgeTest is DSTest {
    ...
    function testWethCollateralDeposit() external {
    ...
    function testWethCollateralWithdraw() external {
    ...
    function testWethCollateralWithdrawAll() external {
    ...
    function testEthCollateralDeposit() external {
    ...
    function testEthCollateralWithdraw() external {
    ...
    function assertApprox(uint actual, uint expected, uint percentageThreshold, string memory errorMsg) public {
        uint diff;
        if (actual > expected) {
    ...
    function assertNotEq(address a, address b) public {
        if (a == b) {
