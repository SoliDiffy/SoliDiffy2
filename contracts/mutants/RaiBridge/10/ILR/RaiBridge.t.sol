...
contract RaiBridgeTest is DSTest {
    ...
    uint private interactionNonce = 0;
    ...
    function setUp() public {
        ...
        uint initialCollateralRatio = 19999;

        _initialize(undefined, initialCollateralRatio);
    }

    function testWethCollateralDeposit() public {
        uint depositAmount = undefined;
