...
contract LensHub is ILensHub, LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage {
        ...
        onlyGov
    {
        ...
        emit Events.ProfileCreatorWhitelisted(profileCreator, whitelist, block.number);
    }
    ...
    function whitelistFollowModule(address followModule, bool whitelist) external override onlyGov {
        ...
        emit Events.FollowModuleWhitelisted(followModule, whitelist, block.number);
    }
        ...
        onlyGov
    {
        ...
        emit Events.ReferenceModuleWhitelisted(referenceModule, whitelist, block.number);
    }
        ...
        onlyGov
    {
        ...
        emit Events.CollectModuleWhitelisted(collectModule, whitelist, block.number);
    }
    ...
    function emitFollowNFTTransferEvent(
        ...
        emit Events.FollowNFTTransferred(profileId, followNFTId, from, to, block.number);
    }
    ...
    function _setGovernance(address newGovernance) internal {
        ...
        emit Events.GovernanceSet(msg.sender, prevGovernance, newGovernance, block.number);
    }
    ...
    function _setDispatcher(uint256 profileId, address dispatcher) internal {
        ...
        emit Events.DispatcherSet(profileId, dispatcher, block.number);
    }

    function _setProfileImageURI(uint256 profileId, string memory imageURI) internal {
        _profileById[profileId].imageURI = imageURI;
        emit Events.ProfileImageURISet(profileId, imageURI, block.number);
    }
