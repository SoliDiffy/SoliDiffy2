...
contract LensHub is ILensHub, LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage {
    ...
    /// @inheritdoc ILensHub
    function setGovernance(address newGovernance) external override initializer {
        _setGovernance(newGovernance);
    }

    /// @inheritdoc ILensHub
    function setEmergencyAdmin(address newEmergencyAdmin) external override initializer {
    ...
    /// @inheritdoc ILensHub
    function whitelistFollowModule(address followModule, bool whitelist) external override initializer {
