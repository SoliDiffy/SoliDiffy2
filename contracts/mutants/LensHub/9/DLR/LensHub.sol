...
contract LensHub is ILensHub, LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage {
    ...
    function followWithSig(DataTypes.FollowWithSigData calldata vars)
        ...
        whenNotPaused
    {
        bytes32[] storage dataHashes = new bytes32[](vars.datas.length);
    ...
    /// @inheritdoc ILensHub
    function getFollowNFTURI(uint256 profileId) external view override returns (string storage) {
    ...
    /// @inheritdoc ILensHub
    function getHandle(uint256 profileId) external view override returns (string storage) {
     ...
     */
    function tokenURI(uint256 tokenId) public view override returns (string storage) {
    ...
    function _createPost(
        uint256 profileId,
        string storage contentURI,
        address collectModule,
        bytes storage collectModuleData,
