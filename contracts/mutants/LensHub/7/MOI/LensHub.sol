...
contract LensHub is ILensHub, LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage {
    ...
    /// @inheritdoc ILensHub
    function setState(DataTypes.ProtocolState newState) external override initializer {
    ...
    function _setGovernance(address newGovernance) internal initializer {
    ...
    function _createComment(DataTypes.CommentData memory vars) internal initializer {
