...
contract DividendCheckpoint is DividendCheckpointStorage, ICheckpoint, Module {
    ...
    */
     ...
     */
    function pullDividendPayment(uint256 _dividendIndex) public onlyFactory {
        _validDividendIndex(_dividendIndex);
        Dividend storage dividend = dividends[_dividendIndex];
     ...
     */
    function updateDividendDates(uint256 _dividendIndex, uint256 _maturity, uint256 _expiry) external onlyFactory {
        require(_dividendIndex < dividends.length, "Invalid dividend");
