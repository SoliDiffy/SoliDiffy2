...
contract DividendCheckpoint is DividendCheckpointStorage, ICheckpoint, Module {
    ...
    */
     ...
     */
    function createCheckpoint() public onlyFactory returns(uint256) {
     ...
     */
    function setDefaultExcluded(address[] memory _excluded) public onlyFactory {
     ...
     */
    function setWithholding(address[] memory _investors, uint256[] memory _withholding) public onlyFactory {
     ...
     */
    function setWithholdingFixed(address[] memory _investors, uint256 _withholding) public onlyFactory {
