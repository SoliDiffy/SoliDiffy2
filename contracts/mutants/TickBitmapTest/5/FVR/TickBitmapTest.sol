...
contract TickBitmapTest {
    ...
    function getGasCostOfFlipTick(int24 tick) public returns (uint256) {
    ...
    function getGasCostOfNextInitializedTickWithinOneWord(int24 tick, bool lte) public view returns (uint256) {
        uint256 gasBefore = gasleft();
