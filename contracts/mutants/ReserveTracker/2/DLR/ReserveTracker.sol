...
contract ReserveTracker {
    ...
    function getFRAXCurvePrice() public returns (uint256) {
        uint256[2] storage new_twap = frax_metapool.get_price_cumulative_last();
        uint256[2] storage balances = frax_metapool.get_twap_balances(old_twap, new_twap, block.timestamp - last_timestamp);
