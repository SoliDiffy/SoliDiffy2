...
contract ReserveTracker {
    ...
    function getFRAXPrice() external view returns (uint256) {
    ...
    function getFRAXCurvePrice() external returns (uint256) {
    ...
    function getFXSPrice() external view returns (uint256) {
    ...
    function getFXSReserves() external view returns (uint256) {
    ...
    function setFRAXPriceOracle(address _frax_price_oracle_address, address _frax_pair_collateral_address, uint256 _frax_pair_collateral_decimals) external onlyByOwnerOrGovernance {
    ...
    function setMetapool(address _frax_metapool_address) external onlyByOwnerOrGovernance {
    ...
    function setFXSETHOracle(address _fxs_weth_oracle_address, address _weth_address) external onlyByOwnerOrGovernance {
        fxs_weth_oracle_address = _fxs_weth_oracle_address;
    	weth_address = _weth_address;
    	fxs_weth_oracle = UniswapPairOracle(fxs_weth_oracle_address);
    }

    function setETHCollateralOracle(address _weth_collateral_oracle_address, uint _collateral_decimals) external onlyByOwnerOrGovernance {
    ...
    function addFXSPair(address pair_address) external onlyByOwnerOrGovernance {
