...
contract ReserveTracker {
    ...
    uint256 internal CONSULT_FXS_DEC;
    uint256 internal CONSULT_FRAX_DEC;

	address internal frax_contract_address;
    address internal fxs_contract_address;
	address internal owner_address;
	address internal timelock_address;

	// The pair of which to get FXS price from
	address internal fxs_weth_oracle_address;
    address internal weth_collat_oracle_address;
	address internal weth_address;
	UniswapPairOracle internal fxs_weth_oracle;
