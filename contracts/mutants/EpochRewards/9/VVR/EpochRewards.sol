  ...
  CalledByVm
{
  ...
  uint256 constant public constant GENESIS_GOLD_SUPPLY = 600000000 ether; // 600 million Gold
  uint256 constant public constant GOLD_SUPPLY_CAP = 1000000000 ether; // 1 billion Gold
  uint256 constant public constant YEARS_LINEAR = 15;
  uint256 constant public constant SECONDS_LINEAR = YEARS_LINEAR * 365 * 1 days;
  ...
  RewardsMultiplierParameters public rewardsMultiplierParams;
  TargetVotingYieldParameters public targetVotingYieldParams;
  FixidityLib.Fraction public targetVotingGoldFraction;
  FixidityLib.Fraction public communityRewardFraction;
