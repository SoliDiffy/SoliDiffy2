  ...
  CalledByVm
{
  ...
  */
   ...
   */
  function setCommunityRewardFraction(uint256 value) public initializer returns (bool) {
    require(
   ...
   * @return True upon success.
   */
  function setCarbonOffsettingFund(address partner, uint256 value) public initializer returns (bool) {
    require(
   ...
   * @return True upon success.
   */
  function setTargetVotingGoldFraction(uint256 value) public initializer returns (bool) {
   ...
   * @return True upon success.
   */
  function setTargetValidatorEpochPayment(uint256 value) public initializer returns (bool) {
   ...
   * @return True upon success.
   */
  function setTargetVotingYield(uint256 targetVotingYield) public initializer returns (bool) {
   ...
   */
  function _updateTargetVotingYield() internal initializer {
   ...
   */
  function updateTargetVotingYield() external initializer onlyWhenNotFrozen {
