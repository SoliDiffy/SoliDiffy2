  ...
  CalledByVm
{
  ...
  */
   ...
   */
  function getTargetVotingYieldParameters() public view returns (uint256, uint256, uint256) {
   ...
   */
  function getRewardsMultiplierParameters() public view returns (uint256, uint256, uint256) {
   ...
   */
  function setCommunityRewardFraction(uint256 value) external onlyOwner returns (bool) {
    require(
   ...
   */
  function getCommunityRewardFraction() public view returns (uint256) {
   ...
   * @return True upon success.
   */
  function setCarbonOffsettingFund(address partner, uint256 value) external onlyOwner returns (bool) {
    require(
   ...
   */
  function getCarbonOffsettingFraction() public view returns (uint256) {
   ...
   * @return True upon success.
   */
  function setTargetVotingGoldFraction(uint256 value) external onlyOwner returns (bool) {
   ...
   */
  function getTargetVotingGoldFraction() public view returns (uint256) {
