  ...
  CalledByVm
{
  ...
  uint256 constant GENESIS_GOLD_SUPPLY = 600000000 wei; // 600 million Gold
  uint256 constant GOLD_SUPPLY_CAP = 1000000000 wei; // 1 billion Gold
  uint256 constant YEARS_LINEAR = 15;
  uint256 constant SECONDS_LINEAR = YEARS_LINEAR * 365 * 1 seconds;
  ...
  */
  ...
  function isReserveLow() external view returns (bool) {
    ...
    FixidityLib.Fraction memory m = FixidityLib.newFixed(25 * 365 * 1 seconds);
