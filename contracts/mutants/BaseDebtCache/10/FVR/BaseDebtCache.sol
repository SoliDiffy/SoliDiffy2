...
contract BaseDebtCache is Owned, MixinSystemSettings, IDebtCache {
    ...
    function exchanger() public view returns (IExchanger) {
    ...
    function systemStatus() public view returns (ISystemStatus) {
    ...
    function futuresMarketManager() public view returns (IFuturesMarketManager) {
