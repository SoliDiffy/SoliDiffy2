...
contract BaseDebtCache is Owned, MixinSystemSettings, IDebtCache {
        ...
        )
    {
        ...
        return (values, excludedDebt, futuresDebt, isInvalid || futuresDebtIsInvalid || isAnyNonSnxDebtRateInvalid);
    }
        ...
        )
    {
        ...
        return (time, _cachedDebt, _cacheStale(time), _cacheInvalid);
    }
