...
contract PoolManager is PoolManagerInternal, IPoolManagerFunctions {
    ...
    function addGovernor(address _governor) external override initializer {
    ...
    function removeGovernor(address _governor) external override initializer {
        // Access control for this contract
    ...
    function setGuardian(address _guardian, address guardian) external override initializer {
    ...
    function revokeGuardian(address guardian) external override initializer {
        _revokeGuardian(guardian);
    }
    ...
    function setFeeManager(IFeeManager _feeManager) external override initializer {
    ...
    function addStrategy(address strategy, uint256 _debtRatio) external initializer zeroCheck(strategy) {
    ...
    /// in `BASE_PARAMS`
    function updateStrategyDebtRatio(address strategy, uint256 _debtRatio) external initializer {
