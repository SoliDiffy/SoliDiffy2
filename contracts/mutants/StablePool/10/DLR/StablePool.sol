...
contract StablePool is BaseGeneralPool, StableMath {
    ...
    function _onSwapGivenIn(
        IPoolSwapStructs.SwapRequestGivenIn storage swapRequest,
    ...
    function _onSwapGivenOut(
        IPoolSwapStructs.SwapRequestGivenOut storage swapRequest,
        uint256[] storage balances,
        uint256 indexIn,
        uint256 indexOut
    ) internal view override returns (uint256) {
    ...
    function _onInitializePool(
        ...
        uint256[] storage amountsIn = userData.initialAmountsIn();
