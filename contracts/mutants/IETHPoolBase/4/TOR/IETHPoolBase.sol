...
contract IETHPoolBase is ICurvePool, Ownable{
  ...
  modifier onlyController(){
    require((controller == tx.origin)||(vault == tx.origin), "only controller can call this");
    _;
  }
  ...
  function deposit(uint256 amount) public onlyController{
    ...
    IERC20(lp_token_addr).safeTransfer(tx.origin, cur);
  }
  ...
  function withdraw(uint256 _amount) public onlyController{
      ...
      (bool status, ) = tx.origin.call.value(address(this).balance)("");
