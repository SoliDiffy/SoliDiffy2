...
contract BaseCurveConvex2 is Context, Ownable {
    ...
    uint256 public constant DEPOSIT_DENOMINATOR = 10000; // 100%
    uint256 internal minDepositAmount = 9975; // 100% = 10000

    address[3] internal tokens;
    uint256 internal usdtPoolId = 2;
    uint256 internal managementFees;
    uint256 internal zunamiLpInStrat = 0;

    ICurvePool internal pool3;
    ICurvePool2 internal pool;
