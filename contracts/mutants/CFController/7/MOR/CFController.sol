...
contract CFControllerV2 is Ownable{
  ...
  function add_pool(address addr) public onlyVault{
  ...
  function remove_pool(address addr) public onlyVault{
  ...
  function change_current_pool(address addr) public onlyVault{
    require(all_pools.exists(addr), "not exist");
  ...
  function earnReward(uint min_amount) public onlyVault{
