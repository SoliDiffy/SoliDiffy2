...
contract CFControllerV2 is Ownable{
  ...
  address[] internal all_pools;

  address internal current_pool;

  uint256 internal last_earn_block;
  uint256 internal earn_gap;
  address internal crv_token;
  address internal target_token;

  address internal fee_pool;
  uint256 internal harvest_fee_ratio;
