...
interface ISwapFlashLoan {
    ...
    function swapStorage() external view returns (uint256 adminFee, uint256 initialA, uint256 futureA, uint256 initialATime, uint256 futureATime, uint256 swapFee, address lpToken);
