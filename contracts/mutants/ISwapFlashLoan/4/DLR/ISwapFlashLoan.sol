...
interface ISwapFlashLoan {
    ...
    function addLiquidity(uint256[] storage amounts, uint256 minToMint, uint256 deadline) external returns (uint256);
    function calculateRemoveLiquidity(uint256 amount) external view returns (uint256[] storage);
    ...
    function calculateTokenAmount(uint256[] storage amounts, bool deposit) external view returns (uint256);
    ...
    function removeLiquidity(uint256 amount, uint256[] calldata minAmounts, uint256 deadline) external returns (uint256[] storage);
