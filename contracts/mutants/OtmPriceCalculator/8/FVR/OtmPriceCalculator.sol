...
contract OtmPriceCalculator is IPremiumCalculator, Ownable {
     ...
     **/
    function setBorder(uint256 value) public onlyOwner {
        border = value;
    }
     ...
     **/
    function setStrikePercentage(uint256 value) public onlyOwner {
    ...
    function setImpliedVolRate0(uint256 value) public onlyOwner {
     ...
     * @param value New IVRate value
     **/
    function setImpliedVolRate1(uint256 value) public onlyOwner {
     ...
     **/
    function setSettlementFeeShare(uint256 value) public onlyOwner {
        require(value <= 100, "The value is too large");
        settlementFeeShare = value;
    }

    function setMaxPeriod(uint256 value) public onlyOwner {
        maxPeriod = value;
    }
    ...
    function round(uint value, uint8 decimals) external pure returns (uint roundedValue) {
     ...
     * @return price Price
     **/
    function _currentPrice() public view returns (uint256 price) {
