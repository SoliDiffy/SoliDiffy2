...
contract OtmPriceCalculator is IPremiumCalculator, Ownable {
    ...
    uint256 internal impliedVolRate0;
    uint256 internal impliedVolRate1;
    uint256 internal border = 20;
    uint256 internal strikePercentage;
    // uint256 internal immutable priceDecimals;
    uint256 public constant IVL_DECIMALS = 1e18;
    uint256 internal settlementFeeShare = 0;
    uint256 internal maxPeriod = 45 days;
