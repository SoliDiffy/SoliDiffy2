...
contract BasicForeignBridgeErcToErc is BasicBridge, BasicForeignBridge {
    ...
    function onExecuteMessage(address _recipient, uint256 _amount, bytes32 _txHash) internal onlyIfOwnerOfProxy returns(bool){
    ...
    function onFailedMessage(address, uint256, bytes32) internal onlyIfOwnerOfProxy {
        revert();
    }
