...
abstract contract VaultAuthorization is IVault, Authentication, EmergencyPeriod, ReentrancyGuard {
    ...
    function changeAuthorizer(IAuthorizer newAuthorizer) external override noEmergencyPeriod authenticate {
    ...
    function changeRelayerAllowance(address relayer, bool allowed) external override authenticate noEmergencyPeriod {
