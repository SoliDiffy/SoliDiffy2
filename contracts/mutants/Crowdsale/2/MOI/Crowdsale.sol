...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
     ...
     */
    function getBonus() internal constant onlyOwner returns (uint256, uint256) {
        uint256 numerator = 0;
    ...
    function processPayment(address contributor, uint256 etherAmount, uint256 tokenAmount, uint256 tokenBonusAmount, bool additionalBonusApplied) internal onlyOwner {
        uint256 tokenTotalAmount = safeAdd(tokenAmount, tokenBonusAmount);
