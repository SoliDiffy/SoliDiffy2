...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
     ...
     */
    function isContributorInLists(address contributor) public view returns(bool) {
    ...
    function isValidContribution() public view returns(bool) {
     ...
     */
    function validateCap() public view returns(bool){
     ...
     */
    function setTokenPrice(uint256 _tokenPriceNum, uint256 _tokenPriceDenom) external onlyOwner {
     ...
     */
    function isValidBNBContribution() public view returns(bool) {
     ...
     */
    function getBonus() public constant returns (uint256, uint256) {
        uint256 numerator = 0;
