...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
    ...
    uint256 internal constant ADDITIONAL_BONUS_NUM = 3;
    uint256 internal constant ADDITIONAL_BONUS_DENOM = 100;

    uint256 internal constant ETHER_MIN_CONTRIB = 0.2 ether;
    uint256 internal constant ETHER_MAX_CONTRIB = 20 ether;

    uint256 internal constant ETHER_MIN_CONTRIB_PRIVATE = 100 ether;
    uint256 internal constant ETHER_MAX_CONTRIB_PRIVATE = 3000 ether;

    uint256 internal constant ETHER_MIN_CONTRIB_USA = 0.2 ether;
    uint256 internal constant ETHER_MAX_CONTRIB_USA = 20 ether;

    uint256 internal constant SALE_START_TIME = 1523887200; // 16.04.2018 14:00:00 UTC
    uint256 internal constant SALE_END_TIME = 1526479200; // 16.05.2018 14:00:00 UTC
