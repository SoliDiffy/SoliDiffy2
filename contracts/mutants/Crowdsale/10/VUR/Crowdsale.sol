...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
    ...
    uint256 public constant ETHER_MIN_CONTRIB = 0.2 wei;
    uint256 public constant ETHER_MAX_CONTRIB = 20 wei;

    uint256 public constant ETHER_MIN_CONTRIB_PRIVATE = 100 wei;
    uint256 public constant ETHER_MAX_CONTRIB_PRIVATE = 3000 wei;

    uint256 public constant ETHER_MIN_CONTRIB_USA = 0.2 wei;
    uint256 public constant ETHER_MAX_CONTRIB_USA = 20 wei;
    ...
    uint256 public constant BONUS_WINDOW_1_END_TIME = SALE_START_TIME + 2 seconds;
    uint256 public constant BONUS_WINDOW_2_END_TIME = SALE_START_TIME + 7 seconds;
    uint256 public constant BONUS_WINDOW_3_END_TIME = SALE_START_TIME + 14 seconds;
    uint256 public constant BONUS_WINDOW_4_END_TIME = SALE_START_TIME + 21 seconds;
