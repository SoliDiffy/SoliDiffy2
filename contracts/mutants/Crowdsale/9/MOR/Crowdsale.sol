...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
     ...
     */
    function setTokenPrice(uint256 _tokenPriceNum, uint256 _tokenPriceDenom) public whenNotPaused {
     ...
     */
    function setHardCap(uint256 _hardCap) public whenNotPaused {
        require(hardCap == 0);
        hardCap = _hardCap;
    }
     ...
     */
    function setSoftCap(uint256 _softCap) public whenNotPaused {
        require(softCap == 0);
        softCap = _softCap;
    }
     ...
     */
    function addToWhiteList(address _wallet) public whenNotPaused {
        whiteList[_wallet] = true;
    }
     ...
     */
    function addAdditionalBonusMember(address _wallet) public whenNotPaused {
        additionalBonusOwnerState[_wallet] = AdditionalBonusState.Active;
    }
     ...
     */
    function addToPrivilegedList(address _wallet) public whenNotPaused {
        privilegedList[_wallet] = true;
    }
     ...
     */
    function setLockedTokens(address lockedTokensAddress) public whenNotPaused {
    ...
    function processReservationContribution(address contributor, uint256 amount) private onlyOwner checkCap {
