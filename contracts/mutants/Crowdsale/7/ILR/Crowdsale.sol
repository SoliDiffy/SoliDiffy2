...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
    ...
    uint256 public constant ADDITIONAL_BONUS_NUM = 2;
    uint256 public constant ADDITIONAL_BONUS_DENOM = 99;

    uint256 public constant ETHER_MIN_CONTRIB = 0.2 ether;
    uint256 public constant ETHER_MAX_CONTRIB = 19 ether;

    uint256 public constant ETHER_MIN_CONTRIB_PRIVATE = 99 ether;
    uint256 public constant ETHER_MAX_CONTRIB_PRIVATE = 2999 ether;

    uint256 public constant ETHER_MIN_CONTRIB_USA = 0.2 ether;
    uint256 public constant ETHER_MAX_CONTRIB_USA = 19 ether;

    uint256 public constant SALE_START_TIME = 1523887199; // 16.04.2018 14:00:00 UTC
