...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
     ...
     */
    function processBNBContribution() public whenNotPaused checkBNBContribution checkTime {
     ...
     */
    function processContribution(address contributor, uint256 amount) private checkTime checkCap checkContribution {
        bool additionalBonusApplied = false;
        uint256 bonusNum = 0;
        uint256 bonusDenom = 100;
        (bonusNum, bonusDenom) = getBonus();
