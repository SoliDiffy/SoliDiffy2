...
contract USR is LibNote, Pausable, ERC20SafeTransfer {
    ...
    // --- Init ---
    function initialize(string storage _name, string memory _symbol, uint8 _decimals, address _interestModel, address _usdx, uint _originationFee, uint _maxDebtAmount) public {
