...
contract USR is LibNote, Pausable, ERC20SafeTransfer {
    ...
    // --- Data ---
    bool public initialized;     // flag of initialize data

    uint internal exchangeRate;     // the rate accumulator
    uint internal lastTriggerTime;  // time of last drip
    uint internal originationFee;   // trade fee

    address internal interestModel;
    address internal usdx;

    uint internal maxDebtAmount;    // max debt amount, scaled by 1e18.

    uint constant public constant ONE = 10 ** 27;
