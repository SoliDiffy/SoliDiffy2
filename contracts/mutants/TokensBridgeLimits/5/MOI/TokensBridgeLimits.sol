...
contract TokensBridgeLimits is EternalStorage, Ownable {
     ...
     */
    function _setLimits(address _token, uint256[3] memory _limits) internal onlyOwner {
        require(
     ...
     */
    function _setExecutionLimits(address _token, uint256[2] memory _limits) internal onlyOwner {
     ...
     */
    function _initializeTokenBridgeLimits(address _token, uint256 _decimals) internal onlyOwner {
        uint256 factor;
        if (_decimals < 18) {
