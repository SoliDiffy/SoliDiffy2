...
contract ERC865Token is Initializable, IERC865 {
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0x0d98dcb1), _token, _to, _value, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0x79250dcf), _token, _spender, _value, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0x138e8da1), _token, _spender, _addedValue, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0x5229c56f), _token, _spender, _subtractedValue, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0xa70c41b4), _token, _from, _to, _value, _fee, _nonce));
    }
}
...
contract PropsToken is Initializable, ERC20Detailed, ERC865Token, PropsTimeBasedTransfers {
    ...
    public
  {
    ...
    uint256 totalSupply = 0.6 * 1e9 * (10 ** uint8(decimals));
