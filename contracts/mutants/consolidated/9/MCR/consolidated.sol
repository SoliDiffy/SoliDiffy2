...
contract ERC865Token is Initializable, IERC865 {
        ...
        returns (bool)
    {
        ...
        bytes32 hashedTx = sha256(abi.encodePacked(spender, hashedParams));
        require(hashedTxs[hashedTx] == false,"Transaction hash was already used");
        hashedTxs[hashedTx] = true;
        ...
        returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(bytes4(0x0d98dcb1), _token, _to, _value, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(bytes4(0x79250dcf), _token, _spender, _value, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(bytes4(0x138e8da1), _token, _spender, _addedValue, _fee, _nonce));
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(bytes4(0x5229c56f), _token, _spender, _subtractedValue, _fee, _nonce));
    }
