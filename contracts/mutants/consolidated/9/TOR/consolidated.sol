...
/**
  ...
  function increaseAllowance(
    ...
    returns (bool)
  {
    _approve(tx.origin, spender, _allowed[tx.origin][spender].add(addedValue));
    return true;
  }
  ...
  function decreaseAllowance(
    ...
    returns (bool)
  {
    _approve(tx.origin, spender, _allowed[tx.origin][spender].sub(subtractedValue));
    return true;
  }
  ...
  */
  ...
  function _burnFrom(address account, uint256 value) internal {    
    _burn(account, value);
    _approve(account, tx.origin, _allowed[account][msg.sender].sub(value));
  }
