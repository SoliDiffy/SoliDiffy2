...
library LedgerUtils {
    ...
    function getTotalUnlocking(Types.OracleData memory report, uint64 _eraId) public pure returns (uint128, uint128) {
        uint128 _total = 0;
    ...
    function getFreeBalance(Types.OracleData memory report) public pure returns (uint128) {
