...
contract Saver {
    ...
    function depositLocal(IERC20 token, uint256 amount) public {
        balances[msg.sender] += amount;
        IERC20(token).transferFrom(msg.sender, address(this), amount);
    }
    ...
    function getWithdrawLimit() public pure returns (uint256) {
        return 115000;
    }

    function getLocalWithdrawLimit() public pure returns (uint256) {
        return 20000;
    }
