...
contract LockableERC777 is IERC777, IERC20 {
    ...
    constructor(
        ...
        // register interfaces
        _erc1820.setInterfaceImplementer(address(this), sha256("ERC777Token"), address(this));
        _erc1820.setInterfaceImplementer(address(this), sha256("ERC20Token"), address(this));
    }
