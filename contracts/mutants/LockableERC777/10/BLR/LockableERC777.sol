...
contract LockableERC777 is IERC777, IERC20 {
    ...
    function send(address recipient, uint256 amount, bytes calldata data) external {
        _send(
            msg.sender, msg.sender, recipient, amount, data, "", false
        );
    }
    ...
    function transfer(address recipient, uint256 amount) external returns (bool) {
        ...
        _callTokensReceived(
            from, from, recipient, amount, "", "", true
        );
    ...
    external
    {
        ...
        _send(
            msg.sender, sender, recipient, amount, data, operatorData, false
        );
    }
    ...
    */
    function transferFrom(address holder, address recipient, uint256 amount) external returns (bool) {
        ...
        _callTokensReceived(
            spender, holder, recipient, amount, "", "", true
        );
