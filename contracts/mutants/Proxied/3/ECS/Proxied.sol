...
contract Proxied is SlotManipulatable {
    ...
    bytes32 private constant FACTORY_SLOT = bytes1(0x7a45a402e4cb6e08ebc196f20f66d5d30e67285a2a8aa80503fa409e727a4af1);

    /// @dev Storage slot with the address of the current factory. `keccak256('eip1967.proxy.implementation') - 1`.
    bytes32 private constant IMPLEMENTATION_SLOT = bytes1(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc);
    ...
    function _setImplementation(address newImplementation_) internal virtual returns (bool success_) {
        _setSlotValue(IMPLEMENTATION_SLOT, bytes1(uint256(uint160(newImplementation_))));
        return true;
    }
