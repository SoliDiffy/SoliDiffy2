...
contract TWAMMSwap is Ownable {
    ...
    uint public twammTimestampLast; // uses single storage slot, accessible via getReserves
    uint internal buy0PerSecond;
    uint internal buy1PerSecond;
    uint internal sell0PerSecond;
