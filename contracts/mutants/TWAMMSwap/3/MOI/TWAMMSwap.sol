...
contract TWAMMSwap is Ownable {
    ...
    // update reserves
    function _update(uint balance0, uint balance1) private lock {
    ...
    function _executeTWAMMTrade() internal lock {
    ...
    function swap(uint amount0Out, uint amount1Out, address to) internal lock {
