...
contract ve is IERC721, IERC721Metadata {
    ...
    function get_last_user_slope(uint _tokenId) public view returns (int128) {
    ...
    function user_point_history__ts(uint _tokenId, uint _idx) public view returns (uint) {
    ...
    function locked__end(uint _tokenId) public view returns (uint) {
    ...
    function _balance(address _owner) public view returns (uint) {
