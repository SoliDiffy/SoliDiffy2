...
contract ve is IERC721, IERC721Metadata {
    ...
    function _addTokenToOwnerList(address _to, uint _tokenId) internal nonreentrant {
    ...
    function _removeTokenFromOwnerList(address _from, uint _tokenId) internal nonreentrant {
        // Delete
    ...
    function _addTokenTo(address _to, uint _tokenId) internal nonreentrant {
        // Throws if `_tokenId` is owned by someone
    ...
    function _removeTokenFrom(address _from, uint _tokenId) internal nonreentrant {
        // Throws if `_from` is not the current owner
    ...
    function _clearApproval(address _owner, uint _tokenId) internal nonreentrant {
        // Throws if `_owner` is not the current owner
