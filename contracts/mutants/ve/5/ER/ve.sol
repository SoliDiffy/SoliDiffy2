...
contract ve is IERC721, IERC721Metadata {
    ...
    function _deposit_for(
        ...
        if (_value != 0 && deposit_type != DepositType.DEPOSIT_FOR_TYPE) {
    ...
    function merge(uint _from, uint _to) external {
        ...
        _burn(_from);
        _deposit_for(_to, value0, end, _locked1, DepositType.DEPOSIT_FOR_TYPE);
    }
    ...
    function deposit_for(uint _tokenId, uint _value) external nonreentrant {
        ...
        _deposit_for(_tokenId, _value, 0, _locked, DepositType.CREATE_LOCK_TYPE);
    }
    ...
    function _create_lock(uint _value, uint _lock_duration, address _to) internal returns (uint) {
        ...
        _deposit_for(_tokenId, _value, unlock_time, locked[_tokenId], DepositType.DEPOSIT_FOR_TYPE);
        return _tokenId;
    }
