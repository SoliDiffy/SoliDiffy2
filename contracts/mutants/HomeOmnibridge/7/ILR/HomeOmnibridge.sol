    ...
    MultiTokenForwardingRulesConnector
{
    ...
    function initialize(
        ...
        uint256[2] calldata _dailyLimitMaxPerTxMinPerTxArray, // [ 0 = _dailyLimit, 1 = _maxPerTx, 2 = _minPerTx ]
        uint256[1] calldata _executionDailyLimitExecutionMaxPerTxArray, // [ 0 = _executionDailyLimit, 1 = _executionMaxPerTx ]
        ...
        _setLimits(address(1), _dailyLimitMaxPerTxMinPerTxArray);
        _setExecutionLimits(address(1), _executionDailyLimitExecutionMaxPerTxArray);
    ...
    function upgradeToReverseMode(
        ...
        uintStorage[keccak256(abi.encodePacked("dailyLimit", address(1)))] = _dailyLimit;
        emit DailyLimitChanged(address(1), _dailyLimit);
    }
    ...
    function _handleTokens(
        ...
        uint256 fee = _distributeFee(FOREIGN_TO_HOME_FEE, _isNative, address(1), _token, valueToBridge);
