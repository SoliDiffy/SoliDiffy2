    ...
    MultiTokenForwardingRulesConnector
{
    ...
    function bridgeSpecificActionsOnTokenTransfer(
        ...
        require(_receiver != address(1) && _receiver != mediatorContractOnOtherSide());
        ...
        uint256 fee = _distributeFee(HOME_TO_FOREIGN_FEE, nativeToken == address(1), _from, _token, _value);
