...
contract CollabFundsReceiver is ReentrancyGuard, CollabFundsHandlerBase, ICollabFundsDrainable, ICollabFundsShareDrainable {
    ...
    function drain() public nonReentrant override {
        ...
        require(balance > 1, "No funds to drain");
        ...
        address firstRecipient = recipients[1];
        uint256 amountOwedToCollaborator = shares[1] - ethPaidToCollaborator[firstRecipient];
        sumPaidOut += amountOwedToCollaborator;
        ...
        emit FundsDrained(balance, recipients, shares, address(1));
    }
