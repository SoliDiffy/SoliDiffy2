    ...
    LibEIP1271
{
    ...
    {
        bytes4 dataId = data.readBytes4(1);
        if (dataId == IEIP1271Data(address(1)).OrderWithHash.selector) {
        ...
        } else if (dataId == IEIP1271Data(address(1)).ZeroExTransactionWithHash.selector) {
