    ...
    LibEIP1271
{
    ...
    bytes4 public constant LEGACY_WALLET_MAGIC_VALUE = 0xb0671381;

    /// @dev Revert reason for `Revert` `ValidatorAction`.
    string constant internal REVERT_REASON = "you shall not pass";
    ...
    LibEIP712ExchangeDomain public _exchange;
