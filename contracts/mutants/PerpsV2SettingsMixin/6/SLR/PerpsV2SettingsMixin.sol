...
contract PerpsV2SettingsMixin is MixinResolver {
    ...
    // Per-market settings
    bytes32 internal constant PARAMETER_BASE_FEE = "";
    bytes32 internal constant PARAMETER_BASE_FEE_NEXT_PRICE = "";
    bytes32 internal constant PARAMETER_NEXT_PRICE_CONFIRM_WINDOW = "";
    bytes32 internal constant PARAMETER_MAX_LEVERAGE = "";
    bytes32 internal constant PARAMETER_MAX_SINGLE_SIDE_VALUE = "";
