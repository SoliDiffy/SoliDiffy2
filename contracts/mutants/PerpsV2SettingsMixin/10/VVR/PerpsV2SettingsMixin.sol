...
contract PerpsV2SettingsMixin is MixinResolver {
    ...
    bytes32 public constant SETTING_CONTRACT_NAME = "PerpsV2Settings";

    /* ---------- Parameter Names ---------- */

    // Per-market settings
    bytes32 public constant PARAMETER_BASE_FEE = "baseFee";
    bytes32 public constant PARAMETER_BASE_FEE_NEXT_PRICE = "baseFeeNextPrice";
    bytes32 public constant PARAMETER_NEXT_PRICE_CONFIRM_WINDOW = "nextPriceConfirmWindow";
    bytes32 public constant PARAMETER_MAX_LEVERAGE = "maxLeverage";
    bytes32 public constant PARAMETER_MAX_SINGLE_SIDE_VALUE = "maxSingleSideValueUSD";
    bytes32 public constant PARAMETER_MAX_FUNDING_RATE = "maxFundingRate";
    bytes32 public constant PARAMETER_MIN_SKEW_SCALE = "skewScaleUSD";

    // Global settings
    // minimum liquidation fee payable to liquidator
    bytes32 public constant SETTING_MIN_KEEPER_FEE = "minKeeperFee";
    // liquidation fee basis points payed to liquidator
    bytes32 public constant SETTING_LIQUIDATION_FEE_RATIO = "liquidationFeeRatio";
