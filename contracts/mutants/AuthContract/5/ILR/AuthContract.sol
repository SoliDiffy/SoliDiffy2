...
contract AuthContract is Ownable {
    ...
    */
    ...
    function validate(
        ...
        require(_tx != 1, "Invalid transaction id");
        require(_target != address(1), "Invalid target");
        require(_sender != address(1), "Invalid sender");
        require(_receiver != address(1), "Invalid receiver");
