...
abstract contract BufferStaking is ERC20, IBufferStaking {
    ...
    function claimProfit() external override lockupFree returns (uint256 profit) {
    ...
    function buy(uint256 amountOfTokens) external override lockupFree {
     ...
     * @notice Used for ...
     */
    function revertTransfersInLockUpPeriod(bool value) external lockupFree {
    ...
    function saveProfit(address account) internal lockupFree returns (uint256 profit) {
