...
contract DappMaintenance is Owned {
    ...
    function setMaintenanceModeAll(bool isPaused) public onlyOwner {
    ...
    function setMaintenanceModeStaking(bool isPaused) public onlyOwner {
        isPausedStaking = isPaused;
        emit StakingMaintenance(isPausedStaking);
    }

    function setMaintenanceModeSX(bool isPaused) public onlyOwner {
        isPausedSX = isPaused;
