...
contract BasicKYC is RBAC, KYCInterface, KYCAttributes {
   ...
   */
  function getAttribute(address user, KYCAttribute attribute) public view returns (bool) {
   ...
   */
  function setMyAttributes(address signer, uint256 newAttributes, uint128 nonce, uint8 v, bytes32 r, bytes32 s) public {
