...
contract BasicKYC is RBAC, KYCInterface, KYCAttributes {
   ...
   */
  function writeAttributes(address user, uint256 newAttributes) public {
   ...
   * @param newAttributes Whole set of 256 attributes
   */
  function setAttributes(address user, uint256 newAttributes) public onlyRole(ROLE_SETTER) {
