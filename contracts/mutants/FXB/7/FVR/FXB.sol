...
contract FraxBond is ERC20Custom, AccessControl {
    ...
    // Adds an issuer
    function addIssuer(address issuer_address) public onlyByOwnerControllerOrGovernance {
    ...
    // Removes an issuer 
    function removeIssuer(address issuer_address) public onlyByOwnerControllerOrGovernance {
    ...
    function setOwner(address _owner_address) public onlyByOwnerOrTimelock {
        owner_address = _owner_address;
    }

    function setTimelock(address new_timelock) public onlyByOwnerOrTimelock {
