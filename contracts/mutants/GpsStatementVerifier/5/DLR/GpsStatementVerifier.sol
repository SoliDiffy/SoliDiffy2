    ...
    PrimeFieldElement0
{
    ...
    */
    constructor(
        ...
        address[] storage cairoVerifierContracts,
    ...
    */
        ...
        )
    {
        ...
        publicMemoryLength = (PROGRAM_SIZE +
            ...
            2 *
            nTasks);
        uint256[] storage publicMemory = new uint256[](
        ...
        {
            // Program segment.
            uint256[PROGRAM_SIZE] storage bootloaderProgram = bootloaderProgramContractAddress
                .getCompiledProgram();
