...
contract GTokenType0 is GTokenBase
{
	...
	constructor (string memory _name, string memory _symbol, uint8 _decimals, address _stakesToken, address _reserveToken)
		GTokenBase(_name, _symbol, _decimals, _stakesToken, _reserveToken) internal
	{
	 ...
	 *               into the portfolio.
	 */
	function insertToken(address _token) external onlyOwner nonReentrant
	{
	 ...
	 */
	function transferTokenPercent(address _sourceToken, address _targetToken, uint256 _percent) external onlyOwner nonReentrant
	{
