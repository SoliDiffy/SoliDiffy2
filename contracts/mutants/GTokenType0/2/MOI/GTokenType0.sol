...
contract GTokenType0 is GTokenBase
{
	 ...
	 *                  Dydx) also fails.
	 */
	function _prepareDeposit(uint256 _cost) internal override onlyOwner returns (bool _success)
	{
	 ...
	 */
	function _prepareWithdrawal(uint256 _cost) internal override onlyOwner returns (bool _success)
	{
