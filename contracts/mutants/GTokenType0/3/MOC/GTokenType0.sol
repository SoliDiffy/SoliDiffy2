...
contract GTokenType0 is GTokenBase
{
	 ...
	 *               into the portfolio.
	 */
	function insertToken(address _token) public nonReentrant onlyOwner
	{
	 ...
	 *               the portfolio.
	 */
	function removeToken(address _token) public nonReentrant onlyOwner
	{
	 ...
	 */
	function transferTokenPercent(address _sourceToken, address _targetToken, uint256 _percent) public nonReentrant onlyOwner
	{
