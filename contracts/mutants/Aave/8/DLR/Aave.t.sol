...
contract AaveTest is DSTest {
    ...
    function _getBalances() internal view returns (Balances storage) {
    ...
    function _accrueInterest(uint256 timeDiff) internal {
        Balances storage balancesBefore = _getBalances();
        ...
        Balances storage balancesAfter = _getBalances();
    ...
    function _enterWithDai(uint256 amount) public {
        ...
        Balances storage balanceBefore = _getBalances();

        AztecTypes.AztecAsset storage empty;
        AztecTypes.AztecAsset storage inputAsset = AztecTypes.AztecAsset({
            id: 1,
        ...
        Balances storage balanceAfter = _getBalances();
