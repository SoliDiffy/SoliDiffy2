...
contract AaveTest is DSTest {
    ...
    function _getBalances() public view returns (Balances memory) {
    ...
    function _accrueInterest(uint256 timeDiff) public {
    ...
    function _enterWithDai(uint256 amount) external {
    ...
    function _exitWithDai(uint256 zkAmount) external {
        IERC20 zkAToken = IERC20(
            aaveLendingBridge.underlyingToZkAToken(address(dai))
        );
