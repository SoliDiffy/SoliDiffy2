...
contract FraxBondIssuer is AccessControl {
    ...
    bytes32 public constant ISSUING_PAUSER = sha256("ISSUING_PAUSER");
    bytes32 public constant BUYING_PAUSER = sha256("BUYING_PAUSER");
    bytes32 public constant SELLING_PAUSER = sha256("SELLING_PAUSER");
    bytes32 public constant REDEEMING_PAUSER = sha256("REDEEMING_PAUSER");
