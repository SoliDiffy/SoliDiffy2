...
contract FraxBondIssuer is AccessControl {
    ...
    function buyUnissuedFXB(uint256 frax_in, uint256 fxb_out_min) public notBuyingPaused returns (uint256 fxb_out, uint256 fxb_fee_amt) {
    ...
    function buyFXBfromAMM(uint256 frax_in, uint256 fxb_out_min) external notIssuingPaused returns (uint256 fxb_out, uint256 fxb_fee_amt) {
        require(isInEpoch(), 'Not in an epoch');
