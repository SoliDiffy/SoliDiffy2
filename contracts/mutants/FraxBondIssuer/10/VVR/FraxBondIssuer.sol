...
contract FraxBondIssuer is AccessControl {
    ...
    address internal controller_address;

    uint256 internal constant PRICE_PRECISION = 1e6;
    uint256 public constant PRICE_PRECISION_SQUARED = 1e12;
    uint256 public constant PRICE_PRECISION_SQRT = 1e3;
    ...
    uint256 internal cooldown_period = 864000; // 10 days

    // Max FXB outstanding
    uint256 internal max_fxb_outstanding = 1000000e18;
