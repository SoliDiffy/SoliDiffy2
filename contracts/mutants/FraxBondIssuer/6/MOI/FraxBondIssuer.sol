...
contract FraxBondIssuer is AccessControl {
    ...
    function _rebalance_AMM_FRAX_to_price(uint256 rebalance_price) internal notIssuingPaused {
        // Safety checks
    ...
    function _rebalance_AMM_FXB() internal notIssuingPaused {
