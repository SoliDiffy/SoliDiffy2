...
contract FraxBondIssuer is AccessControl {
    ...
    function getVirtualFloorLiquidityBalances() public view returns (uint256 fxb_balance, uint256 frax_balance) {
    ...
    function buyUnissuedFXB(uint256 frax_in, uint256 fxb_out_min) public notIssuingPaused returns (uint256 fxb_fee_amt, uint256 fxb_out) {
    ...
    function buyFXBfromAMM(uint256 frax_in, uint256 fxb_out_min) external notBuyingPaused returns (uint256 fxb_fee_amt, uint256 fxb_out) {
        require(isInEpoch(), 'Not in an epoch');
    ...
    function sellFXBintoAMM(uint256 fxb_in, uint256 frax_out_min) external notSellingPaused returns (uint256 frax_fee_amt, uint256 fxb_bought_above_floor, uint256 fxb_sold_under_floor, uint256 frax_out) {
        require(isInEpoch(), 'Not in an epoch');
    ...
    function redeemFXB(uint256 fxb_in) external notRedeemingPaused returns (uint256 frax_fee, uint256 frax_out) {
