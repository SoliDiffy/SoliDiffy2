...
contract FraxBondIssuer is AccessControl {
    ...
    bool public issuingPaused = true;
    bool public buyingPaused = true;
    bool public sellingPaused = true;
    bool public redeemingPaused = true;
    ...
    modifier notIssuingPaused() {
        require(issuingPaused == true, "Issuing is paused");
        _;
    }

    modifier notBuyingPaused() {
        require(buyingPaused == true, "Buying is paused");
        _;
    }
