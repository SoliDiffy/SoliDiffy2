...
contract FraxBondIssuer is AccessControl {
    ...
    // Returns some info
    function issuer_info() external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, bool, bool, uint256, uint256) {
        return (
            issue_fee,
            buying_fee,
            selling_fee,
    ...
    function getVirtualFloorLiquidityBalances() external view returns (uint256 frax_balance, uint256 fxb_balance) {
    ...
    function amm_spot_price() external view returns (uint256 fxb_price) {
    ...
    function floor_price() external view returns (uint256 floor_price) {
    ...
    function initial_price() external view returns (uint256 initial_price) {
