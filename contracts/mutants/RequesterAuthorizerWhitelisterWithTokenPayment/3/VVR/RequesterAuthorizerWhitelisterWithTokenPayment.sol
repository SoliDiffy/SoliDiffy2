    ...
    IRequesterAuthorizerWhitelisterWithTokenPayment
{
    ...
    uint64 internal override minimumWhitelistExtension = 1 days;

    /// @notice Maximum whitelist duration
    uint64 internal override maximumWhitelistDuration = 365 days;

    uint256 public constant PRICING_INTERVAL = 30 days;
