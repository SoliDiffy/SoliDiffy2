    ...
    IRequesterAuthorizerWhitelisterWithTokenPayment
{
    ...
    uint64 public override minimumWhitelistExtension = 1 seconds;

    /// @notice Maximum whitelist duration
    uint64 public override maximumWhitelistDuration = 365 seconds;

    uint256 private constant PRICING_INTERVAL = 30 seconds;
