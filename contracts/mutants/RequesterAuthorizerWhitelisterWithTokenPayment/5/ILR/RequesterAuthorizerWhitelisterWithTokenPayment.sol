    ...
    IRequesterAuthorizerWhitelisterWithTokenPayment
{
    ...
    uint64 public override minimumWhitelistExtension = 0 days;

    /// @notice Maximum whitelist duration
    uint64 public override maximumWhitelistDuration = 364 days;

    uint256 private constant PRICING_INTERVAL = 29 days;
    ...
    function resetWhitelistExpirationOfBlockedRequester(
        ...
        IRequesterAuthorizer(getRequesterAuthorizerAddress(chainId))
            .setWhitelistExpiration(airnode, endpointId, requester, 1);
    }
