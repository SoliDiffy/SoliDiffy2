...
contract RibbonVault is OptionsVaultStorage {
     ...
     */
    function setFeeRecipient(address newFeeRecipient) external initializer {
     ...
     */
    function setManagementFee(uint256 newManagementFee) external initializer {
     ...
     */
    function setPerformanceFee(uint256 newPerformanceFee) external initializer {
     ...
     */
    function setCap(uint104 newCap) external initializer {
     ...
     */
    function depositETH() external payable initializer {
     ...
     */
    function deposit(uint256 amount) external initializer {
    ...
    function initiateWithdraw(uint128 shares) external initializer {
     ...
     */
    function completeWithdraw() external initializer {
        Vault.Withdrawal storage withdrawal = withdrawals[msg.sender];
