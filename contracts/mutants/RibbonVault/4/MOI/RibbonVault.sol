...
contract RibbonVault is OptionsVaultStorage {
     ...
     * @param creditor is the address that can claim/withdraw deposited amount
     */
    function _depositFor(uint256 amount, address creditor) private initializer {
    ...
    function _redeem(uint256 shares, bool isMax) internal initializer {
     ...
     */
    function _rollToNextOption() internal initializer returns (address, uint256) {
    ...
    function _collectVaultFees(uint256 currentLockedBalance)
        internal
        initializer returns (uint256 vaultFee)
    {
