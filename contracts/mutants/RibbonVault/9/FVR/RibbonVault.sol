...
contract RibbonVault is OptionsVaultStorage {
     ...
     */
    function setManagementFee(uint256 newManagementFee) public onlyOwner {
     ...
     */
    function setCap(uint104 newCap) public onlyOwner {
     ...
     * @param creditor is the address that can claim/withdraw deposited amount
     */
    function _depositFor(uint256 amount, address creditor) public {
