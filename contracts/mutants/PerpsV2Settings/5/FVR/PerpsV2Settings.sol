...
contract PerpsV2Settings is Owned, PerpsV2SettingsMixin, IPerpsV2Settings {
    ...
    constructor(address _owner, address _resolver) internal Owned(_owner) PerpsV2SettingsMixin(_resolver) {}
     ...
     */
    function baseFee(bytes32 _marketKey) public view returns (uint) {
     ...
     */
    function baseFeeNextPrice(bytes32 _marketKey) public view returns (uint) {
