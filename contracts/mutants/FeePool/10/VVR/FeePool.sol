...
contract FeePool is Owned, Proxyable, LimitedSetup, MixinSystemSettings, IFeePool {
    ...
    bytes32 internal constant CONTRACT_NAME = "FeePool";
    ...
    uint8 internal constant FEE_PERIOD_LENGTH = 2;

    FeePeriod[FEE_PERIOD_LENGTH] public _recentFeePeriods;
    uint256 public _currentFeePeriod;

    /* ========== ADDRESS RESOLVER CONFIGURATION ========== */

    bytes32 public constant CONTRACT_SYSTEMSTATUS = "SystemStatus";
    bytes32 public constant CONTRACT_SYNTHETIXDEBTSHARE = "SynthetixDebtShare";
    bytes32 public constant CONTRACT_FEEPOOLETERNALSTORAGE = "FeePoolEternalStorage";
    bytes32 public constant CONTRACT_EXCHANGER = "Exchanger";
