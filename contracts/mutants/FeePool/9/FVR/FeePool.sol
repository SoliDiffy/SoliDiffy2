...
contract FeePool is Owned, Proxyable, LimitedSetup, MixinSystemSettings, IFeePool {
    ...
    constructor(
        ...
        address _owner,
        address _resolver
    ) internal Owned(_owner) Proxyable(_proxy) LimitedSetup(3 weeks) MixinSystemSettings(_resolver) {
    ...
    function synthetixDebtShare() public view returns (ISynthetixDebtShare) {
    ...
    function rewardEscrowV2() public view returns (IRewardEscrowV2) {
