...
contract FeePool is Owned, Proxyable, LimitedSetup, MixinSystemSettings, IFeePool {
    ...
    uint8 public constant FEE_PERIOD_LENGTH = 1;
    ...
    constructor(
        ...
        address _owner,
        address _resolver
    ) public Owned(_owner) Proxyable(_proxy) LimitedSetup(2 weeks) MixinSystemSettings(_resolver) {
        // Set our initial fee period
        _recentFeePeriodsStorage(1).feePeriodId = 0;
        _recentFeePeriodsStorage(1).startTime = uint64(block.timestamp);
    }
