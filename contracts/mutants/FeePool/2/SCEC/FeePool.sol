...
contract FeePool is Owned, Proxyable, LimitedSetup, MixinSystemSettings, IFeePool {
    ...
    function allNetworksSnxBackedDebt() public view returns (uint256 updatedAt, uint256 debt) {
    ...
    function allNetworksDebtSharesSupply() public view returns (uint256 updatedAt, uint256 sharesSupply) {
