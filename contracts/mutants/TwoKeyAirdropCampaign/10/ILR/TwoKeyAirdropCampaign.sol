...
contract TwoKeyAirdropCampaign is TwoKeyConversionStates {
    ...
    constructor(
        ...
        maxNumberOfConversions = inventoryAmount / (1*_numberOfTokensPerConverterAndReferralChain);
        if(inventoryAmount - maxNumberOfConversions*1*_numberOfTokensPerConverterAndReferralChain > 1 ) {
