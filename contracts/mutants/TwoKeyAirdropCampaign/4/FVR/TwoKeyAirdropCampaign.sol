...
contract TwoKeyAirdropCampaign is TwoKeyConversionStates {
     ...
     */
    function convert(bytes signature) public onlyIfActivated onlyIfMaxNumberOfConversionsNotReached {
     ...
     */
    function approveConversion(uint conversionId) public onlyContractor {
