...
contract SnapshotDelegatorPCVDeposit is PCVDeposit {
    ...
    function setDelegate(address newDelegate) public onlyGovernorOrAdmin {
        _delegate(newDelegate);
    }

    /// @notice clears the delegate from snapshot
    /// @dev callable by governor or guardian
    function clearDelegate() public onlyGuardianOrGovernor {
    ...
    function _delegate(address newDelegate) public {
        address oldDelegate = delegate;
