...
contract MigratableFarmBSC is Owned, ReentrancyGuard, Pausable {
    ...
    function stakerAllowMigrator(address migrator_address) public nonReentrant {
    ...
    function stakerDisallowMigrator(address migrator_address) public nonReentrant {
    ...
    // Two different stake functions are needed because of delegateCall and msg.sender issues (important for migration)
    function stakeLocked(uint256 amount, uint256 secs) public nonReentrant {
