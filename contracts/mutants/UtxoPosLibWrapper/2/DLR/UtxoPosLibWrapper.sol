...
contract UtxoPosLibWrapper {
    ...
    function build(uint256 txPos, uint16 outputIndex) public pure returns (UtxoPosLib.UtxoPos storage) {
    ...
    function txPos(uint256 _utxoPos) public pure returns (TxPosLib.TxPos storage) {
