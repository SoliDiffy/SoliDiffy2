...
contract DescendingPriceAuction is AuctionBase, FeeCollector {
   ...
   */
  function bid(uint256 auctionId) onlySeller(auctionId) onlyAcceptingBids(auctionId) whenNotPaused external payable {
    // Bidder must exist
...
//SWC-135-Code With No Effects:L344
  ...
  function cancel(uint256 auctionId) onlyAcceptingBids(auctionId) public onlySeller(auctionId) {
