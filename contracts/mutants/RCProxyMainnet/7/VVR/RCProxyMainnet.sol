...
contract RCProxyMainnet is Ownable
{
    ...
    IRealitio internal realitio;
    IBridge internal bridge;
    IAlternateReceiverBridge internal alternateReceiverBridge;
    IERC20Dai internal dai;
    IERC721 internal nfthub;

    /// @dev governance variables
    address internal proxyXdaiAddress;
    address internal nftHubAddress;
