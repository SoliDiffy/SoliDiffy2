...
contract RootBridge is BaseBridge {
    ...
    // PUBLIC
    //
    function initialize(IAMB _ambBridge, IMultiTokenMediator _multiTokenMediator) public onlyOwner {
    ...
    function setPriceFeed(address _priceFeed) external initializer {
