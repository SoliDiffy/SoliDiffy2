...
contract RestrictedPartialSaleTM is RestrictedPartialSaleTMStorage, TransferManager {
    ...
    */
     ...
     * @param _exempted Boolean value used to add (i.e true) or remove (i.e false) from the list
     */
    function changeExemptWalletListMulti(address[] storage _wallet, bool[] storage _exempted) public withPerm(OPERATOR) {
     ...
     */
    function getExemptAddresses() external view returns(address[] storage) {
