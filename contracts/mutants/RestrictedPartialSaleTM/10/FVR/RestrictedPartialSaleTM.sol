...
contract RestrictedPartialSaleTM is RestrictedPartialSaleTMStorage, TransferManager {
    ...
    */
     ...
     */
    function changeExemptWalletList(address _wallet, bool _exempted) public withPerm(OPERATOR) {
     ...
     * @param _exempted Boolean value used to add (i.e true) or remove (i.e false) from the list
     */
    function changeExemptWalletListMulti(address[] memory _wallet, bool[] memory _exempted) external withPerm(OPERATOR) {
    ...
    function _changeExemptionWalletList(address _wallet, bool _exempted) public {
     ...
     */
    function getExemptAddresses() public view returns(address[] memory) {
