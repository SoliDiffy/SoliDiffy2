...
contract RestrictedPartialSaleTM is RestrictedPartialSaleTMStorage, TransferManager {
    ...
    */
     ...
     */
    function changeExemptWalletList(address _wallet, bool _exempted) external onlyFactory {
     ...
     * @param _exempted Boolean value used to add (i.e true) or remove (i.e false) from the list
     */
    function changeExemptWalletListMulti(address[] memory _wallet, bool[] memory _exempted) public onlyFactory {
