...
contract TestEarningsPool {
    ...
    function test_feePoolShare_noClaimableStake() public {
        fixture.init(0, 0, 0);
        Assert.equal(fixture.feePoolShare(500, true), 0, "should return 0 if no claimble stake");
    }

    function test_feePoolShare_notTranscoder() public {
        fixture.setFeePool(1000);
        Assert.equal(fixture.feePoolShare(500, true), 250, "should return delegator's share of fee pool");
    }

    function test_feePoolShare_isTranscoder() public {
        fixture.setFeePool(1000);
        Assert.equal(fixture.feePoolShare(500, false), 750, "should return transcoder's share of fee pool which includes its share as a delegator");
    }
