...
contract TestEarningsPool {
    ...
    function test_init() public {
        ...
        Assert.equal(rewardPool, 0, "");
        Assert.equal(feePool, 0, "");
        Assert.equal(totalStake, 1000, "");
        Assert.equal(claimableStake, 1000, "");
        Assert.equal(rewardCut, 500000, "");
        Assert.equal(feeShare, 500000, "");
    }
    ...
    function test_claimShare_notTranscoder() public {
        ...
        Assert.equal(fees, 250, "");
        Assert.equal(rewards, 250, "");
        Assert.equal(fixture.getFeePool(), 750, "");
        Assert.equal(fixture.getRewardPool(), 750, "");
