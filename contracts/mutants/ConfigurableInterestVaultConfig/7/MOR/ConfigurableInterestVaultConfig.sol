...
contract ConfigurableInterestVaultConfig is IVaultConfig, OwnableUpgradeSafe {
  ...
  function setWorkers(address[] calldata addrs, IWorkerConfig[] calldata configs) external initializer {
  ...
  function setMaxKillBps(uint256 _maxKillBps) external initializer {
