...
contract ConfigurableInterestVaultConfig is IVaultConfig, OwnableUpgradeSafe {
  ...
  /// Interest rate model
  InterestModel internal interestModel;
  ...
  address internal override getFairLaunchAddr;
  /// maximum killBps
  uint256 internal maxKillBps;
  ...
  uint256 internal override getKillTreasuryBps;
