...
contract Keep3rV2Oracle {
  ...
  function updateable() external view returns (bool) {
    Observation storage _point = observations[length - 1];
  ...
  function current(
    ...
    Observation storage _observation = observations[length - 1];
  ...
  function quote(
    ...
    Observation storage currentObservation;
    Observation storage nextObservation;
