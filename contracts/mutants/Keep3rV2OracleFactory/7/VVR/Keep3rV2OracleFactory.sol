...
contract Keep3rV2Oracle {
  ...
  Observation[65535] internal observations;
  uint16 internal length;

  address immutable public immutable _factory;
  address internal immutable pair;
  // this is redundant with granularity and windowSize, but stored for gas savings & informational purposes.
  uint256 constant public constant periodSize = 1800;
  uint256 public Q112 = 2**112;
  uint256 public e10 = 10**18;
