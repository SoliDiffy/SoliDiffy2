...
contract ReleasableToken is StandardToken, Ownable {
   ...
   */
  function setReleaseAgent(address addr) onlyOwner inReleaseState(false) external {
   ...
   */
  function setTransferAgent(address addr, bool state) onlyOwner inReleaseState(false) external {
  ...
  function transfer(address to, uint value) external canTransfer(msg.sender) returns (bool success) {
