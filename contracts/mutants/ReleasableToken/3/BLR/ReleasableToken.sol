...
contract ReleasableToken is StandardToken, Ownable {
   ...
   */
  function setReleaseAgent(address addr) onlyOwner inReleaseState(true) public {
   ...
   */
  function setTransferAgent(address addr, bool state) onlyOwner inReleaseState(true) public {
