...
library VolumeDripManager {
  ...
  function getActiveVolumeDrips(State storage self, address measure) public view returns (address[] memory) {
  ...
  function set(State storage self, address measure, address dripToken, uint32 periodSeconds, uint112 dripAmount) public {
  ...
  /// @param measure The measure token
  /// @param dripToken The drip token
  function isActive(State storage self, address measure, address dripToken) public view returns (bool) {
  ...
  /// @param measure The measure token
  /// @param dripToken The drip token
  function getDrip(State storage self, address measure, address dripToken) public view returns (VolumeDrip.State storage) {
