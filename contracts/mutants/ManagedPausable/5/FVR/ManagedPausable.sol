...
abstract contract ManagedPausable {
    ...
    function _initializeManagedPausable(address pauser_) public {
    ...
    function renouncePauserRole() public onlyPauser {
        emit PauserRoleTransferred(_pauser, address(0));
        _pauser = address(0);
    }

    function transferPauserRole(address newPauser) public onlyPauser {
