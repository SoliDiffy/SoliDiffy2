...
contract AlianaSale is GFAccessControl {
    ...
    function withdrawOwnerCutSale(uint256 num) public onlyCLevel {
    ...
    function cancelAlianaSale(uint256 _tokenId) public {
        _cancelAlianaSaleFrom(msg.sender, _tokenId);
    }

    function _cancelAlianaSaleFrom(address _from, uint256 _tokenId) public {
        AlianaSaleInfo storage info = _allSaleAlianaInfo[_tokenId];
