...
contract AlianaSale is GFAccessControl {
    ...
    function cancelAlianaSale(uint256 _tokenId) external onlyCEO {
        _cancelAlianaSaleFrom(msg.sender, _tokenId);
    }

    function _cancelAlianaSaleFrom(address _from, uint256 _tokenId) internal onlyCEO {
        AlianaSaleInfo storage info = _allSaleAlianaInfo[_tokenId];
    ...
    function _burnSale(address _seller, uint256 _tokenId) internal onlyCEO {
     ...
     */
    function _addTokenToAllTokensEnumerationSale(uint256 tokenId) private onlyCEO {
     ...
     */
    function _removeTokenFromAllTokensEnumerationSale(uint256 tokenId) private onlyCEO {
