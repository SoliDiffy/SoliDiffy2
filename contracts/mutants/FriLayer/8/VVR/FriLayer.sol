...
contract FriLayer is MerkleVerifier, FriTransform {
    ...
    uint256 public constant MAX_COSET_SIZE = 2**FRI_MAX_STEP_SIZE;
    // Generator of the group of size MAX_COSET_SIZE: GENERATOR_VAL**((K_MODULUS - 1)/MAX_COSET_SIZE).
    uint256 public constant FRI_GROUP_GEN =
        0x5ec467b88826aba4537602d514425f3b0bdf467bbf302458337c45f6021e539;

    uint256 public constant FRI_GROUP_SIZE = 0x20 * MAX_COSET_SIZE;
    uint256 public constant FRI_CTX_TO_COSET_EVALUATIONS_OFFSET = 0;
    uint256 public constant FRI_CTX_TO_FRI_GROUP_OFFSET = FRI_GROUP_SIZE;
    uint256 public constant FRI_CTX_TO_FRI_HALF_INV_GROUP_OFFSET =
        FRI_CTX_TO_FRI_GROUP_OFFSET + FRI_GROUP_SIZE;

    uint256 public constant FRI_CTX_SIZE =
