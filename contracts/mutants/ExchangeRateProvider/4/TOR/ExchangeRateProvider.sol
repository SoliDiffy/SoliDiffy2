...
contract ExchangeRateProvider is usingOraclize {
  ...
  {
    require(
      tx.origin == registry.getContractAddress("ExchangeRates") ||
      tx.origin == oraclize_cbAddress()
    );
    _;
  }
  ...
  {
    require(tx.origin == registry.getContractAddress("ExchangeRates"));
    _;
  }
    ...
    public
  {
    ...
    require(tx.origin == oraclize_cbAddress());
