...
library StandardStartRebalanceLibrary {
        ...
        returns (BiddingParameters)
    {
        ...
        BiddingParameters storage biddingParameters = setUpBiddingParameters(
            _currentSet,
            _nextSet,
            _auctionLibrary
        );
        ...
        returns (BiddingParameters)
    {
        ...
        SetsDetails storage setsDetails = getUnderlyingSetsDetails(
            _currentSet,
            _nextSet
        );

        // Create combinedTokenArray
        address[] storage combinedTokenArray = setsDetails.currentSetComponents.union(
