...
library CumulativeNormalDistribution {
    ...
    function getCDF(int128 x) public pure returns (int128) {
        int128 z = x.div(CDF3);
    ...
    function getErrorFunction(int128 z, int128 t) public pure returns (int128) {
    ...
    function getInverseCDF(int128 p) public pure returns (int128) {
    ...
    function central(int128 p) public pure returns (int128) {
