...
interface RocketDAONodeTrustedProposalsInterface {
    ...
    function proposalSettingBool(string storage _settingContractName, string storage _settingPath, bool _value) external;
    function proposalUpgrade(string storage _type, string storage _name, string memory _contractAbi, address _contractAddress) external;
}
