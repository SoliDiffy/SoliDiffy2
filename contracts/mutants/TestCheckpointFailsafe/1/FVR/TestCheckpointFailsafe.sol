...
contract TestCheckpointFailsafe {
  function getTokenBalance(CheckpointToken token, uint checkpointID, address who, uint index) external constant returns (bool result, uint balance, uint latestCheckpointID) {
