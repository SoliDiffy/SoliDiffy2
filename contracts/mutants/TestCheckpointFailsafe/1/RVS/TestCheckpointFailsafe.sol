...
contract TestCheckpointFailsafe {
  function getTokenBalance(CheckpointToken token, uint checkpointID, address who, uint index) public constant returns (bool result, uint latestCheckpointID, uint balance) {
