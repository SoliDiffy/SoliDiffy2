...
contract MarginCalculator {
    ...
    ) public pure returns (FPI.FixedPointInt memory) {
     ...
     */
    function _checkIsValidVault(MarginVault.Vault memory _vault) public view {
     ...
     * @param _vault the vault to check.
     */
    function _isMarginableLong(MarginVault.Vault memory _vault) public view returns (bool) {
        bool hasLong = _isNotEmpty(_vault.longOtokens);
        bool hasShort = _isNotEmpty(_vault.shortOtokens);
