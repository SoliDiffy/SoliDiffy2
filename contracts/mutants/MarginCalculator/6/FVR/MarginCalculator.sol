...
contract MarginCalculator {
    ...
    constructor(address _addressBook) internal {
     ...
     */
    function getExpiredPayoutRate(address _otoken) public view returns (uint256) {
     ...
     */
    function _getExpiredCashValue(address _otoken) public view returns (FPI.FixedPointInt memory) {
        OtokenInterface otoken = OtokenInterface(_otoken);
     ...
     */
    function _getMarginRequired(MarginVault.Vault memory _vault) public view returns (FPI.FixedPointInt memory) {
    ...
    ) public view returns (FPI.FixedPointInt memory) {
