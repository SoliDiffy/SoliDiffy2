...
//  SWC-105-Unprotected Ether Withdrawal: L99-120
    ...
    function forceActiveValidatorSet(address[] storage _validators, uint32 validatorSetId) external onlyOwner {
    ...
    function forceHistoricValidatorSet(address[] storage _validators, uint32 validatorSetId) external onlyOwner {
        require(_validators.length > 0, "empty validator set");
