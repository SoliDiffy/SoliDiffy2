...
contract LiquidationHelper  {
    ...
    uint32 internal constant TWAP_PERIOD = 5 minutes;

    address immutable internal controller;
    address immutable internal oracle;
    address immutable internal wPowerPerp;
    address immutable internal weth;
    address immutable internal quoteCurrency;
    address immutable internal ethQuoteCurrencyPool;
    address immutable internal wPowerPerpPool;
    address immutable internal uniswapPositionManager;
