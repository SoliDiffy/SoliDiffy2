...
contract LiquidationHelper  {
        ...
        )
    {
        ...
        return (true, true, collateralToPay, wMaxAmountToLiquidate);
    }
        ...
        )
    {
        ...
        return (bounty, burnAmount, wPowerPerpExcess);
    }
    ...
    function _getLiquidationResult(
        ...
        return (collateralToPay, finalLiquidateAmount);
    }
    ...
    function _getSingleLiquidationAmount(
        ...
        return (collateralToPay, finalWAmountToLiquidate);
    }
}
