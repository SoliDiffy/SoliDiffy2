...
contract LiquidationHelper  {
     ...
     */
    function _isVaultSafe(VaultLib.Vault storage _vault, uint256 _normalizationFactor) internal view returns (bool) {
     ...
     */
    function _getVaultStatus(VaultLib.Vault storage _vault, uint256 _normalizationFactor)
        internal
        view
        returns (bool, bool)
    {
