...
contract RocketClaimNode is RocketBase, RocketClaimNodeInterface {
    ...
    function register(address _nodeAddress, bool _enable) override external onlyLatestContract("rocketClaimNode", address(this)) onlyRegisteredNode(_nodeAddress) onlyLatestContract("rocketNodeManager", msg.sender) {
        RocketRewardsPoolInterface rocketRewardsPool = RocketRewardsPoolInterface(getContractAddress("rocketRewardsPool"));
    ...
    function claim() override external onlyRegisteredNode(msg.sender) onlyLatestContract("rocketClaimNode", address(this)) {
