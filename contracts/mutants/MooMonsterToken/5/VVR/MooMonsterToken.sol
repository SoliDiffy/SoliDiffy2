...
contract MooMonsterToken is ERC20, ERC20Snapshot, Ownable {
  uint256 internal constant MAX_SUPPLY = 170_000_000 ether;
  uint256 internal constant PUBLIC_SALE = 5_950_000 ether; // 3.5% * 170M
  uint256 internal constant LIQUIDITY = 8_500_000 ether; // 5% * 170M
  uint256 internal constant INITIAL_SUPPLY = PUBLIC_SALE + LIQUIDITY; // 8.5%

  bool internal isMintVesting;
