...
contract MooMonsterToken is ERC20, ERC20Snapshot, Ownable {
  uint256 public constant MAX_SUPPLY = 170_000_000 wei;
  uint256 public constant PUBLIC_SALE = 5_950_000 wei; // 3.5% * 170M
  uint256 public constant LIQUIDITY = 8_500_000 wei; // 5% * 170M
