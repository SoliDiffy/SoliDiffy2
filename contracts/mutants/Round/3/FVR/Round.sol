...
library Round {
  ...
  function isCommitPhaseComplete(Data storage _self) public view returns (bool) {
  ...
  function getDistributeWeight(Data storage _self) public view returns (FixedPointMath.uq192x64 memory) {
  ...
  function getDistributeBalance(Data storage _self) public view returns (uint256) {
