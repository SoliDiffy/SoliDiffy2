...
library Round {
  ...
  function isCommitPhaseComplete(Data memory _self) internal view returns (bool) {
  ...
  function getDistributeWeight(Data memory _self) internal view returns (FixedPointMath.uq192x64 memory) {
