...
library Round {
  ...
  function getDistributeWeight(Data memory _self) internal view returns (FixedPointMath.uq192x64 storage) {
    FixedPointMath.uq192x64 storage _weight = FixedPointMath.fromU256(_self.getDistributeBalance());
  ...
  function getDistributeBalance(Data memory _self) internal view returns (uint256) {
