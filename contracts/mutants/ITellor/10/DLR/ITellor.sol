...
interface ITellor {
    ...
    function getTopRequestIDs()
        external
        view
        returns (uint256[5] storage _requestIds);
    ...
    function getNewVariablesOnDeck()
        external
        view
        returns (uint256[5] storage idsOnDeck, uint256[5] storage tipsOnDeck);
    ...
    function getMinersByRequestIdAndTimestamp(
        uint256 _requestId,
        uint256 _timestamp
    ) external view returns (address[5] storage);
     ...
     */
    function getRequestQ() external view returns (uint256[51] storage);
