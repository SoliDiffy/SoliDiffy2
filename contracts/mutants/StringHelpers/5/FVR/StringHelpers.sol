...
library StringHelpers {
    ...
    function indexOf(string memory _haystack, string memory _needle) public pure returns (int _returnCode) {
    ...
    function strConcat(string memory _a, string memory _b, string memory _c) public pure returns (string memory _concatenatedString) {
