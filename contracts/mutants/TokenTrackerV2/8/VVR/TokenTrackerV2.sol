...
contract TokenTrackerV2 is Owned {
    ...
    IFrax internal IFRAX = IFrax(0x853d955aCEf822Db058eb8505911ED77F175b99e);
    IFraxAMOMinter internal amo_minter;
    ComboOracle internal ethUSDOracle;

    // Tracked addresses
    address[] internal tracked_addresses;
    ...
    uint256 internal chainlink_eth_usd_decimals;
