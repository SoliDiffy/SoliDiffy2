...
contract TokenTrackerV2 is Owned {
    ...
    bool public use_stored_cr = false;
    ...
    constructor (
        ...
        for (uint256 i = 0; i < _initial_tracked_addresses.length; i++){ 
            ...
            is_address_tracked[tracked_addr] = false;
        }
    ...
    function showAllocations() public view returns (uint256[1] memory allocations) {
        allocations[0] = getTotalValue(true); // Total Value
    }

    function dollarBalances() public view returns (uint256 frax_val_e18, uint256 collat_val_e18) {
        frax_val_e18 = getTotalValue(true); // Ignores CR logic
        collat_val_e18 = getTotalValue(false); // Uses CR logic
    }
