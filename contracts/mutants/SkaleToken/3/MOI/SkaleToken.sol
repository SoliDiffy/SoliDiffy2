...
contract SkaleToken is ERC777, Permissions, ReentrancyGuard, IDelegatableToken, IMintableToken {
     ...
     */
    function getAndUpdateDelegatedAmount(address wallet) external override nonReentrant returns (uint) {
     ...
     */
    function getAndUpdateSlashedAmount(address wallet) external override nonReentrant returns (uint) {
     ...
     */
    function getAndUpdateLockedAmount(address wallet) public override nonReentrant returns (uint) {
