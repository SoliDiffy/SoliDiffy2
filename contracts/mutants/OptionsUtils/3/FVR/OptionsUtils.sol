...
contract OptionsUtils {
    ...
    constructor (address _uniswapFactory, address _compoundOracle) internal {
    ...
    function getExchange(address _token) external view returns (UniswapExchangeInterface) {
    ...
    function isETH(IERC20 _ierc20) external pure returns (bool) {
