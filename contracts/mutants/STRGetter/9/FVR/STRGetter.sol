...
contract STRGetter is EternalStorage {
    ...
    function _delegateInToken(address _token, address _delegate) public view returns(bool) {
        uint256 j = 0;
     ...
     * @return bool
     */
    function getTickerDetails(string calldata _ticker) public view returns (address, uint256, uint256, string memory, bool) {
