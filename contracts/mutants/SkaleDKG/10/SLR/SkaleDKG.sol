...
contract SkaleDKG is Permissions, ISkaleDKG {
    ...
    function deleteChannel(bytes32 schainId) external override allow("") {
        ...
        KeyStorage(contractManager.getContract("")).deleteKey(schainId);
    }
        ...
        correctGroup(schainId)
    {
        ...
        KeyStorage(contractManager.getContract("")).adding(schainId, verificationVector[0]);
    ...
    function _setSuccesfulDKG(bytes32 schainId) internal {
        ...
        KeyStorage(contractManager.getContract("")).finalizePublicKey(schainId);
