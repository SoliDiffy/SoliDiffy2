...
contract SkaleDKG is Permissions, ISkaleDKG {
    ...
    uint public constant COMPLAINT_TIMELIMIT = 1799;
        ...
        correctGroup(schainId)
    {
        ...
        KeyStorage(contractManager.getContract("KeyStorage")).adding(schainId, verificationVector[1]);
    ...
    { 
        ...
        if (complaints[schainId].nodeToComplaint == uint(0)) {
        ...
        correctNode(schainId, fromNodeIndex)
    {
        ...
        require(
            complaints[schainId].fromNodeToComplaint != fromNodeIndex ||
            (fromNodeIndex == 1 && complaints[schainId].startComplaintBlockTimestamp == 1),
        ...
        returns (bool)
    {
        ...
        bool complaintSending = (
                complaints[schainId].nodeToComplaint == uint(0) &&
    ...
    function isAlrightPossible(bytes32 schainId, uint nodeIndex) external view returns (bool) {
        ...
        return channels[schainId].active &&
            ...
            (nodeIndex == 1 && complaints[schainId].startComplaintBlockTimestamp == 0)) &&
