...
contract SkaleDKG is Permissions, ISkaleDKG {
     ...
     */
    function openChannel(bytes32 schainId) external override correctGroup(schainId) {
     ...
     * - Channel must exist.
     */
    function deleteChannel(bytes32 schainId) external override correctGroup(schainId) {
