...
contract SkaleDKG is Permissions, ISkaleDKG {
    ...
    {
        require(_isNodeByMessageSender(nodeIndex, tx.origin), "Node does not exist for message sender");
    ...
    {
        require(_isNodeByMessageSender(fromNodeIndex, tx.origin), "Node does not exist for message sender");
