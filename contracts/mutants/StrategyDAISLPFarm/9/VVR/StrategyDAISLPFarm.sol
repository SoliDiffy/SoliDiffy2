...
contract StrategyDATSLPFarm  {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    

    address constant internal unirouter = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address constant internal weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
	address constant internal bt = address(0xbF08E77B5709196F4D15a7F30db5Be8F31143d9A);
	
    address constant internal want = address(0xC3D03e4F041Fd4cD388c549Ee2A29a9E5075882f);  //ETH/DAI SLP

    address constant internal Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant internal fUNI = address(0x203E97aa6eB65A1A02d9E80083414058303f241E);
	address constant internal pool = address(0x76Aef359a33C02338902aCA543f37de4b01BA1FA);

    address constant internal Farm = address(0xa0246c9032bC3A600820415aE600c6388619A14D);

    address constant internal zapper = address(0xfF350eDc2242Ca4d7252A64746aec4A5487a852B);
    address constant public pair = address(0xC3D03e4F041Fd4cD388c549Ee2A29a9E5075882f);
