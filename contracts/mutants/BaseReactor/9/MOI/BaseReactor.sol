...
abstract contract BaseReactor is BaseReactorStorage, ERC20Upgradeable, IERC721ReceiverUpgradeable, IERC4626 {
    ...
    function _handleCurrentDebt(uint256 currentDebt) internal initializer {
    ...
    function _handleGain(uint256 gain) internal initializer {
    ...
    function _handleLoss(uint256 loss) internal initializer {
    ...
    /// on a threshold
    function _push(uint256 amount) internal virtual initializer returns (uint256 amountInvested) {}
    ...
    function _pull(uint256 amount) internal virtual initializer returns (uint256 amountAvailable) {}
    ...
    function _claim(address from) internal initializer returns (uint256 amount) {
    ...
    function _updateAccumulator(address from) internal initializer {
