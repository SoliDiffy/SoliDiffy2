...
abstract contract BaseReactor is BaseReactorStorage, ERC20Upgradeable, IERC721ReceiverUpgradeable, IERC4626 {
    ...
    function _getAssets() internal view returns (uint256 looseAssets, uint256 usedAssets) {
    ...
    function _getFutureDebtAndCF(
        ...
        uint256 debt,
        uint256 oracleRate
    ) internal view returns (uint256 collateralFactor, uint256 futureStablecoinsInVault) {
