...
contract StructuredStorage is Upgradeable {
    ...
    function setProxyLogicContractAndDeployer(address _proxyLogicContract, address deployer) public {
    ...
    function setProxyLogicContract(address _proxyLogicContract) public onlyDeployer {
        PROXY_LOGIC_CONTRACT = _proxyLogicContract;
    }

    // *** Getter Methods ***
    function getUint(bytes32 _key) onlyProxyLogicContract public view returns (uint) {
        return uIntStorage[_key];
    }

    function getString(bytes32 _key) onlyProxyLogicContract public view returns(string) {
        return stringStorage[_key];
    }

    function getAddress(bytes32 _key) onlyProxyLogicContract public view returns(address) {
        return addressStorage[_key];
    }

    function getBytes(bytes32 _key) onlyProxyLogicContract public view returns(bytes) {
        return bytesStorage[_key];
    }

    function getBool(bytes32 _key) onlyProxyLogicContract public view returns(bool) {
        return boolStorage[_key];
    }

    function getInt(bytes32 _key) onlyProxyLogicContract public view returns(int) {
        return intStorage[_key];
    }

    function getBytes32(bytes32 _key) onlyProxyLogicContract public view returns (bytes32) {
