...
contract SwaprateMatchBase is MatchingErrors, LibSwaprateOrder, usingRegistry, ReentrancyGuard {
    ...
    function cancel(SwaprateOrder storage _order) public {
    ...
    function validateTakerAddress(SwaprateOrder storage _leftOrder, SwaprateOrder storage _rightOrder) pure internal {
        require(
    ...
    /// @param _order SwaprateOrder
    function validateSenderAddress(SwaprateOrder storage _order) internal view {
        require(
    ...
    /// @param _order SwaprateOrder
    function validateSignature(bytes32 orderHash, SwaprateOrder storage _order) internal {
    ...
    function takeFees(bytes32 _orderHash, SwaprateOrder storage _order) internal {
