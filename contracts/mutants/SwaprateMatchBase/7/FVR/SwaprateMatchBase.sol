...
contract SwaprateMatchBase is MatchingErrors, LibSwaprateOrder, usingRegistry, ReentrancyGuard {
    ...
    function cancel(SwaprateOrder memory _order) external {
    ...
    function validateTakerAddress(SwaprateOrder memory _leftOrder, SwaprateOrder memory _rightOrder) pure public {
        require(
    ...
    /// @param _order SwaprateOrder
    function validateSenderAddress(SwaprateOrder memory _order) public view {
        require(
    ...
    /// @param _order SwaprateOrder
    function validateSignature(bytes32 orderHash, SwaprateOrder memory _order) public {
    ...
    function takeFees(bytes32 _orderHash, SwaprateOrder memory _order) public {
