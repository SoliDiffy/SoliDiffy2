...
contract SwaprateMatchBase is MatchingErrors, LibSwaprateOrder, usingRegistry, ReentrancyGuard {
    ...
    function cancel(SwaprateOrder memory _order) public nonReentrant {
    ...
    /// @param _order SwaprateOrder
    function validateSignature(bytes32 orderHash, SwaprateOrder memory _order) internal nonReentrant {
