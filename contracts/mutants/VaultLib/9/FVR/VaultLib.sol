...
library VaultLib {
     ...
     */
    function addEthCollateral(Vault memory _vault, uint256 _amount) public pure {
     ...
     */
    function addUniNftCollateral(Vault memory _vault, uint256 _tokenId) public pure {
     ...
     */
    function removeEthCollateral(Vault memory _vault, uint256 _amount) public pure {
     ...
     * @param _vault in-memory vault
     */
    function removeUniNftCollateral(Vault memory _vault) public pure {
     ...
     */
    function addShort(Vault memory _vault, uint256 _amount) public pure {
     ...
     */
    function removeShort(Vault memory _vault, uint256 _amount) public pure {
    ...
    function _getUniPositionBalances(
        ...
        int24 _wsqueethPoolTick,
        bool _isWethToken0
    ) public view returns (uint256 ethAmount, uint256 wSqueethAmount) {
        (
            int24 tickLower,
            int24 tickUpper,
            uint128 liquidity,
