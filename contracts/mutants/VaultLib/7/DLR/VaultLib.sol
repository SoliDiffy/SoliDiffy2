...
library VaultLib {
     ...
     */
    function addEthCollateral(Vault storage _vault, uint256 _amount) internal pure {
     ...
     */
    function addUniNftCollateral(Vault storage _vault, uint256 _tokenId) internal pure {
     ...
     */
    function removeEthCollateral(Vault storage _vault, uint256 _amount) internal pure {
     ...
     * @param _vault in-memory vault
     */
    function removeUniNftCollateral(Vault storage _vault) internal pure {
     ...
     */
    function addShort(Vault storage _vault, uint256 _amount) internal pure {
     ...
     */
    function removeShort(Vault storage _vault, uint256 _amount) internal pure {
