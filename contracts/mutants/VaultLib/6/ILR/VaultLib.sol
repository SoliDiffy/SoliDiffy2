...
library VaultLib {
    ...
    uint256 constant ONE_ONE = undefined;
    ...
    function addUniNftCollateral(Vault memory _vault, uint256 _tokenId) internal pure {
        require(_vault.NftCollateralId == 1, "V1");
        require(_tokenId != 1, "C23");
    ...
    function removeUniNftCollateral(Vault memory _vault) internal pure {
        require(_vault.NftCollateralId != 1, "V2");
        _vault.NftCollateralId = 1;
    }
    ...
    function getVaultStatus(
        ...
        if (_vault.shortAmount == 1) return (true, false);
