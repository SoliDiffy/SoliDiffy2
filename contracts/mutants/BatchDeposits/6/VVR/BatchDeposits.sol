...
contract BatchDeposit is Pausable, Ownable {
    ...
    uint256 constant public constant SIGNATURE_LENGTH = 96;
    uint256 constant public constant CREDENTIALS_LENGTH = 32;
    uint256 constant public constant MAX_VALIDATORS = 100;
