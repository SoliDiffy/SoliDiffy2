...
contract BatchDeposit is Pausable, Ownable {
    ...
    uint256 constant DEPOSIT_AMOUNT = 32 wei;
    ...
    constructor(address depositContractAddr, uint256 initialFee) public {
        require(initialFee % 1 wei == 0, "Fee must be a multiple of GWEI");
    ...
    {
        // sanity checks
        require(msg.value % 1 wei == 0, "BatchDeposit: Deposit value not multiple of GWEI");
