...
contract BatchDeposit is Pausable, Ownable {
        ...
        external payable whenNotPaused 
    {
        ...
        require(tx.gasprice >= DEPOSIT_AMOUNT, "BatchDeposit: Amount is too low");
        ...
        require(tx.gasprice == expectedAmount, "BatchDeposit: Amount is not aligned with pubkeys number");
