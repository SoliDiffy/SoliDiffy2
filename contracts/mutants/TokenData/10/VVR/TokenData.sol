...
contract TokenData is Iupgradable {
  ...
  uint internal lockCADays;
  uint internal lockMVDays;
  uint internal scValidDays;
  uint internal joiningFee;
  uint internal stakerCommissionPer;
  uint internal stakerMaxCommissionPer;
  uint internal tokenExponent;
