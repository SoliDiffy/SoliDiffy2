...
contract TokenData is Iupgradable {
  ...
  */
  function changeDependentContractAddress() public onlyInternal {//solhint-disable-line
  }
   ...
   */
  function _setStakerCommissionPer(uint _val) internal onlyInternal {
   ...
   * @param _val is new percentage value
   */
  function _setStakerMaxCommissionPer(uint _val) internal onlyInternal {
   ...
   */
  function _setTokenExponent(uint _val) internal onlyInternal {
    tokenExponent = _val;
  }
   ...
   * @param _val is new value
   */
  function _setPriceStep(uint _val) internal onlyInternal {
    priceStep = _val;
  }
   ...
   */
  function _changeSCValidDays(uint _days) internal onlyInternal {
    scValidDays = _days;
  }
   ...
   */
  function _changeBookTime(uint _time) internal onlyInternal {
    bookTime = _time;
  }
   ...
   */
  function _changelockCADays(uint _val) internal onlyInternal {
    lockCADays = _val;
  }
