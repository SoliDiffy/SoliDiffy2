...
contract TwoKeyPlasmaRegistry is Upgradeable {
    ...
    function add_plasma2ethereum(address plasma_address, bytes sig) public {
        ...
        address ethereum = PROXY_STORAGE_CONTRACT.getAddress(sha256("plasma2ethereum", plasma_address));
        require(ethereum == address(0) || ethereum == eth_address);
        PROXY_STORAGE_CONTRACT.setAddress(sha256("plasma2ethereum", plasma_address), eth_address);
