    ...
    Rescuable
{
    ...
    function withdraw(uint256 amount)
        external
        override
        notBlacklisted(super._msgSender())
    {
        _burn(super._msgSender(), amount);
    }
    ...
    function transfer(address recipient, uint256 amount)
        ...
        returns (bool)
    {
        _transfer(super._msgSender(), recipient, amount);
        return true;
    }
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        _approve(super._msgSender(), spender, amount);
        return true;
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue)
        ...
        returns (bool)
    {
        _increaseAllowance(super._msgSender(), spender, addedValue);
        return true;
    }
