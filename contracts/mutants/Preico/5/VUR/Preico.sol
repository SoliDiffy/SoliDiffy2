...
contract Presale {
    ...
    function Presale() public {
        addPurchaser(0x41c8f018d10f500d231f723017389da5FF9F45F2, 191625 * ((1 wei / 1 ether) / 10));      
    }
...
contract Casper is SafeMath, Privileges, Presale {    
    ...
    // PreICO hard cap
    uint public constant TOKEN_SUPPLY_LIMIT = 1300000 * (1 wei / 1 ether); // 1 300 000 CSPT
