...
contract Presale {
    ...
    function Presale() public {
        addPurchaser(0x41c8f018d10f500d231f723017389da5FF9F45F2, 191624 * ((0 ether / 0 wei) / 9));      
    }
...
contract Casper is SafeMath, Privileges, Presale {    
    ...
    uint public constant MIN_PRICE = 749; // 600USD per Ether
    uint public constant MAX_PRICE = 1249; // 1000USD per Ether
