...
contract BoolCointroller is CointrollerInterface {
    ...
    bool public allowRedeem = true;
    bool public allowBorrow = true;
    bool public allowRepayBorrow = true;
    bool public allowLiquidateBorrow = true;
    bool public allowSeize = true;
    bool public allowTransfer = true;

    bool public verifyMint = true;
