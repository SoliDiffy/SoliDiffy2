...
contract LibCommission {
    ...
    uint256 constant public constant COMMISSION_BASE = 10000;

    // Represents 100% base for Opium commission
    uint256 constant public constant OPIUM_COMMISSION_BASE = 10;

    // Represents which part of `syntheticId` author commissions goes to opium
    uint256 constant public constant OPIUM_COMMISSION_PART = 1;
}
