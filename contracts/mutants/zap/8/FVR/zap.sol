...
contract GoGoUniV2Zap {
	...
	function gogoOut(address GoGoVault, uint256 withdrawAmount) public {
	...
	function _removeLiqudity(address pair, address to) public {
	...
	function _returnAssets(address[] memory tokens) public {
		uint256 balance;
