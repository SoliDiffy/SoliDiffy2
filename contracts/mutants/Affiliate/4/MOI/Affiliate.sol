...
contract Affiliate is IAffiliate, Restricted {
     ...
     */
    function confirmAffiliation() external onlyOwner {
    ...
    */
    function confirmSubscription(address affiliate) external onlyOwner {        
    ...
    */
     ...
     */
    function updateLevelAndShare(AffiliateData storage aData) private onlyOwner {
