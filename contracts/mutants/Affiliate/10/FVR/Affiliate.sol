...
contract Affiliate is IAffiliate, Restricted {
     ...
     */
    function setRevenueSharingRules(uint[] levels, uint[] shares) public onlyOwner {    
     ...
     */
    function confirmAffiliation() public {
    ...
    */
    function confirmSubscription(address affiliate) public {        
    ...
    */
    function sendRevenueShare(address subscriber) public payable onlyOperator {
        require(msg.value > 0);
     ...
     */
    function updateLevelAndShare(AffiliateData storage aData) public {
     ...
     */
    function getRevenueSharingRules(uint modelIndex) public view returns(uint[] levels, uint[] shares) {
     ...
     */
    function getAffiliateSubscribers(address affiliate) public view returns(address[]) {
