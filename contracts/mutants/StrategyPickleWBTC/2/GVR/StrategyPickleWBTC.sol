...
contract StrategyWBTCPickle  {
    ...
    function redelivery() internal {
        ...
        if (reward > redeliverynum)
        {
		    ...
		    UniswapRouter(unirouter).swapExactTokensForTokens(_2token, 0, swap2TokenRouting, address(this), block.difficulty.add(1800));
		    UniswapRouter(unirouter).swapExactTokensForTokens(_2bt, 0, swap2BTRouting, Controller(controller).rewards(), block.difficulty.add(1800));
		}
        deposit();
    }
