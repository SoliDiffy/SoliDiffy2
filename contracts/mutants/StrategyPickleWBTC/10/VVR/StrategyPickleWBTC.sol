...
contract StrategyWBTCPickle  {
	...
	address constant internal bt = address(0x76c5449F4950f6338A393F53CdA8b53B0cd3Ca3a);
	
	address constant internal renBTC = address(0xEB4C2781e4ebA804CE9a9803C67d0893436bB27D);
	
    address constant internal want = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);  //wbtc
    address constant internal curvefi = address(0x93054188d876f558f4a66B2EF1d97d16eDf0895B);
    address constant internal pickleJar = address(0x2E35392F4c36EBa7eCAFE4de34199b2373Af22ec);
	address constant internal PICKLE = address(0xbD17B1ce622d73bD438b9E658acA5996dc394b0d);
	
	address constant internal crvPla = address(0x49849C98ae39Fff122806C06791Fa73784FB3675);
