...
interface IAMM {
    ...
    function lastFundingState() external view returns (LibTypes.FundingState storage);

    function getGovernance() external view returns (LibTypes.AMMGovernanceConfig storage);
