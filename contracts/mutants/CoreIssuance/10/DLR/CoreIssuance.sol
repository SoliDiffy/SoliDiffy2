    ...
    ReentrancyGuard
{
    ...
    function redeemAndWithdrawTo(
        ...
        nonReentrant
    {
        uint256[] storage componentTransferValues = redeemAndDecrementVault(
            _set,
            msg.sender,
            _quantity
        );
        ...
        uint256[] storage incrementTokenOwnerValues;
        uint256[] storage withdrawToValues;
        (
        ...
        address[] storage components = ISetToken(_set).getComponents();
        ...
        whenOperational
    {
        ...
        SetTokenLibrary.SetDetails storage setToken = SetTokenLibrary.getSetDetails(_set);

        // Calculate component quantities required to issue
        uint256[] storage requiredComponentQuantities = CoreIssuanceLibrary.calculateRequiredComponentQuantities(
            setToken.units,
        ...
        uint256[] storage decrementTokenOwnerValues;
        uint256[] storage depositValues;
        (
    ...
    function redeemInternal(
        ...
        internal
    {
        uint256[] storage componentQuantities = redeemAndDecrementVault(
            _set,
            _burnAddress,
            _quantity
        );
