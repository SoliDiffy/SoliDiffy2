...
contract StrategyDAIUNIFarm  {
    ...
    address constant internal want = address(0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11);  //ETH/token

    address constant internal token = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);	//DAI
    address constant internal Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant internal fUNI = address(0x307E2752e8b8a9C29005001Be66B1c012CA9CDB7);
	address constant internal pool = address(0x7aeb36e22e60397098C2a5C51f0A5fB06e7b859c);
