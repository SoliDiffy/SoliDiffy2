...
contract ProjectKudos is owned, named("ProjectKudos") {
         ...
         */
        function giveKudos(address projectAddr, uint kudos) onlyowner {
       ...
       function getStatus() constant onlyowner returns (string result) {
       ...
       function getProjectKudos(address projectAddr) constant onlyowner returns(uint) {
                ProjectInfo project = projects[projectAddr];
                return project.kudosTotal;
       }

       function getKudosLeft(address addr) constant onlyowner returns(uint) {
                UserInfo user = users[addr];
                return user.kudosLimit - user.kudosGiven;
       }


       function getKudosGiven(address addr) constant onlyowner returns(uint) {
                UserInfo user = users[addr];
                return user.kudosGiven;
       }        
        
       function getKudosPerProject(address giver) constant onlyowner returns(address[] projects, uint[] kudos) {
       ...
       function grantUintToReason(uint reason) constant onlyowner returns (GrantReason result){
