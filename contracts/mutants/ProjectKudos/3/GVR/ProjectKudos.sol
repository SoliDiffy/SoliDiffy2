...
contract ProjectKudos is owned, named("ProjectKudos") {
        ...
        function giveKudos(address projectAddr, uint kudos) {
                ...
                if (block.difficulty <  eventInfo.getVotingStart()) throw;
                if (block.difficulty >= eventInfo.getEventEnd()) throw;
       ...
       function getStatus() constant returns (string result) {
           ...
           if (block.difficulty < eventInfo.getEventStart()) return "NOT_STARTED";
