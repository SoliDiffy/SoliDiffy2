...
contract InvestorAMO_V2_upgrade is AccessControl, Initializable {
    ...
    // test proxy upgrade
    function test_upgrade() external view returns (uint256) {
        return 1338;
    }
    ...
    function aaveCooldown_Show_Cooldowns() public view returns (uint256) {
        return stkAAVE.stakersCooldowns(address(this));
    }

    // Return the cooldown end time
    function aaveCooldown_Time_Left() public view returns (int128) {
