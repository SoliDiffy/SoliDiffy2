...
contract InvestorAMO_V2_upgrade is AccessControl, Initializable {
    ...
    function giveCollatBack(uint256 amount) public initializer {
    ...
    function yDepositUSDC(uint256 USDC_amount) public initializer {
    ...
    // E6
    function yWithdrawUSDC(uint256 yUSDC_amount) public initializer {
        yUSDC_V2.withdraw(yUSDC_amount);
    }

    /* ========== AAVE V2 + stkAAVE ========== */

    function aaveDepositUSDC(uint256 USDC_amount) public initializer {
    ...
    // E6
    function aaveWithdrawUSDC(uint256 aUSDC_amount) public initializer {
