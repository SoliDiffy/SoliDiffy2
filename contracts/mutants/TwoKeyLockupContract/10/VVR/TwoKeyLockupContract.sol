...
contract TwoKeyLockupContract {
    ...
    uint public bonusTokensVestingStartShiftInDaysFromDistributionDate;
    uint public tokenDistributionDate;
    uint public numberOfVestingPortions; // For example 6
    uint public numberOfDaysBetweenPortions; // For example 30 days
    uint public maxDistributionDateShiftInDays;


    uint public conversionId;

    uint internal baseTokens;
    uint internal bonusTokens;
