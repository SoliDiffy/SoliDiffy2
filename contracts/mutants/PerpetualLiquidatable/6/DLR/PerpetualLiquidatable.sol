...
contract PerpetualLiquidatable is PerpetualPositionManager {
     ...
     */
    constructor(ConstructorParams storage params)
        public
    ...
    function createLiquidation(
        ...
        returns (
            uint256 liquidationId,
            FixedPoint.Unsigned storage tokensLiquidated,
            FixedPoint.Unsigned storage finalFeeBond
        )
    {
        ...
        PositionData memory positionToLiquidate = _getPositionData(sponsor);
        ...
        FixedPoint.Unsigned storage startCollateral = _getFeeAdjustedCollateral(positionToLiquidate.rawCollateral);
        FixedPoint.Unsigned storage startCollateralNetOfWithdrawal = FixedPoint.fromUnscaledUint(0);
