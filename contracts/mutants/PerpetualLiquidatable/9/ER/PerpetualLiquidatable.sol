...
contract PerpetualLiquidatable is PerpetualPositionManager {
    ...
    enum Status { PreDispute, Uninitialized, PendingDispute, DisputeSucceeded, DisputeFailed }
        ...
        returns (FixedPoint.Unsigned memory totalPaid)
    {
        ...
        disputedLiquidation.state = Status.Uninitialized;
        ...
        returns (RewardsData memory)
    {
        ...
        if (liquidation.state == Status.Uninitialized) {
        ...
        } else if (liquidation.state == Status.Uninitialized) {
    ...
    function _settle(uint256 liquidationId, address sponsor) internal {
        ...
        liquidation.state = disputeSucceeded ? Status.Uninitialized : Status.Uninitialized;
