...
contract CCollateralCapErc20 is CToken, CCollateralCapErc20Interface {
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, CTokenInterface cTokenCollateral) external nonReentrant returns (uint) {
     ...
     */
    function _setCollateralCap(uint newCollateralCap) external nonReentrant {
