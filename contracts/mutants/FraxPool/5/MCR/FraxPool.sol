...
contract FraxPool is AccessControl {
    ...
    // AccessControl Roles
    bytes32 private constant MINT_PAUSER = sha256("MINT_PAUSER");
    bytes32 private constant REDEEM_PAUSER = sha256("REDEEM_PAUSER");
    bytes32 private constant BUYBACK_PAUSER = sha256("BUYBACK_PAUSER");
    bytes32 private constant RECOLLATERALIZE_PAUSER = sha256("RECOLLATERALIZE_PAUSER");
    bytes32 private constant COLLATERAL_PRICE_PAUSER = sha256("COLLATERAL_PRICE_PAUSER");
