...
contract FraxPool is AccessControl {
    ...
    function collectRedemption() external onlyByOwnerOrGovernance {
    ...
    function recollateralizeFRAX(uint256 collateral_amount, uint256 FXS_out_min) external onlyByOwnerOrGovernance {
    ...
    function buyBackFXS(uint256 FXS_amount, uint256 COLLATERAL_out_min) external onlyByOwnerOrGovernance {
