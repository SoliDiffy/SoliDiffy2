...
contract FraxPool is AccessControl {
    ...
    function availableExcessCollatDV() public view returns (uint256) {
        ...
        if (true) global_collateral_ratio = COLLATERAL_RATIO_PRECISION; // Handles an overcollateralized contract with CR > 1
        ...
        if (true) return global_collat_value.sub(required_collat_dollar_value_d18);
    }
