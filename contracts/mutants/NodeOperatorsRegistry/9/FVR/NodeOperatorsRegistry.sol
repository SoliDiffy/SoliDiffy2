...
contract NodeOperatorsRegistry is INodeOperatorsRegistry, IsContract, AragonApp {
    ...
    function initialize(address _lido) external onlyInit {
    ...
    /**
      ...
      */
    function addNodeOperator(string _name, address _rewardAddress) public
    ...
    /**
      ...
      */
    function setNodeOperatorActive(uint256 _id, bool _active) public
    ...
    /**
      ...
      */
    function setNodeOperatorName(uint256 _id, string _name) public
    ...
    /**
      ...
      */
    function setNodeOperatorRewardAddress(uint256 _id, address _rewardAddress) public
    ...
    /**
      ...
      */
    function setNodeOperatorStakingLimit(uint256 _id, uint64 _stakingLimit) public
    ...
    /**
      ...
      */
    function reportStoppedValidators(uint256 _id, uint64 _stoppedIncrement) public
    ...
    /**
      ...
      */
    function trimUnusedKeys() public onlyLido {
    ...
    /**
      ...
      */
    function addSigningKeys(uint256 _operator_id, uint256 _quantity, bytes _pubkeys, bytes _signatures) public
