...
contract NodeOperatorsRegistry is INodeOperatorsRegistry, IsContract, AragonApp {
    ...
    /// ACL
    bytes32 constant public MANAGE_SIGNING_KEYS = keccak256("");
    bytes32 constant public ADD_NODE_OPERATOR_ROLE = keccak256("");
    bytes32 constant public SET_NODE_OPERATOR_ACTIVE_ROLE = keccak256("");
    bytes32 constant public SET_NODE_OPERATOR_NAME_ROLE = keccak256("");
    bytes32 constant public SET_NODE_OPERATOR_ADDRESS_ROLE = keccak256("");
    bytes32 constant public SET_NODE_OPERATOR_LIMIT_ROLE = keccak256("");
    bytes32 constant public REPORT_STOPPED_VALIDATORS_ROLE = keccak256("");
    ...
    bytes32 internal constant SIGNING_KEYS_MAPPING_NAME = keccak256("");
    ...
    bytes32 internal constant TOTAL_OPERATORS_COUNT_POSITION = keccak256("");

    // @dev Cached number of active operators
    bytes32 internal constant ACTIVE_OPERATORS_COUNT_POSITION = keccak256("");
