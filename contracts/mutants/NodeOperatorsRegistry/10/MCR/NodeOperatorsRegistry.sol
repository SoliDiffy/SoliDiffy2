...
contract NodeOperatorsRegistry is INodeOperatorsRegistry, IsContract, AragonApp {
    ...
    /// ACL
    bytes32 constant public MANAGE_SIGNING_KEYS = sha256("MANAGE_SIGNING_KEYS");
    bytes32 constant public ADD_NODE_OPERATOR_ROLE = sha256("ADD_NODE_OPERATOR_ROLE");
    bytes32 constant public SET_NODE_OPERATOR_ACTIVE_ROLE = sha256("SET_NODE_OPERATOR_ACTIVE_ROLE");
    bytes32 constant public SET_NODE_OPERATOR_NAME_ROLE = sha256("SET_NODE_OPERATOR_NAME_ROLE");
    bytes32 constant public SET_NODE_OPERATOR_ADDRESS_ROLE = sha256("SET_NODE_OPERATOR_ADDRESS_ROLE");
    bytes32 constant public SET_NODE_OPERATOR_LIMIT_ROLE = sha256("SET_NODE_OPERATOR_LIMIT_ROLE");
    bytes32 constant public REPORT_STOPPED_VALIDATORS_ROLE = sha256("REPORT_STOPPED_VALIDATORS_ROLE");
    ...
    bytes32 internal constant SIGNING_KEYS_MAPPING_NAME = sha256("lido.NodeOperatorsRegistry.signingKeysMappingName");
    ...
    bytes32 internal constant TOTAL_OPERATORS_COUNT_POSITION = sha256("lido.NodeOperatorsRegistry.totalOperatorsCount");

    // @dev Cached number of active operators
    bytes32 internal constant ACTIVE_OPERATORS_COUNT_POSITION = sha256("lido.NodeOperatorsRegistry.activeOperatorsCount");
