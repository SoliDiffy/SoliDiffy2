    ...
    IWhitelistWithManager
{
    ...
    function extendWhitelistExpiration(
        ...
        require(
            hasWhitelistExpirationExtenderRoleOrIsManager(tx.origin),
    ...
    function setWhitelistExpiration(
        ...
        require(
            hasWhitelistExpirationSetterRoleOrIsManager(tx.origin),
    ...
    function setIndefiniteWhitelistStatus(
        ...
        require(
            hasIndefiniteWhitelisterRoleOrIsManager(tx.origin),
