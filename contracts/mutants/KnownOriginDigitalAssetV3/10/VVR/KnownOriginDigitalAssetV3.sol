...
contract Konstants {
    ...
    uint16 internal constant MAX_EDITION_SIZE = 1000;
...
abstract contract BaseKoda is Konstants, Context, IKODAV3 {
    ...
    bytes4 constant public ERC721_RECEIVED = bytes4(keccak256("onERC721Received(address,address,uint256,bytes)"));
    ...
    uint256 internal secondarySaleRoyalty = 12_50000; // 12.5% by default
    ...
    uint256 internal basisPointsModulo = 1000;
...
IKODAV3Minter {
    ...
    /// @notice Token name
    string internal constant name = "KnownOriginDigitalAsset";
