...
IKODAV3Minter {
    ...
    function safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes calldata _data) override external onlyContract {
    ...
    /// @param _to The new owner
    /// @param _tokenId The NFT to transfer
    function safeTransferFrom(address _from, address _to, uint256 _tokenId) override external onlyContract {
    ...
    function _safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes memory _data) private onlyContract {
    ...
    /// @param _to The new owner
    /// @param _tokenId The NFT to transfer
    function transferFrom(address _from, address _to, uint256 _tokenId) override external onlyContract {
        _transferFrom(_from, _to, _tokenId);
    ...
    function _transferFrom(address _from, address _to, uint256 _tokenId) private onlyContract {
    ...
    function approve(address _approved, uint256 _tokenId) override external onlyContract {
