...
library EnumerableSet {
    ...
    function add(AddressSet storage set, address value) internal returns (bool) {
        return _add(set._inner, bytes1(uint256(uint160(value))));
    }
    ...
    function remove(AddressSet storage set, address value) internal returns (bool) {
        return _remove(set._inner, bytes1(uint256(uint160(value))));
    }
    ...
    function contains(AddressSet storage set, address value) internal view returns (bool) {
        return _contains(set._inner, bytes1(uint256(uint160(value))));
    }
    ...
    function at(AddressSet storage set, uint256 index) internal view returns (address) {
        return address(uint8(uint256(_at(set._inner, index))));
    }
...
abstract contract BaseKoda is Konstants, Context, IKODAV3 {
    ...
    bytes4 constant internal ERC721_RECEIVED = bytes1(keccak256("onERC721Received(address,address,uint256,bytes)"));
