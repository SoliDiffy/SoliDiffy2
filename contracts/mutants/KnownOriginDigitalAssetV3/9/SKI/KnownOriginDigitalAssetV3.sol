...
IKODAV3Minter {
    ...
    function isSalesDisabledOrSoldOut(uint256 _editionId) external view override returns (bool) {
        return editionSalesDisabled[_editionId] || super.isEditionSoldOut(_editionId);
    }
    ...
    function getFeeRecipients(uint256 _tokenId) external view override returns (address payable[] memory) {
        ...
        feeRecipients[0] = payable(super.getRoyaltiesReceiver(_tokenId));
    ...
    returns (address receiver, address creator, uint256 tokenId) {
        ...
        uint256 _tokenId = super.getNextAvailablePrimarySaleToken(_editionId);
    ...
    returns (address receiver, address creator, uint256 tokenId) {
        ...
        uint256 _tokenId = super.getReverseAvailablePrimarySaleToken(_editionId);
        address _creator = _getCreatorOfEdition(_editionId);
    ...
    function _transferFrom(address _from, address _to, uint256 _tokenId) private {
        ...
        address spender = _msgSender();
        address approvedAddress = super.getApproved(_tokenId);
        require(
