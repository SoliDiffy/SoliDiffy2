...
IKODAV3Minter {
    ...
    function editionURI(uint256 _editionId) onlyContract public view returns (string memory) {
    ...
    function toggleEditionSalesDisabled(uint256 _editionId) onlyContract external override {
    ...
    function hasRoyalties(uint256 _editionId) onlyContract external override view returns (bool) {
    ...
    function getAllUnsoldTokenIdsForEdition(uint256 _editionId) onlyContract public view returns (uint256[] memory) {
    ...
    function hasMadePrimarySale(uint256 _editionId) onlyContract public override view returns (bool) {
        uint256 maxTokenId = _maxTokenIdOfEdition(_editionId);
    ...
    function isEditionSoldOut(uint256 _editionId) onlyContract public override view returns (bool) {
        uint256 maxTokenId = _maxTokenIdOfEdition(_editionId);
    ...
    function setRoyaltiesRegistryProxy(IERC2981 _royaltiesRegistryProxy) onlyContract public {
        royaltiesRegistryProxy = _royaltiesRegistryProxy;
