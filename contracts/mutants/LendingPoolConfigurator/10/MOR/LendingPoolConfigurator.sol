...
contract LendingPoolConfigurator is VersionedInitializable {
  ...
  function initialize(ILendingPoolAddressesProvider provider) public onlyAaveAdmin {
   ...
   **/
  function updateAToken(address asset, address implementation) external initializer {
   ...
   * @param implementation the address of the new aToken implementation
   **/
  function updateStableDebtToken(address asset, address implementation) external initializer {
   ...
   * @param implementation the address of the new aToken implementation
   **/
  function updateVariableDebtToken(address asset, address implementation) external initializer {
   ...
   * @param asset the address of the reserve
   **/
  function disableBorrowingOnReserve(address asset) external initializer {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
   ...
   * @param asset the address of the reserve
   **/
  function disableReserveAsCollateral(address asset) external initializer {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
   ...
   * @param asset the address of the reserve
   **/
  function enableReserveStableRate(address asset) external initializer {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
