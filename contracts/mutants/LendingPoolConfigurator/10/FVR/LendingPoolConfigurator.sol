...
contract LendingPoolConfigurator is VersionedInitializable {
   ...
   * @param implementation the address of the new aToken implementation
   **/
  function updateVariableDebtToken(address asset, address implementation) public onlyAaveAdmin {
   ...
   * @param asset the address of the reserve
   **/
  function disableBorrowingOnReserve(address asset) public onlyAaveAdmin {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
   ...
   * @param asset the address of the reserve
   **/
  function disableReserveAsCollateral(address asset) public onlyAaveAdmin {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
   ...
   * @param asset the address of the reserve
   **/
  function enableReserveStableRate(address asset) public onlyAaveAdmin {
    ReserveConfiguration.Map memory currentConfig = pool.getConfiguration(asset);
