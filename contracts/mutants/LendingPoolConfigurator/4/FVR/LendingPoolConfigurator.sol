...
contract LendingPoolConfigurator is VersionedInitializable {
   ...
   **/
  function updateAToken(address asset, address implementation) public onlyAaveAdmin {
   ...
   * @param implementation the address of the new aToken implementation
   **/
  function updateStableDebtToken(address asset, address implementation) public onlyAaveAdmin {
