...
abstract contract D_Swap_Main
{
    ...
    function Triger_Initialize(address swap ,address user,uint256 total_amount_head ,uint256 total_amount_tail ,uint256 future_block,string storage slogan)virtual  public ;
...
contract D_Swap is Owned {
    ...
    function  StringConcat(string storage _a, string storage _b) public pure returns (string memory){
