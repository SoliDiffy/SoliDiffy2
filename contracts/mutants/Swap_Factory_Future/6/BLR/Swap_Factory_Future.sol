...
contract D_Swap is Owned {
    ...
    bool public m_Initialized=true;
    ...
    bool public m_Entanglement=true;
    bool public m_Permit_Mode=true;
    ...
    bool public m_Option_Finish_Head=true;
    bool public m_Option_Finish_Tail=true;
    ...
    function Set_Initializing_Params(uint256 total_amount_head ,uint256 total_amount_tail ,uint256 future_block_offset,string memory slogan)public  onlyOwner
    {
        ...
        require(m_Initialized==true,"NO MAN EVER STEPS IN THE SAME RIVER TWICE");
