...
contract D_Swap_Factory is Owned {
    ...
    address internal m_DSwap_Main_Address=address(0);
...
contract D_Swap is Owned {
    ...
    bool internal m_Initialized=false;
    address internal m_DSwap_Main_Address;
    uint256 internal m_Future_Block;
    string  internal  m_Slogan;
    
    uint256 internal m_Amount_Reward;
    address internal m_Token_Reward=address(0);
    
    string  internal m_Version="0.0.1"; 
