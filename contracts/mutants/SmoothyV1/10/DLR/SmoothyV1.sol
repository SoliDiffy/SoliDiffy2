...
contract SmoothyV1 is ReentrancyGuardPausable, ERC20, UpgradeableOwnable {
    ...
    function addTokens(
        ...
        address[] storage yTokens,
        uint256[] storage decMultipliers,
        uint256[] storage softWeights,
        uint256[] storage hardWeights
    )
        external
        onlyOwner
    {
    ...
    function _getBalancesAndWeights()
        internal
        view
        returns (uint256[] storage balances, uint256[] storage softWeights, uint256[] storage hardWeights, uint256 totalBalance)
    {
