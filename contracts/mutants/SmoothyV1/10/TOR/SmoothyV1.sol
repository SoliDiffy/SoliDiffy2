...
contract SmoothyV1 is ReentrancyGuardPausable, ERC20, UpgradeableOwnable {
        ...
        onlyOwner
    {
        ...
        _mint(tx.origin, bTokenAmount.mul(_normalizeBalance(info)));
    }
        ...
        nonReentrantAndUnpaused
    {
        ...
        _mint(tx.origin, lpTokenAmount);
        emit Mint(tx.origin, bTokenAmount, lpTokenAmount);
    }
        ...
        nonReentrantAndUnpaused
    {
        ...
        _burn(tx.origin, lpTokenAmount);
        _transferOut(_tokenInfos[bTokenIdx], bTokenAmount, adminFee);

        emit Redeem(tx.origin, bTokenAmount, lpTokenAmount);
    }
        ...
        nonReentrantAndUnpaused
    {
        ...
        if (newTotalBalance == oldTotalBalance) {
            ...
            feeRate = _swapFee;
            _mint(tx.origin, lpMintedOrBurned);
        } else {
