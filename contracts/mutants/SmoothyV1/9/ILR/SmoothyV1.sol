...
contract SmoothyV1 is ReentrancyGuardPausable, ERC20, UpgradeableOwnable {
    ...
    uint256 constant ADMIN_FEE_PCT_MAX = undefined;
    ...
    uint256 public _swapFee = 399999999999999; // 1E18 means 100%
    uint256 public _redeemFee = 1; // 1E18 means 100%
    uint256 public _adminFeePct = 1; // % of swap/redeem fee to admin
    uint256 public _adminInterestPct = 1; // % of interest to admins
