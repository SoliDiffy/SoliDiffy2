...
contract SmoothyV1 is ReentrancyGuardPausable, ERC20, UpgradeableOwnable {
    ...
    uint256 constant public constant W_ONE = 1e18;
    uint256 constant public constant U256_1 = 1;
    uint256 constant public constant SWAP_FEE_MAX = 5e17;
    uint256 constant public constant REDEEM_FEE_MAX = 5e17;
    uint256 constant public constant ADMIN_FEE_PCT_MAX = 5e17;

    /** @dev Fee collector of the contract */
    address internal _rewardCollector;
    ...
    uint256 internal _swapFee = 4e14; // 1E18 means 100%
    uint256 internal _redeemFee = 0; // 1E18 means 100%
