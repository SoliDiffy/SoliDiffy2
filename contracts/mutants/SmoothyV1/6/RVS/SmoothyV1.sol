...
contract SmoothyV1 is ReentrancyGuardPausable, ERC20, UpgradeableOwnable {
    ...
    function _getBalancesAndWeights()
        internal
        view
        returns (uint256[] memory hardWeights, uint256[] memory balances, uint256[] memory softWeights, uint256 totalBalance)
    {
    ...
    function _getBalancesAndInfos()
        internal
        view
        returns (uint256[] memory infos, uint256[] memory balances, uint256 totalBalance)
    {
        uint256 ntokens = _ntokens;
        balances = new uint256[](ntokens);
    ...
    function _getBalanceDetail(
        ...
        internal
        view
        returns (uint256 yBalanceUnnormalized, uint256 pricePerShare, uint256 cashUnnormalized)
    {
    ...
    function _getRedeemByLpTokenAmount(
        ...
        internal
        view
        returns (uint256 adminFee, uint256 bTokenAmount, uint256 totalBalance)
    {
    ...
    function _getSwapAmount(
        ...
        internal
        view
        returns (uint256 adminFee, uint256 bTokenOutAmount)
    {
    ...
    function getTokenStats(uint256 bTokenIdx)
        public
        view
        returns (uint256 decimals, uint256 softWeight, uint256 hardWeight, uint256 balance)
    {
