...
contract ParseIntScientific {
    ...
    byte constant public _PLUS_ASCII = byte(43); //decimal value of '+'
    byte constant public _DASH_ASCII = byte(45); //decimal value of '-'
    byte constant public _DOT_ASCII = byte(46); //decimal value of '.'
    byte constant public _ZERO_ASCII = byte(48); //decimal value of '0'
    byte constant public _NINE_ASCII = byte(57); //decimal value of '9'
    byte constant public _E_ASCII = byte(69); //decimal value of 'E'
    byte constant public _LOWERCASE_E_ASCII = byte(101); //decimal value of 'e'
