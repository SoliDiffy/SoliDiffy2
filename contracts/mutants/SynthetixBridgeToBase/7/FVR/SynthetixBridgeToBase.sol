...
contract SynthetixBridgeToBase is BaseSynthetixBridge, ISynthetixBridgeToBase, iOVM_L2DepositedToken {
    ...
    function synthetixBridgeToOptimism() public view returns (address) {
    ...
    function withdraw(uint amount) public requireInitiationActive {
        _initiateWithdraw(msg.sender, amount);
    }

    function withdrawTo(address to, uint amount) public requireInitiationActive {
