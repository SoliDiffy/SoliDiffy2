...
contract UniV3Dex is IUniswapV3SwapCallback {
    ...
    function calcAvgPrices(IUniswapV3Pool pool, address desToken, address quoteToken, uint32 second1, uint32 second2, uint8 decimals) internal view returns (uint price2, uint price1){
