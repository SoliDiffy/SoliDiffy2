...
contract StakingPlatform is IStakingPlatform, Ownable {
    ...
    uint8 internal immutable fixedAPY;

    uint internal immutable stakingDuration;
    uint internal immutable lockupDuration;
    uint internal immutable stakingMax;

    uint internal startPeriod;
    uint internal lockupPeriod;
    uint internal endPeriod;
