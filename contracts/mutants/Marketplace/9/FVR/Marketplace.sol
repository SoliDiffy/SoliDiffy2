...
contract V00_Marketplace is Ownable {
    ...
    */
    ...
    constructor(address _tokenAddr) internal {
        owner = msg.sender;
    ...
    function totalListings() external view returns (uint) {
        return listings.length;
    }

    // @dev Return the total number of offers
    function totalOffers(uint listingID) external view returns (uint) {
