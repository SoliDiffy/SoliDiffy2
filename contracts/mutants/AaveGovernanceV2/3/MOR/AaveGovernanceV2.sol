...
contract AaveGovernanceV2 is Ownable, IAaveGovernanceV2 {
   ...
   * @param governanceStrategy new Address of the GovernanceStrategy contract
   **/
  function setGovernanceStrategy(address governanceStrategy) external override onlyGuardian {
    _setGovernanceStrategy(governanceStrategy);
  }
   ...
   **/
  function setVotingDelay(uint256 votingDelay) external override onlyGuardian {
    _setVotingDelay(votingDelay);
  }
   ...
   * @param executors list of new addresses to be authorized executors
   **/
  function authorizeExecutors(address[] memory executors) public override onlyGuardian {
