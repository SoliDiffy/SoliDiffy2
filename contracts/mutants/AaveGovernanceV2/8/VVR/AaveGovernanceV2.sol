...
contract AaveGovernanceV2 is Ownable, IAaveGovernanceV2 {
  ...
  address public _governanceStrategy;
  ...
  bytes32 internal constant VOTE_EMITTED_TYPEHASH = keccak256('VoteEmitted(uint256 id,bool support)');
  string internal constant NAME = 'Aave Governance v2';
