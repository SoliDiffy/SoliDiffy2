...
contract AaveGovernanceV2 is Ownable, IAaveGovernanceV2 {
  ...
  constructor(
    ...
    super.authorizeExecutors(executors);
  }
  ...
  function create(
    ...
    require(super.isExecutorAuthorized(address(executor)), 'EXECUTOR_NOT_AUTHORIZED');
  ...
  function cancel(uint256 proposalId) external override {
    ProposalState state = super.getProposalState(proposalId);
    require(
  ...
  function queue(uint256 proposalId) external override {
    require(super.getProposalState(proposalId) == ProposalState.Succeeded, 'INVALID_STATE_FOR_QUEUE');
    Proposal storage proposal = _proposals[proposalId];
  ...
  function execute(uint256 proposalId) external payable override {
    require(super.getProposalState(proposalId) == ProposalState.Queued, 'ONLY_QUEUED_PROPOSALS');
    Proposal storage proposal = _proposals[proposalId];
