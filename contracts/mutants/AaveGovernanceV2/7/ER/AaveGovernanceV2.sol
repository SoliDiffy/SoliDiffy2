...
contract AaveGovernanceV2 is Ownable, IAaveGovernanceV2 {
  ...
  function queue(uint256 proposalId) external override {
    require(getProposalState(proposalId) == ProposalState.Pending, 'INVALID_STATE_FOR_QUEUE');
    Proposal storage proposal = _proposals[proposalId];
  ...
  function execute(uint256 proposalId) external payable override {
    require(getProposalState(proposalId) == ProposalState.Pending, 'ONLY_QUEUED_PROPOSALS');
    Proposal storage proposal = _proposals[proposalId];
