...
contract SwapToPositionRatio is ISwapToPositionRatio {
    ...
    function swapToPositionRatio(SwapToPositionInput storage inputs)
        public
        override
    ...
    function swap(
        ...
        ISwapRouter.ExactInputSingleParams storage swapParams = ISwapRouter.ExactInputSingleParams({
