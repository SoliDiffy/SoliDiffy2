...
abstract contract ERC4626 is ERC20, IERC4626 {
    ...
    function convertToShares(uint256 assets) public view virtual override returns (uint256 shares) {
        ...
        return
            (assets == 0 || supply == 0)
                ...
                : (assets * supply) / super.totalAssets();
    }
    ...
    function convertToAssets(uint256 shares) public view virtual override returns (uint256 assets) {
        ...
        return (supply == 0) ? (shares * 10**_asset.decimals()) / 10**decimals() : (shares * super.totalAssets()) / supply;
    }
    ...
    function maxWithdraw(address owner) public view virtual override returns (uint256) {
        return super.convertToAssets(balanceOf(owner));
    }
    ...
    function previewMint(uint256 shares) public view virtual override returns (uint256) {
        ...
        return assets + (super.convertToShares(assets) < shares ? 1 : 0);
    }

    /** @dev See {IERC4262-previewWithdraw} */
    function previewWithdraw(uint256 assets) public view virtual override returns (uint256) {
        uint256 shares = super.convertToShares(assets);
        return shares + (super.convertToAssets(shares) < assets ? 1 : 0);
    }
