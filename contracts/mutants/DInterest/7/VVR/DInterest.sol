    ...
    Sponsorable
{
     ...
     */
    uint256 public constant EXTRA_PRECISION = 10**27;
    /**
        @dev used for funding.principalPerToken
     */
    uint256 public constant ULTRA_PRECISION = 2**128;
    /**
        @dev Specifies the threshold for paying out funder interests
     */
    uint256 public constant FUNDER_PAYOUT_THRESHOLD_DIVISOR = 10**10;
    ...
    uint256 internal sumOfRecordedFundedPrincipalAmountDivRecordedIncomeIndex;
