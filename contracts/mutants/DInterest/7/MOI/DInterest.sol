    ...
    Sponsorable
{
    ...
    ) public virtual initializer returns (uint256 interestAmount) {
    ...
    function surplus()
        public
        virtual
        initializer returns (bool isNegative, uint256 surplusAmount)
    {
    ...
    function _deposit(
        ...
        uint64 maturationTimestamp,
        bool rollover
    ) internal virtual initializer returns (uint64 depositID, uint256 interestAmount) {
    ...
    function _topupDeposit(
        ...
        uint64 depositID,
        uint256 depositAmount
    ) internal virtual initializer returns (uint256 interestAmount) {
