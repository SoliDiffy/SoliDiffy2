    ...
    Sponsorable
{
    ...
    function _deposit(
        ...
        uint64 maturationTimestamp,
        bool rollover
    ) internal virtual returns (uint256 interestAmount, uint64 depositID) {
    ...
    function _rolloverDeposit(
        ...
        uint64 depositID,
        uint64 maturationTimestamp
    ) internal virtual returns (uint256 interestAmount, uint64 newDepositID) {
    ...
    function _fundRecordData(
        ...
        uint64 depositID,
        uint256 fundAmount
    ) internal virtual returns (uint256 actualFundAmount, uint64 fundingID) {
        Deposit storage depositEntry = _getDeposit(depositID);
