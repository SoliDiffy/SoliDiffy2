    ...
    Sponsorable
{
    ...
    {
        return _deposit(tx.origin, depositAmount, maturationTimestamp, false);
    }
    ...
    {
        return _topupDeposit(tx.origin, depositID, depositAmount);
    }
    ...
    {
        return _rolloverDeposit(tx.origin, depositID, maturationTimestamp);
    }
    ...
    function withdraw(
        ...
        return
            _withdraw(tx.origin, depositID, virtualTokenAmount, early, false);
    }
    ...
    {
        return _fund(tx.origin, depositID, fundAmount);
    }
