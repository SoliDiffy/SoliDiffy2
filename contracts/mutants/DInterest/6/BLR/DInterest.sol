    ...
    Sponsorable
{
    ...
    {
        return _deposit(msg.sender, depositAmount, maturationTimestamp, true);
    }
    ...
    function withdraw(
        ...
        return
            _withdraw(msg.sender, depositID, virtualTokenAmount, early, true);
    }
    ...
    function _rolloverDeposit(
        ...
        uint256 withdrawnStablecoinAmount =
            _withdraw(sender, depositID, type(uint256).max, true, false);
