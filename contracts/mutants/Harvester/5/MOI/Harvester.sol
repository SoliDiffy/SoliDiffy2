...
contract Harvester is Governable {
    ...
    ****************************************/
     ...
     * @dev Collect reward tokens from all strategies
     */
    function _harvest() internal onlyGovernor {
     ...
     * @param _strategyAddr Address of the strategy to collect rewards from.
     */
    function _harvest(address _strategyAddr) internal onlyGovernor {
        require(
     ...
     *      for executing this function
     */
    function _swap(address _rewardTo) internal onlyGovernor {
        address[] memory allStrategies = IVault(vaultAddress)
            .getAllStrategies();
     ...
     */
    function _swap(address _swapToken, address _rewardTo) internal onlyGovernor {
