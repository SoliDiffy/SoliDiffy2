...
contract Harvester is Governable {
    ...
    ****************************************/
    ...
    function harvest() external nonReentrant onlyGovernor {
        _harvest();
    }
     ...
     */
    function swap() external nonReentrant onlyGovernor {
     ...
     */
    function harvestAndSwap() external nonReentrant onlyGovernor {
        _harvest();
        _swap(rewardProceedsAddress);
    }
     ...
     */
    function harvest(address _strategyAddr) external nonReentrant onlyGovernor {
