...
contract Harvester is Governable {
    ...
    ****************************************/
    ...
    function setRewardTokenConfig(
        ...
        RewardTokenConfig storage tokenConfig = RewardTokenConfig({
    ...
    ****************************************/
    ...
    function _harvest() internal {
        address[] storage allStrategies = IVault(vaultAddress)
            .getAllStrategies();
        ...
        internal
    {
        ...
        address[] storage rewardTokens = strategy.getRewardTokenAddresses();
