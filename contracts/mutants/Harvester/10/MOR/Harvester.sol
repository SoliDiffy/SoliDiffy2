...
contract Harvester is Governable {
    ...
    ****************************************/
    ...
    function harvest() external onlyVaultOrGovernor nonReentrant {
        _harvest();
    }
     ...
     */
    function swap() external onlyVaultOrGovernor nonReentrant {
     ...
     */
    function harvestAndSwap() external onlyVaultOrGovernor nonReentrant {
        _harvest();
        _swap(rewardProceedsAddress);
    }
     ...
     */
    function harvest(address _strategyAddr) external onlyVaultOrGovernor nonReentrant {
     ...
     * @param _strategyAddr Address of the strategy to collect rewards from
     */
    function harvestAndSwap(address _strategyAddr) external onlyGovernor {
