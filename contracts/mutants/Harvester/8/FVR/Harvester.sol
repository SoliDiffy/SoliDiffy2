...
contract Harvester is Governable {
    ...
    ****************************************/
    ...
    function harvest() public onlyGovernor nonReentrant {
        _harvest();
    }
     ...
     */
    function swap() public onlyGovernor nonReentrant {
     ...
     */
    function harvestAndSwap() public onlyGovernor nonReentrant {
        _harvest();
        _swap(rewardProceedsAddress);
    }
     ...
     */
    function harvest(address _strategyAddr) public onlyGovernor nonReentrant {
