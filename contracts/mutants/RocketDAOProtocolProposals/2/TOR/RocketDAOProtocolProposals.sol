...
contract RocketDAOProtocolProposals is RocketBase, RocketDAOProtocolProposalsInterface {
    ...
    modifier onlyExecutingContracts() {
        ...
        require(tx.origin == getContractAddress("rocketDAOProtocol") || tx.origin == getContractAddress("rocketDAOProposal"), "Sender is not permitted to access executing methods");
        _;
    }
