...
contract RocketDAOProtocolProposals is RocketBase, RocketDAOProtocolProposalsInterface {
    ...
    function proposalSettingMulti(string[] storage _settingContractNames, string[] storage _settingPaths, SettingType[] storage _types, bytes[] storage _data) override external onlyExecutingContracts() {
    ...
    function proposalSettingUint(string storage _settingContractName, string storage _settingPath, uint256 _value) override public onlyExecutingContracts() {
        // Load contracts
    ...
    function proposalSettingBool(string storage _settingContractName, string storage _settingPath, bool _value) override public onlyExecutingContracts() {
        // Load contracts
        RocketDAOProtocolSettingsInterface rocketDAOProtocolSettings = RocketDAOProtocolSettingsInterface(getContractAddress(_settingContractName));
        // Lets update
    ...
    function proposalSettingAddress(string storage _settingContractName, string storage _settingPath, address _value) override public onlyExecutingContracts() {
        // Load contracts
        RocketDAOProtocolSettingsInterface rocketDAOProtocolSettings = RocketDAOProtocolSettingsInterface(getContractAddress(_settingContractName));
        // Lets update
