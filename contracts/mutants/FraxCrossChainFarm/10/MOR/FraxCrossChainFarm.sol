...
contract FraxCrossChainFarm is Owned, ReentrancyGuard {
    ...
    function stakeLocked(uint256 liquidity, uint256 secs) onlyByOwnGovCtrlr public {
    ...
    function withdrawLocked(bytes32 kek_id) onlyByOwnGovCtrlr public {
    ...
    function getReward() external onlyByOwnGovCtrlr returns (uint256, uint256) {
    ...
    function initializeDefault() external nonReentrant {
