...
contract Curate is Ownable, ERC20Burnable {
  ...
  function computeFee(uint256 _amount) public view returns (uint256 fee, uint256 sendAmount) {
  ...
  function setParams(uint256 _newBasisPoints, uint256 _newMaxFee, address _masterAccount) external onlyOwner {
