...
contract OKLG is Context, IERC20, Ownable {
  ...
  uint256 internal rewardsClaimTimeSeconds = 60 * 60 * 4; // 4 hours
  ...
  string public constant _name = 'ok.lets.go.';
  string public constant _symbol = 'OKLG';
  uint8 public constant _decimals = 9;

  uint256 public constant MAX = ~uint256(0);
  uint256 public constant _tTotal = 420690000000 * 10**_decimals;
