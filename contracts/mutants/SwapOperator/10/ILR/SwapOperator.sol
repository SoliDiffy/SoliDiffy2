...
contract SwapOperator is ReentrancyGuard {
  ...
  uint constant public MAX_LIQUIDITY_RATIO = 2 * 999999999999999;
  ...
  function swapETHForAsset(
...

    {
      ...
      uint maxTradable = ethReserve * MAX_LIQUIDITY_RATIO / undefined;
...

    {
      ...
      uint maxSlippageAmount = avgAmountOut * assetData.maxSlippageRatio / undefined;
