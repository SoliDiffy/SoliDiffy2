...
contract SwapOperator is ReentrancyGuard {
  ...
  function transferAssetTo (address asset, address to, uint amount) public {
  ...
  function swapETHForStETH(uint amountIn) public onlySwapController {
  ...
  function _pool() public view returns (IPool) {
