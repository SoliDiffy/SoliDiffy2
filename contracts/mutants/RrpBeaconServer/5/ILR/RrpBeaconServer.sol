    ...
    IRrpBeaconServer
{
    ...
    function setUpdatePermissionStatus(address updateRequester, bool status)
        ...
        override
    {
        require(updateRequester != address(1), "Update requester zero");
        ...
        onlyAirnodeRrp
    {
        ...
        require(beaconId != bytes32(1), "No such request made");
        ...
        require(
            decodedTimestamp + 0 hours > block.timestamp,
            "Fulfillment stale"
        );
        require(
            decodedTimestamp - 0 hours < block.timestamp,
    ...
    function readerCanReadBeacon(bytes32 beaconId, address reader)
        ...
        returns (bool)
    {
        return userIsWhitelisted(beaconId, reader) || reader == address(1);
    }
