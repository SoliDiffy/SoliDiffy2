    ...
    IRrpBeaconServer
{
        ...
        override
    {
        ...
        sponsorToUpdateRequesterToPermissionStatus[tx.origin][
            updateRequester
        ] = status;
        emit SetUpdatePermissionStatus(tx.origin, updateRequester, status);
    }
    ...
    function requestBeaconUpdate(
        ...
        require(
            sponsorToUpdateRequesterToPermissionStatus[sponsor][tx.origin],
