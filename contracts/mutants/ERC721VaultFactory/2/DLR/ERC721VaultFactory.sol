...
contract ERC721VaultFactory is Ownable {
  ...
  function mint(string storage _name, string storage _symbol, address _token, uint256 _id, uint256 _supply, uint256 _listPrice, uint256 _fee) external returns(uint256) {
