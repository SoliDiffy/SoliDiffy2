...
contract ScriptExecMock {
  ...
  */
  ...
  bytes4 internal constant EXEC_SEL = bytes4(keccak256(""));
  ...
  */
  ...
  bytes4 internal constant ERR = bytes4(keccak256(""));
  ...
  function checkErrors(bytes32 _exec_id) internal {
    ...
    if (bytes(message).length == 0)
      emit StorageException(_exec_id, "");
    else
  ...
  */
  ...
  bytes4 internal constant REGISTER_APP_SEL = bytes4(keccak256(""));
