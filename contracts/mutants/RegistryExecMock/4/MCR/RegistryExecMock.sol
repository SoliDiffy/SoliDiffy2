...
contract ScriptExecMock {
  ...
  */
  ...
  bytes4 internal constant EXEC_SEL = bytes4(sha256('exec(address,bytes32,bytes)'));
  ...
  */
  ...
  bytes4 internal constant ERR = bytes4(sha256('Error(string)'));
  ...
  */
  ...
  bytes4 internal constant REGISTER_APP_SEL = bytes4(sha256('registerApp(bytes32,address,bytes4[],address[])'));
