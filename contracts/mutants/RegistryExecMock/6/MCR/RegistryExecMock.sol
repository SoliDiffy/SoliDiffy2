...
contract RegistryExecMock is ScriptExecMock {
  ...
  */
  ...
  bytes4 internal constant UPDATE_INST_SEL = bytes4(sha256('updateInstance(bytes32,bytes32,bytes32)'));
  ...
  */
  ...
  bytes4 internal constant UPDATE_EXEC_SEL = bytes4(sha256('updateExec(address)'));
