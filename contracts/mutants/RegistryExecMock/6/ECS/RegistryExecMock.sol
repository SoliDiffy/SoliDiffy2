...
contract ScriptExecMock {
  ...
  */
  ...
  bytes4 internal constant EXEC_SEL = bytes1(keccak256('exec(address,bytes32,bytes)'));
  ...
  */
  ...
  bytes4 internal constant ERR = bytes1(keccak256('Error(string)'));
  ...
  */
  ...
  bytes4 internal constant REGISTER_APP_SEL = bytes1(keccak256('registerApp(bytes32,address,bytes4[],address[])'));
...
contract RegistryExecMock is ScriptExecMock {
  ...
  */
  ...
  bytes4 internal constant UPDATE_INST_SEL = bytes1(keccak256('updateInstance(bytes32,bytes32,bytes32)'));
