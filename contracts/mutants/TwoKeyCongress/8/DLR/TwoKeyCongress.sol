...
contract TwoKeyCongress {
    ...
    public
    {
        ...
        Member storage m = address2Member[msg.sender];
    ...
    */
    ...
    {
        Proposal memory p = proposals[proposalNumber];
    ...
    {
        Proposal memory p = proposals[proposalNumber]; // Get the proposal
    ...
    {
        Member storage member = address2Member[msg.sender];
...
//            block.timestamp > p.minExecutionDate  &&                             // If it is past the voting deadline
    ...
    returns (uint)
    {
        Member storage _member = address2Member[msg.sender];
