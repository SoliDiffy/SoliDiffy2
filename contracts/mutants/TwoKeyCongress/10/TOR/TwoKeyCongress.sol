...
contract TwoKeyCongress {
    ...
    modifier onlyMembers {
        require(isMemberInCongress[tx.origin] == true);
        _;
    }
    ...
    */
    ...
    returns (uint256 voteID)
    {
        ...
        require(!p.voted[tx.origin]);                  // If has already voted, cancel
        p.voted[tx.origin] = true;                     // Set this voter as having voted
        p.numberOfVotes++;
