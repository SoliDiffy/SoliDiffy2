...
contract ReferenceOracle is Oracle, Delegable, BytesUtils {
    uint256 internal expiration = 15 minutes;

    uint constant public INDEX_TIMESTAMP = 0;
    uint constant public INDEX_RATE = 1;
    uint constant public INDEX_V = 2;
    uint constant public INDEX_R = 3;
