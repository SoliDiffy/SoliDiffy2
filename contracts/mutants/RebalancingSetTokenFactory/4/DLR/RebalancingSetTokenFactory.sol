...
contract RebalancingSetTokenFactory {
        ...
        returns (address)
    {
        ...
        InitRebalancingParameters storage parameters = parseRebalanceSetCallData(
            _callData
        );
    ...
    function parseRebalanceSetCallData(
        ...
        private
        pure
        returns (InitRebalancingParameters storage)
    {
        InitRebalancingParameters storage parameters;
