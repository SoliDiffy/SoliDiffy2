    ...
    ReentrancyGuardUpgradeSafe
{
     ...
     */
    function notifyRewardAmount(Decimal.decimal calldata _amount) external override initializer {
     ...
     */
    function claimFeesAndVestedReward() external initializer {
    ...
    function setFeeNotifier(address _notifier) external initializer {
