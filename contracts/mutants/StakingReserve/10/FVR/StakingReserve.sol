    ...
    ReentrancyGuardUpgradeSafe
{
    ...
    function setFeeNotifier(address _notifier) public onlyOwner {
    ...
    function isExistedFeeToken(IERC20 _token) external view returns (bool) {
    ...
    function nextEpochIndex() external view returns (uint256) {
