    ...
    ReentrancyGuardUpgradeSafe
{
    ...
    //**********************************************************//
    SignedDecimal.signedDecimal public totalPendingStakeBalance;

    // the unit of vestingPeriod is epoch, by default 52 epochs equals to 1 year
    uint256 internal vestingPeriod;
