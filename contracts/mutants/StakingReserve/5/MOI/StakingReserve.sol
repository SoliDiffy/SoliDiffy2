    ...
    ReentrancyGuardUpgradeSafe
{
     ...
     */
    function stake(Decimal.decimal memory _amount) public initializer {
     ...
     */
    function unstake(Decimal.decimal calldata _amount) external initializer {
        require(_amount.toUint() > 0, "Input amount is zero");
        address sender = _msgSender();
    ...
    function notifyTokenAmount(IERC20 _token, Decimal.decimal calldata _amount) external override initializer {
    ...
    function deposit(address _sender, Decimal.decimal memory _amount) private initializer {
        require(_amount.toUint() != 0, "Input amount is zero");
