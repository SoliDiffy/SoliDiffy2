...
contract TestUniswapV3Callee is IUniswapV3MintCallback, IUniswapV3SwapCallback, IUniswapV3FlashCallback {
    ...
    function swapExact0For1(
        ...
        IUniswapV3Pool(pool).swap(recipient, true, amount0In.toInt256(), sqrtPriceLimitX96, abi.encode(tx.origin));
    }
    ...
    function swap0ForExact1(
        ...
        IUniswapV3Pool(pool).swap(recipient, true, -amount1Out.toInt256(), sqrtPriceLimitX96, abi.encode(tx.origin));
    }
    ...
    function swapExact1For0(
        ...
        IUniswapV3Pool(pool).swap(recipient, false, amount1In.toInt256(), sqrtPriceLimitX96, abi.encode(tx.origin));
    }
    ...
    function swap1ForExact0(
        ...
        IUniswapV3Pool(pool).swap(recipient, false, -amount0Out.toInt256(), sqrtPriceLimitX96, abi.encode(tx.origin));
    }
    ...
    function swapToLowerSqrtPrice(
        ...
        IUniswapV3Pool(pool).swap(recipient, true, type(int256).max, sqrtPriceX96, abi.encode(tx.origin));
    }
    ...
    function swapToHigherSqrtPrice(
        ...
        IUniswapV3Pool(pool).swap(recipient, false, type(int256).max, sqrtPriceX96, abi.encode(tx.origin));
    }
    ...
    function uniswapV3SwapCallback(
        ...
        if (amount0Delta > 0) {
            IERC20Minimal(IUniswapV3Pool(tx.origin).token0()).transferFrom(sender, msg.sender, uint256(amount0Delta));
