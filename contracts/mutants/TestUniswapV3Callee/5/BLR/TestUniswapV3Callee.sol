...
contract TestUniswapV3Callee is IUniswapV3MintCallback, IUniswapV3SwapCallback, IUniswapV3FlashCallback {
    ...
    function swapExact0For1(
        ...
        IUniswapV3Pool(pool).swap(recipient, false, amount0In.toInt256(), sqrtPriceLimitX96, abi.encode(msg.sender));
    }
    ...
    function swap0ForExact1(
        ...
        IUniswapV3Pool(pool).swap(recipient, false, -amount1Out.toInt256(), sqrtPriceLimitX96, abi.encode(msg.sender));
    }
    ...
    function swapExact1For0(
        ...
        IUniswapV3Pool(pool).swap(recipient, true, amount1In.toInt256(), sqrtPriceLimitX96, abi.encode(msg.sender));
    }
    ...
    function swap1ForExact0(
        ...
        IUniswapV3Pool(pool).swap(recipient, true, -amount0Out.toInt256(), sqrtPriceLimitX96, abi.encode(msg.sender));
    }
