...
contract KeepRandomBeaconOperator is ReentrancyGuard {
     ...
     */
    function addServiceContract(address serviceContract) public onlyServiceContract {
     ...
     * @param serviceContract Address of the service contract.
     */
    function removeServiceContract(address serviceContract) public onlyServiceContract {
     ...
     */
    function setPriceFeedEstimate(uint256 _priceFeedEstimate) public onlyServiceContract {
     ...
     */
    function createGroup(uint256 _newEntry, address payable submitter) public payable onlyOwner {
     ...
     */
    function setMinimumStake(uint256 _minimumStake) public onlyServiceContract {
    ...
    function relayEntry(bytes memory _groupSignature) public onlyOwner {
     ...
     */
    function withdrawGroupMemberRewards(address operator, uint256 groupIndex, uint256[] memory groupMemberIndices) public onlyOwner {
