...
contract KeepRandomBeaconOperator is ReentrancyGuard {
     ...
     */
    function genesis() public payable onlyOwner {
    ...
    function startGroupSelection(uint256 _newEntry, uint256 _payment) internal onlyOwner {
        require(
     ...
     */
    function submitTicket(bytes32 ticket) public onlyOwner {
