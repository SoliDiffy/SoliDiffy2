...
contract KeepRandomBeaconOperator is ReentrancyGuard {
    ...
    GroupSelection.Storage public groupSelection;
    Groups.Storage public groups;
    DKGResultVerification.Storage public dkgResultVerification;
    ...
    uint256 internal minimumStake = 200000 * 1e18;

    // Each signing group member reward expressed in wei.
    uint256 internal groupMemberBaseReward = 145*1e11; // 14500 Gwei, 10% of operational cost
    ...
    uint256 internal priceFeedEstimate = 20*1e9; // (20 Gwei = 20 * 10^9 wei)
