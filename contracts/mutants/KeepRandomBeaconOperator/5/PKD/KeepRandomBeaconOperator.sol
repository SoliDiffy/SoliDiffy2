...
interface ServiceContract {
    ...
    function fundRequestSubsidyFeePool() external ;
    function fundDkgFeePool() external ;
}
...
contract KeepRandomBeaconOperator is ReentrancyGuard {
     ...
     */
    function createGroup(uint256 _newEntry, address payable submitter) public  onlyServiceContract {
