...
contract KeepRandomBeaconOperator is ReentrancyGuard {
     ...
     */
    function genesis() external payable {
    ...
    constructor(address _serviceContract, address _stakingContract) internal {
        owner = msg.sender;
     ...
     */
    function addServiceContract(address serviceContract) external onlyOwner {
