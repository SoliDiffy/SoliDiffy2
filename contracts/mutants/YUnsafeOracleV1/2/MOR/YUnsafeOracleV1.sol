...
contract YUnsafeOracleV1 is UtilsReady, IYOracle {
  ...
  function setPairOracle(address _pair, address _oracle) external override UtilsReady() {
    pairOracle[_pair] = _oracle;
  }

  function setDefaultOracle(address _defaultOracle) external override UtilsReady() {
    _setOracle(_defaultOracle);
  }
