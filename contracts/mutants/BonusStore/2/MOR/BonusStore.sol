...
contract BonusStore is Active {
    ...
    function setTokenGenerator(ITokenGenerator newGenerator) public activeOnly {
        generator = newGenerator;
    }

    /**@dev Buys specific product for Bonus Tokens. User should first call 'approve' on token contract */
    function buy(IProduct product, string clientId, uint32 units, uint256 currentPrice) ownerOnly {
