...
interface ItAsset {
  ...
  function destinations() external view returns(address destinationOnL2, address fxStateSender);
  ...
  function requestedWithdrawals(address) external view returns(uint256 amount, uint256 minCycle);
