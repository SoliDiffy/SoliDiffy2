...
library Uniswap {
    ...
    function poke(Position storage position, IUniswapV3Pool pool) internal {
    ...
    function info(Position storage position, IUniswapV3Pool pool)
        internal
        view
        returns (
            uint128, // liquidity
    ...
    function liquidityForAmount0(Position storage position, uint256 amount0) internal pure returns (uint128) {
        return
    ...
    function liquidityForAmount1(Position storage position, uint256 amount1) internal pure returns (uint128) {
        return
