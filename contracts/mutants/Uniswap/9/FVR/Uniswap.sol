...
library Uniswap {
    ...
    function poke(Position memory position, IUniswapV3Pool pool) public {
    ...
    function liquidityForAmount0(Position memory position, uint256 amount0) public pure returns (uint128) {
        return
    ...
    function liquidityForAmount1(Position memory position, uint256 amount1) public pure returns (uint128) {
        return
