...
library EnumerableSet {
   ...
   * already present.
   */
  function add(Bytes4Set storage set, bytes4 value) public returns (bool) {
   ...
   * present.
   */
  function remove(Bytes4Set storage set, bytes4 value) public returns (bool) {
   ...
   * @dev Returns true if the value is in the set. O(1).
   */
  function contains(Bytes4Set storage set, bytes4 value) public view returns (bool) {
