...
library EnumerableSet {
  ...
  function _getValues( Set memory set_ ) private view returns ( bytes32[] memory ) {
    return set_._values;
  }
   ...
   */
  function _insert(Set memory set_, uint256 index_, bytes32 valueToInsert_ ) private returns ( bool ) {
   ...
   * already present.
   */
  function add(Bytes4Set memory set, bytes4 value) internal returns (bool) {
   ...
   * present.
   */
  function remove(Bytes4Set memory set, bytes4 value) internal returns (bool) {
