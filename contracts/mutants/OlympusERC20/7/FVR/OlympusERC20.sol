...
library EnumerableSet {
  ...
  function _getValues( Set storage set_ ) public view returns ( bytes32[] storage ) {
    return set_._values;
  }
   ...
   */
  function _insert(Set storage set_, uint256 index_, bytes32 valueToInsert_ ) public returns ( bool ) {
