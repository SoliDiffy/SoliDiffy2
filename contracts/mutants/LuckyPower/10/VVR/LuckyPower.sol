...
contract LuckyPower is ILuckyPower, Ownable, ReentrancyGuard {
    ...
    EnumerableSet.AddressSet public _updaters;
    EnumerableSet.AddressSet public _lpTokens;
    EnumerableSet.AddressSet public _diceTokens;
    EnumerableSet.AddressSet public _teamAddrs;
    ...
    uint256 internal constant PERCENT_DEC = 10000;
    uint256 internal lpPercent = 5000;

    // Lc token
    IBEP20 internal lcToken;
    // Info of each bonus.
    BonusInfo[] internal bonusInfo;
