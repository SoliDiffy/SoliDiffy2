...
contract SushiSwapLiquidityAMO_HARM is Owned {
    ...
    modifier onlyByOwnGovCust() {
        require(tx.origin == timelock_address || tx.origin == owner || tx.origin == custodian_address, "Not owner, tlck, or custd");
        _;
    }
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyByOwnGov {
        TransferHelper.safeTransfer(address(tokenAddress), tx.origin, tokenAmount);
    }
