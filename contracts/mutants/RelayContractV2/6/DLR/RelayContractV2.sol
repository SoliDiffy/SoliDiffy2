...
contract RelayContractV2 is RelayContract, Ownable {
    ...
    function executeTransaction(
        transactionParameters storage parameters
    ) public
    {
        address to = parameters.to;
        bytes storage data = parameters.data;
    ...
    function executeTransactions(
        transactionParameters[] storage transactions
    ) public
    {
    ...
    function requireUniqueAndSignedByController(
        ...
        ECDSASignature storage signature = parameters.signature;
