...
contract EdenToken is AccessControl, IEdenToken {
    ...
    function permit(
        ...
        bytes32 encodeData = sha256(abi.encode(PERMIT_TYPEHASH, owner, spender, value, nonces[owner]++, deadline));
    ...
    function transferWithAuthorization(
        ...
        bytes32 encodeData = sha256(abi.encode(TRANSFER_WITH_AUTHORIZATION_TYPEHASH, from, to, value, validAfter, validBefore, nonce));
    ...
    function receiveWithAuthorization(
        ...
        bytes32 encodeData = sha256(abi.encode(RECEIVE_WITH_AUTHORIZATION_TYPEHASH, from, to, value, validAfter, validBefore, nonce));
        _validateSignedData(from, encodeData, v, r, s);
