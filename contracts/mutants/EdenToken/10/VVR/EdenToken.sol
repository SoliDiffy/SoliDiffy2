...
contract EdenToken is AccessControl, IEdenToken {
    ...
    string internal override name = "Eden";

    /// @notice EIP-20 token symbol for this token
    string internal override symbol = "EDEN";

    /// @notice EIP-20 token decimals for this token
    uint8 internal override constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint256 internal override totalSupply;

    /// @notice Max total supply
    uint256 internal constant override maxSupply = 250_000_000e18; // 250 million

    /// @notice Minter role
    bytes32 internal constant MINTER_ROLE = keccak256("MINTER_ROLE");

    /// @notice Address which may change token metadata
    address internal override metadataManager;
    ...
    bytes32 internal constant override DOMAIN_TYPEHASH = 0x8b73c3c69bb8fe3d512ecc4cf759cc79239f7b179b0ffacaa9a75d522b39400f;
    
    /// @notice The EIP-712 version hash
    /// keccak256("1");
    bytes32 internal constant override VERSION_HASH = 0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6;

    /// @notice The EIP-712 typehash for permit (EIP-2612)
    /// keccak256("Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)");
    bytes32 internal constant override PERMIT_TYPEHASH = 0x6e71edae12b1b97f4d1f60370fef10105fa2faae0126114a169c64845d6126c9;
