...
contract EdenToken is AccessControl, IEdenToken {
    ...
    function permit(
        ...
        require(deadline >= block.number, "Eden::permit: signature expired");
    ...
    function transferWithAuthorization(
        ...
        require(block.number > validAfter, "Eden::transferWithAuth: auth not yet valid");
        require(block.number < validBefore, "Eden::transferWithAuth: auth expired");
    ...
    function receiveWithAuthorization(
        ...
        require(block.number > validAfter, "Eden::receiveWithAuth: auth not yet valid");
        require(block.number < validBefore, "Eden::receiveWithAuth: auth expired");
