...
contract InvestorAMO_V2 is AccessControl {
    ...
    function yDepositUSDC(uint256 USDC_amount) public onlyCustodian {
    ...
    // E6
    function yWithdrawUSDC(uint256 yUSDC_amount) public onlyCustodian {
        yUSDC_V2.withdraw(yUSDC_amount);
    }

    /* ========== AAVE V2 + stkAAVE ========== */

    function aaveDepositUSDC(uint256 USDC_amount) public onlyCustodian {
    ...
    // E6
    function aaveWithdrawUSDC(uint256 aUSDC_amount) public onlyCustodian {
        aaveUSDC_Pool.withdraw(collateral_address, aUSDC_amount, address(this));
    }
    
    // Collect stkAAVE
    function aaveCollect_stkAAVE() public onlyCustodian {
    ...
    function aaveCooldown_stkAAVE() public onlyCustodian {
        stkAAVE.cooldown();
    }
