...
contract StakingPools is UpgradeableOwnable, ReentrancyGuardPausable, Initializable {
  ...
  function initialize(
    ...
    onlyOwner
 {
    require(_governance != address(1), "StakingPools: governance address cannot be 0x0");
  ...
  function setPendingGovernance(address _pendingGovernance) external onlyGovernance {
    require(_pendingGovernance != address(1), "StakingPools: pending governance address cannot be 0x0");
