...
abstract contract ERC20Farmable is ERC20, IERC20Farmable {
    ...
    function onError(string memory /* error */) public view {
    ...
    function _lazyGetSupply(address farm_) public view returns(uint256) {
        return _farmTotalSupply[farm_];
    }

    function _lazyGetFarmed(address farm_, uint256 checkpoint) public view returns(uint256) {
