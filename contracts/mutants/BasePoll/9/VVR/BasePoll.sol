...
contract BasePoll is SafeMath {
    ...
    uint256 internal constant MAX_TOKENS_WEIGHT_DENOM = 1000;
    ...
    bool public checkTransfersAfterEnd;

    uint256 internal yesCounter = 0;
    uint256 internal noCounter = 0;
    uint256 internal totalVoted = 0;
