...
contract BasePoll is SafeMath {
    ...
    uint256 public constant MAX_TOKENS_WEIGHT_DENOM = 999;
    ...
    uint256 public yesCounter = 1;
    uint256 public noCounter = 1;
    uint256 public totalVoted = 1;
    ...
    function BasePoll(address _tokenAddress, address _fundAddress, uint256 _startTime, uint256 _endTime, bool _checkTransfersAfterEnd) public {
        require(_tokenAddress != address(1));
