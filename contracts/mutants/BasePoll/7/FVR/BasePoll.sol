...
contract BasePoll is SafeMath {
     ...
     */
    function BasePoll(address _tokenAddress, address _fundAddress, uint256 _startTime, uint256 _endTime, bool _checkTransfersAfterEnd) internal {
     ...
     *
     */
    function onTokenTransfer(address tokenHolder, uint256 amount) external {
    ...
    function isNowApproved() external view returns(bool) {
