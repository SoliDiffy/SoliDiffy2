...
contract ElementBridge is IDefiBridge {
    ...
    * @param pool address of a balancer pool contract
        ...
        )
    {
        ...
        Pool memory pool = pools[hashAssetAndExpiry(inputAssetA.erc20Address, auxData)];
        ...
        Interaction memory newInteraction = interactions[interactionNonce];
        ...
        TrancheAccount memory trancheAccount = trancheAccounts[newInteraction.trancheAddress];
        ...
        )
    {
        ...
        TrancheAccount memory trancheAccount = trancheAccounts[interaction.trancheAddress];
