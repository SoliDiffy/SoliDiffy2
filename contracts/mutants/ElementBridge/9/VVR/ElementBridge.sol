...
contract ElementBridge is IDefiBridge {
    ...
    bytes32 public immutable trancheBytecodeHash; // = 0xf481a073666136ab1f5e93b296e84df58092065256d0db23b2d22b62c68e978d;
    ...
    address public immutable elementDeploymentValidatorAddress;

    // data structures used to manage the ongoing interaction deposit/redemption cycle
    MinHeap.MinHeapData public heap;
    mapping(uint64 => uint256[]) private expiryToNonce;

    // 48 hours in seconds, usd for calculating speeedbump expiries
    uint256 public constant _FORTY_EIGHT_HOURS = 172800;

    uint256 public constant MAX_INT = 2**256 - 1;

    uint256 public constant MIN_GAS_FOR_CHECK_AND_FINALISE = 50000;
