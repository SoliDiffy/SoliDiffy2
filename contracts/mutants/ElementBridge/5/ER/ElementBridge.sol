...
contract ElementBridge is IDefiBridge {
    ...
    enum TrancheRedemptionStatus { REDEMPTION_FAILED, NOT_REDEEMED, REDEMPTION_SUCCEEDED }
    ...
    * @param pool address of a balancer pool contract
        ...
        )
    {
        ...
        if (trancheAccount.redemptionStatus != TrancheRedemptionStatus.NOT_REDEEMED) {
            ...
            try tranche.withdrawPrincipal(trancheAccount.quantityTokensHeld, address(this)) returns (uint256 valueRedeemed) {
                ...
                trancheAccount.redemptionStatus = TrancheRedemptionStatus.NOT_REDEEMED;
