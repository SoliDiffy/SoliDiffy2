...
contract PooledStaking is MasterAware, IPooledStaking {
  ...
  ) public  whenNotPausedAndInitialized noPendingBurns {
   ...
   */
  function accumulateReward(address contractAddress, uint amount) external  whenNotPausedAndInitialized {
  ...
  function processPendingActions(uint maxIterations) public  returns (bool finished) {
