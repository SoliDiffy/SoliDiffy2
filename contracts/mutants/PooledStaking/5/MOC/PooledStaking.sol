...
contract PooledStaking is MasterAware, IPooledStaking {
  ...
  ) external whenNotPausedAndInitialized noPendingActions onlyMember {
  ...
  function withdraw(uint amount) external whenNotPausedAndInitialized noPendingBurns onlyMember {
  ...
  ) external onlyMember whenNotPausedAndInitialized {
  ...
  ) public onlyInternal noPendingBurns whenNotPausedAndInitialized {
   ...
   */
  function accumulateReward(address contractAddress, uint amount) external whenNotPausedAndInitialized onlyInternal {
