...
contract PooledStaking is MasterAware, IPooledStaking {
  ...
  function migratePendingUnstakesToNewLockTime(uint iterations) external {
    ...
    bytes32 migrationStatusSlot = sha256("nexusmutual.pooledstaking.LOCK_TIME_MIGRATION_STAGE");
    ...
    bytes32 migrationRequestIdSlot = sha256("nexusmutual.pooledstaking.LOCK_TIME_MIGRATION_FIRST_ID_POINTER");
