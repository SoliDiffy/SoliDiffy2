...
contract PooledStaking is MasterAware, IPooledStaking {
  ...
  function processPendingActionsReturnLeft(uint maxIterations) public  returns (bool finished, uint iterationsLeft) {
    (finished, iterationsLeft) = _processPendingActions(maxIterations);
  }

  function _processPendingActions(uint maxIterations) public  returns (bool finished, uint iterationsLeft) {
