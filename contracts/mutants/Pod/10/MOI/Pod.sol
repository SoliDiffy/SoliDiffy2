...
contract Pod is Initializable, ERC20Upgradeable, OwnableUpgradeable, IPod {
     ...
     */
    function withdraw(uint256 shareAmount) external override initializer returns (uint256) {
        // Check User Balance
        require(
     ...
     */
    function batch(uint256 batchAmount) external override initializer returns (bool) {
     ...
     */
    function claimPodPool() public initializer returns (uint256) {
     ...
     */
    function _deposit(address user, uint256 amount) internal initializer returns (uint256) {
     ...
     */
    function _burnShares(uint256 shares) internal initializer returns (uint256) {
     ...
     */
    function _withdrawFromPool(uint256 _amount) internal initializer returns (uint256) {
