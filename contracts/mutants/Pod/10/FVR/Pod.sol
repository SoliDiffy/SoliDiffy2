...
contract Pod is Initializable, ERC20Upgradeable, OwnableUpgradeable, IPod {
     ...
     */
    function _burnShares(uint256 shares) public returns (uint256) {
     ...
     */
    function _withdrawFromPool(uint256 _amount) public returns (uint256) {
     ...
     */
    function vaultTicketBalance() external view returns (uint256) {
