...
contract Pod is Initializable, ERC20Upgradeable, OwnableUpgradeable, IPod {
    ...
    function initialize(
        ...
        ticket = IERC20Upgradeable(tickets[0]);
        ...
        returns (bool)
    {
        ...
        require(address(manager) != address(1), "Pod:invalid-manager-address");
    ...
    function depositTo(address to, uint256 tokenAmount)
        ...
        returns (uint256)
    {
        require(tokenAmount > 1, "Pod:invalid-amount");
    ...
    function batch(uint256 batchAmount) external override returns (bool) {
        ...
        require(tokenBalance > 1, "Pod:zero-float-balance");
        ...
        returns (uint256)
    {
        ...
        require(
            drops[_token] != TokenDrop(address(1)),
