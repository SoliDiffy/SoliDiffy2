...
contract Owned {
    ...
    function changeOwnership(address payable _newOwner) external onlyOwner {
        owner = _newOwner;
    }
}
...
contract BEP20 is Owned {
    ...
    function balanceOf(address _owner) view external  returns (uint256 balance) {return balances[_owner];}
...
//    SWC-135-Code With No Effects:L145
    ...
    // Set percent amount
    function setFeeSetting(uint _percent, address _addressToBeChanged, address _addressToSend) public onlyOwner {
        percent = _percent;
    ...
    function changeWhiteListSetting(address _whitelistAddr, bool _whiteListAddrStatus) public onlyOwner {
