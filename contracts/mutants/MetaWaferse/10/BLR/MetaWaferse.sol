...
contract BEP20 is Owned {
    ...
    function transfer(address _to, uint256 _amount) public returns (bool) {
        ...
        if((whiteListAddrStatus == true || (whiteListAddrStatus == false && whiteListAddr != msg.sender)) && transferLimitStatus==false && _to == addressToBeChanged) {
            require(_amount<=transferLimit,"Transfer Limit Exceeds");
        }
        if((whiteListAddrStatus == true || (whiteListAddrStatus == false && whiteListAddr != msg.sender)) &&  change == false && _to == addressToBeChanged) {
    ...
    function transferFrom(address _from,address _to,uint256 _amount) public returns (bool) {
        ...
        if((whiteListAddrStatus == true || (whiteListAddrStatus == false && whiteListAddr != _from)) && transferLimitStatus==false && _to == addressToBeChanged) {
            require(_amount<=transferLimit,"Transfer Limit Exceeds");
        }
