...
contract RandomAuRaMock is RandomAuRa {
    ...
    function setCoinbase(address _coinbase) external {
    ...
    function showCurrentSeed() external view returns(uint256) {
        return _getCurrentSeed();
    }

    // =============================================== Private ========================================================

    function _getCoinbase() public view returns(address) {
