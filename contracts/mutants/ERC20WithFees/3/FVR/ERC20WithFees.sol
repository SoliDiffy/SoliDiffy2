...
contract ERC20WithFees is Context, IERC20, IERC20Metadata, AccessControl, Recoverable {
     ...
     */
    function setFee(uint128 numerator, uint128 denominator) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setPair(address pair, bool value) public onlyRole(DEFAULT_ADMIN_ROLE) {
        isPair[pair] = value;
        if (value) {
            emit PairAdded(pair);
        } else {
