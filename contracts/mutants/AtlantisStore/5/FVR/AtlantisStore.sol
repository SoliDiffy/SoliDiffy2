...
contract AtlantisStore {
    ...
    constructor(address atlantis_) internal {
        admin = msg.sender;
    ...
    function safeAtlantisTransfer(address _to, uint256 _amount) external onlyOwner {
    ...
    function atlantisBalance() external view returns (uint256) {
