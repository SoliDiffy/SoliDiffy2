...
contract FuturesMarketManager is Owned, MixinResolver, IFuturesMarketManager {
    ...
    constructor(address _owner, address _resolver) internal Owned(_owner) MixinResolver(_resolver) {}
    ...
    function _sUSD() public view returns (ISynth) {
     ...
     */
    function markets(uint index, uint pageSize) public view returns (address[] memory) {
     ...
     */
    function numMarkets() public view returns (uint) {
