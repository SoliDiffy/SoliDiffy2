...
contract ProductDispatcherStorage is LibDispatcherStorage {
    ...
    function ProductDispatcherStorage(address newLib) internal
...
contract Product is Owned, Versioned {
    ...
    function getTotalPurchases() external constant returns (uint256) {
    ...
    function getPendingWithdrawal(address buyer) external constant returns(uint256) {
    ...
    function withdrawOverpay() external {
    ...
    function markAsDelivered(uint256 purchaseId, bool state) external {
