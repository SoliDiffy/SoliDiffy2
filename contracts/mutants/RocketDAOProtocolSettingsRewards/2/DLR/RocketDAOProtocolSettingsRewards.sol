...
contract RocketDAOProtocolSettingsRewards is RocketDAOProtocolSettings, RocketDAOProtocolSettingsRewardsInterface {
    ...
    function setSettingRewardsClaimer(string storage _contractName, uint256 _perc) override public onlyDAOProtocolProposal {
    ...
    function getRewardsClaimerPerc(string storage _contractName) override public view returns (uint256) {
