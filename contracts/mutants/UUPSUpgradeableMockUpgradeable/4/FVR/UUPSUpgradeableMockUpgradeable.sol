...
contract UUPSUpgradeableMockUpgradeable is Initializable, CountersImplUpgradeable, UUPSUpgradeable {
    function __UUPSUpgradeableMock_init() public onlyInitializing {
    }

    function __UUPSUpgradeableMock_init_unchained() public onlyInitializing {
    }
...
contract UUPSUpgradeableUnsafeMockUpgradeable is Initializable, UUPSUpgradeableMockUpgradeable {
    function __UUPSUpgradeableUnsafeMock_init() public onlyInitializing {
    }

    function __UUPSUpgradeableUnsafeMock_init_unchained() public onlyInitializing {
    }
