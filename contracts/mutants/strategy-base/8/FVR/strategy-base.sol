...
abstract contract StrategyBase {
    ...
    function whitelistHarvester(address _harvester) public {
        require(msg.sender == controller ||
             msg.sender == strategist, "not authorized");
        harvesters[_harvester] = true;
    }

    function revokeHarvester(address _harvester) public {
        require(msg.sender == controller ||
             msg.sender == strategist, "not authorized");
        harvesters[_harvester] = false;
    }

    function setWithdrawalDevFundFee(uint256 _withdrawalDevFundFee) public {
        require(msg.sender == strategist, "!strategist");
        withdrawalDevFundFee = _withdrawalDevFundFee;
    }

    function setWithdrawalTreasuryFee(uint256 _withdrawalTreasuryFee) public {
        require(msg.sender == strategist, "!strategist");
        withdrawalTreasuryFee = _withdrawalTreasuryFee;
    }

    function setPerformanceDevFee(uint256 _performanceDevFee) public {
        require(msg.sender == strategist, "!strategist");
