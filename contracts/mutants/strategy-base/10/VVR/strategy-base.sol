...
abstract contract StrategyBase {
    ...
    uint256 internal performanceTreasuryFee = 500;
    uint256 internal constant performanceTreasuryMax = 10000;

    uint256 internal performanceDevFee = 1000;
    uint256 internal constant performanceDevMax = 10000;

    // Withdrawal fee 0%
    // - 0% to treasury
    // - 0% to dev fund
    uint256 internal withdrawalTreasuryFee = 0;
    uint256 internal constant withdrawalTreasuryMax = 100000;

    uint256 internal withdrawalDevFundFee = 0;
    uint256 internal constant withdrawalDevFundMax = 100000;
