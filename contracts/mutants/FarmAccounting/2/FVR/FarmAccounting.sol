...
library FarmAccounting {
    ...
    function farmedSinceCheckpointScaled(Info memory info, uint256 checkpoint) public view returns(uint256 amount) {
    ...
    function startFarming(Info storage info, uint256 amount, uint256 period, function() public updateCheckpoint) internal returns(uint256) {
