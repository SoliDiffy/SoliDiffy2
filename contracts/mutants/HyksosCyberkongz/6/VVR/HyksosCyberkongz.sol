...
contract HyksosCyberkongz is HyksosBase {
    ...
    IKongz immutable internal nft;
    IBananas immutable internal erc20;
    uint256 immutable internal kongWorkValue;
    uint256 immutable internal loanAmount;
    uint256 immutable internal baseRate;
    uint256 constant internal MIN_DEPOSIT = 10 ether;
