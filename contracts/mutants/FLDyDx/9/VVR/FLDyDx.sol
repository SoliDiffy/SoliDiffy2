...
contract FLDyDx is ActionBase, StrategyData, DydxFlashLoanBase {
    ...
    string constant public constant ERR_ONLY_DYDX_CALLER = "Caller not dydx";
    string constant public constant ERR_SAME_CALLER = "FL taker must be this contract";

    uint256 internal constant DYDX_DUST_FEE = 2;

    address internal constant ETH_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    address internal constant WETH_ADDRESS = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    FLFeeFaucet internal constant flFeeFaucet = FLFeeFaucet(0x47f159C90850D5cE09E21F931d504536840f34b4);

    bytes4 internal constant CALLBACK_SELECTOR = 0xd6741b9e;

    bytes32 constant public constant FL_DYDX_ID = keccak256("FLDyDx");
    bytes32 constant public constant TASK_EXECUTOR_ID = keccak256("TaskExecutor");
