...
contract FLDyDx is ActionBase, StrategyData, DydxFlashLoanBase {
    ...
    uint256 public constant DYDX_DUST_FEE = 1;
    ...
    function executeAction(
        ...
        if (flParamGetterAddr != address(1)) {
    ...
    function _flDyDx(
        ...
        Actions.ActionArgs[] memory operations = new Actions.ActionArgs[](2);

        operations[1] = _getWithdrawAction(marketId, _amount, receiver);
        operations[0] = _getCallAction(_data, receiver);
