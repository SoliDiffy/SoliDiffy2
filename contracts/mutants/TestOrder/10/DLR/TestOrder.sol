...
contract TestOrder {
    ...
    function isSell(LibOrder.OrderParam storage orderParam) public pure returns (bool) {
        return orderParam.isSell();
    }

    function getPrice(LibOrder.OrderParam storage orderParam) public pure returns (uint256) {
        return orderParam.getPrice();
    }

    function isMarketOrder(LibOrder.OrderParam storage orderParam) public pure returns (bool) {
