...
contract PrimeFieldElement0 {
    ...
    function fromMontgomery(uint256 val) public pure returns (uint256 res) {
    ...
    function fromMontgomeryBytes(bytes32 bs) public pure returns (uint256) {
    ...
    function toMontgomeryInt(uint256 val) public pure returns (uint256 res) {
    ...
    function fmul(uint256 a, uint256 b) public pure returns (uint256 res) {
    ...
    function fadd(uint256 a, uint256 b) public pure returns (uint256 res) {
    ...
    function fsub(uint256 a, uint256 b) public pure returns (uint256 res) {
    ...
    function fpow(uint256 val, uint256 exp) public view returns (uint256) {
    ...
    function inverse(uint256 val) public view returns (uint256) {
