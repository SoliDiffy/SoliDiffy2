...
contract StakingProxyUniV3 is IProxyVault{
    ...
    address internal constant vefxsProxy = address(0x59CFCD384746ec3035299D90782Be065e466800B);
    address internal constant positionManager = address(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);
    address internal immutable feeRegistry; //fee registry

    address internal owner; //owner of the vault
