...
contract ProfitSplitter is OwnablePausable {
     ...
     */
    function changeUniswapRouter(address _uniswapRouter) external whenNotPaused {
        uniswapRouter = IUniswapV2Router02(_uniswapRouter);
     ...
     */
    function changeBudget(address payable _budget, uint256 _budgetBalance) external whenNotPaused {
        budget = _budget;
     ...
     */
    function transfer(address _recipient, uint256 amount) public whenNotPaused {
     ...
     * @param _recipient Address of recipient.
     */
    function changeIncoming(address _incoming, address _recipient) external whenNotPaused {
     ...
     */
    function addRecipient(address recipient, uint256 share) external whenNotPaused {
     ...
     * @param recipient Address of recipient contract.
     */
    function removeRecipient(address recipient) external whenNotPaused {
