...
contract ProfitSplitter is OwnablePausable {
     ...
     */
    constructor(address _incoming, address _uniswapRouter) internal {
     ...
     */
    function changeUniswapRouter(address _uniswapRouter) public onlyOwner {
        uniswapRouter = IUniswapV2Router02(_uniswapRouter);
     ...
     */
    function changeBudget(address payable _budget, uint256 _budgetBalance) public onlyOwner {
        budget = _budget;
     ...
     * @param _recipient Address of recipient.
     */
    function changeIncoming(address _incoming, address _recipient) public onlyOwner {
     ...
     */
    function _currentShare() public view returns (uint256 result) {
