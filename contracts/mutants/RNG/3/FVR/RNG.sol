...
contract RNG is VRFConsumerBase {
  ...
  */
  function requestBlockRandom(address caller) public authorized {
  ...
  */
  function checkBlockRandom(address caller) public {
  ...
  */
  function getBlockRandom(address caller) public view returns (uint256) {
