...
library BondSize {
    ...
    */
    function updateBondSize(Params storage self, uint128 newBondSize) public {
    ...
    */
    function bondSize(Params memory self) public view returns (uint128) {
    ...
    function validateBondSize(Params memory self, uint128 newBondSize) public view {
