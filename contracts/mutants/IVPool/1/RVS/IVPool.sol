...
interface IVPool {
  ...
  function strategy(address _strategy) external view returns (bool _active, uint256 _debtRatio, uint256 _interestFee, uint256 _debtRate, uint256 _lastRebalance, uint256 _totalDebt, uint256 _totalLoss, uint256 _totalProfit);
