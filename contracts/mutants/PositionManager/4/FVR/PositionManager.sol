...
contract PositionManager is IPositionManager, ERC721Holder {
    ...
    ///@param tokenId ID of the position
    function _setDefaultDataOfPosition(uint256 tokenId) public {
        StorageStruct storage Storage = PositionManagerStorage.getStorage();
    ...
    function _calledFromActiveModule(address _address) public view returns (bool isCalledFromActiveModule) {
        StorageStruct storage Storage = PositionManagerStorage.getStorage();
    ...
    function _calledFromRecipe(address _address) public view returns (bool isCalledFromRecipe) {
        StorageStruct storage Storage = PositionManagerStorage.getStorage();
