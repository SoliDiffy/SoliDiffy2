...
contract PositionManager is IPositionManager, ERC721Holder {
    ...
    function middlewareDeposit(uint256 tokenId) public override onlyWhitelisted {
    ...
    function removePositionId(uint256 tokenId) public override onlyOwnedPosition(tokenId) {
    ...
    function pushPositionId(uint256 tokenId) public override onlyWhitelisted {
    ...
    function toggleModule(
        ...
        bool activated
    ) external override onlyWhitelisted onlyOwnedPosition(tokenId) {
