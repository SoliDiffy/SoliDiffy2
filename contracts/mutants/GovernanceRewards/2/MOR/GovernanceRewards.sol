...
contract GovernanceRewards is RewardDistributionRecipient, BaseGovernanceModule, BalanceAccounting {
    ...
    function _notifyStakeChanged(address account, uint256 newBalance) internal override onlyRewardDistribution {
    ...
    function getReward() external onlyRewardDistribution {
