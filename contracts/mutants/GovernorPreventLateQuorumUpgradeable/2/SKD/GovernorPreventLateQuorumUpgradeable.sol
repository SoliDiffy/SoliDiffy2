...
abstract contract GovernorPreventLateQuorumUpgradeable is Initializable, GovernorUpgradeable {
    ...
    function proposalDeadline(uint256 proposalId) public view virtual override returns (uint256) {
        return MathUpgradeable.max(proposalDeadline(proposalId), _extendedDeadlines[proposalId].getDeadline());
    }
    ...
    function _castVote(
        ...
        uint256 result = _castVote(proposalId, account, support, reason, params);
