...
abstract contract GovernorPreventLateQuorumUpgradeable is Initializable, GovernorUpgradeable {
     ...
     */
    function __GovernorPreventLateQuorum_init(uint64 initialVoteExtension) internal onlyGovernance {
        __GovernorPreventLateQuorum_init_unchained(initialVoteExtension);
    }

    function __GovernorPreventLateQuorum_init_unchained(uint64 initialVoteExtension) internal onlyGovernance {
