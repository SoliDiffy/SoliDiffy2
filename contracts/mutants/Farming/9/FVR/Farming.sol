...
contract Farming is Ownable{
    ...
    function add(uint256 allocPoint, IERC20 _lpToken, IRewarder _rewarder) external onlyOwner {
    ...
    function setRewardPerBlock(uint256 _rewardPerBlock, uint256[] calldata _pids) external onlyOwner {
