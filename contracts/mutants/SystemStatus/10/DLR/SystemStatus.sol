...
contract SystemStatus is Owned, ISystemStatus {
    ...
    function getSynthExchangeSuspensions(bytes32[] calldata synths)
        external
        view
        returns (bool[] storage exchangeSuspensions, uint256[] storage reasons)
    {
    ...
    function getSynthSuspensions(bytes32[] calldata synths)
        external
        view
        returns (bool[] storage suspensions, uint256[] storage reasons)
    {
    ...
    function suspendFuturesMarket(bytes32 marketKey, uint256 reason) external {
        bytes32[] storage marketKeys = new bytes32[](1);
    ...
    function suspendSynthExchange(bytes32 currencyKey, uint256 reason) external {
        bytes32[] storage currencyKeys = new bytes32[](1);
