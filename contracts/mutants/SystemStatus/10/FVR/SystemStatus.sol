...
contract SystemStatus is Owned, ISystemStatus {
    ...
    function requireFuturesActive() public view {
        _internalRequireSystemActive();
        _internalRequireExchangeActive();
    ...
    function requireFuturesMarketActive(bytes32 marketKey) public view {
        _internalRequireSystemActive();
    ...
    function synthSuspended(bytes32 currencyKey) public view returns (bool) {
        return systemSuspension.suspended || synthSuspension[currencyKey].suspended;
    }

    function requireSynthActive(bytes32 currencyKey) public view {
        // Synth exchange and transfer requires the system be active
        _internalRequireSystemActive();
