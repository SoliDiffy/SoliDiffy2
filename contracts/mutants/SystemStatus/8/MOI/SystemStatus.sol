...
contract SystemStatus is Owned, ISystemStatus {
    ...
    function suspendSystem(uint256 reason) external onlyOwner {
    ...
    function suspendIssuance(uint256 reason) external onlyOwner {
    ...
    function suspendExchange(uint256 reason) external onlyOwner {
    ...
    function suspendFutures(uint256 reason) external onlyOwner {
    ...
    function resumeFutures() external onlyOwner {
