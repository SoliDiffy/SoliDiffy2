...
contract SystemStatus is Owned, ISystemStatus {
    ...
    function systemSuspended() public view returns (bool) {
        return systemSuspension.suspended;
    }

    function requireIssuanceActive() public view {
    ...
    function requireExchangeActive() public view {
    ...
    function requireSynthExchangeActive(bytes32 currencyKey) public view {
