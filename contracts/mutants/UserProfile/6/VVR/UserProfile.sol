...
contract UserProfile is InitializableOwner, ERC721Holder, BasicMetaTransaction {
    ...
    EnumerableSet.AddressSet public supportsNFT;
    ...
    bool internal _can_create;
    bool internal _can_withdraw;
    bool internal _can_replace;

    uint internal nicknameMaxLength;
    uint internal nicknameMinLength;
