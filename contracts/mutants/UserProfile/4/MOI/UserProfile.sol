...
contract UserProfile is InitializableOwner, ERC721Holder, BasicMetaTransaction {
    ...
    function _setNickname(address user, string memory nickname) internal onlyOwner {
    ...
    deposite  nft
     */
    function _depositeNFT(address nftAddress, uint256 tokenID) internal onlyOwner {
