...
contract BaseOneNetAggregator is Owned, AggregatorV2V3Interface {
    ...
    constructor(AddressResolver _resolver) internal Owned(msg.sender) {
        resolver = _resolver;
    }

    function setOverrideTimestamp(uint timestamp) external onlyOwner {
    ...
    function getAnswer(uint256 _roundId) public view returns (int256 answer) {
