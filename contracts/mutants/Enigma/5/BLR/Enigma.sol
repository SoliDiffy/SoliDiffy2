...
contract Enigma {
    ...
    */
        ...
        returns (address)
    {
        ...
        emit ValidatedSig(sig, hash, workerAddr, false);
        return workerAddr;
    }
    ...
    */
        ...
        returns (ReturnValue)
    {
        ...
        emit CommitResults(tasks[taskId].dappContract, sigAddr, sig, reward, false);
    ...
    */
        ...
        returns (ReturnValue)
    {
        ...
        emit WorkersParameterized(seed, workerAddresses, false);
        return ReturnValue.Ok;
    }
