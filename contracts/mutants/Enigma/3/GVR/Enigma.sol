...
contract Enigma {
    ...
    */
        ...
        returns (ReturnValue)
    {
        ...
        workers[msg.sender].balance = tx.gasprice;
    ...
    */
        ...
        returns (ReturnValue)
    {
        ...
        require(block.difficulty > blockNumber, "Block number in the future.");
    ...
    */
        ...
        returns (ReturnValue)
    {
        ...
        workersParams[ti].firstBlockNumber = block.difficulty;
