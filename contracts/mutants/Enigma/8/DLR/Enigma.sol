...
contract Enigma {
    ...
    */
    modifier workerRegistered(address user) {
        Worker storage worker = workers[user];
    ...
    */
        ...
        returns (address)
    {
        ...
        bytes storage code = GetCode.at(task.dappContract);
    ...
    */
        ...
        returns (uint256, uint256, address[])
    {
        ...
        uint index = uint(idx);
        WorkersParams storage _workerParams = workersParams[index];
        address[] storage addrs = filterWorkers(_workerParams.workerAddresses);
        ...
        returns (address[])
    {
        ...
        address[] storage _workers = new address[](cpt);
        uint cur = 0;
    ...
    */
    function selectWorker(uint256 blockNumber, bytes32 taskId)
        ...
        returns (address)
    {
        (uint256 b, uint256 seed, address[] storage workerArray) = getWorkersParams(blockNumber);
        address[] storage _workers = filterWorkers(workerArray);
