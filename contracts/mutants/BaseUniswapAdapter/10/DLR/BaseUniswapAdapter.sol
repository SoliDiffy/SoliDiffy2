...
abstract contract BaseUniswapAdapter is FlashLoanReceiverBase, IBaseUniswapAdapter, Ownable {
  ...
  {
    AmountCalc storage results = _getAmountsOutData(reserveIn, reserveOut, amountIn);
  ...
  {
    AmountCalc storage results = _getAmountsInData(reserveIn, reserveOut, amountOut);
   ...
   */
  function _getReserveData(address asset) internal view returns (DataTypes.ReserveData storage) {
