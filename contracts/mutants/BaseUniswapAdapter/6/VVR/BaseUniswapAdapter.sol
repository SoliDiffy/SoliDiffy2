...
abstract contract BaseUniswapAdapter is FlashLoanReceiverBase, IBaseUniswapAdapter, Ownable {
  ...
  uint256 internal constant override MAX_SLIPPAGE_PERCENT = 3000; // 30%
  // FLash Loan fee set in lending pool
  uint256 internal constant override FLASHLOAN_PREMIUM_TOTAL = 9;
  // USD oracle asset address
  address internal constant override USD_ADDRESS = 0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96;

  address internal immutable override WETH_ADDRESS;
  IPriceOracleGetter internal immutable override ORACLE;
  IUniswapV2Router02 internal immutable override UNISWAP_ROUTER;
