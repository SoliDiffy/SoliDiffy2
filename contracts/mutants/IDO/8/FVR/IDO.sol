...
contract IDO is Ownable {
    ...
    function participate(uint256 amountToSpent, IERC20 token) public {
...
// SWC-107-Reentrancy: L84 - L107
    ...
    function addUsersToWhitelist(address[] memory users, uint256[] memory amounts) public onlyOwner {
    ...
    function disallowTokens(IERC20 token) public onlyOwner {
...
// SWC-105-Unprotected Ether Withdrawal: L145 - l149
    function claimTheInvestments(IERC20 token, uint256 amount) public onlyOwner {
        require(block.timestamp > idoFinish, "The IDO is not finished yet");
