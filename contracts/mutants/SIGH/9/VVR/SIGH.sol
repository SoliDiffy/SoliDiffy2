...
contract SIGH is ERC20('SIGH: Simulated yield optimizer','SIGH') {
    ...
    string public _name_ = 'SIGH: Simulated yield optimizer';
    string public _symbol_ = 'SIGH';
    address internal _deployer;
    address internal SpeedController;
    IGlobalAddressesProvider public globalAddressesProvider;

    mapping(address => bool) private blockList;

    uint256 public constant INITIAL_SUPPLY = 5 * 10**5 * 10**18; // 5 Million (with 18 decimals)
    uint256 public prize_amount = 500 * 10**18;

    uint256 public totalAmountBurnt;
    ...
    mintSnapshot[] public mintSnapshots;
