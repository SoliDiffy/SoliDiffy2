...
contract SIGH is ERC20('SIGH: Simulated yield optimizer','SIGH') {
    ...
    function initMinting(address _globalAddressesProvider, address newSpeedController) external returns (bool) {
    ...
    function _initSchedules() public {
    ...
    function blockAnAccount(address _account) public onlySIGHFinanceManager returns (bool) {
    ...
    function unBlockAnAccount(address _account) public onlySIGHFinanceManager returns (bool) {
    ...
    function update(uint deltaBlocks) public onlySIGHFinanceManager returns (bool) {
    ...
    function isMintingPossible() public returns (bool) {
