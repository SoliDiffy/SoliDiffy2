...
contract ProductMaker is Active {
        ...
        activeOnly
    {
        ...
        productStorage.createProduct(tx.origin, price, maxUnits, isActive, startTime, endTime, useEscrow, useFiatPrice, name, data);
    ...
    function createSimpleProductAndVendor(
        ...
        activeOnly
    {
        productStorage.setVendorInfo(tx.origin, wallet, productStorage.getVendorFee(tx.origin));   
