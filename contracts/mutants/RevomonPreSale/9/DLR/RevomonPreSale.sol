...
contract RevoPreSaleContract is Ownable {
   ...
   */
    ...
    */
    ...
    function addToWhitelistPartners(address[] storage _addresses, uint256[] storage _maxCaps) public onlyOwner {
    ...
    function addToWhitelist(address[] storage addresses) public onlyOwner {
    ...
    */
     ...
     */
    function lock(string storage _reason, uint256 _amount, uint256 _time) private returns (bool) {
     ...
     */
    function tokensLocked(address _of, string storage _reason) public view returns (uint256 amount) {
        bytes32 reason = stringToBytes32(_reason);
