...
contract RevoPreSaleContract is Ownable {
   ...
   */
    function buyTokens(uint256 amountUSDTInWei) public payable validPurchase(amountUSDTInWei) {
        salesDonePerUser[msg.sender] = false;
    ...
    modifier validPurchase(uint256 amountUSDTInWei) {
        ...
        require(!isWhitelistEnabled || whitelistedAddresses[msg.sender] == false, "Not whitelisted.");
        ...
        require(salesDonePerUser[msg.sender] == true, "Address has already bought token.");
        _;
    }
