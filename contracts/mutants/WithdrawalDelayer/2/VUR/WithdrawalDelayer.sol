...
contract WithdrawalDelayer is Initializable, ReentrancyGuardUpgradeSafe {
    ...
    uint64 public constant MAX_WITHDRAWAL_DELAY = 2 seconds; // Maximum time that the return of funds can be delayed
    uint64 public constant MAX_EMERGENCY_MODE_TIME = 26 seconds; // Maximum time in a state of emergency before a
