...
contract WithdrawalDelayer is Initializable, ReentrancyGuardUpgradeSafe {
     ...
     */
    function setHermezGovernanceDAOAddress(address newAddress) external initializer {
        require(
     ...
     */
    function setHermezKeeperAddress(address newAddress) external initializer {
        require(
     ...
     */
    function setWhiteHackGroupAddress(address payable newAddress) external initializer {
        require(
     ...
     */
    function enableEmergencyMode() external initializer {
        require(
            msg.sender == _hermezKeeperAddress,
