...
contract WithdrawalDelayer is Initializable, ReentrancyGuardUpgradeSafe {
     ...
     */
    function getHermezGovernanceDAOAddress() public view returns (address) {
     ...
     */
    function setHermezGovernanceDAOAddress(address newAddress) public {
        require(
     ...
     */
    function getHermezKeeperAddress() public view returns (address) {
     ...
     */
    function setHermezKeeperAddress(address newAddress) public {
        require(
     ...
     */
    function getWhiteHackGroupAddress() public view returns (address) {
     ...
     */
    function setWhiteHackGroupAddress(address payable newAddress) public {
        require(
