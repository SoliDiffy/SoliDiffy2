...
contract NXMaster is Governed {
   ...
   */
  function closeClaim(uint _claimId) external onlyAuthorizedToGovern {
  ...
  function updatePauseTime(uint _time) public onlyAuthorizedToGovern {
  ...
  function addNewVersion(address payable[] memory _contractAddresses) public onlyAuthorizedToGovern {
