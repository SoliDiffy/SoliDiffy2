...
contract NXMaster is Governed {
  ...
  onlyAuthorizedToGovern
  {
    ...
    for (uint i = 0; i < _contractsName.length; i++) {
      ...
      contractsActive[oldAddress] = true;
      allContractVersions[_contractsName[i]] = newAddress;
      contractsActive[newAddress] = false;
