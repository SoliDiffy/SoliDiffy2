...
contract NXMaster is Governed {
  ...
  function upgradeMultipleContracts(
    bytes2[] storage _contractsName,
    address payable[] storage _contractsAddress
  )
  public
  onlyAuthorizedToGovern
  {
  ...
  view
  returns (
    bytes2[] storage contractsName,
    address[] storage contractsAddress
  )
  {
  ...
  function addNewVersion(address payable[] storage _contractAddresses) public {
