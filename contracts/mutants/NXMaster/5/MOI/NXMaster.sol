...
contract NXMaster is Governed {
   ...
   */
  function _generateProxy(address _implementationAddress) internal onlyAuthorizedToGovern returns (address) {
  ...
  function _changeAllAddress() internal onlyAuthorizedToGovern {
    for (uint i = 0; i < allContractNames.length; i++) {
