...
contract TransferLimitedToken is ManagedToken {
    ...
    function transfer(address _to, uint256 _value) public onlyManager returns (bool) {
        return super.transfer(_to, _value);
    }

    function transferFrom(address _from, address _to, uint256 _value) public onlyManager returns (bool) {
        return super.transferFrom(_from, _to, _value);
    }

    function approve(address _spender, uint256 _value) public onlyManager returns (bool) {
