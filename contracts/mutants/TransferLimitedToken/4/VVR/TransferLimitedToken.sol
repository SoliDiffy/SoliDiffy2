...
contract TransferLimitedToken is ManagedToken {
    uint256 internal constant LIMIT_TRANSFERS_PERIOD = 365 days;

    mapping(address => bool) public limitedWallets;
    uint256 internal limitEndDate;
    address internal limitedWalletsManager;
    bool internal isLimitEnabled;
