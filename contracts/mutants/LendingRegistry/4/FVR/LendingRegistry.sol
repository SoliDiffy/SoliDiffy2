...
contract LendingRegistry is Ownable {
    ...
    */
    function setWrappedToProtocol(address _wrapped, bytes32 _protocol) onlyOwner public {
    ...
    */
    function setWrappedToUnderlying(address _wrapped, address _underlying) onlyOwner public {
    ...
    */
    function setProtocolToLogic(bytes32 _protocol, address _logic) onlyOwner public {
    ...
    /**
        ...
        @param _wrapped Address of the wrapped token
    */
    function setUnderlyingToProtocolWrapped(address _underlying, bytes32 _protocol, address _wrapped) onlyOwner public {
