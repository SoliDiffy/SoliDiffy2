...
contract LendingRegistry is Ownable {
    ...
    */
    function getLendTXData(address _underlying, uint256 _amount, bytes32 _protocol) public view returns(address[] memory targets, bytes[] memory data) {
    ...
    /**
        ...
        @return data Calldata for the calls
    */
    function getUnlendTXData(address _wrapped, uint256 _amount) public view returns(address[] memory targets, bytes[] memory data) {
