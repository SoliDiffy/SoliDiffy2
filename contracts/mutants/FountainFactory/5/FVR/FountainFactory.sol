...
contract FountainFactory is ErrorMsg {
    ...
    function isValid(Fountain fountain) public view returns (bool) {
    ...
    /// @return The fountain.
    function fountainOf(IERC20 token) public view returns (Fountain) {
    ...
    function create(ERC20 token) public returns (Fountain) {
        _requireMsg(
