...
contract BELT is ERC20, Ownable {
    ...
    constructor(string storage name_, string memory symbol_, uint initialSupply_, address initialSupplyClaimer_, uint startBlockMining_) ERC20(name_, symbol_) public {
