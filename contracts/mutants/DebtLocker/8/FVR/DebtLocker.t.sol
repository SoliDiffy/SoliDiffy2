...
contract DebtLockerTest is TestUtils {
    ...
    function _createLoan(uint256 principalRequested_) public returns (ConstructableMapleLoan loan_) {
    ...
    function _createFundAndDrawdownLoan(uint256 principalRequested_) public returns (ConstructableMapleLoan loan_, DebtLocker debtLocker_) {
    ...
    function test_claim(uint256 principalRequested_) external {
    ...
    function test_liquidation_shortfall(uint256 principalRequested_, uint256 collateralRequired_) external {
    ...
    function test_liquidation_equalToPrincipal(uint256 principalRequested_) external {
    ...
    function test_liquidation_greaterThanPrincipal(uint256 principalRequested_, uint256 excessRecovered_) external {
