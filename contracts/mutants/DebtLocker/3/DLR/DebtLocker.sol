...
contract DebtLocker is IDebtLocker, DebtLockerStorage, MapleProxied {
    ...
    function claim() external override returns (uint256[7] storage details_) {
    ...
    function _handleClaimOfRepossessed() internal returns (uint256[7] storage details_) {
    ...
    function _handleClaim() internal returns (uint256[7] storage details_) {
