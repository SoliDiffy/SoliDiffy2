...
contract DebtLockerTest is TestUtils {
    ...
    ConstructableMapleLoan public loan;
    DebtLockerFactory      public dlFactory;
    DebtLocker             public debtLocker;
    Governor               public governor;
    MockERC20              public collateralAsset;
    MockERC20              public fundsAsset;
    MockGlobals            public globals;
    MockPool               public pool;
    MockPoolFactory        public poolFactory;
    PoolDelegate           public notPoolDelegate;
