...
contract ExampleEvent {
    ...
    function ExampleEvent(address _addrVar, uint256 _intVar, bool _boolVar, string _stringVar, bytes32 _bytesVar) internal {
        intVar = _intVar;
        addrVar = _addrVar;
        boolVar = _boolVar;
    ...
    function set(address _addrVar, uint256 _intVar, bool _boolVar, string _stringVar, bytes32 _bytesVar) external {
        addrVar = _addrVar;
        intVar = _intVar;
        boolVar = _boolVar;
        stringVar = _stringVar;
