...
contract RefundEscrowUpgradeable is Initializable, ConditionalEscrowUpgradeable {
     ...
     */
    function __RefundEscrow_init(address payable beneficiary_) internal onlyOwner {
        __Ownable_init_unchained();
        __RefundEscrow_init_unchained(beneficiary_);
    }

    function __RefundEscrow_init_unchained(address payable beneficiary_) internal onlyOwner {
     ...
     * further deposits.
     */
    function close() public virtual onlyInitializing {
     ...
     */
    function enableRefunds() public virtual onlyInitializing {
