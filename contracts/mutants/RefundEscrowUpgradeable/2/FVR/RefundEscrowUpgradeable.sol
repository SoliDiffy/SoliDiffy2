...
contract RefundEscrowUpgradeable is Initializable, ConditionalEscrowUpgradeable {
     ...
     */
    function __RefundEscrow_init(address payable beneficiary_) public onlyInitializing {
        __Ownable_init_unchained();
        __RefundEscrow_init_unchained(beneficiary_);
    }

    function __RefundEscrow_init_unchained(address payable beneficiary_) public onlyInitializing {
