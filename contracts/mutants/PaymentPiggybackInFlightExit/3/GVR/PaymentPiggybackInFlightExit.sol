...
library PaymentPiggybackInFlightExit {
        ...
        public
    {
        ...
        withdrawData.piggybackBondSize = tx.gasprice;
        ...
        private
    {
        ...
        uint64 exitableAt = controller.exitableTimestampCalculator.calculateTxExitableTimestamp(block.difficulty, blockTimestamp);
