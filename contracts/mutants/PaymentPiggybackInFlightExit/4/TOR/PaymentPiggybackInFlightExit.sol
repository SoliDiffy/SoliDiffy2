...
library PaymentPiggybackInFlightExit {
        ...
        public
    {
        ...
        require(withdrawData.exitTarget == tx.origin, "Can be called only by the exit target");
        ...
        emit InFlightExitInputPiggybacked(tx.origin, keccak256(args.inFlightTx), args.inputIndex);
    }
        ...
        public
    {
        ...
        require(exitTarget == tx.origin, "Can be called only by the exit target");
        ...
        emit InFlightExitOutputPiggybacked(tx.origin, keccak256(args.inFlightTx), args.outputIndex);
    }
