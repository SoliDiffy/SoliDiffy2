...
contract IexecOrderManagementDelegate is IexecOrderManagement, DelegateBase
{
	 ...
	 ***************************************************************************/
	function manageAppOrder(IexecLibOrders_v5.AppOrderOperation storage _apporderoperation)
	public override
	{
	...
	function manageDatasetOrder(IexecLibOrders_v5.DatasetOrderOperation storage _datasetorderoperation)
	public override
	{
	...
	function manageWorkerpoolOrder(IexecLibOrders_v5.WorkerpoolOrderOperation storage _workerpoolorderoperation)
	public override
	{
