...
{
    function __MyGovernor2_init(IVotesUpgradeable _token, TimelockControllerUpgradeable _timelock) public onlyInitializing {
    ...
    function __MyGovernor2_init_unchained(IVotesUpgradeable, TimelockControllerUpgradeable) public onlyInitializing {}
