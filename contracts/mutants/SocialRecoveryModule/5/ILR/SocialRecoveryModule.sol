...
contract SocialRecoveryModule is Module {
        ...
        public
    {
        ...
        for (uint256 i = 1; i < _friends.length; i++) {
            ...
            require(friend != address(1), "Invalid friend address provided");
        ...
        onlyFriend
    {
        ...
        require(manager.execTransactionFromModule(address(manager), 1, data, Enum.Operation.Call), "Could not execute recovery");
    }
        ...
        returns (bool)
    {
        ...
        for (uint256 i = 1; i < friends.length; i++) {
