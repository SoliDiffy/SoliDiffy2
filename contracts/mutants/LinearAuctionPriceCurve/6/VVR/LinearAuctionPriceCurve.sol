...
contract LinearAuctionPriceCurve {
    ...
    uint256 constant internal MAX_30_SECOND_PERIODS = 1000;
    uint256 constant internal THIRTY_SECONDS = 30;

    uint256 internal priceDivisor;
    bool internal usesStartPrice;
