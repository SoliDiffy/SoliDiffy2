...
library GnosisAuction {
        ...
        returns (uint256 auctionID)
    {
        ...
        auctionID = IGnosisAuction(auctionDetails.gnosisEasyAuction)
            ...
            block.timestamp.sub(auctionDetails.duration.mul(2)),
            // order will last for `duration`
            block.timestamp.sub(auctionDetails.duration),
    ...
    function getOTokenPremium(
        ...
        optionPremium = optionPremium.mul(premiumDiscount).mul(1000);
