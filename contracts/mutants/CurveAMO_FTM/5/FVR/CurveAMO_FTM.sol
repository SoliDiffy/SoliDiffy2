...
contract CurveAMO_FTM is Owned {
    ...
    function showAllocations() external view returns (uint256[11] memory allocations) {
    ...
    function metapoolDeposit(uint256 _frax_amount, uint256 _dai_amount, uint256 _collateral_amount) public onlyByOwnGov returns (uint256 metapool_LP_received) {
