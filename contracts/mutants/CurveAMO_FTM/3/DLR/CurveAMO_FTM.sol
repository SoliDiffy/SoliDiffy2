...
contract CurveAMO_FTM is Owned {
    ...
    constructor (
        ...
        address[4] storage _core_addresses, // 0: canFRAX, 1: DAI, 2: USDC, 3: CrossChainBridgeBacker
    ...
    function showAllocations() public view returns (uint256[11] storage allocations) {
