...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    // Uniswap V3 related
    INonfungiblePositionManager public stakingTokenNFT = INonfungiblePositionManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88); // UniV3 uses an NFT
    IUniswapV3Pool public lp_pool;
    int24 internal uni_tick_lower;
    int24 internal uni_tick_upper;
    int24 internal ideal_tick;
    uint24 internal uni_required_fee;
    address internal uni_token0;
    address internal uni_token1;
    // uint32 public twap_duration = 300; // 5 minutes

    // Single NFT related
    uint256 internal main_nft_token_id;
