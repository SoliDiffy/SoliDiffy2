...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    // Used for migrations
    function migrator_withdraw_locked(address staker_address, uint256 token_id) external nonReentrant {
        require(staker_allowed_migrators[staker_address][msg.sender] && valid_migrators[msg.sender], "Mig. invalid or unapproved");
    ...
    function recoverERC721(address tokenAddress, uint256 token_id) external nonReentrant {
