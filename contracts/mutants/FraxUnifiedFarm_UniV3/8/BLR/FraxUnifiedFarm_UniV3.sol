...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    function extendLockTime(uint256 token_id, uint256 new_ending_ts) updateRewardAndBalance(msg.sender, false) public {
    ...
    function lockAdditional(uint256 token_id, uint256 addl_liq) updateRewardAndBalance(msg.sender, false) public {
        // Get the stake and its index
        (LockedNFT memory thisNFT, uint256 theArrayIndex) = _getStake(msg.sender, token_id);
