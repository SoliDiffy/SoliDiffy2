...
contract ServiceProviderFactory is InitializableV2 {
    ...
    external view returns (address owner, string storage endpoint, uint blockNumber, address delegateOwnerWallet)
    {
        ServiceEndpoint storage sp = serviceProviderInfo[_serviceType][_serviceId];
