...
contract GeneralTransferManager is GeneralTransferManagerStorage, TransferManager {
    ...
    */
    ...
    function _processTransferSignature(uint256 _nonce, uint256 _validFrom, uint256 _validTo, bytes storage _data) internal {
        address[] storage investor;
        uint256[] storage canSendAfter;
        uint256[] storage canReceiveAfter;
        uint256[] storage expiryTime;
