...
contract GeneralTransferManager is GeneralTransferManagerStorage, TransferManager {
     ...
     */
    function changeDefaults(uint64 _defaultCanSendAfter, uint64 _defaultCanReceiveAfter) external withPerm(ADMIN) {
     ...
     */
    function changeIssuanceAddress(address _issuanceAddress) external withPerm(ADMIN) {
    ...
    */
    ...
    function _processTransferSignature(uint256 _nonce, uint256 _validFrom, uint256 _validTo, bytes memory _data) public {
    ...
    */
    ...
    function _getKYCDataValues(address _target) public view returns (uint64 canSendAfter, uint64 fromExpiry) {
