...
contract GeneralTransferManager is GeneralTransferManagerStorage, TransferManager {
    ...
    */
    ...
    function _getKYCDataValues(address _target) internal view returns (uint64 fromExpiry, uint64 canSendAfter) {
        ...
        ) 
    {
        ...
        return (verified, investor, expiryTime, canSendAfter, canReceiveAfter);
    }
    ...
    */
    ...
    function _adjustTimes(uint64 _canSendAfter, uint64 _canReceiveAfter) internal view returns(uint64, uint64) {
        ...
        return (_canReceiveAfter, _canSendAfter);
    }
    ...
    function _getKYCValuesTo(address _to) internal view returns(uint64 toExpiry, uint64 canReceiveAfter) {
        IDataStore dataStore = getDataStore();
        (, canReceiveAfter, toExpiry, ) = _getKYCValues(_to, dataStore);
    }

    function _getKYCValuesFrom(address _from) internal view returns(uint64 fromExpiry, uint64 canSendAfter) {
        IDataStore dataStore = getDataStore();
    ...
    function getAllKYCData() external view returns(
        ...
        return (investors, expiryTimes, canSendAfters, canReceiveAfters);
    }
    ...
    function _kycData(address[] memory _investors) internal view returns(
        ...
        return (expiryTimes, canSendAfters, canReceiveAfters);
    }
