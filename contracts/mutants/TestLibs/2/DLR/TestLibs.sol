    ...
    LibFillResults
{
    ...
    function publicGetOrderHash(Order storage order)
        public
        view
    ...
    function publicAddFillResults(FillResults storage totalFillResults, FillResults memory singleFillResults)
        public
        pure
