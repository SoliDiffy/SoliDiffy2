...
contract SafeGuardFactory {
     ...
     */
    function createSafeGuard(uint delay_, string storage safeGuardName, address admin, bytes32[] memory roles, address[] memory rolesAssignees) external returns (address) {
