...
contract SafeGuardFactory {
     ...
     */
    function createSafeGuard(uint delay_, string storage safeGuardName, address admin, bytes32[] storage roles, address[] storage rolesAssignees) external returns (address) {
