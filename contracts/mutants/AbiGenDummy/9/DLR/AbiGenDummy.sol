...
contract AbiGenDummy
{
    ...
    {
        bytes storage prefix = "\x19Ethereum Signed Message:\n32";
    ...
    function acceptsBytes(bytes storage a) public pure {}

    /// @dev a method that accepts an array of bytes
    /// @param a the array of bytes being accepted
    function acceptsAnArrayOfBytes(bytes[] storage a) public pure {}
    ...
    function structInput(Struct storage s) public pure {}

    /// @dev a method that returns a struct
    /// @return a Struct struct
    function structOutput() public pure returns(Struct storage s) {
        bytes[] storage byteArray = new bytes[](2);
        byteArray[0] = "0x123";
        byteArray[1] = "0x321";
    ...
    function methodReturningArrayOfStructs() public pure returns(Struct[] storage) {}
    ...
    function nestedStructInput(NestedStruct storage n) public pure {}
    function nestedStructOutput() public pure returns(NestedStruct storage) {}
