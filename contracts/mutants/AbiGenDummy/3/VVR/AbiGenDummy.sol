...
contract AbiGenDummy
{
    ...
    uint256 constant public SOME_CONSTANT = 1234;
    string constant public REVERT_REASON = "REVERT_WITH_CONSTANT";
    string constant public REQUIRE_REASON = "REQUIRE_WITH_CONSTANT";
