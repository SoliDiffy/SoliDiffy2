...
contract HoldefiSettings is Ownable {
	...
	uint constant internal ratesDecimal = 10 ** 4;

	uint constant internal secondsPerTenDays = 864000;

	uint constant internal maxBorrowRate = 4000;				  //40%

	uint constant internal borrowRateMaxIncrease = 500;		  //5%

	uint constant internal minSuppliersShareRate = 5000;		  //50%

	uint constant internal suppliersShareRateMaxDecrease = 500; //5%

	uint constant internal maxValueToLoanRate = 20000; 		  //200%

	uint constant internal valueToLoanRateMaxIncrease = 500;	  //5%

	uint constant internal maxPenaltyRate = 13000; 			  //130%
