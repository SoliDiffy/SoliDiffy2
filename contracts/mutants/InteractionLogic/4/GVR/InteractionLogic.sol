...
library InteractionLogic {
    ...
    function follow(
        ...
        for (uint256 i = 0; i < profileIds.length; i++) {
            ...
            if (followNFT == address(0)) {
                ...
                emit Events.FollowNFTDeployed(profileIds[i], followNFT, block.number);
            }
        ...
        emit Events.Followed(follower, profileIds, block.number);
    }
    ...
    function collect(
        ...
        if (collectNFT == address(0)) {
            ...
            emit Events.CollectNFTDeployed(rootProfileId, rootPubId, collectNFT, block.number);
        }
