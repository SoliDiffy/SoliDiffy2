...
contract AlpacaFeeder is IVault, Initializable, OwnableUpgradeable {
  ...
  function fairLaunchDeposit() public onlyOwner {
  ...
  function fairLaunchWithdraw() public onlyOwner {
  ...
  function fairLaunchHarvest() public {
    _fairLaunchHarvest();
  }

  /// @notice Receive reward from FairLaunch
  function _fairLaunchHarvest() public {
