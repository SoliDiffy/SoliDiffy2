...
contract ExchangeWrapperMock is IExchangeWrapper, DecimalERC20 {
    ...
    function mockSetSwapRatio(Decimal.decimal memory _ratio) external {
        exchangeRatio = _ratio;
    }

    function mockSpotPrice(Decimal.decimal memory _price) external {
        spotPrice = _price;
    }

    function mockSetException() external {
        bException = true;
    }
