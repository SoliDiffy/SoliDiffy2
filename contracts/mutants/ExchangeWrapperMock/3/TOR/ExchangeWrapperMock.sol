...
contract ExchangeWrapperMock is IExchangeWrapper, DecimalERC20 {
    ...
    function swapInput(
        ...
        _transferFrom(inputToken, tx.origin, address(this), inputTokenSold);
        _transfer(outputToken, tx.origin, inputTokenSold.divD(exchangeRatio));
    ...
    function swapOutput(
        ...
        _transferFrom(inputToken, tx.origin, address(this), outputTokenBought.mulD(exchangeRatio));
