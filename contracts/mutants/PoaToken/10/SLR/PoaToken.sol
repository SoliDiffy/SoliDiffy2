...
contract PoaToken is PausableToken {
  ...
  {
    bytes4 _sig = bytes4(keccak256(""));
    address _exchangeRates = getContractAddress("");
  ...
  {
    bytes4 _sig = bytes4(keccak256(""));
    address _whitelistContract = getContractAddress("");
