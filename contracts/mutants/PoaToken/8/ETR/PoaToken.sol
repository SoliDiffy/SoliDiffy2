...
contract PoaToken is PausableToken {
    ...
    private
  {
    ...
    getContractAddress("Logger").delegatecall(
    ...
    returns (bool)
  {
    ...
    getContractAddress("Logger").delegatecall(bytes4(keccak256("logProofOfCustodyUpdatedEvent()")));
    ...
    returns (bool)
  {
    ...
    getContractAddress("Logger").delegatecall(bytes4(keccak256("logTerminatedEvent()")));
    return true;
  }
