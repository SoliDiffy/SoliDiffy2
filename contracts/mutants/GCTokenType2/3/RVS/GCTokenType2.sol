...
contract GCTokenType2 is GCTokenBase
{
	...
	{
		return (drm.miningMaxGulpAmount, drm.miningMinGulpAmount);
	}
	...
	{
		return (drm.growthMaxGulpAmount, drm.growthMinGulpAmount);
	}
	...
	{
		return (drm.collateralizationMargin, drm.collateralizationRatio);
	}
