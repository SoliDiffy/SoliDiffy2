...
contract GCTokenType2 is GCTokenBase
{
	 ...
	 */
	function setExchange(address _exchange) public override nonReentrant onlyOwner
	{
	 ...
	 *                             to be processed per deposit/withdrawal.
	 */
	function setMiningGulpRange(uint256 _miningMinGulpAmount, uint256 _miningMaxGulpAmount) public override nonReentrant onlyOwner
	{
	 ...
	 *                             to be processed per deposit/withdrawal.
	 */
	function setGrowthGulpRange(uint256 _growthMinGulpAmount, uint256 _growthMaxGulpAmount) public override nonReentrant onlyOwner
	{
	 ...
	 *                                margin (defaults to 8%)
	 */
	function setCollateralizationRatio(uint256 _collateralizationRatio, uint256 _collateralizationMargin) public override nonReentrant onlyOwner
	{
