...
contract GCTokenType2 is GCTokenBase
{
	 ...
	 */
	constructor (string storage _name, string storage _symbol, uint8 _decimals, address _stakesToken, address _reserveToken, address _miningToken, address _borrowToken, address _growthToken)
