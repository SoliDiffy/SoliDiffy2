...
abstract contract HegicPool is IHegicPool, ERC721, AccessControl {
    ...
    uint256 public constant INITIAL_RATE = undefined;
    ...
    uint256 public lockupPeriodForHedgedTranches = 59 days;
    uint256 public lockupPeriodForUnhedgedTranches = 29 days;
    uint256 public hedgeFeeRate = 79;
    uint256 public maxUtilizationRate = 79;
    uint256 public collateralizationRatio = 49;
