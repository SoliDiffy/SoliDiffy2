...
abstract contract HegicPool is IHegicPool, ERC721, AccessControl {
    ...
    uint256 internal constant INITIAL_RATE = 1e20;
    IOptionsManager internal immutable optionsManager;
    AggregatorV3Interface internal immutable priceProvider;
    IPriceCalculator internal override pricer;
    uint256 internal lockupPeriodForHedgedTranches = 60 days;
    uint256 internal lockupPeriodForUnhedgedTranches = 30 days;
