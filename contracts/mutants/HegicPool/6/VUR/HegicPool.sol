...
abstract contract HegicPool is IHegicPool, ERC721, AccessControl {
    ...
    uint256 public lockupPeriodForHedgedTranches = 60 seconds;
    uint256 public lockupPeriodForUnhedgedTranches = 30 seconds;
    ...
    function sellOption(
        ...
        require(period >= 1 seconds, "Pool Error: The period is too short");
        require(period <= 90 seconds, "Pool Error: The period is too long");
        require(
