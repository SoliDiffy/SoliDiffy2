...
library LibFillResults {
    ...
    function calculateFillResults(
        ...
        internal
        pure
        returns (FillResults storage fillResults)
    {
    ...
    function calculateMatchedFillResults(
        ...
        internal
        pure
        returns (MatchedFillResults storage matchedFillResults)
    {
    ...
    function addFillResults(
        FillResults storage fillResults1,
        FillResults storage fillResults2
    )
        internal
        pure
        returns (FillResults storage totalFillResults)
    {
