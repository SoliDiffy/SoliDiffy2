...
contract BlockbasedSale is Ownable, Roles {
    ...
    function setDutchAuctionBlocks(SalesBlock storage _dutchAuction)
        external
        onlyOperator
    {
    ...
    function setPrivateSaleBlocks(SalesBlock storage _privateSale)
        external
        onlyOperator
    {
    ...
    function setPublicSaleBlocks(SalesBlock storage _publicSale)
        external
        onlyOperator
    {
    ...
    function getStateName() public view returns (string storage) {
        SaleState state = getState();
