...
contract BlockbasedSale is Ownable, Roles {
    ...
    SalesBlock internal dutchAuction;
    SalesBlock internal privateSale;
    SalesBlock internal publicSale;

    OverrideSaleState internal overridedSaleState = OverrideSaleState.None;
    SalePhase internal salePhase = SalePhase.None;

    DutchAuctionConfig internal dutchAuctionConfig;
    SaleStats internal saleStats;
    SaleConfig internal saleConfig;

    uint256 internal maxSupply;
    uint256 internal maxReserve;
