...
contract MultiTokenForwardingRulesConnector is Ownable {
     ...
     */
    function setForwardingRulesManager(address _manager) public onlyOwner {
     ...
     */
    function forwardingRulesManager() external view returns (MultiTokenForwardingRulesManager) {
     ...
     * @param _manager address of forwarding rules manager contract.
     */
    function _setForwardingRulesManager(address _manager) public {
