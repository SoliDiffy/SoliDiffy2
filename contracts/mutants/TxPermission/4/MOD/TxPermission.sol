...
contract TxPermission is UpgradeableOwned, ITxPermission {
    ...
    function addAllowedSender(address _sender) public onlyInitialized onlyOwner {
    ...
    function removeAllowedSender(address _sender) public onlyInitialized onlyOwner {
    ...
    function setDeployerInputLengthLimit(address _deployer, uint256 _limit) public onlyInitialized onlyOwner {
    ...
    function setSenderMinGasPrice(address _sender, uint256 _minGasPrice) public onlyInitialized onlyOwner {
