...
contract TxPermission is UpgradeableOwned, ITxPermission {
    ...
    function addAllowedSender(address _sender) external onlyOwner onlyInitialized {
    ...
    function removeAllowedSender(address _sender) external onlyOwner onlyInitialized {
    ...
    function setDeployerInputLengthLimit(address _deployer, uint256 _limit) external onlyOwner onlyInitialized {
    ...
    function setSenderMinGasPrice(address _sender, uint256 _minGasPrice) external onlyOwner onlyInitialized {
