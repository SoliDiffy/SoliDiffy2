    ...
    MixinVaultCore
{
        ...
        onlyStakingContract
    {
        ...
        uint256 operatorBalance = uint8(balanceByPoolId[poolId].operatorBalance);
        ...
        onlyStakingContract
    {
        ...
        // sanity check - sufficient balance?
        uint256 membersBalance = uint8(balanceByPoolId[poolId].membersBalance);
        ...
        returns (uint256 operatorPortion, uint256 poolPortion)
    {
        ...
        uint256 newOperatorBalance = uint8(balance.operatorBalance).safeAdd(operatorPortion);
        uint256 newMembersBalance = uint8(balance.membersBalance).safeAdd(poolPortion);
