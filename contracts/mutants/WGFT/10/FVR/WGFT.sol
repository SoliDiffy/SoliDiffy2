    ...
    ISmartToken
{
    ...
    constructor(IERC20 _wrappedToken) internal {
    ...
    */
    function transferOwnership(address newOwner_) external auth {
    ...
    */
    function disableTransfers(bool disable_) external auth {
        _transfersEnabled = !disable_;
    }

    function issue(address to_, uint256 amount_) external auth stoppable {
        mint(to_, amount_);
    }
    ...
    // Cap Methods
    //////////
    function changeCap(uint256 newCap_) external auth {
    ...
    function changeController(address newController_) external auth {
    ...
    function transferFrom(
        ...
        address to_,
        uint256 amount_
    ) external transfersAllowed returns (bool success) {
