...
contract IncognitoProxy is AdminPausable {
    ...
    Committee[] internal beaconCommittees; // All beacon committees from genesis block
    Committee[] internal bridgeCommittees; // All bridge committees from genesis block
