...
contract IncognitoProxy is AdminPausable {
     ...
     */
    function getBeaconCommittee(uint i) external view returns(Committee memory) {
     ...
     */
    function getBridgeCommittee(uint i) external view returns(Committee memory) {
     ...
     */
    function findBeaconCommitteeFromHeight(uint blkHeight) external view returns (address[] memory, uint) {
        uint l = 0;
