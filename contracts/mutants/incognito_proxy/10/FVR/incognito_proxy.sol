...
contract IncognitoProxy is AdminPausable {
     ...
     */
    function findBridgeCommitteeFromHeight(uint blkHeight) external view returns (address[] memory, uint) {
        uint l = 0;
     ...
     */
    function extractMetaFromInstruction(bytes memory inst) external pure returns(uint8, uint8, uint, uint) {
