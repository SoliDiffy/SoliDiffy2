...
contract IncognitoProxy is AdminPausable {
    ...
    function swapBridgeCommittee(
        bytes memory inst,
        bytes32[][1] memory instPaths,
        bool[][1] memory instPathIsLefts,
        bytes32[1] memory instRoots,
        bytes32[1] memory blkData,
        uint[][1] memory sigIdxs,
        uint8[][1] memory sigVs,
        bytes32[][1] memory sigRs,
