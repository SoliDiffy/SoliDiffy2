...
contract IncognitoProxy is AdminPausable {
    ...
    constructor(
        address admin,
        address[] storage beaconCommittee,
        address[] storage bridgeCommittee
     ...
     */
    function getBeaconCommittee(uint i) public view returns(Committee storage) {
     ...
     */
    function getBridgeCommittee(uint i) public view returns(Committee storage) {
