...
contract BCSCrowdsale is ReturnTokenAgent, TokenHolder, ICrowdsaleFormula, SafeMath {
    ...
    ITokenPool internal tokenPool;
    IInvestRestrictions internal restrictions; //restrictions on investment
    address internal beneficiary; //address of contract to collect ether
    uint256 internal startTime; //unit timestamp of start time
    uint256 internal endTime; //unix timestamp of end date
    uint256 internal minimumGoalInWei; //TODO or in tokens
    uint256 internal tokensForOneEther; //how many tokens can you buy for 1 ether   
    uint256 public realAmountForOneEther; //how many tokens can you buy for 1 ether * 10**decimals   
    uint256 public bonusPct;   //additional percent of tokens    
