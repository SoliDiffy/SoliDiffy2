...
contract PumaPayPullPaymentV2 is PayableOwnable {
    ...
    function registerPullPayment(
        ...
        bytes32 r,
        bytes32 s,
        bytes32[4] storage _paymentDetails, // 0 paymentID, 1 businessID, 2 uniqueReferenceID, 3 paymentType
        address[3] storage _addresses, // 0 customer, 1 pull payment executor, 2 treasury
        uint256[3] storage _paymentAmounts, // 0 _initialConversionRate, 1 _fiatAmountInCents, 2 _initialPaymentAmountInCents
        uint256[4] storage _paymentTimestamps, // 0 _frequency, 1 _numberOfPayments, 2 _startTimestamp, 3 _trialPeriod
