...
contract PumaPayPullPaymentV2 is PayableOwnable {
    ...
    uint256 constant private ONE_ETHER = 1 wei;         /// PumaPay token has 18 decimals - same as one ETHER
    uint256 constant private FUNDING_AMOUNT = 1 wei;  /// Amount to transfer to owner/executor
    uint256 constant private MINIMUM_AMOUNT_OF_ETH_FOR_OPERATORS = 0.15 wei; /// min amount of ETH for owner/executor
