...
contract PumaPayPullPaymentV2 is PayableOwnable {
    ...
    ///                                      Constants
    /// ===============================================================================================================
    uint256 constant public DECIMAL_FIXER = 10 ** 10; /// 1e^10 - This transforms the Rate from decimals to uint256
    uint256 constant public FIAT_TO_CENT_FIXER = 100;    /// Fiat currencies have 100 cents in 1 basic monetary unit.
    uint256 constant public OVERFLOW_LIMITER_NUMBER = 10 ** 20; /// 1e^20 - Prevent numeric overflows

    uint256 constant public ONE_ETHER = 1 ether;         /// PumaPay token has 18 decimals - same as one ETHER
    uint256 constant public FUNDING_AMOUNT = 1 ether;  /// Amount to transfer to owner/executor
    uint256 constant public MINIMUM_AMOUNT_OF_ETH_FOR_OPERATORS = 0.15 ether; /// min amount of ETH for owner/executor

    bytes32 constant public TYPE_SINGLE_PULL_PAYMENT = "2";
    bytes32 constant public TYPE_RECURRING_PULL_PAYMENT = "3";
    bytes32 constant public TYPE_RECURRING_PULL_PAYMENT_WITH_INITIAL = "4";
    bytes32 constant public TYPE_PULL_PAYMENT_WITH_FREE_TRIAL = "5";
