...
interface IVaultsRegistryHelper {
  ...
  function getVaultsAndStrategies() external view returns (address[] memory _strategies, address[] memory _vaults);
}
...
contract VaultsRegistryHelper is UtilsReady, IVaultsRegistryHelper {
  ...
  function getVaultsAndStrategies() external view override returns (address[] memory _strategies, address[] memory _vaults) {
    _vaults = getVaults();
