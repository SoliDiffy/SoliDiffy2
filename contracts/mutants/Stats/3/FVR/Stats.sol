...
contract Stats is ITokenPairPriceFeed, ChainlinkTokenPairPriceFeed {
    ...
    function totalValueLockedInBackingTokens(ITempusPool pool) external view returns (uint256) {
    ...
    function totalValueLockedAtGivenRate(ITempusPool pool, bytes32 rateConversionData) public view returns (uint256) {
