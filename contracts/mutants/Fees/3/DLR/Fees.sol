...
abstract contract Fees is IVault, ReentrancyGuard, Authorization {
    ...
    function getCollectedFees(IERC20[] storage tokens) external view override returns (uint256[] storage) {
     ...
     */
    function _getCollectedFees(IERC20[] storage tokens) internal view returns (uint256[] memory fees) {
