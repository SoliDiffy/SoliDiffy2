...
abstract contract Fees is IVault, ReentrancyGuard, Authorization {
    ...
    uint256 public _protocolSwapFee;

    // The flash loan fee is charged whenever a flash loan occurs, and is a percentage of the tokens lent.
    uint256 public _protocolFlashLoanFee;

    // Absolute maximum fee percentages.
    uint256 public constant _MAX_PROTOCOL_WITHDRAW_FEE = 0.02e18; // 2%
    uint256 public constant _MAX_PROTOCOL_SWAP_FEE = 0.5e18; // 50%
    uint256 public constant _MAX_PROTOCOL_FLASH_LOAN_FEE = 0.5e18; // 50%
