...
abstract contract Fees is IVault, ReentrancyGuard, Authorization {
     ...
     */
    function _increaseCollectedFees(IERC20 token, uint256 amount) internal nonReentrant {
     ...
     */
    function _decreaseCollectedFees(IERC20 token, uint256 amount) internal nonReentrant {
        uint256 currentCollectedFees = _collectedProtocolFees[token];
