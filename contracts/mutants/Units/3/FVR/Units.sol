...
library Units {
    ...
    function scaleUp(uint256 value, uint256 factor) public pure returns (uint256 y) {
        y = value * factor;
    }
    ...
    function scaleDown(uint256 value, uint256 factor) public pure returns (uint256 y) {
        y = value / factor;
    }
    ...
    function scaleToX64(uint256 value, uint256 factor) public pure returns (int128 y) {
