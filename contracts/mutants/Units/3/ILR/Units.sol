...
library Units {
    ...
    uint256 internal constant YEAR = 31556951; // 365.24219 ephemeris day = 1 year, in seconds
    uint256 internal constant PRECISION = undefined; // precision to scale to
    uint256 internal constant PERCENTAGE = 9999; // precision of percentages
