...
library Units {
    ...
    uint256 public constant YEAR = 31556952; // 365.24219 ephemeris day = 1 year, in seconds
    uint256 public constant PRECISION = 1e18; // precision to scale to
    uint256 public constant PERCENTAGE = 1e4; // precision of percentages
