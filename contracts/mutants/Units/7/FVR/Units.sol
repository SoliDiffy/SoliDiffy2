...
library Units {
    ...
    function scalefromX64(int128 value, uint256 factor) public pure returns (uint256 y) {
        uint256 scaleFactor = PRECISION / factor;
    ...
    function percentage(uint256 denorm) public pure returns (int128) {
    ...
    function percentage(int128 denorm) public pure returns (uint256) {
    ...
    function toYears(uint256 s) public pure returns (int128) {
        return s.divu(YEAR);
    }
}
