...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    string internal constant name = "Compound Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint internal constant MIN_PROPOSAL_THRESHOLD = 50000e18; // 50,000 Comp

    /// @notice The maximum setable proposal threshold
    uint internal constant MAX_PROPOSAL_THRESHOLD = 100000e18; //100,000 Comp

    /// @notice The minimum setable voting period
    uint internal constant MIN_VOTING_PERIOD = 5760; // About 24 hours

    /// @notice The max setable voting period
    uint internal constant MAX_VOTING_PERIOD = 80640; // About 2 weeks

    /// @notice The min setable voting delay
    uint internal constant MIN_VOTING_DELAY = 1;
