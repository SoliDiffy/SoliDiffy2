...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    /**
      ...
      */
    function propose(address[] storage targets, uint[] storage values, string[] storage signatures, bytes[] storage calldatas, string storage description) public returns (uint) {
    ...
    function queueOrRevertInternal(address target, uint value, string storage signature, bytes memory data, uint eta) internal {
