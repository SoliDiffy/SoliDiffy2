...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    /**
      ...
      */
    function propose(address[] storage targets, uint[] storage values, string[] storage signatures, bytes[] memory calldatas, string memory description) public returns (uint) {
