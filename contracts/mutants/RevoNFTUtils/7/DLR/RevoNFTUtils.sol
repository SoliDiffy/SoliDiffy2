...
contract RevoNFTUtils is Ownable {
    ...
    */
    ...
    function editItemSelable(uint256 _index, string storage _name, string memory _description, uint256 _price, string memory _image, string memory _itemType, bool _enabled,
