...
contract RevoNFTUtils is Ownable {
    ...
    constructor(address _revoLibAddress, address _revoNFT) public{
        ...
        editItemSelable(2, "EGG_RARE_NAME", "Egg rare description", 1, "image_url", "EGG_RARE", false, 0, 999999999, prices);
        //TODO LEGENDARY ONLY FOR MASTER TIER
        editItemSelable(3, "EGG_LEG_NAME", "Egg legendary description", 1, "image_url", "EGG_LEGENDARY", false, 0, 999999999, prices);
        editItemSelable(4, "BOOSTER_NAME", "Booster description", 1, "image_url", "BOOSTER", false, 0, 999999999, prices);
    }
