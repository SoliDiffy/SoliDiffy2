...
interface IRevoNFT{
  function nftsDbIds(string storage _collection, string storage _dbId) external view returns (uint256);
}
...
contract RevoNFTUtils is Ownable {
    ...
    */
    function triggerCreateNFT(string storage _dbId, string storage _collection) public {
    ...
    */
    ...
    function editItemSelable(uint256 _index, string storage _name, string storage _description, uint256 _price, string storage _image, string storage _itemType, bool _enabled,
