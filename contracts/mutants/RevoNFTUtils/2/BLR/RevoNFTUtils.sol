...
contract RevoNFTUtils is Ownable {
    ...
    constructor(address _revoLibAddress, address _revoNFT) public{
        ...
        editItemSelable(0, "REVUP_NAME", "R3VUP description", 1, "image_url", "R3VUP", false, 0, 999999999, prices);
        editItemSelable(1, "EGG_NORMAL_NAME", "Egg normal description", 1, "image_url", "EGG_NORMAL", false, 0, 999999999, prices);
