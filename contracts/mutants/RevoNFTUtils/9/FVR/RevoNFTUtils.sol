...
contract RevoNFTUtils is Ownable {
    ...
    */
    function triggerCreateNFT(string memory _dbId, string memory _collection) external {
    ...
    */
    function buyItem(uint256 _itemIndex) external {
    ...
    function getItemPrice(uint256 _itemIndex) external view returns(uint256){
    ...
    function setRevoFees(uint256 _fees) external onlyOwner {
        revoFees = _fees;
    }
