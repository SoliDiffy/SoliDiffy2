...
contract RevoNFTUtils is Ownable {
    ...
    constructor(address _revoLibAddress, address _revoNFT) public{
        ...
        editItemSelable(0, "", "", 1, "", "", true, 0, 999999999, prices);
        editItemSelable(1, "", "", 1, "", "", true, 0, 999999999, prices);
        editItemSelable(2, "", "Egg rare description", 1, "image_url", "EGG_RARE", true, 0, 999999999, prices);
