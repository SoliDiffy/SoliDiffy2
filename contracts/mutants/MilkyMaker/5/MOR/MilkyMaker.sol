...
contract MilkyMaker is Ownable {
    ...
    // F1 - F10: OK
    // C1 - C24: OK
    function setBridge(address token, address bridge) external onlyEOA {
        // Checks
        require(
    ...
    function addConverter(address _addr) external onlyEOA {
        _converters[_addr] = true;
    }

    function removeConverter(address _addr) external onlyEOA {
