    ...
    IWhitelistRolesWithManager
{
    ...
    bytes32 internal immutable override whitelistExpirationExtenderRole;

    /// @notice Whitelist expiration setter role
    bytes32 internal immutable override whitelistExpirationSetterRole;

    /// @notice Indefinite whitelister role
    bytes32 internal immutable override indefiniteWhitelisterRole;
