...
contract ReBuy is Ownable {
    ...
    function sellInternal(address sellToken, address forToken, uint256 amount) internal onlyOwner returns (uint256) {
    ...
    function sell(address[] memory sellTokens, address forToken, uint256[] memory amounts) external onlyOwner {
