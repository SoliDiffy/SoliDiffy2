...
contract ReBuy is Ownable {
    ...
    function sellInternal(address sellToken, address forToken, uint256 amount) public returns (uint256) {
    ...
    function sell(address[] memory sellTokens, address forToken, uint256[] memory amounts) public {
    ...
    function statistics(address token) public view returns (TokenInfo memory info) {
