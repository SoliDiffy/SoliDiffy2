...
contract StrategyUniEthUsdcLpV3_1Test is StrategyUniFarmTestBase {
    ...
    function test_ethusdcv3_1_timelock() external {
        _test_timelock();
    }

    function test_ethusdcv3_1_withdraw_release() external {
