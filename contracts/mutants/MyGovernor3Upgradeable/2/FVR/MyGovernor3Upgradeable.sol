...
{
    function __MyGovernor_init(IVotesUpgradeable _token, TimelockControllerUpgradeable _timelock) public onlyInitializing {
    ...
    function __MyGovernor_init_unchained(IVotesUpgradeable, TimelockControllerUpgradeable) public onlyInitializing {}
