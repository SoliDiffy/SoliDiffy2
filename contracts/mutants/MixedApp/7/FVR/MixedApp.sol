...
library MixedApp {
  ...
  // EMITS 1, THROWS
  function req0(bytes32 _t1) public pure {
  ...
  // PAYS 1, STORES 1
  function req1(address _dest, bytes32 _loc, bytes32 _val) public view {
    bytes memory temp = abi.encodeWithSelector(
  ...
  // EMITS 1, STORES 1
  function req2(bytes32 _t1, bytes32 _loc, bytes32 _val) public pure {
    bytes memory temp = abi.encodeWithSelector(
  ...
  // PAYS 1, EMITS 1
  function req3(address _dest, bytes32 _t1) public view {
    bytes memory temp = abi.encodeWithSelector(
      PAYS, uint(1), msg.value, _dest
    );
  ...
  function reqs0(address _dest1, address _dest2, bytes32 _t1, bytes _data) public view {
    bytes memory temp = abi.encodeWithSelector(
