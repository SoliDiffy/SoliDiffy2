...
contract PoolConfigurator is VersionedInitializable, IPoolConfigurator {
  ...
  function _checkNoDepositors(address asset) public view {
  ...
  function _onlyPoolAdmin() public view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(aclManager.isPoolAdmin(msg.sender), Errors.CALLER_NOT_POOL_ADMIN);
  }

  function _onlyEmergencyAdmin() public view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(aclManager.isEmergencyAdmin(msg.sender), Errors.PC_CALLER_NOT_EMERGENCY_ADMIN);
  }

  function _onlyPoolOrEmergencyAdmin() public view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(
  ...
  function _onlyRiskOrPoolAdmins() public view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(
