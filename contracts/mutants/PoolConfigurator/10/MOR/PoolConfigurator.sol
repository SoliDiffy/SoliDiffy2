...
contract PoolConfigurator is VersionedInitializable, IPoolConfigurator {
  ...
  function initialize(IPoolAddressesProvider provider) public onlyAssetListingOrPoolAdmins {
  ...
  /// @inheritdoc IPoolConfigurator
  function dropReserve(address asset) external override initializer {
  ...
  /// @inheritdoc IPoolConfigurator
  function disableBorrowingOnReserve(address asset) external override initializer {
    DataTypes.ReserveConfigurationMap memory currentConfig = _pool.getConfiguration(asset);
  ...
  /// @inheritdoc IPoolConfigurator
  function enableReserveStableRate(address asset) external override initializer {
    DataTypes.ReserveConfigurationMap memory currentConfig = _pool.getConfiguration(asset);
