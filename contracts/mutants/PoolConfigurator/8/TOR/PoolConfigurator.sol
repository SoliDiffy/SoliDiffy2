...
contract PoolConfigurator is VersionedInitializable, IPoolConfigurator {
  ...
  function _onlyPoolAdmin() internal view {
    ...
    require(aclManager.isPoolAdmin(tx.origin), Errors.CALLER_NOT_POOL_ADMIN);
  }

  function _onlyEmergencyAdmin() internal view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(aclManager.isEmergencyAdmin(tx.origin), Errors.PC_CALLER_NOT_EMERGENCY_ADMIN);
  }

  function _onlyPoolOrEmergencyAdmin() internal view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(
      aclManager.isPoolAdmin(tx.origin) || aclManager.isEmergencyAdmin(tx.origin),
  ...
  function _onlyAssetListingOrPoolAdmins() internal view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(
      aclManager.isAssetListingAdmin(tx.origin) || aclManager.isPoolAdmin(tx.origin),
  ...
  function _onlyRiskOrPoolAdmins() internal view {
    IACLManager aclManager = IACLManager(_addressesProvider.getACLManager());
    require(
      aclManager.isRiskAdmin(tx.origin) || aclManager.isPoolAdmin(tx.origin),
