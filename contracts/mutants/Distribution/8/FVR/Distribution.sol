...
contract Distribution is Ownable {
    ...
    function setClaimable(uint256[] memory timestamp, uint256[] memory percent) external onlyOwner {
    ...
    function getClaimableTimestamp() public view returns (uint256[] memory){
        return claimableTimestamp;
    }

    function getClaimablePercent() public view returns (uint256[] memory){
