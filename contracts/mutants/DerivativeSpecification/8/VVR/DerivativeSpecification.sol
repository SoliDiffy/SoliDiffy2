...
contract DerivativeSpecification is IDerivativeSpecification {
    ...
    bytes32[] public oracleSymbols_;
    bytes32[] public oracleIteratorSymbols_;
    bytes32 public collateralTokenSymbol_;
    bytes32 public collateralSplitSymbol_;

    uint256 public livePeriod_;

    uint256 public primaryNominalValue_;
    uint256 public complementNominalValue_;
