...
contract ClaimsData is Iupgradable {
   ...
   */
  function setpendingClaimStart(uint _start) public onlyInternal {
   ...
   */
  function setRewardDistributedIndexCA(address _voter, uint caIndex) public onlyInternal {
   ...
   */
  function setUserClaimVotePausedOn(address user) public {
   ...
   */
  function setRewardDistributedIndexMV(address _voter, uint mvIndex) public onlyInternal {
   ...
   */
  function setRewardClaimed(uint _voteid, bool claimed) public onlyInternal {
   ...
   */
  function changeFinalVerdict(uint _claimId, int8 _verdict) public onlyInternal {
