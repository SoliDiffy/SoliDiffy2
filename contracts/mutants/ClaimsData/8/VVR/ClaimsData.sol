...
contract ClaimsData is Iupgradable {
  ...
  ClaimRewardStatus[] public rewardStatus;

  Claim[] public allClaims;
  Vote[] public allvotes;
  ClaimsPause[] public claimPause;
  ClaimPauseVoting[] public claimPauseVotingEP;
  ...
  uint public claimPauseLastsubmit;
  uint public claimStartVotingFirstIndex;
  uint internal pendingClaimStart;
