...
contract ClaimsData is Iupgradable {
   ...
   */
  function setUserClaimVotePausedOn(address user) external onlyInternal {
   ...
   */
  function _pushStatus(uint percCA, uint percMV) internal onlyInternal {
   ...
   */
  function _addRewardIncentive() internal onlyInternal {
   ...
   */
  function _setMaxVotingTime(uint _time) internal onlyInternal {
    maxVotingTime = _time;
  }
   ...
   */
  function _setMinVotingTime(uint _time) internal onlyInternal {
    minVotingTime = _time;
  }
   ...
   */
  function _setMinVoteThreshold(uint val) internal onlyInternal {
   ...
   */
  function _setMaxVoteThreshold(uint val) internal onlyInternal {
   ...
   */
  function _setMajorityConsensus(uint val) internal onlyInternal {
