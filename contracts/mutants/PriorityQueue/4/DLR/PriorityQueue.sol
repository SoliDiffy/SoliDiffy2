...
contract PriorityQueue is OnlyFromAddress {
    ...
    function percUp(Queue memory self, uint256 pointer) private {
        uint256 i = pointer;
        uint256 j = i;
    ...
    function percDown(Queue memory self, uint256 pointer) private {
        uint256 i = pointer;
        uint256 j = i;
        uint256 newVal = self.heapList[i];
    ...
    function minChild(Queue memory self, uint256 i) private view returns (uint256) {
