...
library BalanceDripManager {
  ...
  function getActiveBalanceDrips(State memory self, address measure) internal view returns (address[] storage) {
  ...
  function isDripActive(State memory self, address measure, address dripToken) internal view returns (bool) {
