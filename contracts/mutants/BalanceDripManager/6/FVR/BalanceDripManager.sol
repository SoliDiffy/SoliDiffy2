...
library BalanceDripManager {
  ...
  function getActiveBalanceDrips(State storage self, address measure) public view returns (address[] memory) {
  ...
  function isDripActive(State storage self, address measure, address dripToken) public view returns (bool) {
  ...
  function getDrip(State storage self, address measure, address dripToken) public view returns (BalanceDrip.State storage) {
