...
contract Controller is IController, Ownable, Claimable {
    ...
    constructor(address _ownerAddress_, bool _transferable_) Ownable(_ownerAddress_, _transferable_) internal { }
    ...
    function addController(address _account) public onlyAdmin {
        _addController(_account);
    }

    /// @notice Remove a controller from the list of controllers.
    /// @param _account address to remove from the list of controllers.
    function removeController(address _account) public onlyAdmin {
