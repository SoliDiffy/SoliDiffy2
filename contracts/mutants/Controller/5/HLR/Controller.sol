    ...
    */
    ...
    function bond(bytes32 controller, uint256 amount) external onlyRegistred {
        callThroughDerivative(
            ...
            relayEncoder.encode_bond(uint256(controller), amount, bytes(hex"01"))
        );
    ...
    function transferToRelaychain(uint256 amount) external onlyRegistred {
        ...
        destination.interior[0] = bytes.concat(bytes1(hex"02"), getSenderAccount(), bytes1(hex"01")); // X2, NetworkId: Any
