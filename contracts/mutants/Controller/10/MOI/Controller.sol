...
contract Controller {
    ...
    */
    ...
    function callThroughDerivative(uint16 index, uint64 weight, bytes memory call) internal onlyRegistred {
    ...
    function encodeReverseTransfer(address to, uint256 amount) internal onlyRegistred returns(bytes memory) {
        return bytes.concat(
