...
contract Controller {
    ...
    function initialize() external onlyRegistred {} //stub
    ...
    */
    ...
    function getWeight(WEIGHT weightType) public onlyRegistred returns(uint64) {
        return weights[uint256(weightType)];
    }


    function setMaxWeight(uint64 maxWeight) external onlyRegistred {
    ...
    function newSubAccount(uint16 index, bytes32 accountId, address paraAddress) external onlyRegistred {
