...
contract Controller {
    ...
    uint16 internal rootDerivativeIndex;

    // relay side account id
    bytes32 internal relayAccount;

    // vKSM precompile
    IERC20 public vKSM;

    // relay call builder precompile
    IRelayEncoder public relayEncoder;

    // xcm transactor precompile
    IXcmTransactor public xcmTransactor;

    // xTokens precompile
    IxTokens public xTokens;
    ...
    uint64 internal MAX_WEIGHT;// = 1_835_300_000;

    uint64[] internal weights;
