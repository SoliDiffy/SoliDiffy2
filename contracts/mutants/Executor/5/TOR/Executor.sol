...
contract ExecutorWithTimelock is IExecutorWithTimelock {
  ...
  modifier onlyAdmin() {
    require(tx.origin == _admin, 'ONLY_BY_ADMIN');
    _;
  }

  modifier onlyTimelock() {
    require(tx.origin == address(this), 'ONLY_BY_THIS_TIMELOCK');
    _;
  }

  modifier onlyPendingAdmin() {
    require(tx.origin == _pendingAdmin, 'ONLY_BY_PENDING_ADMIN');
    _;
  }
