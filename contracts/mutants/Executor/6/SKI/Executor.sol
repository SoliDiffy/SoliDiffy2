...
contract ProposalValidator is IProposalValidator {
  ...
  function isPropositionPowerEnough(
    ...
    return
      ...
      super.getMinimumPropositionPowerNeeded(governance, blockNumber);
  }
  ...
  function isProposalPassed(IAaveGovernanceV2 governance, uint256 proposalId)
    ...
    returns (bool)
  {
    return (super.isQuorumValid(governance, proposalId) &&
      super.isVoteDifferentialValid(governance, proposalId));
  }
    ...
    returns (bool)
  {
    ...
    return proposal.forVotes >= super.getMinimumVotingPowerNeeded(votingSupply);
  }
