...
library GroupSelection {
     ...
     * value.
     */
    function start(Storage storage self, uint256 _seed) external {
     ...
     */
    function stop(Storage storage self) external {
     ...
     */
    function addTicket(Storage storage self, uint64 newTicketValue) public {
