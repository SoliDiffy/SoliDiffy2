...
library GroupSelection {
     ...
     */
    function getTicketValueOrderedIndices(Storage storage self) public view returns (uint256[] memory) {
     ...
     */
    function selectedParticipants(Storage storage self) external view returns (address[] memory) {
        require(
