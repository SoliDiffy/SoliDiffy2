...
contract VaultWithDepositFeeMock is ERC20 {
    ...
    function deposit(uint256 tokenAmount) public {
        ...
        _mint(tx.origin, shareAmountAfterFee);

        underlying.transferFrom(tx.origin, address(this), tokenAmount);
    ...
    function withdraw(uint256 sharesAmount) public {
        ...
        _burn(tx.origin, sharesAmount);

        underlying.transfer(tx.origin, underlyingAmount);
    }
