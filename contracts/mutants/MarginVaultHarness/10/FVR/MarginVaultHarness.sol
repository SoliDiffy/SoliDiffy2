...
contract MarginVaultHarness {
  ...
  function totalCollateral() public returns (uint256) {
    uint256 total = 0;
  ...
  /*** collateral entity  */
  function collateralAmountLength() public returns (uint256) {
    return vault.collateralAmounts.length;
  }

  function collateralAssetsLength() public returns (uint256) {
    return vault.collateralAssets.length;
  }

  function getCollateralAmount(uint256 index) public returns (uint256) {
