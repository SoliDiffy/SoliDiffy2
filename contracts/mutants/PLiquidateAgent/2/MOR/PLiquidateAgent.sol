...
contract PLiquidateAgent is Ownable{
  ...
  function liquidate_asset(address payable _sender, uint256 _target_amount, uint256 _stable_amount) public onlyOwner{
  ...
  function changeCaller(address _caller) public onlyCaller{
    caller = _caller;
  }
