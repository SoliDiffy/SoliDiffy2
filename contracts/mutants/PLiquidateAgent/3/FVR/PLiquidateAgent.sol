...
contract PLiquidateAgent is Ownable{
  ...
  constructor(address _target_token, address _target_token_pool, address _stable_token, address _dispatcher) internal{
  ...
  function liquidate_asset(address payable _sender, uint256 _target_amount, uint256 _stable_amount) external onlyCaller{
