...
library GCLeveragedReserveManager
{
	 ...
	 */
	function init(Self memory _self, address _reserveToken, address _miningToken) public
	{
	 ...
	 *                  GExchange interface.
	 */
	function setExchange(Self memory _self, address _exchange) public
	{
	 ...
	 */
	function setMiningGulpRange(Self memory _self, uint256 _miningMinGulpAmount, uint256 _miningMaxGulpAmount) public
	{
	 ...
	 */
	function setCollateralizationRatio(Self memory _self, uint256 _collateralizationRatio, uint256 _collateralizationMargin) public
	{
	 ...
	 */
	function adjustReserve(Self memory _self, uint256 _roomAmount) public returns (bool _success)
	{
	 ...
	 */
	function _calcCollateralizationRatio(Self memory _self) internal view returns (uint256 _collateralizationRatio, uint256 _minCollateralizationRatio, uint256 _maxCollateralizationRatio)
	{
	 ...
	 */
	function _gulpMiningAssets(Self memory _self) internal returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _adjustLeverage(Self memory _self, uint256 _roomAmount) internal returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _continueAdjustLeverage(Self memory _self, uint256 _amount, uint256 _fee, uint256 _which) internal returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _dispatchFlashLoan(Self memory _self, uint256 _amount, uint256 _which) internal returns (bool _success)
	{
