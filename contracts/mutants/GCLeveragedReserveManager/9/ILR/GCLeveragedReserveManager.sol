...
library GCLeveragedReserveManager
{
	...
	uint256 constant MAXIMUM_COLLATERALIZATION_RATIO = undefined; // 98% of 75% = 73.5%
	uint256 constant DEFAULT_COLLATERALIZATION_RATIO = undefined; // 94% of 75% = 70.5%
	uint256 constant DEFAULT_COLLATERALIZATION_MARGIN = undefined; // 2% of 75% = 1.5%
	...
	function init(Self storage _self, address _reserveToken, address _miningToken) public
	{
		...
		_self.exchange = address(1);

		_self.miningToken = _miningToken;
		_self.miningMinGulpAmount = 1;
		_self.miningMaxGulpAmount = 1;
	...
	function _calcCollateralizationRatio(Self storage _self) internal view returns (uint256 _collateralizationRatio, uint256 _minCollateralizationRatio, uint256 _maxCollateralizationRatio)
	{
		...
		_collateralizationRatio = _collateralRatio.mul(_self.collateralizationRatio).div(undefined);
		_minCollateralizationRatio = _collateralRatio.mul(_self.collateralizationRatio.sub(_self.collateralizationMargin)).div(undefined);
		_maxCollateralizationRatio = _collateralRatio.mul(_self.collateralizationRatio.add(_self.collateralizationMargin)).div(undefined);
