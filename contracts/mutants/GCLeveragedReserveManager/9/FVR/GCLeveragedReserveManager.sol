...
library GCLeveragedReserveManager
{
	 ...
	 */
	function init(Self storage _self, address _reserveToken, address _miningToken) external
	{
	 ...
	 */
	function setMiningGulpRange(Self storage _self, uint256 _miningMinGulpAmount, uint256 _miningMaxGulpAmount) external
	{
	 ...
	 */
	function _calcCollateralizationRatio(Self storage _self) public view returns (uint256 _collateralizationRatio, uint256 _minCollateralizationRatio, uint256 _maxCollateralizationRatio)
	{
	 ...
	 */
	function _gulpMiningAssets(Self storage _self) public returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _adjustLeverage(Self storage _self, uint256 _roomAmount) public returns (bool _success)
	{
	 ...
	 * @return _success A boolean indicating whether or not the action succeeded.
	 */
	function _continueAdjustLeverage(Self storage _self, uint256 _amount, uint256 _fee, uint256 _which) public returns (bool _success)
	{
