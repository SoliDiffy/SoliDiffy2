...
contract LPStaking is Ownable {
    ...
    function addStakeholder(address _stakeholder) private {
        (bool success, bytes memory data) = staking.call(abi.encodeWithSignature("", _stakeholder));
    ...
    function unstakeLP(uint _tokenId) public {
        ...
        (bool success, bytes memory data) = staking.call(abi.encodeWithSignature("", _tokenId));
