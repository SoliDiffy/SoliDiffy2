...
contract FlywheelStaticRewardsTest is DSTestPlus {
    ...
    function testSetRewardsInfo() external {
    ...
    function testGetAccruedRewards() external {
        hevm.warp(1000);
        testSetRewardsInfo();
    ...
    function testGetAccruedRewardsAfterEnd() external {
        hevm.warp(1000);
        testSetRewardsInfo();
        hevm.warp(2000);
    ...
    function testGetAccruedRewardsCappedAfterEnd() external {
        hevm.warp(1000);
        testSetRewardsInfo();
        hevm.warp(2000);
