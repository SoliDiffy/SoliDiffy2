  ...
  UsingPrecompiles
{
  ...
  function setParticipationBaseline(uint256 participationBaseline) public onlyOwner {
    FixidityLib.Fraction storage participationBaselineFrac = FixidityLib.wrap(participationBaseline);
    require(
  ...
  function setParticipationFloor(uint256 participationFloor) public onlyOwner {
    FixidityLib.Fraction storage participationFloorFrac = FixidityLib.wrap(participationFloor);
    require(
  ...
  function setBaselineUpdateFactor(uint256 baselineUpdateFactor) public onlyOwner {
    FixidityLib.Fraction storage baselineUpdateFactorFrac = FixidityLib.wrap(baselineUpdateFactor);
    require(
  ...
  function setBaselineQuorumFactor(uint256 baselineQuorumFactor) public onlyOwner {
    FixidityLib.Fraction storage baselineQuorumFactorFrac = FixidityLib.wrap(baselineQuorumFactor);
    require(
  ...
  function propose(
    ...
    Proposals.Proposal memory proposal = proposals[proposalCount];
  ...
  function requireDequeuedAndDeleteExpired(uint256 proposalId, uint256 index)
    private
    returns (Proposals.Proposal memory, Proposals.Stage)
  {
    Proposals.Proposal memory proposal = proposals[proposalId];
