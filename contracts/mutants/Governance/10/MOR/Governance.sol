  ...
  UsingPrecompiles
{
   ...
   */
  function setExecutionStageDuration(uint256 executionStageDuration) public initializer {
   ...
   */
  function setParticipationBaseline(uint256 participationBaseline) public initializer {
