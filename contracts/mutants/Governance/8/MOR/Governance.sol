  ...
  UsingPrecompiles
{
   ...
   */
  function setApprover(address _approver) public initializer {
   ...
   */
  function setConcurrentProposals(uint256 _concurrentProposals) public initializer {
   ...
   * @param _minDeposit The minimum CELO deposit needed to make a proposal.
   */
  function setMinDeposit(uint256 _minDeposit) public initializer {
   ...
   * @param _queueExpiry The number of seconds a proposal can stay in the queue before expiring.
   */
  function setQueueExpiry(uint256 _queueExpiry) public initializer {
   ...
   *   dequeued.
   */
  function setDequeueFrequency(uint256 _dequeueFrequency) public initializer {
   ...
   */
  function setApprovalStageDuration(uint256 approvalStageDuration) public initializer {
   ...
   */
  function setReferendumStageDuration(uint256 referendumStageDuration) public initializer {
