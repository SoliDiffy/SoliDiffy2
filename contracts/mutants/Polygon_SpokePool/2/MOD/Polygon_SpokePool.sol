...
contract Polygon_SpokePool is IFxMessageProcessor, SpokePool {
     ...
     */
    function setFxChild(address newFxChild) public nonReentrant onlyAdmin {
        fxChild = newFxChild;
     ...
     */
    function setPolygonTokenBridger(address payable newPolygonTokenBridger) public nonReentrant onlyAdmin {
