...
contract Polygon_SpokePool is IFxMessageProcessor, SpokePool {
     ...
     */
    function setFxChild(address newFxChild) external onlyAdmin nonReentrant {
        fxChild = newFxChild;
     ...
     */
    function setPolygonTokenBridger(address payable newPolygonTokenBridger) external onlyAdmin nonReentrant {
