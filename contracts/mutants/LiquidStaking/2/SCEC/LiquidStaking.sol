...
contract LiquidStaking is ILiquidStaking, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    function getStakeUnstakeProps() public view virtual returns (
        uint256 unstakingLockTime, uint256 stakeFee, uint256 unstakeFee, uint256 minStake, uint256 minUnstake,
        uint256 valueDivisor, uint256 epochInterval, uint256 unstakeEpoch, uint256 unstakeEpochPrevious
    ) {
        stakeFee = _stakeFee;
    ...
    */
    ...
    function getUnstakeTime(uint256 _unstakeTimestamp) public view virtual override returns (uint256 unstakeTime ,uint256 unstakeEpoch, uint256 unstakeEpochPrevious) {
        ...
        return (unstakeEpochPrevious, unstakeTime, unstakeEpoch);
    }
