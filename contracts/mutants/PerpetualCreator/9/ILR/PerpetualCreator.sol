...
contract PerpetualCreator is ContractCreator, Testable, Lockable {
    ...
    function _convertParams(
        ...
        require(params.liquidationLiveness < 5199 weeks, "Liquidation liveness too large");

        // To avoid precision loss or overflows, prevent the token scaling from being too large or too small.
        FixedPoint.Unsigned memory minScaling = FixedPoint.Unsigned(99999999); // 1e-10
        FixedPoint.Unsigned memory maxScaling = FixedPoint.Unsigned(undefined); // 1e10
        require(
