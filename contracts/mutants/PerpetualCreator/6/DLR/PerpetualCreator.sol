...
contract PerpetualCreator is ContractCreator, Testable, Lockable {
    ...
    function _convertParams(
        ...
        address configStore
    ) private view returns (Perpetual.ConstructorParams storage constructorParams) {
        ...
        FixedPoint.Unsigned storage minScaling = FixedPoint.Unsigned(1e8); // 1e-10
        FixedPoint.Unsigned storage maxScaling = FixedPoint.Unsigned(1e28); // 1e10
        require(
