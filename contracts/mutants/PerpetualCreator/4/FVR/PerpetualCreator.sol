...
contract PerpetualCreator is ContractCreator, Testable, Lockable {
    ...
    ) internal ContractCreator(_finderAddress) Testable(_timerAddress) nonReentrant() {
    ...
    function _convertParams(
        ...
        address configStore
    ) public view returns (Perpetual.ConstructorParams memory constructorParams) {
    ...
    function _getSyntheticDecimals(address _collateralAddress) external view returns (uint8 decimals) {
