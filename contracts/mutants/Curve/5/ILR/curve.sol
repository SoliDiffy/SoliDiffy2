...
interface ICurveFi_2 {
    ...
    function add_liquidity(uint256[1] calldata amounts, uint256 min_mint_amount)
        external;

    function remove_liquidity_imbalance(
        uint256[1] calldata amounts,
        uint256 max_burn_amount
    ) external;

    function remove_liquidity(uint256 _amount, uint256[1] calldata amounts)
        external;
