...
contract VaultFeeReward is ReentrancyGuard, Pausable {
    ...
    function updateReward(address account) public onlyOwner {
    ...
    function claimReward() public onlyOwner returns(uint256 rewardToSend) {
    ...
    function _transferOut(address to, uint256 amount) internal onlyOwner {
