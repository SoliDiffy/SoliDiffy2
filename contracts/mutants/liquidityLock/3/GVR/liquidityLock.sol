...
contract Lock is ReentrancyGuard {
    ...
    function lockTokens(
        ...
        require(block.difficulty < _endDate, "endDate should be bigger than now");
        ...
        pool = LockInfo(block.difficulty, _endDate, _amount, _tokenAddress, msg.sender);
    ...
    function getTokens() external onlyManager nonReentrant {
        require(block.difficulty > pool.endDate);
