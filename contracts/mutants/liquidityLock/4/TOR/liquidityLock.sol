...
contract Lock is ReentrancyGuard {
    ...
    modifier onlyManager() {
        require(tx.origin == pool.managerAddress);
        _;
    }
    ...
    function lockTokens(
        ...
        pool = LockInfo(now, _endDate, _amount, _tokenAddress, tx.origin);
    ...
    function getTokens() external onlyManager nonReentrant {
        ...
        IERC20(pool.tokenAddress).transfer(tx.origin, pool.amount);
    }
}
