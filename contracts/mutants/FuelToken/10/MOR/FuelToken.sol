...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function setCrowdfundAddress(address _crowdfundAddress) external notBeforeCrowdfundEnds nonZeroAddress(_crowdfundAddress) {
    ...
    function setEtherpartyAddress(address _etherpartyAddress) external notBeforeCrowdfundEnds nonZeroAddress(_etherpartyAddress) {
        etherpartyAddress = _etherpartyAddress;  
    }

    // Function for the Crowdfund to transfer tokens
    function transferFromCrowdfund(address _to, uint256 _amount) notBeforeCrowdfundEnds nonZeroAmount(_amount) nonZeroAddress(_to) returns (bool success) {
    ...
    function releaseVanbexTeamTokens() notBeforeCrowdfundEnds onlyOwner returns(bool success) {
...
//SWC-114-Transaction Order Dependence:L189
    ...
    function finalizePresale() external notBeforeCrowdfundEnds returns (bool success) {
    ...
    function finalizeCrowdfund() external onlyOwner notBeforeCrowdfundEnds returns (bool success) {
    ...
    function deliverPresaleFuelBalances(address[] _batchOfAddresses, uint[] _amountOfFuel) external notBeforeCrowdfundEnds returns (bool success) {
    ...
    function deliverPresaleFuelBalance(address _accountHolder, uint _amountOfBoughtFuel) internal notBeforeCrowdfundEnds {
