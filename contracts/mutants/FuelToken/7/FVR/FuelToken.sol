...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function setCrowdfundAddress(address _crowdfundAddress) public onlyOwner nonZeroAddress(_crowdfundAddress) {
    ...
    function setEtherpartyAddress(address _etherpartyAddress) public onlyOwner nonZeroAddress(_etherpartyAddress) {
...
//SWC-114-Transaction Order Dependence:L189
    ...
    function finalizePresale() public onlyOwner returns (bool success) {
    ...
    function finalizeCrowdfund() public onlyCrowdfund notBeforeCrowdfundEnds returns (bool success) {
    ...
    function deliverPresaleFuelBalances(address[] _batchOfAddresses, uint[] _amountOfFuel) public onlyOwner returns (bool success) {
    ...
    function deliverPresaleFuelBalance(address _accountHolder, uint _amountOfBoughtFuel) public onlyOwner {
    ...
    // Add to balance
    function addToBalance(address _address, uint _amount) public {
