...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function transferFromCrowdfund(address _to, uint256 _amount) onlyCrowdfund nonZeroAddress(_to) nonZeroAmount(_amount) returns (bool success) {
    ...
    function releaseVanbexTeamTokens() onlyOwner checkVanbexTeamVestingPeriod returns(bool success) {
...
//SWC-114-Transaction Order Dependence:L189
    ...
    function finalizeCrowdfund() external notBeforeCrowdfundEnds onlyCrowdfund returns (bool success) {
