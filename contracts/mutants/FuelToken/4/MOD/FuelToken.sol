...
/////////////////////// ERC20 FUNCTIONS ///////////////////////
    ...
    // Transfer
    function transfer(address _to, uint256 _amount) nonZeroAmount(_amount) notBeforeCrowdfundEnds returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint256 _amount) nonZeroAmount(_amount) notBeforeCrowdfundEnds returns (bool success) {
...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function setCrowdfundAddress(address _crowdfundAddress) external nonZeroAddress(_crowdfundAddress) onlyOwner {
    ...
    function setEtherpartyAddress(address _etherpartyAddress) external nonZeroAddress(_etherpartyAddress) onlyOwner {
