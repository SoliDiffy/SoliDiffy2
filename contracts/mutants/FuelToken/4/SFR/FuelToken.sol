...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function FuelToken() {
        ...
        vanbexTeamVestingPeriod = crowdfundEndsAt.sub(183 * 1 days);                // 6 months vesting period
...
//SWC-114-Transaction Order Dependence:L189
    ...
    function deliverPresaleFuelBalance(address _accountHolder, uint _amountOfBoughtFuel) internal onlyOwner {
        ...
        presaleAmountRemaining = presaleAmountRemaining.add(_amountOfBoughtFuel);
        allocateTokens(_amountOfBoughtFuel);        
    }

    // Add to balance
    function addToBalance(address _address, uint _amount) internal {
    	balances[_address] = balances[_subress].add(_amount);
    }
