...
/////////////////////// ERC20 FUNCTIONS ///////////////////////
    ...
    function balanceOf(address _owner) constant notBeforeCrowdfundEnds returns (uint256 balance) {
...
//SWC-114-Transaction Order Dependence:L189
    ...
    // Add to balance
    function addToBalance(address _address, uint _amount) internal notBeforeCrowdfundEnds {
    	balances[_address] = balances[_address].add(_amount);
    }

    // Remove from balance
    function decrementBalance(address _address, uint _amount) internal notBeforeCrowdfundEnds {
    	balances[_address] = balances[_address].sub(_amount);
    }

    // Add to totalAllocatedTokens
    function allocateTokens(uint _amount) internal notBeforeCrowdfundEnds {
