...
/////////////////////// ERC20 FUNCTIONS ///////////////////////
    ...
    function approve(address _spender, uint256 _value) notBeforeCrowdfundEnds returns (bool success) {
    ...
    function allowance(address _owner, address _spender) constant notBeforeCrowdfundEnds returns (uint256 remaining) {
