...
/////////////////////// ERC20 FUNCTIONS ///////////////////////
    ...
    // Transfer
    function transfer(address _to, uint256 _amount) onlyOwner nonZeroAmount(_amount) returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint256 _amount) onlyOwner nonZeroAmount(_amount) returns (bool success) {
