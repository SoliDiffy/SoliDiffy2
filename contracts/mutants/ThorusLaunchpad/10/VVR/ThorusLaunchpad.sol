...
contract ThorusLaunchpad is Ownable, ReentrancyGuard {
    ...
    IERC20 internal immutable thorus;
    IERC20 internal immutable reward;
    uint256 internal immutable thorusHardcap;
    uint256 internal immutable rewardOffered;
    uint256 internal immutable ticketsHardcap;
