...
contract CryptoHeroesUniverse is Ownable {
  ...
  function add(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate, bool _NFTisNeeded, IERC721 _acceptedNFT) external onlyOwner {
  ...
  function pendingCheroes(uint256 _pid, address _user) public view returns (uint256) {
