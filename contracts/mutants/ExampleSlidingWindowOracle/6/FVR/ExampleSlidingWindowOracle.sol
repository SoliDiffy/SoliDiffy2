...
contract ExampleSlidingWindowOracle {
    ...
    constructor(address factory_, uint windowSize_, uint8 granularity_) internal {
    ...
    function getFirstObservationInWindow(address pair) public view returns (Observation storage firstObservation) {
