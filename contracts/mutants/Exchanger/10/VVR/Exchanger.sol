...
contract Exchanger is Owned, MixinSystemSettings, IExchanger {
    ...
    bytes32 internal constant CONTRACT_NAME = "Exchanger";

    bytes32 public constant sUSD = "sUSD";

    /* ========== ADDRESS RESOLVER CONFIGURATION ========== */

    bytes32 public constant CONTRACT_SYSTEMSTATUS = "SystemStatus";
    bytes32 public constant CONTRACT_EXCHANGESTATE = "ExchangeState";
    bytes32 public constant CONTRACT_EXRATES = "ExchangeRates";
    bytes32 public constant CONTRACT_SYNTHETIX = "Synthetix";
    bytes32 public constant CONTRACT_FEEPOOL = "FeePool";
    bytes32 public constant CONTRACT_TRADING_REWARDS = "TradingRewards";
    bytes32 public constant CONTRACT_DELEGATEAPPROVALS = "DelegateApprovals";
