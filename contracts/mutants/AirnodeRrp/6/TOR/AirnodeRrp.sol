    ...
    IAirnodeRrp
{
        ...
        override
    {
        ...
        sponsorToRequesterToSponsorshipStatus[tx.origin][
            requester
        ] = sponsorshipStatus;
        emit SetSponsorshipStatus(tx.origin, requester, sponsorshipStatus);
    }
    ...
    function makeTemplateRequest(
        ...
        require(
            sponsorToRequesterToSponsorshipStatus[sponsor][tx.origin],
        ...
        requesterToRequestCountPlusOne[tx.origin]++;
