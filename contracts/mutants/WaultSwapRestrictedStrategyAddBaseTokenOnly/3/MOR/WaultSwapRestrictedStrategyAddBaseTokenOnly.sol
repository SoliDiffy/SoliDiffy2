...
contract WaultSwapRestrictedStrategyAddBaseTokenOnly is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  function initialize(IWaultSwapRouter02 _router) external onlyWhitelistedWorkers {
  ...
  function setWorkersOk(address[] calldata workers, bool isOk) external initializer {
