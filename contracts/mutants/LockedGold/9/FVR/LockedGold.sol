  ...
  UsingRegistry
{
  ...
  function isSlasher(address slasher) public view returns (bool) {
  ...
  */
   ...
   */
  function initialize(address registryAddress, uint256 _unlockingPeriod) public initializer {
   ...
   */
  function lock() public payable nonReentrant {
   ...
   * @param value The amount by which to increment.
   */
  function _incrementNonvotingAccountBalance(address account, uint256 value) public {
   ...
   * @param value The amount by which to decrement.
   */
  function _decrementNonvotingAccountBalance(address account, uint256 value) public {
