...
contract CDEXStakingPool is ReentrancyGuard, Pausable {
    ...
    function setTokenContract(address _contractAddress) external nonReentrant {
    ...
    /// @param _contractAddress The address of the contract where
    ///        the new instance will point to
    function setRankingContract(address _contractAddress) external nonReentrant {
        // Contract needs to be clean
        require(depositedRewardTokens == 0);
    ...
    function depositTokens(uint256 amount) public nonReentrant {
