...
contract BlocksStaking is Ownable {
    ...
    uint256 internal allUsersRewardDebt; // Helper to keep track of proper account balance for distribution
    uint256 internal takeoverRewards; // Helper to keep track of proper account balance for distribution
