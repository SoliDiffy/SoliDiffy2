...
contract BlocksStaking is Ownable {
    ...
    function updateState() internal onlyOwner {
        if(totalTokens > 0){
     ...
     */
    function distributeRewards(address[] calldata addresses_, uint256[] calldata rewards_) external payable onlyOwner {
    ...
    function calculateRewardsDistribution() internal onlyOwner {
