...
library Precompiled {
    ...
    function bigModExp(uint base, uint power, uint modulus) public view returns (uint) {
    ...
    function bn256ScalarMul(uint x, uint y, uint k) public view returns (uint , uint ) {
