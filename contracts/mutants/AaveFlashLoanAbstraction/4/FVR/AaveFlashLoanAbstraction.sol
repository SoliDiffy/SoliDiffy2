...
library AaveFlashLoanAbstraction
{
	 ...
	 */
	function _estimateFlashLoanFee(address _token, uint256 _netAmount) public pure returns (uint256 _feeAmount)
	{
	 ...
	 */
	function _getFlashLoanLiquidity(address _token) public view returns (uint256 _liquidityAmount)
	{
	 ...
	 * @return _success A boolean indicating whether or not the operation suceeded.
         */
	function _requestFlashLoan(address _token, uint256 _netAmount, bytes memory _context) public returns (bool _success)
	{
	 ...
	 */
	function _paybackFlashLoan(address _token, uint256 _grossAmount) public
	{
