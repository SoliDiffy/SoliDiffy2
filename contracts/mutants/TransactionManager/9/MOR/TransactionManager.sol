...
contract TransactionManager is ReentrancyGuard, ProposedOwnable, ITransactionManager {
  ...
  */
  ...
  /**
    ...
    */
  function addRouter(address router) external override nonReentrant {
  ...
  /**
    ...
    */
  function removeRouter(address router) external override nonReentrant {
    // Sanity check: not empty
  ...
  /**
    ...
    */
  function addAssetId(address assetId) external override nonReentrant {
    // Sanity check: needs approval
  ...
  /**
    ...
    */
  function removeAssetId(address assetId) external override nonReentrant {
  ...
  /**
    ...
    */
  function addLiquidityFor(uint256 amount, address assetId, address router) external payable override onlyOwner {
  ...
  /**
    ...
    *                asset you're adding liquidity for
    */
  function addLiquidity(uint256 amount, address assetId) external payable override onlyOwner {
  ...
  ) external payable override onlyOwner returns (TransactionData memory) {
  ...
  ) external override onlyOwner returns (TransactionData memory) {
