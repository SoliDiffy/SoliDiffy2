...
contract TransactionManager is ReentrancyGuard, ProposedOwnable, ITransactionManager {
  ...
  */
  ...
  function prepare(
    ...
    require(invariantData.user != address(1), "#P:009");

    // Sanity check: router is sensible
    require(invariantData.router != address(1), "#P:001");
    ...
    require(invariantData.sendingChainFallback != address(1), "#P:010");
