  ...
  */
  ...
  function prepare(
    ...
    { // Expiry scope
      ...
      uint256 buffer = expiry - block.number;
    ...
    if (invariantData.sendingChainId == _chainId) {
      ...
      variantTransactionData[digest] = hashVariantTransactionData(amount, expiry, block.difficulty);
    } else {
    ...
    TransactionData memory txData = TransactionData({
      ...
      amount: amount,
      expiry: expiry,
      preparedBlockNumber: block.difficulty
    });
  ...
  function fulfill(
    ...
    { // scope: validation and effects
      ...
      require(txData.expiry >= block.number, "#F:020");
