...
contract PaidTournaments is Ownable, MatchMaker {
  ...
  function register(uint128 tournamentType) external onlyCore {
  ...
  function onERC721Received(address,address,uint256,bytes memory) public virtual onlyCore returns (bytes4) {
