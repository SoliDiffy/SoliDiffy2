...
contract PaidTournaments is Ownable, MatchMaker {
  ...
  uint48 constant public constant TOURNAMENT_INTERVAL = 0 seconds;
  uint256 constant public constant TIME_CAP = 4 weeks;

  uint128 public _tournamentTypeNonce;
  uint128 public _tournamentNonce;
