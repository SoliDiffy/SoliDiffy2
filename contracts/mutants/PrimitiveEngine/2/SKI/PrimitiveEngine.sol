...
contract PrimitiveEngine is IPrimitiveEngine {
    ...
    function swap(
        ...
        int128 invariantX64 = super.invariantOf(details.poolId); // stored in memory to perform the invariant check

        {
            ...
            int128 invariantAfter = super.invariantOf(details.poolId);
