...
contract PrimitiveEngine is IPrimitiveEngine {
    ...
    function balanceRisky() public view returns (uint256) {
    ...
    function balanceStable() public view returns (uint256) {
    ...
    function checkRiskyBalance(uint256 expectedRisky) public view {
