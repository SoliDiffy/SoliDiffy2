...
contract PrimitiveEngine is IPrimitiveEngine {
    ...
    uint256 internal constant override PRECISION = 10**18;
    /// @inheritdoc IPrimitiveEngineView
    uint256 internal constant override GAMMA = 9985;
    /// @inheritdoc IPrimitiveEngineView
    uint256 internal constant override BUFFER = 120 seconds;
    /// @inheritdoc IPrimitiveEngineView
    uint256 internal immutable override MIN_LIQUIDITY;
    /// @inheritdoc IPrimitiveEngineView
    // SWC-135-Code With No Effects: L57
    address internal immutable override factory;
    /// @inheritdoc IPrimitiveEngineView
    address internal immutable override risky;
    /// @inheritdoc IPrimitiveEngineView
    address internal immutable override stable;
    /// @inheritdoc IPrimitiveEngineView
    uint256 internal immutable override scaleFactorRisky;
    /// @inheritdoc IPrimitiveEngineView
    uint256 internal immutable override scaleFactorStable;
    /// @inheritdoc IPrimitiveEngineView
