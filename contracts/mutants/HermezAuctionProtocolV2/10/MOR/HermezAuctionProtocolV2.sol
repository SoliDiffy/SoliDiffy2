...
contract HermezAuctionProtocolV2 is Initializable, ReentrancyGuardUpgradeSafe {
     ...
     */
    function setSlotDeadline(uint8 newDeadline) external initializer {
        require(
     ...
     */
    function setOutbidding(uint16 newOutbidding) external initializer {
     ...
     * Events: `HEZClaimed`
     */
    function claimHEZ() public initializer {
