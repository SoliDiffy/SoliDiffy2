...
contract ClosePosition is IClosePosition {
        ...
        )
    {
        ...
        INonfungiblePositionManager.DecreaseLiquidityParams storage decreaseliquidityparams = INonfungiblePositionManager
        ...
        INonfungiblePositionManager.CollectParams storage collectparams = INonfungiblePositionManager.CollectParams({
            tokenId: tokenId,
