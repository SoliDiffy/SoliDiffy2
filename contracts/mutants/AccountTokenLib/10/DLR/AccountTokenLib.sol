...
library AccountTokenLib {
    ...
    function borrow(TokenInfo memory self, uint256 amount, uint256 accruedRate, uint256 _block) public {
     ...
     */
    function withdraw(TokenInfo memory self, uint256 amount, uint256 accruedRate, uint256 _block) public {
