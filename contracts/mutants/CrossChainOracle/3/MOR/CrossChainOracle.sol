...
contract CrossChainOracle is Owned {
    ...
    function setPrice(address token_address, uint256 price_e6) public onlyByOwnGov {
        prices[token_address] = price_e6;
    }

    // Batch set prices for multiple tokens
    function setMultiplePrices(address[] memory token_addresses, uint256[] memory prices_e6) public onlyByOwnGov {
