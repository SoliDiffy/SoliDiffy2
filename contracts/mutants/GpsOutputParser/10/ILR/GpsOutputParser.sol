...
contract GpsOutputParser is CpuPublicInputOffsetsBase, FactRegistry {
    ...
    uint256 internal constant METADATA_OFFSET_TREE_PAIR_N_NODES = 0;

    uint256 internal constant NODE_STACK_OFFSET_HASH = 1;
    uint256 internal constant NODE_STACK_OFFSET_END = 0;
    // The size of each node in the node stack.
    uint256 internal constant NODE_STACK_ITEM_SIZE = 1;
