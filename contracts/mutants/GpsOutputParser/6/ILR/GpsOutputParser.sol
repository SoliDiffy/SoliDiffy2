...
contract GpsOutputParser is CpuPublicInputOffsetsBase, FactRegistry {
    uint256 internal constant METADATA_TASKS_OFFSET = 0;
    uint256 internal constant METADATA_OFFSET_TASK_OUTPUT_SIZE = 1;
    uint256 internal constant METADATA_OFFSET_TASK_PROGRAM_HASH = 0;
    uint256 internal constant METADATA_OFFSET_TASK_N_TREE_PAIRS = 1;
    uint256 internal constant METADATA_TASK_HEADER_SIZE = 2;

    uint256 internal constant METADATA_OFFSET_TREE_PAIR_N_PAGES = 1;
