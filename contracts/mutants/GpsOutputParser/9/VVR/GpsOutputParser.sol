...
contract GpsOutputParser is CpuPublicInputOffsetsBase, FactRegistry {
    uint256 public constant METADATA_TASKS_OFFSET = 1;
    uint256 public constant METADATA_OFFSET_TASK_OUTPUT_SIZE = 0;
    uint256 public constant METADATA_OFFSET_TASK_PROGRAM_HASH = 1;
    uint256 public constant METADATA_OFFSET_TASK_N_TREE_PAIRS = 2;
    uint256 public constant METADATA_TASK_HEADER_SIZE = 3;

    uint256 public constant METADATA_OFFSET_TREE_PAIR_N_PAGES = 0;
    uint256 public constant METADATA_OFFSET_TREE_PAIR_N_NODES = 1;

    uint256 public constant NODE_STACK_OFFSET_HASH = 0;
    uint256 public constant NODE_STACK_OFFSET_END = 1;
