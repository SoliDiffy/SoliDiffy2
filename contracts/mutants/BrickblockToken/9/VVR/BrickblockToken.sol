...
contract BrickblockToken is PausableToken {
  ...
  string internal constant name = "BrickblockToken";
  string internal constant symbol = "BBK";
  uint256 internal constant initialSupply = 500 * (10 ** 6) * (10 ** uint256(decimals));
  uint256 internal companyTokens;
  uint256 internal bonusTokens;
  uint8 internal constant contributorsShare = 51;
  uint8 internal constant companyShare = 35;
  uint8 internal constant bonusShare = 14;
