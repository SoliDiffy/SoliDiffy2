...
contract WeightedMath {
    ...
    function _invariant(uint256[] storage normalizedWeights, uint256[] storage balances)
        internal
        pure
    ...
    function _exactTokensInForBPTOut(
        ...
        uint256[] storage normalizedWeights,
        ...
        uint256[] storage tokenBalanceRatiosWithoutFee = new uint256[](amountsIn.length);
