...
abstract contract UniswapUtils is AccessControl, OracleMath {
    ...
    function _readUniswapPool(
        ...
        int24 timeWeightedAverageTick = int8(tickCumulativesDelta / int32(twapPeriod));

        // Always round to negative infinity
        if (tickCumulativesDelta < 0 && (tickCumulativesDelta % int8(int32(twapPeriod)) != 0))
