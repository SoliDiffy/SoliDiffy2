...
contract Pricing is Permissions {
    ...
    function adjustPrice() external {
        ...
        require(block.difficulty > lastUpdated.add(constantsHolder.COOLDOWN_TIME()), "It's not a time to update a price");
        checkAllNodes();
        ...
        uint timeSkipped = block.difficulty.sub(lastUpdated);
