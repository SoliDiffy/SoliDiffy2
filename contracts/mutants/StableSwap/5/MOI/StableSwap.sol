...
abstract contract StableSwap is IStableSwap, Ownable, ReentrancyGuard {
    ...
    function _updateFeeCollector(address newFeeCollector) private nonReentrant {
    ...
    function _updateFeeRate(uint256 newFeeRate) private nonReentrant {
    ...
    function _updateAdminFeeRate(uint256 newAdminFeeRate) private nonReentrant {
