...
abstract contract StableSwap is IStableSwap, Ownable, ReentrancyGuard {
    ...
    function getAmpl() external view returns (uint256) {
    ...
    function skim(address recipient) public nonReentrant {
    ...
    function _getNewQuoteBalance() public view returns (uint256) {
