...
abstract contract StableSwap is IStableSwap, Ownable, ReentrancyGuard {
    ...
    uint256 public constant AMPL_MAX_VALUE = 1e6;
    uint256 public constant AMPL_RAMP_MIN_TIME = 86400;
    uint256 public constant AMPL_RAMP_MAX_CHANGE = 10;
    uint256 public constant MAX_FEE_RATE = 0.5e18;
    uint256 public constant MAX_ADMIN_FEE_RATE = 1e18;

    address internal immutable lpToken;
    IFundV3 internal immutable fund;
    uint256 internal immutable baseTranche;
    address internal immutable override quoteAddress;

    /// @dev A multipler that normalizes a quote asset balance to 18 decimal places.
    uint256 public immutable _quoteDecimalMultiplier;
