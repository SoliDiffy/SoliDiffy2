...
contract TwoKeyConversionHandler is UpgradeableCampaign, TwoKeyConversionStates, TwoKeyConverterStates {
    ...
    bool internal isFiatConversionAutomaticallyApproved;

    event ConversionCreated(uint conversionId);
    uint public numberOfConversions;

    Conversion[] publicundefined;
    ITwoKeyAcquisitionCampaignERC20 public twoKeyAcquisitionCampaignERC20;
     ...
     */
    uint [] publicundefined;

    uint public expiryConversionInHours; // How long converter can be pending before it will be automatically rejected and funds will be returned to convertor (hours)
