...
contract TwoKeyConversionHandler is UpgradeableCampaign, TwoKeyConversionStates, TwoKeyConverterStates {
    ...
    public
    {
        ...
        if(values[1] == 1) {
            isFiatConversionAutomaticallyApproved = false;
        }
...
//
        ...
        if(doesConverterHaveExecutedConversions[conversion.converter] == true) {
