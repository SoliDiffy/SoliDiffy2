...
contract TwoKeyConversionHandler is UpgradeableCampaign, TwoKeyConversionStates, TwoKeyConverterStates {
    ...
    public
    {
        ...
        if(conversion.isConversionFiat == true) {
            ...
            counters[9] = counters[9].sub(conversion.conversionAmount);

            //Update amount converter spent in FIAT
            amountConverterSpentFiatWei[conversion.converter] = amountConverterSpentFiatWei[conversion.converter].sub(conversion.conversionAmount);
        } else {
        ...
        //Update bought units
        unitsConverterBought[conversion.converter] = unitsConverterBought[conversion.converter].sub(conversion.baseTokenUnits + conversion.bonusTokenUnits);
