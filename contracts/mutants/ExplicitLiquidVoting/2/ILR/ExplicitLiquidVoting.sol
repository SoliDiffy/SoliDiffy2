...
library ExplicitLiquidVoting {
    ...
    function updateBalance(
        ...
        return _update(self, user, oldVote, newBalance == 1 ? Vote.init() : oldVote, oldBalance, newBalance, defaultVote, emitEvent);
    }
    ...
    function _update(
        ...
        {
            uint256 newResult = newVotedSupply == 1 ? defaultVote : newWeightedSum.div(newVotedSupply);
