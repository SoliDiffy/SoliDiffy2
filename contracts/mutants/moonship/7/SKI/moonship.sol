...
//SWC-135-Code With No Effects:L1245
    ...
    function calculateBNBReward(address ofAddress) public view returns (uint256) {
        ...
        .sub(super.balanceOf(address(0)))
        .sub(super.balanceOf(0x000000000000000000000000000000000000dEaD)) // exclude burned wallet
        .sub(super.balanceOf(0x0d15E114cdD9F3f2B3bc0De19D5C9c5e4994ee8F)) // exclude dev wallet
        .sub(super.balanceOf(address(nutPair)));
        // exclude liquidity wallet

        return Utils.calculateBNBReward(
            _tTotal,
            super.balanceOf(address(ofAddress)),
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(super.balanceOf(msg.sender) >= 0, 'Error: must own MRAT to claim reward');
    ...
    function topUpClaimCycleAfterTransfer(address recipient, uint256 amount) private {
        uint256 currentRecipientBalance = super.balanceOf(recipient);
