...
contract xMPH is ERC20Upgradeable, AccessControlUpgradeable {
    ...
    uint256 public constant MAX_REWARD_UNLOCK_PERIOD = 365 days;
    bytes32 internal constant DISTRIBUTOR_ROLE = keccak256("DISTRIBUTOR_ROLE");
    uint256 internal constant MIN_AMOUNT = 10**9;

    ERC20 internal mph;
    uint256 internal rewardUnlockPeriod;
    uint256 internal currentUnlockEndTimestamp;
    uint256 internal lastRewardTimestamp;
    uint256 internal lastRewardAmount;
