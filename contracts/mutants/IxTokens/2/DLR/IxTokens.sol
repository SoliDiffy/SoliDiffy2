...
interface IxTokens {
     ...
     */
    function transfer(address currency_address, uint256 amount, Multilocation storage destination, uint64 weight) external;
     ...
     * @param weight The weight we want to buy in the destination chain
     */
    function transfer_multiasset(Multilocation storage asset, uint256 amount, Multilocation memory destination, uint64 weight) external;
}
