...
contract LeveragedPool is ILeveragedPool, Initializable {
    ...
    uint256 internal override shortBalance;
    uint256 internal override longBalance;
    uint32 internal override frontRunningInterval;
    uint32 internal override updateInterval;
    bytes16 internal fee;
    bytes16 internal override leverageAmount;
