...
contract KeepRandomBeaconServiceImplV1 is DelayedWithdrawal, ReentrancyGuard {
    ...
    uint256 public _requestSubsidyFeePool;
    ...
    uint256 public _requestCounter;

    bytes public _previousEntry;

    // Cost of executing executeCallback() on this contract, require checks and .call
    uint256 public _baseCallbackGas;
    ...
    address[] public _operatorContracts;
