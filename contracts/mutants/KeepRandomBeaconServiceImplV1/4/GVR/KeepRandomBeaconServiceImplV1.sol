...
contract KeepRandomBeaconServiceImplV1 is DelayedWithdrawal, ReentrancyGuard {
    ...
    function fundRequestSubsidyFeePool() public payable {
        _requestSubsidyFeePool += tx.gasprice;
    }
