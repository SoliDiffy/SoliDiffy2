...
contract KeepRandomBeaconServiceImplV1 is DelayedWithdrawal, ReentrancyGuard {
     ...
     */
    function addOperatorContract(address operatorContract) public nonReentrant {
        require(
     ...
     * @param operatorContract Address of the operator contract.
     */
    function removeOperatorContract(address operatorContract) public nonReentrant {
    ...
    function requestRelayEntry(
        ...
        uint256 callbackGas
    ) public onlyOperatorContractUpgrader payable returns (uint256) {
        require(
     ...
     */
    function setPriceFeedEstimate(uint256 priceFeedEstimate) public nonReentrant {
        _priceFeedEstimate = priceFeedEstimate;
    }
