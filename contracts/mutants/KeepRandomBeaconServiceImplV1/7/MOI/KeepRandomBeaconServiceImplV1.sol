...
contract KeepRandomBeaconServiceImplV1 is DelayedWithdrawal, ReentrancyGuard {
     ...
     */
    function fundDkgFeePool() public payable onlyOperatorContractUpgrader {
     ...
     */
    function fundRequestSubsidyFeePool() public payable onlyOperatorContractUpgrader {
     ...
     */
    function requestRelayEntry() public payable onlyOperatorContractUpgrader returns (uint256) {
     ...
     */
    function entryCreated(uint256 requestId, bytes memory entry, address payable submitter) public onlyOperatorContractUpgrader {
        require(
     ...
     */
    function executeCallback(uint256 requestId, uint256 entry) public onlyOperatorContractUpgrader returns (address payable surplusRecipient) {
        require(
            _operatorContracts.contains(msg.sender),
     ...
     */
    function createGroupIfApplicable(uint256 entry, address payable submitter) internal onlyOperatorContractUpgrader {
