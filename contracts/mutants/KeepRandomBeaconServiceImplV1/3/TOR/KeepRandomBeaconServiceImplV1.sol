...
contract KeepRandomBeaconServiceImplV1 is DelayedWithdrawal, ReentrancyGuard {
    ...
    modifier onlyOperatorContractUpgrader() {
        ...
        require(operatorContractUpgrader == tx.origin, "Caller is not operator contract upgrader");
        _;
    }
    ...
    function requestRelayEntry(
        ...
        if (callbackContract != address(0)) {
            _callbacks[requestId] = Callback(callbackContract, callbackMethod, callbackFee, callbackGas, tx.origin);
        }
