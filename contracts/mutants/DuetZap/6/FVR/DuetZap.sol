...
contract DuetZap is OwnableUpgradeable {
    ...
    /* ========== INITIALIZER ========== */
    function initialize(address _controller, address _factory, address _router, address _wbnb) public initializer {
        __Ownable_init();
    ...
    /* ========== External Functions ========== */
    function tokenToLp(address _token, uint amount, address _lp, bool needDeposit) public {
    ...
    function coinToLp(address _lp, bool needDeposit) public payable returns (uint liquidity){
        if (!needDeposit) {
    ...
    function tokenToToken(address _token, uint _amount, address _to, bool needDeposit) public returns (uint amountOut){
    ...
    // unpack lp 
    function zapOut(address _from, uint _amount) public {
