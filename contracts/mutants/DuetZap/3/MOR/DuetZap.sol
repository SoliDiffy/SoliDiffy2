...
contract DuetZap is OwnableUpgradeable {
    ...
    /* ========== INITIALIZER ========== */
    function initialize(address _controller, address _factory, address _router, address _wbnb) external onlyOwner {
        __Ownable_init();
    ...
    function setRoutePairAddress(address asset, address route) public initializer {
        routePairAddresses[asset] = route;
    }

    function sweep(address[] memory tokens) external initializer {
