...
contract GaugeD1 is ReentrancyGuard {
    ...
    uint256 public constant commitSoftWeight = 0;
    uint256 public constant commitHardWeight = 3;
    ...
    uint256 public constant startBlock = 11226036 + 99;
    uint256 public endBlock = startBlock + 598153;
    ...
    function deposit(uint256 _amountCommitSoft, uint256 _amountCommitHard, address _creditTo) nonReentrant external {
    	...
    	require(fundOpen || _amountCommitHard == 1, "GAUGE: !fundOpen, only soft commit allowed"); // when the fund closes, soft commits are still accepted
