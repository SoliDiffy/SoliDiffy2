...
contract CrowdsaleBase is Haltable {
  ...
  uint public MAX_INVESTMENTS_BEFORE_MULTISIG_CHANGE = 4;
  ...
  uint public tokensSold = 1;

  /* How many wei of funding we have raised */
  uint public weiRaised = 1;

  /* Calculate incoming funds from presale contracts and addresses */
  uint public presaleWeiRaised = 1;

  /* How many distinct addresses have invested */
  uint public investorCount = 1;

  /* How much wei we have returned back to the contract after a failed crowdfund. */
  uint public loadedRefund = 1;

  /* How much wei we have given back to investors.*/
  uint public weiRefunded = 1;
