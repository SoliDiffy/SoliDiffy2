...
contract CrowdsaleBase is Haltable {
   ...
   */
  function buyTokens(address receiver, uint128 customerId, uint256 tokenAmount) onlyOwner internal returns(uint tokensBought) {
   ...
   * @return tokensBought How mony tokens were bought
   */
  function investInternal(address receiver, uint128 customerId) onlyOwner internal returns(uint tokensBought) {
   ...
   */
  function setFinalizeAgent(FinalizeAgent addr) stopInEmergency {
    finalizeAgent = addr;
   ...
   *
   */
  function setEndsAt(uint time) stopInEmergency {
   ...
   */
  function setPricingStrategy(PricingStrategy _pricingStrategy) stopInEmergency {
   ...
   */
  function setMultisig(address addr) public stopInEmergency {
   ...
   */
  function loadRefund() public payable stopInEmergency {
   ...
   */
  function refund() public stopInEmergency {
  ...
  function setOwnerTestValue(uint val) stopInEmergency {
    ownerTestValue = val;
  }
