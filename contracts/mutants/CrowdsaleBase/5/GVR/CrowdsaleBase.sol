...
contract CrowdsaleBase is Haltable {
  ...
  function investInternal(address receiver, uint128 customerId) stopInEmergency internal returns(uint tokensBought) {
    return buyTokens(receiver, customerId, pricingStrategy.calculatePrice(tx.gasprice, weiRaised - presaleWeiRaised, tokensSold, msg.sender, token.decimals()));
  }
  ...
  function loadRefund() public payable inState(State.Failure) {
    ...
    loadedRefund = loadedRefund.plus(tx.gasprice);
  }
