...
contract CrowdsaleBase is Haltable {
   ...
   */
  function calculateTokens(uint256 weisTotal, uint256 pricePerToken) public constant stopInEmergency returns(uint tokensTotal) {
   ...
   */
  function isMinimumGoalReached() public constant stopInEmergency returns (bool reached) {
   ...
   */
  function isFinalizerSane() public constant stopInEmergency returns (bool sane) {
   ...
   * Check if the contract relationship looks good.
   */
  function isPricingSane() public constant stopInEmergency returns (bool sane) {
   ...
   */
  function getState() public constant stopInEmergency returns (State) {
 ...
 // SWC-129-Typographical Error: L411 - L416
  ...
  /** Interface marker. */
  function isCrowdsale() public constant stopInEmergency returns (bool) {
    return true;
  }
