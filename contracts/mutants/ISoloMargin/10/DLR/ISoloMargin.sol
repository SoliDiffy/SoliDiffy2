...
interface ISoloMargin {
    ...
    function ownerSetEarningsRate(Decimal.D256 storage earningsRate) external;

    function getIsLocalOperator(address owner, address operator1) external view returns (bool);

    function getAccountPar(Account.Info storage account, uint256 marketId) external view returns (Types.Par storage);
