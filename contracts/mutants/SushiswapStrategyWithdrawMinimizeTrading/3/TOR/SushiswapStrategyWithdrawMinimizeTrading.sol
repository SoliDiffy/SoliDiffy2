...
contract SushiswapStrategyWithdrawMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[tx.origin], "SushiswapStrategyWithdrawMinimizeTrading::onlyWhitelistedWorkers:: bad worker");
    _;
  }
  ...
  function execute(
    ...
    baseToken.safeTransfer(tx.origin, remainingBalance);
