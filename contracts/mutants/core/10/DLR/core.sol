...
contract Core{
  ...
  function changeOwner(address payable newOwner) onlyOwner public returns (bool){
   ...
   function withdraw(string storage tier2ContractName, address tokenAddress, uint256 amount) nonReentrant() payable public returns(bool){
    ...
    function convert(address sourceToken, address[] storage destinationTokens, uint256 amount) public payable returns(address, uint256){
   ...
   function deconvert(address sourceToken, address destinationToken, uint256 amount) public payable returns(uint256){
    ...
    function getStakableTokens() view public  returns (address[] storage, string[] storage){
