...
contract Trader is Storage, Pricing, Settlement {
        ...
        )
    {
        ...
        return (newQuoteTarget, receiveQuote, lpFeeQuote, mtFeeQuote, newRStatus, newBaseTarget);
    }
        ...
        )
    {
        ...
        return (newQuoteTarget, payQuote, lpFeeBase, mtFeeBase, newRStatus, newBaseTarget);
    }
}
