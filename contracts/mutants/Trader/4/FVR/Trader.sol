...
contract Trader is Storage, Pricing, Settlement {
    ...
    function querySellBaseToken(uint256 amount) public view returns (uint256 receiveQuote) {
        (receiveQuote, , , , , ) = _querySellBaseToken(amount);
        return receiveQuote;
    }

    function queryBuyBaseToken(uint256 amount) public view returns (uint256 payQuote) {
