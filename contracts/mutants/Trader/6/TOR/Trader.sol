...
contract Trader is Storage, Pricing, Settlement {
        ...
        returns (uint256)
    {
        ...
        _quoteTokenTransferOut(tx.origin, receiveQuote);
        ...
        emit SellBaseToken(tx.origin, amount, receiveQuote);
        ...
        returns (uint256)
    {
        ...
        // settle assets
        _quoteTokenTransferIn(tx.origin, payQuote);
        _baseTokenTransferOut(tx.origin, amount);
        ...
        emit BuyBaseToken(tx.origin, amount, payQuote);
