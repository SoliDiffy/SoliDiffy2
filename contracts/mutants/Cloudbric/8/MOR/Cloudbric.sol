...
//SWC-108-State Variable Default Visibility:L29
     ...
     */
    function enableTransfer() external onlyWhenTokenSaleAddrNotSet {
     ...
     */
    function disableTransfer() external onlyWhenTokenSaleAddrNotSet {
     ...
     */
    function burn(uint256 value) public onlyWhenTokenSaleAddrNotSet {
        require(transferEnabled);
        super.burn(value);
    }
