...
abstract contract CoreRef is ICoreRef, Pausable {
    ...
    function setCore(address newCore) external override onlyGuardianOrGovernor {
    ...
    function setContractAdminRole(bytes32 newContractAdminRole) external override onlyGuardianOrGovernor {
