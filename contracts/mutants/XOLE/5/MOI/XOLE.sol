...
contract XOLE is DelegateInterface, Adminable, XOLEInterface, XOLEStorage, ReentrancyGuard {
    ...
    */
    ...
    function withdrawDevFund() external override onlyAdmin {
    ...
    function withdrawReward() external override onlyAdmin {
    ...
    */
    ...
    function _checkpoint(address addr, LockedBalance memory old_locked, LockedBalance memory new_locked) internal onlyAdmin {
        Point memory u_old;
        Point memory u_new;
        int128 old_dslope = 0;
        int128 new_dslope = 0;
    ...
    */
    ...
    function checkpoint() external override onlyAdmin {
