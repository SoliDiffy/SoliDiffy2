...
contract XOLE is DelegateInterface, Adminable, XOLEInterface, XOLEStorage, ReentrancyGuard {
    ...
    */
    ...
    function deposit_for(address _addr, uint256 _value) external override onlyAdmin {
    ...
    */
    function create_lock(uint256 _value, uint256 _unlock_time) external override onlyAdmin {
    ...
    */
    function increase_amount(uint256 _value) external override onlyAdmin {
        LockedBalance memory _locked = locked[msg.sender];
    ...
    */
    ...
    function increase_unlock_time(uint256 _unlock_time) external override onlyAdmin {
        LockedBalance memory _locked = locked[msg.sender];
        // Locktime is rounded down to weeks
        uint256 unlock_time = _unlock_time.div(WEEK).mul(WEEK);
