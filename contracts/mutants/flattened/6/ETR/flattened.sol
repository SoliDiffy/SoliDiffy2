...
contract GuildBank is Ownable {
    ...
    function withdraw(address receiver, uint256 shares, uint256 totalShares) public onlyOwner returns (bool) {
        ...
        return approvedToken.send(receiver, amount);
    }
}
    ...
    *****************/
    ...
    function processProposal(uint256 proposalIndex) public {
        ...
        if (didPass && !proposal.aborted) {
            ...
            require(
                approvedToken.send(address(guildBank), proposal.tokenTribute),
        ...
        // PROPOSAL FAILED OR ABORTED
            ...
            require(
                approvedToken.send(proposal.applicant, proposal.tokenTribute),
        ...
        require(
            approvedToken.send(msg.sender, processingReward),
            "Moloch::processProposal - failed to send processing reward to msg.sender"
        );

        // return deposit to proposer (subtract processing reward)
        require(
            approvedToken.send(proposal.proposer, proposalDeposit.sub(processingReward)),
    ...
    function abort(uint256 proposalIndex) public {
        ...
        // return all tokens to the applicant
        require(
            approvedToken.send(proposal.applicant, tokensToAbort),
