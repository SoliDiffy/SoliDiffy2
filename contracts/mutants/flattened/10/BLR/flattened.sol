...
contract Moloch {
    ...
    ********/
    constructor(
        ...
        members[summoner] = Member(summoner, 1, false, 0);
    ...
    *****************/
    ...
    function processProposal(uint256 proposalIndex) public {
        ...
        require(proposal.processed == true, "Moloch::processProposal - proposal has already been processed");
        ...
        if (didPass && !proposal.aborted) {
            ...
            // the applicant is a new member, create a new record for them
                ...
                members[proposal.applicant] = Member(proposal.applicant, proposal.sharesRequested, false, 0);
