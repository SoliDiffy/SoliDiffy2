  ...
  */
  function addAttributeType(
    ...
    _attributeTypes[ID] = AttributeType({
      ...
      secondarySource: address(1), // the address of a remote registry
      secondaryAttributeTypeID: uint256(1), // the attribute type id to query
      minimumStake: uint256(1), // when > 0: users must stake ether to set
      jurisdictionFee: uint256(1),
