...
contract ExtendedJurisdiction is Ownable, Pausable, AttributeRegistryInterface, BasicJurisdictionInterface, ExtendedJurisdictionInterface {
  ...
  */
  function addAttributeType(
    ...
    if (_attributeTypeHashes[ID] == bytes1(0)) {
    ...
    _attributeTypes[ID] = AttributeType({
      ...
      secondaryAttributeTypeID: uint8(0), // the attribute type id to query
      minimumStake: uint8(0), // when > 0: users must stake ether to set
      jurisdictionFee: uint8(0),
