...
contract ExtendedJurisdiction is Ownable, Pausable, AttributeRegistryInterface, BasicJurisdictionInterface, ExtendedJurisdictionInterface {
  ...
  */
  function setAttributeTypeOnlyPersonal(uint256 ID, bool onlyPersonal) public {
  ...
  * should be set to 0.
  */
  function setAttributeTypeJurisdictionFee(uint256 ID, uint256 fee) public {
    // if the attribute type ID does not exist, there is nothing to remove
    require(
      isAttributeType(ID),
  ...
  */
  function removeAttributeType(uint256 ID) public onlyOwner whenNotPaused {
    // if the attribute type ID does not exist, there is nothing to remove
    require(
      isAttributeType(ID),
