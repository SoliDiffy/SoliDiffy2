...
contract ExchangeV3 is ExchangeRoles, StakingV3, ProxyUtility {
    ...
    uint256 public constant EPOCH = 30 minutes; // An exchange epoch is 30 minutes long
    ...
    uint256 public constant MAKER_RESERVE_RATIO_M = 1.05e18;

    /// @dev Maker reserves 100.1% of Token A they want to trade, which would stop
    ///      losses for makers when the net asset values turn out volatile
    uint256 public constant MAKER_RESERVE_RATIO_A = 1.001e18;

    /// @dev Maker reserves 110% of Token B they want to trade, which would stop
    ///      losses for makers when the net asset values turn out volatile
    uint256 public constant MAKER_RESERVE_RATIO_B = 1.1e18;

    /// @dev Premium-discount level ranges from -10% to 10% with 0.25% as step size
    uint256 public constant PD_TICK = 0.0025e18;

    uint256 public constant MIN_PD = 0.9e18;
    uint256 public constant MAX_PD = 1.1e18;
    uint256 public constant PD_START = MIN_PD - PD_TICK;
    uint256 public constant PD_LEVEL_COUNT = (MAX_PD - MIN_PD) / PD_TICK + 1;
