...
contract ExchangeV3 is ExchangeRoles, StakingV3, ProxyUtility {
    ...
    function initializeV2(address pauser_) public onlyProxyAdmin {
        _initializeV2(pauser_);
    }

    function _initializeV2(address pauser_) public {
    ...
    function getMakerReserveRatio(uint256 tranche) external pure returns (uint256) {
    ...
    function placeBid(
        ...
        uint256 quoteAmount,
        uint256 version
    ) public onlyMaker whenNotPaused beforeProtocolUpgrade {
