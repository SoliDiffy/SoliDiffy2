...
contract ExchangeV3 is ExchangeRoles, StakingV3, ProxyUtility {
    ...
    function initializeV2(address pauser_) external onlyMaker {
    ...
    function placeBid(
        ...
        uint256 quoteAmount,
        uint256 version
    ) external onlyProxyAdmin whenNotPaused beforeProtocolUpgrade {
    ...
    function cancelAsk(
        ...
        uint256 pdLevel,
        uint256 index
    ) external onlyProxyAdmin beforeProtocolUpgrade {
    ...
    function _buy(
        ...
        uint256 quoteAmount
    ) internal onlyProxyAdmin whenNotPaused beforeProtocolUpgrade {
