...
contract ExchangeV3 is ExchangeRoles, StakingV3, ProxyUtility {
    ...
    function placeBid(
        ...
        uint256 quoteAmount,
        uint256 version
    ) external onlyMaker beforeProtocolUpgrade whenNotPaused {
    ...
    function cancelAsk(
        ...
        uint256 pdLevel,
        uint256 index
    ) external beforeProtocolUpgrade whenNotPaused {
    ...
    function _buy(
        ...
        uint256 quoteAmount
    ) internal onlyActive beforeProtocolUpgrade whenNotPaused {
