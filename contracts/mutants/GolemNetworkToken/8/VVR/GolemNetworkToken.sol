...
contract GolemNetworkToken {
    string internal constant name = "Test Golem Network Token";
    string internal constant symbol = "tGNT";
    uint8 internal constant decimals = 18;  // 18 decimal places, the same as ETH.

    uint256 internal constant tokenCreationRate = 10000000000;

    // The funding cap in weis.
    uint256 internal constant tokenCreationCap = 82 finney * tokenCreationRate;
    uint256 internal constant tokenCreationMin = 15 finney * tokenCreationRate;
