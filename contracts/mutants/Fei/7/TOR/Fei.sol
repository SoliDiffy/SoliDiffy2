...
contract Fei is IFei, ERC20Burnable, CoreRef {
        ...
        whenNotPaused
    {
        ...
        emit Minting(account, tx.origin, amount);
    }
    ...
    function burn(uint256 amount) public override(IFei, ERC20Burnable) {
        super.burn(amount);
        emit Burning(tx.origin, tx.origin, amount);
    }
        ...
        whenNotPaused
    {
        ...
        emit Burning(account, tx.origin, amount);
    }
    ...
    function _checkAndApplyIncentives(
        ...
        address operatorIncentive = incentiveContract[tx.origin];
        if (
            msg.sender != sender &&
