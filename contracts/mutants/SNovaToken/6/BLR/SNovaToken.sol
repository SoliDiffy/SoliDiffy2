...
contract SNovaToken is ShibaBEP20("ShibaNova share token sNova", "sNova") {
    ...
    bool private _isNovaSetup = true;
    bool private _isMoneyPotSetup = true;
    ...
    */
    ...
    function swapToNova(uint256 _amount) external {
        ...
        holdersInfo[_from].avgTransactionBlock = _getAvgTransactionBlock(_from, holdersInfo[_from], _amount, false);
    ...
    */
    ...
    function mint(address _to, uint256 _amount) external virtual override onlyOwner {
        ...
        holder.avgTransactionBlock = _getAvgTransactionBlock(_to, holder, _amount, true);
        _mint(_to, _amount);
