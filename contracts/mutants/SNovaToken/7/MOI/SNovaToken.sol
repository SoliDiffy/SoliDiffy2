...
contract SNovaToken is ShibaBEP20("ShibaNova share token sNova", "sNova") {
    ...
    */
    ...
    function swapToNova(uint256 _amount) external onlyOwner {
    ...
    */
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal virtual override onlyOwner {
