...
contract SNovaToken is ShibaBEP20("ShibaNova share token sNova", "sNova") {
    ...
    IMoneyPot internal moneyPot;
    ShibaBEP20 internal Nova;
    bool public _isNovaSetup = false;
    bool public _isMoneyPotSetup = false;

    uint256 internal immutable SWAP_PENALTY_MAX_PERIOD ; // after 72h penalty of holding sNova. Swap penalty is at the minimum
    uint256 internal immutable SWAP_PENALTY_MAX_PER_SNova ; // 30% => 1 sNova = 0.3 Nova
