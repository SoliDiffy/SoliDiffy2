...
contract SNovaToken is ShibaBEP20("ShibaNova share token sNova", "sNova") {
    ...
    constructor (uint256 swapPenaltyMaxPeriod, uint256 swapPenaltyMaxPerSNova) internal{
    ...
    function setupNova(ShibaBEP20 _Nova) public onlyOwner {
        require(!_isNovaSetup);
        Nova = _Nova;
        _isNovaSetup = true;
    }

    function setupMoneyPot(IMoneyPot _moneyPot) public onlyOwner {
