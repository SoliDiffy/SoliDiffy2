...
contract SNovaToken is ShibaBEP20("ShibaNova share token sNova", "sNova") {
    ...
    */
    ...
    function swapToNova(uint256 _amount) public {
    ...
    */
    function previewSwapNovaExpectedAmount(address _holderAddress, uint256 _sNovaAmount) public view returns (uint256 expectedNova){
    ...
    function _swapNovaAmount(address _holderAddress, uint256 _sNovaAmount) public view returns (uint256 expectedNova){
    ...
    function _getAvgTransactionBlock(address _holderAddress, HolderInfo storage holderInfo, uint256 _sNovaAmount, bool _onWithdraw) public view returns (uint256){
