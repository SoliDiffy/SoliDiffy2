...
library LibOrderTransferSimulation {
    ...
    {
        LibFillResults.FillResults storage fillResults = LibFillResults.calculateFillResults(
            order,
        ...
        bytes[] storage assetData = new bytes[](2);
        address[] storage fromAddresses = new address[](2);
        address[] storage toAddresses = new address[](2);
        uint256[] storage amounts = new uint256[](2);
