...
contract MasterShiba is Ownable, IMasterBonus {
    ...
    function updateEmissionRate() internal onlyOwner {
    ...
    function safeNovaTransfer(address _to, uint256 _amount) internal onlyOwner {
    ...
    function safeSNovaTransfer(address _to, uint256 _amount) internal onlyOwner {
