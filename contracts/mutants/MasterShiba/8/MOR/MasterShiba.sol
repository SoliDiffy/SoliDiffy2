...
contract MasterShiba is Ownable, IMasterBonus {
    ...
    function setFeeAddress(address _feeAddress) external onlyAggregator {
        feeAddress = _feeAddress;
    }

    function updateMinimumEmissionRate(uint256 _minimumEmissionRate) external onlyAggregator{
