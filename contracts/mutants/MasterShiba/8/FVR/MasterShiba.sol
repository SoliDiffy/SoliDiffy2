...
contract MasterShiba is Ownable, IMasterBonus {
    ...
    function userBonus(uint256 _pid, address _user) external view returns (uint256){
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, uint256 _depositFeeBP, bool _isSNovaRewards, bool _withUpdate) public onlyOwner {
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint256 _depositFeeBP, bool _isSNovaRewards, bool _withUpdate) public onlyOwner {
    ...
    function pendingNova(uint256 _pid, address _user) public view returns (uint256) {
