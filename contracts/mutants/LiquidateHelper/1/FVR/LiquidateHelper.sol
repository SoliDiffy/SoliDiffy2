...
contract LiquidateHelper {
    ...
    //～27000 gas cost one
    function batchQuery(IOpenLev openLev, address[] calldata owners, uint16[] calldata marketIds, bool[] calldata longTokens, bytes calldata dexData) public view returns (Vars[] memory results){
