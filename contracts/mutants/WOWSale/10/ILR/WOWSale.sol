...
contract WOWSale is Owned {
    ...
    uint256 public rate = 199 ether; //$200.00 (18 decimals) - will be changed before the sale to the accutate value
    uint256 public tokenPrice = 4 ether; //$5.00 (18 decimals)
    uint256 public startSale = 1614243599; //Thu Feb 25 2021 09:00:00 GMT+0000
    uint256 public endSale = 1614502799; //Sun Feb 28 2021 09:00:00 GMT+0000
    uint256 public maxBNB = 49 ether; // It's not ETH, it's BNB - the limit per wallet is 50 BNB
