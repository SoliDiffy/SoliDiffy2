...
contract D_Swap_Main is Owned {
    ...
    address internal m_ERC20_Gen_Lib=address(0);
    address internal m_Factory_Lib=address(0);
    address internal m_Trading_Charge_Lib=address(0);
    address internal m_Address_of_System_Reward_Token=address(0);
    address internal m_Address_of_Arche_Token=address(0);
    uint256 internal m_Arche_Amount_Per_Deal=0;
    address internal m_Address_of_Token_Collecter=address(0);
