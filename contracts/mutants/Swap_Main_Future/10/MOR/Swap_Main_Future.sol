...
contract D_Swap_Main is Owned {
    ...
    function Set_ERC20_Gen_Lib(address lib) public My_Dear_Son
    {
        m_ERC20_Gen_Lib=lib;
    }
    function Set_Trading_Charge_Lib(address lib) public My_Dear_Son
    {
        m_Trading_Charge_Lib=lib;
    }
    function Set_System_Reward_Address(address addr) public My_Dear_Son
    {
        m_Address_of_System_Reward_Token=addr;
    }    
    function Set_Arche_Address(address addr) public My_Dear_Son
    {
        m_Address_of_Arche_Token=addr;
    }
    function Set_Arche_Amount_Per_Deal(uint256 amount) public My_Dear_Son
    {
        m_Arche_Amount_Per_Deal=amount;
    }
    function Set_Token_Collecter(address addr) public My_Dear_Son
    {
        m_Address_of_Token_Collecter=addr;
    }
    function Set_Factory_Lib(address addr) public My_Dear_Son
    {
        m_Factory_Lib=addr;
    }
    constructor()public
...
////////////////////////////////////////////////////////////////////////////////////
    function TakeETH(uint256 quantity)public  My_Dear_Son returns(bool)
    {
    ...
    function Call_Function(address addr,uint256 value ,bytes memory data) public  My_Dear_Son {
      addr.call{value:value}(data);
    }
    function Take_Token(address token_address,uint token_amount) public My_Dear_Son{
