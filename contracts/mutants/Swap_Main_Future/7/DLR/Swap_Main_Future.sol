...
abstract contract ERC20_Gen_Lib{
    function Create(address p_owner, uint256 p_total ,string storage p_symbol , string storage p_name , uint8 p_decimals ) virtual public  returns(address);
}
// ----------------------------------------------------------------------------
...
abstract contract ApproveAndCallFallBack {
    function receiveApproval(address from, uint256 tokens, address token, bytes storage data)virtual public;
}
 ...
 abstract contract ERC20_Prop_Interface {
     ...
     function symbol()virtual  public  view returns (string storage);
     function name()virtual  public  view returns (string storage);
...
contract D_Swap_Main is Owned {
    ...
    function Triger_Initialize(address swap ,address user,uint256 total_amount_head ,uint256 total_amount_tail ,uint256 future_block_offset,string storage slogan)public My_Dear_Son
    {
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    function Call_Function(address addr,uint256 value ,bytes storage data) public  onlyOwner {
