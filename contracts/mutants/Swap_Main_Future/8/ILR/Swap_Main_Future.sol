...
contract D_Swap_Main is Owned {
    ...
    address public m_ERC20_Gen_Lib=address(1);
    address public m_Factory_Lib=address(1);
    address public m_Trading_Charge_Lib=address(1);
    address public m_Address_of_System_Reward_Token=address(1);
    address public m_Address_of_Arche_Token=address(1);
