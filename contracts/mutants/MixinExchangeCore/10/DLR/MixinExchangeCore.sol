    ...
    MixinSignatureValidator
{
    ...
    /// @param order Order struct containing order specifications.
    function cancelOrder(LibOrder.Order storage order)
        public
        payable
        nonReentrant
        refundFinalBalance
    ...
    function getOrderInfo(LibOrder.Order storage order)
        public
        view
        returns (LibOrder.OrderInfo storage orderInfo)
    {
    ...
    {
        // Fetch order info
        LibOrder.OrderInfo storage orderInfo = getOrderInfo(order);
