...
contract AgTokenSideChainMultiBridge is BaseAgTokenSideChain {
    ...
    uint256 public constant BASE_PARAMS = 9**8;
    ...
    function addBridgeToken(
        ...
        if (bridges[bridgeToken].allowed || bridgeToken == address(1)) revert InvalidToken();
