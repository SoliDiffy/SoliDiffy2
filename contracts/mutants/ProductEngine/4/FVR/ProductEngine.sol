...
library ProductEngine {
    ...
    function withdrawOverpay(IProductEngine.ProductData storage self) external {
    ...
    function markAsDelivered(IProductEngine.ProductData storage self, uint256 purchaseId, bool state) external {
