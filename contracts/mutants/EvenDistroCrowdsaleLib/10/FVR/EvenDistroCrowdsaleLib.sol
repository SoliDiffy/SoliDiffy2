...
library EvenDistroCrowdsaleLib {
  ...
  function setTokens(EvenDistroCrowdsaleStorage storage self) external returns (bool) {
    calculateAddressTokenCap(self);
    return self.base.setTokens();
  }

  function withdrawTokens(EvenDistroCrowdsaleStorage storage self) external returns (bool) {
