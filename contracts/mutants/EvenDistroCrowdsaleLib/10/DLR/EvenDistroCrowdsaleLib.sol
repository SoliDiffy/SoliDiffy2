...
library EvenDistroCrowdsaleLib {
  ...
  function init(EvenDistroCrowdsaleStorage memory self,
                address _owner,
                uint256[] _saleData,
                uint256 _endTime,
                uint8 _percentBurn,
  ...
  function registerUser(EvenDistroCrowdsaleStorage memory self, address _registrant)
                        public
                        returns (bool)
  {
  ...
  function registerUsers(EvenDistroCrowdsaleStorage memory self, address[] _registrants)
                         public
                         returns (bool)
  {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  function unregisterUser(EvenDistroCrowdsaleStorage memory self, address _registrant)
                          public
                          returns (bool)
  {
    require((msg.sender == self.base.owner) || (msg.sender == address(this)));
  ...
  function unregisterUsers(EvenDistroCrowdsaleStorage memory self, address[] _registrants)
                           public
                           returns (bool)
  {
    require(msg.sender == self.base.owner);
  ...
  /// @param self Stored crowdsale from crowdsale contract
  function calculateAddressTokenCap(EvenDistroCrowdsaleStorage memory self)
                                    internal
                                    returns (bool)
  {
  ...
  function receivePurchase(EvenDistroCrowdsaleStorage memory self, uint256 _amount)
                           public
                           returns (bool)
  {
    require(msg.sender != self.base.owner);
  ...
  function setTokens(EvenDistroCrowdsaleStorage memory self) public returns (bool) {
    calculateAddressTokenCap(self);
    return self.base.setTokens();
  }

  function withdrawTokens(EvenDistroCrowdsaleStorage memory self) public returns (bool) {
    return self.base.withdrawTokens();
  }

  function withdrawLeftoverWei(EvenDistroCrowdsaleStorage memory self) public returns (bool) {
