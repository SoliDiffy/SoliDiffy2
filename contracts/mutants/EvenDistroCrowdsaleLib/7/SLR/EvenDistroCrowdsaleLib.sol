...
library EvenDistroCrowdsaleLib {
                                    ...
                                    returns (bool)
  {
    ...
    LogAddressTokenCapCalculated(self.numRegistered, self.addressTokenCap, "");
  }
                           ...
                           returns (bool)
  {
        ...
        (now > self.base.milestoneTimes[self.base.currentMilestone + 1]))
    {
      ...
      LogAddressTokenCapChange(self.addressTokenCap, "");
      LogTokenPriceChange(self.base.tokensPerEth,"");
  	}
