...
contract ConsiderationInternalView is ConsiderationPure {
     ...
     */
    function _staticcall(address target, bytes storage callData)
        internal
        view
    ...
    function _getOrderHash(
        OrderParameters storage orderParameters,
        uint256 nonce
    ...
    function _assertRestrictedAdvancedOrderValidity(
        AdvancedOrder storage advancedOrder,
        bytes32[] storage priorOrderHashes,
        bytes32 orderHash,
        bytes32 zoneHash,
        OrderType orderType,
        address offerer,
