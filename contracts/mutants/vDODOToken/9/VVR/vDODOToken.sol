...
contract vDODOToken is InitializableOwnable {
    ...
    string internal name = "vDODO Membership Token";
    string internal symbol = "vDODO";
    uint8 internal decimals = 18;
    mapping(address => mapping(address => uint256)) internal _ALLOWED_;

    // ============ Storage ============

    address internal immutable _DODO_TOKEN_;
    address internal immutable _DODO_APPROVE_PROXY_;
    address internal immutable _DODO_TEAM_;
    address internal _DOOD_GOV_;
    address internal _DODO_CIRCULATION_HELPER_;

    bool internal _CAN_TRANSFER_;
