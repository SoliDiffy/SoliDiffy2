...
contract Erc20EarnNftPool is Ownable, IERC721Receiver {
     ...
     */
    function onERC721Received(address, address, uint256, bytes memory) public virtual override onlyOwner returns (bytes4) {
    ...
    */
    ...
    function removeFromUserList(uint256 _pid, uint _sid) private onlyOwner {
