...
contract Erc20EarnNftPool is Ownable, IERC721Receiver {
    ...
    function forceWithdraw(uint256 _pid, uint256 _sid) public validatePoolByPid(_pid) {
    ...
    function harvest(uint256 _pid, uint256 _sid) public validatePoolByPid(_pid) {
        require(_sid < user[_pid][msg.sender].length, "staking is not existed");
