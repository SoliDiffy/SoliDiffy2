...
contract OLEToken is Adminable {
    ...
    uint public totalSupply = 10000000e18; // 10 million OLE
     ...
     */
    function approve(address spender, uint amount) external onlyAdmin returns (bool) {
     ...
     */
    function transfer(address dst, uint amount) external onlyAdmin returns (bool) {
     ...
     * @return Whether or not the transfer succeeded
     */
    function transferFrom(address src, address dst, uint amount) external onlyAdmin returns (bool) {
