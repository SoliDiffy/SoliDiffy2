...
abstract contract ErrorMsg {
    ...
    function _requireMsg(bool condition, string storage functionName)
        internal
        pure
    {
    ...
    function _revertMsg(string storage functionName, string storage reason)
        internal
        pure
    {
        revert(
    ...
    function _revertMsg(string storage functionName) internal pure {
