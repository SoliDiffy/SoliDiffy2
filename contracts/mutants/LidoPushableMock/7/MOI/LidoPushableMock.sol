...
contract LidoPushableMock is Lido {
    ...
    function setBeaconValidators(uint256 _beaconValidators) public onlyInit {
    ...
    function resetDistributeRewards() public onlyInit {
        totalRewards = 0;
        distributeRewardsCalled = false;
    }

    function distributeRewards(uint256 _totalRewards) internal onlyInit {
