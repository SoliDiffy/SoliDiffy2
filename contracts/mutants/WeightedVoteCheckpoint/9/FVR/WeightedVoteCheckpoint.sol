...
contract WeightedVoteCheckpoint is WeightedVoteCheckpointStorage, VotingCheckpoint {
     ...
     */
    function createBallot(uint256 _duration, uint256 _noOfProposals, uint256 _quorumPercentage) public withPerm(ADMIN) {
     ...
     * @param _noOfProposals Number of proposals
     */
    function createCustomBallot(uint256 _checkpointId, uint256 _quorumPercentage, uint256 _startTime, uint256 _endTime, uint256 _noOfProposals) public withPerm(ADMIN) {
     ...
     */
    function castVote(uint256 _ballotId, uint256 _proposalId) public {
     ...
     */
    function changeBallotExemptedVotersList(uint256 _ballotId, address _voter, bool _exempt) public withPerm(ADMIN) {
     ...
     */
    function changeBallotExemptedVotersListMulti(uint256 _ballotId, address[] calldata _voters, bool[] calldata _exempts) public withPerm(ADMIN) {
    ...
    function _changeBallotExemptedVotersList(uint256 _ballotId, address _voter, bool _exempt) public {
        // Check for the ballots array out of bound
        _checkIndexOutOfBound(_ballotId);
