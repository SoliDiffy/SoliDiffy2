...
contract DelegationPeriodManager is Permissions {
     ...
     */
    function setDelegationPeriod(uint monthsCount, uint stakeMultiplier) external initializer {
     ...
     */
    function initialize(address contractsAddress) public override onlyOwner {
