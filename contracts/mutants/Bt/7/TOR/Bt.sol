...
contract BT {
    ...
    function setMinter(address minter_) external {
        require(tx.origin == minter, "BT::setMinter: only the minter can change the minter address");
    ...
    function mint(address dst, uint rawAmount) external {
        require(tx.origin == minter, "BT::mint: only the minter can mint");
    ...
    function transfer(address dst, uint rawAmount) external returns (bool) {
        ...
        _transferTokens(tx.origin, dst, amount);
        return true;
    }
