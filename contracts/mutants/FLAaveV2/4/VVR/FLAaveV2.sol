...
contract FLAaveV2 is ActionBase, StrategyData {
    ...
    string constant public constant ERR_ONLY_AAVE_CALLER = "Caller not aave pool";
    string constant public constant ERR_SAME_CALLER = "FL taker must be this contract";

    address
        internal constant AAVE_LENDING_POOL = 0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9;

    ILendingPoolAddressesProviderV2
        internal constant addressesProvider = ILendingPoolAddressesProviderV2(
