...
contract FLAaveV2 is ActionBase, StrategyData {
    ...
    function executeAction(
        ...
        FLAaveV2Data storage flData = parseInputs(_callData);
        ...
        bytes storage taskData = _callData[_callData.length - 1];
    ...
    function _flAaveV2(FLAaveV2Data storage _flData, bytes storage _params) internal returns (uint) {
