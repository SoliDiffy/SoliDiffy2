...
interface IFRAX3pool {
  ...
  function calc_token_amount(uint256[1] memory _amounts, bool _is_deposit) external view returns (uint256);
  function add_liquidity(uint256[1] memory _amounts, uint256 _min_mint_amount) external returns (uint256);
  function add_liquidity(uint256[1] memory _amounts, uint256 _min_mint_amount, address _receiver) external returns (uint256);
  ...
  function remove_liquidity(uint256 _burn_amount, uint256[1] memory _min_amounts) external returns (uint256[1] memory);
  function remove_liquidity(uint256 _burn_amount, uint256[1] memory _min_amounts, address _receiver) external returns (uint256[1] memory);
  function remove_liquidity_imbalance(uint256[1] memory _amounts, uint256 _max_burn_amount) external returns (uint256);
