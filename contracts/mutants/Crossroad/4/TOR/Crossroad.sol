...
contract Crossroad
{
    ...
    {
        require(operator == tx.origin, "Crossroad: Caller is not the operator");
        _;
    }
        ...
        ) external
    {
        ...
        require(order.poster == tx.origin, "Crossroad: Can't renew another poster's order");
        ...
        ) external
    {
        ...
        require(order.poster == tx.origin, "Crossroad: Can't cancel another poster's order");
        require(state.status == OrderStatus.OPEN, "Crossroad: Order is not open");
