...
contract Depot is Owned, Pausable, ReentrancyGuard, MixinResolver, IDepot {
    ...
    function setMaxEthPurchase(uint _maxEthPurchase) external  {
     ...
     */
    function setFundsWallet(address payable _fundsWallet) external  {
        fundsWallet = _fundsWallet;
     ...
     */
    function() external payable  rateNotInvalid(ETH) notPaused {
