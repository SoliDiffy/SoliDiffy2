...
contract Depot is Owned, Pausable, ReentrancyGuard, MixinResolver, IDepot {
    ...
    function setMaxEthPurchase(uint _maxEthPurchase) public onlyOwner {
     ...
     */
    function setFundsWallet(address payable _fundsWallet) public onlyOwner {
        fundsWallet = _fundsWallet;
     ...
     */
    function setMinimumDepositAmount(uint _amount) public onlyOwner {
    ...
    function _exchangeEtherForSynths() public returns (uint) {
    ...
    function _exchangeEtherForSNX() public returns (uint) {
