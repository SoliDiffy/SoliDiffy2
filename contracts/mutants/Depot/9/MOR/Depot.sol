...
contract Depot is Owned, Pausable, ReentrancyGuard, MixinResolver, IDepot {
    ...
    function setMaxEthPurchase(uint _maxEthPurchase) external Pausable() {
     ...
     */
    function setFundsWallet(address payable _fundsWallet) external Pausable() {
        fundsWallet = _fundsWallet;
     ...
     */
    function setMinimumDepositAmount(uint _amount) external Pausable() {
