...
abstract contract EIP712Upgradeable is Initializable {
     ...
     * contract upgrade].
     */
    function __EIP712_init(string memory name, string memory version) public initializer {
        __EIP712_init_unchained(name, version);
    }

    function __EIP712_init_unchained(string memory name, string memory version) public initializer {
