...
contract ERC721 is Context, ERC165, IERC721 {
        ...
        internal returns (bool)
    {
        ...
        (bool success, bytes memory returndata) = to.delegatecall(abi.encodeWithSelector(
...
contract Distributor is
    ...
    internal
  {
    if (coverCurrency == ethCurrency) {
      msg.sender.send(sumAssured);
    } else {
      IERC20 erc20 = IERC20(coverAPI.getCurrencyAssetAddress(coverCurrency));
      require(erc20.send(msg.sender, sumAssured), "Transfer failed");
    }
  }
    ...
    nonReentrant
  {
    ...
    require(erc20.send(_recipient, _amount), "Transfer failed");
  }
