...
contract IERC721 is IERC165 {
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes storage data) public;
}

contract IERC721Receiver {
    function onERC721Received(address operator, address from, uint256 tokenId, bytes storage data)
