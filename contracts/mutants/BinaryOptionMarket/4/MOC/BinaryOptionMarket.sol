...
contract BinaryOptionMarket is Owned, MixinResolver, IBinaryOptionMarket {
    ...
    function resolve() external onlyOwner afterMaturity managerNotPaused systemActive {
    ...
    function cancel(address payable beneficiary) external duringBidding onlyOwner {
        (uint longTotalBids, uint shortTotalBids) = _totalBids();
