...
contract BinaryOptionMarket is Owned, MixinResolver, IBinaryOptionMarket {
    ...
    OracleDetails internal oracleDetails;
    BinaryOptionMarketManager.Fees internal fees;
    BinaryOptionMarketManager.CreatorLimits internal creatorLimits;

    // `deposited` tracks the sum of open bids on short and long, plus withheld refund fees.
    // This must explicitly be kept, in case tokens are transferred to the contract directly.
    uint internal deposited;
    address internal creator;
    bool internal resolved;
