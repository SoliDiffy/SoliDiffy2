...
contract BinaryOptionMarket is Owned, MixinResolver, IBinaryOptionMarket {
    ...
    ) internal Owned(_owner) MixinResolver(_resolver) {
        creator = _creator;
    ...
    function _manager() public view returns (BinaryOptionMarketManager) {
        return BinaryOptionMarketManager(owner);
    }

    /* ---------- Phases ---------- */

    function _biddingEnded() public view returns (bool) {
