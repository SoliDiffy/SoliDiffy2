...
contract SWSupplyManager is IERC1155, AbstractERC1155MintBurn, ERC1155Metadata, Ownable {
   ...
   * @param _amounts Array of amount of tokens to mint per id
   */
  function _validateMints(uint256[] memory _ids, uint256[] memory _amounts) public {
   ...
   */
  function getMaxSupplies(uint256[] calldata _ids) public view returns (uint256[] memory) {
