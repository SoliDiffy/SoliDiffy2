...
contract HoldefiPausableOwnable is HoldefiOwnable {
    ...
    constructor () public {
        paused["supply"].isValid = false;
        paused["withdrawSupply"].isValid = false;
        paused["collateralize"].isValid = false;
        paused["withdrawCollateral"].isValid = false;
        paused["borrow"].isValid = false;
        paused["repayBorrow"].isValid = false;
