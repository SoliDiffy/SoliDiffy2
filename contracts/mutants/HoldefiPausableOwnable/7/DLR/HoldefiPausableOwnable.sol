...
contract HoldefiPausableOwnable is HoldefiOwnable {
    ...
    modifier whenNotPaused(string storage operation) {
    ...
    /// @param operation Name of the operation
    modifier whenPaused(string storage operation) {
    ...
    /// @param operation Name of the operation
    modifier operationIsValid(string storage operation) {
    ...
    function isPaused(string storage operation) public view returns (bool res) {
    ...
    function pause(string storage operation, uint256 pauseDuration)
        public
        onlyPausers
    ...
    /// @param operation Name of the operation
    function unpause(string storage operation)
        public
        onlyOwner
        operationIsValid(operation)
    ...
    function batchPause(string[] storage operations, uint256[] memory pauseDurations) external {
