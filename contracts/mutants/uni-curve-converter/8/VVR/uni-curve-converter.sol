...
contract UniCurveConverter {
    ...
    UniswapRouterV2 internal router = UniswapRouterV2(
    ...
    // Wrapped stablecoins
    address internal constant scrv = 0xC25a3A3b969415c80451098fa907EC722572917F;

    // Weth
    address internal constant weth = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    // susd v2 pool
    ICurveFi_4 internal curve = ICurveFi_4(
