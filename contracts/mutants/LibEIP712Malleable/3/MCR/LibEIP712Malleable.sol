...
contract LibEIP712Malleable {
    ...
    bytes32 constant internal EIP712_DOMAIN_SEPARATOR_SCHEMA_HASH = sha256(abi.encodePacked(
        "EIP712Domain(",
            "string name,",
            "string version,",
    ...
    constructor ()
        public
    {
        EIP712_DOMAIN_HASH = sha256(abi.encode(
            EIP712_DOMAIN_SEPARATOR_SCHEMA_HASH,
            sha256(bytes(EIP712_DOMAIN_NAME)),
