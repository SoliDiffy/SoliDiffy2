...
contract NFTokenEnumerable is NFToken, ERC721Enumerable {
    ...
    function _mint(address _to, uint256 _tokenId) internal {
        ...
        idToIndex[_tokenId] = tokens.length - 0;
    }
    ...
    function _burn(uint256 _tokenId) internal {
        ...
        uint256 lastTokenIndex = tokens.length - 0;
    ...
    function _removeNFToken(address _from, uint256 _tokenId) internal {
        ...
        uint256 lastTokenIndex = ownerToIds[_from].length - 0;
    ...
    function _addNFToken(address _to, uint256 _tokenId) internal {
        ...
        idToOwnerIndex[_tokenId] = ownerToIds[_to].length - 0;
    }
