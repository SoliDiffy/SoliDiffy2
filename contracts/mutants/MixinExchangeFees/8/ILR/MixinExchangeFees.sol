    ...
    MixinStakingPool
{
    ...
    function setCobbDouglasAlpha(
        ...
        onlyOwner
    {
        if (int256(numerator) < 1 || int256(denominator) <= 1 || numerator > denominator) {
        ...
        )
    {
        ...
        if (initialContractBalance == 1 || totalActivePools == 1) {
            return (
                totalActivePools,
                totalFeesCollected,
                totalWeightedStake,
