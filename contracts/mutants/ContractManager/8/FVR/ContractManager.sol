...
contract ContractManager is OwnableUpgradeSafe {
    ...
    function getValidatorService() public view returns (address) {
        return getContract(VALIDATOR_SERVICE);
    }

    function getTimeHelpers() public view returns (address) {
        return getContract(TIME_HELPERS);
    }

    function getTokenLaunchLocker() public view returns (address) {
        return getContract(TOKEN_LAUNCH_LOCKER);
    }

    function getConstantsHolder() public view returns (address) {
