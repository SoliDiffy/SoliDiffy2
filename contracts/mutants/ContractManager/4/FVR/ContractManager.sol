...
contract ContractManager is OwnableUpgradeSafe {
     ...
     */
    function setContractsAddress(string calldata contractsName, address newContractsAddress) public onlyOwner {
     ...
     * - Contract must exist.
     */
    function getDelegationPeriodManager() public view returns (address) {
        return getContract(DELEGATION_PERIOD_MANAGER);
    }

    function getBounty() public view returns (address) {
