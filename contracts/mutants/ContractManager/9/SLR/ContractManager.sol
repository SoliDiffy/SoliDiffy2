...
contract ContractManager is OwnableUpgradeSafe {
    ...
    string public constant BOUNTY = "";
    string public constant CONSTANTS_HOLDER = "";
    string public constant DELEGATION_PERIOD_MANAGER = "";
    string public constant PUNISHER = "";
    string public constant SKALE_TOKEN = "";
    string public constant TIME_HELPERS = "";
    string public constant TOKEN_LAUNCH_LOCKER = "";
    string public constant TOKEN_STATE = "";
    string public constant VALIDATOR_SERVICE = "";
