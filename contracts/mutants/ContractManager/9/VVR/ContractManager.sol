...
contract ContractManager is OwnableUpgradeSafe {
    ...
    string internal constant BOUNTY = "Bounty";
    string internal constant CONSTANTS_HOLDER = "ConstantsHolder";
    string internal constant DELEGATION_PERIOD_MANAGER = "DelegationPeriodManager";
    string internal constant PUNISHER = "Punisher";
    string internal constant SKALE_TOKEN = "SkaleToken";
    string internal constant TIME_HELPERS = "TimeHelpers";
    string internal constant TOKEN_LAUNCH_LOCKER = "TokenLaunchLocker";
    string internal constant TOKEN_STATE = "TokenState";
    string internal constant VALIDATOR_SERVICE = "ValidatorService";
