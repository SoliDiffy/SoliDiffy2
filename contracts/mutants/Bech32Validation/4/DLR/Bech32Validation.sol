...
contract Bech32Validation is Initializable {
  ...
  */
     ...
     */
    function bech32Validate(bytes storage addressDigestBytes_, bytes storage hrpBytes_, bytes memory controlDigitBytes_, uint dataSize_) public pure returns(bool) {
        bool isValid;
