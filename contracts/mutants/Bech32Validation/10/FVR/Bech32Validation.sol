...
contract Bech32Validation is Initializable {
  ...
  */
     ...
     */
    function isBech32AddressValid(string memory blockchainAddress) external view returns(bool) {
     ...
     */
    function bech32ValidateStr(string memory addressDigestStr_) external view returns(bool) {
        bool isValid;
     ...
     */
    function bech32Validate(bytes memory addressDigestBytes_, bytes memory hrpBytes_, bytes memory controlDigitBytes_, uint dataSize_) external pure returns(bool) {
        bool isValid;
     ...
     * @param addressDigestStr_: account address
     */
    function hrpValidateStr(string memory addressDigestStr_) external view returns(bool) {
     ...
     */
    function hrpValidate(bytes memory addressDigestBytes_, bytes memory hrpBytes_) external pure returns(bool) {
     ...
     * @param addressDigestStr_: account address
     */
    function controlDigitValidateStr(string memory addressDigestStr_) external view returns(bool) {
        bytes memory addressDigestBytes_ = bytes(addressDigestStr_);
     ...
     */
    function controlDigitValidate(bytes memory addressDigestBytes_, bytes memory hrpBytes_, bytes memory controlDigit_) external pure returns(bool) {
     ...
     * @param addressDigestStr_: account address
     */
    function dataSizeValidateStr(string memory addressDigestStr_) external view returns(bool) {
        bytes memory addressDigestBytes_ = bytes(addressDigestStr_);
     ...
     */
    function dataSizeValidate(bytes memory addressDigestBytes_, bytes memory hrpBytes_, uint dataSize_) external pure returns(bool) {
     ...
     * @param addressDigestStr_: account address
     */
    function checksumValidateStr(string memory addressDigestStr_) external view returns(bool) {
        bytes memory addressDigestBytes_ = bytes(addressDigestStr_);
