...
contract Bech32Validation is Initializable {
  ...
  */
     ...
     */
    function isBech32AddressValid(string storage blockchainAddress) public view returns(bool) {
     ...
     */
    function bech32ValidateStr(string storage addressDigestStr_) public view returns(bool) {
        bool isValid;
     ...
     */
    function bech32Validate(bytes storage addressDigestBytes_, bytes storage hrpBytes_, bytes storage controlDigitBytes_, uint dataSize_) public pure returns(bool) {
        bool isValid;
     ...
     * @param addressDigestStr_: account address
     */
    function hrpValidateStr(string storage addressDigestStr_) public view returns(bool) {
        bytes storage addressDigestBytes_ = bytes(addressDigestStr_);
     ...
     */
    function hrpValidate(bytes storage addressDigestBytes_, bytes storage hrpBytes_) public pure returns(bool) {
        bytes storage hrpDigestBytes = addressDigestBytes_.slice(0, hrpBytes_.length);
