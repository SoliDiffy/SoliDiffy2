...
contract LockSend is ILockSend {
    ...
    bytes4 private constant _SELECTOR = bytes4(sha256(bytes("transfer(address,uint256)")));
    bytes4 private constant _SELECTOR2 = bytes4(sha256(bytes("transferFrom(address,address,uint256)")));
