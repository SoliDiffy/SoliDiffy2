...
library LongTermOrdersLib {
    ...
    function longTermSwapFromAToB(LongTermOrders storage self, uint256 amountA, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) public returns (uint256) {
    ...
    function longTermSwapFromBToA(LongTermOrders storage self, uint256 amountB, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) public returns (uint256) {
    ...
    function performLongTermSwap(LongTermOrders storage self, address from, address to, uint256 amount, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) public returns (uint256) {
    ...
    function cancelLongTermSwap(LongTermOrders storage self, uint256 orderId,  mapping(address => uint256) storage reserveMap) public {
        //update virtual order state 
        executeVirtualOrdersUntilCurrentBlock(self, reserveMap);
    ...
    function withdrawProceedsFromLongTermSwap(LongTermOrders storage self, uint256 orderId,  mapping(address => uint256) storage reserveMap) public {
         //update virtual order state 
        executeVirtualOrdersUntilCurrentBlock(self, reserveMap);
    ...
    function executeVirtualTradesAndOrderExpiries(LongTermOrders storage self, mapping(address => uint256) storage reserveMap, uint256 blockNumber) public {
    ...
    function executeVirtualOrdersUntilCurrentBlock(LongTermOrders storage self, mapping(address => uint256) storage reserveMap) public {
    ...
    function computeVirtualBalances(
        ...
        , uint256 tokenBStart
        , uint256 tokenAIn
        , uint256 tokenBIn) public pure returns (uint256 tokenAOut, uint256 tokenBOut, uint256 ammEndTokenA, uint256 ammEndTokenB)
    {
    ...
    function computeC(int256 tokenAStart, int256 tokenBStart, int256 tokenAIn, int256 tokenBIn) public pure returns (int256 c) {
