...
library LongTermOrdersLib {
    ...
    function initialize(LongTermOrders memory self
                        , address tokenA
                        , address tokenB
                        , uint256 lastVirtualOrderBlock
    ...
    function longTermSwapFromAToB(LongTermOrders memory self, uint256 amountA, uint256 numberOfBlockIntervals,  mapping(address => uint256) memory reserveMap) internal returns (uint256) {
    ...
    function longTermSwapFromBToA(LongTermOrders memory self, uint256 amountB, uint256 numberOfBlockIntervals,  mapping(address => uint256) memory reserveMap) internal returns (uint256) {
    ...
    function performLongTermSwap(LongTermOrders memory self, address from, address to, uint256 amount, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) private returns (uint256) {
