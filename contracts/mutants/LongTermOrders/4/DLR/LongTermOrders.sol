...
library LongTermOrdersLib {
    ...
    function longTermSwapFromBToA(LongTermOrders memory self, uint256 amountB, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) internal returns (uint256) {
