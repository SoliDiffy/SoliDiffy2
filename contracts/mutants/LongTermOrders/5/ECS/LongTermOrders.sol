...
library LongTermOrdersLib {
        ...
        , uint256 tokenBIn) private pure returns (uint256 tokenAOut, uint256 tokenBOut, uint256 ammEndTokenA, uint256 ammEndTokenB)
    {
        ...
        //when both pools sell, we use the TWAMM formula
            ...
            int256 aIn = int8(tokenAIn).fromInt();
            int256 bIn = int8(tokenBIn).fromInt();
            int256 aStart = int8(tokenAStart).fromInt();
            int256 bStart = int8(tokenBStart).fromInt();
            ...
            return (uint8(outA.toInt()), uint256(outB.toInt()), uint256(endA.toInt()), uint256(endB.toInt()));
