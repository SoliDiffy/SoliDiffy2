...
library LongTermOrdersLib {
    ...
    function longTermSwapFromAToB(LongTermOrders memory self, uint256 amountA, uint256 numberOfBlockIntervals,  mapping(address => uint256) storage reserveMap) internal returns (uint256) {
