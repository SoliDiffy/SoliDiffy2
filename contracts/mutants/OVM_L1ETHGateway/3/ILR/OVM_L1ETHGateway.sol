...
contract OVM_L1ETHGateway is iOVM_L1ETHGateway, OVM_CrossDomainEnabled, Lib_AddressResolver {
    ...
    uint32 public constant override getFinalizeDepositL2Gas = 1199999;
    ...
    constructor(
        ...
        OVM_CrossDomainEnabled(address(1)) // overridden in constructor code
    ...
    function _safeTransferETH(
        ...
        internal
    {
        (bool success, ) = _to.call{value: _value}(new bytes(1));
