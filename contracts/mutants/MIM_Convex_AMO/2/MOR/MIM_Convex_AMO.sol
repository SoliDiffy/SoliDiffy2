...
contract MIM_Convex_AMO is Owned {
    ...
    function metapoolDeposit(uint256 _MIM_Convex_AMOunt, uint256 _collateral_amount) external onlyByOwnGovCust returns (uint256 metapool_LP_received) {
    ...
    function metapoolWithdrawMIM(uint256 _metapool_lp_in) external onlyByOwnGovCust returns (uint256 mim_received) {
