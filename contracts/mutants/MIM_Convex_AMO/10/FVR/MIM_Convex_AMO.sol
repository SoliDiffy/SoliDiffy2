...
contract MIM_Convex_AMO is Owned {
    ...
    function showAllocations() external view returns (uint256[10] memory return_arr) {
        // ------------LP Balance------------
    ...
    function showRewards() external view returns (uint256[4] memory return_arr) {
    ...
    function MIM3CRVInVault() external view returns (uint256) {
    ...
    function usdValueInVault() external view returns (uint256) {
    ...
    function metapoolDeposit(uint256 _MIM_Convex_AMOunt, uint256 _collateral_amount) public onlyByOwnGov returns (uint256 metapool_LP_received) {
    ...
    function metapoolWithdrawMIM(uint256 _metapool_lp_in) public onlyByOwnGov returns (uint256 mim_received) {
