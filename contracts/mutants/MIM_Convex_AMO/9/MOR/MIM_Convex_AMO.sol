...
contract MIM_Convex_AMO is Owned {
    ...
    function depositMIM3CRV(uint256 _metapool_lp_in) external onlyByOwnGov{
    ...
    function withdrawAndUnwrapMIM3CRV(uint256 amount, bool claim) external onlyByOwnGov{
        convex_base_reward_pool.withdrawAndUnwrap(amount, claim);
    }

    // Claim CVX, CRV, and SPELL rewards
    function claimRewardsMIM3CRV() external onlyByOwnGov {
