...
contract NoteUtilsTest {
    ...
    */
    function getLength(bytes storage _proofOutputsOrNotes) public pure returns (
        uint len
    ) {
    ...
    * @return number of entries in the pseudo dynamic array
    */
    function get(bytes storage _proofOutputsOrNotes, uint _i) public pure returns (
        bytes storage out
    ) {
    ...
    */
    function extractProofOutput(bytes storage _proofOutput) public pure returns (
    ...
    */
    function extractChallenge(bytes storage _proofOutput) public pure returns (
        bytes32 challenge
    ) {
    ...
    */
    function extractNote(bytes storage _note) public pure returns (
        address owner,
        bytes32 noteHash,
