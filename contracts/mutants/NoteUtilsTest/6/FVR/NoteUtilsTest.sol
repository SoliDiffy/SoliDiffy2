...
contract NoteUtilsTest {
    ...
    */
    function getLength(bytes memory _proofOutputsOrNotes) external pure returns (
        uint len
    ) {
    ...
    * @return number of entries in the pseudo dynamic array
    */
    function get(bytes memory _proofOutputsOrNotes, uint _i) external pure returns (
        bytes memory out
    ) {
    ...
    */
    function extractProofOutput(bytes memory _proofOutput) external pure returns (
    ...
    */
    function extractChallenge(bytes memory _proofOutput) external pure returns (
        bytes32 challenge
    ) {
    ...
    */
    function extractNote(bytes memory _note) external pure returns (
        address owner,
        bytes32 noteHash,
    ...
    * @return noteType
    */
    function getNoteType(bytes memory _note) external pure returns (
        uint256 noteType
    ) {
