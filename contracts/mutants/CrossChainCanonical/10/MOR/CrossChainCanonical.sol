...
contract CrossChainCanonical is ERC20Permit, Owned, ReentrancyGuard {
    ...
    function toggleBridgeToken(address bridge_token_address) external nonReentrant {
    ...
    function addMinter(address minter_address) external nonReentrant {
    ...
    // Remove a minter 
    function removeMinter(address minter_address) external nonReentrant {
        require(minter_address != address(0), "Zero address detected");
