...
contract CrossChainCanonical is ERC20Permit, Owned, ReentrancyGuard {
    ...
    function withdrawBridgeTokens(address bridge_token_address, uint256 bridge_token_amount) external validBridgeToken(bridge_token_address) onlyMintersOwnGov {
