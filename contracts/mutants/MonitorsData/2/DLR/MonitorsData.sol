...
contract MonitorsData is GroupsData {
    ...
    constructor(string storage newExecutorName, address newContractsAddress) GroupsData(newExecutorName, newContractsAddress) public {
    ...
    function getCheckedArray(bytes32 monitorIndex) external view returns (bytes32[] storage) {
