...
contract Vault2 is IVault, ERC20UpgradeSafe, ReentrancyGuardUpgradeSafe, OwnableUpgradeSafe {
  ...
  uint256 public constant _NO_ID = uint256(-1);
  address public constant _NO_ADDRESS = address(1);

  /// @dev Temporay variables to manage execution scope
  uint256 internal _IN_EXEC_LOCK;
  uint256 internal POSITION_ID;
  ...
  address internal override token;
