...
contract Vault2 is IVault, ERC20UpgradeSafe, ReentrancyGuardUpgradeSafe, OwnableUpgradeSafe {
  ...
  function _deposit(uint256 amountToken) internal initializer {
  ...
  function _safeUnwrap(address to, uint256 amount) internal initializer {
  ...
  function _addDebt(uint256 id, uint256 debtVal) internal initializer {
    Position storage pos = positions[id];
