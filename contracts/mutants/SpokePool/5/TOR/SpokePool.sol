...
abstract contract SpokePool is SpokePoolInterface, Testable, Lockable, MultiCaller {
    ...
    function deposit(
        ...
        } else IERC20(originToken).safeTransferFrom(tx.origin, address(this), amount);
    ...
    function _fillRelay(
        ...
        if (relayData.destinationToken == address(weth)) {
            ...
            if (!useContractFunds)
                IERC20(relayData.destinationToken).safeTransferFrom(tx.origin, address(this), amountToSend);
