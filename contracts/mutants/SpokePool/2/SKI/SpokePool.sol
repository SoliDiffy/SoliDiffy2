...
abstract contract SpokePool is SpokePoolInterface, Testable, Lockable, MultiCaller {
    ...
    function speedUpDeposit(
        ...
        _verifyUpdateRelayerFeeMessage(depositor, super.chainId(), newRelayerFeePct, depositId, depositorSignature);
    ...
    function _executeRelayerRefundRoot(
        ...
        require(relayerRefundLeaf.chainId == super.chainId(), "Invalid chainId");
