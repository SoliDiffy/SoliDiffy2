...
abstract contract SpokePool is SpokePoolInterface, Testable, Lockable, MultiCaller {
     ...
     */
    function setCrossDomainAdmin(address newCrossDomainAdmin) public override nonReentrant onlyAdmin {
     ...
     */
    function setHubPool(address newHubPool) public override nonReentrant onlyAdmin {
    ...
    function setEnableRoute(
        ...
        uint256 destinationChainId,
        bool enabled
    ) public override nonReentrant onlyAdmin {
     ...
     */
    function setDepositQuoteTimeBuffer(uint32 newDepositQuoteTimeBuffer) public override nonReentrant onlyAdmin {
     ...
     */
    function relayRootBundle(bytes32 relayerRefundRoot, bytes32 slowRelayRoot) public override nonReentrant onlyAdmin {
    ...
    function deposit(
        ...
        uint64 relayerFeePct,
        uint32 quoteTimestamp
    ) public payable override nonReentrant onlyEnabledRoute(originToken, destinationChainId) {
