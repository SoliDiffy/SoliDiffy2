...
abstract contract SpokePool is SpokePoolInterface, Testable, Lockable, MultiCaller {
    ...
    function relayRootBundle(bytes32 relayerRefundRoot, bytes32 slowRelayRoot) public override onlyAdmin nonReentrant {
        ...
        RootBundle memory rootBundle = rootBundles.push();
    ...
    function fillRelay(
        ...
        SpokePoolInterface.RelayData storage relayData = SpokePoolInterface.RelayData({
            depositor: depositor,
            recipient: recipient,
    ...
    function fillRelayWithUpdatedFee(
        ...
        RelayData storage relayData = RelayData({
            depositor: depositor,
            recipient: recipient,
            destinationToken: destinationToken,
            amount: amount,
