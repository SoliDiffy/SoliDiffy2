...
abstract contract SpokePool is SpokePoolInterface, Testable, Lockable, MultiCaller {
    ...
    function fillRelay(
        ...
        uint256 fillAmountPreFees = _fillRelay(relayHash, relayData, maxTokensToSend, relayerFeePct, true);
    ...
    function fillRelayWithUpdatedFee(
        ...
        bytes32 relayHash = _getRelayHash(relayData);
        uint256 fillAmountPreFees = _fillRelay(relayHash, relayData, maxTokensToSend, newRelayerFeePct, true);
    ...
    function _executeSlowRelayRoot(
        ...
        // funds in all cases.
        uint256 fillAmountPreFees = _fillRelay(relayHash, relayData, relayData.amount, relayerFeePct, false);
