...
contract MatchLogic is MatchingErrors, LibOrder, usingRegistry, ReentrancyGuard {
    ...
    /// @param _order Order
    function cancel(Order memory _order) external {
    ...
    function withdraw(IERC20 _token) external nonReentrant {
    ...
    function validateCanceled(bytes32 _hash) public view {
    ...
    function validateTakerAddress(Order memory _leftOrder, Order memory _rightOrder) public pure {
        require(
    ...
    /// @param _order Order
    function validateExpiration(Order memory _order) public view {
        require(
            _order.expiresAt == 0 ||
    ...
    /// @param _order Order
    function validateSenderAddress(Order memory _order) public view {
        require(
    ...
    /// @param _order Order
    function validateSignature(bytes32 orderHash, Order memory _order) public {
    ...
    function takeFees(bytes32 _orderHash, Order memory _order) public {
