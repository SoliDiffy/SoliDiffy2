...
contract MatchLogic is MatchingErrors, LibOrder, usingRegistry, ReentrancyGuard {
    ...
    /// @param _order Order
    function cancel(Order memory _order) public nonReentrant {
    ...
    /// @param _order Order
    function validateSignature(bytes32 orderHash, Order memory _order) internal nonReentrant {
    ...
    function takeFees(bytes32 _orderHash, Order memory _order) internal nonReentrant {
