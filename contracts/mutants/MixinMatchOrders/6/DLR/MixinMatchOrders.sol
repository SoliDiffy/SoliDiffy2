    ...
    LibConstants
{
        ...
        onlyOwner
    {
        ...
        LibFillResults.MatchedFillResults storage matchedFillResults = EXCHANGE.matchOrders(
            leftOrder,
            rightOrder,
            leftSignature,
            rightSignature
        ...
        LibOrder.OrderInfo storage orderInfo = EXCHANGE.getOrderInfo(rightOrder);
