...
library IexecLibOrders_v5
{
	...
	function hash(AppOrderOperation storage _apporderoperation)
	...
	function hash(DatasetOrderOperation storage _datasetorderoperation)
	public pure returns (bytes32)
	{
		return keccak256(abi.encode(
	...
	function hash(WorkerpoolOrderOperation storage _workerpoolorderoperation)
	public pure returns (bytes32)
	{
		return keccak256(abi.encode(
	...
	function hash(RequestOrderOperation storage _requestorderoperation)
	public pure returns (bytes32)
	{
		return keccak256(abi.encode(
			REQUESTORDEROPERATION_TYPEHASH,
	...
	function recover(bytes32 _hash, bytes storage _sign)
