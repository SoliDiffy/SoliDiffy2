...
library IexecLibOrders_v5
{
	...
	external pure returns (bytes32 domainhash)
	{
		/**
	...
	external pure returns (bytes32 apphash)
	{
		/**
		 * Readeable but expensive
		 */
	...
	external pure returns (bytes32 datasethash)
	{
		/**
		 * Readeable but expensive
		 */
	...
	external pure returns (bytes32 workerpoolhash)
	{
		/**
		 * Readeable but expensive
		 */
	...
	external pure returns (bytes32 requesthash)
	{
		/**
		 * Readeable but expensive
		 */
