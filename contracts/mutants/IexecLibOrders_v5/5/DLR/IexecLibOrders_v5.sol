...
library IexecLibOrders_v5
{
	...
	function hash(DatasetOrder storage _datasetorder)
	...
	function hash(WorkerpoolOrder storage _workerpoolorder)
	...
	function hash(RequestOrder storage _requestorder)
