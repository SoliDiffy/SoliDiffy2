...
contract ComptrollerMock is ComptrollerStorage, ComptrollerInterface {
    ...
    /// @notice MOCK ONLY
    function setFailNextDepositOrRedeem(bool fail) external {
    ...
    function addToMarketInternal(CTokenMock cToken, address borrower) public returns (uint) {
    ...
    function isParticipant(address cTokenAddress, address participant) external view returns (bool) {
