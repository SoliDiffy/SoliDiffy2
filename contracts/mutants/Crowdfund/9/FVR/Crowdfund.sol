...
//SWC-116-Block values as a proxy for time:L61、68、76、162、173、180
     ...
     */
    function buyTokens(address _to) external payable duringCrowdfund nonZeroAddress(_to) nonZeroValue isWhitelisted(msg.sender)  {
     ...
     */
    function closeCrowdfund() public onlyAfterCrowdfund onlyOwner returns (bool success) {
