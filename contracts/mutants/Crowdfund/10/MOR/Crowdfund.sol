...
//SWC-116-Block values as a proxy for time:L61、68、76、162、173、180
     ...
     *
     */
    function reScheduleCrowdfund(uint256 _startDate) external duringCrowdfund returns(bool) {
     ...
     */
    function changeWalletAddress(address _wallet) external duringCrowdfund nonZeroAddress(_wallet) {
        wallet = _wallet;
    }
     ...
     */
    function changeForwardAddress(address _forwardTokensTo) external duringCrowdfund {
        forwardTokensTo = _forwardTokensTo;
    }
     ...
     */
    function buyTokens(address _to) public payable onlyOwner nonZeroAddress(_to) nonZeroValue isWhitelisted(msg.sender)  {
     ...
     */
    function closeCrowdfund() external duringCrowdfund onlyOwner returns (bool success) {
     ...
     */
    function kill() external duringCrowdfund {
        uint256 amount = getCrowdFundAllocation();
    ...
    */
    function addToWhitelist(address _beneficiary) external duringCrowdfund {
    ...
    *
    */
    function addManyToWhitelist(address[] _beneficiaries) external duringCrowdfund {
