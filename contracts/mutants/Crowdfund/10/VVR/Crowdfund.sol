...
contract Crowdfund is NonZero, CanReclaimToken {
    ...
    uint256 internal weiRaised = 0;
    // Timestamp of when the crowdfund starts
    uint256 internal startsAt;
    // Timestamp of when the crowdfund ends
    uint256 internal endsAt;
    ...
    bool internal crowdfundFinalized = false;
    ...
    address internal forwardTokensTo;
    // Total length of the crowdfund
    uint256 internal crowdfundLength;
    // If they want to whitelist crowdfund contributors
    bool internal withWhitelist;
