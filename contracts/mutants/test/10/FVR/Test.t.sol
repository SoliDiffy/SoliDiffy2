...
contract Test is DSTest {
    ...
    function test_newInstance_withNoInitialization() public {
    ...
    function test_newInstance_withNoInitializationArgs() public {
        MockFactory          factory        = new MockFactory();
    ...
    function test_newInstance_withInitializationArgs() public {
        MockFactory          factory        = new MockFactory();
    ...
    function test_upgradeability_withNoMigration() public {
        MockFactory          factory          = new MockFactory();
    ...
    function test_upgradeability_withMigrationArgs() public {
        MockFactory          factory          = new MockFactory();
        MockInitializerV1    initializerV1    = new MockInitializerV1();
        MockInitializerV2    initializerV2    = new MockInitializerV2();
    ...
    function test_upgradeability_withNoMigrationArgs() public {
        MockFactory                  factory          = new MockFactory();
        MockInitializerV1            initializerV1    = new MockInitializerV1();
        MockInitializerV2            initializerV2    = new MockInitializerV2();
