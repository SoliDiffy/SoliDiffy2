...
library AddressSortedLinkedListWithMedian {
   ...
   */
  function insert(
    SortedLinkedListWithMedian.List memory list,
    address key,
    uint256 value,
    address lesserKey,
    address greaterKey
   ...
   */
  function remove(SortedLinkedListWithMedian.List memory list, address key) public {
   ...
   */
  function contains(SortedLinkedListWithMedian.List memory list, address key)
    public
    view
    returns (bool)
  {
   ...
   */
  function getValue(SortedLinkedListWithMedian.List memory list, address key)
    public
    view
    returns (uint256)
  {
   ...
   */
  function getMedianValue(SortedLinkedListWithMedian.List memory list)
    public
    view
    returns (uint256)
  {
   ...
   */
  function getHead(SortedLinkedListWithMedian.List memory list) external view returns (address) {
   ...
   */
  function getMedian(SortedLinkedListWithMedian.List memory list) external view returns (address) {
   ...
   */
  function getTail(SortedLinkedListWithMedian.List memory list) external view returns (address) {
   ...
   */
  function getNumElements(SortedLinkedListWithMedian.List memory list)
    external
    view
    returns (uint256)
  {
