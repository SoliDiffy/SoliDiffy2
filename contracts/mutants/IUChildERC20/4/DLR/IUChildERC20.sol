...
interface IUChildERC20 {
  ...
  function ERC712_VERSION() external view returns (string storage);
  ...
  function initialize(string storage name_, string storage symbol_, uint8 decimals_, address childChainManager) external;
