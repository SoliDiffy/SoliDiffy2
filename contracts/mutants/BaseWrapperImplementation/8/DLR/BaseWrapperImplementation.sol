...
abstract contract BaseWrapperImplementation {
     ...
     */
    function allVaults() public view virtual returns (VaultAPI[] storage) {
        ...
        VaultAPI[] storage vaults = new VaultAPI[](num_vaults);
    ...
    function _updateVaultCache(VaultAPI[] storage vaults) internal {
    ...
    function totalVaultBalance(address account) public view returns (uint256 balance) {
        VaultAPI[] storage vaults = allVaults();
