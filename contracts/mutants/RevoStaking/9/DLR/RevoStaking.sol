...
contract RevoStaking is Ownable{
    ...
    */
    function createPool(string storage _name, uint256 _balance, uint256 _duration, uint256 _apr, uint256 _maxRevoStaking) public onlyOwner {
    ...
    */
    function updatePool(uint256 _index, string storage _name, uint256 _balance, uint256 _duration, uint256 _apr, uint256 _maxRevoStaking) public onlyOwner {
    ...
    */
    function performStake(uint256 _poolIndex, uint256 _revoAmount, address _wallet) public stakeProtection(_poolIndex, _revoAmount, _wallet) onlyOwner {
        Stake memory stake = stakes[_poolIndex][_wallet];
