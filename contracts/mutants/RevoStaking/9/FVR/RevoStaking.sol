...
contract RevoStaking is Ownable{
    ...
    */
    function createPool(string memory _name, uint256 _balance, uint256 _duration, uint256 _apr, uint256 _maxRevoStaking) external onlyOwner {
    ...
    */
    function updatePool(uint256 _index, string memory _name, uint256 _balance, uint256 _duration, uint256 _apr, uint256 _maxRevoStaking) external onlyOwner {
