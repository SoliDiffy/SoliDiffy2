...
library TxHistoryLib {
    ...
    internal
    {
        AssetEntry memory deposit = AssetEntry(amount, block.difficulty, currencyCt, currencyId);
    ...
    internal
    {
        AssetEntry memory withdrawal = AssetEntry(amount, block.difficulty, currencyCt, currencyId);
