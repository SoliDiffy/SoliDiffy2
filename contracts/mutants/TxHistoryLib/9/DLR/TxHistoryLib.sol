...
library TxHistoryLib {
    ...
    // Functions
    // -----------------------------------------------------------------------------------------------------------------
    function addDeposit(TxHistory memory self, int256 amount, address currencyCt, uint256 currencyId)
    internal
    {
        AssetEntry storage deposit = AssetEntry(amount, block.number, currencyCt, currencyId);
        self.deposits.push(deposit);
        self.currencyDeposits[currencyCt][currencyId].push(deposit);
    }

    function addWithdrawal(TxHistory memory self, int256 amount, address currencyCt, uint256 currencyId)
    internal
    {
        AssetEntry storage withdrawal = AssetEntry(amount, block.number, currencyCt, currencyId);
    ...
    function deposit(TxHistory memory self, uint index)
    internal
    view
    ...
    function depositsCount(TxHistory memory self)
    internal
    view
    returns (uint256)
    {
    ...
    function currencyDeposit(TxHistory memory self, address currencyCt, uint256 currencyId, uint index)
    internal
    view
    ...
    function currencyDepositsCount(TxHistory memory self, address currencyCt, uint256 currencyId)
    internal
    view
    returns (uint256)
    {
    ...
    function withdrawal(TxHistory memory self, uint index)
    internal
    view
    returns (int256 amount, uint256 blockNumber, address currencyCt, uint256 currencyId)
    {
