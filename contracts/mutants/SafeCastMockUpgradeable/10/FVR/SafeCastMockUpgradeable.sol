...
contract SafeCastMockUpgradeable is Initializable {
    function __SafeCastMock_init() public onlyInitializing {
    }

    function __SafeCastMock_init_unchained() public onlyInitializing {
    }
    using SafeCastUpgradeable for uint256;
    using SafeCastUpgradeable for int256;

    function toUint256(int256 a) external pure returns (uint256) {
        return a.toUint256();
    }

    function toUint248(uint256 a) external pure returns (uint248) {
        return a.toUint248();
    }

    function toUint240(uint256 a) external pure returns (uint240) {
        return a.toUint240();
    }

    function toUint232(uint256 a) external pure returns (uint232) {
        return a.toUint232();
    }

    function toUint224(uint256 a) external pure returns (uint224) {
        return a.toUint224();
    }

    function toUint216(uint256 a) external pure returns (uint216) {
        return a.toUint216();
    }

    function toUint208(uint256 a) external pure returns (uint208) {
        return a.toUint208();
    }

    function toUint200(uint256 a) external pure returns (uint200) {
        return a.toUint200();
    }
