    ...
    Addresses
{
    ...
    ///     just one element.
    function decodeZeroExTransactionData(bytes storage transactionData)
        public
        pure
        returns(
            string storage functionName,
            LibOrder.Order[] storage orders,
            uint256[] storage takerAssetFillAmounts,
    ...
    function decodeAssetProxyId(bytes storage assetData)
        public
        pure
        returns (
            bytes4 assetProxyId
    ...
    function encodeERC20AssetData(address tokenAddress)
        public
        pure
        returns (bytes storage assetData)
    {
    ...
    function decodeERC20AssetData(bytes storage assetData)
        public
        pure
        returns (
            bytes4 assetProxyId,
    ...
    /// asset to be traded.
    function decodeERC721AssetData(bytes storage assetData)
        public
        pure
        returns (
            bytes4 assetProxyId,
