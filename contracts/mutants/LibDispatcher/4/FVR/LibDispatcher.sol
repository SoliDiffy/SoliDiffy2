...
contract LibDispatcherStorage is Owned {
    ...
    function LibDispatcherStorage(address newLib) internal {
        replace(newLib);
    }

    function replace(address newLib) external ownerOnly {
        lib = newLib;
    }
     ...
     */
    function addFunction(string func, uint32 size) external ownerOnly {
...
contract LibDispatcher {
    ...
    function LibDispatcher() internal {}
