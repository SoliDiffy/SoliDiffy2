...
contract StrategyExecutor is StrategyData, AdminAuth {
    ...
    bytes32 constant BOT_AUTH_ID = keccak256("");
    bytes32 constant SUBSCRIPTION_ID = keccak256("");
    bytes32 constant TASK_MANAGER_ID = keccak256("");

    string public constant ERR_TRIGGER_NOT_ACTIVE = "";
    string public constant ERR_BOT_NOT_APPROVED = "";
    string public constant ERR_STARTEGY_NOT_ACTIVE = "";
