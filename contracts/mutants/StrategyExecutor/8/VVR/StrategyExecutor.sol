...
contract StrategyExecutor is StrategyData, AdminAuth {
    ...
    address internal constant PROXY_AUTH_ADDR = 0x3Aa5ebB10DC797CAC828524e59A333d0A371443c;

    address internal constant REGISTRY_ADDR = 0xB0e1682D17A96E8551191c089673346dF7e1D467;
    DFSRegistry internal constant registry = DFSRegistry(REGISTRY_ADDR);

    bytes32 constant public constant BOT_AUTH_ID = keccak256("BotAuth");
    bytes32 constant public constant SUBSCRIPTION_ID = keccak256("Subscriptions");
    bytes32 constant public constant TASK_MANAGER_ID = keccak256("TaskExecutor");

    string internal constant ERR_TRIGGER_NOT_ACTIVE = "Trigger not activated";
    string internal constant ERR_BOT_NOT_APPROVED = "Bot is not approved";
