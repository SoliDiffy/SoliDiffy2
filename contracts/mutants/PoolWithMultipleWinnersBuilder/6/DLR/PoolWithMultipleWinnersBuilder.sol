...
contract PoolWithMultipleWinnersBuilder {
  ...
  function _tokens(MultipleWinners _multipleWinners) internal returns (ControlledTokenInterface[] storage) {
    ControlledTokenInterface[] storage tokens = new ControlledTokenInterface[](2);
