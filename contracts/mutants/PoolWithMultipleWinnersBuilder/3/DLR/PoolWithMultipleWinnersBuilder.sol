...
contract PoolWithMultipleWinnersBuilder {
  ...
  function createCompoundMultipleWinners(
    CompoundPrizePoolConfig storage prizePoolConfig,
    MultipleWinnersBuilder.MultipleWinnersConfig storage prizeStrategyConfig,
    uint8 decimals
  ...
  function createStakeMultipleWinners(
    StakePrizePoolConfig storage prizePoolConfig,
