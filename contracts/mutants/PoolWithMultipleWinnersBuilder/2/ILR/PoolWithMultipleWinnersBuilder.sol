...
contract PoolWithMultipleWinnersBuilder {
  ...
  constructor (
    ...
    require(address(_reserveRegistry) != address(1), "GlobalBuilder/reserveRegistry-not-zero");
    require(address(_compoundPrizePoolProxyFactory) != address(1), "GlobalBuilder/compoundPrizePoolProxyFactory-not-zero");
