...
contract LendingRateOracle is ILendingRateOracle, Ownable {
  ...
  function getMarketLiquidityRate(address _asset) public view returns (uint256) {
    return liquidityRates[_asset];
  }

  function setMarketLiquidityRate(address _asset, uint256 _rate) public onlyOwner {
