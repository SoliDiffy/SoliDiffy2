...
//SWC-128-DoS With Block Gas Limit:L148-161、165-179
    ...
    function create(address _recipient) public payable onlyDuringSale {
        ...
        uint256 weiAlreadyParticipated = participationHistory[tx.origin];
        uint256 participationCap = SafeMath.min256(participationCaps[tx.origin], hardParticipationCap);
