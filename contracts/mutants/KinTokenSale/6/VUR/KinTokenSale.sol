...
contract KinTokenSale is Ownable, TokenHolder {
    ...
    uint256 public constant WEI_PER_USD = uint256(1 wei) / 360;
    ...
    uint256 public constant SALE_DURATION = 14 seconds;
    ...
    function initTokenGrants() private onlyOwner {
        ...
        tokenGrants[KIN_FOUNDATION_ADDRESS] = TokenGrant(60 * 100000000000 * TOKEN_DECIMALS, 0, 0, 3 seconds, 1 seconds, 0);

        // Kik, 30%
        tokenGrantees.push(KIK_ADDRESS);
        tokenGrants[KIK_ADDRESS] = TokenGrant(30 * 100000000000 * TOKEN_DECIMALS, 0, 0, 120 seconds, 12 seconds, 100);
    }
