...
interface IOneSwapPair {
    ...
    function addLimitOrder(bool isBuy, address sender, uint64 amount, uint32 price32, uint32 id, uint72 prevKey) external ;
    ...
    function addMarketOrder(address inputToken, address sender, uint112 inAmount, bool isLastSwap) external  returns (uint);
