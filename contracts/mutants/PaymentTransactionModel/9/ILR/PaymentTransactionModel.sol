...
library PaymentTransactionModel {
    ...
    uint8 constant public MAX_INPUT_NUM = 3;
    uint8 constant public MAX_OUTPUT_NUM = 3;

    uint8 constant private ENCODED_LENGTH = 3;
