...
contract AlgoVestStaking is Ownable {
    ...
    IERC20 internal avsAddress;
    uint256 internal zeroDayStartTime;
    uint256 internal dayDurationSec;
    ...
    uint256 internal allAVSTokens;
    uint256 internal totalStakers;
    uint256 internal totalStakedAVS;
    uint256 internal unfreezedAVSTokens;
    uint256 internal freezedAVSTokens;
    ...
    uint256 internal constant maxNumDays = 180;
    struct StakeInfo {
        uint256 stakeId;
        uint256 startDay;
