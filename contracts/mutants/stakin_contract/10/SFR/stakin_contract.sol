...
// SWC-107-Reentrancy: L74 - L84
        ...
        onlyWhenOpen
    {
        ...
        unfreezedAVSTokens = unfreezedAVSTokens.add(avsEarnings - amount);
        freezedAVSTokens = freezedAVSTokens.sub(avsEarnings - amount);
        ...
        totalStakedAVS = totalStakedAVS.sub(amount);
    }
        ...
        onlyWhenOpen
    {
        ...
        if (servedNumOfDays < st.numDaysStake) {
            ...
            uint256 remainingAVSTokens =
                st.freezedRewardAVSTokens.add(avsTokensToReturn - st.stakedAVS);
            unfreezedAVSTokens = unfreezedAVSTokens.sub(remainingAVSTokens);
            freezedAVSTokens = freezedAVSTokens.add(st.freezedRewardAVSTokens);
