...
// SWC-107-Reentrancy: L74 - L84
    function AVSTokenDonation(uint256 amount) public {
    ...
    function AVSOwnerWithdraw(uint256 amount) public onlyOwner {
        address sender = _msgSender();
    ...
    function stakeListCount(address who) public view returns (uint256) {
        return stakeList[who].length;
    }

    function currentDay() public view onlyWhenOpen returns (uint256) {
        return _currentDay();
    }
