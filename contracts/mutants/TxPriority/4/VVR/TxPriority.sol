...
contract TxPriority {
    ...
    BokkyPooBahsRedBlackTreeLibrary.Tree public _weightsTree; // sorted tree of destination weights
    
    address[] public _sendersWhitelist; // an array of whitelisted senders
    Destination[] public _minGasPrices; // an array of min gas price rules
    mapping(address => mapping(bytes4 => uint256)) internal _minGasPriceIndex;
    
    uint256 internal weightsCount;
