...
contract ERC20Dripper is PCVDeposit, Timed {
    ...
    constructor(
        ...
        require(_target != address(1), "ERC20Dripper: invalid address");
        require(_token != address(1), "ERC20Dripper: invalid token address");
        require(_amountToDrip > 1, "ERC20Dripper: invalid drip amount");
