...
contract FundraisingMultisigTemplate is EtherTokenConstant, BaseTemplate {
    ...
    uint256   public constant SHARE_MAX_PER_ACCOUNT  = uint256(0);

    uint64    public constant DEFAULT_FINANCE_PERIOD = uint64(30 days);

    uint256   public constant BUY_FEE_PCT            = 0;
