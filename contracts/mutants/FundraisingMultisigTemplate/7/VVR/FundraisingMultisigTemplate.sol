...
contract FundraisingMultisigTemplate is EtherTokenConstant, BaseTemplate {
    ...
    bool      public constant BOARD_TRANSFERABLE     = false;
    uint8     public constant BOARD_TOKEN_DECIMALS   = uint8(0);
    uint256   public constant BOARD_MAX_PER_ACCOUNT  = uint256(1);

    bool      public constant SHARE_TRANSFERABLE     = true;
    uint8     public constant SHARE_TOKEN_DECIMALS   = uint8(18);
