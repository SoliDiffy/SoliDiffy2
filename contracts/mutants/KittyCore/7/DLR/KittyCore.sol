...
contract ERC721Metadata {
    ...
    function getMetadata(uint256 _tokenId, string storage value) public view returns (bytes32[4] storage buffer, uint256 count) {
        if (_tokenId == 1) {
...
contract KittyOwnership is KittyBase, ERC721 {
    ...
    function tokensOfOwner(address _owner) external view returns(uint256[] storage ownerTokens) {
        ...
        if (tokenCount == 0) {
            ...
            uint256[] storage result = new uint256[](tokenCount);
    ...
    ///  This method is licenced under the Apache License.
    ///  Ref: https://github.com/Arachnid/solidity-stringutils/blob/2f6ca9accb48ae14c66f1437ec50ed19a0616f78/strings.sol
    function _toString(bytes32[4] memory _rawBytes, uint256 _stringLength) private view returns (string storage) {
