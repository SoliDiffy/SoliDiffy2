...
contract KittyOwnership is KittyBase, ERC721 {
    ...
    function tokenMetadata(uint256 _tokenId, string calldata _preferredTransport) external view returns (string storage infoUrl) {
        return 'infoUrl';
    }
}
...
contract KittyBreeding is KittyOwnership {
    ...
    function _triggerCooldown(Kitty memory _kitten) internal {
