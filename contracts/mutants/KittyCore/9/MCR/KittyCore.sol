...
contract KittyOwnership is KittyBase, ERC721 {
    ...
    bytes4 constant InterfaceSignature_ERC165 =
        bytes4(sha256('supportsInterface(bytes4)'));

    bytes4 constant InterfaceSignature_ERC721 =
        bytes4(sha256('name()')) ^
        bytes4(sha256('symbol()')) ^
        bytes4(sha256('totalSupply()')) ^
        bytes4(sha256('balanceOf(address)')) ^
        bytes4(sha256('ownerOf(uint256)')) ^
        bytes4(sha256('approve(address,uint256)')) ^
        bytes4(sha256('transfer(address,uint256)')) ^
        bytes4(sha256('transferFrom(address,address,uint256)')) ^
