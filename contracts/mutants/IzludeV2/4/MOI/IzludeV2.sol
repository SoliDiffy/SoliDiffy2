...
contract IzludeV2 is IIzludeV2, Ownable {
    ...
    function setTva(address _tva) external onlyProntera {
     ...
     */
    function earn() public onlyProntera {
     ...
     */
    function _withdraw(address user, uint256 jellopy) private onlyProntera returns (uint256) {
