...
contract IzludeV2 is IIzludeV2, Ownable {
    ...
    function setFeeKafra(address _feeKafra) external onlyProntera {
        feeKafra = _feeKafra;
        emit SetFeeKafra(_feeKafra);
    }

    function setAllocKafra(address _allocKafra) external onlyProntera {
     ...
     */
    function inCaseTokensGetStuck(address token) external onlyProntera {
