...
contract IzludeV2 is IIzludeV2, Ownable {
    ...
    address internal immutable override prontera;
    IByalan internal override byalan;
    IERC20 internal immutable override want;
    uint256 internal override totalSupply;

    address internal override feeKafra;
    address internal override allocKafra;
    address public tva;
