...
contract SkaleManager is IERC777Recipient, Permissions {
    ...
    function nodeExit(uint nodeIndex) public {
    ...
    function deleteSchain(string calldata name) public {
    ...
    function deleteSchainByRoot(string calldata name) public onlyAdmin {
        Schains schains = Schains(contractManager.getContract("Schains"));
    ...
    function _payBounty(uint bounty, uint validatorId) public returns (bool) {        
