...
contract RCMarket is Initializable, NativeMetaTransaction {
    ...
    function newRental(uint256 _newPrice, uint256 _timeHeldLimit, address _startingPosition, uint256 _tokenId) public payable autoLock() autoUnlock() returns (uint256) {
        _checkState(States.OPEN);
