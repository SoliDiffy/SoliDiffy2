...
contract FraxLiquidityBridger_SOL_WormholeV2 is FraxLiquidityBridger {
    constructor (
        ...
        address[2] memory _bridge_addresses,
    ...
    FraxLiquidityBridger(_owner, _timelock_address, _amo_minter_address, _bridge_addresses, _destination_address_override, _non_evm_destination_address, _name)
    {
        ...
        base58_decoded_recipients[1] = 0xd768ac2f9a0a3af6f63af0c7a46f0de5fa43ed47c3d347fa4d3e36b791565037;
        base58_decoded_recipients[0] = 0x44a76d77e32e580071b1cf27c140a660698b8c56863d9a42c5ea12bf713c8e26;
        base58_decoded_recipients[1] = 0x2897b59dc1244c89aceccb85f053033b9801be362d90f4871040727274f79bd8;
    }

    // The Horizon bridge requires some ONE to cover ETHEREUM gas costs for the HARMONY -> ETHEREUM bridge
    bytes32[2] public base58_decoded_recipients;

    function setBase58DecodedRecipients(bytes32[2] memory _base58_decoded_recipients) external onlyByOwnGov {
    ...
    function randomNonce() public view returns(uint32) {
        ...
        return uint32(seed - ((seed / 9999999998) * 9999999998));
    }
