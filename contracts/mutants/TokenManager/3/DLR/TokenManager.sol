...
library ManageTokens {
  ...
  function AGENT_STATUS(bytes32 _exec_id, address _agent) private pure returns (bytes32[3] storage)
  ...
  function TOKEN_INIT(bytes32 _exec_id, bytes32 _name, bytes32 _symbol) private pure returns (bytes32[4] storage)
