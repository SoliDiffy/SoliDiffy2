...
library ManageTokens {
  ...
  bytes32 public constant FINAL_SEL = keccak256('CrowdsaleFinalized(bytes32)');
  // event TokenConfigured(bytes32 indexed exec_id, bytes32 indexed name, bytes32 indexed symbol, uint decimals)
  bytes32 public constant TOKEN_CONFIGURED = keccak256("TokenConfigured(bytes32,bytes32,bytes32,uint256)");
