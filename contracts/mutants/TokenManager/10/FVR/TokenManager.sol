...
library ManageTokens {
  ...
  function removeReservedTokens(address _destination) public view {
    // Ensure valid input
    if (_destination == 0)
      revert('invalid destination');
  ...
  function distributeReservedTokens(uint _num_destinations) public view {
    // Ensure valid input
  ...
  function finalizeCrowdsaleAndToken() public view {
  ...
  function distributeAndUnlockTokens() public view {
