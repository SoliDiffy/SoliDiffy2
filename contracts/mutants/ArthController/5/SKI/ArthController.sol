...
// SWC-135-Code With No Effects: L117
    ...
    function refreshCollateralRatio() external override {
        ...
        uint256 currentPrice = super.getARTHPrice();
    ...
    {
        return (
            super.getARTHPrice(), // ARTH price.
            super.getARTHXPrice(), // ARTHX price.
            ARTH.totalSupply(), // ARTH total supply.
            globalCollateralRatio, // Global collateralization ratio.
            super.getGlobalCollateralValue(), // Global collateral value.
            mintingFee, // Minting fee.
            redemptionFee, // Redemtion fee.
            super.getETHGMUPrice() // ETH/GMU price.
        );
    }
