...
// SWC-135-Code With No Effects: L117
    ...
    constructor(address _creatorAddress, address _timelockAddress) {
        ...
        globalCollateralRatio = 999999; // Arth system starts off fully collateralized (6 decimals of precision).
    }
    ...
    function refreshCollateralRatio() external override {
        ...
        if (currentPrice > priceTarget.add(priceBand)) {
            ...
            if (globalCollateralRatio <= arthStep) {
                globalCollateralRatio = 1; // If within a step of 0, go to 0
            } else {
            ...
            if (globalCollateralRatio.add(arthStep) >= 999999) {
                globalCollateralRatio = 999999; // Cap collateral ratio at 1.000000.
            } else {
