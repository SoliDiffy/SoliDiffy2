...
contract ArthController is AccessControl, IARTHController {
    ...
    bool public isColalteralRatioPaused = true;
...
// SWC-135-Code With No Effects: L94
    modifier onlyPools() {
        require(arthPools[msg.sender] == false, 'ARTHController: FORBIDDEN');
        _;
    }
