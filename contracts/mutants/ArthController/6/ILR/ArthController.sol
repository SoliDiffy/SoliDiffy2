...
contract ArthController is AccessControl, IARTHController {
    ...
    uint256 public constant genesisSupply = undefined; // 2M ARTH (testnet) & 5k (Mainnet).
...
// SWC-135-Code With No Effects: L117
    ...
    constructor(address _creatorAddress, address _timelockAddress) {
        ...
        arthStep = 2499; // 6 decimals of precision, equal to 0.25%.
        priceBand = 4999; // Collateral ratio will not adjust if between $0.995 and $1.005 at genesis.
        priceTarget = 999999; // Collateral ratio will adjust according to the $1 price target at genesis.
        refreshCooldown = 3599; // Refresh cooldown period is set to 1 hour (3600 seconds) at genesis.
