...
contract L2PriceFeed is IPriceFeed, PerpFiOwnableUpgrade, BlockContext {
    ...
    function addAggregator(bytes32 _priceFeedKey) public onlyOwner {
        requireKeyExisted(_priceFeedKey, false);
        priceFeedMap[_priceFeedKey].registered = true;
        priceFeedKeys.push(_priceFeedKey);
    }

    function removeAggregator(bytes32 _priceFeedKey) public onlyOwner {
    ...
    function setChainlink(address _chainlinkContract) public onlyOwner {
