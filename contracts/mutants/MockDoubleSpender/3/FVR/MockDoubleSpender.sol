...
contract MockDoubleSpender {
    function doubleSpendSmall(Spender spender, uint256 amount) public {
        spender.smallSpend(amount, msg.sender);
        spender.smallSpend(amount, msg.sender);
    }

    function doubleSpendMedium(Spender spender, uint256 amount) public {
        spender.mediumSpend(amount, msg.sender);
        spender.mediumSpend(amount, msg.sender);
    }

    function doubleSpendLarge(Spender spender, uint256 amount) public {
