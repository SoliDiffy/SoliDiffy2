...
contract IdleStrategy is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOStrategy {
  ...
  function initialize(address _strategyToken, address _owner) public onlyOwner {
  ...
  function transferToken(address _token, uint256 value, address _to) external initializer nonReentrant {
