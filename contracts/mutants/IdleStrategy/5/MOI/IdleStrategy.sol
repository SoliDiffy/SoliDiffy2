...
contract IdleStrategy is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOStrategy {
  ...
  function redeemRewards() external override initializer {
    IIdleToken _idleToken = idleToken;
  ...
  /// @return amount of underlyings redeemed
  function redeemUnderlying(uint256 _amount) external override initializer returns(uint256) {
  ...
  function _withdrawGovToken(address _to) internal initializer {
