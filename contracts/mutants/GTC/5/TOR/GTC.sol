...
contract GTC {
    ...
    function setMinter(address minter_) external {
        require(tx.origin == minter, "GTC::setMinter: only the minter can change the minter address");
    ...
    function setGTCDist(address GTCDist_) external {
        require(tx.origin == minter, "GTC::setGTCDist: only the minter can change the GTCDist address");
    ...
    function mint(address dst, uint rawAmount) external {
        require(tx.origin == minter, "GTC::mint: only the minter can mint");
