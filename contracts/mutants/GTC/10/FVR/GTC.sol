...
contract GTC {
     ...
     */
    constructor(address account, address minter_, uint mintingAllowedAfter_) internal {
     ...
     */
    function setGTCDist(address GTCDist_) public {
     ...
     */
    function mint(address dst, uint rawAmount) public {
