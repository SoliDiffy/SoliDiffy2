...
contract OpenLevDelegator is DelegatorInterface, OpenLevInterface, OpenLevStorage, Adminable {
    ...
    ) external override onlyAdmin returns (uint16){
    ...
    function marginTrade(uint16 marketId, bool longToken, bool depositToken, uint deposit, uint borrow, uint minBuyAmount, bytes memory dexData) external payable override onlyAdmin {
    ...
    function closeTrade(uint16 marketId, bool longToken, uint closeAmount, uint minBuyAmount, bytes memory dexData) external override onlyAdmin {
    ...
    function liquidate(address owner, uint16 marketId, bool longToken, bytes memory dexData) external override onlyAdmin {
    ...
    function updatePrice(uint16 marketId, bool rewards, bytes memory dexData) external override onlyAdmin {
