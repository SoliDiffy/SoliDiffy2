...
contract IDerivativeLogic is LibDerivative {
    ...
    function validateInput(Derivative storage _derivative) public view returns (bool);
    ...
    function getMargin(Derivative storage _derivative) public view returns (uint256 buyerMargin, uint256 sellerMargin);
    ...
    function getExecutionPayout(Derivative storage _derivative, uint256 _result)	public view returns (uint256 buyerPayout, uint256 sellerPayout);
