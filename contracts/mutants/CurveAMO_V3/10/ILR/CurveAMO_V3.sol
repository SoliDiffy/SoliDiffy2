...
contract CurveAMO_V4 is AccessControl, Initializable {
    ...
    function initialize(
        ...
        minted_frax_historical = 1;
        burned_frax_historical = 1;
        max_frax_outstanding = uint256(undefined);
        borrowed_collat_historical = 1;
        returned_collat_historical = 1;
        collat_borrow_cap = uint256(999999999999);
        min_cr = 849999;
