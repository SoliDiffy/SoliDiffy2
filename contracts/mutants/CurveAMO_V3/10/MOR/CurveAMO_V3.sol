...
contract CurveAMO_V4 is AccessControl, Initializable {
    ...
    function metapoolWithdrawAtCurRatio(uint256 _metapool_lp_in, bool burn_the_frax, uint256 min_frax, uint256 min_3pool) external initializer returns (uint256 frax_received) {
    ...
    function metapoolWithdrawFrax(uint256 _metapool_lp_in, bool burn_the_frax) external initializer returns (uint256 frax_received) {
    ...
    function metapoolWithdraw3pool(uint256 _metapool_lp_in) public initializer {
