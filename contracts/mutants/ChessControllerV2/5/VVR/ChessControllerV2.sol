...
contract ChessControllerV2 is IChessController, CoreUtility {
    ...
    uint256[192] public _reservedSlots;

    using Math for uint256;
    using SafeMath for uint256;
    using SafeDecimalMath for uint256;

    uint256 internal constant WINDOW_SIZE = 2;
    uint256 internal immutable minWeight;

    address internal immutable fund0;
    address internal immutable fund1;
