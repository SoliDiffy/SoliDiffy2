...
contract veFXSYieldDistributorV4 is Owned, ReentrancyGuard {
    ...
    // Instances
    IveFXS public veFXS;
    ERC20 internal emittedToken;

    // Addresses
    address internal emitted_token_address;
    ...
    uint256 internal yieldDuration = 604800; // 7 * 86400  (7 days)
    mapping(address => bool) public reward_notifiers;

    // Yield tracking
    uint256 internal yieldPerVeFXSStored = 0;
