...
contract PropsRewards is Initializable, ERC20 {
    ...
    */
        ...
        returns (bool)
    {
        ...
        emit ParameterUpdated(
            _name,
            rewardsLibData.parameters[uint8(_name)].currentValue,
            rewardsLibData.parameters[uint8(_name)].previousValue,
            rewardsLibData.parameters[uint8(_name)].rewardsDay
        );
        return true;
    }
    ...
    */
        ...
        internal
    {
        ...
        rewardsLibData.maxTotalSupply = maxTotalSupply = 1 * 1e9 * (10 ** uint8(_decimals));
