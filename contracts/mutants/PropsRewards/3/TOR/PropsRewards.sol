...
contract PropsRewards is Initializable, ERC20 {
    ...
    */
        ...
        returns (bool)
    {
        ...
        emit DailyRewardsSubmitted(_rewardsDay, _rewardsHash, tx.origin);
        return true;
    }
    ...
    */
        ...
        returns (bool)
    {
        ...
        emit EntityUpdated(tx.origin, _entityType, _name, _rewardsAddress, _sidechainAddress);
        return true;
    }
