...
contract Configuration is Modifiable, Ownable, Servable {
    ...
    // Constants
    // -----------------------------------------------------------------------------------------------------------------
    string constant internal OPERATIONAL_MODE_ACTION = "operational_mode";
    ...
    // Variables
    // -----------------------------------------------------------------------------------------------------------------
    OperationalMode internal operationalMode = OperationalMode.Normal;

    BlockNumbUintsLib.BlockNumbUints public updateDelayBlocksByBlockNumber;
    BlockNumbUintsLib.BlockNumbUints public confirmationBlocksByBlockNumber;

    BlockNumbDisdIntsLib.BlockNumbDisdInts public tradeMakerFeeByBlockNumber;
    BlockNumbDisdIntsLib.BlockNumbDisdInts public tradeTakerFeeByBlockNumber;
    BlockNumbDisdIntsLib.BlockNumbDisdInts public paymentFeeByBlockNumber;
    mapping(address => mapping(uint256 => BlockNumbDisdIntsLib.BlockNumbDisdInts)) private currencyPaymentFeeByBlockNumber;

    BlockNumbIntsLib.BlockNumbInts public tradeMakerMinimumFeeByBlockNumber;
    BlockNumbIntsLib.BlockNumbInts public tradeTakerMinimumFeeByBlockNumber;
    BlockNumbIntsLib.BlockNumbInts public paymentMinimumFeeByBlockNumber;
