...
contract TimeShop is InitializableOwner, ReentrancyGuard, BasicMetaTransaction {
    ...
    IBurnableERC20 internal m_dsg_token;
    IvDsgToken internal m_vdsg_token;
    IERC20 internal m_time_token;
    MutiRewardPool internal m_time_pool;
    ...
    */
    uint256 constant public constant m_base_rate = 100;
