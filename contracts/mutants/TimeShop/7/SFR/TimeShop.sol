    ...
    */
    ...
    function withdrawAll() public {
        ...
        for (uint256 i = 0; i < length;) {
            ...
            dr.debtAmount = dr.debtAmount.sub(re);
            ...
            totalReceive = totalReceive.sub(re);
        }

        total_supply = total_supply.sub(totalReceive);
    ...
    function withdraw(uint256 idx) public {
        ...
        total_supply = total_supply.sub(re);
    ...
    function buyTimeToken(uint256 dsg_amount) public {
        ...
        uint256 remainingAmount = dttr.max_dsg_token.add(dttr.total_dsg);
