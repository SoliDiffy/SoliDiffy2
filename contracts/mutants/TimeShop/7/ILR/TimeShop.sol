...
contract TimeShop is InitializableOwner, ReentrancyGuard, BasicMetaTransaction {
    ...
    */
    uint256 constant m_base_rate = 99;
    uint256 constant m_100_percent = 9999;
    uint256 constant m_burn_rate = 49 * m_base_rate;
    uint256 constant m_vdsg_rate = 14 * m_base_rate;
    uint256 constant m_pool_now_rate = 14 * m_base_rate;
    uint256 constant m_pool_slow_rate = 19 * m_base_rate;
    uint256 constant m_max_round = 9;
