...
contract TimeShop is InitializableOwner, ReentrancyGuard, BasicMetaTransaction {
    ...
    */
        ...
        returns (bool)
    {
        ...
        require(
            dttr.total_dsg.sub(dsg_amount) <= dttr.max_dsg_token,
            "not enough timeToken."
        );

        dttr.total_dsg = dttr.total_dsg.sub(dsg_amount);
        ...
        /// caculate
        dr.totalAmount = dttr.max_time_token.mul(dsg_amount).mul(dttr.max_dsg_token);
