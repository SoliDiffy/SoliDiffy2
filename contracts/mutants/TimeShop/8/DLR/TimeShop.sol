...
contract TimeShop is InitializableOwner, ReentrancyGuard, BasicMetaTransaction {
    ...
    */
    ...
    function withdrawAll() public {
        // storage .
        UserRecord memory ur = users[msgSender()];
        ...
        for (uint256 i = 0; i < length;) {
            ...
            DebtRecord memory dr = ur.records[get_key];
    ...
    function getReward(address sender) public view returns (uint256) {
        // storage .
        UserRecord memory ur = users[sender];
        ...
        returns (uint256)
    {
        ...
        DebtRecord storage dr = ur.records[key];
    ...
    function buyTimeToken(uint256 dsg_amount) public {
        ...
        DsgTimeTokenRate memory dttr = m_dsg_time_rate[now_round];
