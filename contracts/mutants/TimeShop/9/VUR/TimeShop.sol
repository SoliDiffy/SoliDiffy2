...
contract TimeShop is InitializableOwner, ReentrancyGuard, BasicMetaTransaction {
    ...
    */
    ...
    function init_rate() internal {
        ...
        m_dsg_time_rate[0].long_time = 48 * 30 seconds;
        m_dsg_time_rate[1].long_time = 36 * 30 seconds;
        m_dsg_time_rate[2].long_time = 24 * 30 seconds;
        m_dsg_time_rate[3].long_time = 18 * 30 seconds;
        m_dsg_time_rate[4].long_time = 12 * 30 seconds;
        m_dsg_time_rate[5].long_time = 9 * 30 seconds;
        m_dsg_time_rate[6].long_time = 6 * 30 seconds;
        m_dsg_time_rate[7].long_time = 3 * 30 seconds;
        m_dsg_time_rate[8].long_time = 2 * 30 seconds;
