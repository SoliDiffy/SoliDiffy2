...
contract AdminProxy is IAdmin, SaleProxy {
  ...
  */
  function getCrowdsaleInfo() public view returns (uint, address, uint, bool, bool, bool) {
  ...
  */
  function getCrowdsaleStatus() public view returns (uint, uint, uint, uint, uint, uint, bool) {
  ...
  */
  function getCrowdsaleWhitelist() public view returns (uint, address[]) {
  ...
  */
  function getWhitelistStatus(address _buyer) public view returns (uint, uint) {
  ...
  */
  function getCrowdsaleUniqueBuyers() public view returns (uint) {
