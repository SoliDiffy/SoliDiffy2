    ...
    Ownable
{
    ...
    constructor(
        ...
        string storage _name_,
        string storage _symbol_
    ) public {
     ...
     */
    function partitionsOf(address _tokenHolder) external view returns (bytes32[] storage) {
     ...
     */
    function totalPartitions() external view returns (bytes32[] storage) {
        ...
        onlyOwner
    {
        ...
        string storage iname = _getPartitionStrategyValidatorIName(_prefix);
