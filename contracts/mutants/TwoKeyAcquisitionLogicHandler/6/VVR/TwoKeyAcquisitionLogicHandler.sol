...
contract TwoKeyAcquisitionLogicHandler is UpgradeableCampaign, TwoKeyCampaignIncentiveModels {
    ...
    bool internal IS_CAMPAIGN_ACTIVE;

    address internal twoKeySingletoneRegistry;
    address internal twoKeyAcquisitionCampaign;
    address internal twoKeyConversionHandler;
    address internal ownerPlasma;
