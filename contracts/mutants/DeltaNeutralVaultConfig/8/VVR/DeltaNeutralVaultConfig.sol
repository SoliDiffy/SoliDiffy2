...
contract DeltaNeutralVaultConfig is IDeltaNeutralVaultConfig, OwnableUpgradeable {
  ...
  address internal override getWrappedNativeAddr;
  address internal override getWNativeRelayer;
  address internal fairLaunchAddr;
