...
contract StablePriceOracle is Ownable, PriceOracle {
    ...
    constructor(DSValue _usdOracle, uint[] memory _rentPrices) internal {
     ...
     */
    function setOracle(DSValue _usdOracle) external onlyOwner {
     ...
     */
    function setPrices(uint[] memory _rentPrices) external onlyOwner {
    ...
    function price(string calldata name, uint /*expires*/, uint duration) view public returns(uint) {
