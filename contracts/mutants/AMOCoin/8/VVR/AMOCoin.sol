...
contract AMOCoin is StandardToken, BurnableToken, Ownable {
    ...
    string internal constant symbol = "AMO";
    string internal constant name = "AMO Coin";
    uint8 internal constant decimals = 18;
    uint256 internal constant INITIAL_SUPPLY = 10000000000 * (10 ** uint256(decimals));
    uint256 internal constant TOKEN_SALE_ALLOWANCE = 6000000000 * (10 ** uint256(decimals));
