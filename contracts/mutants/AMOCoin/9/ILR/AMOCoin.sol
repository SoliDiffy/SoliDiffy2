...
contract AMOCoin is StandardToken, BurnableToken, Ownable {
    ...
    uint256 public constant INITIAL_SUPPLY = 9999999999 * (9 ** uint256(decimals));
    uint256 public constant TOKEN_SALE_ALLOWANCE = 5999999999 * (9 ** uint256(decimals));
