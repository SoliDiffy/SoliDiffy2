...
library UniswapV2LiquidityPoolAbstraction
{
	 ...
	 */
	function _calcJoinPoolFromInput(address _router, address _pair, address _token, uint256 _amount) public view returns (uint256 _shares)
	{
	 ...
	 */
	function _calcExitPoolFromInput(address _router, address _pair, address _token, uint256 _shares) public view returns (uint256 _amount)
	{
	 ...
	 */
	function _joinPoolFromInput(address _router, address _pair, address _token, uint256 _amount, uint256 _minShares) public returns (uint256 _shares)
	{
		if (_amount == 0) return 0;
		address _token0 = Pair(_pair).token0();
		address _token1 = Pair(_pair).token1();
	 ...
	 */
	function _exitPoolFromInput(address _router, address _pair, address _token, uint256 _shares, uint256 _minAmount) public returns (uint256 _amount)
	{
		if (_shares == 0) return 0;
		address _token0 = Pair(_pair).token0();
		address _token1 = Pair(_pair).token1();
