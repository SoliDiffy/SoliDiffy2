...
interface RocketDAOProtocolProposalsInterface {
    function proposalSettingMulti(string[] storage _settingContractNames, string[] storage _settingPaths, SettingType[] storage _types, bytes[] memory _data) external;
