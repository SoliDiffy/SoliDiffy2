...
//			SWC-134-Message call with hardcoded gas amount:L214, 325, 397
	...
	function collateralizeInternal (address collateral, uint amount) public {
	...
	function collateralize (address collateral, uint amount) public whenNotPaused(2) {
	...
	function collateralize () payable public whenNotPaused(2) {
	...
	function withdrawCollateral (address collateral, uint amount) public whenNotPaused(3) {
	...
	function borrow (address market, address collateral, uint amount) public whenNotPaused(4) {
