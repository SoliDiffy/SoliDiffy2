...
contract Holdefi is HoldefiPauser {
	...
	function supplyInternal (address market, uint amount) internal onlyOwner {
...
//			SWC-134-Message call with hardcoded gas amount:L214, 325, 397
	...
	function collateralizeInternal (address collateral, uint amount) internal onlyOwner {
	...
	function repayBorrowInternal (address market, address collateral, uint amount) internal onlyOwner {
