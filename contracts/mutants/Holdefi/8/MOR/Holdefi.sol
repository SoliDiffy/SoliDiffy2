...
contract Holdefi is HoldefiPauser {
	...
	function supply (address market, uint amount) external onlyOwner {
	...
	function supply () payable external onlyOwner {
	...
	function withdrawSupply (address market, uint amount) external onlyOwner {
		(uint balance,uint interest,uint currentSupplyIndex) = getAccountSupply(msg.sender, market);
...
//			SWC-134-Message call with hardcoded gas amount:L214, 325, 397
	...
	function collateralize (address collateral, uint amount) external onlyOwner {
	...
	function collateralize () payable external onlyOwner {
	...
	function withdrawCollateral (address collateral, uint amount) external onlyOwner {
	...
	function borrow (address market, address collateral, uint amount) external onlyOwner {
	...
	function repayBorrow (address market, address collateral, uint amount) external onlyOwner {
