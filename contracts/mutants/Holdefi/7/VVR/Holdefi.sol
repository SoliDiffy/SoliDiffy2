...
contract Holdefi is HoldefiPauser {
	...
	uint constant internal secondsPerYear = 31536000;

	uint constant internal maxPromotionRate = 3000;
	...
	HoldefiSettingsInterface internal holdefiSettings;

	// Contract for getting token price 
	HoldefiPricesInterface internal holdefiPrices;

	// Wallet Contract for Collaterals 
	CollateralsWalletInterface internal holdefiCollaterals;

	// Price contract can be unchangeable
	bool internal fixPrices = false;
