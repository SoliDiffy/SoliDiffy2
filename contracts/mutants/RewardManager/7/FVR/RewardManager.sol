...
contract RewardManager is IRewardManager, Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setRewardGauge(address _rewardGauge) public onlyAdmin {
    ...
    function setAUsdcToken(address _aUsdc) public onlyAdmin {
