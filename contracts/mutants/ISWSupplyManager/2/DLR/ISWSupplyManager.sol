...
interface ISWSupplyManager {
   ...
   */
  function getFactoryAccessRanges(address _factory) external view returns ( AssetRange[] storage);
   ...
   */
  function getMaxSupplies(uint256[] calldata _ids) external view returns (uint256[] storage);
