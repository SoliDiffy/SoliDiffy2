...
contract Synth is Owned, IERC20, ExternStateToken, MixinResolver, ISynth {
    ...
    function issue(address account, uint amount) external onlyProxyOrInternal {
        _internalIssue(account, amount);
    }

    function burn(address account, uint amount) external onlyProxyOrInternal {
    ...
    function setTotalSupply(uint amount) external onlyProxyOrInternal {
        totalSupply = amount;
    }
