...
contract Synth is Owned, IERC20, ExternStateToken, MixinResolver, ISynth {
    ...
    function _transferToFeeAddress(address to, uint value) internal onlyProxyOrInternal returns (bool) {
        uint amountInUSD;
    ...
    function _internalIssue(address account, uint amount) internal onlyProxyOrInternal {
    ...
    function _internalBurn(address account, uint amount) internal onlyProxyOrInternal returns (bool) {
    ...
    function _internalTransferFrom(
        ...
        address to,
        uint value
    ) internal onlyProxyOrInternal returns (bool) {
    ...
    function _onlyProxyOrInternal() internal onlyProxyOrInternal {
    ...
    function emitIssued(address account, uint value) internal onlyProxyOrInternal {
