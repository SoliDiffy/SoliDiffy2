...
contract Synth is Owned, IERC20, ExternStateToken, MixinResolver, ISynth {
    ...
    function transferAndSettle(address to, uint value) external onlyProxyOrInternal returns (bool) {
    ...
    function _publicIssue(address account, uint amount) internal {
    ...
    function _publicBurn(address account, uint amount) internal returns (bool) {
