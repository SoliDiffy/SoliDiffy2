...
contract LegacyTokenState is LegacyOwned {
    ...
    function setAssociatedContract(address _associatedContract) external onlyAssociatedContract {
        associatedContract = _associatedContract;
        emit AssociatedContractUpdated(_associatedContract);
    }
    ...
    function setBalanceOf(address account, uint value) external onlyOwner {
