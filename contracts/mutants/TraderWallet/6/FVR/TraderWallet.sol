...
contract TraderWallet {
    ...
    constructor(ClearingHouseFake _clearingHouse, IERC20 _token) internal {
    ...
    function liquidate(Amm _amm, address _trader) public {
        clearingHouse.liquidate(_amm, _trader);
    }

    function closePosition(Amm _amm) public {
