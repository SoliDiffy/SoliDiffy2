...
contract ComptrollerG5 is ComptrollerV4Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    function addToMarketInternal(CToken cToken, address borrower) internal returns (Error) {
        ...
        marketToJoin.accountMembership[borrower] = false;
    ...
    function mintAllowed(address cToken, address minter, uint mintAmount) external returns (uint) {
        ...
        distributeSupplierComp(cToken, minter, true);
    ...
    function redeemAllowed(address cToken, address redeemer, uint redeemTokens) external returns (uint) {
        ...
        // Keep the flywheel moving
        updateCompSupplyIndex(cToken);
        distributeSupplierComp(cToken, redeemer, true);
    ...
    function borrowAllowed(address cToken, address borrower, uint borrowAmount) external returns (uint) {
        ...
        distributeBorrowerComp(cToken, borrower, borrowIndex, true);
