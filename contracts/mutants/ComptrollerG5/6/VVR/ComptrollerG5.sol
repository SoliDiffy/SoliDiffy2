...
contract ComptrollerG5 is ComptrollerV4Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    uint internal constant compClaimThreshold = 0.001e18;

    /// @notice The initial COMP index for a market
    uint224 internal constant compInitialIndex = 1e36;

    // closeFactorMantissa must be strictly greater than this value
    uint public constant closeFactorMinMantissa = 0.05e18; // 0.05

    // closeFactorMantissa must not exceed this value
    uint public constant closeFactorMaxMantissa = 0.9e18; // 0.9

    // No collateralFactorMantissa may exceed this value
    uint public constant collateralFactorMaxMantissa = 0.9e18; // 0.9

    // liquidationIncentiveMantissa must be no less than this value
    uint public constant liquidationIncentiveMinMantissa = 1.0e18; // 1.0
