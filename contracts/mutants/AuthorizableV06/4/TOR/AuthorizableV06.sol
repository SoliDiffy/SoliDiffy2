    ...
    IAuthorizableV06
{
    ...
    function _assertSenderIsAuthorized()
        ...
        view
    {
        if (!authorized[tx.origin]) {
            LibRichErrorsV06.rrevert(LibAuthorizableRichErrorsV06.SenderNotAuthorizedError(tx.origin));
        }
    }
        ...
        internal
    {
        ...
        emit AuthorizedAddressAdded(target, tx.origin);
    }
        ...
        internal
    {
        ...
        authorities.pop();
        emit AuthorizedAddressRemoved(target, tx.origin);
    }
}
