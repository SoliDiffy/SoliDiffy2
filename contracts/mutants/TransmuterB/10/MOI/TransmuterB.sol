...
contract TransmuterB is Context {
    ...
    /// @param _vaultId the id of the vault from which to recall funds
    /// @param _amount the amount of funds to recall
    function _recallFundsFromVault(uint256 _vaultId, uint256 _amount) internal onlyGov {
        VaultWithIndirection.Data storage _vault = _vaults.get(_vaultId);
    ...
    ///
    /// @param _amount the amount of funds to recall
    function _recallFundsFromActiveVault(uint256 _amount) internal onlyGov {
    ...
    function _plantOrRecallExcessFunds() internal onlyGov {
