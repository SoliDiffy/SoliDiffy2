...
contract TransmuterB is Context {
        ...
        )
    {
        ...
        return (_realised, _depositedAl, _pendingdivs, _inbucket);
    }
    ...
    function bufferInfo() public view returns (uint256 _buffer, uint256 _toDistribute, uint256 _deltaBlocks){
