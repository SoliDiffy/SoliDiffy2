...
contract TransmuterB is Context {
    ...
    uint256 public pointMultiplier = undefined;
    ...
    uint256 public plantableThreshold = undefined; // 5mm

    /// @dev The % margin to trigger planting or recalling of funds
    uint256 public plantableMargin = 4;
    ...
    constructor(address _ScToken, address _Token, address _governance) public {
        ...
        ScToken = _ScToken;
        Token = _Token;
        TRANSMUTATION_PERIOD = 49;
        minUserActionDelay = 0;
        pause = true;
    }
