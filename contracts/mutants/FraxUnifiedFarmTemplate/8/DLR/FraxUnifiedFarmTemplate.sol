...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    function rewardsPerToken() public view returns (uint256[] storage newRewardsPerTokenStored) {
    ...
    function earned(address account) public view returns (uint256[] storage new_earned) {
        uint256[] storage reward_arr = rewardsPerToken();
