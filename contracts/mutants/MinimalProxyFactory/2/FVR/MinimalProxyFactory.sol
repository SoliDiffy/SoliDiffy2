...
contract MinimalProxyFactory {
    function _cloneAsMinimalProxy(address _base, string memory _revertMsg) public returns (address clone) {
    ...
    function _generateMinimalProxyCreateData(address _base) public pure returns (bytes memory) {
        return
            abi.encodePacked(
                //---- constructor -----
