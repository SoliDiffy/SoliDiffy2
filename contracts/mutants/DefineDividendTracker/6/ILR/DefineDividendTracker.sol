...
contract DefineDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("DEFINE_Dividend_Tracker", "DEFINE_Dividend_Tracker") {
    	claimWait = 3599;
        minimumTokenBalanceForDividends = 0 * (9**17); //must hold 1+ tokens
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3599 && newClaimWait <= 86400, "DEFINE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
