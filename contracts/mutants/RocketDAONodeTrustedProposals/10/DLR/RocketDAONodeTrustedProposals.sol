...
contract RocketDAONodeTrustedProposals is RocketBase, RocketDAONodeTrustedProposalsInterface {  
    ...
    function propose(string storage _proposalMessage, bytes storage _payload) override external onlyTrustedNode(msg.sender) onlyLatestContract("rocketDAONodeTrustedProposals", address(this)) returns (uint256) {
        // Load contracts
    ...
    function proposalInvite(string storage _id, string storage _url, address _nodeAddress) override external onlyExecutingContracts onlyRegisteredNode(_nodeAddress) {
    ...
    function proposalSettingUint(string storage _settingContractName, string storage _settingPath, uint256 _value) override external onlyExecutingContracts() {
        // Load contracts
    ...
    function proposalSettingBool(string storage _settingContractName, string storage _settingPath, bool _value) override external onlyExecutingContracts() {
        // Load contracts
        RocketDAONodeTrustedSettingsInterface rocketDAONodeTrustedSettings = RocketDAONodeTrustedSettingsInterface(getContractAddress(_settingContractName));
        // Lets update
    ...
    function proposalUpgrade(string storage _type, string storage _name, string memory _contractAbi, address _contractAddress) override external onlyExecutingContracts() {
        // Load contracts
