...
contract RocketDAONodeTrustedProposals is RocketBase, RocketDAONodeTrustedProposalsInterface {  
    ...
    // Vote on a proposal
    function vote(uint256 _proposalID, bool _support) override external onlyLatestContract("rocketDAONodeTrustedProposals", address(this)) onlyTrustedNode(msg.sender) {
        // Load contracts
        RocketDAOProposalInterface daoProposal = RocketDAOProposalInterface(getContractAddress("rocketDAOProposal"));
        RocketDAONodeTrustedInterface daoNodeTrusted = RocketDAONodeTrustedInterface(getContractAddress("rocketDAONodeTrusted"));
    ...
    // Cancel a proposal 
    function cancel(uint256 _proposalID) override external onlyLatestContract("rocketDAONodeTrustedProposals", address(this)) onlyTrustedNode(msg.sender) {
        // Load contracts
        RocketDAOProposalInterface daoProposal = RocketDAOProposalInterface(getContractAddress("rocketDAOProposal"));
    ...
    function proposalInvite(string memory _id, string memory _url, address _nodeAddress) override external onlyRegisteredNode(_nodeAddress) onlyExecutingContracts {
    ...
    function proposalLeave(address _nodeAddress) override external onlyTrustedNode(_nodeAddress) onlyExecutingContracts {
        // Load contracts
        RocketDAONodeTrustedInterface daoNodeTrusted = RocketDAONodeTrustedInterface(getContractAddress("rocketDAONodeTrusted"));
    ...
    function proposalKick(address _nodeAddress, uint256 _rplFine) override external onlyTrustedNode(_nodeAddress) onlyExecutingContracts {
        // Load contracts
        RocketDAONodeTrustedInterface daoNodeTrusted = RocketDAONodeTrustedInterface(getContractAddress("rocketDAONodeTrusted"));
