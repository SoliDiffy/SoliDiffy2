...
contract RocketDAONodeTrustedProposals is RocketBase, RocketDAONodeTrustedProposalsInterface {  
    ...
    function propose(string memory _proposalMessage, bytes memory _payload) override external onlyLatestContract("rocketDAONodeTrustedProposals", address(this)) onlyTrustedNode(msg.sender) returns (uint256) {
        // Load contracts
