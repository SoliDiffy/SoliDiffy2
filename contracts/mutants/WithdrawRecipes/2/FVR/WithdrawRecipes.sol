...
contract WithdrawRecipes {
    ...
    function withdrawUniNft(uint256 tokenId, uint256 partToWithdraw) public onlyOwner(tokenId) {
        require(
    ...
    function zapOutUniNft(uint256 tokenId, address tokenOut) public onlyOwner(tokenId) {
