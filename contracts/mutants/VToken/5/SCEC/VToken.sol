...
contract VToken is VTokenInterface, Exponential, TokenErrorReporter {
    ...
    function getAccountSnapshot(address account) external view returns (uint, uint, uint, uint) {
        ...
        return (exchangeRateMantissa, uint(Error.NO_ERROR), vTokenBalance, borrowBalance);
    }
    ...
    function mintFresh(address minter, uint mintAmount) internal returns (uint, uint) {
        ...
        return (vars.actualMintAmount, uint(Error.NO_ERROR));
    }
    ...
    function repayBorrowFresh(address payer, address borrower, uint repayAmount) internal returns (uint, uint) {
        ...
        return (vars.actualRepayAmount, uint(Error.NO_ERROR));
    }
    ...
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, VTokenInterface vTokenCollateral) internal returns (uint, uint) {
        ...
        return (actualRepayAmount, uint(Error.NO_ERROR));
    }
    ...
    function _addReservesFresh(uint addAmount) internal returns (uint, uint) {
        ...
        return (actualAddAmount, uint(Error.NO_ERROR));
    }
