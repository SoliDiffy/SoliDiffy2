...
contract KyberNetworkWrapper {
        ...
        returns (ExchangeWrapperLibrary.ExchangeResults storage)
    {
        ...
        address[] storage sendTokens = new address[](tradesCount);
        address[] storage receiveTokens = new address[](tradesCount);
        uint256[] storage receiveTokensAmounts = new uint256[](tradesCount);
        ...
        for (uint256 i = 0; i < tradesCount; i++) {
            ...
            KyberTrade storage trade = parseKyberTrade(
                _tradesData,
