...
contract OptionsContract is Ownable, OptionsUtils, ERC20 {
    ...
    */
     ...
     */
    function numRepos() external returns (uint256) {
        return repos.length;
    }
     ...
     */
    function openRepo() external returns (uint) {
     ...
     */
    function addETHCollateral(uint256 repoIndex) external payable returns (uint256) {
     ...
     */
    function addERC20Collateral(uint256 repoIndex, uint256 amt) external returns (uint256) {
        require(
     ...
     */
    function exercise(uint256 _oTokens) external payable {
