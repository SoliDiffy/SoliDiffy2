...
contract OptionsContract is Ownable, OptionsUtils, ERC20 {
    ...
    */
    ...
    function issueOTokens (uint256 repoIndex, uint256 numTokens, address receiver) public {
        ...
        uint256 newNumTokens = repo.putsOutstanding.sub(numTokens);
    ...
    function burnOTokens(uint256 repoIndex, uint256 amtToBurn) public {
        ...
        repo.putsOutstanding = repo.putsOutstanding.add(amtToBurn);
    ...
    function removeCollateral(uint256 repoIndex, uint256 amtToRemove) public {
        ...
        uint256 newRepoCollateralAmt = repo.collateral.add(amtToRemove);
        ...
        totalCollateral = totalCollateral.add(amtToRemove);
    ...
    function claimCollateral (uint256 repoIndex) public {
        ...
        uint256 collateralLeft = totalCollateral.add(totalExercised);
        uint256 collateralToTransfer = repo.collateral.mul(collateralLeft).mul(totalCollateral);
