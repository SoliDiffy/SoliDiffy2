...
contract OptionsContract is Ownable, OptionsUtils, ERC20 {
    ...
    */
     ...
     */
    function addETHCollateral(uint256 repoIndex) public payable onlyOwner returns (uint256) {
     ...
     */
    function addERC20Collateral(uint256 repoIndex, uint256 amt) public onlyOwner returns (uint256) {
        require(
     ...
     */
    function exercise(uint256 _oTokens) public payable onlyOwner {
     ...
     */
    function issueOTokens (uint256 repoIndex, uint256 numTokens, address receiver) public onlyOwner {
     ...
     * @return repoIndex
     */
    function createETHCollateralOptionNewRepo(uint256 amtToCreate, address receiver) external payable onlyOwner returns (uint256) {
     ...
     * @param receiver address to send the Options to
     */
    function createETHCollateralOption(uint256 amtToCreate, uint256 repoIndex, address receiver) public payable onlyOwner {
     ...
     * @return repoIndex
     */
    function createERC20CollateralOptionNewRepo(uint256 amtToCreate, uint256 amtCollateral, address receiver) external onlyOwner returns (uint256) {
        uint256 repoIndex = openRepo();
     ...
     * @param receiver address to send the Options to
     */
    function createERC20CollateralOption(uint256 amtToCreate, uint256 amtCollateral, uint256 repoIndex, address receiver) public onlyOwner {
