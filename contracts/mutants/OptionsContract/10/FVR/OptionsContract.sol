...
contract OptionsContract is Ownable, OptionsUtils, ERC20 {
    ...
    */
     ...
     */
    function issueOTokens (uint256 repoIndex, uint256 numTokens, address receiver) external {
     ...
     */
    function getReposByOwner(address _owner) external view returns (uint[] memory) {
