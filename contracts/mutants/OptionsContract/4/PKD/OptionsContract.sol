...
contract OptionsContract is Ownable, OptionsUtils, ERC20 {
    ...
    */
     ...
     */
    function addETHCollateral(uint256 repoIndex) public  returns (uint256) {
     ...
     */
    function exercise(uint256 _oTokens) public  {
     ...
     * @return repoIndex
     */
    function createETHCollateralOptionNewRepo(uint256 amtToCreate, address receiver) external  returns (uint256) {
     ...
     * @param receiver address to send the Options to
     */
    function createETHCollateralOption(uint256 amtToCreate, uint256 repoIndex, address receiver) public  {
