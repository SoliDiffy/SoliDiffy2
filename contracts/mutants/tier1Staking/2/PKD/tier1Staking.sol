...
interface Tier2StakingInterface {
  ...
  //actions
  function deposit(address tokenAddress, uint256 amount, address onBehalfOf)  external returns (bool);
  function withdraw(address tokenAddress, uint256 amount, address payable onBehalfOf)  external returns(bool);
