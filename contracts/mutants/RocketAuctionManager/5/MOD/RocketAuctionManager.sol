...
contract RocketAuctionManager is RocketBase, RocketAuctionManagerInterface {
    ...
    function createLot() override external  {
        // Load contracts
    ...
    // Bid on a lot
    function placeBid(uint256 _lotIndex) override external payable  {
        // Load contracts
        RocketDAOProtocolSettingsAuctionInterface rocketAuctionSettings = RocketDAOProtocolSettingsAuctionInterface(getContractAddress("rocketDAOProtocolSettingsAuction"));
    ...
    function claimBid(uint256 _lotIndex) override external  {
        // Check lot exists
        require(getLotExists(_lotIndex), "Lot does not exist");
        // Get lot price info
    ...
    function recoverUnclaimedRPL(uint256 _lotIndex) override external  {
