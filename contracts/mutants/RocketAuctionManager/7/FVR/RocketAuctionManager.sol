...
contract RocketAuctionManager is RocketBase, RocketAuctionManagerInterface {
    ...
    function increaseAllottedRPLBalance(uint256 _amount) public {
        addUint(keccak256(abi.encodePacked("auction.rpl.allotted")), _amount);
    }
    function decreaseAllottedRPLBalance(uint256 _amount) public {
    ...
    function setLotCount(uint256 _amount) public {
    ...
    function increaseLotTotalBidAmount(uint256 _index, uint256 _amount) public {
    ...
    function setLotAddressBidAmount(uint256 _index, address _bidder, uint256 _amount) public {
        setUint(keccak256(abi.encodePacked("auction.lot.bid.address", _index, _bidder)), _amount);
    }
    function increaseLotAddressBidAmount(uint256 _index, address _bidder, uint256 _amount) public {
    ...
    function setLotRPLRecovered(uint256 _index, bool _recovered) public {
