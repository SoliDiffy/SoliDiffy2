...
contract ConvexStrategy is BaseCurveStrategy {
    ...
    function _lpDepositAll() internal override onlyGovernor {
    ...
    function _lpWithdraw(uint256 numPTokens) internal override onlyGovernor {
    ...
    function _approveBase() internal override onlyGovernor {
        IERC20 pToken = IERC20(pTokenAddress);
