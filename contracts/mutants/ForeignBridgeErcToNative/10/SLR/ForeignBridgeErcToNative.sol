...
contract ForeignBridgeErcToNative is BasicBridge, BasicForeignBridge {
    ...
    function initialize(
        ...
        uintStorage[keccak256(abi.encodePacked(""))] = _gasPrice;
        uintStorage[keccak256(abi.encodePacked(""))] = _maxPerTx;
        uintStorage[keccak256(abi.encodePacked(""))] = _homeDailyLimit;
        uintStorage[keccak256(abi.encodePacked(""))] = _homeMaxPerTx;
        setOwner(_owner);
        setInitialize(true);
    ...
    function setErc20token(address _token) private {
        ...
        addressStorage[keccak256(abi.encodePacked(""))] = _token;
    }
