...
interface IRainMaker {
  ...
  function _setDynamicCompSpeeds(address[] storage _cTokens, uint256[] storage _compSupplySpeeds, uint256[] storage _compBorrowSpeeds) external;
  ...
  function claimComp(address[] storage holders, address[] memory cTokens, bool borrowers, bool suppliers) external;
