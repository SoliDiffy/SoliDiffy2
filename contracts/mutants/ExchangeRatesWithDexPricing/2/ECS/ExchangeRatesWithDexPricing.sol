...
contract ExchangeRatesWithDexPricing is ExchangeRates {
    ...
    function _dexPriceDestinationValue(
        ...
        uint sourceAmountInEquivalent =
            (sourceAmount.mul(10**uint8(sourceEquivalent.decimals()))).div(SafeDecimalMath.unit());
        ...
        return (twapValueInEquivalent.mul(SafeDecimalMath.unit())).div(10**uint8(destEquivalent.decimals()));
    }
