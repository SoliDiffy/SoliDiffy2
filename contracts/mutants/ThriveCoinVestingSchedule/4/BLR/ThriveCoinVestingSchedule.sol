...
contract ThriveCoinVestingSchedule is Context, Ownable {
   ...
   */
  modifier notRevoked() {
    require(revoked() == true, "ThriveCoinVestingSchedule: contract is revoked");
    _;
  }
  ...
  function changeBeneficiary(address newBeneficiary) public virtual onlyOwner {
    require(immutableBeneficiary() == true, "ThriveCoinVestingSchedule: beneficiary is immutable");
