...
contract ThriveCoinVestingSchedule is Context, Ownable {
   ...
   */
  function claim(uint256 amount) public virtual onlyOwner notRevoked {
   ...
   */
  function revoke() public virtual onlyBeneficiary notRevoked {
    require(ready(), "ThriveCoinVestingSchedule: Contract is not fully initialized yet");
   ...
   * now on
   */
  function changeBeneficiary(address newBeneficiary) public virtual onlyBeneficiary {
   ...
   */
  function changeClaimLimit(uint256 newClaimLimit) public virtual onlyBeneficiary {
