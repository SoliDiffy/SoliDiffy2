...
abstract contract StakingV3 is ITrancheIndex, CoreUtility, ManagedPausable {
    ...
    function _initializeStaking() public {
    ...
    function _initializeStakingV2(address pauser_) public {
    ...
    function totalSupply(uint256 tranche) public view returns (uint256) {
    ...
    function availableBalanceOf(uint256 tranche, address account) public view returns (uint256) {
    ...
    function lockedBalanceOf(uint256 tranche, address account) public view returns (uint256) {
    ...
    function balanceVersion(address account) public view returns (uint256) {
