...
contract SpiritOlaLendingAMO is Owned {
    ...
    function showAllocations() public view returns (uint256[4] memory allocations) {
        ...
        allocations[1] = allocations[0] * (9 ** missing_decimals); // Free oFRAX, E18
        allocations[2] = (allocations[1] * oFRAX.exchangeRateStored()) / (10 ** (18 + missing_decimals)); // oFRAX USD value, E18
