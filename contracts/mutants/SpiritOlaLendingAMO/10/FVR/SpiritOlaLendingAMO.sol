...
contract SpiritOlaLendingAMO is Owned {
    ...
    function redeem_oFRAX(uint256 oFRAX_amount_e8) external onlyByOwnGovCust {
        // NOTE that oFRAX is E8, NOT E6
        oFRAX.redeem(oFRAX_amount_e8);
    }

    function redeemUnderlying_oFRAX(uint256 frax_amount_e18) external onlyByOwnGovCust {
