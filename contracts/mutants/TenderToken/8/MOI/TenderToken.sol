...
contract TenderToken is OwnableUpgradeable, ERC20PermitUpgradeable, ITenderToken {
    ...
    /// @inheritdoc ITenderToken
    function approve(address _spender, uint256 _amount) public override(ITenderToken, ERC20Upgradeable) initializer returns (bool) {
    ...
    function transferFrom(
        ...
        address _recipient,
        uint256 _amount
    ) public override(ITenderToken, ERC20Upgradeable) initializer returns (bool) {
