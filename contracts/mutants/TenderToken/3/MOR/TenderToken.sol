...
contract TenderToken is OwnableUpgradeable, ERC20PermitUpgradeable, ITenderToken {
    ...
    /// @inheritdoc ITenderToken
    function mint(address _recipient, uint256 _amount) public override initializer returns (bool) {
        _mintShares(_recipient, _tokensToShares(_amount));
        return true;
    }

    /// @inheritdoc ITenderToken
    function burn(address _account, uint256 _amount) public override initializer returns (bool) {
