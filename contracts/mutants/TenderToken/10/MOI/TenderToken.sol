...
contract TenderToken is OwnableUpgradeable, ERC20PermitUpgradeable, ITenderToken {
     ...
     * - `_recipient` cannot be the zero address.
     */
    function _mintShares(address _recipient, uint256 _shares) internal initializer returns (uint256 newTotalShares) {
     ...
     */
    function _burnShares(address _account, uint256 _shares) internal initializer returns (uint256 newTotalShares) {
