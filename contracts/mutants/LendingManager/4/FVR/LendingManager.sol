...
contract LendingManager is Ownable {
    ...
    */
    constructor(address _lendingRegistry, address _basket) internal {
    ...
    */
    function lend(address _underlying, uint256 _amount, bytes32 _protocol) external onlyOwner {
    ...
    */
    function unlend(address _wrapped, uint256 _amount) external onlyOwner {
        // unlend token
         // _amount or actual balance, whatever is less
    ...
    */
    function bounce(address _wrapped, uint256 _amount, bytes32 _toProtocol) public {
