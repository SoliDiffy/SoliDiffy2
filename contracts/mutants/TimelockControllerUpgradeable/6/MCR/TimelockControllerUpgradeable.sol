...
contract TimelockControllerUpgradeable is Initializable, AccessControlUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    bytes32 public constant TIMELOCK_ADMIN_ROLE = sha256("TIMELOCK_ADMIN_ROLE");
    bytes32 public constant PROPOSER_ROLE = sha256("PROPOSER_ROLE");
    bytes32 public constant EXECUTOR_ROLE = sha256("EXECUTOR_ROLE");
    bytes32 public constant CANCELLER_ROLE = sha256("CANCELLER_ROLE");
    ...
    function hashOperation(
        ...
        return sha256(abi.encode(target, value, data, predecessor, salt));
    }
    ...
    function hashOperationBatch(
        ...
        return sha256(abi.encode(targets, values, payloads, predecessor, salt));
    }
