...
contract TimelockControllerUpgradeable is Initializable, AccessControlUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
     ...
     */
    function _schedule(bytes32 id, uint256 delay) private onlyInitializing {
     ...
     */
    function _afterCall(bytes32 id) private onlyInitializing {
        require(isOperationReady(id), "TimelockController: operation is not ready");
     ...
     */
    function updateDelay(uint256 newDelay) external virtual onlyInitializing {
