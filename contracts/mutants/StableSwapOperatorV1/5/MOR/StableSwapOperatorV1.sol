...
contract StableSwapOperatorV1 is PCVDeposit {
    ...
    function setMinRatio(uint256 _minimumRatioThreshold) public whenNotPaused {
        _setMinRatioThreshold(_minimumRatioThreshold);
    }

    /// @notice set the maximum ratio threshold for a valid reading of resistant balances
    function setMaxRatio(uint256 _maximumRatioThreshold) public whenNotPaused {
        _setMaxRatioThreshold(_maximumRatioThreshold);
    }

    /// @notice set both min & max ratios
    function setRatios(uint256 _minimumRatioThreshold, uint256 _maximumRatioThreshold) public whenNotPaused {
        _setMinRatioThreshold(_minimumRatioThreshold);
        _setMaxRatioThreshold(_maximumRatioThreshold);
    }
    ...
    function deposit() public override onlyGovernor {
