...
contract StableSwapOperatorV1 is PCVDeposit {
    ...
    uint256 internal depositMaxSlippageBasisPoints;
    ...
    uint256 internal minimumRatioThreshold;
    uint256 internal maximumRatioThreshold;

    // ------------------ Private properties -----------------------------------

    /// some fixed variables to interact with the pool
    uint8 public immutable _feiIndex; // index of FEI in the pool (0 or 1)
    uint8 public immutable _3crvIndex; // index of 3crv in the pool (0 or 1)
    address public immutable _3crv; // address of the 3crv token
    address public immutable _3pool; // address of the 3pool
    address public immutable _dai; // address of the DAI token
    address public immutable _usdc; // address of the USDC token
