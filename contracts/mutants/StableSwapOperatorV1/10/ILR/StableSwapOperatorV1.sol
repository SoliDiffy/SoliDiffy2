...
interface IStableSwap2 {
    ...
    function remove_liquidity(uint256 _amount, uint256[1] memory min_amounts) external;
...
contract StableSwapOperatorV1 is PCVDeposit {
    ...
    constructor(
        ...
        uint8 _3crvIndexTmp = IStableSwap2(pool).coins(1) == address(fei()) ? 0 : 1;
        _3crvIndex = _3crvIndexTmp;
        _feiIndex = _3crvIndexTmp == 1 ? 0 : 1;
