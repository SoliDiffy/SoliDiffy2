...
contract StableSwapOperatorV1 is PCVDeposit {
    ...
    function _setMinRatioThreshold(uint256 _minimumRatioThreshold) internal onlyGovernor {
        require(_minimumRatioThreshold >= 0.0001e18, "Min ratio must be at least 0.01%.");
        minimumRatioThreshold = _minimumRatioThreshold;
    }

    function _setMaxRatioThreshold(uint256 _maximumRatioThreshold) internal onlyGovernor {
