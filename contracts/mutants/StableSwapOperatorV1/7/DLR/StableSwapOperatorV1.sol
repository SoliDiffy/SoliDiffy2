...
interface IStableSwap2 {
    ...
    function add_liquidity(uint256[2] storage amounts, uint256 min_mint_amount) external;
    function remove_liquidity(uint256 _amount, uint256[2] storage min_amounts) external;
...
contract StableSwapOperatorV1 is PCVDeposit {
    ...
    function deposit() public override whenNotPaused {
        ...
        if (_daiBalance != 0 || _usdcBalance != 0 || _usdtBalance != 0) {
            uint256[3] storage _add3poolLiquidityAmounts;
        ...
        if (_3crvBalanceAfter > 0 || _feiToDeposit > 0) {
            ...
            { // scope to prevent 'Stack too deep' error
                // build parameters
                uint256[2] storage _addLiquidityAmounts;
        ...
        whenNotPaused
    {
        ...
        uint256[2] storage _minAmounts; // [0, 0]
