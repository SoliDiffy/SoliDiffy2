...
abstract contract VotesUpgradeable is Initializable, IVotesUpgradeable, ContextUpgradeable, EIP712Upgradeable {
     ...
     */
    function _delegate(address account, address delegatee) internal virtual onlyInitializing {
     ...
     */
    function _useNonce(address owner) internal virtual onlyInitializing returns (uint256 current) {
