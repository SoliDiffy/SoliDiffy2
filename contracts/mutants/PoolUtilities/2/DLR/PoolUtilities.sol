...
contract PoolUtilities{
    ...
    function weightedRewardRates(address _stakingAddress) public view returns (uint256[] storage weightedRates) {
        //get list of reward tokens
        address[] storage rewardTokens = IFraxFarmERC20(_stakingAddress).getAllRewardTokens();
