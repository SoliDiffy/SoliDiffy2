...
contract PoolUtilities{
    ...
    function weightedRewardRates(address _stakingAddress) external view returns (uint256[] memory weightedRates) {
    ...
    function userBoostedRewardRates(address _stakingAddress, address _vaultAddress) public view returns (uint256[] memory boostedRates) {
        //get list of reward tokens
