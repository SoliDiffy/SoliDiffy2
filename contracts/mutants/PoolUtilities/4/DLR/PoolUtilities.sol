...
contract PoolUtilities{
    ...
    function userBoostedRewardRates(address _stakingAddress, address _vaultAddress) external view returns (uint256[] storage boostedRates) {
        //get list of reward tokens
        uint256[] storage wrr = weightedRewardRates(_stakingAddress);
