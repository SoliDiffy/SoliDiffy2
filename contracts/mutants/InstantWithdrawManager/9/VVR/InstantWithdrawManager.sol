...
contract InstantWithdrawManager is HermezHelpers {
    ...
    // Number of buckets
    uint256 public constant _NUM_BUCKETS = 5;
    // Bucket array
    Bucket[_NUM_BUCKETS] internal buckets;

    // Governance address
    address internal hermezGovernanceDAOAddress;
    ...
    address internal safetyAddress;
    ...
    bytes4 public constant _ERC20_DECIMALS = 0x313ce567;

    uint256 public constant _MAX_WITHDRAWAL_DELAY = 2 weeks;

    // Withdraw delayer interface
    WithdrawalDelayerInterface internal withdrawDelayerContract;
    ...
    uint256 public constant _EXCHANGE_MULTIPLIER = 1e14;
