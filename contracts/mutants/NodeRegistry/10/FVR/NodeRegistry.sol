...
contract NodeRegistry {
    ...
    constructor(BlockhashRegistry _blockRegistry) internal {
    ...
    function convict(uint _blockNumber, bytes32 _hash) public {
    ...
    function returnDeposit(address _signer) public {
