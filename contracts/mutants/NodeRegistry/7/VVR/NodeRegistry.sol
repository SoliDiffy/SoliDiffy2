...
contract NodeRegistry {
    ...
    BlockhashRegistry internal blockRegistry;

    /// the timestamp of the deployment
    uint internal blockTimeStampDeployment;

    /// admin-key to remove some server, only usable within the 1st year
    address internal unregisterKey;
    ...
    uint constant public YEAR_DEFINITION = 1 days * 365;
