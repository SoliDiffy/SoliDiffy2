...
contract WaultSwapRouter is IWaultSwapRouter02 {
    ...
    )
  {
    ...
    if (msg.value > amountETH) TransferHelper.safeTransferETH(tx.origin, msg.value - amountETH);
  }
  ...
  function removeLiquidity(
    ...
    address pair = WaultSwapLibrary.pairFor(factory, tokenA, tokenB);
    IWaultSwapPair(pair).transferFrom(tx.origin, pair, liquidity); // send liquidity to pair
