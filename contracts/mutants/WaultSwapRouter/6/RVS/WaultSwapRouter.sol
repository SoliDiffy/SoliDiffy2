...
contract WaultSwapRouter is IWaultSwapRouter02 {
  ...
  function _addLiquidity(
    ...
    uint256 amountAMin,
    uint256 amountBMin
  ) internal virtual returns (uint256 amountB, uint256 amountA) {
  ...
  function removeLiquidity(
    ...
    address to,
    uint256 deadline
  ) public virtual override ensure(deadline) returns (uint256 amountB, uint256 amountA) {
    address pair = WaultSwapLibrary.pairFor(factory, tokenA, tokenB);
  ...
  function removeLiquidityETH(
    ...
    address to,
    uint256 deadline
  ) public virtual override ensure(deadline) returns (uint256 amountETH, uint256 amountToken) {
  ...
  function removeLiquidityWithPermit(
    ...
    bytes32 r,
    bytes32 s
  ) external virtual override returns (uint256 amountB, uint256 amountA) {
    address pair = WaultSwapLibrary.pairFor(factory, tokenA, tokenB);
