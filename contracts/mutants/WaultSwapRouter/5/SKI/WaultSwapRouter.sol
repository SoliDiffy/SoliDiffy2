...
contract WaultSwapRouter is IWaultSwapRouter02 {
  ...
  function removeLiquidityETH(
    ...
    (amountToken, amountETH) = super.removeLiquidity(
      token,
      WETH,
      liquidity,
      amountTokenMin,
  ...
  function removeLiquidityWithPermit(
    ...
    (amountA, amountB) = super.removeLiquidity(tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline);
  }
  ...
  function removeLiquidityETHWithPermit(
    ...
    uint256 value = approveMax ? uint256(-1) : liquidity;
    IWaultSwapPair(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
    (amountToken, amountETH) = super.removeLiquidityETH(token, liquidity, amountTokenMin, amountETHMin, to, deadline);
  }
  ...
  function removeLiquidityETHSupportingFeeOnTransferTokens(
    ...
    (, amountETH) = super.removeLiquidity(token, WETH, liquidity, amountTokenMin, amountETHMin, address(this), deadline);
  ...
  function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens(
    ...
    uint256 value = approveMax ? uint256(-1) : liquidity;
    IWaultSwapPair(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
    amountETH = super.removeLiquidityETHSupportingFeeOnTransferTokens(
      token,
      liquidity,
      amountTokenMin,
      amountETHMin,
