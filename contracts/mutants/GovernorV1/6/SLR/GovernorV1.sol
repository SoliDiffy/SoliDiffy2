...
contract GovernorV1 {
    ...
    bytes32 public constant BALLOT_TYPE_HASH = keccak256("");
    ...
    function __queueSetTimelockPendingAdmin(address newPendingAdmin, uint256 eta) public {
        ...
        timelock.queueTransaction(address(timelock), 0, "", abi.encode(newPendingAdmin), eta);
    }

    function __executeSetTimelockPendingAdmin(address newPendingAdmin, uint256 eta) public {
        require(msg.sender == guardian, "GovernorV1::__executeSetTimelockPendingAdmin: sender must be gov guardian");
        timelock.executeTransaction(address(timelock), 0, "", abi.encode(newPendingAdmin), eta);
    }
