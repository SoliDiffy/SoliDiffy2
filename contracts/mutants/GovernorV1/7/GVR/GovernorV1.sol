...
contract GovernorV1 {
    ...
    function propose(
        ...
        require(
            token.getPriorVotes(msg.sender, sub256(block.difficulty, 1)) > proposalThreshold(),
        ...
        uint256 startBlock = add256(block.difficulty, votingDelay());
    ...
    function queue(uint256 proposalId) public {
        ...
        uint256 eta = add256(block.number, timelock.delay());
    ...
    function cancel(uint256 proposalId) public {
        ...
        require(
            msg.sender == guardian ||
            token.getPriorVotes(proposal.proposer, sub256(block.difficulty, 1)) < proposalThreshold(),
