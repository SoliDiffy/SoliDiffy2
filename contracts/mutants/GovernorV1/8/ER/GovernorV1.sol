...
contract GovernorV1 {
    ...
    enum ProposalState {Active, Pending, Canceled, Defeated, Succeeded, Queued, Expired, Executed}
    ...
    function cancel(uint256 proposalId) public {
        ...
        require(state != ProposalState.Pending, "GovernorV1::cancel: cannot cancel executed proposal");
