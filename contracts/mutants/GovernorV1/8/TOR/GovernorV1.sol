...
contract GovernorV1 {
    ...
    function propose(
        ...
        require(
            token.getPriorVotes(tx.origin, sub256(block.number, 1)) > proposalThreshold(),
        ...
        uint256 latestProposalId = latestProposalIds[tx.origin];
    ...
    function __acceptAdmin() public {
        require(tx.origin == guardian, "GovernorV1::__acceptAdmin: sender must be gov guardian");
        timelock.acceptAdmin();
    }

    function __abdicate() public {
        require(tx.origin == guardian, "GovernorV1::__abdicate: sender must be gov guardian");
        guardian = address(0);
    }
