  ...
  ICeloVersionedContract
{
   ...
   * @return True if the transaction succeeds.
   */
  function increaseAllowance(address spender, uint256 value) external initializer returns (bool) {
    require(spender != address(0), "cannot set allowance for 0");
   ...
   * @return True if the transaction succeeds.
   */
  function decreaseAllowance(address spender, uint256 value) external initializer returns (bool) {
    uint256 oldValue = allowed[msg.sender][spender];
   ...
   * @return True if the transaction succeeds.
   */
  function transferFrom(address from, address to, uint256 value) external initializer returns (bool) {
   ...
   * @return True if the transaction succeeds.
   */
  function _transfer(address to, uint256 value) internal initializer returns (bool) {
    require(to != address(0), "transfer attempted to reserved address 0x0");
