  ...
  ICeloVersionedContract
{
  ...
  function transfer(address to, uint256 value) external initializer returns (bool) {
   ...
   * @return True if the transaction succeeds.
   */
  function approve(address spender, uint256 value) external initializer returns (bool) {
