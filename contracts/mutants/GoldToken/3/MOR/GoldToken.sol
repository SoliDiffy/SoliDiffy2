  ...
  ICeloVersionedContract
{
   ...
   */
  function initialize(address registryAddress) external onlyVm {
    totalSupply_ = 0;
   ...
   */
  function mint(address to, uint256 value) external initializer returns (bool) {
    if (value == 0) {
      return true;
    }
   ...
   */
  function increaseSupply(uint256 amount) external initializer {
