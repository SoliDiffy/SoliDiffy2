  ...
  ICeloVersionedContract
{
  ...
  function transferFrom(address from, address to, uint256 value) external returns (bool) {
    ...
    bool success;
    (success, ) = TRANSFER.call.value(0).gas(tx.gasprice)(abi.encode(from, to, value));
  ...
  function mint(address to, uint256 value) external onlyVm returns (bool) {
    ...
    bool success;
    (success, ) = TRANSFER.call.value(0).gas(tx.gasprice)(abi.encode(address(0), to, value));
    require(success, "CELO transfer failed");
  ...
  function _transfer(address to, uint256 value) internal returns (bool) {
    ...
    bool success;
    (success, ) = TRANSFER.call.value(0).gas(tx.gasprice)(abi.encode(msg.sender, to, value));
    require(success, "CELO transfer failed");
