...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    uint256[] public _currentValidators;
    uint256[] public _pendingValidators;
    uint256[] public _previousValidators;
    struct ValidatorsList {
        bool forNewEpoch;
        uint256[] list;
    }
    ValidatorsList public _finalizeValidators;

    bool public _pendingValidatorsChanged;
    bool public _pendingValidatorsChangedForNewEpoch;
