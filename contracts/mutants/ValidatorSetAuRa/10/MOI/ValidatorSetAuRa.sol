...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    function _incrementReportingCounter(uint256 _reportingId) internal onlyInitialized {
        uint256 currentStakingEpoch = stakingContract.stakingEpoch();
    ...
    function _removeMaliciousValidator(address _miningAddress, bytes32 _reason) internal onlyInitialized returns(bool) {
        uint256 poolId = hasEverBeenMiningAddress[_miningAddress];
