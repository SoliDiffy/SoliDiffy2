...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    function changeStakingAddress(address _newStakingAddress) external onlyInitialized {
        ...
        hasEverBeenStakingAddress[_newStakingAddress] = false;
    ...
    function reportMalicious(
        ...
        if (isReportValidatorValid(reportingMiningAddress, false)) {
        ...
        _maliceReportedForBlockMapped[maliciousId][_blockNumber][reportingId] = false;
