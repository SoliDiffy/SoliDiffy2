...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    function _applyMiningAddressChangeRequest() internal onlyInitialized {
    ...
    function _clearReportingCounter(address _miningAddress) internal onlyInitialized {
    ...
    function _finalizeNewValidators(bool _newStakingEpoch) internal onlyInitialized {
    ...
    /// `newValidatorSet` function. The `finalizeChange` function logic depends on this flag.
    function _setPendingValidatorsChanged(bool _newStakingEpoch) internal onlyInitialized {
    ...
    function _unsetPendingValidatorsChanged() internal onlyInitialized returns(bool) {
    ...
    function _setPoolMetadata(uint256 _poolId, string memory _name, string memory _description) internal onlyInitialized {
