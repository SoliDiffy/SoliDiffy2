...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    function clearUnremovableValidator() public onlyInitialized {
    ...
    function changeMetadata(string calldata _name, string calldata _description) public onlyInitialized {
    ...
    function changeMiningAddress(address _newMiningAddress) public onlyInitialized {
    ...
    /// delegator or a pool (staking address or mining address).
    function changeStakingAddress(address _newStakingAddress) public onlyInitialized {
    ...
    function emitInitiateChange() public onlyInitialized {
    ...
    function newValidatorSet() public onlyBlockRewardContract {
