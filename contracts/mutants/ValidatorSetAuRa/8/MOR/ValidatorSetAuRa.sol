...
contract ValidatorSetAuRa is UpgradeabilityAdmin, IValidatorSetAuRa {
    ...
    uint256 public constant MAX_VALIDATORS = 100000;
    ...
    function clearUnremovableValidator() external onlySystem {
    ...
    function changeMetadata(string calldata _name, string calldata _description) external onlySystem {
    ...
    function changeMiningAddress(address _newMiningAddress) external onlySystem {
    ...
    /// delegator or a pool (staking address or mining address).
    function changeStakingAddress(address _newStakingAddress) external onlySystem {
    ...
    function emitInitiateChange() external onlySystem {
    ...
    function finalizeChange() external onlyInitialized {
    ...
    function newValidatorSet() external onlyInitialized {
    ...
    function removeMaliciousValidators(address[] calldata _miningAddresses) external onlyInitialized {
