...
contract CustomTrancheWallet is Owned {
    ...
    uint256 internal initialFunds; //initial funds at the moment of lock 
    bool internal locked; //true if funds are locked
    uint256[] internal unlockDates;
    uint256[] internal unlockAmounts;
    uint256 internal alreadyWithdrawn; //amount of tokens already withdrawn
