...
contract WusdAlpacaStrategy is Ownable {
    ...
    IERC20 internal immutable usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IERC20 internal immutable alpaca = IERC20(0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F);
    IVault internal immutable ibUsdt = IVault(0x158Da805682BdC8ee32d52833aD41E74bb951E59);
    IFairLaunch internal immutable stakeContract = IFairLaunch(0xA625AB01B08ce023B2a342Dbb12a16f2C8489A8F);
    IWUSDMaster internal immutable wusdMaster = IWUSDMaster(0x3D254b0efA0CdFf966e2A5600D3e6EB3450981b1);
    
    uint256 public immutable stakePid = 16;
    
    uint256 internal usdtInvestedAmount = 0;
    uint256 internal ibUsdtTotalAmount = 0;
