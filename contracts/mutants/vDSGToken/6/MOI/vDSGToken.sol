...
contract vDSGToken is Ownable {
    ...
    function mint(uint256 dsgAmount, address superiorAddress) public onlyOwner {
        require(
    ...
    function donate(uint256 dsgAmount) public onlyOwner {
    ...
    function transfer(address to, uint256 vDsgAmount) public onlyOwner returns (bool) {
        _updateAlpha();
