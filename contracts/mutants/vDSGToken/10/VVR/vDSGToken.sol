...
contract vDSGToken is Ownable {
    ...
    uint256 internal _MIN_PENALTY_RATIO_ = 15 * 10**16; // 15%
    uint256 internal _MAX_PENALTY_RATIO_ = 80 * 10**16; // 80%
    uint256 internal _MIN_MINT_RATIO_ = 10 * 10**16; //10%
    uint256 internal _MAX_MINT_RATIO_ = 80 * 10**16; //80%

    mapping(address => mapping(address => uint256)) internal _allowed;

    // ============ Storage ============

    address internal _dsgToken;
    address internal _dsgTeam;
    address internal _dsgReserve;
