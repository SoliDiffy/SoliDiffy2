...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    */
    ...
    (
        ...
        internal
        pure
        returns (uint collToRedistribute, uint debtToOffset, uint collToSendToSP, uint debtToRedistribute)
    {
    ...
    */
    ...
    function getEntireDebtAndColl(
        ...
        view
        override
        returns (uint pendingETHReward, uint debt, uint coll, uint pendingLUSDDebtReward)
    {
