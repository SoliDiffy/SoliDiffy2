...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    */
    ...
    enum Status { active, nonExistent, closed }
    ...
    */
        ...
        internal 
    {
        ...
        Troves[_borrower].status = Status.nonExistent;
    ...
    */
    function _removeTroveOwner(address _borrower, uint TroveOwnersArrayLength) internal {
        require(Troves[_borrower].status == Status.nonExistent, "TroveManager: Trove is still active");
