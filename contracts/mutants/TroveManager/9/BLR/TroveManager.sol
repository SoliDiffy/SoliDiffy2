    ...
    */
        ...
        returns(LiquidationTotals memory T)
    {
        ...
        while (L.i < _n) {
            ...
            else if (L.backToNormalMode == false && L.ICR < MCR) {
