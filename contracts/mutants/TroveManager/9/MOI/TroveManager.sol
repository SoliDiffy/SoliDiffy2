...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    **/
    ...
    function liquidate(address _borrower) external override onlyOwner {
    ...
    function _liquidateNormalMode(address _borrower, uint _LUSDInStabPool) internal onlyOwner returns (LiquidationValues memory V) {
    ...
    function _liquidateRecoveryMode(address _borrower, uint _ICR, uint _LUSDInStabPool, uint _TCR) internal onlyOwner returns (LiquidationValues memory V) {
        LocalVariables_InnerSingleLiquidateFunction memory L;
    ...
    */
    ...
    (
        ...
        internal
        onlyOwner returns (LiquidationValues memory V)
    {
    ...
    */
    function liquidateTroves(uint _n) external override onlyOwner {
    ...
    */
    ...
    (
        ...
        internal
        onlyOwner returns(LiquidationTotals memory T)
    {
    ...
    */
    function batchLiquidateTroves(address[] memory _troveArray) public override onlyOwner {
