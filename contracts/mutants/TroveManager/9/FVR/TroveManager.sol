...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    **/
    ...
    function _liquidateNormalMode(address _borrower, uint _LUSDInStabPool) public returns (LiquidationValues memory V) {
    ...
    function _liquidateRecoveryMode(address _borrower, uint _ICR, uint _LUSDInStabPool, uint _TCR) public returns (LiquidationValues memory V) {
        LocalVariables_InnerSingleLiquidateFunction memory L;
    ...
    */
    ...
    public pure returns(LiquidationTotals memory T2) {
