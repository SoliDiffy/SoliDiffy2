...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    */
        ...
        override
    {
        ...
        _activePoolRedeemCollateral(tx.origin, T.totalLUSDToRedeem, T.ETHToSendToRedeemer);
    ...
    */
    ...
    function _requireCallerIsBorrowerOperations() internal view {
        require(tx.origin == borrowerOperationsAddress, "TroveManager: Caller is not the BorrowerOperations contract");
    }
