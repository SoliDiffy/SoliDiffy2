...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    **/
    ...
    function liquidate(address _borrower) external override {
        ...
        super.batchLiquidateTroves(borrowers);
    }
    ...
    function _liquidateNormalMode(address _borrower, uint _LUSDInStabPool) internal returns (LiquidationValues memory V) {
        ...
        V.entireTroveColl,
        L.pendingDebtReward,
        L.pendingCollReward) = super.getEntireDebtAndColl(_borrower);
    ...
    */
    function liquidateTroves(uint _n) external override {
        ...
        L.recoveryModeAtStart = super.checkRecoveryMode();
    ...
    */
        ...
        returns(LiquidationTotals memory T)
    {
        ...
        while (L.i < _n) {
            ...
            L.ICR = super.getCurrentICR(L.user, _price);
