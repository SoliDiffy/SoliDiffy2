...
contract TroveManager is LiquityBase, Ownable, ITroveManager {
    ...
    **/
    ...
    function liquidate(address _borrower) external override {
        ...
        address[] storage borrowers = new address[](1);
    ...
    function _liquidateNormalMode(address _borrower, uint _LUSDInStabPool) internal returns (LiquidationValues storage V) {
        LocalVariables_InnerSingleLiquidateFunction storage L;
    ...
    function _liquidateRecoveryMode(address _borrower, uint _ICR, uint _LUSDInStabPool, uint _TCR) internal returns (LiquidationValues storage V) {
        LocalVariables_InnerSingleLiquidateFunction storage L;
        ...
        */
            ...
            LiquidationValues storage zeroVals;
            return zeroVals;
        }
    ...
    */
    ...
    (
        ...
        internal
        returns (LiquidationValues storage V)
    {
    ...
    */
    function liquidateTroves(uint _n) external override {
        LocalVariables_OuterLiquidationFunction storage L;

        LiquidationTotals storage T;
    ...
    */
    ...
    (
        ...
        internal
        returns(LiquidationTotals storage T)
    {
