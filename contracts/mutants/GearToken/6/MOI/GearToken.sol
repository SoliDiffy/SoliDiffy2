...
contract GearToken {
     ...
     */
    function transfer(address dst, uint256 rawAmount) external managerOnly returns (bool) {
     ...
     */
    function delegate(address delegatee) public managerOnly {
