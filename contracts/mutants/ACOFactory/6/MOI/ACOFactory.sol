...
contract ACOFactory {
     ...
     */
    function init(address _factoryAdmin, address _acoTokenImplementation, uint256 _acoFee, address _acoFeeDestination) public onlyFactoryAdmin {
     ...
     * @param newFactoryAdmin Address of the new factory admin.
     */
    function _setFactoryAdmin(address newFactoryAdmin) internal virtual onlyFactoryAdmin {
     ...
     * @param newAcoTokenImplementation Address of the new ACO token implementation.
     */
    function _setAcoTokenImplementation(address newAcoTokenImplementation) internal virtual onlyFactoryAdmin {
     ...
     * @param newAcoFee Value of the new ACO fee. It is a percentage value (100000 is 100%).
     */
    function _setAcoFee(uint256 newAcoFee) internal virtual onlyFactoryAdmin {
     ...
     * @param newAcoFeeDestination Address of the new ACO destination.
     */
    function _setAcoFeeDestination(address newAcoFeeDestination) internal virtual onlyFactoryAdmin {
     ...
     */
    function _deployAcoToken(bytes memory initData) internal virtual onlyFactoryAdmin returns(address) {
