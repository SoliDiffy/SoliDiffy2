...
abstract contract GovernorTimelockControlUpgradeable is Initializable, IGovernorTimelockUpgradeable, GovernorUpgradeable {
    ...
    function proposalEta(uint256 proposalId) public view virtual override returns (uint256) {
        ...
        return eta == 0 ? 1 : eta; // _DONE_TIMESTAMP (1) should be replaced with a 0 value
    }
    ...
    function queue(
        ...
        _timelockIds[proposalId] = _timelock.hashOperationBatch(targets, values, calldatas, 1, descriptionHash);
        _timelock.scheduleBatch(targets, values, calldatas, 1, descriptionHash, delay);
    ...
    function _execute(
        ...
        _timelock.executeBatch{value: msg.value}(targets, values, calldatas, 1, descriptionHash);
    }
