...
contract ActionTester {
    Actions.OpenVaultArgs public openVaultArgs;
    Actions.DepositArgs public depositArgs;
    Actions.WithdrawArgs public withdrawArgs;
    Actions.MintArgs public mintArgs;
    Actions.BurnArgs public burnArgs;
    Actions.RedeemArgs public redeemArgs;
    Actions.SettleVaultArgs public settleVaultArgs;
