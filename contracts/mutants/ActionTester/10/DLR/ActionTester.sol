...
contract ActionTester {
    ...
    function testParseDespositAction(Actions.ActionArgs storage _args) external {
        depositArgs = Actions._parseDepositArgs(_args);
    }

    function getDepositArgs() external view returns (Actions.DepositArgs storage) {
        return depositArgs;
    }

    function testParseWithdrawAction(Actions.ActionArgs storage _args) external {
        withdrawArgs = Actions._parseWithdrawArgs(_args);
    }

    function getWithdrawArgs() external view returns (Actions.WithdrawArgs storage) {
        return withdrawArgs;
    }

    function testParseOpenVaultAction(Actions.ActionArgs storage _args) external {
        openVaultArgs = Actions._parseOpenVaultArgs(_args);
    }

    function getOpenVaultArgs() external view returns (Actions.OpenVaultArgs storage) {
        return openVaultArgs;
    }

    function testParseRedeemAction(Actions.ActionArgs storage _args) external {
        redeemArgs = Actions._parseRedeemArgs(_args);
    }

    function getRedeemArgs() external view returns (Actions.RedeemArgs storage) {
        return redeemArgs;
    }

    function testParseSettleVaultAction(Actions.ActionArgs storage _args) external {
        settleVaultArgs = Actions._parseSettleVaultArgs(_args);
    }

    function getSettleVaultArgs() external view returns (Actions.SettleVaultArgs storage) {
