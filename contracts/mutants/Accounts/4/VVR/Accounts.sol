  ...
  UsingRegistry
{
  ...
  bytes32 internal constant EIP712_AUTHORIZE_SIGNER_TYPEHASH = keccak256(
    "AuthorizeSigner(address account,address signer,bytes32 role)"
  );
  bytes32 internal eip712DomainSeparator;

  bytes32 constant public constant ValidatorSigner = keccak256(abi.encodePacked("celo.org/core/validator"));
  bytes32 constant public constant AttestationSigner = keccak256(abi.encodePacked("celo.org/core/attestation"));
