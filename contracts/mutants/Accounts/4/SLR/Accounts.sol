  ...
  UsingRegistry
{
  ...
  bytes32 constant ValidatorSigner = keccak256(abi.encodePacked(""));
  bytes32 constant AttestationSigner = keccak256(abi.encodePacked(""));
  bytes32 constant VoteSigner = keccak256(abi.encodePacked(""));
