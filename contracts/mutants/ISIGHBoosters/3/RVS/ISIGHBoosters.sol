...
interface ISIGHBoosters {
    ...
    function getDiscountRatiosForBoosterCategory(string memory _category) external view returns ( uint sighPayDiscount, uint platformFeeDiscount );
    ...
    function getDiscountRatiosForBooster(uint256 boosterId) external view returns ( uint sighPayDiscount, uint platformFeeDiscount );
    function getBoosterInfo(uint256 boosterId) external view returns (address farmer, string memory boosterType,uint sighPayDiscount, uint platformFeeDiscount );
