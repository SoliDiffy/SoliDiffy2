...
contract ShibaBonusAggregator is Ownable, IBonusAggregator{
    ...
    function addUserBonusOnFarm(address _user, uint256 _percent, uint256 _pid) external onlyOwner{
    ...
    function removeUserBonusOnFarm(address _user, uint256 _percent, uint256 _pid) external onlyOwner{
