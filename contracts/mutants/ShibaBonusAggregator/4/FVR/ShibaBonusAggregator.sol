...
contract ShibaBonusAggregator is Ownable, IBonusAggregator{
    ...
    function setupMaster(IMasterBonus _master) public onlyOwner{
        master = _master;
    }

    function addOrRemoveContractBonusSource(address _contract, bool _add) public onlyOwner{
        contractBonusSource[_contract] = _add;
    }

    function addUserBonusOnFarm(address _user, uint256 _percent, uint256 _pid) public onlyVerifiedContract{
    ...
    function removeUserBonusOnFarm(address _user, uint256 _percent, uint256 _pid) public onlyVerifiedContract{
