...
contract ShibaBonusAggregator is Ownable, IBonusAggregator{
    ...
    function setupMaster(IMasterBonus _master) external onlyVerifiedContract{
        master = _master;
    }

    function addOrRemoveContractBonusSource(address _contract, bool _add) external onlyVerifiedContract{
