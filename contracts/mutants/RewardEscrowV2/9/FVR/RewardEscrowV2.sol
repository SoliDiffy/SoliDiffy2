...
contract RewardEscrowV2 is BaseRewardEscrowV2 {
    ...
    function oldRewardEscrow() public view returns (IRewardEscrow) {
    ...
    function setMigrateEntriesThresholdAmount(uint amount) public onlyOwner {
    ...
    function migrateVestingSchedule(address addressToMigrate) public systemActive {
    ...
    ) public onlyDuringSetup onlyOwner {
