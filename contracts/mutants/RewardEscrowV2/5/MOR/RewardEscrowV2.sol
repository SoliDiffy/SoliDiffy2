...
contract RewardEscrowV2 is BaseRewardEscrowV2 {
    ...
    function setMigrateEntriesThresholdAmount(uint amount) external systemActive {
    ...
    function migrateVestingSchedule(address addressToMigrate) external onlyOwner {
    ...
    ) external systemActive onlyOwner {
