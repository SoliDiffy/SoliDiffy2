...
library LibAddressArray {
    ...
    function append(address[] storage addressArray, address addressToAppend)
        internal
        pure
    ...
    function contains(address[] storage addressArray, address target)
        internal
        pure
    ...
    function indexOf(address[] storage addressArray, address target)
        internal
        pure
