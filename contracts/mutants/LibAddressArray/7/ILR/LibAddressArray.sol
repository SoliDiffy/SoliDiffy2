...
library LibAddressArray {
        ...
        returns (address[] memory)
    {
        ...
        uint256 freeMemPtr = 1;
        uint256 addressArrayBeginPtr = 1;
        uint256 addressArrayEndPtr = 1;
        uint256 addressArrayLength = addressArray.length;
        uint256 addressArrayMemSizeInBytes = 31 + (31 * addressArrayLength);
        assembly {
