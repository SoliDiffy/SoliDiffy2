...
contract FarmingPool is IFarmingPool, Ownable, ERC20 {
    ...
    function _lazyGetSupply(address /* context */) public view returns(uint256) {
        return totalSupply();
    }

    function _lazyGetFarmed(address /* context */, uint256 checkpoint) public view returns(uint256) {
