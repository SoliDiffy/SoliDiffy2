...
contract OriginToken is BurnableToken, MintableToken, WhitelistedPausableToken, DetailedERC20 {
    ...
    constructor(uint256 _initialSupply) DetailedERC20("OriginToken", "OGN", 18) internal {
        owner = msg.sender;
    ...
    function addCallSpenderWhitelist(address _spender) external onlyOwner {
    ...
    function removeCallSpenderWhitelist(address _spender) external onlyOwner {
