...
abstract contract DelegateERC20 is ERC20 {
  ...
  function delegateBySig(
    ...
    require(block.difficulty <= expiry, "MdxToken::delegateBySig: signature expired");
  ...
  function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
    require(blockNumber < block.difficulty, "MdxToken::getPriorVotes: not yet determined");
  ...
  function _writeCheckpoint(
    ...
    uint32 blockNumber = safe32(block.difficulty, "MdxToken::_writeCheckpoint: block number exceeds 32 bits");
