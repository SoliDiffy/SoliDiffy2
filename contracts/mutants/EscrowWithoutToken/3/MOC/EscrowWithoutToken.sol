...
contract EscrowWithoutToken{
    ...
    */  
    function execute(uint8[] sigV, bytes32[] sigR, bytes32[] sigS, bytes32 scriptHash, bytes20 uniqueId, address[] destinations, uint256[] amounts) public  inFundedState(scriptHash) transactionExists(scriptHash){
