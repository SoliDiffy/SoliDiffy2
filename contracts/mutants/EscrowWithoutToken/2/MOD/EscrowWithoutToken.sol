...
contract EscrowWithoutToken{
    ...
    */
    ...
    public payable transactionDoesNotExists(scriptHash) nonZeroAddress(_seller) nonZeroAddress(_buyer){
    ...
    */
    function addFundsToTransaction(bytes32 scriptHash)public inFundedState(scriptHash) transactionExists(scriptHash) payable{
