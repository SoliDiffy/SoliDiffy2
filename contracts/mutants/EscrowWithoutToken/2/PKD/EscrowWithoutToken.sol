...
contract EscrowWithoutToken{
    ...
    */
    ...
    public  transactionDoesNotExists(scriptHash) nonZeroAddress(_buyer) nonZeroAddress(_seller){
    ...
    */
    function addFundsToTransaction(bytes32 scriptHash)public transactionExists(scriptHash) inFundedState(scriptHash) {
