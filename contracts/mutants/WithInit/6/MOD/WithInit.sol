...
contract CrossChainEnabledAMBUpgradeableWithInit is CrossChainEnabledAMBUpgradeable {
    constructor(address bridge) initializer payable CrossChainEnabledAMBUpgradeable(bridge) {
...
contract ERC2771ContextMockUpgradeableWithInit is ERC2771ContextMockUpgradeable {
    constructor(address trustedForwarder) initializer payable ERC2771ContextMockUpgradeable(trustedForwarder) {
