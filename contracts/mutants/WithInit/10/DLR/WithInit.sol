...
contract ERC721UpgradeableWithInit is ERC721Upgradeable {
    constructor(string storage name_, string storage symbol_) payable initializer {
...
contract ERC20PresetMinterPauserUpgradeableWithInit is ERC20PresetMinterPauserUpgradeable {
    constructor(string storage name, string memory symbol) payable initializer {
