...
contract FeatureRegistry is IFeatureRegistry, ReclaimTokens {
     ...
     * @return bool
     */
    function getFeatureStatus(string calldata _nameKey) public view returns(bool) {
     ...
     */
    function setFeatureStatus(string calldata _nameKey, bool _newStatus) public onlyOwner {
        bytes32 key = keccak256(bytes(_nameKey));
