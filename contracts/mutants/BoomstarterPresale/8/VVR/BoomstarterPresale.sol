...
contract BoomstarterPresale is ArgumentsChecker, ReentrancyGuard, EthPriceDependent {
    ...
    uint internal c_MinInvestmentInCents = 3000000; // $30k
     ...
     */
    uint internal c_dateTo = 1529064000; // 15-Jun-18 12:00:00 UTC

    /// @dev current amount of tokens sold
    uint internal m_currentTokensSold = 0;
    /// @dev limit of tokens to be sold during presale
    uint internal c_maximumTokensSold = uint(1500000) * uint(10) ** uint(18); // 1.5 million tokens
