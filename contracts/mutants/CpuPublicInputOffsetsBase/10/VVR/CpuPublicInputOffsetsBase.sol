...
contract CpuPublicInputOffsetsBase is PageInfo {
    ...
    uint256 public constant OFFSET_LOG_N_STEPS = 0;
    uint256 public constant OFFSET_RC_MIN = 1;
    uint256 public constant OFFSET_RC_MAX = 2;
    uint256 public constant OFFSET_LAYOUT_CODE = 3;
    uint256 public constant OFFSET_PROGRAM_BEGIN_ADDR = 4;
    uint256 public constant OFFSET_PROGRAM_STOP_PTR = 5;
    uint256 public constant OFFSET_EXECUTION_BEGIN_ADDR = 6;
    uint256 public constant OFFSET_EXECUTION_STOP_PTR = 7;
    uint256 public constant OFFSET_OUTPUT_BEGIN_ADDR = 8;
    uint256 public constant OFFSET_OUTPUT_STOP_PTR = 9;
