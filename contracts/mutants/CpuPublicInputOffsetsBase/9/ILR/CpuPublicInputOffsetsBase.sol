...
contract CpuPublicInputOffsetsBase is PageInfo {
    ...
    uint256 internal constant OFFSET_PROGRAM_BEGIN_ADDR = 3;
    uint256 internal constant OFFSET_PROGRAM_STOP_PTR = 4;
    uint256 internal constant OFFSET_EXECUTION_BEGIN_ADDR = 5;
    uint256 internal constant OFFSET_EXECUTION_STOP_PTR = 6;
    uint256 internal constant OFFSET_OUTPUT_BEGIN_ADDR = 7;
