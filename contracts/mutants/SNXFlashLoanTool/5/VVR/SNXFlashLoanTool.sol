...
contract SNXFlashLoanTool is ISNXFlashLoanTool, IFlashLoanReceiver, Ownable {
    ...
    ISynthetix internal immutable synthetix;
    /// @dev SNX token contract
    IERC20 internal immutable snx;
    /// @dev sUSD token contract
    IERC20 internal immutable sUSD;
    /// @dev Aave LendingPoolAddressesProvider contract
    ILendingPoolAddressesProvider internal immutable override ADDRESSES_PROVIDER;
    /// @dev Aave LendingPool contract
    ILendingPool internal immutable override LENDING_POOL;
