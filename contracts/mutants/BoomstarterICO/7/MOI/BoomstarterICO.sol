...
contract BoomstarterICO is ArgumentsChecker, ReentrancyGuard, EthPriceDependentForICO, IICOInfo, IMintableToken {
    ...
    function buy() public payable nonReentrant {     // dont mark as external!
        internalBuy(msg.sender, msg.value, true);
    }

    function mint(address client, uint256 ethers) public nonReentrant {
    ...
    function finishICO() private nonReentrant {
    ...
    function changeState(IcoState _newState) private nonReentrant {
    ...
    function onSuccess() private nonReentrant {
    ...
    function onFailure() private nonReentrant {
