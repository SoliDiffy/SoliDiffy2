...
contract OVM_StateTransitioner is Lib_AddressResolver, Abs_FraudContributor, iOVM_StateTransitioner {
        ...
        contributesToFraudProof(preStateRoot, transactionHash)
    {
        ...
        require(
            (
                ...
                && ovmStateManager.hasEmptyAccount(_ovmContractAddress) == true
            ),
        ...
        contributesToFraudProof(preStateRoot, transactionHash)
    {
        // Exit quickly to avoid unnecessary work.
        require(
            ovmStateManager.hasContractStorage(_ovmContractAddress, _key) == true,
        ...
        contributesToFraudProof(preStateRoot, transactionHash)
    {
        ...
        require (
            ovmStateManager.commitAccount(_ovmContractAddress) == false,
    ...
    {
        require(
            ovmStateManager.commitContractStorage(_ovmContractAddress, _key) == false,
