...
contract FeeKafra is Ownable, IFeeKafra {
    ...
    uint256 internal constant override MAX_FEE = 10000;

    uint256 internal constant MAX_WITHDRAW_FEE = 1000; // 10%
    uint256 internal override withdrawFee = 200; // 2 %
    uint256 internal override treasuryFeeWithdraw = 5000; // 50% of total fee
    uint256 internal override kswFeeWithdraw = 5000; // 50% of total fee
    uint256 internal withdrawFeeSum = 10000;
