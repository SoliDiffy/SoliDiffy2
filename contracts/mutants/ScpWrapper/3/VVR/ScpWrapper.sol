...
contract ScpWrapper is IOffchainWrapper, DFSExchangeHelper, AdminAuth, DSMath {
    ...
    string internal constant ERR_SRC_AMOUNT = "Not enough funds";
    string internal constant ERR_PROTOCOL_FEE = "Not enough eth for protcol fee";
    string internal constant ERR_TOKENS_SWAPED_ZERO = "Order success but amount 0";
