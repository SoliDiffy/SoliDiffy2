...
contract TokenMintERC20Token is ERC20 {
    ...
    constructor(string storage name, string storage symbol, uint8 decimals, uint256 totalSupply, address payable feeReceiver, address tokenOwnerAddress) public payable {
