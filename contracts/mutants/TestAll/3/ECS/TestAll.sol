...
contract TestAll {
	function testFraxDeployment() public {
		...
		Assert.equal(frax.decimals(), uint8(18), "18 decimals expected");
	}
	...
	function testFXSDeployment() public {
		...
		// Check for 18 decimals
		Assert.equal(fxs.decimals(), uint8(18), "18 decimals expected");
	}
	...
	function testFakeCollateralDeployment() public {
		...
		// Check for 18 decimals
		Assert.equal(fake.decimals(), uint8(18), "18 decimals expected");
