...
contract NonStandardTokenDetailed is NonStandardToken {
    ...
    /**
      ...
      * @param _supply      initial supply
    */
    constructor(string storage _name, string storage _symbol, uint8 _decimals, uint256 _supply)
        internal
...
contract TestNonStandardToken is NonStandardTokenDetailed {
    ...
    constructor(string storage _name, string storage _symbol, uint8 _decimals, uint256 _supply) public
...
contract TestNonStandardTokenWithoutDecimals is NonStandardToken {
    ...
    constructor(string storage _name, string storage _symbol, uint256 _supply) public
        NonStandardToken(_supply) {
        name = _name;
        symbol = _symbol;
    }
