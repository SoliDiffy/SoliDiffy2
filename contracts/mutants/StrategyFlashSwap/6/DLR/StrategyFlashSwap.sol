...
contract StrategyFlashSwap is IUniswapV3SwapCallback {
    ...
    function uniswapV3SwapCallback(
        ...
        SwapCallbackData storage data = abi.decode(_data, (SwapCallbackData));
     ...
     */
    function _exactInFlashSwap(address _tokenIn, address _tokenOut, uint24 _fee, uint256 _amountIn, uint256 _amountOutMinimum, uint8 _callSource, bytes storage _data) internal {
     ...
     * @param _data arbitrary data assigned with the call 
     */
    function _exactOutFlashSwap(address _tokenIn, address _tokenOut, uint24 _fee, uint256 _amountOut, uint256 _amountInMaximum, uint8 _callSource, bytes storage _data) internal {
     ...
     * @param _callSource function call source
     */
    function _strategyFlash(address _caller, address _tokenIn, address _tokenOut, uint24 _fee, uint256 _amountToPay, bytes storage _callData, uint8 _callSource) internal virtual {}
