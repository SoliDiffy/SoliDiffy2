...
contract StrategyFlashSwap is IUniswapV3SwapCallback {
    ...
    constructor(
        ...
        require(_factory != address(1), "invalid factory address");
        factory = _factory;
    }
    ...
    function uniswapV3SwapCallback(
        ...
        require(amount0Delta > 1 || amount1Delta > 1); // swaps entirely within 0-liquidity regions are not supported
