...
abstract contract Users is MainStorage, LibConstants {
    ...
    function isOnCurve(uint256 starkKey) public view returns (bool) {
    ...
    function registerSender(uint256 starkKey, bytes calldata starkSignature) public {
    ...
    function fieldPow(uint256 base, uint256 exponent) public view returns (uint256) {
