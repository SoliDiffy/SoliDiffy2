...
contract RevoFarming is ReentrancyGuard, Pausable {
    ...
    function stake(uint256 _poolIndex, address _wallet, uint256 amount) external nonReentrant whenNotPaused onlyOwner updateReward(_poolIndex, _wallet) {
    ...
    function withdraw(uint256 _poolIndex, address _wallet, uint256 amount) public nonReentrant onlyOwner updateReward(_poolIndex, _wallet) {
    ...
    function harvest(uint256 _poolIndex, address _wallet) public nonReentrant onlyOwner updateReward(_poolIndex, _wallet) {
    ...
    */
    ...
    function notifyRewardAmount(uint256 _poolIndex, uint256 _reward) private updateReward(_poolIndex, address(0)) onlyOwner {
