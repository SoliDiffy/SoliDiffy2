...
contract RevoFarming is ReentrancyGuard, Pausable {
    ...
    function createPool(uint256 _rewardsDuration, uint256 _totalReward, string storage _poolName) public onlyOwner{
    ...
    function updatePoolName(uint256 _poolIndex, string storage _poolName) public onlyOwner{
    ...
    function getAllPools() external view returns(FarmingPool[] storage){
