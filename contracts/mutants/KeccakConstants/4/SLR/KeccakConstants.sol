...
contract KeccakConstants is APMNamehash {
    ...
    // Kernel
    bytes32 public constant CORE_NAMESPACE = keccak256(abi.encodePacked(""));
    bytes32 public constant APP_BASES_NAMESPACE = keccak256(abi.encodePacked(""));
    bytes32 public constant APP_ADDR_NAMESPACE = keccak256(abi.encodePacked(""));

    bytes32 public constant KERNEL_APP_ID = keccak256(abi.encodePacked(APM_NODE, keccak256("")));
