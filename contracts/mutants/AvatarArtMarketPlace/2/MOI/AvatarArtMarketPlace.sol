...
contract AvatarArtMarketplace is AvatarArtBase, IAvatarArtMarketplace{
     ...
     */ 
    function cancelSellOrder(uint256 tokenId) external override onlyOwner returns(bool){
     ...
     */ 
    function purchase(uint tokenId) external override onlyOwner returns(uint){
