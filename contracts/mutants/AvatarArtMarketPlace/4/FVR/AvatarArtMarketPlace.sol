...
contract AvatarArtMarketplace is AvatarArtBase, IAvatarArtMarketplace{
     ...
     */ 
    function getTokenInfo(uint tokenId) public view returns(address, uint){
        return (_tokenOwners[tokenId], _tokenPrices[tokenId]);
    }
    
    
    function getMarketHistories(uint256 tokenId) public view returns(MarketHistory[] memory){
