...
contract AvatarArtMarketplace is AvatarArtBase, IAvatarArtMarketplace{
     ...
     */ 
    function getTokens() external view returns(uint256[] storage){
        return _tokens;
    }
    ...
    function getMarketHistories(uint256 tokenId) external view returns(MarketHistory[] storage){
    ...
    */ 
    function _removeFromTokens(uint tokenId) internal view returns(uint256[] storage){
