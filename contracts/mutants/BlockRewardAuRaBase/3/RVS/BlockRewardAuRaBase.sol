...
contract BlockRewardAuRaBase is UpgradeableOwned, IBlockRewardAuRa {
    ...
    function _currentRewardToDistribute(
        ...
        return (_totalReward, rewardToDistribute);
    }
    ...
    function _rewardShareNumDenom(
        ...
        return (totalRewardShareDenom, totalRewardShareNum);
    }
    ...
    function _dequeueExtraReceiver() internal returns(uint256 amount, address bridge, address receiver) {
