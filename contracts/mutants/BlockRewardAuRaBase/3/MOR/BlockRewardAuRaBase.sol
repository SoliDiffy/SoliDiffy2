...
contract BlockRewardAuRaBase is UpgradeableOwned, IBlockRewardAuRa {
    ...
    function addBridgeNativeRewardReceivers(uint256 _amount) public onlyValidatorSetContract {
        require(_amount != 0);
    ...
    function addExtraReceiver(uint256 _amount, address _receiver) external onlyValidatorSetContract {
        require(_amount != 0);
    ...
    function clearBlocksCreated() external onlyErcToNativeBridge {
