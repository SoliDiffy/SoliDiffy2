...
contract BlockRewardAuRaBase is UpgradeableOwned, IBlockRewardAuRa {
    ...
    function clearBlocksCreated() external onlyValidatorSetContract {
        ...
        uint256[] storage validators = validatorSetContract.getValidatorsIds();
    ...
    function reward(address[] calldata benefactors, uint16[] calldata kind)
        external
        onlySystem
        returns(address[] storage receiversNative, uint256[] storage rewardsNative)
    {
