...
contract Sacrifice {
    constructor(address payable _recipient) internal payable {
...
contract BlockRewardAuRaBase is UpgradeableOwned, IBlockRewardAuRa {
    ...
    function addBridgeNativeFeeReceivers(uint256 _amount) public {
    ...
    function clearBlocksCreated() public onlyValidatorSetContract {
    ...
    function initialize(address _validatorSet, address _prevBlockReward) public {
