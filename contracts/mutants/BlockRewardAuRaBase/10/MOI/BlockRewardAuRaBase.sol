...
contract BlockRewardAuRaBase is UpgradeableOwned, IBlockRewardAuRa {
    ...
    function initialize(address _validatorSet, address _prevBlockReward) external onlyErcToNativeBridge {
    ...
    function _distributeNativeRewards(
        ...
        uint256[] memory _blocksCreatedShareNum,
        uint256 _blocksCreatedShareDenom
    ) internal onlyErcToNativeBridge returns(uint256) {
    ...
    function _distributeRewards(
        ...
        uint256 _stakingEpoch,
        uint256 _stakingEpochEndBlock
    ) internal onlyErcToNativeBridge returns(uint256 nativeTotalRewardAmount) {
        uint256[] memory validators = validatorSetContract.getValidatorsIds();
    ...
    function _migrateMintingStatistics() internal onlyErcToNativeBridge {
    ...
    function _mintNativeCoins(
        ...
        internal
        onlyErcToNativeBridge returns(address[] memory receivers, uint256[] memory rewards)
    {
    ...
    function _dequeueExtraReceiver() internal onlyErcToNativeBridge returns(uint256 amount, address receiver, address bridge) {
    ...
    function _enqueueExtraReceiver(uint256 _amount, address _receiver, address _bridge) internal onlyErcToNativeBridge {
    ...
    function _setMinted(uint256 _amount, address _account, address _bridge) internal onlyErcToNativeBridge {
    ...
    function _snapshotPoolStakeAmounts(
        ...
        uint256 _stakingEpoch,
        uint256 _poolId
    ) internal onlyErcToNativeBridge {
