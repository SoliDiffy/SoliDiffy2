...
contract AkropolisTimeLock is TokenTimelock, BeneficiaryOperations {
        ...
        */
        ...
        constructor (IERC20 _token, address _beneficiary, uint256 _releaseTime) internal
        ...
        */
        function changeBeneficiary(address _newBeneficiary) external onlyManyBeneficiaries {
