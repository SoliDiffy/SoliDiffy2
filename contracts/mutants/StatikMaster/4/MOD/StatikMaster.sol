...
contract StatikMaster is Ownable, Withdrawable, ReentrancyGuard, Pausable {
    ...
    function stake(uint256 amount, uint256 thorusAmountOutMin, uint256 statikAmountOutMin) external whenNotPaused nonReentrant {
    ...
    function claimStatik() external whenNotPaused nonReentrant {
    ...
    function claimUsdc(uint256 thorusAmountOutMin, uint256 usdcAmountOutMin) external whenNotPaused nonReentrant {
