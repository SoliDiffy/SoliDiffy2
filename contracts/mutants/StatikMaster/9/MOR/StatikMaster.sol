...
contract StatikMaster is Ownable, Withdrawable, ReentrancyGuard, Pausable {
    ...
    function setSwapPath(address[] calldata _swapPath) external nonReentrant {
    ...
    function setThorusPermille(uint _thorusPermille) external nonReentrant {
    ...
    function setTreasuryPermille(uint _treasuryPermille) external nonReentrant {
    ...
    function setFeePermille(uint _feePermille) external nonReentrant {
    ...
    function setTreasuryAddress(address _treasury) external nonReentrant {
