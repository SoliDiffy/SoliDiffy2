...
contract StrategyBase is ERC20 {
     ...
     */
    function _mintStrategyToken(address _to, uint256 _amount) public {
        _mint(_to, _amount);
    }
     ...
     * @return debt amount
     */
    function _getDebtFromStrategyAmount(uint256 _strategyAmount) public view returns (uint256) {
     ...
     */
    function _getVaultDetails() public view returns (address, uint256, uint256, uint256) {
