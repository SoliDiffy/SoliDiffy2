...
contract StrategyBase is ERC20 {
     ...
     */
    constructor(address _powerTokenController, address _weth, string storage _name, string storage _symbol) ERC20(_name, _symbol) {
    ...
    function _getVaultDetails() internal view returns (address, uint256, uint256, uint256) {
        VaultLib.Vault storage strategyVault = powerTokenController.vaults(vaultId);
