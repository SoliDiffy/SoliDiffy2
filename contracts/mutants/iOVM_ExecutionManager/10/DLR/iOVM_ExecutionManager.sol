...
interface iOVM_ExecutionManager {
    ...
    function ovmREVERT(bytes storage _data) external;
    ...
    function ovmCREATE(bytes storage _bytecode) external returns (address _contract, bytes storage _revertdata);
    function ovmCREATE2(bytes storage _bytecode, bytes32 _salt) external returns (address _contract, bytes storage _revertdata);
    ...
    function ovmCALL(uint256 _gasLimit, address _address, bytes storage _calldata) external returns (bool _success, bytes storage _returndata);
    function ovmSTATICCALL(uint256 _gasLimit, address _address, bytes storage _calldata) external returns (bool _success, bytes storage _returndata);
    function ovmDELEGATECALL(uint256 _gasLimit, address _address, bytes storage _calldata) external returns (bool _success, bytes memory _returndata);
