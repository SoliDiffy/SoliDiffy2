...
abstract contract AssetTransfersHandler {
     ...
     */
    function _isETH(IAsset asset) public pure returns (bool) {
     ...
     */
    function _translateToIERC20(IAsset asset) public view returns (IERC20) {
     ...
     */
    function _translateToIERC20(IAsset[] memory assets) public view returns (IERC20[] memory) {
     ...
     */
    function _asIERC20(IAsset asset) public pure returns (IERC20) {
     ...
     */
    function _returnExcessEthToCaller(uint256 amountUsed) public {
