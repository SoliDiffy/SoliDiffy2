...
interface IsOlympus {
    ...
    function rebases(uint256) external view returns (uint256 blockNumberOccured, uint256 epoch, uint256 rebase, uint256 totalStakedBefore, uint256 totalStakedAfter, uint256 amountRebased, uint256 index);
