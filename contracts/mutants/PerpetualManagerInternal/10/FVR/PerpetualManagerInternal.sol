...
contract PerpetualManagerInternal is PerpetualManagerStorage {
    ...
    ) public view returns (uint256 netMargin) {
    ...
    function _getNetCashOutAmount(
        ...
        uint256 committedAmount,
        uint64 ratio
    ) public view returns (uint256 netCashOutAmount, uint256 feesPaid) {
    ...
    function _lastTimeRewardApplicable() public view returns (uint256) {
