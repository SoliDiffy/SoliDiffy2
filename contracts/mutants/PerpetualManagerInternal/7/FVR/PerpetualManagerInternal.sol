...
contract PerpetualManagerInternal is PerpetualManagerStorage {
    ...
    function _closePerpetual(uint256 perpetualID, Perpetual memory perpetual) public {
    ...
    function _secureTransfer(address owner, uint256 amount) public {
    ...
    function _getOraclePrice() public view returns (uint256, uint256) {
    ...
    function _computeKeeperLiquidationFees(uint256 cashOutAmount) public view returns (uint256 keeperFees) {
    ...
    function _computeHedgeRatio(uint256 currentHedgeAmount) public view returns (uint64 ratio) {
