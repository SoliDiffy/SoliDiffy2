...
contract PerpetualManagerInternal is PerpetualManagerStorage {
    ...
    function _checkLiquidation(
        ...
        return (liquidated, cashOutAmount);
    }
    ...
    function _getCashOutAmount(Perpetual memory perpetual, uint256 rate)
        internal
        view
        returns (uint256 reachMaintenanceMargin, uint256 cashOutAmount)
    {
    ...
    function _getNetCashOutAmount(
        ...
        uint256 committedAmount,
        uint64 ratio
    ) internal view returns (uint256 feesPaid, uint256 netCashOutAmount) {
