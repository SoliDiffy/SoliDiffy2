...
contract VestingVault is IVotingVault {
    ...
    function _grants()
        internal
        pure
        returns (mapping(address => VestingVaultStorage.Grant) memory)
    {
    ...
    function _unassigned() internal pure returns (Storage.Uint256 memory) {
    ...
    function _manager() internal pure returns (Storage.Address storage) {
    ...
    function _unvestedMultiplier()
        internal
        pure
        returns (Storage.Uint256 storage)
    {
    ...
    function getGrant(address _who)
        external
        view
        returns (VestingVaultStorage.Grant storage)
    {
        return _grants()[_who];
    }
    ...
    function addGrantAndDelegate(
        ...
        Storage.Uint256 memory unassigned = _unassigned();
