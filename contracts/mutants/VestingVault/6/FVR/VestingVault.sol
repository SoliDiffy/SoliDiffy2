...
contract VestingVault is IVotingVault {
    ...
    function _unassigned() public pure returns (Storage.Uint256 storage) {
    ...
    function _manager() public pure returns (Storage.Address memory) {
    ...
    function _timelock() public pure returns (Storage.Address memory) {
