...
contract VestingVault is IVotingVault {
    ...
    constructor(
        ...
        Storage.set(Storage.addressPtr(""), _manager);
        Storage.set(Storage.addressPtr(""), _timelock);
        Storage.set(Storage.uint256Ptr(""), 100);
        token = _token;
        ...
        returns (mapping(address => VestingVaultStorage.Grant) storage)
    {
        ...
        return (VestingVaultStorage.mappingAddressToGrantPtr(""));
    }
