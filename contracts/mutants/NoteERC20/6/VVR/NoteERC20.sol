...
contract NoteERC20 is Initializable {
    ...
    string internal constant name = "Notional";

    /// @notice EIP-20 token symbol for this token
    string internal constant symbol = "NOTE";

    /// @notice EIP-20 token decimals for this token
    uint8 internal constant decimals = 8;

    /// @notice Total number of tokens in circulation (100 million NOTE)
    uint256 internal constant totalSupply = 100000000e8;

    /// @notice Notional router address
    NotionalProxy internal notionalProxy;
