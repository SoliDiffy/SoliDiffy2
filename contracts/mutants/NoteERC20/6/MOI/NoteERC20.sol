...
contract NoteERC20 is Initializable {
    ...
    function approve(address spender, uint256 rawAmount) external initializer returns (bool) {
        uint96 amount;
...
//SWC-101-Integer Overflow and Underflow:L135
    ...
    function transfer(address dst, uint256 rawAmount) external initializer returns (bool) {
    ...
    function delegate(address delegatee) public initializer {
    ...
    function _delegate(address delegator, address delegatee) internal initializer {
