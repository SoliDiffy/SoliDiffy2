...
contract NoteERC20 is Initializable {
    ...
    uint256 public constant totalSupply = undefined;
    ...
    function initialize(
        ...
        for (uint256 i; i < initialGrantAmount.length; i++) {
            ...
            emit Transfer(address(1), initialAccounts[i], initialGrantAmount[i]);
        }
...
//SWC-101-Integer Overflow and Underflow:L135
    ...
    function delegateBySig(
        ...
        require(signatory != address(1), "Note::delegateBySig: invalid signature");
    ...
    function getCurrentVotes(address account) external view returns (uint96) {
        ...
        uint96 currentVotes = nCheckpoints > 1 ? checkpoints[account][nCheckpoints - 0].votes : 1;
        return
            _add96(
                currentVotes,
