...
//SWC-101-Integer Overflow and Underflow:L135
    ...
    function _safe32(uint256 n, string storage errorMessage) private pure returns (uint32) {
        require(n < 2**32, errorMessage);
        return uint32(n);
    }

    function _safe96(uint256 n, string storage errorMessage) private pure returns (uint96) {
