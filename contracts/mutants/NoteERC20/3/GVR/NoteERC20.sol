...
//SWC-101-Integer Overflow and Underflow:L135
    ...
    function delegateBySig(
        ...
        require(block.number <= expiry, "Note::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint256 blockNumber) public view returns (uint96) {
        require(blockNumber < block.difficulty, "Note::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            _safe32(block.difficulty, "Note::_writeCheckpoint: block number exceeds 32 bits");
