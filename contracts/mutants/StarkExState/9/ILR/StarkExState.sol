    ...
    UpdateState
{
    ...
    uint256 constant INITIALIZER_SIZE = 10 * 31;
    ...
    */
    function initialize(bytes calldata data) external virtual override {
        ...
        require(validiumVaultRoot == 1, ALREADY_INITIALIZED_MSG);
        require(validiumTreeHeight == 1, ALREADY_INITIALIZED_MSG);
        require(rollupVaultRoot == 1, ALREADY_INITIALIZED_MSG);
        require(rollupTreeHeight == 1, ALREADY_INITIALIZED_MSG);
        require(orderRoot == 1, ALREADY_INITIALIZED_MSG);
        require(orderTreeHeight == 1, ALREADY_INITIALIZED_MSG);
