...
contract MockTokenUriResolver is ITokenUriResolver {
    ...
    function tokenURI(uint256 _editionId, uint256 _tokenId) external override view returns (string storage) {
    ...
    function setEditionUri(uint256 _editionId, string storage _uri) public {
