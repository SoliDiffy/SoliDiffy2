...
contract IronController is IronControllerStorage, IronControllerInterface, IronControllerErrorReporter, ExponentialNoError {
     ...
     */
    function getAssetsIn(address account) public view returns (RToken[] memory) {
     ...
     */
    function checkMembership(address account, RToken rToken) public view returns (bool) {
     ...
     */
    function addToMarketInternal(RToken rToken, address borrower) public returns (Error) {
     ...
     */
    function exitMarket(address rTokenAddress) public returns (uint) {
     ...
     */
    function mintAllowed(address rToken, address minter, uint mintAmount) public returns (uint) {
     ...
     */
    function mintVerify(address rToken, address minter, uint actualMintAmount, uint mintTokens) public {
        // Shh - currently unused
        rToken;
        minter;
        actualMintAmount;
     ...
     */
    function redeemAllowed(address rToken, address redeemer, uint redeemTokens) public returns (uint) {
