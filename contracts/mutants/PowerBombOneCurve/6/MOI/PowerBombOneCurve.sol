...
contract PowerBombOneCurve is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function swap2(address tokenIn, address tokenOut, uint amount) private initializer returns (uint) {
    ...
    function getPoolPendingReward(IERC20Upgradeable pendingRewardToken) external initializer returns (uint) {
