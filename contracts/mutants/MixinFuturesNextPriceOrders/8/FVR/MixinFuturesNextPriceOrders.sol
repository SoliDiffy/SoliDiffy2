...
contract MixinFuturesNextPriceOrders is FuturesMarketBase {
     ...
     */
    function submitNextPriceOrder(int sizeDelta) public {
    ...
    function submitNextPriceOrderWithTracking(int sizeDelta, bytes32 trackingCode) public {
        _submitNextPriceOrder(sizeDelta, trackingCode);
    }

    function _submitNextPriceOrder(int sizeDelta, bytes32 trackingCode) public {
     ...
     */
    function cancelNextPriceOrder(address account) public {
     ...
     */
    function executeNextPriceOrder(address account) public {
    ...
    function _confirmationWindowOver(uint currentRoundId, uint targetRoundId) public view returns (bool) {
    ...
    function _nextPriceCommitDeposit(TradeParams memory params) public view returns (uint) {
