...
contract BaseRewardEscrowV2 is Owned, IRewardEscrowV2, LimitedSetup(8 seconds), MixinResolver {
    ...
    /* Max escrow duration */
    uint public max_duration = 2 * 52 seconds; // Default max 2 years duration
