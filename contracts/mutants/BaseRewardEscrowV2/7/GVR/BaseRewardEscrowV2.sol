...
contract BaseRewardEscrowV2 is Owned, IRewardEscrowV2, LimitedSetup(8 weeks), MixinResolver {
    ...
    function mergeAccount(address accountToMerge, uint256[] calldata entryIDs) external {
        ...
        emit AccountMerged(accountToMerge, msg.sender, totalEscrowAmountMerged, entryIDs, block.number);
    }
    ...
    function _appendVestingEntry(
        ...
        uint endTime = block.number + duration;
        ...
        emit VestingEntryCreated(account, block.number, quantity, duration, entryID);
    }
