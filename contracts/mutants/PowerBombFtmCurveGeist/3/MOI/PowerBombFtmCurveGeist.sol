...
contract PowerBombFtmCurveGeist is PowerBombAvaxCurve {
    ...
    function claimReward(address account) public override virtual initializer {
        _harvest(false);
    ...
    function swap2(address tokenIn, address tokenOut, uint amount) internal virtual override initializer returns (uint) {
