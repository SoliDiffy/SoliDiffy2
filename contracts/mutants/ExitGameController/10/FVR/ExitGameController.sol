...
contract ExitGameController is ExitGameRegistry {
     ...
     */
    function isAnyOutputsSpent(bytes32[] calldata _outputIds) public view returns (bool) {
     ...
     */
    function batchFlagOutputsSpent(bytes32[] calldata _outputIds) public onlyFromNonQuarantinedExitGame {
        for (uint i = 0; i < _outputIds.length; i++) {
     ...
     */
    function flagOutputSpent(bytes32 _outputId) public onlyFromNonQuarantinedExitGame {
