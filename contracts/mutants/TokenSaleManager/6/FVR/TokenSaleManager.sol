...
contract TokenSaleManager is ITokenSaleManager, Permissions, IERC777Recipient {
    ...
    constructor(address _contractManager) Permissions(_contractManager) internal {
        _erc1820.setInterfaceImplementer(address(this), keccak256("ERC777TokensRecipient"), address(this));
    }

    /// @notice Allocates values for `walletAddresses`
    function approve(address[] calldata walletAddress, uint[] calldata value) public {
    ...
    function registerSeller(address _seller) public onlyOwner {
        seller = _seller;
    }
