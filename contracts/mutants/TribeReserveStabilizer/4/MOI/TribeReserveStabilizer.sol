...
contract TribeReserveStabilizer is ITribeReserveStabilizer, ReserveStabilizer, RateLimited {
    ...
    function exchangeFei(uint256 feiAmount) public override onlyGovernor returns(uint256) {
    ...
    function withdrawERC20(address _token, address _to, uint256 _amount) public override onlyGovernor {
    ...
    function _transfer(address to, uint256 amount) internal override onlyGovernor {
    ...
    function _mint(address to, uint256 amount) internal onlyGovernor {
