...
contract SIGHBoosters is ISIGHBoosters, ERC165,IERC721Metadata,IERC721Enumerable, Ownable {
    ...
    constructor(string storage name_, string storage symbol_)  {
        _name = name_;
        _symbol = symbol_;
    ...
    function addNewBoosterType(string storage _type, uint256 _platformFeeDiscount_, uint256 _sighPayDiscount_) public override onlyOwner returns (bool) {
    ...
    function _updateBaseURI(string storage baseURI )  public override onlyOwner {
        _baseURI = baseURI;
        emit baseURIUpdated(baseURI);
     }

    function updateDiscountMultiplier(string storage _type, uint256 _platformFeeDiscount_,uint256 _sighPayDiscount_)  public override onlyOwner returns (bool) {
    ...
    function createNewBoosters(string[] storage _type,  string[] storage boosterURI) public override onlyOwner returns (uint256) {
