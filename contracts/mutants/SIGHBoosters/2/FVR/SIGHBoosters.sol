...
//    }
     ...
     */
    function _safeMint(address to, uint256 boosterId, string memory _typeOfBoost, bytes memory _data) public {
     ...
     */
    function _mint(address to, uint256 boosterId, string memory _typeOfBoost) public  {
