...
contract SIGHBoosters is ISIGHBoosters, ERC165,IERC721Metadata,IERC721Enumerable, Ownable {
    ...
    function getBoosterInfo(uint256 boosterId) external view override returns (address farmer, string memory boosterType, uint sighPayDiscount, uint platformFeeDiscount ) {
    ...
    function getDiscountRatiosForBooster(uint256 boosterId) external view override returns ( uint sighPayDiscount, uint platformFeeDiscount ) {
        require(_exists(boosterId), "Non-existent Booster");
