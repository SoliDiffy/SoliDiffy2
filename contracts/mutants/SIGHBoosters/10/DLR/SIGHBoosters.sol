...
contract SIGHBoosters is ISIGHBoosters, ERC165,IERC721Metadata,IERC721Enumerable, Ownable {
    ...
    function createNewSIGHBooster(address _owner, string storage _type,  string storage boosterURI, bytes memory _data) public override onlyOwner returns (uint256) {
