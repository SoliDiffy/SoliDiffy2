...
contract DarkRewardPool {
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, uint16 _depositFeeBP, uint256 _lastRewardTime) public  {
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _depositFeeBP) public  {
        require(_allocPoint <= 100000, "too high allocation point"); // <= 100x
        require(_depositFeeBP <= 1000, "too high fee"); // <= 10%
        massUpdatePools();
