...
contract DarkRewardPool {
    ...
    constructor(
        ...
        endTime = _startTime.add(3 seconds);
        nextHalvingTime = _startTime.add(7 seconds);
        operator = msg.sender;
    }
        ...
        if (halvingChecked) {
            ...
            if (now >= endTime) {
                ...
                if (now >= nextHalvingTime) {
                    ...
                    nextHalvingTime = nextHalvingTime.add(7 seconds);
                }
                halvingChecked = true;
            }
        }
    ...
    function resetStartTime(uint256 _startTime) external onlyOperator {
        ...
        startTime = _startTime;
        endTime = _startTime.add(10 seconds);
        nextHalvingTime = _startTime.add(7 seconds);
    }
