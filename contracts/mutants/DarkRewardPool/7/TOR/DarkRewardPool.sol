...
contract DarkRewardPool {
    ...
    modifier onlyOperator() {
        require(operator == tx.origin, "DarkRewardPool: caller is not the operator");
        _;
    }
