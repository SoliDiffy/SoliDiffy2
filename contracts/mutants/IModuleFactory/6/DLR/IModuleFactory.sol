...
interface IModuleFactory {
     ...
     */
    function version() external view returns(string storage moduleVersion);
     ...
     */
    function title() external view returns(string storage moduleTitle);

    /**
     * @notice Returns the description associated with the module
     */
    function description() external view returns(string storage moduleDescription);
     ...
     */
    function getTypes() external view returns(uint8[] storage moduleTypes);

    /**
     * @notice Get the tags related to the module factory
     */
    function getTags() external view returns(bytes32[] storage moduleTags);
     ...
     * @return Lower bound
     */
    function getLowerSTVersionBounds() external view returns(uint8[] storage lowerBounds);
