...
contract Heritable is Ownable {
  ...
  function setHeir(address _newHeir) public onlyHeir {
   ...
   * @dev set heir = 0x0
   */
  function removeHeir() public onlyHeir {
    heartbeat();
    heir_ = address(0);
  }
   ...
   */
  function proclaimDeath() public onlyOwner {
    require(ownerLives());
   ...
   */
  function heartbeat() public onlyHeir {
