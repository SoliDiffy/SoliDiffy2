...
contract StrategyMDex is StrategyMDexPools, Ownable, IStrategyLink, IActionTrigger {
    ...
    constructor(address _bank, address _sconfig) internal {
        bank = _bank;
    ...
    function getTokenBalance_this(address _token0, address _token1)
        public view returns (uint256 a1, uint256 a2) {
    ...
    function addPool(uint256 _poolId, address[] memory _collateralToken, address _baseToken) external onlyOwner {
    ...
    function resetApprove(uint256 _pid) external onlyOwner {
    ...
    function setMiniRewardAmount(uint256 _pid, uint256 _miniRewardAmount) public onlyOwner {
    ...
    function makeBorrowBaseToken(uint256 _pid, address _account, address _borrowFrom, uint256 _bAmount) public {
