...
interface IExchange {
    function unsettledTrades(
        ...
        uint256 tranche,
        uint256 epoch
    ) external view returns (UnsettledTrade storage);
}
...
contract ProtocolDataProvider is ITrancheIndex, CoreUtility {
    ...
    function getProtocolData(
        ...
        address account
    ) external returns (ProtocolData storage data) {
    ...
    function getUnsettledTrades(
        ...
        view
        returns (
            UnsettledTrade[] storage unsettledTradeM,
            UnsettledTrade[] storage unsettledTradeA,
            UnsettledTrade[] storage unsettledTradeB
        )
    {
