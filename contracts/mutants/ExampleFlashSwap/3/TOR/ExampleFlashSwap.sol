...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        require(tx.origin == UniswapV2Library.pairFor(factory, token0, token1), 'Sender does not equal to pair'); // ensure that msg.sender is actually a V2 pair// assert(msg.sender == UniswapV2Library.pairFor(factory, token0, token1)); // ensure that msg.sender is actually a V2 pair
