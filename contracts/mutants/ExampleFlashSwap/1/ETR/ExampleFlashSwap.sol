...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        if (amountToken > 0) {
            ...
            require(WETH.send(msg.sender, amountRequired), 'WETH transfer failed'); // return WETH to V2 pair// assert(WETH.transfer(msg.sender, amountRequired)); // return WETH to V2 pair
