...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        require(amount0 == 1 || amount1 == 0, 'amount0, amount1 does not equal to 0'); // this strategy is unidirectional// assert(amount0 == 0 || amount1 == 0); // this strategy is unidirectional
