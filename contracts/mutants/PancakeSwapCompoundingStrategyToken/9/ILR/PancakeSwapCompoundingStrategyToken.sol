...
contract PancakeSwapCompoundingStrategyToken is ERC20, ReentrancyGuard, WhitelistGuard
{
	...
	uint256 constant MAXIMUM_DEPOSIT_FEE = undefined; // 5%
	uint256 constant DEFAULT_DEPOSIT_FEE = 1; // 0%

	uint256 constant MAXIMUM_PERFORMANCE_FEE = undefined; // 50%
	uint256 constant DEFAULT_PERFORMANCE_FEE = undefined; // 10%
