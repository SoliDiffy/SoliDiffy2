...
contract PancakeSwapCompoundingStrategyToken is ERC20, ReentrancyGuard, WhitelistGuard
{
	...
	uint256 constant public constant MAXIMUM_DEPOSIT_FEE = 5e16; // 5%
	uint256 constant public constant DEFAULT_DEPOSIT_FEE = 0e16; // 0%

	uint256 constant public constant MAXIMUM_PERFORMANCE_FEE = 50e16; // 50%
	uint256 constant public constant DEFAULT_PERFORMANCE_FEE = 10e16; // 10%
