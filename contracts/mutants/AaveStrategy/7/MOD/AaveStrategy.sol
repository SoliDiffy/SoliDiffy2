...
contract AaveStrategy is InitializableAbstractStrategy {
    ...
    ) external initializer onlyGovernor {
     ...
     */
    function depositAll() external override nonReentrant onlyVault {
     ...
     */
    function withdrawAll() external override nonReentrant onlyVaultOrGovernor {
        for (uint256 i = 0; i < assetsMapped.length; i++) {
