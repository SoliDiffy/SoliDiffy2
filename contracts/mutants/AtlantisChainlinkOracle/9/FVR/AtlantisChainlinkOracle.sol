...
contract AtlantisChainlinkOracle is PriceOracle {
    ...
    function getPrice(AToken aToken) public view returns (uint price) {
    ...
    function setUnderlyingPrice(AToken aToken, uint underlyingPriceMantissa) public onlyAdmin() {
