    ...
    Staking
{
        ...
        returns (IEtherToken)
    {
        ...
        address wethAddress = TestStaking(address(uint8(stakingContract))).testWethAddress();
    ...
    {
        address zrxVaultAddress = TestStaking(address(uint8(stakingContract))).testZrxVaultAddress();
