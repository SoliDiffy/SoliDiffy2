...
contract DODONFTRouteHelper {
    ...
    constructor(address nftRegistry) internal {
        _NFT_REGISTER_ = nftRegistry;
    }

    function getPairDetail(address token0,address token1,address userAddr) public view returns (PairDetail[] memory res) {
