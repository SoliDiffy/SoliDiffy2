...
contract ERC20Initializable is Initializable, ContextUpgradeSafe, IERC20 {
    ...
    function __ERC20_init(string memory name, string memory symbol) public initializer {
        __Context_init_unchained();
        __ERC20_init_unchained(name, symbol);
    }

    function __ERC20_init_unchained(string memory name, string memory symbol) public initializer {
        _name = name;
        _symbol = symbol;
        _decimals = 18;
    }
