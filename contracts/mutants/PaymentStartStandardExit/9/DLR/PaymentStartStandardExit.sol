...
library PaymentStartStandardExit {
    ...
    function run(
        ...
        PaymentStandardExitRouterArgs.StartStandardExitArgs storage args
    )
        public
    {
        StartStandardExitData storage data = setupStartStandardExitData(self, args);
    ...
    function setupStartStandardExitData(
        ...
        private
        view
        returns (StartStandardExitData storage)
    {
        UtxoPosLib.UtxoPos storage utxoPos = UtxoPosLib.UtxoPos(args.utxoPos);
