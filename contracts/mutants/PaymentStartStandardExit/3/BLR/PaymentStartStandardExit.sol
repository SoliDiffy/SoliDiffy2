...
library PaymentStartStandardExit {
        ...
        view
    {
        ...
        require(exitMap.exits[data.exitId].exitable == true, "Exit has already started");

        require(self.framework.isOutputSpent(data.outputId) == true, "Output is already spent");
    }
