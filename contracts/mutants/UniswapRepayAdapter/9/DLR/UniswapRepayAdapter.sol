...
contract UniswapRepayAdapter is BaseUniswapAdapter {
  ...
  function executeOperation(
    ...
    RepayParams storage decodedParams = _decodeParams(params);
  ...
  function swapAndRepay(
    ...
    DataTypes.ReserveData storage collateralReserveData = _getReserveData(collateralAsset);
    DataTypes.ReserveData storage debtReserveData = _getReserveData(debtAsset);
   ...
   */
  function _decodeParams(bytes storage params) internal pure returns (RepayParams storage) {
    (
      address collateralAsset,
      uint256 collateralAmount,
      uint256 rateMode,
