...
abstract contract MApprovalChain {
    ...
    */
    function addEntry(
        StarkExTypes.ApprovalChainData memory chain,
        address entry,
        uint256 maxLength,
    ...
    /*
      ...
      otherwise.
    */
    function findEntry(address[] memory list, address entry)
        internal
        view
        virtual
        returns (uint256);
    ...
    */
    function safeFindEntry(address[] memory list, address entry)
        internal
        view
        virtual
        returns (uint256 idx);
