...
contract TokenLaunchLocker is Permissions, ILocker {
     ...
     */
    function lock(address holder, uint amount) public allow("TokenLaunchManager") {
    ...
    function handleDelegationAdd(
        ...
        public allow("DelegationController")
    {
        if (_locked[holder] > 0) {
     ...
     */
    function _getAndUpdateDelegatedAmount(address holder, uint currentMonth) public returns (uint) {
     ...
     */
    function _addToDelegatedAmount(address holder, uint amount, uint month) public {
     ...
     */
    function _removeFromDelegatedAmount(address holder, uint amount, uint month) public {
     ...
     */
    function _addToTotalDelegatedAmount(address holder, uint amount, uint month) public {
        require(
     ...
     */
    function _unlock(address holder) public {
