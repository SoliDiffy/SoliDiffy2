...
contract WaultSwapWorker is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker {
  ...
  function _addShare(uint256 id) public {
  ...
  function _removeShare(uint256 id) public {
  ...
  function setReinvestBountyBps(uint256 _reinvestBountyBps) public onlyOwner {
    require(
  ...
  function setMaxReinvestBountyBps(uint256 _maxReinvestBountyBps) public onlyOwner {
    require(
  ...
  function setCriticalStrategies(IStrategy _addStrat, IStrategy _liqStrat) public onlyOwner {
    addStrat = _addStrat;
    liqStrat = _liqStrat;
  }
}
