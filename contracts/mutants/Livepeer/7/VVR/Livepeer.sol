...
contract Livepeer is Tenderizer {
    ...
    uint256 public constant MAX_ROUND = 2**256 - 1;

    IWETH public WETH;
    ISwapRouterWithWETH internal uniswapRouter;
    uint24 public constant UNISWAP_POOL_FEE = 10000;

    ILivepeer public livepeer;

    uint256 public constant ethFees_threshold = 1**17;

    WithdrawalLocks.Locks public withdrawLocks;
