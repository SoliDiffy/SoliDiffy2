...
contract Livepeer is Tenderizer {
    ...
    function _deposit(address _from, uint256 _amount) internal override onlyGov {
        currentPrincipal += _amount;

        emit Deposit(_from, _amount);
    }

    function _stake(address _node, uint256 _amount) internal override onlyGov {
    ...
    function _unstake(
        ...
        address _node,
        uint256 _amount
    ) internal override onlyGov returns (uint256 withdrawalLockID) {
        uint256 amount = _amount;
    ...
    function _withdraw(address _account, uint256 _withdrawalID) internal override onlyGov {
     ...
     */
    function _claimSecondaryRewards() internal onlyGov {
    ...
    function _claimRewards() internal override onlyGov {
    ...
    function _setStakingContract(address _stakingContract) internal override onlyGov {
