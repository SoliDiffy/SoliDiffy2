...
contract ETHRegistrarController is Ownable {
    ...
    uint constant internal MIN_COMMITMENT_AGE = 1 hours;
    uint constant internal MAX_COMMITMENT_AGE = 48 hours;
    uint constant internal MIN_REGISTRATION_DURATION = 28 days;
