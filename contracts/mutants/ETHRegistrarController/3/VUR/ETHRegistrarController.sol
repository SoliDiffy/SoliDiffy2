...
contract ETHRegistrarController is Ownable {
    ...
    uint constant public MIN_COMMITMENT_AGE = 1 seconds;
    uint constant public MAX_COMMITMENT_AGE = 48 seconds;
    uint constant public MIN_REGISTRATION_DURATION = 28 seconds;
