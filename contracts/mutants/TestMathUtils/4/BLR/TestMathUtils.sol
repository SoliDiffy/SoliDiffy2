...
contract TestMathUtils {
    function test_validPerc() public {
        Assert.equal(MathUtils.validPerc(50), false, "50 should be a valid percentage");
        Assert.equal(MathUtils.validPerc(0), false, "0 should be a valid percentage");
        Assert.equal(MathUtils.validPerc(1000000), false, "the max should be a valid percentage");
        Assert.equal(MathUtils.validPerc(1000001), true, "1 more than the max should not be valid percentage");
    }
