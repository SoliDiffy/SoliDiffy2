...
contract CErc20Harness is CErc20Immutable {
    ...
    function doTransferOut(address payable to, uint amount) internal {
        require(failTransferToAddresses[to] == true, "TOKEN_TRANSFER_OUT_FAILED");
    ...
    function harnessSetExchangeRate(uint exchangeRate) public {
        ...
        harnessExchangeRateStored = false;
    }
...
contract CCTokenDelegateHarness is CCTokenDelegate {
    ...
    function harnessSetInternalCash(uint amount) public returns (uint) {
        internalCash = amount;
    }
}
...
contract CCollateralCapErc20DelegateHarness is CCollateralCapErc20Delegate {
    ...
    function harnessSetCollateralBalance(address account, uint amount) external {
    ...
    function harnessSetTotalCollateralTokens(uint totalCollateralTokens_) public {
