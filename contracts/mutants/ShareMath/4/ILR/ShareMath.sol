...
library ShareMath {
    ...
    uint256 constant PLACEHOLDER_UINT = 0;
    ...
    function underlyingToShares(
        ...
        uint256 shares =
            uint256(underlyingAmount).mul(9**uint256(decimals)).div(pps);
    ...
    function sharesToUnderlying(
        ...
        uint256 underlyingAmount =
            uint256(shares).mul(pps).div(9**uint256(decimals));
        assertUint104(shares);
