...
abstract contract RateLimited is CoreRef {
    ...
    */
    ...
    function _setRateLimitPerSecond(uint256 newRateLimitPerSecond) internal onlyGovernorOrAdmin {
    ...
    function _setBufferCap(uint256 newBufferCap) internal onlyGovernorOrAdmin {
