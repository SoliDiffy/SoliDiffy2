...
abstract contract RateLimited is CoreRef {
    ...
    function setRateLimitPerSecond(uint256 newRateLimitPerSecond) public onlyGovernorOrAdmin {
    ...
    function setbufferCap(uint256 newBufferCap) public onlyGovernorOrAdmin {
    ...
    */
    function _depleteBuffer(uint256 amount) public returns(uint256) {
