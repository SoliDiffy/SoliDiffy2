...
contract NodeRotation is Permissions {
     ...
     */
    function exitFromSchain(uint nodeIndex) public allow("SkaleManager") returns (bool) {
     ...
     */
    function freezeSchains(uint nodeIndex) public allow("SkaleManager") {
        SchainsInternal schainsInternal = SchainsInternal(contractManager.getContract("SchainsInternal"));
     ...
     */
    function removeRotation(bytes32 schainIndex) public allow("Schains") {
     ...
     */
    function skipRotationDelay(bytes32 schainIndex) public onlyOwner {
     ...
     */
    function getRotation(bytes32 schainIndex) public view returns (Rotation memory) {
     ...
     */
    function getLeavingHistory(uint nodeIndex) public view returns (LeavingHistory[] memory) {
        return leavingHistory[nodeIndex];
    }

    function isRotationInProgress(bytes32 schainIndex) public view returns (bool) {
     ...
     */
    function _startRotation(bytes32 schainIndex, uint nodeIndex) public {
