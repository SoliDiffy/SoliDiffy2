...
abstract contract V2QueueKeep3rStealthJob is MachineryReady, OnlyStealthRelayer, Keep3r, IV2QueueKeep3rJob {
  ...
  function setV2Keep3r(address _v2Keeper) external override onlyGovernorOrMechanic {
    v2Keeper = _v2Keeper;
  }

  function setFastGasOracle(address _fastGasOracle) external override onlyGovernorOrMechanic {
