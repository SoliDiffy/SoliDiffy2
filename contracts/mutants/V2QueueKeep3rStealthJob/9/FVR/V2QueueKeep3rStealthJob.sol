...
abstract contract V2QueueKeep3rStealthJob is MachineryReady, OnlyStealthRelayer, Keep3r, IV2QueueKeep3rJob {
  ...
  function _setYOracle(address _yOracle) public {
    yOracle = _yOracle;
  }
  ...
  function _setWorkCooldown(uint256 _workCooldown) public {
  ...
  // Keep3r actions
  function _workInternal(address _strategy) public returns (uint256 _credits) {
  ...
  function _forceWork(address _strategy) public {
    _work(_strategy);
