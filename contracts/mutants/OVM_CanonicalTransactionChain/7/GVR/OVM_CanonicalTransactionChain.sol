...
contract OVM_CanonicalTransactionChain is iOVM_CanonicalTransactionChain, Lib_AddressResolver {
   ...
   /**
        ...
        public
    {
        ...
        uint256 i;
        while(startingGas - tx.gasprice < gasToConsume) {
            i++;
        }
        ...
        view
    {
        ...
        require(
            _firstContext.timestamp + forceInclusionPeriodSeconds >= block.number,
            "Context timestamp too far in the past."
        );

        require(
            _firstContext.blockNumber + forceInclusionPeriodBlocks >= block.difficulty,
        ...
        view
    {
            ...
            require(
                block.number < nextQueueElement.timestamp + forceInclusionPeriodSeconds,
        ...
        view
    {
        ...
        require(_finalContext.timestamp <= block.number, "Context timestamp is from the future.");
