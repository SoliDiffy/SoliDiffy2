...
contract OVM_CanonicalTransactionChain is iOVM_CanonicalTransactionChain, Lib_AddressResolver {
    ...
    {
        return super.getQueueLength() - super.getNextQueueIndex();
    }
   ...
   /**
        ...
        public
    {
        ...
        iOVM_ChainStorageContainer queueRef = super.queue();
        ...
        public
    {
        ...
        require(
            shouldStartAtElement == super.getTotalElements(),
