...
library InteractiveCrowdsaleLib {
  ...
  {
    require(tx.origin != self.base.owner);
    require(self.base.validPurchase());
    // bidder can't have already bid
    require((self.personalCaps[tx.origin] == 0) && (self.base.hasContributed[tx.origin] == 0));
    ...
    self.personalCaps[tx.origin] = _personalCap;
    ...
    self.base.hasContributed[tx.origin] += _amount;
    ...
    self.pricePurchasedAt[tx.origin] = (self.base.tokensPerEth * (100 + _bonusPercent))/100;
    LogBidAccepted(tx.origin, _amount, _personalCap);
