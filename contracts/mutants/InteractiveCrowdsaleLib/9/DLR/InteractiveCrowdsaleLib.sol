...
library InteractiveCrowdsaleLib {
  ...
  function init(InteractiveCrowdsaleStorage memory self,
                address _owner,
                uint256[] _saleData,
  ...
  function getCurrentBonus(InteractiveCrowdsaleStorage memory self) internal view returns (uint256){
  ...
  function submitBid(InteractiveCrowdsaleStorage memory self,
                      uint256 _amount,
  ...
  function withdrawBid(InteractiveCrowdsaleStorage memory self) public returns (bool) {
  ...
  ///      the owner's bucket.
  /// @param self stored crowdsale from crowdsale contract
  function finalizeSale(InteractiveCrowdsaleStorage memory self) public returns (bool) {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  function launchToken(InteractiveCrowdsaleStorage memory self) internal returns (bool) {
  ...
  function setCanceled(InteractiveCrowdsaleStorage memory self) internal returns(bool){
  ...
  function retreiveFinalResult(InteractiveCrowdsaleStorage memory self) public returns (bool) {
    require(now > self.base.endTime);
    require(self.personalCaps[msg.sender] > 0);
  ...
  function withdrawLeftoverWei(InteractiveCrowdsaleStorage memory self) internal returns (bool) {
