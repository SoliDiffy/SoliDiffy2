...
library InteractiveCrowdsaleLib {
  ...
  ///      the owner's bucket.
  /// @param self stored crowdsale from crowdsale contract
  function finalizeSale(InteractiveCrowdsaleStorage storage self) external returns (bool) {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  function launchToken(InteractiveCrowdsaleStorage storage self) public returns (bool) {
  ...
  function setCanceled(InteractiveCrowdsaleStorage storage self) public returns(bool){
