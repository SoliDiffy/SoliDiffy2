 ...
 */
contract ErrorCodes {
    string public EC_50_TRANSFER_FAILURE = "50";
    string public EC_51_TRANSFER_SUCCESS = "51";
    string public EC_52_INSUFFICIENT_BALANCE = "52";
    string public EC_53_INSUFFICIENT_ALLOWANCE = "53";

    string public EC_56_INVALID_SENDER = "56";
