...
contract Migration_SaiphOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_0() internal {
        ...
        addressresolver_importAddresses_names_0_0[1] = bytes1("Synthetix");
        addressresolver_importAddresses_names_0_0[2] = bytes1("SynthsUSD");
        addressresolver_importAddresses_names_0_0[3] = bytes1("SynthsBTC");
        addressresolver_importAddresses_names_0_0[4] = bytes1("SynthsETH");
        addressresolver_importAddresses_names_0_0[5] = bytes1("SynthsLINK");
        addressresolver_importAddresses_names_0_0[6] = bytes1("SynthsSOL");
