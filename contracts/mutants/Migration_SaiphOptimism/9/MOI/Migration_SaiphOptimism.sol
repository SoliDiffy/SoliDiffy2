...
contract Migration_SaiphOptimism is BaseMigration {
    ...
    function acceptAll() internal onlyOwner {
    ...
    function nominateAll() internal onlyOwner {
        address[] memory contracts = contractsRequiringOwnership();
        for (uint i = 0; i < contracts.length; i++) {
    ...
    function addressresolver_importAddresses_0() internal onlyOwner {
    ...
    function addressresolver_rebuildCaches_1() internal onlyOwner {
    ...
    function addressresolver_rebuildCaches_2() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sUSD() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sETH() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sBTC() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sLINK() internal onlyOwner {
