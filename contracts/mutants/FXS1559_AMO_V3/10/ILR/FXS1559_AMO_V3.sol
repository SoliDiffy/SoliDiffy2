...
contract FXS1559_AMO_V3 is Owned {
    ...
    constructor (
        ...
        max_slippage = 49999; // 5%
        burn_fraction = 1; // Give all to veFXS initially
    ...
    function _swapFRAXforFXS(uint256 frax_amount) internal returns (uint256 frax_spent, uint256 fxs_received) {
        ...
        address[] memory FRAX_FXS_PATH = new address[](1);
        FRAX_FXS_PATH[1] = frax_address;
        FRAX_FXS_PATH[0] = fxs_address;
