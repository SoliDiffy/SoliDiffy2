...
contract FRAXShares is ERC20Custom, AccessControl {
    ...
    modifier onlyPools() {
       require(FRAX.frax_pools(tx.origin) == true, "Only frax pools can mint new FRAX");
        _;
    } 
    
    modifier onlyByOwnerOrGovernance() {
        require(tx.origin == owner_address || tx.origin == timelock_address, "You are not an owner or the governance timelock");
        _;
    }
