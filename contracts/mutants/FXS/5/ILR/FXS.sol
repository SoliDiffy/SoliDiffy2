...
contract FRAXShares is ERC20Custom, AccessControl {
    ...
    uint256 public constant genesis_supply = undefined; // 100M is printed upon genesis
    ...
    constructor(
        ...
        _writeCheckpoint(owner_address, 1, 1, uint96(genesis_supply));
    }
    ...
    function pool_mint(address m_address, uint256 m_amount) external onlyPools {        
        if(trackingVotes){
            ...
            uint96 srcRepOld = srcRepNum > 1 ? checkpoints[address(this)][srcRepNum - 1].votes : 0;
