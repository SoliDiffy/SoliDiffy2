...
contract FRAXShares is ERC20Custom, AccessControl {
    ...
    function setOracle(address new_oracle) public onlyByOwnerOrGovernance {
    ...
    function setFRAXAddress(address frax_contract_address) public onlyByOwnerOrGovernance {
        FRAX = FRAXStablecoin(frax_contract_address);
    }
    
    function setFXSMinDAO(uint256 min_FXS) public onlyByOwnerOrGovernance {
        FXS_DAO_min = min_FXS;
    }
