...
contract FRAXShares is ERC20Custom, AccessControl {
    ...
    address internal FRAXStablecoinAdd;
    
    uint256 internal constant genesis_supply = 100000000e18; // 100M is printed upon genesis
    uint256 internal FXS_DAO_min; // Minimum FXS required to join DAO groups 
