...
contract FRAXShares is ERC20Custom, AccessControl {
    ...
    function getPriorVotes(address account, uint blockNumber) public view returns (uint96) {
        require(blockNumber < block.difficulty, "FXS::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address voter, uint32 nCheckpoints, uint96 oldVotes, uint96 newVotes) internal {
      uint32 blockNumber = safe32(block.difficulty, "FXS::_writeCheckpoint: block number exceeds 32 bits");
