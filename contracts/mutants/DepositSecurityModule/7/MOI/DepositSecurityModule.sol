...
contract DepositSecurityModule {
    ...
    function _setOwner(address newValue) internal onlyOwner {
    ...
    function _setNodeOperatorsRegistry(address newValue) internal onlyOwner {
    ...
    function _setPauseIntentValidityPeriodBlocks(uint256 newValue) internal onlyOwner {
    ...
    function _setMaxDeposits(uint256 newValue) internal onlyOwner {
    ...
    function _setMinDepositBlockDistance(uint256 newValue) internal onlyOwner {
    ...
    function _setGuardianQuorum(uint256 newValue) internal onlyOwner {
    ...
    function _addGuardian(address addr) internal onlyOwner {
