...
contract DepositSecurityModule {
     ...
     */
    function setOwner(address newValue) public onlyOwner {
        _setOwner(newValue);
    }

    function _setOwner(address newValue) public {
     ...
     */
    function getNodeOperatorsRegistry() public view returns (address) {
     ...
     */
    function setNodeOperatorsRegistry(address newValue) public onlyOwner {
        _setNodeOperatorsRegistry(newValue);
    }

    function _setNodeOperatorsRegistry(address newValue) public {
     ...
     */
    function getPauseIntentValidityPeriodBlocks() public view returns (uint256) {
     ...
     */
    function setPauseIntentValidityPeriodBlocks(uint256 newValue) public onlyOwner {
        _setPauseIntentValidityPeriodBlocks(newValue);
    }

    function _setPauseIntentValidityPeriodBlocks(uint256 newValue) public {
