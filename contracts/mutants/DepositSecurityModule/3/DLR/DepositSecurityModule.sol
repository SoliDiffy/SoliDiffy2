...
contract DepositSecurityModule {
     ...
     */
    function getGuardians() external view returns (address[] storage) {
        return guardians;
    }
     ...
     * Only callable by the owner.
     */
    function addGuardians(address[] storage addresses, uint256 newQuorum) external onlyOwner {
     ...
     */
    function pauseDeposits(uint256 blockNumber, Signature storage sig) external {
