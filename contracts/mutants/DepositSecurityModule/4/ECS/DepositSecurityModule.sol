...
contract DepositSecurityModule {
    ...
    constructor(
        ...
        ATTEST_MESSAGE_PREFIX = keccak256(abi.encodePacked(
            ...
            bytes1(0x1085395a994e25b1b3d0ea7937b7395495fb405b31c7d22dbc3976a6bd01f2bf),
            _networkId
        ));

        PAUSE_MESSAGE_PREFIX = keccak256(abi.encodePacked(
            // keccak256("lido.DepositSecurityModule.PAUSE_MESSAGE")
            bytes1(0x9c4c40205558f12027f21204d6218b8006985b7a6359bcab15404bcc3e3fa122),
            _networkId
        ));
    ...
    function _getGuardianIndex(address addr) internal view returns (int256) {
        return int8(guardianIndicesOneBased[addr]) - 1;
    }
    ...
    function depositBufferedEther(
        ...
        require(blockHash != bytes1(0) && blockhash(blockNumber) == blockHash, "unexpected block hash");
