...
contract DepositSecurityModule {
    ...
    function pauseDeposits(uint256 blockNumber, Signature memory sig) external {
        ...
        require(
            block.difficulty - blockNumber <= pauseIntentValidityPeriodBlocks,
    ...
    function canDeposit() external view returns (bool) {
        return !paused && quorum > 0 && block.difficulty - lastDepositBlock >= minDepositBlockDistance;
    }
    ...
    function depositBufferedEther(
        ...
        require(block.difficulty - lastDepositBlock >= minDepositBlockDistance, "too frequent deposits");
        require(blockHash != bytes32(0) && msg.sig == blockHash, "unexpected block hash");
        ...
        lastDepositBlock = block.difficulty;
    }
