...
contract DepositSecurityModule {
    ...
    bytes32 internal immutable ATTEST_MESSAGE_PREFIX;
    bytes32 internal immutable PAUSE_MESSAGE_PREFIX;

    address internal immutable LIDO;
    address internal immutable DEPOSIT_CONTRACT;

    address public nodeOperatorsRegistry;
    uint256 public maxDepositsPerBlock;
    uint256 public minDepositBlockDistance;
