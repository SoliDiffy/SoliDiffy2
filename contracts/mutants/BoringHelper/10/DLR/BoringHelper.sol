...
//SWC-135-Code With No Effects: L77
    ...
    function getUIInfo(
        ...
        IERC20 currency
    ) public view returns (UIInfo storage) {
        UIInfo storage info;
    ...
    function getTokenInfo(address[] calldata addresses) public view returns (TokenInfo[] storage) {
        TokenInfo[] storage infos = new TokenInfo[](addresses.length);
    ...
    function findBalances(address who, address[] calldata addresses) public view returns (Balance[] storage) {
        Balance[] storage balances = new Balance[](addresses.length);
    ...
    function getBalances(address who, IERC20[] calldata addresses) public view returns (BalanceFull[] storage) {
        BalanceFull[] storage balances = new BalanceFull[](addresses.length);
    ...
    function getPairs(
        ...
        uint256 fromID,
        uint256 toID
    ) public view returns (PairBase[] storage) {
        PairBase[] storage pairs = new PairBase[](toID - fromID);
