...
//SWC-135-Code With No Effects: L77
    ...
    function getPools(uint256[] calldata pids) external view returns (PoolsInfo memory, PoolInfo[] memory) {
    ...
    function findPools(address who, uint256[] calldata pids) external view returns (PoolFound[] memory) {
