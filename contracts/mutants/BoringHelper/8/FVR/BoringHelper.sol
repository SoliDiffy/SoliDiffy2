...
//SWC-135-Code With No Effects: L77
    function getMETARate(IERC20 token) external view returns (uint256) {
        if (token == WMETA) {
            return 1e18;
        }
        IPair pair;
    ...
    function getUIInfo(
        ...
        IERC20 currency
    ) external view returns (UIInfo memory) {
        UIInfo memory info;
    ...
    function getTokenInfo(address[] calldata addresses) external view returns (TokenInfo[] memory) {
    ...
    function findBalances(address who, address[] calldata addresses) external view returns (Balance[] memory) {
    ...
    function getBalances(address who, IERC20[] calldata addresses) external view returns (BalanceFull[] memory) {
    ...
    function getPairs(
        ...
        uint256 fromID,
        uint256 toID
    ) external view returns (PairBase[] memory) {
    ...
    function pollPairs(address who, IPair[] calldata addresses) external view returns (PairPoll[] memory) {
