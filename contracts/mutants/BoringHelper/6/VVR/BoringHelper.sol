...
contract BoringHelper is Ownable {
    ...
    IGravityCenter internal gravity; // IMasterChef(0xc2EdaD668740f1aA35E4D8f227fB8E17dcA888Cd);
    IERC20 internal mspace; // ISushiToken(0x6B3595068778DD592e39A122f4f5a5cF09C90fE2);
    IERC20 internal WMETA; // 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    IERC20 internal WETH; // 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599;
    IFactory internal factory; // IFactory(0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac);
    IERC20 internal space; // 0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272;
