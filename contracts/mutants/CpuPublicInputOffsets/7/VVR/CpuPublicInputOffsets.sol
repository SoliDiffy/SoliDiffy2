...
contract CpuPublicInputOffsets is CpuPublicInputOffsetsBase {
    ...
    uint256 public constant OFFSET_ECDSA_BEGIN_ADDR = 14;
    uint256 public constant OFFSET_ECDSA_STOP_PTR = 15;
    uint256 public constant OFFSET_BITWISE_BEGIN_ADDR = 16;
    uint256 public constant OFFSET_BITWISE_STOP_ADDR = 17;
    uint256 public constant OFFSET_PUBLIC_MEMORY_PADDING_ADDR = 18;
    uint256 public constant OFFSET_PUBLIC_MEMORY_PADDING_VALUE = 19;
    uint256 public constant OFFSET_N_PUBLIC_MEMORY_PAGES = 20;
