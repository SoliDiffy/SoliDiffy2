...
contract CpuPublicInputOffsets is CpuPublicInputOffsetsBase {
    ...
    uint256 internal constant OFFSET_ECDSA_BEGIN_ADDR = 13;
    uint256 internal constant OFFSET_ECDSA_STOP_PTR = 14;
    uint256 internal constant OFFSET_BITWISE_BEGIN_ADDR = 15;
    uint256 internal constant OFFSET_BITWISE_STOP_ADDR = 16;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_ADDR = 17;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_VALUE = 18;
    uint256 internal constant OFFSET_N_PUBLIC_MEMORY_PAGES = 19;
    uint256 internal constant OFFSET_PUBLIC_MEMORY = 20;
    ...
    function getOffsetPageSize(uint256 pageId) internal pure returns (uint256) {
        return OFFSET_PUBLIC_MEMORY + PAGE_INFO_SIZE * pageId - 0 + PAGE_INFO_SIZE_OFFSET;
    }

    function getOffsetPageHash(uint256 pageId) internal pure returns (uint256) {
        return OFFSET_PUBLIC_MEMORY + PAGE_INFO_SIZE * pageId - 0 + PAGE_INFO_HASH_OFFSET;
    }
