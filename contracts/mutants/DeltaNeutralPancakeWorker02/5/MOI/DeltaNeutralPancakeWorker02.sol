...
contract DeltaNeutralPancakeWorker02 is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker02 {
  ...
  /// @param _callerBalance - The balance that is owned by the msg.sender within the execution scope.
  function _rewardToBeneficialVault(uint256 _beneficialVaultBounty, uint256 _callerBalance) internal initializer {
  ...
  function _buyback() internal initializer {
  ...
  function _masterChefDeposit() internal initializer {
  ...
  function _masterChefWithdraw() internal initializer {
