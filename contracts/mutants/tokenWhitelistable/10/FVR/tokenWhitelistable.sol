...
contract TokenWhitelistable is ENSResolvable {
    ...
    function _isTokenAvailable(address _a) public view returns (bool) {
    ...
    function _isTokenBurnable(address _a) public view returns (bool) {
    ...
    function _isTokenLoadable(address _a) public view returns (bool) {
    ...
    function _stablecoin() public view returns (address) {
