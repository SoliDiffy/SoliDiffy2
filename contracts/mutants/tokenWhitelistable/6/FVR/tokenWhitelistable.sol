...
contract TokenWhitelistable is ENSResolvable {
    ...
    constructor(bytes32 _tokenWhitelistNameHash_) public {
    ...
    function _getTokenInfo(address _a) public view returns (string, uint256, uint256, bool, bool, bool, uint256) {
    ...
    /// @return bool whether the token is burnable to the TKN Holder Contract
    /// @return uint of the lastUpdated time of the token's exchange rate
    function _getStablecoinInfo() public view returns (string, uint256, uint256, bool, bool, bool, uint256) {
    ...
    function _tokenAddressArray() public view returns (address[]) {
    ...
    function _updateTokenRate(address _token, uint _rate, uint _updateDate) public {
