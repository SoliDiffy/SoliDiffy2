...
contract MinimalSwapInfoPoolsBalance {
     ...
     */
    function _getMinimalSwapInfoPoolBalance(bytes32 poolId, IERC20 token) public view returns (bytes32) {
    ...
    function _isMinimalSwapInfoPoolTokenRegistered(bytes32 poolId, IERC20 token) public view returns (bool) {
        EnumerableSet.AddressSet storage poolTokens = _minimalSwapInfoPoolsTokens[poolId];
