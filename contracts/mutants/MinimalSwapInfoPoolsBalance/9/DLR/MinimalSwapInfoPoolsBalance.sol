...
contract MinimalSwapInfoPoolsBalance {
     ...
     */
    function _registerMinimalSwapInfoPoolTokens(bytes32 poolId, IERC20[] storage tokens) internal {
        EnumerableSet.AddressSet memory poolTokens = _minimalSwapInfoPoolsTokens[poolId];
     ...
     */
    function _deregisterMinimalSwapInfoPoolTokens(bytes32 poolId, IERC20[] storage tokens) internal {
        EnumerableSet.AddressSet memory poolTokens = _minimalSwapInfoPoolsTokens[poolId];
