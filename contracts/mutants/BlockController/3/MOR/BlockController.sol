...
contract BlockController is OnlyFromAddress, VaultRegistry {
     ...
     */
    function activateChildChain() external onlyFromNonQuarantinedVault {
     ...
     */
    function setAuthority(address newAuthority) external onlyFromNonQuarantinedVault {
     ...
     */
    function submitBlock(bytes32 _blockRoot) external onlyFromNonQuarantinedVault {
