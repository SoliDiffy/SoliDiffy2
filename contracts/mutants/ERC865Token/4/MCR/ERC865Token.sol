...
contract ERC865Token is ERC865 {
        ...
        returns (bytes32)
    {
        ...
        return sha256(bytes4(0x48664c16), _token, _to, _value, _fee, _nonce);
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(bytes4(0xf7ac9c2e), _token, _spender, _value, _fee, _nonce);
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(bytes4(0xa45f71ff), _token, _spender, _addedValue, _fee, _nonce);
    }
        ...
        returns (bytes32)
    {
        ...
        return sha256(bytes4(0x59388d78), _token, _spender, _subtractedValue, _fee, _nonce);
    }
