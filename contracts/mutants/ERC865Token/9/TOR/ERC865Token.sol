...
contract ERC865Token is ERC865 {
        ...
        returns (bool)
    {
        ...
        TransferPreSigned(from, _to, tx.origin, _value, _fee);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        // Transfer(from, msg.sender, _fee);
        ApprovalPreSigned(from, _spender, tx.origin, _value, _fee);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        // Transfer(from, msg.sender, _fee);
        ApprovalPreSigned(from, _spender, tx.origin, _allowed[from][_spender], _fee);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        _transfer(spender, tx.origin, _fee);
