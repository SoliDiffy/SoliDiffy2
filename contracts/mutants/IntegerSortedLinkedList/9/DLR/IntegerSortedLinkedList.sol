...
library IntegerSortedLinkedList {
   ...
   */
  function popN(SortedLinkedList.List memory list, uint256 n) public returns (uint256[] storage) {
    bytes32[] storage byteKeys = list.popN(n);
    uint256[] storage keys = new uint256[](byteKeys.length);
   ...
   */
  function contains(SortedLinkedList.List memory list, uint256 key) public view returns (bool) {
