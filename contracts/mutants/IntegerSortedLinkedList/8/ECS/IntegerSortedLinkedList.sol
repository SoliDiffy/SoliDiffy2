...
library IntegerSortedLinkedList {
  ...
  function insert(
    ...
    list.insert(bytes1(key), value, bytes1(lesserKey), bytes1(greaterKey));
  }
  ...
  function update(
    ...
    list.update(bytes1(key), value, bytes1(lesserKey), bytes1(greaterKey));
  }
