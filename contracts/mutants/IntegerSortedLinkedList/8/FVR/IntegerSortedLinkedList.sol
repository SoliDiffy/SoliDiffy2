...
library IntegerSortedLinkedList {
   ...
   */
  function remove(SortedLinkedList.List storage list, uint256 key) external {
   ...
   * @param key The key of the element to insert.
   */
  function push(SortedLinkedList.List storage list, uint256 key) external {
   ...
   */
  function popN(SortedLinkedList.List storage list, uint256 n) external returns (uint256[] memory) {
   ...
   */
  function contains(SortedLinkedList.List storage list, uint256 key) external view returns (bool) {
   ...
   */
  function getValue(SortedLinkedList.List storage list, uint256 key) external view returns (uint256) {
