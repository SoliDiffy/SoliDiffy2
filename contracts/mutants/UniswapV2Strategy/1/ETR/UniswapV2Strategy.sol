...
contract UniswapV2Strategy is IUniswapV2StyleStrategy {
        ...
        external override
    {
        ...
        require(ERC20Helper.send(fundsAsset_, profitDestination_, IERC20Like(fundsAsset_).balanceOf(address(this)) - minReturnAmount_), "UniswapV2Strategy:PROFIT_TRANSFER");
    }
