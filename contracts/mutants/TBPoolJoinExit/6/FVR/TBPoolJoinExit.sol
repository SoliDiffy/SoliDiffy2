...
contract TBPoolJoinExit is CryticInterface, BPool {
    ...
    function set_two_inputs(uint _amount1, uint _amount2) external {
        amount1 = EXIT_FEE + _amount1 % 2**64;
        amount2 = EXIT_FEE + _amount2 % 2**64;
    }

    function echidna_joinPool_exitPool_balance_consistency() external returns (bool) {
    ...
    function echidna_revert_impossible_joinPool_exitPool() external returns (bool) {
