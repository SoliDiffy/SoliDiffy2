...
library FraxPoolLibrary {
    ...
    function calcBuyBackFXS(BuybackFXS_Params memory params) internal pure returns (uint256) {
        ...
        uint256 fxs_dollar_value_d18 = params.FXS_amount.mul(params.fxs_price_usd).mul(1e6);
        ...
        uint256 collateral_equivalent_d18 = fxs_dollar_value_d18.mul(1e6).mul(params.col_price_usd);
