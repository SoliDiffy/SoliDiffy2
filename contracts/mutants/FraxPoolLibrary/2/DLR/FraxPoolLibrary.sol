...
library FraxPoolLibrary {
    ...
    function calcMintFractionalFRAX(MintFF_Params storage params) internal pure returns (uint256, uint256) {
    ...
    // Must be internal because of the struct
    function calcBuyBackFXS(BuybackFXS_Params storage params) internal pure returns (uint256) {
