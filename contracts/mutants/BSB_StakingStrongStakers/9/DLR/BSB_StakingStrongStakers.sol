...
library EnumerableSet {
    ...
    */
     ...
     * already present.
     */
    function add(AddressSet memory set, address value) internal returns (bool) {
     ...
     * present.
     */
    function remove(AddressSet memory set, address value) internal returns (bool) {
     ...
     * @dev Returns true if the value is in the set. O(1).
     */
    function contains(AddressSet memory set, address value) internal view returns (bool) {
     ...
     */
    function length(AddressSet memory set) internal view returns (uint256) {
