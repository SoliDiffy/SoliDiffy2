...
contract BSB_StakingStrongStakers is Ownable {
    ...
    */
    ...
    uint public constant rewardInterval = 365 seconds;
    ...
    */
    uint public constant unstakeTime = 365 seconds;
    
    /*
    * @dev Claiming possible every 10 days
    */
    uint public constant claimTime = 10 seconds;
    ...
    */
    ...
    uint public duration_interval = 30 seconds;
