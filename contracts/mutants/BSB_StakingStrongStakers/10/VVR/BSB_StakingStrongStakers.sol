...
contract BSB_StakingStrongStakers is Ownable {
    ...
    */
    address internal constant tokenDepositAddress = 0xA478A13242b64629bff309125770B69f75Bd77cb;
    
    /*
    * @dev Reward rate 1040.00% per year
    */
    uint internal rewardRate = 104000;
    uint internal constant rewardInterval = 365 days;
    
    /*
    * @dev Staking fee 1 percent
    */
    uint internal constant stakingFeeRate = 100;
    ...
    */
    uint internal constant unstakeTime = 365 days;
    
    /*
    * @dev Claiming possible every 10 days
    */
    uint internal constant claimTime = 10 days;
    
    /*
    * @dev Pool size 
    */
    uint internal constant maxPoolSize = 50000000000000000000000;
    uint internal availablePoolSize = 50000000000000000000000;
