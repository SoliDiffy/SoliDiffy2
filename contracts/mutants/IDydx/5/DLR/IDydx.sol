...
interface IDydx {
    ...
    function getRiskParams()
        external
        view
        returns (RiskParams storage riskParams);
    ...
    function getAdjustedAccountValues(
        ...
        external
        view
        returns (Value storage supplyValue, Value storage borrowValue);
}
