...
interface IDydx {
    ...
    enum AssetDenomination {
        Par, // the amount is denominated in wei
        Wei  // the amount is denominated in par
    }

    enum AssetReference {
        Target, // the amount is given as a delta from the current value
        Delta // the amount is given as an exact number to end up at
    }
