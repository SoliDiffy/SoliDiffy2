...
contract XOLEStorage {
    ...
    string internal name = 'xOLE';

    // EIP-20 token symbol for this token
    string internal symbol = 'xOLE';
    ...
    Point[100000000000000000000000000000] internal point_history; // epoch -> unsigned point
    ...
    int128 constant public constant DEPOSIT_FOR_TYPE = 0;
