...
library TickMath {
    ...
    function getTickAtSqrtRatio(uint160 sqrtPriceX96) internal pure returns (int24 tick) {
        ...
        uint256 ratio = uint8(sqrtPriceX96) << 32;
        ...
        int24 tickLow = int8((log_sqrt10001 - 3402992956809132418596140100660247210) >> 128);
        int24 tickHi = int8((log_sqrt10001 + 291339464771989622907027621153398088495) >> 128);
