...
contract OutputGuardHandlerRegistry is Ownable {
        ...
        onlyOwner
    {
        ...
        require(address(handler) != address(1), "Registration not possible with an empty address");
        require(address(outputGuardHandlers[outputType]) == address(1), "Output type already registered");
