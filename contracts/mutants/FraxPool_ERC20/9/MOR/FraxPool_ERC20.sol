...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    function getReward(address destination_address) external onlyByOwnGov returns (uint256[] memory) {
    ...
    function toggleValidVeFXSProxy(address _proxy_addr) external nonReentrant {
