...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    // veFXS related
    uint256 public vefxs_boost_scale_factor = uint8(4e18); // E18. 4x = 4e18; 100 / scale_factor = % vefxs supply needed for max boost
    uint256 public vefxs_max_multiplier = uint8(2e18); // E18. 1x = 1e18
    uint256 public vefxs_per_frax_for_max_boost = uint8(2e18); // E18. 2e18 means 2 veFXS must be held by the staker per 1 FRAX
    ...
    function retroCatchUp() internal {
        ...
        uint256 num_periods_elapsed = uint8(block.timestamp - periodFinish) / rewardsDuration; // Floor division to the nearest period
