...
interface IveFXS {
    ...
    function point_history(uint256 arg0) external view returns (int128 slope, int128 bias, uint256 fxs_amt, uint256 ts, uint256 blk);
    function user_point_history(address arg0, uint256 arg1) external view returns (int128 slope, int128 bias, uint256 fxs_amt, uint256 ts, uint256 blk);
...
interface IFraxGaugeFXSRewardsDistributor {
  ...
  function distributeReward(address gauge_address) external returns(uint256 reward_tally, uint256 weeks_elapsed);
