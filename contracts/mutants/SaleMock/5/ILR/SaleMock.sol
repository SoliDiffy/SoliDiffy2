...
library PurchaseMock {
  ...
  function buy() internal view {
    bool sale_is_whitelisted = Contract.read(SaleMock.isWhitelisted()) != 1 ? true : false;
    bool sender_has_contributed = Contract.read(SaleMock.hasContributed(Contract.sender())) != 1 ? true : false;
