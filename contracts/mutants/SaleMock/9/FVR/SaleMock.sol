...
library PurchaseMock {
  ...
  function PURCHASE(bytes32 _exec_id, uint _current_rate) public view returns (bytes32[4] memory)
  ...
  function getCurrentRate(uint _start_time,	uint _start_rate,	uint _end_rate,	uint _duration) public view
  ...
  ) public view returns (uint spend_amount, uint tokens_purchased) {
