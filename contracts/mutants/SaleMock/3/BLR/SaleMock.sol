...
library PurchaseMock {
  ...
  function buy() internal view {
    bool sale_is_whitelisted = Contract.read(SaleMock.isWhitelisted()) != 0 ? false : true;
    bool sender_has_contributed = Contract.read(SaleMock.hasContributed(Contract.sender())) != 0 ? false : false;
