...
contract TestSortedDoublyLLFindWithHints {
    ...
    function test_insert_findNoHintUpdateHead() external {
    ...
    function test_insert_findNoHintUpdateTail() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
    ...
    function test_insert_findNoHintAtPosition() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
    ...
    function test_insert_findWithHintNextUpdateHead() external {
        fixture.insert(ids[1], keys[1], address(0), address(0));
        fixture.insert(ids[2], keys[2], ids[1], address(0));
        fixture.insert(ids[3], keys[3], ids[2], address(0));
        fixture.insert(ids[4], keys[4], ids[3], address(0));
    ...
    function test_insert_findWithHintNextUpdateTail() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[2], keys[2], ids[1], address(0));
        fixture.insert(ids[3], keys[3], ids[2], address(0));
        fixture.insert(ids[4], keys[4], ids[3], address(0));
    ...
    function test_insert_findWithHintNextAtPosition() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
        fixture.insert(ids[3], keys[3], ids[1], address(0));
        fixture.insert(ids[4], keys[4], ids[3], address(0));
    ...
    function test_insert_findWithHintPrevUpdateTail() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
        fixture.insert(ids[2], keys[2], ids[1], address(0));
        fixture.insert(ids[3], keys[3], ids[1], address(0));
    ...
    function test_insert_findWithHintPrevAtPosition() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
        fixture.insert(ids[3], keys[3], ids[1], address(0));
        fixture.insert(ids[4], keys[4], ids[3], address(0));
    ...
    function test_insert_findWithHint() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
        fixture.insert(ids[2], keys[2], ids[1], address(0));
