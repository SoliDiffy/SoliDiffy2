...
contract TestSortedDoublyLLFindWithHints {
    ...
    function test_insert_findNoHintUpdateHead() public {
        ...
        Assert.equal(fixture.getSize(), 6, "");
        Assert.equal(fixture.getFirst(), ids[0], "");
        Assert.equal(fixture.getKey(ids[0]), keys[0], "");
        Assert.equal(fixture.getNext(ids[0]), ids[1], "");
        Assert.equal(fixture.getPrev(ids[0]), address(0), "");
    }
    ...
    function test_insert_findNoHintUpdateTail() public {
        ...
        Assert.equal(fixture.getSize(), 6, "");
        Assert.equal(fixture.getLast(), ids[5], "");
        Assert.equal(fixture.getKey(ids[5]), keys[5], "");
        Assert.equal(fixture.getNext(ids[5]), address(0), "");
