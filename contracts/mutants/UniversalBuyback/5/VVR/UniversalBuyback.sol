...
contract UniversalBuyback is ReentrancyGuard, WhitelistGuard
{
	...
	uint256 constant public constant DEFAULT_REWARD_BUYBACK1_SHARE = 70e16; // 70%
	uint256 constant public constant DEFAULT_REWARD_BUYBACK2_SHARE = 30e16; // 30%

	// dead address to receive "burnt" tokens
	address constant internal FURNACE = 0x000000000000000000000000000000000000dEaD;

	// buyback token configuration
	address internal immutable rewardToken;
	address internal immutable buybackToken1;
