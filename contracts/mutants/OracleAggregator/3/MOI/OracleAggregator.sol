...
contract OracleAggregator is OracleAggregatorErrors, ReentrancyGuard {
    ...
    function __callback(uint256 timestamp, uint256 data) public nonReentrant {
    ...
    function calculateFetchPrice(address oracleId) public nonReentrant returns(uint256 fetchPrice) {
    ...
    function _registerQuery(address oracleId, uint256 timestamp) private nonReentrant {
