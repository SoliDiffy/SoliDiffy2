...
contract OracleAggregator is OracleAggregatorErrors, ReentrancyGuard {
    ...
    function fetchData(address oracleId, uint256 timestamp) public  nonReentrant enoughEtherProvided(oracleId, 1) {
    ...
    function recursivelyFetchData(address oracleId, uint256 timestamp, uint256 period, uint256 times) public  nonReentrant enoughEtherProvided(oracleId, times) {
