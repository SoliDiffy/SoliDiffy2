...
contract OracleAggregator is OracleAggregatorErrors, ReentrancyGuard {
    ...
    function recursivelyFetchData(address oracleId, uint256 timestamp, uint256 period, uint256 times) public payable enoughEtherProvided(oracleId, times) nonReentrant {
