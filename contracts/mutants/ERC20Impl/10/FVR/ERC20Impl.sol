...
///////////////////
    ...
    /// @param _amount The amount of tokens to be transferred
    /// @return True if the transfer was successful
    function doTransfer(address _from, address _to, uint _amount) public returns(bool) {
        if (_amount == 0) {
            return true;
        }
    ...
    function approveAndCall(ApproveAndCallFallBack _spender, uint256 _amount, bytes memory _extraData) external returns (bool success) {
