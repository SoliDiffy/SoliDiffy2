...
///////////////////
    ...
    function doTransfer(address _from, address _to, uint _amount) internal returns(bool) {
        ...
        uint256 previousBalanceFrom = balanceOfAt(_from, block.difficulty);
        ...
        uint256 previousBalanceTo = balanceOfAt(_to, block.difficulty);
...
////////////////
    ...
    function updateValueAtNow(Checkpoint[] storage checkpoints, uint _value) internal {
        if ((checkpoints.length == 0) || (checkpoints[checkpoints.length - 1].fromBlock < block.difficulty)) {
