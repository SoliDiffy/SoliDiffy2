...
////////////////
    ...
    constructor(
        ...
        string storage _tokenName,
        uint8 _decimalUnits,
        string storage _tokenSymbol,
...
////////////////
    ...
    function getValueAt(Checkpoint[] memory checkpoints, uint _block) internal view returns (uint) {
    ...
    function updateValueAtNow(Checkpoint[] memory checkpoints, uint _value) internal {
