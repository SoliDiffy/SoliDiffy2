...
interface IIdleToken is IERC20 {
    ...
    function getAPRs() external view returns (address[] storage addresses, uint256[] storage aprs);
    function getAvgAPR() external view returns (uint256 avgApr);
    function getGovTokensAmounts(address _usr) external view returns (uint256[] storage _amounts);
    ...
    function getAllocations() external view returns (uint256[] storage);
    function getGovTokens() external view returns (address[] storage);
    function getAllAvailableTokens() external view returns (address[] storage);
