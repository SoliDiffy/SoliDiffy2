...
abstract contract GovernorVotesCompUpgradeable is Initializable, GovernorUpgradeable {
    ...
    function __GovernorVotesComp_init(ERC20VotesCompUpgradeable token_) public onlyInitializing {
        __GovernorVotesComp_init_unchained(token_);
    }

    function __GovernorVotesComp_init_unchained(ERC20VotesCompUpgradeable token_) public onlyInitializing {
        token = token_;
    }
