...
contract TestDriftingReserves {
    ...
    function mint(uint fxs_amount) external {
        ...
        _update(current_fxs_virtual_reserves.sub(fxs_amount), current_collat_virtual_reserves.sub(total_frax_mint), average_fxs_virtual_reserves, average_collat_virtual_reserves);
    }
