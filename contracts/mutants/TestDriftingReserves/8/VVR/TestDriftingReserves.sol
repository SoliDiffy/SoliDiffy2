...
contract TestDriftingReserves {
    ...
    uint public end_dift;
    uint public last_update_time;
    uint public fxs_virtual_reserves;
    uint public collat_virtual_reserves;
    uint public drift_fxs_positive;
    uint public drift_fxs_negative;
    uint public drift_collat_positive;
    uint public drift_collat_negative;
