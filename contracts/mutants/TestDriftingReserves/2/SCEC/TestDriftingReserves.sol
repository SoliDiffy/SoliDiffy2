...
contract TestDriftingReserves {
    ...
    function getVirtualReserves() public view returns (uint average_collat_virtual_reserves,uint current_fxs_virtual_reserves, uint current_collat_virtual_reserves, uint average_fxs_virtual_reserves) {
