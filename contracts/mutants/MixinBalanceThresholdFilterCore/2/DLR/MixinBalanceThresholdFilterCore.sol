    ...
    MixinExchangeCalldata
{
        ...
        external
    {
        ...
        address[] storage addressesToValidate = _getAddressesToValidate(signerAddress);
        ...
        LibZeroExTransaction.ZeroExTransaction storage transaction = LibZeroExTransaction.ZeroExTransaction({
            salt: salt,
