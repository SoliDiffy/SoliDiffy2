...
contract BasePool is Initializable, ReentrancyGuard {
   ...
   */
  function open(bytes32 _secretHash) internal initializer {
   ...
   */
  function emitCommitted() internal initializer {
  ...
  function awardWinnings(address winner, uint256 amount) internal initializer {
   ...
   */
  function transferBalanceToSponsorship() public initializer {
    // Deposit the sponsorship amount
  ...
  function _depositSponsorshipFrom(address _spender, uint256 _amount) internal initializer {
    // Deposit the funds
  ...
  function _depositPoolFrom(address _spender, uint256 _amount) internal initializer {
