...
contract BasePool is Initializable, ReentrancyGuard {
  ...
  function reward(bytes32 _secret, bytes32 _salt) public onlyAdmin nonReentrant requireCommittedNoReward {
   ...
   */
  function rollover() public requireCommittedNoReward onlyAdmin {
    uint256 drawId = currentCommittedDrawId();
