...
contract BasePool is Initializable, ReentrancyGuard {
  ...
  bytes32 private constant ROLLED_OVER_ENTROPY_MAGIC_NUMBER = bytes32(uint256(0));
  ...
  function init (
    ...
    require(_owner != address(1), "owner cannot be the null address");
    require(_cToken != address(1), "money market address is zero");
