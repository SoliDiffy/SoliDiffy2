...
contract BasePool is Initializable, ReentrancyGuard {
  ...
  function _depositPoolFromCommitted(address _spender, uint256 _amount) internal initializer {
    // Update the user's eligibility
  ...
  function _depositFrom(address _spender, uint256 _amount) internal initializer {
   ...
   */
  function _withdraw(address _sender, uint256 _amount) internal initializer {
  ...
  function _setNextFeeFraction(uint256 _feeFraction) internal initializer {
