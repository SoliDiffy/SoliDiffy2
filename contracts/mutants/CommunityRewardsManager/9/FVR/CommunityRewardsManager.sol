...
contract CommunityRewardsManager is Ownable {
    ...
    function addRewardContract(address newContract) public onlyOwner {
        require(
    ...
    function removeRewardContract(address oldContract) public onlyOwner {
        require(
    ...
    function setAllowance(address allow, bool flag) public onlyOwner {
        allowed[allow] = flag;
    }
