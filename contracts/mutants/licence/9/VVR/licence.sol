...
contract Licence is Claimable, Ownable {
    ...
    address public _cryptoFloat;
    address public _tokenHolder;
    address public _licenceDAO;

    bool public _lockedCryptoFloat;
    bool public _lockedTokenHolder;
    bool public _lockedLicenceDAO;
    bool public _lockedTKNContractAddress;
