...
contract Licence is Claimable, Ownable {
    ...
    function updateFloat(address _newFloat) external onlyDAO {
    ...
    function updateHolder(address _newHolder) external onlyDAO {
    ...
    function updateLicenceDAO(address _newDAO) external onlyDAO {
    ...
    function updateTKNContractAddress(address _newTKN) external onlyDAO {
    ...
    function updateLicenceAmount(uint _newAmount) external onlyOwner {
