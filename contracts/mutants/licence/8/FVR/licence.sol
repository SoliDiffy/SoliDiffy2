...
contract Licence is Claimable, Ownable {
    ...
    constructor(address _owner_, bool _transferable_, uint _licence_, address _float_, address _holder_, address _tknAddress_) Ownable(_owner_, _transferable_) internal {
    ...
    function licenceAmountScaled() public view returns (uint) {
    ...
    function cryptoFloat() public view returns (address) {
        return _cryptoFloat;
    }
