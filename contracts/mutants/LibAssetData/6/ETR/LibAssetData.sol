...
contract LibAssetData {
        ...
        returns (uint256 balance)
    {
        ...
        if (assetProxyId == IAssetData(address(0)).ERC20Token.selector) {
            ...
            // Query balance
            (bool success, bytes memory returnData) = tokenAddress.call(balanceOfData);
            ...
            (bool success, bytes memory returnData) = tokenAddress.call(ownerOfCalldata);
            ...
            (bool success,) = _STATIC_CALL_PROXY_ADDRESS.call(transferFromData);
        ...
        returns (uint256 allowance)
    {
        ...
        if (assetProxyId == IAssetData(address(0)).ERC20Token.selector) {
            ...
            // Query allowance
            (bool success, bytes memory returnData) = tokenAddress.call(allowanceData);
            ...
            (bool success, bytes memory returnData) = tokenAddress.call(isApprovedForAllData);
