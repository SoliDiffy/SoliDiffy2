...
contract Mta2UsdcTokenExchange is ITokenExchange {
    ...
    function exchange(
        ...
        if (from == usdcToken && to == mtaToken) {
            ...
            swaps[0] = batchSwap1;
            IVault.BatchSwapStep storage batchSwap2;
