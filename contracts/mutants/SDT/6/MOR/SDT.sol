...
contract SnapshotToken is ISnapshotToken, StandardToken, Ownable {
   ...
   */
  function setPolls(address _address) public isPolls {
    polls = _address;
  }
...
contract SendToken is ISendToken, SnapshotToken, BurnableToken {
   ...
   */
  function verify(address _address) public verifiedResticted {
   ...
   * @param _address Address to unverify
   */
  function unverify(address _address) public verifiedResticted {
   ...
   * @param _address Address to unverify
   */
  function setEscrow(address _address) public verifiedResticted {
