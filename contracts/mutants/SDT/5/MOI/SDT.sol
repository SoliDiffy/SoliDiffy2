...
contract SnapshotToken is ISnapshotToken, StandardToken, Ownable {
   ...
   * @param _value The amount to be transferred.
   */
  function transfer(address _to, uint256 _value) public isPolls returns (bool) {
   ...
   * @param _value uint256 the amount of tokens to be transferred
   */
  function transferFrom(address _from, address _to, uint256 _value) public isPolls returns (bool) {
    takeSnapshot(_from);
    takeSnapshot(_to);
   ...
   */
  function takeSnapshot(address _owner) public isPolls returns(uint256) {
