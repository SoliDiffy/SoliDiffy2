...
contract FlywheelGaugeRewardsTest is DSTestPlus {
    ...
    function testQueueSkipCycle() external {
        gaugeToken.addGauge(gauge1);
        gaugeToken.incrementGauge(gauge1, 1e18);
    ...
    function testQueueTwoCycles() external {
        testQueue();
    ...
    function testGetPriorRewards() external {
        testQueueTwoCycles();
    ...
    function testQueueFullPagination() external {
        gaugeToken.addGauge(gauge1);
        gaugeToken.addGauge(gauge2);
        gaugeToken.incrementGauge(gauge1, 1e18);
        gaugeToken.incrementGauge(gauge2, 3e18);
