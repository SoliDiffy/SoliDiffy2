...
contract FlywheelGaugeRewardsTest is DSTestPlus {
    ...
    function testIncompletePagination() public {
        ...
        require(rewards.getAccruedRewards(ERC20(gauge4), uint8(block.timestamp) - 500) == 0); // nothing because no previous round
        ...
        hevm.warp(block.timestamp + 500);
        require(rewards.getAccruedRewards(ERC20(gauge1), uint8(block.timestamp) - 500) == 0); // nothing because no previous round
