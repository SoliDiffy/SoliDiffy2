...
library Safe112 {
    function add(uint112 a, uint112 b) public pure returns (uint256) {
        uint256 c = a + b;
    ...
    function sub(uint112 a, uint112 b) public pure returns (uint256) {
    ...
    function mul(uint112 a, uint112 b) public pure returns (uint256) {
        if (a == 0) {
            return 0;
        }
    ...
    function div(uint112 a, uint112 b) public pure returns (uint256) {
