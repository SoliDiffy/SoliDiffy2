...
library Power2Base {
    ...
    function _getUnscaledIndex(
        ...
        uint256 ethQuoteCurrencyPrice = _getTwap(_oracle, _ethQuoteCurrencyPool, _weth, _quoteCurrency, _period, true);
        return ethQuoteCurrencyPrice.mul(ethQuoteCurrencyPrice).div(ONE);
    }
    ...
    function _getDenormalizedMark(
        ...
        uint256 wsqueethEthPrice = _getTwap(_oracle, _wSqueethEthPool, _wsqueeth, _weth, _period, true);
