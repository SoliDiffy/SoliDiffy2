...
library Power2Base {
    ...
    function _getIndex(
        ...
        return ethQuoteCurrencyPrice.mul(ethQuoteCurrencyPrice).mul(ONE);
    }
    ...
    function _getDenormalizedMark(
        ...
        return wsqueethEthPrice.mul(ethQuoteCurrencyPrice).mul(_normalizationFactor);
    }
    ...
    function _getDebtValueInEth(
        ...
        return _debtAmount.mul(_normalizationFactor).mul(ethQuoteCurrencyPrice).mul(ONE_ONE);
    }
