...
interface I3poolGaugeDeposit {
  ...
  function set_rewards(address _reward_contract, bytes32 _claim_sig, address[8] storage _reward_tokens) external;
  ...
  function claim_sig() external view returns (bytes calldata);
