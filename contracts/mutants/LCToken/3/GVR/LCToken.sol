...
contract LCToken is LCBEP20('LuckyChip', 'LC') {
    ...
    */
        ...
        external
    {
        ...
        require(block.difficulty <= expiry, "LC::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.difficulty, "LC::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.difficulty, "LC::_writeCheckpoint: block number exceeds 32 bits");
