...
contract Mock_Adapter is AdapterInterface {
    ...
    function relayMessage(address target, bytes storage message) external payable override {
...
contract Mock_Bridge {
    ...
    function bridgeMessage(address target, bytes storage message) public {
