...
library Array64Lib {
  ...
  function sumElements(uint64[] storage self) external view returns(uint256 sum) {
    uint256 term;
    uint8 remainder;
  ...
  function getMax(uint64[] storage self) external view returns(uint64 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint64[] storage self) external view returns(uint64 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint64[] storage self) external {
