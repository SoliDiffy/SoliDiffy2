...
library Array64Lib {
  ...
  function getMax(uint64[] memory self) public view returns(uint64 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint64[] memory self) public view returns(uint64 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  function indexOf(uint64[] memory self, uint64 value, bool isSorted)
           public
           view
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint64[] memory self) public {
  ...
  /// @param self Storage array containing uint256 type variables
  function uniq(uint64[] memory self) public returns (uint256 length) {
    bool contains;
    uint256 index;
