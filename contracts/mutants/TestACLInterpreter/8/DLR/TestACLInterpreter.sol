...
contract TestACLInterpreter is ACL, ACLHelper {
    ...
    function testNot() public {
        Param storage retTrue = Param(PARAM_VALUE_PARAM_ID, uint8(Op.RET), 1);
        Param storage retFalse = Param(PARAM_VALUE_PARAM_ID, uint8(Op.RET), 0);

        Param storage notOp = Param(LOGIC_OP_PARAM_ID, uint8(Op.NOT), encodeOperator(1, 0));
        Param[] storage params = new Param[](2);
    ...
    function testComplexCombination() public {
        ...
        Param[] storage params = new Param[](7);
