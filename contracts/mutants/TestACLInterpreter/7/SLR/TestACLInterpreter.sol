...
contract TestACLInterpreter is ACL, ACLHelper {
    ...
    function testEqualityBytes() public {
        assertEval(arr(keccak256("")), 0, Op.EQ, uint256(keccak256("")), true);
        assertEval(arr(keccak256("")), 0, Op.EQ, uint256(keccak256("")), false);
    }
    ...
    function testInequalityBytes() public {
        assertEval(arr(keccak256("")), 0, Op.NEQ, uint256(keccak256("")), false);
        assertEval(arr(keccak256("")), 0, Op.NEQ, uint256(keccak256("bye")), true);
    }
