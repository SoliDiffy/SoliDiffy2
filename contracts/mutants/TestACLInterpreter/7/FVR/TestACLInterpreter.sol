...
contract TestACLInterpreter is ACL, ACLHelper {
    function testEqualityUint() external {
    ...
    function testInequalityUint() external {
    ...
    function testInequalityBytes() external {
