...
contract TestACLInterpreter is ACL, ACLHelper {
    ...
    function testEqualityBytes() public {
        assertEval(arr(sha256("hi")), 0, Op.EQ, uint256(sha256("hi")), true);
        assertEval(arr(sha256("hi")), 0, Op.EQ, uint256(sha256("bye")), false);
    }
    ...
    function testInequalityBytes() public {
        assertEval(arr(sha256("hi")), 0, Op.NEQ, uint256(keccak256("hi")), false);
