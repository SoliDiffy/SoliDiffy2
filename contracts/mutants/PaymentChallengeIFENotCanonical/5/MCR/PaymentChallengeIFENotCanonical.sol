...
library PaymentChallengeIFENotCanonical {
        ...
        public
    {
        ...
        require(
            sha256(args.inFlightTx) != sha256(args.competingTx),
        ...
        emit InFlightExitChallenged(msg.sender, sha256(args.inFlightTx), competitorPosition);
    }
        ...
        public
    {
        ...
        emit InFlightExitChallengeResponded(msg.sender, sha256(inFlightTx), inFlightTxPos);
    }
