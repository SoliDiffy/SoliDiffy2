...
library PaymentChallengeIFENotCanonical {
    ...
    function challenge(
        ...
        PaymentInFlightExitRouterArgs.ChallengeCanonicityArgs storage args
    )
        public
    {
        ...
        UtxoPosLib.UtxoPos storage inputUtxoPos = UtxoPosLib.UtxoPos(args.inputUtxoPos);
        ...
        WireTransaction.Output storage output = WireTransaction.getOutput(args.inputTx, args.inFlightTxInputIndex);
