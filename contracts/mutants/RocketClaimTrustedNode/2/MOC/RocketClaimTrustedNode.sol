...
contract RocketClaimTrustedNode is RocketBase, RocketClaimTrustedNodeInterface {
    ...
    function register(address _trustedNodeAddress, bool _enable) override external onlyLatestContract("rocketClaimTrustedNode", address(this)) onlyTrustedNode(_trustedNodeAddress) onlyLatestContract("rocketDAONodeTrustedActions", msg.sender) {
        // Init the rewards pool contract
        RocketRewardsPoolInterface rewardsPool = RocketRewardsPoolInterface(getContractAddress("rocketRewardsPool"));
