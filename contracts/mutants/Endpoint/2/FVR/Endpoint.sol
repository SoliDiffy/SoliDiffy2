...
contract Endpoint is Ownable, ILayerZeroEndpoint {
    ...
    function newVersion(address _newLayerZeroLibraryAddress) public onlyOwner {
    ...
    function setDefaultSendVersion(uint16 _newDefaultSendVersion) public onlyOwner validVersion(_newDefaultSendVersion) {
