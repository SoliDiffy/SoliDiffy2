...
contract Endpoint is Ownable, ILayerZeroEndpoint {
    ...
    function setDefaultReceiveVersion(uint16 _newDefaultReceiveVersion) public onlyOwner validVersion(_newDefaultReceiveVersion) {
    ...
    function _getSendLibrary(LibraryConfig storage uaConfig) public view returns (ILayerZeroMessagingLibrary) {
