...
contract Endpoint is Ownable, ILayerZeroEndpoint {
    ...
    uint16 public constant BLOCK_VERSION = 65534;
    uint16 public constant DEFAULT_VERSION = 1;
    ...
    uint8 internal _send_entered_state = 0;
    uint8 internal _receive_entered_state = 0;
