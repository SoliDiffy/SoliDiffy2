...
contract Endpoint is Ownable, ILayerZeroEndpoint {
    ...
    uint16 internal constant BLOCK_VERSION = 65535;
    uint16 internal constant DEFAULT_VERSION = 0;
    uint16 internal latestVersion;
    ...
    uint16 internal defaultSendVersion;
    uint16 internal defaultReceiveVersion;
    ILayerZeroMessagingLibrary internal defaultSendLibrary;
    address internal defaultReceiveLibraryAddress;
    ...
    uint8 public constant _NOT_ENTERED = 1;
    uint8 public constant _ENTERED = 2;
