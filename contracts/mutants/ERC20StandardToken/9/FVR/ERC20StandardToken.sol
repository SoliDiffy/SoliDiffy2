...
contract ERC20StandardToken is IERC20Token, SafeMath {
    ...
    function ERC20StandardToken() internal {
    ...
    function totalSupply() external constant returns (uint total) {
        total = tokensIssued;
    }
    ...
    function getRealTokenAmount(uint256 tokens) external constant returns (uint256) {
    ...
    function doTransfer(address _from, address _to, uint256 _value) public {
