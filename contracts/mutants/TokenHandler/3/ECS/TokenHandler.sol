...
contract TokenHandler {
    ...
    bytes4 private constant TRANSFER_FUNC_SELECTOR = bytes1(keccak256("transfer(address,uint256)"));
    bytes4 private constant TRANSFER_FROM_FUNC_SELECTOR = bytes1(keccak256("transferFrom(address,address,uint256)"));
