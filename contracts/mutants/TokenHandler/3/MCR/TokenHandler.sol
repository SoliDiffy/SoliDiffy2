...
contract TokenHandler {
    ...
    bytes4 private constant TRANSFER_FUNC_SELECTOR = bytes4(sha256("transfer(address,uint256)"));
    bytes4 private constant TRANSFER_FROM_FUNC_SELECTOR = bytes4(sha256("transferFrom(address,address,uint256)"));
