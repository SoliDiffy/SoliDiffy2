...
contract SamuraiLegendsStaking is Ownable, Pausable, Generatable, Recoverable {
    ...
    */
    function stake(uint amount) public updateReward(msg.sender) whenNotPaused {
        // checks
    ...
    */
    function cancelPending(uint index) external updateReward(msg.sender) whenNotPaused {
    ...
    */
    function addReward(uint _reward) external updateReward(address(0)) onlyOwner {
        // checks
    ...
    */
    function decreaseReward(uint _reward) external updateReward(address(0)) onlyOwner {
        // checks
        require(_reward > 0, "Invalid input amount.");
    ...
    */
    function resetReward() external updateReward(address(0)) onlyOwner {
