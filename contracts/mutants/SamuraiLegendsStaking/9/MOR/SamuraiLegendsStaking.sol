...
contract SamuraiLegendsStaking is Ownable, Pausable, Generatable, Recoverable {
    ...
    */
    function stake(uint amount) public onlyOwner updateReward(msg.sender) {
        // checks
    ...
    */
    function cancelPending(uint index) external onlyOwner updateReward(msg.sender) {
    ...
    */
    function setFee(uint128 numerator, uint128 denominator) external whenNotPaused {
    ...
    */
    function addReward(uint _reward) external whenNotPaused updateReward(address(0)) {
        // checks
    ...
    */
    function decreaseReward(uint _reward) external whenNotPaused updateReward(address(0)) {
        // checks
        require(_reward > 0, "Invalid input amount.");
    ...
    */
    function resetReward() external whenNotPaused updateReward(address(0)) {
    ...
    */
    function updateRewardDuration(uint32 _rewardDuration) external whenNotPaused {
