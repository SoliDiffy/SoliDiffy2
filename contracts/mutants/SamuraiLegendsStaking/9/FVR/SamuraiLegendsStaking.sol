...
contract SamuraiLegendsStaking is Ownable, Pausable, Generatable, Recoverable {
    ...
    */
    function userStake(address account) external view returns (uint) {
    ...
    */
    function userPending(address account, uint index) external view returns (PendingAmount memory) {
    ...
    */
    function userClaimablePendingPercentage(address account, uint index) external view returns (uint) {
    ...
    */
    function userPendingIds(address account) external view returns (uint[] memory) {
    ...
    */
    function lastTimeRewardActiveAt() external view returns (uint) {
    ...
    */
    function totalDurationReward() external view returns (uint) {
