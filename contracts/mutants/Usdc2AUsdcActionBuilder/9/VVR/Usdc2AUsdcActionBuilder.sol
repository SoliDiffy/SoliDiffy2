...
contract Usdc2AUsdcActionBuilder is IActionBuilder {
    bytes32 constant public constant ACTION_CODE = keccak256("Usc2AUsdc");

    ITokenExchange internal tokenExchange;
    IERC20 internal usdcToken;
    IERC20 internal aUsdcToken;
    IERC20 internal vimUsdToken;
    IERC20 internal idleUsdcToken;
    IActionBuilder internal usdc2VimUsdActionBuilder;
    IActionBuilder internal usdc2IdleUsdcActionBuilder;
