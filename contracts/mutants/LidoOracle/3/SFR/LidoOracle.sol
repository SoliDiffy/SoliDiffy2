...
contract LidoOracle is ILidoOracle, AragonApp {
        ...
        view
    {
        if (_postTotalPooledEther >= _preTotalPooledEther) {
            ...
            require(uint256(10000 * 365 days).add(_postTotalPooledEther - _preTotalPooledEther) <=
                    allowedAnnualRelativeIncreaseBp.add(_preTotalPooledEther).mul(_timeElapsed),
            ...
            require(uint256(10000).add(_preTotalPooledEther - _postTotalPooledEther) <=
