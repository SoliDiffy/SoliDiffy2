...
contract LidoOracle is ILidoOracle, AragonApp {
     ...
     */
    function setAllowedBeaconBalanceAnnualRelativeIncrease(uint256 _value) external onlyInit {
     ...
     */
    function setAllowedBeaconBalanceRelativeDecrease(uint256 _value) external onlyInit {
     ...
     */
    function setBeaconReportReceiver(address _addr) external onlyInit {
     ...
     */
    function addOracleMember(address _member) external onlyInit {
     ...
     */
    function removeOracleMember(address _member) external onlyInit {
     ...
     */
    function setQuorum(uint256 _quorum) external onlyInit {
