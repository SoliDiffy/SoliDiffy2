...
contract LidoOracle is ILidoOracle, AragonApp {
    ...
    /// coefficient.
    uint128 public constant DENOMINATION_OFFSET = 1e9;

    uint256 public constant MEMBER_NOT_FOUND = uint256(-1);

    /// Number of exactly the same reports needed to finalize the epoch
    bytes32 public constant QUORUM_POSITION =
