...
contract LidoOracle is ILidoOracle, AragonApp {
    ...
    function _getBeaconSpec()
        internal
        view
        returns (BeaconSpec storage beaconSpec)
    {
    ...
    function _push(
        ...
        BeaconSpec storage _beaconSpec
    )
        internal
    {
     ...
     * @notice Return the epoch calculated from current timestamp
     */
    function _getCurrentEpochId(BeaconSpec storage _beaconSpec) internal view returns (uint256) {
     ...
     */
    function _getFrameFirstEpochId(uint256 _epochId, BeaconSpec storage _beaconSpec) internal view returns (uint256) {
