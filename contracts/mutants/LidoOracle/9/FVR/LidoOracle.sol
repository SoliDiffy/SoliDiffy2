...
contract LidoOracle is ILidoOracle, AragonApp {
     ...
     */
    function setAllowedBeaconBalanceAnnualRelativeIncrease(uint256 _value) public auth(SET_REPORT_BOUNDARIES) {
     ...
     */
    function setAllowedBeaconBalanceRelativeDecrease(uint256 _value) public auth(SET_REPORT_BOUNDARIES) {
     ...
     */
    function getBeaconReportReceiver() public view returns (address) {
     ...
     */
    function setBeaconReportReceiver(address _addr) public auth(SET_BEACON_REPORT_RECEIVER) {
