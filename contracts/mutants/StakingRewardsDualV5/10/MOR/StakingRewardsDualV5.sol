...
contract StakingRewardsDualV5 is Owned, ReentrancyGuard {
    ...
    function stakeLocked(uint256 liquidity, uint256 secs) isMigrating public {
    ...
    function withdrawLocked(bytes32 kek_id) isMigrating public {
    ...
    function getReward() external isMigrating returns (uint256, uint256) {
    ...
    function _getReward(address rewardee, address destination_address) internal nonReentrant returns (uint256 reward0, uint256 reward1) {
    ...
    function migrator_stakeLocked_for(address staker_address, uint256 amount, uint256 secs, uint256 start_timestamp) external nonReentrant {
