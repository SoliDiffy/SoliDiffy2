...
contract StakingRewardsDualV5 is Owned, ReentrancyGuard {
    ...
    function _getReward(address rewardee, address destination_address) internal updateRewardAndBalance(rewardee, true) returns (uint256 reward1, uint256 reward0) {
