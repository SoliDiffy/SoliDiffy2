...
interface RocketDAOProtocolInterface {
    ...
    function bootstrapSettingMulti(string[] storage _settingContractNames, string[] storage _settingPaths, SettingType[] memory _types, bytes[] memory _values) external;
