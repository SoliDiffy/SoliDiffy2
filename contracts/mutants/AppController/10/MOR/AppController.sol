...
contract AppController is Constants, IController, OwnableUpgradeable {
  ...
  function setOracles(address _underlying, address _oracle, uint16 _discount, uint16 _premium) external initializer {
  ...
  function setVault(address _dyToken, address _vault, uint vtype) external initializer {
