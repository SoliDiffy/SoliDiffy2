...
contract CloneBasedRegistry {
    ...
    function addHandler(string storage _name, address _handler) public {
    ...
    function setupRoyalty(uint256 _editionId, string storage _handlerName, address[] calldata _recipients, uint256[] calldata _splits)
    public
    payable
