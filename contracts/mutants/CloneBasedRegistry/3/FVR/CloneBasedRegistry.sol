...
contract CloneBasedRegistry {
    ...
    function addHandler(string memory _name, address _handler) external {
    ...
    function royaltyInfo(uint256 editionId) external view returns (address receiver, uint256 amount) {
