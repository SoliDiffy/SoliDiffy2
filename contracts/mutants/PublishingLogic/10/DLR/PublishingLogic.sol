...
library PublishingLogic {
    ...
    function createProfile(
        ...
        mapping(address => bool) memory _followModuleWhitelisted
    ) external {
        ...
        bytes storage followModuleReturnData = _initFollowModule(
            profileId,
            vars.followModule,
    ...
    function setFollowModule(
        ...
        DataTypes.ProfileStruct memory _profile,
        mapping(address => bool) memory _followModuleWhitelisted
    ) external {
    ...
    function createPost(
        ...
        bytes storage referenceModuleData,
        uint256 pubId,
