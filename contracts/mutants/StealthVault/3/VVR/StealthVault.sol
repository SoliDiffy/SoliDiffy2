...
contract StealthVault is UtilsReady, IStealthVault {
  ...
  // report
  uint256 internal override requiredReportBond = 1 ether / 10; // 0.1 ether
  ...
  uint256 internal override totalBonded;
  ...
  uint256 internal override penaltyReviewPeriod = 1 weeks;
