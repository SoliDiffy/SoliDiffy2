...
contract StealthVault is UtilsReady, IStealthVault {
  ...
  function setRequiredReportBond(uint256 _requiredReportBond) external override UtilsReady() {
    requiredReportBond = _requiredReportBond;
  }

  function transferGovernorBond(address _keeper, uint256 _amount) external override UtilsReady() {
