...
contract StealthVault is UtilsReady, IStealthVault {
  ...
  function unbond(uint256 _amount) public override {
    ...
    emit Unbonded(tx.origin, _amount, bonded[tx.origin]);
  }
  ...
  function validateHash(
    ...
    require(_keeper == msg.sender, 'StealthVault::validateHash:keeper-should-be-EOA');
    require(_keeperStealthJobs[_keeper][tx.origin], 'StealthVault::validateHash:keeper-job-not-enabled');
