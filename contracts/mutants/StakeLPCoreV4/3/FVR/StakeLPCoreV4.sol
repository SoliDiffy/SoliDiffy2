...
contract StakeLPCoreV4 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     */
    function calculatePendingRewardsAndLiquidity(address lpToken, address to) external view returns (uint256 liquidity, uint256 reward, uint256 updatedSupplyLPTimeshare){
     ...
     */
    function calculateRewardsAndLiquidity(address lpToken, uint256 amount) public whenNotPaused returns (uint256 liquidity, uint256 reward){
