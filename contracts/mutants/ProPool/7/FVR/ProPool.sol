...
contract ProPool is IERC223Receiver {
     ...
     * @dev Redirect to pool library.
     */
    function deposit(uint groupIndex) public payable {
     ...
     * @dev Redirect to pool library.
     */
    function modifyWhitelist(uint groupIndex, address[] include, address[] exclude) public {
     ...
     * @dev Redirect to pool library.
     */
    function payToPresale(address presaleAddress, uint minPoolBalance, bool feeToToken, bytes data) public {
     ...
     * @dev Redirect to pool library.
     */
    function lockPresaleAddress(address presaleAddress, bool lock) public {
