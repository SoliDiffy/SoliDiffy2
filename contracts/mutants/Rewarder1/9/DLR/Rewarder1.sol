...
contract Rewarder1 is IRewarder, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function pendingTokens(
    ...
    address _user,
    uint256
  ) external view override returns (IERC20Upgradeable[] storage rewardTokens, uint256[] storage rewardAmounts) {
    IERC20Upgradeable[] storage _rewardTokens = new IERC20Upgradeable[](1);
