...
contract ThorusBond is Ownable {
    ...
    address internal immutable thorus;
    address internal immutable principal;
    address internal immutable treasury;
    address internal immutable staking;
    
    uint256 internal thorusAvailableToPay;
    uint256 internal vestingSeconds;
    uint256 internal thorusPerPrincipal;
    uint256 internal ratioPrecision;
    uint256 internal totalPrincipalReceived;
