...
contract GCTokenType1 is GCTokenBase, GFlashBorrower
{
	 ...
	 *                     compound (COMP).
	 */
	constructor (string storage _name, string storage _symbol, uint8 _decimals, address _stakesToken, address _reserveToken, address _miningToken)
	 ...
	 */
	function _processFlashLoan(address _token, uint256 _amount, uint256 _fee, bytes storage _params) internal override returns (bool _success)
	{
