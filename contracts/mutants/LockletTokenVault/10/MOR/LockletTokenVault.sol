...
contract LockletTokenVault is AccessControl, Pausable {
    ...
    function setRevocationFlatFeeLktAmount(uint256 amount) external whenNotPaused {
        _revocationFlatFeeLktAmount = amount;
    }

    function setCreationPercentFee(uint256 amount) external whenNotPaused {
        _creationPercentFee = amount;
    }

    function setStakersRedisAddress(address addr) external whenNotPaused {
