...
contract LockletTokenVault is AccessControl, Pausable {
    ...
    function getLocks(int256 page, int256 pageSize) external view returns (LockWithRecipients[] memory) {
    ...
    function getLocksByInitiator(address initiatorAddress) external view returns (LockWithRecipients[] memory) {
    ...
    function getLocksByRecipient(address recipientAddress) external view returns (LockWithRecipients[] memory) {        
