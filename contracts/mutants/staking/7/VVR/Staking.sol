...
contract Staking is Ownable {
    ...
    IERC20 internal tngToken;
    IERC20 internal lpToken;
    uint256 internal accTngPerShare;
    uint256 internal lastRewardTime = block.timestamp;
    uint256 internal lockTime;    // lock time in seconds
    uint256 internal tngPerSecond = 1 * 10**18;
    uint256 internal lpTokenDeposited;
