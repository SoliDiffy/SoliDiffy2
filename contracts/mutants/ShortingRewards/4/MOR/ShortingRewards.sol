...
contract ShortingRewards is IShortingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable, MixinResolver {
    ...
    function enrol(address account, uint256 amount) external onlyRewardsDistribution nonReentrant notPaused updateReward(account) {
    ...
    function withdraw(address account, uint256 amount) external notPaused nonReentrant updateReward(account) {
    ...
    function getReward(address account) external onlyShortContract updateReward(account) {
    ...
    function notifyRewardAmount(uint256 reward) external onlyShortContract updateReward(address(0)) {
