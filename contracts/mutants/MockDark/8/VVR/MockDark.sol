...
contract MorkDarkCrypto is ERC20Burnable, Operator {
    ...
    address internal taxOffice;

    // Current tax rate
    uint256 internal taxRate;
    // Price threshold below which taxes will get burned
    uint256 internal burnThreshold = 1.10e18;
    // Address of the tax collector wallet
    address internal taxCollectorAddress;

    // Should the taxes be calculated using the tax tiers
    bool internal autoCalculateTax;

    // Tax Tiers
    uint256[] internal taxTiersTwaps = [0, 5e17, 6e17, 7e17, 8e17, 9e17, 9.5e17, 1e18, 1.05e18, 1.10e18, 1.20e18, 1.30e18, 1.40e18, 1.50e18];
    uint256[] internal taxTiersRates = [2000, 1900, 1800, 1700, 1600, 1500, 1500, 1500, 1500, 1400, 900, 400, 200, 100];
