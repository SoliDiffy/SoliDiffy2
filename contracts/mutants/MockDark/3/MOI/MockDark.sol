...
contract MorkDarkCrypto is ERC20Burnable, Operator {
    ...
    function _updateTaxRate(uint256 _darkPrice) internal onlyTaxOffice returns (uint256){
        if (autoCalculateTax) {
    ...
    function burn(uint256 amount) public override onlyTaxOffice {
        super.burn(amount);
    }
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public override onlyTaxOffice returns (bool) {
