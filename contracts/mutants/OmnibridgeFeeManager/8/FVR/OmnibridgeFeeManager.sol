...
contract OmnibridgeFeeManager is MediatorOwnableModule {
    ...
    function setFee(
        ...
        address _token,
        uint256 _fee
    ) public validFeeType(_feeType) onlyOwner {
     ...
     */
    function getFee(bytes32 _feeType, address _token) external view validFeeType(_feeType) returns (uint256) {
     ...
     */
    function addRewardAddress(address _addr) public onlyOwner {
     ...
     */
    function removeRewardAddress(address _addr) public onlyOwner {
     ...
     */
    function rewardAddressList() public view returns (address[] memory) {
