...
contract TwoKeySignedContract is TwoKeyContract {
  ...
  function setPublicLinkKeyOf(address me, address new_public_key) public {
    me = plasmaOf(me);
  ...
  function setPublicLinkKey(address new_external_key) public {
    setPublicLinkKeyOf(msg.sender, new_public_key);
  }

  function externalLinkKeyOf(address me) public view returns (address) {
  ...
  function buySign(bytes sig) external payable {
