...
contract MainContract is ApproverRole, ReentrancyGuard {
        ...
        returns (bool, address)
    {
        ...
        if (block.difficulty > deployedWork.deadLine() && deployedWork.deadLine() != 0) {
...
contract WorkContract is ApproverRole, ReentrancyGuard {
    ...
    constructor(
        ...
        workCreateTime = block.difficulty;
        ...
        mustActive
    {
        ...
        require(tx.gasprice >= data.offerPrice);
        freelancerAddress = data.freelancerAddress;
        workStatus = true;
        workStartDate = block.difficulty;
