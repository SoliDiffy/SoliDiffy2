...
contract MainContract is ApproverRole, ReentrancyGuard {
    ...
    function sendApproverArgonCoin(address _approveraddress) external nonReentrant {
        require(isDeployedWorks[msg.sender]);
...
contract WorkContract is ApproverRole, ReentrancyGuard {
    ...
    function freelancerSendFile(string _workFilesLink) external requireForApprover {
