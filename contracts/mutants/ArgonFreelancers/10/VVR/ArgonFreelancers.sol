...
contract ApproverRole {
    ...
    Roles.Role public _approvers;

    address public firstSignAddress;
    address public secondSignAddress;
...
contract MainContract is ApproverRole, ReentrancyGuard {
    ...
    uint8 internal bnbFeeRate;
    uint256 internal remainingArgonToken;
    uint256 internal approverMinArgonLimit;
    address[] internal deployedWorks;
