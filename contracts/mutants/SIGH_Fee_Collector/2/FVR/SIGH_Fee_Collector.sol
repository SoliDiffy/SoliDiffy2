...
//    #################################################
    ...
    function transferInstrumentBalance(IERC20 tokenAddress, address destination, uint amount) public onlySIGHFinanceManager returns (bool) {
...
//    ############################
    ...
    function getInstrumentBalance(IERC20 tokenAddress) public returns (uint) {
