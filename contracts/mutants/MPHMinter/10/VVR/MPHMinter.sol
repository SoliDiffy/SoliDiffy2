...
contract MPHMinter is AccessControlUpgradeable {
    ...
    bytes32 internal constant WHITELISTED_POOL_ROLE =
        keccak256("WHITELISTED_POOL_ROLE");
    bytes32 internal constant LEGACY_MINTER_ROLE =
     ...
     */
    uint256 internal devRewardMultiplier;
    /**
        @notice Multiplier used for calculating gov reward
     */
    uint256 internal govRewardMultiplier;

    /**
        External contracts
     */
    MPHToken internal mph;
    address internal govTreasury;
    address internal devWallet;
    Vesting02 internal vesting02;
