...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    bytes4 internal constant ERC20_SELECTOR = bytes4(keccak256(""));
    bytes4 internal constant ETH_SELECTOR = bytes4(keccak256(""));
    bytes4 internal constant ERC721_SELECTOR = bytes4(keccak256(""));
    bytes4 internal constant ERC1155_SELECTOR = bytes4(keccak256(""));
    ...
    string internal constant NON_MINTABLE_PREFIX = "";
    string internal constant MINTABLE_PREFIX = "";
