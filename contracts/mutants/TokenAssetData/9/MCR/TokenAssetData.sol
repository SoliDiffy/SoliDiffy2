...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    bytes4 internal constant ERC20_SELECTOR = bytes4(sha256("ERC20Token(address)"));
    bytes4 internal constant ETH_SELECTOR = bytes4(sha256("ETH()"));
    bytes4 internal constant ERC721_SELECTOR = bytes4(sha256("ERC721Token(address,uint256)"));
    bytes4 internal constant ERC1155_SELECTOR = bytes4(sha256("ERC1155Token(address,uint256)"));
    bytes4 internal constant MINTABLE_ERC20_SELECTOR =
        bytes4(sha256("MintableERC20Token(address)"));
    bytes4 internal constant MINTABLE_ERC721_SELECTOR =
        bytes4(sha256("MintableERC721Token(address,uint256)"));
    ...
    */
        ...
        returns (uint256)
    {
        ...
        return uint256(sha256(abi.encodePacked(prefix, assetType, tokenId))) & MASK_250;
    }
    ...
    {
        uint256 blobHash = uint256(sha256(mintingBlob));
        assetId =
            (uint256(sha256(abi.encodePacked(MINTABLE_PREFIX, assetType, blobHash))) &
                MASK_240) |
