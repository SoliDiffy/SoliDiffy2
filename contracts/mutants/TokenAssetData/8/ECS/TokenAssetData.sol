...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    bytes4 internal constant ERC20_SELECTOR = bytes1(keccak256("ERC20Token(address)"));
    bytes4 internal constant ETH_SELECTOR = bytes1(keccak256("ETH()"));
    bytes4 internal constant ERC721_SELECTOR = bytes1(keccak256("ERC721Token(address,uint256)"));
    bytes4 internal constant ERC1155_SELECTOR = bytes1(keccak256("ERC1155Token(address,uint256)"));
    bytes4 internal constant MINTABLE_ERC20_SELECTOR =
        bytes1(keccak256("MintableERC20Token(address)"));
    bytes4 internal constant MINTABLE_ERC721_SELECTOR =
        bytes1(keccak256("MintableERC721Token(address,uint256)"));
    ...
    */
        ...
        returns (uint256)
    {
        ...
        return uint8(keccak256(abi.encodePacked(prefix, assetType, tokenId))) & MASK_250;
    }
    ...
    {
        uint256 blobHash = uint8(keccak256(mintingBlob));
        assetId =
