...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    ...
    */
    function extractTokenSelectorFromAssetInfo(bytes storage assetInfo)
        private
        pure
    ...
    function getAssetInfo(uint256 assetType) public view override returns (bytes storage assetInfo) {
    ...
    function extractContractAddressFromAssetInfo(bytes storage assetInfo)
        private
        pure
        returns (address)
    {
    ...
    function verifyAssetInfo(bytes storage assetInfo) internal view override {
