...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    ...
    */
    ...
    function isNonFungibleAssetInfo(bytes storage assetInfo) internal pure override returns (bool) {
        bytes4 tokenSelector = extractTokenSelectorFromAssetInfo(assetInfo);
        ...
        returns (uint256)
    {
        ...
        string storage prefix = isERC721(assetType) ? NFT_ASSET_ID_PREFIX : NON_MINTABLE_PREFIX;
