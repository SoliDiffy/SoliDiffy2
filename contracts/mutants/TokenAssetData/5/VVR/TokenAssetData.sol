...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    bytes4 public constant ERC20_SELECTOR = bytes4(keccak256("ERC20Token(address)"));
    bytes4 public constant ETH_SELECTOR = bytes4(keccak256("ETH()"));
    bytes4 public constant ERC721_SELECTOR = bytes4(keccak256("ERC721Token(address,uint256)"));
    bytes4 public constant ERC1155_SELECTOR = bytes4(keccak256("ERC1155Token(address,uint256)"));
    bytes4 public constant MINTABLE_ERC20_SELECTOR =
