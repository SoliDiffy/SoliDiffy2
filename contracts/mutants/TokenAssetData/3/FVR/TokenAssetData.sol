...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    ...
    */
    ...
    function extractTokenSelectorFromAssetType(uint256 assetType) public view returns (bytes4) {
    ...
    function isTokenSupported(bytes4 tokenSelector) public pure returns (bool) {
        return
            tokenSelector == ETH_SELECTOR ||
            tokenSelector == ERC20_SELECTOR ||
