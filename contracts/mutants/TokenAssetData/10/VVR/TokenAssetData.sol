...
contract TokenAssetData is MainStorage, LibConstants, MTokenAssetData {
    ...
    bytes4 public constant MINTABLE_ERC721_SELECTOR =
        bytes4(keccak256("MintableERC721Token(address,uint256)"));

    // The selector follows the 0x20 bytes assetInfo.length field.
    uint256 public constant SELECTOR_OFFSET = 0x20;
    uint256 public constant SELECTOR_SIZE = 4;
    uint256 public constant TOKEN_CONTRACT_ADDRESS_OFFSET = SELECTOR_OFFSET + SELECTOR_SIZE;
    string public constant NFT_ASSET_ID_PREFIX = "NFT:";
