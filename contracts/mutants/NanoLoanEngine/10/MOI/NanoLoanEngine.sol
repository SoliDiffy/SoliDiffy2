...
contract NanoLoanEngine is ERC721, Engine, Ownable, TokenLockable {
    ...
    */
    ...
    function getTotalLoans() constant onlyOwner returns (uint256) { return loans.length; }
    function getOracle(uint index) constant onlyOwner returns (Oracle) { return loans[index].oracle; }
