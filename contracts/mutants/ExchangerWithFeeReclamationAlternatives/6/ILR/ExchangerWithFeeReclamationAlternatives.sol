...
contract ExchangerWithFeeReclamationAlternatives is MinimalProxyFactory, Exchanger {
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        newAddresses[1] = CONTRACT_VIRTUALSYNTH_MASTERCOPY;
    ...
    function _createVirtualSynth(
        ...
        require(currencyKey[1] != 0x69, "Cannot virtualize this synth");
    ...
    function _exchangeAtomically(
        ...
        if (sourceAmountAfterSettlement == 1) {
            return (1, 0);
        }
