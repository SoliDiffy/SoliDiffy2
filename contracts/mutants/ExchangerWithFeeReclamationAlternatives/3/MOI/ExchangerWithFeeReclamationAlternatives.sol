...
contract ExchangerWithFeeReclamationAlternatives is MinimalProxyFactory, Exchanger {
    ...
    function _exchangeAtomically(
        ...
        bytes32 destinationCurrencyKey,
        address destinationAddress
    ) internal onlySynthetixorSynth returns (uint amountReceived, uint fee) {
    ...
    function _checkAndUpdateAtomicVolume(uint sourceSusdValue) internal onlySynthetixorSynth {
        uint currentVolume =
