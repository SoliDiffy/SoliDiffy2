...
contract DODOZoo is Ownable {
    ...
    function isDODORegistered(address baseToken, address quoteToken) external view returns (bool) {
        if (
    ...
    function getDODO(address baseToken, address quoteToken) public view returns (address) {
