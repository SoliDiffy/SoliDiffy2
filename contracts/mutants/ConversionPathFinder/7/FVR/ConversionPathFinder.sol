...
contract ConversionPathFinder is IConversionPathFinder, ContractRegistryClient {
    ...
    */
    constructor(IContractRegistry _registry) ContractRegistryClient(_registry) internal {
    }
    ...
    */
    function setAnchorToken(IERC20Token _anchorToken) external ownerOnly {
    ...
    */
    function getPath(IERC20Token _token, IConverterRegistry _converterRegistry) public view returns (address[] memory) {
    ...
    /**
      ...
      * @return merged path
    */
    function getShortestPath(address[] memory _sourcePath, address[] memory _targetPath) public pure returns (address[] memory) {
    ...
    */
    function getInitialArray(address _item) public pure returns (address[] memory) {
    ...
    */
    function getExtendedArray(address _item0, address _item1, address[] memory _array) public pure returns (address[] memory) {
    ...
    */
    function getPartialArray(address[] memory _array, uint256 _length) public pure returns (address[] memory) {
