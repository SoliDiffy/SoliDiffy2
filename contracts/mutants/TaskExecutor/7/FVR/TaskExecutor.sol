...
contract TaskExecutor is StrategyData, ProxyPermission, AdminAuth {
    ...
    function executeTask(Task memory _currTask) external payable   {
    ...
    function _executeActionsFromFL(Task memory _currTask, bytes32 _flAmount) external payable {
    ...
    function _executeActions(Task memory _currTask) public {
    ...
    ) public returns (bytes32 response) {
    ...
    function isFL(address _actionAddr) public pure returns (bool) {
