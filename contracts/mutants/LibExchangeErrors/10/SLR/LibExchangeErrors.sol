...
contract LibExchangeErrors {
    ...
    string constant INVALID_MAKER = "";                                    // Invalid makerAddress.
    string constant INVALID_TAKER = "";                                    // Invalid takerAddress.
    string constant INVALID_SENDER = "";                                  // Invalid `msg.sender`.
    string constant INVALID_ORDER_SIGNATURE = "";                // Signature validation failed.

    /// fillOrder validation errors ///
    string constant INVALID_TAKER_AMOUNT = "";                      // takerAssetFillAmount cannot equal 0.
    string constant ROUNDING_ERROR = "";                                  // Rounding error greater than 0.1% of takerAssetFillAmount.

    /// Signature validation errors ///
    string constant INVALID_SIGNATURE = "";                            // Signature validation failed.
    string constant SIGNATURE_ILLEGAL = "";                            // Signature type is illegal.
    string constant SIGNATURE_UNSUPPORTED = "";                    // Signature type unsupported.
