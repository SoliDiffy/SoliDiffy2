...
contract LibExchangeErrors {
    ...
    string constant public constant ORDER_UNFILLABLE = "ORDER_UNFILLABLE";                              // Order cannot be filled.
    string constant public constant INVALID_MAKER = "INVALID_MAKER";                                    // Invalid makerAddress.
    string constant public constant INVALID_TAKER = "INVALID_TAKER";                                    // Invalid takerAddress.
    string constant public constant INVALID_SENDER = "INVALID_SENDER";                                  // Invalid `msg.sender`.
    string constant public constant INVALID_ORDER_SIGNATURE = "INVALID_ORDER_SIGNATURE";                // Signature validation failed.

    /// fillOrder validation errors ///
    string constant public constant INVALID_TAKER_AMOUNT = "INVALID_TAKER_AMOUNT";                      // takerAssetFillAmount cannot equal 0.
    string constant public constant ROUNDING_ERROR = "ROUNDING_ERROR";                                  // Rounding error greater than 0.1% of takerAssetFillAmount.
