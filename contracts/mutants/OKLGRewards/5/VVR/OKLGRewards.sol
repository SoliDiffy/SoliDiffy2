...
contract OKLGRewards is OKLGWithdrawable {
  ...
  IOKLG public _oklg = IOKLG(0x5f67df361f568e185aA0304A57bdE4b8028d059E);

  uint256 internal rewardsClaimTimeSeconds = 60 * 60 * 12; // 12 hours
  mapping(address => uint256) private _rewardsLastClaim;

  uint256 internal boostRewardsPercent = 50;
  address internal boostRewardsMultiplierContract;
