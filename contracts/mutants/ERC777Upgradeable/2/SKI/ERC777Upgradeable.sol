...
contract ERC777Upgradeable is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable {
    ...
    function operatorSend(
        ...
        require(super.isOperatorFor(_msgSender(), sender), "ERC777: caller is not an operator for holder");
    ...
    function operatorBurn(
        ...
        require(super.isOperatorFor(_msgSender(), account), "ERC777: caller is not an operator for holder");
