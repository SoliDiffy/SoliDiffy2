...
contract ERC777Upgradeable is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable {
     ...
     * Also emits a {IERC20-Transfer} event for ERC20 compatibility.
     */
    function burn(uint256 amount, bytes memory data) public virtual override onlyInitializing {
     ...
     */
    function authorizeOperator(address operator) public virtual override onlyInitializing {
     ...
     */
    function revokeOperator(address operator) public virtual override onlyInitializing {
     ...
     */
    function approve(address spender, uint256 value) public virtual override onlyInitializing returns (bool) {
