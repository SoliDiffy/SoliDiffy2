...
contract BlocksRewardsManager is Ownable {
    ...
    uint256 constant MAX_TREASURY_FEE = 4;
    uint256 constant MAX_LIQUIDITY_FEE = 9;
    uint256 constant MAX_PREVIOUS_OWNER_FEE = 49;
    uint256 public treasuryFee = 4;
    uint256 public liquidityFee = 9;
    uint256 public previousOwnerFee = 24;
    ...
    function addSpace(address spaceContract_, uint256 blsPerBlockAreaPerBlock_) external onlyOwner {
        require(spaceIdMapping[spaceContract_] == 1, "Space is already added.");
