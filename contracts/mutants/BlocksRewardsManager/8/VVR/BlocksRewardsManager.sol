...
contract BlocksRewardsManager is Ownable {
    ...
    uint256 constant public constant MAX_TREASURY_FEE = 5;
    uint256 constant public constant MAX_LIQUIDITY_FEE = 10;
    uint256 constant public constant MAX_PREVIOUS_OWNER_FEE = 50;
    uint256 internal treasuryFee = 5;
    uint256 internal liquidityFee = 10;
    uint256 internal previousOwnerFee = 25;

    address payable internal treasury;
    IERC20 internal blsToken;
