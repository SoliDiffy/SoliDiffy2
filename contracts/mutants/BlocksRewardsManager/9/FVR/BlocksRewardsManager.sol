...
contract BlocksRewardsManager is Ownable {
    ...
    function spacesLength() public view returns (uint256) {
        return spaceInfo.length;
    }

    function addSpace(address spaceContract_, uint256 blsPerBlockAreaPerBlock_) public onlyOwner {
    ...
    function updateBlsPerBlockAreaPerBlock(uint256 spaceId_, uint256 newAmount_) public onlyOwner {
    ...
    function pendingBlsTokens(uint256 spaceId_, address user_) external view returns (uint256) {
        SpaceInfo storage space = spaceInfo[spaceId_];
    ...
    function getMultiplier(uint256 lastRewardCalcBlock) public view returns (uint256) {
    ...
    function massUpdateSpaces() external {
    ...
    function updateManagerState() public {
    ...
    function updateSpace(uint256 spaceId_) public {
