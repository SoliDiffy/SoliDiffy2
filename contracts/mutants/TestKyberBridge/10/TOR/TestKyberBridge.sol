...
contract TestToken {
    ...
    constructor(uint8 decimals_) public {
        decimals = decimals_;
        _testContract = ITestContract(tx.origin);
    }
    ...
    function withdraw(uint256 amount)
        external
    {
        return _testContract.wethWithdraw(tx.origin, amount);
    }
    ...
    function deposit()
        ...
        payable
    {
        return _testContract.wethDeposit.value(msg.value)(tx.origin);
    }
    ...
    IKyberNetworkProxy
{
    ...
    function wethDeposit(
        ...
        payable
    {
        require(tx.origin == address(weth), "ONLY_WETH");
    ...
    function tokenTransfer(
        ...
        returns (bool success)
    {
        _tokenBalances[tx.origin][ownerAddress] -= amount;
        _tokenBalances[tx.origin][recipientAddress] += amount;
