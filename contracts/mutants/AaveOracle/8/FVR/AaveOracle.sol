...
contract AaveOracle is IPriceOracleGetter {
   ...
   * @param fallbackOracle The address of the fallback oracle
   */
  function setFallbackOracle(address fallbackOracle) public onlyAssetListingOrPoolAdmins {
    _setFallbackOracle(fallbackOracle);
  }
   ...
   * @param sources The address of the source of each asset
   */
  function _setAssetsSources(address[] memory assets, address[] memory sources) public {
   ...
   * @param fallbackOracle The address of the fallback oracle
   */
  function _setFallbackOracle(address fallbackOracle) public {
   ...
   */
  function getAssetsPrices(address[] calldata assets) public view returns (uint256[] memory) {
  ...
  function _onlyAssetListingOrPoolAdmins() public view {
