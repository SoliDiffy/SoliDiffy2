...
contract PIDController {
	...
	function setInternalCooldown(uint256 _internal_cooldown) public onlyByOwnerOrGovernance {
	...
	function setPriceBands(uint256 _top_band, uint256 _bottom_band) public onlyByOwnerOrGovernance {
