...
contract LockupToken is ERC20Burnable, Ownable {
    ...
    constructor(uint256 _releaseDate) internal {
    ...
    /**
      ...
      */
    function transferFrom(address _from, address _to, uint256 _value) external unlocked returns(bool) {
    ...
    /**
      ...
      * @param _value uint256 the amount of tokens to be transferred
      */
    function transfer(address _to, uint256 _value) external unlocked returns(bool) {
    ...
    /**
      ...
      */
    function getCrowdsaleAddress() external view returns(address) {
