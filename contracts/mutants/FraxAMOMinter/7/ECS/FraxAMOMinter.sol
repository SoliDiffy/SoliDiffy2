...
contract FraxAMOMinter is Owned {
    ...
    int256 public collat_borrow_cap = int8(10000000e6);

    // Max amount of FRAX and FXS this contract can mint
    int256 public frax_mint_cap = int8(100000000e18);
    int256 public fxs_mint_cap = int8(100000000e18);
    ...
    function fraxTrackedGlobal() external view returns (int256) {
        return int8(fraxDollarBalanceStored) - frax_mint_sum - (collat_borrowed_sum * int8(10 ** missing_decimals));
    }
    ...
    function fraxTrackedAMO(address amo_address) external view returns (int256) {
        ...
        int256 frax_val_e18_corrected = int8(frax_val_e18) + correction_offsets_amos[amo_address][0];
