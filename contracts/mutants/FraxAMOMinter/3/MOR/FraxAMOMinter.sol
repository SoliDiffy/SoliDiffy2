...
contract FraxAMOMinter is Owned {
    ...
    function burnFraxFromAMO(uint256 frax_amount) external onlyByOwnGov {
        int256 frax_amt_i256 = int256(frax_amount);
    ...
    function burnFxsFromAMO(uint256 fxs_amount) external onlyByOwnGov {
        int256 fxs_amt_i256 = int256(fxs_amount);
    ...
    function receiveCollatFromAMO(uint256 usdc_amount) external onlyByOwnGov {
