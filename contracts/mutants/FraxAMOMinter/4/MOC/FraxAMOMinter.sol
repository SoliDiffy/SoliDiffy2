...
contract FraxAMOMinter is Owned {
    ...
    function oldPoolCollectAndGive(address destination_amo) external validAMO(destination_amo) onlyByOwnGov {
    ...
    function mintFraxForAMO(address destination_amo, uint256 frax_amount) external validAMO(destination_amo) onlyByOwnGov {
    ...
    function mintFxsForAMO(address destination_amo, uint256 fxs_amount) external validAMO(destination_amo) onlyByOwnGov {
    ...
    ) external validAMO(destination_amo) onlyByOwnGov {
