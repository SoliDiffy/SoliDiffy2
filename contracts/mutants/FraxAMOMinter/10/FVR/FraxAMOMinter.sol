...
contract FraxAMOMinter is Owned {
    ...
    function fraxTrackedGlobal() public view returns (int256) {
        return int256(fraxDollarBalanceStored) - frax_mint_sum - (collat_borrowed_sum * int256(10 ** missing_decimals));
    }

    function fraxTrackedAMO(address amo_address) public view returns (int256) {
    ...
    function oldPoolRedeem(uint256 frax_amount) public onlyByOwnGov {
    ...
    function oldPoolCollectAndGive(address destination_amo) public onlyByOwnGov validAMO(destination_amo) {
    ...
    function mintFraxForAMO(address destination_amo, uint256 frax_amount) public onlyByOwnGov validAMO(destination_amo) {
