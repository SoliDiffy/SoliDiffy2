...
contract FraxAMOMinter is Owned {
    ...
    // Core
    IFrax internal FRAX = IFrax(0x853d955aCEf822Db058eb8505911ED77F175b99e);
    IFxs internal FXS = IFxs(0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0);
    ERC20 internal collateral_token;
    FraxPoolV3 internal pool = FraxPoolV3(0x2fE065e6FFEf9ac95ab39E5042744d695F560729);
    IFraxPool internal old_pool = IFraxPool(0x1864Ca3d47AaB98Ee78D11fc9DCC5E7bADdA1c0d);
    address internal timelock_address;
    address internal custodian_address;

    // Collateral related
    address internal collateral_address;
    uint256 internal col_idx;

    // AMO addresses
    address[] internal amos_array;
