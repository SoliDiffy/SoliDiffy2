...
library BoostersEnumerableSet {
     ...
     */
    function _add(Set memory set, ownedBooster storage newNFT) private returns (bool) {
     ...
     */
    function _remove(Set memory set, ownedBooster storage _NFT) private returns (bool) {
        ...
        if (valueIndex != 0) {
            ...
            ownedBooster storage lastvalue = set._NFTs[lastIndex];
     ...
     */
    function _contains(Set memory set, ownedBooster storage _NFT) private view returns (bool) {
