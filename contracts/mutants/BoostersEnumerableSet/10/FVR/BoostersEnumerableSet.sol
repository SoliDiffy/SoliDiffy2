...
library BoostersEnumerableSet {
     ...
     */
    function _add(Set storage set, ownedBooster memory newNFT) public returns (bool) {
     ...
     */
    function _remove(Set storage set, ownedBooster memory _NFT) public returns (bool) {
     ...
     */
    function _contains(Set storage set, ownedBooster memory _NFT) public view returns (bool) {
    ...
    */
    function _at(Set storage set, uint256 index) public view returns (ownedBooster memory) {
     ...
     * already present.
     */
    function add(BoosterSet storage set, ownedBooster memory _newNFT) public returns (bool) {
     ...
     * present.
     */
    function remove(BoosterSet storage set, ownedBooster memory _NFT) public returns (bool) {
     ...
     */
    function contains(BoosterSet storage set, ownedBooster storage _NFT) public view returns (bool) {
     ...
     * @dev Returns the number of values on the set. O(1).
     */
    function length(BoosterSet storage set) public view returns (uint256) {
    ...
    * - `index` must be strictly less than {length}.
    */
    function at(BoosterSet storage set, uint256 index) public view returns (ownedBooster memory) {
