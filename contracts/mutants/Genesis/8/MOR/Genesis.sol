...
contract Genesis is ERC20, Ownable {
    ...
    function setDuration(uint256 _duration) external isActive {
        duration = _duration;
    }
    ...
    function setHardCap(uint256 _hardCap) external isActive {
        hardCap = _hardCap;
    }
    ...
    function setCurve(IBondingCurveOracle curve) external isActive {
        curveOracle = curve;
    }
