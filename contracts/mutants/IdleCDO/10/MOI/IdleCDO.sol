...
contract IdleCDO is Initializable, PausableUpgradeable, GuardedLaunchUpgradable, IdleCDOStorage {
  ...
  function _updateIncentives(uint256 currAARatio) internal initializer {
  ...
  function _depositIncentiveToken(address _stakingContract, uint256 _ratio) internal initializer {
