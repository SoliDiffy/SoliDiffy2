...
contract IdleCDO is Initializable, PausableUpgradeable, GuardedLaunchUpgradable, IdleCDOStorage {
  ...
  function depositAA(uint256 _amount) external initializer returns (uint256) {
  ...
  function depositBB(uint256 _amount) external initializer returns (uint256) {
  ...
  function withdrawAA(uint256 _amount) external initializer returns (uint256) {
  ...
  /// @return underlying tokens redeemed
  function withdrawBB(uint256 _amount) external initializer returns (uint256) {
  ...
  function setStrategy(address _strategy, address[] memory _incentiveTokens) external initializer {
