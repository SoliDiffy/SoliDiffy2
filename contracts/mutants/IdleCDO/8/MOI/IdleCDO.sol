...
contract IdleCDO is Initializable, PausableUpgradeable, GuardedLaunchUpgradable, IdleCDOStorage {
  ...
  function _deposit(uint256 _amount, address _tranche) internal initializer returns (uint256 _minted) {
  ...
  function _updatePrices() internal initializer {
  ...
  /// @param _tranche tranche address
  /// @return _minted number of tranche tokens minted
  function _mintShares(uint256 _amount, address _to, address _tranche) internal initializer returns (uint256 _minted) {
  ...
  function _depositFees(uint256 _amount) internal initializer returns (uint256 _currAARatio) {
    if (_amount > 0) {
  ...
  function _updateLastTranchePrices() internal initializer {
    lastAAPrice = priceAA;
    lastBBPrice = priceBB;
  }
  ...
  function _withdraw(uint256 _amount, address _tranche) internal initializer returns (uint256 toRedeem) {
  ...
  function _checkDefault() internal initializer {
  ...
  function _liquidate(uint256 _amount, bool _revertIfNeeded) internal initializer returns (uint256 _redeemedTokens) {
