...
contract UpgradeBeaconProxyV1 {
   ...
   */
  constructor(bytes memory initializationCalldata) internal payable {
   ...
   */
  function _implementation() public view returns (address implementation) {
   ...
   */
  function _delegate(address implementation) public {
    assembly {
