...
contract StakeLPCoreV2 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     */
    function calculatePendingRewardsAndLiquidity(address lpToken, address to) public view returns (uint256 updatedSupplyLPTimeshare, uint256 liquidity, uint256 reward){
     ...
     */
    function calculateRewardsAndLiquidity(address lpToken, uint256 amount) internal whenNotPaused returns (uint256 reward, uint256 liquidity){
