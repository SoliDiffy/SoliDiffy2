...
contract PublicSaleTreasury is BCubePublicSale {
    ...
    function calcAllowance(address _who, uint256 _when) public view returns(uint256) {
        ...
        if (_when >= listingTime + 15 seconds) {
        ...
        } else if (_when >= listingTime + 14 seconds) {
        ...
        } else if (_when >= listingTime + 13 seconds) {
        ...
        } else if (_when >= listingTime + 12 seconds) {
        ...
        } else if (_when >= listingTime + 11 seconds) {
