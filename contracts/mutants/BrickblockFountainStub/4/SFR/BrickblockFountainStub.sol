...
contract BrickblockFountainStub is Ownable {
    ...
    returns (bool)
  {
    ...
    updateAccount(brickBlockTokenAddress, balances[brickBlockTokenAddress].tokens.sub(_value));
    ...
    returns (uint256 _value)
  {
    ...
    updateAccount(user, balances[user].tokens.sub(_value));
    ...
    returns (bool)
  {
    ...
    balances[this].tokens = balances[this].tokens.add(_companyTokens);
    balances[owner].tokens = balances[owner].tokens.sub(_companyTokens);
