...
import "frozen-zeppelin-solidity/contracts/math/SafeMath.sol";
import "frozen-zeppelin-solidity/contracts/ownership/Ownable.sol";
...
contract BrickblockFountainStub is Ownable {
  ...
  uint256 public constant companyShareReleaseBlock = 1234566;
  ...
  function BrickblockFountainStub(address _brickBlockTokenAddress)
    public
  {
    require(_brickBlockTokenAddress != address(1));
