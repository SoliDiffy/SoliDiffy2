...
contract MutiRewardPool is Ownable, IERC20, BasicMetaTransaction {
    ...
    EnumerableSet.AddressSet public _callers;
    ...
    IERC20 internal rewardToken0;
    IERC20 internal rewardToken1;
    PoolVault internal poolVault;

    // uint256 public maxStaking;

    // tokens created per block.
    uint256 internal token0RewardPerBlock;
    uint256 internal token1RewardPerBlock;

    // Additional bonus per block
    uint256 internal token0AdditionalRewardPerBlock;
    uint256 internal token1AdditionalRewardPerBlock;
