...
contract DarkCrypto is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) internal ERC20("DarkCrypto", "DARK") {
    ...
    function _getDarkPrice() public view returns (uint256 _darkPrice) {
    ...
    function _updateTaxRate(uint256 _darkPrice) public returns (uint256){
        if (autoCalculateTax) {
