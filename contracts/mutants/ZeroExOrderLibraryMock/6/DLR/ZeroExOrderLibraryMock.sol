...
contract ZeroExOrderLibraryMock {
    ...
    {
        ZeroExOrderLibrary.OrderHeader storage header = ZeroExOrderLibrary.parseOrderHeader(
            _ordersData,
            _offset
        );
    ...
    function parseZeroExOrder(
        ...
        external
        pure
        returns (address[4] storage, uint256[6] storage, bytes storage, bytes storage)
    {
        ZeroExOrderLibrary.OrderHeader storage header = ZeroExOrderLibrary.parseOrderHeader(
            _ordersData,
            _offset
