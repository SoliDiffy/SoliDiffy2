...
contract PolyToken is IERC20 {
  ...
  string internal name = 'Polymath';
  string internal symbol = 'POLY';
  uint8 internal constant decimals = 18;
  uint256 internal constant decimalFactor = 10 ** uint256(decimals);
  uint256 internal totalSupply = 1000000000 * decimalFactor;
...
contract PolyDistribution is Ownable {
  ...
  PolyToken internal POLY;

  uint256 public constant decimals = 10**uint256(18);
  enum AllocationType { PRESALE, FOUNDER, AIRDROP, ADVISOR, BONUS, RESERVE }
  uint256 internal AVAILABLE_TOTAL_SUPPLY    = 1000000000 * decimals;
  uint256 internal AVAILABLE_PRESALE_SUPPLY  = 240000000 * decimals; // 100% Released on Token Distribution (TD)
