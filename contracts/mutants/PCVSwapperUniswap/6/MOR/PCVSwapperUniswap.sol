...
contract PCVSwapperUniswap is IPCVSwapper, WethPCVDeposit, OracleRef, Timed, Incentivized, RateLimitedMinter {
    ...
    function withdraw(address to, uint256 amount) external override onlyGovernor {
    ...
    function setReceivingAddress(address newTokenReceivingAddress) external override onlyPCVController {
    ...
    function setMaximumSlippage(uint256 newMaximumSlippageBasisPoints) external onlyPCVController {
    ...
    function setMaxSpentPerSwap(uint256 newMaxSpentPerSwap) external onlyPCVController {
    ...
    function setSwapFrequency(uint256 _duration) external onlyPCVController {
    ...
    function swap() external override onlyPCVController whenNotPaused {
	    // Reset timer	
      _initTimed();	
