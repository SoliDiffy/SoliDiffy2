...
contract PCVSwapperUniswap is IPCVSwapper, WethPCVDeposit, OracleRef, Timed, Incentivized, RateLimitedMinter {
    ...
    function setMaximumSlippage(uint256 newMaximumSlippageBasisPoints) public onlyGovernor {
    ...
    function setMaxSpentPerSwap(uint256 newMaxSpentPerSwap) public onlyGovernor {
    ...
    function setSwapFrequency(uint256 _duration) public onlyGovernor {
    ...
    function _getExpectedAmountIn() public view returns (uint256) {
    ...
    function _getExpectedAmountOut(uint256 amountIn) public view returns (uint256) {
      // Get pair reserves
