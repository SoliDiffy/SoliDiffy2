...
interface IStakingRewardsDualV3 {
    ...
    function calcCurCombinedWeight(address account) external view returns (uint256 new_combined_weight, uint256 old_combined_weight, uint256 new_vefxs_multiplier);
