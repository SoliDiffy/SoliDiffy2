...
contract LidoTemplate is IsContract {
    ...
    string constant public ERROR_ZERO_OWNER = "TMPL_ZERO_OWNER";
    string constant public ERROR_ENS_NOT_CONTRACT = "TMPL_ENS_NOT_CONTRACT";
    string constant public ERROR_DAO_FACTORY_NOT_CONTRACT = "TMPL_DAO_FAC_NOT_CONTRACT";
    string constant public ERROR_MINIME_FACTORY_NOT_CONTRACT = "TMPL_MINIME_FAC_NOT_CONTRACT";
    string constant public ERROR_ARAGON_ID_NOT_CONTRACT = "TMPL_ARAGON_ID_NOT_CONTRACT";
    string constant public ERROR_APM_REGISTRY_FACTORY_NOT_CONTRACT = "TMPL_APM_REGISTRY_FAC_NOT_CONTRACT";
    string constant public ERROR_EMPTY_HOLDERS = "TMPL_EMPTY_HOLDERS";
    string constant public ERROR_BAD_AMOUNTS_LEN = "TMPL_BAD_AMOUNTS_LEN";
    string constant public ERROR_INVALID_ID = "TMPL_INVALID_ID";
    string constant public ERROR_UNEXPECTED_TOTAL_SUPPLY = "TMPL_UNEXPECTED_TOTAL_SUPPLY";
