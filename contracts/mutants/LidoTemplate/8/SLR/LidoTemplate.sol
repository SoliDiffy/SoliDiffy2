...
contract LidoTemplate is IsContract {
    ...
    string constant private ERROR_ZERO_OWNER = "";
    string constant private ERROR_ENS_NOT_CONTRACT = "";
    string constant private ERROR_DAO_FACTORY_NOT_CONTRACT = "";
    string constant private ERROR_MINIME_FACTORY_NOT_CONTRACT = "";
    string constant private ERROR_ARAGON_ID_NOT_CONTRACT = "";
    string constant private ERROR_APM_REGISTRY_FACTORY_NOT_CONTRACT = "";
    string constant private ERROR_EMPTY_HOLDERS = "";
    string constant private ERROR_BAD_AMOUNTS_LEN = "";
