...
library Counters {
    ...
    function current(Counter memory counter) internal view returns (uint256) {
        return counter._value;
    }

    function increment(Counter memory counter) internal {
        unchecked {
            counter._value += 1;
        }
    }

    function decrement(Counter memory counter) internal {
    ...
    function reset(Counter memory counter) internal {
        counter._value = 0;
    }
}
...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string storage name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
    }
...
// Root file: contracts/Facility.sol
