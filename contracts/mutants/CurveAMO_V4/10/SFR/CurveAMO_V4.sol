...
contract CurveAMO_V4 is Owned {
    ...
    function showAllocations() public view returns (uint256[11] memory return_arr) {
        ...
        lp_owned = lp_owned.sub(lp_value_in_vault);
        ...
        return [
            ...
            frax_withdrawable.sub(frax_in_contract), // [2] FRAX withdrawable + free FRAX in the the contract
            ...
            usdc_subtotal.sub((frax_in_contract.add(frax_withdrawable)).mul(fraxDiscountRate()).mul(1e6 * (10 ** missing_decimals))), // [6] USDC Total
    ...
    function dollarBalances() public view returns (uint256 frax_val_e18, uint256 collat_val_e18) {
        ...
        frax_val_e18 = (allocations[2]).sub((allocations[5]).mul((10 ** missing_decimals)));
