...
contract Strategy is BaseStrategy {
    ...
    function _removeLender(address a, bool force) internal onlyAuthorized {
        for (uint256 i = 0; i < lenders.length; i++) {
    ...
    function _withdrawSome(uint256 _amount) internal onlyAuthorized returns (uint256 amountWithdrawn) {
        //dont withdraw dust
