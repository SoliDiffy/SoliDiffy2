...
contract Strategy is BaseStrategy {
    ...
    function setPriceOracle(address _oracle) external onlyGovernance {
    ...
    function addLender(address a) public onlyAuthorized {
    ...
    function safeRemoveLender(address a) public onlyGovernance {
        _removeLender(a, false);
    }

    function forceRemoveLender(address a) public onlyGovernance {
    ...
    function manualAllocation(lenderRatio[] memory _newPositions) public onlyGovernance {
        uint256 share = 0;
