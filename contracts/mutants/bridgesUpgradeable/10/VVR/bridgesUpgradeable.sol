...
contract BridgeArbitrumL1MockUpgradeable is Initializable, BaseRelayMockUpgradeable {
    ...
    address internal immutable inbox = address(new BridgeArbitrumL1InboxUpgradeable());
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable state-variable-assignment
    address internal immutable outbox = address(new BridgeArbitrumL1OutboxUpgradeable());
...
contract BridgeArbitrumL1InboxUpgradeable is Initializable {
    ...
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable state-variable-assignment
    address internal immutable bridge = msg.sender;
