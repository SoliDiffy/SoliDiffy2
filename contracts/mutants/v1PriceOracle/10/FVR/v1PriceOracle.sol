...
contract ErrorReporter {
    ...
    /**
      ...
      */
    function fail(Error err, FailureInfo info) public returns (uint) {
    ...
    /**
      ...
      */
    function failOpaque(FailureInfo info, uint opaqueError) public returns (uint) {
...
contract CarefulMath is ErrorReporter {
    ...
    */
    function mul(uint a, uint b) public pure returns (Error, uint) {
        if (a == 0) {
    ...
    */
    function div(uint a, uint b) public pure returns (Error, uint) {
        if (b == 0) {
    ...
    */
    function sub(uint a, uint b) public pure returns (Error, uint) {
        if (b <= a) {
            return (Error.NO_ERROR, a - b);
        } else {
    ...
    */
    function add(uint a, uint b) public pure returns (Error, uint) {
        uint c = a + b;
    ...
    */
    function addThenSub(uint a, uint b, uint c) public pure returns (Error, uint) {
...
contract Exponential is ErrorReporter, CarefulMath {
    ...
    *            or if `denom` is zero.
    */
    function getExp(uint num, uint denom) pure public returns (Error, Exp memory) {
    ...
    */
    function addExp(Exp memory a, Exp memory b) pure public returns (Error, Exp memory) {
    ...
    */
    function subExp(Exp memory a, Exp memory b) pure public returns (Error, Exp memory) {
