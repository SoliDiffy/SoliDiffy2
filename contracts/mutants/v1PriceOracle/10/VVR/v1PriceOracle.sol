...
contract Exponential is ErrorReporter, CarefulMath {
    ...
    uint constant public constant expScale = 10**18;

    // See TODO on expScale
    uint constant public constant halfExpScale = expScale/2;

    struct Exp {
        uint mantissa;
    }

    uint constant public constant mantissaOne = 10**18;
    uint constant public constant mantissaOneTenth = 10**17;
...
contract PriceOracle is Exponential {
    ...
    uint internal constant numBlocksPerPeriod = 240; // approximately 1 hour: 60 seconds/minute * 60 minutes/hour * 1 block/15 seconds

    uint internal constant maxSwingMantissa = (10 ** 17); // 0.1
    ...
    /**
      ...
      */
    address internal anchorAdmin;

    /**
      * @dev pending anchor administrator for this contract.
      */
    address internal pendingAnchorAdmin;
