...
contract Exponential is ErrorReporter, CarefulMath {
    ...
    *            or if `denom` is zero.
    */
    function getExp(uint num, uint denom) pure internal returns (Error, Exp storage) {
    ...
    */
    function addExp(Exp storage a, Exp storage b) pure internal returns (Error, Exp storage) {
    ...
    */
    function subExp(Exp storage a, Exp storage b) pure internal returns (Error, Exp storage) {
    ...
    */
    function mulScalar(Exp storage a, uint scalar) pure internal returns (Error, Exp storage) {
    ...
    */
    function divScalar(Exp storage a, uint scalar) pure internal returns (Error, Exp memory) {
