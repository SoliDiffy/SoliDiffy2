...
contract AvalaunchCollateral is Initializable {
     ...
     */
    function initialize(address _moderator, address _admin, uint256 chainId) public initializer {
    ...
    function safeTransferAVAX(address to, uint256 value) public {
     ...
     */
    function setModerator(address _moderator) onlyModerator public {
        require(_moderator != address(0x0), "Moderator can not be 0x0");
        moderator = _moderator;
    }
     ...
     */
    function approveSale(address saleAddress) onlyModerator public {
