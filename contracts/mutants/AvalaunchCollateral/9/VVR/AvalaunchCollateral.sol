...
contract AvalaunchCollateral is Initializable {
    ...
    string internal constant AUTOBUY_TYPE = "AutoBuy(string confirmationMessage,address saleAddress)";
    bytes32 internal constant AUTOBUY_TYPEHASH = keccak256(abi.encodePacked(AUTOBUY_TYPE));
    bytes32 internal constant AUTOBUY_MESSAGEHASH = keccak256("Turn AutoBUY ON.");

    // BOOST - TYPE / TYPEHASH / MESSAGEHASH
    string internal constant BOOST_TYPE = "Boost(string confirmationMessage,address saleAddress)";
    bytes32 internal constant BOOST_TYPEHASH = keccak256(abi.encodePacked(BOOST_TYPE));
    bytes32 internal constant BOOST_MESSAGEHASH = keccak256("Boost participation.");
