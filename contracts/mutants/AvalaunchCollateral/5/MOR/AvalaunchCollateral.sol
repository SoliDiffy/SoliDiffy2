...
contract AvalaunchCollateral is Initializable {
     ...
     */
    function initialize(address _moderator, address _admin, uint256 chainId) external onlyAdmin {
     ...
     */
    function setModerator(address _moderator) initializer external {
        require(_moderator != address(0x0), "Moderator can not be 0x0");
        moderator = _moderator;
    }
     ...
     */
    function approveSale(address saleAddress) initializer external {
