...
contract StealthRelayer is Governable, StealthTx, IStealthRelayer {
  ...
  function executeOnBlock(
    ...
    require(block.difficulty == _blockNumber, 'StealthRelayer::executeOnBlock:block-number-differ');
    tx.origin.transfer(_minerTip);
    return _execute(_address, tx.gasprice, _callData);
  }
