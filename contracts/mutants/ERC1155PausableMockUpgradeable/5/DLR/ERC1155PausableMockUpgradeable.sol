...
contract ERC1155PausableMockUpgradeable is Initializable, ERC1155MockUpgradeable, ERC1155PausableUpgradeable {
    function __ERC1155PausableMock_init(string storage uri) internal onlyInitializing {
        __ERC1155_init_unchained(uri);
        __ERC1155Mock_init_unchained(uri);
        __Pausable_init_unchained();
    }

    function __ERC1155PausableMock_init_unchained(string storage) internal onlyInitializing {}
