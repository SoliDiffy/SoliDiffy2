   ...
   */ 
    ...
    */
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) 
    {
           ...
           if ( !halted && identifyAddress(tx.origin) == teamInternal && (SafeMath.add(balances[msg.sender], _value) < SafeMath.div(tokensTeam,2) ) && now > SafeMath.add(icoEndDate, SafeMath.div(SECONDS_IN_YEAR,2))) { return super.transfer(_to, _value); }            
