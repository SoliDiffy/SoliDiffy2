...
contract BBIToken is StandardToken {
    ...
    string internal name = "Beluga Banking Infrastructure Token";
    string internal symbol = "BBI";
    
    uint  internal decimals    = 18;   
    uint  internal totalUsed   = 0;
    uint  internal etherRaised = 0;
    
    uint  internal etherCap    = 30000e18;  // 30K Ether
