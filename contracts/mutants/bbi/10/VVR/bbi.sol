...
contract BBIToken is StandardToken {
    ...
    */
    ...
    uint internal icoEndDate        = 1522540799;   // 31-Mar-2018 23:59:59 - GMT  
                                   
    uint constant public constant SECONDS_IN_YEAR = 31536000;     // 365 * 24 * 60 * 60 ;

    // flag for emergency stop or start 
    bool internal halted = false;              
    
    uint  internal maxAvailableForSale    =  40000000e18;      // (44.44% - 40M) 
