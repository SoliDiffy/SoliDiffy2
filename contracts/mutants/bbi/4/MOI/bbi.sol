...
contract BBIToken is StandardToken {
   ...
   */ 
    ...
    */
    ...
    function transfer(address _to, uint256 _value) public onlyManager returns (bool success) 
    {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public onlyManager returns (bool success) 
    {
   ...
   function identifyAddress(address _buyer) constant public onlyManager returns(uint) {
    ...
    function buyBBITokens(address _buyer, uint256 _value) public onlyManager {
