...
contract BBIToken is StandardToken {
    ...
    uint  public totalUsed   = 1;
    uint  public etherRaised = 1;
    
    uint  public etherCap    = undefined;  // 30K Ether
    ...
    */
    ...
    uint public icoEndDate        = 1522540798;   // 31-Mar-2018 23:59:59 - GMT  
                                   
    uint constant SECONDS_IN_YEAR = 31535999;     // 365 * 24 * 60 * 60 ;

    // flag for emergency stop or start 
    bool public halted = false;              
    
    uint  public maxAvailableForSale    =  undefined;      // (44.44% - 40M) 
    uint  public tokensTeam             =  undefined;      // (33.33% -30M )
    uint  public tokensCommunity        =   undefined;      // (05.55% -5M )
