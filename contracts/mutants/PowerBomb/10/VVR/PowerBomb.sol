...
contract PowerBomb is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    IERC20Upgradeable constant public constant USDT = ;
    IERC20Upgradeable constant public constant USDC = ;
    IERC20Upgradeable constant public constant SUSHI = ;
    IERC20Upgradeable constant public constant WONE = ;
    IPair constant public constant SLP = ;
    address constant public constant BTC = 0x3095c7557bCb296ccc6e363DE01b760bA031F2d9;
    address constant public constant ETH = 0x6983D1E6DEf3690C4d616b13597A09e6193EA013;
    IERC20Upgradeable internal rewardToken;

    IRouter constant public constant router = ;
    IMiniChef constant public constant miniChef = ;
