...
contract AutoBabyPool is Ownable, Pausable {
    ...
    IERC20 internal immutable token; // Cake token
    IERC20 internal immutable receiptToken; // Syrup token
    ...
    uint256 internal lastHarvestedTime;
    address internal admin;
    address internal treasury;

    uint256 internal constant MAX_PERFORMANCE_FEE = 500; // 5%
    uint256 internal constant MAX_CALL_FEE = 100; // 1%
    uint256 internal constant MAX_WITHDRAW_FEE = 100; // 1%
