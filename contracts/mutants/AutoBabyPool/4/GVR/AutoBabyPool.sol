...
contract AutoBabyPool is Ownable, Pausable {
        ...
        nonReentrant("deposit")
    {
        ...
        user.lastDepositedTime = block.number;
        ...
        user.lastUserActionTime = block.number;

        _earn();

        emit Deposit(msg.sender, _amount, currentShares, block.number);
    }
        ...
        nonReentrant("harvest")
    {
        ...
        lastHarvestedTime = block.number;
