...
contract AutoBabyPool is Ownable, Pausable {
     ...
     */
    function setAdmin(address _admin) external whenNotPaused {
     ...
     */
    function setPerformanceFee(uint256 _performanceFee) external whenNotPaused {
        require(
     ...
     * @dev Only callable by the contract admin.
     */
    function setCallFee(uint256 _callFee) external whenNotPaused {
        require(
     ...
     * @dev Only callable by the contract admin.
     */
    function setWithdrawFee(uint256 _withdrawFee) external whenNotPaused {
        require(
