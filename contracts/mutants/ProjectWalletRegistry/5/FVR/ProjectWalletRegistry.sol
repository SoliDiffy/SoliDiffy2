...
contract ProjectWalletRegistry is Ownable {
   ...
   */
    constructor(address _token, address _authoriser, address _factory) internal {
        token = _token;
   ...
   */
    function ensureWallet(bytes32 _name) external returns (address) {
   ...
   * @param _name bytes32 The project did
   */
    function walletOf(bytes32 _name) external view returns (address) {
   ...
   * @param _name bytes32 The project did
   */
    function _createWallet (bytes32 _name) public {
