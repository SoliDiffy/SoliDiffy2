...
contract WStakingRewards is ERC1155('WStakingRewards'), ReentrancyGuard, IERC20Wrapper {
  ...
  address internal immutable staking; // Staking reward contract address
  address internal immutable underlying; // Underlying token address
  address internal immutable reward; // Reward token address
