...
contract MockedValidator is Ownable, SignerManageable {
    ...
    // Variables
    // -----------------------------------------------------------------------------------------------------------------
    bool public orderWalletHash;
    bool public orderWalletSeal;
    bool public orderOperatorSeal;
    bool public orderSeals;
    bool public tradeBuyerFeeOfFungible;
    bool public tradeSellerFeeOfFungible;
    bool public tradeBuyerGenuine;
    bool public tradeSellerGenuine;
    bool[] publicundefined;
    bool public tradeParty;
    bool tradeBuyer;
    bool tradeSeller;
    bool tradeOrder;
