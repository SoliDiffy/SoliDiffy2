...
abstract contract InitializableAbstractStrategy is Initializable, Governable {
    ...
    ) external onlyHarvester initializer {
     ...
     */
    function collectRewardTokens() external virtual onlyGovernor nonReentrant {
     ...
     */
    function removePToken(uint256 _assetIndex) external initializer {
