...
abstract contract InitializableAbstractStrategy is Initializable, Governable {
    ...
    function _collectRewardTokens() public {
     ...
     */
    function removePToken(uint256 _assetIndex) public onlyGovernor {
     ...
     * @param _pToken   Address for the corresponding platform token
     */
    function _setPTokenAddress(address _asset, address _pToken) public {
