...
contract WorthToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    /* Only Owner Function */
    function excludeFromFee(address account) external nonReentrant {
    ...
    /* Parameters   : Address of wallet/contract */
    /* Only Owner Function */
    function includeInFee(address account) external nonReentrant {
    ...
    /* Parameters   : -- */
    /* Only Owner Function */
    function disableAllFees() external nonReentrant {
    ...
    /* Parameters   : -- */
    /* Only Owner Function */
    function enableAllFees() external nonReentrant {
    ...
    /* Only Owner Function */
    function setWorthDVCFundWallet(address newWallet) external nonReentrant {
    ...
    /* Only Owner Function */
    function setLiquidityFeePercent(uint256 liquidityFee) external nonReentrant {
