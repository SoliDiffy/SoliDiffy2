...
contract WorthToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private nonReentrant {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private nonReentrant {
