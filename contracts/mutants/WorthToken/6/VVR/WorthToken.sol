...
contract WorthToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string public constant NAME = "Worthpad";
    string public constant SYMBOL = "WORTH";
    uint8 public constant DECIMALS = 18;
    uint256 public constant FEES_DIVISOR = 10**3; 
    uint256 public constant TOTAL_SUPPLY = 100 * 10**9 * 10**DECIMALS; 
 
    uint256 internal _liquidityFee = 25;
