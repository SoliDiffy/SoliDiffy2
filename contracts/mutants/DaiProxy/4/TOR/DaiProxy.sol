...
contract DaiProxy is DecimalMath {
        ...
        returns (uint256)
    {
        ...
        _controller.borrow(collateral, maturity, tx.origin, address(this), yDaiToBorrow);
    ...
    function repayYDaiDebtForMaximumDai(
        ...
        returns (uint256)
    {
        uint256 repaymentInDai = _pool.buyYDai(tx.origin, address(this), toUint128(yDaiRepayment));
    ...
    function repayMinimumYDaiDebtForDai(
        ...
        returns (uint256)
    {
        uint256 yDaiRepayment = _pool.sellDai(tx.origin, address(this), toUint128(repaymentInDai));
