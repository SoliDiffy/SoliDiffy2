...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    function mint(
        ...
        uint128 amount,
        bytes calldata data
    ) external override lock returns (uint256 amount1, uint256 amount0) {
        require(amount > 0);
    ...
    ) external override lock returns (uint128 amount1, uint128 amount0) {
    ...
    function swap(
        ...
        bytes calldata data
    ) external override noDelegateCall returns (int256 amount1, int256 amount0) {
