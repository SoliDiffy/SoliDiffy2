...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    function secondsInside(int24 tickLower, int24 tickUpper) external view override lock returns (uint32) {
    ...
    function flash(
        ...
        uint256 amount1,
        bytes calldata data
    ) external override onlyFactoryOwner noDelegateCall {
    ...
    function setFeeProtocol(uint8 feeProtocol0, uint8 feeProtocol1) external override noDelegateCall onlyFactoryOwner {
        require(
