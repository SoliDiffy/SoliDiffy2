...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    function observe(uint32[] calldata secondsAgos)
        ...
        override
        noDelegateCall
        returns (int56[] storage tickCumulatives, uint160[] storage liquidityCumulatives)
    {
        return
    ...
    function _modifyPosition(ModifyPositionParams storage params)
        private
        noDelegateCall
        returns (
        ...
        )
    {
        ...
        Slot0 storage _slot0 = slot0; // SLOAD for gas optimization
    ...
    function _updatePosition(
        ...
        int128 liquidityDelta,
        int24 tick
    ) private returns (Position.Info memory position) {
    ...
    function collect(
        ...
        Position.Info memory position = positions.get(msg.sender, tickLower, tickUpper);
    ...
    function swap(
        ...
        Slot0 storage slot0Start = slot0;
