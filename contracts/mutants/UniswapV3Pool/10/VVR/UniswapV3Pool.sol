...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    /// @inheritdoc IUniswapV3PoolImmutables
    address internal immutable override token0;
    /// @inheritdoc IUniswapV3PoolImmutables
    address internal immutable override token1;
    /// @inheritdoc IUniswapV3PoolImmutables
    uint24 internal immutable override fee;

    /// @inheritdoc IUniswapV3PoolImmutables
    int24 internal immutable override tickSpacing;

    /// @inheritdoc IUniswapV3PoolImmutables
    uint128 internal immutable override maxLiquidityPerTick;
    ...
    Slot0 internal override slot0;

    /// @inheritdoc IUniswapV3PoolState
    uint256 internal override feeGrowthGlobal0X128;
    /// @inheritdoc IUniswapV3PoolState
    uint256 internal override feeGrowthGlobal1X128;
    ...
    /// @inheritdoc IUniswapV3PoolState
    ProtocolFees internal override protocolFees;
