...
contract ConfigStore is ConfigStoreInterface, Testable, Lockable, Ownable {
     ...
     */
    constructor(ConfigSettings memory _initialConfig, address _timerAddress) public  {
     ...
     */
    function proposeNewConfig(ConfigSettings memory newConfig) external  nonReentrant() updateConfig() {
    ...
    function publishPendingConfig() external  updateConfig() {}
