...
contract ConfigStore is ConfigStoreInterface, Testable, Lockable, Ownable {
     ...
     */
    function proposeNewConfig(ConfigSettings memory newConfig) external onlyOwner() updateConfig() nonReentrant() {
    ...
    function publishPendingConfig() external updateConfig() nonReentrant() {}
