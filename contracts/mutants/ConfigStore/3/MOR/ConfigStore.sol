...
contract ConfigStore is ConfigStoreInterface, Testable, Lockable, Ownable {
     ...
     */
    function proposeNewConfig(ConfigSettings memory newConfig) external nonReentrantView() nonReentrant() updateConfig() {
    ...
    function publishPendingConfig() external nonReentrantView() updateConfig() {}
