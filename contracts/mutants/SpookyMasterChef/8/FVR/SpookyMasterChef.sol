...
contract SpookyMasterChef is Ownable {
  ...
  function setBooPerSecond(uint256 _booPerSecond) public onlyOwner {
  ...
  function checkForDuplicate(IERC20 _lpToken) public view {
  ...
  function pendingBOO(uint256 _pid, address _user) public view returns (uint256) {
