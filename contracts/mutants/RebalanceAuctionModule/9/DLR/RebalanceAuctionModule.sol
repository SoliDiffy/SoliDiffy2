    ...
    ReentrancyGuard
{
        ...
        nonReentrant
    {
        ...
        address[] storage withdrawComponents = rebalancingSetToken.getFailedAuctionWithdrawComponents();
        ...
        uint256[] storage componentTransferAmount = new uint256[](transferArrayLength);
        ...
        returns (uint256)
    {
        ...
        uint256[] storage biddingParameters = IRebalancingSetToken(_rebalancingSetToken).getBiddingParameters();
