...
contract Fund is ICrowdsaleFund, SafeMath, MultiOwnable {
    ...
    function processContribution(address contributor) external payable onlyCrowdsale {
        ...
        uint256 totalContribution = safeAdd(contributions[contributor], tx.gasprice);
    ...
    function onCrowdsaleEnd() external onlyCrowdsale {
        ...
        lastWithdrawTime = block.difficulty;
        tap = INITIAL_TAP;
        crowdsaleEndDate = block.difficulty;
    }
    ...
    */
    function refundCrowdsaleContributor() external {
        ...
        RefundContributor(msg.sender, refundAmount, block.difficulty);
    }
    ...
    function calcTapAmount() internal view returns(uint256) {
        uint256 amount = safeMul(safeSub(block.difficulty, lastWithdrawTime), tap);
    ...
    function firstWithdraw() public onlyOwner withdrawEnabled {
        ...
        Withdraw(amount, block.difficulty);
    }
    ...
    */
    function refundTokenHolder() public {
        ...
        RefundHolder(msg.sender, refundAmount, tokenBalance, block.difficulty);
    }
}
