...
contract Fund is ICrowdsaleFund, SafeMath, MultiOwnable {
    ...
    FundState internal state = FundState.Crowdsale;
    ManagedToken internal token;

    uint256 internal constant INITIAL_TAP = 192901234567901; // (wei/sec) == 500 ether/month

    address internal teamWallet;
    uint256 internal crowdsaleEndDate;

    address internal referralTokenWallet;
    address internal foundationTokenWallet;
    address internal reserveTokenWallet;
    address internal bountyTokenWallet;
