...
contract Fund is ICrowdsaleFund, SafeMath, MultiOwnable {
    ...
    function setCrowdsaleAddress(address _crowdsaleAddress) public onlyCrowdsale {
        require(crowdsaleAddress == address(0));
        crowdsaleAddress = _crowdsaleAddress;
    }

    function setTokenAddress(address _tokenAddress) public onlyCrowdsale {
     ...
     */
    function processContribution(address contributor) external payable onlyOwner {
     ...
     */
    function onCrowdsaleEnd() external onlyOwner {
     ...
     */
    function enableCrowdsaleRefund() external onlyOwner {
        require(state == FundState.Crowdsale);
