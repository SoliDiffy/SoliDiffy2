...
contract Fund is ICrowdsaleFund, SafeMath, MultiOwnable {
    ...
    */
     ...
     */
    function decTap(uint256 _tap) external onlyCrowdsale {
    ...
    function firstWithdraw() public onlyCrowdsale withdrawEnabled {
     ...
     */
    function withdraw() public onlyCrowdsale withdrawEnabled {
        require(state == FundState.TeamWithdraw);
