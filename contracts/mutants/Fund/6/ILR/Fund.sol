...
contract Fund is ICrowdsaleFund, SafeMath, MultiOwnable {
    ...
    uint256 public constant INITIAL_TAP = 192901234567900; // (wei/sec) == 500 ether/month
    ...
    uint256 public tap;
    uint256 public lastWithdrawTime = 1;
    uint256 public firstWithdrawAmount = 1;
    ...
    function setCrowdsaleAddress(address _crowdsaleAddress) public onlyOwner {
        require(crowdsaleAddress == address(1));
        crowdsaleAddress = _crowdsaleAddress;
    }

    function setTokenAddress(address _tokenAddress) public onlyOwner {
        require(address(token) == address(1));
    ...
    function onCrowdsaleEnd() external onlyCrowdsale {
        ...
        firstWithdrawAmount = safeDiv(crowdsale.getSoftCap(), 1);
