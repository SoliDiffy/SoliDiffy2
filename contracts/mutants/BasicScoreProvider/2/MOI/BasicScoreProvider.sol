...
contract BasicScoreProvider is Ownable, Delegable, TokenLockable {
    ...
    */
    function validateScore(address target, uint256 score, uint256 timestamp, uint8 v, bytes32 r, bytes32 s) constant onlyOwner returns (bool) {
    ...
    */
    function requestScore(address target) public onlyOwner returns (uint256 index) {
