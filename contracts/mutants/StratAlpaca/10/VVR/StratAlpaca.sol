...
contract StratAlpaca is UpgradeableOwnable, ReentrancyGuardPausable, ISimpleStrategy, Initializable {
    ...
    bool internal wantIsWBNB = false;
    IERC20 internal wantToken = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address internal uniRouterAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;

    address internal wbnbAddress =
        0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    IFairLaunch internal fairLaunch = IFairLaunch(0xA625AB01B08ce023B2a342Dbb12a16f2C8489A8F);
    IERC20 internal alpacaToken = IERC20(0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F);
    IAlpacaVault internal alpacaVault = IAlpacaVault(0x7C9e73d4C71dae564d41F78d56439bB4ba87592f);

    uint256 internal lastHarvestBlock = 0;

    address[] internal alpacaToWantPath;

    uint256 internal poolId = 3;
