...
contract ImpossiblePair is IImpossiblePair, ImpossibleERC20, ReentrancyGuard {
    ...
    */
    function makeUni() public onlyGovernance nonReentrant {
    ...
    */
    function updateTradeFees(uint8 _newFee) public onlyGovernance {
    ...
    */
    function updateDelay(uint256 _newDelay) public onlyGovernance {
    ...
    /**
     ...
     @param _ratioEnd If token ratios in pool are above this, trade that further imbalances pool is halted
    */
    function updateHardstops(uint8 _ratioStart, uint8 _ratioEnd) public onlyGovernance nonReentrant {
    ...
    /**
     ...
     @param _newBoost1 The new boost1
    */
    function updateBoost(uint32 _newBoost0, uint32 _newBoost1) public onlyGovernance nonReentrant {
        require(isXybk, 'IF: IS_CURRENTLY_UNI');
        _updateBoost(_newBoost0, _newBoost1);
    }
    ...
    /**
     ...
     @param _newBoost1 The new boost1
    */
    function _updateBoost(uint32 _newBoost0, uint32 _newBoost1) public {
        require(
