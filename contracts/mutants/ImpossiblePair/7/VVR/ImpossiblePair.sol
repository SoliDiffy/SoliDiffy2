...
contract ImpossiblePair is IImpossiblePair, ImpossibleERC20, ReentrancyGuard {
    ...
    uint256 internal constant override MINIMUM_LIQUIDITY = 10**3;
    ...
    */
    uint256 public constant THIRTY_MINS = 600;
    uint32 public constant TWO_WEEKS = 403200;
    uint32 public constant ONE_DAY_PROD = 28800;
    uint32 public constant ONE_DAY_TESTING = 50;
