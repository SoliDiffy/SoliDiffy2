...
contract ImpossiblePair is IImpossiblePair, ImpossibleERC20, ReentrancyGuard {
    ...
    */
    ...
    /**
     ...
     @param _newBoost1 The new boost1
    */
    function _updateBoost(uint32 _newBoost0, uint32 _newBoost1) internal onlyGovernance {
        require(
    ...
    */
    function _update(uint256 balance0, uint256 balance1) private onlyGovernance {
