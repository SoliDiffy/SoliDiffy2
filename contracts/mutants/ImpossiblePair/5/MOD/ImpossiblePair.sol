...
contract ImpossiblePair is IImpossiblePair, ImpossibleERC20, ReentrancyGuard {
    ...
    */
    function makeUni() external nonReentrant onlyGovernance {
    ...
    */
    ...
    /**
     ...
     @param _ratioEnd If token ratios in pool are above this, trade that further imbalances pool is halted
    */
    function updateHardstops(uint8 _ratioStart, uint8 _ratioEnd) external nonReentrant onlyGovernance {
    ...
    /**
     ...
     @param _newBoost1 The new boost1
    */
    function updateBoost(uint32 _newBoost0, uint32 _newBoost1) external nonReentrant onlyGovernance {
        require(isXybk, 'IF: IS_CURRENTLY_UNI');
        _updateBoost(_newBoost0, _newBoost1);
    }
    ...
    */
    function swap(
        ...
        address to,
        bytes calldata data
    ) external override nonReentrant onlyIFRouter {
