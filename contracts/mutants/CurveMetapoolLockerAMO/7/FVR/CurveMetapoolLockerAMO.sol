...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function showAllocations() external view returns (uint256[6] memory return_arr) {
        // ------------LP Balance------------
        // Free LP
    ...
    function metapoolDeposit(uint256 _collateral_amount) public onlyByOwnGov returns (uint256 metapool_LP_received) {
    ...
    function metapoolWithdraw3pool(uint256 metapool_lp_in) external onlyByOwnGov {
