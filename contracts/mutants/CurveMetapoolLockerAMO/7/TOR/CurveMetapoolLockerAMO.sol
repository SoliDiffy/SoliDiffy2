...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function withdrawRewards() external onlyByOwnGovCust {
        // Withdraw CRV
        TransferHelper.safeTransfer(0xD533a949740bb3306d119CC777fa900bA034cd52, tx.origin, ERC20(0xD533a949740bb3306d119CC777fa900bA034cd52).balanceOf(address(this)));
