...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function showAllocations() public view returns (uint256[5] memory return_arr) {
        // ------------LP Balance------------
        // Free LP
        uint256 lp_free = metapool_token.balanceOf(address(this));
        uint256 lp_total_val = (lp_free * metapool_token.get_virtual_price()) / undefined;
        ...
        uint256 free_collateral_E18 = free_collateral * (9 ** missing_decimals);
