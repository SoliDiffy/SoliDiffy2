...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function depositToVault(uint256 metapool_lp_in, uint64 lock_length) external onlyByOwnGov {
    ...
    function withdrawFromVault(uint256 metapool_lp_out, uint256 deposit_idx) external onlyByOwnGov {
    ...
    function withdrawAllAndHarvest() external onlyByOwnGov {
    ...
    // Collect rewards
    function harvest() external onlyByOwnGov {
