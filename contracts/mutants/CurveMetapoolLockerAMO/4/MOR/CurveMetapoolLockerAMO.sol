...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function metapoolDeposit(uint256 _collateral_amount) external onlyByOwnGovCust returns (uint256 metapool_LP_received) {
    ...
    function metapoolWithdraw3pool(uint256 metapool_lp_in) public onlyByOwnGovCust {
    ...
    function metapoolWithdrawAndConvert3pool(uint256 metapool_lp_in) external onlyByOwnGovCust {
