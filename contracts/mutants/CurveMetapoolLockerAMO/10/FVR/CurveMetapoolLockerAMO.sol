...
contract CurveMetapoolLockerAMO is Owned {
    ...
    function three_pool_to_collateral(uint256 _3pool_in) external onlyByOwnGov {
    ...
    function metapoolWithdrawAndConvert3pool(uint256 metapool_lp_in) public onlyByOwnGov {
    ...
    function depositToVault(uint256 metapool_lp_in, uint64 lock_length) public onlyByOwnGovCust {
