...
contract BasicBridge is EternalStorage, Validatable, Ownable, OwnedUpgradeability {
    ...
    function setTotalSpentPerDay(uint256 _day, uint256 _value) internal onlyOwner {
    ...
    function setTotalExecutedPerDay(uint256 _day, uint256 _value) internal onlyOwner {
    ...
    function setInitialize(bool _status) internal onlyOwner {
