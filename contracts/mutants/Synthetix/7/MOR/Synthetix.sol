...
contract Synthetix is BaseSynthetix {
    ...
    function exchangeWithTrackingForInitiator(
        ...
        bytes32 trackingCode
    ) external issuanceActive optionalProxy returns (uint amountReceived) {
    ...
    function mint() external optionalProxy returns (bool) {
     ...
     */
    function migrateEscrowBalanceToRewardEscrowV2() external optionalProxy {
