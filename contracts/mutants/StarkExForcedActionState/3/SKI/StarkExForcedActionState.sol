...
contract StarkExForcedActionState is StarkExStorage, ActionHash, MStarkExForcedActionState {
    ...
    */
        ...
        override
    {
        ...
        delete forcedActionRequests[super.fullWithdrawActionHash(ownerKey, vaultId)];
    }
        ...
        returns (uint256)
    {
        ...
        return forcedActionRequests[super.fullWithdrawActionHash(ownerKey, vaultId)];
    }
    ...
    function setFullWithdrawalRequest(uint256 ownerKey, uint256 vaultId) internal override {
        ...
        setActionHash(super.fullWithdrawActionHash(ownerKey, vaultId), true);
    }
}
