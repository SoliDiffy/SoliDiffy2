...
contract EchidnaTester {
    ...
    function openTroveRawExt(uint _i, uint _ETH, uint _LUSDAmount, address _hint) public  {
        uint actor = _i % NUMBER_OF_ACTORS;
    ...
    function addCollRawExt(uint _i, uint _ETH, address _hint) external  {
        uint actor = _i % NUMBER_OF_ACTORS;
    ...
    function adjustTroveRawExt(uint _i, uint _ETH, uint _collWithdrawal, uint _debtChange, bool _isDebtIncrease, address _hint) external  {
        uint actor = _i % NUMBER_OF_ACTORS;
