...
abstract contract BuyNowMarketplace is IBuyNowMarketplace, BaseMarketplace {
    ...
    override
    whenNotPaused {
        require(super._isListingPermitted(_id), "Listing is not permitted");
        require(super._isBuyNowListingPermitted(_id), "Buy now listing invalid");
    ...
    function _facilitateBuyNow(uint256 _id, address _recipient) internal {
        ...
        uint256 tokenId = super._processSale(_id, msg.value, _recipient, listing.seller);
...
abstract contract ReserveAuctionMarketplace is IReserveAuctionMarketplace, BaseMarketplace {
    ...
    override
    whenNotPaused {
        require(super._isListingPermitted(_id), "Listing not permitted");
        require(super._isReserveListingPermitted(_id), "Reserve listing not permitted");
    ...
    nonReentrant {
        ...
        super._processSale(_id, winningBid, winner, seller);
    ...
    nonReentrant {
        ...
        require(super._hasReserveListingBeenInvalidated(_id), "Bid cannot be withdrawn as reserve auction listing is valid");
