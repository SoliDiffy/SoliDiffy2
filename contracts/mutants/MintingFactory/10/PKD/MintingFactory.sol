...
interface IBuyNowMarketplace {
    ...
    function buyEditionToken(uint256 _id) external ;
    function buyEditionTokenFor(uint256 _id, address _recipient) external ;
...
interface IEditionOffersMarketplace {
    ...
    function placeEditionBidFor(uint256 _editionId, address _bidder) external ;
...
interface IEditionSteppedMarketplace {
    ...
    function buyNextStep(uint256 _editionId) external ;
    function buyNextStepFor(uint256 _editionId, address _buyer) external ;
...
interface IReserveAuctionMarketplace {
    ...
    function placeBidOnReserveAuction(uint256 _id) external ;
    function placeBidOnReserveAuctionFor(uint256 _id, address _bidder) external ;
...
interface ITokenOffersMarketplace {
    ...
    function placeTokenBid(uint256 _tokenId) external ;
    function placeTokenBidFor(uint256 _tokenId, address _bidder) external ;
}
