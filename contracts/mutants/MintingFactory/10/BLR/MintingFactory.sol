...
BuyNowMarketplace {
    ...
    nonReentrant {
        ...
        uint256 tokenId = _facilitateNextPrimarySale(_editionId, offer.offer, offer.bidder, true);
    ...
    function _buyNextStep(uint256 _editionId, address _buyer) internal {
        ...
        uint256 tokenId = _facilitateNextPrimarySale(_editionId, expectedPrice, _buyer, false);
    ...
    function _processSale(uint256 _id, uint256 _paymentAmount, address _buyer, address) internal override returns (uint256) {
        return _facilitateNextPrimarySale(_id, _paymentAmount, _buyer, true);
    }
