...
BuyNowMarketplace {
    ...
    function _placeEditionBid(uint256 _editionId, address _bidder) internal onlyContract {
        require(!_isEditionListed(_editionId), "Edition is listed");
...
contract MintingFactory is Context {
    ...
    function _setupSalesMechanic(uint256 _editionId, SaleType _saleType, uint128 _startDate, uint128 _basePrice, uint128 _stepPrice) internal canMintAgain {
    ...
    function _setupRoyalties(uint256 _editionId, address _deployedHandler) internal canMintAgain {
    ...
    function _recordSuccessfulMint(address _account) internal canMintAgain {
