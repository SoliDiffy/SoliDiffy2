...
contract CTokenDeprecated is CTokenInterface, Exponential, TokenErrorReporter {
    ...
    function initialize(ComptrollerInterface comptroller_,
                        ...
                        uint8 decimals_) public nonReentrant {
     ...
     */
    function balanceOfUnderlying(address owner) external nonReentrant returns (uint) {
     ...
     */
    function accrueInterest() public nonReentrant returns (uint) {
     ...
     * @return (uint, uint) An error code (0=success, otherwise a failure, see ErrorReporter.sol), and the actual mint amount.
     */
    function mintFresh(address minter, uint mintAmount) internal nonReentrant returns (uint, uint) {
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function redeemFresh(address payable redeemer, uint redeemTokensIn, uint redeemAmountIn) internal nonReentrant returns (uint) {
     ...
     * @return (uint, uint) An error code (0=success, otherwise a failure, see ErrorReporter.sol), and the actual repayment amount.
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, CTokenInterface cTokenCollateral) internal nonReentrant returns (uint, uint) {
