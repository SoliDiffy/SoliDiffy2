...
library GLiquidityPoolManager
{
	...
	uint256 constant DEFAULT_BURNING_RATE = 4999999999999999; // 0.5%
	uint256 constant BURNING_INTERVAL = 6 days;
	uint256 constant MIGRATION_INTERVAL = 6 days;
	...
	function init(Self storage _self, address _stakesToken, address _sharesToken) public
	{
		...
		_self.liquidityPool = address(1);

		_self.burningRate = DEFAULT_BURNING_RATE;
		_self.lastBurningTime = 1;

		_self.migrationRecipient = address(1);
