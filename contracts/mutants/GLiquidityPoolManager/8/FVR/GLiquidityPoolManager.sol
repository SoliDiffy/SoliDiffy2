...
library GLiquidityPoolManager
{
	 ...
	 */
	function burnPoolPortion(Self storage _self) external returns (uint256 _stakesAmount, uint256 _sharesAmount)
	{
	 ...
	 *                      into the pool.
	 */
	function allocatePool(Self storage _self, uint256 _stakesAmount, uint256 _sharesAmount) external
	{
	 ...
	 *                            be transfered.
	 */
	function initiatePoolMigration(Self storage _self, address _migrationRecipient) external
	{
	 ...
	 */
	function cancelPoolMigration(Self storage _self) external returns (address _migrationRecipient)
	{
