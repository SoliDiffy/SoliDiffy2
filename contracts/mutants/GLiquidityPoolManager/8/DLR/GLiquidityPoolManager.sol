...
library GLiquidityPoolManager
{
	 ...
	 *                     token (gToken).
	 */
	function init(Self memory _self, address _stakesToken, address _sharesToken) public
	{
	 ...
	 */
	function hasMigrated(Self memory _self) public view returns (bool _hasMigrated)
	{
	 ...
	 */
	function gulpPoolAssets(Self memory _self) public
	{
	 ...
	 */
	function setBurningRate(Self memory _self, uint256 _burningRate) public
	{
	 ...
	 */
	function burnPoolPortion(Self memory _self) public returns (uint256 _stakesAmount, uint256 _sharesAmount)
	{
	 ...
	 *                      into the pool.
	 */
	function allocatePool(Self memory _self, uint256 _stakesAmount, uint256 _sharesAmount) public
	{
	 ...
	 *                            be transfered.
	 */
	function initiatePoolMigration(Self memory _self, address _migrationRecipient) public
	{
	 ...
	 */
	function cancelPoolMigration(Self memory _self) public returns (address _migrationRecipient)
	{
