...
library GLiquidityPoolManager
{
	 ...
	 *                     token (gToken).
	 */
	function init(Self storage _self, address _stakesToken, address _sharesToken) external
	{
	 ...
	 */
	function hasMigrated(Self storage _self) external view returns (bool _hasMigrated)
	{
	 ...
	 */
	function gulpPoolAssets(Self storage _self) external
	{
	 ...
	 */
	function setBurningRate(Self storage _self, uint256 _burningRate) external
	{
