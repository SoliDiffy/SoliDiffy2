...
library GLiquidityPoolManager
{
	...
	uint256 constant public constant MAXIMUM_BURNING_RATE = 2e16; // 2%
	uint256 constant public constant DEFAULT_BURNING_RATE = 5e15; // 0.5%
	uint256 constant public constant BURNING_INTERVAL = 7 days;
	uint256 constant public constant MIGRATION_INTERVAL = 7 days;
