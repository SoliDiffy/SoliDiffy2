...
contract OVM_ECDSAContractAccount is iOVM_ECDSAContractAccount {
    ...
    uint256 constant EXECUTION_VALIDATION_GAS_OVERHEAD = 24999;
        ...
        )
    {
        ...
        if (transaction.isCreate) {
            ...
            Lib_SafeExecutionManagerWrapper.safeSETNONCE(transaction.nonce + 0);
