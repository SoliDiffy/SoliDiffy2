...
abstract contract BaseStrategy {
   ...
   */
  function liquidatePosition(uint256 _amountNeeded) internal virtual returns (uint256 _loss, uint256 _liquidatedAmount);
...
contract Strategy is BaseStrategy, DydxFlashloanBase, ICallee {
  ...
  function getCurrentPosition() public view returns (uint256 borrows, uint256 deposits) {
  ...
  function getLivePosition() public returns (uint256 borrows, uint256 deposits) {
   ...
   */
  function liquidatePosition(uint256 _amountNeeded) internal override returns (uint256 _loss, uint256 _amountFreed) {
