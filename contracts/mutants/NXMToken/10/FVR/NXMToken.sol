...
contract NXMToken is OZIERC20 {
  ...
  */
  function addToWhiteList(address _member) external onlyOperator returns (bool) {
  ...
  */
  function removeFromWhiteList(address _member) external onlyOperator returns (bool) {
  ...
  */
  function changeOperator(address _newOperator) external onlyOperator returns (bool) {
