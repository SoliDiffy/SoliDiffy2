...
contract NXMToken is OZIERC20 {
  ...
  */
  function approve(address spender, uint256 value) public onlyOperator returns (bool) {
  ...
  */
  function burnFrom(address from, uint256 value) public onlyOperator returns (bool) {
  ...
  * @param value The amount to be transferred.
  */
  function _transfer(address to, uint256 value) internal onlyOperator {
  ...
  * @param amount The amount that will be created.
  */
  function _mint(address account, uint256 amount) internal onlyOperator {
  ...
  * @param amount The amount that will be burnt.
  */
  function _burn(address account, uint256 amount) internal onlyOperator {
  ...
  */
  function _burnFrom(address account, uint256 value) internal onlyOperator {
