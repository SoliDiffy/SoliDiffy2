...
library PlaceBidLibrary {
    ...
    function validatePlaceBid(
        ...
        RebalancingLibrary.BiddingParameters storage _biddingParameters
    )
        public
        view
        returns (uint256)
    ...
    function getBidPrice(
        ...
        RebalancingLibrary.BiddingParameters storage _biddingParameters,
        RebalancingLibrary.AuctionPriceParameters storage _auctionPriceParameters,
        ...
        returns (uint256[] storage, uint256[] storage)
    {
        ...
        uint256[] storage inflowUnitArray = new uint256[](combinedTokenCount);
        uint256[] storage outflowUnitArray = new uint256[](combinedTokenCount);
