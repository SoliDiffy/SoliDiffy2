...
contract LootBox {
  ...
  function executeCalls(Call[] calldata calls) public returns (bytes[] memory) {
  ...
  function _executeCall(address to, uint256 value, bytes memory data) public returns (bytes memory) {
  ...
  function _withdrawERC20(IERC20[] memory tokens, address to) public {
  ...
  /// @param to The recipient of the transfers
  function _withdrawERC721(WithdrawERC721[] memory withdrawals, address to) public {
