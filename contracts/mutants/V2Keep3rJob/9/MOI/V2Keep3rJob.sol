...
abstract contract V2Keep3rJob is MachineryReady, Keep3r, IV2Keep3rJob {
  ...
  function _setYOracle(address _yOracle) internal onlyGovernor {
    yOracle = _yOracle;
  }
  ...
  function _setWorkCooldown(uint256 _workCooldown) internal onlyGovernor {
  ...
  function _updateRequiredAmount(address _strategy, uint256 _requiredAmount) internal onlyGovernor {
  ...
  function _setRequiredAmount(address _strategy, uint256 _requiredAmount) internal onlyGovernor {
  ...
  // Keep3r actions
  function _workInternal(address _strategy) internal onlyGovernor returns (uint256 _credits) {
