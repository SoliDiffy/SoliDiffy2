...
contract DeltaNeutralVault is ERC20Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  uint64 public constant MAX_ALPACA_BOUNTY_BPS = 2500; // 25%

  uint8 public constant ACTION_WORK = 1;
  uint8 public constant ACTION_WRAP = 2;

  address public lpToken;
  address internal stableVault;
  address internal assetVault;

  address internal stableVaultWorker;
