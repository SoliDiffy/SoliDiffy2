...
contract DeltaNeutralVault is ERC20Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function pendingManagementFee() public view returns (uint256) {
    uint256 _secondsFromLastCollection = block.number - lastFeeCollected;
  ...
  function deposit(
    ...
    _outstandingBefore.nativeAmount = _outstandingBefore.nativeAmount - tx.gasprice;
