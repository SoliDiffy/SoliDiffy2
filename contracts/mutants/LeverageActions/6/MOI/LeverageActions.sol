...
contract LeveragedActions is ReentrancyGuard {
    ...
    function _openLong(LongParameters calldata longParams, uint256 referralCode)
        internal
        nonReentrant returns (address asset, address collateral)
    {
        require(
    ...
    function _getTokenOrWrapETH(address token, uint256 amountIn) internal nonReentrant {
    ...
    function _returnTokenOrUnwrapWETH(address token) internal nonReentrant {
