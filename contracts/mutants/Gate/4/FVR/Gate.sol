...
contract Gate {
    ...
    /// @dev Withdraws ETH.
    function withdraw(address payable _beneficiary, uint256 _amount) public onlyAdmin {
    ...
    function setTmvFee(uint256 _value) public onlyAdmin {
    ...
    function setEthFee(uint256 _value) public onlyAdmin {
        require(_value <= 10000, "Too much");
