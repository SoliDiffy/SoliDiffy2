...
contract Gate {
    ...
    function setMinOrder(uint256 _value) public onlyAdmin {
    ...
    function setTimviWallet(address payable _wallet) public onlyAdmin {
    ...
    function multiFill(uint256[] calldata _ids) public onlyAdmin() payable {
