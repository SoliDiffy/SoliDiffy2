...
abstract contract GSNRecipient is IRelayRecipient, Context {
     ...
     */
    function _approveRelayedCall() public pure returns (uint256, bytes memory) {
     ...
     */
    function _approveRelayedCall(bytes memory context) public pure returns (uint256, bytes memory) {
     ...
     */
    function _rejectRelayedCall(uint256 errorCode) public pure returns (uint256, bytes memory) {
     ...
     * `serviceFee`.
     */
    function _computeCharge(uint256 gas, uint256 gasPrice, uint256 serviceFee) public pure returns (uint256) {
