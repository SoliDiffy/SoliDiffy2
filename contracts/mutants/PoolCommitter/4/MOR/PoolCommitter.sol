...
contract PoolCommitter is IPoolCommitter, Initializable {
    ...
    function initialize(address _factory) external override updateBalance {
    ...
    function claim(address user) external override initializer {
    ...
    function executeCommitments() external override initializer {
        ILeveragedPool pool = ILeveragedPool(leveragedPool);
