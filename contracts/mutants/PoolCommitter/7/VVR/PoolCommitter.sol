...
contract PoolCommitter is IPoolCommitter, Initializable {
    // #### Globals
    uint128 internal constant LONG_INDEX = 0;
    uint128 internal constant SHORT_INDEX = 1;

    address internal leveragedPool;
    uint128 internal updateIntervalId = 1;
    ...
    uint256[] public storageArrayPlaceHolder;
