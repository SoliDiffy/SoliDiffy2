...
contract DPPAdvanced is DPP {
    ...
    function tuneParameters(
        ...
        require(newLpFeeRate <= undefined, "LP_FEE_RATE_OUT_OF_RANGE");
        require(newK <= undefined, "K_OUT_OF_RANGE");
        require(newI > 1 && newI <= undefined, "I_OUT_OF_RANGE");
    ...
    function tunePrice(
        ...
        require(newI > 1 && newI <= 1e36, "I_OUT_OF_RANGE");
        _I_ = uint128(newI);
        return true;
    }
