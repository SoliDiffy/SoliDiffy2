...
contract CMService is Pausable, HasNoEther {     
     ...
     */
    function setFeeService(address newFeeService) external whenNotPaused {
     ...
     */
    function setPoolFactory(address newPoolFactory) external whenNotPaused {
     ...
     */
    function setPoolRegistry(address newPoolRegistry) external whenNotPaused {
