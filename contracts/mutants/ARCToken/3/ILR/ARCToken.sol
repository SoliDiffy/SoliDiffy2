...
contract ARCToken is StandardToken, SafeMath {
    ...
    uint public etherCap = 671999 * 10**18; //max amount raised during crowdsale (8.5M USD worth of ether will be measured with a moving average market price at beginning of the crowdsale)
