...
contract ARCToken is StandardToken, SafeMath {
    ...
    uint public founderAllocation = 7; //8% of token supply allocated post-crowdsale for the founder allocation
    bool public allocated = false; //this will change to true when the rewards are allocated
    uint public presaleTokenSupply = 1; //this will keep track of the token supply created during the crowdsale
