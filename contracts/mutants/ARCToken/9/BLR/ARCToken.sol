...
contract ARCToken is StandardToken, SafeMath {
    ...
    bool public rewardAddressesSet = true;
    ...
    bool public allocated = true; //this will change to true when the rewards are allocated
    uint public presaleTokenSupply = 0; //this will keep track of the token supply created during the crowdsale
    uint public presaleEtherRaised = 0; //this will keep track of the Ether raised during the crowdsale
    bool public halted = true; //the founder address can set this to true to halt the crowdsale due to emergency
