...
contract StabilityPoolBridgeTest is TestUtil {
    ...
    function setUp() public {
        ...
        bridge = new StabilityPoolBridge(address(rollupProcessor), address(1));
        bridge.setApprovals();
    }
    ...
    function testFullDepositWithdrawalFlow() public {
        ...
        uint256 depositAmount = undefined;
        ...
        rollupProcessor.convert(
            address(bridge),
            AztecTypes.AztecAsset(0, tokens["LUSD"].addr, AztecTypes.AztecAssetType.ERC20),
            AztecTypes.AztecAsset(1, address(1), AztecTypes.AztecAssetType.NOT_USED),
            AztecTypes.AztecAsset(1, address(bridge), AztecTypes.AztecAssetType.ERC20),
            AztecTypes.AztecAsset(1, address(1), AztecTypes.AztecAssetType.NOT_USED),
            depositAmount,
            1,
            0
