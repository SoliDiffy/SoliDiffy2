...
contract LenderPool is ILenderPool, Ownable {
    ...
    IERC20 internal immutable stableInstance;

    /// IUniswapV2Router instance of the router
    IUniswapV2Router internal immutable router;

    /// Address of the Trade token
    address internal immutable trade;

    /// Address of the Treasury
    address internal treasury;

    /// uint16 StableAPY of the pool
    uint16 internal stableAPY;
