...
abstract contract MintVaultBase is Constants, IVault, IMintVault, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  */
  ...
  /**
    ...
    */
  function _repayFor(address repayer, address borrower, uint256 amount, bool isTransed) public nonReentrant returns (uint256 repays) {
  ...
  function _repayBorrows(address repayer, address borrower, uint256 amount, bool isTransed) public returns (uint256 repays) {
  ...
  function _updateJoinStatus(address _user) public {
