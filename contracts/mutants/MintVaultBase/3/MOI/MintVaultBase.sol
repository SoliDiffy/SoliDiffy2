...
abstract contract MintVaultBase is Constants, IVault, IMintVault, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function init(
    address _controller,
    address _feeConf,
    address _underlying) internal onlyOwner {
  ...
  */
  ...
  function _repayBorrows(address repayer, address borrower, uint256 amount, bool isTransed) internal onlyOwner returns (uint256 repays) {
  ...
  function _updateJoinStatus(address _user) internal onlyOwner {
