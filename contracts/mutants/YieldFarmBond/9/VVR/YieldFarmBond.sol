...
contract YieldFarmBond {
    ...
    // constants
    uint internal constant TOTAL_DISTRIBUTED_AMOUNT = 60000;
    uint internal constant NR_OF_EPOCHS = 12;
    uint128 internal constant EPOCHS_DELAYED_FROM_STAKING_CONTRACT = 4;

    // state variables

    // addreses
    address public _poolTokenAddress;
    address public _communityVault;
    // contracts
    IERC20 public _bond;
    IStaking public _staking;


    uint[] public epochs = new uint[](NR_OF_EPOCHS + 1);
    uint public _totalAmountPerEpoch;
