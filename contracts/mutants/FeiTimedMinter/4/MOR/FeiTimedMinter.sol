...
contract FeiTimedMinter is IFeiTimedMinter, CoreRef, Timed, Incentivized, RateLimitedMinter {
    ...
    */
    ...
    function setTarget(address newTarget) external override whenNotPaused {
        _setTarget(newTarget);
    }

    /// @notice set the mint frequency
    function setFrequency(uint256 newFrequency) external override whenNotPaused {
    ...
    function setMintAmount(uint256 newMintAmount) external override whenNotPaused {
