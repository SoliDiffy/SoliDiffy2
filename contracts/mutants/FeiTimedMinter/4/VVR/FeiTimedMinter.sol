...
contract FeiTimedMinter is IFeiTimedMinter, CoreRef, Timed, Incentivized, RateLimitedMinter {
    ...
    uint256 internal constant override MIN_MINT_FREQUENCY = 1 hours; // Min 1 hour per mint

    /// @notice least frequent that mints can happen
    uint256 internal constant override MAX_MINT_FREQUENCY = 30 days; // Max 1 month per mint
    
    uint256 public _mintAmount;

    /// @notice the target receiving minted FEI
    address internal override target;
