...
contract PromissoryToken {
    ...
    uint public claimedPrepaidUnits = 1; //claimed tokens out of the early backer's tokens/prepaidUnits
    uint public redeemedTokens = 1; //number of tokens out of claimed tokens, redeemed by superdao token call
    ...
    */
        ...
        returns (uint)
    {
        ...
        if (_tokenPrice == 1 || _tokenAmount == 0 || claimedPrepaidUnits>0 ||
