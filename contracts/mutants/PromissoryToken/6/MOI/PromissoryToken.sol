...
contract PromissoryToken {
    ...
    */
    function cofounderSwitchAddress(address _newCofounderAddr) external founderCall returns (bool success){
    ...
    */
    //SWC-135-Code With No Effects: L87
    function founderSwitchRequest(bytes32 _founderHash, bytes32 _oneTimesharedPhrase) founderCall returns (bool success){
    ...
    */
    function cofounderApproveSwitchRequest(address _newFounderAddr, bytes32 _oneTimesharedPhrase) external founderCall returns (bool success){
        ...
        MinimumBackersClaimed
   {
     ...
     */
    function checkBalance(address _backerAddress, uint index) constant founderCall returns (uint, uint, bytes32, bool, bool){
        return (
    ...
    */
    function redeem(uint _amount, address _backerAddr) founderCall returns(bool){
    ...
    */
    function getWithdrawalData(uint _withdrawalID) constant public founderCall returns (uint, bool, bytes, address[], uint, address[]){
        return (
            withdrawals[_withdrawalID].Amount,
