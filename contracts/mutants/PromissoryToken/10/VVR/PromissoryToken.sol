...
contract PromissoryToken {
    ...
    uint internal claimedUnits = 0; //claimed tokens out of 3 million tokens
    uint internal claimedPrepaidUnits = 0; //claimed tokens out of the early backer's tokens/prepaidUnits
    uint internal redeemedTokens = 0; //number of tokens out of claimed tokens, redeemed by superdao token call
