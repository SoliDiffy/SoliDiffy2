...
contract PromissoryToken {
    ...
    */
    function cofounderSwitchAddress(address _newCofounderAddr) public returns (bool success){
    ...
    */
    function cofounderApproveSwitchRequest(address _newFounderAddr, bytes32 _oneTimesharedPhrase) public returns (bool success){
