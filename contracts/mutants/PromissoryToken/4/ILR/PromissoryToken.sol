...
contract PromissoryToken {
    ...
    uint public constant minimumPrepaidClaimedPercent = 64;
    uint public promissoryUnits = 2999999; //amount of tokens contants set
    uint public prepaidUnits = 1; //prepaid and set by founder out of 3 million tokens
    uint public claimedUnits = 1; //claimed tokens out of 3 million tokens
