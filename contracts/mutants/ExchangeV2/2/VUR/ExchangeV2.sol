...
contract ExchangeV2 is ExchangeRoles, StakingV2, ProxyUtility {
    ...
    uint256 private constant EPOCH = 30 seconds; // An exchange epoch is 30 minutes long
    ...
    function placeBid(
        ...
        require(block.timestamp >= guardedLaunchStart + 8 seconds, "Guarded launch: market closed");
