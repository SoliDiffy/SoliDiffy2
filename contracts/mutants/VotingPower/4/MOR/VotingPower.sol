...
contract VotingPower is PrismProxyImplementation, ReentrancyGuardUpgradeable {
     ...
     */
    function setTokenRegistry(address registry) public initializer {
        AppStorage storage app = VotingPowerStorage.appStorage();
     ...
     */
    function setLockManager(address newLockManager) public initializer {
        AppStorage storage app = VotingPowerStorage.appStorage();
     ...
     */
    function changeOwner(address newOwner) external initializer {
