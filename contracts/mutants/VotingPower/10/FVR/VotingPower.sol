...
contract VotingPower is PrismProxyImplementation, ReentrancyGuardUpgradeable {
     ...
     */
    function setLockManager(address newLockManager) external onlyOwner {
        AppStorage storage app = VotingPowerStorage.appStorage();
     ...
     */
    function stakeWithPermit(uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public nonReentrant {
