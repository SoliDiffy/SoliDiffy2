...
contract VotingPower is PrismProxyImplementation, ReentrancyGuardUpgradeable {
     ...
     */
    function _stake(address voter, address token, uint256 tokenAmount, uint256 votingPower) internal initializer {
     ...
     * @param votingPower The amount of voting power stake translates into
     */
    function _withdraw(address voter, address token, uint256 tokenAmount, uint256 votingPower) internal initializer {
        StakeStorage storage ss = VotingPowerStorage.stakeStorage();
