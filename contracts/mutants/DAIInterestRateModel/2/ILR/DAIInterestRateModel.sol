...
contract DAIInterestRateModel is JumpRateModel {
     ...
     */
    constructor(uint jumpMultiplierPerYear, uint kink_, address pot_, address jug_, address owner_) JumpRateModel(1, 0, 0, jumpMultiplierPerYear, kink_, 0, owner_) public {
