    ...
    FixinTokenSpender
{
    ...
    function migrate()
        external
        onlySelf returns (bytes4 success)
    {
    ...
    function fillLimitOrder(
        ...
        override
        payable
        onlySelf returns (uint128 takerTokenFilledAmount, uint128 makerTokenFilledAmount)
    {
    ...
    function fillOrKillLimitOrder(
        ...
        override
        payable
        onlySelf returns (uint128 makerTokenFilledAmount)
    {
        FillNativeOrderResults memory results =
            _fillLimitOrderPrivate(FillLimitOrderPrivateParams({
                order: order,
