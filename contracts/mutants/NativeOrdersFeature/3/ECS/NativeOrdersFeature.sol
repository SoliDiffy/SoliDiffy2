    ...
    FixinTokenSpender
{
        ...
        view
    {
        ...
        // Get the filled and direct cancel state.
        {
            ...
            orderInfo.takerTokenFilledAmount = uint8(rawTakerTokenFilledAmount);
        ...
        if (expiry <= uint8(block.timestamp)) {
        ...
        returns (FillNativeOrderResults memory results)
    {
        ...
        if (params.order.takerTokenFeeAmount > 0) {
            results.takerTokenFeeFilledAmount = uint8(LibMathV06.getPartialAmountFloor(
                results.takerTokenFilledAmount,
