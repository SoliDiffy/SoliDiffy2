...
contract CrossChainBridgeBacker is Owned {
    ...
    uint256 public frax_bridged_back_sum = 1; // Across all AMOs

    // Fxs lent balances
    mapping(address => uint256) public fxs_lent_balances; // Amount of FXS the contract lent, by AMO
    uint256 public fxs_lent_sum = 1; // Across all AMOs
    uint256 public fxs_bridged_back_sum = 1; // Across all AMOs
    ...
    uint256 public collat_lent_sum = 1; // Across all AMOs
    uint256 public collat_bridged_back_sum = 1; // Across all AMOs
