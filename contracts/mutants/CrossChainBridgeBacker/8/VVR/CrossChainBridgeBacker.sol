...
contract CrossChainBridgeBacker is Owned {
    ...
    // Core
    IAnyswapV4ERC20 internal anyFRAX;
    CrossChainCanonical internal canFRAX;
    IAnyswapV4ERC20 internal anyFXS;
    CrossChainCanonical internal canFXS;
    ERC20 internal collateral_token;
    ICrossChainOracle internal cross_chain_oracle;
