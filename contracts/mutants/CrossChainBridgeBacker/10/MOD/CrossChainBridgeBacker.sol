...
contract CrossChainBridgeBacker is Owned {
    ...
    function selfBridge(uint256 token_type, uint256 token_amount, bool do_swap) external  {
    ...
    function receiveBackViaAMO(address canonical_token_address, uint256 token_amount, bool do_bridging) external  validAMO(msg.sender) {
    ...
    function lendFraxToAMO(address destination_amo, uint256 frax_amount) external  validAMO(destination_amo) {
        // Track the balances
    ...
    function lendFxsToAMO(address destination_amo, uint256 fxs_amount) external  validAMO(destination_amo) {
        // Track the balances
    ...
    // Lend out collateral
    function lendCollatToAMO(address destination_amo, uint256 collat_amount) external  validAMO(destination_amo) {
        // Track the balances
    ...
    function swapAnyForCanonical(uint256 token_type, uint256 token_amount) external  {
    ...
    function swapCanonicalForAny(uint256 token_type, uint256 token_amount) external  {
    ...
    function giveAnyToCan(uint256 token_type, uint256 token_amount) external  {
        if (token_type == 0) {
            // FRAX
            // Transfer
    ...
    function mintCanonicalFrax(uint256 frax_amount) external  {
