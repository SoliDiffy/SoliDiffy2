...
contract CrossChainBridgeBacker is Owned {
    ...
    // Optionally bridge
    function _receiveBack(address from_address, uint256 token_type, uint256 token_amount, bool do_bridging, bool do_swap) public {
    ...
    function lendFraxToAMO(address destination_amo, uint256 frax_amount) public onlyByOwnGov validAMO(destination_amo) {
        // Track the balances
