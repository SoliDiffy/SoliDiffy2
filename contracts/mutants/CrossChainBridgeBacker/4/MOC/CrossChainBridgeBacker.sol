...
contract CrossChainBridgeBacker is Owned {
    ...
    function receiveBackViaAMO(address canonical_token_address, uint256 token_amount, bool do_bridging) external validAMO(msg.sender) validCanonicalToken(canonical_token_address) {
    ...
    function lendFraxToAMO(address destination_amo, uint256 frax_amount) external validAMO(destination_amo) onlyByOwnGov {
        // Track the balances
    ...
    function lendFxsToAMO(address destination_amo, uint256 fxs_amount) external validAMO(destination_amo) onlyByOwnGov {
        // Track the balances
    ...
    // Lend out collateral
    function lendCollatToAMO(address destination_amo, uint256 collat_amount) external validAMO(destination_amo) onlyByOwnGov {
        // Track the balances
