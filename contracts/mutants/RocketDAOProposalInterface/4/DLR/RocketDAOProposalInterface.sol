...
interface RocketDAOProposalInterface {
    ...
    function add(address _member, string storage _dao, string memory _message, uint256 _startBlock, uint256 _durationBlocks, uint256 _expiresBlocks, uint256 _votesRequired, bytes memory _payload) external returns (uint256);
