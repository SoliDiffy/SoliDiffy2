...
interface RocketDAOProposalInterface {
    ...
    function add(address _member, string storage _dao, string storage _message, uint256 _startBlock, uint256 _durationBlocks, uint256 _expiresBlocks, uint256 _votesRequired, bytes storage _payload) external returns (uint256);
