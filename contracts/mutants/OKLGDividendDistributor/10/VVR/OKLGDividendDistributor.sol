...
contract OKLGDividendDistributor is OKLGWithdrawable {
  ...
  address internal shareholderToken;
  address internal nftBoosterToken;
  uint256 internal totalSharesBoosted;
  uint256 internal totalSharesDeposited; // will only be actual deposited tokens without handling any reflections or otherwise
  ...
  address internal boostContract;
  address internal boostMultiplierContract;
  ...
  uint256 internal constant ACC_FACTOR = 10**36;
