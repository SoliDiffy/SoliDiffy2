...
contract TestCosigner is Cosigner, BytesUtils {
    bytes32 internal dummyCost = bytes32(uint256(1 * 10**18));
    bytes internal data = buildData(keccak256("test_oracle"), dummyCost);
    bytes internal badData = buildData(keccak256("bad_data"), dummyCost);
