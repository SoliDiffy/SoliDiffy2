...
contract TestCosigner is Cosigner, BytesUtils {
    ...
    bytes public data = buildData(sha256("test_oracle"), dummyCost);
    bytes public badData = buildData(sha256("bad_data"), dummyCost);
    ...
    function requestCosign(Engine engine, uint256 index, bytes data, bytes) returns (bool) {
        if(readBytes32(data, 0) == sha256("test_oracle")) {
