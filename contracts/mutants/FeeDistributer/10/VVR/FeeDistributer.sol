...
contract FeeDistributor {
    ...
    address internal _BASE_TOKEN_;
    address internal _QUOTE_TOKEN_;
    uint256 internal _BASE_RESERVE_;
    uint256 internal _QUOTE_RESERVE_;

    address internal _STAKE_VAULT_;
    address internal _STAKE_TOKEN_;
    uint256 internal _STAKE_RESERVE_;

    uint256 internal _BASE_REWARD_RATIO_;
    mapping(address => uint256) public _USER_BASE_REWARDS_;
    mapping(address => uint256) public _USER_BASE_PER_SHARE_;

    uint256 internal _QUOTE_REWARD_RATIO_;
