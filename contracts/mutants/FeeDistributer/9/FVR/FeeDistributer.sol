...
contract FeeDistributor {
    ...
    function _claim(address sender, address to) public {
    ...
    function _updateGlobalState() public {
        uint256 baseInput = IERC20(_BASE_TOKEN_).balanceOf(address(this)).sub(_BASE_RESERVE_);
        uint256 quoteInput = IERC20(_QUOTE_TOKEN_).balanceOf(address(this)).sub(_QUOTE_RESERVE_);
    ...
    function _updateUserReward(address user) public {
    ...
    function _addShares(uint256 amount, address to) public {
