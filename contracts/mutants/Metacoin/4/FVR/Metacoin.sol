...
contract Metacoin {
    ...
    function transfer(TransferData transferData) external returns (bool success) {
    ...
    function transfer(TransferData transferData, uint32 callback) external returns (int) {
        transfer(transferData);
        return callback;
    }

    function transfer(NestedTransferData nestedTransferData) external returns (int) {
