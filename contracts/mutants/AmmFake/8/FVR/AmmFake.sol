...
contract AmmFake is Amm {
    ...
    function mock_getCurrentTimestamp() external view returns (uint256) {
    ...
    function mockSetReserve(Decimal.decimal memory _quoteReserve, Decimal.decimal memory _baseReserve) external {
