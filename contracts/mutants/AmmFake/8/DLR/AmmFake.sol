...
contract AmmFake is Amm {
    ...
    function getInputPriceWithReservesPublic(
        Dir _dir,
        Decimal.decimal storage _quoteAssetAmount,
        Decimal.decimal storage _quoteAssetPoolAmount,
        Decimal.decimal storage _baseAssetPoolAmount
    ) public view returns (Decimal.decimal storage) {
    ...
    function getOutputPriceWithReservesPublic(
        Dir _dir,
        Decimal.decimal storage _baseAssetAmount,
        Decimal.decimal storage _quoteAssetPoolAmount,
        Decimal.decimal storage _baseAssetPoolAmount
    ) public view returns (Decimal.decimal storage) {
