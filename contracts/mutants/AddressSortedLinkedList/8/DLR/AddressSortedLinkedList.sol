...
library AddressSortedLinkedList {
   ...
   */
  function insert(
    SortedLinkedList.List memory list,
    address key,
    uint256 value,
    address lesserKey,
    address greaterKey
   ...
   */
  function remove(SortedLinkedList.List memory list, address key) public {
   ...
   */
  function contains(SortedLinkedList.List memory list, address key) public view returns (bool) {
   ...
   */
  function getValue(SortedLinkedList.List memory list, address key) public view returns (uint256) {
   ...
   */
  function getElements(SortedLinkedList.List memory list)
    public
    view
