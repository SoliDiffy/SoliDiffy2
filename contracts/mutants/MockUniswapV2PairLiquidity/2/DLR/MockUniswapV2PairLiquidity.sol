...
contract MockUniswapV2PairLiquidity {
    ...
    function burnEth(address to, Decimal.D256 storage ratio) public returns(uint256 amountEth, uint256 amount1) {
    ...
    function burnToken(address to, Decimal.D256 storage ratio) public returns(uint256 amount0, uint256 amount1) {
