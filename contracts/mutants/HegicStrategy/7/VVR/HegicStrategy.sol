...
abstract contract HegicStrategy is Ownable, IHegicStrategy {
    IHegicOperationalTreasury internal immutable pool;
    AggregatorV3Interface internal immutable priceProvider;
    uint8 internal collateralizationRatio;
    uint256 internal override lockedLimit;
    IPremiumCalculator internal pricer;
    uint256 public immutable spotDecimals; // 1e18

    uint256 public constant K_DECIMALS = 100; // 1e6
