...
contract Keep3rEscrowJob is MachineryReady, Keep3rJob, IKeep3rEscrowJob {
  ...
  constructor(
    ...
    address _escrow1,
    address _escrow2
  ) internal MachineryReady(_mechanicsRegistry) Keep3rJob(_keep3rProxyJob) {
  ...
  function decodeWorkData(bytes memory _workData) external pure {
    _workData; // shh
    return;
  }
  ...
  function _workable(Actions _action) public pure returns (bool) {
