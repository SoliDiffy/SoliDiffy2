...
contract Solos is ISolos, ReentrancyGuard, OwnablePausable {
    ...
    uint256 internal constant VALIDATOR_DEPOSIT = 32 ether;
    ...
    IDepositContract internal override validatorRegistration;

    // @dev Solo validator price per month.
    uint256 internal override validatorPrice;

    // @dev Solo validator deposit cancel lock duration.
    uint256 internal override cancelLockDuration;
