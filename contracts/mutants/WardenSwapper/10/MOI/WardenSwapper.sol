...
contract WardenSwapper is OwnableUpgradeable {
   ...
   /* ========== Private Functions ========== */
    ...
    function _swapWBNBtoCRAFT(uint value, address receiver, uint amountOutMin) private initializer returns (uint) {
        address[] memory path;
    ...
    function _swap(address _from, uint amount, address _to, address receiver) private initializer returns (uint) {
        address[] memory path;
    ...
    function _swapInPool(address _from, uint amount, address _to, address receiver) private initializer returns (uint) {
        address[] memory path;
