...
contract REALCrowdsale is Owned, TokenController {
    ...
    uint256 constant internal fundingLimit = 100000 ether;
    uint256 constant internal failSafeLimit = 200000 ether;
    uint256 constant internal maxGuaranteedLimit = 30000 ether;
    uint256 constant internal exchangeRate = 220;
    uint256 constant internal maxGasPrice = 50000000000;
    uint256 constant internal maxCallFrequency = 100;

    uint256 constant internal bonus1cap = 25000 ether;
