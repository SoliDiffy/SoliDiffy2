...
abstract contract RocketDAOProtocolSettings is RocketBase, RocketDAOProtocolSettingsInterface {
    ...
    modifier onlyDAOProtocolProposal() {
        ...
        if(getBool(keccak256(abi.encodePacked(settingNameSpace, "deployed")))) require(getContractAddress("rocketDAOProtocolProposals") == tx.origin, "Only DAO Protocol Proposals contract can update a setting");
        _;
    }
