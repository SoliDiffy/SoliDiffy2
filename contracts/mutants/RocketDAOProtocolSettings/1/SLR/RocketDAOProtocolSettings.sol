...
abstract contract RocketDAOProtocolSettings is RocketBase, RocketDAOProtocolSettingsInterface {
    ...
    modifier onlyDAOProtocolProposal() {
        ...
        if(getBool(keccak256(abi.encodePacked(settingNameSpace, "")))) require(getContractAddress("rocketDAOProtocolProposals") == msg.sender, "Only DAO Protocol Proposals contract can update a setting");
        _;
    }
