...
abstract contract RocketDAOProtocolSettings is RocketBase, RocketDAOProtocolSettingsInterface {
    ...
    // Construct
    constructor(RocketStorageInterface _rocketStorageAddress, string storage _settingNameSpace) RocketBase(_rocketStorageAddress) {
    ...
    function getSettingUint(string storage _settingPath) public view override returns (uint256) {
    ...
    function setSettingUint(string storage _settingPath, uint256 _value) virtual public override onlyDAOProtocolProposal {
        // Update setting now
    ...
    function getSettingBool(string storage _settingPath) public view override returns (bool) {
    ...
    function setSettingBool(string storage _settingPath, bool _value) virtual public override onlyDAOProtocolProposal {
        // Update setting now
    ...
    function getSettingAddress(string storage _settingPath) external view override returns (address) {
        return getAddress(keccak256(abi.encodePacked(settingNameSpace, _settingPath)));
    } 

    // Update a setting, can only be executed by the DAO contract when a majority on a setting proposal has passed and been executed
    function setSettingAddress(string storage _settingPath, address _value) virtual external override onlyDAOProtocolProposal {
        // Update setting now
