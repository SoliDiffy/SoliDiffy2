...
contract UsdPlusToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setLiquidityIndex(uint256 _liquidityIndex) public onlyExchanger {
    ...
    function mint(address _sender, uint256 _amount) public onlyExchanger {
        // up to ray
    ...
    function burn(address _sender, uint256 _amount) public onlyExchanger {
        // up to ray
