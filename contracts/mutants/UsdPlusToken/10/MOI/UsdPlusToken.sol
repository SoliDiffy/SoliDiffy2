...
contract UsdPlusToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
     ...
     */
    function _mint(address account, uint256 amount) internal  onlyAdmin {
    ...
    * @dev Destroys `amount` tokens from `account`, reducing the
     ...
     */
    function _burn(address account, uint256 amount) internal  onlyAdmin {
     ...
     */
    function transfer(address recipient, uint256 amount) public override onlyAdmin returns (bool) {
        // up to ray
    ...
    * @dev See {IERC20-allowance}.
     ...
     */
    function approve(address spender, uint256 amount) external override onlyAdmin returns (bool){
        // up to ray
    ...
    * @dev See {IERC20-balanceOf}.
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) public  onlyAdmin returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public  onlyAdmin returns (bool) {
