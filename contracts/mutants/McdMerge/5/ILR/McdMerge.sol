...
contract McdMerge is ActionBase {
    ...
    function executeAction(
        ...
        destVaultId = _parseParamUint(destVaultId, _paramMapping[0], _subData, _returnValues);
    ...
    {
        srcVaultId = abi.decode(_callData[1], (uint256));
        destVaultId = abi.decode(_callData[0], (uint256));
