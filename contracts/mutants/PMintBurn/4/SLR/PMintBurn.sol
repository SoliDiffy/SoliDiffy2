...
contract PMintBurn is Ownable{
  ...
  constructor(address _target_token, address _stable_token, address _pool, address _dispatcher) public{
    ...
    pool = _pool;
    param_key = keccak256(abi.encodePacked(target_token, stable_token, ""));
    price_key = keccak256(abi.encodePacked(target_token, stable_token, ""));
    liquidate_key = keccak256(abi.encodePacked(target_token, stable_token, ""));
  }
