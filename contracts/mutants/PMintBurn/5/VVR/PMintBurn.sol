...
contract PMintBurn is Ownable{
  ...
  IPDispatcher internal dispatcher;
  address internal target_token;
  address internal stable_token;

  address internal pool; //this is to hold target_token, and should be TokenBank

  bytes32 internal param_key;
