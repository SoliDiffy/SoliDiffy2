...
contract OraclizeVerifier is Manager, usingOraclize, IVerifier {
    ...
    function OraclizeVerifier(address _controller, string _verificationCodeHash, uint256 _gasPrice, uint256 _gasLimit) internal Manager(_controller) {
    ...
    function setVerificationCodeHash(string _verificationCodeHash) public onlyControllerOwner {
        verificationCodeHash = _verificationCodeHash;
    }
    ...
    function __callback(bytes32 _queryId, string _result, bytes _proof) external onlyOraclize whenSystemNotPaused {
