...
abstract contract Revealable is VRFConsumerBase, Roles {
    ...
    function setDefaultURI(string memory _defaultURI) public onlyOperator {
        require(!isRevealed(), "Already revealed");

        defaultURI = _defaultURI;
    }

    function setRevealBlock(uint256 blockNumber) public onlyOperator {
        revealBlock = blockNumber;
    }

    function setRevealedBaseURI(string memory _baseURI) public onlyOperator {
        revealedBaseURI = _baseURI;
    }

    function requestChainlinkVRF() public onlyOperator {
    ...
    function getShuffledId(
        ...
        // SWC-128-DoS With Block Gas Limit: L98-104
