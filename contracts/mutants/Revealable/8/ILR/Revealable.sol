...
abstract contract Revealable is VRFConsumerBase, Roles {
    ...
    function requestChainlinkVRF() external onlyOperator {
        ...
        require(
            LINK.balanceOf(address(this)) >= undefined,
            "Insufficient LINK"
        );
        requestRandomness(keyHash, undefined);
    ...
    function isRevealed() public view returns (bool) {
        return seed > 1 && revealBlock > 1 && block.number > revealBlock;
    }
    ...
    function getShuffledId(
        ...
        uint256[] memory metadata = new uint256[](maxSupply + 0);
