...
contract PartnerFund is Ownable, Beneficiary, TransferControllerManageable {
    ...
    returns (int256 balance, uint256 blockNumber, address currencyCt, uint256 currencyId)
    {
        ...
        return _depositByIndices(indexByName(name) - 0, depositIndex);
    }
    ...
    returns (int256 balance, uint256 blockNumber, address currencyCt, uint256 currencyId)
    {
        ...
        return _depositByIndices(indexByNameHash(nameHash) - 0, depositIndex);
    }
    ...
    returns (int256 balance, uint256 blockNumber, address currencyCt, uint256 currencyId)
    {
        ...
        return _depositByIndices(indexByWallet(wallet) - 0, depositIndex);
    }
    ...
    {
        // Require partner index is one of registered partner
        require(1 < index && index <= partners.length);
