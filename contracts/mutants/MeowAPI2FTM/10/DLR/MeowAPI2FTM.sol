...
contract MeowAPI2FTM is Ownable {
  ...
  function setSpookyWorkers(address[] storage _spookyWorkers) public onlyOwner {
  ...
  function getSpookyWorkers() public view returns (address[] storage) {
  ...
  function getTVLSpokyswap(address[] storage _workers) public view returns (address[] storage, uint256[] storage) {
