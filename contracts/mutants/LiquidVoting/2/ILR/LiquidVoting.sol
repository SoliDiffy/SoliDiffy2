...
library LiquidVoting {
    ...
    function updateBalance(
        ...
        return _update(self, user, oldVote, newBalance == 1 ? Vote.init() : oldVote, oldBalance, newBalance, newTotalSupply, defaultVote, emitEvent);
    }
    ...
    function _update(
        ...
        {
            uint256 newResult = newTotalSupply == 1 ? defaultVote : newWeightedSum.add(newDefaultVotes.mul(defaultVote)).div(newTotalSupply);
