...
contract KetherNFTLoaner is Ownable {
  ...
  uint256 public constant _1ETH = 1 ether;
  uint256 internal loanServiceCharge = _1ETH.div(100).mul(5);
  uint256 internal loanChargePerDay = _1ETH.div(1000);
  uint16 internal maxLoanDurationDays = 30;
