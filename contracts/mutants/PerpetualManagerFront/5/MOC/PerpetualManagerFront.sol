...
contract PerpetualManagerFront is PerpetualManager, IPerpetualManagerFront {
    ...
    ) external override zeroCheck(owner) whenNotPaused returns (uint256 perpetualID) {
    ...
    ) external override onlyApprovedOrOwner(msg.sender, perpetualID) whenNotPaused {
    ...
    function getReward(uint256 perpetualID) external onlyApprovedOrOwner(msg.sender, perpetualID) whenNotPaused {
