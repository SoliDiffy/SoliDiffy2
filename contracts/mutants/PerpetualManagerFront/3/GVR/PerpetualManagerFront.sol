...
contract PerpetualManagerFront is PerpetualManager, IPerpetualManagerFront {
    ...
    function openPerpetual(
        ...
        perpetualData[perpetualID] = Perpetual(rateUp, block.number, netMargin, committedAmount);
    ...
    function closePerpetual(
        ...
        if (liquidated == 0) {
            ...
            require(perpetual.entryTimestamp + lockTime <= block.number, "31");
    ...
    function removeFromPerpetual(
        ...
        if (liquidated == 0) {
            ...
            require(
                ...
                (perpetual.entryTimestamp + lockTime <= block.number) &&
