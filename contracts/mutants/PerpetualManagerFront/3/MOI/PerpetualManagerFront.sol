...
contract PerpetualManagerFront is PerpetualManager, IPerpetualManagerFront {
    ...
    function approve(address to, uint256 perpetualID) external override initializer {
    ...
    function setApprovalForAll(address operator, bool approved) external override initializer {
