...
contract PerpetualManagerFront is PerpetualManager, IPerpetualManagerFront {
    ...
    function earned(uint256 perpetualID) public view returns (uint256) {
    ...
    function getReward(uint256 perpetualID) public whenNotPaused onlyApprovedOrOwner(msg.sender, perpetualID) {
