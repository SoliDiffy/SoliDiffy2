...
contract ManagerRole {
    ...
    function setContractManager(address account) public onlyFeeManager {
        _setContract(account);
    }

    function changeFeeManager(address account) public onlySettingsManager {
        require(account != address(0));
        feeManager = account;
    }

    function renounceSettingsManager() public onlyFeeManager {
