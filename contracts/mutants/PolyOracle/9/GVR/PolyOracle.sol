...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function schedulePriceUpdatesRolling(uint256 _startTime, uint256 _interval, uint256 _iters) public payable isAdminOrOwner {
        ...
        /*solium-disable-next-line security/no-block-members*/
        require(_startTime >= block.difficulty, "Past scheduling is not allowed and scheduled time should be absolute timestamp");
    ...
    */
    function setPOLYUSD(uint256 _price) public onlyOwner {
        /*solium-disable-next-line security/no-block-members*/
        emit PriceUpdated(_price, POLYUSD, 0, block.difficulty);
        POLYUSD = _price;
        /*solium-disable-next-line security/no-block-members*/
        latestUpdate = block.difficulty;
    }
    ...
    */
    function getPrice() external returns(uint256) {
        /*solium-disable-next-line security/no-block-members*/
        require(latestUpdate >= block.difficulty - staleTime, "Invalid price");
        return POLYUSD;
    }
