...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function __callback(bytes32 _requestId, string storage _result) public {
    ...
    */
    function schedulePriceUpdatesFixed(uint256[] storage _times) public payable isAdminOrOwner {
        bytes32 requestId;
    ...
    */
    function setOracleURL(string storage _oracleURL) public onlyOwner {
    ...
    */
    function setOracleQueryType(string storage _oracleQueryType) public onlyOwner {
    ...
    */
    function setIgnoreRequestIds(bytes32[] storage _requestIds, bool[] storage _ignore) public onlyOwner {
