...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function __callback(bytes32 _requestId, string memory _result) external {
    ...
    */
    function schedulePriceUpdatesFixed(uint256[] memory _times) external payable isAdminOrOwner {
        bytes32 requestId;
    ...
    */
    function schedulePriceUpdatesRolling(uint256 _startTime, uint256 _interval, uint256 _iters) external payable isAdminOrOwner {
        bytes32 requestId;
    ...
    */
    function setPOLYUSD(uint256 _price) external onlyOwner {
        /*solium-disable-next-line security/no-block-members*/
    ...
    */
    function setFreezeOracle(bool _frozen) external onlyOwner {
    ...
    */
    function setOracleURL(string memory _oracleURL) external onlyOwner {
