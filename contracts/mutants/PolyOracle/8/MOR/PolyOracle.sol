...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function setOracleURL(string memory _oracleURL) public isAdminOrOwner {
    ...
    */
    function setOracleQueryType(string memory _oracleQueryType) public isAdminOrOwner {
    ...
    */
    function setSanityBounds(uint256 _sanityBounds) public isAdminOrOwner {
    ...
    */
    function setGasPrice(uint256 _gasPrice) public isAdminOrOwner {
