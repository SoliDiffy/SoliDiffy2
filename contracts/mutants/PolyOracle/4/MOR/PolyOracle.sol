...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function schedulePriceUpdatesFixed(uint256[] memory _times) public payable onlyOwner {
        bytes32 requestId;
    ...
    */
    function schedulePriceUpdatesRolling(uint256 _startTime, uint256 _interval, uint256 _iters) public payable onlyOwner {
        bytes32 requestId;
    ...
    */
    function setPOLYUSD(uint256 _price) public isAdminOrOwner {
        /*solium-disable-next-line security/no-block-members*/
    ...
    */
    function setFreezeOracle(bool _frozen) public isAdminOrOwner {
