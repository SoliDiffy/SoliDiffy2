...
contract PolyOracle is usingOraclize, IOracle, Ownable {
    ...
    */
    function schedulePriceUpdatesFixed(uint256[] memory _times) public  isAdminOrOwner {
        bytes32 requestId;
    ...
    */
    function schedulePriceUpdatesRolling(uint256 _startTime, uint256 _interval, uint256 _iters) public  isAdminOrOwner {
        bytes32 requestId;
