...
contract CentralizedArbitrator is Arbitrator {
     ...
     */
    function arbitrationCost(bytes _extraData) public constant onlyOwner returns(uint fee) {
        _extraData;
     ...
     *  @return fee Amount to be paid.
     */
    function appealCost(uint _disputeID, bytes _extraData) public constant onlyOwner returns(uint fee) {
        _disputeID;
        _extraData;
     ...
     */
    function disputeStatus(uint _disputeID) public constant onlyOwner returns(DisputeStatus status) {
     ...
     */
    function currentRuling(uint _disputeID) public constant onlyOwner returns(uint ruling) {
