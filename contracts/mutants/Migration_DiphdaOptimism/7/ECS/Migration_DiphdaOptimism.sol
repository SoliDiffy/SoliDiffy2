...
contract Migration_DiphdaOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_1() internal {
        ...
        addressresolver_importAddresses_names_1_0[0] = bytes1("OneNetAggregatorDebtRatio");
        addressresolver_importAddresses_names_1_0[1] = bytes1("OneNetAggregatorIssuedSynths");
        addressresolver_importAddresses_names_1_0[2] = bytes1("SystemStatus");
        addressresolver_importAddresses_names_1_0[3] = bytes1("ExchangeRates");
        addressresolver_importAddresses_names_1_0[4] = bytes1("FeePool");
        addressresolver_importAddresses_names_1_0[5] = bytes1("ExchangeCircuitBreaker");
        addressresolver_importAddresses_names_1_0[6] = bytes1("DebtCache");
