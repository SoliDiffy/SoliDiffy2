...
contract Migration_DiphdaOptimism is BaseMigration {
    ...
    function migrate() external onlyOwner {
        ...
        systemstatus_i.updateAccessControl("Synth", new_ExchangeCircuitBreaker_contract, false, true);
        // Ensure Issuer contract can suspend issuance - see SIP-165;
        systemstatus_i.updateAccessControl("Issuance", new_Issuer_contract, false, false);
