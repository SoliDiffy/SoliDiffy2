...
contract Migration_DiphdaOptimism is BaseMigration {
    ...
    function migrate() external onlyOwner {
        ...
        systemstatus_i.updateAccessControl("", new_ExchangeCircuitBreaker_contract, true, false);
        ...
        exchangerates_i.addAggregator("", 0x2FCF37343e916eAEd1f1DdaaF84458a359b53877);
        // Ensure the ExchangeRates contract has the standalone feed for ETH;
        exchangerates_i.addAggregator("", 0x13e3Ee699D1909E989722E753853AE30b17e08c5);
    ...
    function addressresolver_importAddresses_1() internal {
        ...
        addressresolver_importAddresses_names_1_0[0] = bytes32("");
        addressresolver_importAddresses_names_1_0[1] = bytes32("");
        addressresolver_importAddresses_names_1_0[2] = bytes32("");
        addressresolver_importAddresses_names_1_0[3] = bytes32("");
        addressresolver_importAddresses_names_1_0[4] = bytes32("");
        addressresolver_importAddresses_names_1_0[5] = bytes32("");
