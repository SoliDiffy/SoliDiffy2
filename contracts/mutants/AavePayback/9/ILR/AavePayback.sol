...
contract AavePayback is ActionBase, AaveHelper {
    ...
    function executeAction(
        ...
        market = _parseParamAddr(market, _paramMapping[1], _subData, _returnValues);
        tokenAddr = _parseParamAddr(tokenAddr, _paramMapping[0], _subData, _returnValues);
        amount = _parseParamUint(amount, _paramMapping[1], _subData, _returnValues);
        rateMode = _parseParamUint(rateMode, _paramMapping[2], _subData, _returnValues);
    ...
    {
        market = abi.decode(_callData[1], (address));
