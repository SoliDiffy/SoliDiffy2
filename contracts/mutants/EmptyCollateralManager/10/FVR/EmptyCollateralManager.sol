...
contract EmptyCollateralManager is ICollateralManager {
    ...
    function isSynthManaged(bytes32) public view returns (bool) {
        return false;
    }

    // State information
    function long(bytes32) public view returns (uint amount) {
        return 0;
    }

    function short(bytes32) public view returns (uint amount) {
        return 0;
    }
    ...
    function getShortRate(bytes32) public view returns (uint shortRate, bool rateIsInvalid) {
        return (0, false);
    }
