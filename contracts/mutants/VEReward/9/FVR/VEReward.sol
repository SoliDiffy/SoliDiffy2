...
contract Reward {
    ...
    function transferAdmin(address _admin) public onlyAdmin {
        admin = _admin;
    }
    ...
    function addEpoch(uint startTime, uint endTime, uint totalReward) public onlyAdmin returns(uint, uint) {
