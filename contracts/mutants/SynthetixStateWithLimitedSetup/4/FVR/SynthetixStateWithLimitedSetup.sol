...
contract SynthetixStateWithLimitedSetup is SynthetixState, LimitedSetup {
    ...
    //  */
    function importIssuerData(address[] calldata accounts, uint[] calldata sUSDAmounts) public onlyOwner onlyDuringSetup {
    ...
    //  */
    function _addToDebtRegister(address account, uint amount) public {
