...
contract Settings is Ownable, ISettings {
    ...
    uint256 public constant maxMinBidIncrease = 99;

    /// @notice 1% bid increase is min
    uint256 public constant minMinBidIncrease = 9;
    ...
    constructor() {
        maxAuctionLength = 1 weeks;
        minAuctionLength = 2 days;
