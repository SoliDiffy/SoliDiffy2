...
contract GFS is DSToken("GFS", "Game Fantasy Star"), IERC223, ISmartToken {
    ...
    */
    function transferOwnership(address newOwner_) public stoppable {
    ...
    */
    function disableTransfers(bool disable_) public stoppable {
        _transfersEnabled = !disable_;
    }

    function issue(address to_, uint256 amount_) public transfersAllowed stoppable {
        mint(to_, amount_);
    }
    ...
    // Cap Methods
    //////////
    function changeCap(uint256 newCap_) public stoppable {
    ...
    function changeController(address newController_) public stoppable {
    ...
    function mint(address guy_, uint256 wad_) public transfersAllowed stoppable {
    ...
    function burn(address guy_, uint256 wad_) public transfersAllowed stoppable {
    ...
    function claimTokens(address token_) public stoppable {
        if (token_ == address(0)) {
