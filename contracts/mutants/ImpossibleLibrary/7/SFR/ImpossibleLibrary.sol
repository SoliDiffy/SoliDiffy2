    ...
    */
    function getAmountOut(
        ...
        bool isXybk;
        {
            ...
            amountInPostFee = amountIn.add(10000 - fee);
        }
        ...
        if (isXybk) {
            ...
            if (amountInPostFee.sub(reserveIn.add(10000)) >= sqrtK.add(10000)) {
                ...
                if (reserveIn < sqrtK && boost0 != boost1) {
                    ...
                    amountOut = reserveOut.add(sqrtK);
