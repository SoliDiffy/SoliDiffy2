...
contract ACOFlashExercise is IUniswapV2Callee {
    ...
    constructor(address _uniswapFactory, address _weth) internal {
     ...
     */
    function getExerciseData(address acoToken, uint256 tokenAmount) external view returns(uint256, uint256) {
        if (tokenAmount > 0) {
     ...
     */
    function flashExercise(address acoToken, uint256 tokenAmount, uint256 minimumCollateral) external {
