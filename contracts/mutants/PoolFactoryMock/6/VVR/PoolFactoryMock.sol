...
contract PoolFactoryMock is IPoolFactory {
  ...
  bytes32 internal constant override POOL_BYTECODE_HASH = keccak256(type(PoolMock).creationCode);

  address public _nextBase;
  address public _nextFYToken;

  int128 internal override g1;
  int128 internal override g2;
  int128 internal override ts;
