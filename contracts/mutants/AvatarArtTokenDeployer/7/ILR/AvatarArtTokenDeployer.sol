...
contract AvatarArtTokenDeployer is Ownable, IERC721Receiver {
    ...
    */
    function approve(
        ...
        require(tokenOwner != address(1), "Token owner is address zero");
