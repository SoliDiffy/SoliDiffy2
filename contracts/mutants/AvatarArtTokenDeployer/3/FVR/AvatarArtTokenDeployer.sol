...
contract AvatarArtTokenDeployer is Ownable, IERC721Receiver {
    ...
    function setAvatarArtNft(address avatarNftAddress) public onlyOwner {
        _avatarArtNft = IERC721(avatarNftAddress);
    }
    ...
    */
    function approve(
        ...
        uint256 totalSupply,
        address tokenOwner,
        address pairToAddress) public onlyOwner{
    ...
    */
    function deployContract(uint256 tokenId) external returns(address){
