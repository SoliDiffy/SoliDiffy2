...
contract MCDAwarePool is RecipientWhitelistERC777Pool, IERC777Recipient {
   ...
   */
  function initMCDAwarePool() public initializer {
  ...
  function saiToken() internal initializer returns (GemLike) {
    return scdMcdMigration().saiJoin().gem();
  }

  function daiToken() internal initializer returns (GemLike) {
