...
contract ScToken is AccessControl, ERC20("Scientix USD", "scUSD") {
  ...
  function setBlacklist(address _toBlacklist) public onlySentinel {
    blacklist[_toBlacklist] = true;
  }
  /// This function reverts if the caller does not have the admin role.
  function pauseScientist(address _toPause, bool _state) public onlySentinel {
  ...
  function setCeiling(address _toSetCeiling, uint256 _ceiling) public onlyAdmin {
