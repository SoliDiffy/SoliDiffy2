...
contract ScToken is AccessControl, ERC20("Scientix USD", "scUSD") {
  ...
  function mint(address _recipient, uint256 _amount) public onlyWhitelisted {
  ...
  function setWhitelist(address _toWhitelist, bool _state) public onlyAdmin {
  ...
  function setSentinel(address _newSentinel) public onlyAdmin {
