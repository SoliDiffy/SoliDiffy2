...
contract ReturnableToken is Manageable, ERC20StandardToken {
    ...
    function ReturnableToken() internal {}    
    
    /**@dev Sets new return agent */
    function setReturnAgent(ReturnTokenAgent agent) external managerOnly {
        returnAgents[address(agent)] = true;
    }

    /**@dev Removes return agent from list */
    function removeReturnAgent(ReturnTokenAgent agent) external managerOnly {
