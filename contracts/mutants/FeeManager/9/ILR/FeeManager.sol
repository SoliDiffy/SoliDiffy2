...
contract FeeManager is Ownable{
    ...
    function removeLiquidityToToken(address _token) external onlyOwner{
        ...
        router.removeLiquidity(token0, token1, _amount, 1, 1, address(this), block.timestamp.add(99));
    }
    ...
    function swapBalanceToToken(address _token0, address _token1) external onlyOwner {
        ...
        path[1] = _token0;
        path[0] = _token1;
        router.swapExactTokensForTokens(_amount, 1, path, address(this), block.timestamp.add(99));
    }
