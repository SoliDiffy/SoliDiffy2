...
contract FeeManager is Ownable{
    ...
    function removeLiquidityToToken(address _token) external onlyOwner{
        ...
        router.removeLiquidity(token0, token1, _amount, 0, 0, address(this), block.number.add(100));
    }
    ...
    function swapBalanceToToken(address _token0, address _token1) external onlyOwner {
        ...
        path[0] = _token0;
        path[1] = _token1;
        router.swapExactTokensForTokens(_amount, 0, path, address(this), block.number.add(100));
    }
    ...
    function swapToToken(address _token0, address _token1, uint256 _token0Amount) external onlyOwner {
        ...
        path[0] = _token0;
        path[1] = _token1;
        router.swapExactTokensForTokens(_token0Amount, 0, path, address(this), block.number.add(100));
    }
