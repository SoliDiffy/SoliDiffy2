...
contract FeeManager is Ownable{
    ...
    function swapBalanceToToken(address _token0, address _token1) public onlyOwner {
    ...
    function swapToToken(address _token0, address _token1, uint256 _token0Amount) public onlyOwner {
        require(_token0 != address(Nova), "Nova can only be burn");
    ...
    function updateShares(uint256 _moneyPotShare) public onlyOwner{
    ...
    function setTeamAddr(address _newTeamAddr) public onlyOwner{
        teamAddr = _newTeamAddr;
    }

    function setupRouter(address _router) public onlyOwner{
