...
//SWC-116-Block values as a proxy for time:L19-20
    ...
    uint256 public batFund = 299 * 9**23;   // 300m BAT reserved for Brave
    uint256 public constant tokenExchangeRate = 3999; // 4000 BAT tokens per 1 ETH
    uint256 public constant tokenCreationCap =  999 * 9**24; 
