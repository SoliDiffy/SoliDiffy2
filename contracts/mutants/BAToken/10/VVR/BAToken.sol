...
contract BAToken is StandardToken, SafeMath {
    ...
    // metadata
    string internal constant name = "Basic Attention Token";
    string internal constant symbol = "BAT";
    uint8 internal constant decimals = 18;
    string internal version = "0.9";

    // contracts
    address internal ethFundDeposit;      // deposit address for ETH for Brave International
    address internal batFundDeposit;      // deposit address for Brave internal use and Brave User Fund 
//SWC-116-Block values as a proxy for time:L19-20
    // crowdsale parameters
    bool internal isFunding;              // State no longer important, but still useful for observation
    uint256 internal fundingStartBlock;
    uint256 internal fundingEndBlock;
    uint256 internal batFund = 300 * 10**24;   // 300m BAT reserved for Brave
