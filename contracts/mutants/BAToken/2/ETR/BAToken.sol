...
//SWC-135-Code With No Effects:L58,61,79
    ...
    function finalize() external {
      ...
      // move to operational
      isFunding = false;
      if(!ethFundDeposit.transfer(this.balance)) throw;  // send the eth to Brave International
    }
//SWC-101-Integer Overflow and Underflow:L84-85
    ...
    function refund() external {
      ...
      if (!msg.sender.transfer(ethVal)) throw;       // if you're using a contract; make sure it works with .send gas limits
    }
