...
contract FlexibleStorage is ContractStorage, IFlexibleStorage {
    ...
    function getUIntValue(bytes32 contractName, bytes32 record) public view returns (uint) {
        return uintStorage[hashes[contractName]][record];
    }

    function getUIntValues(bytes32 contractName, bytes32[] calldata records) public view returns (uint[] memory) {
    ...
    function getIntValue(bytes32 contractName, bytes32 record) public view returns (int) {
