...
contract VolatilityOracle is IVolatilityOracle {
    ...
    ) public view returns (uint256 IV, Volatility.FeeGrowthGlobals memory current) {
    ...
    function _timingError(uint256 age) public pure returns (uint32) {
