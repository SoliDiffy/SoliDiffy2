...
contract EternalHeroesFactory is Ownable {
  ...
  // Initiate Variables
  ISWSupplyManager public factoryManager;  // SkyWeaver Factory manager contract
  IERC1155 public arcadeumCoin;            // ERC-1155 Arcadeum Coin contract
  uint256 public arcadeumCoinID;           // ID of ARC token in respective ERC-1155 contract
  ...
  // Variables
  uint256 public floorPrice;     // Base, most discounted price
  uint256 public tierSize;       // How many asset need to be purchased to move to next discount tier
  uint256 public priceIncrement; // Discount you get when you move up a discount step
