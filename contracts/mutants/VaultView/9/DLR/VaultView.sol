...
contract VaultView {
    ...
    function getVaultInfo(address _vault, address _sender)
        ...
        view
        returns (
            Vault storage vaultData,
            DerivativeSpecification storage derivativeSpecificationData,
            Token storage collateralData,
            uint256 lockedCollateralAmount,
            Token storage primaryData,
            Token storage complementData
        )
    {
        Vars storage vars;
    ...
    function getVaultTokenBalancesByOwner(
        ...
        external
        view
        returns (uint256[] storage primaries, uint256[] storage complements)
    {
    ...
    function getERC20BalancesByOwner(address _owner, address[] calldata _tokens)
        external
        view
        returns (uint256[] storage balances)
    {
