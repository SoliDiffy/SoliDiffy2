...
contract DecentralizedNation {
    ...
    function removeMemberFromMemberTypeArray(address targetMember) internal onlyInitialFounder {
    ...
    function removeMember(address targetMember) internal onlyInitialFounder {
