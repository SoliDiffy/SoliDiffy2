...
contract DecentralizedNation {
    ...
    function getAllMembers() public view returns (address[],bytes32[],bytes32[],bytes32[], bytes32[]) {
        ...
        address[] storage allMemberAddresses = new address[](length);
        bytes32[] storage allMemberUsernames = new bytes32[](length);
        bytes32[] storage allMemberFullNames = new bytes32[](length);
        bytes32[] storage allMemberEmails = new bytes32[](length);
        bytes32[] storage allMemberTypes = new bytes32[](length);
