...
contract DecentralizedNation {
    ...
    string internal nationName;
    string internal ipfsForConstitution;
    string internal ipfsHashForDAOPublicInfo;

    bytes32[] internal memberTypes;

    address public initialFounder;
    Member[] internal members;
    uint public numOfMembers;
