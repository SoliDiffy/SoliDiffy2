...
contract DecentralizedNation {
    ...
    constructor(
        ...
        addMember(0,bytes1(0));
        addMember(founder[0], bytes1("FOUNDERS"));
    ...
    function addMembersByFounders(address _memberAddress, bytes32 _memberType) public onlyInitialFounder {
        ...
        require(checkIfMemberTypeExists(_memberType) || _memberType == bytes1(0));
    ...
    function removeMember(address targetMember) internal {
        ...
        memberAddressToMemberType[targetMember] = bytes1(0);
    ...
    function startCampagin(
        ...
        if(flag == 0) {
            _campaignType = bytes1("VOTING");
        } else {
            _campaignType = bytes1("PETITIONING");
        }
