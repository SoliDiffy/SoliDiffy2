    ...
    TestStakingNoWETH
{
        ...
        external
    {
        ...
        IStructs.PoolStats storage poolStats = poolStatsByEpoch[poolId][currentEpoch_];
    ...
    function getUnfinalizedPoolRewards(bytes32 poolId)
        external
        view
        returns (UnfinalizedPoolReward storage reward)
    {
    ...
    function getPoolStatsFromEpoch(uint256 epoch, bytes32 poolId)
        external
        view
        returns (IStructs.PoolStats storage)
    {
    ...
    function getAggregatedStatsForPreviousEpoch()
        external
        view
        returns (IStructs.AggregatedStats storage)
    {
