...
contract RifiLens {
    ...
    function rTokenMetadata(RToken rToken) external returns (RTokenMetadata memory) {
    ...
    function rTokenMetadataAll(RToken[] calldata rTokens) public returns (RTokenMetadataAll memory) {
    ...
    function rTokenBalances(RToken rToken, address payable account) external returns (RTokenBalances memory) {
    ...
    function rTokenBalancesAll(RToken[] calldata rTokens, address payable account) public returns (RTokenBalances[] memory) {
        uint rTokenCount = rTokens.length;
    ...
    function rTokenUnderlyingPrice(RToken rToken) external returns (RTokenUnderlyingPrice memory) {
        CointrollerLensInterface cointroller = CointrollerLensInterface(address(rToken.cointroller()));
    ...
    function rTokenUnderlyingPriceAll(RToken[] calldata rTokens) public returns (RTokenUnderlyingPrice[] memory) {
        uint rTokenCount = rTokens.length;
    ...
    function getAccountLimits(CointrollerLensInterface cointroller, address account) external returns (AccountLimits memory) {
    ...
    function setProposal(GovProposal memory res, GovernorAlpha governor, uint proposalId) public view {
        (
            ,
            address proposer,
            uint eta,
    ...
    function getGovProposals(GovernorAlpha governor, uint[] calldata proposalIds) public view returns (GovProposal[] memory) {
