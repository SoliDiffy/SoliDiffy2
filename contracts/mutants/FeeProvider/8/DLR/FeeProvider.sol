...
// #################################
    ...
    function updateATopUpOption(string storage category, uint optionNo, uint _fee, uint _multiplier) external override onlySighFinanceConfigurator returns (bool) {
...
// ###############################
    ...
    function getOptionDetails(string storage category, uint optionNo) external view override returns (uint fee, uint multiplier) {
