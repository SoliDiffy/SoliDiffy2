...
contract FeeProvider is IFeeProvider, VersionedInitializable {
    ...
    modifier onlyLendingPool {
        require(globalAddressesProvider.getLendingPool() == tx.origin, "The caller must be the Lending Pool Contract");
        _;
    }
...
// #################################
    ...
    function fuelTopUp(uint optionNo, uint boosterID) override external {
        ...
        IERC20(tokenAccepted).transferFrom(tx.origin,address(this),amount);
