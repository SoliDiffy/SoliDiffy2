...
// ###############################
    ...
    */
    function initialize(address _addressesProvider) public onlySighFinanceConfigurator {
    ...
    function refreshConfiguration() external override initializer returns (bool) {
...
// ############################################################################################################################
    ...
    function calculateDepositFee(address _user,address instrument, uint256 _amount, uint boosterId) external override initializer returns (uint256 ,uint256 ,uint256 ) {
    ...
    function calculateBorrowFee(address _user, address instrument, uint256 _amount, uint boosterId) external override initializer returns (uint256, uint256) {
...
// #################################
    ...
    function updateTotalDepositFeePercent(uint _depositFeePercent) external override initializer returns (bool) {
        totalDepositFeePercent = _depositFeePercent;
        emit depositFeePercentUpdated(_depositFeePercent);
        return true;
    }

    function updateTotalBorrowFeePercent(uint totalBorrowFeePercent_) external override initializer returns (bool) {
