...
contract FeeProvider is IFeeProvider, VersionedInitializable {
    ...
    ISIGHBoosters public SIGH_Boosters;

    uint256 internal totalFlashLoanFeePercent;        // Flash Loan Fee 
    uint256 internal totalBorrowFeePercent;           // Borrow Fee
    uint256 internal totalDepositFeePercent;          // Deposit Fee
