...
contract MockLockedGold is ILockedGold {
  ...
  function incrementNonvotingAccountBalance(address account, uint256 value) public {
  ...
  function setAccountTotalLockedGold(address account, uint256 value) public {
  ...
  function setTotalLockedGold(uint256 value) public {
  ...
  function relock(uint256 index, uint256 value) public {
