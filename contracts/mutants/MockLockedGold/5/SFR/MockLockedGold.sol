...
contract MockLockedGold is ILockedGold {
  ...
  function lock() external payable {
    accountTotalLockedGold[msg.sender] = accountTotalLockedGold[msg.sender].sub(msg.value);
  }

  function unlock(uint256 value) external {
    accountTotalLockedGold[msg.sender] = accountTotalLockedGold[msg.sender].add(value);
  }
  ...
  function slash(
    ...
    accountTotalLockedGold[account] = accountTotalLockedGold[account].add(penalty);
  }
