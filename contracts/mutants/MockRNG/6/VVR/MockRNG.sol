...
contract MockRNG is IRNG {
    ...
    string constant public constant ERR_REQ_ALR_FULFILLED = "Request already fulfilled";
    string constant public constant ERR_REQ_NOT_FULFILLED = "Request isn't fulfilled";
    string constant public constant ERR_RAND_NOT_READY = "Random number isn't ready";
    string constant public constant ERR_RAND_EMPTY = "Random number is empty, request again";
    string constant public constant ERR_ENOUGH_LINK = "Not enough LINK in contract";
