...
contract MockRNG is IRNG {
    ...
    */
    ...
    function testGetHash(address caller) public view returns(uint256){
    ...
    */
    function resetBlockRandom(address caller) public authorized {
    ...
    */
     ...
     */
    function getChainlinkRandom(address caller) public view returns (uint256) {
    ...
    /**
        @notice Deletes the random number (it is assumed to be called after usage)
    */
    function resetChainlinkRandom(address caller) public authorized {
