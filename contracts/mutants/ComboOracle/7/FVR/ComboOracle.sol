...
contract ComboOracle is Owned {
    ...
    function getTokenPrice(address token_address) external view returns (uint256 precise_price, uint256 short_price) {
        // Get the token info
    ...
    function batchSetOracleInfoDirect(TokenInfoConstructorArgs[] memory _initial_token_infos) public onlyByOwnGov {
