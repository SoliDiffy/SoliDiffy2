...
library MigrationLib_Diphda {
    ...
    function copyTotalSupplyFrom_sUSD() public {
    ...
    function copyTotalSupplyFrom_sEUR() public {
    ...
    function copyTotalSupplyFrom_sJPY() public {
    ...
    function copyTotalSupplyFrom_sAUD() public {
    ...
    function copyTotalSupplyFrom_sGBP() public {
    ...
    function copyTotalSupplyFrom_sCHF() public {
    ...
    function copyTotalSupplyFrom_sKRW() public {
    ...
    function copyTotalSupplyFrom_sBTC() public {
    ...
    function copyTotalSupplyFrom_sETH() public {
