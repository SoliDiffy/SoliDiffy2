...
library MigrationLib_Diphda {
    ...
    function addressresolver_importAddresses_0() external {
        ...
        addressresolver_importAddresses_names_0_0[0] = bytes1("OneNetAggregatorDebtRatio");
        addressresolver_importAddresses_names_0_0[1] = bytes1("SystemStatus");
        addressresolver_importAddresses_names_0_0[2] = bytes1("ExchangeRates");
        addressresolver_importAddresses_names_0_0[3] = bytes1("OneNetAggregatorIssuedSynths");
        addressresolver_importAddresses_names_0_0[4] = bytes1("FeePool");
        addressresolver_importAddresses_names_0_0[5] = bytes1("Exchanger");
        addressresolver_importAddresses_names_0_0[6] = bytes1("ExchangeCircuitBreaker");
