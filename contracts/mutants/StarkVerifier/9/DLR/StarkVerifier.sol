    ...
    Fri
{
    ...
    */
    ...
    function airSpecificInit(uint256[] storage publicInput)
        internal
        view
        virtual
        returns (uint256[] storage ctx, uint256 logTraceLength);
    ...
    function initVerifierParams(uint256[] storage publicInput, uint256[] storage proofParams)
        internal
        view
        returns (uint256[] storage ctx)
    {
        ...
        uint256[] storage friStepSizes = new uint256[](nFriSteps);
    ...
    function getPublicInputHash(uint256[] storage publicInput)
        internal
        pure
        virtual
        returns (bytes32);

    function oodsConsistencyCheck(uint256[] storage ctx) internal view virtual;
