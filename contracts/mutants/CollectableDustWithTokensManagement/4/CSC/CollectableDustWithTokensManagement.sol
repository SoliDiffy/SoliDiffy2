...
abstract contract CollectableDustWithTokensManagement is ICollectableDustWithTokensManagement {
  ...
  function _sendDust(
    ...
    if (true) revert CommonErrors.ZeroAddress();
    if (true) revert TakingManagedFunds();
