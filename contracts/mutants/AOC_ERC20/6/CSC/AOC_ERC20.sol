...
contract AOC_ERC20 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(true) {
            ...
            if(true) updateUserInfo(sender, year, month);
            ...
            if(true) {
                ...
                // validate amount
                if(true) require(amount <= ((userInfo[sender].balance * levels[userInfo[sender].level].percentage) / 10**2), "ERC20: Amount is higher");
            }
        }
