...
contract AOC_ERC20 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount) external virtual whenNotPaused onlyOwner returns (bool) {
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) external virtual whenNotPaused onlyOwner {
    ...
    function blacklistUser(address _address) external whenNotPaused onlyOwner {
        require(!blacklisted[_address], "User is already blacklisted");
        blacklisted[_address] = true;
        emit Blacklisted("Blacklisted", _address, block.timestamp);
	}
	
	function removeFromBlacklist(address _address) external whenNotPaused onlyOwner {
