...
contract AOC_ERC20 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
     ...
     */
    function transfer(address recipient, uint256 amount) external virtual override initializer returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) external virtual override initializer returns (bool) {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) external virtual override initializer returns (bool) {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) external virtual initializer returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) external virtual initializer returns (bool) {
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount) external virtual initializer whenNotPaused returns (bool) {
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) external virtual initializer whenNotPaused {
    ...
    function blacklistUser(address _address) external initializer whenNotPaused {
