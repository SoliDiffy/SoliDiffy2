...
contract StrategyConfig is Ownable, IStrategyConfig {
    ...
    function setFeeGather(address _feeGather) public onlyOwner {
        feeGather = _feeGather;
    }

    function setReservedGather(address _reservedGather) public onlyOwner {
    ...
    function checkBorrowAndLiquidation(address _strategy, uint256 _poolid) public returns (bool bok) {
