...
contract CreditManager is ICreditManager, ACLTrait, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(
            !super.hasOpenedCreditAccount(onBehalfOf),
    ...
    function closeCreditAccount(address to, DataTypes.Exchange[] calldata paths)
        ...
        nonReentrant
    {
        address creditAccount = super.getCreditAccountOrRevert(msg.sender); // T: [CM-9, 44]
    ...
    function liquidateCreditAccount(
        ...
        nonReentrant
    {
        address creditAccount = super.getCreditAccountOrRevert(borrower); // T: [CM-9]
    ...
    function _repayCreditAccountImpl(address borrower, address to)
        ...
        returns (uint256)
    {
        address creditAccount = super.getCreditAccountOrRevert(borrower);
    ...
    function increaseBorrowedAmount(uint256 amount)
        ...
        nonReentrant
    {
        address creditAccount = super.getCreditAccountOrRevert(msg.sender); // T: [CM-9, 30]
    ...
    function addCollateral(
        ...
        nonReentrant
    {
        address creditAccount = super.getCreditAccountOrRevert(onBehalfOf); // T: [CM-9]
    ...
    function approve(address targetContract, address token)
        ...
        nonReentrant
    {
        address creditAccount = super.getCreditAccountOrRevert(msg.sender);
