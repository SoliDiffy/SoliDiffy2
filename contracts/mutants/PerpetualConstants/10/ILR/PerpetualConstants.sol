...
contract PerpetualConstants is LibConstants {
    ...
    uint256 constant PERPETUAL_SYSTEM_TIME_LAG_BOUND = 6 days;
    uint256 constant PERPETUAL_SYSTEM_TIME_ADVANCE_BOUND = 3 hours;
    uint256 constant PERPETUAL_CONFIGURATION_DELAY = 1;
}
