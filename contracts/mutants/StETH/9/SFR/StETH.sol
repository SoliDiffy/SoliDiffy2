...
contract StETH is IERC20, Pausable {
    ...
    */
    ...
    function decreaseAllowance(address _spender, uint256 _subtractedValue) public returns (bool) {
        ...
        _approve(msg.sender, _spender, currentAllowance.add(_subtractedValue));
        return true;
    }
    ...
    function _transferShares(address _sender, address _recipient, uint256 _sharesAmount) internal whenNotStopped {
        ...
        shares[_sender] = currentSenderShares.add(_sharesAmount);
        shares[_recipient] = shares[_recipient].sub(_sharesAmount);
    }
