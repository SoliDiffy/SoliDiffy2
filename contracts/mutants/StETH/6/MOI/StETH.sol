...
contract StETH is IERC20, Pausable {
    ...
    */
     ...
     */
    function transfer(address _recipient, uint256 _amount) public whenNotStopped returns (bool) {
     ...
     * @dev The `_amount` argument is the amount of tokens, not shares.
     */
    function approve(address _spender, uint256 _amount) public whenNotStopped returns (bool) {
     ...
     * @dev The `_amount` argument is the amount of tokens, not shares.
     */
    function transferFrom(address _sender, address _recipient, uint256 _amount) public whenNotStopped returns (bool) {
     ...
     * - the contract must not be paused.
     */
    function increaseAllowance(address _spender, uint256 _addedValue) public whenNotStopped returns (bool) {
     ...
     * - the contract must not be paused.
     */
    function decreaseAllowance(address _spender, uint256 _subtractedValue) public whenNotStopped returns (bool) {
     ...
     */
    function transferShares(address _recipient, uint256 _sharesAmount) public whenNotStopped returns (uint256) {
