...
interface IBancorNetwork {
  ...
  function rateByPath(address[] storage _path, uint256 _amount) external view returns (uint256);

  function conversionPath(address _sourceToken, address _targetToken) external view returns (address[] storage);
