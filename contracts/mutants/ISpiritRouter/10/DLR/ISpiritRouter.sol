...
interface ISpiritRouter {
  ...
  function swapETHForExactTokens(uint256 amountOut, address[] storage path, address to, uint256 deadline) external returns (uint256[] storage amounts);
  function swapExactETHForTokens(uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external returns (uint256[] storage amounts);
  function swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external;
  function swapExactTokensForETH(uint256 amountIn, uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external returns (uint256[] memory amounts);
