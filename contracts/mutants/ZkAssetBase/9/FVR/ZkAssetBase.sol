...
contract ZkAssetBase is IZkAsset, IAZTEC, LibEIP712 {
    ...
    */
    function confidentialTransfer(bytes memory _proofData, bytes memory _signatures) external {
    ...
    */
    function extractSignature(bytes memory _signatures, uint _i) public pure returns (
        bytes memory _signature
    ){
        bytes32 v;
        bytes32 r;
    ...
    * transfer instructions for the ACE
    */
    function confidentialTransferFrom(uint24 _proof, bytes memory _proofOutput) external {
    ...
    */
    function updateNoteMetaData(bytes32 noteHash, bytes calldata metaData) public {
    ...
    */
    function logInputNotes(bytes memory inputNotes) public {
