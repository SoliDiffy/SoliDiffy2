...
contract ZkAssetBase is IZkAsset, IAZTEC, LibEIP712 {
    ...
    string constant public EIP712_DOMAIN_NAME = "ZK_ASSET";

    bytes32 constant public NOTE_SIGNATURE_TYPEHASH = keccak256(abi.encodePacked(
        "NoteSignature(",
            "bytes32 noteHash,",
            "address spender,",
            "bool status",
    ...
    bytes32 constant public JOIN_SPLIT_SIGNATURE_TYPE_HASH = keccak256(abi.encodePacked(
        "JoinSplitSignature(",
            "uint24 proof,",
            "bytes32 noteHash,",
            "uint256 challenge,",
