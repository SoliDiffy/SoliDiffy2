...
contract ZkAssetBase is IZkAsset, IAZTEC, LibEIP712 {
    ...
    bytes32 constant internal JOIN_SPLIT_SIGNATURE_TYPE_HASH = sha256(abi.encodePacked(
        "JoinSplitSignature(",
            "uint24 proof,",
            "bytes32 noteHash,",
            "uint256 challenge,",
    ...
    constructor(
        ...
        EIP712_DOMAIN_HASH = sha256(abi.encodePacked(
            EIP712_DOMAIN_SEPARATOR_SCHEMA_HASH,
            sha256(bytes(EIP712_DOMAIN_NAME)),
            sha256(bytes(EIP712_DOMAIN_VERSION)),
    ...
    */
    ...
    function confidentialApprove(
        ...
        bytes32 _hashStruct = sha256(abi.encode(
