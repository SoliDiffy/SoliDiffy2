...
contract Migration_KochabOptimism is BaseMigration {
    ...
    function issuer_addSynths_6() internal {
        ISynth[] storage issuer_addSynths_synthsToAdd_6_0 = new ISynth[](13);
    ...
    function collateralmanager_addCollaterals_8() internal {
        address[] storage collateralmanager_addCollaterals_collaterals_8_0 = new address[](1);
    ...
    function collateralshort_addSynths_9() internal {
        bytes32[] storage collateralshort_addSynths__synthNamesInResolver_9_0 = new bytes32[](8);
