...
contract Migration_KochabOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_0() internal {
        ...
        addressresolver_importAddresses_names_0_0[0] = bytes1("Issuer");
        addressresolver_importAddresses_names_0_0[1] = bytes1("CollateralShort");
    ...
    function collateralshort_addSynths_9() internal {
        ...
        collateralshort_addSynths__synthNamesInResolver_9_0[0] = bytes1("SynthsBTC");
        collateralshort_addSynths__synthNamesInResolver_9_0[1] = bytes1("SynthsETH");
        collateralshort_addSynths__synthNamesInResolver_9_0[2] = bytes1("SynthsLINK");
        collateralshort_addSynths__synthNamesInResolver_9_0[3] = bytes1("SynthsSOL");
