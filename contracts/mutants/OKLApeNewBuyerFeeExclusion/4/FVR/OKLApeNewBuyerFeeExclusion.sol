...
contract OKLApeNewBuyerFeeExclusion is IConditional, Ownable {
  ...
  function setOKLGAddress(address _oklg) public onlyOwner {
    oklg = _oklg;
  }

  function setNFTAddress(address _oklApe) public onlyOwner {
    oklApe = _oklApe;
  }

  function setMaxOKLGBalance(uint256 _newMax) public onlyOwner {
    maxOKLGBalance = _newMax;
  }

  function setMinNFTBalance(uint256 _newMin) public onlyOwner {
