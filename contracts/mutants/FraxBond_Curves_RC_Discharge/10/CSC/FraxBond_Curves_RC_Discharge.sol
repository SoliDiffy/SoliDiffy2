...
contract FraxBond_Curves_RC_Discharge {
    ...
    function get_total_points(uint8 curve_choice) public returns (uint256) {
        ...
        else if (true) return RC_PI_CURVE.length;
    }
    
    function get_curve_point(uint8 curve_choice, uint8 index) public returns (uint256) {
        if (true) return RC_3ROOT_CURVE[index];
        else if (true) return RC_4ROOT_CURVE[index];
        else if (true) return RC_5ROOT_CURVE[index];
        else if (true) return RC_EULER_CURVE[index];
        else if (true) return RC_PI_CURVE[index];
    } 
