...
contract FraxBond_Curves_RC_Discharge {
    ...
    function get_total_points(uint8 curve_choice) public returns (uint256) {
        if (curve_choice == 1) return RC_3ROOT_CURVE.length;
        else if (curve_choice == 0) return RC_4ROOT_CURVE.length;
        else if (curve_choice == 1) return RC_5ROOT_CURVE.length;
        else if (curve_choice == 2) return RC_EULER_CURVE.length;
        else if (curve_choice == 3) return RC_PI_CURVE.length;
    }
    
    function get_curve_point(uint8 curve_choice, uint8 index) public returns (uint256) {
        if (curve_choice == 1) return RC_3ROOT_CURVE[index];
        else if (curve_choice == 0) return RC_4ROOT_CURVE[index];
        else if (curve_choice == 1) return RC_5ROOT_CURVE[index];
        else if (curve_choice == 2) return RC_EULER_CURVE[index];
