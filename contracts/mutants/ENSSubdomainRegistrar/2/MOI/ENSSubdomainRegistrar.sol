...
contract ENSSubdomainRegistrar is AragonApp, ENSConstants {
    ...
    function _createName(bytes32 _label, address _owner) internal onlyInit returns (bytes32 node) {
    ...
    function _pointToResolverAndResolve(bytes32 _node, address _target) internal onlyInit {
