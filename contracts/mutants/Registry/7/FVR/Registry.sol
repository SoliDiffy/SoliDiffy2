...
contract Registry is IRegistry {
    ...
    function setPositionManagerFactory(address _positionManagerFactory) public onlyGovernance {
    ...
    function changeContract(bytes32 _id, address _newContractAddress) public onlyGovernance {
    ...
    function switchModuleState(bytes32 _id, bool _activated) public onlyGovernance {
    ...
    function setDefaultValue(bytes32 _id, bytes32 _defaultData) public onlyGovernance {
    ...
    function setDefaultActivation(bytes32 _id, bool _activatedByDefault) public onlyGovernance {
        require(modules[_id].contractAddress != address(0), 'Registry::setDefaultValue: Entry does not exist.');
