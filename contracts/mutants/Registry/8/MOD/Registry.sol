...
contract Registry is IRegistry {
    ...
    function changeContract(bytes32 _id, address _newContractAddress) external  {
    ...
    function switchModuleState(bytes32 _id, bool _activated) external  {
    ...
    function addKeeperToWhitelist(address _keeper) external override  {
    ...
    function setDefaultValue(bytes32 _id, bytes32 _defaultData) external  {
    ...
    function setDefaultActivation(bytes32 _id, bool _activatedByDefault) external  {
        require(modules[_id].contractAddress != address(0), 'Registry::setDefaultValue: Entry does not exist.');
