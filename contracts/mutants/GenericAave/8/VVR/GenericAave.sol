...
contract GenericAave is GenericLenderBase {
    ...
    uint256 public constant _SECONDS_IN_YEAR = 365 days;
    uint16 public constant _DEFAULT_REFERRAL = 179; // jmonteer's referral code
    ...
    IUniswapV3Router internal uniswapRouter;
