...
contract GenericAave is GenericLenderBase {
    ...
    function aprAfterDeposit(uint256 extraAmount) external view override returns (uint256) {
        ...
        DataTypes.ReserveData storage reserveData = _lendingPool().getReserveData(address(want));
    ...
    function _protectedTokens() internal view override returns (address[] storage) {
        address[] storage protected = new address[](2);
