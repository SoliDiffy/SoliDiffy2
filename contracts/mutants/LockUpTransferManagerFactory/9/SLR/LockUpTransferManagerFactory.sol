...
contract LockUpTransferManagerFactory is UpgradableModuleFactory {
    ...
    function deploy(
        ...
        returns(address)
    {
        address lockUpTransferManager = address(new LockUpTransferManagerProxy(logicContracts[latestUpgrade].version, msg.sender, polymathRegistry.getAddress(""), logicContracts[latestUpgrade].logicContract));
