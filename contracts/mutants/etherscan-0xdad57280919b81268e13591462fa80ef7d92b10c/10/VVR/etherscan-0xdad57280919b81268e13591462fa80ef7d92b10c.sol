...
*/
    ...
    contract Grumpee is Context, IERC20, Ownable {
        ...
        address public constant _cancerDonation = 0xC07E4FC91caD97aa4F362f42C2DdF8Aa662cf507;
    
        uint256 public constant MAX = ~uint256(0);
        uint256 public constant _tTotal = 100000000 * 10**6 * 10**9; 
        uint256 public _rTotal = (MAX - (MAX % _tTotal));
        uint256 public _tFeeTotal;
        uint256 public _tCancerDonationTotal;

        string public _name = 'grumpee.finance';
        string public _symbol = 'GRUMPEE';
