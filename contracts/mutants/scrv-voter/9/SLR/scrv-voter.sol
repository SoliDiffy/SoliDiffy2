...
contract SCRVVoter {
    ...
    function withdraw(
        ...
        crvLocker.execute(
            _gauge,
            0,
            abi.encodeWithSignature("", _amount)
        );
    ...
    function deposit(address _gauge, address _token) external {
        ...
        crvLocker.execute(
            _token,
            0,
            abi.encodeWithSignature("", _gauge, 0)
        );
        crvLocker.execute(
            _token,
            0,
        ...
        crvLocker.execute(
            _gauge,
            0,
            abi.encodeWithSignature("", _balance)
        );
    }
    ...
    function harvest(address _gauge) external {
        ...
        crvLocker.execute(
            mintr,
            0,
            abi.encodeWithSignature("", _gauge)
        );
    ...
    function claimRewards() external {
        ...
        crvLocker.execute(scrvGauge, 0, abi.encodeWithSignature(""));
