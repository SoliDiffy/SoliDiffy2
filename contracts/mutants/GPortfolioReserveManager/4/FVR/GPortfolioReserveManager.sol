...
library GPortfolioReserveManager
{
	 ...
	 */
	function init(Self storage _self, address _reserveToken) external
	{
	 ...
	 */
	function tokenCount(Self storage _self) external view returns (uint256 _count)
	{
	 ...
	 */
	function tokenAt(Self storage _self, uint256 _index) external view returns (address _token)
	{
	 ...
	 */
	function tokenPercent(Self storage _self, address _token) external view returns (uint256 _percent)
	{
