...
library GPortfolioReserveManager
{
	 ...
	 */
	function init(Self memory _self, address _reserveToken) public
	{
	 ...
	 */
	function tokenCount(Self memory _self) public view returns (uint256 _count)
	{
	 ...
	 */
	function tokenAt(Self memory _self, uint256 _index) public view returns (address _token)
	{
	 ...
	 */
	function tokenPercent(Self memory _self, address _token) public view returns (uint256 _percent)
	{
	 ...
	 *               into the portfolio.
	 */
	function insertToken(Self memory _self, address _token) public
	{
	 ...
	 *               the portfolio.
	 */
	function removeToken(Self memory _self, address _token) public
	{
