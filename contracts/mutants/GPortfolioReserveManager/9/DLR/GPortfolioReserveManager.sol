...
library GPortfolioReserveManager
{
	 ...
	 */
	function transferTokenPercent(Self memory _self, address _sourceToken, address _targetToken, uint256 _percent) public
	{
	 ...
	 */
	function setRebalanceMargins(Self memory _self, uint256 _liquidRebalanceMargin, uint256 _portfolioRebalanceMargin) public
	{
	 ...
	 */
	function totalReserve(Self memory _self) public view returns (uint256 _totalReserve)
	{
