...
library GPortfolioReserveManager
{
	 ...
	 *               into the portfolio.
	 */
	function insertToken(Self storage _self, address _token) external
	{
	 ...
	 *               the portfolio.
	 */
	function removeToken(Self storage _self, address _token) external
	{
	 ...
	 */
	function transferTokenPercent(Self storage _self, address _sourceToken, address _targetToken, uint256 _percent) external
	{
	 ...
	 */
	function setRebalanceMargins(Self storage _self, uint256 _liquidRebalanceMargin, uint256 _portfolioRebalanceMargin) external
	{
	 ...
	 */
	function totalReserve(Self storage _self) external view returns (uint256 _totalReserve)
	{
