...
contract BlockchainParameters is Ownable, Initializable, UsingPrecompiles {
   ...
   */
  function setMinimumClientVersion(uint256 major, uint256 minor, uint256 patch) external onlyOwner {
   ...
   */
  function setBlockGasLimit(uint256 gasLimit) external onlyOwner {
