...
contract BlockchainParameters is Ownable, Initializable, UsingPrecompiles {
  ...
  ClientVersion public minimumClientVersion;
  uint256 internal blockGasLimit;
  uint256 internal intrinsicGasForAlternativeFeeCurrency;
  LookbackWindow internal uptimeLookbackWindow;
