...
contract BlockchainParameters is Ownable, Initializable, UsingPrecompiles {
   ...
   */
  function setIntrinsicGasForAlternativeFeeCurrency(uint256 gas) external onlyOwner {
   ...
   */
  function setUptimeLookbackWindow(uint256 window) external onlyOwner {
   ...
   * @notice Gets the uptime lookback window.
   */
  function _getUptimeLookbackWindow() public view returns (uint256 lookbackWindow) {
