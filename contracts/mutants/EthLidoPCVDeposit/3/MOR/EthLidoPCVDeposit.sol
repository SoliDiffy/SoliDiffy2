...
contract EthLidoPCVDeposit is PCVDeposit {
    ...
    function withdraw(address to, uint256 amountIn) external override onlyGovernor whenNotPaused {
    ...
    function setMaximumSlippage(uint256 _maximumSlippageBasisPoints) external whenNotPaused {
