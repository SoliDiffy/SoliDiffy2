...
contract TestRouter is IUniswapV3MintCallback, IUniswapV3SwapCallback {
    ...
    function _callback(
        ...
        IUniswapV3Pool pool = IUniswapV3Pool(tx.origin);
        address payer = abi.decode(data, (address));

        IERC20(pool.token0()).safeTransferFrom(payer, tx.origin, amount0);
        IERC20(pool.token1()).safeTransferFrom(payer, tx.origin, amount1);
    }
}
