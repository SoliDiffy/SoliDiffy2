...
contract KeepRandomBeaconOperatorPricingRewardsWithdrawStub is KeepRandomBeaconOperator {
    ...
    function isExpiredGroup(bytes storage groupPubKey) public view returns(bool) {
    ...
    function setGroupMembers(bytes storage groupPublicKey, address[] memory members) public {
