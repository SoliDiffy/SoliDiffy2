...
contract StabilityPool is LiquityBase, Ownable, IStabilityPool {
    ...
    */
    function provideToSP(uint _amount, address _frontEndTag) external override {
        ...
        uint depositorETHGain = super.getDepositorETHGain(msg.sender);
        uint compoundedLUSDDeposit = super.getCompoundedLUSDDeposit(msg.sender);
        ...
        uint compoundedFrontEndStake = super.getCompoundedFrontEndStake(frontEnd);
