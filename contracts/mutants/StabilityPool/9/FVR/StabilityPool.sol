...
contract StabilityPool is LiquityBase, Ownable, IStabilityPool {
    ...
    */
    ...
    function _moveOffsetCollAndDebt(uint _collToAdd, uint _debtToOffset) public {
    ...
    function _decreaseLUSD(uint _amount) public {
    ...
    */
    ...
    function _getETHGainFromSnapshots(uint initialDeposit, Snapshots memory snapshots) public view returns (uint) {
        /*  
