...
interface IModuleRegistry {
    ...
    */
     ...
     */
    function getFactoryDetails(address _factoryAddress) external view returns(bool isVerified, address factoryOwner, address[] storage usingTokens);
     ...
     */
    function getTagsByTypeAndToken(uint8 _moduleType, address _securityToken) external view returns(bytes32[] storage tags, address[] storage factories);
     ...
     * @return corresponding list of module factories
     */
    function getTagsByType(uint8 _moduleType) external view returns(bytes32[] storage tags, address[] storage factories);
     ...
     */
    function getAllModulesByType(uint8 _moduleType) external view returns(address[] storage factories);
    /**
