...
contract CompensationClaims is Governable {
    ...
    function claim(address _recipient) public onlyInClaimPeriod nonReentrant {
    ...
    ) public notInClaimPeriod onlyUnlockedAdjuster {
        require(
    ...
    function lockAdjuster() public onlyGovernor notInClaimPeriod {
        _lockAdjuster();
    }

    function _lockAdjuster() public {
        isAdjusterLocked = true;
        emit Lock();
    }

    function unlockAdjuster() public onlyGovernor notInClaimPeriod {
