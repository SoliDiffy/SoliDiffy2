...
contract CompensationClaims is Governable {
    ...
    function claim(address _recipient) external nonReentrant onlyInClaimPeriod {
    ...
    function lockAdjuster() external notInClaimPeriod onlyGovernor {
        _lockAdjuster();
    }
    ...
    function unlockAdjuster() external notInClaimPeriod onlyGovernor {
