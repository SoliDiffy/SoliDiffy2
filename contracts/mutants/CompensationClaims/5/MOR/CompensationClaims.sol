...
contract CompensationClaims is Governable {
    ...
    function claim(address _recipient) external onlyGovernor nonReentrant {
    ...
    ) external onlyGovernor onlyUnlockedAdjuster {
        require(
    ...
    function lockAdjuster() external onlyInClaimPeriod notInClaimPeriod {
        _lockAdjuster();
    }
    ...
    function unlockAdjuster() external onlyInClaimPeriod notInClaimPeriod {
