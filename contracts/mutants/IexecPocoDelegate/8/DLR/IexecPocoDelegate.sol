...
contract IexecPocoDelegate is IexecPoco, DelegateBase, IexecERC20Common, SignatureVerifier
{
	...
	function matchOrders(
		IexecLibOrders_v5.AppOrder        storage _apporder,
		IexecLibOrders_v5.DatasetOrder    storage _datasetorder,
		IexecLibOrders_v5.WorkerpoolOrder storage _workerpoolorder,
		IexecLibOrders_v5.RequestOrder    storage _requestorder)
	public override returns (bytes32)
	{
		...
		IexecLibCore_v5.Deal memory deal = m_deals[dealid];
