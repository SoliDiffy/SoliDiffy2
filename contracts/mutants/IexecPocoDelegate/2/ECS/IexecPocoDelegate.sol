...
contract IexecPocoDelegate is IexecPoco, DelegateBase, IexecERC20Common, SignatureVerifier
{
	...
	public override
	{
		...
		uint256 workerReward    = deal.workerpool.price.percentage(uint8(100).sub(deal.schedulerRewardRatio));
	...
	internal
	{
		...
		uint256 workersReward = totalReward.percentage(uint8(100).sub(deal.schedulerRewardRatio));
