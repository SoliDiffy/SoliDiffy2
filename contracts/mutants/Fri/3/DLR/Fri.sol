...
contract Fri is MemoryMap, MemoryAccessUtils, HornerEvaluator, FriLayer {
    function verifyLastLayer(uint256[] storage ctx, uint256 nPoints) internal view {
    ...
    */
    function friVerifyLayers(uint256[] storage ctx) internal view virtual {
        ...
        uint256[] storage friStepSizes = getFriStepSizes(ctx);
