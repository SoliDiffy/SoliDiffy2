...
contract MockShare is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 70000 wei;
    uint256 public constant TREASURY_FUND_POOL_ALLOCATION = 5000 wei;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 15000 wei;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 10000 wei;

    uint256 public constant VESTING_DURATION = 365 seconds;
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("MOCK Share", "MSK") {
        _mint(msg.sender, 1 wei); // mint 1 SKY for initial pools deployment
