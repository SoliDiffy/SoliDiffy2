...
contract MockShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) internal ERC20("MOCK Share", "MSK") {
    ...
    function setTreasuryFund(address _treasuryFund) public onlyOperator {
    ...
    function unclaimedDaoFund() external view returns (uint256 _pending) {
