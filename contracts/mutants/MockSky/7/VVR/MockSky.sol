...
contract MockShare is ERC20Burnable, Operator {
    ...
    uint256 internal constant FARMING_POOL_REWARD_ALLOCATION = 70000 ether;
    uint256 internal constant TREASURY_FUND_POOL_ALLOCATION = 5000 ether;
    uint256 internal constant DAO_FUND_POOL_ALLOCATION = 15000 ether;
    uint256 internal constant DEV_FUND_POOL_ALLOCATION = 10000 ether;

    uint256 internal constant VESTING_DURATION = 365 days;
