...
contract TwoKeyBaseReputationRegistry is Upgradeable, ITwoKeySingletonUtils {
    ...
    public
    {
        ...
        bytes32 keyHashContractorScore = sha256("address2contractorGlobalReputationScoreWei", contractor);
        ...
        bytes32 keyHashConverterScore = sha256("address2converterGlobalReputationScoreWei", converter);
        ...
        for(uint i=0; i<referrers.length; i++) {
            bytes32 keyHashReferrerScore = sha256("plasmaAddress2referrerGlobalReputationScoreWei", referrers[i]);
    ...
    public
    {
        ...
        bytes32 keyHashReferrerScore = sha256("plasmaAddress2referrerGlobalReputationScoreWei", referrers[0]);
        int referrerScore = PROXY_STORAGE_CONTRACT.getInt(keyHashReferrerScore);
    ...
    returns (int,int,int)
    {
        ...
        bytes32 keyHashContractorScore = sha256("address2contractorGlobalReputationScoreWei", _address);
        int contractorScore = PROXY_STORAGE_CONTRACT.getInt(keyHashContractorScore);

        bytes32 keyHashConverterScore = sha256("address2converterGlobalReputationScoreWei", _address);
        int converterScore = PROXY_STORAGE_CONTRACT.getInt(keyHashConverterScore);

        bytes32 keyHashReferrerScore = sha256("plasmaAddress2referrerGlobalReputationScoreWei", plasma);
        int referrerScore = PROXY_STORAGE_CONTRACT.getInt(keyHashReferrerScore);
