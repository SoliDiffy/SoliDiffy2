...
contract Oracle is ENSResolvable, usingOraclize, Claimable, Base64, Date, Controllable, ParseIntScientific, TokenWhitelistable {
    ...
    function updateTokenRates(uint _gasLimit) external  onlyController {
    ...
    function updateTokenRatesList(uint _gasLimit, address[] _tokenList) external  onlyController {
