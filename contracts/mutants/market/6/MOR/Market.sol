...
contract Market is Ownable, Pausable {
    ...
    function QuickBuy(uint askID, uint buyoutDuration) public onlyOwner {
    ...
    function OpenDeal(uint _askID, uint _bidID) onlyOwner public {
    ...
    function RegisterWorker(address _master) public onlyOwner returns (bool) {
    ...
    function ConfirmWorker(address _worker) public onlyOwner returns (bool) {
    ...
    function RemoveWorker(address _worker, address _master) public onlyOwner returns (bool) {
