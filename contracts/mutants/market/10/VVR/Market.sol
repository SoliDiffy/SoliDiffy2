...
contract Market is Ownable, Pausable {
    ...
    OracleUSD public oracle;

    ProfileRegistry public pr;

    uint public ordersAmount = 0;

    uint public dealAmount = 0;

    uint public requestsAmount = 0;

    // current length of benchmarks
    uint public benchmarksQuantity;

    // current length of netflags
    uint public netflagsQuantity;
