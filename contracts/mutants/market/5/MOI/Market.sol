...
contract Market is Ownable, Pausable {
    ...
    function CancelOrder(uint orderID) public whenNotPaused returns (bool){
    ...
    function CloseDeal(uint dealID, BlacklistPerson blacklisted) public whenNotPaused returns (bool){
    ...
    function Bill(uint dealID) public whenNotPaused returns (bool){
        InternalBill(dealID);
        ReserveNextPeriodFunds(dealID);
        return true;
    }

    function CreateChangeRequest(uint dealID, uint newPrice, uint newDuration) public whenNotPaused returns (uint changeRequestID) {
    ...
    function CancelChangeRequest(uint changeRequestID) public whenNotPaused returns (bool) {
