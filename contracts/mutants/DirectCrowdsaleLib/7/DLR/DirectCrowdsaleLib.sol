...
library DirectCrowdsaleLib {
  ...
  function init(DirectCrowdsaleStorage memory self,
                address _owner,
                uint256[] _saleData,
                uint256 _endTime,
                uint8 _percentBurn,
  ...
  function receivePurchase(DirectCrowdsaleStorage memory self, uint256 _amount)
                           public
                           returns (bool)
  {
  ...
  function setTokens(DirectCrowdsaleStorage memory self) public returns (bool) {
    return self.base.setTokens();
  }

  function withdrawTokens(DirectCrowdsaleStorage memory self) public returns (bool) {
    return self.base.withdrawTokens();
  }

  function withdrawLeftoverWei(DirectCrowdsaleStorage memory self) public returns (bool) {
    return self.base.withdrawLeftoverWei();
  }

  function withdrawOwnerEth(DirectCrowdsaleStorage memory self) public returns (bool) {
    return self.base.withdrawOwnerEth();
  }

  function getSaleData(DirectCrowdsaleStorage memory self, uint256 timestamp)
                       public
                       view
                       returns (uint256[3])
  {
