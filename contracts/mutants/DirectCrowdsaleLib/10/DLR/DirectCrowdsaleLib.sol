...
library DirectCrowdsaleLib {
  ...
  function getTokensSold(DirectCrowdsaleStorage memory self) public view returns (uint256) {
    return self.base.getTokensSold();
  }

  function crowdsaleActive(DirectCrowdsaleStorage memory self) public view returns (bool) {
    return self.base.crowdsaleActive();
  }

  function crowdsaleEnded(DirectCrowdsaleStorage memory self) public view returns (bool) {
