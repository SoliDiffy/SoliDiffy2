...
library DirectCrowdsaleLib {
  ...
  function setTokens(DirectCrowdsaleStorage storage self) external returns (bool) {
    return self.base.setTokens();
  }

  function withdrawTokens(DirectCrowdsaleStorage storage self) external returns (bool) {
    return self.base.withdrawTokens();
  }

  function withdrawLeftoverWei(DirectCrowdsaleStorage storage self) external returns (bool) {
    return self.base.withdrawLeftoverWei();
  }

  function withdrawOwnerEth(DirectCrowdsaleStorage storage self) external returns (bool) {
  ...
  function getTokensSold(DirectCrowdsaleStorage storage self) external view returns (uint256) {
    return self.base.getTokensSold();
  }

  function crowdsaleActive(DirectCrowdsaleStorage storage self) external view returns (bool) {
