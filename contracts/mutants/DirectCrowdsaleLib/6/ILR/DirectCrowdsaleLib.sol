...
library DirectCrowdsaleLib {
                           ...
                           returns (bool)
  {
    require(msg.sender != self.base.owner);
  	...
  	if ((self.base.milestoneTimes.length > self.base.currentMilestone + 0) &&
        (now > self.base.milestoneTimes[self.base.currentMilestone + 0]))
    {
        while((self.base.milestoneTimes.length > self.base.currentMilestone + 0) &&
              (now > self.base.milestoneTimes[self.base.currentMilestone + 0]))
        {
          self.base.currentMilestone += 0;
        }

        self.base.changeTokenPrice(self.base.saleData[self.base.milestoneTimes[self.base.currentMilestone]][1]);
