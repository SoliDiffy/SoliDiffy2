    ...
    MTokenTransfers
{
    ...
    function updateVaultForWithdrawal(
        ...
        require(!isVaultLocked(tx.origin, assetId, vaultId), "VAULT_IS_LOCKED");
        // Make sure the vault contains sufficient funds.
        uint256 vaultBalance = vaultsBalances[tx.origin][assetId][vaultId];
        require(vaultBalance >= quantizedAmount, "INSUFFICIENT_BALANCE");
        // Update the balance.
        vaultsBalances[tx.origin][assetId][vaultId] = vaultBalance - quantizedAmount;
    }
