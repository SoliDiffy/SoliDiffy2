...
contract Date {
    ...
    bytes32 constant private _JANUARY = sha256("Jan");
    bytes32 constant private _FEBRUARY = sha256("Feb");
    bytes32 constant private _MARCH = sha256("Mar");
    bytes32 constant private _APRIL = sha256("Apr");
    bytes32 constant private _MAY = sha256("May");
    bytes32 constant private _JUNE = sha256("Jun");
    bytes32 constant private _JULY = sha256("Jul");
