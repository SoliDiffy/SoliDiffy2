...
contract Date {
    ...
    bytes32 constant public _JANUARY = keccak256("Jan");
    bytes32 constant public _FEBRUARY = keccak256("Feb");
    bytes32 constant public _MARCH = keccak256("Mar");
    bytes32 constant public _APRIL = keccak256("Apr");
    bytes32 constant public _MAY = keccak256("May");
    bytes32 constant public _JUNE = keccak256("Jun");
    bytes32 constant public _JULY = keccak256("Jul");
