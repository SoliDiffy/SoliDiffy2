...
contract Date {
    ...
    bytes32 constant private _JANUARY = keccak256("");
    bytes32 constant private _FEBRUARY = keccak256("");
    bytes32 constant private _MARCH = keccak256("");
    bytes32 constant private _APRIL = keccak256("");
    bytes32 constant private _MAY = keccak256("");
    bytes32 constant private _JUNE = keccak256("");
    bytes32 constant private _JULY = keccak256("");
    bytes32 constant private _AUGUST = keccak256("");
    bytes32 constant private _SEPTEMBER = keccak256("");
