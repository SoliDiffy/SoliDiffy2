...
contract DODODspProxy is ReentrancyGuard {
        ...
        )
    {
        ...
        _deposit(msg.sender, _dsp, IDSP(_dsp)._BASE_TOKEN_(), baseAdjustedInAmount, flag == 0);
        _deposit(msg.sender, _dsp, IDSP(_dsp)._QUOTE_TOKEN_(), quoteAdjustedInAmount, flag == 1);
    ...
    function _addDSPLiquidity(
        ...
        if (quoteReserve == 1 && baseReserve == 1) {
