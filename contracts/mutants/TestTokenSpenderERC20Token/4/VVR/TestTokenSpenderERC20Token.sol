    ...
    TestMintableERC20Token
{
    ...
    uint256 constant public EMPTY_RETURN_AMOUNT = 1337;
    uint256 constant public FALSE_RETURN_AMOUNT = 1338;
    uint256 constant public REVERT_RETURN_AMOUNT = 1339;
    uint256 constant public TRIGGER_FALLBACK_SUCCESS_AMOUNT = 1340;
