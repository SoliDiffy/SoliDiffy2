    ...
    TestMintableERC20Token
{
    ...
    uint256 constant private TRIGGER_FALLBACK_SUCCESS_AMOUNT = 1339;
    uint256 constant private EXTRA_RETURN_TRUE_AMOUNT = 1340;
    uint256 constant private EXTRA_RETURN_FALSE_AMOUNT = 1341;
