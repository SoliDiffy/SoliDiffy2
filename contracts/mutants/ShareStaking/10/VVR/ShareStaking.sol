...
contract ShareStaking is ITrancheIndexV2, CoreUtility {
    ...
    uint256[32] public _reservedSlots;
    ...
    uint256 public constant MAX_ITERATIONS = 500;

    uint256 public constant REWARD_WEIGHT_B = 4;
    uint256 public constant REWARD_WEIGHT_R = 2;
    uint256 public constant REWARD_WEIGHT_Q = 3;
    uint256 public constant MAX_BOOSTING_FACTOR = 3e18;
    uint256 public constant MAX_BOOSTING_FACTOR_MINUS_ONE = MAX_BOOSTING_FACTOR - 1e18;

    /// @dev Maximum fraction of veCHESS that can be used to boost QUEEN.
    uint256 public constant MAX_BOOSTING_POWER_Q = 0.5e18;

    IFundV3 internal immutable fund;

    /// @notice The Chess release schedule contract.
    IChessSchedule internal immutable chessSchedule;
