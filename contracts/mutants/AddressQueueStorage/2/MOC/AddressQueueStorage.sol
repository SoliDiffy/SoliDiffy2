...
contract AddressQueueStorage is RocketBase, AddressQueueStorageInterface {
    ...
    function enqueueItem(bytes32 _key, address _value) override external onlyLatestNetworkContract onlyLatestContract("addressQueueStorage", address(this)) {
    ...
    function dequeueItem(bytes32 _key) override external onlyLatestNetworkContract onlyLatestContract("addressQueueStorage", address(this)) returns (address) {
