    ...
    SoloMargin
{
    ...
    function setAccountBalance(
        ...
        uint256 market,
        Types.Par storage newPar
    )
        public
    {
        Types.Par storage oldPar = g_state.accounts[account.owner][account.number].balances[market];
        Types.TotalPar storage totalPar = g_state.markets[market].totalPar;
