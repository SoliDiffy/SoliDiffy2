...
contract TestAMM is AMM {
    ...
    function setBlockTimestamp(uint256 newValue) external {
    ...
    function integrateOnFundingCurvePublic(
        ...
        int256 v0, // lastEMAPremium
        int256 _lastPremium
    ) external view returns (int256 r) {
    ...
    function forceSetFunding(LibTypes.FundingState memory state) external {
        fundingState = state;
    }
}
