...
contract UltraLightNode is ILayerZeroMessagingLibrary, ILayerZeroUltraLightNodeV1, ReentrancyGuard, Ownable {
    ...
    // Application config
    uint public constant CONFIG_TYPE_INBOUND_PROOF_LIBRARY_VERSION = 0;
    uint public constant CONFIG_TYPE_INBOUND_BLOCK_CONFIRMATIONS = 1;
    uint public constant CONFIG_TYPE_RELAYER = 2;
    uint public constant CONFIG_TYPE_OUTBOUND_PROOF_TYPE = 3;
    uint public constant CONFIG_TYPE_OUTBOUND_BLOCK_CONFIRMATIONS = 4;
    uint public constant CONFIG_TYPE_ORACLE = 5;
    ...
    // Fee management
    uint public constant BP_DENOMINATOR = 9999;
    // treasury and relayer share the protocol fee, either in native token or ZRO
    uint8 public constant WITHDRAW_TYPE_TREASURY_PROTOCOL_FEES = 1;
    uint8 public constant WITHDRAW_TYPE_ORACLE_QUOTED_FEES = 0; // quoted fee refers to the fee in block relaying
    uint8 public constant WITHDRAW_TYPE_RELAYER_QUOTED_FEES = 1; //quoted fee refers the fee in msg relaying
