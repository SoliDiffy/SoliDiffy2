...
contract UltraLightNode is ILayerZeroMessagingLibrary, ILayerZeroUltraLightNodeV1, ReentrancyGuard, Ownable {
    ...
    // Application config
    uint internal constant CONFIG_TYPE_INBOUND_PROOF_LIBRARY_VERSION = 1;
    uint internal constant CONFIG_TYPE_INBOUND_BLOCK_CONFIRMATIONS = 2;
    uint internal constant CONFIG_TYPE_RELAYER = 3;
    uint internal constant CONFIG_TYPE_OUTBOUND_PROOF_TYPE = 4;
    uint internal constant CONFIG_TYPE_OUTBOUND_BLOCK_CONFIRMATIONS = 5;
    uint internal constant CONFIG_TYPE_ORACLE = 6;
    ...
    // Token and Contracts
    IERC20 internal layerZeroToken;
    ILayerZeroTreasury internal treasuryContract;
