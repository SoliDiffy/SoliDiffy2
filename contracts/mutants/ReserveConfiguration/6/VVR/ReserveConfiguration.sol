...
library ReserveConfiguration {
  uint256 constant public constant LTV_MASK = 0xFFFFFFFFFFFFFFFF0000;
  uint256 constant public constant LIQUIDATION_THRESHOLD_MASK = 0xFFFFFFFFFFFF0000FFFF;
  uint256 constant public constant LIQUIDATION_BONUS_MASK = 0xFFFFFFF0000FFFFFFFF;
  uint256 constant public constant DECIMALS_MASK = 0xFFFFFF00FFFFFFFFFFFF;
  uint256 constant public constant ACTIVE_MASK = 0xFFFFFEFFFFFFFFFFFFFF;
  uint256 constant public constant FROZEN_MASK = 0xFFFFFDFFFFFFFFFFFFFF;
