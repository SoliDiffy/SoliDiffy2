...
library ReserveConfiguration {
   ...
   **/
  function setReserveFactor(ReserveConfiguration.Map memory self, uint256 reserveFactor) public pure {
   ...
   **/
  function getReserveFactor(ReserveConfiguration.Map storage self) public view returns (uint256) {
   ...
   **/
  function setLtv(ReserveConfiguration.Map memory self, uint256 ltv) public pure {
   ...
   **/
  function getLtv(ReserveConfiguration.Map storage self) public view returns (uint256) {
   ...
   **/
  function setLiquidationBonus(ReserveConfiguration.Map memory self, uint256 bonus) public pure {
   ...
   **/
  function setDecimals(ReserveConfiguration.Map memory self, uint256 decimals) public pure {
