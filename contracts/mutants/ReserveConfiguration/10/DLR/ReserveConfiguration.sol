...
library ReserveConfiguration {
   ...
   **/
  function setReserveFactor(ReserveConfiguration.Map storage self, uint256 reserveFactor) internal pure {
   ...
   **/
  function getReserveFactor(ReserveConfiguration.Map memory self) internal view returns (uint256) {
   ...
   **/
  function setLtv(ReserveConfiguration.Map storage self, uint256 ltv) internal pure {
   ...
   **/
  function getLtv(ReserveConfiguration.Map memory self) internal view returns (uint256) {
   ...
   **/
  function setLiquidationThreshold(ReserveConfiguration.Map storage self, uint256 threshold)
    internal
    pure
  {
   ...
   **/
  function getLiquidationThreshold(ReserveConfiguration.Map memory self)
    internal
    view
    returns (uint256)
  {
   ...
   **/
  function setLiquidationBonus(ReserveConfiguration.Map storage self, uint256 bonus) internal pure {
   ...
   **/
  function getLiquidationBonus(ReserveConfiguration.Map memory self)
    internal
    view
    returns (uint256)
  {
   ...
   **/
  function setDecimals(ReserveConfiguration.Map storage self, uint256 decimals) internal pure {
   ...
   **/
  function getDecimals(ReserveConfiguration.Map memory self) internal view returns (uint256) {
