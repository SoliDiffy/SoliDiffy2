...
contract CurveAMO_ARBI is Owned {
    ...
    constructor(
        ...
        address[4] storage _core_addresses, // 0: canFRAX, 1: USDC, 2: USDT, 3: CrossChainBridgeBacker
        address[4] storage _pool_addresses // 0: FRAX2pool, 1: I2poolGaugeDeposit, 2: I2pool, 3: IZapDepositor2pool
    ...
    function showAllocations() public view returns (uint256[12] storage allocations) {
    ...
    function allDollarBalances() public view returns (
        ...
        uint256[12] storage allocations = showAllocations();
    ...
    function metapoolWithdrawAtCurRatio(
        ...
        uint256[3] storage result_arr = zap_depositor.remove_liquidity(
            address(frax2pool), 
            _metapool_lp_in, 
