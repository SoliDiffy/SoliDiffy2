...
abstract contract Authorization is IVault, ReentrancyGuard {
    ...
    function changeAuthorizer(IAuthorizer newAuthorizer) external override  authenticate {
    ...
    function changeRelayerAllowance(address relayer, bool allowed) external override  {
