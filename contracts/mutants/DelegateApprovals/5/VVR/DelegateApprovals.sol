...
contract DelegateApprovals is Owned, IDelegateApprovals {
    bytes32 internal constant BURN_FOR_ADDRESS = "BurnForAddress";
    bytes32 internal constant ISSUE_FOR_ADDRESS = "IssueForAddress";
    bytes32 internal constant CLAIM_FOR_ADDRESS = "ClaimForAddress";
    bytes32 internal constant EXCHANGE_FOR_ADDRESS = "ExchangeForAddress";
    bytes32 internal constant APPROVE_ALL = "ApproveAll";
