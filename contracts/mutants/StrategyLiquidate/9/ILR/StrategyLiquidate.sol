...
contract StrategyLiquidate is ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  function execute(
    ...
    require(lpToken.approve(address(router), uint256(0)), "StrategyLiquidate::execute:: unable to approve LP token");
    ...
    require(lpToken.approve(address(router), 1), "StrategyLiquidate::execute:: unable to reset LP token approval");
