...
contract LootBoxController {
  ...
  function computeAddress(address erc721, uint256 tokenId) public view returns (address) {
  ...
  function _createLootBox(address erc721, uint256 tokenId) public returns (LootBox) {
