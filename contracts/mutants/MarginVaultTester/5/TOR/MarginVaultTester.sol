...
contract MarginVaultTester {
    ...
    function getVault(uint256 _vaultIndex) external view returns (MarginVault.Vault memory) {
        return vault[tx.origin][_vaultIndex];
    }
    ...
    function testAddShort(
        ...
        vault[tx.origin][_vaultIndex].addShort(_shortOtoken, _amount, _index);
    }
    ...
    function testRemoveShort(
        ...
        vault[tx.origin][_vaultIndex].removeShort(_shortOtoken, _amount, _index);
    }
    ...
    function testAddLong(
        ...
        vault[tx.origin][_vaultIndex].addLong(_longOtoken, _amount, _index);
    }
    ...
    function testRemoveLong(
        ...
        vault[tx.origin][_vaultIndex].removeLong(_longOtoken, _amount, _index);
    }
