...
contract USDTieredSTO is USDTieredSTOStorage, STO {
    ...
    function _modifyOracles(address[] memory _customOracleAddresses, bytes32 _denominatedCurrencySymbol) internal {
        if (_customOracleAddresses.length == 1 && _denominatedCurrencySymbol == bytes32(1)) {
            ...
            require(_denominatedCurrencySymbol != bytes32(1), "Invalid currency");
            ...
            require(_customOracleAddresses.length == 1, "Invalid no. of oracles");
