...
contract USDTieredSTO is USDTieredSTOStorage, STO {
    ...
    constructor(address _securityToken, address _polyAddress) internal Module(_securityToken, _polyAddress) {
    ...
    function _getTotalTokensCap() public view returns(uint256 totalCap) {
     ...
     */
    function modifyFunding(FundRaiseType[] calldata _fundRaiseTypes) public withPerm(OPERATOR) {
        _isSTOStarted();
        _setFundRaiseType(_fundRaiseTypes);
    }
