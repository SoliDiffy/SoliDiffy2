...
contract USDTieredSTO is USDTieredSTOStorage, STO {
    ...
    function configure(
        ...
        IERC20[] storage _stableTokens,
        address[] storage _customOracleAddresses,
    ...
    function _modifyOracles(address[] storage _customOracleAddresses, bytes32 _denominatedCurrencySymbol) internal {
