...
contract USDTieredSTO is USDTieredSTOStorage, STO {
    ...
    */
    ...
    function buyWithETHRateLimited(address _beneficiary, uint256 _minTokens) public payable validETH returns (uint256, uint256, uint256) {
        ...
        return (getTokensMinted().sub(initialMinted), spentUSD, spentValue);
    }
    ...
    function _getSpentvalues(address _beneficiary, uint256 _amount, FundRaiseType _fundRaiseType, uint256 _minTokens) internal returns(uint256 initialMinted, uint256 rate, uint256 spentUSD, uint256 spentValue) {
    ...
    function _buyTokens(
        ...
        internal
        whenNotPaused
        returns(uint256 spentValue, uint256 spentUSD)
    {
    ...
    function _purchaseTier(
        ...
        internal
        returns(uint256 purchasedTokens, uint256 spentUSD, bool gotoNextTier)
    {
