...
contract USDTieredSTO is USDTieredSTOStorage, STO {
    ...
    */
    ...
    function buyWithETH(address _beneficiary) external  returns (uint256, uint256, uint256) {
    ...
    /**
      ...
      */
    function buyWithETHRateLimited(address _beneficiary, uint256 _minTokens) public  validETH returns (uint256, uint256, uint256) {
