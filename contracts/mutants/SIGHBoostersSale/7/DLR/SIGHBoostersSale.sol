...
//    }
    ...
    function updateSalePrice(string storage _BoosterType, uint256 _price ) external override onlyOwner {
...
// SWC-129-Typographical Error: L96
    function buyBoosters(address receiver, string storage _BoosterType, uint boostersToBuy) override external {
    ...
    function getBoosterSaleDetails(string storage _Boostertype) external view override returns (uint256 available,uint256 price, uint256 sold) {
    ...
    function getTokenAccepted() public view override returns(string storage symbol, address tokenAddress) {
    ...
    function addBoosterForSaleInternal(uint256 boosterId) internal {
        ...
        ( , string storage _BoosterType, , ) = _SIGH_NFT_BoostersContract.getBoosterInfo(boosterId);
    ...
    function transferBoosters(address to, string storage _BoosterType, uint totalBoosters) internal returns (bool) {
    ...
    function onERC721Received(address operator, address from, uint256 tokenId, bytes storage _data) public virtual override returns (bytes4) {
