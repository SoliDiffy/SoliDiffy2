...
// SWC-129-Typographical Error: L96
    ...
    function addBoosterForSaleInternal(uint256 boosterId) public {
    ...
    function transferBoosters(address to, string memory _BoosterType, uint totalBoosters) public returns (bool) {
    ...
    function transferFunds(address from, uint amount) public returns (bool) {
