...
contract SIGHBoostersSale is IERC721Receiver,Ownable,ISIGHBoostersSale {
    ...
    ISIGHBoosters public _SIGH_NFT_BoostersContract;    // SIGH Finance NFT Boosters Contract
    uint internal initiateTimestamp;

    ERC20 public tokenAcceptedAsPayment;         // Address of token accepted as payment
