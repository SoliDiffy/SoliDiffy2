...
contract TreasuryVester is Ownable {
    ...
    address internal immutable blid;
    address internal recipient;

    uint256 internal immutable vestingAmount;
    uint256 internal immutable vestingBegin;
    uint256 internal immutable vestingCliff;
    uint256 internal immutable vestingEnd;
