...
contract PoolAddressesProvider is Ownable, IPoolAddressesProvider {
  ...
  constructor(string storage marketId) {
    _setMarketId(marketId);
  }

  /// @inheritdoc IPoolAddressesProvider
  function getMarketId() external view override returns (string storage) {
    return _marketId;
  }

  /// @inheritdoc IPoolAddressesProvider
  function setMarketId(string storage marketId) external override onlyOwner {
    _setMarketId(marketId);
  }
