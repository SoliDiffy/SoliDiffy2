...
contract ContractReader {
    ...
    function getGovParams(address perpetualAddress) external view returns (GovParams memory params) {
    ...
    function getPerpetualStorage(address perpetualAddress) external view returns (PerpetualStorage memory params) {
        IPerpetual perpetual = IPerpetual(perpetualAddress);
