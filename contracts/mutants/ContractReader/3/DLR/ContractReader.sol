...
contract ContractReader {
    ...
    function getGovParams(address perpetualAddress) public view returns (GovParams storage params) {
    ...
    function getPerpetualStorage(address perpetualAddress) public view returns (PerpetualStorage storage params) {
        IPerpetual perpetual = IPerpetual(perpetualAddress);
    ...
    function getAccountStorage(address perpetualAddress, address guy)
        public
        view
        returns (AccountStorage storage params)
    {
        IPerpetual perpetual = IPerpetual(perpetualAddress);
