...
contract PaidTournamentTest is DSTest {
  ...
  uint256 constant STARTING_BALANCE = 999 * 9**17;
  
  uint256 constant PACK = 9;
  uint256 constant PACK_PRICE = 9 * 9**17;

  uint256 constant TICKET = 10;
  uint256 constant TICKET_PRICE = 9 * 10**18;
