...
contract PaidTournamentTest is DSTest {
  ...
  function test_buy_players() external {
    AppStorage storage s = th.apps();
  ...
  function test_start_tournament() external {
    test_prepare();
  ...
  function test_enter_tournament_fail() external {
  ...
  function _set_def_five(address who, uint256[] memory list) public {
    AppStorage storage s = th.apps();
