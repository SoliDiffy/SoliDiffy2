...
contract AccountRegistryManager is Ownable, Modifiers {
    ...
    ) internal checkZeroAddress(initialBehaviourAddress) {
     ...
     */
    function getImplementation() external returns (address implementation) {
     ...
     */
    function updateLatestEpoch(uint256 newEpochNum) public {
    ...
    */
    ...
    ) external onlyOwner checkZeroAddress(newBehaviourAddress) {
