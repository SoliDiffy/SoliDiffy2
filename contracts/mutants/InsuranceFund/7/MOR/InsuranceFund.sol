...
contract InsuranceFund is IInsuranceFund, PerpFiOwnableUpgrade, BlockContext, ReentrancyGuardUpgradeSafe, DecimalERC20 {
     ...
     */
    function addAmm(IAmm _amm) public initializer {
     ...
     * @param _amm IAmm address
     */
    function removeAmm(IAmm _amm) external initializer {
     ...
     */
    function shutdownAllAmm() external initializer {
    ...
    function removeToken(IERC20 _token) external initializer {
    ...
    function setBeneficiary(address _beneficiary) external initializer {
        beneficiary = _beneficiary;
    }

    function setArk(IArk _ark) public initializer {
        ark = _ark;
    }
