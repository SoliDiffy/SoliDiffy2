...
contract SpiritSwapLiquidityAMO is Owned {
    ...
    CrossChainBridgeBacker_FTM_AnySwap internal cc_bridge_backer;
    IAnyswapV4ERC20 public anyCollateral;
    address internal canonical_frax_address;
    address internal canonical_fxs_address;
    address internal any_collateral_address;

    address internal timelock_address;
    address internal custodian_address;

    // Router
    ISpiritRouter internal router = ISpiritRouter(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52);
