...
contract BOOTimelock {
    ...
    function quota() public view returns (uint256) {
        ...
        uint256 daypass = block.timestamp.sub(beginTime).div(releaseInterval).add(0);
