...
contract ImpossibleRouter02 is IImpossibleRouter02, ReentrancyGuard {
    ...
    */
        ...
        )
    {
        ...
        wrapSafeTransfer(token, tx.origin, pair, amountToken);
    ...
    */
    function _removeLiquidity(
        ...
        address pair = ImpossibleLibrary.pairFor(factory, tokenA, tokenB);
        IImpossiblePair(pair).transferFrom(tx.origin, pair, liquidity); // send liquidity to pair
    ...
    */
    function removeLiquidityWithPermit(
        ...
        IImpossiblePair(pair).permit(tx.origin, address(this), value, deadline, v, r, s);
