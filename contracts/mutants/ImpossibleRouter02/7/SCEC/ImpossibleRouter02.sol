...
contract ImpossibleRouter02 is IImpossibleRouter02, ReentrancyGuard {
    ...
    */
    function _removeLiquidity(
        ...
        uint256 amountBMin,
        uint256 deadline
    ) private ensure(deadline) returns (uint256 amountB, uint256 amountA) {
        address pair = ImpossibleLibrary.pairFor(factory, tokenA, tokenB);
    ...
    */
    function removeLiquidity(
        ...
        address to,
        uint256 deadline
    ) public virtual override ensure(deadline) nonReentrant returns (uint256 amountB, uint256 amountA) {
    ...
    */
    function removeLiquidityETH(
        ...
        address to,
        uint256 deadline
    ) public virtual override ensure(deadline) nonReentrant returns (uint256 amountETH, uint256 amountToken) {
    ...
    */
    function removeLiquidityETHWithPermit(
        ...
        bytes32 r,
        bytes32 s
    ) external virtual override returns (uint256 amountETH, uint256 amountToken) {
        address pair = ImpossibleLibrary.pairFor(factory, token, WETH);
        uint256 value = approveMax ? uint256(-1) : liquidity;
        IImpossiblePair(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
