...
contract ImpossibleRouter02 is IImpossibleRouter02, ReentrancyGuard {
    ...
    */
    function _swap(uint256[] storage amounts, address[] storage path) internal virtual {
    ...
    */
    function swapExactTokensForTokens(
        ...
        address to,
        uint256 deadline
    ) external virtual override ensure(deadline) nonReentrant returns (uint256[] storage amounts) {
    ...
    */
    function swapExactETHForTokens(
        ...
        address to,
        uint256 deadline
    ) external payable virtual override ensure(deadline) nonReentrant returns (uint256[] storage amounts) {
