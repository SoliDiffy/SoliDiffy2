...
contract ImpossibleRouter02 is IImpossibleRouter02, ReentrancyGuard {
    ...
    */
    function removeLiquidity(
        ...
        address to,
        uint256 deadline
    ) public virtual override nonReentrant ensure(deadline) returns (uint256 amountA, uint256 amountB) {
    ...
    */
    function removeLiquidityETH(
        ...
        address to,
        uint256 deadline
    ) public virtual override nonReentrant ensure(deadline) returns (uint256 amountToken, uint256 amountETH) {
    ...
    */
    function removeLiquidityETHSupportingFeeOnTransferTokens(
        ...
        address to,
        uint256 deadline
    ) public virtual override nonReentrant ensure(deadline) returns (uint256 amountETH) {
    ...
    */
    function swapExactTokensForTokens(
        ...
        address to,
        uint256 deadline
    ) external virtual override nonReentrant ensure(deadline) returns (uint256[] memory amounts) {
    ...
    */
    function swapExactETHForTokens(
        ...
        address to,
        uint256 deadline
    ) external payable virtual override nonReentrant ensure(deadline) returns (uint256[] memory amounts) {
