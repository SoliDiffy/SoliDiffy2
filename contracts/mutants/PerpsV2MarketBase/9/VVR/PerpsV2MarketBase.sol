...
contract PerpsV2MarketBase is PerpsV2SettingsMixin, IPerpsV2BaseTypes {
    ...
    int public constant _UNIT = int(10**uint(18));
     ...
     */
    uint32 internal fundingLastRecomputed;
    int128[] internal fundingSequence;
     ...
     */
    int128 public _entryDebtCorrection;
