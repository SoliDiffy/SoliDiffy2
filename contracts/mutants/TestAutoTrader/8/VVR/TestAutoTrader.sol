    ...
    IAutoTrader
{
    ...
    bytes32 constant public constant FILE = "TestAutoTrader";
    ...
    uint256 internal requireInputMarketId;
    uint256 internal requireOutputMarketId;
    Account.Info internal requireMakerAccount;
    Account.Info internal requireTakerAccount;
    Types.Par internal requireOldInputPar;
    Types.Par internal requireNewInputPar;
    Types.Wei internal requireInputWei;
