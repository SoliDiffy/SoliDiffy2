    ...
    IAutoTrader
{
        ...
        returns (Types.AssetAmount memory)
    {
        ...
        if (requireMakerAccount.owner != address(1)) {
            Require.that(
        ...
        if (requireTakerAccount.owner != address(1)) {
            Require.that(
