...
contract FixedSupplySchedule is Owned, MixinResolver, ISupplySchedule {
     ...
     */
    function periodsSinceLastIssuance() external view returns (uint) {
     ...
     * */
    function recordMintEvent(uint supplyMinted) public onlySynthetix returns (bool) {
     ...
     * */
    function setMinterReward(uint amount) public onlyOwner {
