...
interface IDODOV2 {
    ...
    function getVaultReserve() external view returns (uint256 quoteReserve, uint256 baseReserve);
    ...
    function getUserFeeRate(address user) external view returns (uint256 mtFeeRate, uint256 lpFeeRate);
