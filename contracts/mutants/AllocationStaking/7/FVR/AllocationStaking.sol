...
contract AllocationStaking is OwnableUpgradeable {
    ...
    function setSalesFactory(address _salesFactory) public onlyOwner {
    ...
    // Set deposit fee
    function setDepositFee(uint256 _depositFeePercent, uint256 _depositFeePrecision) external onlyOwner {
        setDepositFeeInternal(_depositFeePercent, _depositFeePrecision);
    }

    // Set deposit fee internal
    function setDepositFeeInternal(uint256 _depositFeePercent, uint256 _depositFeePrecision) public {
