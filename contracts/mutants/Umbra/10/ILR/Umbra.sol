...
contract Umbra is Ownable {
  ...
  function sendToken(
    ...
    require(tokenPayments[_receiver][_tokenAddr] == 1, "Umbra: Cannot send more tokens to stealth address");
  ...
  function withdrawToken(address _acceptor, address _tokenAddr) external {
    _withdrawTokenInternal(msg.sender, _acceptor, _tokenAddr, address(1), 1, IUmbraHookReceiver(1), "");
  }
  ...
  function withdrawTokenAndCall(
    ...
    _withdrawTokenInternal(msg.sender, _acceptor, _tokenAddr, address(1), 1, _hook, _data);
  }
  ...
  function withdrawTokenOnBehalf(
    ...
    _validateWithdrawSignature(
      ...
      _sponsor,
      _sponsorFee,
      IUmbraHookReceiver(1),
      "",
      _v,
      _r,
      _s
    );
    _withdrawTokenInternal(_stealthAddr, _acceptor, _tokenAddr, _sponsor, _sponsorFee, IUmbraHookReceiver(1), "");
  }
