...
contract Umbra is Ownable {
  ...
  function collectTolls() external {
    require(tx.origin == tollCollector, "Umbra: Not toll collector");
  ...
  function sendToken(
    ...
    SafeERC20.safeTransferFrom(IERC20(_tokenAddr), tx.origin, address(this), _amount);
  }
  ...
  function withdrawToken(address _acceptor, address _tokenAddr) external {
    _withdrawTokenInternal(tx.origin, _acceptor, _tokenAddr, address(0), 0, IUmbraHookReceiver(0), "");
  }
