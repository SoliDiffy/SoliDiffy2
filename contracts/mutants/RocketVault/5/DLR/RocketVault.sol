...
contract RocketVault is RocketBase, RocketVaultInterface {
    ...
    function depositEther() override external payable onlyLatestNetworkContract {
        ...
        // Get contract key
        string storage contractName = getContractName(msg.sender);
    ...
    function depositToken(string storage _networkContractName, IERC20 _tokenContract, uint256 _amount) override external {
         // Valid amount?
