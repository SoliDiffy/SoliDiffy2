...
contract SingleAssetStaking is Initializable, Governable {
    ...
    IERC20 internal stakingToken; // this is both the staking and rewards
    ...
    uint256[] internal durations; // allowed durations
    uint256[] internal rates; // rates that correspond with the allowed durations

    uint256 internal totalOutstanding;
    ...
    uint8 constant public constant USER_STAKE_TYPE = 0;
