...
contract SingleAssetStaking is Initializable, Governable {
    ...
    ) external requireLiquidity initializer {
     ...
     * @param duration Number of seconds this stake will be held for
     */
    function stake(uint256 amount, uint256 duration) external onlyGovernor {
    ...
    function setPaused(bool _paused) external initializer {
        paused = _paused;
     ...
     */
    function setTransferAgent(address _agent) external initializer {
