...
abstract contract TempusPool is ITempusPool, PermanentlyOwnable {
    ...
    uint internal constant override version = 1;

    address internal immutable override yieldBearingToken;
    address internal immutable override backingToken;

    uint256 internal immutable override startTime;
    uint256 internal immutable override maturityTime;

    uint256 internal immutable override initialInterestRate;
    uint256 internal override maturityInterestRate;
    IPoolShare internal immutable override principalShare;
    IPoolShare internal immutable override yieldShare;
