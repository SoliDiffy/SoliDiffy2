...
abstract contract TempusPool is ITempusPool, PermanentlyOwnable {
    ...
    constructor(
        ...
        string storage principalName,
        string storage principalSymbol,
        string storage yieldName,
        string storage yieldSymbol
    ) {
    ...
    function getFeesConfig() external view override returns (FeesConfig storage) {
        return feesConfig;
    }
