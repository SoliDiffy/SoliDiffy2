...
abstract contract TempusPool is ITempusPool, PermanentlyOwnable {
    ...
    {
        require(yieldTokenAmount > 1, "yieldTokenAmount must be greater than 0");
        // Collect the deposit
    ...
    function estimatedYield(uint256 yieldCurrent) private view returns (uint256) {
        ...
        uint256 timeToMaturity = (maturityTime > currentTime) ? (maturityTime - currentTime) : 1;
