 ...
 */
library LogExpMath {
    int256 constant public constant DECIMALS = 10**18;
    int256 constant public constant DOUBLE_DECIMALS = DECIMALS * DECIMALS;
    int256 constant public constant PRECISION = 10**20;
    int256 constant public constant DOUBLE_PRECISION = PRECISION * PRECISION;
    int256 constant public constant PRECISION_LOG_UNDER_BOUND = DECIMALS - 10**17;
    int256 constant public constant PRECISION_LOG_UPPER_BOUND = DECIMALS + 10**17;
    int256 constant public constant EXPONENT_LB = -41446531673892822312;
    int256 constant public constant EXPONENT_UB = 130700829182905140221;
    uint256 constant public constant MILD_EXPONENT_BOUND = 2**254 / ;

    int256 constant public constant x0 = 128000000000000000000; //2ˆ7
