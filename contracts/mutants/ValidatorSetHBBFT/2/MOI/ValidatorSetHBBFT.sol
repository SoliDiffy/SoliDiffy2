...
contract ValidatorSetHBBFT is IValidatorSetHBBFT, ValidatorSetBase {
    ...
    function initializePublicKeys(bytes[] memory _keys) public onlyStakingContract {
    ...
    function _savePublicKey(address _miningAddress, bytes memory _key) internal onlyStakingContract {
