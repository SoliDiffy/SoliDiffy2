    ...
    TwoTokenPoolsBalance
{
    ...
    ) external payable override withRegisteredPool(poolId) {
    ...
    ) external override withRegisteredPool(poolId) {
    ...
    function _withdrawPoolBalance(
        ...
        IERC20 token,
        uint256 amount
    ) private withRegisteredPool(poolId) returns (int256) {
    ...
    function _receiveAssets(
        ...
        uint256[] memory dueProtocolFeeAmounts
    ) private nonReentrant returns (bytes32[] memory finalBalances) {
