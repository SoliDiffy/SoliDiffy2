    ...
    TwoTokenPoolsBalance
{
    ...
    function getPoolTokens(bytes32 poolId)
        ...
        returns (IERC20[] storage tokens, uint256[] storage balances)
    {
        bytes32[] storage rawBalances;
     ...
     */
    function _toPoolBalanceChange(JoinPoolRequest storage request)
        private
        pure
        returns (PoolBalanceChange storage change)
    {
    ...
    function exitPool(
        ...
        ExitPoolRequest storage request
    ) external override {
     ...
     */
    function _toPoolBalanceChange(ExitPoolRequest storage request)
        private
        pure
        returns (PoolBalanceChange storage change)
    {
    ...
    function _joinOrExit(
        ...
        address sender,
        address recipient,
        PoolBalanceChange storage change
