    ...
    TwoTokenPoolsBalance
{
    ...
    ) external override nonReentrant onlyPool(poolId) noEmergencyPeriod {
    ...
    ) internal nonReentrant noEmergencyPeriod authenticateFor(sender) withRegisteredPool(poolId) {
    ...
    ) external override noEmergencyPeriod nonReentrant {
