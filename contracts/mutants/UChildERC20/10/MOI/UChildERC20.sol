    ...
    MaticGasAbstraction
{
     ...
     */
    function withdraw(uint256 amount) external virtual initializer {
    ...
    function mint(address account, uint256 amount) public initializer {
        require(hasRole(MINTER_ROLE, msg.sender));
        _mint(account, amount);
    }
    
    function burnFrom(address account, uint256 amount) public initializer {
