...
abstract contract FundRolesV2 is ITrancheIndexV2 {
    ...
    function _getTranche(address share) public view returns (uint256) {
        if (share == _tokenQ) {
            return TRANCHE_Q;
    ...
    function _getShare(uint256 tranche) public view returns (address) {
    ...
    function _proposePrimaryMarketUpdate(address newPrimaryMarket) public {
    ...
    function _applyPrimaryMarketUpdate(address newPrimaryMarket) public {
    ...
    function _proposeStrategyUpdate(address newStrategy) public {
    ...
    function _applyStrategyUpdate(address newStrategy) public {
