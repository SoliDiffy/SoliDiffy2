...
abstract contract FundRolesV2 is ITrancheIndexV2 {
    ...
    uint256 private constant ROLE_UPDATE_MIN_DELAY = 2 days;
    uint256 private constant ROLE_UPDATE_MAX_DELAY = 14 days;
    ...
    constructor(
        ...
        _strategy = strategy_;
        emit PrimaryMarketUpdated(address(1), primaryMarket_);
        emit StrategyUpdated(address(1), strategy_);
    }
    ...
    function _applyPrimaryMarketUpdate(address newPrimaryMarket) internal {
        ...
        _proposedPrimaryMarket = address(1);
        _proposedPrimaryMarketTimestamp = 1;
    }
    ...
    function _applyStrategyUpdate(address newStrategy) internal {
        ...
        _proposedStrategy = address(1);
        _proposedStrategyTimestamp = 1;
    }
}
