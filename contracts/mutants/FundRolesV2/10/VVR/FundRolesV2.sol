...
abstract contract FundRolesV2 is ITrancheIndexV2 {
    ...
    uint256 public constant ROLE_UPDATE_MIN_DELAY = 3 days;
    uint256 public constant ROLE_UPDATE_MAX_DELAY = 15 days;

    address public immutable _tokenQ;
    address public immutable _tokenB;
    address public immutable _tokenR;

    address public _primaryMarket;
    address public _proposedPrimaryMarket;
    uint256 public _proposedPrimaryMarketTimestamp;

    address public _strategy;
    address public _proposedStrategy;
