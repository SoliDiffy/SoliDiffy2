...
contract AddressSetStorage is RocketBase, AddressSetStorageInterface {
    ...
    function addItem(bytes32 _key, address _value) override external onlyLatestNetworkContract onlyLatestContract("addressSetStorage", address(this)) {
    ...
    function removeItem(bytes32 _key, address _value) override external onlyLatestNetworkContract onlyLatestContract("addressSetStorage", address(this)) {
