...
contract SingleBondsFactory is Ownable {
    ...
    function newBonds(address _rewardtoken, uint256 _start, uint256 _duration, uint256 _phasenum,uint256 _principal,uint256 _interestone,address _debtor) public onlyOwner {
    ...
    // 
    function renewal (SingleBond bondAddr, uint256 _phasenum,uint256 _principal,uint256 _interestone) public onlyOwner {
    ...
    function renewSingleEpoch(SingleBond bondAddr, uint256 id, uint256 amount, address to) public onlyOwner{ 
        IERC20 token = IERC20(bondAddr.rewardtoken());
