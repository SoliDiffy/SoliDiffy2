...
contract ClearingHouse is DecimalERC20, OwnerPausableUpgradeSafe, ReentrancyGuardUpgradeSafe, BlockContext {
     ...
     */
    function addMargin(IAmm _amm, Decimal.decimal calldata _addedMargin) external nonReentrant() whenNotPaused() {
        // check condition
     ...
     */
    function removeMargin(IAmm _amm, Decimal.decimal calldata _removedMargin) external nonReentrant() whenNotPaused() {
        // check condition
        requireAmm(_amm, true);
