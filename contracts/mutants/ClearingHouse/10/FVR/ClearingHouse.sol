...
contract ClearingHouse is DecimalERC20, OwnerPausableUpgradeSafe, ReentrancyGuardUpgradeSafe, BlockContext {
    ...
    function setFeePool(IMultiTokenRewardRecipient _feePool) public onlyOwner {
        feePool = _feePool;
    }
     ...
     */
    function addMargin(IAmm _amm, Decimal.decimal calldata _addedMargin) public whenNotPaused() nonReentrant() {
        // check condition
     ...
     */
    function removeMargin(IAmm _amm, Decimal.decimal calldata _removedMargin) public whenNotPaused() nonReentrant() {
        // check condition
        requireAmm(_amm, true);
     ...
     * @param _amm IAmm address
     */
    function settlePosition(IAmm _amm) public nonReentrant() {
        // check condition
