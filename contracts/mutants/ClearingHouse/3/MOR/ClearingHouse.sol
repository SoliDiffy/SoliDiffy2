...
contract ClearingHouse is DecimalERC20, OwnerPausableUpgradeSafe, ReentrancyGuardUpgradeSafe, BlockContext {
     ...
     */
    function setLiquidationFeeRatio(Decimal.decimal memory _liquidationFeeRatio) public initializer {
     ...
     */
    function setMaintenanceMarginRatio(Decimal.decimal memory _maintenanceMarginRatio) public initializer {
