...
contract VaultAdmin is VaultStorage {
    ...
    ****************************************/
     ...
     */
    function setPriceProvider(address _priceProvider) external onlyGovernorOrStrategist {
     ...
     */
    function setRedeemFeeBps(uint256 _redeemFeeBps) external onlyGovernorOrStrategist {
     ...
     * @param _threshold OUSD amount with 18 fixed decimals.
     */
    function setRebaseThreshold(uint256 _threshold) external onlyGovernorOrStrategist {
     ...
     */
    function setStrategistAddr(address _address) external onlyGovernorOrStrategist {
     ...
     */
    function supportAsset(address _asset) external onlyGovernorOrStrategist {
     ...
     */
    function approveStrategy(address _addr) external onlyGovernorOrStrategist {
    ...
    function removeStrategy(address _addr) external onlyGovernorOrStrategist {
