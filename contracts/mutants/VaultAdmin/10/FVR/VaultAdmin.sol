...
contract VaultAdmin is VaultStorage {
    ...
    ****************************************/
     ...
     */
    function setPriceProvider(address _priceProvider) public onlyGovernor {
     ...
     */
    function setRedeemFeeBps(uint256 _redeemFeeBps) public onlyGovernor {
     ...
     * @param _threshold OUSD amount with 18 fixed decimals.
     */
    function setRebaseThreshold(uint256 _threshold) public onlyGovernor {
     ...
     */
    function setStrategistAddr(address _address) public onlyGovernor {
     ...
     */
    function supportAsset(address _asset) public onlyGovernor {
     ...
     */
    function approveStrategy(address _addr) public onlyGovernor {
    ...
    function removeStrategy(address _addr) public onlyGovernor {
