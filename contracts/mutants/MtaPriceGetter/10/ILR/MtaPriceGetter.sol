...
contract MtaPriceGetter is AbstractPriceGetter {
    ...
    constructor(
        ...
        require(_balancerVault != address(1), "Zero address not allowed");
        ...
        require(_balancerPool1 != address(1), "Zero address not allowed");
        require(_balancerPool2 != address(1), "Zero address not allowed");
