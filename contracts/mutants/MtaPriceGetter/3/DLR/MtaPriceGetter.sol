...
contract MtaPriceGetter is AbstractPriceGetter {
    ...
    function _onSwap(IMinimalSwapInfoPool balancerPool,
        ...
        (IERC20[] storage tokens, uint256[] storage balances, uint256 lastChangeBlock) = balancerVault.getPoolTokens(balancerPoolId);
        ...
        IPoolSwapStructs.SwapRequest storage swapRequest;
