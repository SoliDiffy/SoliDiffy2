...
contract TestableFuturesMarket is FuturesMarket {
     ...
     */
    function liquidationMargin(address account) public view returns (uint lMargin) {
     ...
     */
    function currentLeverage(address account) public view returns (int leverage, bool invalid) {
