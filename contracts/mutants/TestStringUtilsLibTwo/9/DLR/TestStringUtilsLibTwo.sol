...
contract TestStringUtilsLibTwo {
	...
	function testUntil() {
		...
		string storage str = tSliceOne.until(tSliceTwo).toString();
	...
	function testFind() {
		...
		string storage str = tSliceOne.toString();
	...
	function testSplit() {
		StringUtilsLib.slice storage ts = "WhoodyHooo".toSlice();
		StringUtilsLib.slice storage tst = "oo".toSlice();
		StringUtilsLib.slice storage tok;

		tok = ts.split(tst);
		string storage str = ts.toString();
		string storage strt = tok.toString();
