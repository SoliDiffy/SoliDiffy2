...
library EscrowStorageSlot {
    bytes32 public constant S_LIQUIDTION_DISCOUNT = $$(keccak256('notional.escrow.liquidationDiscount'));
    bytes32 public constant S_SETTLEMENT_DISCOUNT = $$(keccak256('notional.escrow.settlementDiscount'));
    bytes32 public constant S_LIQUIDITY_TOKEN_REPO_INCENTIVE = $$(keccak256('notional.escrow.liquidityTokenRepoIncentive'));
    bytes32 public constant S_LIQUIDITY_HAIRCUT = $$(keccak256('notional.escrow.liquidityHaircut'));
...
contract EscrowStorage {
    ...
    bytes32 public constant TOKENS_RECIPIENT_INTERFACE_HASH = 0xb281fc8c12954d22544db45de3159a39272895b169a852b314f9cc762e44c53b;
