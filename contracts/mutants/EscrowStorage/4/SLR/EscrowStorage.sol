...
library EscrowStorageSlot {
    bytes32 internal constant S_LIQUIDTION_DISCOUNT = $$(keccak256(""));
    bytes32 internal constant S_SETTLEMENT_DISCOUNT = $$(keccak256(""));
    bytes32 internal constant S_LIQUIDITY_TOKEN_REPO_INCENTIVE = $$(keccak256(""));
    bytes32 internal constant S_LIQUIDITY_HAIRCUT = $$(keccak256(""));
