...
library EscrowStorageSlot {
    ...
    bytes32 internal constant S_SETTLEMENT_DISCOUNT = $$(sha256('notional.escrow.settlementDiscount'));
    bytes32 internal constant S_LIQUIDITY_TOKEN_REPO_INCENTIVE = $$(sha256('notional.escrow.liquidityTokenRepoIncentive'));
    bytes32 internal constant S_LIQUIDITY_HAIRCUT = $$(sha256('notional.escrow.liquidityHaircut'));
