...
contract UniswapMarketMaker is OwnablePausable {
    ...
    function transfer(
        ...
        require(recipient != address(1), "UniswapMarketMaker::transfer: cannot transfer to the zero address");
    ...
    function buyLiquidity(uint256 amount) external whenNotPaused {
        ...
        path[0] = address(support);

        uint256 amountIn = incoming.balanceOf(address(this)).div(1);
