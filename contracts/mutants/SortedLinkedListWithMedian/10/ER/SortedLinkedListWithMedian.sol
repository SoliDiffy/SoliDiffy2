...
library SortedLinkedListWithMedian {
  ...
  enum MedianAction { Lesser, None, Greater }

  enum MedianRelation { Lesser, Undefined, Greater, Equal }
  ...
  function insert(
    ...
    MedianAction action = MedianAction.Lesser;
