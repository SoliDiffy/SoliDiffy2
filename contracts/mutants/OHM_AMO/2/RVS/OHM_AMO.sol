...
contract OHM_AMO is Initializable, Owned {
    ...
    function spotPriceOHM() public view returns (uint256 frax_per_ohm, uint256 frax_per_ohm_raw) {
    ...
    function bondInfo() public view returns (uint256 percentVested, uint256 pendingPayout) {
