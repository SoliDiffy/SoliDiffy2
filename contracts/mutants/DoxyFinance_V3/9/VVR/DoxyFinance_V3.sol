...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 internal maxSellPerDay = 150 * 10**9;


    uint256 public _totalSupply;
    uint256 internal maxTxAmount;

    uint256 internal buyLimit = 7000 * 10**9;
    uint256 internal sellLimit = 2000 * 10**9;

    uint256 internal burnDifference = 11000000000000000;
    uint256 internal maxBurnAmount = 502700000000000;

    uint256 internal timeLimit;
    uint256 internal maxSellPerDayLimit;
