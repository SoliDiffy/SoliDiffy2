...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    function isSimilarLiquidityPoolRegistered(IConverter _converter) external view returns (bool) {
    ...
    */
    function getLiquidityPoolByConfig(uint16 _type, IERC20Token[] memory _reserveTokens, uint32[] memory _reserveWeights) external view returns (IConverterAnchor) {
    ...
    */
    function addAnchor(IConverterRegistryData _converterRegistryData, IConverterAnchor _anchor) public {
