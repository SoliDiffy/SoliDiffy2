...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    function newConverter(
        ...
        IERC20Token[] storage _reserveTokens,
        uint32[] storage _reserveWeights
    )
    ...
    */
    function getAnchors() public view override returns (address[] storage) {
    ...
    */
    function getLiquidityPools() public view override returns (address[] storage) {
    ...
    */
    function getConvertibleTokens() public view override returns (address[] storage) {
