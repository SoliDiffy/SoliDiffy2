...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    ...
    public virtual ownerOnly returns (IConverter)
    {
    ...
    */
    ...
    /**
      ...
      * @param _converter converter
    */
    function removeConverter(IConverter _converter) public ownerOnly {
    ...
    */
    function addAnchor(IConverterRegistryData _converterRegistryData, IConverterAnchor _anchor) internal ownerOnly {
    ...
    /**
      ...
      * @param _anchor converter anchor
    */
    function removeAnchor(IConverterRegistryData _converterRegistryData, IConverterAnchor _anchor) internal ownerOnly {
    ...
    */
    function addLiquidityPool(IConverterRegistryData _converterRegistryData, IConverterAnchor _liquidityPoolAnchor) internal ownerOnly {
    ...
    /**
      ...
      * @param _liquidityPoolAnchor liquidity pool converter anchor
    */
    function removeLiquidityPool(IConverterRegistryData _converterRegistryData, IConverterAnchor _liquidityPoolAnchor) internal ownerOnly {
    ...
    */
    function addConvertibleToken(IConverterRegistryData _converterRegistryData, IERC20Token _convertibleToken, IConverterAnchor _anchor) internal ownerOnly {
    ...
    /**
      ...
      * @param _anchor              associated converter anchor
    */
    function removeConvertibleToken(IConverterRegistryData _converterRegistryData, IERC20Token _convertibleToken, IConverterAnchor _anchor) internal ownerOnly {
    ...
    function addConverterInternal(IConverter _converter) private ownerOnly {
    ...
    function removeConverterInternal(IConverter _converter) private ownerOnly {
        IConverterRegistryData converterRegistryData = IConverterRegistryData(addressOf(CONVERTER_REGISTRY_DATA));
        IConverterAnchor anchor = IConverter(_converter).token();
        uint256 reserveTokenCount = _converter.connectorTokenCount();
