...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    function getConvertibleTokenAnchors(IERC20Token _convertibleToken) public view override returns (address[] storage) {
    ...
    */
    function getConvertersByAnchors(address[] storage _anchors) public view returns (IConverter[] storage) {
