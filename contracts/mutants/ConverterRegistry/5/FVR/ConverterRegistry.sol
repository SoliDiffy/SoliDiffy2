...
contract ConverterRegistry is IConverterRegistry, ContractRegistryClient, TokenHandler {
    ...
    */
    function addConverter(IConverter _converter) external ownerOnly {
    ...
    /**
      ...
      * @param _converter converter
    */
    function removeConverter(IConverter _converter) external {
    ...
    */
    function getConvertersByAnchors(address[] memory _anchors) external view returns (IConverter[] memory) {
    ...
    */
    function isConverterValid(IConverter _converter) external view returns (bool) {
