...
contract AddressResolver is Owned, IAddressResolver {
    ...
    function rebuildCaches(MixinResolver[] calldata destinations) public {
    ...
    function areAddressesImported(bytes32[] calldata names, address[] calldata destinations) public view returns (bool) {
        for (uint i = 0; i < names.length; i++) {
    ...
    function getSynth(bytes32 key) public view returns (address) {
