...
contract AvatarArtAuction is AvatarArtBase, IAvatarArtAuction{
     ...
     */ 
    function createAuction(uint256 tokenId, uint256 startTime, uint256 endTime, uint256 price) external override  returns(uint256){
     ...
     * 
     */ 
    function deactivateAuction(uint256 auctionIndex) external override  returns(bool){
