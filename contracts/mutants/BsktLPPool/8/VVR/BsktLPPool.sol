...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 internal BSKTASREWARD = IERC20(0x3d3c60970D3369e48f79664787433fc0d2B7C44b);  // Approve and Transfer for Stake and Withdraw
...
contract BsktLPPool is LPTokenWrapper {
    IERC20 internal STAKEBSKT = IERC20(0x3d3c60970D3369e48f79664787433fc0d2B7C44b); // BSKT TOKEN ADDRESS
    
    uint256 internal duration = 30 days;              //-----| Pool Duration |-----       
    uint256 internal starttime = 0;                   //-----| Pool will start once notify the reward |-----                           
