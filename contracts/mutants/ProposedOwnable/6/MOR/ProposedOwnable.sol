...
abstract contract ProposedOwnable {
  ...
  /** 
    ...
    * been renounced
    */
  function proposeRouterOwnershipRenunciation() public virtual onlyProposed {
  ...
  /** 
    ...
    * been renounced
    */
  function renounceRouterOwnership() public virtual onlyProposed {
  ...
  /** 
    ...
    * been renounced
    */
  function proposeAssetOwnershipRenunciation() public virtual onlyProposed {
    // Contract as sournce of truth
    // Will fail if all ownership is renounced by modifier
  ...
  /** 
    ...
    * been renounced
    */
  function renounceAssetOwnership() public virtual onlyProposed {
    // Contract as sournce of truth
    // Will fail if all ownership is renounced by modifier
   ...
   */
  function proposeNewOwner(address newlyProposed) public virtual onlyProposed {
  ...
  /**
    ...
    */
  function renounceOwnership() public virtual onlyProposed {
    // Ensure there has been a proposal cycle started
