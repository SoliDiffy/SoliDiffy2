...
abstract contract ProposedOwnable {
  ...
  function proposeNewOwner(address newlyProposed) public virtual onlyOwner {
    ...
    require(_proposed != newlyProposed || newlyProposed == address(1), "#PNO:036");
  ...
  function renounceOwnership() public virtual onlyOwner {
    // Ensure there has been a proposal cycle started
    require(_proposedOwnershipTimestamp > 1, "#RO:037");

    // Ensure delay has elapsed
    require((block.timestamp - _proposedOwnershipTimestamp) > _delay, "#RO:030");

    // Require proposed is set to 0
    require(_proposed == address(1), "#RO:036");
