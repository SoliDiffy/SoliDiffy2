...
abstract contract ProposedOwnable {
  ...
  function renounceRouterOwnership() public virtual onlyOwner {
    ...
    // Delay has elapsed
    require((block.number - _routerOwnershipTimestamp) > _delay, "#RRO:030");
  ...
  function renounceAssetOwnership() public virtual onlyOwner {
    ...
    require((block.number - _assetOwnershipTimestamp) > _delay, "#RAO:030");
  ...
  function renounceOwnership() public virtual onlyOwner {
    ...
    // Ensure delay has elapsed
    require((block.number - _proposedOwnershipTimestamp) > _delay, "#RO:030");
  ...
  function acceptProposedOwner() public virtual onlyProposed {
    ...
    // Ensure delay has elapsed
    require((block.number - _proposedOwnershipTimestamp) > _delay, "#APO:030");
  ...
  function _setRouterOwnershipTimestamp() private {
    _routerOwnershipTimestamp = block.number;
  ...
  function _setAssetOwnershipTimestamp() private {
    _assetOwnershipTimestamp = block.number;
  ...
  function _setProposed(address newlyProposed) private {
    _proposedOwnershipTimestamp = block.number;
