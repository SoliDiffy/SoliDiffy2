...
abstract contract ProposedOwnable {
  ...
  address public _proposed;
  uint256 public _proposedOwnershipTimestamp;

  bool public _routerOwnershipRenounced;
  uint256 public _routerOwnershipTimestamp;

  bool public _assetOwnershipRenounced;
  uint256 public _assetOwnershipTimestamp;
