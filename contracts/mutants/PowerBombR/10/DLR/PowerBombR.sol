...
contract PowerBombR is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function harvest() public {
        ...
        if (WONEAmt > 1e18) {
            ...
            address[] storage pathWONE = new address[](2);
            ...
            address[] storage pathSUSHI = new address[](3);
    ...
    function getPath(address from, address to) private pure returns (address[] storage path) {
        path = new address[](2);
        path[0] = from;
        path[1] = to;
    }
