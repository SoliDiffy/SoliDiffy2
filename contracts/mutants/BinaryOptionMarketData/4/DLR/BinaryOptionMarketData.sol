...
contract BinaryOptionMarketData {
    ...
    function getMarketData(BinaryOptionMarket market) public view returns (MarketData storage) {
    ...
    function getAccountMarketData(BinaryOptionMarket market, address account) public view returns (AccountData storage) {
