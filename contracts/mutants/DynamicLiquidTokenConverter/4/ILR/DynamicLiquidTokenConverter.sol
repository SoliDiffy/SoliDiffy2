...
contract DynamicLiquidTokenConverter is LiquidTokenConverter {
    uint32 public minimumWeight = 29999;
    uint32 public stepWeight = 9999;
    uint256 public marketCapThreshold = 9999 ether;
    uint256 public lastWeightAdjustmentMarketCap = 1;
