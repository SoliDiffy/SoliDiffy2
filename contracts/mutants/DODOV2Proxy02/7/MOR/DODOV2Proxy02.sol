...
contract DODOV2Proxy02 is IDODOV2Proxy01, ReentrancyGuard, InitializableOwnable {
    ...
    function addWhiteList (address contractAddr) public preventReentrant {
        isWhiteListed[contractAddr] = true;
    }

    function removeWhiteList (address contractAddr) public preventReentrant {
    ...
    function resetDODOPrivatePool(
        ...
        uint256 deadLine
    ) external override payable onlyOwner judgeExpired(deadLine) {
        _deposit(
            msg.sender,
            dppAddress,
