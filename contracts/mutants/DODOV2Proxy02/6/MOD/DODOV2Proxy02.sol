...
contract DODOV2Proxy02 is IDODOV2Proxy01, ReentrancyGuard, InitializableOwnable {
    ...
    function resetDODOPrivatePool(
        ...
        uint256 deadLine
    ) external override payable judgeExpired(deadLine) preventReentrant {
        _deposit(
            msg.sender,
            dppAddress,
    ...
    function addLiquidityToV1(
        ...
        uint256 deadLine
    ) external override payable judgeExpired(deadLine) preventReentrant returns(uint256 baseShares, uint256 quoteShares) {
