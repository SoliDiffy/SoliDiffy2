...
contract DODOV2Proxy02 is IDODOV2Proxy01, ReentrancyGuard, InitializableOwnable {
        ...
        )
    {
        ...
        // refund dust eth
        if (flag == 1 && msg.value > baseAdjustedInAmount) msg.sender.send(msg.value - baseAdjustedInAmount);
        if (flag == 2 && msg.value > quoteAdjustedInAmount) msg.sender.send(msg.value - quoteAdjustedInAmount);
    }
        ...
        returns (uint256 returnAmount)
    {
        ...
        IWETH(_WETH_).send(dodoPairs[0], msg.value);
