...
contract DODOV2Proxy02 is IDODOV2Proxy01, ReentrancyGuard, InitializableOwnable {
    ...
    function _addDVMLiquidity(
        ...
        uint256 baseInAmount,
        uint256 quoteInAmount
    ) internal view returns (uint256 quoteAdjustedInAmount, uint256 baseAdjustedInAmount) {
    ...
    function addLiquidityToV1(
        ...
        uint256 deadLine
    ) external override payable preventReentrant judgeExpired(deadLine) returns(uint256 quoteShares, uint256 baseShares) {
