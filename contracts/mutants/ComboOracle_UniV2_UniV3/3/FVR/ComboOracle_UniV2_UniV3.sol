...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    // UniV2 / SLP Info
    function uniV2LPBasicInfo(address pair_address) external view returns (UniV2LPBasicInfo memory) {
    ...
    function uniV2LPPriceInfo(address lp_token_address) external view returns (UniV2PriceInfo memory) {
    ...
    function getUniV3NFTBasicInfo(uint256 token_id) external view returns (UniV3NFTBasicInfo memory) {
