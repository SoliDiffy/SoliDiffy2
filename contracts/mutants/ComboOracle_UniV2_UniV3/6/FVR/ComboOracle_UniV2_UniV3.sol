...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    function getUniV3NFTValueInfo(uint256 token_id) external view returns (UniV3NFTValueInfo memory) {
    ...
    function setComboOracle(address _combo_oracle) public onlyByOwnGov {
