...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    function getUniV3NFTBasicInfo(uint256 token_id) public view returns (UniV3NFTBasicInfo storage) {
    ...
    function getUniV3NFTValueInfo(uint256 token_id) public view returns (UniV3NFTValueInfo storage) {
