...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    // Core addresses
    address public timelock_;
    address internal frax_address;
    address internal fxs_address;

    // Oracle info
    ComboOracle internal combo_oracle;

    // UniV2 / SLP
    IUniswapV2Router02 internal router;

    // UniV3
    IUniswapV3Factory internal univ3_factory;
    INonfungiblePositionManager internal univ3_positions;
    ISwapRouter internal univ3_router;

    // Precision
    uint256 internal PRECISE_PRICE_PRECISION = 1e18;
    uint256 internal PRICE_PRECISION = 1e6;
