...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    constructor (
        ...
        address[] storage _starting_addresses
    ...
    // UniV2 / SLP Info
    function uniV2LPBasicInfo(address pair_address) public view returns (UniV2LPBasicInfo storage) {
    ...
    function uniV2LPPriceInfo(address lp_token_address) public view returns (UniV2PriceInfo storage) {
        // Get info about the LP token
        UniV2LPBasicInfo storage lp_basic_info = uniV2LPBasicInfo(lp_token_address);
