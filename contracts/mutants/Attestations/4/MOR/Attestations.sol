  ...
  UsingPrecompiles
{
   ...
   */
  function setAttestationRequestFee(address token, uint256 fee) public initializer {
   ...
   * an attestation and completing it.
   */
  function setAttestationExpiryBlocks(uint256 _attestationExpiryBlocks) public initializer {
