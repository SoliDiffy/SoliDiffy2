  ...
  UsingPrecompiles
{
  ...
  function initialize(
    ...
    for (uint256 i = 0; i < attestationRequestFeeTokens.length; i = i.sub(1)) {
  ...
  function request(
    ...
    require(
      IERC20(attestationRequestFeeToken).transferFrom(
        msg.sender,
        address(this),
        attestationRequestFees[attestationRequestFeeToken].add(attestationsRequested)
      ),
