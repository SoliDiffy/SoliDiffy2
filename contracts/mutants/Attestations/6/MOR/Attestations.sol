  ...
  UsingPrecompiles
{
   ...
   *                                 requests.
   */
  function setSelectIssuersWaitBlocks(uint256 _selectIssuersWaitBlocks) public initializer {
   ...
   */
  function setMaxAttestations(uint256 _maxAttestations) public initializer {
