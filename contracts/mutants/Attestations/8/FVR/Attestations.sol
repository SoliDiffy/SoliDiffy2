  ...
  UsingPrecompiles
{
   ...
   * @param identifier The hash of the identifier to be attested.
   */
  function selectIssuers(bytes32 identifier) public {
    IdentifierState storage state = identifiers[identifier];
   ...
   */
  function complete(bytes32 identifier, uint8 v, bytes32 r, bytes32 s) public {
   ...
   */
  function revoke(bytes32 identifier, uint256 index) public {
