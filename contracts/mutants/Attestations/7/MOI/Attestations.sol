  ...
  UsingPrecompiles
{
   ...
   * @param identifier The hash of the identifier to be attested.
   */
  function selectIssuers(bytes32 identifier) external initializer {
    IdentifierState storage state = identifiers[identifier];
   ...
   */
  function complete(bytes32 identifier, uint8 v, bytes32 r, bytes32 s) external initializer {
   ...
   */
  function revoke(bytes32 identifier, uint256 index) external initializer {
   ...
   */
  function withdraw(address token) external initializer {
   ...
   * @param identifier The hash of the identifier to be attested.
   */
  function addIncompleteAttestations(bytes32 identifier) internal initializer {
   ...
   */
  function _transfer(bytes32 identifier, uint256 index, address from, address to) internal initializer {
    uint256 numAccounts = identifiers[identifier].accounts.length;
    require(index < numAccounts, "Index is invalid");
