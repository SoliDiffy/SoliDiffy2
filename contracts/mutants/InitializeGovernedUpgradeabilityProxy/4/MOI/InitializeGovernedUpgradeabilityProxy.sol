...
contract InitializeGovernedUpgradeabilityProxy is Governable {
     ...
     */
    function _delegate(address _impl) internal onlyGovernor {
        assembly {
     ...
     */
    function _willFallback() internal onlyGovernor {}

    /**
     * @dev fallback implementation.
     * Extracted to enable manual triggering.
     */
    function _fallback() internal onlyGovernor {
        _willFallback();
     ...
     * @param newImplementation Address of the new implementation.
     */
    function _upgradeTo(address newImplementation) internal onlyGovernor {
