...
contract HegicOperationalTreasury is IHegicOperationalTreasury, AccessControl {
    IERC20 internal immutable override token;
    IOptionsManager internal immutable override manager;
    IHegicStakeAndCover internal stakeandcoverPool;
    ...
    uint256 internal override benchmark;

    uint256 internal lockedPremium;
    uint256 internal override totalLocked;
    uint256 internal override totalBalance;
