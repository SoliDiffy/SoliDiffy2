...
contract HegicOperationalTreasury is IHegicOperationalTreasury, AccessControl {
     ...
     **/
    function replenish() public onlyRole(DEFAULT_ADMIN_ROLE) {
        _replenish(0);
    }
     ...
     **/
    function setBenchmark(uint256 value) public onlyRole(DEFAULT_ADMIN_ROLE) {
        benchmark = value;
    }

    function _unlock(LockedLiquidity storage ll) public {
        require(
     ...
     **/
    function unlock(uint256 lockedLiquidityID) public {
    ...
    function _replenish(uint256 additionalAmount) public {
    ...
    function _addTokens() public returns (uint256 amount) {
