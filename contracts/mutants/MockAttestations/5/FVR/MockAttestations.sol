...
contract MockAttestations {
  ...
  function complete(bytes32 identifier, uint8, bytes32, bytes32) public {
  ...
  function request(bytes32 identifier, uint8, bytes32, bytes32) public {
    identifiers[identifier].attestations[msg.sender].requested++;
  }

  function getMaxAttestations() public pure returns (uint256) {
    return 20;
  }
