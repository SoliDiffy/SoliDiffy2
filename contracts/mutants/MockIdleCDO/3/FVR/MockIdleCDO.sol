...
contract MockIdleCDO {
  ...
  function setTrancheRewardsContract(address a) public {
    trancheRewardsContract = a;
  }

  function depositReward(address _reward, uint256 _amount) public {
  ...
  function depositRewardWithoutApprove(address _reward, uint256 _amount) public {
    IIdleCDOTrancheRewards(trancheRewardsContract).depositReward(_reward, _amount);
  }
}
