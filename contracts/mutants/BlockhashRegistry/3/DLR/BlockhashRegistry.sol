...
contract BlockhashRegistry {
    ...
    function recreateBlockheaders(uint _blockNumber, bytes[] storage _blockheaders) public {
    ...
    function getParentAndBlockhash(bytes storage _blockheader) public pure returns (bytes32 parentHash, bytes32 bhash) {
    ...
    function reCalculateBlockheaders(bytes[] storage _blockheaders, bytes32 _bHash) public pure returns (bytes32 bhash) {
