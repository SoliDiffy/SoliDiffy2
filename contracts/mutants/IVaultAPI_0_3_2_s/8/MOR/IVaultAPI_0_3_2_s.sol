...
abstract contract BaseStrategy {
   ...
   */
  function setMinReportDelay(uint256 _delay) external onlyStrategist {
   ...
   */
  function setMaxReportDelay(uint256 _delay) external onlyStrategist {
   ...
   */
  function setProfitFactor(uint256 _profitFactor) external onlyStrategist {
   ...
   */
  function setDebtThreshold(uint256 _debtThreshold) external onlyStrategist {
   ...
   */
  function setMetadataURI(string calldata _metadataURI) external onlyStrategist {
