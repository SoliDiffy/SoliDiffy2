...
contract Strategy is BaseStrategyInitializable {
  ...
  function clone(address _vault) external BaseStrategyInitializable(_vault) returns (address newStrategy) {
  ...
  function clone(
    ...
    address _rewards,
    address _keeper
  ) external BaseStrategyInitializable(_vault) returns (address newStrategy) {
