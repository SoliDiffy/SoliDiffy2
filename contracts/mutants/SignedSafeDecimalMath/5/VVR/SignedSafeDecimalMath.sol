...
library SignedSafeDecimalMath {
    ...
    int internal constant UNIT = int(10**uint(decimals));

    /* The number representing 1.0 for higher fidelity numbers. */
    int internal constant PRECISE_UNIT = int(10**uint(highPrecisionDecimals));
    int public constant UNIT_TO_HIGH_PRECISION_CONVERSION_FACTOR = int(10**uint(highPrecisionDecimals - decimals));
