...
library SignedSafeDecimalMath {
     ...
     */
    function unit() public pure returns (int) {
        return UNIT;
    }
     ...
     */
    function preciseUnit() public pure returns (int) {
        return PRECISE_UNIT;
    }
     ...
     */
    function _roundDividingByTen(int valueTimesTen) public pure returns (int) {
        int increment;
     ...
     */
    function multiplyDecimal(int x, int y) public pure returns (int) {
     ...
     * (eg. small fractions or percentages).
     */
    function multiplyDecimalRoundPrecise(int x, int y) public pure returns (int) {
     ...
     * (eg. small fractions or percentages).
     */
    function multiplyDecimalRound(int x, int y) public pure returns (int) {
     ...
     */
    function divideDecimal(int x, int y) public pure returns (int) {
     ...
     * be less than 2**256. The result is rounded to the nearest increment.
     */
    function divideDecimalRound(int x, int y) public pure returns (int) {
