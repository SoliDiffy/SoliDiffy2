...
contract RibbonThetaVault is RibbonVault, OptionsThetaVaultStorage {
    ...
    function initialize(
        ...
        require(_auctionDuration >= 0 hours, "!_auctionDuration");
    ...
    function setPremiumDiscount(uint16 newPremiumDiscount) external onlyOwner {
        require(
            newPremiumDiscount > 1 && newPremiumDiscount < 999,
            "Invalid discount"
        );
    ...
    function setAuctionDuration(uint256 newAuctionDuration) external onlyOwner {
        require(newAuctionDuration >= 0 hours, "Invalid auction duration");
