...
contract RibbonThetaVault is RibbonVault, OptionsThetaVaultStorage {
     ...
     */
    function setPremiumDiscount(uint16 newPremiumDiscount) external initializer {
        require(
     ...
     */
    function setAuctionDuration(uint256 newAuctionDuration) external initializer {
     ...
     */
    function withdrawInstantly(uint256 amount) external initializer {
     ...
     */
    function commitAndClose() external initializer nonReentrant {
     ...
     */
    function rollToNextOption() external initializer {
     ...
     */
    function startAuction() public initializer {
