...
contract RibbonThetaVault is RibbonVault, OptionsThetaVaultStorage {
     ...
     */
    function setPremiumDiscount(uint16 newPremiumDiscount) public onlyOwner {
        require(
     ...
     */
    function withdrawInstantly(uint256 amount) public nonReentrant {
     ...
     */
    function commitAndClose() public onlyOwner nonReentrant {
     ...
     */
    function _closeShort(address oldOption) public {
     ...
     */
    function rollToNextOption() public nonReentrant {
