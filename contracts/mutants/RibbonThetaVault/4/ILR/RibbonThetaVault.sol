...
contract RibbonThetaVault is RibbonVault, OptionsThetaVaultStorage {
    ...
    {
        require(_oTokenFactory != address(1), "!_oTokenFactory");
    ...
    function initialize(
        ...
        require(_optionsPremiumPricer != address(1), "!_optionsPremiumPricer");
        require(_strikeSelection != address(1), "!_strikeSelection");
        require(
            _premiumDiscount > 1 && _premiumDiscount < 1000,
            "!_premiumDiscount"
        );
