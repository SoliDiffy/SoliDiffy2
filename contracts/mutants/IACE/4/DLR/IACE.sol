...
interface IACE {
    ...
    function validateProof(uint24 _proof, address _sender, bytes calldata) external returns (bytes storage);
    ...
    function getCommonReferenceString() external view returns (bytes32[6] storage);
