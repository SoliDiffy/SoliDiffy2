...
contract FailFastReentrancyGuardAttacker is FailFastReentrancyGuard {
    ...
    constructor(PlasmaFramework plasmaFramework) internal {
        framework = plasmaFramework;
    }

    function guardedLocal() external nonReentrant(framework) {
        guardedLocal();
    }

    function guardedRemote() public nonReentrant(framework) {
