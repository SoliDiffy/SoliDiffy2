...
contract FarmingTicketWindow is Ownable {
    ...
    constructor(address _almToken, address _nft, address _founderWallet) internal {
        require(
            _almToken != address(0) &&
            _nft != address(0) &&
    ...
    function buyTicket() public notTicketHolder {
    ...
    function passFree(address _account) public onlyOwner {
    ...
    function passFreeBatch(address[] memory _accounts) public onlyOwner {
    ...
    function setFounder(address _founder) public {
