...
contract FarmingTicketWindow is Ownable {
    ...
    function buyTicket() external onlyOwner {
    ...
    function passFree(address _account) external notTicketHolder {
    ...
    function passFreeBatch(address[] memory _accounts) external notTicketHolder {
