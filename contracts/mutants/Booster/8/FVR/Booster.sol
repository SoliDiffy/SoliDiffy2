...
contract Booster{
    ...
    function setRewardManager(address _rmanager) public onlyOwner{
    ...
    function claimOperatorRoles() public onlyOwner{
    ...
    function setPoolFees(uint256 _cvxfxs, uint256 _cvx, uint256 _platform) public onlyOwner{
        require(!isShutdown,"shutdown");
    ...
    function setPoolFeeDeposit(address _deposit) public onlyOwner{
        require(!isShutdown,"shutdown");
