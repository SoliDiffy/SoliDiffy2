...
contract Booster{
    ...
    function addPool(address _implementation, address _stakingAddress, address _stakingToken) public onlyOwner{
    ...
    function setPoolRewardImplementation(address _impl) public onlyOwner{
