...
contract TokenExchanger is Owned {
    ...
    constructor(address _owner, address _integrationProxy) internal Owned(_owner) {
        integrationProxy = _integrationProxy;
    }

    function setSynthetixProxy(address _integrationProxy) public onlyOwner {
        integrationProxy = _integrationProxy;
    }

    function setSynthetix(address _synthetix) public onlyOwner {
