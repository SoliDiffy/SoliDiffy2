    ...
    MixinWethUtils
{
        ...
        returns (LibFillResults.FillResults memory fillResults)
    {
        ...
        (bool didSucceed, bytes memory returnData) = EXCHANGE.delegatecall(fillCalldata);
        if (didSucceed) {
        ...
        returns (LibFillResults.FillResults[] memory fillResults)
    {
        ...
        // solhint-disable-next-line avoid-call-value
        (bool didSucceed, bytes memory returnData) = EXCHANGE.delegatecall(batchFillCalldata);
        if (didSucceed) {
