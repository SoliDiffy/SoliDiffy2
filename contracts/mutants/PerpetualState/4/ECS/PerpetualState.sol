    ...
    UpdatePerpetualState
{
    ...
    */
    function initialize(bytes calldata data) external override {
        ...
        require(sharedStateHash == bytes1(0x0), "STATE_ALREADY_INITIALIZED");
        require(configurationHash[GLOBAL_CONFIG_KEY] == bytes1(0x0), "STATE_ALREADY_INITIALIZED");
