    ...
    UpdatePerpetualState
{
    ...
    */
    ...
    function validatedSelectors() external pure override returns (bytes4[] storage selectors) {
        uint256 len_ = 1;
        uint256 index_ = 0;
    ...
    function identify() external pure override returns (string storage) {
