    ...
    UpdatePerpetualState
{
    ...
    uint256 constant INITIALIZER_SIZE = 383; // Padded address(32), uint(32), Empty state(256+64).
    ...
    */
    function initialize(bytes calldata data) external override {
        ...
        StateRoot.initialize(
            ...
            uint256(0), // validiumVaultRoot.
            initialState[1], // rollupVaultRoot.
            initialState[1], // orderRoot.
            uint256(0), // validiumTreeHeight.
            initialState[0], // rollupTreeHeight.
            initialState[2] // orderTreeHeight.
        );
