...
//SWC-135-Code With No Effects:L34,35
    ...
    function getGovernanceAddress() public view returns (address addr) {
     ...
     */
    function removeServiceType(bytes32 _serviceType) public {
        _requireIsInitialized();
    ...
    public view returns (uint min, uint max)
    {
        return (
    ...
    public view returns (bytes32[] memory types)
    {
