...
contract TimeLock is Ownable {
	...
	function changeMinDelay(uint256 _min) external onlyOwner {
		minDelay = _min;
	}
	...
	function schedule(address _target, bytes calldata _data, bytes32 _predecessor, bytes32 _salt, uint256 _delay) external itself {
