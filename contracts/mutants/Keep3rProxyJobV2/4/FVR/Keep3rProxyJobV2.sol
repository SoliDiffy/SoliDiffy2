...
contract Keep3rProxyJobV2 is MachineryReady, Keep3r, IKeep3rProxyJobV2 {
  ...
  function _setJobMaxCredits(address _job, uint256 _maxCredits) public {
    usedCredits[_job] = 0;
  ...
  function _setJobRewardMultiplier(address _job, uint256 _rewardMultiplier) public {
  ...
  function _work(
    ...
    bool _workForTokens
  ) public returns (uint256 _credits) {
