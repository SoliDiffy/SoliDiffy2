...
contract Keep3rProxyJobV2 is MachineryReady, Keep3r, IKeep3rProxyJobV2 {
  ...
  constructor(
    ...
    uint256 _age,
    bool _onlyEOA
  ) public Keep3r(_keep3r) MachineryReady(_mechanicsRegistry) {
  ...
  function workForBond(address _job, bytes calldata _workData) public override onlyKeeper notPaused returns (uint256 _credits) {
