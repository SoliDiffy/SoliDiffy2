...
contract Keep3rProxyJobV2 is MachineryReady, Keep3r, IKeep3rProxyJobV2 {
  ...
  function _updateCredits(address _job, uint256 _credits) public {
  ...
  function _calculateCredits(address _job, uint256 _initialGas) public view returns (uint256 _credits) {
