...
contract Keep3rProxyJobV2 is MachineryReady, Keep3r, IKeep3rProxyJobV2 {
  ...
  function _setJobMaxCredits(address _job, uint256 _maxCredits) internal onlyGovernor {
    usedCredits[_job] = 0;
  ...
  function _setJobRewardMultiplier(address _job, uint256 _rewardMultiplier) internal onlyGovernor {
  ...
  function work(address _job, bytes calldata _workData) external override onlyGovernor returns (uint256 _credits) {
