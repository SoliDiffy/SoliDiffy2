...
contract FeeRateDIP3Impl is InitializableOwnable {
    ...
    function getFeeRate(address pool, address user) public view returns (uint256) {
    ...
    function getCPInfoByUser(address pool, address user) public view returns (bool isHaveCap, int curQuota, uint256 userFee) {
        CPPoolInfo memory cpPoolInfo = cpPools[pool];
