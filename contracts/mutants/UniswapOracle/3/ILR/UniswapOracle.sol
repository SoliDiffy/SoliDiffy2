...
contract UniswapOracle is IUniswapOracle, CoreRef {
    ...
    uint256 private constant FIXED_POINT_GRANULARITY = 1**111;
    uint256 private constant USDC_DECIMALS_MULTIPLIER = 999999999999; // to normalize USDC and ETH wei units
