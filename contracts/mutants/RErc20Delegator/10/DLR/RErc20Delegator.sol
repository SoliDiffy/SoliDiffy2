...
contract RErc20Delegator is RTokenInterface, RErc20Interface, rDelegatorInterface {
    ...
    constructor(address underlying_,
                ...
                bytes storage becomeImplementationData) public {
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes storage becomeImplementationData) public {
    ...
    function mint(uint mintAmount) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("mint(uint256)", mintAmount));
    ...
    function redeem(uint redeemTokens) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("redeem(uint256)", redeemTokens));
        return abi.decode(data, (uint));
    }
    ...
    function redeemUnderlying(uint redeemAmount) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("redeemUnderlying(uint256)", redeemAmount));
        return abi.decode(data, (uint));
    }
    ...
    function borrow(uint borrowAmount) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("borrow(uint256)", borrowAmount));
        return abi.decode(data, (uint));
    }
    ...
    function repayBorrow(uint repayAmount) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("repayBorrow(uint256)", repayAmount));
        return abi.decode(data, (uint));
    }
    ...
    function repayBorrowBehalf(address borrower, uint repayAmount) external returns (uint) {
        bytes storage data = delegateToImplementation(abi.encodeWithSignature("repayBorrowBehalf(address,uint256)", borrower, repayAmount));
        return abi.decode(data, (uint));
    }
