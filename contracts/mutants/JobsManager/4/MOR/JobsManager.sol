...
contract JobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
     ...
     */
    function setVerificationRate(uint64 _verificationRate) external whenSystemNotPaused {
     ...
     */
    function setVerificationPeriod(uint256 _verificationPeriod) external whenSystemNotPaused {
     ...
     */
    function setVerificationSlashingPeriod(uint256 _verificationSlashingPeriod) external whenSystemNotPaused {
        // Verification period + verification slashing period currently cannot be longer than 256 blocks
        // because contracts can only access the last 256 blocks from
        // the current block
     ...
     */
    function setFailedVerificationSlashAmount(uint256 _failedVerificationSlashAmount) external whenSystemNotPaused {
