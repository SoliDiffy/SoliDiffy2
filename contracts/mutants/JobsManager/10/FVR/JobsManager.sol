...
contract JobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
     ...
     */
    function setDoubleClaimSegmentSlashAmount(uint256 _doubleClaimSegmentSlashAmount) public onlyControllerOwner {
        // Must be a valid percentage
     ...
     */
    function setFinderFee(uint256 _finderFee) public onlyControllerOwner {
        // Must be a valid percentage
     ...
     */
    function deposit() public payable whenSystemNotPaused {
