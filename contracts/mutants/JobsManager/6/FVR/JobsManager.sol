...
contract JobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
    ...
    function JobsManager(address _controller) internal Manager(_controller) {}
     ...
     */
    function setVerificationRate(uint64 _verificationRate) public onlyControllerOwner {
     ...
     */
    function setVerificationPeriod(uint256 _verificationPeriod) public onlyControllerOwner {
     ...
     */
    function setVerificationSlashingPeriod(uint256 _verificationSlashingPeriod) public onlyControllerOwner {
        // Verification period + verification slashing period currently cannot be longer than 256 blocks
        // because contracts can only access the last 256 blocks from
        // the current block
     ...
     */
    function setFailedVerificationSlashAmount(uint256 _failedVerificationSlashAmount) public onlyControllerOwner {
     ...
     */
    function setMissedVerificationSlashAmount(uint256 _missedVerificationSlashAmount) public onlyControllerOwner {
        // Must be a valid percentage
