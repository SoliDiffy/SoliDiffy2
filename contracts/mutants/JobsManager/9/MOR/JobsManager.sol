...
contract JobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
     ...
     */
    function setMissedVerificationSlashAmount(uint256 _missedVerificationSlashAmount) external whenSystemNotPaused {
        // Must be a valid percentage
     ...
     */
    function setDoubleClaimSegmentSlashAmount(uint256 _doubleClaimSegmentSlashAmount) external whenSystemNotPaused {
        // Must be a valid percentage
     ...
     */
    function setFinderFee(uint256 _finderFee) external whenSystemNotPaused {
        // Must be a valid percentage
     ...
     */
    function deposit() external payable onlyControllerOwner {
     ...
     */
    function withdraw() external onlyControllerOwner {
