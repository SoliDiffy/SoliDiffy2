...
contract JobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
    ...
    function getJob(
        ...
        public
        view
        returns (string transcodingOptions, string streamId, uint256 totalClaims, address transcoderAddress, address broadcasterAddress, uint256 maxPricePerSegment, uint256 creationRound, uint256 creationBlock, uint256 endBlock, uint256 escrow)
    {
        Job storage job = jobs[_jobId];
    ...
    function getClaim(
        ...
        public
        view
        returns (uint256[2] segmentRange, bytes32 claimRoot, uint256 endVerificationSlashingBlock, uint256 claimBlock, uint256 endVerificationBlock, ClaimStatus status)
    {
