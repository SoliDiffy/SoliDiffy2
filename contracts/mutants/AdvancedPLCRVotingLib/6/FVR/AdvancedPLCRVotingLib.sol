...
library AdvancedPLCRVotingLib {
     ...
     * @param ballot Details of the given ballot id
     */
    function getCurrentBallotStage(AdvancedPLCRVotingCheckpointStorage.Ballot storage ballot) external view returns (AdvancedPLCRVotingCheckpointStorage.Stage) {
    ...
    function _getNoOfChoice(uint256 _noOfChoice) public pure returns(uint256 noOfChoice) {
