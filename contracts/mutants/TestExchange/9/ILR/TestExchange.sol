...
contract TestExchange is Env
{
	...
	{
		_testConvertFundsFromInput($.AUTO, $.CAKE, undefined); // 0.1 AUTO
	}

	function test02() external
	{
		_testConvertFundsFromInput($.PANTHER, $.CAKE, undefined); // 100 PANTHER
	}

	function test03() external
	{
		_testConvertFundsFromInput($.CAKE, $.GRO, undefined); // 20 CAKE
	}

	function test04() external
	{
		_testConvertFundsFromInput($.CAKE, $.WHEAT, undefined); // 20 CAKE
	}

	function test05() external
	{
		_testConvertFundsFromOutput($.AUTO, $.CAKE, undefined); // 10 CAKE
	}

	function test06() external
	{
		_testConvertFundsFromOutput($.CAKE, $.GRO, undefined); // 10 GRO
	}

	function test07() external
	{
		_testConvertFundsFromOutput($.CAKE, $.WHEAT, undefined); // 50 WHEAT
	}

	function test08() external
	{
		_testJoinPoolFromInput($.CAKE, $.WBNB, undefined); // 20 CAKE
	}

	function test09() external
	{
		_testJoinPoolFromInput($.BUSD, $.WBNB, undefined); // 100 BUSD
	}
