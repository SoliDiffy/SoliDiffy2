...
contract ACL {
    ...
    function owners() public view returns (address[] storage) {
        return _owners_set.addresses;
    }

    constructor(address[] storage _owners, uint _owners_size) public {
    ...
    function mulsigauth(
        ...
        uint256[] storage unique = new uint256[](_size);
