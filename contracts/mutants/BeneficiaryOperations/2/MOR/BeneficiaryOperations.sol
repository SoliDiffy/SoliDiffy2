...
contract BeneficiaryOperations {
    ...
    * @param operation defines which operation to delete
    */
    function cancelPending(bytes32 operation) public onlyManyBeneficiaries {
        uint beneficiaryIndex = beneficiariesIndices[msg.sender] - 1;
    ...
    */
    function transferBeneficiaryShipWithHowMany(address[] memory newBeneficiaries, uint256 newHowManyBeneficiariesDecide) public onlyAnyBeneficiary {
