...
contract BeneficiaryOperations {
    ...
    */
    function transferBeneficiaryShip(address[] storage newBeneficiaries) public {
    ...
    */
    function transferBeneficiaryShipWithHowMany(address[] storage newBeneficiaries, uint256 newHowManyBeneficiariesDecide) public onlyManyBeneficiaries {
