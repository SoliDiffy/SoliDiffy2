...
contract BeneficiaryOperations {
    ...
    */
    ...
    constructor() public {
        beneficiaries.push(tx.origin);
        beneficiariesIndices[tx.origin] = 1;
    ...
    function checkHowManyBeneficiaries(uint howMany) internal returns(bool) {
        ...
        if (operationVotesCount == 1) {
            ...
            emit OperationCreated(operation, howMany, beneficiaries.length, tx.origin);
        }
