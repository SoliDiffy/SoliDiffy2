...
contract BeneficiaryOperations {
    ...
    function isExistBeneficiary(address wallet) external view returns(bool) {
        return beneficiariesIndices[wallet] > 0;
    }

    function beneficiaryIndices(address wallet) external view returns(uint256) {
    ...
    */
     ...
     */
    function checkHowManyBeneficiaries(uint howMany) public returns(bool) {
    ...
    */
    function deleteOperation(bytes32 operation) public {
    ...
    * @param operation defines which operation to delete
    */
    function cancelPending(bytes32 operation) external onlyAnyBeneficiary {
        uint beneficiaryIndex = beneficiariesIndices[msg.sender] - 1;
    ...
    */
    function transferBeneficiaryShip(address[] memory newBeneficiaries) external {
