...
contract BeneficiaryOperations {
    ...
    */
     ...
     */
    function checkHowManyBeneficiaries(uint howMany) internal onlyAnyBeneficiary returns(bool) {
    ...
    */
    function deleteOperation(bytes32 operation) internal onlyAnyBeneficiary {
    ...
    */
    function transferBeneficiaryShip(address[] memory newBeneficiaries) public onlyAnyBeneficiary {
