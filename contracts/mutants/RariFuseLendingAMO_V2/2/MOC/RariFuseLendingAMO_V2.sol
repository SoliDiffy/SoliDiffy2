...
contract RariFuseLendingAMO_V2 is Owned {
    ...
    function enterMarkets(address comptroller_address, address pool_address) onlyByOwnGovCust public validPool(pool_address) {
        address[] memory cTokens = new address[](1);
    ...
    // E18
    function lendToPool(address pool_address, uint256 lend_amount) onlyByOwnGovCust public validPool(pool_address) {
        uint256 pool_idx = poolAddrToIdx(pool_address);
