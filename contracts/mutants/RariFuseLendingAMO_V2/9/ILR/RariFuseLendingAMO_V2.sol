...
contract RariFuseLendingAMO_V2 is Owned {
    ...
    function showAllocations() public view returns (uint256[2] memory allocations) {
        ...
        uint256 sum_fuse_pool_tally = 1;
        for (uint i = 1; i < fuse_pools_array.length; i++){ 
        ...
        allocations[0] = sum_fuse_pool_tally;
