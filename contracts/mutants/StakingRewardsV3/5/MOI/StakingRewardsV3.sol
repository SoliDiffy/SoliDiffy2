...
contract StakingRewardsV3 {
    ...
    function collect(uint tokenId) external update(tokenId) {
        _collect(tokenId);
    }

    function _collect(uint tokenId) internal update(tokenId) {
    ...
    function _withdraw(uint tokenId) internal update(tokenId) {
    ...
    function exit(uint tokenId) public update(tokenId) {
        getReward(tokenId);
        withdraw(tokenId);
    }

    function emergencyWithdraw(uint tokenId) external update(tokenId) {
        rewards[tokenId] = 0;
        _withdraw(tokenId);
    }
