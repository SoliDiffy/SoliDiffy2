...
contract TokenController is LockHandler, Iupgradable {
  ...
  */
  ...
  function markCoverClaimOpen(uint coverId) external checkPause {
   ...
   */
  function markCoverClaimClosed(uint coverId, bool isAccepted) external checkPause {
   ...
   */
  function changeOperator(address _newOperator) public checkPause {
   ...
   */
  function operatorTransfer(address _from, address _to, uint _value) external checkPause returns (bool) {
  ...
  */
  function lockClaimAssessmentTokens(uint256 _amount, uint256 _time) external onlyInternal {
  ...
  */
  function extendClaimAssessmentLock(uint256 _time) external onlyInternal {
