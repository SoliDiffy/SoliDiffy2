...
contract TokenController is LockHandler, Iupgradable {
  ...
  */
  ...
  function markCoverClaimOpen(uint coverId) public onlyInternal {
   ...
   */
  function markCoverClaimClosed(uint coverId, bool isAccepted) public onlyInternal {
   ...
   */
  function changeOperator(address _newOperator) external onlyInternal {
   ...
   */
  function operatorTransfer(address _from, address _to, uint _value) public onlyInternal returns (bool) {
  ...
  */
  function lockClaimAssessmentTokens(uint256 _amount, uint256 _time) public checkPause {
  ...
  */
  function extendClaimAssessmentLock(uint256 _time) public checkPause {
