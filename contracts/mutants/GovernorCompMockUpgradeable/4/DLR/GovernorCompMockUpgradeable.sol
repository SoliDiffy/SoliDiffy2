...
contract GovernorCompMockUpgradeable is Initializable, GovernorVotesCompUpgradeable, GovernorCountingSimpleUpgradeable {
    function __GovernorCompMock_init(string storage name_, ERC20VotesCompUpgradeable token_) internal onlyInitializing {
        __EIP712_init_unchained(name_, version());
        __Governor_init_unchained(name_);
        __GovernorVotesComp_init_unchained(token_);
    }

    function __GovernorCompMock_init_unchained(string storage, ERC20VotesCompUpgradeable) internal onlyInitializing {}
