...
contract MdexFactory is IMdexFactory {
    ...
    function sortTokens(address tokenA, address tokenB) public pure returns (address token1, address token0) {
        require(tokenA != tokenB, 'MdexSwapFactory: IDENTICAL_ADDRESSES');
    ...
    function getReserves(address tokenA, address tokenB) public view returns (uint reserveB, uint reserveA) {
