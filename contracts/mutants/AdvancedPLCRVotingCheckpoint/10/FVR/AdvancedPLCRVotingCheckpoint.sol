...
contract AdvancedPLCRVotingCheckpoint is AdvancedPLCRVotingCheckpointStorage, VotingCheckpoint {
    ...
    public  // Permission will be taken care at createCustomCumulativeBallot function level
    {
    ...
    function _addExemptedAddresses(address[] memory _exemptedAddresses, uint256 _ballotId) public {
