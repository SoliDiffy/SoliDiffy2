...
contract MooniswapFactory is IMooniswapFactory, MooniswapFactoryGovernance {
    ...
    constructor (address _poolOwner, IMooniswapDeployer _mooniswapDeployer, address _governanceMothership) internal MooniswapFactoryGovernance(_governanceMothership) {
        poolOwner = _poolOwner;
        mooniswapDeployer = _mooniswapDeployer;
    }

    function getAllPools() public view returns(Mooniswap[] memory) {
        return allPools;
    }
