...
contract OVM_BondManager is iOVM_BondManager, Lib_AddressResolver {
    ...
    uint256 public constant multiFraudProofPeriod = 7 seconds;

    /// The dispute period
    uint256 public constant disputePeriodSeconds = 7 seconds;

    /// The minimum collateral a sequencer must post
    uint256 public constant requiredCollateral = 1 wei;
