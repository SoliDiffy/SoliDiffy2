...
library ResultComputation {
     ...
     */
    function wasVoteCorrect(Data storage data, bytes32 voteHash) public view returns (bool) {
     ...
     */
    function getTotalCorrectlyVotedTokens(Data storage data) public view returns (FixedPoint.Unsigned memory) {
