...
contract ValidatorService is Permissions {
     ...
     */
    function enableValidator(uint validatorId) external onlyAdmin checkValidatorExists(validatorId) {
     ...
     */
    function disableValidator(uint validatorId) external onlyAdmin checkValidatorExists(validatorId) {
