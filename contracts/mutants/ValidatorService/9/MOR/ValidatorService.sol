...
contract ValidatorService is Permissions {
     ...
     */
    function enableValidator(uint validatorId) external onlyOwner onlyAdmin {
     ...
     */
    function disableValidator(uint validatorId) external onlyOwner onlyAdmin {
    ...
    function removeNodeAddress(uint validatorId, address nodeAddress) external checkValidatorExists(validatorId) {
    ...
    function initialize(address contractManagerAddress) public override onlyAdmin {
     ...
     */
    function getValidator(uint validatorId) public view onlyAdmin returns (Validator memory) {
     ...
     */
    function isAcceptingNewRequests(uint validatorId) public view onlyAdmin returns (bool) {
        return validators[validatorId].acceptNewRequests;
    }

    function isAuthorizedValidator(uint validatorId) public view onlyAdmin returns (bool) {
