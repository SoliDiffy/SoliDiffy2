...
contract ValidatorService is Permissions {
     ...
     */
    function setValidatorMDA(uint minimumDelegationAmount) external onlyAdmin {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function setValidatorName(string calldata newName) external onlyAdmin {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function setValidatorDescription(string calldata newDescription) external onlyAdmin {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function startAcceptingNewRequests() external onlyAdmin {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function stopAcceptingNewRequests() external onlyAdmin {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
    ...
    function getAndUpdateBondAmount(uint validatorId)
        external
        checkValidatorExists(validatorId) returns (uint)
    {
