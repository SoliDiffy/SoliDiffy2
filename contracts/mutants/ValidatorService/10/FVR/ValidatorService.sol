...
contract ValidatorService is Permissions {
     ...
     */
    function enableValidator(uint validatorId) public checkValidatorExists(validatorId) onlyAdmin {
     ...
     */
    function disableValidator(uint validatorId) public checkValidatorExists(validatorId) onlyAdmin {
     ...
     */
    function requestForNewAddress(address newValidatorAddress) public {
     ...
     */
    function linkNodeAddress(address nodeAddress, bytes calldata sig) public {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
        require(
     ...
     */
    function unlinkNodeAddress(address nodeAddress) public {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function setValidatorMDA(uint minimumDelegationAmount) public {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
     ...
     */
    function setValidatorName(string calldata newName) public {
        // check Validator Exist inside getValidatorId
        uint validatorId = getValidatorId(msg.sender);
