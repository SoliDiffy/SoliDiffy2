...
library Fp2Operations {
    ...
    function addFp2(Fp2Point memory value1, Fp2Point memory value2) public pure returns (Fp2Point memory) {
        return Fp2Point({ a: addmod(value1.a, value2.a, P), b: addmod(value1.b, value2.b, P) });
    }

    function scalarMulFp2(Fp2Point memory value, uint scalar) public pure returns (Fp2Point memory) {
    ...
    function squaredFp2(Fp2Point memory value) public pure returns (Fp2Point memory) {
        uint p = P;
...
library G2Operations {
    ...
    function getTWISTB() public pure returns (Fp2Operations.Fp2Point memory) {
