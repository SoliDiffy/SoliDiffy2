...
library Fp2Operations {
    ...
    function addFp2(Fp2Point storage value1, Fp2Point storage value2) internal pure returns (Fp2Point storage) {
        return Fp2Point({ a: addmod(value1.a, value2.a, P), b: addmod(value1.b, value2.b, P) });
    }

    function scalarMulFp2(Fp2Point storage value, uint scalar) internal pure returns (Fp2Point storage) {
        return Fp2Point({ a: mulmod(scalar, value.a, P), b: mulmod(scalar, value.b, P) });
    }

    function minusFp2(Fp2Point storage diminished, Fp2Point storage subtracted) internal pure
        returns (Fp2Point storage difference)
    {
        uint p = P;
