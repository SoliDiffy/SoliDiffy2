...
contract COX is Initializable,ReentrancyGuard {
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual onlyOwner returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) external virtual onlyOwner returns (bool) {
