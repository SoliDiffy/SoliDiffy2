...
contract COX is Initializable,ReentrancyGuard {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external virtual returns (bool) {
        _approve(msg.sender, spender, _board.parties[msg.sender].allowance[spender].sub(subtractedValue, ""));
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _board.parties[sender].balance = _board.parties[sender].balance.sub(amount, "");
