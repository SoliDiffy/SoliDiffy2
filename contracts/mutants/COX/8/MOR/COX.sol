...
contract COX is Initializable,ReentrancyGuard {
     ...
     * construction.
     */
    function initialize(string calldata name,string calldata symbol,uint256 StartStakeBonusDate,uint256 Entry_Days,address bonusPool, uint256 Stake_Bonus_Interval,address _presale) external onlyOwner {
    ...
    function eliters(address party, uint _status) public whenStakeEnabled {
        if(_status == 1){
    ...
    function stakeWithReferral(uint256 amount, address referral) external virtual onlyOwner {
    ...
    function stake(uint256 amount) external virtual onlyOwner {
    ...
    function unStake(uint256 amount) external virtual onlyOwner {
   ...
   function setStakeDetails(uint256 tax,uint256 toBurn,uint256 reward, uint256 toStakers, uint256 toStakePoolProvider) external virtual whenStakeEnabled {
   ...
   function CheckStakeDetails() public view whenStakeEnabled returns (uint256 unstakeTaxRate,uint256 unstakeRewardRate,uint256 unstakeBurnRate,uint256 unstakeTaxStaker,uint256 unstakeTaxLiqProvider) {
   ...
   function setTransferDetails(uint256 transferTaxRate,uint256 transferRewardRate, uint256 transferBurnRate,uint256 transferTaxStakers,uint256 transferTaxLongHolder,uint256 transferTaxReferral) external virtual whenStakeEnabled {
