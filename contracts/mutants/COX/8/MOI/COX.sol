...
contract COX is Initializable,ReentrancyGuard {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) external virtual onlyOwner returns (bool) {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) external virtual onlyOwner returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) external virtual onlyOwner returns (bool) {
     ...
     * - `sender` must have a balance of at least `amount`.
     */
    function _transfer(address sender, address recipient, uint256 amount) internal virtual onlyOwner {
    ...
    function burn(uint256 amount) external virtualonlyOwner {
