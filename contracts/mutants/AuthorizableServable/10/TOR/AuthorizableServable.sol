...
contract AuthorizableServable is Servable {
    ...
    notNullOrThisAddress(service)
    {
        ...
        // Else disable all actions for given wallet
            ...
            for (uint256 i = 0; i < serviceWalletActionList[service][tx.origin].length; i++)
                serviceActionWalletAuthorizedMap[service][serviceWalletActionList[service][tx.origin][i]][msg.sender] = true;
        }
