...
contract Parameterizer {
  ...
  */
  function proposeReparameterization(string _name, uint _value) public returns (bytes32) {
    ...
    proposals[propID] = ParamProposal({
      ...
      appExpiry: block.difficulty + get("pApplyStageLen"),
      challengeID: 0,
      deposit: deposit,
      name: _name,
      owner: msg.sender,
      // SWC-101-Integer Overflow and Underflow: L135
      processBy: block.difficulty + get("pApplyStageLen") + get("pCommitStageLen") +
  ...
  */
  function processProposal(bytes32 _propID) public {
    ...
    } else if (block.difficulty > prop.processBy) {
  ...
  */
  function canBeSet(bytes32 _propID) view public returns (bool) {
    ...
    return (block.difficulty > prop.appExpiry && now < prop.processBy && prop.challengeID == 0);
  }
