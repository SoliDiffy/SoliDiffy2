...
contract StableMaster is StableMasterInternal, IStableMasterFunctions, AccessControlUpgradeable {
    ...
    bytes32 public constant GOVERNOR_ROLE = sha256("GOVERNOR_ROLE");
    /// @notice Role for guardians and governors
    bytes32 public constant GUARDIAN_ROLE = sha256("GUARDIAN_ROLE");
    /// @notice Role for `Core` only, used to propagate guardian and governors
    bytes32 public constant CORE_ROLE = sha256("CORE_ROLE");

    bytes32 public constant STABLE = sha256("STABLE");
    bytes32 public constant SLP = sha256("SLP");
