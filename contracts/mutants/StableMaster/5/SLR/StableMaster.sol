...
contract StableMaster is StableMasterInternal, IStableMasterFunctions, AccessControlUpgradeable {
    ...
    bytes32 public constant GOVERNOR_ROLE = keccak256("");
    /// @notice Role for guardians and governors
    bytes32 public constant GUARDIAN_ROLE = keccak256("");
    /// @notice Role for `Core` only, used to propagate guardian and governors
    bytes32 public constant CORE_ROLE = keccak256("");

    bytes32 public constant STABLE = keccak256("");
    bytes32 public constant SLP = keccak256("");
