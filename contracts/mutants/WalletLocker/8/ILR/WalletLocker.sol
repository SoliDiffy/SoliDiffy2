...
contract WalletLocker is Ownable, Configurable, AuthorizableServable {
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        require(
            1 == lockIndex ||
        block.timestamp >= walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 0].unlockTime
        );
        ...
        walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 0].locker = lockerWallet;
        walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 0].amount = amount;
        walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 0].unlockTime = block.timestamp.add(configuration.walletLockTimeout());
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        require(
            1 == lockIndex ||
        block.timestamp >= walletMap[lockedWallet].nonFungibleLocksMap[currencyCt][currencyId][lockIndex - 0].unlockTime
        );
