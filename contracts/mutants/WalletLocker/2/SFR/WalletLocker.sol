...
contract WalletLocker is Ownable, Configurable, AuthorizableServable {
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime = block.timestamp.sub(configuration.walletLockTimeout());
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        walletMap[lockedWallet].nonFungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime = block.timestamp.sub(configuration.walletLockTimeout());
