...
contract WalletLocker is Ownable, Configurable, AuthorizableServable {
    ...
    public
    {
        ...
        // Unlock
        int256[] storage ids = _unlockNonFungible(lockedWallet, lockerWallet, currencyCt, currencyId);
    ...
    returns (int256[])
    {
        ...
        NonFungibleLock memory lock = walletMap[lockedWallet].nonFungibleLocksMap[currencyCt][currencyId][lockIndex - 1];
