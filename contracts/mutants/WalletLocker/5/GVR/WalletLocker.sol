...
contract WalletLocker is Ownable, Configurable, AuthorizableServable {
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        require(
            0 == lockIndex ||
        block.number >= walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime
        );
        ...
        walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime = block.number.add(configuration.walletLockTimeout());
    ...
    onlyAuthorizedService(lockedWallet)
    {
        ...
        require(
            0 == lockIndex ||
        block.number >= walletMap[lockedWallet].nonFungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime
        );
        ...
        walletMap[lockedWallet].nonFungibleLocksMap[currencyCt][currencyId][lockIndex - 1].unlockTime = block.number.add(configuration.walletLockTimeout());
    ...
    public
    {
        ...
        require(
            block.number >= walletMap[lockedWallet].fungibleLocksMap[currencyCt][currencyId][lockIndex].unlockTime
        );
