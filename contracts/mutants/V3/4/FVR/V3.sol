...
contract IFOV3 is Whitelist{
     ...
     * @param _pid: pool id
     */
    function depositPool(uint256 _amount, uint8 _pid) public {
     ...
     * @param _pid: pool id
     */
    function harvestPool(uint8 _pid) public {
     ...
     */
    function finalWithdraw(uint256 _lpAmount, uint256 _offerAmount, uint256 _weiAmount) public  onlyOwner TimeLock {
