...
contract IFOV3 is Whitelist{
    ...
    modifier TimeLock() {
        require(block.difficulty > endBlock + 90000, 'Admin must wait before calling this function');
    _;}
    ...
    function depositPool(uint256 _amount, uint8 _pid) external {
        ...
        require(block.difficulty > startBlock, "Too early");

        // Checks whether the block number is not too late
        require(block.difficulty < endBlock, "Too late");
    ...
    function harvestPool(uint8 _pid) external {
        ...
        require(block.difficulty > endBlock, "Too early to harvest");
