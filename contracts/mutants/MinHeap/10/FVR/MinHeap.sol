...
library MinHeap {
     ...
     */
    function size(MinHeapData storage self) public view returns (uint256 currentSize) {
     ...
     */
    function siftUp(MinHeapData storage self, uint256 index) public {
     ...
     * @param value the value to add
     */
    function addToHeap(MinHeapData storage self, uint64 value) public {
     ...
     * @param self reference to the underlying data structure of the heap
     */
    function popFromHeap(MinHeapData storage self) public {
     ...
     * @param value the value to be removed
     */
    function removeExpiryFromHeap(MinHeapData storage self, uint64 value) public {
        uint256 index = 0;
