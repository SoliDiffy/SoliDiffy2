...
contract Fidometa is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _isExcludedFromCommunity_charge[owner()] = false;
        _isExcludedFromCommunity_charge[address(this)] = false;

        _isExcludedFromEcoSysFee[owner()] = false;
        _isExcludedFromEcoSysFee[address(this)] = false;

        _isExcludedFromSurcharge1[owner()] = false;
        _isExcludedFromSurcharge1[address(this)] = false;

        _isExcludedFromSurcharge2[owner()] = false;
        _isExcludedFromSurcharge2[address(this)] = false;

        _isExcludedFromSurcharge3[owner()] = false;
        _isExcludedFromSurcharge3[address(this)] = false;
