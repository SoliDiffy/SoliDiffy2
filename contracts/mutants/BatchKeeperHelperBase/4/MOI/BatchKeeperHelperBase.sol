...
contract BatchKeeperHelperBase is KeeperCompatibleInterface, Ownable {
    ...
    function _checkUpkeep(address contractAddress) internal virtual onlyOwner returns (bool) {}

    function _performUpkeep(address contractAddress) internal virtual onlyOwner {}
}
