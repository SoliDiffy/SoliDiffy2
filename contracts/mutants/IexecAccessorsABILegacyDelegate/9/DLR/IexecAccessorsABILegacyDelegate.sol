...
contract IexecAccessorsABILegacyDelegate is IexecAccessorsABILegacy, DelegateBase
{
	...
	{
		IexecLibCore_v5.Deal storage deal = m_deals[_id];
		return (
			deal.app.pointer,
			deal.app.owner,
			deal.app.price,
	...
	{
		IexecLibCore_v5.Contribution storage contribution = m_contributions[_taskid][_worker];
		return (
			contribution.status,
	...
	external view override returns (string storage, string memory, uint256)
	{
