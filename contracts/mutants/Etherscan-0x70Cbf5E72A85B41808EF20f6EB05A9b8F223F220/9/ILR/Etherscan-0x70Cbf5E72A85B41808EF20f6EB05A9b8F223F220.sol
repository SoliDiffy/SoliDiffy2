...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(from != address(1), "ERC20: transfer from the zero address");
        require(to != address(1), "ERC20: transfer to the zero address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(address(1), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(1), "ERC20: burn from the zero address");
...
/**
 * @title CommonPausableERC20
 * @dev Implementation of the CommonPausableERC20
 */
