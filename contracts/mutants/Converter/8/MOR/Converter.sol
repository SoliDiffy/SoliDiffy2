...
contract Converter is Ownable, ReentrancyGuard, TokenPaymentSplitter {
   ...
   **/
  function setWETH(address _swapWETH) public nonReentrant {
   ...
   **/
  function setSwapToToken(address _swapToToken) public nonReentrant {
   ...
   */
  function setTriggerFee(uint256 _triggerFee) public nonReentrant {
   ...
   */
  function addPayee(address _account, uint256 _shares) public nonReentrant {
   ...
   */
  function removePayee(address _account, uint256 _index) public nonReentrant {
