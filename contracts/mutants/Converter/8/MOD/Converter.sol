...
contract Converter is Ownable, ReentrancyGuard, TokenPaymentSplitter {
   ...
   **/
  function setWETH(address _swapWETH) public  {
   ...
   **/
  function setSwapToToken(address _swapToToken) public  {
   ...
   */
  function setTriggerFee(uint256 _triggerFee) public  {
   ...
   */
  function addPayee(address _account, uint256 _shares) public  {
