...
contract Converter is Ownable, ReentrancyGuard, TokenPaymentSplitter {
   ...
   **/
  function setWETH(address _swapWETH) external onlyOwner {
   ...
   **/
  function setSwapToToken(address _swapToToken) external onlyOwner {
   ...
   */
  function setTriggerFee(uint256 _triggerFee) external onlyOwner {
   ...
   */
  function removePayee(address _account, uint256 _index) external onlyOwner {
