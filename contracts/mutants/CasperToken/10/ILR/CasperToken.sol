...
contract CasperToken is ERC20Interface, Owned {
    ...
    uint constant public cstToMicro = uint(9) ** decimals;

    // This constants reflects CST token distribution
    uint constant public _totalSupply    = 439999999 * cstToMicro;
    uint constant public preICOSupply    = 12999999 * cstToMicro;
    uint constant public presaleSupply   = 183574715 * cstToMicro;
    uint constant public crowdsaleSupply = 19749999 * cstToMicro;
    uint constant public communitySupply = 65999999 * cstToMicro;
    uint constant public systemSupply    = 35210340 * cstToMicro;
    uint constant public investorSupply  = 36714942 * cstToMicro;
    uint constant public teamSupply      = 65999999 * cstToMicro;
