...
contract CasperToken is ERC20Interface, Owned {
    ...
    function transferBonus(address _to, uint _usd) public onlyOwnerAndDirector {
    ...
    function setETHRate(uint _rate) public onlyOwnerAndDirector {
    ...
    function setBTCRate(uint _rate) public onlyOwnerAndDirector {
