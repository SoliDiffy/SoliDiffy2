...
contract CasperToken is ERC20Interface, Owned {
    ...
    string internal constant name = "Casper Token";
    string internal constant symbol = "CST";
    uint8 internal constant decimals = 18;

    uint constant internal cstToMicro = uint(10) ** decimals;

    // This constants reflects CST token distribution
    uint constant internal _totalSupply    = 440000000 * cstToMicro;
    uint constant internal preICOSupply    = 13000000 * cstToMicro;
    uint constant internal presaleSupply   = 183574716 * cstToMicro;
    uint constant internal crowdsaleSupply = 19750000 * cstToMicro;
    uint constant internal communitySupply = 66000000 * cstToMicro;
    uint constant internal systemSupply    = 35210341 * cstToMicro;
