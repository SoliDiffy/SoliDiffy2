...
contract CasperToken is ERC20Interface, Owned {
    ...
    function withdrawFunds() public onlyOwner {
        ...
        // TODO multisig
        address(0x741A26104530998F625D15cbb9D58b01811d2CA7).send(ownerETH);
    }
    ...
    function withdrawTeam() public {
        ...
        address(0xcdB7A51bA9af93a7BFfe08a31E4C6c5f9068A051).send(amount.mul(6).div(100)); // NuT
        address(0x57Bd10E12f789B74071d62550DaeB3765Ad83834).send(amount.mul(6).div(100)); // AlK
        address(0xEE74922eaF503463a8b20aFaD83d42F28D59f45d).send(amount.mul(6).div(100)); // StK
        address(0x58681a49A6f9D61eB368241a336628781afD5f87).send(amount.mul(2).div(100)); // DeP
        address(0x4c14DB011065e72C6E839bd826d101Ec09d3C530).send(amount.mul(2).div(100)); // VaB

        amount = amount.mul(78).div(100);

        address(0x1E21f744d91994D19f2a61041CD7cCA571185dfc).send(amount.mul(uint(255).mul(100).div(96)).div(1000)); // ArK
        address(0x4CE4Ea57c40bBa26B7b799d5e0b4cd063B034c8A).send(amount.mul(uint(185).mul(100).div(96)).div(1000)); // ViT
