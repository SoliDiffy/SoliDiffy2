...
contract CasperToken is ERC20Interface, Owned {
    ...
    address admin;
    function setAdmin(address _newAdmin) external onlyOwnerAndDirector {
        admin = _newAdmin;
    }
    ...
    function assignPreicoTokens() external onlyOwnerAndDirector {
    ...
    function assignTeamTokens() external onlyOwnerAndDirector {
    ...
    function kycPassed(address _mem, address _ref) external onlyAdmin {
        kyc[_mem] = true;
