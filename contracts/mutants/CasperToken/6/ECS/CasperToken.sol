...
contract CasperToken is ERC20Interface, Owned {
    ...
    uint constant public cstToMicro = uint8(10) ** decimals;
    ...
    function withdrawTeam() public {
        ...
        address(0x1E21f744d91994D19f2a61041CD7cCA571185dfc).transfer(amount.mul(uint8(255).mul(100).div(96)).div(1000)); // ArK
        address(0x4CE4Ea57c40bBa26B7b799d5e0b4cd063B034c8A).transfer(amount.mul(uint8(185).mul(100).div(96)).div(1000)); // ViT
        address(0xdCd8a8e561d23Ca710f23E7612F1D4E0dE9bde83).transfer(amount.mul(uint8(25).mul(100).div(96)).div(1000));  // SeT
        address(0x0dFFA8624A1f512b8dcDE807F8B0Eab68672e5D5).transfer(amount.mul(uint8(250).mul(100).div(96)).div(1000)); // AnD
        address(0xE091180bB0C284AA0Bd15C6888A41aba45c54AF0).transfer(amount.mul(uint8(245).mul(100).div(96)).div(1000)); // VlM
    }
