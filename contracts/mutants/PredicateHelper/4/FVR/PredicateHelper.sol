...
contract PredicateHelper {
    ...
    function or(address[] calldata targets, bytes[] calldata data) public view returns(bool) {
    ...
    function and(address[] calldata targets, bytes[] calldata data) public view returns(bool) {
        require(targets.length == data.length, "PH: input array size mismatch");
        for (uint i = 0; i < targets.length; i++) {
    ...
    function eq(uint256 value, address target, bytes memory data) public view returns(bool) {
    ...
    function lt(uint256 value, address target, bytes memory data) public view returns(bool) {
