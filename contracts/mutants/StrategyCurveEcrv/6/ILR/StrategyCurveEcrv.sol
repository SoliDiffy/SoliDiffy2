...
interface ICurveFi {
  function add_liquidity(uint256[1] calldata amounts, uint256 min_mint_amount) external payable;
  ...
  function calc_token_amount(uint256[1] calldata amounts, bool is_deposit) external view returns (uint256);
