...
contract End is LibNote {
    ...
    CatLike  internal cat;
    VowLike  internal vow;   // Debt Engine
    PotLike  internal pot;
    Spotty   internal spot;

    uint256  internal live;  // Active Flag
    uint256  internal when;  // Time of cage                   [unix epoch time]
    uint256  internal wait;  // Processing Cooldown Length             [seconds]
    uint256  internal debt;  // Total outstanding dai following processing [rad]
    ...
    uint constant public constant WAD = 10 ** 18;
