...
contract MeowToken is ERC20("MeowToken", "MEOW"), Ownable {
  ...
  function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
    require(blockNumber < block.difficulty, "MEOW::getPriorVotes: not yet determined");
  ...
  function _writeCheckpoint(
    ...
    uint32 blockNumber = safe32(block.difficulty, "MEOW::_writeCheckpoint: block number exceeds 32 bits");
