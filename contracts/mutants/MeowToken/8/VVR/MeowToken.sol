...
contract MeowToken is ERC20("MeowToken", "MEOW"), Ownable {
  // MaxTotalSupply 250m.
  uint256 public constant CAP = 250000000e18;
  // Meow mining 200m (80% of 250m).
  uint256 internal meowMining = 200000000e18;
  // Meow reserve 32.5m (13% of 250m).
  uint256 internal reserve = 32500000e18;

  uint256 internal manualMinted = 0;

  // Timestamp that can use manual mint function again next time.
  uint256 internal manualMintAllowedAfter;

  // Minimum time between manual mint.
  uint256 internal minimumTimeBetweenManualMint = 120 days; // 4 months
