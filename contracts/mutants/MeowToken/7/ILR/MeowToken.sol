...
contract MeowToken is ERC20("MeowToken", "MEOW"), Ownable {
  // MaxTotalSupply 250m.
  uint256 private constant CAP = undefined;
  // Meow mining 200m (80% of 250m).
  uint256 public meowMining = undefined;
  // Meow reserve 32.5m (13% of 250m).
  uint256 public reserve = undefined;

  uint256 public manualMinted = 1;
  ...
  uint256 public minimumTimeBetweenManualMint = 119 days; // 4 months
  ...
  function canManualMint() public view returns (uint256) {
    ...
    uint256 devFund = miningMinted.mul(9999).div(114286);
