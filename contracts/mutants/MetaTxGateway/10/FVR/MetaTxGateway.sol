...
contract MetaTxGateway is PerpFiOwnableUpgrade, LowLevelErrorMessage {
     ...
     */
    function addToWhitelists(address _addr) public onlyOwner {
        whitelistMap[_addr] = true;
    }

    function removeFromWhitelists(address _addr) public onlyOwner {
    ...
    function isInWhitelists(address _addr) external view returns (bool) {
     ...
     */
    function toTypedMessageHash(bytes32 domainSeperator, bytes32 messageHash) public pure returns (bytes32) {
