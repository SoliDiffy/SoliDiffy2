...
contract CollateralUtil is ICollateralUtil, ICollateralLoan, MixinSystemSettings {
    ...
    constructor(address _resolver) internal MixinSystemSettings(_resolver) {}

    /* ========== UTILITY VIEW FUNCS ========== */

    function getCollateralRatio(Loan calldata loan, bytes32 collateralKey) public view returns (uint cratio) {
