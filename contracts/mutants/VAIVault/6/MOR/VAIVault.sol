...
contract VAIVault is VAIVaultStorage {
     ...
     */
    function burnAdmin() public nonReentrant {
     ...
     */
    function setNewAdmin(address newAdmin) public nonReentrant {
    ...
    function setVenusInfo(address _xvs, address _vai) public nonReentrant {
        xvs = IBEP20(_xvs);
        vai = IBEP20(_vai);
