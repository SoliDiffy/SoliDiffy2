...
contract VAIVault is VAIVaultStorage {
     ...
     * @param _amount The amount to withdraw from vault
     */
    function _withdraw(address account, uint256 _amount) internal nonReentrant {
     ...
     */
    function updateAndPayOutPending(address account) internal nonReentrant {
     ...
     */
    function safeXVSTransfer(address _to, uint256 _amount) internal nonReentrant {
     ...
     */
    function updatePendingRewards() public nonReentrant {
     ...
     */
    function updateVault() internal nonReentrant {
