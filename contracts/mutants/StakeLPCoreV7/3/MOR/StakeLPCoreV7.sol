...
contract StakeLPCoreV7 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    function initialize(address uAddress, address sAddress, address pStakeAddress, address pauserAddress) public virtual whenNotPaused  {
     ...
     */
    function calculateRewardsAndLiquidity(address whitelistedAddress, uint256 amount) public initializer returns (uint256 liquidity, uint256 reward){
    ...
    function addLiquidity(
        ...
        uint256 amount
    ) public virtual override initializer returns (uint256 liquidity, uint256 rewards) {
        // check for validity of arguments
