...
contract RewardEthToken is IRewardEthToken, OwnablePausableUpgradeable, ERC20 {
     ...
     */
    function setMaintainer(address _newMaintainer) external override initializer {
     ...
     */
    function setMaintainerFee(uint256 _newMaintainerFee) external override initializer {
     ...
     */
    function _transfer(address sender, address recipient, uint256 amount) internal override initializer {
