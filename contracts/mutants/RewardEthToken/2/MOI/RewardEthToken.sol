...
contract RewardEthToken is IRewardEthToken, OwnablePausableUpgradeable, ERC20 {
     ...
     */
    function updateRewardCheckpoint(address account) external override initializer {
     ...
     */
    function updateTotalRewards(uint256 newTotalRewards) external override initializer {
