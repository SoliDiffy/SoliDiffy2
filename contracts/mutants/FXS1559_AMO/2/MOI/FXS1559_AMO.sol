...
contract FXS1559_AMO is AccessControl {
    ...
    function _mintFRAXForSwap(uint256 frax_amount) internal onlyByOwnerOrGovernance {
    ...
    function _swapFRAXforFXS(uint256 frax_amount) internal onlyByOwnerOrGovernance returns (uint256 frax_spent, uint256 fxs_received) {
        // Get the FXS price
