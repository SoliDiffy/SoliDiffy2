...
contract FXS1559_AMO is AccessControl {
    ...
    function unspentInvestorAMOProfit_E18() external view returns (uint256 unspent_profit_e18) {
    ...
    function cr_info() external view returns (
    ...
    function _mintFRAXForSwap(uint256 frax_amount) public {
    ...
    function _swapFRAXforFXS(uint256 frax_amount) public returns (uint256 frax_spent, uint256 fxs_received) {
        // Get the FXS price
    ...
    function mintSwapBurn(uint256 override_USDC_amount, bool use_override) external onlyByOwnerOrGovernance {
    ...
    // Burn unneeded or excess FRAX
    function burnFRAX(uint256 frax_amount) external onlyByOwnerOrGovernance {
    ...
    function setTimelock(address new_timelock) public onlyByOwnerOrGovernance {
