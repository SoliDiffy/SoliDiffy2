...
contract TempusAMM is BaseGeneralPool, BaseMinimalSwapInfoPool, StableMath, IRateProvider {
    ...
    function getLastInvariant() public view returns (uint256 lastInvariant, uint256 lastInvariantAmp) {
    ...
    function _doJoin(
        ...
        uint256[] memory scalingFactors,
        bytes memory userData
    ) public returns (uint256 bptAmountOut, uint256[] memory amountsIn) {
    ...
    function _exitBPTInForExactTokensOut(
        ...
        uint256[] memory scalingFactors,
        bytes memory userData
    ) public whenNotPaused beforeMaturity returns (uint256, uint256[] memory) {
     ...
     */
    function _updateLastInvariant(uint256 invariant, uint256 amplificationParameter) public {
