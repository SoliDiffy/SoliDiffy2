...
contract TempusAMM is BaseGeneralPool, BaseMinimalSwapInfoPool, StableMath, IRateProvider {
    ...
    function getLastInvariant() external view returns (uint256 lastInvariantAmp, uint256 lastInvariant) {
        ...
        )
    {
        ...
        return (bptAmountOut, dueProtocolFeeAmounts, amountsIn);
    }
        ...
        )
    {
        ...
        return (bptAmountIn, dueProtocolFeeAmounts, amountsOut);
    }
