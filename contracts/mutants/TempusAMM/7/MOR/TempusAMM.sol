...
contract TempusAMM is BaseGeneralPool, BaseMinimalSwapInfoPool, StableMath, IRateProvider {
    ...
    function _onSwapGivenIn(
        ...
        uint256 indexIn,
        uint256 indexOut
    ) internal virtual override authenticate beforeMaturity returns (uint256) {
    ...
    ) internal virtual override authenticate beforeMaturity returns (uint256, uint256[] memory) {
    ...
    function _exitBPTInForExactTokensOut(
        ...
        uint256[] memory scalingFactors,
        bytes memory userData
    ) private authenticate beforeMaturity returns (uint256, uint256[] memory) {
     ...
     */
    function startAmplificationParameterUpdate(uint256 rawEndValue, uint256 endTime) external whenNotPaused {
     ...
     */
    function stopAmplificationParameterUpdate() external whenNotPaused {
        (uint256 currentValue, bool isUpdating) = _getAmplificationParameter();
