...
contract TempusAMM is BaseGeneralPool, BaseMinimalSwapInfoPool, StableMath, IRateProvider {
    ...
    function _onSwapGivenIn(
        ...
        _require(super._getTotalTokens() == 2, Errors.NOT_TWO_TOKENS);
    ...
    function _onInitializePool(
        ...
        InputHelpers.ensureInputLengthMatch(amountsIn.length, super._getTotalTokens());
    ...
    function _joinExactTokensInForBPTOut(
        ...
        InputHelpers.ensureInputLengthMatch(super._getTotalTokens(), amountsIn.length);
        ...
        )
    {
        ...
        if (_isNotPaused()) {
            ...
            dueProtocolFeeAmounts = new uint256[](super._getTotalTokens());
        }
