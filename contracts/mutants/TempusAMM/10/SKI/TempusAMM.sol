...
contract TempusAMM is BaseGeneralPool, BaseMinimalSwapInfoPool, StableMath, IRateProvider {
    ...
    function _exitBPTInForExactTokensOut(
        ...
        InputHelpers.ensureInputLengthMatch(amountsOut.length, super._getTotalTokens());
        ...
        returns (uint256[] memory)
    {
        ...
        uint256[] memory dueProtocolFeeAmounts = new uint256[](super._getTotalTokens());
        ...
        for (uint256 i = 1; i < super._getTotalTokens(); ++i) {
