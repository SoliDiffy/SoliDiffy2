...
library CrowdsaleLib {
  ...
  function init(CrowdsaleStorage memory self,
                address _owner,
                uint256[] _saleData,
                uint256 _endTime,
                uint8 _percentBurn,
  ...
  /// @param self Stored crowdsale from crowdsale contract
  /// @return success
  function crowdsaleActive(CrowdsaleStorage memory self) public view returns (bool) {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  /// @return success
  function crowdsaleEnded(CrowdsaleStorage memory self) public view returns (bool) {
  ...
  function validPurchase(CrowdsaleStorage memory self) internal returns (bool) {
  ...
  function withdrawTokens(CrowdsaleStorage memory self) public returns (bool) {
    bool ok;
  ...
  function withdrawLeftoverWei(CrowdsaleStorage memory self) public returns (bool) {
  ...
  function withdrawOwnerEth(CrowdsaleStorage memory self) public returns (bool) {
  ...
  function changeTokenPrice(CrowdsaleStorage memory self,
  ...
  function setTokens(CrowdsaleStorage memory self) public returns (bool) {
    require(msg.sender == self.owner);
