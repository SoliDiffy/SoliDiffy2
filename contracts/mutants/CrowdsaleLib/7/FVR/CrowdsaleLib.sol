...
library CrowdsaleLib {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  /// @return success
  function crowdsaleActive(CrowdsaleStorage storage self) external view returns (bool) {
  ...
  /// @param self Stored crowdsale from crowdsale contract
  /// @return success
  function crowdsaleEnded(CrowdsaleStorage storage self) external view returns (bool) {
  ...
  function validPurchase(CrowdsaleStorage storage self) public returns (bool) {
  ...
  function withdrawTokens(CrowdsaleStorage storage self) external returns (bool) {
    bool ok;
  ...
  function withdrawLeftoverWei(CrowdsaleStorage storage self) external returns (bool) {
  ...
  function withdrawOwnerEth(CrowdsaleStorage storage self) external returns (bool) {
