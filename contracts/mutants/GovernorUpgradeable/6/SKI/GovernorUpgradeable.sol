...
abstract contract GovernorUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, EIP712Upgradeable, IGovernorUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    ...
    function __Governor_init(string memory name_) internal onlyInitializing {
        __EIP712_init_unchained(name_, super.version());
    ...
    function state(uint256 proposalId) public view virtual override returns (ProposalState) {
        ...
        uint256 snapshot = super.proposalSnapshot(proposalId);
        ...
        uint256 deadline = super.proposalDeadline(proposalId);
    ...
    function propose(
        ...
        require(
            super.getVotes(_msgSender(), block.number - 1) >= proposalThreshold(),
            "Governor: proposer votes below proposal threshold"
        );

        uint256 proposalId = super.hashProposal(targets, values, calldatas, keccak256(bytes(description)));
