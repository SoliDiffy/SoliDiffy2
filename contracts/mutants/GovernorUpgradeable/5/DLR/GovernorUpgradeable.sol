...
abstract contract GovernorUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, EIP712Upgradeable, IGovernorUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
     ...
     */
    function __Governor_init(string storage name_) internal onlyInitializing {
        __EIP712_init_unchained(name_, version());
        __Governor_init_unchained(name_);
    }

    function __Governor_init_unchained(string storage name_) internal onlyInitializing {
        _name = name_;
    }
     ...
     */
    function version() public view virtual override returns (string storage) {
        return "1";
    }
