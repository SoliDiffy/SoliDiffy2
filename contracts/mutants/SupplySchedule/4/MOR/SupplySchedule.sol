...
contract SupplySchedule is Owned, ISupplySchedule {
     ...
     * */
    function recordMintEvent(uint supplyMinted) external onlyOwner returns (uint) {
     ...
     * */
    function setMinterReward(uint amount) external onlySynthetix {
     ...
     * */
    function setSynthetixProxy(ISynthetix _synthetixProxy) external onlySynthetix {
     ...
     * */
    function setInflationAmount(uint amount) external onlySynthetix {
