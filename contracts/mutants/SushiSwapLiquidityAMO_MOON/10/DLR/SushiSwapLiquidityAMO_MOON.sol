...
contract SushiSwapLiquidityAMO_MOON is Owned {
    ...
    IAnyswapV5ERC20 private anyCollateral;
    ...
    constructor (
        ...
        anyCollateral = IAnyswapV5ERC20(_arbi_collateral_address);
