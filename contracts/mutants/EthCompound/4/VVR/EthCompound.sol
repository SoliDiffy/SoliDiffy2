...
contract EthCompound is GenericLenderBase {
    ...
    uint256 public constant blocksPerYear = 2_300_000;
    IWETH internal constant weth = IWETH(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2));
    CEtherI internal constant crETH = CEtherI(address(0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5));
