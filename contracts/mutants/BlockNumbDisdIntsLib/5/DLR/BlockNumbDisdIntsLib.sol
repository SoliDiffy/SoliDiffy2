...
library BlockNumbDisdIntsLib {
    ...
    // Functions
    // -----------------------------------------------------------------------------------------------------------------
    function currentNominalValue(BlockNumbDisdInts memory self)
    internal
    view
    returns (int256)
    {
    ...
    function currentDiscountedValue(BlockNumbDisdInts memory self, int256 tier)
    internal
    view
    returns (int256)
    {
    ...
    function currentEntry(BlockNumbDisdInts memory self)
    internal
    view
    returns (Entry)
    {
    ...
    function nominalValueAt(BlockNumbDisdInts memory self, uint256 _blockNumber)
    internal
    view
    returns (int256)
    {
    ...
    function discountedValueAt(BlockNumbDisdInts memory self, uint256 _blockNumber, int256 tier)
    internal
    view
    returns (int256)
    {
