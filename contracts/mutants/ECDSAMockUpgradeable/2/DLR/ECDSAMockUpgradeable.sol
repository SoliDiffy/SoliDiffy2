...
contract ECDSAMockUpgradeable is Initializable {
    ...
    function recover(bytes32 hash, bytes storage signature) public pure returns (address) {
    ...
    function toEthSignedMessageHash(bytes storage s) public pure returns (bytes32) {
