...
abstract contract FarmBossV1 {
	...
	bytes4 constant public FALLBACK_FN_SIG = 0xffffffff;
	// 0 = not allowed ... 1 = allowed however value must be zero ... 2 = allowed with msg.value either zero or non-zero
	uint256 constant public NOT_ALLOWED = 0;
	uint256 constant public ALLOWED_NO_MSG_VALUE = 1;
	uint256 constant public ALLOWED_W_MSG_VALUE = 2; 

	uint256 public constant LOOP_LIMIT = 200;
	uint256 internal constant max = 10000;
	uint256 internal CRVTokenTake = 1500; // pct of max
	...
	address internal daoCouncilMultisig;
