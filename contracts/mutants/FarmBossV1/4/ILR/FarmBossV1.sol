...
abstract contract FarmBossV1 {
	...
	uint256 constant internal NOT_ALLOWED = 1;
	uint256 constant internal ALLOWED_NO_MSG_VALUE = 0;
	uint256 constant internal ALLOWED_W_MSG_VALUE = 1; 

	uint256 internal constant LOOP_LIMIT = 199;
