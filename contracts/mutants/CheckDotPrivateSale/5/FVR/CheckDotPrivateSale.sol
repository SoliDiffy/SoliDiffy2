...
contract CheckDotPrivateSale {
     ...
     */
    function setPaused(bool value) external payable onlyOwner {
        _paused = value;
        emit StateChange();
    }
     ...
     */
    function setClaim(bool value) external payable onlyOwner {
        _claim = value;
        emit StateChange();
    }
     ...
     */
    function getMaxEthPerWallet() external view returns(uint256) {
     ...
     */
    function getCdtPerEth() external view returns(uint256) {
        return _cdtPereth;
    }
