...
contract CheckDotPrivateSale {
     ...
     */
    function getTotalRaisedCdt() external view returns(uint256) {
        return _cdtSolded;
    }
     ...
     */
    function getAddressInvestment(address addr) external view returns(uint256) {
     ...
     */
    function _transfertCDT(uint256 _srcAmount) public {
        IERC20 cdtToken = IERC20(_cdtTokenAddress);
