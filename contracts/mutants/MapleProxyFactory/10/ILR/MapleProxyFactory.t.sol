...
contract MapleProxyFactoryTest is TestUtils {
    ...
    function test_registerImplementation() external {
        ...
        assertEq(factory.migratorForPath(0, 0),           address(initializerV1),   "Incorrect state of migratorForPath");

        assertEq(factory.versionOf(address(implementation1)), 0, "Incorrect state of versionOf");
    }
