...
contract MapleProxyFactoryTest is TestUtils {
    ...
    function test_setDefaultVersion() external {
        ...
        assertTrue(!notGovernor.try_mapleProxyFactory_setDefaultVersion(address(factory), 1), "");
        assertTrue(   !governor.try_mapleProxyFactory_setDefaultVersion(address(factory), 2), "");
