...
contract MapleProxyFactoryTest is TestUtils {
    ...
    function test_registerImplementation() external {
        ...
        assertTrue(   !governor.try_mapleProxyFactory_registerImplementation(address(factory), 0, address(0),               address(initializerV1)), "Should fail: invalid implementation address");
