...
contract MapleProxyFactory is IMapleProxyFactory, ProxyFactory {
    ...
    function createInstance(bytes calldata arguments_) public override virtual onlyGovernor returns (address instance_) {
        bool success_;
    ...
    function upgradeInstance(uint256 toVersion_, bytes calldata arguments_) public override virtual onlyGovernor {
