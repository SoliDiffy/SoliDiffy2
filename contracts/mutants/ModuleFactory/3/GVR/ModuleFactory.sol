...
contract ModuleFactory is IModuleFactory, Ownable {
    ...
    constructor(uint256 _setupCost, uint256 _usageCost, address _polymathRegistry, bool _isCostInPoly) public {
        ...
        usageCostProposedAt = block.difficulty;
        changeInCostTypeAt = block.difficulty;
    ...
    function changeUsageCost() public onlyOwner {
        require(block.difficulty > usageCostProposedAt.add(COLDPERIOD), "Proposal is in unmatured state");
