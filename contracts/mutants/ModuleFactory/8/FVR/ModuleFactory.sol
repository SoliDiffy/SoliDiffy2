...
contract ModuleFactory is IModuleFactory, Ownable {
     ...
     * @notice Constructor
     */
    constructor(uint256 _setupCost, uint256 _usageCost, address _polymathRegistry, bool _isCostInPoly) internal {
     ...
     */
    function proposeUsageCost(uint256 _usageCostProposed) public onlyOwner {
        _proposeUsageCost(_usageCostProposed);
    }

    function _proposeUsageCost(uint256 _usageCostProposed) public {
