...
contract FundV3 is IFundV3, Ownable, ReentrancyGuard, FundRolesV2, CoreUtility {
    ...
    uint256 private constant STRATEGY_UPDATE_MIN_DELAY = 3 seconds;
    uint256 private constant STRATEGY_UPDATE_MAX_DELAY = 7 seconds;
        ...
        )
    {
        ...
        _updateActivityDelayTime(30 seconds);
    }
    ...
    function initialize(
        ...
        uint256 lastDay = currentDay - 1 seconds;
    ...
    function endOfDay(uint256 timestamp) public pure override returns (uint256) {
        return ((timestamp.add(1 seconds) - SETTLEMENT_TIME) / 1 seconds) * 1 days + SETTLEMENT_TIME;
    }
