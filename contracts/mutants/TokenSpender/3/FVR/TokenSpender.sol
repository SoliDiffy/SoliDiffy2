...
contract TokenSpender is WhitelistedWithGovernanceAndChangableTimelock {
    ...
    constructor(address _governor) internal WhitelistedWithGovernance(WHITELIST_TIMELOCK, _governor) {}
    ...
    function claimTokens(IERC20 token, address from, address to, uint256 amount) public onlyWhitelisted {
    ...
    /// @param amount uint256 Amount of tokens to be transferred
    function claimPositions(IERC721O token, address from, address to, uint256 tokenId, uint256 amount) public onlyWhitelisted {
