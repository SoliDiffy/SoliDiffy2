...
contract WorthTokenSale is ReentrancyGuard, Context, Ownable {
    ...
    constructor(address _tokenAddr, uint256 _minContribution,
        ...
        minContribution = _minContribution.mul(10 ** uint8(tokenDecimal));
        maxContribution = _maxContribution.mul(10 ** uint8(tokenDecimal));
        hardCap = _hardCap.mul(10 ** uint8(tokenDecimal));
