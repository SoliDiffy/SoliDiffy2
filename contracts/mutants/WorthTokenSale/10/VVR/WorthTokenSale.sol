...
contract WorthTokenSale is ReentrancyGuard, Context, Ownable {
    ...
    address internal busdAddr;
    
    uint256 internal tokenPriceUsd; 
    uint256 internal tokenDecimal = 18;
    uint256 internal totalTransaction;
    uint256 internal totalHardCap;
    uint256 internal minContribution;
    uint256 internal maxContribution;
