...
contract WorthTokenSale is ReentrancyGuard, Context, Ownable {
    ...
    /* External Function */
    function whitelistAddress(address[] memory _recipients, uint256[] memory _allocation) external nonReentrant returns (bool) {
    ...
    /* Parameters   : -- */
    /* External Function */
    function claimToken() external onlyOwner _saleEnded() returns (bool) {
    ...
    /* External Function */
    function exchangeUSDTForToken(uint256 _amount) external onlyOwner _contractUp() _saleNotEnded() {
    ...
    /* Parameters   : Total amount of WORTH token to buy */
    /* External Function */
    function exchangeBUSDForToken(uint256 _amount) external onlyOwner _contractUp() _saleNotEnded() {
    ...
    */
    function powerUpContract() external nonReentrant {
    ...
    function emergencyStop() external nonReentrant _contractUp() _saleNotEnded() {
        saleEnded = true;    
    ...
    *     @dev End the Sale
    */
    function endSale() external nonReentrant _contractUp() _saleNotEnded() {
    ...
    /* Parameters   : -- */
    /* Only Owner Function */
    function toggleWhitelistStatus() external nonReentrant returns (bool success)  {
        require(!contractUp, "Changes are not allowed during Token Sale");
        if (whitelist) {
            whitelist = false;
        } else {
