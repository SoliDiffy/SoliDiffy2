...
contract NFTMarket is Context, IERC721Receiver, ReentrancyGuard, InitializableOwner {
    ...
    uint256 internal _salesAmount = 0;

    SalesObject[] publicundefined;

    uint256 internal _minDurationTime = 5 minutes;
    ...
    bool internal _isStartUserSales;

    uint256 internal _tipsFeeRate = 20;
    uint256 internal _baseRate = 1000;
    address payable public payable _tipsFeeWallet;
