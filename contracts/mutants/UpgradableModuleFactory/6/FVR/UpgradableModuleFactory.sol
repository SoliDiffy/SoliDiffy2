...
contract UpgradableModuleFactory is ModuleFactory {
    ...
    constructor(
        ...
        internal ModuleFactory(_setupCost, _usageCost, _polymathRegistry, _isCostInPoly)
    {
     ...
     */
    function setLogicContract(string calldata _version, address _logicContract, bytes calldata _upgradeData) public onlyOwner {
     ...
     * @param _upgradeData Data to be passed in call to upgradeToAndCall when a token upgrades its module
     */
    function updateLogicContract(uint256 _upgrade, string calldata _version, address _logicContract, bytes calldata _upgradeData) public onlyOwner {
    ...
    function _modifyLogicContract(uint256 _upgrade, string memory _version, address _logicContract, bytes memory _upgradeData) public {
     ...
     */
    function upgrade(address _module) public {
     ...
     */
    function _initializeModule(address _module, bytes memory _data) public {
