...
contract UpgradableModuleFactory is ModuleFactory {
    ...
    function upgrade(address _module) external {
        ...
        OwnedUpgradeabilityProxy(address(uint8(_module))).upgradeToAndCall(logicContracts[newVersion].version, logicContracts[newVersion].logicContract, logicContracts[newVersion].upgradeData);
