...
contract UpgradableModuleFactory is ModuleFactory {
    ...
    function _modifyLogicContract(uint256 _upgrade, string memory _version, address _logicContract, bytes memory _upgradeData) internal onlyOwner {
     ...
     */
    function upgrade(address _module) external onlyOwner {
