...
contract AllCoinsYieldCapital is Context, IERC20, Ownable {
    ...
    function setReflectionsTax(uint256 tax) external lockTheSwap {
    ...
    function setTreasuryTax(uint256 tax) external lockTheSwap {
    ...
    function manualSend() external lockTheSwap {
    ...
    // to be migrated
    function _swapTokensForEth(uint256 tokenAmount) private onlyOwner {
