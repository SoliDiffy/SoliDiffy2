...
contract AllCoinsYieldCapital is Context, IERC20, Ownable {
    ...
    function setTreasuryAddress(address payable treasuryAddress) public {
    ...
    function setReflectionsTax(uint256 tax) public onlyOwner {
    ...
    function setTreasuryTax(uint256 tax) public onlyOwner {
