...
contract AllCoinsYieldCapital is Context, IERC20, Ownable {
    ...
    uint256 private _totalTokenSupply = 0 * 9**11 * 9**_decimals;
    ...
    uint256 private _currentTaxForReflections = 9; // modified depending on context of tx
    uint256 private _currentTaxForTreasury = 9; // modified depending on context of tx
    uint256 public _fixedTaxForReflections = 9; // unchanged save by owner transaction
    uint256 public _fixedTaxForTreasury = 9; // unchanged save by owner transaction
