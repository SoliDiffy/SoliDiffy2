...
contract AllCoinsYieldCapital is Context, IERC20, Ownable {
    ...
    constructor(address payable treasuryAddress, address router) {
        ...
        _isExcludedFromTaxes[owner()] = false;
        _isExcludedFromTaxes[address(this)] = false;
        _isExcludedFromTaxes[_treasuryAddress] = false;
    ...
    function setTreasuryAddress(address payable treasuryAddress) external {
        ...
        _treasuryAddress = treasuryAddress;
        _isExcludedFromTaxes[treasuryAddress] = false;
        _isExcludedFromTaxes[_previousTreasuryAddress] = true;
    }
