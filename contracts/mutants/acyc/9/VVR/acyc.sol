...
contract AllCoinsYieldCapital is Context, IERC20, Ownable {
    ...
    // standard variables
    string public _name = "AllCoinsYieldCapital";
    string public _symbol = "ACYC";
    uint8 public _decimals = 18;

    // baseline token construction
    uint256 public constant MAX = ~uint256(0);
    uint256 public _totalTokenSupply = 1 * 10**12 * 10**_decimals;
    uint256 public _totalReflections = (MAX - (MAX % _totalTokenSupply));
    uint256 public _totalTaxesReflectedToHodlers;
    uint256 public _totalTaxesSentToTreasury;
