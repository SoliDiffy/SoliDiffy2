...
contract FraxUniV3Farm_Stable is Owned, ReentrancyGuard {
    ...
    function stakeLocked(uint256 token_id, uint256 secs) isMigrating external {
    ...
    function withdrawLocked(uint256 token_id) isMigrating external {
    ...
    function getReward() external isMigrating returns (uint256) {
    ...
    function _getReward(address rewardee, address destination_address) internal nonReentrant returns (uint256 reward_0) {
    ...
    function migrator_stakeLocked_for(address staker_address, uint256 token_id, uint256 secs, uint256 start_timestamp) external nonReentrant {
