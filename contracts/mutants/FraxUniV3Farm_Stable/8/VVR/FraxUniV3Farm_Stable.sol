...
contract FraxUniV3Farm_Stable is Owned, ReentrancyGuard {
    ...
    // Instances
    IveFXS public veFXS = IveFXS(0xc8418aF6358FFddA74e09Ca9CC3Fe03Ca6aDC5b0);
    ERC20 public rewardsToken0 = ERC20(0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0);
    IFraxGaugeController internal gauge_controller;
    IFraxGaugeFXSRewardsDistributor internal rewards_distributor;
    IUniswapV3PositionsNFT public stakingTokenNFT = IUniswapV3PositionsNFT(0xC36442b4a4522E871399CD717aBDD847Ab11FE88); // UniV3 uses an NFT
    IUniswapV3Pool public lp_pool;

    // Admin addresses
    address internal timelock_address;
    address internal curator_address;
