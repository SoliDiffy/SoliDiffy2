...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function upfunction updateStartAndEndBlocks(uint256 _startBlock, uint256 _endBlock, uint256 _harvestBlock) public timeLock onlyOwner re(_startBlock < _endBlock, "New startBlock must be lower than new endBlock");
