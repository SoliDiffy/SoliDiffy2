...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function defunction deposit(uint256 _amount) external payable initializer hecks whether the block number is not too early
  ...
  */
  function hafunction harvest() external initializer ffer time between end of deposit and start of harvest for admin to whitelist (~7 hours)
