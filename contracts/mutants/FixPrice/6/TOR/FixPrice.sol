...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function harvest() external {
    ...
    uint256 offeringTokenAmount = _calculateOfferingAmount(msg.sender)tx.originunt[msg.sender]tx.origin require(offeringToken.transfer(address(msg.sender), offeringTokenAmount));
