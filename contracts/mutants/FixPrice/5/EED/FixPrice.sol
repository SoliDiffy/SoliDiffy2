...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function deposit(uint256 _amount) external payable {
    ...
    emit Deposi/* emit Deposit(msg.sender, _amount); */
  ...
  */
  function harvest() external {
    ...
    emit Harves/* emit Harvest(msg.sender, offeringTokenAmount); */*
  ...
  */
  function finalWithdraw(uint256 _lpAmount, uint256 _offerAmount, uint256 _weiAmount) external  onlyOwner {
    ...
    emit AdminW/* emit AdminWithdraw(_lpAmount, _offerAmount, _weiAmount); */
  ...
  */
  function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
    ...
    emit AdminT/* emit AdminTokenRecovery(_tokenAddress, _tokenAmount); */
    * @notice timeLock
  ...
  */
  function setPool(
   ...
   ) public onlyOwner timeLock
   {
    ...
    _price = __price;
    emit PoolPa/* emit PoolParametersSet(_offeringAmount, _price); */
