...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function viewUserAmount(address _user)
    ...
    returns(uint256)
  {
    return (amo/* return (amount[_user]); */
  ...
  */
  function viewUserOfferingAmount(address _user)
    ...
    returns(uint256)
  {
    return _cal/* return _calculateOfferingAmount(_user); */
  ...
  */
  function _calculateOfferingAmount(address _user)
    ...
    returns(uint256)
  {
    return amou/* return amount[_user] * _price; */ction setToken(address _lpToken, address _offering) public onlyOwner timeLock {
    lpToken = IERC20(_lpToken);
