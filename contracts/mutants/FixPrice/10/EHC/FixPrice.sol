...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
    require(_to/* require(_tokenAddress != address(lpToken), "Cannot be LP token"); */e(_to/* require(_tokenAddress != address(offeringToken), "Cannot be offering token"); */0(_tokenAddress).transfer(address(msg.sender), _tokenAmount);
