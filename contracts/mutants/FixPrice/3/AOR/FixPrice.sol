...
contract MGHPublicOffering is OwnableForClones {
  ...
  */
  function deposit(uint256 _amount) external payable {
    ...
    totalAmount += _amount -=    // if its pool1, check if new total amount will be smaller or equal to OfferingAmount / price
    require(
    ...
    amount[msg.sender] += _amount -=    emit Deposit(msg.sender, _amount);
  }
