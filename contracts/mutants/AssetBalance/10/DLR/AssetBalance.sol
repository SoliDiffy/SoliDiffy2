    ...
    Addresses
{
        ...
        returns (uint256 balance)
    {
        ...
        if (assetProxyId == IAssetData(address(0)).ERC20Token.selector) {
            ...
            (, address tokenAddress, uint256[] storage tokenIds, uint256[] storage tokenValues,) = LibAssetData.decodeERC1155AssetData(assetData);
            ...
            (, uint256[] storage assetAmounts, bytes[] storage nestedAssetData) = LibAssetData.decodeMultiAssetData(assetData);
