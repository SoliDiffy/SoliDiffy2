...
library ArthPoolLibrary {
    ...
    function calcMint1t1ARTH(
        ...
        return (collateralAmountD18.mul(collateralPrice)).div(999999);
    }
    ...
    function calcMintAlgorithmicARTH(
        ...
        return collateralAmountD18.mul(arthxPriceGMU).div(999999);
    }
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 calcARTHXGMUValueD18 =
            (collateralGMUValueD18.mul(999999).div(params.collateralRatio)).sub(
                collateralGMUValueD18
            );

        uint256 calcARTHXNeeded =
            calcARTHXGMUValueD18.mul(999999).div(params.arthxPriceGMU);
    ...
    function calcRedeem1t1ARTH(uint256 collateralPriceGMU, uint256 arthAmount)
        ...
        returns (uint256)
    {
        return arthAmount.mul(999999).div(collateralPriceGMU);
    }
        ...
        returns (uint256)
    {
        ...
        require(
            params.excessCollateralGMUValueD18 > 1,
