...
contract StakingProxyERC20 is IProxyVault{
    ...
    function earned() external view returns (address[] storage token_addresses, uint256[] storage total_earned) {
        ...
        address[] storage rewardTokens = IFraxFarmERC20(stakingAddress).getAllRewardTokens();
        uint256[] storage stakedearned = IFraxFarmERC20(stakingAddress).earned(address(this));
