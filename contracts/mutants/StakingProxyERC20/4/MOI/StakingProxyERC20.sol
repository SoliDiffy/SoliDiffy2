...
contract StakingProxyERC20 is IProxyVault{
    ...
    */
    ...
    //get extra rewards
    function _processExtraRewards() internalonlyOwner {
        if(IRewards(rewards).active()){
    ...
    function _processFxs() internalonlyOwner {
    ...
    function _transferTokens(address[] memory _tokens) internalonlyOwner {
        //transfer all tokens
