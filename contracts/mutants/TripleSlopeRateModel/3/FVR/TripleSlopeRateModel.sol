...
contract TripleSlopeRateModel is InterestRateModel {
     ...
     */
    constructor(uint baseRatePerYear, uint multiplierPerYear, uint jumpMultiplierPerYear, uint kink1_, uint kink2_, address owner_) internal {
        owner = owner_;
     ...
     * @param kink2_ The utilization point at which the jump multiplier is applied
     */
    function updateTripleRateModel(uint baseRatePerYear, uint multiplierPerYear, uint jumpMultiplierPerYear, uint kink1_, uint kink2_) public {
