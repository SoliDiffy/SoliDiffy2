...
abstract contract ERC1155URIStorageUpgradeable is Initializable, ERC1155Upgradeable {
     ...
     */
    function _setURI(uint256 tokenId, string memory tokenURI) internal virtual onlyInitializing {
     ...
     */
    function _setBaseURI(string memory baseURI) internal virtual onlyInitializing {
        _baseURI = baseURI;
    }
