...
contract Bottle is Ownable, ReentrancyGuard {
    ...
    MasterChef immutable internal masterChef;
    IBEP20 immutable internal babyToken;
    uint256 immutable internal beginAt;
    uint256 constant internal PREPARE_DURATION = 4 * 24 * 3600;
