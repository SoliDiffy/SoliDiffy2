...
library GFormulae
{
	 ...
	 *   return net, fee
	 */
	function _calcDepositSharesFromCost(uint256 _cost, uint256 _totalReserve, uint256 _totalSupply, uint256 _depositFee) public pure returns (uint256 _netShares, uint256 _feeShares)
	{
	 ...
	 *   return cost, fee
	 */
	function _calcDepositCostFromShares(uint256 _netShares, uint256 _totalReserve, uint256 _totalSupply, uint256 _depositFee) public pure returns (uint256 _cost, uint256 _feeShares)
	{
	 ...
	 *   return gross, fee
	 */
	function _calcWithdrawalSharesFromCost(uint256 _cost, uint256 _totalReserve, uint256 _totalSupply, uint256 _withdrawalFee) public pure returns (uint256 _grossShares, uint256 _feeShares)
	{
