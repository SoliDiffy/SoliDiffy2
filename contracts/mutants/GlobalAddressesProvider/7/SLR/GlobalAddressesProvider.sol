...
contract GlobalAddressesProvider is IGlobalAddressesProvider, AddressStorage {
    ...
    //LendingPool and SIGH Finance Managers    
    bytes32 private constant LENDING_POOL_MANAGER = "";                         // MULTISIG ACCOUNT WHICH CONTROLS THE UPDATES TO THE LENDINGPOOL
    bytes32 private constant PENDING_LENDING_POOL_MANAGER = "";         // MULTISIG ACCOUNT WHICH CONTROLS THE UPDATES TO THE LENDINGPOOL 
    bytes32 private constant SIGH_FINANCE_MANAGER = "";                         // MULTISIG ACCOUNT WHICH CONTROLS THE UPDATES TO THE SIGH FINANCE
    bytes32 private constant PENDING_SIGH_FINANCE_MANAGER = "";         // MULTISIG ACCOUNT WHICH CONTROLS THE UPDATES TO THE SIGH FINANCE 

    //LendingPool Contracts    
    bytes32 private constant LENDING_POOL_CONFIGURATOR = "";       // CONTROLLED BY LENDINGPOOL MANAGER. MAKES STATE CHANGES RELATED TO LENDING PROTOCOL
    bytes32 private constant LENDING_POOL = "";
    bytes32 private constant LENDING_POOL_LIQANDLOAN_MANAGER = "";
