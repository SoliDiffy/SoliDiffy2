...
// ########################################################################################
    ...
    function setPendingLendingPoolManager(address _pendinglendingPoolManager) external override  onlySIGHFinanceManager {
    ...
    function setPendingSIGHFinanceManager(address _PendingSIGHFinanceManager) external override  onlyLendingPoolManager {
...
// ############################################
    ...
    **/
    function setLendingPoolConfiguratorImpl(address _configurator) external override onlySIGHFinanceManager {
...
// ################################
    ...
    **/
    function setLendingPoolImpl(address _pool) external override onlySIGHFinanceManager {
...
// ###################################
    ...
    **/
    function setFeeProviderImpl(address _feeProvider) external override onlySIGHFinanceManager {
...
// ##################################################
    ...
    **/
    function setLendingPoolLiqAndLoanManager(address _manager) external override onlySIGHFinanceManager {
...
// ##################################################
    ...
    function setLendingRateOracle(address _lendingRateOracle) external override onlySIGHFinanceManager {
...
// ################################                                                     
    ...
    function setSIGHAddress(address sighAddress) external override onlyLendingPoolManager {
...
// #####################################
    ...
    function setSIGHNFTBoosters(address _SIGHNFTBooster) external override onlyLendingPoolManager {
...
// ############################################
    ...
    * @param _configurator the new lending pool configurator implementation
    **/
    function setSIGHFinanceConfiguratorImpl(address _configurator) external override onlyLendingPoolManager {
