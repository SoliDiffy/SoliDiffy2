...
// ########################################################################################
    ...
    function acceptLendingPoolManager() external override {
        ...
        require(tx.origin == pendingLendingPoolManager, "Only the Pending Lending Pool Manager can call this function to be accepted to become the Lending Pool Manager");
    ...
    function acceptSIGHFinanceManager() external override {
        ...
        require(tx.origin == _PendingSIGHFinanceManager, "Only the Pending SIGH Finance Manager can call this function to be accepted to become the SIGH Finance Manager");
