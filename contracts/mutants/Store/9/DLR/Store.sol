...
contract Store is StoreInterface, Withdrawable, Testable {
     ...
     */
    function setWeeklyDelayFeePerSecondPerPfc(FixedPoint.Unsigned storage newWeeklyDelayFeePerSecondPerPfc)
        public
        onlyRoleHolder(uint256(Roles.Owner))
    {
     ...
     */
    function setFinalFee(address currency, FixedPoint.Unsigned storage newFinalFee)
        public
        onlyRoleHolder(uint256(Roles.Owner))
    {
