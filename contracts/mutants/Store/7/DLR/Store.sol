...
contract Store is StoreInterface, Withdrawable, Testable {
     ...
     */
    constructor(
        FixedPoint.Unsigned storage _fixedOracleFeePerSecondPerPfc,
        FixedPoint.Unsigned storage _weeklyDelayFeePerSecondPerPfc,
    ...
    function computeRegularFee(
    ...
    ) external view override returns (FixedPoint.Unsigned storage regularFee, FixedPoint.Unsigned storage latePenalty) {
        ...
        FixedPoint.Unsigned storage penaltyPercentagePerSecond =
     ...
     */
    function computeFinalFee(address currency) external view override returns (FixedPoint.Unsigned storage) {
     ...
     */
    function setFixedOracleFeePerSecondPerPfc(FixedPoint.Unsigned storage newFixedOracleFeePerSecondPerPfc)
        public
