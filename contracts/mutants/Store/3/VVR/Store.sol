...
contract Store is StoreInterface, Withdrawable, Testable {
    ...
    FixedPoint.Unsigned internal fixedOracleFeePerSecondPerPfc; // Percentage of 1 E.g., .1 is 10% Oracle fee.
    FixedPoint.Unsigned internal weeklyDelayFeePerSecondPerPfc; // Percentage of 1 E.g., .1 is 10% weekly delay fee.
