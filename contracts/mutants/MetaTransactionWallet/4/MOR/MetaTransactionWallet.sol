  ...
  Ownable
{
   ...
   */
  function initialize(address _signer) external onlyOwner {
    _setSigner(_signer);
   ...
   * @param _signer The address authorized to execute transactions via this wallet.
   */
  function setSigner(address _signer) external initializer {
    _setSigner(_signer);
  }
   ...
   */
  function setGuardian(address _guardian) external initializer {
    guardian = _guardian;
   ...
   */
  function recoverWallet(address newSigner) external initializer {
