...
contract SXP is BEP20Interface, Tokenlock, UserLock {
    ...
    */
     ...
     */
    function transfer(address recipient, uint256 amount) external permissionCheck validLock returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) external permissionCheck validLock returns (bool) {
     ...
     * @return true
     */
    function approveAndCall(address spender, uint256 amount, bytes memory data) public permissionCheck validLock returns (bool) {
        _approve(_msgSender(), spender, amount);
     ...
     * @return Whether or not the transfer succeeded
     */
    function transferFrom(address sender, address recipient, uint256 amount) external permissionCheck validLock returns (bool) {
     ...
     * @return Whether or not the approval succeeded
     */
    function increaseAllowance(address spender, uint256 addedValue) public permissionCheck validLock returns (bool) {
     ...
     * @return Whether or not the approval succeeded
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public permissionCheck validLock returns (bool) {
     ...
     * @return true
     */
    function burn(uint256 amount) public permissionCheck validLock returns (bool) {
     ...
     */
    function delegate(address delegatee) public permissionCheck validLock {
     ...
     */
    function delegateBySig(address delegatee, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) public permissionCheck validLock {
