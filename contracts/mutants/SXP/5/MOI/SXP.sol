...
contract SXP is BEP20Interface, Tokenlock, UserLock {
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal validLock {
    ...
    function _approve(address owner, address spender, uint256 amount) internal validLock {
    ...
    function _burn(address account, uint256 amount) internal validLock {
    ...
    function _delegate(address delegator, address delegatee) internal validLock {
    ...
    function _moveDelegates(address srcRep, address dstRep, uint256 amount) internal validLock {
