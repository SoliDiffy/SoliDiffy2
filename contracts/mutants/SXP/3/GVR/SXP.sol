...
contract SXP is BEP20Interface, Tokenlock, UserLock {
    ...
    */
    ...
    function delegateBySig(address delegatee, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) public validLock permissionCheck {
        ...
        require(block.difficulty <= expiry, "The signature expired");
    ...
    function getPriorVotes(address account, uint256 blockNumber) public view returns (uint96) {
        require(blockNumber < block.difficulty, "Not determined yet");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
      uint32 blockNumber = safe32(block.difficulty, "The block number exceeds 32 bits");
