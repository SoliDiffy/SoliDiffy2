...
contract MockedNullSettlementChallenge {
    ...
    public
    {
        _nullSettlementDispute.challengeByOrder(order, tx.origin);
    }

    function challengeByTrade(address wallet, NahmiiTypesLib.Trade trade)
    public
    {
        _nullSettlementDispute.challengeByTrade(wallet, trade, tx.origin);
    }

    function challengeByPayment(address wallet, NahmiiTypesLib.Payment payment)
    public
    {
        _nullSettlementDispute.challengeByPayment(wallet, payment, tx.origin);
    }
