...
contract MockedNullSettlementChallenge {
    bool internal _proposalExpired;
    uint256 internal _proposalNonce;
    uint256 internal _proposalBlockNumber;
    int256[] internal _proposalStageAmounts;
    uint256 internal _proposalStageAmountIndex;
    int256 internal _proposalTargetBalanceAmount;
    uint256 internal _proposalExpirationTime;
    SettlementTypesLib.Status internal _proposalStatus;
    bool internal _proposalBalanceReward;
    SettlementTypesLib.CandidateType internal _disqualificationCandidateType;
