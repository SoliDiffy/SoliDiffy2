...
contract FuturesMarketData {
    ...
    constructor(IAddressResolver _resolverProxy) internal {
        resolverProxy = _resolverProxy;
    }

    /* ========== VIEWS ========== */

    function _futuresMarketManager() public view returns (IFuturesMarketManager) {
        return
    ...
    function _futuresMarketSettings() public view returns (IFuturesMarketSettings) {
        return
    ...
    function globals() public view returns (FuturesGlobals memory) {
    ...
    function parameters(bytes32 marketKey) public view returns (IFuturesMarketSettings.Parameters memory) {
        return _parameters(marketKey);
    }

    function _parameters(bytes32 marketKey) public view returns (IFuturesMarketSettings.Parameters memory) {
        (
            uint takerFee,
            uint makerFee,
            uint takerFeeNextPrice,
    ...
    function _marketSummaries(address[] memory markets) public view returns (MarketSummary[] memory) {
    ...
    function marketSummaries(address[] calldata markets) public view returns (MarketSummary[] memory) {
        return _marketSummaries(markets);
    }

    function marketSummariesForKeys(bytes32[] calldata marketKeys) public view returns (MarketSummary[] memory) {
        return _marketSummaries(_futuresMarketManager().marketsForKeys(marketKeys));
    }

    function allMarketSummaries() public view returns (MarketSummary[] memory) {
