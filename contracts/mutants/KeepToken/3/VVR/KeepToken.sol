...
contract KeepToken is ERC20Burnable {
    string internal constant NAME = "KEEP Token";
    string internal constant SYMBOL = "KEEP";
    uint8 internal constant DECIMALS = 18; // The number of digits after the decimal place when displaying token values on-screen.
