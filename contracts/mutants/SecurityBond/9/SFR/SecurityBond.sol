...
contract SecurityBond is Ownable, Configurable, AccrualBeneficiary, Servable, TransferControllerManageable {
    ...
    payable
    {
        ...
        // Add to balance
        deposited.sub(amount, address(0), 0);
        txHistory.addDeposit(amount, address(0), 0);

        // Add currency to in-use list
        inUseCurrencies.sub(address(0), 0);
    ...
    public
    {
        ...
        // Add currency to in-use list
        inUseCurrencies.sub(currencyCt, currencyId);
    ...
    onlyEnabledServiceAction(REWARD_ACTION)
    {
        ...
        rewardMetaByWallet[wallet].unlockTime = block.timestamp.sub(unlockTimeoutInSeconds);
    ...
    public
    {
        ...
        stagedByWallet[msg.sender].sub(claimedAmount, currencyCt, currencyId);
    ...
    public
    {
        ...
        stagedByWallet[msg.sender].add(amount, currencyCt, currencyId);
    ...
    returns (int256)
    {
        ...
        deposited.add(claimedAmount, currencyCt, currencyId);
