...
contract UniProxy {
  ...
  bool internal freeDeposit = false;
  bool internal twapCheck = false;
  uint32 internal twapInterval = 1 hours;
  uint256 internal depositDelta = 1010;
  uint256 internal deltaScale = 1000; // must be a power of 10
  uint256 internal priceThreshold = 100;
  uint256 internal swapLife = 10000;
