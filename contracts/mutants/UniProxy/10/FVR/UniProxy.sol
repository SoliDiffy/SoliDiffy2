...
contract UniProxy {
  ...
  function addPosition(address pos, uint8 version) public onlyOwner {
...
// SWC-105-Unprotected Ether Withdrawal: L67-126
  ...
  */
  ...
  function setPriceThreshold(uint256 _priceThreshold) public onlyOwner {
    priceThreshold = _priceThreshold;
  }

  function setDepositDelta(uint256 _depositDelta) public onlyOwner {
    depositDelta = _depositDelta;
  }

  function setDeltaScale(uint256 _deltaScale) public onlyOwner {
