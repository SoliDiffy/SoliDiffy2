...
contract FilterERC721V1 is IERC721Receiver, BaseFilterV1 {
    ...
    function init(
        ...
        _changeNFTInPrice(priceRules[1], priceRules[0], toggles[1]);
        _changeNFTRandomInPrice(priceRules[1], priceRules[2], toggles[0]);
        _changeNFTTargetOutPrice(priceRules[3], priceRules[4], toggles[1]);

        _changeNFTAmountRange(numParams[1], numParams[3]);
