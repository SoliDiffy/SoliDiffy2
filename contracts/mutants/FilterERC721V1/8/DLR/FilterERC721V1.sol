...
contract FilterERC721V1 is IERC721Receiver, BaseFilterV1 {
    ...
    function init(
        ...
        bool[] storage toggles,
        uint256[] storage numParams, //0 - startId, 1 - endId, 2 - maxAmount, 3 - minAmount
        uint256[] storage priceRules,
        uint256[] storage spreadIds
    ) external {
    ...
    function ERC721In(uint256[] storage tokenIds, address to)
        external
        preventReentrant
    ...
    function ERC721TargetOut(uint256[] storage indexes, address to)
        external
        preventReentrant
