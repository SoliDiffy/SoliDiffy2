...
contract MixinSystemSettings is MixinResolver {
    ...
    enum CrossDomainMessageGasLimits {Escrow, Deposit, Reward, Withdrawal, CloseFeePeriod, Relay}
    ...
    function _getGasLimitSetting(CrossDomainMessageGasLimits gasLimitType) internal pure returns (bytes32) {
        if (gasLimitType == CrossDomainMessageGasLimits.Escrow) {
            return SETTING_CROSS_DOMAIN_DEPOSIT_GAS_LIMIT;
        } else if (gasLimitType == CrossDomainMessageGasLimits.Deposit) {
