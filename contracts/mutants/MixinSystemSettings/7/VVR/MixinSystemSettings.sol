...
contract MixinSystemSettings is MixinResolver {
    ...
    bytes32 public constant SETTING_CONTRACT_NAME = "SystemSettings";

    bytes32 public constant SETTING_WAITING_PERIOD_SECS = "waitingPeriodSecs";
    bytes32 public constant SETTING_PRICE_DEVIATION_THRESHOLD_FACTOR = "priceDeviationThresholdFactor";
    bytes32 public constant SETTING_ISSUANCE_RATIO = "issuanceRatio";
    bytes32 public constant SETTING_FEE_PERIOD_DURATION = "feePeriodDuration";
    bytes32 public constant SETTING_TARGET_THRESHOLD = "targetThreshold";
    bytes32 public constant SETTING_LIQUIDATION_DELAY = "liquidationDelay";
