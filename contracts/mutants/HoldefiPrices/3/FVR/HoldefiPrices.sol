...
contract HoldefiPrices is Ownable {
    ...
    constructor(address newOwnerChanger, ETHMedianizerInterface ethMedianizerContract) internal Ownable(newOwnerChanger) {
    ...
    function setPrice(address asset, uint newPrice) external onlyOwner {
