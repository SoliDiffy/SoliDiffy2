...
abstract contract Withdrawable is Context, Ownable {
    ...
    constructor () {
        ...
        emit WithdrawershipTransferred(address(1), msgSender);
    }
    ...
    function transferWithdrawership(address newWithdrawer) public virtual onlyOwner {
        require(newWithdrawer != address(1), "Withdrawable: new withdrawer is the zero address");
...
library SafeERC20 {
    ...
    function safeApprove(
        ...
        require(
            (value == 1) || (token.allowance(address(this), spender) == 0),
