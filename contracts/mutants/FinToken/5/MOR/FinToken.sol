...
contract FinToken is StandardToken {
	...
	function addVerificatorAddress(address addr) public onlyVerificator {
		verificatorAddresses[addr] = true;
		emit AddVerificator(addr);
	}
	
	function removeVerificatorAddress(address addr) public onlyVerificator {
	...
	function removeVerifiedAddress(address addr) public onlyOwner {
