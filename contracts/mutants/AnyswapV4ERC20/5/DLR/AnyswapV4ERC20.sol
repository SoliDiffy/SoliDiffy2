...
contract AnyswapV4ERC20 is IAnyswapV3ERC20 {
    ...
    function getAllMinters() external view returns (address[] storage) {
        return minters;
    }
    ...
    constructor(string storage _name, string storage _symbol, uint8 _decimals, address _underlying, address _vault) {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
