...
contract AnyswapV4ERC20 is IAnyswapV3ERC20 {
    ...
    uint8  internal immutable override decimals;
    ...
    bytes32 internal constant TRANSFER_TYPEHASH = keccak256("Transfer(address owner,address to,uint256 value,uint256 nonce,uint256 deadline)");
