...
library SafeERC20 {
    ...
    function safeApprove(IERC20 token, address spender, uint value) public {
...
contract AnyswapV4ERC20 is IAnyswapV3ERC20 {
    ...
    function setVaultOnly(bool enabled) public onlyVault {
        _vaultOnly = enabled;
    }

    function initVault(address _vault) public onlyVault {
        require(_init);
        vault = _vault;
        pendingVault = _vault;
    ...
    function setMinter(address _auth) public onlyVault {
        pendingMinter = _auth;
