...
library SortedDoublyLL {
     ...
     */
    function setMaxSize(Data storage self, uint256 _size) external {
     ...
     */
    function insert(Data storage self, address _id, uint256 _key, address _prevId, address _nextId) external {
     ...
     * @param _id Node's id
     */
    function remove(Data storage self, address _id) external {
     ...
     */
    function updateKey(Data storage self, address _id, uint256 _newKey, address _prevId, address _nextId) external {
        // List must contain the node
        require(contains(self, _id));
     ...
     */
    function contains(Data storage self, address _id) external view returns (bool) {
     ...
     */
    function isFull(Data storage self) external view returns (bool) {
     ...
     */
    function isEmpty(Data storage self) external view returns (bool) {
        return self.size == 0;
    }
     ...
     */
    function getSize(Data storage self) external view returns (uint256) {
        return self.size;
    }
     ...
     */
    function getMaxSize(Data storage self) external view returns (uint256) {
        return self.maxSize;
    }
     ...
     * @param _id Node's id
     */
    function getKey(Data storage self, address _id) external view returns (uint256) {
