...
library SortedDoublyLL {
     ...
     */
    function setMaxSize(Data memory self, uint256 _size) public {
     ...
     */
    function insert(Data memory self, address _id, uint256 _key, address _prevId, address _nextId) public {
     ...
     * @param _id Node's id
     */
    function remove(Data memory self, address _id) public {
     ...
     */
    function updateKey(Data memory self, address _id, uint256 _newKey, address _prevId, address _nextId) public {
        // List must contain the node
        require(contains(self, _id));
     ...
     */
    function contains(Data memory self, address _id) public view returns (bool) {
     ...
     */
    function isFull(Data memory self) public view returns (bool) {
     ...
     */
    function isEmpty(Data memory self) public view returns (bool) {
        return self.size == 0;
    }
     ...
     */
    function getSize(Data memory self) public view returns (uint256) {
        return self.size;
    }
     ...
     */
    function getMaxSize(Data memory self) public view returns (uint256) {
        return self.maxSize;
    }
     ...
     * @param _id Node's id
     */
    function getKey(Data memory self, address _id) public view returns (uint256) {
