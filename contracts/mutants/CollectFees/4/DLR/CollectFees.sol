...
contract CollectFees is ICollectFees {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        INonfungiblePositionManager.CollectParams storage params = INonfungiblePositionManager.CollectParams({
            tokenId: tokenId,
    ...
    function _updateUncollectedFees(uint256 tokenId) internal {
        StorageStruct memory Storage = PositionManagerStorage.getStorage();
        INonfungiblePositionManager.DecreaseLiquidityParams storage params = INonfungiblePositionManager
