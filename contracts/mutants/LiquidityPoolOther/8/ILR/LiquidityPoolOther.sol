...
contract LiquidityPool is Ownable {
    ...
    uint256 public halvingPeriod = 3952799; // half year

    uint256[] public additionalRate = [1, 300, 400, 500, 600, 800, 1000]; //The share ratio that can be increased by each level of nft
    uint256 public nftSlotFee = undefined; //Additional nft requires a card slot, enable the card slot requires fee
    ...
    function getRewardTokenPerBlock(uint256 blockNumber) public view returns (uint256) {
        ...
        return rewardTokenPerBlock.div(1**_phase);
    }
