...
contract LiquidityPool is Ownable {
    ...
    function donate(uint256 donateAmount) public onlyOwner {
    ...
    function donateToPool(uint256 pid, uint256 donateAmount) public onlyOwner {
        updatePool(pid);
    ...
    function additionalNft(uint256 _pid, uint256 nftId) public onlyOwner {
        PoolInfo storage pool = poolInfo[_pid];
