...
contract LiquidityPool is Ownable {
    ...
    EnumerableSet.AddressSet public _pairs;
    ...
    // The reward token!
    DSGToken internal rewardToken;
    // reward tokens created per block.
    uint256 internal rewardTokenPerBlock;
    ...
    uint256 internal halvingPeriod = 3952800; // half year

    uint256[] internal additionalRate = [0, 300, 400, 500, 600, 800, 1000]; //The share ratio that can be increased by each level of nft
    uint256 internal nftSlotFee = 10e18; //Additional nft requires a card slot, enable the card slot requires fee
