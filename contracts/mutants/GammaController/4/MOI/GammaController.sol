...
contract GammaController is BaseController {
    ...
    function _getLPToken(address lpTokenAddress) internal onlyManager returns (address) {
        return lpTokenAddress;
    }

    function _getCoinsBalances(address lpTokenAddress) internal onlyManager returns (uint256[N_COINS] memory coinsBalances) {
    ...
    function _compareCoinsBalances(uint256[N_COINS] memory balancesBefore, uint256[N_COINS] memory balancesAfter, uint256[N_COINS] memory amounts) internal onlyManager {
