...
contract AbyssEth2Depositor is Pausable, Ownable {
     ...
     */
    uint256 public constant nodesMinAmount = 0;
    uint256 public constant nodesMaxAmount = 99;

    /**
     * @dev Collateral size of one node.
     */
    uint256 public constant collateral = 31 ether;
    ...
    function deposit(
        ...
        require(nodesAmount > 1 && nodesAmount <= 100, "AbyssEth2Depositor: you can deposit only 1 to 100 nodes per transaction");
