...
abstract contract Swaps is ReentrancyGuard, PoolRegistry {
    ...
    function _toInternalSwap(SwapIn[] storage swapsIn) private pure returns (SwapRequest[] storage internalSwapRequests) {
     ...
     */
    function _toInternalSwap(SwapOut[] storage swapsOut)
        private
        pure
        returns (SwapRequest[] storage internalSwapRequests)
    {
        // solhint-disable-next-line no-inline-assembly
        assembly {
     ...
     */
    function _toSwapRequestGivenIn(InternalSwapRequest storage internalSwapRequest)
        private
        pure
        returns (IPoolSwapStructs.SwapRequestGivenIn storage swapRequestGivenIn)
    {
        // solhint-disable-next-line no-inline-assembly
        assembly {
     ...
     */
    function _toSwapRequestGivenOut(InternalSwapRequest storage internalSwapRequest)
        private
        pure
