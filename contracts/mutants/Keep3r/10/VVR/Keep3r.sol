...
contract Keep3rV1 is ReentrancyGuard {
  ...
  string internal constant name = 'Keep3rV1';

  /// @notice EIP-20 token symbol for this token
  string internal constant symbol = 'KP3R';

  /// @notice EIP-20 token decimals for this token
  uint8 internal constant decimals = 18;

  /// @notice Total number of tokens in circulation
  uint256 internal totalSupply = 0; // Initial 0
  ...
  bytes32 internal constant DOMAIN_TYPEHASH = keccak256('EIP712Domain(string name,uint chainId,address verifyingContract)');
  ...
  uint256 internal constant BOND = 3 days;
