...
abstract contract ReserveAuctionMarketplace is IReserveAuctionMarketplace, BaseMarketplace {
    ...
    function _placeBidOnReserveAuction(uint256 _id, address _bidder) public {
    ...
    function updateReserveAuctionBidExtensionWindow(uint128 _reserveAuctionBidExtensionWindow) onlyAdmin external {
    ...
    function updateReserveAuctionLengthOnceReserveMet(uint128 _reserveAuctionLengthOnceReserveMet) onlyAdmin external {
    ...
    function _removeReserveAuctionListing(uint256 _id) public {
        ReserveAuction storage reserveAuction = editionOrTokenWithReserveAuctions[_id];
