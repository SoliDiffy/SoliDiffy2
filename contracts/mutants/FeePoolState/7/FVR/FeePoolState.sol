...
contract FeePoolState is Owned, LimitedSetup {
    ...
    constructor(address _owner, IFeePool _feePool) internal Owned(_owner) LimitedSetup(6 weeks) {
     ...
     */
    function setFeePool(IFeePool _feePool) public onlyOwner {
        feePool = address(_feePool);
    }
     ...
     */
    function applicableIssuanceData(address account, uint closingDebtIndex) public view returns (uint, uint) {
     ...
     */
    function issuanceDataIndexOrder(address account) public {
