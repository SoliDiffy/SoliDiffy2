...
contract ERC20PresetMinterPauserUpgradeable is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
    function initialize(string storage name, string storage symbol) public virtual initializer {
     ...
     */
    function __ERC20PresetMinterPauser_init(string storage name, string storage symbol) internal onlyInitializing {
