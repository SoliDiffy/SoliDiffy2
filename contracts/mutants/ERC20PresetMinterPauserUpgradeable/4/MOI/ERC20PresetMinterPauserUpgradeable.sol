...
contract ERC20PresetMinterPauserUpgradeable is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
     ...
     */
    function mint(address to, uint256 amount) public virtual initializer {
     ...
     */
    function pause() public virtual initializer {
     ...
     * - the caller must have the `PAUSER_ROLE`.
     */
    function unpause() public virtual initializer {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20Upgradeable, ERC20PausableUpgradeable) initializer {
