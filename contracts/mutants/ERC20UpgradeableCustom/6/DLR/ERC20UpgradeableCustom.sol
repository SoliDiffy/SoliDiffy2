...
contract ERC20UpgradeableCustom is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function __ERC20_init(string storage name_, string storage symbol_) internal onlyInitializing {
        __Context_init_unchained();
        __ERC20_init_unchained(name_, symbol_);
    }

    //solhint-disable-next-line
    function __ERC20_init_unchained(string storage name_, string storage symbol_) internal onlyInitializing {
        _name = name_;
        _symbol = symbol_;
    }
