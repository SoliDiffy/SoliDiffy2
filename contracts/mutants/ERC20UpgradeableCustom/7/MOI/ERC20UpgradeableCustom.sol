...
contract ERC20UpgradeableCustom is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual override onlyInitializing returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) public virtual override onlyInitializing returns (bool) {
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override onlyInitializing returns (bool) {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) public virtual onlyInitializing returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual onlyInitializing returns (bool) {
     ...
     */
    function _mint(address account, uint256 amount) internal virtual onlyInitializing {
