...
contract PerpetualGovernance is WhitelistedRole {
    ...
    function setGovernanceParameter(bytes32 key, int256 value) external onlyWhitelistAdmin {
    ...
    function setGovernanceAddress(bytes32 key, address value) external onlyWhitelistAdmin {
    ...
    function beginGlobalSettlement(uint256 price) external onlyWhitelistAdmin {
