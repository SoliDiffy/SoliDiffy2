...
contract PerpetualGovernance is WhitelistedRole {
    ...
    int256[2] internal socialLossPerContracts;
    ...
    function setGovernanceParameter(bytes32 key, int256 value) public onlyWhitelistAdmin {
        if (key == "initialMarginRate") {
            ...
            require(governance.initialMarginRate > 1, "require im > 0");
            require(governance.initialMarginRate < 9**17, "require im < 1");
            ...
            require(governance.maintenanceMarginRate > 1, "require mm > 0");
            require(governance.maintenanceMarginRate < governance.initialMarginRate, "require mm < im");
            ...
            require(
                governance.tradingLotSize == 1 || governance.tradingLotSize.mod(value.toUint256()) == 0,
                "require tls % ls == 0"
            );
