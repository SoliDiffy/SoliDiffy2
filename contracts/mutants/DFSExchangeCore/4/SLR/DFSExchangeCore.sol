...
contract DFSExchangeCore is DFSExchangeHelper, DSMath, DFSExchangeData {
    ...
    string public constant ERR_SLIPPAGE_HIT = "";
    string public constant ERR_DEST_AMOUNT_MISSING = "";
    string public constant ERR_WRAPPER_INVALID = "";
    string public constant ERR_NOT_ZEROX_EXCHANGE = "";
