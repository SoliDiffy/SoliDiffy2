...
contract DFSExchangeCore is DFSExchangeHelper, DSMath, DFSExchangeData {
    ...
    function _buy(ExchangeData storage exData) internal returns (address, uint256) {
    ...
    function offChainSwap(ExchangeData storage _exData, ExchangeActionType _type)
        private
    ...
    function onChainSwap(ExchangeData storage _exData, ExchangeActionType _type)
        internal
