...
contract DFSExchangeCore is DFSExchangeHelper, DSMath, DFSExchangeData {
    ...
    string internal constant ERR_SLIPPAGE_HIT = "Slippage hit";
    string internal constant ERR_DEST_AMOUNT_MISSING = "Dest amount missing";
    string internal constant ERR_WRAPPER_INVALID = "Wrapper invalid";
    string internal constant ERR_NOT_ZEROX_EXCHANGE = "Zerox exchange invalid";
