...
contract SeedSale is Ownable {
    ...
    uint256 internal constant totalAllocation = 50e6 * 1e18;
    uint256 internal remainingAmount = 50e6 * 1e18;
    uint256 internal constant eachReleaseAmount = (totalAllocation * 16) / 10000;
    uint256 internal nextTimeRelease = block.timestamp + 90 days;
