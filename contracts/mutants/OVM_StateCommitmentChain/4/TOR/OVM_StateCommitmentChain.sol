...
contract OVM_StateCommitmentChain is iOVM_StateCommitmentChain, Lib_AddressResolver {
        ...
        public
    {
        ...
        require(
            iOVM_BondManager(resolve("OVM_BondManager")).isCollateralized(tx.origin),
        ...
        _appendBatch(
            _batch,
            abi.encode(block.timestamp, tx.origin)
        );
    }
    ...
    {
        require(
            tx.origin == resolve("OVM_FraudVerifier"),
