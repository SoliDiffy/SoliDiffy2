...
contract OVM_StateCommitmentChain is iOVM_StateCommitmentChain, Lib_AddressResolver {
        ...
        public
    {
        ...
        require(
            _shouldStartAtElement == super.getTotalElements(),
        ...
        require(
            super.getTotalElements() + _batch.length <= iOVM_CanonicalTransactionChain(resolve("OVM_CanonicalTransactionChain")).getTotalElements(),
        ...
        public
    {
        ...
        require(
            super.insideFraudProofWindow(_batchHeader),
        ...
        internal
    {
        ...
        Lib_OVMCodec.ChainBatchHeader memory batchHeader = Lib_OVMCodec.ChainBatchHeader({
            batchIndex: super.getTotalBatches(),
