...
contract OVM_StateCommitmentChain is iOVM_StateCommitmentChain, Lib_AddressResolver {
        ...
        )
    {
        ...
        return SafeMath.add(timestamp, FRAUD_PROOF_WINDOW) > block.number;
    }
        ...
        internal
    {
        ...
        if (msg.sender == sequencer) {
            lastSequencerTimestamp = uint40(block.number);
        } else {
            ...
            require(
                lastSequencerTimestamp + SEQUENCER_PUBLISH_WINDOW < block.number,
