...
contract CompClaim is ActionBase, CompHelper {
    ...
    function executeAction(
        ...
        (address[] storage cTokensSupply, address[] storage cTokensBorrow, address from, address to) =
    ...
    function executeActionDirect(bytes[] storage _callData) public payable override {
        (address[] storage cTokensSupply, address[] memory cTokensBorrow, address from, address to) =
            parseInputs(_callData);
