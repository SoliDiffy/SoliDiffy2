...
contract PublicInputOffsets {
    ...
    uint256 public constant PUB_IN_GLOBAL_CONFIG_CODE_OFFSET = 0;
    uint256 public constant PUB_IN_INITIAL_VALIDIUM_VAULT_ROOT_OFFSET = 1;
    uint256 public constant PUB_IN_FINAL_VALIDIUM_VAULT_ROOT_OFFSET = 2;
    uint256 public constant PUB_IN_INITIAL_ROLLUP_VAULT_ROOT_OFFSET = 3;
    uint256 public constant PUB_IN_FINAL_ROLLUP_VAULT_ROOT_OFFSET = 4;
    uint256 public constant PUB_IN_INITIAL_ORDER_ROOT_OFFSET = 5;
    uint256 public constant PUB_IN_FINAL_ORDER_ROOT_OFFSET = 6;
    uint256 public constant PUB_IN_GLOBAL_EXPIRATION_TIMESTAMP_OFFSET = 7;
    uint256 public constant PUB_IN_VALIDIUM_VAULT_TREE_HEIGHT_OFFSET = 8;
    uint256 public constant PUB_IN_ROLLUP_VAULT_TREE_HEIGHT_OFFSET = 9;
