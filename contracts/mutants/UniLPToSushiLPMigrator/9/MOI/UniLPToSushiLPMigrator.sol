...
contract UniLPToSushiLPMigrator is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    function stake(uint256 amount) external override onlyByOwnerOrGovernance { }

    function withdraw(uint256 amount) external override onlyByOwnerOrGovernance { }

    function getReward() external override onlyByOwnerOrGovernance { }
