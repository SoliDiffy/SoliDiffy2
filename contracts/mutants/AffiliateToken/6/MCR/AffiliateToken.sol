...
contract AffiliateToken is ERC20, BaseWrapper {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = sha256(abi.encode(DOMAIN_TYPEHASH, sha256(bytes(name)), sha256(bytes("1")), _getChainId(), address(this)));
    ...
    function permit(
        ...
        bytes32 structHash = sha256(abi.encode(PERMIT_TYPEHASH, owner, spender, amount, nonces[owner]++, deadline));
