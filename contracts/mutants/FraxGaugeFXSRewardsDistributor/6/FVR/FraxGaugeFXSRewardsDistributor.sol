...
contract FraxGaugeFXSRewardsDistributor is Owned, ReentrancyGuard {
    ...
    // Callable by anyone
    function distributeReward(address gauge_address) external isDistributing nonReentrant returns (uint256 weeks_elapsed, uint256 reward_tally) {
    ...
    function setGaugeState(address _gauge_address, bool _is_middleman, bool _is_active) public onlyByOwnGov {
