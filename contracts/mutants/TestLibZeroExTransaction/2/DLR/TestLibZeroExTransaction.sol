...
contract TestLibZeroExTransaction {
    ...
    function getTypedDataHash(LibZeroExTransaction.ZeroExTransaction storage transaction, bytes32 eip712ExchangeDomainHash)
        public
        pure
    ...
    function getStructHash(LibZeroExTransaction.ZeroExTransaction storage transaction)
        public
        pure
