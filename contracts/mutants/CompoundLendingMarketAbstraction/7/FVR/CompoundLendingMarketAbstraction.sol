...
library CompoundLendingMarketAbstraction
{
	 ...
	 */
	function _getUnderlyingToken(address _ctoken) public view returns (address _token)
	{
	 ...
	 */
	function _getCollateralRatio(address _ctoken) public view returns (uint256 _collateralRatio)
	{
	 ...
	 *                       market liquidity.
	 */
	function _getMarketAmount(address _ctoken) public view returns (uint256 _marketAmount)
	{
	 ...
	 */
	function _getLiquidityAmount(address _ctoken) public view returns (uint256 _liquidityAmount)
	{
		address _comptroller = $.Compound_COMPTROLLER;
	 ...
	 *                          underlying reserve token.
	 */
	function _getAvailableAmount(address _ctoken, uint256 _marginAmount) public view returns (uint256 _availableAmount)
	{
	 ...
	 *                       underlying reserve token.
	 */
	function _getExchangeRate(address _ctoken) public view returns (uint256 _exchangeRate)
	{
	 ...
	 *                       underlying reserve token.
	 */
	function _fetchExchangeRate(address _ctoken) public returns (uint256 _exchangeRate)
	{
