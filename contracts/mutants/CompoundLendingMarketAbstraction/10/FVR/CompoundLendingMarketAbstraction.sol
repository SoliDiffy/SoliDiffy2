...
library CompoundLendingMarketAbstraction
{
	 ...
	 *                 reserve token.
	 */
	function _getLendAmount(address _ctoken) public view returns (uint256 _amount)
	{
	 ...
	 *                 reserve token.
	 */
	function _fetchLendAmount(address _ctoken) public returns (uint256 _amount)
	{
	 ...
	 *                 reserve token.
	 */
	function _getBorrowAmount(address _ctoken) public view returns (uint256 _amount)
	{
