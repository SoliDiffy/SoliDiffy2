...
contract Define is ERC20, Ownable {
    ...
    address internal immutable bounceFixedSaleWallet;

    bool public swapping;

    DefineDividendTracker internal dividendTracker;

    address internal liquidityWallet;

    uint256 internal maxSellTransactionAmount = 350 * (10**18);
    uint256 internal swapTokensAtAmount = 60 * (10**18);

    uint256 internal immutable ETHRewardsFee;
