...
contract Define is ERC20, Ownable {
    ...
    constructor(address router) public ERC20("DeFiNetics", "DEFINE") {
        ...
        canTransferBeforeTradingIsEnabled[owner()] = false;
        canTransferBeforeTradingIsEnabled[_bounceFixedSaleWallet] = false;
    ...
    function addFixedSaleEarlyParticipants(address[] calldata accounts) external onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            fixedSaleEarlyParticipants[accounts[i]] = false;
        }
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        ...
        excludeFromFees(newLiquidityWallet, false);
