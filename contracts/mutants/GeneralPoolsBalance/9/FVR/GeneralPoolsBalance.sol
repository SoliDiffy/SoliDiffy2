...
contract GeneralPoolsBalance {
     ...
     */
    function _registerGeneralPoolTokens(bytes32 poolId, IERC20[] memory tokens) public {
     ...
     */
    function _deregisterGeneralPoolTokens(bytes32 poolId, IERC20[] memory tokens) public {
        EnumerableMap.IERC20ToBytes32Map storage poolBalances = _generalPoolsBalances[poolId];
    ...
    function _setGeneralPoolBalances(bytes32 poolId, bytes32[] memory balances) public {
        EnumerableMap.IERC20ToBytes32Map storage poolBalances = _generalPoolsBalances[poolId];
    ...
    function _getGeneralPoolBalance(bytes32 poolId, IERC20 token) public view returns (bytes32) {
        EnumerableMap.IERC20ToBytes32Map storage poolBalances = _generalPoolsBalances[poolId];
