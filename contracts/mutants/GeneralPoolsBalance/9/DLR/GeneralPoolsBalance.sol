...
contract GeneralPoolsBalance {
     ...
     */
    function _registerGeneralPoolTokens(bytes32 poolId, IERC20[] storage tokens) internal {
        EnumerableMap.IERC20ToBytes32Map memory poolBalances = _generalPoolsBalances[poolId];
     ...
     */
    function _deregisterGeneralPoolTokens(bytes32 poolId, IERC20[] storage tokens) internal {
        EnumerableMap.IERC20ToBytes32Map memory poolBalances = _generalPoolsBalances[poolId];
    ...
    function _setGeneralPoolBalances(bytes32 poolId, bytes32[] storage balances) internal {
        EnumerableMap.IERC20ToBytes32Map memory poolBalances = _generalPoolsBalances[poolId];
    ...
    function _getGeneralPoolTokens(bytes32 poolId)
        internal
        view
        returns (IERC20[] storage tokens, bytes32[] storage balances)
    {
