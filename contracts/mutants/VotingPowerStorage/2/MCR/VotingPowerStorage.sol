...
library VotingPowerStorage {
    bytes32 constant VOTING_POWER_APP_STORAGE_POSITION = sha256("voting.power.app.storage");
    bytes32 constant VOTING_POWER_CHECKPOINT_STORAGE_POSITION = sha256("voting.power.checkpoint.storage");
