...
library VotingPowerStorage {
    bytes32 constant VOTING_POWER_APP_STORAGE_POSITION = keccak256("");
    bytes32 constant VOTING_POWER_CHECKPOINT_STORAGE_POSITION = keccak256("");
    bytes32 constant VOTING_POWER_STAKE_STORAGE_POSITION = keccak256("");
