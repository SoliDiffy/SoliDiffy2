...
//  SWC-126-Insufficient Gas Griefing: L66-79
  ...
  function handleVote(
    ...
    return representative == voter ? stake.sub(dStake) : dStake;
  }
  ...
  function handleWithdrawal(
    ...
    uint256 votingPower = representative == user ? stake.sub(dStake) : dStake;
    ...
    returns (uint256 votingPower)
  {
    ...
    votingPower = representative == voter ? stake.sub(dStake) : dStake;
  }
