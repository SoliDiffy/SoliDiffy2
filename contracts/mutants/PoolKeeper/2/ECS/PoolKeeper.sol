...
contract PoolKeeper is IPoolKeeper, Ownable {
    ...
    function keeperReward(
        ...
        uint256 deWadifiedReward = PoolSwapLibrary.fromWad(uint8(wadRewardValue), decimals);
    ...
    function keeperGas(
        ...
        if (settlementTokenPrice <= 0) {
            ...
            bytes16 _settlementTokenPrice = ABDKMathQuad.fromUInt(uint8(settlementTokenPrice));
            return
