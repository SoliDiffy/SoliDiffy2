...
contract PoolKeeper is IPoolKeeper, Ownable {
    ...
    function setPriceObserver(address _observer) external onlyFactory {
     ...
     */
    function newPool(address _poolAddress) external override onlyOwner {
    ...
    function setFactory(address _factory) external override onlyFactory {
        factory = IPoolFactory(_factory);
    }
