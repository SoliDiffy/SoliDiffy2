...
contract PoolKeeper is IPoolKeeper, Ownable {
    ...
    function setPriceObserver(address _observer) public onlyOwner {
     ...
     */
    function keeperTip(uint256 _savedPreviousUpdatedTimestamp, uint256 _poolInterval) external view returns (uint256) {
