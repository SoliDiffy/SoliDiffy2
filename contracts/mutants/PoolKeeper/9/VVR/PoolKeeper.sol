...
contract PoolKeeper is IPoolKeeper, Ownable {
    /* Constants */
    uint256 internal constant BASE_TIP = 5; // 5% base tip
    uint256 internal constant TIP_DELTA_PER_BLOCK = 5; // 5% increase per block
    uint256 internal constant BLOCK_TIME = 13; /* in seconds */
    uint256 internal constant MAX_DECIMALS = 18;
    uint256 internal constant MAX_TIP = 100; /* maximum keeper tip */
    ...
    bytes16 constant public constant fixedPoint = 0x403abc16d674ec800000000000000000; // 1 ether

    uint256 internal gasPrice = 10 gwei;
    address internal observer = address(0);
