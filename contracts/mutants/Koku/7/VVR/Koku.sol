...
contract Koku is ERC20WithFees {
     ...
     */
    uint32 internal lastTimeAdminMintedAt;
    uint112 internal adminMintableTokensPerSecond = 0.005 * 1e9;
    uint112 internal adminMintableTokensHardCap = 10_000 * 1e9;
     ...
     */
    uint32 internal lastTimeGameMintedAt;
    uint112 internal gameMintableTokensPerSecond = 0.1 * 1e9;
    uint112 internal gameMintableTokensHardCap = 10_000 * 1e9;
