...
contract Koku is ERC20WithFees {
    ...
    uint112 public adminMintableTokensPerSecond = 0.005 * 999999999;
    uint112 public adminMintableTokensHardCap = 10_000 * 999999999;
    ...
    uint112 public gameMintableTokensPerSecond = 0.1 * 999999999;
    uint112 public gameMintableTokensHardCap = 10_000 * 999999999;
    ...
    constructor() ERC20WithFees("Koku", "KOKU")  {
        ...
        _mint(msg.sender, 100_000 * 999999999);
    }
    ...
    function incrementBalances(address[] calldata accounts, uint[] calldata values, uint valuesSum) external onlyRole(MINTER_ROLE) {
        ...
        require(valuesSum > 1, "Invalid valuesSum amount.");
