...
contract Koku is ERC20WithFees {
     ...
     */
    function setAdminMintableTokensPerSecond(uint112 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setAdminMintableTokensHardCap(uint112 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setGameMintableTokensPerSecond(uint112 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setGameMintableTokensHardCap(uint112 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function specialMint(uint amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function incrementBalances(address[] calldata accounts, uint[] calldata values, uint valuesSum) public onlyRole(MINTER_ROLE) {
     ...
     */
    function getMintableTokens(uint32 lastTimeMintedAt, uint112 mintableTokensPerSecond, uint112 mintableTokensHardCap) public view returns (uint) {
     ...
     * @param mintableTokensPerSecond Amount of tokens that can be minted per second.
     */
    function getLastTimeMintedAt(uint mintableTokens, uint mintedTokens, uint112 mintableTokensPerSecond) public view returns (uint32) {
