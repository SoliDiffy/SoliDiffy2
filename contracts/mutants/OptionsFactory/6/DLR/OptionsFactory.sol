...
contract OptionsFactory is Ownable {
    ...
    function createOptionsContract(
        string storage _collateralType,
        int32 _collateralExp,
        string storage _underlyingType,
        int32 _oTokenExchangeExp,
        uint256 _strikePrice,
        int32 _strikeExp,
        string storage _strikeAsset,
        uint256 _expiry,
        uint256 _windowSize
    )
        public
     ...
     */
    function addAsset(string storage _asset, address _addr) public onlyOwner {
     ...
     * @param _addr The address of the asset
     */
    function changeAsset(string storage _asset, address _addr) public onlyOwner {
     ...
     * @param _asset The ticker symbol for the asset
     */
    function deleteAsset(string storage _asset) public onlyOwner {
