...
contract FraxCrossChainLiquidityTracker is Owned {
    ...
    // --------------------- FXS ---------------------
    function noteFxsMint(uint256 chain_id, uint256 fxs_amount) public validChain(chain_id) onlyByOwnGov {
        fxs_minted[chain_id] += fxs_amount;
    }

    function noteFxsRetirement(uint256 chain_id, uint256 fxs_amount) public validChain(chain_id) onlyByOwnGov {
