...
contract MasterChef {
    ...
    function add(uint256 _allocPoint, ERC20 _lpToken) external {
    ...
    function safeSushiTransfer(address _to, uint256 _amount) public {
    ...
    function harnessSetUserAmount(uint256 _pid, address _user, uint256 _amount) external {
