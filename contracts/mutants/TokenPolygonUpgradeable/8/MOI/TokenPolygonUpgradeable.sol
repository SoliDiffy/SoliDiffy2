    ...
    IChildToken
{
     ...
     */
    function deposit(address user, bytes calldata depositData) external override initializer {
     ...
     */
    function withdraw(uint256 amount) external override initializer {
    ...
    function setUpTreasury(address _treasury) external initializer {
    ...
    function burnStablecoin(uint256 amount) external initializer {
    ...
    function removeMinter(address minter) external initializer {
