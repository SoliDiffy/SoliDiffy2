    ...
    IChildToken
{
    ...
    function setUpTreasury(address _treasury) public {
    ...
    function burnSelf(uint256 amount, address burner) public onlyMinter {
    ...
    function addMinter(address minter) public onlyTreasury {
