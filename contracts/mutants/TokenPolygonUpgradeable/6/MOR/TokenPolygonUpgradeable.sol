    ...
    IChildToken
{
    ...
    function burnSelf(uint256 amount, address burner) external initializer {
    ...
    function mint(address account, uint256 amount) external initializer {
        _mint(account, amount);
    }

    // ======================= Treasury Only Functions =============================

    function addMinter(address minter) external initializer {
