...
contract LGEWhitelisted is Context {
    ...
    function transferWhitelister(address newWhitelister) external  {
    ...
    function createLGEWhitelist(address pairAddress, uint256[] calldata durations, uint256[] calldata amountsMax) external  {
    ...
    function modifyLGEWhitelist(uint256 index, uint256 duration, uint256 amountMax, address[] calldata addresses, bool enabled) external  {
