...
contract LGEWhitelisted is Context {
    ...
    function _transferWhitelister(address newWhitelister) internal onlyWhitelister {
    ...
    function _applyLGEWhitelist(address sender, address recipient, uint256 amount) internal onlyWhitelister {
