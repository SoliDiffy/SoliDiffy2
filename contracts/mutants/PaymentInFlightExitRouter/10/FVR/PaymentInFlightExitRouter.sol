...
contract PaymentInFlightExitRouter is IExitProcessor, OnlyFromAddress, OnlyWithValue, FailFastReentrancyGuard {
     ...
     */
    function inFlightExits(uint160 exitId) external view returns (PaymentExitDataModel.InFlightExit memory) {
     ...
     */
    function processInFlightExit(uint160 exitId, address token) public {
