...
contract GFT is DSToken("GFT", "Game Fantasy Token"), IERC223, ISmartToken {
    ...
    */
    ...
    function issue(address to_, uint256 amount_) public stoppable auth {
        mint(to_, amount_);
    }
    ...
    function mint(address guy_, uint256 wad_) public stoppable auth {
    ...
    function burn(address guy_, uint256 wad_) public stoppable auth {
