...
contract CrazyToken is ERC20PresetMinterPauser, Ownable {
     ...
     */
    function transferToVesting(address _vestingAddress) public onlyOwner
    {
     ...
     * to send (40% of total supply).
     */
    function transferToMining(address _miningAddress) public onlyOwner
    {
     ...
     */
    function transferToVaultInGameReward(address _inGameRewardAddress) public onlyOwner {
     ...
     */
    function transferToEcosystemGrowth(address _ecosystemGrowthAddress) public onlyOwner {
     ...
     * to send (5% of total supply).
     */
    function transferToMarketing(address _marketingAddress) public onlyOwner {
