...
contract TokenFaucet is OwnableUpgradeable, TokenListener {
    ...
    function claim(address user) external initializer returns (uint256) {
        drip();
    ...
    function drip() public initializer returns (uint256) {
    ...
    function _captureNewTokensForUser(address user) private initializer returns (uint128) {
