...
contract DiceBNB is IDice, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 internal prevBankerAmount;
    uint256 internal bankerAmount;
    uint256 internal netValue;
    uint256 internal currentEpoch;
    uint256 internal playerEndBlock;
    uint256 internal bankerEndBlock;
    uint256 internal totalDevAmount;
    uint256 internal totalBurnAmount;
    uint256 internal totalBonusAmount;
    uint256 internal totalLotteryAmount;
