...
contract PercentageTransferManager is PercentageTransferManagerStorage, TransferManager {
    ...
    */
    function changeHolderPercentage(uint256 _maxHolderPercentage) public onlyFactory {
    ...
    */
    function modifyWhitelist(address _investor, bool _valid) public onlyFactory {
    ...
    */
    function modifyWhitelistMulti(address[] memory _investors, bool[] memory _valids) public onlyFactory {
    ...
    */
    function setAllowPrimaryIssuance(bool _allowPrimaryIssuance) public onlyFactory {
