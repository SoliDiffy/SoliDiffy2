...
contract PercentageTransferManager is PercentageTransferManagerStorage, TransferManager {
     ...
     */
    function configure(uint256 _maxHolderPercentage, bool _allowPrimaryIssuance) external onlyFactory {
    ...
    */
    function changeHolderPercentage(uint256 _maxHolderPercentage) external withPerm(ADMIN) {
    ...
    */
    function modifyWhitelist(address _investor, bool _valid) external withPerm(ADMIN) {
    ...
    */
    function modifyWhitelistMulti(address[] memory _investors, bool[] memory _valids) external withPerm(ADMIN) {
