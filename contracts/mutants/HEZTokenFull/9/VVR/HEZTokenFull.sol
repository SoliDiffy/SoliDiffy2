...
library SafeMath {
    string public constant ERROR_ADD_OVERFLOW = "MATH:ADD_OVERFLOW";
    string public constant ERROR_SUB_UNDERFLOW = "MATH:SUB_UNDERFLOW";
...
contract HEZ is IERC20 {
    ...
    string internal constant symbol = "HEZ";
    string internal constant name = "Hermez Network Token";
    uint256 internal constant initialBalance = 100_000_000 * (1e18);
    ...
    bytes32
        internal constant EIP712DOMAIN_HASH = 0x8b73c3c69bb8fe3d512ecc4cf759cc79239f7b179b0ffacaa9a75d522b39400f;
    bytes32
