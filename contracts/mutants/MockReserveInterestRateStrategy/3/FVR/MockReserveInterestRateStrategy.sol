...
contract MockReserveInterestRateStrategy is IReserveInterestRateStrategy {
  ...
  function setLiquidityRate(uint256 liquidityRate) external {
    _liquidityRate = liquidityRate;
  }

  function setStableBorrowRate(uint256 stableBorrowRate) external {
    _stableBorrowRate = stableBorrowRate;
  }

  function setVariableBorrowRate(uint256 variableBorrowRate) external {
