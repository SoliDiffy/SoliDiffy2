...
contract MockReserveInterestRateStrategy is IReserveInterestRateStrategy {
  ...
  function getVariableRateSlope2() public view returns (uint256) {
    return _variableRateSlope2;
  }

  function getStableRateSlope1() public view returns (uint256) {
    return _stableRateSlope1;
  }

  function getStableRateSlope2() public view returns (uint256) {
