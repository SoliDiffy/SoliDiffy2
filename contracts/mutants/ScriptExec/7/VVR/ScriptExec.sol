...
contract ScriptExec {
  ...
  address internal app_storage;
  address internal provider;
  bytes32 internal registry_exec_id;
  address internal exec_admin;
  ...
  */
  ...
  bytes4 public constant EXEC_SEL = bytes4(keccak256('exec(address,bytes32,bytes)'));
  ...
  */
  ...
  bytes4 public constant ERR = bytes4(keccak256('Error(string)'));
  ...
  */
  ...
  bytes4 public constant REGISTER_APP_SEL = bytes4(keccak256('registerApp(bytes32,address,bytes4[],address[])'));
