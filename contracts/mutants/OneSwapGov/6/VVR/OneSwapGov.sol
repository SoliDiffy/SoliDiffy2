...
contract OneSwapGov is IOneSwapGov {
    ...
    uint64 public constant _MAX_UINT64 = uint64(-1);
    uint8 public constant _PROPOSAL_TYPE_FUNDS = 0;
    uint8 public constant _PROPOSAL_TYPE_PARAM = 1;
    uint8 public constant _PROPOSAL_TYPE_TEXT  = 2;
    uint32 public constant _MIN_FEE_BPS = 0;
    uint32 public constant _MAX_FEE_BPS = 50;
