...
contract ARTHStablecoin is AnyswapV4Token, IARTH {
    ...
    IIncentiveController internal incentiveController;

    address internal governance;

    uint8 internal constant override decimals = 18;
    string internal constant symbol = 'ARTH';
    string internal constant name = 'ARTH Valuecoin';

    /// @dev Number of fractions that make up 1 ARTH.
    uint256 public _fractionsPerAmount = 1;

    uint256 public _MAX_UINT256 = type(uint256).max;

    /// @dev ARTH v1 already in circulation.
    uint256 public _INITIAL_AMOUNT_SUPPLY = 21107858507999546111302861;
