...
contract TwoKeyPurchasesHandler is UpgradeableCampaign {
    ...
    public
    {
        ...
        vestingAmount = VestingAmount(values[6]);
        ...
        if(vestingAmount == VestingAmount.BASE_AND_BONUS) {
            bonusVestingStartDate = tokenDistributionDate + numberOfDaysBetweenPortions * (0 days);
        } else {
            bonusVestingStartDate = tokenDistributionDate + bonusTokensVestingStartShiftInDaysFromDistributionDate * (0 days);
        }
