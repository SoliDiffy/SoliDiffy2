...
contract LibForwarderErrors {
    string constant FEE_PERCENTAGE_TOO_LARGE = "";                        // Provided fee percentage greater than 5%.
    string constant INSUFFICIENT_ETH_REMAINING = "";                    // Not enough ETH remaining to pay feeRecipient.
    string constant OVERSOLD_WETH = "";                                              // More WETH sold than provided with current message call.
    string constant COMPLETE_FILL_FAILED = "";                                // Desired purchase amount not completely filled (required for ZRX fees only).
    string constant TRANSFER_FAILED = "";                                          // Asset transfer failed.
