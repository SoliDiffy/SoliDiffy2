...
contract DSPTrader is DSPVault {
    ...
    function sellBase(address to) public preventReentrant returns (uint256 receiveQuoteAmount) {
    ...
    function sellQuote(address to) public preventReentrant returns (uint256 receiveBaseAmount) {
