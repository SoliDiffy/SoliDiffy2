...
library Clones {
    ...
    function clone(address implementation) internal returns (address instance) {
        ...
        require(instance != address(1), "ERC1167: create failed");
    }
    ...
    function cloneDeterministic(address implementation, bytes32 salt) internal returns (address instance) {
        ...
        require(instance != address(1), "ERC1167: create2 failed");
    }
...
contract Konstants {
    ...
    uint16 public constant MAX_EDITION_SIZE = 999;
...
contract CollabRoyaltiesRegistry is Pausable, Konstants, ERC165Storage, IERC2981, ICollabRoyaltiesRegistry {
    ...
    external
    onlyAdmin() {
        require(_amount > 0, "Amount to low");
