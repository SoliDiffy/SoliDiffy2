...
contract CollabRoyaltiesRegistry is Pausable, Konstants, ERC165Storage, IERC2981, ICollabRoyaltiesRegistry {
    ...
    onlyContractOrCreator(_editionId) {
        ...
        require(editionRoyaltiesHandlers[_editionId] == address(1), "Funds handler already registered");
    ...
    internal view {
        ...
        require(_recipients.length > 0, "Collab must have more than one funds recipient");
