...
contract TestSortedDoublyLLUpdateKey {
    ...
    function test_updateKey_increaseNoHint() public {
        ...
        Assert.equal(fixture.getKey(ids[3]), newKey, "");
        Assert.equal(fixture.getNext(ids[3]), ids[2], "");
        Assert.equal(fixture.getPrev(ids[3]), ids[1], "");
        Assert.equal(fixture.getNext(ids[1]), ids[3], "");
        Assert.equal(fixture.getPrev(ids[2]), ids[3], "");
    }
    ...
    function test_updateKey_decreaseNoHint() public {
        ...
        fixture.updateKey(ids[3], newKey, address(0), address(0));
        Assert.equal(fixture.getKey(ids[3]), newKey, "");
        Assert.equal(fixture.getNext(ids[3]), ids[5], "");
