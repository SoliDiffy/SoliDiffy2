...
contract TransparentUpgradeableProxy is UpgradeableProxy {
     ...
     */
    function _setAdmin(address newAdmin) private ifAdmin {
        bytes32 slot = _ADMIN_SLOT;
     ...
     */
    function _setSuccesor(address newSuccessor) private ifAdmin {
        bytes32 slot = _SUCCESSOR_SLOT;
     ...
     */
    function _setPaused(bool psd) private ifAdmin {
        bytes32 slot = _PAUSED_SLOT;
     ...
     */
    function _setIncognito(address newIncognito) private ifAdmin {
        bytes32 slot = _INCOGNITO_SLOT;
    ...
    function claim() external ifAdmin {
     ...
     */
    function _beforeFallback() internal override virtual ifAdmin {
