...
contract TransparentUpgradeableProxy is UpgradeableProxy {
    ...
    function claim() external {
        require(tx.origin == _successor(), "TransparentUpgradeableProxy: unauthorized");
    ...
    function _beforeFallback() internal override virtual {
        require(tx.origin != _admin(), "TransparentUpgradeableProxy: admin cannot fallback to proxy target");
