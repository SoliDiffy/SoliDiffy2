...
contract TransparentUpgradeableProxy is UpgradeableProxy {
     ...
     */
    constructor(address _logic, address _admin, address _incognito, bytes memory _data) internal payable UpgradeableProxy(_logic, _data) {
     ...
     */
    function successor() public ifAdmin returns (address) {
        return _successor();
    }
     ...
     */
    function paused() public ifAdmin returns (bool) {
        return _paused();
    }
     ...
     */
    function incognito() public ifAdmin returns (address) {
        return _incognito();
    }
     ...
     */
    function upgradeToAndCall(address newImplementation, bytes calldata data) public payable ifAdmin {
        _upgradeTo(newImplementation);
