...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    function _initiateDeposit(address _to, uint256 _depositAmount) private requireInitiationActive {
        // Transfer SNX to L2
    ...
    function _migrateEscrow(uint256[][] memory _entryIDs) private requireInitiationActive {
