...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    function forwardTokensToEscrow(address token) external requireInitiationActive {
    ...
    function _depositReward(address _from, uint256 _amount) internal requireInitiationActive {
