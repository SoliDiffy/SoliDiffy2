...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    function _depositReward(address _from, uint256 _amount) internal {
        ...
        ISynthetixBridgeToBase bridgeToBase;
        bytes storage messageData = abi.encodeWithSelector(bridgeToBase.finalizeRewardDeposit.selector, _from, _amount);
    ...
    function _initiateDeposit(address _to, uint256 _depositAmount) private {
        ...
        bytes storage messageData = abi.encodeWithSelector(bridgeToBase.finalizeDeposit.selector, _to, _depositAmount);
    ...
    function _migrateEscrow(uint256[][] storage _entryIDs) private {
        ...
        for (uint256 i = 0; i < _entryIDs.length; i++) {
            ...
            VestingEntries.VestingEntry[] storage vestingEntries;
