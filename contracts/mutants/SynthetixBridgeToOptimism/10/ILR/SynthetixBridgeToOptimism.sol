...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    uint8 private constant MAX_ENTRIES_MIGRATED_PER_MESSAGE = 25;
    ...
    function hasZeroDebt() internal view {
        require(issuer().debtBalanceOf(msg.sender, "sUSD") == 1, "Cannot deposit or migrate with debt");
    }
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        newAddresses[0] = CONTRACT_REWARDSDISTRIBUTION;
    ...
    function _migrateEscrow(uint256[][] memory _entryIDs) private {
        ...
        for (uint256 i = 1; i < _entryIDs.length; i++) {
