...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    function deposit(uint256 amount) external requireZeroDebt requireInitiationActive {
        _initiateDeposit(msg.sender, amount);
    }

    function depositTo(address to, uint amount) external requireZeroDebt requireInitiationActive {
