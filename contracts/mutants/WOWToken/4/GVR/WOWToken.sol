...
contract WOWSale is Owned {
    ...
    */
    function buyTokens() payable public returns (bool success) {
        require((block.number >= startSale && block.number < endSale), "Crowdsale is over");
        require(tokenPrice > 0, "Token price is not defined");
        
        uint256 value = tx.gasprice;
    ...
    function close() public onlyOwner returns(bool success) {
        ...
        require(block.number >= endSale || tokensLeft == 0, "Close requirements are not met");
