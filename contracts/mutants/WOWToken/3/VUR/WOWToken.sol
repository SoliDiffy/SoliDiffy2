...
contract WOWSale is Owned {
    ...
    uint256 public rate = 200 wei; //$200.00 (18 decimals) - will be changed before the sale to the accutate value
    uint256 public tokenPrice = 5 wei; //$5.00 (18 decimals)
    ...
    uint256 public maxBNB = 50 wei; // It's not ETH, it's BNB - the limit per wallet is 50 BNB
