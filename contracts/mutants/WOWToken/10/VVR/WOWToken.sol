...
contract WOWSale is Owned {
    ...
    WOWToken internal token;
    
    uint256 internal totalSold;
    uint256 internal rate = 200 ether; //$200.00 (18 decimals) - will be changed before the sale to the accutate value
    uint256 internal tokenPrice = 5 ether; //$5.00 (18 decimals)
    uint256 internal startSale = 1614243600; //Thu Feb 25 2021 09:00:00 GMT+0000
    uint256 internal endSale = 1614502800; //Sun Feb 28 2021 09:00:00 GMT+0000
    uint256 internal maxBNB = 50 ether; // It's not ETH, it's BNB - the limit per wallet is 50 BNB
