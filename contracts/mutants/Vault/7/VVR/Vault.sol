...
contract Vault is Ownable {
    ...
    TokenSubInterface internal lockedToken;
	TokenSubInterface internal timeToken;
	SealedToken internal sealedToken;
	SealedController internal sealedController;
	TimeController internal timeController;

	uint256 internal startBlock;
	uint256 internal endLockBlock;
