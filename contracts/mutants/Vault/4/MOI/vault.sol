...
contract Vault {
     ...
     */
     function verifySignData(bytes memory data, bytes memory signData) internal nonReentrant returns(address){
    ...
    /**
      ...
      */
    function migrateBalance(address owner, address token) internal nonReentrant {
