...
contract Vault {
     ...
     */
    function initialize(address _prevVault) public {
     ...
     */
    function _incognito() public view returns (address icg) {
     ...
     */
    function deposit(string calldata incognitoAddress) public payable nonReentrant {
     ...
     */
    function depositERC20(address token, uint amount, string calldata incognitoAddress) public payable nonReentrant {
     ...
     */
    function isWithdrawed(bytes32 hash) external view returns(bool) {
        if (withdrawed[hash]) {
            return true;
