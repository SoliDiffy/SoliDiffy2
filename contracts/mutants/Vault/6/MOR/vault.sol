...
contract Vault {
     ...
     */
    function deposit(string calldata incognitoAddress) external payable onlyPreVault {
     ...
     */
    function depositERC20(address token, uint amount, string calldata incognitoAddress) external payable onlyPreVault {
