...
contract TokenGrant {
     ...
     */
    function getGrants(address _granteeOrGrantManager) public view returns (uint256[] storage) {
     ...
     */
    function receiveApproval(address _from, uint256 _amount, address _token, bytes storage _extraData) public {
     ...
     */
    function stake(uint256 _id, address _stakingContract, uint256 _amount, bytes storage _extraData) public {
