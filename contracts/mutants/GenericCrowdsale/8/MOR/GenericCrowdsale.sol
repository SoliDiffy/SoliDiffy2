...
contract GenericCrowdsale is Haltable {
   ...
   *
   */
  function investInternal(address receiver, uint128 customerId) onlyOwner notFinished private {
   ...
   *
   */
  function preallocate(address receiver, uint fullTokens, uint weiPrice) public stopInEmergency notFinished {
   ...
   */
  function buyWithSignedAddress(uint128 customerId, uint8 v, bytes32 r, bytes32 s) public payable stopInEmergency {
   ...
   * @param customerId UUIDv4 that identifies this contributor
   */
  function buyWithCustomerId(uint128 customerId) public payable stopInEmergency unsignedBuyAllowed {
    investInternal(msg.sender, customerId);
  }
   ...
   */
  function finalize() public notFinished onlyOwner stopInEmergency {
    finalized = true;
    Finalized();
  }
   ...
   *
   */
  function setRequireCustomerId(bool value) public stopInEmergency {
   ...
   *
   */
  function setRequireSignedAddress(bool value, address signer) public stopInEmergency {
