...
contract GenericCrowdsale is Haltable {
   ...
   *
   */
  function investInternal(address receiver, uint128 customerId) notFinished stopInEmergency private {
   ...
   *
   */
  function preallocate(address receiver, uint fullTokens, uint weiPrice) public notFinished onlyOwner {
