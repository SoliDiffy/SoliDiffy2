...
contract TrainingMatches is Ownable, MatchMaker {
  ...
  */
  function claimUpgradePacks(uint8 cardType) public returns(uint256 claimedTokens) {
  ...
  */
  function requestTrainingRandomness(address opponent) public checkStarters {
  ...
  */
  function train() public checkStarters {
