...
contract TrainingMatches is Ownable, MatchMaker {
  ...
  function setDropRate(uint256 newDropRate) external checkStarters {
  ...
  */
  function requestTrainingRandomness(address opponent) external onlyOwner {
  ...
  */
  function train() external onlyOwner {
