    ...
    FailFastReentrancyGuard
{
     ...
     */
    function standardExits(uint160 exitId) external view returns (PaymentExitDataModel.StandardExit memory) {
     ...
     */
    function startStandardExitBondSize() external view returns (uint128) {
     ...
     */
    function updateStartStandardExitBondSize(uint128 newBondSize) external onlyFrom(framework.getMaintainer()) {
