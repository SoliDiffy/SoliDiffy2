...
contract Unipool is LPTokenWrapper, Ownable, CheckContract, IUnipool {
    ...
    function _notifyRewardAmount(uint256 _reward, uint256 _duration) public {
        assert(_reward > 0);
    ...
    function _updatePeriodFinish() public {
        if (totalSupply() == 0) {
            assert(periodFinish > 0);
            /*
    ...
    function _requireCallerIsLQTYToken() public view {
