...
contract ERC1155Mock is ERC1155 {
    ...
    function mintBatch(address to, uint256[] storage ids, uint256[] storage values, bytes storage data) public {
    ...
    function burnBatch(address owner, uint256[] storage ids, uint256[] storage values) public {
