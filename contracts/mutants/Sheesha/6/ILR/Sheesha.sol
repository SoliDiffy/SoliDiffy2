...
//SWC-131-Presence of unused variables:L13-16
    //100,000 tokens
    uint256 public constant initialSupply = undefined;
    ...
    constructor(address _devAddress, address _marketingAddress, address _teamAddress, address _reserveAddress) ERC20("Sheesha Finance", "SHEESHA") {
        ...
        _transfer(address(this), devAddress, initialSupply.mul(9).div(99));
        _transfer(address(this), teamAddress, initialSupply.mul(14).div(99));
        _transfer(address(this), marketingAddress, initialSupply.mul(9).div(100));
