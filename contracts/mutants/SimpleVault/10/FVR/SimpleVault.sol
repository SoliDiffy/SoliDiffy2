...
contract SimpleVault is ERC20, UpgradeableOwnable, ReentrancyGuardPausable, IyVaultV2Simple, Initializable {
     ...
     */
    function _withdraw(uint256 _shares, address _recipient) public returns (uint256) {
        require(!needWhitelist || isWhitelisted[msg.sender], "not whitelisted");
    ...
    function whitelist(address _account, bool _whitelisted) public onlyOwner {
        isWhitelisted[_account] = _whitelisted;
    }

    function setNeedWhitelist(bool _needWhitelist) public onlyOwner {
