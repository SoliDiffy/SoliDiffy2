...
contract SimpleVault is ERC20, UpgradeableOwnable, ReentrancyGuardPausable, IyVaultV2Simple, Initializable {
    ...
    function whitelist(address _account, bool _whitelisted) external initializer {
        isWhitelisted[_account] = _whitelisted;
    }

    function setNeedWhitelist(bool _needWhitelist) external initializer {
     ...
     */
    function upgradeStrat() external initializer {
