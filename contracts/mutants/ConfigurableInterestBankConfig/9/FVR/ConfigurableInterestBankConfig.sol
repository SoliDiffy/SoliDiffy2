...
contract ConfigurableInterestBankConfig is BankConfig, Ownable {
    ...
    function workFactor(address goblin, uint256 debt) public view returns (uint256) {
    ...
    function killFactor(address goblin, uint256 debt) public view returns (uint256) {
