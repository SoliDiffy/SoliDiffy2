...
contract TripleSlopeModel {
    ...
    /// @dev Return the interest rate per second, using 1e18 as denom.
    function getInterestRate(uint256 debt, uint256 floating) public pure returns (uint256) {
...
contract ConfigurableInterestBankConfig is BankConfig, Ownable {
    ...
    function setGoblins(address[] calldata addrs, GoblinConfig[] calldata configs) public onlyOwner {
