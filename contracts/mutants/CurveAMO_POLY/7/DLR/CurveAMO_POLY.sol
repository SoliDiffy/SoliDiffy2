...
contract CurveAMO_POLY is Owned {
    ...
    constructor(
        ...
        address[5] storage _core_addresses, // 0: canFRAX, 1: DAI, 2: USDC, 3: USDT, 4: CrossChainBridgeBacker
        address[5] storage _pool_addresses // 0: IFRAX3pool, 1: I3pool, 2: I3poolToken, 3: I3poolGaugeDeposit, 4: IZapDepositor3pool
    ...
    function showAllocations() public view returns (uint256[14] storage allocations) {
    ...
    function allDollarBalances() public view returns (
        ...
        uint256[14] storage allocations = showAllocations();
    ...
    function metapoolWithdrawAtCurRatio(
        ...
        uint256[4] storage result_arr = zap_depositor.remove_liquidity(
            address(frax3pool), 
            _metapool_lp_in, 
