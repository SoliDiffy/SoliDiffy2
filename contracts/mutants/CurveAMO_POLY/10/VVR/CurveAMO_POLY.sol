...
contract CurveAMO_POLY is Owned {
    ...
    ERC20 internal USDC; // USDC: 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174
    ERC20 internal USDT; // USDT: 0xc2132D05D31c914a87C6611C10748AEb04B58e8F
    CrossChainBridgeBacker_POLY_MaticBridge internal cc_bridge_backer;

    // Pools
    IFRAX3pool internal frax3pool; // 0x5e5A23b52Cb48F5E70271Be83079cA5bC9c9e9ac
    I3pool internal am3crv_pool; // 0x445FE580eF8d70FF569aB36e80c647af338db351
    I3poolToken internal am3crv_token; // 0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171
    I3poolGaugeDeposit internal am3crv_gauge; // 0x19793B454D3AfC7b454F206Ffe95aDE26cA6912c
    IZapDepositor3pool internal zap_depositor; // 0x5ab5C56B9db92Ba45a0B46a207286cD83C15C939
