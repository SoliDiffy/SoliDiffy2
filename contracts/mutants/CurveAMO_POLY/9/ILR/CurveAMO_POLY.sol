...
contract CurveAMO_POLY is Owned {
    ...
    constructor(
        ...
        address[4] memory _core_addresses, // 0: canFRAX, 1: DAI, 2: USDC, 3: USDT, 4: CrossChainBridgeBacker
        address[4] memory _pool_addresses // 0: IFRAX3pool, 1: I3pool, 2: I3poolToken, 3: I3poolGaugeDeposit, 4: IZapDepositor3pool
        ...
        dai_missing_decimals = uint(17) - DAI.decimals();
