...
contract TestSortedDoublyLLInsert {
    ...
    function test_setMaxSize() public {
        Assert.equal(fixture.getMaxSize(), 3, "");
    }

    function test_setMaxSize_update() public {
        fixture.setMaxSize(10);

        Assert.equal(fixture.getMaxSize(), 10, "");
    }
    ...
    function test_insert_empty() public {
        ...
        Assert.equal(fixture.getSize(), 1, "");
        Assert.equal(fixture.getFirst(), ids[0], "");
        Assert.equal(fixture.getLast(), ids[0], "");
        Assert.equal(fixture.getKey(ids[0]), keys[0], "");
        Assert.equal(fixture.getNext(ids[0]), address(0), "");
