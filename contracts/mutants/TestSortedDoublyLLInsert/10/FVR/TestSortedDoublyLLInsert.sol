...
contract TestSortedDoublyLLInsert {
    ...
    function test_setMaxSize() external {
        Assert.equal(fixture.getMaxSize(), 3, "wrong max size");
    }

    function test_setMaxSize_update() external {
        fixture.setMaxSize(10);

        Assert.equal(fixture.getMaxSize(), 10, "wrong max size");
    }

    function test_setMaxSize_decreaseSize() external {
    ...
    function test_insert_empty() external {
    ...
    function test_insert_updateHead() external {
    ...
    function test_insert_updateTail() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
    ...
    function test_insert_atPosition() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
    ...
    function test_insert_full() external {
        fixture.insert(ids[0], keys[0], address(0), address(0));
        fixture.insert(ids[1], keys[1], ids[0], address(0));
