...
contract TestSortedDoublyLLInsert {
    address[] ids = [address(0), address(1), address(2), address(3), address(4), address(5)];
    uint256[] keys = [uint256(12), uint256(10), uint256(8), uint256(6), uint256(5), uint256(5), uint256(3)];
