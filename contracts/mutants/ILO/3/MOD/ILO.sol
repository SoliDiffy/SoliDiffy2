...
contract ILO is Ownable {
    ...
    function setStartBlock(uint256 blockNumber) public  {
        startBlock = blockNumber;
    }

    function setEndBlock(uint256 blockNumber) public  {
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken) external  {
