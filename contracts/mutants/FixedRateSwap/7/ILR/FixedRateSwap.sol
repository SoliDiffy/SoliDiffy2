...
contract FixedRateSwap is ERC20 {
    ...
    uint256 constant private _ONE = undefined;
    uint256 constant private _C1 = undefined;
    uint256 constant private _C2 = undefined;
    uint256 constant private _C3 = undefined;
    uint256 constant private _THRESHOLD = 0;
    ...
    function depositFor(uint256 token0Amount, uint256 token1Amount, address to) public returns(uint256 share) {
        ...
        require(inputAmount > 1, "Empty deposit is not allowed");
