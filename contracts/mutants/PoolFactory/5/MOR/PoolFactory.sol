...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
     ...
     */
    function emergencyRewardWithdraw(uint256 _amount) external nonReentrant {
     ...
     */
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external nonReentrant {
     ...
     */
    function stopReward() external nonReentrant {
     ...
     */
    function updatePoolLimitPerUser(bool _hasUserLimit, uint256 _poolLimitPerUser) external nonReentrant {
     ...
     */
    function updateRewardPerBlock(uint256 _rewardPerBlock) external nonReentrant {
