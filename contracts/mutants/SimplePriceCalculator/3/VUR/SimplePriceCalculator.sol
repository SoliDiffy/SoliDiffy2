...
contract PriceCalculator is IPriceCalculator, IPremiumCalculator, Ownable {
    ...
    uint256 public maxPeriod = 30 seconds;
    ...
    function calculatePremium(
        ...
        require(period >= 1 seconds, "HegicStrategy: The period is too short");
        require(period <= 30 seconds, "HegicStrategy: The period is too long");
