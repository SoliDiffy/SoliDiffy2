...
contract SelfOwnedStETHBurner is IBeaconReportReceiver {
    ...
    /**
      ...
      *
      */
    function setBurnAmountPerRunQuota(uint256 _maxBurnAmountPerRunBasisPoints) public {
        require(_maxBurnAmountPerRunBasisPoints > 0, "ZERO_BURN_AMOUNT_PER_RUN");
        require(_maxBurnAmountPerRunBasisPoints <= MAX_BASIS_POINTS, "TOO_LARGE_BURN_AMOUNT_PER_RUN");
    ...
    /**
      ...
      *
      */
    function requestBurnMyStETHForCover(uint256 _stETH2Burn) public {
    ...
    /**
      ...
      *
      */
    function requestBurnMyStETH(uint256 _stETH2Burn) public {
    ...
    /**
      ...
      */
    function recoverExcessStETH() public {
    ...
    /**
      ...
      */
    function recoverERC721(address _token, uint256 _tokenId) public {
    ...
    /**
      ...
      */
    function getCoverSharesBurnt() public view returns (uint256) {
    ...
    /**
      ...
      */
    function getNonCoverSharesBurnt() public view returns (uint256) {
    ...
    /**
      ...
      */
    function getBurnAmountPerRunQuota() public view returns (uint256) {
