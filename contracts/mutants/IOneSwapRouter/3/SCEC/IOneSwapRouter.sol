...
interface IOneSwapRouter {
    ...
    function addLiquidity(
        ...
        address to,
        uint deadline
    ) external returns (uint liquidity, uint amountStock, uint amountMoney);
    function addLiquidityETH(
        ...
        address to,
        uint deadline
    ) external payable returns (uint liquidity, uint amountStock, uint amountMoney);
    function removeLiquidity(
        ...
        address to,
        uint deadline
    ) external returns (uint amountMoney, uint amountStock);
