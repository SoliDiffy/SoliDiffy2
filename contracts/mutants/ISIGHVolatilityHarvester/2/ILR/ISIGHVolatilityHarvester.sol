...
interface ISIGHVolatilityHarvester {
    ...
    function getAllPriceSnapshots(address instrument_ ) external view returns (uint256[23] memory);
    function getBlockNumbersForPriceSnapshots() external view returns (uint256[23] memory);
