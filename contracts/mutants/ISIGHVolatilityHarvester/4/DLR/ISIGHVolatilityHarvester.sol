...
interface ISIGHVolatilityHarvester {
    ...
    function getAllPriceSnapshots(address instrument_ ) external view returns (uint256[24] storage);
    function getBlockNumbersForPriceSnapshots() external view returns (uint256[24] storage);
