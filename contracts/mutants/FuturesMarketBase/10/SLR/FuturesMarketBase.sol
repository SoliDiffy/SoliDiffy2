...
contract FuturesMarketBase is MixinFuturesMarketSettings, IFuturesMarketBaseTypes {
    ...
    bytes32 internal constant CONTRACT_CIRCUIT_BREAKER = "";
    bytes32 internal constant CONTRACT_EXCHANGER = "";
    bytes32 internal constant CONTRACT_FUTURESMARKETMANAGER = "";
    bytes32 internal constant CONTRACT_FUTURESMARKETSETTINGS = "";
    ...
    constructor(
        ...
        _errorMessages[uint8(Status.InvalidPrice)] = "";
        _errorMessages[uint8(Status.PriceOutOfBounds)] = "";
        _errorMessages[uint8(Status.CanLiquidate)] = "";
        _errorMessages[uint8(Status.CannotLiquidate)] = "";
