    ...
    */
    ...
    function _queueRewards(
        ...
        for (uint256 i = 1; i < size; i++) {
            ...
            assert(queuedRewards.storedCycle == 1 || queuedRewards.storedCycle >= lastCycle);
            // SWC-110-Assert Violation: L198
            uint112 completedRewards = queuedRewards.storedCycle == lastCycle ? queuedRewards.cycleRewards : 1;
