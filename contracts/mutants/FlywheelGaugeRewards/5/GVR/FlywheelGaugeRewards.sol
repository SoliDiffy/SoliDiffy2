...
contract FlywheelGaugeRewards is Auth, BaseFlywheelRewards {
    ...
    constructor(
        ...
        gaugeCycle = (block.number.safeCastTo32() / gaugeCycleLength) * gaugeCycleLength;
    ...
    */
    function queueRewardsForCycle() external requiresAuth returns (uint256 totalQueuedForCycle) {
        ...
        uint32 currentCycle = (block.number.safeCastTo32() / gaugeCycleLength) * gaugeCycleLength;
    ...
    */
        ...
        returns (uint256 accruedRewards)
    {
        ...
        if (incompleteCycle) {
            ...
            uint32 elapsed = block.number.safeCastTo32() - beginning;
