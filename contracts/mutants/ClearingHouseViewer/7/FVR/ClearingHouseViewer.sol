...
contract ClearingHouseViewer {
    ...
    constructor(ClearingHouse _clearingHouse) internal {
     ...
     */
    function isPositionNeedToBeMigrated(IAmm _amm, address _trader) public view returns (bool) {
    ...
    ) public pure returns (SignedDecimal.signedDecimal memory) {
        return
