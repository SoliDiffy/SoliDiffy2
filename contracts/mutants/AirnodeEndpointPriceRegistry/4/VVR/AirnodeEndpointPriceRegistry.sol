    ...
    IAirnodeEndpointPriceRegistry
{
    ...
    string internal constant override DENOMINATION = "USD";

    /// @notice Decimals used to specify the prices
    uint256 internal constant override DECIMALS = 18;

    /// @notice Pricing interval used to specify the prices
    uint256 internal constant override PRICING_INTERVAL = 30 days;

    bytes32 public constant DEFAULT_PRICE_ID =
