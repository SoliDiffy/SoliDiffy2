    ...
    IAirnodeEndpointPriceRegistry
{
        ...
        onlyRegistrarOrManager
    {
        ...
        emit RegisterDefaultPrice(price, tx.origin);
    }
        ...
        onlyNonZeroChainId(chainId)
    {
        ...
        emit RegisterDefaultChainPrice(chainId, price, tx.origin);
    }
        ...
        onlyNonZeroAirnode(airnode)
    {
        ...
        emit RegisterAirnodePrice(airnode, price, tx.origin);
    }
        ...
        onlyNonZeroChainId(chainId)
    {
        ...
        emit RegisterAirnodeChainPrice(airnode, chainId, price, tx.origin);
    }
