...
contract veFXS_Solidity is ReentrancyGuard{
    ...
    */
    ...
    function EMPTY_POINT_FACTORY() public view returns (Point memory){
        return Point({
            bias: 0, 
            slope: 0, 
            ts: 0, 
    ...
    // Constant structs not allowed yet, so this will have to do
    function EMPTY_LOCKED_BALANCE_FACTORY() public view returns (LockedBalance memory){
    ...
    */
    function get_last_user_slope(address addr) public view returns (int128) {
    ...
    */
    function user_point_history__ts(address _addr, uint256 _idx) public view returns (uint256) {
