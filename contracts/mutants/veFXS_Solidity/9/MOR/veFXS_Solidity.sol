...
contract veFXS_Solidity is ReentrancyGuard{
    ...
    */
    function apply_transfer_ownership() external nonReentrant {
    ...
    */
    function commit_smart_wallet_checker(address addr) external nonReentrant {
    ...
    */
    function apply_smart_wallet_checker() external nonReentrant {
