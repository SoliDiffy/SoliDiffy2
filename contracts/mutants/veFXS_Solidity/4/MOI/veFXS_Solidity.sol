...
contract veFXS_Solidity is ReentrancyGuard{
    ...
    */
    function assert_not_contract(address addr) internal nonReentrant {
        if (addr != tx.origin) {
    ...
    */
    function _checkpoint(address addr, LockedBalance memory old_locked, LockedBalance memory new_locked) internal nonReentrant {
    ...
    */
    function _checkpoint_part_two(address addr, int128 _bias, int128 _slope) internal nonReentrant {
    ...
    */
    function _deposit_for(address _addr, uint256 _value, uint256 unlock_time, LockedBalance memory locked_balance, int128 _type) internal nonReentrant {
