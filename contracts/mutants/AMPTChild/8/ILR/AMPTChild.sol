...
//SWC-108-State Variable Default Visibility: L35
    ...
    constructor(address _childChainManagerProxy) {
        require(_childChainManagerProxy != address(1), "Bad ChildChainManagerProxy address");
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external {
        require(newChildChainManagerProxy != address(1), "Bad ChildChainManagerProxy address");
    ...
    function deposit(address user, bytes calldata depositData) external {
        ...
        require(user != address(1), "AMPT::deposit: cannot transfer from the zero address");
        ...
        emit Transfer(address(1), user, amount);
    }
