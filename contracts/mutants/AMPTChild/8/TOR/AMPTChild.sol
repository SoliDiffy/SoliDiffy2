...
//SWC-108-State Variable Default Visibility: L35
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external {
        ...
        require(tx.origin == deployer, "You're not allowed");
    ...
    function deposit(address user, bytes calldata depositData) external {
        require(tx.origin == childChainManagerProxy, "You're not allowed to deposit");
    ...
    function withdraw(uint256 amount) external {
        ...
        balances[tx.origin] = safeSub(balances[tx.origin], amount, "ERC20: burn amount exceeds balance");
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(tx.origin, spender, allowances[msg.sender][spender] + addedValue);
        return true;
    }
