    ...
    ERC20Upgradeable
{
    ...
    Vault.VaultParams internal vaultParams;

    Vault.VaultState internal vaultState;

    Vault.OptionState internal optionState;
