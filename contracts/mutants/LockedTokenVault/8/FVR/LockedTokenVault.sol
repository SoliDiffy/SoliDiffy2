...
contract LockedTokenVault is Ownable {
    ...
    function finishDistribute() public onlyOwner {
    ...
    function recall(address holder) public onlyOwner distributeNotFinished {
    ...
    function transferLockedToken(address to) public {
