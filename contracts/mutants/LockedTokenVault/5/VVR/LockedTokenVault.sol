...
contract LockedTokenVault is Ownable {
    ...
    address internal immutable _TOKEN_;

    mapping(address => uint256) internal originBalances;
    mapping(address => uint256) internal claimedBalances;

    uint256 internal _UNDISTRIBUTED_AMOUNT_;
    uint256 internal _START_RELEASE_TIME_;
    uint256 internal _RELEASE_DURATION_;
    uint256 internal _CLIFF_RATE_;
