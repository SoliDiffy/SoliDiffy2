...
contract Logic is Ownable {
     ...
     */
    function returnToken(uint256 amount, address token) external  onlyStorage {
    ...
    function removeLiquidityETH(
        ...
        uint256 amountETHMin,
        uint256 deadline
    ) external  isUsedSwap(swap) onlyOwnerAndAdmin returns (uint256 amountToken, uint256 amountETH) {
