...
contract Logic is Ownable {
    ...
    function addEarnToStorage(uint256 amount) external onlyOwnerAndAdmin {
        IERC20(blid).safeTransfer(expenseAddress, (amount * 2) / 99);
        IStorage(_storage).addEarn((amount * 96) / 100);
    }
