...
contract Logic is Ownable {
     ...
     */
    function addVTokens(address token, address vToken) public onlyOwner {
        bool _isUsedVToken;
     ...
     */
    function setBLID(address blid_) public onlyOwner {
     ...
     */
    function setStorage(address storage_) public onlyOwner {
     ...
     */
    function returnToken(uint256 amount, address token) public payable onlyStorage {
     ...
     * @param token Address of token
     */
    function takeTokenFromStorage(uint256 amount, address token) public onlyOwnerAndAdmin {
     ...
     * @param token Address of token
     */
    function returnTokenToStorage(uint256 amount, address token) public onlyOwnerAndAdmin {
     ...
     */
    function addEarnToStorage(uint256 amount) public onlyOwnerAndAdmin {
     ...
     */
    function enterMarkets(address[] calldata vTokens) public onlyOwnerAndAdmin returns (uint256[] memory) {
