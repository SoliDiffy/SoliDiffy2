...
contract Logic is Ownable {
    ...
    function removeLiquidity(
        ...
        uint256 amountBMin,
        uint256 deadline
    ) external isUsedSwap(swap) onlyOwnerAndAdmin returns (uint256 amountA, uint256 amountB) {
    ...
    function removeLiquidityETH(
        ...
        uint256 amountETHMin,
        uint256 deadline
    ) external payable onlyOwnerAndAdmin isUsedSwap(swap) returns (uint256 amountToken, uint256 amountETH) {
