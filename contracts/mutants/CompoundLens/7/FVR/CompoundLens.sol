...
contract CompoundLens {
    ...
    function cTokenMetadata(CToken cToken) external returns (CTokenMetadata memory) {
    ...
    function cTokenMetadataAll(CToken[] calldata cTokens) public returns (CTokenMetadata[] memory) {
    ...
    function cTokenBalances(CToken cToken, address payable account) external returns (CTokenBalances memory) {
    ...
    function cTokenBalancesAll(CToken[] calldata cTokens, address payable account) public returns (CTokenBalances[] memory) {
        uint cTokenCount = cTokens.length;
    ...
    function cTokenUnderlyingPrice(CToken cToken) external returns (CTokenUnderlyingPrice memory) {
        ComptrollerLensInterface comptroller = ComptrollerLensInterface(address(cToken.comptroller()));
    ...
    function cTokenUnderlyingPriceAll(CToken[] calldata cTokens) public returns (CTokenUnderlyingPrice[] memory) {
        uint cTokenCount = cTokens.length;
    ...
    function getAccountLimits(ComptrollerLensInterface comptroller, address account) external returns (AccountLimits memory) {
