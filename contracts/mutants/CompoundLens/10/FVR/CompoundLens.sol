...
contract CompoundLens {
    ...
    function getCompBalanceMetadata(Comp comp, address account) public view returns (CompBalanceMetadata memory) {
    ...
    function getCompBalanceMetadataExt(Comp comp, ComptrollerLensInterface comptroller, address account) public returns (CompBalanceMetadataExt memory) {
    ...
    function getCompVotes(Comp comp, address account, uint32[] calldata blockNumbers) public view returns (CompVotes[] memory) {
