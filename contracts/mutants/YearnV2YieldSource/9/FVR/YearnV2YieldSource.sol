...
contract YearnV2YieldSource is IYieldSource, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function setMaxLosses(uint256 _maxLosses) public onlyOwner {
    ...
    function sponsor(uint256 amount) public {
    ...
    function _depositInVault() public returns (uint256) {
    ...
    function _withdrawFromVault(uint amount) public returns (uint256) {
    ...
    function _balanceOfYShares() public view returns (uint256) {
    ...
    function _pricePerYShare() public view returns (uint256) {
        return vault.pricePerShare();
    }

    /// @notice Balance of deposit token held in the Yield Source
    /// @return balance of deposit token
    function _balanceOfToken() public view returns (uint256) {
