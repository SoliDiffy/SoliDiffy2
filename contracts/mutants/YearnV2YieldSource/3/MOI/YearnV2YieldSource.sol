...
contract YearnV2YieldSource is IYieldSource, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function balanceOfToken(address addr) external override initializer returns (uint256) {
    ...
    function supplyTokenTo(uint256 _amount, address to) override external initializer {
    ...
    function redeemToken(uint256 amount) external override initializer returns (uint256) {
