...
library PropsRewardsLib {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        getParameterValue(_self, ParameterName.ApplicationRewardsMaxVariationPercent, _rewardsDay)).mul(
        getParameterValue(_self, ParameterName.ApplicationRewardsPercent, _rewardsDay))).div(1e16);
    }
    ...
    */
        ...
        returns (uint256)
    {
        ...
        getParameterValue(_self, ParameterName.ApplicationRewardsPercent, _rewardsDay))).div(1e8)).div(_numOfValidators);
    }
    ...
    */
    ...
    {
        if (_getSelectedRewardedEntityListType(_self.selectedValidators, _rewardsDay) == 0) {
            return ((_self.selectedValidators.currentList.length.mul(getParameterValue(_self, ParameterName.ApplicationRewardsPercent, _rewardsDay))).div(1e8)).add(1);
        } else {
            return ((_self.selectedValidators.previousList.length.mul(getParameterValue(_self, ParameterName.ApplicationRewardsPercent, _rewardsDay))).div(1e8)).add(1);
        }
    }
