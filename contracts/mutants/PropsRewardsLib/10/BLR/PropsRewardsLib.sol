...
library PropsRewardsLib {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        _self.dailyRewards.submissions[_rewardsHash].validators[msg.sender] = false;
    ...
    */
        ...
        returns (uint256)
    {
        ...
        if (!_self.applications[msg.sender].isInitializedState) {
            ...
            _self.applications[msg.sender].isInitializedState = false;
    ...
    */
        ...
        returns (uint256)
    {
        ...
        if (!_self.validators[msg.sender].isInitializedState) {
            ...
            _self.validators[msg.sender].isInitializedState = false;
