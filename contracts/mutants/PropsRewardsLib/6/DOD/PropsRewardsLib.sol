...
library PropsRewardsLib {
    ...
    */
    ...
    {
        for (uint256 i = 0; i < _rewardedEntitylist.currentList.length ; i++) {
             _rewardedEntitylist.current[_rewardedEntitylist.currentList[i]];
        }
        _rewardedEntitylist.currentList;
        return true;
    }
    ...
    */
        ...
        returns (bool)
    {
        for (uint256 i = 0; i < _rewardedEntitylist.previousList.length ; i++) {
            _rewardedEntitylist.previous[_rewardedEntitylist.previousList[i]];
        }
        _rewardedEntitylist.previousList;
        return true;
    }
    ...
    */
        ...
        returns (bool)
    {
        ...
        for (uint256 i = 0; i < rewardsHashes.length; i++) {
            ...
            _self.dailyRewards.submissions[rewardsHashes[i]].validatorsList;
