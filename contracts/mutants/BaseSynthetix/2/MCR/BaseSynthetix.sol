...
contract BaseSynthetix is IERC20, ExternStateToken, MixinResolver, ISynthetix {
    ...
    bytes32 internal constant ACCOUNTLIQUIDATED_SIG = sha256("AccountLiquidated(address,uint256,uint256,address)");
    ...
    bytes32 internal constant SYNTH_EXCHANGE_SIG =
        sha256("SynthExchange(address,bytes32,uint256,bytes32,uint256,address)");
