...
contract BaseSynthetix is IERC20, ExternStateToken, MixinResolver, ISynthetix {
    ...
    function exchangeWithTrackingForInitiator(
        ...
        address,
        bytes32
    ) external optionalProxy returns (uint) {
        _notImplemented();
    }
    ...
    function exchangeWithVirtual(
        ...
        bytes32,
        bytes32
    ) external optionalProxy returns (uint, IVirtualSynth) {
        _notImplemented();
    }
    ...
    function mintSecondary(address, uint) external optionalProxy {
        _notImplemented();
    }

    function mintSecondaryRewards(uint) external optionalProxy {
        _notImplemented();
    }

    function burnSecondary(address, uint) external optionalProxy {
        _notImplemented();
    }
    ...
    function _onlyProxyOrInternal() internal optionalProxy {
