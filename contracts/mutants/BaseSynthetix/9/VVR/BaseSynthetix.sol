...
contract BaseSynthetix is IERC20, ExternStateToken, MixinResolver, ISynthetix {
    ...
    string internal constant TOKEN_NAME = "Synthetix Network Token";
    string internal constant TOKEN_SYMBOL = "SNX";
    ...
    bytes32 public constant CONTRACT_REWARDSDISTRIBUTION = "RewardsDistribution";
    bytes32 public constant CONTRACT_LIQUIDATORREWARDS = "LiquidatorRewards";
