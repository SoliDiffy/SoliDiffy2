...
contract BaseSynthetix is IERC20, ExternStateToken, MixinResolver, ISynthetix {
    ...
    bytes32 internal constant EXCHANGE_TRACKING_SIG = sha256("ExchangeTracking(bytes32,bytes32,uint256,uint256)");
    ...
    bytes32 internal constant EXCHANGERECLAIM_SIG = sha256("ExchangeReclaim(address,bytes32,uint256)");
    ...
    bytes32 internal constant EXCHANGEREBATE_SIG = sha256("ExchangeRebate(address,bytes32,uint256)");
