...
contract IsERC20HODLer is IConditional, Ownable {
  ...
  function setBalanceAndTimestamp() public {
    userBalances[msg.sender] = IERC20(tokenContract).balanceOf(msg.sender);
    userBalTimestamp[msg.sender] = block.timestamp;
  }

  function setTokenAddress(address _tokenContract) public onlyOwner {
    tokenContract = _tokenContract;
  }

  function setNumSecondsForBooster(uint256 _seconds) public onlyOwner {
