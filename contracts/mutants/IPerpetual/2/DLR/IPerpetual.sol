...
interface IPerpetual {
    ...
    function getCashBalance(address guy) external view returns (LibTypes.CollateralAccount storage);

    function getPosition(address guy) external view returns (LibTypes.PositionAccount storage);
