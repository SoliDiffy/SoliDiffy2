...
interface IPerpetual {
    ...
    function getBroker(address guy) external view returns (LibTypes.Broker storage);

    function getGovernance() external view returns (LibTypes.PerpGovernanceConfig storage);
