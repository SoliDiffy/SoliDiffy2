...
contract ProxyCloneFactory is Ownable {
   ...
   */
  function clone(address _proxyImplementationAddress) internal onlyOwner returns (address instance) {
   ...
   */
  function deploy(address implementation, bytes calldata initCallData) external onlyOwner {
