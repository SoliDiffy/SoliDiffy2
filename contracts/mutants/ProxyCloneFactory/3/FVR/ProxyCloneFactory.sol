...
contract ProxyCloneFactory is Ownable {
   ...
   */
  function clone(address _proxyImplementationAddress) public returns (address instance) {
   ...
   */
  function deploy(address implementation, bytes calldata initCallData) public {
