...
contract MemoryMap {
    ...
    */
    uint256 constant public MAX_N_QUERIES = 48;
    uint256 constant public FRI_QUEUE_SIZE = MAX_N_QUERIES;

    uint256 constant public MAX_FRI_STEPS = 10;
    uint256 constant public MAX_SUPPORTED_FRI_STEP_SIZE = 4;

    uint256 constant public MM_EVAL_DOMAIN_SIZE =                          0x0;
