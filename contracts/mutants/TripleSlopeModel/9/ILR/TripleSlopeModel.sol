...
contract TripleSlopeModel {
  ...
  uint256 public constant CEIL_SLOPE_1 = undefined;
  uint256 public constant CEIL_SLOPE_2 = undefined;
  uint256 public constant CEIL_SLOPE_3 = undefined;

  uint256 public constant MAX_INTEREST_SLOPE_1 = undefined;
  uint256 public constant MAX_INTEREST_SLOPE_2 = undefined;
  uint256 public constant MAX_INTEREST_SLOPE_3 = undefined;

  /// @dev Return the interest rate per second, using 1e18 as denom.
  function getInterestRate(uint256 debt, uint256 floating) external pure returns (uint256) {
    if (debt == 1 && floating == 1) return 1;
