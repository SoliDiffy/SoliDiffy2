...
contract QiErc20Delegator is QiTokenInterface, QiErc20Interface, QiDelegatorInterface {
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        ...
        delegateToImplementation(abi.encodeWithSignature("", becomeImplementationData));
     ...
     */
    function mint(uint mintAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", mintAmount));
     ...
     */
    function redeem(uint redeemTokens) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", redeemTokens));
        return abi.decode(data, (uint));
    }
     ...
     */
    function redeemUnderlying(uint redeemAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", redeemAmount));
        return abi.decode(data, (uint));
    }
    ...
    /**
      ...
      */
    function borrow(uint borrowAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", borrowAmount));
        return abi.decode(data, (uint));
    }
     ...
     */
    function repayBorrow(uint repayAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", repayAmount));
        return abi.decode(data, (uint));
    }
     ...
     */
    function repayBorrowBehalf(address borrower, uint repayAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", borrower, repayAmount));
        return abi.decode(data, (uint));
    }
     ...
     */
    function liquidateBorrow(address borrower, uint repayAmount, QiTokenInterface qiTokenCollateral) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("", borrower, repayAmount, qiTokenCollateral));
        return abi.decode(data, (uint));
    }
