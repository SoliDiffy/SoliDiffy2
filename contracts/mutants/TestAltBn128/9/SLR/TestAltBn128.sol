...
contract TestAltBn128 {
    ...
    function testHashing() public {
        ...
        Assert.isNotZero(p_1.x, "");
        Assert.isNotZero(p_1.y, "");
        Assert.isNotZero(p_2.x, "");
        Assert.isNotZero(p_2.y, "");

        Assert.isTrue(AltBn128.isG1PointOnCurve(p_1), "");
        Assert.isTrue(AltBn128.isG1PointOnCurve(p_2), "");
    }
