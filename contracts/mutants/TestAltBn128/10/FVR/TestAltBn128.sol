...
contract TestAltBn128 {
    ...
    function testHashAndAdd() external {
        string memory hello = "hello!";
        string memory goodbye = "goodbye.";
        AltBn128.G1Point memory p_1;
        AltBn128.G1Point memory p_2;
    ...
    function testHashAndScalarMultiply() external {
        string memory hello = "hello!";
        AltBn128.G1Point memory p_1;
        AltBn128.G1Point memory p_2;
        p_1 = AltBn128.g1HashToPoint(bytes(hello));
    ...
    function testScalarMultiply() external {
        uint i;
        uint j;
    ...
    function testBasicPairing() external {
    ...
    function testCompressG1Invertibility() external {
        AltBn128.G1Point memory p_1;
        AltBn128.G1Point memory p_2;
    ...
    function testCompressG2Invertibility() external {
