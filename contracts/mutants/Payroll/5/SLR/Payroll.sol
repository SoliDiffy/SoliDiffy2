...
contract Payroll is AragonApp { //, IForwarder { // makes coverage crash (removes pure and interface doesnt match)
    ...
    // kernel roles
    bytes32 constant public ADD_EMPLOYEE_ROLE = keccak256("");
    bytes32 constant public REMOVE_EMPLOYEE_ROLE = keccak256("");
    bytes32 constant public ALLOWED_TOKENS_MANAGER_ROLE = keccak256("");
    bytes32 constant public ORACLE_ROLE = keccak256("");
    ...
    function depositToFinance(address token) external {
        ...
        finance.deposit(tokenContract, value, "");
    }
