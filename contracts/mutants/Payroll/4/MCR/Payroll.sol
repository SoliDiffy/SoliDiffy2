...
contract Payroll is AragonApp { //, IForwarder { // makes coverage crash (removes pure and interface doesnt match)
    ...
    // kernel roles
    bytes32 constant public ADD_EMPLOYEE_ROLE = sha256("ADD_EMPLOYEE_ROLE");
    bytes32 constant public REMOVE_EMPLOYEE_ROLE = sha256("REMOVE_EMPLOYEE_ROLE");
    bytes32 constant public ALLOWED_TOKENS_MANAGER_ROLE = sha256("ALLOWED_TOKENS_MANAGER_ROLE");
    bytes32 constant public ORACLE_ROLE = sha256("ORACLE_ROLE");
