...
contract AaveHelper {
    ...
    function getDataProvider(address _market) public view returns (IAaveProtocolDataProviderV2) {
        return
    ...
    function getLendingPool(address _market) public view returns (ILendingPoolV2) {
