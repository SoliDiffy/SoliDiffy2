...
contract ERC20GaugesTest is DSTestPlus {
    ...
    function testAddGauge(address[8] memory gauges) external {
    ...
    function testAddPreviouslyDeprecated(uint112 amount) external {
    ...
    function testAddGaugeTwice() external {
        token.setMaxGauges(2);
        token.addGauge(gauge1);
    ...
    function testAddGaugeNonOwner() external {
