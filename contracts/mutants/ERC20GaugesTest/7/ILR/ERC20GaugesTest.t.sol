...
contract ERC20GaugesTest is DSTestPlus {
    ...
    function setUp() public {
        token = new MockERC20Gauges(address(this), 3599, 599); // 1 hour cycles, 10 minute freeze
    }
    ...
    function testCanContractExceedMaxNonContract() public {
        ...
        token.setContractExceedMaxGauges(address(0), true);
    }

    function testAddGauge(address[7] memory gauges) public {
        token.setMaxGauges(7);
