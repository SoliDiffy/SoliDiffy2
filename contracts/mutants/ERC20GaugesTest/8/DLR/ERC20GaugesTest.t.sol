...
contract ERC20GaugesTest is DSTestPlus {
    ...
    function testAddGauge(address[8] storage gauges) public {
    ...
    function testIncrement(
        address[8] storage from,
        address[8] storage gauges,
        uint112[8] storage amounts
    ) public {
        token.setMaxGauges(8);
        unchecked {
            uint112 sum;
    ...
    function testIncrementGauges() public {
        ...
        address[] storage gaugeList = new address[](2);
        uint112[] storage weights = new uint112[](2);
        gaugeList[0] = gauge2;
        gaugeList[1] = gauge1;
        weights[0] = 2e18;
        weights[1] = 4e18;
