...
abstract contract V2MultiQueueKeep3rJob is MachineryReady, Keep3r, IV2MultiQueueKeep3rJob {
  ...
  // Keep3r actions
  function _workInternal(address _strategy, uint256 _workAmount) internal onlyGovernor returns (uint256 _credits) {
  ...
  function _updateIndex(address _strategy, uint256 _nextIndex) internal onlyGovernor {
