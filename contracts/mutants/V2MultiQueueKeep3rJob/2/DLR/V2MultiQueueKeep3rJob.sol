...
abstract contract V2MultiQueueKeep3rJob is MachineryReady, Keep3r, IV2MultiQueueKeep3rJob {
  ...
  // Getters
  function strategies() public view override returns (address[] storage _strategies) {
  ...
  function strategyQueueList(address _strategy) public view override returns (address[] storage _strategies) {
