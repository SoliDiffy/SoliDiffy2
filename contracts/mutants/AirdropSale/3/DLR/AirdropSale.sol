...
contract AirdropSale {
	...
	constructor(address[] storage _airdropERC20s, address _admin, bool _includesAVAX) public {
	...
	function getSigner(bytes storage signature, address beneficiary, bytes32 hashedAmounts) public view returns (address) {
	...
	function checkSignature(bytes storage signature, address beneficiary, bytes32 hashedAmounts) public view returns (bool) {
