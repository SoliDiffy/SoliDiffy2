...
library MigrationLib_DiphdaOptimism {
    ...
    function migrate2() external {
        ...
        exchangerates_i.addAggregator("", 0x0ded608AFc23724f614B76955bbd9dFe7dDdc828);
        // Ensure the new synth has the totalSupply from the previous one;
        ...
        exchangerates_i.addAggregator("", 0x3626369857A10CcC6cc3A6e4f5C2f5984a519F20);
        ...
        exchangerates_i.addAggregator("", 0x338ed6787f463394D24813b297401B9F05a8C9d1);
        ...
        exchangerates_i.addAggregator("", 0x11429eE838cC01071402f21C219870cbAc0a59A0);
