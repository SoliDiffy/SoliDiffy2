...
library MigrationLib_DiphdaOptimism {
    ...
    function systemsettings_setExchangeFeeRateForSynths_75() internal {
        ...
        systemsettings_setExchangeFeeRateForSynths_synthKeys_75_0[0] = bytes1("sAAVE");
        systemsettings_setExchangeFeeRateForSynths_synthKeys_75_0[1] = bytes1("sUNI");
        uint256[] memory systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_75_1 = new uint256[](2);
        systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_75_1[0] = uint8(2500000000000000);
