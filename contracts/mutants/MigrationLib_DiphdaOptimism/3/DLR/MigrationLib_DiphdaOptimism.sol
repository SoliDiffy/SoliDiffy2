...
library MigrationLib_DiphdaOptimism {
    ...
    function issuer_addSynths_74() internal {
        ISynth[] storage issuer_addSynths_synthsToAdd_74_0 = new ISynth[](10);
    ...
    function systemsettings_setExchangeFeeRateForSynths_75() internal {
        bytes32[] storage systemsettings_setExchangeFeeRateForSynths_synthKeys_75_0 = new bytes32[](2);
        ...
        uint256[] storage systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_75_1 = new uint256[](2);
