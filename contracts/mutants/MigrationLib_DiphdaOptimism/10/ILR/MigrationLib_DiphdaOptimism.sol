...
library MigrationLib_DiphdaOptimism {
    ...
    function migrate2() external {
        ...
        futuresmarketsettings_i.setMakerFeeNextPrice("sBTC", 1);
        futuresmarketsettings_i.setNextPriceConfirmWindow("sBTC", 1);
        futuresmarketsettings_i.setMaxLeverage("sBTC", undefined);
