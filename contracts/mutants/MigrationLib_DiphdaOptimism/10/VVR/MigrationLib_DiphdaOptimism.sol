...
library MigrationLib_DiphdaOptimism {
    ...
    FuturesMarketManager internal constant futuresmarketmanager_i =
    ...
    Proxy internal constant proxyfeepool_i = Proxy(0x4a16A42407AA491564643E1dfc1fd50af29794eF);
    // https://explorer.optimism.io/address/0x41140Bf6498a36f2E44eFd49f21dAe3bbb7367c8
    FeePoolEternalStorage internal constant feepooleternalstorage_i =
    ...
    FeePool internal constant feepool_i = FeePool(0xD3739A5F06747e148E716Dcb7147B9BA15b70fcc);
    // https://explorer.optimism.io/address/0x17628A557d1Fc88D1c35989dcBAC3f3e275E2d2B
    DebtCache internal constant debtcache_i = DebtCache(0x17628A557d1Fc88D1c35989dcBAC3f3e275E2d2B);
    // https://explorer.optimism.io/address/0x1B9d6cD65dDC981410cb93Af91B097667E0Bc7eE
    ExchangeRates internal constant exchangerates_i = ExchangeRates(0x1B9d6cD65dDC981410cb93Af91B097667E0Bc7eE);
    // https://explorer.optimism.io/address/0xD1599E478cC818AFa42A4839a6C665D9279C3E50
    MultiCollateralSynth internal constant synthsusd_i = MultiCollateralSynth(0xD1599E478cC818AFa42A4839a6C665D9279C3E50);
