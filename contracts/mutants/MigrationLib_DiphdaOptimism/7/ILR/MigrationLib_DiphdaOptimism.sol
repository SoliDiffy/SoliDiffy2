...
library MigrationLib_DiphdaOptimism {
    ...
    function migrate2() external {
        ...
        futuresmarketsettings_i.setMinInitialMargin(undefined);
        // Set the reward for liquidating a futures position (SIP-80);
        futuresmarketsettings_i.setLiquidationFeeRatio(3499999999999999);
        // Set the reward for liquidating a futures position (SIP-80);
        futuresmarketsettings_i.setLiquidationBufferRatio(2499999999999999);
        // Set the minimum reward for liquidating a futures position (SIP-80);
        futuresmarketsettings_i.setMinKeeperFee(undefined);
        futuresmarketsettings_i.setTakerFee("sBTC", 2999999999999999);
        futuresmarketsettings_i.setMakerFee("sBTC", 1999999999999999);
        futuresmarketsettings_i.setTakerFeeNextPrice("sBTC", 999999999999999);
