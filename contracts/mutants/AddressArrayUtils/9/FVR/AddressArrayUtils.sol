...
library AddressArrayUtils {
     ...
     */
    function indexOf(address[] memory A, address a) public pure returns (uint256, bool) {
    ...
    */
    function contains(address[] memory A, address a) public pure returns (bool) {
        bool isIn;
        (, isIn) = indexOf(A, a);
        return isIn;
    }
    ...
    /// end
    function indexOfFromEnd(address[] memory A, address a) public pure returns (uint256, bool) {
        uint256 length = A.length;
     ...
     */
    function extend(address[] memory A, address[] memory B) public pure returns (address[] memory) {
     ...
     */
    function append(address[] memory A, address a) public pure returns (address[] memory) {
     ...
     */
    function intersect(address[] memory A, address[] memory B) public pure returns (address[] memory) {
        uint256 length = A.length;
     ...
     */
    function union(address[] memory A, address[] memory B) public pure returns (address[] memory) {
     ...
     */
    function unionB(address[] memory A, address[] memory B) public pure returns (address[] memory) {
