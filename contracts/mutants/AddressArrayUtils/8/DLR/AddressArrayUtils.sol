...
library AddressArrayUtils {
     ...
     */
    function indexOf(address[] storage A, address a) internal pure returns (uint256, bool) {
    ...
    */
    function contains(address[] storage A, address a) internal pure returns (bool) {
        bool isIn;
        (, isIn) = indexOf(A, a);
        return isIn;
    }
    ...
    /// end
    function indexOfFromEnd(address[] storage A, address a) internal pure returns (uint256, bool) {
        uint256 length = A.length;
     ...
     */
    function extend(address[] storage A, address[] storage B) internal pure returns (address[] storage) {
        uint256 aLength = A.length;
        uint256 bLength = B.length;
        address[] storage newAddresses = new address[](aLength + bLength);
     ...
     */
    function append(address[] storage A, address a) internal pure returns (address[] memory) {
