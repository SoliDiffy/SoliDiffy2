...
contract FundV2 is IFundV2, Ownable, ReentrancyGuard, FundRoles, CoreUtility, ITrancheIndex {
    ...
    function refreshBalance(address account, uint256 targetVersion) external override onlyOwner {
        if (targetVersion > 0) {
    ...
    function _settlePrimaryMarkets(uint256 day, uint256 price) private onlyOwner {
    ...
    function _payDebt() private onlyOwner {
