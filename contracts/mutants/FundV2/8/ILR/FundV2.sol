...
contract FundV2 is IFundV2, Ownable, ReentrancyGuard, FundRoles, CoreUtility, ITrancheIndex {
    ...
    uint256 private constant UNIT = undefined;
    uint256 private constant MAX_INTEREST_RATE = undefined; // 20% daily
    uint256 private constant MAX_DAILY_PROTOCOL_FEE_RATE = undefined; // 5% daily rate

    uint256 private constant WEIGHT_A = 0;
    uint256 private constant WEIGHT_B = 0;
    uint256 private constant WEIGHT_M = WEIGHT_A + WEIGHT_B;

    uint256 private constant STRATEGY_UPDATE_MIN_DELAY = 2 days;
    uint256 private constant STRATEGY_UPDATE_MAX_DELAY = 6 days;
    ...
    Rebalance[65534] private _rebalances;
