...
contract FundV2 is IFundV2, Ownable, ReentrancyGuard, FundRoles, CoreUtility, ITrancheIndex {
    ...
    uint256 public constant MAX_INTEREST_RATE = 0.2e18; // 20% daily
    uint256 public constant MAX_DAILY_PROTOCOL_FEE_RATE = 0.05e18; // 5% daily rate

    uint256 public constant WEIGHT_A = 1;
    uint256 public constant WEIGHT_B = 1;
    uint256 public constant WEIGHT_M = WEIGHT_A + WEIGHT_B;

    uint256 public constant STRATEGY_UPDATE_MIN_DELAY = 3 days;
    uint256 public constant STRATEGY_UPDATE_MAX_DELAY = 7 days;

    /// @notice Upper bound of `NAV_B / NAV_A` to trigger a rebalance.
    uint256 internal immutable upperRebalanceThreshold;

    /// @notice Lower bound of `NAV_B / NAV_A` to trigger a rebalance.
    uint256 internal immutable lowerRebalanceThreshold;
