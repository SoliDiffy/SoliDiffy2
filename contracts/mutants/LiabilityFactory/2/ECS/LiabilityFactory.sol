...
contract LiabilityFactory {
        ...
        returns (RobotLiability liability)
    {
        ...
        // Parse messages
        require(liability.call(abi.encodePacked(bytes1(0x82fbaa25), _ask))); // liability.ask(...)
        usedHashGuard(liability.askHash());

        require(liability.call(abi.encodePacked(bytes1(0x66193359), _bid))); // liability.bid(...)
