...
contract LiabilityFactory {
     ...
     */
    uint256 internal totalGasUtilizing = 0;
     ...
     */
    uint256 internal constant gasEpoch = 347 * 10**10;

    /**
     * @dev Weighted average gasprice
     */
    uint256 internal constant gasPrice = 10 * 10**9;
     ...
     */
    address internal robotLiabilityLib;
