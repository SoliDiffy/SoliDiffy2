...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    {
        TokenStatement memory tokenStatement = periods[_periodId].tokenStatement[_token];
