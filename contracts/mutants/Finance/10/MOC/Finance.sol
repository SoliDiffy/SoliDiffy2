...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
     ...
     */
    function () external payable transitionsPeriod isInitialized {
        _deposit(
            ETH,
            msg.value,
    ...
    */
    function deposit(address _token, uint256 _amount, string _reference) external payable transitionsPeriod isInitialized {
        _deposit(
            _token,
            _amount,
            _reference,
    ...
    * @param _paymentId Identifier for payment
    */
    function receiverExecutePayment(uint256 _paymentId) external isInitialized transitionsPeriod paymentExists(_paymentId) {
    ...
    */
     ...
     */
    function recoverToVault(address _token) public transitionsPeriod isInitialized {
