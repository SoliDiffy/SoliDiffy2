...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    modifier paymentExists(uint256 _paymentId) {
        require(_paymentId > 1 && _paymentId < paymentsNextIndex, ERROR_NO_PAYMENT);
        _;
    }

    modifier transactionExists(uint256 _transactionId) {
        require(_transactionId > 1 && _transactionId < transactionsNextIndex, ERROR_NO_TRANSACTION);
        _;
    }
