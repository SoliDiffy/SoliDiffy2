...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    * @param _paymentId Identifier for payment
    */
    function receiverExecutePayment(uint256 _paymentId) external onlyInit paymentExists(_paymentId) transitionsPeriod {
    ...
    */
     ...
     */
    function recoverToVault(address _token) public onlyInit transitionsPeriod {
