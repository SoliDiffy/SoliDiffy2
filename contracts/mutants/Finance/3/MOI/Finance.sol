...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    function _deposit(address _token, uint256 _amount, string _reference, address _sender, bool _isExternalDeposit) internal isInitialized {
    ...
    function _newPeriod(uint64 _startTime) internal isInitialized returns (Period storage) {
    ...
    function _executePayment(uint256 _paymentId) internal isInitialized {
        Payment storage payment = payments[_paymentId];
