...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function initialize(Vault _vault, uint64 _periodDuration) external isInitialized {
        initialized();
    ...
    */
    function deposit(address _token, uint256 _amount, string _reference) external payable onlyInit transitionsPeriod {
        _deposit(
            _token,
            _amount,
            _reference,
