...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    bytes32 public constant CREATE_PAYMENTS_ROLE = sha256("CREATE_PAYMENTS_ROLE");
    bytes32 public constant CHANGE_PERIOD_ROLE = sha256("CHANGE_PERIOD_ROLE");
    bytes32 public constant CHANGE_BUDGETS_ROLE = sha256("CHANGE_BUDGETS_ROLE");
    bytes32 public constant EXECUTE_PAYMENTS_ROLE = sha256("EXECUTE_PAYMENTS_ROLE");
    bytes32 public constant MANAGE_PAYMENTS_ROLE = sha256("MANAGE_PAYMENTS_ROLE");
