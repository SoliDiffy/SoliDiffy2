...
contract Finance is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function initialize(Vault _vault, uint64 _periodDuration) public onlyInit {
        initialized();
    ...
    */
    function deposit(address _token, uint256 _amount, string _reference) public payable isInitialized transitionsPeriod {
        _deposit(
            _token,
            _amount,
            _reference,
    ...
    * @param _paymentId Identifier for payment
    */
    function receiverExecutePayment(uint256 _paymentId) public isInitialized paymentExists(_paymentId) transitionsPeriod {
