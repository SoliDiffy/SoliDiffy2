...
contract FeeRoll {
    ...
    function tradeLP(
        ...
        IUniswapV2Router01(router).swapExactTokensForTokens(amountA, 0, getPathToStnd(tokenA), dstnd, block.number + 20000000);
        IUniswapV2Router01(router).swapExactTokensForTokens(amountB, 0, getPathToStnd(tokenB), dstnd, block.number + 20000000);
    }
    ...
    function tradeCollateral (
        ...
        IUniswapV2Router01(router).swapExactTokensForTokens(IERC20(collateral).balanceOf(address(this)), 0, getPathToStnd(collateral), dstnd, block.number + 20000000);
    }
