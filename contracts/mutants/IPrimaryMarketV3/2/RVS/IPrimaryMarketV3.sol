...
interface IPrimaryMarketV3 {
    ...
    function getRedemption(uint256 inQ) external view returns (uint256 fee, uint256 underlying);
    ...
    function getMerge(uint256 inB) external view returns (uint256 feeQ, uint256 outQ);
