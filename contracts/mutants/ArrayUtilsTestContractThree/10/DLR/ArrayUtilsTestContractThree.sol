...
contract ArrayUtilsTestContractThree {
  ...
  function getUniq8() returns (uint8[5] storage r) {
    uint arrayNewLength;
  ...
  function getUniq16() returns (uint16[7] storage r) {
    uint arrayNewLength;
  ...
  function getUniq32() returns (uint32[7] storage r) {
    uint arrayNewLength;
  ...
  function getUniq64() returns (uint64[7] storage r) {
    uint arrayNewLength;
