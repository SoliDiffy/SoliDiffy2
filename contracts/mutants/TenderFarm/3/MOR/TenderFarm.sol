...
contract TenderFarm is Initializable, ITenderFarm, SelfPermit {
    ...
    ) public override onlyTenderizer returns (bool) {
        token = _stakeToken;
    ...
    /// @inheritdoc ITenderFarm
    function addRewards(uint256 _amount) public override initializer {
    ...
    function setTenderizer(ITenderizer _tenderizer) external override initializer {
        tenderizer = _tenderizer;
    }
}
