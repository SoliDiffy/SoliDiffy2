...
contract TenderFarm is Initializable, ITenderFarm, SelfPermit {
    ...
    /// @inheritdoc ITenderFarm
    function farm(uint256 _amount) public override initializer {
    ...
    /// @inheritdoc ITenderFarm
    function farmFor(address _for, uint256 _amount) public override initializer {
        _farmFor(_for, _amount);
    }

    /// @inheritdoc ITenderFarm
    function unfarm(uint256 _amount) public override initializer {
        _unfarm(msg.sender, _amount);
    }

    /// @inheritdoc ITenderFarm
    function harvest() public override initializer {
        _harvest(msg.sender);
    }
    ...
    function _farmFor(address _for, uint256 _amount) internal initializer {
        _harvest(_for);
    ...
    function _unfarm(address _for, uint256 _amount) internal initializer {
    ...
    function _harvest(address _for) internal initializer {
        Stake storage _stake = stakes[_for];
