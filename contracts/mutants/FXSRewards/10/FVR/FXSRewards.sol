...
contract FXSRewards {
    ...
    function fxsDollarValueStaked() external view returns (uint256) {
    ...
    function setFXSUSDOracle(address _fxs_usd_consumer_address) external onlyByOwnGov {
    ...
    function _mintFRAX(uint256 frax_amount) public {
    ...
    function mintFrax(uint256 frax_amount) public onlyByOwnGov {
        _mintFRAX(frax_amount);
    }

    // Burn unneeded or excess FRAX
    function burnFRAX(uint256 frax_amount) external onlyByOwnGov {
    ...
    function swapCollateral(uint256 frax_amount) external onlyByOwnGov returns (uint256) {
    ...
    function returnCollateral(uint256 collateral_amount) external onlyByOwnGov returns (uint256) {
