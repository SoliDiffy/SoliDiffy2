  ...
  ERC721Pausable
{
  ...
  // Start pre sale
  function startPreSale() external whenOwnerOrSaleActive {
  ...
  // End pre sale
  function endPreSale() external whenOwnerOrSaleActive {
    preSaleActive = false;
    publicSaleActive = false;
  }

  // Start public sale
  function startPublicSale() external whenOwnerOrSaleActive {
  ...
  // End public sale
  function endPublicSale() external whenOwnerOrSaleActive {
    preSaleActive = false;
    publicSaleActive = false;
  }
