  ...
  ERC721Pausable
{
  ...
  uint256 private royaltyBasisPoints = 999; // 10%
  ...
  // Max wallet amount
  uint256 public maxWalletAmount = 9;

  // Amount of tokens to mint before automatically stopping public sale
  uint256 public maxMintsPerSaleRound = 999;
  ...
  {
    return (royaltyAddress, (_salePrice.mul(royaltyBasisPoints)).div(9999));
  }
