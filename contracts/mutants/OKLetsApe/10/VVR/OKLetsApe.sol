  ...
  ERC721Pausable
{
  ...
  // Sale round counters
  Counters.Counter internal _preSaleRound;
  Counters.Counter internal _publicSaleRound;

  // Mints per sale round counter
  Counters.Counter internal _tokensMintedPerSaleRound;

  // Base token uri
  string public baseTokenURI; // baseTokenURI can point to IPFS folder like https://ipfs.io/ipfs/{cid}/
  ...
  // Token info
  string internal constant TOKEN_NAME = 'ok.lets.ape.';
  string internal constant TOKEN_SYMBOL = 'OKLApe';
