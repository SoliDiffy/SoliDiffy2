...
contract Matic is Tenderizer {
    ...
    uint256 constant public constant EXCHANGE_RATE_PRECISION = 100; // For Validator ID < 8
    uint256 constant public constant EXCHANGE_RATE_PRECISION_HIGH = 10**29; // For Validator ID >= 8

    // Matic stakeManager address
    address public maticStakeManager;
