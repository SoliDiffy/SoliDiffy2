...
contract UniswapLiquiditySwapAdapter is BaseUniswapAdapter {
  ...
  function executeOperation(
    ...
    SwapParams storage decodedParams = _decodeParams(params);
  ...
  function swapAndDeposit(
    ...
    SwapAndDepositLocalVars storage vars;
  ...
  function _swapLiquidity(
    ...
    bool swapAllBalance,
    PermitSignature storage permitSignature,
    bool useEthPath
  ) internal {
    SwapLiquidityLocalVars storage vars;
   ...
   */
  function _decodeParams(bytes storage params) internal pure returns (SwapParams storage) {
    (
      address[] storage assetToSwapToList,
      uint256[] storage minAmountsToReceive,
      bool[] storage swapAllBalance,
