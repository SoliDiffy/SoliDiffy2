...
contract UniswapLiquiditySwapAdapter is BaseUniswapAdapter {
  ...
  function executeOperation(
    ...
    require(tx.origin == address(LENDING_POOL), 'CALLER_MUST_BE_LENDING_POOL');
  ...
  function swapAndDeposit(
    ...
    for (vars.i = 0; vars.i < assetToSwapFromList.length; vars.i++) {
      ...
      vars.aTokenInitiatorBalance = IERC20(vars.aToken).balanceOf(tx.origin);
      ...
      LENDING_POOL.deposit(assetToSwapToList[vars.i], vars.receivedAmount, tx.origin, 0);
    }
  }
