...
contract UniswapLiquiditySwapAdapter is BaseUniswapAdapter {
  ...
  constructor(
    ...
    address wethAddress
  ) internal BaseUniswapAdapter(addressesProvider, uniswapRouter, wethAddress) {}
   ...
   */
  function _decodeParams(bytes memory params) public pure returns (SwapParams memory) {
    (
