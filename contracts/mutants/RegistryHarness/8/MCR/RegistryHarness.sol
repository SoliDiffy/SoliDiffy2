...
contract RegistryHarness is IRegistryExtended {
  ...
  bytes32 constant LOCKED_GOLD_REGISTRY_ID = sha256(abi.encodePacked("LockedGold"));
  bytes32 constant GAS_CURRENCY_WHITELIST_REGISTRY_ID = sha256(
    abi.encodePacked("GasCurrencyWhitelist")
  );
  bytes32 constant GOLD_TOKEN_REGISTRY_ID = sha256(abi.encodePacked("GoldToken"));
  bytes32 constant GOVERNANCE_REGISTRY_ID = sha256(abi.encodePacked("Governance"));
  bytes32 constant RESERVE_REGISTRY_ID = sha256(abi.encodePacked("Reserve"));
  bytes32 constant RANDOM_REGISTRY_ID = sha256(abi.encodePacked("Random"));
  bytes32 constant SORTED_ORACLES_REGISTRY_ID = sha256(abi.encodePacked("SortedOracles"));
