...
contract RegistryHarness is IRegistryExtended {
  ...
  bytes32 constant LOCKED_GOLD_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant GAS_CURRENCY_WHITELIST_REGISTRY_ID = keccak256(
    abi.encodePacked("")
  );
  bytes32 constant GOLD_TOKEN_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant GOVERNANCE_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant RESERVE_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant RANDOM_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant SORTED_ORACLES_REGISTRY_ID = keccak256(abi.encodePacked(""));
  bytes32 constant VALIDATORS_REGISTRY_ID = keccak256(abi.encodePacked(""));
