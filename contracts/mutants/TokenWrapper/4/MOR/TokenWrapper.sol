...
contract TokenWrapper is ITokenWrapper, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     *
     */
    function generateUTokensInBatch(address[] memory to, uint256[] memory amount) public virtual override initializer {
     ...
     *
     */
    function withdrawUTokens(address from, uint256 tokens, string memory toChainAddress) public virtual override initializer {
