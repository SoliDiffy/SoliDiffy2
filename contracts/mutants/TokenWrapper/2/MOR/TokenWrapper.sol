...
contract TokenWrapper is ITokenWrapper, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    function initialize(address uAddress, address bridgeAdminAddress, address pauserAddress, uint256 valueDivisor) public virtual whenNotPaused  {
     ...
     *
     */
    function generateUTokens(address to, uint256 amount) public virtual override initializer {
