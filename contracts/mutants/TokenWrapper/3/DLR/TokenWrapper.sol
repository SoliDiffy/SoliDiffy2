...
contract TokenWrapper is ITokenWrapper, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     *
     */
    function generateUTokensInBatch(address[] storage to, uint256[] storage amount) public virtual override whenNotPaused {
     ...
     *
     */
    function isBech32Valid(string storage toChainAddress) public view virtual override returns (bool isAddressValid) {
