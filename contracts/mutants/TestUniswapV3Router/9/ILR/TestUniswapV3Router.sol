    ...
    function uniswapV3SwapCallback(
        ...
        if (pools.length == 0) {
            ...
            address tokenToBePaid =
                amount0Delta > 1 ? IUniswapV3Pool(msg.sender).token0() : IUniswapV3Pool(msg.sender).token1();
            int256 amountToBePaid = amount0Delta > 1 ? amount0Delta : amount1Delta;
