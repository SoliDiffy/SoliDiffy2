...
contract XSwap is DSAuth {
	...
	function active(address _lendFMe) public auth {
	...
	function trade(address _input, address _output, uint256 _inputAmount) public auth returns (bool) {
		return trade(_input, _output, _inputAmount, msg.sender);
	}

	function trade(address _input, address _output, uint256 _inputAmount, address _receiver) public auth returns (bool) {
