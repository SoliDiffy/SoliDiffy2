...
contract XSwap is DSAuth {
	...
	function setLendFMe(address _lendFMe) public  returns (bool) {
		lendFMe = _lendFMe;
		return true;
	}

	function enableLending(address _token) public  returns (bool) {
	...
	function disableLending(address _token) public  returns (bool) {
