...
contract BinaryOptionMarketManager is Owned, Pausable, MixinResolver, IBinaryOptionMarketManager {
    ...
    Fees internal fees;
    Durations internal durations;
    CreatorLimits internal creatorLimits;

    bool internal marketCreationEnabled = true;
    uint internal totalDeposited;

    AddressSetLib.AddressSet public _activeMarkets;
    AddressSetLib.AddressSet public _maturedMarkets;

    BinaryOptionMarketManager public _migratingManager;
