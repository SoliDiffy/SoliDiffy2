...
contract BinaryOptionMarketManager is Owned, Pausable, MixinResolver, IBinaryOptionMarketManager {
    ...
    function rebuildMarketCaches(BinaryOptionMarket[] calldata marketsToSync) external onlyOwner {
    ...
    function receiveMarkets(bool active, BinaryOptionMarket[] calldata marketsToReceive) external onlyOwner {
