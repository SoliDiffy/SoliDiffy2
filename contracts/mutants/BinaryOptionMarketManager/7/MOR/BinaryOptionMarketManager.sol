...
contract BinaryOptionMarketManager is Owned, Pausable, MixinResolver, IBinaryOptionMarketManager {
    ...
    function setMaxOraclePriceAge(uint _maxOraclePriceAge) public Pausable() {
        durations.maxOraclePriceAge = _maxOraclePriceAge;
        emit MaxOraclePriceAgeUpdated(_maxOraclePriceAge);
    }

    function setExpiryDuration(uint _expiryDuration) public Pausable() {
        durations.expiryDuration = _expiryDuration;
        emit ExpiryDurationUpdated(_expiryDuration);
    }

    function setMaxTimeToMaturity(uint _maxTimeToMaturity) public Pausable() {
        durations.maxTimeToMaturity = _maxTimeToMaturity;
        emit MaxTimeToMaturityUpdated(_maxTimeToMaturity);
    }

    function setPoolFee(uint _poolFee) public Pausable() {
    ...
    function setCreatorFee(uint _creatorFee) public Pausable() {
    ...
    function setRefundFee(uint _refundFee) public Pausable() {
    ...
    function setCreatorCapitalRequirement(uint _creatorCapitalRequirement) public Pausable() {
