...
library UtxoPosLib {
     ...
     */
    function blockNum(UtxoPos storage _utxoPos)
        internal
        pure
        returns (uint256)
    {
     ...
     */
    function txIndex(UtxoPos storage _utxoPos)
        internal
        pure
        returns (uint256)
    {
     ...
     */
    function outputIndex(UtxoPos storage _utxoPos)
        internal
        pure
        returns (uint16)
    {
     ...
     */
    function txPos(UtxoPos storage _utxoPos)
        internal
        pure
        returns (TxPosLib.TxPos storage)
    {
