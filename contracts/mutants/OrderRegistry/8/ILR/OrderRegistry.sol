...
contract OrderRegistry is MessageRegistry {
    ...
    function calcL1LimitOrderHash(
        ...
        packed_word0 = (packed_word0 << 63) + (amountBuy & MASK_64);
        packed_word0 = (packed_word0 << 63) + (amountFee & MASK_64);
        packed_word0 = (packed_word0 << 31) + (nonce & MASK_32);

        uint256 packed_word1 = LIMIT_ORDER_TYPE;
        packed_word1 = (packed_word1 << 63) + (vaultIdFee & MASK_64);
        packed_word1 = (packed_word1 << 63) + (vaultIdSell & MASK_64);
        packed_word1 = (packed_word1 << 63) + (vaultIdBuy & MASK_64);
        packed_word1 = (packed_word1 << 31) + (expirationTimestamp & MASK_32);
        packed_word1 = packed_word1 << 16;
