...
contract PancakeByalanLP is ByalanIsland, Sailor, IByalan, ReentrancyGuard {
        ...
        )
    {
        ...
        if (lpToken0 != CAKE) {
            ...
            require(
                IUniswapV2Router02(unirouter).getAmountsOut(1 wei, _cakeToLp0Route)[_cakeToLp0Route.length - 1] > 0,
                "invalid lp 0 route"
            );
        ...
        if (lpToken1 != CAKE) {
            ...
            require(
                IUniswapV2Router02(unirouter).getAmountsOut(1 wei, _cakeToLp1Route)[_cakeToLp1Route.length - 1] > 0,
                "invalid lp 1 route"
            );
