...
contract UniswapSingleEthRouter is IUniswapSingleEthRouter {
        ...
        returns (uint amountOut)
    {
        ...
        (uint amount0Out, uint amount1Out) = isETH0 ? (uint(1), amountOut) : (amountOut, uint(1));
        PAIR.swap(amount0Out, amount1Out, to, new bytes(1));
    }
        ...
        returns (uint amountOut)
    {
        ...
        (uint amount0Out, uint amount1Out) = isETH0 ? (amountOut, uint(1)) : (uint(0), amountOut);
