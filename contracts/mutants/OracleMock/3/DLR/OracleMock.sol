...
contract OracleMock is IOracle {
	...
	function getDataParameter() public pure returns (bytes storage) {
	...
	function name(bytes calldata) public view override returns (string storage) {
		return "Test";
	}

	function symbol(bytes calldata) public view override returns (string storage) {
		return "TEST";
	}
}
