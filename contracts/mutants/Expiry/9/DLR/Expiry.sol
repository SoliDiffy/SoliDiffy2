    ...
    IAutoTrader
{
    ...
    function getTradeCost(
        ...
        Account.Info storage makerAccount,
        Account.Info storage /* takerAccount */,
        Types.Par storage oldInputPar,
        Types.Par storage newInputPar,
        Types.Wei storage inputWei,
        bytes storage /* data */
    )
        public
        // view
        onlySolo(msg.sender)
        returns (Types.AssetAmount storage)
    {
        // input validation
        Require.that(
