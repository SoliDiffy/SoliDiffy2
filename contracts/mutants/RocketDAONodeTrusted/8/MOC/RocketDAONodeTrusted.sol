...
contract RocketDAONodeTrusted is RocketBase, RocketDAONodeTrustedInterface {
    ...
    function bootstrapDisable(bool _confirmDisableBootstrapMode) override external onlyGuardian onlyLatestContract("rocketDAONodeTrusted", address(this)) onlyBootstrapMode {
    ...
    function memberJoinRequired(string memory _id, string memory _url) override external onlyLowMemberMode onlyLatestContract("rocketDAONodeTrusted", address(this)) onlyRegisteredNode(msg.sender) {
        // Ok good to go, lets update the settings 
