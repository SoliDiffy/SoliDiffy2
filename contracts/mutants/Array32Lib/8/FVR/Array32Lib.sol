...
library Array32Lib {
  ...
  function getMax(uint32[] storage self) external view returns(uint32 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint32[] storage self) external view returns(uint32 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint32[] storage self) external {
  ...
  /// @param self Storage array containing uint256 type variables
  function uniq(uint32[] storage self) external returns (uint256 length) {
    bool contains;
    uint256 index;
