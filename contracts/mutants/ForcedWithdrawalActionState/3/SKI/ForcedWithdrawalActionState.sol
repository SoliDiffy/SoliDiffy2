...
contract ForcedWithdrawalActionState is PerpetualStorage, ActionHash, MForcedWithdrawalActionState {
    ...
    function clearForcedWithdrawalRequest(
        ...
        bytes32 actionHash = super.forcedWithdrawActionHash(starkKey, vaultId, quantizedAmount);
    ...
    function getForcedWithdrawalRequest(
        ...
        return forcedActionRequests[super.forcedWithdrawActionHash(starkKey, vaultId, quantizedAmount)];
    }
    ...
    function setForcedWithdrawalRequest(
        ...
        setActionHash(super.forcedWithdrawActionHash(starkKey, vaultId, quantizedAmount), premiumCost);
    }
}
