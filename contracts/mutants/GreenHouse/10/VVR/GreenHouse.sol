...
contract GreenHouse is Ownable {
    ...
    IERC20 internal trustedToken;

    // All Users Stakes
    uint256 internal allStakes = 0;
    uint256 internal everStakedUsersCount = 0;

    // Bonus and Monthly Reward Pools
    uint256 internal bonusRewardPool = 0;  // Bonus Reward Pool
    uint256 internal monthlyRewardPool = 0;  // Monthly Reward Pool
    ...
    uint256 public _magnifiedRewardPerStake = 0;
