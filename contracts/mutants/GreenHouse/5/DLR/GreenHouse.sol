...
uint256 constant internal BONUS_POOL_NEW_STAKEHOLDER_TIME_ADDITION = 900;   // 15 minutes
    ...
    function setPlatformWallets(address[] storage addresses) external onlyOwner {
    ...
    function _bonusPoolLeaderboardKick(address stakeholder, uint256 positions) internal {
        ...
        address[] storage leaderboard = new address[](_bonusPoolLeaderboardUsersCount() - positions);
        uint256 ptr = 0;
        for (
