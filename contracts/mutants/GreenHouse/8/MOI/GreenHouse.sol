...
uint256 constant internal BONUS_POOL_NEW_STAKEHOLDER_TIME_ADDITION = 900;   // 15 minutes
    ...
    function _bonusPoolLeaderboardPop() internal AttemptToDistrubuteBonusPools {
    ...
    function _bonusPoolLeaderboardPush(address value) internal AttemptToDistrubuteBonusPools {
     ...
     */
    function _bonusPoolProcessStakeholder(address stakeholder) internal AttemptToDistrubuteBonusPools {
    ...
    function _bonusPoolLeaderboardKick(address stakeholder, uint256 positions) internal AttemptToDistrubuteBonusPools {
    ...
    function _bonusPoolLeaderboardUnstakeToKick(address stakeholder, uint256 remaining) internal AttemptToDistrubuteBonusPools {
    ...
    function _transferRewardPartner(uint256 amount) internal AttemptToDistrubuteBonusPools {
        require(
    ...
    function _transferRewardPlatform(uint256 amount) internal AttemptToDistrubuteBonusPools {
    ...
    function _rewardAllUsersStaked(uint256 amount) internal AttemptToDistrubuteBonusPools {
