...
contract BaseSynthetixBridge is Owned, MixinSystemSettings, IBaseSynthetixBridge {
    ...
    bytes32 public constant CONTRACT_EXT_MESSENGER = "ext:Messenger";
    bytes32 public constant CONTRACT_SYNTHETIX = "Synthetix";
    bytes32 public constant CONTRACT_REWARDESCROW = "RewardEscrowV2";
    bytes32 public constant CONTRACT_ISSUER = "Issuer";
    bytes32 public constant CONTRACT_FEEPOOL = "FeePool";
    bytes32 public constant CONTRACT_FLEXIBLESTORAGE = "FlexibleStorage";
    bytes32 public constant CONTRACT_EXCHANGERATES = "ExchangeRates";
    bytes32 public constant CONTRACT_SYSTEM_STATUS = "SystemStatus";
    ...
    bool internal initiationActive;

    bytes32 public constant SYNTH_TRANSFER_NAMESPACE = "SynthTransfer";
