...
contract BaseSynthetixBridge is Owned, MixinSystemSettings, IBaseSynthetixBridge {
    ...
    function messenger() public view returns (iAbs_BaseCrossDomainMessenger) {
    ...
    function flexibleStorage() public view returns (IFlexibleStorage) {
    ...
    function initiatingActive() public view {
