...
contract StrategyCreamYFI {
    ...
    address constant internal want = address(0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e);

    Creamtroller internal constant creamtroller = Creamtroller(0x3d5BC3c8d13dcB8bF317092d84783c2697AE9258);

    address constant internal crYFI = address(0xCbaE0A83f4f9926997c8339545fb8eE32eDc6b76);
    address constant internal cream = address(0x2ba592F78dB6436527729929AAf6c908497cB200);

    address constant internal uni = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address constant internal weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // used for cream <> weth <> yfi route

    uint internal performanceFee = 500;
    uint constant internal performanceMax = 10000;

    uint internal withdrawalFee = 50;
