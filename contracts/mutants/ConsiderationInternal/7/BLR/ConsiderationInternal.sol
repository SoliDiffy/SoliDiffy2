...
contract ConsiderationInternal is ConsiderationInternalView {
    ...
    function _prepareBasicFulfillmentFromCalldata(
        ...
        _verifyTime(parameters.startTime, parameters.endTime, false);
    ...
    function _validateBasicOrderAndUpdateStatus(
        ...
        _verifyOrderStatus(
            orderHash,
            orderStatus,
            false, // Only allow unused orders when fulfilling basic orders.
            false // Signifies to revert if the order is invalid.
        );
        ...
        )
    {
        ...
        if (
            !_verifyOrderStatus(
                orderHash,
                orderStatus,
                true, // Allow partially used orders to be filled.
                revertOnInvalid
            )
        ) {
