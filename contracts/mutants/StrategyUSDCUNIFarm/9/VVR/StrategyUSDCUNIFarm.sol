...
contract StrategyUSDCUNIFarm  {
    ...
    address constant internal want = address(0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc);  //ETH/token

    address constant internal token = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);	//usdc
    address constant internal Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant internal fUNI = address(0xA79a083FDD87F73c2f983c5551EC974685D6bb36);
	address constant internal pool = address(0x156733b89Ac5C704F3217FEe2949A9D4A73764b5);
