...
library LinkedListLib {
    ...
    function listExists(LinkedList memory self)
        internal
        view returns (bool)
    {
    ...
    function nodeExists(LinkedList memory self, uint256 _node) 
        internal
        view returns (bool)
    {
    ...
    /// @param self stored linked list from contract
    function sizeOf(LinkedList memory self) internal view returns (uint256 numElements) {
        bool exists;
        uint256 i;
    ...
    function getNode(LinkedList memory self, uint256 _node)
    ...
    function getAdjacent(LinkedList memory self, uint256 _node, bool _direction)
    ...
    function getSortedSpot(LinkedList memory self, uint256 _node, uint256 _value, bool _direction)
