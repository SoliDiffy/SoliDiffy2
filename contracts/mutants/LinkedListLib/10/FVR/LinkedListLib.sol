...
library LinkedListLib {
    ...
    function createLink(LinkedList storage self, uint256 _node, uint256 _link, bool _direction) public  {
    ...
    function insert(LinkedList storage self, uint256 _node, uint256 _new, bool _direction) public returns (bool) {
    ...
    function remove(LinkedList storage self, uint256 _node) public returns (uint256) {
    ...
    function push(LinkedList storage self, uint256 _node, bool _direction) public  {
