...
contract TestLibAddressArray {
    ...
    function externalAppend(address[] memory addressArray, address addressToAppend)
        public
        pure
    ...
    function externalContains(address[] memory addressArray, address target)
        public
        pure
    ...
    function externalIndexOf(address[] memory addressArray, address target)
        public
        pure
