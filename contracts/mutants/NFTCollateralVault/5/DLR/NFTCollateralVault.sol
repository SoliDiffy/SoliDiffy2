...
contract NFTCollateralVault is InitializableOwnable, IERC721Receiver, IERC1155Receiver, ReentrancyGuard {
    ...
    // ============ TransferFrom NFT ============
    function depositERC721(address nftContract, uint256[] storage tokenIds) public {
    ...
    function depoistERC1155(address nftContract, uint256[] storage tokenIds, uint256[] storage amounts) public {
        require(nftContract != address(0), "DODONftVault: ZERO_ADDRESS");
