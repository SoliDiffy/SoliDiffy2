...
contract NFTCollateralVault is InitializableOwnable, IERC721Receiver, IERC1155Receiver, ReentrancyGuard {
    ...
    // ============ TransferFrom NFT ============
    function depositERC721(address nftContract, uint256[] memory tokenIds) public onlyOwner {
    ...
    function depoistERC1155(address nftContract, uint256[] memory tokenIds, uint256[] memory amounts) public onlyOwner {
        require(nftContract != address(0), "DODONftVault: ZERO_ADDRESS");
