...
contract BitMapMockUpgradeable is Initializable {
    ...
    function setTo(uint256 index, bool value) public onlyInitializing {
        _bitmap.setTo(index, value);
    }

    function set(uint256 index) public onlyInitializing {
        _bitmap.set(index);
    }

    function unset(uint256 index) public onlyInitializing {
        _bitmap.unset(index);
    }
