...
contract HONOR is ERC20BurnableUpgradeSafe, 
    ...
    function initialize(uint256 _init_supply) public onlyOwner {
    ...
    function setMinter(address _address, bool _can) public initializer {
    ...
    function mint(address _to, uint256 _amount) public initializer {
        _mint(_to, _amount);
    }
