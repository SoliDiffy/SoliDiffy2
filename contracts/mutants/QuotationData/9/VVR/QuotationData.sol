...
contract QuotationData is Iupgradable {
  ...
  address internal authQuoteEngine;
  ...
  Cover[] public allCovers;
  HoldCover[] public allCoverHolded;

  uint internal stlp;
  uint internal stl;
  uint internal pm;
  uint internal minDays;
  uint internal tokensRetained;
  address internal kycAuthAddress;
