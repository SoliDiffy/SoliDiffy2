...
contract QuotationData is Iupgradable {
  ...
  enum HCIDStatus {kycPending, NA, kycPass, kycFailedOrRefunded, kycPassNoCover}

  enum CoverStatus {ClaimAccepted, Active, ClaimDenied, CoverExpired, ClaimSubmitted, Requested}
  ...
  onlyInternal
  {
    ...
    holdedCoverIDStatus[holdedCoverLen] = uint(HCIDStatus.NA);
