...
library LibDeterministicQuotes {
        ...
        returns (uint8 decimals)
    {
        ...
        bytes32 seed = sha256(abi.encodePacked(token));
    ...
    {
        bytes32 seed = sha256(abi.encodePacked(salt, sellToken, buyToken));
    ...
    FailTrigger
{
    ...
    constructor(address _tokenAddress) public {
        ...
        salt = sha256(abi.encodePacked(BASE_SALT, _tokenAddress));
    }
