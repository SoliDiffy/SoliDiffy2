...
contract DsgNft is IDsgNft, ERC721, InitializableOwner, ReentrancyGuard, Pausable
{
    ...
    EnumerableSet.AddressSet public _minters;
     ...
     */
    bytes4 public constant _INTERFACE_ID_GET_ROYALTIES = 0xbb3bafd6;
    bytes4 public constant _INTERFACE_ID_ROYALTIES = 0xb282e1fc;

    uint256 public _tokenId = 1000;

    uint256 internal constant maxLevel = 6;

    string public _baseURIVar;
