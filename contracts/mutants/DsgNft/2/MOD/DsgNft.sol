...
contract DsgNft is IDsgNft, ERC721, InitializableOwner, ReentrancyGuard, Pausable
{
    ...
    ) public override nonReentrant onlyMinter returns(uint256 tokenId){
    ...
    function upgradeNft(uint256 nftId, uint256 materialNftId) public override whenNotPaused nonReentrant
    {
