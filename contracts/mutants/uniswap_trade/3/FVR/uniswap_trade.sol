...
contract UniswapV2Trade is TradeUtils {
     ...
     */
    constructor(UniswapV2 _uniswapV2) internal {
    ...
    function trade(IERC20 srcToken, uint srcQty, IERC20 destToken, uint amountOutMin) external payable returns (address, uint) {
    ...
    function ethToToken(address[] memory path, uint srcQty, uint amountOutMin) public returns (uint[] memory) {
