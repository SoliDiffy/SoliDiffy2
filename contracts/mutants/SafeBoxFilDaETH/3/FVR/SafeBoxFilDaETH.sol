...
contract SafeBoxFilDaETH is SafeBoxCTokenETH {
    ...
    constructor (
        address _bank,
        address _cToken
    ) internal SafeBoxCTokenETH(_bank, _cToken) {
    }
    ...
    function setFildaPool(address _actionPoolFilda, uint256 _piddeposit, uint256 _pidborrow) external onlyOwner {
    ...
    function checkFildaPool(address _fildaPool, uint256 _pid, uint256 _fildacallid) public view {
