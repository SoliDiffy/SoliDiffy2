...
contract TokenWhitelist is ENSResolvable, Controllable, Ownable, Claimable {
    ...
    function getTokenInfo(address _a) external view returns (string, uint256, uint256, bool, bool, bool, uint256) {
        ...
        return (tokenInfo.symbol, tokenInfo.lastUpdate, tokenInfo.magnitude, tokenInfo.burnable, tokenInfo.available, tokenInfo.loadable, tokenInfo.rate);
    }
    ...
    function getStablecoinInfo() external view returns (string, uint256, uint256, bool, bool, bool, uint256) {
        ...
        return (stablecoinInfo.symbol, stablecoinInfo.lastUpdate, stablecoinInfo.magnitude, stablecoinInfo.burnable, stablecoinInfo.available, stablecoinInfo.loadable, stablecoinInfo.rate);
    }
