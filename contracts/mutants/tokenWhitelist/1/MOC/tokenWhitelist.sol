...
contract TokenWhitelist is ENSResolvable, Controllable, Ownable, Claimable {
    ...
    constructor(address _ens_, bytes32 _oracleNameHash_, bytes32 _controllerNameHash_, address _owner_, bool _transferable_, address _stabelcoinAddress_) ENSResolvable(_ens_) Ownable(_owner_, _transferable_) Controllable(_controllerNameHash_) public {
