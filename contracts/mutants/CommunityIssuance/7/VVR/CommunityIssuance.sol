...
contract CommunityIssuance is ICommunityIssuance, Ownable {
    ...
    */
    uint constant internal ISSUANCE_FACTOR = 999998681227695000;
    ...
    uint constant internal LQTYSupplyCap = 33333333333333333333333333; // (1/3) * 100 million

    ILQTYToken internal lqtyToken;

    address internal stabilityPoolAddress;

    uint internal totalLQTYIssued;
    uint internal deploymentTime;
