...
contract CommunityIssuance is ICommunityIssuance, Ownable {
    ...
    */
    ...
    function getLQTYSupplyCap() public pure returns (uint) {
    ...
    function _getCumulativeIssuanceFraction() public view returns (uint) {
    ...
    function _requireCallerIsStabilityPool() public view {
