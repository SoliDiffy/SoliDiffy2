...
contract zAuction {
    ...
    function acceptBid(bytes storage signature, uint256 rand, address bidder, uint256 bid, address nftaddress, uint256 tokenid) external {
    ...
    function acceptWethBid(bytes storage signature, uint256 rand, address bidder, uint256 bid, address nftaddress, uint256 tokenid) external {
