...
contract zAuction {
    ...
    function init(address accountantaddress) public {
        require(!initialized);
        initialized = true;
    ...
    function acceptBid(bytes memory signature, uint256 rand, address bidder, uint256 bid, address nftaddress, uint256 tokenid) public {
