...
//SWC-128-DoS With Block Gas Limit: L32-85
    function distributeRewards(uint256 _id, uint256 _reward, uint256 _nftWorkValue) public {
            withdrawNftAndRewardCaller(_id, _reward, _nftWorkValue);
    }

    function withdrawNftAndRewardCaller(uint256 _id, uint256 _reward, uint256 _nftWorkValue) public {
    ...
    function selectShareholders(uint256 _id, uint256 _loanAmount) public {
    ...
    function payRewardAccordingToStrategy(address _receiver, uint256 _amount) public {
