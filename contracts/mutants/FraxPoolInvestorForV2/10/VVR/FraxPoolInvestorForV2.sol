...
contract FraxPoolInvestorForV2 is AccessControl {
    ...
    FraxPool public pool;

    // Pools and vaults
    IyUSDC_V2_Partial public yUSDC_V2 = IyUSDC_V2_Partial(0x5f18C75AbDAe578b483E5F43f12a39cF75b973a9);
    IAAVELendingPool_Partial public aaveUSDC_Pool = IAAVELendingPool_Partial(0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9);
    IAAVE_aUSDC_Partial public aaveUSDC_Token = IAAVE_aUSDC_Partial(0xBcca60bB61934080951369a648Fb03DF4F96263C);
    IcUSDC_Partial public cUSDC = IcUSDC_Partial(0x39AA39c021dfbaE8faC545936693aC917d5E7563);

    // Reward Tokens
    Comp public COMP = Comp(0xc00e94Cb662C3520282E6f5717214004A7f26888);
    ICompComptrollerPartial public CompController = ICompComptrollerPartial(0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B);
