...
contract TokenTimelockUpgradeable is Initializable {
    ...
    function __TokenTimelock_init_unchained(
        ...
        require(releaseTime_ > block.number, "TokenTimelock: release time is before current time");
        _token = token_;
    ...
    function release() public virtual {
        require(block.number >= releaseTime(), "TokenTimelock: current time is before release time");
