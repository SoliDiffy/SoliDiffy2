...
contract GUniLPOracleTest is DSTest {
    ...
    function assertEqApprox(uint256 _a, uint256 _b, uint256 _tolerance) public {
        uint256 a = _a;
        uint256 b = _b;
        if (a < b) {
            uint256 tmp = a;
    ...
    function assertNotEqApprox(uint256 _a, uint256 _b, uint256 _tolerance) public {
        uint256 a = _a;
        uint256 b = _b;
        if (a < b) {
            uint256 tmp = a;
    ...
    function giveAuthAccess (address _base, address target) public {
