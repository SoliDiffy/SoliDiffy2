...
contract FilterERC1155V1 is IERC1155Receiver, BaseFilterV1 {
    ...
    function ERC1155TargetOut(
        ...
        address to
    ) public preventReentrant returns (uint256 paid) {
        uint256 totalAmount = 0;
    ...
    function _maintainERC1155Out(uint256 index, uint256 tokenId) public {
    ...
    function _maintainERC1155In(uint256 tokenId) public returns (uint256 inAmount) {
        uint256 currentAmount = IERC1155(_NFT_COLLECTION_).balanceOf(address(this), tokenId);
