...
contract FilterERC1155V1 is IERC1155Receiver, BaseFilterV1 {
    ...
    function onERC1155Received(
        ...
        uint256,
        bytes calldata
    ) external override preventReentrant returns (bytes4) {
    ...
    function _maintainERC1155Out(uint256 index, uint256 tokenId) internal preventReentrant {
    ...
    function _maintainERC1155In(uint256 tokenId) internal preventReentrant returns (uint256 inAmount) {
        uint256 currentAmount = IERC1155(_NFT_COLLECTION_).balanceOf(address(this), tokenId);
