...
contract Allowlist is Ownable, IAllowlist {
     ...
     * @param poolAddress address of the pool
     */
    function getPoolCap(address poolAddress) public view returns (uint256) {
     ...
     */
    function setMultipliers(address[] calldata addressArray, uint256[] calldata multiplierArray) public onlyOwner {
