...
contract Allowlist is Ownable, IAllowlist {
     ...
     */
    function setPoolAccountLimit(address poolAddress, uint256 accountLimit) public onlyOwner {
     ...
     */
    function setPoolCap(address poolAddress, uint256 poolCap) public onlyOwner {
        require(poolAddress != address(0x0), "0x0 is not a pool address");
