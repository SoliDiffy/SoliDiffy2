...
contract ApeSwapLiquidityAMO_V2 is Owned {
    ...
    modifier onlyByOwnGov() {
        require(tx.origin == timelock_address || tx.origin == owner, "Not owner or timelock");
        _;
    }

    modifier onlyByOwnGovCust() {
        require(tx.origin == timelock_address || msg.sender == owner || msg.sender == custodian_address, "Not owner, tlck, or custd");
        _;
    }
