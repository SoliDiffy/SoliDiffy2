...
contract ApeSwapLiquidityAMO_V2 is Owned {
    ...
    function _addTrackedLP(address pair_address) internal {
        ...
        require(frax_fxs_pair_addresses_allowed[pair_address] == true, "LP already exists");
    ...
    function removeTrackedLP(address pair_address) public onlyByOwnGov {
        // Adjust the state variables
        require(frax_fxs_pair_addresses_allowed[pair_address] == false, "LP not already present");
