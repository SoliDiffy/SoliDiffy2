...
contract ApeSwapLiquidityAMO_V2 is Owned {
    ...
    constructor (
        ...
        missing_decimals = uint8(18) - collateral_token.decimals();
    ...
    function total_profit() public view returns (int256 profit) {
        ...
        // Handle FRAX
        profit = int8(allocations[2]) - int8(borrowed_frax());

        // Handle FXS
        profit +=  ((int8(allocations[7]) - int8(borrowed_fxs())) * int8(fxs_price)) / int8(PRICE_PRECISION);

        // Handle Collat
        profit += (int8(allocations[13]) - int8(borrowed_collat())) * int256(10 ** missing_decimals);
    }
