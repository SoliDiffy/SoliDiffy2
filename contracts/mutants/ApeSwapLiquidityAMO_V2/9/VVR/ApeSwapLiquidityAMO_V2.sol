...
contract ApeSwapLiquidityAMO_V2 is Owned {
    ...
    CrossChainCanonicalFXS public canFXS;
    CrossChainBridgeBacker_BSC_AnySwap internal cc_bridge_backer;
    ERC20 public collateral_token;
    address internal canonical_frax_address;
    address internal canonical_fxs_address;
    address internal collateral_token_address;

    // Important addresses
    address internal timelock_address;
    address internal custodian_address;
