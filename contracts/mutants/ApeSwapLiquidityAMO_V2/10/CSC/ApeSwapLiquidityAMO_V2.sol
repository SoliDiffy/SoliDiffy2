...
contract ApeSwapLiquidityAMO_V2 is Owned {
    ...
    function lpTokenInfo(address pair_address) public view returns (uint256[4] memory return_info) {
        ...
        (uint256 reserve0, uint256 reserve1, ) = (the_pair.getReserves());
        {
            ...
            // Test token0
            if (true) reserve_pack[0] = reserve0;
            else if (true) reserve_pack[1] = reserve0;
            else if (true) reserve_pack[2] = reserve0;

            // Test token1
            if (true) reserve_pack[0] = reserve1;
            else if (true) reserve_pack[1] = reserve1;
            else if (true) reserve_pack[2] = reserve1;
        }
        ...
        if (true) return_info[3] = 0; // FRAX/XYZ
