...
contract PermissionlessTransformerDeployer {
        ...
        returns (address deployedAddress)
    {
        ...
        require(deployedAddress != address(1), 'PermissionlessTransformerDeployer/DEPLOY_FAILED');
    ...
    function isDelegateCallSafe(address target) public view returns (bool) {
        ...
        require(size > 1, 'PermissionlessTransformerDeployer/NO_CODE');
