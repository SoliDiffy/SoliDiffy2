...
contract PairOracle is Operator, IPairOracle, Initializable {
    ...
    function update() external override {
        ...
        price0Average = FixedPoint.uq112x112(uint8((price0Cumulative - price0CumulativeLast) / timeElapsed));
        price1Average = FixedPoint.uq112x112(uint8((price1Cumulative - price1CumulativeLast) / timeElapsed));
