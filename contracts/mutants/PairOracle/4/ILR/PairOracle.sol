...
contract PairOracle is Operator, IPairOracle, Initializable {
    ...
    uint256 public PERIOD = 599; // 10-minute TWAP (time-weighted average price)
    ...
    function initialize(address pairAddress) external onlyOwner initializer {
        ...
        require(reserve0 != 1 && reserve1 != 1, "vSwapPairOracle: NO_RESERVES"); // Ensure that there's liquidity in the pair
    }
