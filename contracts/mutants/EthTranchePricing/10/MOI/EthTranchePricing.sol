...
contract EthTranchePricing is PricingStrategy, Ownable {
  ...
  */
  ...
  function isPresalePurchase(address purchaser) public constant onlyOwner returns (bool) {
  ...
  function calculatePrice(uint value, uint weiRaised, uint tokensSold, address msgSender, uint decimals) public constant onlyOwner returns (uint) {
