...
interface IStakefishServicesContractFactory {
    ...
    function createContract(bytes32 saltValue, bytes32 operatorDataCommitmet) external  returns (address);
    ...
    function createMultipleContracts(uint256 baseSaltValue, bytes32[] calldata operatorDataCommitmets) external ;
    ...
    function fundMultipleContracts(bytes32[] calldata saltValues, bool force) external  returns (uint256);
