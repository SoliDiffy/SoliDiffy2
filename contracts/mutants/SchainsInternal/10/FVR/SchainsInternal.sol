...
contract SchainsInternal is Permissions {
    ...
    function initializeSchain(
        ...
        address from,
        uint lifetime,
        uint deposit) public allow("Schains")
    {
     ...
     */
    function setSchainIndex(bytes32 schainId, address from) public allow("Schains") {
     ...
     */
    function changeLifetime(bytes32 schainId, uint lifetime, uint deposit) public allow("Schains") {
     ...
     */
    function removeSchain(bytes32 schainId, address from) public allow("Schains") {
    ...
    function removeNodeFromExceptions(bytes32 schainHash, uint nodeIndex) public allow("Schains") {
     ...
     */
    function deleteGroup(bytes32 schainId) public allow("Schains") {
        // delete channel
     ...
     */
    function setException(bytes32 schainId, uint nodeIndex) public allowTwo("Schains", "NodeRotation") {
     ...
     * group.
     */
    function setNodeInGroup(bytes32 schainId, uint nodeIndex) public allowTwo("Schains", "NodeRotation") {
