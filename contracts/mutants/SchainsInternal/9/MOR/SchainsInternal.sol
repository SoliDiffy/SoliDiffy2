...
contract SchainsInternal is Permissions {
    ...
    function initializeSchain(
        ...
        address from,
        uint lifetime,
        uint deposit) external initializer
    {
     ...
     */
    function setSchainIndex(bytes32 schainId, address from) external initializer {
     ...
     */
    function changeLifetime(bytes32 schainId, uint lifetime, uint deposit) external initializer {
     ...
     */
    function removeSchain(bytes32 schainId, address from) external initializer {
    ...
    function removeNodeFromExceptions(bytes32 schainHash, uint nodeIndex) external initializer {
     ...
     */
    function deleteGroup(bytes32 schainId) external initializer {
        // delete channel
     ...
     */
    function setException(bytes32 schainId, uint nodeIndex) external initializer {
