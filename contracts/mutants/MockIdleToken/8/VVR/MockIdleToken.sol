...
contract MockIdleToken is ERC20, MockERC20 {
  ...
  uint256 internal apr;
  uint256 internal lossOnRedeem;
  uint256 internal _tokenPriceWithFee;
  uint256 internal _redeemTokenPriceWithFee;
  uint256 internal govAmount;
