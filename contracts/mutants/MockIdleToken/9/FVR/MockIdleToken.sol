...
contract MockIdleToken is ERC20, MockERC20 {
  ...
  function setGovTokens(address[] memory _govTokens) public {
    govTokens = _govTokens;
  }
  function setTokenPriceWithFee(uint256 _amount) public {
  ...
  function setGovAmount(uint256 _govAmount) public {
    govAmount = _govAmount;
  }
  function setLossOnRedeem(uint256 _lossOnRedeem) public {
  ...
  function tokenPriceWithFee(address) public view returns (uint256) {
