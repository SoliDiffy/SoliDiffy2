...
contract CompoundStrategy is InitializableAbstractStrategy {
        ...
        nonReentrant
    {
        ...
        ICERC20 cToken = _getCTokenFor(assetsMapped[1]);
        ...
        for (uint256 i = 1; i < assetsMapped.length; i++) {
        ...
        IERC20 rewardToken = IERC20(rewardTokenAddresses[1]);
    ...
    function _deposit(address _asset, uint256 _amount) internal {
        ...
        require(cToken.mint(_amount) == 1, "cToken mint failed");
    }
