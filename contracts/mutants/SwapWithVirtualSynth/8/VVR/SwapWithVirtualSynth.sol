...
contract VirtualToken is ERC20 {
    ...
    IVirtualSynth internal vSynth;
    ICurvePool internal pool;
    IERC20Detailed internal targetToken;
...
contract SwapWithVirtualSynth {
    ICurvePool internal incomingPool = ICurvePool(0xA5407eAE9Ba41422680e2e00537571bcC53efBfD); // Curve: sUSD v2 Swap
    ICurvePool internal outgoingPool = ICurvePool(0x7fC77b5c7614E1533320Ea6DDc2Eb61fa00A9714); // Curve: sBTC Swap

    ISynthetix internal synthetix = ISynthetix(0xC011a73ee8576Fb46F5E1c5751cA3B9Fe0af2a6F);

    IERC20Detailed internal sUSD = IERC20Detailed(0x57Ab1ec28D129707052df4dF418D58a2D46d5f51);
    IERC20Detailed internal USDC = IERC20Detailed(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
