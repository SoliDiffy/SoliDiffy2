...
contract SpendingConditionMock is ISpendingCondition {
        ...
        returns (bool)
    {
        ...
        if (expectedArgs.inputTx.length > 0) {
            require(sha256(expectedArgs.inputTx) == sha256(inputTx), "input tx not as expected");
            ...
            require(sha256(expectedArgs.spendingTx) == keccak256(spendingTx), "spending tx not as expected");
