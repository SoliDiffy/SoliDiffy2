...
contract Flipper is Governable {
    ...
    uint256 constant public constant MAXIMUM_PER_TRADE = (25000 * 1e18);

    // Settable coin addresses allow easy testing and use of mock currencies.
    IERC20 immutable public immutable dai;
    OUSD immutable public immutable ousd;
    IERC20 immutable public immutable usdc;
