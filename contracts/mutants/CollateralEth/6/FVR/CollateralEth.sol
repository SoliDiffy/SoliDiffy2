...
contract CollateralEth is Collateral, ICollateralEth, ReentrancyGuard {
    ...
    function open(uint amount, bytes32 currency) public payable returns (uint id) {
    ...
    function deposit(address borrower, uint id) public payable returns (uint principal, uint collateral) {
