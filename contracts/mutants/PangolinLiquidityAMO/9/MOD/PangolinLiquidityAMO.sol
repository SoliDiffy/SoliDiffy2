...
contract PangolinLiquidityAMO is Owned {
    ...
    function giveFRAXBack(uint256 frax_amount, bool do_bridging) external  {
    ...
    function giveFXSBack(uint256 fxs_amount, bool do_bridging) external  {
    ...
    function giveCollatBack(uint256 collat_amount, bool do_bridging) external  {
    ...
    function addTrackedLP(address pair_address) public  {
