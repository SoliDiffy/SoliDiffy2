...
contract MdexRouter is IMdexRouter, Ownable {
  ...
  function removeLiquidity(
    ...
    address to,
    uint256 deadline
  ) public virtual override onlyOwner returns (uint256 amountA, uint256 amountB) {
    address pair = pairFor(tokenA, tokenB);
  ...
  function removeLiquidityETH(
    ...
    address to,
    uint256 deadline
  ) public virtual override onlyOwner returns (uint256 amountToken, uint256 amountETH) {
  ...
  function removeLiquidityETHSupportingFeeOnTransferTokens(
    ...
    address to,
    uint256 deadline
  ) public virtual override onlyOwner returns (uint256 amountETH) {
  ...
  function swapExactTokensForTokens(
    ...
    address to,
    uint256 deadline
  ) external virtual override onlyOwner returns (uint256[] memory amounts) {
  ...
  function swapExactETHForTokens(
    ...
    address to,
    uint256 deadline
  ) external payable virtual override onlyOwner returns (uint256[] memory amounts) {
