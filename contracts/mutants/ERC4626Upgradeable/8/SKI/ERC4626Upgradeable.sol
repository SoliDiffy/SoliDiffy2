...
abstract contract ERC4626Upgradeable is Initializable, ERC20Upgradeable, IERC4626Upgradeable {
    ...
    function deposit(uint256 assets, address receiver) public virtual override returns (uint256) {
        require(assets <= super.maxDeposit(receiver), "ERC4626: deposit more than max");
    ...
    function mint(uint256 shares, address receiver) public virtual override returns (uint256) {
        require(shares <= super.maxMint(receiver), "ERC4626: mint more than max");
    ...
    function withdraw(
        ...
        require(assets <= super.maxWithdraw(owner), "ERC4626: withdraw more than max");
    ...
    function redeem(
        ...
        require(shares <= super.maxRedeem(owner), "ERC4626: redeem more than max");
