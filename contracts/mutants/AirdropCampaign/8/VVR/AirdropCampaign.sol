...
contract AirdropCampaign is Owned {
    ...
    uint32 internal maxUnits;
    uint32 internal soldUnits;
    uint8 internal bronzeRewardTokens;
    uint8 internal silverRewardTokens;
    uint8 internal goldRewardTokens;
    uint8 internal silverRewardDistance; //each x-th investor gets silver reward
