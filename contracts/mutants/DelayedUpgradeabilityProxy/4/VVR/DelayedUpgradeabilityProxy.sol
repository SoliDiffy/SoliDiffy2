...
contract DelayedUpgradeabilityProxy is UpgradeabilityProxy {
    ...
    bool internal pendingImplementationIsSet;
    uint256 internal pendingImplementationApplicationDate; // Date on which to switch all contract calls to the new implementation
    uint256 internal UPGRADE_DELAY = 4 weeks;
