...
contract DelayedUpgradeabilityProxy is UpgradeabilityProxy {
    ...
    constructor(address _implementation) internal UpgradeabilityProxy(_implementation) {}
    ...
    */
    function _setPendingUpgrade(address implementation) public {
