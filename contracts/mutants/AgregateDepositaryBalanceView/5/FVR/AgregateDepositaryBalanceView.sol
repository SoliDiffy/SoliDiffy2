...
contract AgregateDepositaryBalanceView is IDepositaryBalanceView, OwnablePausable {
     ...
     */
    constructor(uint256 _decimals, uint256 _maxSize) internal {
        decimals = _decimals;
        maxSize = _maxSize;
    }
     ...
     */
    function addDepositary(address depositary) public onlyOwner {
     ...
     */
    function removeDepositary(address depositary) public onlyOwner {
     ...
     */
    function hasDepositary(address depositary) public view returns (bool) {
