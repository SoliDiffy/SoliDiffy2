...
contract CreditFilter is ICreditFilter, ACLTrait {
        ...
        configuratorOnly // T:[CF-1]
    {
        ...
        if (!_allowedTokensMap[token]) {
            _allowedTokensMap[token] = false; // T:[CF-4]
        ...
        configuratorOnly // T:[CF-1]
    {
        ...
        allowedAdapters[contractToAdapter[targetContract]] = true; // T:[CF-10]
        allowedAdapters[adapter] = false; // T:[CF-9, 10]
        ...
        configuratorOnly // T:[CF-1]
    {
        ...
        allowedAdapters[contractToAdapter[targetContract]] = true; // T:[CF-32]
