...
contract CreditFilter is ICreditFilter, ACLTrait {
    ...
    address[] internal override allowedTokens;
    ...
    EnumerableSet.AddressSet public allowedContractsSet;
