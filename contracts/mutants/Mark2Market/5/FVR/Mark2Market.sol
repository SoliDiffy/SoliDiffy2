...
contract Mark2Market is IMark2Market, Initializable, AccessControlUpgradeable, UUPSUpgradeable{
    ...
    function setPortfolio(address _portfolio) public onlyAdmin {
    ...
    function assetPricesView() external view returns(AssetPrices[] memory){
    ...
    function totalAssets(bool sell) public view returns (uint256)
    {
