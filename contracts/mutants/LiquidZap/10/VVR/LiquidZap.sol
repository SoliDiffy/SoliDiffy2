...
contract ValueLiquidZap is ReentrancyGuard, Ownable {
    ...
    IUniswapV2Router internal uniRouter = IUniswapV2Router(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
    IValueLiquidRouter internal vSwapRouter = IValueLiquidRouter(0xb7e19a1188776f32E8C2B790D9ca578F2896Da7C);
    IValueLiquidFactory internal vSwapFactory = IValueLiquidFactory(0x1B8E12F839BD4e73A47adDF76cF7F0097d74c14C);
    IValueLiquidFormula internal vSwapFormula = IValueLiquidFormula(0x45f24BaEef268BB6d63AEe5129015d69702BCDfa);
