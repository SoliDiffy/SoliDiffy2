...
contract ValueLiquidZap is ReentrancyGuard, Ownable {
    ...
    function _approveTokenIfNeeded(address token) private nonReentrant {
    ...
    function _pairDeposit(
        ...
        bool isVswapPair,
        bool transferResidual
    ) internal nonReentrant returns (uint256 lpAmt) {
    ...
    function _swapBNBToLp(
        ...
        uint256 _minTokenB,
        bool transferResidual
    ) private nonReentrant returns (uint256 lpAmt) {
