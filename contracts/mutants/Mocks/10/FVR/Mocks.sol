...
contract MockPoolFactory {
    ...
    function createPool(address poolDelegate_) public returns (address) {
...
contract MockPool {
    ...
    function createDebtLocker(address dlFactory, address loan) public returns (address) {
    ...
    function triggerDefault(address debtLocker) public {
...
contract MockLiquidationStrategy {
    ...
    function flashBorrowLiquidation(address lender_, uint256 swapAmount_, address collateralAsset_, address fundsAsset_) public {
    ...
    function swap(address collateralAsset_, address fundsAsset_, uint256 swapAmount_, uint256 repaymentAmount_) public {
...
contract MockGlobals {
    ...
    function getLatestPrice(address asset_) public view returns (uint256 price_) {
    ...
    function investorFee() public pure returns (uint256 investorFee_) {
        return 50;
    }

    function treasuryFee() public pure returns (uint256 treasuryFee_) {
        return 50;
    }
