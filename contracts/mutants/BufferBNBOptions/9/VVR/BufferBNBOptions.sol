    ...
    AccessControl
{
    ...
    uint256 internal optionCollateralizationRatio = 100;
    uint256 internal settlementFeePercentage = 4;
    uint256 internal stakingFeePercentage = 75;
    uint256 internal referralRewardPercentage = 50;
