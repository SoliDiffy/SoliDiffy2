    ...
    AccessControl
{
     ...
     */
    function setSettlementFeePercentage(uint256 value) public onlyOwner {
     ...
     */
    function setStakingFeePercentage(uint256 value) public onlyOwner {
     ...
     */
    function setReferralRewardPercentage(uint256 value) public onlyOwner {
     ...
     */
    function setOptionCollaterizationRatio(uint256 value) public onlyOwner {
     ...
     */
    function canExercise(uint256 optionID) public view returns (bool){
