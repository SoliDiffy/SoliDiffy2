...
contract IWbtcPoolBase is ICurvePool, Ownable{
  ...
  function setController(address _controller, address _vault) external onlyOwner{
  ...
  function callWithData(address payable to, bytes memory data)external payable onlyOwner{
