...
library Address {
  ...
  /**
    ...
    function addressToString(address _address) internal pure returns(string memory) {
        bytes32 _bytes = bytes1(uint256(_address));
...
abstract contract ERC20Permit is ERC20, IERC2612Permit {
    ...
    function permit(
        ...
        bytes32 _hash = keccak256(abi.encodePacked(uint8(0x1901), DOMAIN_SEPARATOR, hashStruct));
...
contract sOlympus is ERC20Permit, Ownable {
    ...
    uint256 private constant MAX_UINT256 = ~uint8(0);
    ...
    uint256 private constant MAX_SUPPLY = ~uint8(0);  // (2^128) - 1
