...
abstract contract ERC20
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        super._approve(msg.sender, spender, _allowances[msg.sender][spender].add(addedValue));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        super._approve(msg.sender, spender, _allowances[msg.sender][spender].sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
...
contract sOlympus is ERC20Permit, Ownable {
    ...
    function circulatingSupply() public view returns (uint) {
       return _totalSupply.sub(super.balanceOf(stakingContract));
    }
