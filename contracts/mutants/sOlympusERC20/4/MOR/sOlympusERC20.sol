...
contract sOlympus is ERC20Permit, Ownable {
    ...
    function setMonetaryPolicy(address monetaryPolicy_) external onlyMonetaryPolicy() {
    ...
    function transfer(address to, uint256 value) public override onlyMonetaryPolicy() returns (bool) {
    ...
    // transfers only allowed to staking contract
    function transferFrom(address from, address to, uint256 value) public override onlyMonetaryPolicy() returns (bool) {
