...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function clearUnremovableValidator(address _unremovableStakingAddress) external gasPriceIsValid {
    ...
    function incrementStakingEpoch() external gasPriceIsValid {
    ...
    function removePool(address _stakingAddress) external gasPriceIsValid {
    ...
    function removeMyPool() external onlyValidatorSetContract onlyInitialized {
    ...
    function moveStake(
        ...
        uint256 _amount
    ) external onlyValidatorSetContract onlyInitialized {
    ...
    function stake(address _toPoolStakingAddress, uint256 _amount) external onlyValidatorSetContract onlyInitialized {
    ...
    function stakeNative(address _toPoolStakingAddress) external onlyValidatorSetContract onlyInitialized payable {
    ...
    /// by the `maxWithdrawAllowed` getter.
    function withdraw(address _fromPoolStakingAddress, uint256 _amount) external onlyValidatorSetContract onlyInitialized {
    ...
    function orderWithdraw(address _poolStakingAddress, int256 _amount) external onlyValidatorSetContract onlyInitialized {
