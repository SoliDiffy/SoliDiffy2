...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    uint256 internal constant MAX_CANDIDATES = 3000;
    ...
    uint256 internal constant MAX_DELEGATORS_PER_POOL = 3000;
    ...
    bytes32 public constant CANDIDATE_MIN_STAKE = keccak256("candidateMinStake");
    bytes32 public constant DELEGATOR_MIN_STAKE = keccak256("delegatorMinStake");
    bytes32 public constant ERC20_RESTRICTED = keccak256("erc20Restricted");
    bytes32 public constant ERC20_TOKEN_CONTRACT = keccak256("erc20TokenContract");
    bytes32 public constant POOLS = keccak256("pools");
    bytes32 public constant POOLS_INACTIVE = keccak256("poolsInactive");
