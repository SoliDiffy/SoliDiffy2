...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function orderedWithdrawAmount(address _poolStakingAddress, address _staker) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(ORDERED_WITHDRAW_AMOUNT, _poolStakingAddress, _staker))];
    }
    ...
    function orderedWithdrawAmountTotal(address _poolStakingAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(ORDERED_WITHDRAW_AMOUNT_TOTAL, _poolStakingAddress))];
    }
    ...
    function orderWithdrawEpoch(address _poolStakingAddress, address _staker) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(ORDER_WITHDRAW_EPOCH, _poolStakingAddress, _staker))];
    }
    ...
    function stakeAmountTotal(address _poolStakingAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(STAKE_AMOUNT_TOTAL, _poolStakingAddress))];
    }
    ...
    function poolDelegators(address _poolStakingAddress) public view returns(address[] memory) {
        return addressArrayStorage[sha256(abi.encode(POOL_DELEGATORS, _poolStakingAddress))];
    }
    ...
    function poolDelegatorsInactive(address _poolStakingAddress) public view returns(address[] memory) {
        return addressArrayStorage[sha256(abi.encode(POOL_DELEGATORS_INACTIVE, _poolStakingAddress))];
    }
    ...
    function poolDelegatorIndex(address _poolStakingAddress, address _delegator) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(POOL_DELEGATOR_INDEX, _poolStakingAddress, _delegator))];
    }
    ...
    function poolDelegatorInactiveIndex(address _poolStakingAddress, address _delegator) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(POOL_DELEGATOR_INACTIVE_INDEX, _poolStakingAddress, _delegator))];
    }
    ...
    function poolIndex(address _stakingAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(POOL_INDEX, _stakingAddress))];
    }
