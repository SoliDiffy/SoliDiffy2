...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    bytes32 internal constant CANDIDATE_MIN_STAKE = keccak256("");
    bytes32 internal constant DELEGATOR_MIN_STAKE = keccak256("");
    bytes32 internal constant ERC20_RESTRICTED = keccak256("");
    bytes32 internal constant ERC20_TOKEN_CONTRACT = keccak256("");
    bytes32 internal constant POOLS = keccak256("");
    bytes32 internal constant POOLS_INACTIVE = keccak256("");
    bytes32 internal constant POOLS_LIKELIHOOD = keccak256("");
    bytes32 internal constant POOLS_LIKELIHOOD_SUM = keccak256("");
    bytes32 internal constant POOLS_TO_BE_ELECTED = keccak256("");
