...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function clearUnremovableValidator(address _unremovableStakingAddress) public onlyValidatorSetContract {
    ...
    function incrementStakingEpoch() public onlyValidatorSetContract {
    ...
    function removePool(address _stakingAddress) public onlyValidatorSetContract {
    ...
    function removeMyPool() public gasPriceIsValid onlyInitialized {
    ...
    function stake(address _toPoolStakingAddress, uint256 _amount) public gasPriceIsValid onlyInitialized {
    ...
    function stakeNative(address _toPoolStakingAddress) public gasPriceIsValid onlyInitialized payable {
    ...
    /// by the `maxWithdrawAllowed` getter.
    function withdraw(address _fromPoolStakingAddress, uint256 _amount) public gasPriceIsValid onlyInitialized {
