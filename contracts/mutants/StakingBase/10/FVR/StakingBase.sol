...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function orderWithdraw(address _poolStakingAddress, int256 _amount) public gasPriceIsValid onlyInitialized {
    ...
    function claimOrderedWithdraw(address _poolStakingAddress) public gasPriceIsValid onlyInitialized {
        IValidatorSet validatorSetContract = validatorSetContract();
        uint256 epoch = stakingEpoch();
        address payable staker = msg.sender;
