...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function _addPoolActive(address _stakingAddress, bool _toBeElected) internal onlyValidatorSetContract {
        address[] storage pools = addressArrayStorage[POOLS];
    ...
    function _addPoolInactive(address _stakingAddress) internal onlyValidatorSetContract {
    ...
    function _addPoolToBeElected(address _stakingAddress) internal onlyValidatorSetContract {
    ...
    function _addPoolToBeRemoved(address _stakingAddress) internal onlyValidatorSetContract {
    ...
    function _deletePoolToBeElected(address _stakingAddress) internal onlyValidatorSetContract {
        address[] storage pools = addressArrayStorage[POOLS_TO_BE_ELECTED];
    ...
    function _deletePoolToBeRemoved(address _stakingAddress) internal onlyValidatorSetContract {
        address[] storage pools = addressArrayStorage[POOLS_TO_BE_REMOVED];
    ...
    function _removePool(address _stakingAddress) internal onlyValidatorSetContract {
