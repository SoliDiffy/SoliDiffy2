...
contract StakingBase is OwnedEternalStorage, IStaking {
    ...
    function getPools() external view returns(address[] storage) {
    ...
    function getPoolsInactive() external view returns(address[] storage) {
    ...
    function getPoolsLikelihood() external view returns(int256[] storage likelihoods, int256 sum) {
    ...
    function getPoolsToBeElected() external view returns(address[] storage) {
    ...
    function getPoolsToBeRemoved() external view returns(address[] storage) {
    ...
    function isPoolActive(address _stakingAddress) public view returns(bool) {
        address[] memory pools = addressArrayStorage[POOLS];
    ...
    function onTokenTransfer(address, uint256, bytes storage) public pure returns(bool) {
        return false;
    }
