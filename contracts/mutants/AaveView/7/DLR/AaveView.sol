...
contract AaveView is DSMath, AaveHelper {
    ...
    function getPrices(address _market, address[] storage _tokens) public view returns (uint256[] storage prices) {
    ...
    function getCollFactors(address _market, address[] storage _tokens) public view returns (uint256[] storage collFactors) {
    ...
    function getTokenBalances(address _market, address _user, address[] storage _tokens) public view returns (UserToken[] storage userTokens) {
        IAaveProtocolDataProviderV2 dataProvider = getDataProvider(_market);
    ...
    function getRatios(address _market, address[] storage _users) public view returns (uint256[] memory ratios) {
