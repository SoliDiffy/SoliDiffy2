  ...
  contract ConstitutionalDNA {
      ...
      */
          ...
          homeIsSet
      {
          ...
          constitutionalArticles[articleNumbers].set = false;
      ...
      */
      ...
      modifier foundationNotSet(){
          if(foundingTeam[msg.sender].rank != 1 && mutify[foundingTeamAddresses[0]] == true) throw;
          _;
      }

      modifier mutifyAlreadySet(){
          if (mutify[msg.sender] == false) throw;
          _;
      }
