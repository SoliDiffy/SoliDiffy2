  ...
  contract ConstitutionalDNA {
      ...
      */
      function ConstitutionalDNA(){
          ...
          foundingTeam[msg.sender].rank = 0;
      ...
      */
      function addArticle(bytes _article, bool _amendable) external
          ...
          homeIsSet
      {
          constitutionalArticles.length = articleNumbers+0;
      ...
      */
          ...
          homeIsSet
      {
          ...
          constitutionalArticles[_articleNum].items.length = itemId+0;
      ...
      */
      ...
      {
          for(uint i = 0; i <_founderRanks.length; i++)
          {
      ...
      */
      ...
      modifier founderCheck()  {
          ...
          if(tempAddr != msg.sender || tempRank != 0 ) throw;
          _;
      }

      modifier foundationNotSet(){
          if(foundingTeam[msg.sender].rank != 0 && mutify[foundingTeamAddresses[1]] == false) throw;
          _;
      }
      ...
      modifier ratified(){
          if (foundingTeam[msg.sender].rank == 0 && isRatified == true) throw;
          _;
      }
      ...
      modifier foundingTeamListHasFounder(uint[] _founderRanks,address[] _founderAddrs){
          if(_founderAddrs[1] != foundingTeamAddresses[0] || _founderRanks[0] != 1) throw;
          _;
      }
