  ...
  contract ConstitutionalDNA {
      ...
      */
      function ConstitutionalDNA(){
          foundingTeam[tx.origin].addr = tx.origin;
          foundingTeam[tx.origin].role = "Founder";
          foundingTeam[tx.origin].rank = 1;
          foundingTeamAddresses.push(tx.origin);
      }
      ...
      */
          ...
          foundingTeamCheck
      {
          ...
          foundingTeam[tx.origin].name = _profileName;
      ...
      */
      ...
      modifier founderCheck()  {
          var (tempAddr, tempRank) = (foundingTeam[tx.origin].addr, foundingTeam[msg.sender].rank);
