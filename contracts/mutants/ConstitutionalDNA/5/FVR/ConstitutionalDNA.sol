  ...
  */
  contract ConstitutionalDNA {
      ...
      */
      function addArticle(bytes _article, bool _amendable) public
          founderCheck
          ratified
          homeIsSet
      {
      ...
      */
      function addArticleItem(uint _articleNum, bytes _itemText) public
          founderCheck
      ...
      */
      function getArticleItem(uint _articleNum, uint _item) external constant returns (bytes article, uint articleNum, bool amendible, bytes itemText)
      {
