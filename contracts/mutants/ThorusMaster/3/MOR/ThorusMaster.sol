...
contract ThorusMaster is Ownable, ReentrancyGuard {
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken) external nonReentrant {
        massUpdatePools();
    ...
    function set(uint256 _pid, uint256 _allocPoint) external nonReentrant {
    ...
    function setThorusPerSecond(uint256 _thorusPerSecond) external nonReentrant {
