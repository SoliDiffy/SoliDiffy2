...
interface IRibbonThetaVault {
    ...
    function vaultParams() external view returns (Vault.VaultParams storage);

    function vaultState() external view returns (Vault.VaultState storage);

    function optionState() external view returns (Vault.OptionState storage);
