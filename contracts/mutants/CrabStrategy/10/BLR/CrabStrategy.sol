...
contract CrabStrategy is StrategyBase, StrategyFlashSwap, ReentrancyGuard {
    ...
    function _strategyFlash(
        ...
        if (FLASH_SOURCE(_callSource) == FLASH_SOURCE.FLASH_DEPOSIT) {
            ...
            IWETH9(weth).withdraw(IWETH9(weth).balanceOf(address(this)));
            _executeSellAuction(_caller, data.ethProceeds, data.wSqueethAmount, data.ethProceeds, false);
            ...
            FlashHedgeData memory data = abi.decode(_callData, (FlashHedgeData));
            _executeBuyAuction(_caller, data.wSqueethAmount, data.ethProceeds, false);
    ...
    function _hedge(
        ...
        if (isSellingAuction) {
            ...
            _executeSellAuction(msg.sender, msg.value, wSqueethToAuction, ethProceeds, true);
        } else {
            ...
            _executeBuyAuction(msg.sender, wSqueethToAuction, ethProceeds, true);
        }
