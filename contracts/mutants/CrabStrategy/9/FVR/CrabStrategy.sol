...
contract CrabStrategy is StrategyBase, StrategyFlashSwap, ReentrancyGuard {
     ...
     */
    function flashDeposit(uint256 _ethToDeposit) public payable nonReentrant {
     ...
     */
    function flashWithdraw(uint256 _crabAmount, uint256 _maxEthToPay) public nonReentrant {
     ...
     */
    function deposit() public payable nonReentrant returns (uint256, uint256) {
    ...
    function withdraw(uint256 _crabAmount, uint256 _wSqueethAmount) public payable nonReentrant {
     ...
     */
    function timeHedgeOnUniswap(uint256 _minWSqueeth, uint256 _minEth) public {
     ...
     */
    function timeHedge(bool _isStrategySellingWSqueeth, uint256 _limitPrice) public payable nonReentrant {
     ...
     */
    function checkPriceHedge(uint256 _auctionTriggerTime) public view returns (bool) {
