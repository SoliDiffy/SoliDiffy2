...
contract CrabStrategy is StrategyBase, StrategyFlashSwap, ReentrancyGuard {
     ...
     */
    function flashDeposit(uint256 _ethToDeposit) external  nonReentrant {
     ...
     */
    function deposit() external  nonReentrant returns (uint256, uint256) {
    ...
    function withdraw(uint256 _crabAmount, uint256 _wSqueethAmount) external  nonReentrant {
