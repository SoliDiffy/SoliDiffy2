...
contract WusdAaveStrategy is Ownable {
    ...
    IERC20 internal immutable usdc = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    IERC20 internal immutable wmatic = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    IERC20 internal immutable amUsdc = IERC20(0x1a13F4Ca1d028320A707D99520AbFefca3998b7F);
    ILendingPool internal immutable lendingPool = ILendingPool(0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf);
    IAaveIncentivesController internal immutable rewardsContract = IAaveIncentivesController(0x357D51124f59836DeD84c8a1730D72B749d8BC23);
    IWUSDMaster internal immutable wusdMaster = IWUSDMaster(0xc9fF58Bd2A1CB4FAB0fEC5A0D061527Db1fbb923);
    
    uint256 internal usdcInvestedAmount = 0;
