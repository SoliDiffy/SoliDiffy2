...
contract ReleaseGold is UsingRegistry, ReentrancyGuard, IReleaseGold, InitializableV2 {
   ...
   */
  constructor(bool test) internal InitializableV2(test) {}
   ...
   */
  function transfer(address to, uint256 value) public onlyWhenInProperState {
   ...
   */
  function setLiquidityProvision() public onlyReleaseOwner {
   ...
   */
  function setCanExpire(bool _canExpire) public onlyBeneficiary {
    require(
   ...
   *                          indicating % of total balance available for distribution.
   */
  function setMaxDistribution(uint256 distributionRatio) public onlyReleaseOwner {
