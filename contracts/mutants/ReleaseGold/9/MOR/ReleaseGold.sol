...
contract ReleaseGold is UsingRegistry, ReentrancyGuard, IReleaseGold, InitializableV2 {
   ...
   */
  function setCanExpire(bool _canExpire) external onlyWhenInProperState {
    require(
   ...
   *                          indicating % of total balance available for distribution.
   */
  function setMaxDistribution(uint256 distributionRatio) external onlyWhenInProperState {
   ...
   */
  function setBeneficiary(address payable newBeneficiary) external onlyWhenInProperState {
   ...
   */
  function withdraw(uint256 amount) external onlyWhenInProperState onlyBeneficiary {
   ...
   */
  function refundAndFinalize() external onlyWhenInProperState onlyReleaseOwnerAndRevoked {
   ...
   */
  function revoke() external onlyWhenInProperState onlyReleaseOwner onlyRevocable {
