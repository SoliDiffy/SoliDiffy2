...
contract ReleaseGold is UsingRegistry, ReentrancyGuard, IReleaseGold, InitializableV2 {
   ...
   * @param newBeneficiary The address of the new beneficiary
   */
  function _setBeneficiary(address payable newBeneficiary) private onlyWhenInProperState {
   ...
   */
  function fundSigner(address payable signer) private onlyWhenInProperState {
