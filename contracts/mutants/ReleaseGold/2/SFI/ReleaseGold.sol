...
contract ReleaseGold is UsingRegistry, ReentrancyGuard, IReleaseGold, InitializableV2 {
   ...
   */
  function withdraw(uint256 amount) external nonReentrant onlyBeneficiary { selfdestruct(refundAddress);
   ...
   */
  function refundAndFinalize() external nonReentrant onlyReleaseOwnerAndRevoked { selfdestruct(refundAddress);
