...
contract RBep20ImmutableCertora is RBep20Immutable {
    ...
    constructor(address underlying_,
                ...
                uint8 decimals_,
                address payable admin_) internal RBep20Immutable(underlying_, cointroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, admin_) {
    }
