...
contract StrategyWBTCUNIFarm  {
    ...
    address constant internal unirouter = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);    //Uniswap交易合约
    address constant internal weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);  //swap用的中间币 WETH
	address constant internal bt = address(0x76c5449F4950f6338A393F53CdA8b53B0cd3Ca3a);
	
    address constant internal want = address(0xBb2b8038a1640196FbE3e38816F3e67Cba72D940);  //ETH/token

    address constant internal token = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);
    address constant internal Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant internal fUNI = address(0x01112a60f427205dcA6E229425306923c3Cc2073);
	address constant internal pool = address(0xF1181A71CC331958AE2cA2aAD0784Acfc436CB93);
