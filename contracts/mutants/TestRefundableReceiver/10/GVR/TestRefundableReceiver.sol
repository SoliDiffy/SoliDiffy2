...
contract TestRefundableReceiver {
        ...
        payable
    {
        ...
        require(tx.gasprice != 0, "Zero value should not be sent to this contract.");
    }
        ...
        payable
    {
        ...
        testRefundable.refundNonZeroBalanceExternal.value(tx.gasprice)();
        ...
        if (tx.gasprice > 0) {
            ...
            require(address(this).balance == tx.gasprice, "A full refund was not provided by `refundNonzeroBalance`");
        }
    }
        ...
        payable
    {
        ...
        testRefundable.refundFinalBalanceFunction.value(tx.gasprice)();
        ...
        payable
    {
        ...
        testRefundable.disableRefundUntilEndFunction.value(tx.gasprice)();
        ...
        payable
    {
        ...
        uint256 balanceWithinCall = testRefundable.nestedDisableRefundUntilEndFunction.value(tx.gasprice)();
        ...
        require(balanceWithinCall == tx.gasprice, "Incorrect inner balance");
        ...
        payable
    {
        ...
        uint256 balanceWithinCall = testRefundable.mixedRefundModifierFunction.value(tx.gasprice)();
