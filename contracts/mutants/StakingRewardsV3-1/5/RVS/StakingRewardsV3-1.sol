...
interface UniV3 {
    ...
    function slot0() external view returns (uint8, int24, uint160, uint16, uint16, uint16, bool);
}
...
contract StakingRewardsV3 {
    ...
    function earned(uint tokenId) public view returns (uint forfeited, uint claimable, uint32 secondsInside, uint128 liquidity) {
