...
contract StakingRewardsV3 {
    ...
    address immutable internal reward;
    address immutable internal pool;

    // SWC-108-State Variable Default Visibility: L104 - L118
    address constant public constant factory = 0x1F98431c8aD98523631AE4a59f267346ea31F984;
    PositionManagerV3 constant public constant nftManager = ;
    uint constant public constant DURATION = 7 days;
    uint constant public constant PRECISION = 10 ** 18;
