...
contract RocketStorage is RocketStorageInterface {
    ...
    function setGuardian(address _newAddress) external override onlyLatestRocketNetworkContract {
    ...
    function confirmGuardian() external override onlyLatestRocketNetworkContract {
    ...
    // Set this as being deployed now
    function setDeployedStatus() external onlyLatestRocketNetworkContract {
