...
contract RocketStorage is RocketStorageInterface {
    ...
    /// @param _key The key for the record
    function deleteAddress(bytes32 _key)  override external {
        assembly {
            sstore (_key, 0)
        }
    }
    ...
    /// @param _key The key for the record
    function deleteUint(bytes32 _key)  override external {
        assembly {
            sstore (_key, 0)
        }
    }
    ...
    /// @param _key The key for the record
    function deleteString(bytes32 _key)  override external {
