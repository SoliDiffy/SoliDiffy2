...
contract RocketStorage is RocketStorageInterface {
    ...
    function updateWithdrawalAddress(address _nodeAddress, address _newWithdrawalAddress) private onlyLatestRocketNetworkContract {
    ...
    function _setBool(bytes32 _key, bool _value) private onlyLatestRocketNetworkContract {
        assembly {
            sstore (_key, _value)
        }
    }
