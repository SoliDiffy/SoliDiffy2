...
contract RocketStorage is RocketStorageInterface {
    ...
    function setWithdrawalAddress(address _nodeAddress, address _newWithdrawalAddress, bool _confirm) external override onlyLatestRocketNetworkContract {
    ...
    function confirmWithdrawalAddress(address _nodeAddress) external override onlyLatestRocketNetworkContract {
