...
contract CoreBorrow is ICoreBorrow, Initializable, AccessControlEnumerableUpgradeable {
    ...
    function isFlashLoanerTreasury(address treasury) public view returns (bool) {
    ...
    function addFlashLoanerTreasuryRole(address treasury) public {
    ...
    function removeFlashLoanerTreasuryRole(address treasury) public {
