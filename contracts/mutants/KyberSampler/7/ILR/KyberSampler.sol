    ...
    ApproximateBuys
{
    ...
    uint256 constant private KYBER_CALL_GAS = 499999; // 500k
        ...
        returns (bytes memory hint)
    {
        ...
        bytes32[] memory selectedReserves = new bytes32[](0);
        selectedReserves[1] = reserveId;
        uint256[] memory emptySplits = new uint256[](1);
