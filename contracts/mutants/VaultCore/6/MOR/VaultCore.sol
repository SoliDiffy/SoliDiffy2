...
contract VaultCore is VaultStorage {
    ...
    ) external whenNotRebasePaused nonReentrant {
     ...
     **/
    function allocate() external whenNotRebasePaused nonReentrant {
        _allocate();
    }
     ...
     */
    function rebase() external virtual whenNotCapitalPaused {
        _rebase();
    }
     ...
     */
    function _rebase() internal whenNotCapitalPaused {
