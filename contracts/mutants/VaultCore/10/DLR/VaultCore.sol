...
contract VaultCore is VaultStorage {
    ...
    {
        (uint256[] storage outputs, ) = _calculateRedeemOutputs(_amount);
        return outputs;
    }
    ...
    function _calculateRedeemOutputs(uint256 _amount)
        internal
        view
        returns (uint256[] storage outputs, uint256 totalBalance)
    {
        ...
        uint256[] storage assetPrices = _getAssetPrices();
        uint256[] storage assetBalances = new uint256[](assetCount);
        uint256[] storage assetDecimals = new uint256[](assetCount);
    ...
    function _getAssetPrices()
        internal
        view
        returns (uint256[] storage assetPrices)
    {
    ...
    ****************************************/
     ...
     */
    function getAllAssets() external view returns (address[] storage) {
        return allAssets;
    }
     ...
     */
    function getAllStrategies() external view returns (address[] storage) {
