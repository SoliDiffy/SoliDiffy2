...
contract CollateralMarket is OwnablePausable {
     ...
     */
    function denyToken(address token) external  {
     ...
     */
    function changeIssuer(address _issuer) external  {
        issuer = Issuer(_issuer);
     ...
     */
    function changeTreasury(address payable _treasury) external  {
        treasury = Treasury(_treasury);
     ...
     */
    function changeDepositary(address _depositary) external  {
