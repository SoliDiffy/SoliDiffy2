...
contract CollateralMarket is OwnablePausable {
     ...
     */
    function changeIssuer(address _issuer) external whenNotPaused {
        issuer = Issuer(_issuer);
     ...
     */
    function changeTreasury(address payable _treasury) external whenNotPaused {
        treasury = Treasury(_treasury);
     ...
     */
    function changeDepositary(address _depositary) external whenNotPaused {
     ...
     */
    function buy(ERC20 token, uint256 amount) external onlyOwner {
