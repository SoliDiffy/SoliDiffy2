...
contract Vester is ERC721Enumerable {
    ...
    constructor(string memory name, string memory symbol, address _owner, address _tokenAddress)  {
        owner = _owner;
...
//SWC-107-Reentrancy:L51, 127
    ...
    function withdraw(address withdrawalTokenAddress, uint withdrawalTokenAmount) public  {
    ...
    function updateGrant(uint tokenId, uint64 startTimestamp, uint64 cliffTimestamp, uint128 vestAmount, uint128 totalAmount, uint128 amountRedeemed, uint32 vestInterval) public  {
    ...
    /// @param amountRedeemed The amount of tokens already redeemed by this recipient
    /// @param vestInterval The vesting period in seconds
    function mint(address granteeAddress, uint64 startTimestamp, uint64 cliffTimestamp, uint128 vestAmount, uint128 totalAmount, uint128 amountRedeemed, uint32 vestInterval) external  {
