...
library Interest {
        ...
        returns (Index memory)
    {
        ...
        uint256 borrowInterest = rate.value.add(uint256(currentTime).add(index.lastUpdate));
        ...
        if (Types.isZero(supplyWei)) {
            ...
            supplyInterest = Decimal.add(borrowInterest, earningsRate);
        ...
        return Index({
            borrow: Math.getPartial(index.borrow, borrowInterest, BASE).sub(index.borrow).to96(),
