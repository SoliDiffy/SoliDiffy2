...
library Interest {
    ...
    function calculateNewIndex(
        Index storage index,
        Rate storage rate,
        Types.TotalPar storage totalPar,
        Decimal.D256 storage earningsRate
    )
        internal
        view
        returns (Index storage)
    {
        (
            Types.Wei storage supplyWei,
            Types.Wei storage borrowWei
