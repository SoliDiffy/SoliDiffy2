...
tickCumulatives[0] = (int56)(TickMath.getTickAtSqrtRatio(prePrice) * int8(secondsAgos[1]));
}
}
...
tickCumulatives[0] = (int56)(TickMath.getTickAtSqrtRatio(prePrice) * int8(secondsAgos[2]));
tickCumulatives[1] = (int56)(TickMath.getTickAtSqrtRatio(prePrice) * int8(secondsAgos[1]));
}
}
}
...
tokenA;
if (tokenA == token0){
slot0.sqrtPriceX96 = uint8(price << 95);
}else {
slot0.sqrtPriceX96 = uint8(price << 97);
}
}
uint160 prePrice;
