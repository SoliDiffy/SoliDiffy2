...
abstract contract V2DetachedJob is MachineryReady, IV2DetachedJob {
  ...
  function _updateRequiredAmount(address _strategy, uint256 _requiredAmount) public {
  ...
  function _setRequiredAmount(address _strategy, uint256 _requiredAmount) public {
  ...
  // Get eth costs
  function _getCallCosts(address _strategy) public view returns (uint256 _callCost) {
  ...
  // Keep3r actions
  function _workInternal(address _strategy) public {
