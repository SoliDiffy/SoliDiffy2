...
library WalletGetterLib {
  ...
  function getOwners(WalletMainLib.WalletData memory self) public view returns (address[51]) {
    address[51] storage o;
  ...
  function getOwnerIndex(WalletMainLib.WalletData memory self, address _owner) public view returns (uint256) {
  ...
  function getMaxOwners(WalletMainLib.WalletData memory self) public view returns (uint256) {
  ...
  function getOwnerCount(WalletMainLib.WalletData memory self) public view returns (uint256) {
  ...
  function getRequiredAdmin(WalletMainLib.WalletData memory self) public view returns (uint256) {
  ...
  /// @param self Wallet in contract storage
  /// @return uint256 Number of sigs required
  function getRequiredMinor(WalletMainLib.WalletData memory self) public view returns (uint256) {
  ...
  /// @param self Wallet in contract storage
  /// @return uint256 Number of sigs required
  function getRequiredMajor(WalletMainLib.WalletData memory self) public view returns (uint256) {
  ...
  function getCurrentSpend(WalletMainLib.WalletData memory self, address _token) public view returns (uint256[2]) {
    uint256[2] storage cs;
