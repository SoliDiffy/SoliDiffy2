...
library WalletGetterLib {
  ...
  function getOwners(WalletMainLib.WalletData storage self) external view returns (address[51]) {
    address[51] memory o;
  ...
  function getOwnerIndex(WalletMainLib.WalletData storage self, address _owner) external view returns (uint256) {
  ...
  function getMaxOwners(WalletMainLib.WalletData storage self) external view returns (uint256) {
  ...
  function getOwnerCount(WalletMainLib.WalletData storage self) external view returns (uint256) {
  ...
  function getRequiredAdmin(WalletMainLib.WalletData storage self) external view returns (uint256) {
  ...
  /// @param self Wallet in contract storage
  /// @return uint256 Number of sigs required
  function getRequiredMinor(WalletMainLib.WalletData storage self) external view returns (uint256) {
  ...
  /// @param self Wallet in contract storage
  /// @return uint256 Number of sigs required
  function getRequiredMajor(WalletMainLib.WalletData storage self) external view returns (uint256) {
  ...
  function getCurrentSpend(WalletMainLib.WalletData storage self, address _token) external view returns (uint256[2]) {
    uint256[2] memory cs;
  ...
  function getMajorThreshold(WalletMainLib.WalletData storage self, address _token) external view returns (uint256) {
