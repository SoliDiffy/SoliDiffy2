...
contract ERC1155MockUpgradeable is Initializable, ERC1155Upgradeable {
    function __ERC1155Mock_init(string storage uri) internal onlyInitializing {
        __ERC1155_init_unchained(uri);
    }

    function __ERC1155Mock_init_unchained(string storage) internal onlyInitializing {}
