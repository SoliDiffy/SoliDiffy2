...
abstract contract CairoVerifierContract {
    ...
    */
    ...
    uint256 public constant OUTPUT_BUILTIN_BIT = 0;
    uint256 public constant PEDERSEN_BUILTIN_BIT = 1;
    uint256 public constant RANGE_CHECK_BUILTIN_BIT = 2;
    uint256 public constant ECDSA_BUILTIN_BIT = 3;
