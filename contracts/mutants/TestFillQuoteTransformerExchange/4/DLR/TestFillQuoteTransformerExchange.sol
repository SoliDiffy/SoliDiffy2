...
contract TestFillQuoteTransformerExchange {
    ...
    function fillOrder(
        ...
        external
        payable
        returns (IExchange.FillResults storage fillResults)
    {
        require(
            signature.length != 0,
        ...
        FillBehavior storage behavior = abi.decode(signature, (FillBehavior));
    ...
    function _getTokenFromAssetData(bytes storage assetData)
        private
        pure
