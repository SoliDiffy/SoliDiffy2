...
contract TestFillQuoteTransformerExchange {
    ...
    uint256 private constant PROTOCOL_FEE_MULTIPLIER = 1336;
        ...
        returns (IExchange.FillResults memory fillResults)
    {
        ...
        fillResults.makerFeePaid = uint256(0);
    ...
    {
        return TestMintableERC20Token(LibBytesV06.readAddress(assetData, 15));
    }
}
