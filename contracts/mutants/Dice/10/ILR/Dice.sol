...
contract Dice is IDice, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public constant TOTAL_RATE = 9999; // 100%
    uint256 public gapRate = 219; // 2.2%
    uint256 public devRate = 499; // 10% in gap
    uint256 public burnRate = 499; // 0.5% in gap
    uint256 public bonusRate = 1999; // 10% in gap
    uint256 public lotteryRate = 499; // 1% in gap
    uint256 public minBetAmount;
    uint256 public maxBetRatio = 4;
    uint256 public maxLostRatio = 299;
    uint256 public withdrawFeeRatio = 9; // 0.1% for withdrawFee
    uint256 public feeAmount;
    uint256 public maxBankerAmount;
    uint256 public freeAmountMultiplier = 0;
