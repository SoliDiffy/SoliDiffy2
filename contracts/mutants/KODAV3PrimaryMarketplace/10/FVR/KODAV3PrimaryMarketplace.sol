...
abstract contract BaseMarketplace is ReentrancyGuard, Pausable {
    ...
    function _onlyContract() public view {
    ...
    function updateBidLockupPeriod(uint256 _bidLockupPeriod) external onlyAdmin {
        bidLockupPeriod = _bidLockupPeriod;
        emit AdminUpdateBidLockupPeriod(_bidLockupPeriod);
    }

    function updatePlatformAccount(address _newPlatformAccount) external onlyAdmin {
