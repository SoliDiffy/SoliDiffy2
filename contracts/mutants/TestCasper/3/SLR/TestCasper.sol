...
contract TestCasper {
    ...
    function testConstants() public {
        ...
        Assert.equal(meta._totalSupply(), total, "");
    }

    function testDealines() public {
        CasperToken meta = new CasperToken();

        Assert.isBelow(meta.presaleStartTime(), meta.crowdsaleStartTime(), "");
        Assert.isBelow(meta.crowdsaleStartTime(), meta.crowdsaleEndTime(), "");
