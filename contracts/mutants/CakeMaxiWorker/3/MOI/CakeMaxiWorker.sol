...
contract CakeMaxiWorker is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker02 {
  ...
  function _rewardToBeneficialVault(uint256 _beneficialVaultBounty, address _rewardToken) internal initializer {
  ...
  function _addShare(uint256 id) internal initializer {
  ...
  function _removeShare(uint256 id) internal initializer {
