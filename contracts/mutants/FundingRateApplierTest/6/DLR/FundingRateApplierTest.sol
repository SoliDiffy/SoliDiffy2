...
contract FundingRateApplierTest is FundingRateApplier {
    ...
    function calculateEffectiveFundingRate(
        ...
        FixedPoint.Signed storage fundingRatePerSecond,
        FixedPoint.Unsigned storage currentCumulativeFundingRateMultiplier
    ) public pure returns (FixedPoint.Unsigned storage, FixedPoint.Signed storage) {
        return
    ...
    // Required overrides.
    function _pfc() internal view virtual override returns (FixedPoint.Unsigned storage currentPfc) {
