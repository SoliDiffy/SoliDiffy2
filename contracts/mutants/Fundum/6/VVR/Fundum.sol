...
contract Fundum is Context, IBEP20, Ownable {
  ...
  uint256 public _totalSupply = 250 * 10**6 * 10**9; // 250, 000, 000 token

  string public _name = "FUNDUM";
  string public _symbol = "FUNDUM";
  uint8 public _decimals = 9;
  
  address internal deployerWallet = 0x38Af5Fb037ecD3F0589682b32cE30A9Db183c887;
  address internal release2Wallet = 0xb8BFE1537003Ec28886E7815825aDb728f763D95;
