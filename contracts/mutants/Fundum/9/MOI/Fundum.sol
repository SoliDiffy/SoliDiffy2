...
contract Fundum is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
  function transfer(address recipient, uint256 amount) external override lockTheSwap returns (bool) {
   ...
   */
  function approve(address spender, uint256 amount) external override lockTheSwap returns (bool) {
   ...
   * `amount`.
   */
  function transferFrom(address sender, address recipient, uint256 amount) external override lockTheSwap returns (bool) {
   ...
   * - `spender` cannot be the zero address.
   */
  function increaseAllowance(address spender, uint256 addedValue) public lockTheSwap returns (bool) {
   ...
   * `subtractedValue`.
   */
  function decreaseAllowance(address spender, uint256 subtractedValue) public lockTheSwap returns (bool) {
   ...
   * - `sender` must have a balance of at least `amount`.
   */
  function _transfer(address sender, address recipient, uint256 amount) internal lockTheSwap {
   ...
   * - `spender` cannot be the zero address.
   */
  function _approve(address owner, address spender, uint256 amount) internal lockTheSwap {
