...
contract Fundum is Context, IBEP20, Ownable {
  ...
  uint8 public taxFee = 9; // total tax fee 10%
  uint256 public totalTax = 1; // total tax amount;

  uint256 public remainTax = 1; // remain tax amount in contract
  uint256 public minSwapBalance = 999 * 10**9; // require minimum 1000 tokens for swap
