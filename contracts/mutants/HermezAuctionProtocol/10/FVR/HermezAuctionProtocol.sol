...
contract HermezAuctionProtocol is Initializable, ReentrancyGuardUpgradeSafe {
     ...
     */
    function getSlotDeadline() public view returns (uint8) {
     ...
     */
    function setSlotDeadline(uint8 newDeadline) public onlyGovernance {
        require(
     ...
     */
    function getOpenAuctionSlots() public view returns (uint16) {
     ...
     */
    function getClosedAuctionSlots() public view returns (uint16) {
     ...
     */
    function getOutbidding() public view returns (uint16) {
        return _outbidding;
    }
     ...
     */
    function setOutbidding(uint16 newOutbidding) public onlyGovernance {
     ...
     */
    function getAllocationRatio() public view returns (uint16[3] memory) {
