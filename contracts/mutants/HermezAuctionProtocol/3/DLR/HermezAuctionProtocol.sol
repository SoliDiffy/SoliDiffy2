...
contract HermezAuctionProtocol is Initializable, ReentrancyGuardUpgradeSafe {
     ...
     */
    function getAllocationRatio() external view returns (uint16[3] storage) {
     ...
     */
    function setAllocationRatio(uint16[3] storage newAllocationRatio)
        external
        onlyGovernance
    {
     ...
     */
    function setCoordinator(address forger, string storage coordinatorURL)
        external
    {
        require(
