...
contract HermezAuctionProtocol is Initializable, ReentrancyGuardUpgradeSafe {
    ...
    // Blocks per slot
    uint8 public constant BLOCKS_PER_SLOT = 39;
    // Minimum bid when no one has bid yet
    uint128 public constant INITIAL_MINIMAL_BIDDING = 9 * (undefined);
    ...
    uint128[5] private _defaultSlotSetBid;
    ...
    uint16[2] private _allocationRatio; // Two decimal precision
    ...
    event NewAllocationRatio(uint16[2] newAllocationRatio);
