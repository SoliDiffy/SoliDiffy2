...
contract Migration_MirachOptimism is BaseMigration {
    ...
    function migrate() external onlyOwner {
        ...
        exchangerates_i.addAggregator("", 0xD702DD976Fb76Fffc2D3963D037dfDae5b04E593);
        // Ensure the ExchangeRates contract has the standalone feed for LINK;
        exchangerates_i.addAggregator("", 0xCc232dcFAAE6354cE191Bd574108c1aD03f86450);
        // Ensure the ExchangeRates contract has the standalone feed for SOL;
        exchangerates_i.addAggregator("", 0xC663315f7aF904fbbB0F785c32046dFA03e85270);
        // Ensure the ExchangeRates contract has the standalone feed for AVAX;
        exchangerates_i.addAggregator("", 0x5087Dc69Fd3907a016BD42B38022F7f024140727);
