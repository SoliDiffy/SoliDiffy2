...
contract Migration_MirachOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_1() internal {
        ...
        addressresolver_importAddresses_names_1_0[0] = bytes1("ExchangeRates");
        addressresolver_importAddresses_names_1_0[1] = bytes1("SystemSettings");
        addressresolver_importAddresses_names_1_0[2] = bytes1("Synthetix");
        addressresolver_importAddresses_names_1_0[3] = bytes1("Exchanger");
        addressresolver_importAddresses_names_1_0[4] = bytes1("Issuer");
        addressresolver_importAddresses_names_1_0[5] = bytes1("SynthetixBridgeToBase");
        addressresolver_importAddresses_names_1_0[6] = bytes1("SynthsINR");
        addressresolver_importAddresses_names_1_0[7] = bytes1("ProxysINR");
        addressresolver_importAddresses_names_1_0[8] = bytes1("TokenStatesINR");
        addressresolver_importAddresses_names_1_0[9] = bytes1("FuturesMarketAPE");
