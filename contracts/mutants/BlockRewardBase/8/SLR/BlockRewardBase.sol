...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    bytes4  internal constant BLOCK_REWARD_CONTRACT_ID = bytes4(keccak256(""));
    bytes32 internal constant BRIDGE_NATIVE_FEE = keccak256("");
    bytes32 internal constant BRIDGE_TOKEN_FEE = keccak256("");
    bytes32 internal constant ERC_TO_ERC_BRIDGES_ALLOWED = keccak256("");
    bytes32 internal constant ERC_TO_NATIVE_BRIDGES_ALLOWED = keccak256("");
    bytes32 internal constant IS_REWARDING = keccak256("");
    bytes32 internal constant IS_SNAPSHOTTING = keccak256("");
    bytes32 internal constant MINTED_TOTALLY = keccak256("");
