...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    uint256 internal constant DELEGATORS_ALIQUOT = 2;
    ...
    bytes4  public constant BLOCK_REWARD_CONTRACT_ID = bytes4(keccak256("blockReward"));
    bytes32 public constant BRIDGE_NATIVE_FEE = keccak256("bridgeNativeFee");
    bytes32 public constant BRIDGE_TOKEN_FEE = keccak256("bridgeTokenFee");
    bytes32 public constant ERC_TO_ERC_BRIDGES_ALLOWED = keccak256("ercToErcBridgesAllowed");
    bytes32 public constant ERC_TO_NATIVE_BRIDGES_ALLOWED = keccak256("ercToNativeBridgesAllowed");
    bytes32 public constant IS_REWARDING = keccak256("isRewarding");
    bytes32 public constant IS_SNAPSHOTTING = keccak256("isSnapshotting");
