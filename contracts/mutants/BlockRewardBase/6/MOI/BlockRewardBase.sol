...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    function initialize(address _validatorSet) external onlyErcToNativeBridge {
        require(!isInitialized());
    ...
    function _setSnapshot(address _stakingAddress, IStaking _stakingContract, uint256 _offset) internal onlyErcToNativeBridge {
