...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    function setErcToNativeBridgesAllowed(address[] calldata _bridgesAllowed) external onlyInitialized onlyOwner {
        uint256 i;
    ...
    /// @param _bridgesAllowed The array of bridge addresses.
    function setNativeToErcBridgesAllowed(address[] calldata _bridgesAllowed) external onlyInitialized onlyOwner {
        uint256 i;
