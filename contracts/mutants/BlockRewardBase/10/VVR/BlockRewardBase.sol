...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    bytes32 public constant MINTED_TOTALLY = keccak256("mintedTotally");
    bytes32 public constant NATIVE_TO_ERC_BRIDGES_ALLOWED = keccak256("nativeToErcBridgesAllowed");
