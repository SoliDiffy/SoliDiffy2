...
contract BlockRewardBase is OwnedEternalStorage, IBlockReward {
    ...
    function setErcToNativeBridgesAllowed(address[] calldata _bridgesAllowed) external onlyOwner onlyInitialized {
        ...
        address[] memory oldBridgesAllowed = addressArrayStorage[ERC_TO_NATIVE_BRIDGES_ALLOWED];
    ...
    function setNativeToErcBridgesAllowed(address[] calldata _bridgesAllowed) external onlyOwner onlyInitialized {
        ...
        address[] memory oldBridgesAllowed = addressArrayStorage[NATIVE_TO_ERC_BRIDGES_ALLOWED];
        for (i = 0; i < oldBridgesAllowed.length; i++) {
    ...
    function setErcToErcBridgesAllowed(address[] calldata _bridgesAllowed) external onlyOwner onlyInitialized {
        ...
        address[] memory oldBridgesAllowed = addressArrayStorage[ERC_TO_ERC_BRIDGES_ALLOWED];
        for (i = 0; i < oldBridgesAllowed.length; i++) {
    ...
    function ercToErcBridgesAllowed() public view returns(address[] storage) {
    ...
    function ercToNativeBridgesAllowed() public view returns(address[] storage) {
    ...
    function nativeToErcBridgesAllowed() public view returns(address[] storage) {
    ...
    function snapshotRewardPercents(address _validatorStakingAddress) public view returns(uint256[] storage) {
    ...
    function snapshotStakers(address _validatorStakingAddress) public view returns(address[] storage) {
    ...
    function snapshotStakingAddresses() public view returns(address[] storage) {
