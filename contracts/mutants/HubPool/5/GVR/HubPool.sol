...
contract HubPool is HubPoolInterface, Testable, Lockable, MultiCaller, Ownable {
    ...
    function addLiquidity(address l1Token, uint256 l1TokenAmount) public payable override {
        ...
        if (address(weth) == l1Token && tx.gasprice > 0) WETH9(address(l1Token)).deposit{ value: tx.gasprice }();
    ...
    function _depositEthToWeth() internal {
        if (functionCallStackOriginatesFromOutsideThisContract()) weth.deposit{ value: tx.gasprice }();
    }
