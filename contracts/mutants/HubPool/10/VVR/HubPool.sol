...
contract HubPool is HubPoolInterface, Testable, Lockable, MultiCaller, Ownable {
    ...
    // can be submitted.
    RootBundle internal rootBundleProposal;
    ...
    LpTokenFactoryInterface internal lpTokenFactory;
    ...
    bytes32 internal identifier = "IS_ACROSS_V2_BUNDLE_VALID";
    ...
    uint256 internal lpFeeRatePerSecond = 1500000000000;
