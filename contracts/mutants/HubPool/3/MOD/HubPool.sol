...
contract HubPool is HubPoolInterface, Testable, Lockable, MultiCaller, Ownable {
     ...
     */
    function setBond(IERC20 newBondToken, uint256 newBondAmount) public override noActiveRequests onlyOwner {
     ...
     */
    function setIdentifier(bytes32 newIdentifier) public override noActiveRequests onlyOwner {
