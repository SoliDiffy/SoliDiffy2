...
contract HubPool is HubPoolInterface, Testable, Lockable, MultiCaller, Ownable {
    ...
    function setCrossChainContracts(
        ...
        address adapter,
        address spokePool
    ) public override noActiveRequests onlyOwner {
    ...
    function proposeRootBundle(
        ...
        bytes32 relayerRefundRoot,
        bytes32 slowRelayRoot
    ) public override noActiveRequests nonReentrant {
     ...
     */
    function disputeRootBundle() public zeroOptimisticOracleApproval nonReentrant {
