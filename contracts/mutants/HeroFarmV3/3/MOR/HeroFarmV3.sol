...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function initialize(address _hero, uint256 _heroRewardPerSecond, address[] calldata _disAddresses) public onlyOwner {
        __Ownable_init();
    ...
    function setRewardDistribution(address _rewardDistribution) public virtual initializer {
    ...
    function add(
        ...
        bool _withUpdate,
        address _strat
    ) public initializer nonReentrant nonPoolDuplicated(_want) {
