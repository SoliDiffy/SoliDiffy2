...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    address internal HERO;

    address internal burnAddress;

    uint256 internal startTime;
    uint256 internal HERORewardPerSecond; // HERO tokens created per second
    uint256 internal epochReduceRate; // */100
    uint256 internal epochDuration;
    uint256 internal totalEpoch;
    uint256 internal HEROMaxSupply;

    uint256 internal reservedNFTFarmingRate; // 30%
