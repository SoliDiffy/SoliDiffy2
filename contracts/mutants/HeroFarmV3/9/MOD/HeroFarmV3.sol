...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function withdrawNFT(uint256 _pid, uint256[] memory _tokenIds) public isEOA whenNotPaused nonReentrant {
    ...
    function emergencyWithdraw(uint256 _pid) public nonReentrant isEOA {
    ...
    // Withdraw without caring about rewards. EMERGENCY ONLY.
    function emergencyWithdrawNFT(uint256 _pid, uint256[] memory _tokenIds) public nonReentrant isEOA {
