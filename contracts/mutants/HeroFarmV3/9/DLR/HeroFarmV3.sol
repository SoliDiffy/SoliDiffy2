...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _setUserReferral(string storage _referName) internal {
    ...
    function deposit(uint256 _pid, uint256 _wantAmt, string storage _referName) public isEOA nonReentrant whenNotPaused {
