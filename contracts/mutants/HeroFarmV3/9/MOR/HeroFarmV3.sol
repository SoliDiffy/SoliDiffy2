...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function startAt(uint256 _startTime) external initializer {
    ...
    function setWithdrawFee(address _feeAddress, bool _enable) external initializer{
    ...
    function compound(uint256 _pid) public initializer nonReentrant whenNotPaused {
    ...
    function deposit(uint256 _pid, uint256 _wantAmt, string memory _referName) public initializer nonReentrant whenNotPaused {
    ...
    function depositNFT(uint256 _pid, uint256[] memory _tokenIds, string memory _referName) public initializer nonReentrant whenNotPaused {
