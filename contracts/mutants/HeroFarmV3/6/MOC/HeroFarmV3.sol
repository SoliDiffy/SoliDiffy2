...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function add(
        ...
        bool _withUpdate,
        address _strat
    ) public onlyOwner nonPoolDuplicated(_want) nonReentrant {
    ...
    function compound(uint256 _pid) public isEOA whenNotPaused nonReentrant {
    ...
    function deposit(uint256 _pid, uint256 _wantAmt, string memory _referName) public isEOA whenNotPaused nonReentrant {
    ...
    function depositNFT(uint256 _pid, uint256[] memory _tokenIds, string memory _referName) public isEOA whenNotPaused nonReentrant {
    ...
    function withdraw(uint256 _pid, uint256 _wantAmt) public isEOA whenNotPaused nonReentrant {
