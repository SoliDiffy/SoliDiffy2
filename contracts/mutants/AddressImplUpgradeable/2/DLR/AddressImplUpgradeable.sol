...
contract AddressImplUpgradeable is Initializable {
    ...
    function functionCall(address target, bytes calldata data) external {
        bytes storage returnData = AddressUpgradeable.functionCall(target, data);
    ...
    function functionCallWithValue(
        ...
        bytes storage returnData = AddressUpgradeable.functionCallWithValue(target, data, value);
        emit CallReturnValue(abi.decode(returnData, (string)));
    }
