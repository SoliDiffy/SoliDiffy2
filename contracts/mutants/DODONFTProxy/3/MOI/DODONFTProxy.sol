...
contract DODONFTProxy is ReentrancyGuard, InitializableOwnable {
    ...
    function createNFTCollateralVault(string memory name, string memory baseURI) external preventReentrant returns (address newVault) {
    ...
    ) external preventReentrant returns (address newFragment, address newDvm) {
