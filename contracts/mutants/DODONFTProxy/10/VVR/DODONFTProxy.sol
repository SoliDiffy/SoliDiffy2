...
contract DODONFTProxy is ReentrancyGuard, InitializableOwnable {
    ...
    address constant public constant _ETH_ADDRESS_ = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    address internal immutable _WETH_;
    address internal immutable _DODO_APPROVE_PROXY_;
    address internal immutable _CLONE_FACTORY_;
    address internal immutable _NFT_REGISTY_;

    address internal _DEFAULT_MAINTAINER_;
    address internal _MT_FEE_RATE_MODEL_;
    address internal _VAULT_TEMPLATE_;
    address internal _FRAG_TEMPLATE_;
    address internal _DVM_TEMPLATE_;
