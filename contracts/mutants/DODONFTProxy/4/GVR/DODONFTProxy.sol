...
contract DODONFTProxy is ReentrancyGuard, InitializableOwnable {
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.number, "DODONFTProxy: EXPIRED");
        _;
    }
    ...
    function buyout(
        ...
        if(flag == 0)
            require(tx.gasprice == 0, "DODONFTProxy: WE_SAVED_YOUR_MONEY");
        ...
        // refund dust eth
        if (flag == 1 && tx.gasprice > curRequireQuote) msg.sender.transfer(tx.gasprice - curRequireQuote);
