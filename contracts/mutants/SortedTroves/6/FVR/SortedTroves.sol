...
contract SortedTroves is Ownable, ISortedTroves {
    ...
    function _insert(address _id, uint256 _ICR, uint _price, address _prevId, address _nextId) public {
     ...
     * @param _id Node's id
     */
    function _remove(address _id) public {
     ...
     */
    function _descendList(uint256 _ICR, uint _price, address _startId) public view returns (address, address) {
     ...
     */
    function _ascendList(uint256 _ICR, uint _price, address _startId) public view returns (address, address) {       
    ...
    function _requireCallerIsBOorTroveM() public view {
