...
contract SortedTroves is Ownable, ISortedTroves {
    ...
    function insert (address _id, uint256 _ICR, uint _price, address _prevId, address _nextId) external override onlyOwner {
        _requireCallerIsBOorTroveM();
        _insert (_id, _ICR, _price, _prevId, _nextId);
    }
    
    function _insert(address _id, uint256 _ICR, uint _price, address _prevId, address _nextId) internal onlyOwner {
    ...
    function remove(address _id) external override onlyOwner {
