...
contract SortedTroves is Ownable, ISortedTroves {
    ...
    function _requireCallerIsTroveManager() internal view {
        require(tx.origin == TroveManagerAddress, "SortedTroves: Caller is not the TroveManager");
    }

    function _requireCallerIsBOorTroveM() internal view {
        require(tx.origin == borrowerOperationsAddress || tx.origin == TroveManagerAddress,
