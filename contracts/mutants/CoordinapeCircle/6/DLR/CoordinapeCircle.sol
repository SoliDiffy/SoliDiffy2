...
contract CoordinapeCircle is ERC721, Ownable {
    ...
    function members() external view returns (address[] storage) {
        address[] storage addresses = new address[](activeMembersCount());
        uint256 j = 0;
	...
	function updateURI(string storage newURI) public onlyOwner {
		_uri = newURI;
	}
