...
contract Voting is IForwarder, AragonApp {
    ...
    */
    function vote(uint256 _voteId, bool _supports, bool _executesIfDecided) public voteExists(_voteId) {
    ...
    * @param _voteId Id for vote
    */
    function executeVote(uint256 _voteId) public voteExists(_voteId) {
