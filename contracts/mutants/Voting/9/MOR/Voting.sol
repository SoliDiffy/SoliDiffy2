...
contract Voting is IForwarder, AragonApp {
    ...
    */
    function newVote(bytes _executionScript, string _metadata) external onlyInit returns (uint256 voteId) {
    ...
    */
    function vote(uint256 _voteId, bool _supports, bool _executesIfDecided) external onlyInit {
    ...
    * @param _voteId Id for vote
    */
    function executeVote(uint256 _voteId) external onlyInit {
...
//SWC-135-Code With No Effects:L191-193
    ...
    */
    function canExecute(uint256 _voteId) public view onlyInit returns (bool) {
    ...
    */
    function canVote(uint256 _voteId, address _voter) public view onlyInit returns (bool) {
