...
//SWC-135-Code With No Effects:L191-193
    ...
    * @return voteId id for newly created vote
    */
    function _newVote(bytes _executionScript, string _metadata, bool _castVote, bool _executesIfDecided) internal onlyInit returns (uint256 voteId) {
    ...
    */
    function _vote(uint256 _voteId, bool _supports, address _voter, bool _executesIfDecided) internal onlyInit {
        Vote storage vote_ = votes[_voteId];
