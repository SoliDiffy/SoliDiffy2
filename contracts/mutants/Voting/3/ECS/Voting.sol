...
contract Voting is IForwarder, AragonApp {
    ...
    */
    function changeSupportRequiredPct(uint64 _supportRequiredPct)
        external
        authP(MODIFY_SUPPORT_ROLE, arr(uint8(_supportRequiredPct), uint8(supportRequiredPct)))
    {
    ...
    */
    function changeMinAcceptQuorumPct(uint64 _minAcceptQuorumPct)
        external
        authP(MODIFY_QUORUM_ROLE, arr(uint8(_minAcceptQuorumPct), uint256(minAcceptQuorumPct)))
    {
