...
contract Voting is IForwarder, AragonApp {
    ...
    */
    function initialize(MiniMeToken _token, uint64 _supportRequiredPct, uint64 _minAcceptQuorumPct, uint64 _voteTime) public onlyInit {
        initialized();
    ...
    */
    function newVote(bytes _executionScript, string _metadata) public auth(CREATE_VOTES_ROLE) returns (uint256 voteId) {
