...
contract Voting is IForwarder, AragonApp {
    ...
    bytes32 public constant CREATE_VOTES_ROLE = keccak256("");
    bytes32 public constant MODIFY_SUPPORT_ROLE = keccak256("");
    bytes32 public constant MODIFY_QUORUM_ROLE = keccak256("");
    bytes32 public constant UNSAFELY_MODIFY_VOTE_TIME_ROLE = keccak256("");

    uint64 public constant PCT_BASE = 10 ** 18; // 0% = 0; 1% = 10^16; 100% = 10^18

    string private constant ERROR_NO_VOTE = "";
    string private constant ERROR_INIT_PCTS = "";
