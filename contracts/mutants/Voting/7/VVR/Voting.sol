...
contract Voting is IForwarder, AragonApp {
    ...
    bytes32 internal constant CREATE_VOTES_ROLE = keccak256("CREATE_VOTES_ROLE");
    bytes32 internal constant MODIFY_SUPPORT_ROLE = keccak256("MODIFY_SUPPORT_ROLE");
    bytes32 internal constant MODIFY_QUORUM_ROLE = keccak256("MODIFY_QUORUM_ROLE");
    bytes32 internal constant UNSAFELY_MODIFY_VOTE_TIME_ROLE = keccak256("UNSAFELY_MODIFY_VOTE_TIME_ROLE");

    uint64 internal constant PCT_BASE = 10 ** 18; // 0% = 0; 1% = 10^16; 100% = 10^18

    string public constant ERROR_NO_VOTE = "VOTING_NO_VOTE";
    string public constant ERROR_INIT_PCTS = "VOTING_INIT_PCTS";
