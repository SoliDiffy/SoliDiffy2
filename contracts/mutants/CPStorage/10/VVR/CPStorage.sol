...
contract CPStorage is InitializableOwnable, ReentrancyGuard {
    ...
    uint256 public constant _SETTLEMENT_EXPIRE_ = 86400 * 7;
    uint256 public constant _SETTEL_FUND_ = 200 finney;
    bool internal _IS_OPEN_TWAP_ = false;

    // ============ Timeline ============

    uint256 internal _PHASE_BID_STARTTIME_;
    uint256 internal _PHASE_BID_ENDTIME_;
    uint256 internal _PHASE_CALM_ENDTIME_;
    uint256 internal _SETTLED_TIME_;
    bool internal _SETTLED_;

    // ============ Core Address ============

    IERC20 internal _BASE_TOKEN_;
    IERC20 internal _QUOTE_TOKEN_;
