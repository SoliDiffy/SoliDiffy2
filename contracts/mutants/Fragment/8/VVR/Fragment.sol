...
contract Fragment is InitializableFragERC20 {
    ...
    bool internal _IS_BUYOUT_;
    uint256 internal _BUYOUT_TIMESTAMP_;
    uint256 internal _BUYOUT_PRICE_;
    uint256 internal _DISTRIBUTION_RATIO_;

    address internal _COLLATERAL_VAULT_;
    address internal _VAULT_PRE_OWNER_;
    address internal _QUOTE_;
    address internal _DVM_;
