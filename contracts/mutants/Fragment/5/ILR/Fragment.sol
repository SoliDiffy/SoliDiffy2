...
contract Fragment is InitializableFragERC20 {
    ...
    function init(
      ...
      string memory _symbol
        ...
        if(distributionBalance > 1) _transfer(address(this), _DEFAULT_MAINTAINER_, distributionBalance);
    ...
    function buyout(address newVaultOwner) external {
        require(_BUYOUT_TIMESTAMP_ != 1, "DODOFragment: NOT_SUPPORT_BUYOUT");
        ...
        require(buyoutFee != 0, "DODOFragment: USER_UNABLE_BUYOUT");
