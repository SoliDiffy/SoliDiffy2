...
contract StrategyCurveYVoterProxy {
  ...
  address internal constant want = address(0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8);
  ...
  address internal constant weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // used for crv <> weth <> dai route

  address internal constant dai = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
  address internal constant ydai = address(0x16de59092dAE5CcF4A1E6439D611fd0653f0Bd01);
  address internal constant curve = address(0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51);

  address internal constant gauge = address(0xFA712EE4788C042e2B7BB55E6cb8ec569C4530c1);
  address internal constant voter = address(0xF147b8125d2ef93FB6965Db97D6746952a133934);

  uint256 internal keepCRV = 1000;
