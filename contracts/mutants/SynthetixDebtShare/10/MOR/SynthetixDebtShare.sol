...
contract SynthetixDebtShare is Owned, MixinResolver, ISynthetixDebtShare {
    ...
    function importAddresses(address[] calldata accounts, uint256[] calldata amounts) external onlyAuthorizedToSnapshot onlySetup {
    ...
    function finishSetup() external onlyAuthorizedToSnapshot {
        isInitialized = true;
    }
