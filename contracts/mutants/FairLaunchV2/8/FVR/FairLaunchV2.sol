...
contract FairLaunchV2 is Ownable, ReentrancyGuard {
  ...
  constructor(IFairLaunchV1 _FAIR_LAUNCH_V1, IERC20 _alpaca, uint256 _MASTER_PID) internal {
  ...
  function isDuplicatedPool(IERC20 _stakeToken) external view returns (bool) {
