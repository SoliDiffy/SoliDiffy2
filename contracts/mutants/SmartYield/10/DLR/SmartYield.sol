    ...
    ISmartYield
{
      ...
      external override
    {
        ...
        JuniorBond storage jb = JuniorBond(
          tokenAmount_,
          maturesAt
        );
        ...
        if (this.currentTime() >= maturesAt) {
            JuniorBondsAt storage jBondsAt = juniorBondsMaturingAt[jb.maturesAt];
        ...
        external override
    {
        ...
        JuniorBond storage jb = juniorBonds[jBondId_];
        require(
...
//SWC-126-Insufficient Gas Griefing:L439-451
    ...
    function _liquidateJuniorsAt(uint256 timestamp_)
      internal
    {
        JuniorBondsAt memory jBondsAt = juniorBondsMaturingAt[timestamp_];
    ...
    function unaccountBonds(uint256[] storage bondIds_) public override {
    ...
    function _mintBond(address to_, SeniorBond storage bond_)
      internal
    {
        require(
