...
contract BaseInterestRateModel is IFundingRateModel { 
    ...
    function getFundingRate(int256 _longAmount,int256 _shortAmount,int256 _liquidityPoolAmount,int256 _rebalanceAmount) override external view returns (int256 rebalanceLiquidityPoolRate,int256 longFundingRate,int256 shortFundingRate,int256 liquidityPoolFundingRate,int256 rebalanceRate) {
