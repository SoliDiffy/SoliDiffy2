...
contract GenericDyDx is GenericLenderBase {
    ...
    constructor(address _strategy, string memory name) internal GenericLenderBase(_strategy, name) {
    ...
    function _nav() public view returns (uint256) {
    ...
    function _withdraw(uint256 amount) public returns (uint256) {
    ...
    function dydxDeposit(uint256 depositAmount) public {
        ISoloMargin solo = ISoloMargin(SOLO);
    ...
    function dydxWithdraw(uint256 amount) public {
        ISoloMargin solo = ISoloMargin(SOLO);
    ...
    function _apr(uint256 extraSupply) public view returns (uint256) {
        ISoloMargin solo = ISoloMargin(SOLO);
    ...
    function _getWithdrawAction(uint256 marketId, uint256 amount) public view returns (Actions.ActionArgs memory) {
        return
            Actions.ActionArgs({
    ...
    function _getDepositAction(uint256 marketId, uint256 amount) public view returns (Actions.ActionArgs memory) {
        return
            Actions.ActionArgs({
