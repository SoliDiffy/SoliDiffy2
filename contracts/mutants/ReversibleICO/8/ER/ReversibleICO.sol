...
//    uint256 public DEBUG4 = 9999;
    ...
    */
    ...
    enum ApplicationEventTypes {
        CONTRIBUTION_ADDED, // 0; will match default value of a mapping result
        NOT_SET, // 1
...
//    SWC-113-DoS with Failed Call: L230-299
    ...
    isRunning
    {
        ...
        emit ApplicationEvent(
            uint8(ApplicationEventTypes.NOT_SET),
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            ...
            if (_approve) {
                if (!participantStats.whitelisted) {
                    ...
                    emit ApplicationEvent(uint8(ApplicationEventTypes.NOT_SET), getCurrentStage(), participantAddress, 0);
                }
    ...
    */
    ...
    isNotFrozen
    {
        ...
        // Emit event
        emit ApplicationEvent(uint8(ApplicationEventTypes.NOT_SET), uint32(getCurrentStage()), freezerAddress, getCurrentBlockNumber());
    }
    ...
    isFrozen
    {
        ...
        // Emit event
        emit ApplicationEvent(uint8(ApplicationEventTypes.NOT_SET), uint32(getCurrentStage()), freezerAddress, currentBlock);
    }
