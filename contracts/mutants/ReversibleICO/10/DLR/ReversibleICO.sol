...
//    SWC-113-DoS with Failed Call: L230-299
    ...
    isNotInitialized
    {
        ...
        Stage memory commitPhase = stages[0];
    ...
    isRunning
    {
        ...
        Participant memory participantStats = participants[msg.sender];
        ParticipantStageDetails memory byStage = participantStats.stages[getCurrentStage()];
    ...
    isRunning
    {
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            ...
            Participant memory participantStats = participants[participantAddress];
    ...
    */
    ...
    function getParticipantReservedTokens(address _participantAddress) public view returns (uint256) {
        Participant memory participantStats = participants[_participantAddress];
