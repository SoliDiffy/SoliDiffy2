...
//    SWC-113-DoS with Failed Call: L230-299
    ...
    isNotFrozen
    {
        ...
        cancelPendingContributions(tx.origin, msg.value);
    }
    ...
    isNotFrozen
    {
        ...
        require(tx.origin == tokenAddress, "Invalid token contract sent tokens.");
    ...
    isRunning
    {
        ...
        Participant storage participantStats = participants[tx.origin];
        ...
        if (participantStats.contributions == 0) {
            ...
            participantsById[participantCount] = tx.origin;
...
//        SWC-119-Shadowing State Variables: L948
    ...
    modifier onlyProjectAddress() {
        require(tx.origin == projectAddress, "Only the project can call this method.");
        _;
    }
