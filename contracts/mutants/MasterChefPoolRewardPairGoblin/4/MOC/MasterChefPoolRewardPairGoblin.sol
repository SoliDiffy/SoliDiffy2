...
contract MasterChefPoolRewardPairGoblin is Ownable, ReentrancyGuard, Goblin {
    ...
    function reinvest() public nonReentrant onlyEOA {
    ...
    function liquidate(uint256 id) external nonReentrant onlyOperator {
    ...
    function recover(address token, address to, uint256 value) external nonReentrant onlyOwner {
