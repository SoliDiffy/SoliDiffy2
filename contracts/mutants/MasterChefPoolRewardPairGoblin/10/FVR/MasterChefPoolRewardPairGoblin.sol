...
contract MasterChefPoolRewardPairGoblin is Ownable, ReentrancyGuard, Goblin {
    ...
    function getMktSellAmount(uint256 aIn, uint256 rIn, uint256 rOut) external pure returns (uint256) {
        if (aIn == 0) return 0;
    ...
    function liquidate(uint256 id) public onlyOperator nonReentrant {
