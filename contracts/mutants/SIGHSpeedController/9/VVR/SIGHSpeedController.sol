...
contract SIGHSpeedController is ISIGHSpeedController, VersionedInitializable  {
  ...
  IGlobalAddressesProvider public addressesProvider;

  IERC20 public sighInstrument;                                         // SIGH INSTRUMENT CONTRACT

  bool public isDripAllowed = false;
  uint public lastDripBlockNumber;

   ISIGHVolatilityHarvester public sighVolatilityHarvester;      // SIGH DISTRIBUTION HANDLER CONTRACT
   uint256 public sighVolatilityHarvestingSpeed;
   uint public totalDrippedToVolatilityHarvester;                 // TOTAL $SIGH DRIPPED TO SIGH VOLATILTIY HARVESTER
   uint public recentlyDrippedToVolatilityHarvester;              // $SIGH RECENTLY DRIPPED TO SIGH VOLATILTIY HARVESTER
  ...
  address[] public storedSupportedProtocols;
