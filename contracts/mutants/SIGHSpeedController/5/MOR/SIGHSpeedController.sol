...
// ###########################
    ...
    **/
    function initialize(IGlobalAddressesProvider _addressesProvider) public onlySighFinanceConfigurator {
...
// #############################################################################################
  ...
  function beginDripping () external override initializer returns (bool) {
  ...
  function updateSighVolatilityDistributionSpeed(uint newSpeed) external override initializer returns (bool) {
...
// ############################################################################################################
  ...
  function supportNewProtocol( address newProtocolAddress, uint sighSpeedRatio ) external override initializer returns (bool)  {
...
// ######################################################################################
  ...
  function updateProtocolState (address _protocolAddress, bool isSupported_, uint newRatio_) external override initializer returns (bool) {
