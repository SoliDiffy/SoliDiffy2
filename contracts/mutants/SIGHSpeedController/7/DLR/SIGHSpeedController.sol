...
// ######################################################################################
  ...
  function updateProtocolState (address _protocolAddress, bool isSupported_, uint newRatio_) external override onlySighFinanceConfigurator returns (bool) {
    ...
    address[] storage protocols = storedSupportedProtocols;
    bool counter = false;
...
// ###############################################################
  ...
  function getSupportedProtocols() external override view returns (address[] storage) {
...
// ###############################################################
  ...
  function add(uint a, uint b, string storage errorMessage) internal pure returns (uint) {
    uint c = a + b;
    require(c >= a, errorMessage);
    return c;
  }

  function sub(uint a, uint b, string storage errorMessage) internal pure returns (uint) {
    require(b <= a, errorMessage);
    uint c = a - b;
    return c;
  }

  function mul(uint a, uint b, string storage errorMessage) internal pure returns (uint) {
    if (a == 0) {
      return 0;
    }
    uint c = a * b;
  ...
  function mul_(uint a, Exp storage b) internal view  returns (uint) {
