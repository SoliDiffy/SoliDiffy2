...
// ###########################
    ...
    **/
    function initialize(IGlobalAddressesProvider _addressesProvider) external initializer {
...
// #####################################################################
  ...
  function dripToVolatilityHarvesterInternal() public {
...
// ###############################################################
  ...
  function add(uint a, uint b, string memory errorMessage) public pure returns (uint) {
    uint c = a + b;
    require(c >= a, errorMessage);
    return c;
  }

  function sub(uint a, uint b, string memory errorMessage) public pure returns (uint) {
    require(b <= a, errorMessage);
    uint c = a - b;
    return c;
  }

  function mul(uint a, uint b, string memory errorMessage) public pure returns (uint) {
    if (a == 0) {
      return 0;
    }
    uint c = a * b;
  ...
  function mul_(uint a, Exp memory b) public view  returns (uint) {
