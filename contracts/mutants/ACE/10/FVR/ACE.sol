...
contract ACE is IAZTEC, Ownable, NoteRegistryManager {
    ...
    */
    function validateProof(uint24 _proof, address _sender, bytes calldata) public returns (bytes memory) {
    ...
    */
    function clearProofByHashes(uint24 _proof, bytes32[] calldata _proofHashes) public {
    ...
    */
    function setCommonReferenceString(bytes32[6] memory _commonReferenceString) external {
