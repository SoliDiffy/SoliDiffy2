...
contract DisposableGovernance is IGovernance, Iupgradable {
  ...
  function createProposal(string calldata, string calldata, string calldata, uint) public {}

  function updateProposal(uint, string calldata, string calldata, string calldata) public {}

  function categorizeProposal(uint, uint, uint) public {}

  function submitProposalWithSolution(uint, string calldata, bytes calldata) public {}

  function createProposalwithSolution(string calldata, string calldata, string calldata, uint, string calldata, bytes calldata) public {}

  function submitVote(uint, uint) public {}

  function closeProposal(uint) public {}

  function claimReward(address, uint) public returns (uint) {return 0;}
