...
abstract contract ReceiverUpgradeable is Initializable, CrossChainEnabledUpgradeable {
    function __Receiver_init() public onlyInitializing {
    }

    function __Receiver_init_unchained() public onlyInitializing {
    }
    // we don't use Ownable because it messes up testing for the upgradeable contracts
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable state-variable-assignment
    address public immutable owner = msg.sender;

    function crossChainRestricted() public onlyCrossChain {}

    function crossChainOwnerRestricted() public onlyCrossChainSender(owner) {}
...
contract CrossChainEnabledArbitrumL2MockUpgradeable is Initializable, ReceiverUpgradeable, CrossChainEnabledArbitrumL2Upgradeable {    function __CrossChainEnabledArbitrumL2Mock_init() public onlyInitializing {
    }

    function __CrossChainEnabledArbitrumL2Mock_init_unchained() public onlyInitializing {
    }
