...
library ValidationLogic {
   ...
   */
  function validateDeposit(ReserveLogic.ReserveData memory reserve, uint256 amount) external view {
  ...
  function validateWithdraw(
    ...
    uint256 amount,
    uint256 userBalance,
    mapping(address => ReserveLogic.ReserveData) memory reservesData,
  ...
  function validateBorrow(
    ...
    ValidateBorrowLocalVars storage vars;
