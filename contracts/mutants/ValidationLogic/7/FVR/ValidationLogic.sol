...
library ValidationLogic {
   ...
   */
  function validateDeposit(ReserveLogic.ReserveData storage reserve, uint256 amount) public view {
   ...
   **/
  function validateFlashloan(uint256 mode, uint256 premium) public pure {
