...
contract CollateralSettlerERC20 is CollateralSettlerERC20Events, ICollateralSettler, AccessControl, Pausable {
    ...
    function setAmountToRedistribute(uint256 newAmountToRedistribute) external whenNotPaused onlyClaimPeriod {
    ...
    ) external onlyClaimPeriod onlyBaseAmountsComputed {
    ...
    function pause() external onlyClaimPeriod {
        _pause();
    }
