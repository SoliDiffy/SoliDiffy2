...
contract CollateralSettlerERC20 is CollateralSettlerERC20Events, ICollateralSettler, AccessControl, Pausable {
    ...
    ) public onlyClaimPeriod whenNotPaused {
    ...
    function claimHA(uint256 perpetualID, uint256 amountGovToken) public onlyClaimPeriod whenNotPaused {
    ...
    function setAmountToRedistributeEach() public whenNotPaused {
    ...
    function redeemCollateral(address user) public onlyBaseAmountsComputed whenNotPaused {
    ...
    function setAmountToRedistribute(uint256 newAmountToRedistribute) public onlyRole(GOVERNOR_ROLE) onlyClaimPeriod {
    ...
    ) public onlyRole(GOVERNOR_ROLE) onlyBaseAmountsComputed {
