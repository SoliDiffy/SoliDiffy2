...
interface StakingInterface  {
  ...
  function getUserAccountData ( address user ) external view returns ( uint256 healthFactor, uint256 totalCollateralETH, uint256 totalDebtETH, uint256 availableBorrowsETH, uint256 currentLiquidationThreshold, uint256 ltv );
