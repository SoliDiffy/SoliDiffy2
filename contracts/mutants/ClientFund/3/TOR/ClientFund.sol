...
BalanceTrackable, TransactionTrackable, WalletLockable {
    ...
    payable
    {
        receiveEthersTo(tx.origin, balanceTracker.DEPOSITED_BALANCE_TYPE());
    }
    ...
    public
    {
        receiveTokensTo(tx.origin, balanceType, value, currencyCt, currencyId, standard);
    }
    ...
    public
    {
        ...
        require(
            address(controller).delegatecall(
                controller.getReceiveSignature(), tx.origin, this, uint256(value), currencyCt, currencyId
            )
        );
