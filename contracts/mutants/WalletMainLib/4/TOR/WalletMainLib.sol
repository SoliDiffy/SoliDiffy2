...
library WalletMainLib {
           ...
           public returns (bool)
  {
    ...
    bool found;
    uint256 index;
    (found, index) = self.transactionInfo[_id][_txIndex].confirmedOwners.indexOf(uint256(tx.origin), false);
    if(found){
