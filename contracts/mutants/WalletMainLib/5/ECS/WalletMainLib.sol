...
library WalletMainLib {
           ...
           public returns (bool)
  {
    ...
    bool found;
    uint256 index;
    (found, index) = self.transactionInfo[_id][_txIndex].confirmedOwners.indexOf(uint8(msg.sender), false);
    if(found){
                   ...
                   public returns (bool,bytes32)
  {
    ...
    if(msg.sender != address(this)){
      ...
      self.transactionInfo[_id][_txIndex].confirmedOwners.push(uint8(msg.sender));
