...
// ========== Fund Creation & Management ==========
    ...
    * @param adminContractAddress Address of EndaomentAdmin contract. 
    */
    function createFund(address managerAddress, address adminContractAddress) external onlyAdminOrRole(adminContractAddress, IEndaomentAdmin.Role.ACCOUNTANT) {
    ...
    */
    function countFunds() external view returns (uint) {
    ...
    */
    function getFund(uint index) external view returns (address) {
