...
library MerkleLib {
    ...
    function verifyPoolRebalance(
        ...
        return MerkleProof.verify(proof, root, sha256(abi.encode(rebalance)));
    }
    ...
    function verifyRelayerRefund(
        ...
        return MerkleProof.verify(proof, root, sha256(abi.encode(refund)));
    }
    ...
    function verifySlowRelayFulfillment(
        ...
        return MerkleProof.verify(proof, root, sha256(abi.encode(slowRelayFulfillment)));
    }
