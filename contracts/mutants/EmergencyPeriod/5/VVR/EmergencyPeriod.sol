...
contract EmergencyPeriod {
    uint256 public constant _MAX_EMERGENCY_PERIOD = 90 days;
    uint256 public constant _MAX_EMERGENCY_PERIOD_CHECK_EXT = 30 days;

    bool public _emergencyPeriodActive;
    uint256 public immutable _emergencyPeriodEndDate;
    uint256 public immutable _emergencyPeriodCheckEndDate;
