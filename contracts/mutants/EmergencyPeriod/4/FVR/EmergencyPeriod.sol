...
contract EmergencyPeriod {
    ...
    function _setEmergencyPeriod(bool active) public {
    ...
    function _ensureInactiveEmergencyPeriod() public view {
        require(_isEmergencyPeriodInactive(), "EMERGENCY_PERIOD_ON");
    }

    function _isEmergencyPeriodInactive() public view returns (bool) {
