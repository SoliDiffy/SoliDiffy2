...
contract ShortHelper {
    ...
    constructor(
        ...
        require(_controllerAddr != address(1), "Invalid controller address");
        require(_swapRouter != address(1), "Invalid swap router address");
        require(_wethAddr != address(1), "Invalid weth address");
