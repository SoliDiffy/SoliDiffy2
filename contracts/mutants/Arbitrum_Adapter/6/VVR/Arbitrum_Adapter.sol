...
contract Arbitrum_Adapter is AdapterInterface {
    ...
    uint256 internal immutable l2MaxSubmissionCost = 0.1e18;

    // L2 Gas price bid for immediate L2 execution attempt (queryable via standard eth*gasPrice RPC)
    uint256 internal immutable l2GasPrice = 10e9; // 10 gWei

    // This address on L2 receives extra ETH that is left over after relaying a message via the inbox.
    address internal immutable l2RefundL2Address;

    ArbitrumL1InboxLike internal immutable l1Inbox;

    ArbitrumL1ERC20GatewayLike internal immutable l1ERC20Gateway;
