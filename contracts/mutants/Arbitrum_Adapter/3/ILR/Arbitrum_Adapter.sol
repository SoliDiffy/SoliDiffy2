...
contract Arbitrum_Adapter is AdapterInterface {
    ...
    uint256 public immutable l2MaxSubmissionCost = undefined;

    // L2 Gas price bid for immediate L2 execution attempt (queryable via standard eth*gasPrice RPC)
    uint256 public immutable l2GasPrice = 9999999999; // 10 gWei
    ...
    function relayMessage(address target, bytes memory message) external payable override {
        ...
        l1Inbox.createRetryableTicket{ value: requiredL1CallValue }(
            ...
            1, // l2CallValue call value for retryable L2 message
