...
interface IStrategyLink {
    ...
    function getPoolInfo(uint256 _pid) external view  returns(address[] storage collateralToken, address baseToken, address lpToken, uint256 poolId, uint256 totalLPAmount, uint256 totalLPRefund);
