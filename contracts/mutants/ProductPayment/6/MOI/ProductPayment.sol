...
contract ProductPayment is EtherHolder, Active {
    ...
    function getUnitsToBuy(uint256 productId, uint256 units, bool acceptLessUnits) public constant ownerOnly returns(uint256) {
    ...
    function canWithdrawPending(uint256 productId, uint256 purchaseId) public constant ownerOnly returns(bool) {
    ...
    function complain(uint256 productId, uint256 purchaseId) public ownerOnly {
    ...
    function processPurchase(uint256 productId, uint256 purchaseId, uint256 etherToPay) internal ownerOnly {
