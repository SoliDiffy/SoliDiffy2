...
contract ProductPayment is EtherHolder, Active {
    ...
    function setConvertParams(IBancorConverter _converter, address[] _convertPath) public managerOnly {
    ...
    function resolve(uint256 productId, uint256 purchaseId, bool cancelPayment) public ownerOnly {
