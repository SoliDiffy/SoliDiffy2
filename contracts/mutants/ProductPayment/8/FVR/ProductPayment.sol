...
contract ProductPayment is EtherHolder, Active {
    ...
    function setConvertParams(IBancorConverter _converter, address[] _convertPath) external ownerOnly {
    ...
    function getUnitsToBuy(uint256 productId, uint256 units, bool acceptLessUnits) external constant returns(uint256) {
    ...
    function canWithdrawPending(uint256 productId, uint256 purchaseId) external constant returns(bool) {
    ...
    function complain(uint256 productId, uint256 purchaseId) external {
    ...
    function resolve(uint256 productId, uint256 purchaseId, bool cancelPayment) external managerOnly {
