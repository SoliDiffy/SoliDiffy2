...
contract ProductPayment is EtherHolder, Active {
    ...
    IFeePolicy internal feePolicy;
    IDiscountPolicy internal discountPolicy;
    //contract that stores ether/usd exchange rate
    IEtherPriceProvider internal etherPriceProvider;
    ...
    IBancorConverter internal converter;
    // escrow payment hold time in seconds 
    uint256 internal escrowHoldTime; 
    address[] internal convertPath;
