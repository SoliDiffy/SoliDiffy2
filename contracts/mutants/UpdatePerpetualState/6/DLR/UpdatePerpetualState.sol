    ...
    ProgramOutputOffsets
{
    ...
    function updateState(uint256[] calldata programOutput, uint256[] calldata applicationData)
        ...
        onlyOperator
    {
        ProgramOutputMarkers storage outputMarkers = parseProgramOutput(programOutput);
        require(
    ...
    function validateConfigHashes(
        ...
        ProgramOutputMarkers storage markers
    ) internal view {
    ...
    function parseProgramOutput(uint256[] calldata programOutput)
        internal
        pure
        returns (ProgramOutputMarkers storage)
    {
        require(
        ...
        ProgramOutputMarkers storage markers; // NOLINT: uninitialized-local.
