...
contract RealityCards is ERC721Full, Ownable {
    ...
    function newRental(uint256 _newPrice, uint256 _tokenId, uint256 _deposit) external checkState(States.OPEN) amountNotZero(_deposit) tokenExists(_tokenId) {
    ...
    function depositDai(uint256 _dai, uint256 _tokenId) external checkState(States.OPEN) tokenExists(_tokenId) amountNotZero(_dai) {
        _collectRent(_tokenId);
    ...
    function changePrice(uint256 _newPrice, uint256 _tokenId) external checkState(States.OPEN) onlyTokenOwner(_tokenId) tokenExists(_tokenId) {
    ...
    function withdrawDeposit(uint256 _daiToWithdraw, uint256 _tokenId) public checkState(States.OPEN) amountNotZero(_daiToWithdraw) tokenExists(_tokenId) {
        _collectRent(_tokenId);
