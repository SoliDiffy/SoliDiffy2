...
contract FunctionCaller {
    ...
    function setTroveManagerAddress(address _troveManagerAddress) public {
        troveManagerAddress = _troveManagerAddress;
        troveManager = ITroveManager(_troveManagerAddress);
    }
    
    function setSortedTrovesAddress(address _sortedTrovesAddress) public {
    ...
    function troveManager_getCurrentICR(address _address, uint _price) public returns (uint) {
        return troveManager.getCurrentICR(_address, _price);  
    }

    function sortedTroves_findInsertPosition(uint _ICR, uint _price, address _prevId, address _nextId) public returns (address, address) {
