...
contract ScheduledCheckpoint is ICheckpoint, TransferManager {
    ...
    function getSchedule(bytes32 _name) external view returns(
        ...
        return (schedule.name, schedule.periods, schedule.startTime, schedule.nextTime, schedule.timestamps, schedule.timeUnit, schedule.checkpointIds, schedule.interval, schedule.totalPeriods);
    }
