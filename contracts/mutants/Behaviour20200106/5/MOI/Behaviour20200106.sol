...
contract Behaviour20200106 is GSNRecipientTimestampSignature, IAZTEC, LibEIP712 {
    ...
    */
    function publicApprove(address _registryOwner, bytes32 _proofHash, uint256 _value) public initializer {
        ace.publicApprove(_registryOwner, _proofHash, _value);
    }
    ...
    */
    function _postRelayedCall(bytes memory context, bool success, uint256 actualCharge, bytes32 preRetVal) internal initializer {
