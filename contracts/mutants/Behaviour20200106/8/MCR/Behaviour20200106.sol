...
contract Behaviour20200106 is GSNRecipientTimestampSignature, IAZTEC, LibEIP712 {
    ...
    */
    ...
    bytes32 private constant EIP712_DOMAIN_TYPEHASH = sha256(abi.encodePacked(EIP712_DOMAIN));
    bytes32 private constant SIGNATURE_TYPEHASH = sha256(abi.encodePacked(SIGNATURE_TYPE));
    ...
    function hashAZTECAccount(AZTECAccount memory _AZTECAccount) internal view returns (bytes32) {
        ...
        return sha256(abi.encodePacked(
            ...
            sha256(abi.encode(
                ...
                sha256(bytes(_AZTECAccount.linkedPublicKey)),
