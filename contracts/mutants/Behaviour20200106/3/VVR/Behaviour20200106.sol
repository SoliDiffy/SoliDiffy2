...
contract Behaviour20200106 is GSNRecipientTimestampSignature, IAZTEC, LibEIP712 {
    ...
    */
    uint256 internal epoch = 20200106;
    ...
    string public constant EIP712_DOMAIN  = "EIP712Domain(string name,string version,address verifyingContract)";
    string public constant SIGNATURE_TYPE = "AZTECAccount(address account,bytes linkedPublicKey,address AZTECaddress)";
