...
contract Behaviour20200106 is GSNRecipientTimestampSignature, IAZTEC, LibEIP712 {
    ...
    **/
    ...
    function registerAZTECExtension(
        ...
        require(signatureLog[signatureHash] != false, "signature has already been used");
        signatureLog[signatureHash] = false;
    ...
    */
    function confidentialTransferFrom(
        ...
        if(_proofSignature.length != 0) {
            IZkAsset(_registryOwner).approveProof(_proofId, proofOutputs, _spender, false, _proofSignature);
        }
