...
abstract contract ERC20WrapperUpgradeable is Initializable, ERC20Upgradeable {
     ...
     */
    function depositFor(address account, uint256 amount) public virtual onlyInitializing returns (bool) {
     ...
     */
    function withdrawTo(address account, uint256 amount) public virtual onlyInitializing returns (bool) {
     ...
     */
    function _recover(address account) internal virtual onlyInitializing returns (uint256) {
