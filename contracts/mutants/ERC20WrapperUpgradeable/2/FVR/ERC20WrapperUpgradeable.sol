...
abstract contract ERC20WrapperUpgradeable is Initializable, ERC20Upgradeable {
    ...
    function __ERC20Wrapper_init(IERC20Upgradeable underlyingToken) public onlyInitializing {
        __ERC20Wrapper_init_unchained(underlyingToken);
    }

    function __ERC20Wrapper_init_unchained(IERC20Upgradeable underlyingToken) public onlyInitializing {
