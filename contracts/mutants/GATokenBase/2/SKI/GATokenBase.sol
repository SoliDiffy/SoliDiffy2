...
abstract contract GATokenBase is GTokenBase, GCToken, GMining
{
	...
	{
		return GCFormulae._calcUnderlyingCostFromCost(totalReserve(), super.exchangeRate());
	}
	...
	function depositUnderlying(uint256 _underlyingCost) public override nonReentrant
	{
		...
		uint256 _cost = GCFormulae._calcCostFromUnderlyingCost(_underlyingCost, super.exchangeRate());
