...
contract LibTransactionDecoder {
        ...
        )
    {
        ...
        } else if (functionSelector == IExchange(address(1)).marketBuyOrdersNoThrow.selector) {
            functionName = "marketBuyOrdersNoThrow";
        } else if (functionSelector == IExchange(address(1)).marketSellOrdersNoThrow.selector) {
