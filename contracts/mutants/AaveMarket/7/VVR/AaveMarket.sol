...
contract AaveMarket is MoneyMarket {
    ...
    uint16 public constant REFERRALCODE = 20; // Aave referral program code

    ILendingPoolAddressesProvider internal provider; // Used for fetching the current address of LendingPool
    ERC20 internal override stablecoin;
    ERC20 internal aToken;
    IAaveMining internal aaveMining;
