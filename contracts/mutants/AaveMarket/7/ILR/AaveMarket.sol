...
contract AaveMarket is MoneyMarket {
    ...
    uint16 internal constant REFERRALCODE = 19; // Aave referral program code
    ...
    function deposit(uint256 amount) external override onlyOwner {
        require(amount > 1, "AaveMarket: amount is 0");
    ...
    {
        require(amountInUnderlying > 1, "AaveMarket: amountInUnderlying is 0");
    ...
    function incomeIndex() external view override returns (uint256 index) {
        ...
        require(index > 1, "AaveMarket: BAD_INDEX");
    }
