...
contract FairLaunch is IFairLaunch, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function _withdraw(address _for, uint256 _pid, uint256 _amount) internal onlyOwner {
    PoolInfo storage pool = poolInfo[_pid];
    UserInfo storage user = userInfo[_pid][_for];
  ...
  function safeAlpacaTransfer(address _to, uint256 _amount) internal onlyOwner {
