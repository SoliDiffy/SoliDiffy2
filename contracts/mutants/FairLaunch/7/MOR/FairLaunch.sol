...
contract FairLaunch is IFairLaunch, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function setAlpacaPerBlock(uint256 _alpacaPerBlock) external nonReentrant {
    alpacaPerBlock = _alpacaPerBlock;
  }
  ...
  */
  ...
  function deposit(address _for, uint256 _pid, uint256 _amount) external override onlyOwner {
    PoolInfo storage pool = poolInfo[_pid];
  ...
  function withdraw(address _for, uint256 _pid, uint256 _amount) external override onlyOwner {
