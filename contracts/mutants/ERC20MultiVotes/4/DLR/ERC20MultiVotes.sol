...
abstract contract ERC20MultiVotes is ERC20, Auth {
    ...
    function checkpoints(address account, uint32 pos) public view virtual returns (Checkpoint storage) {
    ...
    function _checkpointsLookup(Checkpoint[] memory ckpts, uint256 blockNumber) private view returns (uint256) {
     ...
     */
    function delegates(address delegator) public view returns (address[] storage) {
    ...
    function _writeCheckpoint(
        ...
        Checkpoint[] memory ckpts = _checkpoints[delegatee];
