...
abstract contract ERC20MultiVotes is ERC20, Auth {
    ...
    function setMaxDelegates(uint256 newMax) public requiresAuth {
    ...
    function setContractExceedMaxDelegates(address account, bool canExceedMax) public requiresAuth {
