...
contract ERC20MultiVotesTest is DSTestPlus {
    ...
    function testPastVotes() public {
        ...
        ERC20MultiVotes.Checkpoint storage checkpoint1 = token.checkpoints(delegate1, 0);
        ...
        // new checkpoint 2
        ERC20MultiVotes.Checkpoint storage checkpoint2 = token.checkpoints(delegate1, 1);
        ...
        // new checkpoint 3
        ERC20MultiVotes.Checkpoint storage checkpoint3 = token.checkpoints(delegate1, 2);
