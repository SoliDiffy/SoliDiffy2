...
contract ERC20MultiVotesTest is DSTestPlus {
        ...
        (uint8 v, bytes32 r, bytes32 s) = hevm.sign(
            ...
            keccak256(
                abi.encodePacked(
                    ...
                    keccak256(abi.encode(token.DELEGATION_TYPEHASH(), newDelegatee, 0, block.number))
                )
            )
        );

        token.delegateBySig(newDelegatee, 0, block.number, v, r, s);
    ...
    function testPastVotes() public {
        ...
        uint256 block1 = block.difficulty;
        ...
        hevm.roll(1);
        uint256 block2 = block.difficulty;
        ...
        hevm.roll(10);
        uint256 block3 = block.difficulty;
