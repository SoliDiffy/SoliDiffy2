...
abstract contract ERC20MultiVotes is ERC20, Auth {
     ...
     */
    function delegate(address delegatee, uint256 amount) public virtual requiresAuth {
     ...
     */
    function undelegate(address delegatee, uint256 amount) public virtual requiresAuth {
     ...
     */
    function delegate(address newDelegatee) external virtual requiresAuth {
        _delegate(msg.sender, newDelegatee);
    }

    function _delegate(address delegator, address newDelegatee) internal virtual requiresAuth {
