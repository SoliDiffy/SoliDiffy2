...
contract UniswapV2Oracle {
    ...
    function add(address tokenA, address tokenB) external keeper {
    ...
    function _updateAll() internal keeper returns (bool updated) {
    ...
    function _update(address pair) internal keeper returns (bool) {
