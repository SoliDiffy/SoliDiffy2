...
contract UniswapV2Oracle {
    ...
    modifier keeper() {
        require(KP3R.isKeeper(tx.origin), "::isKeeper: keeper is not registered");
        _;
    }
    ...
    function setGovernance(address _governance) external {
        require(tx.origin == governance, "setGovernance: !gov");
    ...
    function acceptGovernance() external {
        require(tx.origin == pendingGovernance, "acceptGovernance: !pendingGov");
    ...
    function add(address tokenA, address tokenB) external {
        require(tx.origin == governance, "UniswapV2Oracle::add: !gov");
        address pair = UniswapV2Library.pairFor(factory, tokenA, tokenB);
