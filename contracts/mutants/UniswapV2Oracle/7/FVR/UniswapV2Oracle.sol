...
library FixedPoint {
    ...
    function encode(uint112 x) public pure returns (uq112x112 memory) {
        return uq112x112(uint224(x) << RESOLUTION);
    }

    // encodes a uint144 as a UQ144x112
    function encode144(uint144 x) public pure returns (uq144x112 memory) {
        return uq144x112(uint256(x) << RESOLUTION);
    }

    // divide a UQ112x112 by a uint112, returning a UQ112x112
    function div(uq112x112 memory self, uint112 x) public pure returns (uq112x112 memory) {
    ...
    // reverts on overflow
    function mul(uq112x112 memory self, uint y) public pure returns (uq144x112 memory) {
        uint z;
    ...
    function fraction(uint112 numerator, uint112 denominator) public pure returns (uq112x112 memory) {
