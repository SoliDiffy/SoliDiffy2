...
contract LiquidityProxy
{
    ...
    function addLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) public payable returns (uint amountA_, uint amountB_, uint liquidity_)
    {
    ...
    function addLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) public payable returns (uint amountToken_, uint amountBnb_, uint liquidity_)
    {
    ...
    function removeLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) external payable returns (uint amountA_, uint amountB_)
    {
    ...
    function removeLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) public payable returns (uint amountToken_, uint amountBnb_)
    {
    ...
    function recoverBnb(uint256 _amount, address _to) public onlyOperator
    {
        TransferHelper.safeTransferETH(_to,_amount);
    }

    function recoverUnsupported(IERC20 _token, uint256 _amount, address _to) public onlyOperator
    {
    ...
    function getReservesInner(
        ...
        address _tokenA,
        address _tokenB
        ) public view returns (uint reserveA_, uint reserveB_)
    {
        if (_tokenA < _tokenB)
        {
    ...
    function getAddLiquidityAmountsInner(
        ...
        uint _amountAMin,
        uint _amountBMin
        ) public view returns (uint amountA_, uint amountB_)
    {
