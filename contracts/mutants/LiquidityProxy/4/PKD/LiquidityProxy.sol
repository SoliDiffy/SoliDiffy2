...
contract LiquidityProxy
{
    ...
    function addLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) external  returns (uint amountA_, uint amountB_, uint liquidity_)
    {
    ...
    function addLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external  returns (uint amountToken_, uint amountBnb_, uint liquidity_)
    {
    ...
    function removeLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) public  returns (uint amountA_, uint amountB_)
    {
    ...
    function removeLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external  returns (uint amountToken_, uint amountBnb_)
    {
