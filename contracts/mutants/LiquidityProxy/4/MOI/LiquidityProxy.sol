...
contract LiquidityProxy
{
    ...
    function addLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external payable onlyOperator returns (uint amountToken_, uint amountBnb_, uint liquidity_)
    {
    ...
    function removeLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) public payable onlyOperator returns (uint amountA_, uint amountB_)
    {
    ...
    function removeLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external payable onlyOperator returns (uint amountToken_, uint amountBnb_)
    {
