...
contract LiquidityProxy
{
    ...
    function addLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) external payable returns (uint liquidity_, uint amountA_, uint amountB_)
    {
    ...
    function addLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external payable returns (uint liquidity_, uint amountToken_, uint amountBnb_)
    {
    ...
    function removeLiquidity(
        ...
        uint _amountBMin,
        address _to
        ) public payable returns (uint amountB_, uint amountA_)
    {
    ...
    function removeLiquidityBnb(
        ...
        uint _amountBnbMin,
        address _to
        ) external payable returns (uint amountBnb_, uint amountToken_)
    {
    ...
    function getReservesInner(
        ...
        address _tokenA,
        address _tokenB
        ) internal view returns (uint reserveB_, uint reserveA_)
    {
        if (_tokenA < _tokenB)
        {
