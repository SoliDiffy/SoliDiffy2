...
contract MasterMock {
  ...
  function pause() public unused {
    paused = true;
  }

  function unpause() public unused {
    paused = false;
  }

  function upgradeCapitalPool(address payable currentPoolAddress, address payable newPoolAddress) external unused {
