...
library FixedPointInt256 {
     ...
     */
    function fromUnscaledInt(int256 a) public pure returns (FixedPointInt memory) {
     ...
     */
    function fromScaledUint(uint256 _a, uint256 _decimals) public pure returns (FixedPointInt memory) {
     ...
     */
    function add(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
     ...
     */
    function sub(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
     ...
     */
    function mul(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
     ...
     */
    function div(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
     ...
     */
    function min(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
     ...
     */
    function max(FixedPointInt memory a, FixedPointInt memory b) public pure returns (FixedPointInt memory) {
        return a.value > b.value ? a : b;
    }
     ...
     */
    function isEqual(FixedPointInt memory a, FixedPointInt memory b) public pure returns (bool) {
