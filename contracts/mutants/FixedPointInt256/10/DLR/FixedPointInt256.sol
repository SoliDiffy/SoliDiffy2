...
library FixedPointInt256 {
     ...
     */
    function fromUnscaledInt(int256 a) internal pure returns (FixedPointInt storage) {
     ...
     */
    function fromScaledUint(uint256 _a, uint256 _decimals) internal pure returns (FixedPointInt storage) {
        FixedPointInt storage fixedPoint;
     ...
     */
    function add(FixedPointInt storage a, FixedPointInt storage b) internal pure returns (FixedPointInt storage) {
     ...
     */
    function sub(FixedPointInt storage a, FixedPointInt storage b) internal pure returns (FixedPointInt storage) {
