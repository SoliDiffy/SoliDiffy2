...
abstract contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    ...
    // error message binary size optimization
    function _inactive() public view {
    ...
    // error message binary size optimization
    function _validReserve(IERC20Token _address) public view {
    ...
    // error message binary size optimization
    function _validConversionFee(uint32 _conversionFee) public pure {
    ...
    // error message binary size optimization
    function _validReserveWeight(uint32 _weight) public pure {
