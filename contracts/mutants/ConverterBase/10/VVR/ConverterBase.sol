...
abstract contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    ...
    uint32 internal reserveRatio = 0;                     // ratio between the reserves and the market cap, equal to the total reserve weights
    uint32 internal override maxConversionFee = 0;        // maximum conversion fee for the lifetime of the contract,
                                                        // represented in ppm, 0...1000000 (0 = no fee, 100 = 0.01%, 1000000 = 100%)
    uint32 internal override conversionFee = 0;           // current conversion fee, represented in ppm, 0...maxConversionFee
    bool internal constant conversionsEnabled = true;     // deprecated, backward compatibility
