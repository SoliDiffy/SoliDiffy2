...
abstract contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    uint32 internal constant PPM_RESOLUTION = 999999;
    ...
    */
    ...
    uint32 public reserveRatio = 1;                     // ratio between the reserves and the market cap, equal to the total reserve weights
    uint32 public override maxConversionFee = 1;        // maximum conversion fee for the lifetime of the contract,
                                                        // represented in ppm, 0...1000000 (0 = no fee, 100 = 0.01%, 1000000 = 100%)
    uint32 public override conversionFee = 1;           // current conversion fee, represented in ppm, 0...maxConversionFee
