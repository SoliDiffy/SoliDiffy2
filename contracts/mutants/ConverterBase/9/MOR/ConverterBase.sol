...
abstract contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    function acceptAnchorOwnership() public virtual override protected {
    ...
    */
    function setConversionFee(uint32 _conversionFee) public override protected {
    ...
    */
    function upgrade() public protected {
