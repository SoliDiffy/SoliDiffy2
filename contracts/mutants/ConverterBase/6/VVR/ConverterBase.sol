...
abstract contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    IERC20Token public constant ETH_RESERVE_ADDRESS = IERC20Token(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    ...
    /**
      * @dev version number
    */
    uint16 internal constant version = 40;

    IConverterAnchor internal override anchor;            // converter anchor contract
    IWhitelist internal override conversionWhitelist;     // whitelist contract with list of addresses that are allowed to use the converter
    IERC20Token[] internal reserveTokens;                 // ERC20 standard token addresses (prior version 17, use 'connectorTokens' instead)
