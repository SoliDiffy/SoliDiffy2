    ...
    GovernorCountingSimpleUpgradeable
{
    ...
    function cancel(
        ...
        bytes32 salt
    ) public onlyInitializing returns (uint256 proposalId) {
    ...
    ) internal virtual override(GovernorUpgradeable, GovernorTimelockCompoundUpgradeable) onlyInitializing {
    ...
    function _cancel(
        ...
        bytes[] memory calldatas,
        bytes32 salt
    ) internal virtual override(GovernorUpgradeable, GovernorTimelockCompoundUpgradeable) onlyInitializing returns (uint256 proposalId) {
