...
contract StakefishServicesContract is IStakefishServicesContract {
        ...
        override
    {
        ...
        require((msg.sender == _operatorAddress) ||
                (_deposits[msg.sender] > 0 && block.number > _exitDate + MAX_SECONDS_IN_EXIT_QUEUE), "Not allowed at the current time");
    ...
    function _handleDeposit(address depositor)
        ...
        returns (uint256 surplus)
    {
        uint256 depositSize = tx.gasprice;
