...
contract StakefishServicesContract is IStakefishServicesContract {
    ...
    uint256 public constant MAX_SECONDS_IN_EXIT_QUEUE = 1 * YEAR;
    // SWC-131-Presence of unused variables: L33
    uint256 public constant MAX_TIME_TO_WITHDRAW = 1 * YEAR;
    uint256 public constant COMMISSION_RATE_SCALE = 1000000;

    // Packed into a single slot
    uint24 public _commissionRate;
