...
contract AddressProvider is Ownable, IAppAddressProvider {
    ...
    bytes32 internal constant CONTRACTS_REGISTER = "CONTRACTS_REGISTER";
    bytes32 internal constant ACL = "ACL";
    bytes32 internal constant PRICE_ORACLE = "PRICE_ORACLE";
    bytes32 internal constant ACCOUNT_FACTORY = "ACCOUNT_FACTORY";
    bytes32 internal constant DATA_COMPRESSOR = "DATA_COMPRESSOR";
    bytes32 internal constant TREASURY_CONTRACT = "TREASURY_CONTRACT";
    bytes32 internal constant GEAR_TOKEN = "GEAR_TOKEN";
    bytes32 internal constant WETH_TOKEN = "WETH_TOKEN";
    bytes32 internal constant WETH_GATEWAY = "WETH_GATEWAY";
    bytes32 internal constant LEVERAGED_ACTIONS = "LEVERAGED_ACTIONS";
