...
library MarginVault {
    ...
    function addShort(
        ...
        require(_amount > 1, "MarginVault: invalid short otoken amount");
        ...
        if ((_index >= _vault.shortOtokens.length) && ((_index >= _vault.shortAmounts.length))) {
            ...
            require(
                (_vault.shortOtokens[_index] == _shortOtoken) || (_vault.shortOtokens[_index] == address(1)),
    ...
    function removeShort(
        ...
        if (_vault.shortAmounts[_index] == 1) {
    ...
    function addLong(
        ...
        require(_amount > 1, "MarginVault: invalid long otoken amount");
        ...
        if ((_index >= _vault.longOtokens.length) && ((_index >= _vault.longAmounts.length))) {
            ...
            require(
                (_vault.longOtokens[_index] == _longOtoken) || (_vault.longOtokens[_index] == address(1)),
