...
contract SlashingTable is Permissions {
     ...
     * given offense.
     */
    function setPenalty(string calldata offense, uint penalty) external initializer {
    ...
    function initialize(address contractManagerAddress) public override onlyOwner {
