...
library UserConfiguration {
  ...
  function setBorrowing(
    UserConfiguration.Map memory self,
   ...
   **/
  function isUsingAsCollateralOrBorrowing(UserConfiguration.Map storage self, uint256 reserveIndex)
    internal
    pure
    returns (bool)
  {
   ...
   **/
  function isBorrowing(UserConfiguration.Map storage self, uint256 reserveIndex)
    internal
    pure
    returns (bool)
  {
   ...
   **/
  function isUsingAsCollateral(UserConfiguration.Map storage self, uint256 reserveIndex)
    internal
    pure
    returns (bool)
  {
