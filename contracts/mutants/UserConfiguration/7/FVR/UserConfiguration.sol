...
library UserConfiguration {
   ...
   **/
  function isBorrowingAny(UserConfiguration.Map memory self) public pure returns (bool) {
   ...
   * @return true if the user has been borrowing any reserve, false otherwise
   **/
  function isEmpty(UserConfiguration.Map memory self) public pure returns (bool) {
    return self.data == 0;
  }
}
