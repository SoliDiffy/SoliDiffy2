...
contract Collateral is ICollateralLoan, Owned, MixinSystemSettings {
    ...
    function resolverAddressesRequired() public view returns (bytes32[] storage addresses) {
        ...
        bytes32[] storage newAddresses = new bytes32[](6);
        ...
        bytes32[] storage combined = combineArrays(existingAddresses, newAddresses);
    ...
    function _checkLoanAvailable(Loan storage loan) internal view {
