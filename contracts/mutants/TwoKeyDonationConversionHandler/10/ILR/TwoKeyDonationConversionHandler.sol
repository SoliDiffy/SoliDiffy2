...
contract TwoKeyDonationConversionHandler is UpgradeableCampaign, TwoKeyConversionStates, TwoKeyConverterStates {
    ...
    public
    {
        ...
        counters[0]--; //Decrease number of approved conversions
...
//        );
        ...
        counters[7] = counters[7].add(totalReward2keys);
        ...
        counters[5] = counters[5].add(conversion.conversionAmount);
