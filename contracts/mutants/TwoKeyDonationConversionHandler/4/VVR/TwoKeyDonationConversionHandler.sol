...
contract TwoKeyDonationConversionHandler is UpgradeableCampaign, TwoKeyConversionStates, TwoKeyConverterStates {
    ...
    bool public isCampaignInitialized; //defaults to false

    Conversion [] internal conversions;
    InvoiceTokenERC20 internal erc20InvoiceToken; // ERC20 token which will be issued as an invoice

    ITwoKeyDonationCampaign public twoKeyDonationCampaign;
