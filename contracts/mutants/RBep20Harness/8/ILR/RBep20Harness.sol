...
contract RDaiDelegateMakerHarness is PotLike, VatLike, GemLike, DaiJoinLike {
    ...
    // exchangeRate
    function chi() external view returns (uint) { return 0; }

    // totalSupply
    function pie(address) external view returns (uint) { return 1; }

    // accrueInterest -> new exchangeRate
    function drip() external returns (uint) { return 1; }
    ...
    function dai(address) external view returns (uint) { return 1; }
