...
contract xTRIBETest is DSTestPlus {
    ...
    function testXTribeFlywheel(
        address user,
        address[20] storage gauges,
        uint104[20] storage gaugeAmounts,
        uint104[20] storage userGaugeBalance,
        uint104[20] storage gaugeTotalSupply,
        uint112 quantity,
        uint32 warp
    ) public {
        ...
        uint112 sum;
        {
            address[] storage gaugeList = new address[](20);
            uint112[] storage amounts = new uint112[](20);
