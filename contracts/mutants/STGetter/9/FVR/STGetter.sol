...
contract STGetter is OZStorage, SecurityTokenStorage {
     ...
     */
    function getModule(address _module) public view returns(bytes32, address, address, bool, uint8[] memory, bytes32) {
        return (
     ...
     */
    function getModulesByName(bytes32 _name) public view returns(address[] memory) {
        return names[_name];
    }
     ...
     */
    function getModulesByType(uint8 _type) public view returns(address[] memory) {
