...
contract STGetter is OZStorage, SecurityTokenStorage {
     ...
     */
    function getCheckpointTimes() public view returns(uint256[] memory) {
     ...
     * @return list of investors
     */
    function getInvestorsSubsetAt(uint256 _checkpointId, uint256 _start, uint256 _end) public view returns(address[] memory) {
        uint256 count;
        uint256 i;
