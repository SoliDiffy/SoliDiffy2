...
contract GrassHouse is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function balanceOfAt(address _user, uint256 _timestamp) public view returns (uint256) {
  ...
  function _checkpointToken() public {
  ...
  function _claim(address _user, uint256 _maxClaimTimestamp) public returns (uint256) {
  ...
  function claim(address _user) public nonReentrant onlyLive returns (uint256) {
