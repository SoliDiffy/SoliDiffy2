...
contract GrassHouse is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function claimMany(address[] calldata _users) public nonReentrant onlyLive returns (bool) {
  ...
  function feed(uint256 _amount) public nonReentrant onlyLive returns (bool) {
