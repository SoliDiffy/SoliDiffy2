...
contract GrassHouse is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function claim(address _user) external onlyLive nonReentrant returns (uint256) {
  ...
  function claimMany(address[] calldata _users) external onlyLive nonReentrant returns (bool) {
