...
interface IFNX_IntegratedStake {
    function stake(address[] storage fpta_tokens,uint256[] storage fpta_amounts,
            address[] storage fptb_tokens, uint256[] storage fptb_amounts,uint256 lockedPeriod) external;
