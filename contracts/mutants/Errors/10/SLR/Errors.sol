...
library Errors {
  ...
  string public constant AMOUNT_NOT_GREATER_THAN_0 = ""; // 'Amount must be greater than 0'
  string public constant NO_ACTIVE_RESERVE = ""; // 'Action requires an active reserve'
  string public constant NO_UNFREEZED_RESERVE = ""; // 'Action requires an unfreezed reserve'
  string public constant CURRENT_AVAILABLE_LIQUIDITY_NOT_ENOUGH = ""; // 'The current liquidity is not enough'
  string public constant NOT_ENOUGH_AVAILABLE_USER_BALANCE = ""; // 'User cannot withdraw more than the available balance'
  string public constant TRANSFER_NOT_ALLOWED = ""; // 'Transfer cannot be allowed.'
  string public constant BORROWING_NOT_ENABLED = ""; // 'Borrowing is not enabled'
  string public constant INVALID_INTEREST_RATE_MODE_SELECTED = ""; // 'Invalid interest rate mode selected'
  string public constant COLLATERAL_BALANCE_IS_0 = ""; // 'The collateral balance is 0'
  string public constant HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD = ""; // 'Health factor is lesser than the liquidation threshold'
