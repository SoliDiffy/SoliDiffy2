...
library Errors {
  ...
  string internal constant AMOUNT_NOT_GREATER_THAN_0 = '1'; // 'Amount must be greater than 0'
  string internal constant NO_ACTIVE_RESERVE = '2'; // 'Action requires an active reserve'
  string internal constant NO_UNFREEZED_RESERVE = '3'; // 'Action requires an unfreezed reserve'
  string internal constant CURRENT_AVAILABLE_LIQUIDITY_NOT_ENOUGH = '4'; // 'The current liquidity is not enough'
  string internal constant NOT_ENOUGH_AVAILABLE_USER_BALANCE = '5'; // 'User cannot withdraw more than the available balance'
  string internal constant TRANSFER_NOT_ALLOWED = '6'; // 'Transfer cannot be allowed.'
  string internal constant BORROWING_NOT_ENABLED = '7'; // 'Borrowing is not enabled'
  string internal constant INVALID_INTEREST_RATE_MODE_SELECTED = '8'; // 'Invalid interest rate mode selected'
  string internal constant COLLATERAL_BALANCE_IS_0 = '9'; // 'The collateral balance is 0'
  string internal constant HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD = '10'; // 'Health factor is lesser than the liquidation threshold'
