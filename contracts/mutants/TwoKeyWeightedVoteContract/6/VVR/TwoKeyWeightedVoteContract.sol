...
contract TwoKeyWeightedVoteContract is TwoKeySignedPresellContract {
  ...
  uint internal voted_yes;
  uint internal voted_no;
  uint internal total_vote;  // this can be bigger than voted_yes+voted_no because of abstain votes
  uint internal weighted_yes;
  uint internal weighted_no;
  int internal total_weight;  // this can be bigger than weighted_yes+weighted_no because of lack of voting coins
