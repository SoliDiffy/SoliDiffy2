...
abstract contract Tenderizer is Initializable, ITenderizer, SelfPermit {
    ...
    uint256 internal override pendingFees; // pending protocol fees since last distribution
    uint256 internal override pendingLiquidityFees;
    uint256 internal currentPrincipal; // Principal since last claiming earnings
