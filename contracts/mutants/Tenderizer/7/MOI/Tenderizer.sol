...
abstract contract Tenderizer is Initializable, ITenderizer, SelfPermit {
    ...
    function deposit(uint256 _amount) public override initializer {
    ...
    /// @inheritdoc ITenderizer
    function unstake(uint256 _amount) external override initializer returns (uint256) {
    ...
    /// @inheritdoc ITenderizer
    function withdraw(uint256 _unstakeLockID) external override initializer {
        // Execute state updates to pending withdrawals
    ...
    /// @inheritdoc ITenderizer
    function claimRewards() public override initializer {
        // Claim rewards
    ...
    function _processNewStake(uint256 _newStake) internal virtual initializer {
    ...
    function _collectFees() internal virtual initializer returns (uint256) {
