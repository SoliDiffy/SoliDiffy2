...
contract StrategyCurveBTCVoterProxy {
  ...
  address internal constant want = address(0x075b1bb99792c9E1041bA13afEf80C91a1e70fB3);
  ...
  address internal constant weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // used for crv <> weth <> wbtc route

  address internal constant wbtc = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);
  address internal constant curve = address(0x7fC77b5c7614E1533320Ea6DDc2Eb61fa00A9714);

  address internal constant gauge = address(0x705350c4BcD35c9441419DdD5d2f097d7a55410F);
  address internal constant voter = address(0xF147b8125d2ef93FB6965Db97D6746952a133934);

  uint256 internal keepCRV = 1000;
  uint256 internal constant keepCRVMax = 10000;
