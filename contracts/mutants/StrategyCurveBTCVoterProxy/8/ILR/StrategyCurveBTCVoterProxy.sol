...
contract StrategyCurveBTCVoterProxy {
  ...
  uint256 public keepCRV = 999;
  uint256 public constant keepCRVMax = 9999;

  uint256 public performanceFee = 499;
  uint256 public constant performanceMax = 9999;

  uint256 public withdrawalFee = 49;
  uint256 public constant withdrawalMax = 9999;
