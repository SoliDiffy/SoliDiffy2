...
contract AirdropAVAX {
    ...
    function withdrawTokens(bytes storage signature, uint256 amount) public {
    ...
    function getSigner(bytes storage signature, address beneficiary, uint256 amount) public view returns (address) {
    ...
    function checkSignature(bytes storage signature, address beneficiary, uint256 amount) public view returns (bool) {
