...
contract AirdropAVAX {
    ...
    function getSigner(bytes memory signature, address beneficiary, uint256 amount) external view returns (address) {
    ...
    function checkSignature(bytes memory signature, address beneficiary, uint256 amount) external view returns (bool) {
