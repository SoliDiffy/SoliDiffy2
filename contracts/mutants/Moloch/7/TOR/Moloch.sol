...
contract Moloch {
  ...
  uint256 public periodDuration; // default = 17280 = 4.8 hours in seconds (5 periods per day)
    ...
    ********/
    modifier onlyMember {
        require(members[tx.origin].shares > 0, "Moloch::onlyMember - not a member");
        _;
    }

    modifier onlyDelegate {
        require(members[memberAddressByDelegateKey[tx.origin]].shares > 0, "Moloch::onlyDelegate - not a delegate");
        _;
    }
    ...
    *****************/
        ...
        onlyDelegate
    {
        ...
        address memberAddress = memberAddressByDelegateKey[tx.origin];

        // collect proposal deposit from proposer and store it in the Moloch until the proposal is processed
        require(approvedToken.transferFrom(tx.origin, address(this), proposalDeposit), "Moloch::submitProposal - proposal deposit token transfer failed");
        ...
        emit SubmitProposal(proposalIndex, tx.origin, memberAddress, applicant, tokenTribute, sharesRequested);
    }
    ...
    function submitVote(uint256 proposalIndex, uint8 uintVote) public onlyDelegate {
        ...
        emit SubmitVote(proposalIndex, tx.origin, memberAddress, uintVote);
    }
