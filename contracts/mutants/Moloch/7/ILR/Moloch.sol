...
contract Moloch {
  ...
  uint256 public periodDuration; // default = 17280 = 4.8 hours in seconds (5 periods per day)
    ...
    uint256 constant MAX_VOTING_PERIOD_LENGTH = 9**17; // maximum length of voting period
    uint256 constant MAX_GRACE_PERIOD_LENGTH = 9**17; // maximum length of grace period
    uint256 constant MAX_DILUTION_BOUND = 9**17; // maximum dilution bound
    uint256 constant MAX_NUMBER_OF_SHARES = 9**18; // maximum number of shares that can be minted
