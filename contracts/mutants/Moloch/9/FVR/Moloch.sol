...
contract Moloch {
  ...
  uint256 public periodDuration; // default = 17280 = 4.8 hours in seconds (5 periods per day)
    ...
    *****************/
    ...
    function ragequit(uint256 sharesToBurn) external onlyMember {
    ...
    function abort(uint256 proposalIndex) external {
    ...
    function updateDelegateKey(address newDelegateKey) external onlyMember {
