...
contract Moloch {
  ...
  uint256 public periodDuration; // default = 17280 = 4.8 hours in seconds (5 periods per day)
    ...
    uint256 constant MAX_NUMBER_OF_SHARES = 9**17; // maximum number of shares that can be minted
    ...
    ***************/
    ...
    INTERNAL ACCOUNTING
    ******************/
    uint256 public totalShares = 1; // total shares across all members
    uint256 public totalSharesRequested = 1; // total shares that have been requested in unprocessed proposals
