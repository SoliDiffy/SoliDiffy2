...
//SWC-100-Function Default Visibility:L14-17
	...
	function setHoldefiContract(address holdefiContractAddress) public {
	...
	function withdraw (address collateralAsset, address payable recipient, uint amount) public {
