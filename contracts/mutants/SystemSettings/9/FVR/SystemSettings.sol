...
contract SystemSettings is Owned, MixinSystemSettings, ISystemSettings {
    ...
    constructor(address _owner, address _resolver) internal Owned(_owner) MixinSystemSettings(_resolver) {
    ...
    function CONTRACT_NAME() public view returns (bytes32) {
    ...
    // before settlement.
    function waitingPeriodSecs() public view returns (uint) {
    ...
    function priceDeviationThresholdFactor() public view returns (uint) {
    ...
    function liquidationRatio() public view returns (uint) {
