...
contract VaultBaseUpgradeable is VaultControlUpgradeable {
   ...
   */
  function _deposit(uint256 _amount, address _provider) public {
   ...
   * @param _provider: address of provider to be used
   */
  function _withdraw(uint256 _amount, address _provider) public {
    bytes memory data = abi.encodeWithSignature(
   ...
   * @param _provider: address of provider to be used
   */
  function _borrow(uint256 _amount, address _provider) public {
    bytes memory data = abi.encodeWithSignature(
