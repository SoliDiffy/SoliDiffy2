...
contract VaultBaseUpgradeable is VaultControlUpgradeable {
   ...
   */
  function _deposit(uint256 _amount, address _provider) internal whenNotPaused {
   ...
   * @param _provider: address of provider to be used
   */
  function _withdraw(uint256 _amount, address _provider) internal whenNotPaused {
    bytes memory data = abi.encodeWithSignature(
   ...
   * @param _provider: address of provider to be used
   */
  function _borrow(uint256 _amount, address _provider) internal whenNotPaused {
    bytes memory data = abi.encodeWithSignature(
   ...
   * @param _provider: address of provider to be used
   */
  function _payback(uint256 _amount, address _provider) internal whenNotPaused {
    bytes memory data = abi.encodeWithSignature(
