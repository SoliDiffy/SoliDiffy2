...
contract DharmaSmartWalletImplementationV2 is
  ...
  address public _userSigningKey;
  ...
  bytes4 public _selfCallContext;
  ...
  uint256 public constant _DHARMA_SMART_WALLET_VERSION = 2;

  // The Dharma Key Registry holds a public key for verifying meta-transactions.
  DharmaKeyRegistryInterface public constant _DHARMA_KEY_REGISTRY = (
  ...
  address public constant _ACCOUNT_RECOVERY_MANAGER = address(
    0x00000000d750176e38660203C678D88eE7e28d36
  );

  // This contract interfaces with Dai, USDC, and related CompoundV2 contracts.
  CTokenInterface public constant _CDAI = CTokenInterface(
    0xF5DCe57282A584D2746FaF1593d3121Fcac444dC // mainnet
  );

  CTokenInterface public constant _CUSDC = CTokenInterface(
    0x39AA39c021dfbaE8faC545936693aC917d5E7563 // mainnet
  );

  IERC20 public constant _DAI = IERC20(
    0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359 // mainnet
  );

  IERC20 public constant _USDC = IERC20(
