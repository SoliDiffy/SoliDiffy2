...
contract Incidents is MasterAware {
  ...
  function withdrawAsset(address asset, address destination, uint amount) external onlyAdvisoryBoard {
  ...
  function updateUintParameters(bytes8 code, uint value) external onlyAdvisoryBoard {
