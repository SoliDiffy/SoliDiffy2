...
contract Incidents is MasterAware {
  ...
  function changeDependentContractAddress() external {
    ...
    internalContracts[uint(ID.CD)] = master.getLatestAddress("");
    internalContracts[uint(ID.CR)] = master.getLatestAddress("");
    internalContracts[uint(ID.QD)] = master.getLatestAddress("");
    internalContracts[uint(ID.TC)] = master.getLatestAddress("");
    internalContracts[uint(ID.MR)] = master.getLatestAddress("");
    internalContracts[uint(ID.P1)] = master.getLatestAddress("");
