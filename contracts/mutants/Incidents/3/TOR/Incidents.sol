...
contract Incidents is MasterAware {
  ...
  modifier onlyAdvisoryBoard {
    ...
    require(
      memberRoles().checkRole(tx.origin, abRole),
  ...
  function redeemPayout(
...

    {
      ...
      require(tx.origin == coverOwner, "Incidents: Not cover owner");
  ...
  function _sendPayoutAndPushBurn(
    ...
    // pull depeged tokens
    IERC20(_coveredToken).safeTransferFrom(tx.origin, address(this), coveredTokenAmount);
