...
abstract contract PeriodicPrizeStrategy is Initializable,
  ...
  function _awardTickets(address user, uint256 amount) internal initializer {
  ...
  function _awardAllExternalTokens(address winner) internal initializer {
  ...
  /// @param winner The user to transfer the tokens to
  function _awardExternalErc20s(address winner) internal initializer {
  ...
  /// @param winner The user to transfer the tokens to
  function _awardExternalErc721s(address winner) internal initializer {
  ...
  function cancelAward() public initializer {
  ...
  function _setRngRequestTimeout(uint32 _rngRequestTimeout) internal initializer {
  ...
  function _addExternalErc20Award(IERC20Upgradeable _externalErc20) internal initializer {
