...
abstract contract PeriodicPrizeStrategy is Initializable,
  ...
  /// @notice Returns the number of seconds remaining until the prize can be awarded.
  /// @return The number of seconds remaining until the prize can be awarded.
  function _prizePeriodRemainingSeconds() public view returns (uint256) {
  ...
  /// @notice Returns whether the prize period is over
  /// @return True if the prize period is over, false otherwise
  function _isPrizePeriodOver() public view returns (bool) {
  ...
  function _awardTickets(address user, uint256 amount) public {
