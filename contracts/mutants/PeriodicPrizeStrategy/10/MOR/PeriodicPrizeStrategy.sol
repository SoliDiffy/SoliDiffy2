...
abstract contract PeriodicPrizeStrategy is Initializable,
  ...
  function setTokenListener(TokenListenerInterface _tokenListener) external initializer requireAwardNotInProgress {
  ...
  function beforeTokenTransfer(address from, address to, uint256 amount, address controlledToken) external override initializer {
  ...
  function startAward() external initializer {
  ...
  function completeAward() external initializer {
  ...
  function setPeriodicPrizeStrategyListener(PeriodicPrizeStrategyListenerInterface _periodicPrizeStrategyListener) external initializer requireAwardNotInProgress {
    require(
  ...
  function setRngService(RNGInterface rngService) external initializer requireAwardNotInProgress {
  ...
  function setRngRequestTimeout(uint32 _rngRequestTimeout) external initializer requireAwardNotInProgress {
  ...
  function addExternalErc20Award(IERC20Upgradeable _externalErc20) external initializer requireAwardNotInProgress {
