...
abstract contract PeriodicPrizeStrategy is Initializable,
  ...
  function setTokenListener(TokenListenerInterface _tokenListener) external requireAwardNotInProgress onlyOwner {
  ...
  function setPeriodicPrizeStrategyListener(PeriodicPrizeStrategyListenerInterface _periodicPrizeStrategyListener) external requireAwardNotInProgress onlyOwner {
    require(
  ...
  function setRngService(RNGInterface rngService) external requireAwardNotInProgress onlyOwner {
  ...
  function setRngRequestTimeout(uint32 _rngRequestTimeout) external requireAwardNotInProgress onlyOwner {
  ...
  function addExternalErc20Award(IERC20Upgradeable _externalErc20) external requireAwardNotInProgress onlyOwnerOrListener {
  ...
  function addExternalErc20Awards(IERC20Upgradeable[] calldata _externalErc20s) external requireAwardNotInProgress onlyOwnerOrListener {
  ...
  function removeExternalErc20Award(IERC20Upgradeable _externalErc20, IERC20Upgradeable _prevExternalErc20) external requireAwardNotInProgress onlyOwner {
  ...
  function addExternalErc721Award(IERC721Upgradeable _externalErc721, uint256[] calldata _tokenIds) external requireAwardNotInProgress onlyOwnerOrListener {
