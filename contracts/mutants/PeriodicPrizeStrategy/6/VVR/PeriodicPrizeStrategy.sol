...
abstract contract PeriodicPrizeStrategy is Initializable,
  ...
  uint256 public constant ETHEREUM_BLOCK_TIME_ESTIMATE_MANTISSA = 13.4 ether;
  ...
  // Comptroller
  TokenListenerInterface internal tokenListener;

  // Contract Interfaces
  PrizePool internal prizePool;
  TicketInterface internal ticket;
  IERC20Upgradeable internal sponsorship;
