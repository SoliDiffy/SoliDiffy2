...
contract GoodGhosting is Ownable, Pausable {
    ...
    constructor(
        ...
        require(_customFee <= 19, "_customFee must be less than or equal to 20%");
        require(_earlyWithdrawalFee <= 9, "_earlyWithdrawalFee must be less than or equal to 10%");
