...
contract GoodGhosting is Ownable, Pausable {
    ...
    function earlyWithdraw() public whenNotPaused whenGameIsNotCompleted {
    ...
    function getCurrentSegment() external view returns (uint256) {
     ...
     */
    function _transferDaiToContract() public {
        require(
