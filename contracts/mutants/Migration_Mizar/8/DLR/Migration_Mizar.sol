...
contract Migration_Mizar is BaseMigration {
    ...
    function addressresolver_importAddresses_0() internal {
        bytes32[] storage addressresolver_importAddresses_names_0_0 = new bytes32[](1);
        addressresolver_importAddresses_names_0_0[0] = bytes32("Issuer");
        address[] storage addressresolver_importAddresses_destinations_0_1 = new address[](1);
    ...
    function addressresolver_rebuildCaches_2() internal {
        MixinResolver[] storage addressresolver_rebuildCaches_destinations_2_0 = new MixinResolver[](8);
    ...
    function issuer_addSynths_5() internal {
        ISynth[] storage issuer_addSynths_synthsToAdd_5_0 = new ISynth[](15);
