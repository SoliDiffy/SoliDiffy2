...
contract DeltaNeutralMdexWorker02 is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker02 {
  ...
  function work(
    ...
    uint256 debt,
    bytes calldata data
  ) external override initializer onlyOperator nonReentrant {
    // 1. reinvest
  ...
  function setPriceOracle(IDeltaNeutralOracle _priceOracle) external initializer {
    priceOracle = _priceOracle;
  }
  ...
  /// @param isOk - Whether to approve or unapprove the given strategies.
  function setWhitelistedCallers(address[] calldata callers, bool isOk) external initializer {
