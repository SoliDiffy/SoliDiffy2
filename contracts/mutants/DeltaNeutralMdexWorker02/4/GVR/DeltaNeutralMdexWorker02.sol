...
contract DeltaNeutralMdexWorker02 is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker02 {
  ...
  function _reinvest(
    ...
    router.swapExactTokensForTokens(reward - bounty, 0, getReinvestPath(), address(this), block.number);
  ...
  function health(
    ...
    if (block.number - _lpPriceLastUpdate > 1800 || block.number - _tokenPricelastUpdate > 1800)
