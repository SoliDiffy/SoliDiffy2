...
contract PoolManagerInternal is PoolManagerStorage, AccessControlUpgradeable {
    ...
    function _addGuardian(address _guardian) public {
    ...
    function _revokeGuardian(address guardian) public {
    ...
    function _updateStrategyDebtRatio(address strategy, uint256 _debtRatio) public {
