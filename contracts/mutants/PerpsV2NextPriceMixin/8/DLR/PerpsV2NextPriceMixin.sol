...
contract PerpsV2NextPriceMixin is PerpsV2MarketBase {
    ...
    function cancelNextPriceOrder(address account) external {
        ...
        NextPriceOrder storage order = nextPriceOrders[account];
    ...
    function _nextPriceCommitDeposit(TradeParams storage params) internal view returns (uint) {
