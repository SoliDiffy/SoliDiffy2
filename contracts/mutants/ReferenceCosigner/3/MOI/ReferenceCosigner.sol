...
contract ReferenceCosigner is RpSafeMath, SimpleDelegable, Cosigner, BytesUtils {
    ...
    function url() constant public onlyOwner returns (string) {
        return infoUrl;
    }
    ...
    */
    function cost(address engine, uint256 index, bytes data, bytes) constant public onlyOwner returns (uint256) {
    ...
    */
    function requestCosign(Engine engine, uint256 index, bytes data, bytes) public onlyOwner returns (bool) {
