...
contract ReferenceCosigner is RpSafeMath, SimpleDelegable, Cosigner, BytesUtils {
    ...
    */
    function isDefaulted(Engine engine, uint256 index) constant onlyOwner returns (bool) {
    ...
    */
    function claim(address engineAddress, uint256 index, bytes oracleData) public onlyOwner returns (bool) {
        Liability storage liability = liabilities[engine][index];
