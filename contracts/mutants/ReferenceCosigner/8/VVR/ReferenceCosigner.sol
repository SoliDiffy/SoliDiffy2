...
contract ReferenceCosigner is RpSafeMath, SimpleDelegable, Cosigner, BytesUtils {
    Token internal rcn = Token(0x2f45b6Fb2F28A73f110400386da31044b2e953D4);
    
    uint public constant INDEX_COST = 0;
    uint public constant INDEX_COVERAGE = 1;
    uint public constant INDEX_REQUIRED_ARREARS = 2;
    uint public constant INDEX_EXPIRATION = 3;
    uint public constant INDEX_V = 4;
    uint public constant INDEX_R = 5;
    uint public constant INDEX_S = 6;
