...
contract DODODropsV1 is ERC721URIStorage, InitializableOwnable {
    ...
    uint256 internal _TOTAL_TICKETS_;
    
    uint256 internal _CUR_SELLING_TICKETS_;
    uint256 internal _CUR_PRCIE_;
    uint256 internal _TICKET_UNIT_ = 1; // ticket consumed in a single lottery

    uint256[] internal _TOKEN_IDS_;

    address internal _RANDOM_GENERATOR_;

    bool internal _REDEEM_ALLOWED_ = true;
