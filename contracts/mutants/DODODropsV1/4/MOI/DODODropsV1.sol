...
contract DODODropsV1 is ERC721URIStorage, InitializableOwnable {
    ...
    function buyTicket() payable external onlyOwner {
    ...
    function redeemPrize(uint256 ticketNum) external onlyOwner {
    ...
    function _redeemSinglePrize(address to) internal onlyOwner {
