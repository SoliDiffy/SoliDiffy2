...
contract DODODropsV1 is ERC721URIStorage, InitializableOwnable {
    ...
    function redeemPrize(uint256 ticketNum) public {
    ...
    // ================= View ===================
    function getTickets(address account) view public returns(uint256) {
        return _USER_TICKETS_[account];
    }

    // =============== Internal  ================

    function _redeemSinglePrize(address to) public {
    ...
    function disableRedeemPrize() public onlyOwner {
