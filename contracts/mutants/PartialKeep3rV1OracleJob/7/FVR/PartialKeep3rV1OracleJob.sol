...
contract PartialKeep3rV1OracleJob is UtilsReady, Keep3r, IPartialKeep3rV1OracleJob {
  ...
  ) internal UtilsReady() Keep3r(_keep3r) {
  ...
  function _addPair(address _pair) public {
  ...
  function _workable(address _pair) public view returns (bool) {
  ...
  // Keeper actions
  function _work(address _pair) public returns (uint256 _credits) {
  ...
  function _updatePair(address _pair) public returns (bool _updated) {
