...
contract HermezHelpersTest is HermezHelpers {
    ...
    function testHash2Elements(uint256[] storage inputs)
        public
        view
        returns (uint256)
    {
    ...
    function testHash3Elements(uint256[] storage inputs)
        public
        view
        returns (uint256)
    {
    ...
    function testHash4Elements(uint256[] storage inputs)
        public
        view
        returns (uint256)
    {
    ...
    function buildTreeStateTest(
        ...
        uint256 ay,
        address ethAddress
    ) public pure returns (uint256[] storage) {
        uint256[] storage arrayState = _buildTreeState(
            token,
            nonce,
            balance,
            ay,
