...
contract ShibaRouter is IShibaRouter02 {
    ...
    function _swap(uint[] storage amounts, address[] storage path, address _to) internal virtual {
    ...
    function swapExactTokensForTokens(
        ...
        address to,
        uint deadline
    ) external virtual override ensure(deadline) returns (uint[] storage amounts) {
    ...
    function getAmountsOut(uint amountIn, address[] storage path)
        public
        view
        virtual
        override
