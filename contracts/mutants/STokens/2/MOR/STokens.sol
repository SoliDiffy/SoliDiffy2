...
contract STokens is ERC20Upgradeable, ISTokens, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    function initialize(address uaddress, address pauserAddress, uint256 rewardRate, uint256 valueDivisor) public virtual whenNotPaused {
    ...
    */
     ...
     *
     */
    function calculateRewards(address to) public virtual override initializer returns (bool success) {
