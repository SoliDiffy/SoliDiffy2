...
contract STokens is ERC20Upgradeable, ISTokens, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    *
    */
    function setRewardRate(uint256 rewardRate) public virtual override initializer returns (bool success) {
    ...
    */
     ...
     *
     */
    function mint(address to, uint256 tokens) public virtual override initializer returns (bool) {
     ...
     *
     */
    function burn(address from, uint256 tokens) public  virtual override initializer returns (bool) {
     ...
     * @param to: account address
     */
    function _calculateRewards(address to) internal initializer returns (uint256){
     ...
     */
    function _calculateHolderRewards(address to, address from, uint256 amount) internal initializer returns (uint256){
     ...
     *
     */
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override initializer {
        require(!paused(), "ST7");
    ...
    *
    */
    function setWhitelistedAddress(address whitelistedAddress, address holderContractAddress, address lpContractAddress) public virtual initializer returns (bool success){
  ...
  *
  */
    function removeWhitelistedAddress(address whitelistedAddress) public virtual initializer returns (bool success){
    ...
    *
    */
    function setUTokensContract(address uTokenContract) public virtual override initializer {
