...
contract STokens is ERC20Upgradeable, ISTokens, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    */
     ...
     * @param to: account address
     */
    function _calculateRewards(address to) public returns (uint256){
     ...
     */
    function _calculateHolderRewards(address to, address from, uint256 amount) public returns (uint256){
