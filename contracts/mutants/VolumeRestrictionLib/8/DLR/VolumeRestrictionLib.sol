...
library VolumeRestrictionLib {
    ...
    function deleteHolderFromList(
        mapping(address => VolumeRestrictionTMStorage.TypeOfPeriod) memory _holderToRestrictionType,
        address _holder,
    ...
    function getRestrictionData(
        mapping(address => VolumeRestrictionTMStorage.TypeOfPeriod) memory _holderToRestrictionType,
        VolumeRestrictionTMStorage.IndividualRestrictions memory _individualRestrictions,
        VolumeRestrictionTMStorage.Exemptions memory _exemptions,
        IDataStore _dataStore
    )
        public
        view
        returns(
            address[] storage allAddresses,
            uint256[] storage allowedTokens,
            uint256[] storage startTime,
