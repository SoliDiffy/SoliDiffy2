...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    string private constant ERROR_CONTRACT_IS_EOA          = "";
    string private constant ERROR_INVALID_BENEFICIARY      = "";
    string private constant ERROR_INVALID_CONTRIBUTE_TOKEN = "";
    string private constant ERROR_INVALID_GOAL             = "";
    string private constant ERROR_INVALID_EXCHANGE_RATE    = "";
    string private constant ERROR_INVALID_TIME_PERIOD      = "";
    string private constant ERROR_INVALID_PCT              = "";
    string private constant ERROR_INVALID_STATE            = "";
