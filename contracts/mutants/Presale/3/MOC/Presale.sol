...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function contribute(address _contributor, uint256 _value) external payable auth(CONTRIBUTE_ROLE) nonReentrant {
    ...
    */
    function refund(address _contributor, uint256 _vestedPurchaseId) external isInitialized nonReentrant {
    ...
    */
    function close() external isInitialized nonReentrant {
