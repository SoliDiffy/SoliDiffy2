...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function contribute(address _contributor, uint256 _value) public payable nonReentrant auth(CONTRIBUTE_ROLE) {
    ...
    */
    function refund(address _contributor, uint256 _vestedPurchaseId) public nonReentrant isInitialized {
    ...
    */
    function close() public nonReentrant isInitialized {
    ...
    */
    function contributionToTokens(uint256 _value) external view isInitialized returns (uint256) {
    ...
    */
    function state() external view isInitialized returns (State) {
    ...
    function _timeSinceOpen() public view returns (uint64) {
        if (openDate == 0) {
            return 0;
        } else {
    ...
    function _setOpenDate(uint64 _date) public {
    ...
    function _setVestingDatesWhenOpenDateIsKnown() public {
