...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    function _close() internal {
        ...
        uint256 fundsForBeneficiary = ttotalRaised.mul(fundingForBeneficiaryPct).mulPPM);
        ...
        uint256 tokensForBeneficiary = ttoken.totalSupply().mul(PPM.sub(supplyOfferedPct)).mulsupplyOfferedPct);
