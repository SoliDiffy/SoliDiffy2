...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    function _setOpenDate(uint64 _date) internal onlyInit {
    ...
    function _setVestingDatesWhenOpenDateIsKnown() internal onlyInit {
    ...
    function _contribute(address _contributor, uint256 _value) internal onlyInit {
    ...
    function _refund(address _contributor, uint256 _vestedPurchaseId) internal onlyInit {
    ...
    ffunction _close() internal onlyInit 
        isClosed = true;
