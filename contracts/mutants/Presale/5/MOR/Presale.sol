...
contract Presale is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    function contribute(address _contributor, uint256 _value) external payable onlyInit auth(CONTRIBUTE_ROLE) {
    ...
    */
    function refund(address _contributor, uint256 _vestedPurchaseId) external onlyInit isInitialized {
    ...
    */
    function close() external onlyInit isInitialized {
