...
contract BondingCurveOracle is IBondingCurveOracle, CoreRef, Timed {
	...
	constructor(
		...
		uint32 _duration
	) internal CoreRef(_core) Timed(_duration) {
    ...
    function thaw(Decimal.D256 memory peg) public view returns (Decimal.D256 memory) {
    	if (isTimeEnded()) {
    		return peg;
    	}
    ...
    function getOracleValue() public view returns(Decimal.D256 memory, bool) {
