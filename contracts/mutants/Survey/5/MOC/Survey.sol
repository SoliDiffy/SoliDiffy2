...
contract Survey is AragonApp {
    ...
    */
     ...
     */
    function resetVote(uint256 _surveyId) public surveyExists(_surveyId) isInitialized {
    ...
    */
    function voteOptions(uint256 _surveyId, uint256[] _optionIds, uint256[] _stakes) public surveyExists(_surveyId) isInitialized {
    ...
    */
    function voteOption(uint256 _surveyId, uint256 _optionId) public surveyExists(_surveyId) isInitialized {
