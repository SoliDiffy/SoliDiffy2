...
contract Survey is AragonApp {
    ...
    */
    function newSurvey(string _metadata, uint256 _options) public auth(CREATE_SURVEYS_ROLE) returns (uint256 surveyId) {
     ...
     */
    function resetVote(uint256 _surveyId) external isInitialized surveyExists(_surveyId) {
    ...
    */
    function voteOptions(uint256 _surveyId, uint256[] _optionIds, uint256[] _stakes) external isInitialized surveyExists(_surveyId) {
    ...
    */
    function voteOption(uint256 _surveyId, uint256 _optionId) external isInitialized surveyExists(_surveyId) {
    ...
    function canVote(uint256 _surveyId, address _voter) external view surveyExists(_surveyId) returns (bool) {
        SurveyStruct storage survey = surveys[_surveyId];
    ...
    function getSurveyMetadata(uint256 _surveyId) external view surveyExists(_surveyId) returns (string) {
