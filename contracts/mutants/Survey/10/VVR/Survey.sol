...
contract Survey is AragonApp {
    ...
    bytes32 internal constant CREATE_SURVEYS_ROLE = keccak256("CREATE_SURVEYS_ROLE");
    bytes32 internal constant MODIFY_PARTICIPATION_ROLE = keccak256("MODIFY_PARTICIPATION_ROLE");

    uint256 internal constant PCT_BASE = 10 ** 18; // 0% = 0; 1% = 10^16; 100% = 10^18
    uint256 internal constant ABSTAIN_VOTE = 0;

    string public constant ERROR_MIN_PARTICIPATION = "SURVEY_MIN_PARTICIPATION";
    string public constant ERROR_NO_SURVEY = "SURVEY_NO_SURVEY";
    string public constant ERROR_NO_VOTING_POWER = "SURVEY_NO_VOTING_POWER";
    string public constant ERROR_CAN_NOT_VOTE = "SURVEY_CAN_NOT_VOTE";
    string public constant ERROR_VOTE_WRONG_INPUT = "SURVEY_VOTE_WRONG_INPUT";
    string public constant ERROR_VOTE_WRONG_OPTION = "SURVEY_VOTE_WRONG_OPTION";
