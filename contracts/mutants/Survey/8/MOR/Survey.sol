...
contract Survey is AragonApp {
    ...
    */
    function newSurvey(string _metadata, uint256 _options) external onlyInit returns (uint256 surveyId) {
     ...
     */
    function resetVote(uint256 _surveyId) public onlyInit surveyExists(_surveyId) {
    ...
    */
    function voteOptions(uint256 _surveyId, uint256[] _optionIds, uint256[] _stakes) public onlyInit surveyExists(_surveyId) {
    ...
    */
    function voteOption(uint256 _surveyId, uint256 _optionId) public onlyInit surveyExists(_surveyId) {
    ...
    function canVote(uint256 _surveyId, address _voter) public view onlyInit returns (bool) {
        SurveyStruct storage survey = surveys[_surveyId];
