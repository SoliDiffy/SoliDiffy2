...
contract Survey is AragonApp {
    ...
    bytes32 public constant CREATE_SURVEYS_ROLE = keccak256("");
    bytes32 public constant MODIFY_PARTICIPATION_ROLE = keccak256("");

    uint256 public constant PCT_BASE = 10 ** 18; // 0% = 0; 1% = 10^16; 100% = 10^18
    uint256 public constant ABSTAIN_VOTE = 0;

    string private constant ERROR_MIN_PARTICIPATION = "";
    string private constant ERROR_NO_SURVEY = "";
    string private constant ERROR_NO_VOTING_POWER = "";
    string private constant ERROR_CAN_NOT_VOTE = "";
    string private constant ERROR_VOTE_WRONG_INPUT = "";
    string private constant ERROR_VOTE_WRONG_OPTION = "";
