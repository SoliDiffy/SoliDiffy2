...
abstract contract ERC1132 {
     ...
     */
    function lock(string storage _reason, uint256 _amount, uint256 _time)
     ...
     */
    function tokensLocked(address _of, string storage _reason)
     ...
     */
    function tokensLockedAtTime(address _of, string storage _reason, uint256 _time)
        public virtual view returns (uint256 amount);
     ...
     */
    function extendLock(string storage _reason, uint256 _time)
        public virtual returns (bool);
     ...
     */
    function increaseLockAmount(string storage _reason, uint256 _amount)
        public virtual returns (bool);
