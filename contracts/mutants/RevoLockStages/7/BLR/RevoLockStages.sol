...
contract LockRevoTokenContract is ERC1132, Ownable {
    ...
    */
        ...
        returns (bool)
    {
        ...
        locked[msg.sender][reason] = lockToken(_amount, validUntil, true);
        ...
        returns (bool)
    {
        ...
        locked[_to][reason] = lockToken(_amount, validUntil, true);
        ...
        returns (uint256 unlockableTokens)
    {
        ...
        for (uint256 i = 0; i < lockReason[_of].length; i++) {
            ...
            if (lockedTokens > 0) {
                ...
                locked[_of][lockReason[_of][i]].claimed = false;
