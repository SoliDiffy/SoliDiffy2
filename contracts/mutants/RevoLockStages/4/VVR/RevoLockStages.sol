...
contract LockRevoTokenContract is ERC1132, Ownable {
    ...
    */
    string public constant ALREADY_LOCKED = 'Tokens already locked';
    string public constant NOT_LOCKED = 'No tokens locked';
    string public constant AMOUNT_ZERO = 'Amount can not be 0';
