...
contract Archangel is Ownable, ErrorMsg {
    ...
    AngelFactory internal immutable angelFactory;
    FountainFactory internal immutable fountainFactory;
    uint256 internal defaultFlashLoanFee = 9;
    uint256 internal constant FEE_BASE = 1e4;
