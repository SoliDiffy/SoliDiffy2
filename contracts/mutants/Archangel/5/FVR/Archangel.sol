...
contract Archangel is Ownable, ErrorMsg {
    ...
    function getFountain(IERC20 token) public view returns (Fountain) {
    ...
    function setDefaultFlashLoanFee(uint256 fee) public onlyOwner {
        _requireMsg(
            fee <= FEE_BASE,
    ...
    function setFlashLoanFee(address lender, uint256 fee) public onlyOwner {
