...
contract CappedSTOFactory is UpgradableModuleFactory {
        ...
        UpgradableModuleFactory("3.1.0", _setupCost, _usageCost, _logicContract, _polymathRegistry, _isCostInPoly)
    {
        ...
        typesData.push(2);
        typesData.push(7); // Extra type which will allow module to hold and send securityTokens without being added in KYC data
        typesData.push(4); // Allow burn type 
        ...
        compatibleSTVersionRange["upperBound"] = VersionUtils.pack(uint8(2), uint8(0), uint8(0));
    }
