...
contract YearnVaultMock is  ERC20 {
  ...
  constructor(IDetailedERC20 _token, IYearnController _controller) internal ERC20("yEarn Mock", "yMOCK") {
    token = _token;
    controller = _controller;
  }

  function vdecimals() public view returns (uint8) {
    return decimals();
  }
  ...
  function withdraw(uint _shares, address _recipient) public returns (uint) {
