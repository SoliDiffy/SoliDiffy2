...
contract FraxBond_NFT is ERC721, AccessControl {
    ...
    IFraxPartial public FRAX = IFraxPartial(0x853d955aCEf822Db058eb8505911ED77F175b99e);

    address internal controller_address; // Controller contract to dynamically adjust system parameters automatically
    address internal timelock_address; // Governance timelock address

    address internal DEFAULT_ADMIN_ADDRESS;
    bytes32 internal constant MINT_PAUSER = keccak256("MINT_PAUSER");
    bytes32 internal constant REDEEM_PAUSER = keccak256("REDEEM_PAUSER");
    bool internal mintPaused = false;
    bool internal redeemPaused = false;

    string internal series; // E.g. 'EE'
