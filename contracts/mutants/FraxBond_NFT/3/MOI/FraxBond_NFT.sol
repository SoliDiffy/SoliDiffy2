...
contract FraxBond_NFT is ERC721, AccessControl {
    ...
    function burn(uint256 serial_number) external notMintPaused {
    ...
    function toggleMinting() external notMintPaused {
        require(hasRole(MINT_PAUSER, msg.sender));
        mintPaused = !mintPaused;
    }

    function toggleRedeeming() external notMintPaused {
