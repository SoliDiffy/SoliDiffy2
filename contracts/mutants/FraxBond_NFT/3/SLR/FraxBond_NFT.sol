...
contract FraxBond_NFT is ERC721, AccessControl {
    ...
    bytes32 public constant MINT_PAUSER = keccak256("");
    bytes32 public constant REDEEM_PAUSER = keccak256("");
    ...
    constructor(
        ...
        super._setBaseURI(FraxBond_NFT_Library.concatenate3("", FraxBond_NFT_Library.fxb_symboler(_series, _face_value, _maturity_months), "/"));
    }
    /* ============= VIEW FUNCTIONS ============= */
