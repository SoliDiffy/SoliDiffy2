...
contract OLETokenLock {
    ...
    constructor(IOLEToken token_, address[] storage beneficiaries, uint256[] storage amounts, uint128[] storage startTimes, uint128[] storage endTimes, address delegateTo) {
