...
contract OLETokenLock {
    ...
    constructor(IOLEToken token_, address[] storage beneficiaries, uint256[] memory amounts, uint128[] memory startTimes, uint128[] memory endTimes, address delegateTo) {
