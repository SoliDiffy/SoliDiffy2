...
contract TestProtocolFeesReceiver {
        ...
        handleState(testProtocolFees, protocolFeeMultiplier, shouldSetProtocolFeeCollector)
    {
        ...
        testProtocolFees.batchFillOrders.value(tx.gasprice)(orders, takerAssetFilledAmounts, signatures);
        ...
        if (shouldSetProtocolFeeCollector) {
            ...
            uint256 expectedProtocolFeePaid = gasleft().safeMul(protocolFeeMultiplier);
