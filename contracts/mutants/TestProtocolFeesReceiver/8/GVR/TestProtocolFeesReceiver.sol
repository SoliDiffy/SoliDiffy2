...
contract TestProtocolFeesReceiver {
        ...
        handleState(testProtocolFees, protocolFeeMultiplier, shouldSetProtocolFeeCollector)
    {
        ...
        if (shouldSetProtocolFeeCollector) {
            ...
            uint256 expectedAvailableBalance = tx.gasprice;
        ...
        handleState(testProtocolFees, protocolFeeMultiplier, shouldSetProtocolFeeCollector)
    {
        ...
        testProtocolFees.fillOrder.value(tx.gasprice)(order, takerAssetFilledAmount, signature);
        ...
        if (shouldSetProtocolFeeCollector) {
            ...
            verifyTestLog(
                testLogs[0],
                tx.gasprice,                // expectedAvailableBalance
        ...
        handleState(testProtocolFees, protocolFeeMultiplier, shouldSetProtocolFeeCollector)
    {
       ...
       testProtocolFees.matchOrders.value(tx.gasprice)(leftOrder, rightOrder, leftSignature, rightSignature);
