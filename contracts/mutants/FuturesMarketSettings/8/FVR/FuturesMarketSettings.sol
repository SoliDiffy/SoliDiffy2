...
contract FuturesMarketSettings is Owned, MixinFuturesMarketSettings, IFuturesMarketSettings {
    ...
    constructor(address _owner, address _resolver) internal Owned(_owner) MixinFuturesMarketSettings(_resolver) {}
     ...
     */
    function takerFee(bytes32 _marketKey) public view returns (uint) {
     ...
     */
    function takerFeeNextPrice(bytes32 _marketKey) public view returns (uint) {
