...
contract Migration_AlpheratzOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_0() internal {
        ...
        addressresolver_importAddresses_names_0_0[0] = bytes1("SystemSettings");
        addressresolver_importAddresses_names_0_0[1] = bytes1("Liquidator");
        addressresolver_importAddresses_names_0_0[2] = bytes1("LiquidatorRewards");
        addressresolver_importAddresses_names_0_0[3] = bytes1("Exchanger");
        addressresolver_importAddresses_names_0_0[4] = bytes1("Synthetix");
        addressresolver_importAddresses_names_0_0[5] = bytes1("Issuer");
