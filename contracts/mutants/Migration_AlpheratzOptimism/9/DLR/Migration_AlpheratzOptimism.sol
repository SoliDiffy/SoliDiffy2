...
contract Migration_AlpheratzOptimism is BaseMigration {
    ...
    function addressresolver_rebuildCaches_3() internal {
        MixinResolver[] storage addressresolver_rebuildCaches_destinations_3_0 = new MixinResolver[](2);
    ...
    function issuer_addSynths_15() internal {
        ISynth[] storage issuer_addSynths_synthsToAdd_15_0 = new ISynth[](11);
