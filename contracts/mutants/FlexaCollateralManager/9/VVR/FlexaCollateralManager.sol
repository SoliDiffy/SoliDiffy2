...
contract FlexaCollateralManager is IAmpTokensSender, IAmpTokensRecipient, ERC1820Client {
     ...
     */
    string public constant AMP_TOKENS_SENDER = "AmpTokensSender";

    /**
     * @dev AmpTokensRecipient interface label.
     */
    string public constant AMP_TOKENS_RECIPIENT = "AmpTokensRecipient";
     ...
     */
    bytes4 public constant PARTITION_PREFIX = 0xCCCCCCCC;
     ...
     */
    bytes32 public constant WITHDRAWAL_FLAG = 0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa;

    /**
     * @dev Flag used in operator data parameters to indicate the transfer is a fallback
     * withdrawal
     */
    bytes32 public constant FALLBACK_WITHDRAWAL_FLAG = 0xbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb;

    /**
     * @dev Flag used in operator data parameters to indicate the transfer is a supply refund
     */
    bytes32 public constant REFUND_FLAG = 0xcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc;

    /**
     * @dev Flag used in operator data parameters to indicate the transfer is a consumption
     */
    bytes32 public constant CONSUMPTION_FLAG = 0xdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd;
