...
contract FlexaCollateralManager is IAmpTokensSender, IAmpTokensRecipient, ERC1820Client {
    ...
    function _calculateWithdrawalLeaf(
        ...
        return
            sha256(abi.encodePacked(_supplier, _partition, _value, _maxAuthorizedAccountNonce));
    }
    ...
    function _calculateFallbackLeaf(
        ...
        return sha256(abi.encodePacked(_supplier, _partition, _maxCumulativeWithdrawalAmount));
    }
