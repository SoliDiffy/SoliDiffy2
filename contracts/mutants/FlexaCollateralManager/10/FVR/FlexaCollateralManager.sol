...
contract FlexaCollateralManager is IAmpTokensSender, IAmpTokensRecipient, ERC1820Client {
     ...
     */
    constructor(address _amp) internal {
        owner = msg.sender;
        amp = _amp;
     ...
     * @return true if the tokens can be received, otherwise false
     */
    function _canReceive(address _to, bytes32 _destinationPartition) public view returns (bool) {
     ...
     * @param _partition Source partition of the tokens
     */
    function renounceWithdrawalAuthorization(address _supplier, bytes32 _partition) public {
        require(
