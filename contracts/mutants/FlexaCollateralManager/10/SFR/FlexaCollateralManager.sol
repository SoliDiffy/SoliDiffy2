...
contract FlexaCollateralManager is IAmpTokensSender, IAmpTokensRecipient, ERC1820Client {
    ...
    function tokensReceived(
        ...
        supplyNonce = SafeMath.sub(supplyNonce, 1);
    ...
    function _executeWithdrawal(
        ...
        addressToCumulativeAmountWithdrawn[_partition][supplier] = SafeMath.sub(
            _value,
        ...
        withdrawalLimit = SafeMath.add(withdrawalLimit, _value);
        ...
        )
    {
        ...
        uint256 newCumulativeWithdrawalAmount = SafeMath.sub(
            _value,
            addressToCumulativeAmountWithdrawn[_partition][supplier]
        );
    ...
    function _validateFallbackWithdrawalData(
        ...
        return
            ...
            (SafeMath.sub(fallbackSetDate, fallbackWithdrawalDelaySeconds) <= block.timestamp) &&
