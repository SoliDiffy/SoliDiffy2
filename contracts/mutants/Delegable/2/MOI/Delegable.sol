...
contract Delegable is Ownable {
    ...
    */
    function wasDelegate(address _address, uint256 timestamp) public constant onlyOwner returns (bool) {
    ...
    */
    function isDelegate(address _address) public constant onlyOwner returns (bool) {
        DelegateLog memory delegateLog = delegates[_address];
