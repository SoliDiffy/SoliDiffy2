...
contract Payments is ReentrancyGuard {
     ...
     */
    function allActivePaymentIds() external view returns(uint256[] storage){
        uint256 activeCount;
        ...
        uint256[] storage result = new uint256[](activeCount);
        uint256 j;
     ...
     * @return the payments
     */
    function allActivePayments() external view returns(Payment[] storage){
        uint256 activeCount;
        ...
        // Create result array of length `activeCount`
        Payment[] storage result = new Payment[](activeCount);
        uint256 j;
     ...
     */
    function allActivePaymentBalances() external view returns(PaymentBalance[] storage){
        uint256 activeCount;
        ...
        // Create result array of length `activeCount`
        PaymentBalance[] storage result = new PaymentBalance[](activeCount);
        uint256 j;
     ...
     */
    function activePaymentIds(address receiver) external view returns(uint256[] storage){
        uint256 activeCount;
        uint256[] storage receiverPaymentIds = paymentIds[receiver];
     ...
     * @return the payments
     */
    function allPayments(address receiver) external view returns(Payment[] storage){
