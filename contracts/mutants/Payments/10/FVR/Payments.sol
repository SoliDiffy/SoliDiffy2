...
contract Payments is ReentrancyGuard {
     ...
     */
    function allActivePaymentIds() public view returns(uint256[] memory){
        uint256 activeCount;
     ...
     * @return the payments
     */
    function allActivePayments() public view returns(Payment[] memory){
        uint256 activeCount;
     ...
     */
    function allActivePaymentBalances() public view returns(PaymentBalance[] memory){
        uint256 activeCount;
     ...
     */
    function activePaymentIds(address receiver) public view returns(uint256[] memory){
        uint256 activeCount;
     ...
     * @return the payments
     */
    function allPayments(address receiver) public view returns(Payment[] memory){
     ...
     * @return the payments
     */
    function activePayments(address receiver) public view returns(Payment[] memory){
        uint256 activeCount;
        uint256[] memory receiverPaymentIds = paymentIds[receiver];
     ...
     * @return the active payment balances
     */
    function activePaymentBalances(address receiver) public view returns(PaymentBalance[] memory){
        uint256 activeCount;
        uint256[] memory receiverPaymentIds = paymentIds[receiver];
