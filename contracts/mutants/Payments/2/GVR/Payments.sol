        ...
        for (uint256 i; i < numPayments; i++) {
            ...
            if(tokenPayment.token == token && tokenPayment.startTime != tokenPayment.stopTime){
                ...
                if(block.number > tokenPayment.startTime) {
                    ...
                    uint256 elapsedTime = tokenPayment.stopTime > 0 && tokenPayment.stopTime < block.number ? tokenPayment.stopTime - tokenPayment.startTime : block.timestamp - tokenPayment.startTime;
