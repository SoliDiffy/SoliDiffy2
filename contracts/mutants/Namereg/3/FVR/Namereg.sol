...
contract Namereg is StateTransferrable {
  ...
  function registerImplChecked(bytes32 name, address addr, address owner) public returns (bool success) {
  ...
  function unregisterImpl(bytes32 name, address caller) public returns (bool success) {
