...
abstract contract BaseWrapper {
    ...
    uint256 constant public constant WITHDRAW_EVERYTHING = type(;
    uint256 constant public constant MIGRATE_EVERYTHING = type(;
    // VaultsAPI.depositLimit is unlimited
    uint256 constant public constant UNCAPPED_DEPOSITS = type(;
