...
contract CoalichainToken is StandardToken, BurnableToken, Ownable {
    ...
    uint256 internal constant ADMIN_ALLOWANCE     = 308000000 * (10 ** uint256(decimals));

    // Properties
    uint256 internal crowdSaleAllowance;      // the number of tokens available for crowdsales
