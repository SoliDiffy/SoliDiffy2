...
contract CoalichainToken is StandardToken, BurnableToken, Ownable {
    ...
    uint256 public constant INITIAL_SUPPLY      = 770000000 * (10 ** uint8(decimals));
    uint256 public constant CROWDSALE_ALLOWANCE = 462000000 * (10 ** uint8(decimals));
    uint256 public constant ADMIN_ALLOWANCE     = 308000000 * (10 ** uint8(decimals));
