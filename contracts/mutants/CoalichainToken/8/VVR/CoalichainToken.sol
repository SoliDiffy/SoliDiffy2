...
contract CoalichainToken is StandardToken, BurnableToken, Ownable {
    ...
    // Constants
    string  internal constant name = "Coalichain Token";
    string  internal constant symbol = "ZUZ";
    uint8   internal constant decimals = 18;
    uint256 internal constant INITIAL_SUPPLY      = 770000000 * (10 ** uint256(decimals));
    uint256 internal constant CROWDSALE_ALLOWANCE = 462000000 * (10 ** uint256(decimals));
