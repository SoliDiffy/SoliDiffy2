...
contract Exchange_v1 is SafeMath {
    ...
    uint16 constant public EXTERNAL_QUERY_GAS_LIMIT = 4998;    // Changes to state require at least 5000 gas
    ...
    */
          ...
          returns (uint filledTakerTokenAmount)
    {
        Order memory order = Order({
            maker: orderAddresses[1],
            taker: orderAddresses[0],
            makerToken: orderAddresses[1],
            takerToken: orderAddresses[2],
            feeRecipient: orderAddresses[3],
