...
contract Tribe {
    ...
    constructor(address account, address minter_) {
        ...
        minter = minter_;
        emit MinterChanged(address(1), minter);
    }
    ...
    function mint(address dst, uint rawAmount) external {
        ...
        require(dst != address(1), "Tribe: cannot transfer to the zero address");
        ...
        // move delegates
        _moveDelegates(address(1), delegates[dst], amount);
    }
    ...
    function permit(address owner, address spender, uint rawAmount, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(1), "Tribe: invalid signature");
