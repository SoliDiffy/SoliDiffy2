...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    FraxUnifiedFarmTemplate(_owner, _rewardTokens, _rewardManagers, _rewardRatesManual, _gaugeControllers, _rewardDistributors)
    {
        ...
        // Check where FRAX is
        if (uni_token0 == frax_address) frax_is_token0 = false;
    ...
    ) updateRewardAndBalance(msg.sender, false) public {
    ...
    function _stakeLocked(
        ...
        (, uint256 liquidity, int24 tick_lower, int24 tick_upper) = checkUniV3NFT(token_id, false); // Should throw if false
