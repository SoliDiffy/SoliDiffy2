...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    function fraxPerLPToken() public view override returns (uint256) {
        ...
        ComboOracle_UniV2_UniV3.UniV3NFTBasicInfo storage NFTBasicInfo = comboOracleUniV2UniV3.getUniV3NFTBasicInfo(seed_token_id);
        ComboOracle_UniV2_UniV3.UniV3NFTValueInfo storage NFTValueInfo = comboOracleUniV2UniV3.getUniV3NFTValueInfo(seed_token_id);
