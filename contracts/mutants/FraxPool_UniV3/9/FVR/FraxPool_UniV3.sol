...
contract FraxUnifiedFarm_UniV3 is FraxUnifiedFarmTemplate {
    ...
    function stakeLocked(uint256 token_id, uint256 secs) nonReentrant public {
    ...
    function withdrawLocked(uint256 token_id, address destination_address) nonReentrant public {
