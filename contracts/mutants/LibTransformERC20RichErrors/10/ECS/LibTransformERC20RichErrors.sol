...
library LibTransformERC20RichErrors {
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("IncompleteFillSellQuoteError(address,uint256,uint256)")),
            sellToken,
            soldAmount,
            sellAmount
        );
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("IncompleteFillBuyQuoteError(address,uint256,uint256)")),
            buyToken,
            boughtAmount,
            buyAmount
        );
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("InsufficientTakerTokenError(uint256,uint256)")),
            tokenBalance,
            tokensNeeded
        );
    }
