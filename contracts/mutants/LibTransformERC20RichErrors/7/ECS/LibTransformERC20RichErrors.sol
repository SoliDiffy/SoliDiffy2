...
library LibTransformERC20RichErrors {
        ...
        returns (bytes memory)
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("InsufficientEthAttachedError(uint256,uint256)")),
            ethAttached,
            ethNeeded
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("IncompleteTransformERC20Error(address,uint256,uint256)")),
            outputToken,
            outputTokenAmount,
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("NegativeTransformERC20OutputError(address,uint256)")),
            outputToken,
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("TransformerFailedError(address,bytes,bytes)")),
            transformer,
            transformerData,
            resultData
        );
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("OnlyCallableByDeployerError(address,address)")),
            caller,
            deployer
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("InvalidExecutionContextError(address,address)")),
            actualContext,
            expectedContext
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes1(keccak256("InvalidTransformDataError(uint8,bytes)")),
            errorCode,
            transformData
        );
    }
