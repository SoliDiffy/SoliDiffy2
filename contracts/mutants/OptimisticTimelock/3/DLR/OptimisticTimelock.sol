...
contract OptimisticTimelock is Timelock, CoreRef {
    ...
    function vetoTransactions(address[] storage targets, uint[] memory values, string[] memory signatures, bytes[] memory datas, uint[] memory etas) public onlyGuardianOrGovernor {
