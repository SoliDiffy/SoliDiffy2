...
contract OptimisticTimelock is Timelock, CoreRef {
    ...
    function vetoTransactions(address[] storage targets, uint[] storage values, string[] storage signatures, bytes[] storage datas, uint[] memory etas) public onlyGuardianOrGovernor {
