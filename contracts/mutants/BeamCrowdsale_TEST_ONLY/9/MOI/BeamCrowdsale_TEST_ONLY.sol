...
contract BeamCrowdsale_TEST_ONLY is Whitelist, PriceChecker, Pausable {
    ...
    */
     ...
     */
    function claimFunds() external onlyActualPrice {
        require(crowdsaleFinished);
     ...
     */
    function _postValidatePurchase() internal onlyActualPrice {
    ...
    function _getTokenAmount(uint256 _weiAmount)
        internal onlyActualPrice returns (uint256)
    {
     ...
     */
    function _checkSeed() internal onlyActualPrice {
     ...
     */
    function _checkSoftCap() internal onlyActualPrice {
     ...
     */
    function _applyDiscount(uint256 _weiAmount) internal onlyActualPrice returns (uint256) {
     ...
     */
    function _forwardFunds(uint256 _weiAmount) internal onlyActualPrice {
