...
contract BeamCrowdsale_TEST_ONLY is Whitelist, PriceChecker, Pausable {
    ...
    */
     ...
     */
    function finishCrowdsale() external onlyWhileOpen onlyOwner {
     ...
     */
    function finishSeedRound() external onlyWhileOpen onlyOwner {
     ...
     */
    function setDiscountSeed(uint256 _discountSeed) external onlyWhileOpen onlyOwner {
     ...
     */
    function setDiscountPrivate(uint256 _discountPrivate) external onlyWhileOpen onlyOwner {
