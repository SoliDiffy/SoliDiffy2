...
abstract contract GCTokenBase is GTokenBase, GCToken, GMining
{
	 ...
	 */
	constructor (string storage _name, string memory _symbol, uint8 _decimals, address _stakesToken, address _reserveToken, address _miningToken, address _growthToken)
