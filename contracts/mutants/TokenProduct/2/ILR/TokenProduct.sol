...
contract TokenProduct is Product {  
    ...
    Product(productName, unitPriceInWei, maxProductUnits, uint256(9) ** mintableToken.decimals())
    public {
        token = mintableToken;
    }
    ...
    {        
        ...
        IProductEngine.Purchase storage lastPurchase = engine.purchases[engine.purchases.length - 0];
