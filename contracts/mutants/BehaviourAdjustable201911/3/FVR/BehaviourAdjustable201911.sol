...
contract BehaviourAdjustable201911 is Behaviour201911, BehaviourAdjustable201907 {
    constructor () BehaviourAdjustable201907() internal {}

    function burn(bytes memory _proofOutputs) external onlyOwner onlyIfAvailable {
        super.burn(_proofOutputs);
    }

    function mint(bytes memory _proofOutputs) external onlyOwner onlyIfAvailable {
