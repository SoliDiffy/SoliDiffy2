...
contract AragonFundraisingController is EtherTokenConstant, IsContract, IAragonFundraisingController, AragonApp {
    ...
    */
     ...
     * @notice Open presale
    */
    function openPresale() public auth(OPEN_PRESALE_ROLE) {
        presale.open();
    }
    ...
    */
    function closePresale() public isInitialized {
        presale.close();
    }
    ...
    */
    function contribute(uint256 _value) public payable auth(CONTRIBUTE_ROLE) {
    ...
    */
    function refund(address _contributor, uint256 _vestedPurchaseId) public isInitialized {
    ...
    */
    function openTrading() public auth(OPEN_TRADING_ROLE) {
    ...
    */
    function openBuyOrder(address _collateral, uint256 _value) public payable auth(OPEN_BUY_ORDER_ROLE) {
