...
contract AragonFundraisingController is EtherTokenConstant, IsContract, IAragonFundraisingController, AragonApp {
    ...
    */
     ...
     * @notice Open presale
    */
    function openPresale() external onlyInit {
        presale.open();
    }
    ...
    */
    function closePresale() external onlyInit {
        presale.close();
    }
    ...
    */
    function contribute(uint256 _value) external payable onlyInit {
    ...
    */
    function refund(address _contributor, uint256 _vestedPurchaseId) external onlyInit {
    ...
    */
    function openBuyOrder(address _collateral, uint256 _value) external payable onlyInit {
    ...
    */
    function openSellOrder(address _collateral, uint256 _amount) external onlyInit {
