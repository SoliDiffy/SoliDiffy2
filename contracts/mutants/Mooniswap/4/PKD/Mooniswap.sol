...
contract Mooniswap is MooniswapGovernance {
    ...
    function swapFor(IERC20 src, IERC20 dst, uint256 amount, uint256 minReturn, address referral, address payable receiver) public  nonReentrant whenNotShutdown returns(uint256 result) {
