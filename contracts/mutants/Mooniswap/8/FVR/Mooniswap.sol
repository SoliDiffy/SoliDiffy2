...
contract Mooniswap is MooniswapGovernance {
    ...
    function getReturn(IERC20 src, IERC20 dst, uint256 amount) public view returns(uint256) {
    ...
    function deposit(uint256[2] memory maxAmounts, uint256[2] memory minAmounts) public payable returns(uint256 fairSupply, uint256[2] memory receivedAmounts) {
    ...
    function depositFor(uint256[2] memory maxAmounts, uint256[2] memory minAmounts, address target) external payable nonReentrant returns(uint256 fairSupply, uint256[2] memory receivedAmounts) {
