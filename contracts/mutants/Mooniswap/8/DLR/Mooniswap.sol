...
contract Mooniswap is MooniswapGovernance {
    ...
    function depositFor(uint256[2] storage maxAmounts, uint256[2] storage minAmounts, address target) public payable nonReentrant returns(uint256 fairSupply, uint256[2] memory receivedAmounts) {
