...
contract Mooniswap is MooniswapGovernance {
    ...
    function swapFor(IERC20 src, IERC20 dst, uint256 amount, uint256 minReturn, address referral, address payable receiver) public payable whenNotShutdown nonReentrant returns(uint256 result) {
    ...
    */
    ...
    function rescueFunds(IERC20 token, uint256 amount) external onlyOwner nonReentrant {
