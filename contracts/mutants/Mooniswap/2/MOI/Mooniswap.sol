...
contract Mooniswap is MooniswapGovernance {
    ...
    function deposit(uint256[2] memory maxAmounts, uint256[2] memory minAmounts) external payable nonReentrant returns(uint256 fairSupply, uint256[2] memory receivedAmounts) {
    ...
    function withdraw(uint256 amount, uint256[] memory minReturns) external nonReentrant returns(uint256[2] memory withdrawnAmounts) {
