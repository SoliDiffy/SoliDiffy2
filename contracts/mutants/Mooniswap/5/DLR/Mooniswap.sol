...
contract Mooniswap is MooniswapGovernance {
    ...
    function deposit(uint256[2] storage maxAmounts, uint256[2] storage minAmounts) external payable returns(uint256 fairSupply, uint256[2] memory receivedAmounts) {
