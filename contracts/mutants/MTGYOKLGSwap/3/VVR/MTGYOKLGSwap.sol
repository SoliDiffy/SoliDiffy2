...
contract MTGYOKLGSwap is Ownable {
  IERC20 public mtgy = IERC20(0x025c9f1146d4d94F8F369B9d98104300A3c8ca23);
  IERC20 public oklg = IERC20(0x55E8b37a3c43B049deDf56C77f462Db095108651);

  uint8 internal mtgyOklgRatio = 120;
