...
contract DODOApprove is InitializableOwnable {
    ...
    // ============ Storage ============
    uint256 public constant _TIMELOCK_DURATION_ = 3 days;
    uint256 public constant _TIMELOCK_EMERGENCY_DURATION_ = 24 hours;
    uint256 internal _TIMELOCK_;
    address internal _PENDING_DODO_PROXY_;
    address internal _DODO_PROXY_;
