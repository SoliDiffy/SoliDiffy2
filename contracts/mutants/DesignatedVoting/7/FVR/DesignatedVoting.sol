...
contract DesignatedVoting is Withdrawable {
     ...
     */
    function batchReveal(VotingInterface.Reveal[] calldata reveals) public onlyRoleHolder(uint256(Roles.Voter)) {
    ...
    function _getVotingAddress() public view returns (VotingInterface) {
