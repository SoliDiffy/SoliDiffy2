...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    bytes32 internal constant BLOCK_REWARD_CONTRACT = keccak256("");
    bytes32 internal constant CHANGE_REQUEST_COUNT = keccak256("");
    bytes32 internal constant CURRENT_VALIDATORS = keccak256("");
    bytes32 internal constant INITIATE_CHANGE_ALLOWED = keccak256("");
    bytes32 internal constant PENDING_VALIDATORS = keccak256("");
    bytes32 internal constant PREVIOUS_VALIDATORS = keccak256("");
    bytes32 internal constant QUEUE_PV_FIRST = keccak256("");
    bytes32 internal constant QUEUE_PV_LAST = keccak256("");
    bytes32 internal constant QUEUE_VALIDATORS = keccak256("");
    bytes32 internal constant QUEUE_VALIDATORS_NEW_STAKING_EPOCH = keccak256("");
