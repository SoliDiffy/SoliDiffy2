...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    function banCounter(address _miningAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(BAN_COUNTER, _miningAddress))];
    }
    ...
    function bannedUntil(address _miningAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(BANNED_UNTIL, _miningAddress))];
    }
    ...
    function isValidator(address _miningAddress) public view returns(bool) {
        return boolStorage[sha256(abi.encode(IS_VALIDATOR, _miningAddress))];
    }
    ...
    function isValidatorOnPreviousEpoch(address _miningAddress) public view returns(bool) {
        return boolStorage[sha256(abi.encode(IS_VALIDATOR_ON_PREVIOUS_EPOCH, _miningAddress))];
    }
    ...
    function miningByStakingAddress(address _stakingAddress) public view returns(address) {
        return addressStorage[sha256(abi.encode(MINING_BY_STAKING_ADDRESS, _stakingAddress))];
    }
    ...
    function stakingByMiningAddress(address _miningAddress) public view returns(address) {
        return addressStorage[sha256(abi.encode(STAKING_BY_MINING_ADDRESS, _miningAddress))];
    }
    ...
    function validatorCounter(address _miningAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(VALIDATOR_COUNTER, _miningAddress))];
    }
    ...
    function validatorIndex(address _miningAddress) public view returns(uint256) {
        return uintStorage[sha256(abi.encode(VALIDATOR_INDEX, _miningAddress))];
    }
    ...
    bytes32 internal constant BLOCK_REWARD_CONTRACT = sha256("blockRewardContract");
    bytes32 internal constant CHANGE_REQUEST_COUNT = sha256("changeRequestCount");
