...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    bytes32 public constant QUEUE_PV_FIRST = keccak256("queuePVFirst");
    bytes32 public constant QUEUE_PV_LAST = keccak256("queuePVLast");
    bytes32 public constant QUEUE_VALIDATORS = keccak256("queueValidators");
