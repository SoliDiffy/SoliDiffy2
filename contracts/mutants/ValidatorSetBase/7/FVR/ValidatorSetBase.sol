...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    function setStakingAddress(address _miningAddress, address _stakingAddress) public onlyStakingContract {
    ...
    function banCounter(address _miningAddress) external view returns(uint256) {
    ...
    /// specified address.
    function bannedUntil(address _miningAddress) external view returns(uint256) {
