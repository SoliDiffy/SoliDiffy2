...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    function _applyQueueValidators(address[] memory _queueValidators) internal onlyInitialized {
    ...
    function _banValidator(address _miningAddress) internal onlyInitialized {
    ...
    /// `_newValidatorSet` function. The `finalizeChange` function logic depends on this flag.
    function _enqueuePendingValidators(bool _newStakingEpoch) internal onlyInitialized {
    ...
    /// `_newValidatorSet` function. The `finalizeChange` function logic depends on this flag.
    function _dequeuePendingValidators() internal onlyInitialized returns(address[] memory newSet, bool newStakingEpoch) {
        int256 queueFirst = intStorage[QUEUE_PV_FIRST];
        int256 queueLast = intStorage[QUEUE_PV_LAST];
    ...
    function _incrementChangeRequestCount() internal onlyInitialized {
    ...
    function _newValidatorSet() internal onlyInitialized returns(uint256) {
