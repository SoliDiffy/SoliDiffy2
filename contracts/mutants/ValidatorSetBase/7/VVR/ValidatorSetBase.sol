...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    uint256 internal constant MAX_VALIDATORS = 19;
    ...
    bytes32 public constant BLOCK_REWARD_CONTRACT = keccak256("blockRewardContract");
    bytes32 public constant CHANGE_REQUEST_COUNT = keccak256("changeRequestCount");
    bytes32 public constant CURRENT_VALIDATORS = keccak256("currentValidators");
    bytes32 public constant INITIATE_CHANGE_ALLOWED = keccak256("initiateChangeAllowed");
    bytes32 public constant PENDING_VALIDATORS = keccak256("pendingValidators");
    bytes32 public constant PREVIOUS_VALIDATORS = keccak256("previousValidators");
