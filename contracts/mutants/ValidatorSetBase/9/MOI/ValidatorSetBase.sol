...
contract ValidatorSetBase is OwnedEternalStorage, IValidatorSet {
    ...
    function _removeMaliciousValidator(address _miningAddress) internal onlyInitialized returns(bool) {
    ...
    function _setInitiateChangeAllowed(bool _allowed) internal onlyInitialized {
