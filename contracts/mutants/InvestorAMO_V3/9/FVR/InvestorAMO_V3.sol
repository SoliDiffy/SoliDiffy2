...
contract InvestorAMO_V3 is Owned {
    ...
    function showRewards() public view returns (uint256[3] memory rewards) {
        // IMPORTANT
    ...
    // Backwards compatibility
    function borrowed_balance() external view returns (int256) {
    ...
    function giveCollatBack(uint256 collat_amount) public onlyByOwnGovCust {
    ...
    function yDepositUSDC(uint256 USDC_amount) external onlyByOwnGovCust {
    ...
    // E6
    function yWithdrawUSDC(uint256 yUSDC_amount) external onlyByOwnGovCust {
