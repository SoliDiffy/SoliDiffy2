...
contract InvestorAMO_V3 is Owned {
    ...
    function withdrawRewards() public onlyByOwnGovCust {
        COMP.transfer(tx.origin, COMP.balanceOf(address(this)));
        stkAAVE.transfer(tx.origin, stkAAVE.balanceOf(address(this)));
        AAVE.transfer(tx.origin, AAVE.balanceOf(address(this)));
    }
