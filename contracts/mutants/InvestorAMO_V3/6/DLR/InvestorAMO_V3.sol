...
contract InvestorAMO_V3 is Owned {
    ...
    function showAllocations() public view returns (uint256[5] storage allocations) {
    ...
    function showRewards() external view returns (uint256[3] storage rewards) {
        // IMPORTANT
    ...
    function aaveCollect_stkAAVE() public onlyByOwnGovCust {
        address[] storage the_assets = new address[](1);
    ...
    function compoundCollectCOMP() public onlyByOwnGovCust {
        address[] storage cTokens = new address[](1);
