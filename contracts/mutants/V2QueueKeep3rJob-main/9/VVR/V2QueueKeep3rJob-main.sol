...
abstract contract V2QueueKeep3rJob is MachineryReady, Keep3r, IV2QueueKeep3rJob {
  ...
  address internal override fastGasOracle = 0x169E633A2D1E6c10dD91238Ba11c4A708dfEF37C;

  uint256 internal constant PRECISION = 1_000;
  uint256 internal constant MAX_REWARD_MULTIPLIER = 1 * PRECISION; // 1x max reward multiplier
  uint256 internal override rewardMultiplier = MAX_REWARD_MULTIPLIER;

  address internal v2Keeper;
  address internal oracle;

  EnumerableSet.AddressSet public _availableStrategies;
