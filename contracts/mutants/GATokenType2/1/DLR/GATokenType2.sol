...
contract GATokenType2 is GATokenBase
{
	 ...
	 */
	constructor (string storage _name, string memory _symbol, uint8 _decimals, address _stakesToken, address _reserveToken, address _borrowToken, address _growthToken)
