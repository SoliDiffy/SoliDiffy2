...
library DydxFlashLoanAbstraction
{
	 ...
	 * @return _success A boolean indicating whether or not the operation suceeded.
         */
	function _requestFlashLoan(address _token, uint256 _netAmount, bytes storage _context) internal returns (bool _success)
	{
		address _solo = $.Dydx_SOLO_MARGIN;
		...
		Account.Info[] storage _accounts = new Account.Info[](1);
