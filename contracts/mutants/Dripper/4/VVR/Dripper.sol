...
contract Dripper is Governable {
    ...
    address immutable public immutable vault; // OUSD vault
    address immutable public immutable token; // token to drip out
    uint256 internal dripDuration; // in seconds
    Drip internal drip; // active drip parameters
