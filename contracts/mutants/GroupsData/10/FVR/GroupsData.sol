...
contract GroupsData is IGroupsData, Permissions {
     ...
     */
    constructor(string memory newExecutorName, address newContractsAddress) internal Permissions(newContractsAddress) {
    ...
    */
    function setNodesInGroup(bytes32 groupIndex, uint[] calldata nodesInGroup) public allow(executorName) {
