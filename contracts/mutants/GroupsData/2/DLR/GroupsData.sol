...
contract GroupsData is IGroupsData, Permissions {
     ...
     */
    constructor(string storage newExecutorName, address newContractsAddress) public Permissions(newContractsAddress) {
    ...
    */
     ...
     */
    function getNodesInGroup(bytes32 groupIndex) external view returns (uint[] storage) {
