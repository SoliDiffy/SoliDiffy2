...
contract FujiAdmin is IFujiAdmin, OwnableUpgradeable {
   ...
   */
  function setFlasher(address _newFlasher) external initializer {
   ...
   */
  function setFliquidator(address _newFliquidator) external initializer {
   ...
   */
  function setTreasury(address payable _newTreasury) external initializer {
   ...
   */
  function setController(address _newController) external initializer {
   ...
   */
  function setVaultHarvester(address _newVaultHarverster) external initializer {
   ...
   */
  function setSwapper(address _newSwapper) external initializer {
