...
contract FujiAdmin is IFujiAdmin, OwnableUpgradeable {
   ...
   */
  function setFlasher(address _newFlasher) public onlyOwner {
   ...
   */
  function setFliquidator(address _newFliquidator) public onlyOwner {
   ...
   */
  function setVaultHarvester(address _newVaultHarverster) public onlyOwner {
   ...
   */
  function setSwapper(address _newSwapper) public onlyOwner {
   ...
   */
  function allowVault(address _vaultAddr, bool _allowed) public onlyOwner {
