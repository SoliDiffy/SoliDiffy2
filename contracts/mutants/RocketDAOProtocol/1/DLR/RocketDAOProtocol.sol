...
contract RocketDAOProtocol is RocketBase, RocketDAOProtocolInterface {
    ...
    function bootstrapSettingMulti(string[] storage _settingContractNames, string[] memory _settingPaths, SettingType[] memory _types, bytes[] memory _values) override external onlyGuardian onlyBootstrapMode onlyLatestContract("rocketDAOProtocol", address(this)) {
