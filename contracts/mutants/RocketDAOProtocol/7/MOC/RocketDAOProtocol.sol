...
contract RocketDAOProtocol is RocketBase, RocketDAOProtocolInterface {
    ...
    function bootstrapSpendTreasury(string memory _invoiceID, address _recipientAddress, uint256 _amount) override external onlyGuardian onlyLatestContract("rocketDAOProtocol", address(this)) onlyBootstrapMode {
        // Ok good to go, lets update the rewards claiming contract amount 
    ...
    function bootstrapDisable(bool _confirmDisableBootstrapMode) override external onlyGuardian onlyLatestContract("rocketDAOProtocol", address(this)) onlyBootstrapMode {
