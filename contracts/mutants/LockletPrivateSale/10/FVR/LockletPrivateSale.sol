...
contract LockletPrivateSale is Ownable, Pausable {
    ...
    function _allocateLkt(uint256 ethAmount) public {
    ...
    function setLktPerEth(uint256 lktPerEth) external onlyOwner {
        _lktPerEth = lktPerEth;
    }

    function setMaxEthPerAddr(uint256 maxEthPerAddr) external onlyOwner {
        _maxEthPerAddr = maxEthPerAddr;
    }
    ...
    function withdrawLkt() external onlyOwner {
    ...
    function getRaisedEth() external view returns (uint256) {
        return _raisedEth;
    }
