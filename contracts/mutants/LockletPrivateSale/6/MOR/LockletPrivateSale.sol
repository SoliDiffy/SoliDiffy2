...
contract LockletPrivateSale is Ownable, Pausable {
    ...
    function setLktPerEth(uint256 lktPerEth) public whenNotPaused {
        _lktPerEth = lktPerEth;
    }

    function setMaxEthPerAddr(uint256 maxEthPerAddr) public whenNotPaused {
        _maxEthPerAddr = maxEthPerAddr;
    }

    function setClaimable(bool value) public whenNotPaused {
        _claimable = value;
    }
