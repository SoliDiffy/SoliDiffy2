...
contract CappedSTO is CappedSTOStorage, STO, ReentrancyGuard {
    ...
    */
    ...
    /**
      ...
      */
    function buyTokens(address _beneficiary) public payable nonReentrant whenNotPaused {
    ...
    /**
      ...
      */
    function buyTokensWithPoly(uint256 _investedPOLY) public nonReentrant whenNotPaused {
