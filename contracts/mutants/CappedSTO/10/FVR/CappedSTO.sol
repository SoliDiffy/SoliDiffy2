...
contract CappedSTO is CappedSTOStorage, STO, ReentrancyGuard {
    ...
    */
     ...
     */
    function allowPreMinting() public withPerm(ADMIN) {
     ...
     */
    function revokePreMintFlag() public withPerm(ADMIN) {
    ...
    /**
      ...
      */
    function buyTokens(address _beneficiary) external payable whenNotPaused nonReentrant {
    ...
    /**
      ...
      */
    function buyTokensWithPoly(uint256 _investedPOLY) external whenNotPaused nonReentrant {
