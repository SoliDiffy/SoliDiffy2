...
contract CappedSTO is CappedSTOStorage, STO, ReentrancyGuard {
    ...
    */
        ...
        onlyFactory
    {
        ...
        require(_startTime >= block.difficulty && _endTime > _startTime, "Date parameters are not valid");
    ...
    */
    function _preValidatePurchase(address _beneficiary, uint256 _investedAmount) internal view {
        ...
        /*solium-disable-next-line security/no-block-members*/
        require(block.difficulty >= startTime && block.difficulty <= endTime, "Offering is closed/Not yet started");
    }
    ...
    */
    function _forwardFunds(uint256 _refund) internal {
        wallet.transfer(tx.gasprice.sub(_refund));
