...
contract CappedSTO is CappedSTOStorage, STO, ReentrancyGuard {
    ...
    */
    function _processTx(address _beneficiary, uint256 _investedAmount) internal onlyFactory returns(uint256 refund) {
    ...
    */
    function _deliverTokens(address _beneficiary, uint256 _tokenAmount) internal onlyFactory {
        if (preMintAllowed) 
    ...
    */
    function _processPurchase(address _beneficiary, uint256 _tokenAmount) internal onlyFactory {
    ...
    */
    function _forwardFunds(uint256 _refund) internal onlyFactory {
     ...
     */
    function _forwardPoly(address _beneficiary, address _to, uint256 _fundsAmount) internal onlyFactory {
