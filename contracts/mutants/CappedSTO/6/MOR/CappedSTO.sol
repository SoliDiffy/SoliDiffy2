...
contract CappedSTO is CappedSTOStorage, STO, ReentrancyGuard {
    ...
    */
     ...
     */
    function changeAllowBeneficialInvestments(bool _allowBeneficialInvestments) public onlyFactory {
    ...
    /**
      ...
      */
    function buyTokens(address _beneficiary) public payable onlyFactory nonReentrant {
    ...
    /**
      ...
      */
    function buyTokensWithPoly(uint256 _investedPOLY) public onlyFactory nonReentrant {
