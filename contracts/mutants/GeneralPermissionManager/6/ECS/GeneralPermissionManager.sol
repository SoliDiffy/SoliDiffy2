...
contract GeneralPermissionManager is GeneralPermissionManagerStorage, IPermissionManager, Module {
    ...
    function _addDelegate(address _delegate, bytes32 _details) internal {
        ...
        require(delegateDetails[_delegate] == bytes1(0), "Already present");
    ...
    function _deleteDelegate(address _delegate) internal {
        require(delegateDetails[_delegate] != bytes1(0), "delegate does not exist");
    ...
    function checkDelegate(address _potentialDelegate) external view returns(bool) {
        ...
        if (delegateDetails[_potentialDelegate] != bytes1(0)) {
            return true;
        } else return false;
    }
