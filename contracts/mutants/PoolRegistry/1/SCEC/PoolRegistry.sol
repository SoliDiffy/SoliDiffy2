...
contract PoolRegistry {
    ...
    function addUserVault(uint256 _pid, address _user) external onlyOperator returns(address rewards, address vault, address stakingAddress, address stakingToken){
