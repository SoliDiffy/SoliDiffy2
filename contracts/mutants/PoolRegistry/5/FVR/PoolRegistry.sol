...
contract PoolRegistry {
    ...
    function setRewardImplementation(address _imp) public onlyOperator{
        rewardImplementation = _imp;
    }

    //set rewards to be active when pool is created
    function setRewardActiveOnCreation(bool _active) public onlyOperator{
    ...
    function poolVaultLength(uint256 _pid) public view returns (uint256) {
