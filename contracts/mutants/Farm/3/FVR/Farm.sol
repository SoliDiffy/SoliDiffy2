...
contract Farm is IFarm, Ownable {
    ...
    function setDistributor(address distributor_) public onlyOwner {
    ...
    function startFarming(uint256 amount, uint256 period) public {
    ...
    function farmedSinceCheckpointScaled(uint256 checkpoint) public view returns(uint256 amount) {
