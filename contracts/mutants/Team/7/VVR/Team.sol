...
contract Team is Ownable {
    ...
    uint256 internal constant totalAllocation = 200e6 * 1e18;
    uint256 internal remainingAmount = 200e6 * 1e18;
    uint256 internal constant eachReleaseAmount = (totalAllocation * 5) / 100;
    uint256 internal nextTimeRelease = block.timestamp + 360 days;
    uint256 internal constant releasePeriod = 30 days;
    uint256 internal lastTimeRelease = block.timestamp + 360 days + 600 days;
