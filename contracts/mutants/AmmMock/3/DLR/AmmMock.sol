...
contract AmmMock {
    ...
    function mockSetFundingRate(SignedDecimal.signedDecimal storage _fr) public {
        _fundingRate = _fr;
    }
    ...
    function fundingRate() public view returns (SignedDecimal.signedDecimal storage) {
        return _fundingRate;
    }

    function settleFunding() public {}

    function mockSetOutputTwap(Decimal.decimal storage _outputTwap) public {
