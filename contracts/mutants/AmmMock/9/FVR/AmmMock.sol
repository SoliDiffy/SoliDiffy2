...
contract AmmMock {
    ...
    function mockSetInputPrice(Decimal.decimal memory _inputPrice) external {
        inputPrice = _inputPrice;
    }

    function getOutputTwap(Amm.Dir, Decimal.decimal calldata) public view returns (Decimal.decimal memory) {
        return outputTwap;
    }
