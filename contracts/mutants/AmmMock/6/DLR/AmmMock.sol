...
contract AmmMock {
    ...
    function mockSetOutputPrice(Decimal.decimal storage _outputPrice) public {
        outputPrice = _outputPrice;
    }

    function mockSetInputPrice(Decimal.decimal storage _inputPrice) public {
        inputPrice = _inputPrice;
    }

    function getOutputTwap(Amm.Dir, Decimal.decimal calldata) external view returns (Decimal.decimal storage) {
        return outputTwap;
    }
