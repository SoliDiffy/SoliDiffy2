...
contract AmmMock {
    ...
    Decimal.decimal internal quoteAssetReserve;
    Decimal.decimal internal baseAssetReserve;

    /*
     * For removeMargin mocks
     */
    Decimal.decimal public outputTwap;
    Decimal.decimal public outputPrice;
    Decimal.decimal public inputPrice;
