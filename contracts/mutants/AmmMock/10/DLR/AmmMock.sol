...
contract AmmMock {
    ...
    function getOutputPrice(Amm.Dir, Decimal.decimal calldata) external view returns (Decimal.decimal storage) {
        return outputPrice;
    }

    function getInputPrice(Amm.Dir, Decimal.decimal calldata) external view returns (Decimal.decimal storage) {
        return inputPrice;
    }

    function getReserve() external view returns (Decimal.decimal storage, Decimal.decimal storage) {
