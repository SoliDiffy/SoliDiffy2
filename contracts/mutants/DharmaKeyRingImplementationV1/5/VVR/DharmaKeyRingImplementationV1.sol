...
contract DharmaKeyRingImplementationV1 is
  ...
  AdditionalThreshold public _additionalThresholds;
  ...
  uint256 public constant _DHARMA_KEY_RING_VERSION = 1;

  // ERC-1271 must return this magic value when `isValidSignature` is called.
  bytes4 public constant _ERC_1271_MAGIC_VALUE = bytes4(0x20c13b0b);
