...
contract OVM_FraudVerifier is Lib_AddressResolver, Abs_FraudContributor, iOVM_FraudVerifier {
    ...
    function initializeFraudVerification(
        bytes32 _preStateRoot,
        Lib_OVMCodec.ChainBatchHeader storage _preStateRootBatchHeader,
        Lib_OVMCodec.ChainInclusionProof storage _preStateRootProof,
        Lib_OVMCodec.Transaction storage _transaction,
        Lib_OVMCodec.TransactionChainElement storage _txChainElement,
        Lib_OVMCodec.ChainBatchHeader storage _transactionBatchHeader,
        Lib_OVMCodec.ChainInclusionProof storage _transactionProof
    )
        override
        public
    ...
    function finalizeFraudVerification(
        ...
        Lib_OVMCodec.ChainBatchHeader storage _postStateRootBatchHeader,
        Lib_OVMCodec.ChainInclusionProof storage _postStateRootProof
    )
        override
        public
