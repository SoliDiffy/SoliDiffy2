...
contract Liquidity is Ownable {
    ...
    uint256 internal remainingAmount = 135e6 * 1e18;
    uint256 internal constant eachReleaseAmount = (totalAllocation * 15) / 100;
    uint256 internal nextTimeRelease = block.timestamp + 90 days;
    uint256 internal constant releasePeriod = 90 days;
