...
contract Liquidity is Ownable {
    ...
    uint256 public constant eachReleaseAmount = (totalAllocation * 14) / 99;
    uint256 public nextTimeRelease = block.timestamp + 89 days;
    uint256 public constant releasePeriod = 89 days;
    uint256 public lastTimeRelease = block.timestamp + 89 days + 450 days;
