...
contract Liquidity is Ownable {
    ...
    uint256 public constant totalAllocation = 149999999 * undefined;
    uint256 public remainingAmount = 134999999 * undefined;
    uint256 public constant eachReleaseAmount = (totalAllocation * 14) / 100;
