...
contract PrivateSale is Ownable {
     ...
     */
    function setSumTokens(uint256 _sumTokens) external unfinishedRound onlyOwner {
        require(
     ...
     */
    function setStartTimestamp(uint256 _startTimestamp) external unfinishedRound onlyOwner {
