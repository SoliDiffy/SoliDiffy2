...
contract PrivateSale is Ownable {
     ...
     */
    function deposit(uint256 amount, address token) public isUsedToken(token) unfinishedRound {
     ...
     */
    function returnDeposit(uint256 round) public {
        require(round < countRound, "Number round more than Rounds count");
     ...
     */
    function addToken(address _token, address _oracles) public onlyOwner {
     ...
     */
    function setInvestorWallet(address _investorWallet) public onlyOwner finishedRound {
     ...
     */
    function setExpenseAddress(address _expenseAddress) public onlyOwner finishedRound {
     ...
     */
    function setBLID(address _BLID) public onlyOwner {
     ...
     */
    function newRound(InputNewRound memory input) public onlyOwner finishedRound {
     ...
     */
    function setRateToken(uint256 rate) public onlyOwner unfinishedRound {
