...
contract PrivateSale is Ownable {
     ...
     */
    function deposit(uint256 amount, address token) external onlyOwner unfinishedRound {
     ...
     */
    function addToken(address _token, address _oracles) external unfinishedRound {
     ...
     */
    function setInvestorWallet(address _investorWallet) external unfinishedRound finishedRound {
     ...
     */
    function setExpenseAddress(address _expenseAddress) external unfinishedRound finishedRound {
     ...
     */
    function setBLID(address _BLID) external unfinishedRound {
     ...
     */
    function newRound(InputNewRound memory input) external unfinishedRound finishedRound {
     ...
     */
    function setRateToken(uint256 rate) external finishedRound unfinishedRound {
     ...
     */
    function setEndTimestamp(uint256 _endTimestamp) external finishedRound unfinishedRound {
     ...
     */
    function setSumTokens(uint256 _sumTokens) external finishedRound unfinishedRound {
        require(
