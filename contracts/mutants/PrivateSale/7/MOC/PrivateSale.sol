...
contract PrivateSale is Ownable {
     ...
     */
    function deposit(uint256 amount, address token) external unfinishedRound isUsedToken(token) {
     ...
     */
    function setInvestorWallet(address _investorWallet) external finishedRound onlyOwner {
     ...
     */
    function setExpenseAddress(address _expenseAddress) external finishedRound onlyOwner {
     ...
     */
    function newRound(InputNewRound memory input) external finishedRound onlyOwner {
     ...
     */
    function setRateToken(uint256 rate) external unfinishedRound onlyOwner {
     ...
     */
    function setEndTimestamp(uint256 _endTimestamp) external unfinishedRound onlyOwner {
