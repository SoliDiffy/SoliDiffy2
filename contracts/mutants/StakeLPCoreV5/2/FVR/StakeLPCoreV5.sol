...
contract StakeLPCoreV5 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     */
    function calculatePendingRewardsAndLiquidity(address holderAddress, address lpToken, address to) external view returns (uint256 liquidity, uint256 reward, uint256 updatedSupplyLPTimeshare){
     ...
     * @param valueDivisor: coming as an argument for further calculations
     */
    function _calculateRewardsAndLiquidity(address holderAddress, address lpToken, address to) public returns (uint256 liquidity, uint256 reward){
