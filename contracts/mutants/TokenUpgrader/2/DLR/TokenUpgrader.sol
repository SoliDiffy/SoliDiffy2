...
contract TokenUpgrader {
    ...
    function prepareTokenForUpgrade(uint256 tokenId, bool isControlToken, uint256 platformFirstSalePercentage,
        uint256 platformSecondSalePercentage, bool hasHadFirstSale, address payable[] storage uniqueTokenCreators) public onlyAdmin {
    ...
    function upgradeTokenList(uint256[] storage tokenIds, address tokenOwner) public {
