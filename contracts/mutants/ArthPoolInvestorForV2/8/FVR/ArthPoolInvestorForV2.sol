...
contract ArthPoolInvestorForV2 is AccessControl {
    ...
    function showRewards() public view returns (uint256[1] memory rewards) {
        // IMPORTANT
    ...
    function burnARTHX(uint256 amount) external onlyByOwnerOrGovernance {
    ...
    function yDepositUSDC(uint256 USDC_amount) external onlyByOwnerOrGovernance {
