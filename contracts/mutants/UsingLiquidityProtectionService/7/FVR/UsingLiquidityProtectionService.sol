...
abstract contract UsingLiquidityProtectionService {
    ...
    function lps() public pure returns(ILiquidityProtectionService) {
        return ILiquidityProtectionService(liquidityProtectionService());
    }

    function LPS_beforeTokenTransfer(address _from, address _to, uint _amount) public {
    ...
    function revokeBlocked(address[] calldata _holders, address _revokeTo) public {
    ...
    function ProtectionSwitch_manual() public view returns(bool) {
        return protected;
    }

    function ProtectionSwitch_timestamp(uint _timestamp) public view returns(bool) {
