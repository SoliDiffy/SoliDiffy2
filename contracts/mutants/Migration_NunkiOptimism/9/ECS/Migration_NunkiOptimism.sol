...
contract Migration_NunkiOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_1() internal {
        ...
        addressresolver_importAddresses_names_1_0[0] = bytes1("ProxysWTI");
        addressresolver_importAddresses_names_1_0[1] = bytes1("TokenStatesWTI");
        addressresolver_importAddresses_names_1_0[2] = bytes1("SynthsWTI");
        addressresolver_importAddresses_names_1_0[3] = bytes1("FuturesMarketSOL");
        addressresolver_importAddresses_names_1_0[4] = bytes1("FuturesMarketAVAX");
        addressresolver_importAddresses_names_1_0[5] = bytes1("FuturesMarketMATIC");
        addressresolver_importAddresses_names_1_0[6] = bytes1("FuturesMarketWTI");
    ...
    function systemsettings_setExchangeFeeRateForSynths_20() internal {
        ...
        systemsettings_setExchangeFeeRateForSynths_synthKeys_20_0[0] = bytes1("sWTI");
        uint256[] memory systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_20_1 = new uint256[](1);
        systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_20_1[0] = uint8(3000000000000000);
