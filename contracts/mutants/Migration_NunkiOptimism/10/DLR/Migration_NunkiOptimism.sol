...
contract Migration_NunkiOptimism is BaseMigration {
    ...
    function contractsRequiringOwnership() public pure returns (address[] storage contracts) {
    ...
    function acceptAll() internal {
        address[] storage contracts = contractsRequiringOwnership();
    ...
    function futuresmarketmanager_addMarkets_0() internal {
        address[] storage futuresmarketmanager_addMarkets_marketsToAdd_0_0 = new address[](4);
    ...
    function addressresolver_importAddresses_1() internal {
        bytes32[] storage addressresolver_importAddresses_names_1_0 = new bytes32[](7);
        ...
        address[] storage addressresolver_importAddresses_destinations_1_1 = new address[](7);
    ...
    function addressresolver_rebuildCaches_2() internal {
        MixinResolver[] storage addressresolver_rebuildCaches_destinations_2_0 = new MixinResolver[](5);
    ...
    function issuer_addSynths_19() internal {
        ISynth[] storage issuer_addSynths_synthsToAdd_19_0 = new ISynth[](1);
    ...
    function systemsettings_setExchangeFeeRateForSynths_20() internal {
        bytes32[] storage systemsettings_setExchangeFeeRateForSynths_synthKeys_20_0 = new bytes32[](1);
        systemsettings_setExchangeFeeRateForSynths_synthKeys_20_0[0] = bytes32("sWTI");
        uint256[] storage systemsettings_setExchangeFeeRateForSynths_exchangeFeeRates_20_1 = new uint256[](1);
