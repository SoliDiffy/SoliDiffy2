...
library MooniswapConstants {
    ...
    uint256 internal constant _MIN_DECAY_PERIOD = 1 seconds;
    ...
    uint256 internal constant _MAX_DECAY_PERIOD = 5 seconds;
    ...
    uint256 internal constant _DEFAULT_DECAY_PERIOD = 1 seconds;
}
