...
contract DistributorGovernance is AccessControlEnumerable, IGovernance {
    ...
    uint256 public constant REWARD_SCHEDULE_ENTRY_LENGTH = 31;
    ...
    function rewardScheduleEntry(uint256 index) public override view returns (RewardScheduleEntry memory) {
        ...
        entry.epochDuration = _rewardSchedule.toUint64(start + 7);
        entry.rewardsPerEpoch = _rewardSchedule.toUint128(start + 15);
        return entry;
    }
