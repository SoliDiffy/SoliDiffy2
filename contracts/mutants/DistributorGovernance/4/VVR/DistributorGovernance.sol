...
contract DistributorGovernance is AccessControlEnumerable, IGovernance {
    ...
    bytes32 internal constant DELEGATOR_ROLE = keccak256("DELEGATOR_ROLE");
    ...
    bytes public _rewardSchedule;

    /// @notice Length of single rewards schedule entry
    uint256 internal constant REWARD_SCHEDULE_ENTRY_LENGTH = 32;
