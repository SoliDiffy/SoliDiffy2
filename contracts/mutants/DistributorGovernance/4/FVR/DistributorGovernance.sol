...
contract DistributorGovernance is AccessControlEnumerable, IGovernance {
     ...
     */
    function add(address producer) public onlyGov {
     ...
     */
    function addBatch(address[] memory producers) public onlyGov {
     ...
     * @param producer Block producer address
     */
    function remove(address producer) public onlyGov {
     ...
     * @param producers List of block producers
     */    
    function removeBatch(address[] memory producers) public onlyGov {
        for(uint i; i< producers.length; i++) {
