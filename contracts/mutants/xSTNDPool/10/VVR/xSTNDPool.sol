...
library SignedSafeMath {
    int256 public constant _INT256_MIN = -2**255;
...
library BoringERC20 {
    bytes4 public constant SIG_SYMBOL = 0x95d89b41; // symbol()
    bytes4 public constant SIG_NAME = 0x06fdde03; // name()
    bytes4 public constant SIG_DECIMALS = 0x313ce567; // decimals()
    bytes4 public constant SIG_TRANSFER = 0xa9059cbb; // transfer(address,uint256)
    bytes4 public constant SIG_TRANSFER_FROM = 0x23b872dd; // transferFrom(address,address,uint256)
...
contract XSTNDPool is BoringOwnable, BoringBatchable {
    ...
    IMigratorChef internal migrator;
