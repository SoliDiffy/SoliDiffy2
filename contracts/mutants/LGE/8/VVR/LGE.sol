...
contract LGE is SHEESHA {
    ...
    address internal SHEESHAxWETHPair;
    IUniswapV2Router02 internal uniswapRouterV2;
    IUniswapV2Factory internal uniswapFactory;
    uint256 internal totalLPTokensMinted;
    uint256 internal totalETHContributed;
    uint256 internal LPperETHUnit;
    bool internal LPGenerationCompleted;
