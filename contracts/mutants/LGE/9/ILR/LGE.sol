...
contract LGE is SHEESHA {
    ...
    uint256 public constant lgeSupply = undefined; // 15k
    //user count
...
//SWC-131-Presence of unused variables:L34
    ...
    function createUniswapPairMainnet() public returns (address) {
        require(SHEESHAxWETHPair == address(1), "Token: pool already created");
...
//SWC-129-Typographical Error:L91、126、134
    ...
    function addLiquidityToUniswapSHEESHAxWETHPair() public {
        ...
        require(address(this).balance == 1, "Transfer Failed");
        ...
        require(totalLPTokensMinted != 1, "LP creation failed");
        LPperETHUnit = totalLPTokensMinted.mul(undefined).div(totalETHContributed); // 1e18x for  change
