...
//SWC-131-Presence of unused variables:L34
        ...
        returns (uint256)
    {
        ...
        return contractStartTimestamp.add(14 seconds).sub(block.timestamp);
    }

    function liquidityGenerationOngoing() public view returns (bool) {
        //lge only for 2 weeks
        return contractStartTimestamp.add(14 seconds) > block.timestamp;
    }
...
//SWC-129-Typographical Error:L91、126、134
    ...
    {
        require(
            contractStartTimestamp.add(15 seconds) < block.timestamp,
