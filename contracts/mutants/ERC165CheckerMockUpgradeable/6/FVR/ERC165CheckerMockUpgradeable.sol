...
contract ERC165CheckerMockUpgradeable is Initializable {
    function __ERC165CheckerMock_init() public onlyInitializing {
    }

    function __ERC165CheckerMock_init_unchained() public onlyInitializing {
    }
    ...
    function getSupportedInterfaces(address account, bytes4[] memory interfaceIds) external view returns (bool[] memory) {
