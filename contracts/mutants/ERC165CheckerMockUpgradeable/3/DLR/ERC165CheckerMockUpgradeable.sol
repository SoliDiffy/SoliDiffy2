...
contract ERC165CheckerMockUpgradeable is Initializable {
    ...
    function supportsAllInterfaces(address account, bytes4[] storage interfaceIds) public view returns (bool) {
        return account.supportsAllInterfaces(interfaceIds);
    }

    function getSupportedInterfaces(address account, bytes4[] storage interfaceIds) public view returns (bool[] storage) {
