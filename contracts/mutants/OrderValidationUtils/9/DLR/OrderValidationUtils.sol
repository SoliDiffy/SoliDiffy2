    ...
    LibAssetData
{
    ...
    function getOrderRelevantState(LibOrder.Order storage order, bytes storage signature)
        public
        view
        returns (
            LibOrder.OrderInfo storage orderInfo,
    ...
    function getOrderRelevantStates(LibOrder.Order[] storage orders, bytes[] storage signatures)
        public
        view
        returns (
            LibOrder.OrderInfo[] storage ordersInfo,
            uint256[] storage fillableTakerAssetAmounts,
            bool[] storage isValidSignature
        )
    {
    ...
    function getTransferableAssetAmount(address ownerAddress, bytes storage assetData)
        public
        view
