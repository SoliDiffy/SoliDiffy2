...
contract FraxMiddlemanGauge is Owned, ReentrancyGuard {
    ...
    address internal reward_token_address = 0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0; // FXS
    address internal rewards_distributor_address;
    ...
    // Gauge-related
    address internal bridge_address;
    uint256 internal bridge_type;
    address internal destination_address_override;
    string internal non_evm_destination_address;
