...
contract FraxMiddlemanGauge is Owned, ReentrancyGuard {
    ...
    function setBridgeInfo(address _bridge_address, uint256 _bridge_type, address _destination_address_override, string storage _non_evm_destination_address) external onlyByOwnGov {
        bridge_address = _bridge_address;
