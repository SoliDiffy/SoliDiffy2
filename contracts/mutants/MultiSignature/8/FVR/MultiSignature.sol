...
contract MultiSignature{
    ...
    function getConfirmation(bytes32 _id) external view returns(uint256 _confirmation) {
    ...
    function isConfirm(bytes32 _id, address _acc) external view returns(bool) {
    ...
    function addAdmin(address _newAdmin) public onlyWallet returns (bool) {
