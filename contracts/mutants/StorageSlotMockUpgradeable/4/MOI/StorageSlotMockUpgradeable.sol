...
contract StorageSlotMockUpgradeable is Initializable {
    ...
    function setBoolean(bytes32 slot, bool value) public onlyInitializing {
        slot.getBooleanSlot().value = value;
    }

    function setAddress(bytes32 slot, address value) public onlyInitializing {
        slot.getAddressSlot().value = value;
    }

    function setBytes32(bytes32 slot, bytes32 value) public onlyInitializing {
        slot.getBytes32Slot().value = value;
    }

    function setUint256(bytes32 slot, uint256 value) public onlyInitializing {
