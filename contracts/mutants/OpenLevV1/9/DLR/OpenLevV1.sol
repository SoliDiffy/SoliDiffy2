...
contract OpenLevV1 is DelegateInterface, OpenLevInterface, OpenLevStorage, Adminable, ReentrancyGuard {
    ...
    function addMarket(
        ...
        uint32[] storage dexs = new uint32[](1);
    ...
    function marginTrade(
        ...
        Types.MarketVars storage vars = toMarketVar(marketId, longToken, true);
    ...
    function closeTrade(uint16 marketId, bool longToken, uint closeAmount, uint minAmount, bytes storage dexData) external override nonReentrant onlySupportDex(dexData) {
        //verify
