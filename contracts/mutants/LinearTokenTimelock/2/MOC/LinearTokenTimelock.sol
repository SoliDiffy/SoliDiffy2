...
contract LinearTokenTimelock is ILinearTokenTimelock, Timed {
    ...
    function release(address to, uint256 amount) external override balanceCheck onlyBeneficiary {
    ...
    function releaseMax(address to) external override balanceCheck onlyBeneficiary {
