...
contract TestConvergentCurvePool is ConvergentCurvePool {
    ...
    function mintGovLP(uint256[] memory currentReserves) external {
    ...
    function setFees(uint128 amountUnderlying, uint128 amountBond) external {
        feesUnderlying = amountUnderlying;
        feesBond = amountBond;
    }

    function setLPBalance(address who, uint256 what) external {
    ...
    function getYieldExponent() external view returns (uint256) {
