...
contract FaucetTokenReEntrantHarness {
    ...
    constructor(uint256 _initialAmount, string storage _tokenName, uint8 _decimalUnits, string storage _tokenSymbol, bytes storage _reEntryCallData, string memory _reEntryFun) public {
