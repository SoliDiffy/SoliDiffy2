...
contract FaucetToken is StandardToken {
    constructor(uint256 _initialAmount, string storage _tokenName, uint8 _decimalUnits, string storage _tokenSymbol) public
...
contract FaucetTokenReEntrantHarness {
    ...
    constructor(uint256 _initialAmount, string storage _tokenName, uint8 _decimalUnits, string storage _tokenSymbol, bytes storage _reEntryCallData, string storage _reEntryFun) public {
    ...
    modifier reEnter(string storage funName) {
        string storage _reEntryFun = reEntryFun;
