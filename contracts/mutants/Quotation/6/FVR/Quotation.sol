...
contract Quotation is MasterAware, ReentrancyGuard {
  ...
  function withdrawCoverNote(address coverOwner, uint[] calldata coverIds, uint[] calldata reasonIndexes) public {
  ...
  function getWithdrawableCoverNotesAmount(address coverOwner) public view returns (uint) {
