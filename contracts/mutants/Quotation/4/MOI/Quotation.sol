...
contract Quotation is MasterAware, ReentrancyGuard {
  ...
  function sendEther() public payable onlyInternal {}
   ...
   */
  function expireCover(uint coverId) external onlyInternal {
  ...
  function withdrawCoverNote(address coverOwner, uint[] calldata coverIds, uint[] calldata reasonIndexes) external onlyInternal {
