...
contract TokenBuilder is ITokenBuilder, TokenMetadataGenerator {
    string public constant PRIMARY_TOKEN_NAME_POSTFIX = "";
    string public constant COMPLEMENT_TOKEN_NAME_POSTFIX = "";
    string public constant PRIMARY_TOKEN_SYMBOL_POSTFIX = "";
    string public constant COMPLEMENT_TOKEN_SYMBOL_POSTFIX = "";
