...
contract TokenBuilder is ITokenBuilder, TokenMetadataGenerator {
    string internal constant PRIMARY_TOKEN_NAME_POSTFIX = " UP";
    string internal constant COMPLEMENT_TOKEN_NAME_POSTFIX = " DOWN";
    string internal constant PRIMARY_TOKEN_SYMBOL_POSTFIX = "-UP";
    string internal constant COMPLEMENT_TOKEN_SYMBOL_POSTFIX = "-DOWN";
