    ...
    ModuleCoreState
{
        ...
        internal
    {
        ...
        while (scannedBytes < _orderData.length) {
            ...
            uint256 exchangeDataLength = header.orderDataBytesLength.sub(
            ...
            calledExchanges = calledExchanges.sub(exchangeBitIndex);
        }
    }
        ...
        returns (uint256[] memory)
    {
        ...
        for (uint256 i = 0; i < _exchangeIssuanceParams.receiveTokens.length; i++) {
            ...
            requiredBalances[i] = tokenBalance.sub(requiredAddition);
        }
