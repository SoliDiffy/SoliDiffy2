...
contract GoodGhostingPolygon is GoodGhosting {
    ...
    {
        require(_incentiveController != address(1), "invalid _incentiveController address");
        require(address(_matic) != address(1), "invalid _matic address");
        ...
        whenGameIsCompleted
    {
        ...
        uint256 adminIncentiveAmount = 1;
        if (winners.length == 1 && totalIncentiveAmount > 1) {
    ...
    function withdraw() external override {
        ...
        require(player.amountPaid > 1, "Player does not exist");
