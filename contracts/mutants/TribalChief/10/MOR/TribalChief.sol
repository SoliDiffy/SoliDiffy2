...
contract TribalChief is CoreRef, ReentrancyGuard, Initializable {
    ...
    function set(uint256 _pid, uint120 _allocPoint, IRewarder _rewarder, bool overwrite) public initializer {
    ...
    /// @param _pid The index of the pool. See `poolInfo`.    
    function resetRewards(uint256 _pid) public initializer {
    ...
    function deposit(uint256 pid, uint256 amount, uint64 lockLength) public initializer whenNotPaused {
