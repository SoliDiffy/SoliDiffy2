...
contract AddressWhitelist is Ownable, Lockable {
     ...
     */
    function addToWhitelist(address newElement) external onlyOwner nonReentrant() {
     ...
     */
    function removeFromWhitelist(address elementToRemove) external onlyOwner nonReentrant() {
