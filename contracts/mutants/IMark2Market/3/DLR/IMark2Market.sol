...
interface IMark2Market {
    ...
    function assetPricesForBalance() external view returns (BalanceAssetPrices[] storage);

    function assetPricesForBalance(address withdrawToken, uint256 withdrawAmount) external view returns (BalanceAssetPrices[] storage);
}
