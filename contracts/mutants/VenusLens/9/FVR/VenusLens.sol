...
contract VenusLens {
    ...
    function vTokenMetadata(VToken vToken) external returns (VTokenMetadata memory) {
    ...
    function vTokenMetadataAll(VToken[] calldata vTokens) public returns (VTokenMetadata[] memory) {
    ...
    function vTokenBalances(VToken vToken, address payable account) external returns (VTokenBalances memory) {
    ...
    function vTokenBalancesAll(VToken[] calldata vTokens, address payable account) public returns (VTokenBalances[] memory) {
        uint vTokenCount = vTokens.length;
    ...
    function vTokenUnderlyingPrice(VToken vToken) external view returns (VTokenUnderlyingPrice memory) {
        ComptrollerLensInterface comptroller = ComptrollerLensInterface(address(vToken.comptroller()));
    ...
    function vTokenUnderlyingPriceAll(VToken[] calldata vTokens) public view returns (VTokenUnderlyingPrice[] memory) {
        uint vTokenCount = vTokens.length;
    ...
    function getAccountLimits(ComptrollerLensInterface comptroller, address account) external view returns (AccountLimits memory) {
