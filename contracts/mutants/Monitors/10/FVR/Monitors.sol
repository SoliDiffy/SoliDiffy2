...
contract Monitors is Permissions {
     ...
     */
    function addMonitor(uint nodeIndex) public allow("SkaleManager") {
     ...
     */
    function deleteMonitor(uint nodeIndex) public allow("SkaleManager") {
        bytes32 monitorIndex = keccak256(abi.encodePacked(nodeIndex));
     ...
     */
    function removeCheckedNodes(uint nodeIndex) public allow("SkaleManager") {
        bytes32 monitorIndex = keccak256(abi.encodePacked(nodeIndex));
     ...
     */
    function sendVerdict(uint fromMonitorIndex, Verdict calldata verdict) public allow("SkaleManager") {
        uint index;
        uint time;
     ...
     */
    function setLastBountyBlock(uint nodeIndex) public allow("SkaleManager") {
     ...
     */
    function getLastBountyBlock(uint nodeIndex) public view returns (uint) {
     ...
     */
    function getNodesInGroup(bytes32 monitorIndex) public view returns (uint[] memory) {
     ...
     */
    function getNumberOfNodesInGroup(bytes32 monitorIndex) public view returns (uint) {
