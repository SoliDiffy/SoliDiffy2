...
contract Monitors is Permissions {
    ...
    {
        Nodes nodes = Nodes(contractManager.getContract("Nodes"));
        uint[] storage activeNodes = nodes.getActiveNodeIds();
     ...
     */
    function _median(uint[] storage values) private pure returns (uint) {
     ...
     */
    function _swap(uint[] storage array, uint index1, uint index2) private pure {
