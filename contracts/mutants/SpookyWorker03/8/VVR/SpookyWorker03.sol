...
contract SpookyWorker03 is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker03 {
  ...
  ISpookyMasterChef internal spookyMasterChef;
  ISwapFactoryLike internal factory;
  ISwapRouter02Like internal router;
  ISwapPairLike internal override lpToken;
  address internal wNative;
  address internal override baseToken;
  address internal override farmingToken;
  address internal boo;
