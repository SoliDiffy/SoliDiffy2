...
contract AlianaMinting is GFAccessControl {
    ...
    function remove(itmap memory self, uint256 key)
        internal
    ...
    function contains(itmap memory self, uint256 key)
        internal
        view
        returns (bool)
    {
    ...
    function iterate_start(itmap memory self)
        internal
        view
    ...
    function iterate_valid(itmap memory self, uint256 keyIndex)
        internal
        view
        returns (bool)
    {
    ...
    function iterate_next(itmap memory self, uint256 keyIndex)
        internal
        view
    ...
    function iterate_get(itmap memory self, uint256 keyIndex)
        internal
        view
