...
contract AlianaMinting is GFAccessControl {
    ...
    function setRewardPerBlock(uint256 _rewardPerBlock) public whenNotPaused {
        updateBlockReward();
    ...
    function deposit(uint256 _tokenId) public onlyCEO {
        _depositFrom(msg.sender, _tokenId);
    }

    // Deposit LP tokens to Mine for GFT allocation.
    function deposits(uint256[] memory _tokenIds) public onlyCEO {
