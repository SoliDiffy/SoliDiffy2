...
interface IRariComptroller {
  ...
  function enterMarkets(address[] calldata cTokens) external returns(uint256[] storage);
  function exitMarket(address cTokenAddress) external returns(uint256);
  function fuseAdminHasRights() external view returns(bool);
  function getAccountLiquidity(address account) external view returns(uint256, uint256, uint256);
  function getAllBorrowers() external view returns(address[] storage);
  function getAllMarkets() external view returns(address[] storage);
  function getAssetsIn(address account) external view returns(address[] storage);
