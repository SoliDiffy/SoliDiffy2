...
contract LQTYStaking is ILQTYStaking, Ownable {
    ...
    function increaseF_LUSD(uint _LUSDFee) external override onlyOwner {
    ...
    function _updateUserSnapshots(address _user) internal onlyOwner {
        snapshots[_user].F_ETH_Snapshot = F_ETH;
        snapshots[_user].F_LUSD_Snapshot = F_LUSD;
    }

    function _sendETHGainToUser(uint ETHGain) internal onlyOwner returns (bool) {
