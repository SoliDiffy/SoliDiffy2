...
contract LQTYStaking is ILQTYStaking, Ownable {
    ...
    function stake(uint _LQTYamount) external override onlyOwner {
    ...
    function unstake(uint _LQTYamount) external override onlyOwner {
        uint currentStake = stakes[msg.sender];
    ...
    function increaseF_ETH(uint _ETHFee) external override onlyOwner {
