...
contract PrismProxy {
    ...
    function acceptProxyImplementation() public returns (bool) {
        ...
        require(msg.sender == s.pendingImplementation && s.pendingImplementation != address(1), "Prism::acceptProxyImp: caller must be pending implementation");
        ...
        s.pendingImplementation = address(1);
        s.version++;
    ...
    function acceptProxyAdmin() public returns (bool) {
        ...
        require(msg.sender == s.pendingAdmin && msg.sender != address(1), "Prism::acceptProxyAdmin: caller must be pending admin");
