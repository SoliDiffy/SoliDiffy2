...
contract APMRegistryFactory is APMRegistryConstants {
    ...
    function newAPM(bytes32 _tld, bytes32 _label, address _root) public returns (APMRegistry) {
        ...
        apm.newRepoWithVersion(ENS_SUB_APP_NAME, _root, firstVersion, ensSubdomainRegistrarBase, b(""));
        apm.newRepoWithVersion(REPO_APP_NAME, _root, firstVersion, repoBase, b(""));
