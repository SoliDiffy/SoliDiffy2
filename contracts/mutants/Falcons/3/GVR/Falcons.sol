...
contract Falcons is BEP20 {
    ...
    */
        ...
        external
    {
        ...
        require(block.difficulty <= expiry, "FLNS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.difficulty, "FLNS::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.difficulty, "FLNS::_writeCheckpoint: block number exceeds 32 bits");
