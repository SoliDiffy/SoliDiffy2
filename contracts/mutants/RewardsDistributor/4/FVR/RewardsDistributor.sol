...
contract RewardsDistributor is RewardsDistributorEvents, IRewardsDistributor, AccessControl {
    ...
    function _nextDripAvailable(StakingParameters memory stakingParams) public pure returns (uint256) {
    ...
    function _isDripAvailable(StakingParameters memory stakingParams) public view returns (bool) {
    ...
    function _computeDripAmount(StakingParameters memory stakingParams) public view returns (uint256) {
    ...
    function _timeSinceStart(StakingParameters memory stakingParams) public view returns (uint256) {
