...
contract RewardsDistributor is RewardsDistributorEvents, IRewardsDistributor, AccessControl {
    ...
    function drip(IStakingRewards stakingContract) external override returns (uint256) {
        StakingParameters memory stakingParams = stakingContractsMap[stakingContract];
    ...
    function _nextDripAvailable(StakingParameters storage stakingParams) internal pure returns (uint256) {
    ...
    function _isDripAvailable(StakingParameters storage stakingParams) internal view returns (bool) {
    ...
    function _computeDripAmount(StakingParameters storage stakingParams) internal view returns (uint256) {
