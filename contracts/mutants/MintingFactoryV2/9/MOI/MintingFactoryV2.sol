...
abstract contract ERC1967UpgradeUpgradeable is Initializable {
     ...
     */
    function _setImplementation(address newImplementation) private onlyInitializing {
     ...
     */
    function _upgradeTo(address newImplementation) internal onlyInitializing {
     ...
     */
    function _setAdmin(address newAdmin) private onlyInitializing {
     ...
     */
    function _changeAdmin(address newAdmin) internal onlyInitializing {
     ...
     */
    function _setBeacon(address newBeacon) private onlyInitializing {
     ...
     */
    function _functionDelegateCall(address target, bytes memory data) private onlyInitializing returns (bytes memory) {
