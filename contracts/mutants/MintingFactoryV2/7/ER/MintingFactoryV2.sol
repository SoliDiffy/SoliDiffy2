...
contract MintingFactoryV2 is Context, UUPSUpgradeable {
    ...
    enum SaleType {
        OFFERS, BUY_NOW, STEPPED, RESERVE
    }
    ...
    function mintBatchEditionGatedAndPublic(
        ...
        // Setup public sale
        _setupSalesMechanic(editionId, SaleType.OFFERS, _publicStartDate, _publicBuyNowPrice, 0);
