...
contract xALPACA is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function _depositFor(
    ...
    e/* emit LogDeposit(_for, _amount, _newLocked.end, _actionType, block.timestamp); */    e/* emit LogSupply(_supplyBefore, supply); */  }
  ...
  function setBreaker(uint256 _breaker) external onlyOwner {
    ...
    breaker = _breaker;
    e/* emit LogSetBreaker(_previousBreaker, breaker); */  }
