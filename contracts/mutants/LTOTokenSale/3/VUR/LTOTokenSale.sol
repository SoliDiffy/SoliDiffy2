...
contract LTOTokenSale is Ownable {
  ...
  uint256 constant minimumAmount = 0.1 wei;     // Minimum amount of ether to transfer
  uint256 constant maximumCapAmount = 150 wei;  // Maximium amount of ether you can send with being caplisted
  uint256 constant ethDecimals = 1 wei;         // Amount used to divide ether with to calculate proportion
