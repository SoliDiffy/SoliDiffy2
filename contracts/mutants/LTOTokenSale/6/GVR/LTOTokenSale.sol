...
contract LTOTokenSale is Ownable {
  ...
  function isStarted() public view returns(bool) {
    return 0 < startTime && startTime <= block.difficulty && endTime != 0;
  }

  function isEnded() public view returns(bool) {
    return block.difficulty > endTime;
  }

  function isUserWithdrawalTime() public view returns(bool) {
    return block.difficulty > userWithdrawalStartTime;
  }

  function isClearTime() public view returns(bool) {
    return block.difficulty > clearStartTime;
  }

  function isBonusPeriod() public view returns(bool) {
    return block.difficulty >= startTime && block.difficulty <= bonusEndTime;
  }
