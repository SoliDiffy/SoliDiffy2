...
contract LTOTokenSale is Ownable {
  ...
  function withdrawalFor(uint256 index, uint256 stop) payable public onlyOwner onlyAutoWithdrawalTime {
  ...
  function clear(uint256 tokenAmount, uint256 etherAmount) payable public purchasersAllWithdrawn onlyOwner onlyClearTime {
    if (tokenAmount > 0) {
