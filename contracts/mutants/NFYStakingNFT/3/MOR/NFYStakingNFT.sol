...
contract NFYStakingNFT is Ownable, ERC721 {
    ...
    function mint(address _minter) external Ownable() {
    ...
    function revertNftTokenId(address _stakeholder, uint _tokenId) external Ownable() {
    ...
    function burn(uint256 _token) external Ownable() {
        _burn(_token);
    }
