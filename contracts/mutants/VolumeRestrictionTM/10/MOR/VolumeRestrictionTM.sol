...
contract VolumeRestrictionTM is VolumeRestrictionTMStorage, TransferManager {
     ...
     */
    function removeIndividualRestrictionMulti(address[] memory _holders) public onlySecurityToken {
        for (uint256 i = 0; i < _holders.length; i++) {
     ...
     * @param _holder Address of the user
     */
    function removeIndividualDailyRestriction(address _holder) public onlySecurityToken {
     ...
     * @param _holders Array of address of the user
     */
    function removeIndividualDailyRestrictionMulti(address[] memory _holders) public onlySecurityToken {
        for (uint256 i = 0; i < _holders.length; i++) {
     ...
     */
    function removeDefaultRestriction() public onlySecurityToken {
