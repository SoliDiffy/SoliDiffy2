...
contract VolumeRestrictionTM is VolumeRestrictionTMStorage, TransferManager {
     ...
     */
    function changeExemptWalletList(address _wallet, bool _exempted) public onlySecurityToken {
     ...
     */
    function removeIndividualRestriction(address _holder) public onlySecurityToken {
