...
contract VolumeRestrictionTM is VolumeRestrictionTMStorage, TransferManager {
    ...
    function _removeIndividualRestriction(address _holder) internal onlySecurityToken {
    ...
    function _removeIndividualDailyRestriction(address _holder) internal onlySecurityToken {
        require(_holder != address(0));
