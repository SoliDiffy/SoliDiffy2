...
contract SafeBoxFilDa is SafeBoxCToken {
    ...
    uint256 internal constant FILDA_DEPOSIT_CALLID = 16;      // depositinfo callid for action callback
    uint256 internal constant FILDA_BORROW_CALLID = 18;       // borrowinfo callid for action callback
