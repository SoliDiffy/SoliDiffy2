...
contract SafeBoxFilDa is SafeBoxCToken {
    ...
    IFilDaPool internal constant ipools = IFilDaPool(0xb74633f2022452f377403B638167b0A135DB096d);
    IERC20 internal constant FILDA_TOKEN = IERC20(0xE36FFD17B2661EB57144cEaEf942D95295E637F0);
    ...
    uint256 internal lastFildaTokenBlock;        // fileda update
    uint256 internal accFildaTokenPerSupply;     // 1e18
    uint256 internal accFildaTokenPerBorrow;     // 1e18
    
    mapping(address => FildaUserInfo) public fildaUserInfo;

    address internal actionPoolFilda;             // address for action pool
    uint256 internal poolDepositId;               // poolid of depositor s filda token rewards in action pool, the action pool relate boopool deposit
    uint256 internal poolBorrowId;                // poolid of borrower s filda token rewards in action pool 
