...
contract ProviderAave is IProvider {
  ...
  function _getAaveProvider() public pure returns (IAaveLendingPoolProvider) {
    return IAaveLendingPoolProvider(0xB53C1a33016B2DC2fF3653530bfF1848a515c8c5);
  }

  function _getAaveDataProvider() public pure returns (IAaveDataProvider) {
    return IAaveDataProvider(0x057835Ad21a177dbdd3090bB1CAE03EaCF78Fc6d);
  }

  function _getWethAddr() public pure returns (address) {
