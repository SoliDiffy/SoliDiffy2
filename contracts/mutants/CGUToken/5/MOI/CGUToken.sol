...
contract CGUToken is ERC20, IERC677, Ownable {
    ...
    function _checksForLock(address account, uint256 amount) internal onlyOwner {
...
// SWC-100-Function Default Visibility: L55
    ...
    function transfer(address recipient, uint256 amount) public override(ERC20, IERC20) onlyOwner returns (bool) {
        _checksForLock(_msgSender(), amount);
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public override(ERC20, IERC20) onlyOwner returns (bool) {
...
// SWC-100-Function Default Visibility: L80
    function transferAndCall(address _to, uint _value, bytes memory _data) public override onlyOwner returns (bool success)
    {
