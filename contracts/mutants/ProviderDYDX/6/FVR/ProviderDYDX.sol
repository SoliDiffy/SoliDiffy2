...
contract HelperFunct {
   ...
   */
  function getWETHAddr() external pure returns (address weth) {
   ...
   */
  function _getEthAddr() public pure returns (address) {
   ...
   */
  function _getAccountArgs() public view returns (Account.Info[] memory) {
  ...
  function _getActionsArgs(
    ...
    uint256 _amt,
    bool _sign
  ) public view returns (Actions.ActionArgs[] memory) {
