...
contract LendingPair is ERC20, Ownable, IMasterContract {
    ...
    function _addAssetAmount(address user, uint256 amount) private onlyOwner {
        TokenTotals memory _totalAsset = totalAsset;
    ...
    function _addBorrowAmount(address user, uint256 amount) private onlyOwner {
        TokenTotals memory _totalBorrow = totalBorrow;
    ...
    function _removeCollateralAmount(address user, uint256 amount) private onlyOwner {
    ...
    function _removeAssetFraction(address user, uint256 fraction) private onlyOwner returns (uint256 amount) {
        TokenTotals memory _totalAsset = totalAsset;
