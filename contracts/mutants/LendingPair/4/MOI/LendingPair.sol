...
contract LendingPair is ERC20, Ownable, IMasterContract {
    ...
    function init(bytes calldata data) public override onlyOwner {
    ...
    function accrue() public onlyOwner {
    ...
    function updateExchangeRate() public onlyOwner returns (uint256) {
    ...
    function _addCollateralAmount(address user, uint256 amount) private onlyOwner {
