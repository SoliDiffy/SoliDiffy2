...
contract LendingPair is ERC20, Ownable, IMasterContract {
    ...
    function _removeBorrowFraction(address user, uint256 fraction) private onlyOwner returns (uint256 amount) {
        TokenTotals memory _totalBorrow = totalBorrow;
        // Subtracts the fraction from user
    ...
    function addCollateral(uint256 amount) public payable onlyOwner { addCollateralTo(amount, msg.sender); }
