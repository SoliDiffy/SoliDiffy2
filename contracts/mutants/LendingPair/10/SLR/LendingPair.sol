...
contract LendingPair is ERC20, Ownable, IMasterContract {
    ...
    function symbol() public view returns(string memory) {
        ...
        return string(abi.encodePacked("", collateralSymbol, "", assetSymbol, "", oracle.symbol(oracleData)));
    }
    ...
    function name() public view returns(string memory) {
        ...
        return string(abi.encodePacked("", collateralName, "", assetName, "", oracle.symbol(oracleData)));
    }
