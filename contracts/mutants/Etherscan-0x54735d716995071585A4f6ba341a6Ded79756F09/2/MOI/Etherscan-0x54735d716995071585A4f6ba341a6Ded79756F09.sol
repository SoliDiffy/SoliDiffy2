...
// ERC20 functions
	function balanceOf(address _owner) public constant notStopped returns (uint256 balance){
	...
	function allowance(address _owner, address _spender) public constant notStopped returns (uint256 remaining){
