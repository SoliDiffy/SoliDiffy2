...
contract FantomToken is ERC20Token, Wallet, LockSlots, FantomIcoDates {
    ...
    function transferFrom(address _from, address _to, uint _amount) public onlyAdmin returns (bool success) {
        require(tokensTradeable);
    ...
    function transferMultiple(address[] _addresses, uint[] _amounts) external onlyAdmin {
