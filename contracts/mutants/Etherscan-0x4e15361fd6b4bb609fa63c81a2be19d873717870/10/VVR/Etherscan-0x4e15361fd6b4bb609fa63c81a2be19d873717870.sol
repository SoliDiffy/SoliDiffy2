...
contract ERC20Token is ERC20Interface, Owned {
    ...
    uint internal tokensIssuedTotal;
...
contract LockSlots is ERC20Token {
    ...
    uint internal constant LOCK_SLOTS = 5;
...
contract FantomIcoDates is Owned {
    ...
    uint internal dateMainStart = 1529053200; // 15-JUN-2018 09:00 GMT + 0
    uint internal dateMainEnd   = 1529658000; // 22-JUN-2018 09:00 GMT + 0

    uint internal constant DATE_LIMIT = 1529658000 + 180 days;
...
contract FantomToken is ERC20Token, Wallet, LockSlots, FantomIcoDates {
    ...
    uint constant public constant E18 = 10**18;

    // Basic token data

    string internal constant name = "Fantom Token";
