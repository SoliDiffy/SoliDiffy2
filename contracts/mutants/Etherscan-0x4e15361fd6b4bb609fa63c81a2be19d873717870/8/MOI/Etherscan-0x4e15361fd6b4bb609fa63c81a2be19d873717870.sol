...
contract FantomToken is ERC20Token, Wallet, LockSlots, FantomIcoDates {
    ...
    function pWhitelist(address _account) internal onlyAdmin {
    ...
    function makeTradeable() public onlyAdmin {
    ...
    function pMintTokens(uint _mint_type, address _account, uint _tokens, uint _term) private onlyAdmin {
    ...
    function buyTokens() private onlyAdmin {
    ...
    function requestTokenExchangeMax() public onlyAdmin {
        requestTokenExchange(unlockedTokensInternal(msg.sender));
    }

    function requestTokenExchange(uint _tokens) public onlyAdmin {
    ...
    function transfer(address _to, uint _amount) public onlyAdmin returns (bool success) {
