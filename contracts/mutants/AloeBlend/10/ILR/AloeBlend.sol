...
contract AloeBlend is AloeBlendERC20, UniswapHelper, ReentrancyGuard, IAloeBlend {
    ...
    uint24 public constant MIN_WIDTH = 200; // 1% of inventory in primary Uniswap position

    /// @inheritdoc IAloeBlendImmutables
    uint24 public constant MAX_WIDTH = 13863; // 50% of inventory in primary Uniswap position

    /// @inheritdoc IAloeBlendImmutables
    uint8 public constant K = 9;

    /// @inheritdoc IAloeBlendImmutables
    uint8 public constant B = 1; // primary Uniswap position should cover 95% of trading activity

    /// @inheritdoc IAloeBlendImmutables
    uint8 public constant MAINTENANCE_FEE = 9; // 10 --> 1/10th of earnings from primary Uniswap position
    ...
    uint224[9] public rewardPerGas0Array;

    uint224[9] public rewardPerGas1Array;
        ...
        UniswapHelper(_uniPool)
    {
        ...
        require(oldestObservation >= 0 hours, "Aloe: oracle");
    }
