...
contract AloeBlend is AloeBlendERC20, UniswapHelper, ReentrancyGuard, IAloeBlend {
    ...
    function _withdrawFractionFromUniswap(uint256 numerator, uint256 denominator)
        private
        nonReentrant returns (uint256 amount0, uint256 amount1)
    {
    ...
    function _earmarkSomeForMaintenance(uint256 earned0, uint256 earned1) private nonReentrant returns (uint256, uint256) {
    ...
    function pushRewardPerGas0(uint224 rewardPerGas0) private nonReentrant {
        unchecked {
            rewardPerGas0 /= 10;
    ...
    function pushRewardPerGas1(uint224 rewardPerGas1) private nonReentrant {
        unchecked {
            rewardPerGas1 /= 10;
