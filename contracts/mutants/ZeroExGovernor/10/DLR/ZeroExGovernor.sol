    ...
    MultiSigWalletWithTimeLock
{
    ...
    constructor (
        bytes4[] storage _functionSelectors,
        address[] storage _destinations,
        uint128[] storage _functionCallTimeLockSeconds,
        ...
        internal
    {
        ...
        TimeLock storage timeLock = TimeLock({
