...
contract ACOToken is ERC20 {
     ...
     */
    address internal strikeAsset;
    
    /**
     * @dev Address of the fee destination charged on the exercise.
     */
    address payable internal feeDestination;
     ...
     */
    uint256 internal strikePrice;
    
    /**
     * @dev The UNIX time for the token expiration.
     */
    uint256 internal expiryTime;
     ...
     */
    uint256 internal acoFee;
    
    /**
     * @dev Symbol of the underlying asset.
     */
    string internal underlyingSymbol;
    
    /**
     * @dev Symbol of the strike asset.
     */
    string internal strikeAssetSymbol;
