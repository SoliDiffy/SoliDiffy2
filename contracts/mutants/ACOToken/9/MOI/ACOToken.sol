...
contract ACOToken is ERC20 {
     ...
     */
    function mintPayable() external payable nonReentrant {
     ...
     */
    function mintToPayable(address account) external payable nonReentrant {
     ...
     * @param collateralAmount Amount of collateral deposited.
     */
    function mintTo(address account, uint256 collateralAmount) external nonReentrant {
        address _collateral = collateral();
    ...
    function burnFrom(address account, uint256 tokenAmount) external nonReentrant {
     ...
     * @param account Address of the account.
     */
    function redeemFrom(address account) external nonReentrant {
