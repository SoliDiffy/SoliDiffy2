...
contract ACOToken is ERC20 {
     ...
     */
    function _transfer(address sender, address recipient, uint256 amount) nonReentrant internal override {
     ...
     */
    function _approve(address owner, address spender, uint256 amount) nonReentrant internal override {
     ...
     * @param tokenAmount Amount of tokens.
     */
    function _exercise(address account, uint256 tokenAmount) notExpired internal {
     ...
     */
    function _exerciseFromAccounts(address account, uint256 tokenAmount, address[] memory accounts) notExpired internal {
        _validateAndBurn(account, tokenAmount);
     ...
     * @param tokenAmount Amount of tokens.
     */
    function _validateAndBurn(address account, uint256 tokenAmount) nonReentrant internal {
     ...
     * @param account Address of the account.
     */
    function _redeem(address account) notExpired internal {
