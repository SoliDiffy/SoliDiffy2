...
contract ACOToken is ERC20 {
     ...
     */
    function mintToPayable(address account) external  {
     ...
     * @param tokenAmount Amount of tokens.
     */
    function exercise(uint256 tokenAmount) external  {
     ...
     * @param tokenAmount Amount of tokens.
     */
    function exerciseFrom(address account, uint256 tokenAmount) external  {
     ...
     */
    function exerciseAccounts(uint256 tokenAmount, address[] calldata accounts) external  {
