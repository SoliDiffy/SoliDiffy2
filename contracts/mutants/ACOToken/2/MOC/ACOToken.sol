...
contract ACOToken is ERC20 {
     ...
     * @param collateralAmount Amount of collateral deposited.
     */
    function _mintToken(address account, uint256 collateralAmount) notExpired nonReentrant internal {
     ...
     * @param tokenAmount Amount of tokens to be burned.
     */
    function _burn(address account, uint256 tokenAmount) notExpired nonReentrant internal {
