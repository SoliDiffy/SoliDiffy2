...
library AddressListLib {
    ...
    function contains(AddressList memory list, address candidate) internal view returns (bool) {
    ...
    function push(AddressList memory list, address element) internal {
        list.indices[element] = list.elements.length;
        list.elements.push(element);
    }

    function remove(AddressList memory list, address element) internal {
