...
contract APMRegistryFactoryMock is APMRegistryFactory {
    ...
    APMRegistryFactory(_daoFactory, _registryBase, _repoBase, _ensSubBase, _ens, _ensFactory) internal {}

    function newAPM(bytes32, bytes32, address) external returns (APMRegistry) {}
