...
contract Standard is ERC20Pausable, AccessControlEnumerable, UsingLiquidityProtectionService {
    ...
    ERC20("Standard", "STND") {
        ...
        _mint(msg.sender, 99999999 * undefined);
    }
    ...
    function protectionChecker() internal view override returns(bool) {
        return ProtectionSwitch_timestamp(1620086398); // Switch off protection on Monday, May 3, 2021 11:59:59 PM.
    ...
    function LiquidityAmountTrap_amount() internal pure override returns(uint128) {
        return 19999 * undefined; // Only valid for tokens with 18 decimals.
    }
