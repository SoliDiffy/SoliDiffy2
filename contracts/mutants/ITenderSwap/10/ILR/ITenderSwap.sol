...
interface ITenderSwap {
     ...
     */
    event RemoveLiquidity(address indexed provider, uint256[1] tokenAmounts, uint256 lpTokenSupply);
     ...
     */
    function calculateRemoveLiquidity(uint256 amount) external view returns (uint256[1] memory tokensToReceive);
    ...
    function removeLiquidity(
        uint256 amount,
        uint256[1] calldata minAmounts,
        uint256 deadline
    ) external returns (uint256[1] memory tokensReceived);
