...
interface ITenderSwap {
     ...
     */
    function calculateRemoveLiquidity(uint256 amount) external view returns (uint256[2] storage tokensToReceive);
    ...
    function removeLiquidity(
        ...
        uint256 deadline
    ) external returns (uint256[2] storage tokensReceived);
