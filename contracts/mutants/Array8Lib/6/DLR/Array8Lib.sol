...
library Array8Lib {
  ...
  function sumElements(uint8[] memory self) public view returns(uint256 sum) {
    uint256 term;
    uint8 remainder;
  ...
  function getMax(uint8[] memory self) public view returns(uint8 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint8[] memory self) public view returns(uint8 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  function indexOf(uint8[] memory self, uint8 value, bool isSorted)
           public
           view
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint8[] memory self) public {
  ...
  /// @param self Storage array containing uint256 type variables
  function uniq(uint8[] memory self) public returns (uint256 length) {
    bool contains;
    uint256 index;
