...
library Array8Lib {
  ...
  function sumElements(uint8[] storage self) external view returns(uint256 sum) {
    uint256 term;
    uint8 remainder;
  ...
  function getMax(uint8[] storage self) external view returns(uint8 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint8[] storage self) external view returns(uint8 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  /// @param self Storage array containing uint256 type variables
  function heapSort(uint8[] storage self) external {
  ...
  /// @param self Storage array containing uint256 type variables
  function uniq(uint8[] storage self) external returns (uint256 length) {
    bool contains;
    uint256 index;
