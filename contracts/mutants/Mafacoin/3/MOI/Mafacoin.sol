...
contract MafaCoin is ERC20, Ownable {
    ...
    function _updateTotalBuyFee() internal onlyOwner {
        totalBuyFee = liquidityFee.add(burnFee).add(teamBuyFee);
    }

    function _updateTotalSellFee() internal onlyOwner {
    ...
    function _swapAndLiquify(uint256 amount) private onlyOwner {
