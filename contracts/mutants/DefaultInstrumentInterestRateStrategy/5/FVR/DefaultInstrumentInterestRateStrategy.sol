...
contract DefaultInstrumenteInterestRateStrategy is IInstrumentInterestRateStrategy {
  ...
  function variableRateSlope1() public view returns (uint256) {
    return _variableRateSlope1;
  }

  function variableRateSlope2() public view returns (uint256) {
    return _variableRateSlope2;
  }

  function stableRateSlope1() public view returns (uint256) {
    return _stableRateSlope1;
  }

  function stableRateSlope2() public view returns (uint256) {
   ...
   **/
  function _getOverallBorrowRate(uint256 totalStableDebt, uint256 totalVariableDebt, uint256 currentVariableBorrowRate, uint256 currentAverageStableBorrowRate) public pure returns (uint256) {
