...
contract DefaultInstrumenteInterestRateStrategy is IInstrumentInterestRateStrategy {
   ...
   * Expressed in ray
   **/
  uint256 internal immutable OPTIMAL_UTILIZATION_RATE;
  ...
  uint256 internal immutable EXCESS_UTILIZATION_RATE;

  IGlobalAddressesProvider internal immutable addressesProvider;

  // Base variable borrow rate when Utilization rate = 0. Expressed in ray
  uint256 public immutable _baseVariableBorrowRate;

  // Slope of the variable interest curve when utilization rate > 0 and <= OPTIMAL_UTILIZATION_RATE. Expressed in ray
  uint256 public immutable _variableRateSlope1;

  // Slope of the variable interest curve when utilization rate > OPTIMAL_UTILIZATION_RATE. Expressed in ray
  uint256 public immutable _variableRateSlope2;

  // Slope of the stable interest curve when utilization rate > 0 and <= OPTIMAL_UTILIZATION_RATE. Expressed in ray
  uint256 public immutable _stableRateSlope1;

  // Slope of the stable interest curve when utilization rate > OPTIMAL_UTILIZATION_RATE. Expressed in ray
  uint256 public immutable _stableRateSlope2;
