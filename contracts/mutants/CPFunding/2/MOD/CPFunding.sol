...
contract CPFunding is CPStorage {
    ...
    function bid(address to) external phaseBid isBidderAllow(to) preventReentrant {
    ...
    function cancel(address to, uint256 amount, bytes calldata data) external preventReentrant phaseBidOrCalm {
