...
contract CPFunding is CPStorage {
    ...
    function bid(address to) external phaseBidOrCalm preventReentrant isBidderAllow(to) {
    ...
    function cancel(address to, uint256 amount, bytes calldata data) external phaseBid preventReentrant {
    ...
    function settle() external phaseBid preventReentrant {
        _settle();
    ...
    function emergencySettle() external phaseBid preventReentrant {
