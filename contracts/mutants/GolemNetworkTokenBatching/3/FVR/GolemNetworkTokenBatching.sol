...
contract GolemNetworkTokenBatching is TokenProxy {
    ...
    function GolemNetworkTokenBatching(ERC20Basic _gntToken) TokenProxy(_gntToken) internal {
    }

    function batchTransfer(bytes32[] payments, uint64 closureTime) public {
    ...
    function transferAndCall(address to, uint256 value, bytes data) public {
