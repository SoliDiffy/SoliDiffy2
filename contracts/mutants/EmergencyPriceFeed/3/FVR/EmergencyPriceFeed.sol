...
contract EmergencyPriceFeed is IPriceFeed, BlockContext {
    ...
    function _getSqrtMarkTwapX96(uint32 twapInterval) public view returns (uint160) {
     ...
     */
    function _toUint32(uint256 value) public pure returns (uint32 returnValue) {
        require(((returnValue = uint32(value)) == value), "SafeCast: value doesn't fit in 32 bits");
    }

    function _formatSqrtPriceX96ToPriceX96(uint160 sqrtPriceX96) public pure returns (uint256) {
