...
contract PLCRVoting {
    ...
    */
    function revealVote(uint _pollID, uint _voteOption, uint _salt) external {
        ...
        require(sha256(_voteOption, _salt) == getCommitHash(msg.sender, _pollID)); // compare resultant hash from inputs to original commitHash
    ...
    */
    function getNumPassingTokens(address _voter, uint _pollID, uint _salt) public constant returns (uint correctVotes) {
        ...
        bytes32 winnerHash = sha256(winningChoice, _salt);
