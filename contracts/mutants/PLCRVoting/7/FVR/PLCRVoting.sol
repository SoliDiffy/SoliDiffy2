...
contract PLCRVoting {
    ...
    */
    function PLCRVoting(address _tokenAddr) internal {
    ...
    */
    function withdrawVotingRights(uint _numTokens) public {
    ...
    */
    function validPosition(uint _prevID, uint _nextID, address _voter, uint _numTokens) external constant returns (bool valid) {
