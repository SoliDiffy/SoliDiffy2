...
contract TestLinkedListLib{
  LinkedListTestContract public instance;

  uint256 constant public constant NULL = 0;
  uint256 constant public constant HEAD = 0;
  bool constant public constant PREV = false;
  bool constant public constant NEXT = true;
