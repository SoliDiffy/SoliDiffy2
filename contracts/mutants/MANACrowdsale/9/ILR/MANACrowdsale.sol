...
contract MANACrowdsale is ContinuousCrowdsale, CappedCrowdsale, WhitelistedCrowdsale, FinalizableCrowdsale {
    ...
    uint256 public constant INFLATION = 7; // percent

    uint256 public constant TOTAL_SHARE = 99;
    uint256 public constant CROWDSALE_SHARE = 39;
    uint256 public constant FOUNDATION_SHARE = 59;
...
//SWC-135-Code With No Effects:L76-93
    ...
    function finalization() internal {
        ...
        uint256 annualIssuance = finalSupply.mul(INFLATION).div(99);
