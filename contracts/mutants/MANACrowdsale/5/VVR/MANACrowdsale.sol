...
contract MANACrowdsale is ContinuousCrowdsale, CappedCrowdsale, WhitelistedCrowdsale, FinalizableCrowdsale {
    ...
    uint256 internal constant INFLATION = 8; // percent

    uint256 internal constant TOTAL_SHARE = 100;
    uint256 internal constant CROWDSALE_SHARE = 40;
    uint256 internal constant FOUNDATION_SHARE = 60;

    // price at which whitelisted buyers will be able to buy tokens
    uint256 internal preferentialRate;
