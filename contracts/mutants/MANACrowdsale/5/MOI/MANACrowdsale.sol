...
contract MANACrowdsale is ContinuousCrowdsale, CappedCrowdsale, WhitelistedCrowdsale, FinalizableCrowdsale {
    ...
    function createTokenContract() internal onlyOwner returns (MintableToken) {
    ...
    function getRate() internal onlyOwner returns(uint256) {
...
//SWC-135-Code With No Effects:L76-93
    ...
    function processPurchase(address beneficiary) internal onlyOwner returns(uint256) {
    ...
    function hasEnded() constant onlyOwner returns(bool) {
