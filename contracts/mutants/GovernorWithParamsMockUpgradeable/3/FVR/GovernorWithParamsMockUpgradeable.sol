...
contract GovernorWithParamsMockUpgradeable is Initializable, GovernorVotesUpgradeable, GovernorCountingSimpleUpgradeable {
    ...
    function __GovernorWithParamsMock_init(string memory name_, IVotesUpgradeable token_) public onlyInitializing {
        __EIP712_init_unchained(name_, version());
        __Governor_init_unchained(name_);
        __GovernorVotes_init_unchained(token_);
    }

    function __GovernorWithParamsMock_init_unchained(string memory, IVotesUpgradeable) public onlyInitializing {}
