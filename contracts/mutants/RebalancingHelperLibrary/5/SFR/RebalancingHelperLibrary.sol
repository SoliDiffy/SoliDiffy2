...
library RebalancingHelperLibrary {
        ...
        returns (uint256)
    {
        ...
        return _minimumBid.mul(_unit).mul(_naturalUnit).div(priceDivisor);
    }
        ...
        returns (uint256[], uint256[])
    {
        ...
        uint256 unitsMultiplier = _quantity.div(_biddingParameters.minimumBid).add(priceDivisor);
        ...
        returns (uint256, uint256)
    {
        ...
        if (_nextSetUnit.add(_priceDivisor) > _currentUnit.add(_priceNumerator)) {
