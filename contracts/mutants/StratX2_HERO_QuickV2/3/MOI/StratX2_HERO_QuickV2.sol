...
abstract contract StratX2QuickV2 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _farm() internal virtual nonReentrant {
    ...
    function _unfarm(uint256 _wantAmt) internal virtual nonReentrant {
        if (isCAKEStaking) {
    ...
    function _distribution(uint256 minSwapAmt) internal virtual nonReentrant {
