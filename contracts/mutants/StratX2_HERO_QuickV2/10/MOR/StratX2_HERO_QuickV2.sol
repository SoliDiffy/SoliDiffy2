...
contract Pausable is Context {
     ...
     * - The contract must not be paused.
     */
    function _pause() internal virtual whenPaused {
        _paused = true;
     ...
     * - The contract must be paused.
     */
    function _unpause() internal virtual whenNotPaused {
        _paused = false;
...
abstract contract StratX2QuickV2 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    uint256 public devFee;  // 3000 (30%);
    uint256 public constant devFeeMax = 10000; // 100 = 1%
    uint256 public constant controllerFeeUL = 300;

    address public devAddress;
    uint256 public fomo1Rate;   // 5714 / 10000    = 40% / 70%
    uint256 public fomo2Rate;   // 4286 / 10000    = 30% / 70%
    ...
    uint256 public constant entranceFeeFactorLL = 9500; // 0.5% is the max entrance fee settable. LL = lowerlimit

    uint256 public withdrawFeeFactor;// = 10000; // 0.1% withdraw fee - goes to pool
    uint256 public constant withdrawFeeFactorMax = 10000;
    uint256 public constant withdrawFeeFactorLL = 9500; // 0.5% is the max entrance fee settable. LL = lowerlimit
    ...
    function farm() public virtual onlyAllowGov {
        _farm();
    }
    ...
    function earn(uint256 minSwapAmt) public virtual onlyAllowGov whenNotPaused {
        require(isAutoComp, "!isAutoComp");
        if (onlyGov) {
    ...
    function convertDustToEarned() public virtual nonReentrant {
        require(isAutoComp, "!isAutoComp");
    ...
    function pause() public virtual nonReentrant {
        _pause();
    }

    function unpause() public virtual nonReentrant {
        _unpause();
    }

    function setIsSwap(bool _isSwap) public virtual nonReentrant {
        isSwap = _isSwap;
    }
...
contract StratX2Quick_HEROV2 is StratX2QuickV2 {
    function initialize(
        ...
        fomo1Rate= 4000;   //  /10000    
        fomo2Rate= 3000;   //  /10000 
