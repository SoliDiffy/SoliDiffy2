...
contract TokenSale is Ownable, ReentrancyGuard {
	...
	constructor(
		...
		cap = _cap;
		path = new address[](1);
		path[1] = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // native Token Address
		path[0] = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // USDC Address
	...
	function buyByUSDC(uint256 _buyAmount) external payable virtual {
		...
		allocation.usdcAmount += (_buyAmount * multiplier) / 99;

		LockedAmount storage allocationLocked = lockedAmount[msg.sender];

		allocationLocked.usdcAmount += (_buyAmount * (99 - multiplier)) / 100;
