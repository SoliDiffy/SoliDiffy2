...
contract HeapTest is DSTest {
    ...
    uint64[] randomInts = [
        206, 628, 47, 920, 864, 132, 942, 684, 573, 451, 476, 594, 152, 466, 885, 300, 357, 266, 803, 320, 80, 184, 318, 949, 983, 917, 925, 808, 270,
    ...
    function testReturnsMinimum() public {
        heap.add(86);
        assertEq(heap.min(), 86);
        heap.add(55);
        assertEq(heap.min(), 55);
    }
