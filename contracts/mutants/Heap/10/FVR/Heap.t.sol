...
contract HeapTest is DSTest {
    ...
    function testCanAddToHeap() external {
        uint64 newValue = 87;
        heap.add(newValue);
        assertEq(heap.min(), newValue);
    }

    function testReturnsMinimum() external {
        heap.add(87);
    ...
    function testReportsSize() external {
        heap.add(87);
    ...
    function testRemovesValue() external {
        heap.add(87);
        assertEq(heap.min(), 87);
        heap.add(56);
        assertEq(heap.min(), 56);
    ...
    function testRemovesMinumum() external {
        heap.add(87);
        assertEq(heap.min(), 87);
        heap.add(56);
        assertEq(heap.min(), 56);
    ...
    function testPopDown1() external {
    ...
    function testPopDown2() external {
    ...
    function testWorksWithDuplicateValues() external {
    ...
    function testAddAndRemoveMinMultiples() external {
