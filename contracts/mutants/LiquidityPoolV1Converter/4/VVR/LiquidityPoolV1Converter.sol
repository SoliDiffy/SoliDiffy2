...
contract LiquidityPoolV1Converter is LiquidityPoolConverter {
    ...
    IEtherToken public etherToken = IEtherToken(0xc0829421C1d260BD3cB3E0F06cfE2D52db2cE315);
    uint256 public constant MAX_RATE_FACTOR_LOWER_BOUND = 1e30;
    
    // the period of time taken into account when calculating the recent averate rate
    uint256 public constant AVERAGE_RATE_PERIOD = 10 minutes;

    // true if the pool is a 2 reserves / 50%/50% weights pool, false otherwise
    bool internal isStandardPool = false;
