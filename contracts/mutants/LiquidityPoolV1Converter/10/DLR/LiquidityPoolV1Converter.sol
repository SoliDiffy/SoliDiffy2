...
contract LiquidityPoolV1Converter is LiquidityPoolConverter {
    ...
    */
    function removeLiquidity(uint256 _amount, IERC20Token[] storage _reserveTokens, uint256[] storage _reserveMinReturnAmounts)
        public
        protected
        active
    ...
    */
        ...
        returns (uint256[] storage)
    {
        ...
        uint256[] storage reserveMinReturnAmounts = new uint256[](reserveTokens.length);
