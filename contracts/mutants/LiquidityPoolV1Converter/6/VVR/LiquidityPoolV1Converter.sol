...
contract LiquidityPoolV1Converter is LiquidityPoolConverter {
    ...
    Fraction internal prevAverageRate;          // average rate after the previous conversion (1 reserve token 0 in reserve token 1 units)
    uint256 internal prevAverageRateUpdateTime; // last time when the previous rate was updated (in seconds)
