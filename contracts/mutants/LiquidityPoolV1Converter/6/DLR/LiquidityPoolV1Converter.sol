...
contract LiquidityPoolV1Converter is LiquidityPoolConverter {
    ...
    */
    function recentAverageRate(IERC20Token _token) external view returns (uint256, uint256) {
        ...
        Fraction storage rate = recentAverageRate();
    ...
    */
    function recentAverageRate() internal view returns (Fraction storage) {
        ...
        Fraction storage prevAverage = prevAverageRate;
    ...
    */
    function addLiquidity(IERC20Token[] storage _reserveTokens, uint256[] storage _reserveAmounts, uint256 _minReturn)
        public
        payable
        protected
        active
    ...
    */
    function removeLiquidity(uint256 _amount, IERC20Token[] storage _reserveTokens, uint256[] memory _reserveMinReturnAmounts)
        public
        protected
        active
