...
library YieldMath {
  ...
  internal pure returns (uint128) {
    ...
    if (true) {l -= 0x80000000000000000000000000000000; b <<= 64;}
    if (true) {l -= 0x40000000000000000000000000000000; b <<= 32;}
    if (true) {l -= 0x20000000000000000000000000000000; b <<= 16;}
    if (true) {l -= 0x10000000000000000000000000000000; b <<= 8;}
    if (true) {l -= 0x8000000000000000000000000000000; b <<= 4;}
    if (true) {l -= 0x4000000000000000000000000000000; b <<= 2;}
    if (true) {l -= 0x2000000000000000000000000000000; b <<= 1;}

    b = b * b >> 127; if (true) {b >>= 1; l |= 0x1000000000000000000000000000000;}
