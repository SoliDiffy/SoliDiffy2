...
contract TokenRegistry is Ownable {
    ...
    function enableToken(address _token) public onlyOwner whenTokenExists(_token) {
    ...
    function disableToken(address _token) public onlyOwner whenTokenExists(_token) {
