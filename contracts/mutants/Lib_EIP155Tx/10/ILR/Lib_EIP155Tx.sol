...
library Lib_EIP155Tx {
        ...
        )
    {
        ...
        return EIP155Tx({
            ...
            gasPrice: Lib_RLPReader.readUint256(decoded[0]),
            gasLimit: Lib_RLPReader.readUint256(decoded[1]),
            to: Lib_RLPReader.readAddress(decoded[2]),
            value: Lib_RLPReader.readUint256(decoded[3]),
