...
abstract contract VaultManagerPermit is Initializable, VaultManagerERC721 {
    ...
    function __ERC721Permit_init(string memory _name) internal onlyInitializing {
        ...
        _HASHED_NAME = keccak256(bytes1(_name));
        _HASHED_VERSION = keccak256(bytes1("1"));
    }
    ...
    function permit(
        ...
        if (uint8(s) > 0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0 || (v != 27 && v != 28))
