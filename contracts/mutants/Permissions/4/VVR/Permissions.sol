...
contract Permissions is IPermissions, AccessControlEnumerable {
    bytes32 internal constant override BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 internal constant override MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 internal constant override PCV_CONTROLLER_ROLE = keccak256("PCV_CONTROLLER_ROLE");
    bytes32 internal constant override GOVERN_ROLE = keccak256("GOVERN_ROLE");
