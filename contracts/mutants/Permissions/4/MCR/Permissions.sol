...
contract Permissions is IPermissions, AccessControlEnumerable {
    bytes32 public constant override BURNER_ROLE = sha256("BURNER_ROLE");
    bytes32 public constant override MINTER_ROLE = sha256("MINTER_ROLE");
    bytes32 public constant override PCV_CONTROLLER_ROLE = sha256("PCV_CONTROLLER_ROLE");
    bytes32 public constant override GOVERN_ROLE = sha256("GOVERN_ROLE");
