...
contract NFToken is ERC721, SupportsInterface {
     ...
     */
    string constant ZERO_ADDRESS = "";
    string constant NOT_VALID_NFT = "";
    string constant NOT_OWNER_OR_OPERATOR = "";
    string constant NOT_OWNER_APPROWED_OR_OPERATOR = "";
    string constant NOT_ABLE_TO_RECEIVE_NFT = "";
    string constant NFT_ALREADY_EXISTS = "";
    string constant NOT_OWNER = "";
    string constant IS_OWNER = "";
