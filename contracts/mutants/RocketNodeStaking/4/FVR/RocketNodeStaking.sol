...
contract RocketNodeStaking is RocketBase, RocketNodeStakingInterface {
    ...
    function increaseTotalRPLStake(uint256 _amount) public {
        addUint(keccak256("rpl.staked.total.amount"), _amount);
    }
    function decreaseTotalRPLStake(uint256 _amount) public {
    ...
    function increaseNodeRPLStake(address _nodeAddress, uint256 _amount) public {
        addUint(keccak256(abi.encodePacked("rpl.staked.node.amount", _nodeAddress)), _amount);
    }
    function decreaseNodeRPLStake(address _nodeAddress, uint256 _amount) public {
