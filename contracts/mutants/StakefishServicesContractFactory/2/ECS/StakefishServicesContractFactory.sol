...
contract StakefishServicesContractFactory is ProxyFactory, IStakefishServicesContractFactory {
    ...
    {
        require(uint8(commissionRate) <= COMMISSION_RATE_SCALE, "Commission rate exceeds scale");
    ...
    function changeCommissionRate(uint24 newCommissionRate)
        ...
        onlyOperator
    {
        require(uint8(newCommissionRate) <= COMMISSION_RATE_SCALE, "Commission rate exceeds scale");
