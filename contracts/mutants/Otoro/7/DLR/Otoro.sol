    ...
    RequestSigning
{
    ...
    constructor(
        ...
        uint256 _maxSupply,
        uint256 _startPrice,
        string storage _defaultURI,
        ChainLinkParams storage chainLinkParams,
        RevenueShareParams storage revenueShare
    )
    ...
    function airdrop(address[] storage addresses, uint256 amount)
        external
        nonReentrant
        onlyOperator
    {
