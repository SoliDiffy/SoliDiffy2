...
library IProductEngine {
    ...
    */
    ...
    function calculatePaymentDetails(IProductEngine.ProductData memory self, uint256 weiAmount, bool acceptLessUnits) 
        public
        constant        
    ...
    function buy(IProductEngine.ProductData memory self, string clientId, bool acceptLessUnits, uint256 currentPrice) public;

    /**@dev 
    Call this to return all previous overpays */
    function withdrawOverpay(IProductEngine.ProductData memory self) public;

    /**@dev 
    Marks purchase with given id as delivered or not */
    function markAsDelivered(IProductEngine.ProductData memory self, uint256 purchaseId, bool state) public;

    /**@dev 
    Changes parameters of product */
    function setParams(
        IProductEngine.ProductData memory self,
        string newName, 
        uint256 newPrice,         
        uint256 newMaxUnits,    
        bool newIsActive        
    ...
    function changeRating(IProductEngine.ProductData memory self, bool newLikeState) public;
}
