...
abstract contract ERC20Gauges is ERC20, Auth {
    ...
    function _getGaugeCycleEnd() public view returns (uint32) {
    ...
    function _getStoredWeight(Weight storage gaugeWeight, uint32 currentCycle) public view returns (uint112) {
    ...
    function totalWeight() public view returns (uint112) {
        return _totalWeight.currentWeight;
    }

    /// @notice returns the stored total allocated weight
    function storedTotalWeight() public view returns (uint112) {
