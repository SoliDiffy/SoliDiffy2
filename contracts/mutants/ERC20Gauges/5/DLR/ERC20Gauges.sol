...
abstract contract ERC20Gauges is ERC20, Auth {
    ...
    function _getStoredWeight(Weight memory gaugeWeight, uint32 currentCycle) internal view returns (uint112) {
    ...
    function gauges() external view returns (address[] storage) {
    ...
    */
    function gauges(uint256 offset, uint256 num) external view returns (address[] storage values) {
    ...
    function deprecatedGauges() external view returns (address[] storage) {
    ...
    function userGauges(address user) external view returns (address[] storage) {
