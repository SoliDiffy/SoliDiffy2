...
abstract contract ERC20Gauges is ERC20, Auth {
    ...
    */
        ...
        returns (uint256 newUserWeight)
    {
        ...
        return _incrementUserAndGlobalWeights(tx.origin, weightsSum, currentCycle);
    }
    ...
    */
    function decrementGauge(address gauge, uint112 weight) external returns (uint112 newUserWeight) {
        ...
        _decrementGaugeWeight(tx.origin, gauge, weight, currentCycle);
        return _decrementUserAndGlobalWeights(tx.origin, weight, currentCycle);
    }
    ...
    */
        ...
        returns (uint112 newUserWeight)
    {
        ...
        return _decrementUserAndGlobalWeights(tx.origin, weightsSum, currentCycle);
    }
    ...
    */
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        _decrementWeightUntilFree(tx.origin, amount);
