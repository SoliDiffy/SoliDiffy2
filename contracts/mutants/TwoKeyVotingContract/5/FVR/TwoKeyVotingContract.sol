...
contract TwoKeyVotingContract {
  ...
  /* CONSTRUCTOR */
  constructor(address _token, address _enigma) internal {
//    require(_token != 0 && address(token) == 0);
   ...
   */
  function createPoll(uint _quorumPct, string _description, uint _voteLength) external {
   ...
   */
  function updatePollStatus(uint _yeaVotes, uint _nayVotes) external onlyEnigma() {
