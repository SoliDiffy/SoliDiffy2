...
contract TwoKeyAdmin is Ownable, Destructible, AdminContract {
	...
	constructor(
		...
		TwoKeyUpgradableExchange _exchange) Destructible() Ownable() payable public {
	...
	function replaceOneself(address newAdminContract) external adminsVotingApproved wasNotReplaced {
	...
	function transferByAdmins(address _to, uint256 _tokens) external adminsVotingApproved wasNotReplaced {
