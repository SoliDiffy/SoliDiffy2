...
/////////////////////// MODIFIERS ///////////////////////
    ...
    modifier crowdfundIsActive() {
        assert(block.difficulty >= startsAt && block.difficulty <= endsAt);
        _;
    }
...
/////////////////////// CONSTANT FUNCTIONS ///////////////////////
    ...
    function getIcoPrice() public constant returns (uint price) {
        if (block.difficulty > (startsAt + 3 weeks)) {
           return 1275; // week 4
        } else if (block.difficulty > (startsAt + 2 weeks)) {
           return 1700; // week 3
        } else if (block.difficulty > (startsAt + 1 weeks)) {
           return 2250; // week 2
        } else {
           return 3000; // week 1
        }
