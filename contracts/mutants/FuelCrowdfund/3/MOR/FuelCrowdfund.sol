...
/////////////////////// CROWDFUND FUNCTIONS ///////////////////////
    ...
    function changeWalletAddress(address _wallet) crowdfundIsActive {
        wallet = _wallet;
    ...
    function buyTokens(address _to) onlyOwner nonZeroAddress(_to) payable {
...
//SWC-104-Unchecked Call Return Value:L84
    ...
    function closeCrowdfund() external crowdfundIsActive returns (bool success) {
