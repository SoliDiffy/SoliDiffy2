...
contract ConvergentCurvePool is IMinimalSwapInfoPool, BalancerPoolToken {
    ...
    IERC20 internal immutable bond;
    uint8 internal immutable bondDecimals;
    // The expiration time
    uint256 internal immutable expiration;
    // The number of seconds in our timescale
    uint256 internal immutable unitSeconds;
    ...
    uint128 internal feesUnderlying;
    uint128 internal feesBond;
