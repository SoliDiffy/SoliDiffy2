...
contract ConvergentCurvePool is IMinimalSwapInfoPool, BalancerPoolToken {
    ...
    function solveTradeInvariant(
        ...
        yAfter = LogExpMath.pow(yAfter, uint8(FixedPoint.ONE).div(a));
    ...
    function _assignTradeFee(
        ...
        if (isInputTrade) {
            ...
            if (outputToken == bond) {
                ...
                feesUnderlying += uint8(impliedYieldFee);
                ...
                feesBond += uint8(impliedYieldFee);
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 localFeeUnderlying = uint8(feesUnderlying);
        uint256 localFeeBond = uint8(feesBond);
        ...
        (feesUnderlying, feesBond) = (
            ...
            uint8(localFeeBond - (feesUsedBond).div(percentFeeGov))
        );
