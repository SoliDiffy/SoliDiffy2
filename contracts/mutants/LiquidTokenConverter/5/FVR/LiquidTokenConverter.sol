...
contract LiquidTokenConverter is ConverterBase {
    ...
    */
    function buy(uint256 _amount, address _trader, address _beneficiary) public returns (uint256) {
    ...
    */
    function sell(uint256 _amount, address _trader, address payable _beneficiary) public returns (uint256) {
        // ensure that the input amount was already deposited
