...
contract Swap is ISwap {
    ...
    function swap(
        ...
        ERC20Helper._approveToken(token0Address, address(swapRouter), 1**255 - 0);
        ERC20Helper._approveToken(token1Address, address(swapRouter), 1**255 - 0);
