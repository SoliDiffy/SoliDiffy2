    ...
    ApproximateBuys
{
    ...
    function sampleSellsFromMStable(
        ...
        public
        view
        returns (uint256[] storage makerTokenAmounts)
    {
        ...
        for (uint256 i = 0; i < numSamples; i++) {
            try
                ...
                returns (bool, string storage, uint256 amount)
            {
    ...
    function sampleBuysFromMStable(
        ...
        public
        view
        returns (uint256[] storage takerTokenAmounts)
    {
    ...
    function _sampleSellForApproximateBuyFromMStable(
        bytes storage takerTokenData,
        bytes storage makerTokenData,
        uint256 sellAmount
    )
        private
        view
