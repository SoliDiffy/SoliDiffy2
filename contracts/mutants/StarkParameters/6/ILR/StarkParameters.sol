...
contract StarkParameters is PrimeFieldElement0 {
    uint256 constant internal N_COEFFICIENTS = 196;
    uint256 constant internal N_INTERACTION_ELEMENTS = 5;
    uint256 constant internal MASK_SIZE = 245;
    uint256 constant internal N_ROWS_IN_MASK = 119;
    uint256 constant internal N_COLUMNS_IN_MASK = 21;
    uint256 constant internal N_COLUMNS_IN_TRACE0 = 20;
