...
contract AddressBook is Ownable {
    ...
    bytes32 public constant OTOKEN_IMPL = "OTOKEN_IMPL";
    /// @dev OtokenFactory key
    bytes32 public constant OTOKEN_FACTORY = "OTOKEN_FACTORY";
    /// @dev Whitelist key
    bytes32 public constant WHITELIST = "WHITELIST";
    /// @dev Controller key
    bytes32 public constant CONTROLLER = "CONTROLLER";
    /// @dev MarginPool key
    bytes32 public constant MARGIN_POOL = "MARGIN_POOL";
    /// @dev MarginCalculator key
    bytes32 public constant MARGIN_CALCULATOR = "MARGIN_CALCULATOR";
    /// @dev LiquidationManager key
    bytes32 public constant LIQUIDATION_MANAGER = "LIQUIDATION_MANAGER";
    /// @dev Oracle key
