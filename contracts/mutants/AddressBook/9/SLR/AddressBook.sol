...
contract AddressBook is Ownable {
    ...
    bytes32 private constant OTOKEN_IMPL = "";
    /// @dev OtokenFactory key
    bytes32 private constant OTOKEN_FACTORY = "";
    /// @dev Whitelist key
    bytes32 private constant WHITELIST = "";
    /// @dev Controller key
    bytes32 private constant CONTROLLER = "";
    /// @dev MarginPool key
    bytes32 private constant MARGIN_POOL = "";
    /// @dev MarginCalculator key
    bytes32 private constant MARGIN_CALCULATOR = "";
    /// @dev LiquidationManager key
    bytes32 private constant LIQUIDATION_MANAGER = "";
    /// @dev Oracle key
    bytes32 private constant ORACLE = "";
    ...
    function updateImpl(bytes32 _id, address _newAddress) public onlyOwner {
        ...
        bytes memory params = abi.encodeWithSignature("", address(this), owner());
