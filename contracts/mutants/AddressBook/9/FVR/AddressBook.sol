...
contract AddressBook is Ownable {
     ...
     */
    function getOtokenFactory() public view returns (address) {
     ...
     */
    function getMarginPool() public view returns (address) {
     ...
     */
    function getMarginCalculator() public view returns (address) {
     ...
     */
    function setOtokenImpl(address _otokenImpl) public onlyOwner {
