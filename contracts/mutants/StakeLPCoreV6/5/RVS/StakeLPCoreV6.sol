...
contract StakeLPCoreV6 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
     ...
     */
    function calculatePendingRewardsAndLiquidity(address holderAddress, address lpToken, address to) public view returns (uint256 updatedSupplyLPTimeshare, uint256 liquidity, uint256 reward){
     ...
     * @param valueDivisor: coming as an argument for further calculations
     */
    function _calculateRewardsAndLiquidity(address holderAddress, address lpToken, address to) internal returns (uint256 reward, uint256 liquidity){
     ...
     */
    function calculateRewardsAndLiquidity(address whitelistedAddress, uint256 amount) public whenNotPaused returns (uint256 reward, uint256 liquidity){
    ...
    function addLiquidity(
        ...
        uint256 amount
    ) public virtual override whenNotPaused returns (uint256 rewards, uint256 liquidity) {
        // check for validity of arguments
