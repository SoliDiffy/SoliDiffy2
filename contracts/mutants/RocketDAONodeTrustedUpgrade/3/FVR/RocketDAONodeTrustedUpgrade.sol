...
contract RocketDAONodeTrustedUpgrade is RocketBase, RocketDAONodeTrustedUpgradeInterface {
    ...
    function _upgradeContract(string memory _name, address _contractAddress, string memory _contractAbi) public {
    ...
    function _addContract(string memory _name, address _contractAddress, string memory _contractAbi) public {
        // Check contract name
        bytes32 nameHash = keccak256(abi.encodePacked(_name));
    ...
    function _upgradeABI(string memory _name, string memory _contractAbi) public {
        // Check ABI exists
        string memory existingAbi = getString(keccak256(abi.encodePacked("contract.abi", _name)));
