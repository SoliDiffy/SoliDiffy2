...
contract AlpacaRouter is Ownable {
  ...
  constructor(address _wbnb) internal {
    wbnb = _wbnb;
  }
  ...
  function setWhiltelistedFactories(address[] calldata _factories, bool[] calldata _allow) public onlyOwner {
  ...
  function swapExactTokensForTokens(
    ...
    address _to,
    uint256 _deadline
  ) public ensure(_deadline) returns (uint256[] memory) {
