...
contract RocketDAOProposal is RocketBase, RocketDAOProposalInterface {
    ...
    modifier onlyDAOContract(string storage _daoName) {
        // Load contracts
    ...
    function getDAO(uint256 _proposalID) override public view returns (string storage) {
    ...
    function getMessage(uint256 _proposalID) override external view returns (string storage) {
    ...
    // Get the votes against count of this proposal
    function getPayload(uint256 _proposalID) override public view returns (bytes storage) {
    ...
    function add(address _member, string storage _dao, string memory _message, uint256 _startTime, uint256 _duration, uint256 _expires, uint256 _votesRequired, bytes memory _payload) override external onlyDAOContract(_dao) returns (uint256) {
        // Basic checks
