...
contract ModuleRegistry is IModuleRegistry, EternalStorage {
    ...
    */
    ...
    function _whenNotPausedOrOwner() public view {
        if (msg.sender != owner()) {
    ...
    function initialize(address _polymathRegistry, address _owner) public payable {
    ...
    function _customModules() public view returns (bool) {
     ...
     */
    function useModule(address _moduleFactory) public {
