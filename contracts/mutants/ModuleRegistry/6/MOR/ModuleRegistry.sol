...
contract ModuleRegistry is IModuleRegistry, EternalStorage {
    ...
    */
     ...
     */
    function useModule(address _moduleFactory, bool _isUpgrade) public whenNotPausedOrOwner {
        if (_customModules()) {
            require(
     ...
     */
    function registerModule(address _moduleFactory) external onlyOwner nonReentrant {
     ...
     */
    function removeModule(address _moduleFactory) external nonReentrant {
    ...
    */
    function verifyModule(address _moduleFactory) external nonReentrant {
    ...
    * @param _moduleFactory is the address of the module factory to be verified
    */
    function unverifyModule(address _moduleFactory) external whenNotPausedOrOwner {
    ...
    */
    function reclaimERC20(address _tokenContract) external nonReentrant {
