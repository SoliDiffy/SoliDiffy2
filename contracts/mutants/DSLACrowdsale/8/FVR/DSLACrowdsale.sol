...
contract DSLACrowdsale is VestedCrowdsale, Whitelist, Pausable, PullPayment {
    ...
    /**
      ...
      */
    constructor(address wallet, DSLA token) internal {
    ...
    /**
      ...
      */
    function goToNextRound() external onlyOwner returns(bool) {
    ...
    /**
      ...
      * @return True bool
      */
    function closeRefunding() external returns(bool) {
        require(isRefunding);
    ...
    /**
      ...
      * @return True bool
      */
    function closeCrowdsale() external onlyOwner returns(bool) {
    ...
    /**
      ...
      * @return True bool
      */
    function finalizeCrowdsale() external onlyOwner returns(bool) {
