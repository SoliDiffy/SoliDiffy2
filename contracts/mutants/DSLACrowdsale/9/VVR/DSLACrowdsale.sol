...
contract DSLACrowdsale is VestedCrowdsale, Whitelist, Pausable, PullPayment {
    ...
    uint256 internal constant TOKENSFORSALE = 5000000000000000000000000000;
    // Current ico round
    uint256 internal currentIcoRound;
    // Distributed Tokens
    uint256 internal distributedTokens;
    // Amount of wei raised from other currencies
    uint256 internal weiRaisedFromOtherCurrencies;
    // Refund period on
    bool internal isRefunding = false;
