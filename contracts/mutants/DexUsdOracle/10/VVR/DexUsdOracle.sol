...
contract DexUSDOracle is IUSDOracle, Initializable, OwnableUpgradeable {
  ...
  IUSDOracle internal baseOracle;
  address internal token0;
  address internal token1;

  uint    internal price0CumulativeLast1Period;
  uint    internal price1CumulativeLast1Period;
  uint32  internal blockTimestampLast1Period;
  FixedPoint.uq112x112 internal price0Average1Period;
  FixedPoint.uq112x112 internal price1Average1Period;
