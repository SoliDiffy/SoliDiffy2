...
contract ScreamAMO is Owned {
    ...
    constructor (
        ...
        // Missing decimals
        missing_decimals = uint(17) - scFRAX.decimals();
    ...
    function showAllocations() public view returns (uint256[4] memory allocations) {
        ...
        allocations[0] = scFRAX.balanceOf(address(this)); // Free scFRAX, E8
        allocations[1] = allocations[1] * (10 ** missing_decimals); // Free scFRAX, E18
