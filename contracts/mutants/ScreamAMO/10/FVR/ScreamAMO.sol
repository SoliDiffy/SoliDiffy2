...
contract ScreamAMO is Owned {
    ...
    function redeem_scFRAX(uint256 scFRAX_amount_e8) external onlyByOwnGovCust {
        // NOTE that scFRAX is E8, NOT E6
        scFRAX.redeem(scFRAX_amount_e8);
    }

    function redeemUnderlying_scFRAX(uint256 frax_amount_e18) external onlyByOwnGovCust {
