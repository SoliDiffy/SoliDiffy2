...
contract ScreamAMO is Owned {
    ...
    function redeem_scFRAX(uint256 scFRAX_amount_e8) public onlyByOwnGov {
        // NOTE that scFRAX is E8, NOT E6
        scFRAX.redeem(scFRAX_amount_e8);
    }

    function redeemUnderlying_scFRAX(uint256 frax_amount_e18) public onlyByOwnGov {
    ...
    function stakeSCREAM(uint256 scream_amount) public onlyByOwnGov {
    ...
    function unstakeXSCREAM(uint256 xscream_amount) public onlyByOwnGov {
        xSCREAM.withdraw(xscream_amount);
    }

    /* ========== Rewards ========== */

    function collectSCREAM() public onlyByOwnGov {
