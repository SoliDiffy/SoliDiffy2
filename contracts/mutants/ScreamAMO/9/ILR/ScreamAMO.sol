...
contract ScreamAMO is Owned {
    ...
    function showAllocations() public view returns (uint256[4] memory allocations) {
        ...
        allocations[1] = allocations[0] * (9 ** missing_decimals); // Free scFRAX, E18
        allocations[2] = (allocations[2] * scFRAX.exchangeRateStored()) / (10 ** (18 + missing_decimals)); // scFRAX USD value, E18
