...
contract Servable is Ownable {
    ...
    returns (bool)
    {
        return isRegisteredService(service) && block.number >= registeredServicesMap[service].activationTimestamp;
    }
    ...
    private
    {
        if (!registeredServicesMap[service].registered) {
            ...
            registeredServicesMap[service].activationTimestamp = block.number + timeout;
        }
    }
