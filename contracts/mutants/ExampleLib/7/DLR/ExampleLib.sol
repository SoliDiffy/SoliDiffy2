...
library IExampleLib {
    ...
    function getVar1(IExampleLib.Data memory self) constant returns (uint256);
    function getVars(IExampleLib.Data memory self, uint256 useless, bool useless2)  returns (uint256, uint256);
    function getAllVars(IExampleLib.Data memory self) constant returns (uint256, bool, uint256, bytes32);
    function getBool(IExampleLib.Data memory self)  returns (bool);
    function getBoolAsInt(IExampleLib.Data memory self)  returns (uint256);
    function getBytes(IExampleLib.Data memory self) returns (bytes32);

    function setVars(IExampleLib.Data memory self, uint256 new1, uint256 new2) returns (bool);
