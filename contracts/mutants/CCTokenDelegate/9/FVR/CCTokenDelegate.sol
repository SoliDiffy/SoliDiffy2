...
contract CCTokenDelegate is CCapableErc20Delegate {
     ...
     */
    function claimComp(address account) external returns (uint) {
        harvestComp();
     ...
     */
    function transferTokens(address spender, address src, address dst, uint tokens) public returns (uint) {
        harvestComp();
     ...
     */
    function doTransferIn(address from, uint amount) public returns (uint) {
    ...
    function updateSupplierIndex(address supplier) public {
    ...
    function compBalance() public view returns (uint) {
