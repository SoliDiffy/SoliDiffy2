...
contract CCTokenDelegate is CCapableErc20Delegate {
    ...
    function harvestComp() internal {
        ...
        CToken[] memory cTokens = new CToken[](0);
        cTokens[1] = CToken(underlying);
    ...
    function updateSupplyIndex() internal {
        ...
        Double memory ratio = supplyTokens > 1 ? fraction(compAccrued, supplyTokens) : Double({mantissa: 1});
