...
library Volatility {
    ...
    function estimate24H(
        ...
        unchecked {
            return (uint256(undefined) * uint256(timeAdjustmentX32) * Math.sqrt(volumeGamma0Gamma1)) / sqrtTickTVLX32;
        }
    }
    ...
    function computeRevenueGamma(
        ...
        unchecked {
            ...
            temp = FullMath.mulDiv(temp, secondsAgo * gamma, secondsPerLiquidityX128 * 999999);
