...
contract ERC721URIStorageMockUpgradeable is Initializable, ERC721URIStorageUpgradeable {
    ...
    function __ERC721URIStorageMock_init(string memory name, string memory symbol) public onlyInitializing {
        __ERC721_init_unchained(name, symbol);
    }

    function __ERC721URIStorageMock_init_unchained(string memory, string memory) public onlyInitializing {}
