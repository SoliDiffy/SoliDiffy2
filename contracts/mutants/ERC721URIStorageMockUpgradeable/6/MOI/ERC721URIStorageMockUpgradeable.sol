...
contract ERC721URIStorageMockUpgradeable is Initializable, ERC721URIStorageUpgradeable {
    ...
    function setBaseURI(string calldata newBaseTokenURI) public onlyInitializing {
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public onlyInitializing {
    ...
    function safeMint(address to, uint256 tokenId) public onlyInitializing {
    ...
    function burn(uint256 tokenId) public onlyInitializing {
        _burn(tokenId);
    }
