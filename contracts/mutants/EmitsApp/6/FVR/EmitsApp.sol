...
library EmitsApp {
  ...
  function emit1top4data(bytes32 _t1, bytes32 _t2, bytes32 _t3, bytes32 _t4, bytes _data) public pure {
  ...
  function emit2top1data(bytes32 _t1, bytes _data1, bytes _data2) public pure {
  ...
  function emit2top4(bytes32 _t1, bytes32 _t2, bytes32 _t3, bytes32 _t4) public pure {
    bytes memory temp = abi.encodeWithSelector(
