...
contract PandoPot is Ownable, ReentrancyGuard, Pausable {
    ...
    address internal PSR;

    uint256 internal constant PRECISION = 10000000000;
    uint256 internal constant unlockPeriod = 2 * 365 * 1 days;
    uint256 internal timeBomb = 2 * 30 * 1 days;
    uint256 internal rewardExpireTime = 14 * 1 days;
    uint256 internal megaPrizePercentage = 25;
    uint256 internal minorPrizePercentage = 1;
    uint256 internal lastDistribute;
