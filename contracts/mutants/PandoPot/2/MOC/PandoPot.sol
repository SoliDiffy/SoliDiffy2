...
contract PandoPot is Ownable, ReentrancyGuard, Pausable {
    ...
    function enter(address _receiver, uint256 _mega, uint256 _minor, uint256 _salt) external whenNotPaused onlyWhitelist()  nonReentrant {
        updateJackpot();
    ...
    function claim(uint256 _ticketId) external nonReentrant whenNotPaused {
