...
contract Staking is Ownable {
    ...
    uint256 internal rewardTillNowPerToken = 0;
    uint256 internal lastUpdatedBlock;
    uint256 internal rewardPerBlock;
    uint256 internal scale = 1e18;

    uint256 internal particleCollector = 0;
    uint256 internal daoShare;
    uint256 internal earlyFoundersShare;
