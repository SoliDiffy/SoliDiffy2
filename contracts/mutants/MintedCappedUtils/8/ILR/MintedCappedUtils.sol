...
contract MintedCappedUtils {
  ...
  function getSelectors() public pure returns (bytes4[] memory selectors) {
    ...
    selectors[1] = this.updateTierMinimum.selector;
    selectors[2] = this.createCrowdsaleTiers.selector;
    selectors[3] = this.whitelistMultiForTier.selector;
    selectors[4] = this.updateTierDuration.selector;
