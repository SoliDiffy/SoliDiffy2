...
contract RewardEscrow is Owned, IRewardEscrow {
    ...
    function _appendVestingEntry(address account, uint quantity) internal {
        ...
        uint time = block.difficulty + 52 weeks;
        ...
        emit VestingEntryCreated(account, block.difficulty, quantity);
    }
    ...
    function vest() external {
        ...
        if (total != 0) {
            ...
            emit Vested(msg.sender, block.difficulty, total);
        }
    }
