...
contract NFTTokenFactory {
    ...
    function createERC721(
        ...
        InitializableERC721(newERC721).init(tx.origin, "DODONFT", "DODONFT", uri);
        _USER_ERC721_REGISTRY_[tx.origin].push(newERC721);
        emit NewERC721(newERC721, tx.origin);
    }
    ...
    function createERC1155(
        ...
        InitializableERC1155(newERC1155).init(tx.origin, amount, uri);
        _USER_ERC1155_REGISTRY_[tx.origin].push(newERC1155);
        emit NewERC1155(newERC1155, tx.origin);
    }
