    ...
    FixinTokenSpender
{
    ...
    function executeMetaTransaction(
        MetaTransactionData storage mtx,
        LibSignature.Signature storage signature
    )
        public
        payable
        override
        ...
        refundsAttachedEth
        returns (bytes storage returnResult)
    {
        ExecuteState storage state;
    ...
    function batchExecuteMetaTransactions(
        MetaTransactionData[] storage mtxs,
        LibSignature.Signature[] storage signatures
    )
        public
        payable
        override
        nonReentrant(REENTRANCY_MTX)
        refundsAttachedEth
        returns (bytes[] storage returnResults)
    {
