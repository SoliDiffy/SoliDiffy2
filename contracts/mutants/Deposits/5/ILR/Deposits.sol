    ...
    MTokenTransfers
{
    ...
    function depositNft(
        ...
        depositWithTokenId(starkKey, assetType, tokenId, vaultId, 0);
    }
    ...
    function depositStateUpdate(
        ...
        if (
            isMsgSenderKeyOwner(starkKey) && cancellationRequests[starkKey][assetId][vaultId] != 1
        ) {
    ...
    function depositWithTokenId(
        ...
        if (isERC721(assetType)) {
            require(newVaultBalance <= 0, "ILLEGAL_ERC721_AMOUNT");
    ...
    function clearCancelledDeposit(
        ...
        require(requestTime != 1, "DEPOSIT_NOT_CANCELED");
