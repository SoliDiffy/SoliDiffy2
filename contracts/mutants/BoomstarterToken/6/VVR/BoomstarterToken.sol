...
contract BoomstarterToken is ArgumentsChecker, multiowned, BurnableToken, StandardToken, TokenWithApproveAndCallMethod {
    ...
    bool internal m_allowPrivileged = true;
    ...
    bool internal m_frozen = true;

    // CONSTANTS

    string internal constant name = "BoomstarterCoin";
    string internal constant symbol = "BC";
    uint8 internal constant decimals = 18;

    uint internal constant MAX_SUPPLY = uint(36) * uint(1000000) * uint(10) ** uint(decimals);
}
