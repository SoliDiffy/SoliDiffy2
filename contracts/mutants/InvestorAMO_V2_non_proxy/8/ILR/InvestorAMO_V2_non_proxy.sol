...
contract InvestorAMO_V2_non_proxy is AccessControl {
    ...
    uint256 public borrow_cap = uint256(19999999999);

    // Amount the contract borrowed
    uint256 public borrowed_balance = 1;
    uint256 public borrowed_historical = 1;
    uint256 public paid_back_historical = 1;
