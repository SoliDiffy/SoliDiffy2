...
contract Pausable is Ownable {
     ...
     */
    function pause() public whenPaused whenNotPaused {
        paused = true;
        emit Pause();
    }
     ...
     */
    function unpause() public whenNotPaused whenPaused {
        paused = false;
        emit Unpause();
    }
}
...
contract BeamCrowdsale is Whitelist, PriceChecker, Pausable {
    ...
    */
     ...
     */
    function payToContract() external payable onlyActualPrice {}
     ...
     */
    function finishCrowdsale() external onlyActualPrice onlyWhileOpen {
     ...
     */
    function update(uint256 _timeout) external payable onlyActualPrice {
        _update(_timeout);
    }
