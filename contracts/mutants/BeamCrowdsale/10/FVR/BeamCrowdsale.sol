...
contract UsingOraclize {
    ...
    function oraclize_cbAddress() public oraclizeAPI returns (address){
        return oraclize.cbAddress();
    }

    function oraclize_setProof(byte proofP) public oraclizeAPI  {
    ...
    function oraclize_setNetworkName(string _network_name) public {
