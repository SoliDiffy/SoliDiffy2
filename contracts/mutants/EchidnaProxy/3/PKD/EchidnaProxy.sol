...
contract EchidnaProxy {
    ...
    // Borrower Operations
    function openTrovePrx(uint _ETH, uint _LUSDAmount, address _hint) external  {
        borrowerOperations.openTrove{value: _ETH}(_LUSDAmount, _hint);
    }

    function addCollPrx(uint _ETH, address _hint) external  {
    ...
    function adjustTrovePrx(uint _ETH, uint _collWithdrawal, uint _debtChange, bool _isDebtIncrease, address _hint) external  {
