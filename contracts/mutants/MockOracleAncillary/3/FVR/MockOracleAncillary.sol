...
contract MockOracleAncillary is OracleAncillaryInterface, Testable {
    ...
    constructor(address _finderAddress, address _timerAddress) internal Testable(_timerAddress) {
    ...
    function getPendingQueries() public view returns (QueryPoint[] memory) {
