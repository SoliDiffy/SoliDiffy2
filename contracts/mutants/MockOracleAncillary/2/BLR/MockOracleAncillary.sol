...
contract MockOracleAncillary is OracleAncillaryInterface, Testable {
    ...
    function requestPrice(
        ...
        if (!lookup.isAvailable && !queryIndices[identifier][time][ancillaryData].isValid) {
            ...
            queryIndices[identifier][time][ancillaryData] = QueryIndex(false, requestedPrices.length);
    ...
    function pushPrice(
        ...
        verifiedPrices[identifier][time][ancillaryData] = Price(false, price, getCurrentTime());
