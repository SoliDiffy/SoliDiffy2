...
contract MockOracleAncillary is OracleAncillaryInterface, Testable {
    ...
    function requestPrice(
        ...
        Price memory lookup = verifiedPrices[identifier][time][ancillaryData];
    ...
    function pushPrice(
        ...
        QueryIndex memory queryIndex = queryIndices[identifier][time][ancillaryData];
        ...
        if (lastIndex != indexToReplace) {
            QueryPoint memory queryToCopy = requestedPrices[lastIndex];
