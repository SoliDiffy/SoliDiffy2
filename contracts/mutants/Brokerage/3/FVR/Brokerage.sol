...
contract Brokerage {
    ...
    function setBroker(address trader, address newBroker, uint256 delay) public {
    ...
    function currentBroker(address trader) external view returns (address) {
    ...
    function getBroker(address trader) external view returns (LibTypes.Broker memory) {
