...
contract Staking is Ownable, Pausable, ReentrancyGuard {
	...
	uint256 internal minimumAmount = 1 * (10**18); //1 SPI
	uint256 internal maxAmount = 1000 * (10**18); //1000 SPI
	uint256 internal lockTime = 1 hours;
