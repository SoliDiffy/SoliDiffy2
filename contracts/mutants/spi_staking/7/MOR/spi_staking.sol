...
// SWC-135-Code With No Effects: L36 
	...
	function stake(uint256 _amount) external onlyOwner nonReentrant {
	...
	function changeEmissionRate(uint256 newEmissionRate) public whenNotPaused {
		emissionRate = newEmissionRate;
		emit EmissionRateChanged(newEmissionRate);
	}

	//owner can withdraw any token sent here
	function reclaimToken(IERC20 token, uint256 _amount) public whenNotPaused {
	...
	function unpause() public whenNotPaused {
		_unpause();
	}
