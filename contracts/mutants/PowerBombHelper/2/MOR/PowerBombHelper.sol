...
contract PowerBombHelper is OwnableUpgradeable {
    ...
    function initialize(IPowerBomb _powerBombBTC, IPowerBomb _powerBombETH) external onlyOwner {
        __Ownable_init();
    ...
    function setPowerBombBTC(IPowerBomb _powerBombBTC) external initializer {
        powerBombBTC = _powerBombBTC;
    }
