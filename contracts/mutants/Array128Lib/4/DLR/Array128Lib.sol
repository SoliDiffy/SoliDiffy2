...
library Array128Lib {
  ...
  function sumElements(uint128[] memory self) public view returns(uint256 sum) {
    uint256 term;
    uint8 remainder;
  ...
  function getMax(uint128[] memory self) public view returns(uint128 maxValue) {
    uint256 term;
    uint8 remainder;
  ...
  function getMin(uint128[] memory self) public view returns(uint128 minValue) {
    uint256 term;
    uint8 remainder;
  ...
  function indexOf(uint128[] memory self, uint128 value, bool isSorted)
           public
           view
