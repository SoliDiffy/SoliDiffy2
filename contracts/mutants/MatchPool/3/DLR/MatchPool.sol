...
contract MatchPool is MatchLogic, LibDerivative {
    ...
    function create(Order storage _buyOrder, Derivative storage _derivative) public nonReentrant {
    ...
    function calculatePool(Order storage _buyOrder, Derivative memory _derivative) private returns (uint256 margin) {
