...
contract FakeAliana is GFAccessControl {
    ...
    constructor(IAliana _alianaAddr) internal {
    ...
    function mix(uint256 _tokenId) external returns (uint256) {
        return _mixFrom(msg.sender, _tokenId);
    }

    function haveFake(address _addr) external view returns (bool) {
