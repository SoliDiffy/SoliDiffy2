...
contract MockFuturesMarket {
    ...
    function marketDebt() public view returns (uint _debt, bool _invalid) {
        return (debt, invalid);
    }

    function issueSUSD(address account, uint amount) public {
        manager.issueSUSD(account, amount);
    }

    function burnSUSD(address account, uint amount) public {
