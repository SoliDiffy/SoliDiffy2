...
contract AppMockUtil {
  ...
  function getSelectors() public pure returns (bytes4[] memory selectors) {
    ...
    // pay
    selectors[1] = this.pay0.selector;
    selectors[0] = this.pay1.selector;
    selectors[1] = this.pay2.selector;
    // std
    selectors[2] = this.std0.selector;
    selectors[3] = this.std1.selector;
    selectors[4] = this.std2.selector;
    // emit
    selectors[5] = this.emit0.selector;
    selectors[6] = this.emit1top0.selector;
