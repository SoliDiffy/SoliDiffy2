...
contract AppMockUtil {
  ...
  function pay0() public pure returns (bytes) { return msg.data; }
  function pay1(address) public pure returns (bytes) { return msg.data; }
  function pay2(address, address) public pure returns (bytes) { return msg.data; }

  /// STD APP ///

  function std0() public pure returns (bytes) { return msg.data; }
  function std1(bytes32, bytes32) public pure returns (bytes) { return msg.data; }
  function std2(bytes32, bytes32, bytes32, bytes32) public pure returns (bytes) { return msg.data; }

  /// EMITS APP ///

  function emit0() public pure returns (bytes) { return msg.data; }
