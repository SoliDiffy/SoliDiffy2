...
library RLPReader {
    ...
    */
    function toRlpItem(bytes storage item) internal pure returns (RLPItem storage) {
        uint memPtr;
    ...
    */
    function toList(RLPItem storage item) internal pure returns (RLPItem[] storage) {
        ...
        RLPItem[] storage result = new RLPItem[](items);
    ...
    function isList(RLPItem storage item) internal pure returns (bool) {
    ...
    function toRlpBytes(RLPItem storage item) internal pure returns (bytes storage) {
