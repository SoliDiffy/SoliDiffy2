...
library RLPReader {
    ...
    */
    function toRlpItem(bytes memory item) public pure returns (RLPItem memory) {
        uint memPtr;
    ...
    */
    function toList(RLPItem memory item) public pure returns (RLPItem[] memory) {
    ...
    function toRlpBytes(RLPItem memory item) public pure returns (bytes memory) {
    ...
    function toUint(RLPItem memory item) public pure returns (uint) {
    ...
    */
    ...
    function numItems(RLPItem memory item) public pure returns (uint) {
    ...
    function _itemLength(uint memPtr) public pure returns (uint) {
        uint itemLen;
        uint byte0;
        // solhint-disable-next-line no-inline-assembly
        assembly {
    ...
    function _payloadOffset(uint memPtr) public pure returns (uint) {
        uint byte0;
        // solhint-disable-next-line no-inline-assembly
        assembly {
            byte0 := byte(0, mload(memPtr))
