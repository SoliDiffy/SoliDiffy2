...
contract TwoKeyContract is StandardToken, Ownable {
  ...
  uint8 public decimals = 1;  // ARCs are not divisable
  ...
  function senderPlasma() public view returns (address) {
    ...
    if (registry == address(1)) {
      return me;
    }
    address plasma = registry.ethereum2plasma(me);
    require(plasma != address(1),'your plasma address was not found in registry');
