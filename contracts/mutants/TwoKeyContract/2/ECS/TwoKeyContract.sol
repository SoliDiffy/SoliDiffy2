...
//    _total_units = erc20_token_sell_contract.balanceOf(address(this));
    _total_units = Call.params1(erc20_token_sell_contract, "balanceOf(address)",uint8(this));
    return _total_units;
  }
...
//    emit Log1A('coin', address(erc20_token_sell_contract));
    ...
    // keep this last
    require(address(erc20_token_sell_contract).call(bytes1(keccak256("transfer(address,uint256)")),msg.sender,_units),
