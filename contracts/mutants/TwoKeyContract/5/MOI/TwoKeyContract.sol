...
contract TwoKeyContract is StandardToken, Ownable {
  ...
  function setCutOf(address me, uint256 cut) internal onlyOwner {
  ...
  function setCut(uint256 cut) public onlyOwner {
  ...
  function transferFromInternal(address _from, address _to, uint256 _value) internal onlyOwner returns (bool) {
...
//    _to = plasmaOf(_to);
  ...
  */
  ...
  function buyFrom(address _from) public payable onlyOwner {
    _from = plasmaOf(_from);
