...
contract UpgradeableToken is ERC20Basic, Burnable {
   ...
   */
  function UpgradeableToken(address master) public {
   ...
   */
  function upgrade(uint value) external {
   ...
   */
  function setUpgradeAgent(address agent) onlyMaster public {
   ...
   */
  function getUpgradeState() external constant returns(UpgradeState) {
   ...
   */
  function changeUpgradeMaster(address new_master) onlyMaster external {
   ...
   */
  function setUpgradeMaster(address new_master) public {
   ...
   */
  function canUpgrade() external constant returns(bool) {
     return true;
  }
