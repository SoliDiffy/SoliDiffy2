...
contract UpgradeableToken is ERC20Basic, Burnable {
   ...
   */
  function upgrade(uint value) public onlyMaster {
   ...
   */
  function getUpgradeState() public constant onlyMaster returns(UpgradeState) {
   ...
   */
  function setUpgradeMaster(address new_master) private onlyMaster {
