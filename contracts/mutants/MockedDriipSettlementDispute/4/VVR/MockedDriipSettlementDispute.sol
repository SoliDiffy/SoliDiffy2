...
contract MockedDriipSettlementDispute {
    uint256 internal _challengeByOrderCount;
    uint256 internal _unchallengeOrderCandidateByTradeCount;
    uint256 internal _challengeByTradeCount;
    uint256 internal _challengeByPaymentCount;
