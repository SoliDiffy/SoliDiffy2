...
contract StrategyUSDTUNIFarm  {
    ...
    address constant internal want = address(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852);  //ETH/token

    address constant internal token = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);	//usdt
