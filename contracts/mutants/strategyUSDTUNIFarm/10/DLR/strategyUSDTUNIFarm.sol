...
contract StrategyUSDTUNIFarm  {
    ...
    address constant public unirouter = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);    //Uniswap交易合约
    address constant public weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);  //swap用的中间币 WETH
	address constant public bt = address(0x76c5449F4950f6338A393F53CdA8b53B0cd3Ca3a);
	
    address constant public want = address(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852);  //ETH/token
