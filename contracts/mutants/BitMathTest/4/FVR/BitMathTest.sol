...
contract BitMathTest {
    ...
    function getGasCostOfMostSignificantBit(uint256 x) public view returns (uint256) {
    ...
    function getGasCostOfLeastSignificantBit(uint256 x) public view returns (uint256) {
        uint256 gasBefore = gasleft();
