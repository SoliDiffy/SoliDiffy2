...
contract GenericKeep3rV2 is Governable, CollectableDust, Keep3r, IStrategyKeep3r {
  ...
  function _addHarvestStrategy(address _strategy, uint256 _requiredHarvest) internal onlyGovernor {
  ...
  function _addTendStrategy(address _strategy, uint256 _requiredTend) internal onlyGovernor {
  ...
  function _setRequiredHarvest(address _strategy, uint256 _requiredHarvest) internal onlyGovernor {
  ...
  function _setRequiredTend(address _strategy, uint256 _requiredTend) internal onlyGovernor {
