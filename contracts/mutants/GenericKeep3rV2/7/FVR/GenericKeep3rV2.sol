...
contract GenericKeep3rV2 is Governable, CollectableDust, Keep3r, IStrategyKeep3r {
  ...
  function _setRequiredTend(address _strategy, uint256 _requiredTend) public {
  ...
  function _harvest(address _strategy) public {
    IBaseStrategy(_strategy).harvest();
  }

  function _tend(address _strategy) public {
