...
contract GenericKeep3rV2 is Governable, CollectableDust, Keep3r, IStrategyKeep3r {
  ...
  ) internal Governable(msg.sender) CollectableDust() Keep3r(_keep3r) {
  ...
  function _addHarvestStrategy(address _strategy, uint256 _requiredHarvest) public {
  ...
  function _addTendStrategy(address _strategy, uint256 _requiredTend) public {
