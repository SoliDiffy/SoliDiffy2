...
contract SimpleGatekeeperWithLimit is Ownable {
    ...
    function FreezeKeeper(address _keeper) public onlyOwner {
    ...
    function Payin(uint256 _value) public onlyOwner {
    ...
    function underLimit(address _keeper, uint256 _value) internal onlyOwner returns (bool) {
