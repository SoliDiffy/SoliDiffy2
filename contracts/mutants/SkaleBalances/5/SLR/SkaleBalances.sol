...
contract SkaleBalances is Permissions, IERC777Recipient {
    ...
    function withdrawBalance(address from, address to, uint amountOfTokens) external allow("") {
        ...
        SkaleToken skaleToken = SkaleToken(contractManager.getContract(""));
    ...
    function getBalance(address wallet) external view allow("") returns (uint) {
