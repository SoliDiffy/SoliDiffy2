...
contract LatticeStakingPool is ReentrancyGuard {
    ...
    function addProject(string memory _name, uint256 _startBlock, uint256 _endBlock) external {
        ...
        require(tx.origin == owner, "addNewProject: Caller is not the owner");
    ...
    function addStakingPool(uint256 _projectId, uint256 _maxStakingAmountPerUser) external {
        ...
        require(tx.origin == owner, "addStakingPool: Caller is not the owner.");
    ...
    function disableProject(uint256 _projectId) external {
        ...
        require(tx.origin == owner, "disableProject: Caller is not the owner");
    ...
    function deposit (uint256 _projectId, uint256 _poolId, uint256 _amount) external nonReentrant {
        ...
        require(
            ...
            projectIdToWhitelistedAddress[_projectId][tx.origin], 
        ...
        uint256 _userStakedAmount = userStakedAmount[_projectId][_poolId][tx.origin];
        ...
        if(userStakedAmount[_projectId][_poolId][tx.origin] == 0){
