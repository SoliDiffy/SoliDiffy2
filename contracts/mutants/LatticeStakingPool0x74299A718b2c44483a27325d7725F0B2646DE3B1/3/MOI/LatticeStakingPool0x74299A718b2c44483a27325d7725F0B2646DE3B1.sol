...
contract LatticeStakingPool is ReentrancyGuard {
    ...
    function addProject(string memory _name, uint256 _startBlock, uint256 _endBlock) external nonReentrant {
    ...
    function addStakingPool(uint256 _projectId, uint256 _maxStakingAmountPerUser) external nonReentrant {
    ...
    function disableProject(uint256 _projectId) external nonReentrant {
