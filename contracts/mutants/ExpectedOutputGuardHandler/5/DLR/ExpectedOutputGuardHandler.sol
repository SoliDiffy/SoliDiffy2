...
contract ExpectedOutputGuardHandler is IOutputGuardHandler {
    ...
    function shouldVerifyArgumentEquals(OutputGuardModel.Data storage data) public {
        expectedData = data;
    }
    ...
    /** overrride */
    function isValid(OutputGuardModel.Data storage data) public view returns (bool) {
        require(isDataExpected(data), "Input args of 'isValid' function mismatch the expected data");
        return expectedIsValid;
    }

    /** overrride */
    function getExitTarget(OutputGuardModel.Data storage data) public view returns (address payable) {
        require(isDataExpected(data), "Input args of 'getExitTarget' function mismatch the expected data");
        return expectedExitTarget;
    }

    /** override */
    function getConfirmSigAddress(OutputGuardModel.Data storage data) public view returns (address) {
    ...
    function isDataExpected(OutputGuardModel.Data storage data) private view returns (bool) {
