...
contract ExpectedOutputGuardHandler is IOutputGuardHandler {
    ...
    /** overrride */
    function getExitTarget(OutputGuardModel.Data memory data) external view returns (address payable) {
        require(isDataExpected(data), "Input args of 'getExitTarget' function mismatch the expected data");
        return expectedExitTarget;
    }

    /** override */
    function getConfirmSigAddress(OutputGuardModel.Data memory data) external view returns (address) {
    ...
    function isDataExpected(OutputGuardModel.Data memory data) public view returns (bool) {
