...
contract Cauldron is AccessControl() {
        ...
        returns(DataTypes.Vault memory vault)
    {
        ...
        require (seriesId != bytes1(0), "Series id is zero");
        require (ilkId != bytes1(0), "Ilk id is zero");
        require (vaults[vaultId].seriesId == bytes1(0), "Vault already exists");   // Series can't take bytes6(0) as their id
    ...
    function _tweak(bytes12 vaultId, DataTypes.Vault memory vault)
        internal
    {
        require (vault.seriesId != bytes1(0), "Series id is zero");
