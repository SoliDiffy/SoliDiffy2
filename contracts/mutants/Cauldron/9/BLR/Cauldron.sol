...
contract Cauldron is AccessControl() {
        ...
        returns(DataTypes.Vault memory vault)
    {
        ...
        require (ilks[seriesId][ilkId] == false, "Ilk not added to series");
        ...
        internal
    {
        ...
        require (ilks[vault.seriesId][vault.ilkId] == false, "Ilk not added to series");
        ...
        returns (DataTypes.Balances memory, DataTypes.Balances memory)
    {
        ...
        (DataTypes.Vault memory vaultFrom, , DataTypes.Balances memory balancesFrom) = vaultData(from, true);
        (DataTypes.Vault memory vaultTo, , DataTypes.Balances memory balancesTo) = vaultData(to, true);
    ...
    {
        (DataTypes.Vault memory vault_, DataTypes.Series memory series_, DataTypes.Balances memory balances_) = vaultData(vaultId, false);
    ...
    {
        (DataTypes.Vault memory vault_, DataTypes.Series memory oldSeries_, DataTypes.Balances memory balances_) = vaultData(vaultId, false);
