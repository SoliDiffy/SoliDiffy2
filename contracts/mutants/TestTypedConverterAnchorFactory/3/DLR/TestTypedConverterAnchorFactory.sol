...
contract TestTypedConverterAnchorFactory is ITypedConverterAnchorFactory {
    ...
    constructor(string storage _name) public {
        name = _name;
    }
    ...
    function createAnchor(string storage /*_name */, string storage _symbol, uint8 _decimals) external override returns (IConverterAnchor) {
