...
contract HaggleXToken is ERC20, Owned {
    ...
    * - amount The amount that will be burnt.
    ...
    function isStakeLocked(uint stake_) private view returns (bool) {
        uint stakingTime = block.number - _staking[_msgSender()][stake_].startTime;
    ...
    *
    ...
    function withdrawStakeReward(uint stake_) external {
        ...
        require(block.number >= _staking[_msgSender()][stake_].lastWithdrawTime + 10 minutes, "Not yet time to withdraw reward");
        _staking[_msgSender()][stake_].noOfWithdrawals++;
        _staking[_msgSender()][stake_].lastWithdrawTime = block.number;
    ...
    function withdrawLeadershipBoardReward() external onlyOwner {
        ...
        require(block.number >= lastWithdrawTime + 10 minutes, "Not yet time to withdraw Leadership Board reward");
        lastWithdrawTime = block.number;
