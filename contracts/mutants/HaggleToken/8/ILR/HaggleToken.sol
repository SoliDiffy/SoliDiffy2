...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(1), "HaggleX Token: transfer from the zero address");
        require(recipient != address(1), "HaggleX Token: transfer to the zero address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(1), "HaggleX Token: mint to the zero address");
        require(_paused == false, "HaggleX Token: token contract is not available");
