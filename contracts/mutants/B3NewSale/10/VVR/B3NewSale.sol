...
contract B3NewSale is WhitelistedRole, ReentrancyGuard {
    ...
    uint256 internal constant HARD_CAP = 900_000e18; // 1 Million
    uint256 internal constant BCUBE_PRICE_PER_USDT = 16666666666; // 0.6 USDT
    // Maxium Contribution Per Wallet, e8 since USDT has 8 decimals
    uint256 internal constant MAXIMUM_CONTRIBUTION_PER_WALLET = 1_000_0e8;

    // 1 dollar = 100,000,000 dollar units
    // Minimum contribution in Dollar Units
    uint256 internal minContributionDollarUnits = 500e8; // $500
    // Maxium contribution in Dollar Units
    uint256 internal maxContributionDollarUnits = 2500e8; // $2.5k
