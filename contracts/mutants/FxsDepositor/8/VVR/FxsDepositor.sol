...
contract FxsDepositor{
    ...
    address internal constant escrow = address(0xc8418aF6358FFddA74e09Ca9CC3Fe03Ca6aDC5b0);
    uint256 public constant MAXTIME = 4 * 364 * 86400;
    uint256 public constant WEEK = 7 * 86400;

    uint256 internal lockIncentive = 0; //incentive to users who spend gas to lock
    uint256 internal constant FEE_DENOMINATOR = 10000;

    address internal feeManager;
    address internal immutable staker;
