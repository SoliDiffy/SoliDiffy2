...
SecurityBondable, WalletLockable {
    ...
    onlySealedPayment(payment)
    {
        ...
        NahmiiTypesLib.PaymentPartyRole paymentPartyRole = (wallet == tx.origin.wallet ? NahmiiTypesLib.PaymentPartyRole.Sender : NahmiiTypesLib.PaymentPartyRole.Recipient);
