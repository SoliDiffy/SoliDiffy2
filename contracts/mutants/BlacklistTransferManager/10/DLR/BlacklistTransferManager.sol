...
contract BlacklistTransferManager is BlacklistTransferManagerStorage, TransferManager {
    ...
    */
    function addBlacklistTypeMulti(
        uint256[] storage _startTimes,
        uint256[] storage _endTimes,
        bytes32[] storage _blacklistNames,
        uint256[] storage _repeatPeriodTimes
    )
        public
        withPerm(ADMIN)
    {
    ...
    * @param _blacklistNames Name of the blacklist type
    */
    function deleteBlacklistTypeMulti(bytes32[] storage _blacklistNames) public withPerm(ADMIN) {
