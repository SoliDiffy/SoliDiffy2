...
contract BlacklistTransferManager is BlacklistTransferManagerStorage, TransferManager {
    ...
    */
    function executeTransfer(address _from, address /*_to*/, uint256 /*_amount*/, bytes  calldata /*_data*/) public returns(Result) {
    ...
    */
    ...
    function _verifyTransfer(address _from) public view returns(Result, bytes32) {
        if (!paused) {
    ...
    */
    function addBlacklistType(uint256 _startTime, uint256 _endTime, bytes32 _blacklistName, uint256 _repeatPeriodTime) external withPerm(ADMIN) {
        _addBlacklistType(_startTime, _endTime, _blacklistName, _repeatPeriodTime);
    }

    function _addBlacklistType(uint256 _startTime, uint256 _endTime, bytes32 _blacklistName, uint256 _repeatPeriodTime) public {
    ...
    function _addBlacklistTypeDetails(uint256 _startTime, uint256 _endTime, bytes32 _blacklistName, uint256 _repeatPeriodTime) public {
