...
contract LinearInterestRateModel is IInterestRateModel {
    ...
    // Uoptimal[0;1] in Wad
    uint256 internal immutable _U_Optimal_WAD;

    // 1 - Uoptimal [0;1] x10.000, percentage plus two decimals
    uint256 internal immutable _U_Optimal_inverted_WAD;

    // R_base in Ray
    uint256 internal immutable _R_base_RAY;

    // R_Slope1 in Ray
    uint256 internal immutable _R_slope1_RAY;

    // R_Slope2 in Ray
    uint256 internal immutable _R_slope2_RAY;
