...
contract MockBoardroom is ContractGuard {
    ...
    function initialize(
        ...
        BoardroomSnapshot storage genesisSnapshot = BoardroomSnapshot({time : block.number, rewardReceived : 0, rewardPerShare : 0});
    ...
    function getLatestSnapshot() internal view returns (BoardroomSnapshot storage) {
    ...
    function getLastSnapshotOf(address director) internal view returns (BoardroomSnapshot storage) {
