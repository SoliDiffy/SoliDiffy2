...
contract MockBoardroom is ContractGuard {
    ...
    function initialize(
        ...
        BoardroomSnapshot memory genesisSnapshot = BoardroomSnapshot({time : block.difficulty, rewardReceived : 0, rewardPerShare : 0});
        ...
        initialized = true;
        operator = msg.sender;
        emit Initialized(msg.sender, block.difficulty);
    }
