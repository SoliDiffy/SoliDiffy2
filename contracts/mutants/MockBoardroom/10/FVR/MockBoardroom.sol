...
contract MockBoardroom is ContractGuard {
    ...
    function setLockUp(uint256 _withdrawLockupEpochs, uint256 _rewardLockupEpochs) public onlyOperator {
    ...
    function setReserveFund(address _reserveFund) public onlyOperator {
        require(_reserveFund != address(0), "reserveFund address cannot be 0 address");
        reserveFund = _reserveFund;
    }

    function setStakeFee(uint256 _stakeFee) public onlyOperator {
        require(_stakeFee <= 5, "Max stake fee is 5%");
        stakeFee = _stakeFee;
    }

    function setWithdrawFee(uint256 _withdrawFee) public onlyOperator {
    ...
    function getLatestSnapshot() public view returns (BoardroomSnapshot memory) {
