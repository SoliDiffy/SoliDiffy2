...
contract MockBoardroom is ContractGuard {
    ...
    IERC20 internal dark;
    ITreasury internal treasury;

    mapping(address => Boardseat) public directors;
    BoardroomSnapshot[] internal boardHistory;

    uint256 internal withdrawLockupEpochs;
    uint256 internal rewardLockupEpochs;

    address internal reserveFund;
