...
contract MockBoardroom is ContractGuard {
    ...
    function stake(uint256 amount) public updateReward(msg.sender) onlyOneBlock {
    ...
    function withdraw(uint256 amount) public onlyOneBlock updateReward(msg.sender) directorExists {
    ...
    function allocateSeigniorage(uint256 amount) external onlyOperator onlyOneBlock {
