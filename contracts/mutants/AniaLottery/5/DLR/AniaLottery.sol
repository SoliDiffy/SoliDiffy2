...
contract AniaLottery {
    ...
    function getProjectUser(uint projectId, address userAddress) public view returns (Whitelist storage) {
    ...
    function checkBuy(uint projectId, uint256 tokensToBuy) public view returns (bool) {
        ...
        LotteryWinner storage winner = getLotteryWinner(projectId, msg.sender);
