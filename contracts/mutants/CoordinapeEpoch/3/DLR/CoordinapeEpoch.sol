...
contract CoordinapeEpoch is ERC20, Ownable {
    ...
    function addNote(address recipient, string storage note) public onlyParticipant beforeEnd {
    ...
    function participants() public view returns (address[] storage) {
        address[] storage addresses = new address[](Counters.current(_participantsIds));
