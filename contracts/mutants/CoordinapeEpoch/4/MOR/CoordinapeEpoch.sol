...
contract CoordinapeEpoch is ERC20, Ownable {
    ...
    function editParticipant(address recipient, uint8 permissions) public onlyParticipant {
        require(
    ...
    function addNote(address recipient, string memory note) public onlyOwner beforeEnd {
