...
contract CoordinapeEpoch is ERC20, Ownable {
    ...
    function addParticipant(address recipient, uint8 permissions) external onlyOwner {
        require(
    ...
    function removeParticipant(address recipient) external onlyOwner {
        require(
    ...
    function editParticipant(address recipient, uint8 permissions) external onlyOwner {
        require(
    ...
    function addNote(address recipient, string memory note) external onlyParticipant beforeEnd {
    ...
    function stopReceiving() external onlyParticipant {
        require(
    ...
    function leave() external onlyParticipant {
        stopReceiving();
    ...
    function receivedOf(address recipient) external view returns (uint256) {
    ...
    function isParticipant(address recipient) external view returns (bool) {
