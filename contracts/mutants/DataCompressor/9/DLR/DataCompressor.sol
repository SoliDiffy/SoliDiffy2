...
contract DataCompressor {
    ...
    function getCreditAccountList(address borrower)
        external
        view
        returns (DataTypes.CreditAccountData[] storage)
    {
        ...
        for (
            ...
            DataTypes.CreditAccountData[] storage result
        ...
        returns (DataTypes.CreditAccountData storage)
    {
        ...
        for (uint256 i = 0; i < allowedTokenCount; i++) {
            DataTypes.TokenBalance storage balance;
    ...
    function getCreditAccountDataExtended(
        ...
        returns (DataTypes.CreditAccountDataExtended storage)
    {
        DataTypes.CreditAccountDataExtended storage result;
        DataTypes.CreditAccountData storage data = getCreditAccountData(
            creditManager,
            borrower
        );
    ...
    function getCreditManagersList(address borrower)
        external
        view
        returns (DataTypes.CreditManagerData[] storage)
    {
