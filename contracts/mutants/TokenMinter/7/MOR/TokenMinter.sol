...
contract TokenMinter {
    ...
    function setBlockRewardContract(address _blockRewardContract) external onlyMinter {
        _setBlockRewardContract(_blockRewardContract);
    }

    function setBridgeContract(address _bridgeContract) external onlyMinter {
