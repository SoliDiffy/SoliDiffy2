  ...
  */
  ...
  function liquidationCall(
    ...
    if (!receiveAToken) {
      ...
      if (currentAvailableCollateral < vars.maxCollateralToLiquidate) {
        return (
          uint8(Errors.CollateralManagerErrors.NOT_ENOUGH_LIQUIDITY),
    ...
    return (uint8(Errors.CollateralManagerErrors.NO_ERROR), Errors.NO_ERRORS);
  }
  ...
  function swapLiquidity(
    ...
    if (vars.healthFactor < GenericLogic.HEALTH_FACTOR_LIQUIDATION_THRESHOLD) {
      return (
        uint8(Errors.CollateralManagerErrors.HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD),
