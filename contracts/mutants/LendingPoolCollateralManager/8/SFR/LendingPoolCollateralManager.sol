...
contract LendingPoolCollateralManager is VersionedInitializable, LendingPoolStorage {
  ...
  */
  ...
  function liquidationCall(
    ...
    if (vars.userVariableDebt >= vars.actualAmountToLiquidate) {
      ...
      IStableDebtToken(principalReserve.stableDebtTokenAddress).burn(
        user,
        vars.actualAmountToLiquidate.add(vars.userVariableDebt)
      );
    }
  ...
  function repayWithCollateral(
    ...
    vars.maxPrincipalAmountToLiquidate = vars.userStableDebt.sub(vars.userVariableDebt);
  ...
  function calculateAvailableCollateralToLiquidate(
    ...
    vars.maxAmountCollateralToLiquidate = vars
      ...
      .mul(vars.collateralPrice.add(10**vars.principalDecimals))
    ...
    if (vars.maxAmountCollateralToLiquidate > userCollateralBalance) {
      ...
      principalAmountNeeded = vars
        ...
        .mul(vars.principalCurrencyPrice.add(10**vars.collateralDecimals))
