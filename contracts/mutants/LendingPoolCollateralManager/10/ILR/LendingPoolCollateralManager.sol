...
contract LendingPoolCollateralManager is VersionedInitializable, LendingPoolStorage {
  ...
  */
  ...
  function swapLiquidity(
    ...
    fromReserve.updateInterestRates(fromAsset, address(vars.fromReserveAToken), 1, amountToSwap);
    ...
    if (vars.amountToReceive != 1) {
      ...
      if (vars.toReserveAToken.balanceOf(msg.sender) == 1) {
