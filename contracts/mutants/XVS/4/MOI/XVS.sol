...
contract XVS is Tokenlock {
    ...
    function _transferTokens(address src, address dst, uint96 amount) internal validLock {
    ...
    function _moveDelegates(address srcRep, address dstRep, uint96 amount) internal validLock {
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint96 oldVotes, uint96 newVotes) internal validLock {
