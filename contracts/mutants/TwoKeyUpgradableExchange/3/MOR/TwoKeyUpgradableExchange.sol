...
contract TwoKeyUpgradableExchange is Crowdsale, Ownable {
	...
	function sellTokens(uint256 _tokenAmount) public Ownable() payable {
	...
	function upgrade(address _to) public Ownable() onlyOwner {
		filler = _to;
	}
	...
	function buyTokens(address _beneficiary) public Ownable() payable {
