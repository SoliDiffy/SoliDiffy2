...
abstract contract ActionBase is AdminAuth {
    ...
    string internal constant ERR_SUB_INDEX_VALUE = "Wrong sub index value";
    string internal constant ERR_RETURN_INDEX_VALUE = "Wrong return index value";

    /// @dev Subscription params index range [128, 255]
    uint8 internal constant SUB_MIN_INDEX_VALUE = 128;
    uint8 internal constant SUB_MAX_INDEX_VALUE = 255;

    /// @dev Return params index range [1, 127]
    uint8 internal constant RETURN_MIN_INDEX_VALUE = 1;
    uint8 internal constant RETURN_MAX_INDEX_VALUE = 127;
