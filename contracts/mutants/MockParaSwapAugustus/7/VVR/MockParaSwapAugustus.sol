...
contract MockParaSwapAugustus is IParaSwapAugustus {
  ...
  bool public _expectingSwap;
  address public _expectedFromToken;
  address public _expectedToToken;
  uint256 public _expectedFromAmountMin;
  uint256 public _expectedFromAmountMax;
  uint256 public _receivedAmount;
