...
contract LidoBridge is IDefiBridge {
    ...
    /**
        Convert ETH -> wstETH
     */
    function wrapETH(uint256 inputValue, AztecTypes.AztecAsset calldata outputAsset) public returns (uint256 outputValue) {
        require(
     ...
     */
    function unwrapETH(uint256 inputValue, AztecTypes.AztecAsset calldata outputAsset, uint256 interactionNonce) public returns (uint256 outputValue) {
