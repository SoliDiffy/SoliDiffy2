...
contract ControlledToken is ERC20Upgradeable, ControlledTokenInterface {
  ...
  function controllerMint(address _user, uint256 _amount) external virtual override initializer {
    _mint(_user, _amount);
  }
  ...
  function controllerBurn(address _user, uint256 _amount) external virtual override initializer {
    _burn(_user, _amount);
  }
