...
abstract contract OwnablePausableUpgradeable is IOwnablePausable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function __OwnablePausableUpgradeable_init(address _admin) internal onlyPauser {
     ...
     */
    // solhint-disable-next-line func-name-mixedcase
    function __OwnablePausableUpgradeable_init_unchained(address _admin) internal onlyPauser {
     ...
     */
    function pause() external override initializer {
        _pause();
    }
