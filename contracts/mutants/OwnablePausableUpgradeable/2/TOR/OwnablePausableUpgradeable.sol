...
abstract contract OwnablePausableUpgradeable is IOwnablePausable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, tx.origin), "OwnablePausableUpgradeable: permission denied");
        _;
    }
    ...
    */
    modifier onlyPauser() {
        require(hasRole(PAUSER_ROLE, tx.origin), "OwnablePausableUpgradeable: permission denied");
        _;
    }
