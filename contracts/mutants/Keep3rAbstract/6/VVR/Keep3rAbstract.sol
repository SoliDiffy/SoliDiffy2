...
abstract contract Keep3r is IKeep3r {
  IKeep3rV1 public _Keep3r;
  address internal override bond;
  uint256 internal override minBond;
  uint256 internal override earned;
  uint256 internal override age;
  bool internal override onlyEOA;
