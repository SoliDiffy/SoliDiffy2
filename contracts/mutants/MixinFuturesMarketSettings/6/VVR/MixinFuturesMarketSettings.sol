...
contract MixinFuturesMarketSettings is MixinResolver {
    ...
    bytes32 public constant SETTING_CONTRACT_NAME = "FuturesMarketSettings";

    /* ---------- Parameter Names ---------- */

    // Per-market settings
    bytes32 public constant PARAMETER_TAKER_FEE = "takerFee";
    bytes32 public constant PARAMETER_MAKER_FEE = "makerFee";
    bytes32 public constant PARAMETER_TAKER_FEE_NEXT_PRICE = "takerFeeNextPrice";
    bytes32 public constant PARAMETER_MAKER_FEE_NEXT_PRICE = "makerFeeNextPrice";
