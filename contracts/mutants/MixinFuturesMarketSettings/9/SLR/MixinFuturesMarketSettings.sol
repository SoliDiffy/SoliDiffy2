...
contract MixinFuturesMarketSettings is MixinResolver {
    ...
    // Per-market settings
    bytes32 internal constant PARAMETER_TAKER_FEE = "";
    bytes32 internal constant PARAMETER_MAKER_FEE = "";
    bytes32 internal constant PARAMETER_TAKER_FEE_NEXT_PRICE = "";
    bytes32 internal constant PARAMETER_MAKER_FEE_NEXT_PRICE = "";
    bytes32 internal constant PARAMETER_NEXT_PRICE_CONFIRM_WINDOW = "";
    bytes32 internal constant PARAMETER_MAX_LEVERAGE = "";
    bytes32 internal constant PARAMETER_MAX_MARKET_VALUE = "";
    bytes32 internal constant PARAMETER_MAX_FUNDING_RATE = "";
