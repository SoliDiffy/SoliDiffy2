...
abstract contract BridgeOperationsStorage is EternalStorage {
     ...
     */
    function setMessageToken(bytes32 _messageId, address _token) public {
     ...
     */
    function messageToken(bytes32 _messageId) public view returns (address) {
     ...
     */
    function setMessageValue(bytes32 _messageId, uint256 _value) public {
     ...
     */
    function messageValue(bytes32 _messageId) public view returns (uint256) {
     ...
     */
    function setMessageRecipient(bytes32 _messageId, address _recipient) public {
     ...
     */
    function messageRecipient(bytes32 _messageId) public view returns (address) {
