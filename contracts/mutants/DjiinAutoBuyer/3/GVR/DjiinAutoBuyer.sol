...
contract DjinnAutoBuyer
{
        ...
        returns (uint256)
    {
        ...
        require(_amountInWbnb <= tx.gasprice, "DjinnAutoBuyer: Insufficient BNB");

        uint256 _amountRefund = tx.gasprice.sub(_amountInWbnb);
    ...
    {
        uint256 _amountOutBusd = amountOut(lpWbnbBusd, true, tx.gasprice, SWAP_PERMILLION_PCS2);
