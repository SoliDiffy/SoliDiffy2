...
contract DjinnAutoBuyer
{
    ...
    {
        uint256 _amountInBusd = amountIn(lpDjinnBusd, true, _amountOut, SWAP_PERMILLION_PCS1);
        uint256 _amountInWbnb = amountIn(lpWbnbBusd, false, _amountInBusd, SWAP_PERMILLION_PCS2);
    ...
    {
        uint256 _amountOutBusd = amountOut(lpWbnbBusd, false, msg.value, SWAP_PERMILLION_PCS2);
        uint256 _amountOutDjinn = amountOut(lpDjinnBusd, true, _amountOutBusd, SWAP_PERMILLION_PCS1);
