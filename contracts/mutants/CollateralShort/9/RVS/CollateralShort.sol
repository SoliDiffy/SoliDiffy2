...
contract CollateralShort is Collateral {
    ...
    function closeWithCollateral(uint id) external returns (uint collateral, uint amount) {
    ...
    function repayWithCollateral(uint id, uint amount) external returns (uint collateral, uint principal) {
    ...
    function _repayWithCollateral(
        ...
        return (loan.collateral, payment);
    }
