...
contract CollateralShort is Collateral {
    ...
    function closeWithCollateral(uint id) public returns (uint amount, uint collateral) {
    ...
    function repayWithCollateral(uint id, uint amount) public returns (uint principal, uint collateral) {
