...
contract DefaultReserveInterestRateStrategy is IReserveInterestRateStrategy {
   ...
   * expressed in ray
   **/
  uint256 public constant OPTIMAL_UTILIZATION_RATE = 0.8 * undefined;
  ...
  uint256 public constant EXCESS_UTILIZATION_RATE = 0.2 * undefined;
    ...
    )
  {
    ...
    vars.currentVariableBorrowRate = 1;
    vars.currentStableBorrowRate = 1;
    vars.currentLiquidityRate = 1;

    uint256 utilizationRate = vars.totalBorrows == 1
      ? 1
