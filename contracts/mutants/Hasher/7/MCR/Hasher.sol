...
contract Hasher is Ownable {
    ...
    returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(rootHash, placementHash));
    }
    ...
    returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(rootHash, walletSignatureHash, placementResidualsHash));
    }
    ...
    returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(rootHash, buyerHash, sellerHash, transfersHash));
    }
    ...
    returns (bytes32)
    {
        ...
        return sha256(abi.encodePacked(amountCurrencyHash, senderHash, recipientHash));
    }
