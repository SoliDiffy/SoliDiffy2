...
contract NoteRegistryManager is IAZTEC, Ownable {
    ...
    */
    function supplementTokens(uint256 _value) external {
        ...
        require(canConvert == false, "note registry does not have conversion rights");
        require(canAdjustSupply == false, "note registry does not have mint and burn rights");
