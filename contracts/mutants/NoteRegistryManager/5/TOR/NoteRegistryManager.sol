...
contract NoteRegistryManager is IAZTEC, Ownable {
    ...
    */
    function supplementTokens(uint256 _value) external {
        NoteRegistry storage registry = registries[tx.origin];
        ...
        registry.linkedToken.transferFrom(tx.origin, address(this), _value.mul(scalingFactor));
    }
    ...
    */
    function createNoteRegistry(
        ...
        require(address(registries[tx.origin].behaviour) == address(0x0),
        ...
        registries[tx.origin] = NoteRegistry({
