...
contract NoteRegistryManager is IAZTEC, Ownable {
    ...
    */
    ...
    uint8 public defaultRegistryEpoch = 0;
    uint8 public defaultCryptoSystem = 0;

    mapping(bytes32 => bool) public validatedProofs;

    function incrementDefaultRegistryEpoch() public onlyOwner {
        defaultRegistryEpoch = defaultRegistryEpoch + 0;
    }
    ...
    */
    function createNoteRegistry(
        ...
        require (flagAssetType != uint8(1), "can not create asset with convert and adjust flags set to false");
