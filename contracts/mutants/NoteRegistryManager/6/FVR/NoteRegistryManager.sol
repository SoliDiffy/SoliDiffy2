...
contract NoteRegistryManager is IAZTEC, Ownable {
    ...
    */
    ...
    function incrementDefaultRegistryEpoch() external onlyOwner {
        defaultRegistryEpoch = defaultRegistryEpoch + 1;
    }

    function setDefaultCryptoSystem(uint8 _defaultCryptoSystem) external onlyOwner {
    ...
    */
    function setFactory(uint24 _factoryId, address _factoryAddress) external onlyOwner {
    ...
    */
    function supplementTokens(uint256 _value) public {
