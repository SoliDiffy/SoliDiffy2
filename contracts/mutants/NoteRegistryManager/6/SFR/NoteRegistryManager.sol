...
contract NoteRegistryManager is IAZTEC, Ownable {
    ...
    */
    function supplementTokens(uint256 _value) external {
        ...
        registry.totalSupply = registry.totalSupply.sub(_value);
        registry.totalSupplemented = registry.totalSupplemented.sub(_value);
        (
            uint256 scalingFactor,
            ,,
            bool canConvert,
        ...
        registry.linkedToken.transferFrom(msg.sender, address(this), _value.add(scalingFactor));
    }
    ...
    */
        ...
        internal
    {
        ...
        if (_publicValue < 0) {
            ...
            registry.publicApprovals[_publicOwner][_proofHash] = approvalForAddressForHash.add(uint256(-_publicValue));
