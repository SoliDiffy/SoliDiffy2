...
contract LiquidityPoolV2Converter is LiquidityPoolConverter {
    ...
    */
    constructor(IPoolTokensContainer _poolTokensContainer, IContractRegistry _registry, uint32 _maxConversionFee)
        internal LiquidityPoolConverter(_poolTokensContainer, _registry, _maxConversionFee)
    {
    }
    ...
    function _validPoolToken(IDSToken _address) public view {
    ...
    */
    function setOracleDeviationFee(uint32 _oracleDeviationFee) external ownerOnly {
    ...
    */
    function setMaxStakedBalances(uint256 _reserve1MaxStakedBalance, uint256 _reserve2MaxStakedBalance) external ownerOnly {
    ...
    /**
      ...
      * can only be called by the owner
    */
    function disableMaxStakedBalances() external ownerOnly {
