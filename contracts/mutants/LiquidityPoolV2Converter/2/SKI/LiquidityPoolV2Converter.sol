    ...
    */
        ...
        validAddress(address(_secondaryReserveOracle))
    {
        ...
        LiquidityPoolV2ConverterCustomFactory customFactory =
            LiquidityPoolV2ConverterCustomFactory(address(IConverterFactory(addressOf(CONVERTER_FACTORY)).customFactories(super.converterType())));
        ...
        emit Activation(super.converterType(), anchor, true);
    }
