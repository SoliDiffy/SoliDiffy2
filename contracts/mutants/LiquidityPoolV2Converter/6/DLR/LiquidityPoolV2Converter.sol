...
contract LiquidityPoolV2Converter is LiquidityPoolConverter {
    ...
    */
    function effectiveTokensRate() public view returns (uint256, uint256) {
        Fraction storage rate = _effectiveTokensRate();
    ...
    */
    function createPoolTokens() internal {
        ...
        IDSToken[] storage poolTokens = container.poolTokens();
    ...
    /**
      ...
      * @return rate
    */
    function _effectiveTokensRate() private view returns (Fraction storage) {
    ...
    */
    function effectiveReserveWeights(Fraction storage _rate) private view returns (uint32, uint32) {
