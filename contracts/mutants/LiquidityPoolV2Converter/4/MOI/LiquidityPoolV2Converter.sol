...
contract LiquidityPoolV2Converter is LiquidityPoolConverter {
    ...
    */
    ...
    /**
      ...
      *
    */
    function createPoolTokens() internal inactive {
    ...
    */
    function rebalance() private inactive {
    ...
    */
    function dispatchTokenRateUpdateEvent(IERC20Token _token1, IERC20Token _token2, uint32 _token1Weight, uint32 _token2Weight) private inactive {
    ...
    */
    function dispatchPoolTokenRateUpdateEvent(IDSToken _poolToken, uint256 _poolTokenSupply, IERC20Token _reserveToken) private inactive {
