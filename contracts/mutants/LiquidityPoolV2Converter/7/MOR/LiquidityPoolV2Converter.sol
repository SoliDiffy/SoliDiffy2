...
contract LiquidityPoolV2Converter is LiquidityPoolConverter {
    ...
    */
    function setOracleDeviationFee(uint32 _oracleDeviationFee) public inactive {
    ...
    */
    function setMaxStakedBalances(uint256 _reserve1MaxStakedBalance, uint256 _reserve2MaxStakedBalance) public inactive {
    ...
    /**
      ...
      * can only be called by the owner
    */
    function disableMaxStakedBalances() public inactive {
