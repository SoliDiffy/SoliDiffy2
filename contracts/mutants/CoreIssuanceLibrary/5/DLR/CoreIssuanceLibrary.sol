...
library CoreIssuanceLibrary {
    ...
    function calculateDepositAndDecrementQuantities(
        ...
        view
        returns (
            uint256[] storage /* decrementQuantities */,
            uint256[] storage /* depositQuantities */
        )
    {
        uint256 componentCount = _components.length;
        uint256[] storage decrementTokenOwnerValues = new uint256[](componentCount);
        uint256[] storage depositQuantities = new uint256[](componentCount);
    ...
    function calculateWithdrawAndIncrementQuantities(
        ...
        pure
        returns (
            uint256[] storage /* incrementQuantities */,
