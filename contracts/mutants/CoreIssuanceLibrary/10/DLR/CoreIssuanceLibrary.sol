...
library CoreIssuanceLibrary {
    ...
    function calculateWithdrawAndIncrementQuantities(
        ...
        returns (
            ...
            uint256[] storage /* withdrawQuantities */
        )
    {
        uint256 componentCount = _componentQuantities.length;
        uint256[] storage incrementTokenOwnerValues = new uint256[](componentCount);
        uint256[] storage withdrawToValues = new uint256[](componentCount);
        ...
        returns (uint256[] storage)
    {
        ...
        uint256[] storage tokenValues = new uint256[](_componentUnits.length);
