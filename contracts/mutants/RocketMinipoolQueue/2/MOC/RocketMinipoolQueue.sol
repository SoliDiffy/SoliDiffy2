...
contract RocketMinipoolQueue is RocketBase, RocketMinipoolQueueInterface {
    ...
    function enqueueMinipool(MinipoolDeposit _depositType, address _minipool) override external onlyLatestContract("rocketMinipoolManager", msg.sender) onlyLatestContract("rocketMinipoolQueue", address(this)) {
    ...
    function dequeueMinipool() override external onlyLatestContract("rocketDepositPool", msg.sender) onlyLatestContract("rocketMinipoolQueue", address(this)) returns (address minipoolAddress) {
