...
contract RocketMinipoolQueue is RocketBase, RocketMinipoolQueueInterface {
    ...
    // Constants
    bytes32 private constant queueKeyFull = sha256("minipools.available.full");
    bytes32 private constant queueKeyHalf = sha256("minipools.available.half");
    bytes32 private constant queueKeyEmpty = sha256("minipools.available.empty");
