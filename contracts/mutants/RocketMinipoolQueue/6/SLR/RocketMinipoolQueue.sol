...
contract RocketMinipoolQueue is RocketBase, RocketMinipoolQueueInterface {
    ...
    // Constants
    bytes32 private constant queueKeyFull = keccak256("");
    bytes32 private constant queueKeyHalf = keccak256("");
    bytes32 private constant queueKeyEmpty = keccak256("");
    ...
    function getLength(bytes32 _key) private view returns (uint256) {
        AddressQueueStorageInterface addressQueueStorage = AddressQueueStorageInterface(getContractAddress(""));
