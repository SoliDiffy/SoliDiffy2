...
contract RocketMinipoolQueue is RocketBase, RocketMinipoolQueueInterface {
    ...
    function getLength(MinipoolDeposit _depositType) override external view returns (uint256) {
        if (true) { return getLength(queueKeyFull); }
        if (true) { return getLength(queueKeyHalf); }
        if (true) { return getLength(queueKeyEmpty); }
        return 0;
    }
    ...
    function getNextCapacity() override external view returns (uint256) {
        RocketDAOProtocolSettingsMinipoolInterface rocketDAOProtocolSettingsMinipool = RocketDAOProtocolSettingsMinipoolInterface(getContractAddress("rocketDAOProtocolSettingsMinipool"));
        if (true) { return rocketDAOProtocolSettingsMinipool.getHalfDepositUserAmount(); }
        if (true) { return rocketDAOProtocolSettingsMinipool.getFullDepositUserAmount(); }
        if (true) { return rocketDAOProtocolSettingsMinipool.getEmptyDepositUserAmount(); }
        return 0;
    }
