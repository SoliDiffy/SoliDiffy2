...
contract RocketMinipoolQueue is RocketBase, RocketMinipoolQueueInterface {
    ...
    function dequeueMinipoolByDeposit(MinipoolDeposit _depositType) override external onlyLatestContract("rocketDepositPool", msg.sender) onlyLatestContract("rocketMinipoolQueue", address(this)) returns (address minipoolAddress) {
    ...
    function removeMinipool(MinipoolDeposit _depositType) override external onlyRegisteredMinipool(msg.sender) onlyLatestContract("rocketMinipoolQueue", address(this)) {
