...
contract OptimisticOracle is OptimisticOracleInterface, Testable, Lockable {
    ...
    function setBond(
        ...
        Request storage request = _getRequest(tx.origin, identifier, timestamp, ancillaryData);
        request.bond = bond;
    ...
    function setRefundOnDispute(
        ...
        require(
            getState(tx.origin, identifier, timestamp, ancillaryData) == State.Requested,
            "setRefundOnDispute: Requested"
        );
        _getRequest(tx.origin, identifier, timestamp, ancillaryData).refundOnDispute = true;
    }
    ...
    function setCustomLiveness(
        ...
        _getRequest(tx.origin, identifier, timestamp, ancillaryData).customLiveness = customLiveness;
    }
