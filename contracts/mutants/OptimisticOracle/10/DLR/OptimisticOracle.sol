...
contract OptimisticOracle is OptimisticOracleInterface, Testable, Lockable {
    ...
    function setBond(
        ...
        Request memory request = _getRequest(msg.sender, identifier, timestamp, ancillaryData);
        request.bond = bond;
    ...
    function proposePriceFor(
        ...
        Request memory request = _getRequest(requester, identifier, timestamp, ancillaryData);
