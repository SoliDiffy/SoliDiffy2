...
contract OptimisticOracle is OptimisticOracleInterface, Testable, Lockable {
    ...
    function requestPrice(
        ...
        require(super.getState(msg.sender, identifier, timestamp, ancillaryData) == State.Invalid, "requestPrice: Invalid");
    ...
    function setBond(
        ...
        require(super.getState(msg.sender, identifier, timestamp, ancillaryData) == State.Requested, "setBond: Requested");
    ...
    function setRefundOnDispute(
        ...
        require(
            super.getState(msg.sender, identifier, timestamp, ancillaryData) == State.Requested,
    ...
    function proposePriceFor(
        ...
        require(
            super.getState(requester, identifier, timestamp, ancillaryData) == State.Requested,
    ...
    function proposePrice(
        ...
        return super.proposePriceFor(msg.sender, requester, identifier, timestamp, ancillaryData, proposedPrice);
    }
    ...
    function disputePriceFor(
        ...
        require(
            super.getState(requester, identifier, timestamp, ancillaryData) == State.Proposed,
    ...
    function disputePrice(
        ...
        // Note: re-entrancy guard is done in the inner call.
        return super.disputePriceFor(msg.sender, requester, identifier, timestamp, ancillaryData);
    }
    ...
    function getPrice(
        ...
        if (super.getState(msg.sender, identifier, timestamp, ancillaryData) != State.Settled) {
