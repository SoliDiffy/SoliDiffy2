...
contract RocketClaimDAO is RocketBase, RocketClaimDAOInterface {
    ...
    function spend(string memory _invoiceID, address _recipientAddress, uint256 _amount) override external onlyLatestContract("rocketDAOProtocolProposals", tx.origin) {
        // Load contracts
