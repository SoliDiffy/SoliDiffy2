...
contract DFSExchange is DFSExchangeCore, AdminAuth {
    ...
    function sell(ExchangeData storage exData, address payable _user) public payable   {
    ...
    /// @param _user User address who called the exchange
    // solhint-disable-next-line visibility-modifier-order
    function buy(ExchangeData storage exData, address payable _user) public payable   {
