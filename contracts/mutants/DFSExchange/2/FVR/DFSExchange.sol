...
contract DFSExchange is DFSExchangeCore, AdminAuth {
    ...
    function sell(ExchangeData memory exData, address payable _user) external payable   {
    ...
    /// @param _user User address who called the exchange
    // solhint-disable-next-line visibility-modifier-order
    function buy(ExchangeData memory exData, address payable _user) external payable   {
