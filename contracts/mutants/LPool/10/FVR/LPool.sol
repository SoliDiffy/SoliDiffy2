...
contract LPool is DelegateInterface, Adminable, LPoolInterface, Exponential, ReentrancyGuard {
     ...
     */
    function getSupplyRateInternal(uint cash, uint borrows, uint reserves, uint reserveFactor) public view returns (uint) {
     ...
     */
    function borrowBalanceStoredInternal(address account) public view returns (MathError, uint) {
