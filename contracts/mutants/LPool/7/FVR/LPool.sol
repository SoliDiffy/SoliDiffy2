...
contract LPool is DelegateInterface, Adminable, LPoolInterface, Exponential, ReentrancyGuard {
     ...
     */
    function transferTokens(address spender, address src, address dst, uint tokens) public returns (bool) {
     ...
     */
    function doTransferIn(address from, uint amount, bool convertWeth) public returns (uint) {
     ...
     *            See here: https://medium.com/coinmonks/missing-return-value-bug-at-least-130-tokens-affected-d67bf08521ca
     */
    function doTransferOut(address payable to, uint amount, bool convertWeth) public {
        if (isWethPool && convertWeth) {
