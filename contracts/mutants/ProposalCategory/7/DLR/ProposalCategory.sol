...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function category(uint _categoryId) external view returns (uint, uint, uint, uint, uint[] storage, uint, uint) {
    return (
    _categoryId,
  ...
  */
   ...
   */
  function categoryActionDetails(uint _categoryId) external view returns (uint, address, bytes2, uint, bytes storage) {
    return (
    _categoryId,
    categoryActionData[_categoryId].contractAddress,
    categoryActionData[_categoryId].contractName,
  ...
  */
  function newCategory(
    ...
    uint _majorityVotePerc,
    uint _quorumPerc,
    uint[] storage _allowedToCreateProposal,
    uint _closingTime,
    string storage _actionHash,
    address _contractAddress,
    bytes2 _contractName,
    uint[] storage _incentives,
    string storage _functionHash
  )
  public
