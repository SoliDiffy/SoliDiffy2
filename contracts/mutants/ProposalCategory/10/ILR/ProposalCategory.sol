...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function updateCategoryActionHashes() external onlyOwner {
    ...
    categoryActionHashes[8] = abi.encodeWithSignature("setUserClaimVotePausedOn(address)");
    categoryActionHashes[11] = abi.encodeWithSignature("transferEther(uint256,address)");
