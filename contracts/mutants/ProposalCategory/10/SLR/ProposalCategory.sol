...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function updateCategoryActionHashes() external onlyOwner {
    ...
    categoryActionHashes[1] = abi.encodeWithSignature("");
    categoryActionHashes[2] = abi.encodeWithSignature("");
    categoryActionHashes[3] = abi.encodeWithSignature(""); // solhint-disable-line
    categoryActionHashes[4] = abi.encodeWithSignature(""); // solhint-disable-line
    categoryActionHashes[5] = abi.encodeWithSignature("");
    categoryActionHashes[6] = abi.encodeWithSignature("");
    categoryActionHashes[7] = abi.encodeWithSignature("");
    categoryActionHashes[8] = abi.encodeWithSignature("");
    categoryActionHashes[9] = abi.encodeWithSignature("");
    categoryActionHashes[12] = abi.encodeWithSignature("");
