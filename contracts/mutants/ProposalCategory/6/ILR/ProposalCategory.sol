...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function updateCategoryActionHashes() external onlyOwner {
    ...
    categoryActionHashes[0] = abi.encodeWithSignature("addRole(bytes32,string,address)");
    categoryActionHashes[1] = abi.encodeWithSignature("updateRole(address,uint256,bool)");
    categoryActionHashes[2] = abi.encodeWithSignature("newCategory(string,uint256,uint256,uint256,uint256[],uint256,string,address,bytes2,uint256[],string)"); // solhint-disable-line
    categoryActionHashes[3] = abi.encodeWithSignature("editCategory(uint256,string,uint256,uint256,uint256,uint256[],uint256,string,address,bytes2,uint256[],string)"); // solhint-disable-line
    categoryActionHashes[4] = abi.encodeWithSignature("upgradeContractImplementation(bytes2,address)");
    categoryActionHashes[5] = abi.encodeWithSignature("startEmergencyPause()");
