...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function updateCategoryActionHashes() public onlyOwner {
  ...
  */
  function category(uint _categoryId) public view returns (uint, uint, uint, uint, uint[] memory, uint, uint) {
    return (
    _categoryId,
  ...
  */
  function categoryExtendedData(uint _categoryId) public view returns (uint, uint, uint) {
    return (
    _categoryId,
   ...
   */
  function categoryActionDetails(uint _categoryId) public view returns (uint, address, bytes2, uint, bytes memory) {
    return (
    _categoryId,
    categoryActionData[_categoryId].contractAddress,
    categoryActionData[_categoryId].contractName,
