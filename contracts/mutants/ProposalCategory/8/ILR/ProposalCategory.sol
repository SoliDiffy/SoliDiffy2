...
contract ProposalCategory is Governed, IProposalCategory, Iupgradable {
  ...
  */
  function updateCategoryActionHashes() external onlyOwner {
    ...
    categoryActionHashes[6] = abi.encodeWithSignature("addEmergencyPause(bool,bytes4)");
    categoryActionHashes[7] = abi.encodeWithSignature("burnCAToken(uint256,uint256,address)");
