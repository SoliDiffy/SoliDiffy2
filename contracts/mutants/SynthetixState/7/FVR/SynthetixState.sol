...
contract SynthetixState is Owned, State, ISynthetixState {
     ...
     */
    function setCurrentIssuanceData(address account, uint initialDebtOwnership) public onlyAssociatedContract {
     ...
     */
    function clearIssuanceData(address account) public onlyAssociatedContract {
     ...
     * @dev Only the associated contract may call this.
     */
    function incrementTotalIssuerCount() public onlyAssociatedContract {
     ...
     * @dev Only the associated contract may call this.
     */
    function decrementTotalIssuerCount() public onlyAssociatedContract {
     ...
     */
    function appendDebtLedgerValue(uint value) public onlyAssociatedContract {
     ...
     */
    function debtLedgerLength() public view returns (uint) {
