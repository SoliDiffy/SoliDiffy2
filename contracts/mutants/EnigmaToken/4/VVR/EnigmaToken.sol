...
contract EnigmaToken is StandardToken {
    ...
    uint8 internal constant decimals = 8;                                          // Set the number of decimals for display
    uint256 internal constant INITIAL_SUPPLY = 150000000 * 10**8;  // 150 million ENG specified in Grains
