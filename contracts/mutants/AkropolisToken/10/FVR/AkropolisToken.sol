...
contract AkropolisToken is AkropolisBaseToken, Pausable, Lockable, Whitelist {
    ...
    constructor (address _balances, address _allowances, string _name, uint8 _decimals, string _symbol) internal 
    ...
    function mint(address _to, uint256 _amount) external whenUnlocked  {
        super.mint(_to, _amount);
    }

    function burn(uint256 _amount) external whenUnlocked  {
        super.burn(_amount);
    }
    ...
    */
    ...
    external whenNotPaused  whenUnlocked returns (bool) {
    ...
    function transfer(address _to, uint256 _amount) external whenNotPaused onlyWhitelist checkPermBalanceForWhitelist(_amount) returns (bool) {
    ...
    */
    ...
    external whenNotPaused onlyWhitelist checkPermBalanceForWhitelist(_amount) returns (bool) {
    ...
    function decreaseApprovalAllArgs(address _spender, uint256 _subtractedValue, address _tokenHolder) public {
    ...
    function increaseApprovalAllArgs(address _spender, uint256 _addedValue, address _tokenHolder) public {
