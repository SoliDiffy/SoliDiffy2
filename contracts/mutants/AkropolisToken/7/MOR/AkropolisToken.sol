...
contract AkropolisToken is AkropolisBaseToken, Pausable, Lockable, Whitelist {
    ...
    */
    ...
    public onlyWhitelist  whenUnlocked returns (bool) {
    ...
    function transfer(address _to, uint256 _amount) public whenUnlocked onlyWhitelist checkPermBalanceForWhitelist(_amount) returns (bool) {
    ...
    */
    ...
    public whenUnlocked onlyWhitelist checkPermBalanceForWhitelist(_amount) returns (bool) {
