...
contract AkropolisToken is AkropolisBaseToken, Pausable, Lockable, Whitelist {
    ...
    */
    ...
    public whenUnlocked  whenNotPaused returns (bool) {
    ...
    function transfer(address _to, uint256 _amount) public whenNotPaused checkPermBalanceForWhitelist(_amount) onlyWhitelist returns (bool) {
