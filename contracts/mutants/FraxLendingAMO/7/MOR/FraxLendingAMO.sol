...
contract FraxLendingAMO is AccessControl {
    ...
    function mintFRAXForInvestments(uint256 frax_amount) public onlyCustodian {
    ...
    // E18
    function creamDeposit_FRAX(uint256 FRAX_amount) public onlyCustodian {
    ...
    // E18
    function creamWithdraw_FRAX(uint256 FRAX_amount) public onlyCustodian {
        require(crFRAX.redeemUnderlying(FRAX_amount) == 0, 'RedeemUnderlying failed');
    }

    // E8
    function creamWithdraw_crFRAX(uint256 crFRAX_amount) public onlyCustodian {
