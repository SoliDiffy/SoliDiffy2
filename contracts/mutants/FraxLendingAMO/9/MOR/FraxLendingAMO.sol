...
contract FraxLendingAMO is AccessControl {
    ...
    function fnxIntegratedStakeFPTs_FRAX_FNX(uint256 FRAX_amount, uint256 FNX_amount, uint256 lock_period) public onlyCustodian {
    ...
    function fnxStakeFRAXForFPT_FRAX(uint256 FRAX_amount, uint256 lock_period) public onlyCustodian {
        require(allow_finnexus, 'FinNexus strategy is disabled');
        FRAX.approve(address(fnxIntegratedStake), FRAX_amount);
