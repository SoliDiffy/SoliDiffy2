...
contract RocketTokenNETH is RocketBase, ERC20, RocketTokenNETHInterface {
    ...
    // Construct
    constructor(address _rocketStorageAddress) RocketBase(_rocketStorageAddress)  ERC20("", "") {
        version = 1;
    }

    // Deposit ETH rewards
    // Only accepts calls from the RocketNetworkWithdrawal contract
    function depositRewards() override external payable onlyLatestContract("", msg.sender) {
