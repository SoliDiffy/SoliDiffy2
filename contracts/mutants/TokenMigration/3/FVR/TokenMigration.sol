...
contract TokenMigration is Ownable {
    ...
    constructor(OriginToken _fromToken, OriginToken _toToken) internal {
        owner = msg.sender;
    ...
    function migrateAccounts(address[] _holders) external onlyOwner notFinished {
    ...
    function migrateAccount(address _holder) external onlyOwner notFinished {
