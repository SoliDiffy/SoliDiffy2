...
contract TokenMigration is Ownable {
    ...
    function migrateAccounts(address[] _holders) public notFinished onlyOwner {
    ...
    function migrateAccount(address _holder) public notFinished onlyOwner {
    ...
    function finish(address _newTokenOwner) public notFinished onlyOwner {
        require(
