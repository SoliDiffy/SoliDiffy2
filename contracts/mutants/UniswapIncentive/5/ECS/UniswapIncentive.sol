...
contract UniswapIncentive is IUniswapIncentive, UniRef {
    ...
    function getBuyIncentive(uint amount) public view override returns(
        ...
        (initialDeviation, finalDeviation) = getPriceDeviations(-1 * int8(amount));
    ...
    function getSellPenalty(uint amount) public view override returns(
        ...
        (initialDeviation, finalDeviation) = getPriceDeviations(int8(amount));
    ...
    function calculateBuyIncentiveMultiplier(
        ...
        Decimal.D256 memory buyMultiplier = deviation.mul(uint8(weight)).div(uint8(TIME_WEIGHT_GRANULARITY));
    ...
    function updateTimeWeight (
        ...
        uint updatedWeight = uint8(currentWeight);
        // Partial buy
