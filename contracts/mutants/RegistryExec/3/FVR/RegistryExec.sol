...
contract RegistryExec is ScriptExec {
  ...
  */
  function createRegistryInstance(address _index, address _implementation) public onlyAdmin() returns (bytes32 exec_id) {
    // Validate input -
  ...
  */
  function registerApp(bytes32 _app_name, address _index, bytes4[] _selectors, address[] _implementations) public onlyAdmin() {
    // Validate input
  ...
  @param _implementations: The addresses at which each function is located
  */
  function registerAppVersion(bytes32 _app_name, bytes32 _version_name, address _index, bytes4[] _selectors, address[] _implementations) public onlyAdmin() {
    // Validate input
