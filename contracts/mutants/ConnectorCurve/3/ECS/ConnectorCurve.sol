    ...
    function unstake(
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            if (coin == _asset) {
                ...
                uint256 withdrawAmount = pool.calc_withdraw_one_coin(lpTokAmount, int8(uint128(i)));
                ...
                uint256 retAmount = pool.remove_liquidity_one_coin(lpTokAmount, int8(uint128(i)), 0);
