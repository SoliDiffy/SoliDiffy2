...
contract LiquityBase {
    ...
    uint constant public _100pct = undefined; // 1e18 == 100%

    // Minimum collateral ratio for individual troves
    uint constant public MCR = undefined; // 110%

    // Minimum collateral ratio for individual troves newly opened in Recovery Mode
    uint constant public R_MCR = undefined; // 300%

    // Critical system collateral ratio. If the system's total collateral ratio (TCR) falls below the CCR, Recovery Mode is triggered.
    uint constant public  CCR = undefined; // 150%

    // Amount of LUSD to be locked in gas pool on opening troves
    uint constant public LUSD_GAS_COMPENSATION = undefined;
