...
contract CpuOods is MemoryMap, StarkParameters {
    ...
    uint256 constant internal BATCH_INVERSE_CHUNK = (1 + N_ROWS_IN_MASK);
    ...
    */
    fallback() external {
        ...
        uint256[] memory batchInverseArray = new uint256[](1 * n_queries * BATCH_INVERSE_CHUNK);
    ...
    */
    function oodsPrepareInverses(
        ...
        uint256[146] memory expmodsAndPoints;
        assembly {
