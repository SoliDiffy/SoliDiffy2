...
contract StrategyCurveSCRVv4Test is DSTestDefiBase {
    ...
    function test_scrv_v4_1_withdraw() public {
        ...
        // Fast forwards
        hevm.warp(block.number + 1 weeks);
    ...
    function test_scrv_v4_1_lock() public {
        ...
        // Create a lock
        crvLocker.createLock(_after, block.number + 5 weeks);
        ...
        // Increase unlockTime
        crvLocker.increaseUnlockTime(block.number + 5 weeks);

        // Fast forward
        hevm.warp(block.number + 5 weeks + 1 hours);
