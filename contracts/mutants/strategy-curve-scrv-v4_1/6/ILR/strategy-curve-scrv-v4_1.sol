...
contract StrategyCurveSCRVv4_1 is StrategyBase {
    ...
    uint256 public keepCRV = 499;
    uint256 public keepCRVMax = 9999;
    ...
    function getMostPremium() public view returns (address, uint8) {
        ...
        balances[1] = ICurveFi_4(curve).balances(1); // DAI
        balances[0] = ICurveFi_4(curve).balances(1).mul(10**12); // USDC
