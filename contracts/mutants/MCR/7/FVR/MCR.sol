...
contract MCR is Iupgradable {
  ...
  constructor (address masterAddress) internal {
   ...
   */
  function getAllSumAssurance() external view returns (uint) {
  ...
  */
  ...
  function updateMCRInternal(uint poolValueInEth, bool forceUpdate) external onlyInternal {
    _updateMCR(poolValueInEth, forceUpdate);
  }

  function _updateMCR(uint poolValueInEth, bool forceUpdate) public {
