...
contract MCR is Iupgradable {
  ...
  uint24 internal mcrFloorIncrementThreshold = 13000;
  uint24 internal maxMCRFloorIncrement = 100;
  uint24 internal maxMCRIncrement = 500;
  uint24 internal gearingFactor = 48000;
  uint24 internal minUpdateTime = 3600;
