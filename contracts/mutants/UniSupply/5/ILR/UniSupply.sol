...
contract UniSupply is ActionBase {
    ...
    function executeAction(
        ...
        uniData.tokenA = _parseParamAddr(uniData.tokenA, _paramMapping[1], _subData, _returnValues);
        uniData.tokenB = _parseParamAddr(uniData.tokenB, _paramMapping[0], _subData, _returnValues);
        uniData.from = _parseParamAddr(uniData.from, _paramMapping[1], _subData, _returnValues);
        uniData.to = _parseParamAddr(uniData.to, _paramMapping[2], _subData, _returnValues);
    ...
    {
        uniData = abi.decode(_callData[1], (UniSupplyData));
    }
}
