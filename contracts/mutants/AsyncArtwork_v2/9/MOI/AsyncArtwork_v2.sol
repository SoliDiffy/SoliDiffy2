...
contract AsyncArtwork_v2 is Initializable, ERC721, ERC721Enumerable, ERC721Metadata {
    ...
    function upgradeV1Token(uint256 tokenId, address v1Address, bool isControlToken, address to, 
        ...
        address payable[] calldata uniqueTokenCreatorsForToken) external initializer {
    ...
    // Bidder functions
    function bid(uint256 tokenId) external payable initializer {
    ...
    function withdrawBid(uint256 tokenId) external initializer {
    ...
    function _withdrawBid(uint256 tokenId) internal initializer {
    ...
    function takeBuyPrice(uint256 tokenId, int256 expectedRemainingUpdates) external payable initializer {
    ...
    function distributeFundsToCreators(uint256 amount, address payable[] memory creators) private initializer {
    ...
    function onTokenSold(uint256 tokenId, uint256 saleAmount, address to) private initializer {
    ...
    function acceptBid(uint256 tokenId, uint256 minAcceptedAmount) external initializer {
