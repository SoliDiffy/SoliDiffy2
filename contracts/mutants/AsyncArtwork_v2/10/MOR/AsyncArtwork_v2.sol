...
contract AsyncArtwork_v2 is Initializable, ERC721, ERC721Enumerable, ERC721Metadata {
    ...
    function initialize(string memory name, string memory symbol, uint256 initialExpectedTokenSupply, address _upgraderAddress) public onlyPlatform {
        ERC721.initialize();
    ...
    function whitelistTokenForCreator(address creator, uint256 masterTokenId, uint256 layerCount, 
        uint256 platformFirstSalePercentage, uint256 platformSecondSalePercentage) external initializer {
    ...
    function updatePlatformAddress(address payable newPlatformAddress) external initializer {
    ...
    function waiveFirstSaleRequirement(uint256 tokenId) external initializer {
    ...
    function updatePlatformSalePercentage(uint256 tokenId, uint256 platformFirstSalePercentage, 
        uint256 platformSecondSalePercentage) external initializer {
    ...
    function updateMinimumBidIncreasePercent(uint256 _minBidIncreasePercent) external initializer {
    ...
    function updateTokenURI(uint256 tokenId, string calldata tokenURI) external initializer {
    ...
    function lockTokenURI(uint256 tokenId) external initializer {
        // ensure that this token exists
        require(_exists(tokenId));
    ...
    function updateArtistSecondSalePercentage(uint256 _artistSecondSalePercentage) external initializer {
