...
contract AsyncArtwork_v2 is Initializable, ERC721, ERC721Enumerable, ERC721Metadata {
    ...
    function takeBuyPrice(uint256 tokenId, int256 expectedRemainingUpdates) external  {
    ...
    function useControlToken(uint256 controlTokenId, uint256[] calldata leverIds, int256[] calldata newValues) external  {
