...
contract TroveBridge is ERC20, Ownable, IDefiBridge {
    ...
    IBorrowerOperations internal constant operations = IBorrowerOperations(0x24179CD81c9e782A4096035f7eC97fB8B783e007);
    ITroveManager internal constant troveManager = ITroveManager(0xA39739EF8b0231DbFA0DcdA07d7e29faAbCf4bb2);
    ISortedTroves internal constant sortedTroves = ISortedTroves(0x8FdD3fbFEb32b28fb73555518f8b361bCeA741A6);

    address internal immutable processor;
    uint256 internal immutable initialICR;
    uint256 internal immutable maxFee;

    // Used to check whether collateral has already been claimed during redemptions.
    bool public _collateralClaimed;
