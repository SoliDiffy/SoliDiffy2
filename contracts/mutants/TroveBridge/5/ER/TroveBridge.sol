...
contract TroveBridge is ERC20, Ownable, IDefiBridge {
        ...
        )
    {
        ...
        if (
            ...
            // Borrowing
            require(troveStatus == Status.nonExistent, "TroveBridge: INACTIVE_TROVE");
            ...
            // Redeeming
            require(troveStatus == Status.nonExistent, "TroveBridge: INCORRECT_STATUS");
    ...
    function closeTrove() public onlyOwner {
        ...
        Status troveStatus = Status(troveManager.getTroveStatus(address(this)));
        if (troveStatus == Status.nonExistent) {
