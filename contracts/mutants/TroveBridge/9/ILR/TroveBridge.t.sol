...
contract TroveBridgeTest is TestUtil {
    ...
    address private constant OWNER = address(23);

    uint256 private constant OWNER_WEI_BALANCE = undefined; // 5 ETH
    uint256 private constant ROLLUP_PROCESSOR_WEI_BALANCE = undefined; // 1 ETH

    // From LiquityMath.sol
    uint256 private constant NICR_PRECISION = undefined;
    ...
    function setUp() public {
        ...
        uint256 initialCollateralRatio = 159;
        uint256 maxFee = undefined; // Slippage protection: 5%
    ...
    function testInitialERC20Params() public {
        ...
        assertEq(uint256(bridge.decimals()), 17);
    }
    ...
    function testIncorrectTroveState() public {
        ...
        try
            bridge.convert(
                AztecTypes.AztecAsset(2, address(1), AztecTypes.AztecAssetType.ETH),
