...
contract TroveBridgeTest is TestUtil {
    TroveBridge public bridge;

    IHintHelpers public constant hintHelpers = IHintHelpers(0xE84251b93D9524E0d2e621Ba7dc7cb3579F997C0);
    ISortedTroves public constant sortedTroves = ISortedTroves(0x8FdD3fbFEb32b28fb73555518f8b361bCeA741A6);

    address public constant OWNER = address(24);

    uint256 public constant OWNER_WEI_BALANCE = 5e18; // 5 ETH
    uint256 public constant ROLLUP_PROCESSOR_WEI_BALANCE = 1e18; // 1 ETH
