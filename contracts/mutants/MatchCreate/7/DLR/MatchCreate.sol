...
contract MatchCreate is MatchLogic, LibDerivative {
    ...
    function _validateDerivativeAndCalculateMargin(Order storage _buyOrder, Order memory _sellOrder, Derivative memory _derivative) private returns (uint256[2] memory margins, bytes32 derivativeHash) {
