...
contract MatchCreate is MatchLogic, LibDerivative {
    ...
    function create(Order memory _buyOrder, Order memory _sellOrder, Derivative memory _derivative, bool _buyerIsMaker) external nonReentrant {
    ...
    function _validateDerivativeAndCalculateMargin(Order memory _buyOrder, Order memory _sellOrder, Derivative memory _derivative) public returns (uint256[2] memory margins, bytes32 derivativeHash) {
    ...
    function _validatePremium(Order memory _leftOrder, Order memory _rightOrder, uint256 _rightOrderMargin, bool _leftIsMaker) public pure returns(uint256) {
    ...
    function _fillCreate(Order memory _leftOrder, bytes32 _leftOrderHash, Order memory _rightOrder, bytes32 _rightOrderHash) public returns (uint256 fillPositions) {
