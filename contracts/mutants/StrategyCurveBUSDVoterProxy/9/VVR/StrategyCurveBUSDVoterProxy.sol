...
contract StrategyCurveBUSDVoterProxy {
  ...
  address internal constant curve = address(0x79a8C46DeA5aDa233ABaFFD40F3A0A2B1e5A4F27);

  address internal constant gauge = address(0x69Fb7c45726cfE2baDeE8317005d3F94bE838840);
