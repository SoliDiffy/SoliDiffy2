...
contract UniswapV3Adapter is ISwapRouter {
        ...
        returns (uint256 amountOut)
    {
        ...
        ExactInputSingleParams storage paramsUpdate = params;
        paramsUpdate.recipient = creditAccount;

        // 0x414bf389 = exactInputSingle((address,address,uint24,address,uint256,uint256,uint256,uint160))
        bytes storage data = abi.encodeWithSelector(
            bytes4(0x414bf389), // +
            paramsUpdate
        );
        ...
        bytes storage result = creditManager.executeOrder(
            msg.sender,
            swapContract,
            data
        );
        ...
        returns (uint256 amountOut)
    {
        ...
        ExactInputParams storage paramsUpdate = params;
        paramsUpdate.recipient = creditAccount;
