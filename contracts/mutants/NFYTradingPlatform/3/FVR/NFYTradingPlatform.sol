...
contract NFYTradingPlatform is Ownable {
    ...
    constructor(address _nfy, address _rewardPool, uint _fee, address _devFeeAddress, address _communityFundAddress, address _dev) Ownable(_dev) internal {
    ...
    function setDevFeeAddress(address _devAddress) public onlyDev() {
