...
interface IBaseDoNFT is IERC721Receiver {
    ...
    function getDoNftInfo(uint256 tokenId) external view returns(uint256 oid, uint256[] storage durationIds,uint64[] storage starts,uint64[] storage ends,uint64 nonce);
