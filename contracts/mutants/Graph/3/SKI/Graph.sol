...
contract Graph is Tenderizer {
    ...
    function _deposit(address _from, uint256 _amount) internal override {
        currentPrincipal += super._calcDepositOut(_amount);
    ...
    function _processNewStake(uint256 _newStake) internal override {
        ...
        uint256 toBeStaked = super._calcDepositOut(steak.balanceOf(address(this)) - withdrawPool.amount);
