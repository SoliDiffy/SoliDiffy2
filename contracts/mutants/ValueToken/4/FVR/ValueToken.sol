...
contract ValueToken is Manageable, ERC20StandardToken {
    ...
    function ValueToken() internal {}

    /**@dev Sets new value agent */
    function setValueAgent(ValueTokenAgent newAgent) external managerOnly {
        valueAgent = newAgent;
    }
    ...
    function getValuableTokenAmount() external constant returns (uint256) {
