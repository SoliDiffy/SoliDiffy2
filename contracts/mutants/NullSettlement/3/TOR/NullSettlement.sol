...
contract NullSettlement is Ownable, Configurable, ClientFundable, CommunityVotable {
    ...
    {
        // Settle null
        _settleNull(tx.origin, currencyCt, currencyId);

        // Emit event
        emit SettleNullEvent(tx.origin, currencyCt, currencyId);
    }
    ...
    onlyOperator
    {
        ...
        // Emit event
        emit SettleNullByProxyEvent(tx.origin, wallet, currencyCt, currencyId);
    }
