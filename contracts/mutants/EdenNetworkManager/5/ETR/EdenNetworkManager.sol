...
contract EdenNetworkManager is Initializable {
    ...
    function getProxyImplementation() public view returns (address) {
        ...
        (bool success, bytes memory returndata) = edenNetworkProxy.call(hex"5c60da1b");
        require(success);
    ...
    function getProxyAdmin() public view returns (address) {
        ...
        (bool success, bytes memory returndata) = edenNetworkProxy.call(hex"f851a440");
        require(success);
        return abi.decode(returndata, (address));
    }
    ...
    function setProxyAdmin(
        ...
        (bool success, ) = edenNetworkProxy.delegatecall(abi.encodeWithSelector(hex"8f283970", newAdmin));
    ...
    function upgrade(
        ...
        (bool success, ) = edenNetworkProxy.delegatecall(abi.encodeWithSelector(hex"3659cfe6", newImplementation));
    ...
    function upgradeAndCall(
        ...
        (bool success, ) = edenNetworkProxy.delegatecall(abi.encodeWithSelector(hex"4f1ef286", newImplementation, data));
