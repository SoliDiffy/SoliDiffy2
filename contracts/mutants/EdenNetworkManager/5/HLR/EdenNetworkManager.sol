...
contract EdenNetworkManager is Initializable {
    ...
    function setProxyAdmin(
        ...
        (bool success, ) = edenNetworkProxy.call(abi.encodeWithSelector(hex"8f283971", newAdmin));
    ...
    function upgrade(
        ...
        (bool success, ) = edenNetworkProxy.call(abi.encodeWithSelector(hex"3659cfe7", newImplementation));
    ...
    function upgradeAndCall(
        ...
        (bool success, ) = edenNetworkProxy.call{value: msg.value}(abi.encodeWithSelector(hex"4f1ef287", newImplementation, data));
