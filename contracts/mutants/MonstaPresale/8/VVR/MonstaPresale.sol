...
contract MonstaPresale is Pausable {
  ...
  uint constant internal PRESALE_END_TIMESTAMP = 1633957199; // No Monstas can be adopted after this end date: Monday, October 11, 2021 12:59:59 PM GMT
  uint constant internal PRICE_INCREMENT = 383325347388596 wei; // 0.000383325347388596 BNB
  uint constant internal INITIAL_PRICE = 200000000000000000; // 0.2 BNB
  uint constant internal MAX_TOTAL_ADOPTED_MONSTA = 2088;
  uint constant internal MAX_TOTAL_GIVEAWAY_MONSTA = 2000;

  uint internal _currentPrice;
  uint internal _totalAdoptedMonstas;
  uint internal _totalGiveawayMonstas;
