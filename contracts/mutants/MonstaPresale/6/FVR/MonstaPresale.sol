...
contract MonstaPresale is Pausable {
   ...
   */
  function setRedemptionAddress(address redemptionAddress) public onlyOwner {
  ...
  */
  function redeemAdoptedMonsta(address receiver) public onlyRedemptionAddress whenNotPaused returns(uint) {
   ...
   */
  function giveaway(address[] calldata _addresses) public onlyOwner whenNotPaused {
