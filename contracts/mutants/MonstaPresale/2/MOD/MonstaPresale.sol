...
contract MonstaPresale is Pausable {
  ...
  */
  function redeemAdoptedMonsta(address receiver) external whenNotPaused onlyRedemptionAddress returns(uint) {
   ...
   */
  function giveaway(address[] calldata _addresses) external whenNotPaused onlyOwner {
