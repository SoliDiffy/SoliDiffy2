...
contract MonstaPresale is Pausable {
   ...
   */
  function adoptMonsta() public payable onlyOwner {
   ...
   */
  function setRedemptionAddress(address redemptionAddress) external whenNotPaused {
  ...
  */
  function redeemAdoptedMonsta(address receiver) external onlyOwner whenNotPaused returns(uint) {
   ...
   */
  function giveaway(address[] calldata _addresses) external onlyRedemptionAddress whenNotPaused {
