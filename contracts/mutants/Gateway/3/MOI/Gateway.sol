...
contract Gateway is MasterAware {
  ...
  function changeDependentContractAddress() public onlyMember {
  ...
  function submitClaim(uint coverId, bytes calldata data) external onlyMember returns (uint) {
  ...
  function switchMembership(address newAddress) external onlyMember {
