...
contract TestLibBytes {
    ...
    function externalPopLastByte(bytes memory b)
        public
        pure
    ...
    function externalPopLast20Bytes(bytes memory b)
        public
        pure
    ...
    function externalEquals(bytes memory lhs, bytes memory rhs)
        public
        pure
        returns (bool equal)
    {
    ...
    function externalEqualsPop1(bytes memory lhs, bytes memory rhs)
        public
        pure
        returns (bool equal)
    {
    ...
    function externalDeepCopyBytes(
        bytes memory dest,
        bytes memory source
    )
        public
