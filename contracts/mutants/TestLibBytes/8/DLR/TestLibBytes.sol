...
contract TestLibBytes {
    ...
    function publicPopLastByte(bytes storage b)
        public
        pure
        returns (bytes storage, bytes1 result)
    {
    ...
    function publicPopLast20Bytes(bytes storage b)
        public
        pure
        returns (bytes storage, address result)
    {
    ...
    function publicEquals(bytes storage lhs, bytes storage rhs)
        public
        pure
        returns (bool equal)
    {
    ...
    function publicEqualsPop1(bytes storage lhs, bytes storage rhs)
        public
        pure
        returns (bool equal)
    {
