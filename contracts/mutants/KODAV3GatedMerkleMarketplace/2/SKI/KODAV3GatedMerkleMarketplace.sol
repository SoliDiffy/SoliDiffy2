...
contract KODAV3GatedMerkleMarketplace is BaseUpgradableMarketplace, IKODAV3GatedMerkleMarketplace {
    ...
    function merkleMint(
        ...
        require(super.onPhaseMerkleList(_saleId, _phaseId, _msgSender(), _phase, _merkleProof), 'address not able to mint from sale');
    ...
    function remainingMerklePhaseMintAllowance(
        ...
        require(super.onPhaseMerkleList(_saleId, _phaseId, _account, _phase, _merkleProof), 'address not able to mint from sale');
