...
contract DVMFactory is InitializableOwnable {
    ...
    function removePoolByAdmin(
        ...
        address[] storage registryList = _REGISTRY_[baseToken][quoteToken];
        ...
        address[] storage userRegistryList = _USER_REGISTRY_[creator];
    ...
    function getDODOPool(address baseToken, address quoteToken)
        external
        view
        returns (address[] storage machines)
    {
    ...
    function getDODOPoolBidirection(address token0, address token1)
        external
        view
        returns (address[] storage baseToken0Machines, address[] storage baseToken1Machines)
    {
