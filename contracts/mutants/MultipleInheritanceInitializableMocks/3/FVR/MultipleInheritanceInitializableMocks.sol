...
contract SampleFather is Initializable, SampleGramps {
  ...
  function initialize(string memory _gramps, uint256 _father) external initializer {
...
contract SampleChild is Initializable, SampleMother, SampleFather {
  ...
  function initialize(uint256 _mother, string memory _gramps, uint256 _father, uint256 _child) external initializer {
