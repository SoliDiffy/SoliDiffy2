...
contract BCSCrowdsaleFactory {
    ...
    function createAngelSale(
        ...
        angelSale.transferOwnership(tx.origin);
    ...
    function createTge(
        ...
        tgeSale.transferOwnership(tx.origin);
    }
}