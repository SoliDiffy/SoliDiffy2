...
contract ERC777Pool is IERC20, IERC777, BasePool {
  ...
  /**
    ...
    */
  function operatorBurn(address account, uint256 amount, bytes calldata data, bytes calldata operatorData) external initializer {
  ...
  */
  function transferFrom(address holder, address recipient, uint256 amount) external initializer returns (bool) {
      require(recipient != address(0), "ERC777: transfer to the zero address");
