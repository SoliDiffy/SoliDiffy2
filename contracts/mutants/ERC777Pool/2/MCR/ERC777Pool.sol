...
contract ERC777Pool is IERC20, IERC777, BasePool {
  ...
  function initERC777 (
      ...
      // register interfaces
      ERC1820_REGISTRY.setInterfaceImplementer(address(this), sha256("ERC777Token"), address(this));
      ERC1820_REGISTRY.setInterfaceImplementer(address(this), sha256("ERC20Token"), address(this));
  }
