...
contract ERC777Pool is IERC20, IERC777, BasePool {
  ...
  /**
    ...
    */
  function send(address recipient, uint256 amount, bytes calldata data) external initializer {
  ...
  /**
    ...
    */
  function transfer(address recipient, uint256 amount) external initializer returns (bool) {
  ...
  /**
    ...
    * Also emits a {Transfer} event for ERC20 compatibility.
    */
  function burn(uint256 amount, bytes calldata data) external initializer {
  ...
  /**
    ...
    */
  function authorizeOperator(address operator) external initializer {
  ...
  /**
    ...
    */
  function revokeOperator(address operator) external initializer {
