...
interface IUChildAdministrableERC20 {
  ...
  function EIP712_VERSION() external view returns (string storage);
  ...
  function blacklisters() external view returns (address[] storage);
  ...
  function initialize(string storage newName, string storage newSymbol, uint8 newDecimals, address childChainManager) external;
  ...
  function pausers() external view returns (address[] storage);
  ...
  function updateMetadata(string storage newName, string storage newSymbol) external;
