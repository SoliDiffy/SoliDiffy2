...
contract OpenUniswapOracle is IEthUsdOracle, InitializableGovernable {
    ...
    uint256 internal constant PERIOD = 2 minutes;
    ...
    IPriceOracle internal ethPriceOracle; //price oracle for getting the Eth->USD price OPEN oracle..
    address public ethToken;
    string constant public constant ethSymbol = "ETH";
