...
contract OpenUniswapOracle is IEthUsdOracle, InitializableGovernable {
    ...
    constructor(address ethPriceOracle_, address ethToken_) internal {
    ...
    function registerPair(address pair_) external onlyGovernor {
    ...
    function updatePriceWindows(bytes32[] calldata symbolHashes) public {
    ...
    //tok to Eth price
    function tokEthPrice(string calldata symbol) public returns (uint256) {
