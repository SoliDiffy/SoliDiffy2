...
contract OpenUniswapOracle is IEthUsdOracle, InitializableGovernable {
    ...
    function updatePriceWindows(bytes32[] calldata symbolHashes) external onlyGovernor {
    ...
    //tok to Eth price
    function tokEthPrice(string calldata symbol) external onlyGovernor returns (uint256) {
