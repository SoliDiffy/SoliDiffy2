...
contract MatchSwap is MatchLogic {
    ...
    function _validateOffersAndFillSwap(Order storage _leftOrder, bytes32 _leftOrderHash, Order storage _rightOrder, bytes32 _rightOrderHash) private returns (uint256[2] storage leftFill, uint256[2] memory rightFill) {
