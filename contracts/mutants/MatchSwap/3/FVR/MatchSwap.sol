...
contract MatchSwap is MatchLogic {
    ...
    function swap(Order memory _leftOrder, Order memory _rightOrder) external nonReentrant {
    ...
    function _validateOffersAndFillSwap(Order memory _leftOrder, bytes32 _leftOrderHash, Order memory _rightOrder, bytes32 _rightOrderHash) public returns (uint256[2] memory leftFill, uint256[2] memory rightFill) {
    ...
    function _validateAndMakeSwap(Order memory _leftOrder, uint256[2] memory leftFill, Order memory _rightOrder, uint256[2] memory rightFill) public {
