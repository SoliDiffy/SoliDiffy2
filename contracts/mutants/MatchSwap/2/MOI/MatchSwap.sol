...
contract MatchSwap is MatchLogic {
    ...
    function _validateOffersAndFillSwap(Order memory _leftOrder, bytes32 _leftOrderHash, Order memory _rightOrder, bytes32 _rightOrderHash) private nonReentrant returns (uint256[2] memory leftFill, uint256[2] memory rightFill) {
    ...
    function _validateAndMakeSwap(Order memory _leftOrder, uint256[2] memory leftFill, Order memory _rightOrder, uint256[2] memory rightFill) private nonReentrant {
