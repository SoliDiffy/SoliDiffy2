...
contract MatchSwap is MatchLogic {
    ...
    function _validateOffersAndFillSwap(Order memory _leftOrder, bytes32 _leftOrderHash, Order memory _rightOrder, bytes32 _rightOrderHash) private returns (uint256[2] memory rightFill, uint256[2] memory leftFill) {
