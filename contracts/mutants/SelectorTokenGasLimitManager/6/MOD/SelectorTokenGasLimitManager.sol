...
contract SelectorTokenGasLimitManager is OwnableModule {
     ...
     */
    function setRequestGasLimit(uint256 _gasLimit) external  validGasLimit(_gasLimit) {
        defaultGasLimit = _gasLimit;
    }
     ...
     * @param _gasLimit the gas limit for the message execution.
     */
    function setRequestGasLimit(bytes4 _selector, uint256 _gasLimit) external  validGasLimit(_gasLimit) {
    ...
    function setRequestGasLimit(
        ...
        address _token,
        uint256 _gasLimit
    ) external  validGasLimit(_gasLimit) {
     ...
     * Only the owner can call this method.
     */
    function setCommonRequestGasLimits(uint256[] calldata _gasLimits) external  validGasLimits(7, _gasLimits) {
