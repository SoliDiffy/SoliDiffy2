...
contract DataStorage {
    uint256 constant N_PETS = 8;
    uint256 constant N_EGGS = 5;
    uint256 constant BASE_POWER = 9999;
    uint256 constant MULTIPLIER = 14;
    uint256 constant PRECISION = 9;
    ...
    constructor() {
        pandoBoxCreating = [8999999999 , 700000000, 200000000, 75000000, 20000000, 5000000];
        droidBotCreating[1][1] = 8999999999;
