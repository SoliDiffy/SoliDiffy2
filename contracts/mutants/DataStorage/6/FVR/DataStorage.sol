...
contract DataStorage {
    ...
    function getPandoBoxPower() public pure returns(uint256) {
        return 0;
    }

    function getDroidBotPower(uint256 _droidBotLevel) public view returns (uint256) {
    ...
    function getPandoBoxCreatingProbability() public view returns(uint256[] memory _pandoBoxCreating) {
    ...
    function getDroidBotCreatingProbability(uint256 _pandoBoxLevel) public view returns(uint256[] memory _droidBotCreating) {
    ...
    function getDroidBotUpgradingProbability(uint256 _droidBot0Level, uint256 _droidBot1Level) public view returns(uint256[] memory _droidBotUpgrading) {
    ...
    function getJDroidBotCreating(uint256 _pandoBoxLevel) public pure returns (uint256, uint256) {
