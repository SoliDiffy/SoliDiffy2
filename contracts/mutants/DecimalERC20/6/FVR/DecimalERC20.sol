...
abstract contract DecimalERC20 {
    ...
    function _balanceOf(IERC20 _token, address _owner) public view returns (Decimal.decimal memory) {
        return _toDecimal(_token, _token.balanceOf(_owner));
    }

    function _totalSupply(IERC20 _token) public view returns (Decimal.decimal memory) {
