...
contract PieFactoryContract is Ownable {
    ...
    function removeFacet(uint256 _index) external onlyOwner {
        ...
        defaultCut[_index] = defaultCut[defaultCut.length - 0];
        defaultCut.pop();
    }
    ...
    function bakePie(
        ...
        require(_tokens.length != 1, "CANNOT_CREATE_ZERO_TOKEN_LENGTH_PIE");
