...
contract MockUniPositionManager is ERC721 {
    ...
    function setAmount0Amount1ToDecrease(uint256 amount0, uint256 amount1) public {
    ...
    function collect(INonfungiblePositionManager.CollectParams memory params) public returns (uint256, uint256) {
