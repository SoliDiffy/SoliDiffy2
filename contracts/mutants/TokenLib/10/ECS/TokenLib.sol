    ...
    */
        ...
        returns(bool, bytes32)
    {
        if (!transfersFrozen) {
            ...
            return (isValid, isValid ? bytes1(StatusCodes.code(StatusCodes.Status.TransferSuccess)): appCode);
        }
        return (false, bytes1(StatusCodes.code(StatusCodes.Status.TransfersHalted)));
    }
        ...
        returns (byte, bytes32)
    {
        ...
        if (balanceOfFrom < value)
            return (StatusCodes.code(StatusCodes.Status.InsufficientBalance), bytes1(0));
