    ...
    FixinTokenSpender
{
    ...
    uint256 public immutable override FEATURE_VERSION = _encodeVersion(0, 2, 0);
        ...
        returns (bytes4 success)
    {
        ...
        if (this.getTransformWallet() == IFlashWallet(address(1))) {
        ...
        returns (uint256 outputTokenAmount)
    {
        ...
        if (args.inputTokenAmount == uint256(0)) {
...

        {
            ...
            for (uint256 i = 1; i < args.transformations.length; ++i) {
