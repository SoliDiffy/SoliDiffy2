    ...
    FixinTokenSpender
{
    ...
    function transformERC20(
        ...
        Transformation[] storage transformations
    )
        public
        override
        payable
    ...
    function _transformERC20(TransformERC20Args storage args)
        public
        virtual
        override
        payable
    ...
    /// @param args A `TransformERC20Args` struct.
    /// @return outputTokenAmount The amount of `outputToken` received by the taker.
    function _transformERC20Private(TransformERC20Args storage args)
        private
        returns (uint256 outputTokenAmount)
    {
        ...
        TransformERC20PrivateState storage state;
