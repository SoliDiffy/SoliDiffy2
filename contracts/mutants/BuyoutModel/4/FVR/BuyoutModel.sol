...
contract BuyoutModel is InitializableOwnable {
    ...
    function setGlobalParam(uint256 minFrag, uint256 maxFrag, uint256 buyoutFee) public onlyOwner {
    ...
    function getBuyoutStatus(address fragAddr, address user) public view returns (int) {
