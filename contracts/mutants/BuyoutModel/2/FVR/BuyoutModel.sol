...
contract BuyoutModel is InitializableOwnable {
    ...
    function addFragInfo(address fragAddr, uint256 minFrag, uint256 maxFrag, address buyoutAddr) public onlyOwner {
    ...
    function setFragInfo(address fragAddr, uint256 minFrag, uint256 maxFrag, address buyoutAddr) public onlyOwner {
