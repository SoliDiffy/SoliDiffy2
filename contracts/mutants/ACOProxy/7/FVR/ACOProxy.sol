...
contract ACOProxy {
    ...
    constructor(address _admin, address _implementation, bytes memory _initdata) internal {
        _setAdmin(_admin);
     ...
     */
    function transferProxyAdmin(address newAdmin) public onlyAdmin {
        _setAdmin(newAdmin);
    }
     ...
     */
    function setImplementation(address newImplementation, bytes calldata initData) public onlyAdmin {
