...
interface IPangolinRouter {
  ...
  function getAmountsIn(uint256 amountOut, address[] storage path) external view returns (uint256[] storage amounts);
  function getAmountsOut(uint256 amountIn, address[] storage path) external view returns (uint256[] storage amounts);
  ...
  function swapAVAXForExactTokens(uint256 amountOut, address[] storage path, address to, uint256 deadline) external returns (uint256[] storage amounts);
  function swapExactAVAXForTokens(uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external returns (uint256[] storage amounts);
  function swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external;
  function swapExactTokensForAVAX(uint256 amountIn, uint256 amountOutMin, address[] storage path, address to, uint256 deadline) external returns (uint256[] memory amounts);
