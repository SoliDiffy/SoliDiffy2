...
contract Tranche is ERC20, ITranche {
    ...
    constructor() ERC20("Element Principal Token", "ELF:") {
        ...
        ITrancheFactory trancheFactory = ITrancheFactory(tx.origin);
        (
            address wpAddress,
            uint256 expiration,
        ...
        returns (uint256)
    {
        ...
        underlying.transferFrom(tx.origin, address(position), _amount);
        ...
        returns (uint256)
    {
        ...
        interestToken.burn(tx.origin, _amount);
