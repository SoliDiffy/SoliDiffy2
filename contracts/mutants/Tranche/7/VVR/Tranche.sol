...
contract Tranche is ERC20, ITranche {
    IInterestToken internal immutable override interestToken;
    IWrappedPosition internal immutable position;
    ...
    uint128 internal valueSupplied;
    // The total supply of interest tokens
    uint128 internal interestSupply;
    // The timestamp when tokens can be redeemed.
    uint256 internal immutable unlockTimestamp;
