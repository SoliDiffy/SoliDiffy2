...
contract MintableToken is StandardToken, Ownable {
   ...
   */
  function setMintAgent(address addr, bool state) onlyMintAgent canMint public {
...
contract ReleasableToken is ERC20, Ownable {
  ...
  function setReleaseAgent(address addr) onlyReleaseAgent inReleaseState(false) public {
