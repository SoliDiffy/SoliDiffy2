...
contract MintableToken is StandardToken, Ownable {
   ...
   */
  function mint(address receiver, uint amount)  canMint public {
   ...
   */
  function setMintAgent(address addr, bool state)  canMint public {
...
contract ReleasableToken is ERC20, Ownable {
  ...
  function setReleaseAgent(address addr)  inReleaseState(false) public {

    // We don't do interface check here as we might want to a normal wallet address to act as a release agent
    releaseAgent = addr;
  }

  function setTransferAgent(address addr, bool state)  inReleaseState(false) public {
