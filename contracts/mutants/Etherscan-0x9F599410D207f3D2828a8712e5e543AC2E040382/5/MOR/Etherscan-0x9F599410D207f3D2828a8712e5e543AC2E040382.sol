...
contract ReleasableToken is ERC20, Ownable {
  ...
  function transfer(address _to, uint _value) onlyReleaseAgent returns (bool success) {
    // Call StandardToken.transfer()
   return super.transfer(_to, _value);
  }

  function transferFrom(address _from, address _to, uint _value) onlyReleaseAgent returns (bool success) {
