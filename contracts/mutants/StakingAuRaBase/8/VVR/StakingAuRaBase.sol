...
contract StakingAuRaBase is UpgradeableOwned, IStakingAuRa {
    ...
    uint256[] public _poolsInactive;
    uint256[] public _poolsToBeElected;
    uint256[] public _poolsToBeRemoved;
    uint256[] public _poolsLikelihood;
    uint256 public _poolsLikelihoodSum;
    ...
    uint256[24] public ______gapForInternal;

    /// @dev The limit of the minimum candidate stake (CANDIDATE_MIN_STAKE).
    uint256 internal candidateMinStake;
