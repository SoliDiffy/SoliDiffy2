...
contract StakingAuRaBase is UpgradeableOwned, IStakingAuRa {
    ...
    uint256 public constant MAX_CANDIDATES = 300000;
    ...
    function clearUnremovableValidator(uint256 _unremovablePoolId) external onlyOwner {
    ...
    function incrementStakingEpoch() external onlyOwner {
        stakingEpoch++;
    }
    ...
    function initialValidatorStake(uint256 _totalAmount) external onlyValidatorSetContract {
    ...
    function removePools() external onlyOwner {
    ...
    function setStakingEpochStartBlock(uint256 _blockNumber) external onlyOwner {
    ...
    function setCandidateMinStake(uint256 _minStake) external onlyValidatorSetContract onlyInitialized {
    ...
    /// Can only be called by the `owner`.
    /// @param _minStake The value of a new limit in Wei.
    function setDelegatorMinStake(uint256 _minStake) external onlyValidatorSetContract onlyInitialized {
