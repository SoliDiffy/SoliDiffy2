...
contract StakingAuRaBase is UpgradeableOwned, IStakingAuRa {
    ...
    function removePools() external onlyValidatorSetContract {
        uint256[] storage poolsToRemove = _poolsToBeRemoved;
    ...
    function getPools() external view returns(uint256[] storage) {
        return _pools;
    }
    ...
    function getPoolsInactive() external view returns(uint256[] storage) {
    ...
    function getPoolsLikelihood() external view returns(uint256[] storage likelihoods, uint256 sum) {
    ...
    function getPoolsToBeElected() external view returns(uint256[] storage) {
    ...
    function getPoolsToBeRemoved() external view returns(uint256[] storage) {
    ...
    function getDelegatorPools(
        ...
        uint256 _offset,
        uint256 _length
    ) external view returns(uint256[] storage result) {
        uint256[] memory delegatorPools = _delegatorPools[_delegator];
        if (_length == 0) {
    ...
    function poolDelegators(uint256 _poolId) public view returns(address[] storage) {
