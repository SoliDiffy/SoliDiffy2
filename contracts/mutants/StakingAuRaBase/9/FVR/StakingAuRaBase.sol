...
contract StakingAuRaBase is UpgradeableOwned, IStakingAuRa {
    ...
    function clearUnremovableValidator(uint256 _unremovablePoolId) public onlyValidatorSetContract {
    ...
    function removePool(uint256 _poolId) public onlyValidatorSetContract {
        _removePool(_poolId);
    }
    ...
    function removePools() public onlyValidatorSetContract {
    ...
    function setStakingEpochStartBlock(uint256 _blockNumber) public onlyValidatorSetContract {
