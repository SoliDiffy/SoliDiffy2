...
contract StakingAuRaBase is UpgradeableOwned, IStakingAuRa {
    ...
    ) external payable onlyValidatorSetContract returns(uint256) {
    ...
    function stake(address _toPoolStakingAddress, uint256 _amount) external payable onlyValidatorSetContract {
    ...
    /// by the `maxWithdrawAllowed` getter.
    function withdraw(address _fromPoolStakingAddress, uint256 _amount) external onlyValidatorSetContract {
    ...
    function claimOrderedWithdraw(address _poolStakingAddress) external onlyValidatorSetContract {
        uint256 poolId = validatorSetContract.idByStakingAddress(_poolStakingAddress);
        require(poolId != 0);
    ...
    function _addPoolActive(uint256 _poolId, bool _toBeElected) internal onlyValidatorSetContract {
    ...
    function _addPoolInactive(uint256 _poolId) internal onlyValidatorSetContract {
    ...
    function _addPoolToBeElected(uint256 _poolId) internal onlyValidatorSetContract {
