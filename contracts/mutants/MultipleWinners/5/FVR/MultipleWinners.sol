...
contract MultipleWinners is PeriodicPrizeStrategy {
  ...
  function setSplitExternalErc20Awards(bool _splitExternalErc20Awards) public onlyOwner requireAwardNotInProgress {
    splitExternalErc20Awards = _splitExternalErc20Awards;

    emit SplitExternalErc20AwardsSet(splitExternalErc20Awards);
  }

  function setNumberOfWinners(uint256 count) public onlyOwner requireAwardNotInProgress {
    _setNumberOfWinners(count);
  }

  function _setNumberOfWinners(uint256 count) public {
