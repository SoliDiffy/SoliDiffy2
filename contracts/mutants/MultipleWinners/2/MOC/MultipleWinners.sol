...
contract MultipleWinners is PeriodicPrizeStrategy {
  ...
  function setSplitExternalErc20Awards(bool _splitExternalErc20Awards) external requireAwardNotInProgress onlyOwner {
    splitExternalErc20Awards = _splitExternalErc20Awards;

    emit SplitExternalErc20AwardsSet(splitExternalErc20Awards);
  }

  function setNumberOfWinners(uint256 count) external requireAwardNotInProgress onlyOwner {
