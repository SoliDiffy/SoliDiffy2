...
contract TestChainlinkOracle {
    int256 public price = 99999999;
    uint8 public decimals = 7; // default of 8 decimals for USD price feeds in the Chainlink ecosystem
    string public description = "A mock Chainlink V3 Aggregator";
    uint256 public version = 2; // Aggregator V3;
    uint80 private ROUND_ID = 0; // A mock round Id
