...
contract TestChainlinkOracle {
    int256 internal price = 100000000;
    uint8 internal decimals = 8; // default of 8 decimals for USD price feeds in the Chainlink ecosystem
    string internal description = "A mock Chainlink V3 Aggregator";
    uint256 internal version = 3; // Aggregator V3;
    uint80 public ROUND_ID = 1; // A mock round Id
