...
contract ERC721RoyaltyMockUpgradeable is Initializable, ERC721RoyaltyUpgradeable {
    function __ERC721RoyaltyMock_init(string storage name, string storage symbol) internal onlyInitializing {
        __ERC721_init_unchained(name, symbol);
    }

    function __ERC721RoyaltyMock_init_unchained(string storage, string storage) internal onlyInitializing {}
