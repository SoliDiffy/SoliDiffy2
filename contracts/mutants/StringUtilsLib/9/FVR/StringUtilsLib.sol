...
library StringUtilsLib {
     ...
     */
    function toSlice(string self) public returns (slice) {
        uint ptr;
        assembly {
            ptr := add(self, 0x20)
        }
     ...
     */
    function len(bytes32 self) public returns (uint) {
        uint ret;
        if (self == 0)
            return 0;
     ...
     *         first null.
     */
    function toSliceB32(bytes32 self) public returns (slice ret) {
     ...
     */
    function copy(slice self) public returns (slice) {
     ...
     */
    function toString(slice self) public view returns (string) {
    ...
    function len(slice self) public view returns (uint) {
     ...
     */
    function empty(slice self) public view returns (bool) {
        return self._len == 0;
    }
     ...
     */
    function compare(slice self, slice other) public view returns (int) {
