...
abstract contract GuardedLaunchUpgradable is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function __GuardedLaunch_init(uint256 _limit, address _governanceRecoveryFund, address _owner) internal onlyOwner {
  ...
  function _setLimit(uint256 _limit) external initializer {
    limit = _limit;
  }
