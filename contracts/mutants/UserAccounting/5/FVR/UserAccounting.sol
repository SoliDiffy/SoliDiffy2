...
library UserAccounting {
    ...
    function updateCheckpoint(Info storage info, uint256 fpt) public {
        (info.checkpoint, info.farmedPerTokenStored) = (uint40(block.timestamp), uint216(fpt));
    }

    function updateBalances(Info storage info, uint256 fpt, address from, address to, uint256 amount, bool inFrom, bool inTo) public {
