...
// ####################################
    ...
    function supportNewAsset(address asset_, address source_) onlyLendingPoolManager external  {  //
    ...
    function setAssetSources(address[] calldata _assets, address[] calldata _sources) public onlyLendingPoolManager {
    ...
    function setFallbackOracle(address _fallbackOracle) onlyLendingPoolManager public  {  //
...
// ##############################
    ...
    /// @param _assets The addresses of the assets
    /// @param _sources The address of the source of each asset
    function publicSetAssetsSources(address[] memory _assets, address[] memory _sources) internal {
    ...
    /// @param _fallbackOracle The address of the fallbackOracle
    function publicSetFallbackOracle(address _fallbackOracle) internal {
...
// ##########################
    ...
    function getAssetsPrices(address[] calldata _assets) public view returns(uint256[] memory) {
    ...
    function getSourceOfAsset(address _asset) public view returns(address) {
