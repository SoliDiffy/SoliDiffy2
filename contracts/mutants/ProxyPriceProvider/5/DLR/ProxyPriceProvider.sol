...
// ####################################
    ...
    function supportNewAsset(address asset_, address source_) onlyLendingPoolManager public  {  //
        ...
        address[] storage sources = new address[](1) ;
        assets[0] = asset_;
        sources[0] = source_;
...
// ##############################
    ...
    /// @param _assets The addresses of the assets
    /// @param _sources The address of the source of each asset
    function internalSetAssetsSources(address[] storage _assets, address[] storage _sources) internal {
...
// ##########################
    ...
    function getAssetsPrices(address[] calldata _assets) external view returns(uint256[] storage) {
