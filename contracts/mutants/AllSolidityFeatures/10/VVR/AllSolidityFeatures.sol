...
contract C {
  uint248 public x; // 31 bytes: slot 0, offset 0
  uint16 public y; // 2 bytes: slot 1, offset 0 (does not fit in slot 0)
  uint240 public z; // 30 bytes: slot 1, offset 2 bytes
  uint8 public a; // 1 byte: slot 2, offset 0 bytes
  struct S {
