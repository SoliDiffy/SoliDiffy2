...
contract KeeperMulticall is Initializable, AccessControlUpgradeable {
    ...
    function _executeAction(Action memory action) public returns (bytes memory) {
        bool success;
    ...
    function payFlashbots(uint256 value) external payable onlyRole(KEEPER_ROLE) returns (bytes memory) {
        //solhint-disable-next-line
    ...
    function finalBalanceCheck(IERC20[] memory tokens, uint256[] memory minBalances) public view returns (bool) {
