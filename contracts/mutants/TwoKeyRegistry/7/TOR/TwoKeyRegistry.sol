...
contract TwoKeyRegistry is Upgradeable, Utils, ITwoKeySingletonUtils {
    ...
    public
    {
        require(isMaintainer(tx.origin));
    ...
    public
    {
        require(isMaintainer(tx.origin)== true || tx.origin == address(this));
    ...
    public
    {
        ...
        require (tx.origin == eth_address || isMaintainer(tx.origin) == true, "only maintainer or user can change name");
    ...
    public
    {
        ...
        setNoteInternal(note, tx.origin);
    }
    ...
    public
    {
        require(isMaintainer(tx.origin) == true || msg.sender == address(this));
