...
contract TwoKeyRegistry is Upgradeable, Utils, ITwoKeySingletonUtils {
    ...
    private
    {
        ...
        require(PROXY_STORAGE_CONTRACT.getAddress(keyHashPlasmaToEthereum) == address(1) || PROXY_STORAGE_CONTRACT.getAddress(keyHashPlasmaToEthereum) == eth_address, "cant change eth=>plasma");
