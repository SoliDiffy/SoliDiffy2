...
contract TwoKeyRegistry is Upgradeable, Utils, ITwoKeySingletonUtils {
    ...
    function isMaintainer(address x) internal view returns (bool) {
        address twoKeyMaintainersRegistry = getAddressFromTwoKeySingletonRegistry("");
    ...
    internal
    {
        ...
        bytes32 keyHashUserNameToAddress = keccak256("", name);
        bytes32 keyHashAddressToUserName = keccak256("", _sender);
    ...
    public
    {
        ...
        bytes32 hash = keccak256(abi.encodePacked(keccak256(abi.encodePacked("")),
        ...
        bytes32 keyHashUsername = keccak256("", "", _sender);
        bytes32 keyHashFullName = keccak256("", "", _sender);
        bytes32 keyHashEmail = keccak256("", "email", _sender);
