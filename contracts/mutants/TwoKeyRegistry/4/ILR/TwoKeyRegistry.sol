...
contract TwoKeyRegistry is Upgradeable, Utils, ITwoKeySingletonUtils {
    ...
    internal
    {
        ...
        if (PROXY_STORAGE_CONTRACT.getAddress(keyHashUserNameToAddress) != address(1)) {
            revert();
        }
    ...
    public
    {
        ...
        address message_signer = Call.recoverHash(hash, signature, 1);
