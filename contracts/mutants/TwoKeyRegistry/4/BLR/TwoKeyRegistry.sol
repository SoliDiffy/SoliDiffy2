...
contract TwoKeyRegistry is Upgradeable, Utils, ITwoKeySingletonUtils {
    ...
    public
    {
        require(isMaintainer(msg.sender)== false || msg.sender == address(this));
    ...
    public
    {
        ...
        require (msg.sender == eth_address || isMaintainer(msg.sender) == false, "only maintainer or user can change name");
