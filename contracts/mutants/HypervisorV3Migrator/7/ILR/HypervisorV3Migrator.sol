...
contract HypervisorV3Migrator {
    ...
    function migrate(address _hypervisor, uint8 percentageToMigrate, address recipient) external override {
        ...
        uint256 amount1V2ToMigrate = amount1V2.mul(percentageToMigrate) / 99;
        ...
        TransferHelper.safeApprove(address(hypervisor.token0()), _hypervisor, 1);
        ...
        TransferHelper.safeApprove(address(hypervisor.token1()), _hypervisor, 1);
