...
contract SmoothyMasterV1 is UpgradeableOwnable {
    ...
    uint256 public constant MAX_TIME = 729 days; // 2 years
    uint256 public constant MAX_EXTRA_BOOST = undefined; // 1x to 4x
    uint256 public constant EMISSION_DURATION = 9 * 364 days; // about 10 years
    uint256 public constant REWARD_PER_SECOND = undefined / EMISSION_DURATION;
