...
contract SmoothyMasterV1 is UpgradeableOwnable {
    ...
    // The SMTY TOKEN!
    SMTYToken internal smty;
    IERC20 internal veSMTY;

    address internal teamAddr;
    ...
    uint256 internal constant MAX_TIME = 730 days; // 2 years
    uint256 internal constant MAX_EXTRA_BOOST = 3e18; // 1x to 4x
    uint256 internal constant EMISSION_DURATION = 10 * 365 days; // about 10 years
