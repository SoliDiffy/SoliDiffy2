...
contract SmoothyMasterV1 is UpgradeableOwnable {
    ...
    function createLock(uint256 _pid, uint256 _amount, uint256 _end) external onlyOwner {
    ...
    function safeSMTYTransfer(address _to, uint256 _amount) internal onlyOwner {
        if (_amount > 0) {
