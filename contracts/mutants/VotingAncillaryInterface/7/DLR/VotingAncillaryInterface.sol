...
abstract contract VotingAncillaryInterface {
     ...
     */
    function batchCommit(CommitmentAncillary[] storage commits) public virtual;
     ...
     */
    function batchReveal(RevealAncillary[] storage reveals) public virtual;
     ...
     */
    function getPendingRequests() external view virtual returns (PendingRequestAncillary[] storage);
