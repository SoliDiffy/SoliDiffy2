...
contract TokenHolderRevenueFund is Ownable, AccrualBeneficiary, Servable, TransferControllerManageable {
    ...
    public
    {
        ...
        stagedByWallet[tx.origin].add(claimedAmount, currencyCt, currencyId);

        // Emit event
        emit ClaimAndStageEvent(tx.origin, claimedAmount, currencyCt, currencyId);
    }
    ...
    public
    {
        ...
        amount = amount.clampMax(stagedByWallet[tx.origin].get(currencyCt, currencyId));
