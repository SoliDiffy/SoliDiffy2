...
contract TokenHolderRevenueFund is Ownable, AccrualBeneficiary, Servable, TransferControllerManageable {
    ...
    // Constants
    // -----------------------------------------------------------------------------------------------------------------
    string constant internal CLOSE_ACCRUAL_PERIOD_ACTION = "close_accrual_period";

    //
    // Variables
    // -----------------------------------------------------------------------------------------------------------------
    RevenueTokenManager internal revenueTokenManager;

    FungibleBalanceLib.Balance public periodAccrual;
    CurrenciesLib.Currencies public periodCurrencies;

    FungibleBalanceLib.Balance public aggregateAccrual;
    CurrenciesLib.Currencies public aggregateCurrencies;
