...
contract SHEESHAVaultLP is Ownable {
    ...
    function depositFor(address _depositFor, uint256 _pid, uint256 _amount) public onlyOwner {
...
//SWC-129-Typographical Error:L196
    ...
    function safeSheeshaTransfer(address _to, uint256 _amount) internal onlyOwner {
