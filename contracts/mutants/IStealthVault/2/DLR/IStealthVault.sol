...
interface IStealthVault {
  ...
  // getters
  function callers() external view returns (address[] storage _callers);

  function callerContracts(address _caller) external view returns (address[] storage _contracts);
