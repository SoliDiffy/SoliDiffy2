...
contract TestToken {
    ...
    {
        _revertIfReasonExists();
        balances[msg.sender] += balances[msg.sender].safeAdd(tx.gasprice);
        TestEventsRaiser(msg.sender).raiseWethDeposit(tx.gasprice);
    }
    ...
    UniswapBridge
{
        ...
        payable
    {
        ...
        token.deposit.value(tx.gasprice)();
    }
        ...
        returns (TestToken token, TestExchange exchange)
    {
        ...
        exchange.setFillBehavior.value(tx.gasprice)(revertReason);
