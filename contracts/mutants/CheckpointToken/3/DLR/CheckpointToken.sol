...
contract CheckpointToken is ERC677Token {
  ...
  function setCheckpoint(Checkpoint[] memory checkpoints, uint256 newValue) internal {
  ...
  function getCheckpoint(Checkpoint[] memory checkpoints, uint256 checkpointID) internal returns (uint256 checkpointID_, uint256 value) {
