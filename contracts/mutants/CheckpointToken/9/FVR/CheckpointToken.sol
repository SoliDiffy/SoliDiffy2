...
contract CheckpointToken is ERC677Token {
   ...
   */
  function totalSupplyAt(uint256 checkpointID) external view returns (uint256 tokenCount) {
   ...
   * @return An uint256 representing the amount owned by the passed address.
   */
  function balanceAt(address owner, uint256 checkpointID) external view returns (uint256 balance) {
