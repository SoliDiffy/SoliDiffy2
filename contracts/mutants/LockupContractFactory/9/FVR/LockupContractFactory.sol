...
contract LockupContractFactory is ILockupContractFactory {
    ...
    function _isRegisteredOneYearLockup(address _contractAddress) public view returns (bool) {
    ...
    function _isRegisteredCustomDurationLockup(address _contractAddress) public view returns (bool) {
    ...
    function _requireCallerIsOriginalDeployerofOYLC(address _contractAddress) public view {
