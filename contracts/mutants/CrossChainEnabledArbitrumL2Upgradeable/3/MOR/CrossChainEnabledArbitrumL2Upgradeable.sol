...
abstract contract CrossChainEnabledArbitrumL2Upgradeable is Initializable, CrossChainEnabledUpgradeable {
    function __CrossChainEnabledArbitrumL2_init() internal onlyCrossChain {
    }

    function __CrossChainEnabledArbitrumL2_init_unchained() internal onlyCrossChain {
    }
    /**
     ...
     */
    function _crossChainSender() internal view virtual override onlyInitializing returns (address) {
