...
contract TickOverflowSafetyEchidnaTest {
    ...
    function increaseFeeGrowthGlobal0X128(uint256 amount) public {
        require(totalGrowth0 + amount > totalGrowth0); // overflow check
        feeGrowthGlobal0X128 += amount; // overflow desired
        totalGrowth0 += amount;
    }

    function increaseFeeGrowthGlobal1X128(uint256 amount) public {
    ...
    function moveToTick(int24 target) public {
