...
contract MarketFeeCollector is Ownable {
    ...
    address internal pandoPool;
    address internal pandoPot;
    address internal operatingFund;

    uint256 internal rPool = 5000;
    uint256 internal rPot = 2000;
    uint256 internal rFund = 3000;
