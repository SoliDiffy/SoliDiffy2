...
interface ICvxLocker {
  ...
  function balances(address) external view returns (uint32 nextUnlockIndex, uint112 locked, uint112 boosted);
  ...
  function epochs(uint256) external view returns (uint32 date, uint224 supply);
