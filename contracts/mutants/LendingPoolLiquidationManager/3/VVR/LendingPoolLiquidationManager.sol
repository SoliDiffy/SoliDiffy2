...
contract LendingPoolLiquidationManager is ILendingPoolLiquidationManager, VersionedInitializable, LendingPoolStorage {
  ...
  struct LiquidationCallLocalVars {
    ...
    uint256 internal constant LIQUIDATION_MANAGER_REVISION = 0x1;             // NEEDED AS PART OF UPGRADABLE CONTRACTS FUNCTIONALITY ( VersionedInitializable )
    uint256 internal constant FLASHLOAN_PREMIUM_TOTAL = 90;
