    ...
    // ###########################
        ...
        if (!receiveIToken) {
            ...
            if (currentAvailableCollateral < vars.maxCollateralToLiquidate) {
                return (  uint8(Errors.CollateralManagerErrors.NOT_ENOUGH_LIQUIDITY),"NOT ENOUGH LIQUIDITY TO LIQUIDATE");
            }
        }
...
//        debtInstrument.updateInterestRates( debtAsset, debtInstrument.iTokenAddress, vars.actualDebtToLiquidate, 0 );
        ...
        return (uint8(Errors.CollateralManagerErrors.NO_ERROR), Errors.LPCM_NO_ERRORS);
    }
