...
//        debtInstrument.updateInterestRates( debtAsset, debtInstrument.iTokenAddress, vars.actualDebtToLiquidate, 0 );
  ...
  struct AvailableCollateralToLiquidateLocalVars {
    ...
    **/
    function flashLoan(address user, address _receiver, address _instrument, uint256 _amount, bytes storage _params, uint16 boosterID) external returns (uint256, string memory) {
