  ...
  CalledByVm
{
   ...
   */
  function setCommissionUpdateDelay(uint256 delay) public initializer {
   ...
   */
  function setMaxGroupSize(uint256 size) public initializer returns (bool) {
   ...
   * @return True upon success.
   */
  function setMembershipHistoryLength(uint256 length) public initializer returns (bool) {
