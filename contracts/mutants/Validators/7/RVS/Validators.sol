  ...
  CalledByVm
{
  ...
  function getValidatorLockedGoldRequirements() external view returns (uint256, uint256) {
    return (validatorLockedGoldRequirements.duration, validatorLockedGoldRequirements.value);
  }
  ...
  function getGroupLockedGoldRequirements() external view returns (uint256, uint256) {
    return (groupLockedGoldRequirements.duration, groupLockedGoldRequirements.value);
  }
