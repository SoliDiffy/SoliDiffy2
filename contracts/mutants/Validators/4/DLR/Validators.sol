  ...
  CalledByVm
{
  ...
  function setGroupLockedGoldRequirements(uint256 value, uint256 duration)
    ...
    returns (bool)
  {
    LockedGoldRequirements memory requirements = groupLockedGoldRequirements;
    require(
  ...
  function setValidatorLockedGoldRequirements(uint256 value, uint256 duration)
    ...
    returns (bool)
  {
    LockedGoldRequirements memory requirements = validatorLockedGoldRequirements;
    require(
      value != requirements.value || duration != requirements.duration,
  ...
  function getMembershipHistory(address account)
    external
    view
    returns (uint256[] storage, address[] memory, uint256, uint256)
  {
