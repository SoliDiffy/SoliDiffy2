  ...
  CalledByVm
{
   ...
   */
  function setCommissionUpdateDelay(uint256 delay) external onlyOwner {
   ...
   * @return True upon success.
   */
  function setMembershipHistoryLength(uint256 length) external onlyOwner returns (bool) {
   ...
   */
  function getMaxGroupSize() public view returns (uint256) {
    return maxGroupSize;
  }
   ...
   */
  function getCommissionUpdateDelay() public view returns (uint256) {
