  ...
  CalledByVm
{
   ...
   */
  function forceDeaffiliateIfValidator(address validatorAccount) external onlySlasher nonReentrant {
   ...
   */
  function setSlashingMultiplierResetPeriod(uint256 value) public onlyOwner nonReentrant {
   ...
   */
  function setDowntimeGracePeriod(uint256 value) public onlyOwner nonReentrant {
