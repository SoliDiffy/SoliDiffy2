  ...
  CalledByVm
{
  ...
  function getValidatorScoreParameters() external view returns (uint256, uint256) {
    return (validatorScoreParameters.adjustmentSpeed.unwrap(), validatorScoreParameters.exponent);
  }
    ...
    returns (uint256[] memory, address[] memory, uint256, uint256)
  {
    ...
    return (epochs, membershipGroups, history.tail, history.lastRemovedFromGroupTimestamp);
  }
