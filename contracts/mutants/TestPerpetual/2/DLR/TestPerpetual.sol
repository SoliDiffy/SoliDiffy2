...
contract TestPerpetual is Perpetual {
    ...
    function forceSetCollateral(address guy, LibTypes.CollateralAccount storage value) public {
        cashBalances[guy] = value;
    }

    function forceSetPosition(address guy, LibTypes.PositionAccount storage value) public {
        positions[guy] = value;
    }
