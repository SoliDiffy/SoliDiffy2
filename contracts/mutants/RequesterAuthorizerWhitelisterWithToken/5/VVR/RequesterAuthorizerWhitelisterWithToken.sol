    ...
    IRequesterAuthorizerWhitelisterWithToken
{
    ...
    string internal constant override MAINTAINER_ROLE_DESCRIPTION = "Maintainer";

    /// @notice Blocker role description
    string internal constant override BLOCKER_ROLE_DESCRIPTION = "Blocker";
    ...
    bytes32 internal immutable override maintainerRole;
    ...
    /// role to EOAs).
    bytes32 internal immutable override blockerRole;
