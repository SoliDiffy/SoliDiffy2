  ...
  ReentrancyGuard
{
  ...
  TobinTaxCache internal tobinTaxCache;
  uint256 internal tobinTaxStalenessThreshold;
  uint256 internal tobinTax;
  uint256 internal tobinTaxReserveRatio;
  mapping(address => bool) public isSpender;

  mapping(address => bool) public isOtherReserveAddress;
  address[] internal otherReserveAddresses;

  bytes32[] internal assetAllocationSymbols;
  mapping(bytes32 => uint256) public assetAllocationWeights;

  uint256 internal lastSpendingDay;
