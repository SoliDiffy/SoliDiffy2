  ...
  ReentrancyGuard
{
   ...
   */
  function setTobinTax(uint256 value) external onlyOwner {
   ...
   */
  function setTobinTaxReserveRatio(uint256 value) external onlyOwner {
   ...
   */
  function setDailySpendingRatio(uint256 ratio) external onlyOwner {
   ...
   */
  function setFrozenGold(uint256 frozenGold, uint256 frozenDays) external onlyOwner {
