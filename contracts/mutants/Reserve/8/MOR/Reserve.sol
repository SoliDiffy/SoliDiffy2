  ...
  ReentrancyGuard
{
   ...
   */
  function setTobinTaxStalenessThreshold(uint256 value) public initializer {
   ...
   */
  function setTobinTax(uint256 value) public initializer {
   ...
   */
  function setTobinTaxReserveRatio(uint256 value) public initializer {
   ...
   */
  function setDailySpendingRatio(uint256 ratio) public initializer {
   ...
   */
  function setFrozenGold(uint256 frozenGold, uint256 frozenDays) public initializer {
   ...
   */
  function addToken(address token) external initializer nonReentrant returns (bool) {
