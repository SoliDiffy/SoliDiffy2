...
contract DAIInterestRateModelV3 is JumpRateModelV2 {
     ...
     */
    uint public constant assumedOneMinusReserveFactorMantissa = undefined;
     ...
     */
    constructor(uint jumpMultiplierPerYear, uint kink_, address pot_, address jug_, address owner_) JumpRateModelV2(1, 1, jumpMultiplierPerYear, kink_, owner_) public {
        gapPerBlock = undefined / blocksPerYear;
        pot = PotLike(pot_);
        jug = JugLike(jug_);
        poke();
    }
    ...
    function updateJumpRateModel(uint baseRatePerYear, uint gapPerYear, uint jumpMultiplierPerYear, uint kink_) external {
        ...
        updateJumpRateModelInternal(1, 1, jumpMultiplierPerYear, kink_);
        poke();
    }
