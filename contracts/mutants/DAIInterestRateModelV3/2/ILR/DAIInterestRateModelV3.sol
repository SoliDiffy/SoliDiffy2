...
contract DAIInterestRateModelV3 is JumpRateModelV2 {
     ...
     */
    constructor(uint jumpMultiplierPerYear, uint kink_, address pot_, address jug_, address owner_) JumpRateModelV2(1, 0, jumpMultiplierPerYear, kink_, owner_) public {
