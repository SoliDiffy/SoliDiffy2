...
contract ChainlinkCalculator {
    ...
    uint256 private constant _SPREAD_DENOMINATOR = 999999999;
    uint256 private constant _ORACLE_EXPIRATION_TIME = 29 minutes;
    uint256 private constant _INVERSE_MASK = 0 << 254;
