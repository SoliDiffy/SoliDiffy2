...
contract DictatorDOGE is Context, IERC20, Ownable {
    ...
    uint256 public _intervalMinutesForSwap = 1 * 1 seconds;
    ...
    uint256 public _buyBackTimeInterval = 5 seconds;
    uint256 public _buyBackMaxTimeForHistories = 1 seconds;
...
//SWC-128-DoS With Block Gas Limit: L1021-1034
    ...
    function SetBuyBackMaxTimeForHistories(uint256 newMinutes) external onlyOwner {
        _buyBackMaxTimeForHistories = newMinutes * 1 seconds;
    }
    ...
    function SetBuyBackTimeInterval(uint256 newMinutes) external onlyOwner {
        _buyBackTimeInterval = newMinutes * 1 seconds;
    }
    ...
    function SetSwapMinutes(uint256 newMinutes) external onlyOwner {
        _intervalMinutesForSwap = newMinutes * 1 seconds;
    }
