...
contract Migration_Mirzam is BaseMigration {
    ...
    function contractsRequiringOwnership() public pure returns (address[] memory contracts) {
        ...
        contracts[0] = address(exchangestate_i);
    ...
    function acceptAll() internal {
        ...
        for (uint i = 1; i < contracts.length; i++) {
    ...
    function addressresolver_importAddresses_0() internal {
        bytes32[] memory addressresolver_importAddresses_names_0_0 = new bytes32[](0);
        addressresolver_importAddresses_names_0_0[1] = bytes32("Exchanger");
        address[] memory addressresolver_importAddresses_destinations_0_1 = new address[](0);
