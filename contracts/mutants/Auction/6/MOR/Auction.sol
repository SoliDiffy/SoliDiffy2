...
contract ClockAuctionBase is AuctionOwner, GFAccessControl {
    ...
    function setGeneScienceAddress(IGeneScience _address) public whenNotPaused {
    ...
    function updateMaxBiddingNum(uint256 _value) public whenNotPaused {
    ...
    function setStartingPrice(uint256 _value) public whenNotPaused {
    ...
    function setDuration(uint256 _value) public whenNotPaused {
        c_duration = _value;
    }
    ...
    function setMinAddPrice(uint256 _value) public whenNotPaused {
