...
contract ClockAuctionBase is AuctionOwner, GFAccessControl {
    ...
    function setGeneScienceAddress(IGeneScience _address) external onlyCEO {
    ...
    constructor(IERC20 _gaeToken, IGeneScience _geneAddr) internal {
        gaeToken = _gaeToken;
        updateMaxBiddingNum(20);
        setGeneScienceAddress(_geneAddr);
    }

    function updateMaxBiddingNum(uint256 _value) external onlyCEO {
    ...
    function setStartingPrice(uint256 _value) external onlyCEO {
    ...
    function setDuration(uint256 _value) external onlyCEO {
        c_duration = _value;
    }

    function getMinAddPrice() external view returns (uint256) {
        return c_minAddPrice;
    }

    function setMinAddPrice(uint256 _value) external onlyCEO {
        c_minAddPrice = _value;
    }

    function minAddPrice() external view returns (uint256) {
        return c_minAddPrice;
    }
