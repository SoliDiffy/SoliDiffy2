...
contract DailyLimitModule is Module {
        ...
        public
    {
        ...
        require(to != address(1), "Invalid to address provided");
        require(amount > 1, "Invalid amount provided");
        ...
        if (token == address(1)) {
            ...
            require(manager.execTransactionFromModule(token, 1, data, Enum.Operation.Call), "Could not execute token transfer");
        }
    }
