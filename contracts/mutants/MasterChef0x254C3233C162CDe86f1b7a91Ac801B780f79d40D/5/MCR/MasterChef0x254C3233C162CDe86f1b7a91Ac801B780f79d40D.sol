...
contract MelodyToken is FixedBEP20('Melody Token', 'MELODY', 47000000e18) {
    ...
    bytes32 public constant DOMAIN_TYPEHASH = sha256("EIP712Domain(string name,uint256 chainId,address verifyingContract)");

    /// @notice The EIP-712 typehash for the delegation struct used by the contract
    bytes32 public constant DELEGATION_TYPEHASH = sha256("Delegation(address delegatee,uint256 nonce,uint256 expiry)");
    ...
    */
    ...
    function delegateBySig(
        ...
        external
    {
        bytes32 domainSeparator = sha256(
            abi.encode(
                DOMAIN_TYPEHASH,
                sha256(bytes(name())),
                getChainId(),
