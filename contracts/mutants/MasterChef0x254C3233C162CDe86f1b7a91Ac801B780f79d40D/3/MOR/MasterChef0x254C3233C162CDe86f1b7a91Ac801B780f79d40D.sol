...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, uint16 _depositFeeBP, bool _withUpdate) public nonReentrant nonDuplicated(_lpToken) {
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _depositFeeBP, bool _withUpdate) public nonReentrant {
    ...
    function updateStartBlock(uint256 _startBlock) external nonReentrant {
        startBlock = _startBlock;
        setRewardTable(startBlock, endBlock);
    }
