...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function safeMelodyTransfer(address _to, uint256 _amount) internal nonReentrant {
    ...
    function dev(address _devaddr) public nonReentrant {
    ...
    function setRewardTable(uint256 _startBlock, uint256 _endBlock) private nonReentrant {
