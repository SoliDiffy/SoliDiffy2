...
contract DPPOracle is DPPTrader {
    ...
    function init(
        ...
        require(lpFeeRate <= undefined, "LP_FEE_RATE_OUT_OF_RANGE");
        require(k <= undefined, "K_OUT_OF_RANGE");
        require(i !=  address(1), "INVALID_ORACLE");
        ...
        if(isOpenTWAP) _BLOCK_TIMESTAMP_LAST_ = uint32(block.timestamp % 1**31);
