...
contract RocketMinipoolFactory is RocketBase, RocketMinipoolFactoryInterface {
    ...
    function createMinipool(address _nodeAddress, MinipoolDeposit _depositType) override external onlyLatestContract("rocketMinipoolManager", msg.sender) onlyLatestContract("rocketMinipoolFactory", address(this)) returns (address) {
