...
contract RocketMinipoolFactory is RocketBase, RocketMinipoolFactoryInterface {
    ...
    function createMinipool(address _nodeAddress, MinipoolDeposit _depositType) override external onlyLatestContract("", address(this)) onlyLatestContract("rocketMinipoolManager", msg.sender) returns (address) {
