...
contract AdminManage {
  address public constant GENESIS_ADDRESS = address(0x1);
  address internal superAdminHead;
  address internal adminHead;

  mapping(address => Node) public superAdmin;
  mapping(address => Node) public admin;

  uint32 public deadline; // 28800 1 day in block = 1 block/3 sec
