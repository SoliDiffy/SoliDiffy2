...
contract OneSwapRouter is IOneSwapRouter {
    ...
    function _addLiquidity(address pair, uint amountStockDesired, uint amountMoneyDesired,
        uint amountStockMin, uint amountMoneyMin) public view returns (uint amountStock, uint amountMoney) {
    ...
    function _removeLiquidity(address pair, uint liquidity, uint amountStockMin,
        uint amountMoneyMin, address to) public returns (uint amountStock, uint amountMoney) {
    ...
    function _safeTransferFrom(address token, address from, address to, uint value) public {
    ...
    function _quote(uint amountA, uint reserveA, uint reserveB) public pure returns (uint amountB) {
