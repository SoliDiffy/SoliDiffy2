...
contract OneSwapRouter is IOneSwapRouter {
    ...
    function _addLiquidity(address pair, uint amountStockDesired, uint amountMoneyDesired,
        uint amountStockMin, uint amountMoneyMin) private view returns (uint amountMoney, uint amountStock) {
    ...
    function addLiquidity(address stock, address money, bool isOnlySwap, uint amountStockDesired,
        ...
        override ensure(deadline) returns (uint liquidity, uint amountStock, uint amountMoney) {
    ...
    function addLiquidityETH(address token, bool tokenIsStock, bool isOnlySwap, uint amountTokenDesired,
        ...
        ensure(deadline) returns (uint liquidity, uint amountToken, uint amountETH) {
    ...
    function _removeLiquidity(address pair, uint liquidity, uint amountStockMin,
        uint amountMoneyMin, address to) private returns (uint amountMoney, uint amountStock) {
    ...
    function removeLiquidity(address pair, uint liquidity, uint amountStockMin, uint amountMoneyMin,
        address to, uint deadline) external override ensure(deadline) returns (uint amountMoney, uint amountStock) {
        // ensure pair exist
    ...
    function removeLiquidityETH(address pair, uint liquidity, uint amountTokenMin, uint amountETHMin,
        address to, uint deadline) external override ensure(deadline) payable returns (uint amountETH, uint amountToken) {
    ...
    function _getTokensFromPair(address pair)internal view returns(address money, address stock) {
