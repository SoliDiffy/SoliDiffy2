    ...
    PausableUpgradeable
{
    ...
    function setNewRewardsDistribution(address _rewardsDistribution) external override zeroCheck(_rewardsDistribution) {
    ...
    function pause() external override onlyRewardsDistribution {
        _pause();
    }

    /// @notice Unpauses HAs functions
    function unpause() external override onlyRewardsDistribution {
        _unpause();
    }
    ...
    function setBaseURI(string memory _baseURI) external onlyRewardsDistribution {
        baseURI = _baseURI;
    ...
    function setLockTime(uint64 _lockTime) external override onlyRewardsDistribution {
        lockTime = _lockTime;
    ...
    function setHAFees(
        ...
        uint8 deposit
    ) external override onlyRewardsDistribution onlyCompatibleInputArrays(_xHAFees, _yHAFees) {
        if (deposit == 1) {
