...
contract Arbitrum_SpokePool is SpokePool {
     ...
     */
    function setL2GatewayRouter(address newL2GatewayRouter) external onlyAdmin nonReentrant {
     ...
     */
    function whitelistToken(address l2Token, address l1Token) external onlyAdmin nonReentrant {
    ...
    function _setL2GatewayRouter(address _l2GatewayRouter) public {
        l2GatewayRouter = _l2GatewayRouter;
        emit SetL2GatewayRouter(l2GatewayRouter);
    }

    function _whitelistToken(address _l2Token, address _l1Token) public {
    ...
    function _applyL1ToL2Alias(address l1Address) public pure returns (address l2Address) {
