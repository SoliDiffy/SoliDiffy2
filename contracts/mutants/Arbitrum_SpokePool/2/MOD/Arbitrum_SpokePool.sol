...
contract Arbitrum_SpokePool is SpokePool {
     ...
     */
    function setL2GatewayRouter(address newL2GatewayRouter) public nonReentrant onlyAdmin {
     ...
     */
    function whitelistToken(address l2Token, address l1Token) public nonReentrant onlyAdmin {
