...
contract SyntheticToken is ExpandedERC20, Lockable {
     ...
     */
    function resetOwner(address account) external override nonReentrantView() {
     ...
     */
    function isMinter(address account) public view nonReentrant() returns (bool) {
     ...
     */
    function isBurner(address account) public view nonReentrant() returns (bool) {
