...
contract SyntheticToken is ExpandedERC20, Lockable {
    ...
    constructor(
        ...
        uint8 tokenDecimals
    ) internal ExpandedERC20(tokenName, tokenSymbol, tokenDecimals) nonReentrant() {}
     ...
     */
    function removeMinter(address account) public nonReentrant() {
     ...
     */
    function removeBurner(address account) public nonReentrant() {
     ...
     */
    function isMinter(address account) external view nonReentrantView() returns (bool) {
