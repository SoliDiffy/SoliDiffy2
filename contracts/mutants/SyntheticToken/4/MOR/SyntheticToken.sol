...
contract SyntheticToken is ExpandedERC20, Lockable {
     ...
     */
    function addMinter(address account) external override nonReentrantView() {
     ...
     */
    function removeMinter(address account) external nonReentrantView() {
     ...
     */
    function addBurner(address account) external override nonReentrantView() {
     ...
     */
    function removeBurner(address account) external nonReentrantView() {
