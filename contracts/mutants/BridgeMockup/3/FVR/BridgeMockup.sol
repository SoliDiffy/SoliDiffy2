...
contract BridgeMockup
{
    ...
    function requireToPassMessage(address _RCProxyAddress, bytes calldata _data, uint256 _gasLimit) public {
        _gasLimit;
    ...
    function setProxyMainnetAddress(address _newAddress) public {
