...
contract Bridge {
    ...
    */
    function receivePayment() external payable shouldBeInitialized {}
    ...
    */
    ...
    private
    shouldBeInitialized returns (bool) {
    ...
    internal
    shouldBeInitialized returns (uint) {
