...
contract Bridge {
    ...
    */
    ...
    public shouldNotBePreparedForMigration {
    ...
    public
    shouldBePreparedForMigration shouldNotBePreparedForMigration {
    ...
    */
    ...
    public
    shouldNotBePreparedForMigration shouldBePreparedForMigration {
        require(address(this) == thisContractAddress);
