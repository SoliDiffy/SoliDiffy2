...
contract Bridge {
    ...
    bool public preparedForMigration_;

    mapping(address => bool) public isPeer;
    uint internal peersCount;
    ...
    */
    ...
    address[] internal _sidechainTokenAddressArray;
     ...
     */
    address internal _addressVAL;
    address internal _addressXOR;
    /** EVM netowrk ID */
    bytes32 internal _networkId;
