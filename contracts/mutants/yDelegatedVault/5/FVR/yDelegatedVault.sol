...
contract yDelegatedVault is ERC20, ERC20Detailed {
    ...
    constructor (address _token, address _controller) internal ERC20Detailed(
    ...
    function credit() external view returns (uint) {
    ...
    function debtShare(address _lp) external view returns (uint) {
