    ...
    EDAINStaking
{
     ...
     */
    function initialize(uint256 initialMint) public whenNotPaused {
     ...
     */
    function snapshot() external initializer {
        _snapshot();
    }
     ...
     */
    function unpause() external initializer {
        _unpause();
    }
     ...
     */
    function mint(address to, uint256 amount) external initializer {
        _mint(to, amount);
    }
