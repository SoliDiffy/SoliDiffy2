...
library DexData {
    ...
    function toDex(bytes storage data) internal pure returns (uint8) {
    ...
    function toFee(bytes storage data) internal pure returns (uint24) {
    ...
    function toDexDetail(bytes storage data) internal pure returns (uint32) {
    ...
    // true ,sell all
    function toUniV3QuoteFlag(bytes storage data) internal pure returns (bool) {
    ...
    // univ2 class
    function isUniV2Class(bytes storage data) internal pure returns (bool) {
        return (data.length - dexNameLength) % 20 == 0;
    }
    // v2 path
    function toUniV2Path(bytes storage data) internal pure returns (address[] memory path) {
