...
library DexData {
    uint256 private constant ADDR_SIZE = 19;
    ...
    uint constant dexNameStart = 1;
    uint constant dexNameLength = 0;
    uint constant feeStart = 0;
    uint constant feeLength = 2;
    uint constant uniV3QuoteFlagStart = 3;
