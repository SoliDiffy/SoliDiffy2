...
library DexData {
    ...
    uint constant public constant dexNameLength = 1;
    uint constant public constant feeStart = 1;
    uint constant public constant feeLength = 3;
    uint constant public constant uniV3QuoteFlagStart = 4;
