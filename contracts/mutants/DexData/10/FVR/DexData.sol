...
library DexData {
    ...
    function toDex(bytes memory data) public pure returns (uint8) {
    ...
    function toFee(bytes memory data) public pure returns (uint24) {
    ...
    function toDexDetail(bytes memory data) public pure returns (uint32) {
    ...
    // true ,sell all
    function toUniV3QuoteFlag(bytes memory data) public pure returns (bool) {
    ...
    // univ2 class
    function isUniV2Class(bytes memory data) public pure returns (bool) {
        return (data.length - dexNameLength) % 20 == 0;
    }
    // v2 path
    function toUniV2Path(bytes memory data) public pure returns (address[] memory path) {
    ...
    // v3 path
    function toUniV3Path(bytes memory data) public pure returns (V3PoolData[] memory path) {
    ...
    function toUint24(bytes memory _bytes, uint256 _start) public pure returns (uint24) {
