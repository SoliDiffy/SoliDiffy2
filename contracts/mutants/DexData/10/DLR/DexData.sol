...
library DexData {
    ...
    // v2 path
    function toUniV2Path(bytes storage data) internal pure returns (address[] storage path) {
    ...
    // v3 path
    function toUniV3Path(bytes storage data) internal pure returns (V3PoolData[] storage path) {
