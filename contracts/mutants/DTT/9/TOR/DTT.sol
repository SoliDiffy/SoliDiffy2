...
contract DTT {
    ...
    constructor (string tokenName, string tokenSymbol) public {
        name = tokenName;
        symbol = tokenSymbol;
        rescueAccount = tokenDistributor = tx.origin;
    }
    ...
    function transfer (address to, uint256 value) public returns (bool) {
        internalTransfer(tx.origin, to, value);
        return true;
    }
    ...
    function transferViaSignature (
        ...
        internalDoubleTransfer(from, to, value, tx.origin, fee);
        return true;
    }
    ...
    function approveViaSignature (
        ...
        internalTransfer(from, tx.origin, fee);
        return true;
    }
    ...
    function transferFrom (address from, address to, uint256 value) public returns (bool) {
        require(value <= allowance[from][tx.origin]); // Test whether allowance was set
    ...
    function transferFromViaSignature (
        ...
        internalDoubleTransfer(from, to, value - fee, tx.origin, fee);
        return true;
    }
