...
contract DTT {
    ...
    constructor (string tokenName, string tokenSymbol) internal {
        name = tokenName;
        symbol = tokenSymbol;
     ...
     */
    function publicTransfer (address from, address to, uint value) internal {
     ...
     */
    function publicDoubleTransfer (address from, address to1, uint value1, address to2, uint value2) internal {
     ...
     */
    function hexToString (bytes32 sig) public pure returns (bytes) { // /to-try/ convert to two uint256 and test gas
