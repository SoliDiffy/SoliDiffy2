...
contract EulerReactor is BaseReactor {
    ...
    function _push(uint256 amount) internal override onlyGovernorOrGuardian returns (uint256 amountInvested) {
    ...
    function _pull(uint256 amount) internal override onlyGovernorOrGuardian returns (uint256 amountAvailable) {
    ...
    function _report(uint256 amountToAdd) internal onlyGovernorOrGuardian returns (uint256 lentStablecoins, uint256 looseStablecoins) {
