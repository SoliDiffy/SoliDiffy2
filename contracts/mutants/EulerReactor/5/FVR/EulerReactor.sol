...
contract EulerReactor is BaseReactor {
    ...
    function setMinInvest(uint256 minInvest_) external onlyGovernorOrGuardian {
        minInvest = minInvest_;
    ...
    function changeAllowance(uint256 amount) public onlyGovernorOrGuardian {
    ...
    function _maxAmountWithdrawable(
        ...
        uint256 usedAssets,
        uint256 looseAssets
    ) public view returns (uint256 maxAmount) {
    ...
    function _report(uint256 amountToAdd) public returns (uint256 lentStablecoins, uint256 looseStablecoins) {
