...
contract RifiCertora is Rifi {
    constructor(address grantor) Rifi(grantor) internal {}

    function certoraOrdered(address account) public view returns (bool) {
    ...
    function certoraScan(address account, uint blockNumber) public view returns (uint) {
