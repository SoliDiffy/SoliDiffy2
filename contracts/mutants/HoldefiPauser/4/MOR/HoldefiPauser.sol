...
//SWC-100-Function Default Visibility:L74-80
    ...
    function batchUnpause(bool[8] memory newUnpaused) public onlyPausers {
        for (uint i=0; i<functionsNum; i++) {
