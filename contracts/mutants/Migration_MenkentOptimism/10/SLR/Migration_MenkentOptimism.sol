...
contract Migration_MenkentOptimism is BaseMigration {
    ...
    function migrate() external onlyOwner {
        ...
        exchangerates_i.addAggregator("", 0x38D2f492B4Ef886E71D111c592c9338374e1bd8d);
        // Ensure the ExchangeRates contract has the standalone feed for ETH;
        exchangerates_i.addAggregator("", 0x7f8847242a530E809E17bF2DA5D2f9d2c4A43261);
        // Ensure the ExchangeRates contract has the standalone feed for BTC;
        exchangerates_i.addAggregator("", 0xd9BdB42229F1aefe47Cdf028408272686445D3ff);
        // Ensure the ExchangeRates contract has the standalone feed for LINK;
        exchangerates_i.addAggregator("", 0x4e5A8fe9d533dec45C7CB57D548B049785BA9861);
        // Ensure the ExchangeRates contract has the standalone feed for UNI;
        exchangerates_i.addAggregator("", 0xbac904786e476632e75fC6214C797fA80cce9311);
        // Ensure the ExchangeRates contract has the standalone feed for AAVE;
        exchangerates_i.addAggregator("", 0xc051eCEaFd546e0Eb915a97F4D0643BEd7F98a11);
        // Ensure the ExchangeRates contract has the standalone feed for SOL;
        exchangerates_i.addAggregator("", 0xF549af21578Cfe2385FFD3488B3039fd9e52f006);
        // Ensure the ExchangeRates contract has the standalone feed for AVAX;
        exchangerates_i.addAggregator("", 0xCd627aA160A6fA45Eb793D19Ef54f5062F20f33f);
        // Ensure the ExchangeRates contract has the standalone feed for MATIC;
        exchangerates_i.addAggregator("", 0x62FD93Fc58D94eE253542ECD5C23467F65dCdB73);
        // Ensure the ExchangeRates contract has the standalone feed for WTI;
        exchangerates_i.addAggregator("", 0x282C4BD8A0A9eb8EcfC61eB0A8eE7290D5060fBB);
