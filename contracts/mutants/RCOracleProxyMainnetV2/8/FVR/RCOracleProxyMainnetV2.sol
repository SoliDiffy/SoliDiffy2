...
contract RCProxyMainnetV2 is Ownable
{
    ...
    constructor(address _bridgeMainnetAddress, address _realitioAddress) internal {
    ...
    function postQuestionToOracle(address _marketAddress, string calldata _question, uint32 _oracleResolutionTime) public {
    ...
    function getWinnerFromOracle(address _marketAddress) public returns(bool) {
