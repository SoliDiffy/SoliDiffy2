...
library Groups {
    ...
    function reportUnauthorizedSigning(
        ...
        if (!isGroupTerminated(self, groupIndex) && isSignatureValid) {
            ...
            self.stakingContract.seize(minimumStake, 100, tx.origin, self.groupMembers[groupPubKey]);
        }
    }
    ...
    function reportRelayEntryTimeout(
        ...
        self.stakingContract.seize(minimumStake, rewardAdjustment, tx.origin, membersOf(self, groupIndex));
    }
