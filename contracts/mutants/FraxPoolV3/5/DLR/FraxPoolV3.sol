...
contract FraxPoolV3 is Owned {
    ...
    constructor (
        ...
        address[] storage _collateral_addresses,
        uint256[] storage _pool_ceilings,
        uint256[] storage _initial_fees
    ...
    // Helpful for UIs
    function collateral_information(address collat_address) external view returns (CollateralInformation storage return_data){
    ...
    function allCollaterals() external view returns (address[] storage) {
