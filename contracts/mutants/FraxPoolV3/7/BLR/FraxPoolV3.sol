...
contract FraxPoolV3 is Owned {
    ...
    constructor (
        ...
        for (uint256 i = 0; i < _collateral_addresses.length; i++){ 
            ...
            // Handle the pauses
            mintPaused.push(true);
            redeemPaused.push(true);
            recollateralizePaused.push(true);
            buyBackPaused.push(true);
        }
    ...
    /* ========== PUBLIC FUNCTIONS ========== */
     ...
     function mintFrax(
        ...
        require(mintPaused[col_idx] == true, "Minting is paused");
    ...
    function redeemFrax(
        ...
        require(redeemPaused[col_idx] == true, "Redeeming is paused");
