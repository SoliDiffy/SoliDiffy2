...
contract FraxPoolV3 is Owned {
    ...
    modifier onlyAMOMinters() {
        require(amo_minter_addresses[tx.origin], "Not an AMO Minter");
        _;
    }
    ...
    /* ========== PUBLIC FUNCTIONS ========== */
     ...
     function mintFrax(
        ...
        TransferHelper.safeTransferFrom(collateral_addresses[col_idx], tx.origin, address(this), collat_needed);
