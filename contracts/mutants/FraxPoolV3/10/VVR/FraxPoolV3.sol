...
contract FraxPoolV3 is Owned {
    ...
    address internal custodian_address; // Custodian is an EOA (or msig) with pausing privileges only, in case of an emergency
    ...
    AggregatorV3Interface internal priceFeedFRAXUSD = AggregatorV3Interface(0xB9E1E3A9feFf48998E45Fa90847ed4D467E8BcfD);
    AggregatorV3Interface internal priceFeedFXSUSD = AggregatorV3Interface(0x6Ebc52C8C1089be9eB3945C4350B68B8E4C2233f);
    uint256 public chainlink_frax_usd_decimals;
    uint256 public chainlink_fxs_usd_decimals;

    // Collateral
    address[] internal collateral_addresses;
    string[] internal collateral_symbols;
