...
contract OracleMaster is Pausable {
    ...
    */
    function setRelayParams(uint64 _relayGenesisTs, uint64 _relaySecondsPerEra) external whenNotPaused {
    ...
    */
    function setQuorum(uint8 _quorum) external onlyLido {
    ...
    */
    function pause() external onlyLido {
        _pause();
    }
    ...
    */
    function resume() external onlyLido {
        _unpause();
    }
    ...
    */
    function addOracleMember(address _member) external onlyLido {
    ...
    */
    function removeOracleMember(address _member) external onlyLido {
    ...
    */
    function addLedger(address _ledger) external whenNotPaused {
    ...
    * @param _ledger ledger contract
    */
    function removeLedger(address _ledger) external whenNotPaused {
    ...
    */
    function reportRelay(uint64 _eraId, Types.OracleData calldata _report) external onlyLido {
