...
contract OracleMaster is Pausable {
    ...
    */
    function setRelayParams(uint64 _relayGenesisTs, uint64 _relaySecondsPerEra) public onlyLido {
    ...
    */
    function setQuorum(uint8 _quorum) public auth(ROLE_ORACLE_QUORUM_MANAGER) {
    ...
    */
    function getOracle(address _ledger) public view returns (address) {
    ...
    */
    function pause() public auth(ROLE_ORACLE_MANAGER) {
        _pause();
    }
    ...
    */
    function resume() public auth(ROLE_ORACLE_MANAGER) {
        _unpause();
    }
