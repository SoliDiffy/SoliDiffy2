...
contract WETHGateway is IWETHGateway, Ownable {
   ...
   **/
  function depositETH(address onBehalfOf, uint16 referralCode) external payable override onlyOwner {
   ...
   */
  function withdrawETH(uint256 amount, address to) external override onlyOwner {
   ...
   */
  function _safeTransferETH(address to, uint256 value) internal onlyOwner {
