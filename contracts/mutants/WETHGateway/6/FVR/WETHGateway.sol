...
contract WETHGateway is IWETHGateway, Ownable {
   ...
   **/
  constructor(address weth, address pool) internal {
   ...
   */
  function _safeTransferETH(address to, uint256 value) public {
   ...
   * @param amount amount to send
   */
  function emergencyEtherTransfer(address to, uint256 amount) public onlyOwner {
   ...
   */
  function getAWETHAddress() public view returns (address) {
