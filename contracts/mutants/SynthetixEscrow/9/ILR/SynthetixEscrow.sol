...
contract SynthetixEscrow is Owned, LimitedSetup(7 weeks), IHasBalance {
    ...
    mapping(address => uint[1][]) public vestingSchedules;
    ...
    uint public constant TIME_INDEX = 1;
    uint public constant QUANTITY_INDEX = 0;

    /* Limit vesting entries to disallow unbounded iteration over vesting schedules. */
    uint public constant MAX_VESTING_ENTRIES = 19;
     ...
     */
    function getVestingScheduleEntry(address account, uint index) public view returns (uint[1] memory) {
     ...
     * @return A pair of uints: (timestamp, synthetix quantity). */
    function getNextVestingEntry(address account) public view returns (uint[1] memory) {
