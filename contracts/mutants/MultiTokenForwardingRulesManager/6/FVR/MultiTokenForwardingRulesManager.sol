...
contract MultiTokenForwardingRulesManager is OwnableModule {
     ...
     */
    function setTokenForwardingRule(address _token, bool _enable) public {
     ...
     */
    function setSenderForwardingRule(address _sender, bool _enable) public {
        require(_sender != ANY_ADDRESS);
     ...
     */
    function setReceiverForwardingRule(address _receiver, bool _enable) public {
        require(_receiver != ANY_ADDRESS);
