...
import {DataTypes} from '../types/DataTypes.sol';
  ...
  */
  library InstrumentConfiguration {
    ...
    **/
    function setLtv(DataTypes.InstrumentConfigurationMap memory self, uint256 ltv) public pure {
    ...
    **/
    function getLtv(DataTypes.InstrumentConfigurationMap storage self) public view returns (uint256) {
    ...
    **/
    function setLiquidationThreshold(DataTypes.InstrumentConfigurationMap memory self, uint256 threshold) public pure {
    ...
    **/
    function getLiquidationThreshold(DataTypes.InstrumentConfigurationMap storage self) public view returns (uint256) {
    ...
    **/
    function setLiquidationBonus(DataTypes.InstrumentConfigurationMap memory self, uint256 bonus) public pure {
    ...
    **/
    function getLiquidationBonus(DataTypes.InstrumentConfigurationMap storage self) public view returns (uint256) {
    ...
    **/
    function setDecimals(DataTypes.InstrumentConfigurationMap memory self, uint256 decimals) public pure {
    ...
    **/
    function getDecimals(DataTypes.InstrumentConfigurationMap storage self) public view returns (uint256) {
    ...
    **/
    function setActive(DataTypes.InstrumentConfigurationMap memory self, bool active) public pure {
