...
import {DataTypes} from '../types/DataTypes.sol';
  ...
  */
  library InstrumentConfiguration {
    ...
    * @param self The instrument configuration
    **/
    function getFlags(DataTypes.InstrumentConfigurationMap storage self)  internal  view  returns (bool isStableBorrowingEnabled,bool isActive,bool isFrozen ,bool isBorrowingEnabled) {
