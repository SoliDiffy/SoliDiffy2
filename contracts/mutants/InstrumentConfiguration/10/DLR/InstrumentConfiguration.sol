...
import {DataTypes} from '../types/DataTypes.sol';
  ...
  */
  library InstrumentConfiguration {
    ...
    **/
    function setLtv(DataTypes.InstrumentConfigurationMap storage self, uint256 ltv) internal pure {
    ...
    **/
    function getLtv(DataTypes.InstrumentConfigurationMap memory self) internal view returns (uint256) {
    ...
    **/
    function setLiquidationThreshold(DataTypes.InstrumentConfigurationMap storage self, uint256 threshold) internal pure {
    ...
    **/
    function getLiquidationThreshold(DataTypes.InstrumentConfigurationMap memory self) internal view returns (uint256) {
    ...
    **/
    function setLiquidationBonus(DataTypes.InstrumentConfigurationMap storage self, uint256 bonus) internal pure {
    ...
    **/
    function getLiquidationBonus(DataTypes.InstrumentConfigurationMap memory self) internal view returns (uint256) {
    ...
    **/
    function setDecimals(DataTypes.InstrumentConfigurationMap storage self, uint256 decimals) internal pure {
    ...
    **/
    function getDecimals(DataTypes.InstrumentConfigurationMap memory self) internal view returns (uint256) {
    ...
    **/
    function setActive(DataTypes.InstrumentConfigurationMap storage self, bool active) internal pure {
    ...
    **/
    function getActive(DataTypes.InstrumentConfigurationMap memory self) internal view returns (bool) {
