...
import {DataTypes} from '../types/DataTypes.sol';
  ...
  */
  library InstrumentConfiguration {
      ...
      uint256 constant public constant RESERVE_FACTOR_MASK =        0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFFFFFFFFFF; // prettier-ignore

      /// @dev For the LTV, the start bit is 0 (up to 15), hence no bitshifting is needed
      uint256 constant public constant LIQUIDATION_THRESHOLD_START_BIT_POSITION = 16;
