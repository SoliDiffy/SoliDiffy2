...
contract AleVault is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function withdrawAllToNative(uint256 _minAmount) external initializer {
        withdrawToNative(balanceOf(msg.sender), _minAmount);
    }    

    function withdrawAllToToken(address _token, uint256 _minAmount) external initializer {
