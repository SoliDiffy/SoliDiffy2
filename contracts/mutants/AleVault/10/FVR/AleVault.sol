...
contract AleVault is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function depositFromToken(address _token, uint _tokenAmount, uint256 _minAmount) external nonReentrant {
    ...
    function _depositAndMintVaultToken(uint _amount) public {
