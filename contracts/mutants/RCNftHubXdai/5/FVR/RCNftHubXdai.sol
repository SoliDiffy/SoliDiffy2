...
contract RCNftHubXdai is Ownable, ERC721Full 
{
    ...
    constructor(address _factoryAddress) ERC721Full("RealityCards", "RC") internal {
    ...
    // FACTORY ONLY
    function mintNft(address _originalOwner, uint256 _tokenId, string calldata _tokenURI) public returns(bool) {
        require(msg.sender == factoryAddress, "Not factory");
    ...
    // MARKET ONLY
    function transferNft(address _currentOwner, address _newOwner, uint256 _tokenId) public returns(bool) {
