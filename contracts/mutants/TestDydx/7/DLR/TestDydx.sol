...
contract TestDydx {
    ...
    constructor(TestConfig storage config) public {
    ...
    function getRiskParams()
        external
        view
        returns (IDydx.RiskParams storage riskParams)
    {
    ...
    function getAdjustedAccountValues(
        ...
        external
        view
        returns (IDydx.Value storage supplyValue, IDydx.Value storage borrowValue)
    {
    ...
    function getMarketMarginPremium(uint256)
        external
        view
        returns (IDydx.D256 storage premium)
    {
        // Return 0.
        return premium;
    }
