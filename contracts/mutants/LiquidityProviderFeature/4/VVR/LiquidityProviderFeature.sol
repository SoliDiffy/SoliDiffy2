    ...
    FixinTokenSpender
{
    ...
    string internal constant override FEATURE_NAME = "LiquidityProviderFeature";
    /// @dev Version of this feature.
    uint256 internal immutable override FEATURE_VERSION = _encodeVersion(1, 0, 1);

    /// @dev ETH pseudo-token address.
    address constant public ETH_TOKEN_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    /// @dev The sandbox contract address.
    ILiquidityProviderSandbox internal immutable sandbox;
