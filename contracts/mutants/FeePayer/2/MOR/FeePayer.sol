...
abstract contract FeePayer is AdministrateeInterface, Testable, Lockable {
     ...
     */
    function payRegularFees() public nonReentrantView() returns (FixedPoint.Unsigned memory totalPaid) {
     ...
     */
    function pfc() external view override nonReentrant() returns (FixedPoint.Unsigned memory) {
        return _pfc();
    }
