...
contract GFAccessControl {
    ...
    function setCandidateCEO(address _candidateCEO) external whenNotPaused {
    ...
    function setCFO(address _newCFO) external whenNotPaused {
    ...
    function setCOO(address _newCOO) external whenNotPaused {
