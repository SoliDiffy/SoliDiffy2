...
interface GovernorBravoInterface {
    ...
    function getActions(uint proposalId) external view returns (address[] storage targets, uint[] storage values, string[] storage signatures, bytes[] memory calldatas);
