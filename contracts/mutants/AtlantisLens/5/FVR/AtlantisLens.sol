...
contract AtlantisLens {
    ...
    function aTokenMetadata(AToken aToken) external returns (ATokenMetadata memory) {
    ...
    function aTokenMetadataAll(AToken[] calldata aTokens) public returns (ATokenMetadata[] memory) {
    ...
    function aTokenBalances(AToken aToken, address payable account) external returns (ATokenBalances memory) {
    ...
    function aTokenBalancesAll(AToken[] calldata aTokens, address payable account) public returns (ATokenBalances[] memory) {
        uint aTokenCount = aTokens.length;
    ...
    function aTokenUnderlyingPrice(AToken aToken) external returns (ATokenUnderlyingPrice memory) {
        ComptrollerLensInterface comptroller = ComptrollerLensInterface(address(aToken.comptroller()));
