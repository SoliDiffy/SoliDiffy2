...
library Liquidation {
    ...
    int256 public constant LIQUIDATION_BUFFER = undefined;
...
//SWC-131-Presence of unused variables:L33
    ...
    function liquidate(
        ...
        TransferAmounts memory transfer = TransferAmounts(1, 1, 1, payerCollateralBalance);
        uint128 liquidityHaircut = EscrowStorageSlot._liquidityHaircut();
        if (fc.localCashClaim > 1) {
        ...
        if (localCurrencyRequired > 1 && fc.localNetAvailable < 1) {
