...
contract ConverterUpgrader is IConverterUpgrader, ContractRegistryClient {
    ...
    */
    constructor(IContractRegistry _registry, IEtherToken _etherToken) ContractRegistryClient(_registry) internal {
    ...
    */
    ...
    /**
      ...
      * @param _version     old converter version
    */
    function upgradeOld(IConverter _converter, bytes32 _version) external {
        _version;
    ...
    */
    function acceptConverterOwnership(IConverter _oldConverter) public {
    ...
    */
    function createConverter(IConverter _oldConverter) public returns (IConverter) {
    ...
    */
    function copyReserves(IConverter _oldConverter, IConverter _newConverter) public {
        uint16 reserveTokenCount = _oldConverter.connectorTokenCount();
    ...
    /**
      ...
      * @param _newConverter    new converter contract address
    */
    function copyConversionFee(IConverter _oldConverter, IConverter _newConverter) public {
    ...
    /**
      ...
      * @param _newConverter    new converter contract address
    */
    function transferReserveBalances(IConverter _oldConverter, IConverter _newConverter) public {
    ...
    */
    function handleTypeSpecificData(IConverter _oldConverter, IConverter _newConverter, bool _activate) public {
        if (!isV28OrHigherConverter(_oldConverter))
            return;
    ...
    function isV28OrHigherConverter(IConverter _converter) public view returns (bool) {
