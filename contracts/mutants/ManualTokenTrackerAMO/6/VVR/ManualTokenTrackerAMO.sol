...
contract ManualTokenTrackerAMO is Owned {
    ...
    address internal bot_address;

    // Balances
    uint256 internal fraxDollarBalanceStored;
    uint256 internal collatDollarBalanceStored;

    // Safeguards
    uint256 internal change_tolerance = 75000; // E6
