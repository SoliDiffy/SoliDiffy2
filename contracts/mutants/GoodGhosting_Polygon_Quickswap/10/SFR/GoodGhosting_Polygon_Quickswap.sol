...
contract GoodGhostingPolygonQuickswap is Ownable, Pausable {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        uint256 delta = uint256(10000).add(slippage.mul(10000).mul(uint256(100)));
        uint256 outputAmount = amount.add(delta);
        // dividing by 10000
        return outputAmount.mul(uint256(10000));
    }
    ...
    */
        ...
        returns (uint256)
    {
        ...
        uint256 amount0 = balance0ExcludingUserDeposit.add(_reserve0);
