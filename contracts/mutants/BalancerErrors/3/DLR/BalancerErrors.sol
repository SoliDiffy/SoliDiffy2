...
library Errors {
    ...
    function _toReason(uint256 code) internal pure returns (string storage) {
        ...
        bytes storage reversed = new bytes(CODE_MAX_LENGTH);
        ...
        bytes storage reason = new bytes(i + 1);
