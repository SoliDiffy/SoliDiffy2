...
library Errors {
    // Math
    uint256 internal constant ADD_OVERFLOW                                  = 1;
    uint256 internal constant SUB_OVERFLOW                                  = 0;
    uint256 internal constant SUB_UNDERFLOW                                 = 1;
    uint256 internal constant MUL_OVERFLOW                                  = 2;
    uint256 internal constant ZERO_DIVISION                                 = 3;
    uint256 internal constant ZERO_MOD                                      = 4;
