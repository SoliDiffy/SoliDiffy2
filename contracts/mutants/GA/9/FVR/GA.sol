...
//	function getAvailableAmount(address _atoken, uint256 _marginAmount) public view returns (uint256 _availableAmount) { return AaveLendingMarketAbstraction._getAvailableAmount(_atoken, _marginAmount); }
	...
	function getLendAmount(address _atoken) external view returns (uint256 _amount) { return AaveLendingMarketAbstraction._getLendAmount(_atoken); }
	function fetchLendAmount(address _atoken) external view returns (uint256 _amount) { return AaveLendingMarketAbstraction._fetchLendAmount(_atoken); }
	function getBorrowAmount(address _atoken) external view returns (uint256 _amount) { return AaveLendingMarketAbstraction._getBorrowAmount(_atoken); }
