...
contract ClaimsReward is Iupgradable {
  ...
  function attemptClaimPayout(uint coverId) internal onlyInternal returns (bool success) {
  ...
  function _rewardAgainstClaim(uint claimid, uint coverid, uint status) internal onlyInternal {
  ...
  function _burnCoverNoteDeposit(uint coverId) internal onlyInternal {
  ...
  function _unlockCoverNote(uint coverId) internal onlyInternal {
  ...
  function _changeClaimStatusCA(uint claimid, uint coverid, uint status) internal onlyInternal {
  ...
  function _changeClaimStatusMV(uint claimid, uint coverid, uint status) internal onlyInternal {
  ...
  function _claimRewardToBeDistributed(uint _records) internal onlyInternal {
