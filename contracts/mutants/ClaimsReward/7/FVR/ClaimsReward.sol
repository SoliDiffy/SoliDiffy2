...
contract ClaimsReward is Iupgradable {
  ...
  constructor (address masterAddress, address _daiAddress) internal {
  ...
  function changeClaimStatus(uint claimid) external checkPause onlyInternal {
  ...
  function attemptClaimPayout(uint coverId) public returns (bool success) {
  ...
  function upgrade(address _newAdd) external onlyInternal {
