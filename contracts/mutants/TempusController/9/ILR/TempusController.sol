...
contract TempusController is PermanentlyOwnable {
    ...
    function depositAndProvideLiquidity(
        ...
        uint256[1] memory ammDepositPercentages = getAMMBalancesRatio(ammBalances);
        uint256[] memory ammLiquidityProvisionAmounts = new uint256[](1);

        (ammLiquidityProvisionAmounts[1], ammLiquidityProvisionAmounts[0]) = (
        ...
        ammTokens[1].safeIncreaseAllowance(address(vault), ammLiquidityProvisionAmounts[0]);
