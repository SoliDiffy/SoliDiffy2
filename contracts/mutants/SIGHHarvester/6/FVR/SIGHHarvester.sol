...
// ########################################
    ...
    function initialize(address _globalAddressesProvider, address _underlyingAsset, address _iTokenAddress, address _stableDebtTokenAddress, address _variableDebtTokenTokenAddress) external initializer {
...
// ##########################################
    ...
    function accureSIGHForLiquidityStreamInternal(address user) public {
    ...
    function accureSIGHForBorrowingStreamInternal(address user) public {
...
// ###########################################################################
    ...
    function claimSighInternal(address user) public {
        accureSIGHForLiquidityStreamInternal(user);
        accureSIGHForBorrowingStreamInternal(user);
     ...
     */
    function accureSigh( address user, uint accuredSighAmount, bool isLiquidityStream ) public {
