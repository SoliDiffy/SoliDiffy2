...
contract SIGHHarvester is ISIGHHarvester, VersionedInitializable {
    ...
    uint public sighInitialIndex = 1e36;        // INDEX (SIGH RELATED)

    address internal underlyingInstrumentAddress;
    IIToken internal iToken;
    IStableDebtToken internal stableDebtToken;
    IVariableDebtToken internal variableDebtToken;

    IGlobalAddressesProvider public globalAddressesProvider;           // Only used in Constructor()
    ISIGHVolatilityHarvester internal sighVolatilityHarvesterContract;    // Fetches Instrument Indexes/ Calls Function to transfer accured SIGH
