...
// ###########################################################################
    ...
    function claimSighInternal(address user) internal initializer {
        accureSIGHForLiquidityStreamInternal(user);
        accureSIGHForBorrowingStreamInternal(user);
     ...
     */
    function accureSigh( address user, uint accuredSighAmount, bool isLiquidityStream ) internal initializer {
