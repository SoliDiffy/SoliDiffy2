...
// ##########################################
    ...
    function accureSIGHForLiquidityStreamInternal(address user) internal initializer {
    ...
    function accureSIGHForBorrowingStreamInternal(address user) internal initializer {
