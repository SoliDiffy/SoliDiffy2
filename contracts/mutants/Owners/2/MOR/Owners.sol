...
function addOwner(address account) private returns(uint256){
 ...
 function newInOwners(address account ) public onlyOwnersExist(account) onlyNewOwners(account)  returns (uint256){
...
function removeFromOwners(address account) public onlyNewOwners(account) onlyOwnersExist(account) {
