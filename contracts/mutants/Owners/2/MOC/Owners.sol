...
function addOwner(address account) private returns(uint256){
 ...
 function newInOwners(address account ) public onlyNewOwners(account) onlyIsInOwners  returns (uint256){
...
function removeFromOwners(address account) public onlyOwnersExist(account) onlyIsInOwners {
