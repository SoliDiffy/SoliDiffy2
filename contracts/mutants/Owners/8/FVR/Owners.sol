...
constructor () public {
    ...
    function OwnerExist(address account) external view returns (bool) {
        return _SownersExist( _IDSownersIndex[account]);
    }

    function SownersIndexExist(uint256 index) public view returns (bool) {
    ...
    function _SownersExist(uint256 SownersID)public view returns (bool) {
...
function addOwner(address account) public returns(uint256){
