    ...
    GovernorVotesCompUpgradeable
{
    ...
    ) public virtual override(IGovernorUpgradeable, GovernorUpgradeable, GovernorCompatibilityBravoUpgradeable) onlyInitializing returns (uint256) {
    ...
    function queue(
        ...
        bytes[] memory calldatas,
        bytes32 salt
    ) public virtual override(IGovernorTimelockUpgradeable, GovernorTimelockCompoundUpgradeable) onlyInitializing returns (uint256) {
    ...
    function execute(
        ...
        bytes[] memory calldatas,
        bytes32 salt
    ) public payable virtual override(IGovernorUpgradeable, GovernorUpgradeable) onlyInitializing returns (uint256) {
