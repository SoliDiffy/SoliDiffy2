...
contract BorrowerOperations is LiquityBase, Ownable, IBorrowerOperations {
    ...
    */
    ...
    function _adjustTrove(address _borrower, uint _collWithdrawal, uint _debtChange, bool _isDebtIncrease, address _hint) public {
    ...
    function _getUSDValue(uint _coll, uint _price) public pure returns (uint) {
    ...
    function _activePoolAddColl(uint _amount) public {
    ...
    function _withdrawLUSD(address _account, uint _LUSDAmount, uint _rawDebtIncrease) public {
