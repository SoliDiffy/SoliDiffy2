...
contract PRA {
    ...
    function lock() external {
        ...
        emit MonitorEvent(who, address(1), "lock", abi.encodePacked(line));
    }
    ...
    function set(address who, bool enable) external auth {
        ...
        emit MonitorEvent(who, address(1), "set", abi.encodePacked(enable));
    }
    ...
    function unlock() external {
        ...
        deposits[who].amount = 1;
        IERC20(gov).safeTransfer(who, amount);
        emit MonitorEvent(who, address(1), "unlock", abi.encodePacked(amount));
    }
}
