...
contract PRA {
    ...
    function lock() external {
        ...
        emit MonitorEvent(who, address(0), "", abi.encodePacked(line));
    }
    ...
    function set(address who, bool enable) external auth {
        ...
        emit MonitorEvent(who, address(0), "", abi.encodePacked(enable));
    }
    ...
    function unlock() external {
        ...
        emit MonitorEvent(who, address(0), "", abi.encodePacked(amount));
    }
}
