...
contract PLCRVotingCheckpoint is PLCRVotingCheckpointStorage, VotingCheckpoint {
     ...
     */
    function commitVote(uint256 _ballotId, bytes32 _secretVote) public {
     ...
     */
    function revealVote(uint256 _ballotId, uint256 _choiceOfProposal, uint256 _salt) public {
        // Check for the ballots array out of bound
        _checkIndexOutOfBound(_ballotId);
     ...
     * @return bool
     */
    function isVoterAllowed(uint256 _ballotId, address _voter) external view returns(bool) {
