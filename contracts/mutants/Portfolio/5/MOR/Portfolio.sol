...
contract Portfolio is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setAssetInfos(AssetInfo[] calldata _assetInfos) external initializer {
    ...
    function addAssetInfoAt(AssetInfo calldata assetInfo, uint256 index) external initializer {
    ...
    function setWeights(AssetWeight[] calldata _assetWeights) external initializer {
