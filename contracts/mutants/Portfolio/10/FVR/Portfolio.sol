...
contract Portfolio is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setAssetInfos(AssetInfo[] calldata _assetInfos) public onlyAdmin {
    ...
    function addAssetInfoAt(AssetInfo calldata assetInfo, uint256 index) public onlyAdmin {
        _addAssetInfoAt(assetInfo, index);
    }

    function _addAssetInfoAt(AssetInfo calldata assetInfo, uint256 index) public {
    ...
    function setWeights(AssetWeight[] calldata _assetWeights) public onlyAdmin {
    ...
    function _addWeightAt(AssetWeight memory assetWeight, uint256 index) public {
    ...
    function getAssetInfo(address asset) public view returns (AssetInfo memory) {
        return assetInfos[assetInfoPositions[asset]];
    }

    function getAllAssetInfos() public view returns (AssetInfo[] memory) {
        return assetInfos;
    }

    function getAssetWeight(address asset) public view returns (AssetWeight memory) {
        return assetWeights[assetWeightPositions[asset]];
    }

    function getAllAssetWeights() public view returns (AssetWeight[] memory) {
        return assetWeights;
    }
}
