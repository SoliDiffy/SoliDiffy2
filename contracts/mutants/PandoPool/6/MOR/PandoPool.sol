...
contract PandoPool is Ownable, Pausable {
    ...
    function allocateReward(uint256 _days) external onlyOwner whenNotPaused{
    ...
    function emergencyWithdraw(address _token) external onlyOperator whenPaused {
    ...
    function setPandoAssembly(address _pandoAssembly) external onlyOperator {
        pandoAssembly = _pandoAssembly;
    }
