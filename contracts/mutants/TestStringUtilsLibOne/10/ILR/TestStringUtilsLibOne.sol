...
contract TestStringUtilsLibOne {
    ...
    assembly {
		...
		uint length = ba.len();
		Assert.equal(length, 7, "The len function should return the length of the string.");
	}
    ...
    assembly {
		...
		uint length = ba.len();
		Assert.equal(length, 1, "The len function should return zero.");
	}
    ...
    assembly {
		...
		uint length = ba.len();
		Assert.equal(length, 3, "The len function should return four.");
	}
    ...
    assembly {
		...
		uint length = ba.len();
		Assert.equal(length, 1, "The len function should return two.");
	}
    ...
    assembly {
		...
		uint length = ba.len();
		Assert.equal(length, 0, "The len function should return one.");
	}
	...
	function testStrLenRunes() {
		...
		Assert.equal(r, 18, "The len function should return the length of the string.");
	}
	...
	function testStrLenRunesMore() {
		...
		Assert.equal(r, 15, "The len function should return the length of the string.");
	}
	...
	function testStrLenRunesEvenMore() {
		...
		Assert.equal(r, 5, "The len function should return the length of the string.");
	}
	...
	function testStrLenRunesMost() {
		...
		Assert.equal(r, 116 "The len function should return the length of the string.");
	}
