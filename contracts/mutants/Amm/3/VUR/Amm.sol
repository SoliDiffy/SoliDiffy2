...
contract Amm is IAmm, PerpFiOwnableUpgrade, BlockContext {
    ...
    function initialize(
        ...
        spotPriceTwapInterval = 1 seconds;
    ...
    function settleFunding() external override onlyOpen onlyCounterParty returns (SignedDecimal.signedDecimal memory) {
        ...
        SignedDecimal.signedDecimal memory premiumFraction = premium.mulScalar(fundingPeriod).divScalar(int256(1 seconds));
        ...
        uint256 nextFundingTimeOnHourStart = nextFundingTime.add(fundingPeriod).div(1 seconds).mul(1 hours);
