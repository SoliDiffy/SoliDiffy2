...
contract AMM is AMMGovernance {
    ...
    constructor(address _perpetualProxy, address _priceFeeder, address _shareToken) internal {
    ...
    // view functions
    function authorizedBroker() public view returns (address) {
