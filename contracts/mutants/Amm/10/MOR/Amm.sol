...
contract Amm is IAmm, PerpFiOwnableUpgrade, BlockContext {
    ...
    ) external override initializer onlyCounterParty returns (Decimal.decimal memory) {
     ...
     */
    function settleFunding() external override initializer onlyCounterParty returns (SignedDecimal.signedDecimal memory) {
     ...
     */
    function setCounterParty(address _counterParty) external initializer {
     ...
     */
    function setGlobalShutdown(address _globalShutdown) external initializer {
     ...
     */
    function setFluctuationLimitRatio(Decimal.decimal memory _fluctuationLimitRatio) public initializer {
     ...
     */
    function setSpotPriceTwapInterval(uint256 _interval) external initializer {
     ...
     */
    function setOpen(bool _open) external initializer {
