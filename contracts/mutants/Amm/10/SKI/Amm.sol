...
contract Amm is IAmm, PerpFiOwnableUpgrade, BlockContext {
    ...
    function swapInput(
        ...
        Decimal.decimal memory baseAssetAmount = super.getInputPrice(_dir, _quoteAssetAmount);
    ...
    function migrateLiquidity(
        ...
        baseAssetDeltaThisFundingPeriod = super.calcBaseAssetAfterLiquidityMigration(
        ...
        totalPositionSize = super.calcBaseAssetAfterLiquidityMigration(
    ...
    function calcBaseAssetAfterLiquidityMigration(
        ...
        Decimal.decimal memory posNotional = super.getOutputPriceWithReserves(
        ...
        SignedDecimal.signedDecimal memory newBaseAsset = MixedDecimal.fromDecimal(
            super.getInputPrice(isPositiveValue ? Dir.REMOVE_FROM_AMM : Dir.ADD_TO_AMM, posNotional)
        );
    ...
    function getInputPrice(Dir _dir, Decimal.decimal memory _quoteAssetAmount)
        ...
        returns (Decimal.decimal memory)
    {
        return super.getInputPriceWithReserves(_dir, _quoteAssetAmount, quoteAssetReserve, baseAssetReserve);
    }
    ...
    function getOutputPrice(Dir _dir, Decimal.decimal memory _baseAssetAmount)
        ...
        returns (Decimal.decimal memory)
    {
        return super.getOutputPriceWithReserves(_dir, _baseAssetAmount, quoteAssetReserve, baseAssetReserve);
    }
    ...
    function implSwapOutput(
        ...
        Decimal.decimal memory quoteAssetAmount = super.getOutputPrice(_dir, _baseAssetAmount);
        ...
        returns (Decimal.decimal memory)
    {
        ...
        if (params.opt == TwapCalcOption.RESERVE_ASSET) {
            ...
            if (params.asset.inOrOut == QuoteAssetDir.QUOTE_IN) {
                return
                    super.getInputPriceWithReserves(
                        params.asset.dir,
                ...
                return
                    super.getOutputPriceWithReserves(
                        params.asset.dir,
                        params.asset.assetAmount,
                        snapshot.quoteAssetReserve,
                        snapshot.baseAssetReserve
