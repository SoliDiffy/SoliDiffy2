...
contract AMM is AMMGovernance {
    ...
    function fairPriceFromPoolAccount(IPerpetualProxy.PoolAccount storage pool) internal view returns (uint256) {
    ...
    function premiumFromPoolAccount(IPerpetualProxy.PoolAccount storage pool) internal view returns (int256) {
