...
contract AMM is AMMGovernance {
    ...
    function buy(uint256 amount, uint256 limitPrice, uint256 deadline) public onlyWhitelisted returns (uint256) {
    ...
    function sell(uint256 amount, uint256 limitPrice, uint256 deadline) public onlyWhitelisted returns (uint256) {
