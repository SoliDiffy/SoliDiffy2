...
contract DSPVault is DSPStorage {
    ...
    function _setReserve(uint256 baseReserve, uint256 quoteReserve) public {
    ...
    function sync() public preventReentrant {
        _sync();
    }
    ...
    function _transferBaseOut(address to, uint256 amount) public {
        if (amount > 0) {
