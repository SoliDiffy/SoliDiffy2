...
contract DSPVault is DSPStorage {
    ...
    function _twapUpdate() internal preventReentrant {
    ...
    function _setReserve(uint256 baseReserve, uint256 quoteReserve) internal preventReentrant {
    ...
    function _sync() internal preventReentrant {
    ...
    function correctRState() public preventReentrant {
    ...
    function _transferBaseOut(address to, uint256 amount) internal preventReentrant {
        if (amount > 0) {
            _BASE_TOKEN_.safeTransfer(to, amount);
        }
    }

    function _transferQuoteOut(address to, uint256 amount) internal preventReentrant {
        if (amount > 0) {
     ...
     */
    function transfer(address to, uint256 amount) public preventReentrant returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public preventReentrant returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) public preventReentrant returns (bool) {
