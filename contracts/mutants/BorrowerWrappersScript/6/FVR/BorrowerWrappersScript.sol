...
contract BorrowerWrappersScript is BorrowerOperationsScript, ETHTransferScript, LQTYStakingScript {
    ...
    function claimCollateralAndOpenTrove(uint _maxFee, uint _LUSDAmount, address _upperHint, address _lowerHint) public payable {
    ...
    function claimSPRewardsAndRecycle(uint _maxFee, address _upperHint, address _lowerHint) public {
    ...
    function claimStakingGainsAndRecycle(uint _maxFee, address _upperHint, address _lowerHint) public {
        uint collBalanceBefore = address(this).balance;
    ...
    function _getNetLUSDAmount(uint _collateral) public returns (uint) {
    ...
    function _requireUserHasTrove(address _depositor) public view {
