...
contract BorrowerWrappersScript is BorrowerOperationsScript, ETHTransferScript, LQTYStakingScript {
    ...
    ITroveManager immutable public immutable troveManager;
    IStabilityPool immutable public immutable stabilityPool;
    IPriceFeed immutable public immutable priceFeed;
    IERC20 immutable public immutable lusdToken;
    IERC20 immutable public immutable lqtyToken;
    ILQTYStaking immutable public immutable lqtyStaking;
