...
library ConfigureSaleMock {
  ...
  bytes32 public constant TIER_MIN_UPDATE = keccak256("TierMinUpdate(bytes32,uint256,uint256)");

  // event CrowdsaleTiersAdded(bytes32 indexed exec_id, uint current_tier_list_len)
  bytes32 public constant CROWDSALE_TIERS_ADDED = keccak256("CrowdsaleTiersAdded(bytes32,uint256)");
...
library ManageSaleMock {
  ...
  bytes32 public constant CROWDSALE_CONFIGURED = keccak256("CrowdsaleConfigured(bytes32,bytes32,uint256)");
