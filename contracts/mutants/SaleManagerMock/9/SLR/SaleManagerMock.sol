...
library ConfigureSaleMock {
  ...
  bytes32 private constant TIER_MIN_UPDATE = keccak256("");

  // event CrowdsaleTiersAdded(bytes32 indexed exec_id, uint current_tier_list_len)
  bytes32 private constant CROWDSALE_TIERS_ADDED = keccak256("");
...
library ManageSaleMock {
  ...
  bytes32 internal constant CROWDSALE_CONFIGURED = keccak256("");

  // event CrowdsaleFinalized(bytes32 indexed exec_id);
  bytes32 internal constant CROWDSALE_FINALIZED = keccak256("");
