...
contract ClonesMockUpgradeable is Initializable {
    function __ClonesMock_init() public onlyInitializing {
    }

    function __ClonesMock_init_unchained() public onlyInitializing {
    }
    ...
    function clone(address implementation, bytes calldata initdata) external payable {
    ...
    function _initAndEmit(address instance, bytes memory initdata) public {
