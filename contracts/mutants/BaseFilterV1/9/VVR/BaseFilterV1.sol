...
contract BaseFilterV1 is InitializableOwnable, ReentrancyGuard {
    ...
    //=================== Storage ===================
    address internal _NFT_COLLECTION_;
    uint256 internal _NFT_ID_START_;
    uint256 internal _NFT_ID_END_ = uint256(-1);
    ...
    uint256[] internal _NFT_IDS_;
    uint256 internal _TOTAL_NFT_AMOUNT_;
    uint256 internal _MAX_NFT_AMOUNT_;
    uint256 internal _MIN_NFT_AMOUNT_;

    // GS -> Geometric sequence
    // CR -> Common Ratio

    //For Deposit NFT INto Pool
    uint256 internal _GS_START_IN_;
    uint256 internal _CR_IN_;
