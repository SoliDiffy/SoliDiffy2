...
contract BaseFilterV1 is InitializableOwnable, ReentrancyGuard {
    ...
    function _changeNFTAmountRange(uint256 maxNFTAmount, uint256 minNFTAmount) internal onlySuperOwner {
    ...
    function _changeTokenIdRange(uint256 nftIdStart, uint256 nftIdEnd) internal onlySuperOwner {
