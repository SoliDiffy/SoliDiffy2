...
contract BaseFilterV1 is InitializableOwnable, ReentrancyGuard {
    ...
    function changeTokenIdMap(uint256[] storage tokenIds, bool[] storage isRegistered)
        external
        onlySuperOwner
    {
    ...
    function _changeTokenIdMap(uint256[] storage tokenIds, bool[] memory isRegistered) internal {
