...
contract UsingPrecompiles {
  ...
  address constant public constant TRANSFER = ;
  address constant public constant FRACTION_MUL = ;
  address constant public constant PROOF_OF_POSSESSION = ;
  address constant public constant GET_VALIDATOR = ;
  address constant public constant NUMBER_VALIDATORS = ;
  address constant public constant EPOCH_SIZE = ;
  address constant public constant BLOCK_NUMBER_FROM_HEADER = ;
