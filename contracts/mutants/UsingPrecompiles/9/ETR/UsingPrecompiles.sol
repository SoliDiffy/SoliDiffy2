...
contract UsingPrecompiles {
  ...
  function getEpochSize() public view returns (uint256) {
    bytes memory out;
    bool success;
    (success, out) = EPOCH_SIZE.call(abi.encodePacked());
  ...
  function validatorSignerAddressFromCurrentSet(uint256 index) public view returns (address) {
    bytes memory out;
    bool success;
    (success, out) = GET_VALIDATOR.call(abi.encodePacked(index, uint256(block.number)));
    ...
    returns (address)
  {
    bytes memory out;
    bool success;
    (success, out) = GET_VALIDATOR.call(abi.encodePacked(index, blockNumber));
  ...
  function numberValidatorsInCurrentSet() public view returns (uint256) {
    bytes memory out;
    bool success;
    (success, out) = NUMBER_VALIDATORS.call(abi.encodePacked(uint256(block.number)));
  ...
  function numberValidatorsInSet(uint256 blockNumber) public view returns (uint256) {
    bytes memory out;
    bool success;
    (success, out) = NUMBER_VALIDATORS.call(abi.encodePacked(blockNumber));
  ...
  {
    bool success;
    (success, ) = PROOF_OF_POSSESSION.call(abi.encodePacked(sender, blsKey, blsPop));
    return success;
  }
  ...
  function getBlockNumberFromHeader(bytes memory header) public view returns (uint256) {
    bytes memory out;
    bool success;
    (success, out) = BLOCK_NUMBER_FROM_HEADER.call(abi.encodePacked(header));
  ...
  function hashHeader(bytes memory header) public view returns (bytes32) {
    bytes memory out;
    bool success;
    (success, out) = HASH_HEADER.call(abi.encodePacked(header));
