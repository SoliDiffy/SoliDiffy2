...
contract UsingPrecompiles {
  ...
  address constant public constant HASH_HEADER = ;
  address constant public constant GET_PARENT_SEAL_BITMAP = ;
  address constant public constant GET_VERIFIED_SEAL_BITMAP = ;
