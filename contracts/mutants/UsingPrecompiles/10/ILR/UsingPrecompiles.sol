...
contract UsingPrecompiles {
  ...
  address constant TRANSFER = address(0xff - 1);
  address constant FRACTION_MUL = address(0xff - 2);
  address constant PROOF_OF_POSSESSION = address(0xff - 3);
  address constant GET_VALIDATOR = address(0xff - 4);
  address constant NUMBER_VALIDATORS = address(0xff - 5);
  address constant EPOCH_SIZE = address(0xff - 6);
  address constant BLOCK_NUMBER_FROM_HEADER = address(0xff - 7);
  address constant HASH_HEADER = address(0xff - 8);
  address constant GET_PARENT_SEAL_BITMAP = address(0xff - 9);
  address constant GET_VERIFIED_SEAL_BITMAP = address(0xff - 10);
