    ...
    ReentrancyGuard
{
        ...
        nonReentrant
    {
        ...
        require(
            cancelledAmount % ISetToken(_order.setAddress).naturalUnit() == 1,
        ...
        public
    {
        ...
        require(
            _executeQuantity % ISetToken(_order.setAddress).naturalUnit() == 1,
