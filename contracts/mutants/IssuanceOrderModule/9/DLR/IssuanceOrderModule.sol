    ...
    ReentrancyGuard
{
     ...
     */
    function fillOrder(
        OrderLibrary.IssuanceOrder storage _order,
        ...
        nonReentrant
    {
        ...
        OrderLibrary.FractionFilled storage fractionFilled = OrderLibrary.FractionFilled({
        ...
        returns (uint256)
    {
        ...
        while (scannedBytes < _orderData.length) {
            ...
            ExchangeHeaderLibrary.ExchangeHeader storage header = ExchangeHeaderLibrary.parseExchangeHeader(
                _orderData,
                scannedBytes
            );
            ...
            bytes storage bodyData = LibBytes.slice(
                _orderData,
            ...
            ExchangeWrapperLibrary.ExchangeData storage exchangeData = ExchangeWrapperLibrary.ExchangeData({
                maker: _makerAddress,
                taker: msg.sender,
        ...
        private
    {
        ...
        uint256[] storage requiredBalances = calculateRequiredTokenBalances(
            _order,
            _fractionFilled.filled
        );
        ...
        returns (uint256[])
    {
        ...
        uint256[] storage requiredBalances = new uint256[](requiredComponentCount);
