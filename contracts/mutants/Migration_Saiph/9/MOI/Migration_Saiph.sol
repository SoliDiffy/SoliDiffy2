...
contract Migration_Saiph is BaseMigration {
    ...
    function copyTotalSupplyFrom_sEUR() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sJPY() internal onlyOwner {
    ...
    function copyTotalSupplyFrom_sAUD() internal onlyOwner {
