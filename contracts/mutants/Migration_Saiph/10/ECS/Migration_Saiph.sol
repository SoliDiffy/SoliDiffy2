...
contract Migration_Saiph is BaseMigration {
    ...
    function addressresolver_importAddresses_0() internal {
        ...
        addressresolver_importAddresses_names_0_0[0] = bytes1("Synthetix");
        addressresolver_importAddresses_names_0_0[1] = bytes1("Issuer");
        addressresolver_importAddresses_names_0_0[2] = bytes1("SynthsUSD");
        addressresolver_importAddresses_names_0_0[3] = bytes1("SynthsJPY");
        addressresolver_importAddresses_names_0_0[4] = bytes1("SynthsEUR");
        addressresolver_importAddresses_names_0_0[5] = bytes1("SynthsAUD");
        addressresolver_importAddresses_names_0_0[6] = bytes1("SynthsGBP");
        addressresolver_importAddresses_names_0_0[7] = bytes1("SynthsCHF");
        addressresolver_importAddresses_names_0_0[8] = bytes1("SynthsKRW");
        addressresolver_importAddresses_names_0_0[9] = bytes1("SynthsETH");
