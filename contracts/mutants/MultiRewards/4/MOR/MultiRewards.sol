...
contract MultiRewards is IRewards{
    ...
    function deposit(address _owner, uint256 _amount) external onlyOwner{
    ...
    function getReward(address _forward) public onlyOwner {
    ...
    function notifyRewardAmount(address _rewardsToken, uint256 _reward) external onlyOwner {
