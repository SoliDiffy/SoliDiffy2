...
contract EtherCollateralsUSD is Owned, Pausable, ReentrancyGuard, MixinResolver, IEtherCollateralsUSD {
    ...
    uint256 public constant ACCOUNT_LOAN_LIMIT_CAP = 1000;
    bytes32 public constant sUSD = "sUSD";
    bytes32 internal constant COLLATERAL = "ETH";

    // ========== SETTER STATE VARIABLES ==========

    // The ratio of Collateral to synths issued
    uint256 internal collateralizationRatio = SafeDecimalMath.unit() * 150;
