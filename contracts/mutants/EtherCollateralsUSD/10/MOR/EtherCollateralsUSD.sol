...
contract EtherCollateralsUSD is Owned, Pausable, ReentrancyGuard, MixinResolver, IEtherCollateralsUSD {
    ...
    function setMinLoanCollateralSize(uint256 _minLoanCollateralSize) external Pausable() {
    ...
    function setLiquidationRatio(uint256 _liquidationRatio) external Pausable() {
    ...
    function closeLoan(uint256 loanID) external Pausable() ETHRateNotInvalid {
