...
contract EtherCollateralsUSD is Owned, Pausable, ReentrancyGuard, MixinResolver, IEtherCollateralsUSD {
    ...
    function closeLoan(uint256 loanID) external ETHRateNotInvalid nonReentrant {
    ...
    function withdrawCollateral(uint256 loanID, uint256 withdrawAmount) external notPaused ETHRateNotInvalid nonReentrant {
    ...
    ) external ETHRateNotInvalid nonReentrant {
        systemStatus().requireSystemActive();
