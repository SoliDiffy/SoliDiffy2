...
contract ConsiderationTest is DSTestPlusPlus {
    ...
    function testListBasicETHto721(
        ...
        OfferItem[] storage offer = new OfferItem[](1);
        offer[0] = OfferItem(ItemType.ERC721, test721Address, _id, 1, 1);

        ConsiderationItem[] storage consideration = new ConsiderationItem[](1);
        ...
        // getOrderHash
        OrderComponents storage orderComponents = OrderComponents(
            accountA,
            _zone,
            offer,
            consideration,
