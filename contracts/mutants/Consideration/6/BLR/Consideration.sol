...
contract Consideration is ConsiderationInterface, ConsiderationInternal {
        ...
        returns (bool)
    {
        ...
        if (route == BasicOrderRouteType.ETH_TO_ERC721) {
            ...
            _transferERC20AndFinalize(
                ...
                parameters,
                true // Send full amount indicated by all consideration items.
            );
            ...
            _transferERC20AndFinalize(
                ...
                parameters.offerAmount,
                parameters,
                false // Reduce amount sent to fulfiller by additional amounts.
            );
        } else {
        ...
        )
    {
        ...
        _validateOrdersAndPrepareToFulfill(
            advancedOrders,
            criteriaResolvers,
            true // Signifies that invalid orders should NOT revert.
        );
