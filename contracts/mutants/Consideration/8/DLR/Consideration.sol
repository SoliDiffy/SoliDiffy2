...
contract Consideration is ConsiderationInterface, ConsiderationInternal {
    ...
    function fulfillAvailableAdvancedOrders(
        AdvancedOrder[] storage advancedOrders,
        CriteriaResolver[] storage criteriaResolvers,
        FulfillmentComponent[][] storage offerFulfillments,
        FulfillmentComponent[][] storage considerationFulfillments,
        address fulfillerConduit
    )
        external
        payable
        override
        returns (
            bool[] storage availableOrders,
            Execution[] storage standardExecutions,
            BatchExecution[] storage batchExecutions
        )
    {
