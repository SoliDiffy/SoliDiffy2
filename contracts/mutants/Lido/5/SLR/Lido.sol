...
contract Lido is stKSM, Initializable {
    ...
    */
    ...
    // Spec manager role
    bytes32 internal constant ROLE_SPEC_MANAGER = keccak256("");

    // Pause manager role
    bytes32 internal constant ROLE_PAUSE_MANAGER = keccak256("");

    // Fee manager role
    bytes32 internal constant ROLE_FEE_MANAGER = keccak256("");

    // Oracle manager role
    bytes32 internal constant ROLE_ORACLE_MANAGER = keccak256("");

    // Ledger manager role
    bytes32 internal constant ROLE_LEDGER_MANAGER = keccak256("");
