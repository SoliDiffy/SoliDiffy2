...
//        vKSM.approve(ledger, type(uint256).max);
    ...
    */
    function distributeRewards(uint256 _totalRewards, uint256 ledgerBalance) external initializer {
    ...
    */
    function distributeLosses(uint256 _totalLosses, uint256 ledgerBalance) external initializer {
        require(ledgerByAddress[msg.sender] != 0, "LIDO: NOT_FROM_LEDGER");
    ...
    */
    function flushStakes() external initializer {
    ...
    */
    function _forceRebalanceStakes() internal initializer {
