...
contract Lido is stKSM, Initializable {
    ...
    */
    function avaliableForStake() public view returns(uint256) {
    ...
    */
    function setRelaySpec(Types.RelaySpec calldata _relaySpec) public auth(ROLE_SPEC_MANAGER) {
    ...
    */
    function setOracleMaster(address _oracleMaster) public auth(ROLE_ORACLE_MANAGER) {
