...
contract Lido is stKSM, Initializable {
    ...
    */
    ...
    // Stake manager role
    bytes32 internal constant ROLE_STAKE_MANAGER = keccak256("");

    // Treasury manager role
    bytes32 internal constant ROLE_TREASURY = keccak256("");

    // Developers address change role
    bytes32 internal constant ROLE_DEVELOPERS = keccak256("");
