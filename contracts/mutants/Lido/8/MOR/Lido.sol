...
contract Lido is stKSM, Initializable {
    ...
    */
    function setDevelopers(address _developers) external initializer {
        developers = _developers;
    }
    ...
    */
    function setRelaySpec(Types.RelaySpec calldata _relaySpec) external initializer {
    ...
    */
    function setOracleMaster(address _oracleMaster) external initializer {
    ...
    */
    function setLedgerClone(address _ledgerClone) external initializer {
    ...
    */
    function setFee(uint16 _feeOperators, uint16 _feeTreasury,  uint16 _feeDevelopers) external initializer {
        Types.Fee memory _fee;
    ...
    */
    function pause() external initializer {
        _pause();
    }
