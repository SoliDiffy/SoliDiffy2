...
contract LidoTest is DSTest {
    ...
    DefiBridgeProxy public defiBridgeProxy;
    RollupProcessor public rollupProcessor;

    LidoBridge public bridge;

    AztecTypes.AztecAsset public empty;
    AztecTypes.AztecAsset public ethAsset = AztecTypes.AztecAsset({
        id: 1,
        erc20Address: address(0),
        assetType: AztecTypes.AztecAssetType.ETH
    });
    AztecTypes.AztecAsset public wstETHAsset = AztecTypes.AztecAsset({
        id: 2,
