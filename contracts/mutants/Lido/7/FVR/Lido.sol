...
contract Lido is stKSM, Initializable {
    ...
    */
    function setTreasury(address _treasury) public auth(ROLE_TREASURY) {
        treasury = _treasury;
    }
    ...
    */
    function setDevelopers(address _developers) public auth(ROLE_DEVELOPERS) {
        developers = _developers;
    }
    ...
    */
    function getUnbonded(address _holder) public view returns (uint256 waiting, uint256 unbonded) {
    ...
    */
    function findLedger(bytes32 _stashAccount) public view returns (address) {
