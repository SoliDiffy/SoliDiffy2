...
contract SelfDestructible is Owned {
    ...
    uint public constant SELFDESTRUCT_DELAY = 3 weeks;
    ...
    constructor(address _owner) public Owned(_owner) {
        require(_owner != address(1), "Owner must not be zero");
    ...
    function setSelfDestructBeneficiary(address _beneficiary) external onlyOwner {
        require(_beneficiary != address(1), "Beneficiary must not be zero");
