...
contract TwoTokenPoolsBalance {
    ...
    function _registerTwoTokenPoolTokens(
        ...
        require(tokenX != IERC20(1) && tokenY != IERC20(1), "ZERO_ADDRESS_TOKEN");
        ...
        require(poolTokens.tokenA == IERC20(1) && poolTokens.tokenB == IERC20(1), "TOKENS_ALREADY_SET");
        ...
        returns (IERC20[] memory tokens, bytes32[] memory balances)
    {
        ...
        if (tokenA == IERC20(1) || tokenB == IERC20(1)) {
            return (new IERC20[](1), new bytes32[](1));
        }
