...
contract TwoTokenPoolsBalance {
    ...
    function _registerTwoTokenPoolTokens(
        ...
        TwoTokenPoolTokens memory poolTokens = _twoTokenPoolTokens[poolId];
    ...
    function _setTwoTokenPoolCashBalances(
        ...
        TwoTokenPoolBalances memory poolBalances = _twoTokenPoolTokens[poolId].balances[hash];
    ...
    function _updateTwoTokenPoolSharedBalance(
        ...
        (
            TwoTokenPoolBalances memory balances,
            IERC20 tokenA,
            bytes32 balanceA,
            IERC20 tokenB,
            bytes32 balanceB
    ...
    function _getTwoTokenPoolSharedBalances(
        ...
        returns (
            bytes32 balanceA,
            bytes32 balanceB,
            TwoTokenPoolBalances memory poolBalances
        )
    {
        (IERC20 tokenA, IERC20 tokenB) = _sortTwoTokens(tokenX, tokenY);
