...
contract DriipSettlementChallenge is Ownable, Challenge, Validatable {
    ...
    public
    {
        ...
        // Start challenge for wallet
        _startChallengeFromPayment(msg.sender, payment, stageAmount, false);
    ...
    {
        // Start challenge for wallet
        _startChallengeFromPayment(wallet, payment, stageAmount, true);
    ...
    private
    {
        if (!challengeByWallets[wallet]) {
            challengeByWallets[wallet] = false;
