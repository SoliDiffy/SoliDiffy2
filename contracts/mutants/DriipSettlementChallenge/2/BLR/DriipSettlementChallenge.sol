...
contract DriipSettlementChallenge is Ownable, Challenge, Validatable {
    ...
    public
    {
        ...
        // Start challenge
        _startChallengeFromTrade(msg.sender, trade, intendedStageAmount, conjugateStageAmount, false);
    ...
    onlyOperator
    {
        ...
        _startChallengeFromTrade(wallet, trade, intendedStageAmount, conjugateStageAmount, true);
