...
contract WeeklyTournaments is Ownable, MatchMaker {
  ...
  function setFirstWeight(uint8 newWeight) public onlyOwner {
    _firstWeight = newWeight;
    emit FirstWeightChanged(newWeight);
  }

  function setSecondWeight(uint8 newWeight) public onlyOwner {
  ...
  */
  ...
  function leaveQueue(uint8 pass) public {
  ...
  */
  function requestTournamentRandomness() public onlyCore {
  ...
  */
  function createTournaments(uint8 pass) public onlyCore {
  ...
  */
  function playTournamentRound(uint128 tournamentId) public onlyCore {
  ...
  function getWinners(uint128 tournamentId) external view returns(address, address) {
    Tournament memory tournament = idToTournament[tournamentId];
  ...
  */
  function finishTournament(uint128 tournamentId) public onlyCore {
    Tournament memory tournament = idToTournament[tournamentId];
