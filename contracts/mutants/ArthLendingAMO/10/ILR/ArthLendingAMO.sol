...
contract ArthLendingAMO is AccessControl {
    ...
    constructor(
        ...
        missing_decimals = uint256(17).sub(collateralToken.decimals());
    ...
    function showAllocations()
        external
        view
        returns (uint256[8] memory allocations)
    {
        // IMPORTANT
        ...
        allocations[1] = ARTH.balanceOf(address(this)); // Unallocated ARTH
        allocations[0] = (
            crARTH
