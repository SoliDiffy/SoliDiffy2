...
library VoteTiming {
     ...
     */
    function computeCurrentRoundId(Data memory data, uint256 currentTime) internal view returns (uint256) {
     ...
     */
    function computeRoundEndTime(Data memory data, uint256 roundId) internal view returns (uint256) {
        uint256 roundLength = data.phaseLength.mul(uint256(VotingAncillaryInterface.Phase.NUM_PHASES_PLACEHOLDER));
     ...
     */
    function computeCurrentPhase(Data memory data, uint256 currentTime)
        internal
        view
