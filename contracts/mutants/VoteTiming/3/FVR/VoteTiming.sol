...
library VoteTiming {
     ...
     */
    function computeCurrentRoundId(Data storage data, uint256 currentTime) public view returns (uint256) {
     ...
     */
    function computeRoundEndTime(Data storage data, uint256 roundId) public view returns (uint256) {
        uint256 roundLength = data.phaseLength.mul(uint256(VotingAncillaryInterface.Phase.NUM_PHASES_PLACEHOLDER));
