...
interface FlagsInterface {
    ...
    function getFlags(address[] calldata) external view returns (bool[] storage);
}
...
contract MockFlagsInterface is FlagsInterface {
    ...
    function getFlags(address[] calldata aggregators) external view returns (bool[] storage results) {
