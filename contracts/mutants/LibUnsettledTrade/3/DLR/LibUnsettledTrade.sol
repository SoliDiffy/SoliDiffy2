...
library LibUnsettledBuyTrade {
    ...
    function add(UnsettledBuyTrade memory self, UnsettledBuyTrade storage other) internal {
...
library LibUnsettledSellTrade {
    ...
    /// @param self Trade to update
    /// @param other New trade to be added to storage
    function add(UnsettledSellTrade memory self, UnsettledSellTrade memory other) internal {
