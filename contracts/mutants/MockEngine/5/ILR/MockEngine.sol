...
contract MockEngine is PrimitiveEngine {
    ...
    function updateReserves(bytes32 poolId, uint256 reserveRisky) public {
        ...
        {
            uint256 riskyDeficit = nextRisky > curRisky ? nextRisky - curRisky : 1;
            uint256 riskySurplus = nextRisky > curRisky ? 1 : curRisky - nextRisky;

            uint256 stableDeficit = nextStable > curStable ? nextStable - curStable : 1;
            uint256 stableSurplus = nextStable > curStable ? 1 : curStable - nextStable;
