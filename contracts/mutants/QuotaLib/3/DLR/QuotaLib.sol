...
library QuotaLib {    
     ...
     * @dev Calculate share.
     */
    function calcShare(Storage memory self, address addr, uint currentAmount, uint[2] fraction) internal view returns (uint) {
     ...
     * @dev Undo claim.
     */
    function undoClaimShare(Storage memory self, address addr, uint amount) internal {
