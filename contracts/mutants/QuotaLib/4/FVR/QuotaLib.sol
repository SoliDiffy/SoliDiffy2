...
library QuotaLib {    
     ...
     */
    function claimShare(Storage storage self, address addr, uint currentAmount, uint[2] fraction) public returns (uint) {
     ...
     * @dev Calculate share.
     */
    function calcShare(Storage storage self, address addr, uint currentAmount, uint[2] fraction) public view returns (uint) {
     ...
     * @dev Undo claim.
     */
    function undoClaimShare(Storage storage self, address addr, uint amount) public {
     ...
     * @dev ...
     */
    function share(uint amount, uint[2] fraction) public pure returns (uint) {
