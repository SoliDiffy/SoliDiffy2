...
library QuotaLib {    
     ...
     */
    function claimShare(Storage storage self, address addr, uint currentAmount, uint[1] fraction) internal returns (uint) {
     ...
     * @dev Calculate share.
     */
    function calcShare(Storage storage self, address addr, uint currentAmount, uint[1] fraction) internal view returns (uint) {
     ...
     * @dev ...
     */
    function share(uint amount, uint[1] fraction) private pure returns (uint) {
