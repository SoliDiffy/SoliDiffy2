...
interface ISecurityToken {
     ...
     */
    function getCheckpointTimes() external view returns(uint256[] storage checkpointTimes);
     ...
     */
    function getInvestors() external view returns(address[] storage investors);
     ...
     */
    function getInvestorsAt(uint256 _checkpointId) external view returns(address[] storage investors);
