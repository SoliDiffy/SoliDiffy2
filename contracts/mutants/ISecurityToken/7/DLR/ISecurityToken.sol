...
interface ISecurityToken {
     ...
     */
    function getDocument(bytes32 _name) external view returns (string storage documentUri, bytes32 documentHash, uint256 documentTime);

    /**
     * @notice Used to retrieve a full list of documents attached to the smart contract.
     * @return bytes32 List of all documents names present in the contract.
     */
    function getAllDocuments() external view returns (bytes32[] storage documentNames);
     ...
     */
    function getModule(address _module) external view returns (bytes32 moduleName, address moduleAddress, address factoryAddress, bool isArchived, uint8[] storage moduleTypes, bytes32 moduleLabel);
     ...
     */
    function getModulesByName(bytes32 _name) external view returns(address[] storage modules);
     ...
     */
    function getModulesByType(uint8 _type) external view returns(address[] storage modules);
