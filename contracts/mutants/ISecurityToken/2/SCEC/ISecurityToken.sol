...
interface ISecurityToken {
    ...
    function canTransferByPartition(
        ...
        external
        view
        returns (byte statusCode, bytes32 partition, bytes32 reasonCode);
     ...
     */
    function getModule(address _module) external view returns (bytes32 moduleLabel, address factoryAddress, address moduleAddress, bool isArchived, uint8[] memory moduleTypes, bytes32 moduleName);
