    ...
    MixinStakingPoolRewards
{
        ...
        external
    {
        ...
        // execute move
        IStructs.StoredBalance memory fromPtr = _getBalancePtrFromStatus(owner, from.status);
        IStructs.StoredBalance memory toPtr = _getBalancePtrFromStatus(owner, to.status);
