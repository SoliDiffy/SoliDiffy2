...
contract TransferControllerManager is Ownable {
    ...
    {
        require(bytes1(standard).length > 0);
    ...
    notNullAddress(controller)
    {
        require(bytes1(newStandard).length > 0);
    ...
    notNullAddress(currencyCt)
    {
        ...
        require(registeredCurrencies[currencyCt].standard == bytes1(0));
    ...
    onlyOperator
    {
        ...
        registeredCurrencies[currencyCt].standard = bytes1(0);
