...
contract TransferControllerManager is Ownable {
    ...
    notNullAddress(controller)
    {
        ...
        bytes32 standardHash = sha256(abi.encodePacked(standard));
    ...
    notNullAddress(controller)
    {
        ...
        bytes32 oldStandardHash = sha256(abi.encodePacked(oldStandard));
        bytes32 newStandardHash = sha256(abi.encodePacked(newStandard));
