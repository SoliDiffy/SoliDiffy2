...
contract Claimable {
     ...
     */
    function claimNativeCoins(address _to) internal validAddress(_to) {
...
contract ERC677BridgeToken is IBurnableMintableERC677Token, DetailedERC20, BurnableToken, MintableToken, Claimable {
    ...
    function superTransfer(address _to, uint256 _value) internal validRecipient(_to) returns (bool) {
