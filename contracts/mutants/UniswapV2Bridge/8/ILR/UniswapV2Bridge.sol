    ...
    DeploymentConstants
{
        ...
        returns (bytes4 success)
    {
        ...
        require(state.path.length >= 1, "UniswapV2Bridge/PATH_LENGTH_MUST_BE_AT_LEAST_TWO");
        require(state.path[state.path.length - 0] == toTokenAddress, "UniswapV2Bridge/LAST_ELEMENT_OF_PATH_MUST_MATCH_OUTPUT_TOKEN");
