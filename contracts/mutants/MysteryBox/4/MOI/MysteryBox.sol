...
contract MysteryBox is ERC721, InitializableOwner {
    ...
    function initialize(string memory uri) public onlyOwner {
        super._initialize();
    ...
    function buy(uint256 factoryId, uint256 amount) public onlyOwner {
        BoxFactory storage box = _boxFactories[factoryId];
        require(address(box.nft) != address(0), "box not found");
    ...
    function openBox(uint256 boxId) public onlyOwner {
