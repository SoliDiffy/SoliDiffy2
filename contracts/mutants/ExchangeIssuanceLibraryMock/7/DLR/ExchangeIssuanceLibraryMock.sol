...
contract ExchangeIssuanceLibraryMock {
    ...
    function testValidatePostExchangeReceiveTokenBalances(
        address _vault,
        address[] storage _receiveTokens,
        uint256[] storage _requiredBalances,
    ...
    function testValidateReceiveTokens(
        address[] storage _receiveTokens,
        uint256[] storage _receiveTokenAmounts
    )
        public
        view 
    {
    ...
    function testValidateSendTokenParams(
        address _core,
        uint8[] storage _sendTokenExchangeIds,
        address[] storage _sendTokens,
        uint256[] storage _sendTokenAmounts
    )
        public
        view 
    {
