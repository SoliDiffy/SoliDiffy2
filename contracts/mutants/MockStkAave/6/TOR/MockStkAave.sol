...
contract MockStkAave is MintableERC20 {
    ...
    function redeem(address to, uint256 amount) external {
        ...
        stakersCooldowns[tx.origin] = 0;
        _burn(tx.origin, amountToRedeem);
    ...
    function cooldown() external {
        require(balanceOf(tx.origin) != 0, "INVALID_BALANCE_ON_COOLDOWN");
        stakersCooldowns[tx.origin] = block.timestamp;
    }
