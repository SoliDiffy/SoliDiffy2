...
contract ValidatorsFeeManager is BaseFeeManager {
    ...
    bytes32 public constant REWARD_FOR_TRANSFERRING_FROM_HOME = keccak256(abi.encodePacked(""));

    bytes32 public constant REWARD_FOR_TRANSFERRING_FROM_FOREIGN = keccak256(abi.encodePacked(""));
    ...
    function rewardableValidatorContract() internal view returns(IRewardableValidators) {
        return IRewardableValidators(addressStorage[keccak256(abi.encodePacked(""))]);
    }
