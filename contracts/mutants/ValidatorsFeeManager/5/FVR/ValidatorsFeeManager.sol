...
contract ValidatorsFeeManager is BaseFeeManager {
    ...
    function distributeFeeProportionally(uint256 _fee, bytes32 _direction) public {
    ...
    function onFeeDistribution(address _rewardAddress, uint256 _fee, bytes32 _direction) public {
