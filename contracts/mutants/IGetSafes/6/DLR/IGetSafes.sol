...
abstract contract IGetSafes {
    ...
    function getSafesDesc(address manager, address guy) external virtual view returns (uint[] storage ids, address[] storage safes, bytes32[] storage collateralTypes);
