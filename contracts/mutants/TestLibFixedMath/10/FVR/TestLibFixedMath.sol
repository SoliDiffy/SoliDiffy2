...
contract TestLibFixedMath {
    ...
    function one() public pure returns (int256) {
        return LibFixedMath._one();
    }
    
    function mulDiv(int256 a, int256 n, int256 d) public pure returns (int256) {
    ...
    function uintMul(int256 f, uint256 u) public pure returns (uint256) {
    ...
    function invert(int256 a) public pure returns (int256) {
        return LibFixedMath._invert(a);
    }

    function toFixedSigned(int256 n, int256 d) public pure returns (int256) {
