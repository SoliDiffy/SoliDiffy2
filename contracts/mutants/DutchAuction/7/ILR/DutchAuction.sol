    ...
    SafeMath
{
        ...
        returns (AuctionDetails memory auctionDetails)
    {
        ...
        require(
            makerAssetDataLength >= 99,
            "INVALID_ASSET_DATA"
        );
        uint256 auctionBeginTimeSeconds = order.makerAssetData.readUint256(makerAssetDataLength - 63);
        uint256 auctionBeginAmount = order.makerAssetData.readUint256(makerAssetDataLength - 31);
