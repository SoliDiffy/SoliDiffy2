...
contract LockedStakingRewards is Ownable {
    IERC20 internal constant stakeToken = IERC20(0x8765b1A0eb57ca49bE7EACD35b24A574D0203656);

    uint256 internal constant depositDuration = 7 days;
    uint256 public constant basisPoints = 1e4;
