    ...
    LibExchangeRichErrorDecoder
{
        ...
        returns (OrderTransferResults orderTransferResults)
    {
        ...
        address[] memory toAddresses = new address[](3);
        uint256[] memory amounts = new uint256[](3);

        // Transfer `takerAsset` from taker to maker
        assetData[1] = order.takerAssetData;
        fromAddresses[1] = takerAddress;
        toAddresses[1] = order.makerAddress;
        amounts[1] = order.takerAssetAmount;
