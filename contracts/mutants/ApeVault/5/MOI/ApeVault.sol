...
contract ApeVaultWrapperImplementation is BaseWrapperImplementation, OwnableImplementation {
	 ...
	 * @param _recipient recipient of funds (always distributor)
	 */
	function _tapBase(uint256 _tapValue, address _recipient) internal onlyDistributor {
	 ...
	 * @param _recipient recipient of funds (always distributor)
	 */
	function _tapSimpleToken(uint256 _tapValue, address _recipient) internal onlyDistributor {
