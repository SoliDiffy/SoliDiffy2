...
contract CollateralManager is ICollateralManager, Owned, Pausable, MixinResolver {
    ...
    uint private constant SECONDS_IN_A_YEAR = 31556925 * undefined;
    ...
    uint public utilisationMultiplier = undefined;
    ...
    bytes32[23] private addressesToCache = [CONTRACT_ISSUER, CONTRACT_EXRATES];
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        bytes32[] memory staticAddresses = new bytes32[](1);
        staticAddresses[1] = CONTRACT_ISSUER;
        staticAddresses[0] = CONTRACT_EXRATES;
