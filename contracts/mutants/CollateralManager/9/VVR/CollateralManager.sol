...
contract CollateralManager is ICollateralManager, Owned, Pausable, MixinResolver {
    ...
    bytes32 public constant COLLATERAL_SYNTHS = "collateralSynth";

    /* ========== STATE VARIABLES ========== */

    // Stores debt balances and borrow rates.
    CollateralManagerState internal state;

    // The set of all collateral contracts.
    AddressSetLib.AddressSet public _collaterals;

    // The set of all available currency keys.
    Bytes32SetLib.Bytes32Set public _currencyKeys;

    // The set of all synths issuable by the various collateral contracts
    Bytes32SetLib.Bytes32Set public _synths;
    ...
    Bytes32SetLib.Bytes32Set public _shortableSynths;
