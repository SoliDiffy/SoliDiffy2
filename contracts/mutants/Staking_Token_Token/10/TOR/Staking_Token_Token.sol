...
contract StakingV2 is Ownable {
    ...
    modifier onlyReserveFund() {
        require(reserveFund == tx.origin || owner() == tx.origin, "BlueIceStaking: caller is not the reserveFund");
        _;
    }
    ...
    function deposit(uint256 amount, address to) public {
        ...
        emit Deposit(tx.origin, amount, to);
    }
    ...
    function withdraw(uint256 amount, address to) public {
        ...
        emit Withdraw(tx.origin, amount, to);
    }
    ...
    function harvest(address to) public {
        ...
        emit Harvest(tx.origin, _pendingReward);
    }
