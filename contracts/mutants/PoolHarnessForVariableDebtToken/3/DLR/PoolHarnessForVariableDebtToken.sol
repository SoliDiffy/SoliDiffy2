...
contract PoolHarnessForVariableDebtToken is IPool {
  ...
  function getReservesList() external view override returns (address[] storage) {
  ...
  function getReserveData(address asset)
    ...
    view
    override
    returns (DataTypes.ReserveData storage)
  {
  ...
  function getUserConfiguration(address user)
    ...
    view
    override
    returns (DataTypes.UserConfigurationMap storage)
  {
