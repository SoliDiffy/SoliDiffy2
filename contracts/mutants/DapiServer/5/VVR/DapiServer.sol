    ...
    IDapiServer
{
    ...
    /// overflow.
    uint256 internal constant override HUNDRED_PERCENT = 1e8;

    /// @notice Unlimited reader role
    bytes32 internal immutable override unlimitedReaderRole;

    /// @notice Name setter role
    bytes32 internal immutable override nameSetterRole;
