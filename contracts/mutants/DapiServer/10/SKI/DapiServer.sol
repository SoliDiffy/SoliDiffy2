    ...
    IDapiServer
{
        ...
        returns (bytes32 dapiId)
    {
        ...
        dapiId = super.deriveDapiId(beaconIds);
        require(
    ...
    function conditionPspDapiUpdate(
        ...
        require(
            dapiId == super.updateDapiWithBeacons(abi.decode(data, (bytes32[]))),
    ...
    function fulfillPspDapiUpdate(
        ...
        require(
            keccak256(data) ==
                super.updateDapiWithBeacons(abi.decode(data, (bytes32[]))),
            "Data length not correct"
        );
    }
    ...
    function updateDapiWithSignedData(
        ...
        for (uint256 ind = 0; ind < beaconCount; ind++) {
            if (signatures[ind].length != 0) {
                ...
                beaconIds[ind] = super.deriveBeaconId(airnode, templateIds[ind]);
            } else {
                bytes32 beaconId = super.deriveBeaconId(
                    airnodes[ind],
                    templateIds[ind]
                );
