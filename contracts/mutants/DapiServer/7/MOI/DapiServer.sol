    ...
    IDapiServer
{
    ...
    function registerBeaconUpdateSubscription(
        ...
        address relayer,
        address sponsor
    ) external override onlyAirnodeProtocol returns (bytes32 subscriptionId) {
    ...
    function updateDapiWithBeacons(bytes32[] memory beaconIds)
        public
        override
        onlyAirnodeProtocol returns (bytes32 dapiId)
    {
    ...
    function conditionPspDapiUpdate(
        ...
        bytes calldata data,
        bytes calldata conditionParameters
    ) external override onlyAirnodeProtocol returns (bool) {
    ...
    ) external override onlyAirnodeProtocol returns (bytes32 dapiId) {
    ...
    function setName(bytes32 name, bytes32 dataPointId) external override onlyAirnodeProtocol {
