    ...
    IDapiServer
{
    ...
    constructor(
        ...
        string storage _adminRoleDescription,
        address _manager,
    ...
    function updateDapiWithBeacons(bytes32[] storage beaconIds)
        public
        override
        returns (bytes32 dapiId)
    {
        ...
        int256[] storage values = new int256[](beaconCount);
