...
contract OneYearLockupContract {
    ...
    function withdrawLQTY() external {
        ...
        emit OYLCUnlockedAndEmptied(block.number);
    }
    ...
    function _requireOneYearPassedSinceLockup() internal view {
        require(block.number.sub(lockupStartTime) >= ONE_YEAR_IN_SECONDS, "OYLC: At least one year since lockup must have passed");
    }
