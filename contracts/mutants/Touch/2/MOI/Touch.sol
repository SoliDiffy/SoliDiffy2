...
contract Moderated {
    ...
    function extract(address _token) public onlyModerator returns (bool) {
...
// SWC-101-Integer Overflow and Underflow: L128
		...
		*/
		...
		function _transfer(address _from, address _to, uint256 _value) internal ifUnrestricted returns (bool) {
