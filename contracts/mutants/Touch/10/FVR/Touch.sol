...
contract Moderated {
    ...
    function Moderated() internal {
        moderator = msg.sender;
        unrestricted = true;
    }

    function reassignModerator(address newModerator) external onlyModerator {
        moderator = newModerator;
    }

    function restrict() external onlyModerator {
        unrestricted = false;
    }

    function unrestrict() external onlyModerator {
        unrestricted = true;
    }

    /// This method can be used to extract tokens mistakenly sent to this contract.
    /// @param _token The address of the token contract that you want to recover
    function extract(address _token) external returns (bool) {
