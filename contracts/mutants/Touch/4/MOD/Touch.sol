...
// SWC-101-Integer Overflow and Underflow: L128
		...
		*/
		function transfer(address _to, uint256 _value) public onlyPayloadSize(2) ifUnrestricted returns (bool) {
		...
		*/
		function transferFrom(address _from, address _to, uint256 _value) public onlyPayloadSize(3) ifUnrestricted returns (bool) {
		...
		*/
		function approve(address _spender, uint256 _value) public onlyPayloadSize(2) ifUnrestricted returns (bool sucess) {
		...
		*/
		function increaseApproval(address _spender, uint256 _addedValue) public onlyPayloadSize(2) ifUnrestricted returns (bool) {
