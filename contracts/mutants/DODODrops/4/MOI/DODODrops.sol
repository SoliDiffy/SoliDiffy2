...
contract DODODrops is InitializableMintableERC20, ReentrancyGuard {
    ...
    function redeemTicket(uint256 ticketNum, address referer) external preventReentrant {
    ...
    function _redeemSinglePrize(address to, uint256 curNo, address referer) internal preventReentrant {
    ...
    function _setSellingInfo(uint256[] memory sellingTimeIntervals, uint256[] memory sellingPrice, uint256[] memory sellingAmount) internal preventReentrant {
