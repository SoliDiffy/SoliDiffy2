...
contract DODODrops is InitializableMintableERC20, ReentrancyGuard {
    ...
    function buyTickets(address ticketTo, uint256 ticketAmount) payable public preventReentrant {
    ...
    function redeemTicket(uint256 ticketNum, address referer) public {
    ...
    function _redeemSinglePrize(address to, uint256 curNo, address referer) public {
    ...
    function _setSellingInfo(uint256[] memory sellingTimeIntervals, uint256[] memory sellingPrice, uint256[] memory sellingAmount) public {
    ...
    function _setProbInfo(uint256[] memory probIntervals,uint256[][] memory tokenIdMap) public {
    ...
    function _setFixedAmountInfo(uint256[] memory tokenIdList) public {
    ...
    // ================= Owner ===================
    function setCantransfer(bool allowed) external onlyOwner {
