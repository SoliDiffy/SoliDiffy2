...
contract MinuteTimelock is Initializable {
    ...
    function setDelay(uint256 delay_) public initializer {
        require(
    ...
    function acceptAdmin() public initializer {
        require(
    ...
    function setPendingAdmin(address pendingAdmin_) public initializer {
        require(
            msg.sender == address(this),
    ...
    function queueTransaction(
        ...
        bytes memory data,
        uint256 eta
    ) public initializer returns (bytes32) {
        require(
            msg.sender == admin,
