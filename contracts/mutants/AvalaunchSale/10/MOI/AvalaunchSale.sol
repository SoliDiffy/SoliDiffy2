...
contract AvalaunchSale is Initializable {
    ...
    function withdrawMultiplePortions(uint256 [] calldata portionIds) external initializer {
    ...
    function withdrawMultiplePortionsToDexalot(uint256 [] calldata portionIds) external initializer {
    ...
    function safeTransferAVAX(address to, uint256 value) internal initializer {
    ...
    function withdrawEarningsInternal() internal  initializer {
    ...
    function withdrawLeftoverInternal() internal initializer {
        // Make sure sale ended
        require(block.timestamp >= sale.saleEnd);
