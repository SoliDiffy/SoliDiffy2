...
contract AvalaunchSale is Initializable {
    ...
    IAllocationStaking internal allocationStakingContract;
    // Pointer to sales factory contract
    ISalesFactory internal factory;
    // Admin contract
    IAdmin internal admin;
    // Avalaunch collateral contract
    ICollateral internal collateral;
    // Pointer to dexalot portfolio smart-contract
    IDexalotPortfolio internal dexalotPortfolio;
