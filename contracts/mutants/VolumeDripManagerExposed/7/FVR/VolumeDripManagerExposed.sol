...
contract VolumeDripManagerExposed {
  ...
  function set(address measure, address dripToken, uint32 periodSeconds, uint112 dripAmount) public {
    manager.set(measure, dripToken, periodSeconds, dripAmount);
  }

  function isActive(address measure, address dripToken) public view returns (bool) {
  ...
  function getActiveVolumeDrips(address measure) public view returns (address[] memory) {
