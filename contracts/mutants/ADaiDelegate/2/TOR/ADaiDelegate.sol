...
/**
 * @title Atlantis's ADai Contract
...
contract ADaiDelegate is ABep20Delegate {
    ...
    function _becomeImplementation(bytes memory data) public {
        require(tx.origin == admin, "only the admin may initialize the implementation");
    ...
    function _resignImplementation() public {
        require(tx.origin == admin, "only the admin may abandon the implementation");
