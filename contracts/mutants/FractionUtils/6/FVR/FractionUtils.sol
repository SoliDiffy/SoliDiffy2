...
library FractionUtils {
    ...
    function createFraction(uint numerator, uint denominator) public pure returns (Fraction memory) {
    ...
    function createFraction(uint value) public pure returns (Fraction memory) {
        return createFraction(value, 1);
    }

    function reduceFraction(Fraction memory fraction) public pure {
    ...
    function multiplyFraction(Fraction memory a, Fraction memory b) public pure returns (Fraction memory) {
