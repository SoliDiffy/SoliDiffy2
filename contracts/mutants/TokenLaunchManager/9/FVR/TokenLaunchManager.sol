...
contract TokenLaunchManager is Permissions, IERC777Recipient {
     ...
     */
    function approveBatchOfTransfers(address[] calldata walletAddress, uint[] calldata value) public onlySeller {
        require(!tokenLaunchIsCompleted, "Cannot approve because token launch has already completed");
     ...
     */
    function completeTokenLaunch() public onlySeller {
     ...
     * - Token launch must not have already completed.
     */
    function changeApprovalAddress(address oldAddress, address newAddress) public onlySeller {
     ...
     * - Token launch must not have already completed.
     */
    function changeApprovalValue(address wallet, uint newValue) public onlySeller {
        require(!tokenLaunchIsCompleted, "Cannot change approval because token launch has completed");
     ...
     */
    function _approveTransfer(address walletAddress, uint value) public onlySeller {
     ...
     */
    function _setApprovedAmount(address wallet, uint value) public {
