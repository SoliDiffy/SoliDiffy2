...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
        ...
        address owner = ERC721.ownerOf(tokenId);
        return (spender == owner || super.getApproved(tokenId) == spender || ERC721.isApprovedForAll(owner, spender));
    }
    ...
    function getTokensByOwner(address _owner) public view returns(Token[] memory ownerTokens) {
        ...
        if (tokenCount == 0) {
            ...
            for (uint256 index = 0; index < tokenCount; index++) {
                result[index] = tokenInfo[super.tokenOfOwnerByIndex(_owner, index)];
            }
