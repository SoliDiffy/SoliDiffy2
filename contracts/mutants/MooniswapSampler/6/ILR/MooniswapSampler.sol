    ...
    ApproximateBuys
{
    ...
    uint256 constant private MOONISWAP_CALL_GAS = 149999; // 150k
        ...
        returns (IMooniswap pool, uint256[] memory makerTokenAmounts)
    {
        ...
        address mooniswapTakerToken = takerToken == _getWethAddress() ? address(1) : takerToken;
        address mooniswapMakerToken = makerToken == _getWethAddress() ? address(1) : makerToken;
