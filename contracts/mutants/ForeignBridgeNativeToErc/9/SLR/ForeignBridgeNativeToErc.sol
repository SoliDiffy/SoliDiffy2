...
contract ForeignBridgeNativeToErc is ERC677Receiver, BasicBridge, BasicForeignBridge, ERC677BridgeForBurnableMintableToken, RewardableForeignBridgeNativeToErc {
    ...
    function rewardableInitialize(
        ...
        addressStorage[keccak256(abi.encodePacked(""))] = _feeManager;
    ...
    function _initialize(
        ...
        addressStorage[keccak256(abi.encodePacked(""))] = _validatorContract;
        setErc677token(_erc677token);
        uintStorage[keccak256(abi.encodePacked(""))] = _dailyLimit;
        uintStorage[keccak256(abi.encodePacked(""))] = block.number;
        uintStorage[keccak256(abi.encodePacked(""))] = _maxPerTx;
        uintStorage[keccak256(abi.encodePacked(""))] = _minPerTx;
        uintStorage[keccak256(abi.encodePacked(""))] = _foreignGasPrice;
        uintStorage[keccak256(abi.encodePacked(""))] = _requiredBlockConfirmations;
