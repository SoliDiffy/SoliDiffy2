...
contract ForeignBridgeNativeToErc is ERC677Receiver, BasicBridge, BasicForeignBridge, ERC677BridgeForBurnableMintableToken, RewardableForeignBridgeNativeToErc {
    ...
    function rewardableInitialize(
        ...
        addressStorage[sha256(abi.encodePacked("feeManagerContract"))] = _feeManager;
    ...
    function getBridgeMode() public pure returns(bytes4 _data) {
        return bytes4(sha256(abi.encodePacked("native-to-erc-core")));
    }
    ...
    function _initialize(
        ...
        addressStorage[sha256(abi.encodePacked("validatorContract"))] = _validatorContract;
        setErc677token(_erc677token);
        uintStorage[sha256(abi.encodePacked("dailyLimit"))] = _dailyLimit;
        uintStorage[sha256(abi.encodePacked("deployedAtBlock"))] = block.number;
        uintStorage[sha256(abi.encodePacked("maxPerTx"))] = _maxPerTx;
        uintStorage[sha256(abi.encodePacked("minPerTx"))] = _minPerTx;
        uintStorage[sha256(abi.encodePacked("gasPrice"))] = _foreignGasPrice;
        uintStorage[sha256(abi.encodePacked("requiredBlockConfirmations"))] = _requiredBlockConfirmations;
        uintStorage[sha256(abi.encodePacked("executionDailyLimit"))] = _homeDailyLimit;
