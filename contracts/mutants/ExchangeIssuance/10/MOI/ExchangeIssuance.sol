...
//        SWC-134-Message call with hardcoded gas amount: L247, L279, L349
    ...
    */
     ...
     */
    function _issueExactSetFromWETH(ISetToken _setToken, uint256 _amountSetToken) internal isSetToken(_setToken) returns (uint256) {
     ...
     */
    function _redeemExactSetForWETH(ISetToken _setToken, uint256 _amountSetToRedeem) internal isSetToken(_setToken) returns (uint256) {
    ...
    function _acquireComponents(
        ...
        internal
        isSetToken(_setToken) returns (uint256)
    {
        address[] memory components = _setToken.getComponents();
        uint256 maxIndexAmount = PreciseUnitMath.maxUint256();
     ...
     */
    function _swapTokenForWETH(IERC20 _token, uint256 _amount) internal nonReentrant returns (uint256) {
