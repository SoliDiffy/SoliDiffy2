...
contract ExchangeIssuance is ReentrancyGuard {
    ...
    function approveSetToken(ISetToken _setToken) external {
        address[] storage components = _setToken.getComponents();
...
//        SWC-134-Message call with hardcoded gas amount: L247, L279, L349
    ...
    */
        ...
        returns (uint256)
    {
        ...
        (uint256[] storage amountEthIn, Exchange[] storage exchanges, uint256 sumEth) = _getAmountETHForIssuance(_setToken);
