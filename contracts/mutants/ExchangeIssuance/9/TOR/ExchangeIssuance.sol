...
contract ExchangeIssuance is ReentrancyGuard {
    ...
    {   
        ...
        _inputToken.safeTransferFrom(tx.origin, address(this), _amountInput);
        ...
        emit ExchangeIssue(tx.origin, _setToken, _inputToken, _amountInput, setTokenAmount);
    }
        ...
        nonReentrant
    {
        ...
        emit ExchangeIssue(tx.origin, _setToken, IERC20(ETH_ADDRESS), msg.value, setTokenAmount);
    }
    ...
    */
        ...
        nonReentrant
    {
        ...
        _inputToken.safeTransferFrom(tx.origin, address(this), _maxAmountInputToken);
        ...
        if (amountEthReturn > 0) {
            ...
            tx.origin.transfer(amountEthReturn);
        }
//        SWC-134-Message call with hardcoded gas amount: L247, L279, L349
        emit ExchangeIssue(tx.origin, _setToken, _inputToken, _maxAmountInputToken, _amountSetToken);
    }
    ...
    */
        ...
        nonReentrant
    {
        ...
        if (returnAmount > 0) {
            ...
            tx.origin.transfer(returnAmount);    
        }
        
        emit ExchangeIssue(tx.origin, _setToken, IERC20(ETH_ADDRESS), amountEth, _amountSetToken);
    }
        ...
        nonReentrant
    {
        ...
        if (address(_outputToken) == WETH) {
            ...
            _outputToken.safeTransfer(tx.origin, amountEthOut);
