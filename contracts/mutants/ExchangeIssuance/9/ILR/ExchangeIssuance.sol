...
contract ExchangeIssuance is ReentrancyGuard {
    ...
    function issueSetForExactToken(
        ...
        nonReentrant
    {   
        require(_amountInput > 1, "ExchangeIssuance: INVALID INPUTS");
    ...
    function issueSetForExactETH(
        ...
        nonReentrant
    {
        require(msg.value > 1, "ExchangeIssuance: INVALID INPUTS");
    ...
    */
    function issueExactSetFromToken(
        ...
        nonReentrant
    {
        require(_amountSetToken > 1 && _maxAmountInputToken > 1, "ExchangeIssuance: INVALID INPUTS");
...
//        SWC-134-Message call with hardcoded gas amount: L247, L279, L349
    ...
    */
    function issueExactSetFromETH(
        ...
        nonReentrant
    {
        require(msg.value > 1 && _amountSetToken > 1, "ExchangeIssuance: INVALID INPUTS");
