...
library InstrumentReserveLogic {
  ...
  event feeRepaid(address instrumentAddress, address user, address onBehalfOf, uint256 amount, uint256 platformFeePay, uint256 reserveFeePay);
    ...
    **/
    function getNormalizedIncome(DataTypes.InstrumentData storage reserve) public view returns (uint256) {
    ...
    **/
    function getNormalizedDebt(DataTypes.InstrumentData storage reserve) public view returns (uint256) {
        uint40 timestamp = reserve.lastUpdateTimestamp;
    ...
    **/
    function updateState(DataTypes.InstrumentData storage instrument, address sighPayAggregator ) public {
    ...
    **/
    function cumulateToLiquidityIndex( DataTypes.InstrumentData storage instrument, uint256 totalLiquidity, uint256 amount ) public {
    ...
    **/
    function init( DataTypes.InstrumentData storage instrument, address iTokenAddress, address stableDebtTokenAddress, address variableDebtTokenAddress, address interestRateStrategyAddress) public {
    ...
    **/
    function updateInterestRates( DataTypes.InstrumentData storage instrument, address instrumentAddress, address iTokenAddress, uint256 liquidityAdded, uint256 liquidityTaken ) public {
    ...
    **/
    function _mintToTreasury( DataTypes.InstrumentData storage instrument, address sighPayAggregator, uint256 scaledVariableDebt, uint256 previousVariableBorrowIndex, uint256 newLiquidityIndex, uint256 newVariableBorrowIndex, uint40 timestamp ) public {
    ...
    **/
    function _updateIndexes( DataTypes.InstrumentData storage instrument, uint256 scaledVariableDebt, uint256 liquidityIndex, uint256 variableBorrowIndex, uint40 timestamp) public returns (uint256, uint256) {
