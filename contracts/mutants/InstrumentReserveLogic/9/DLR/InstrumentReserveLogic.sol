...
library InstrumentReserveLogic {
  ...
  event feeRepaid(address instrumentAddress, address user, address onBehalfOf, uint256 amount, uint256 platformFeePay, uint256 reserveFeePay);
    ...
    **/
    function getNormalizedIncome(DataTypes.InstrumentData memory reserve) internal view returns (uint256) {
    ...
    **/
    function getNormalizedDebt(DataTypes.InstrumentData memory reserve) internal view returns (uint256) {
        uint40 timestamp = reserve.lastUpdateTimestamp;
    ...
    **/
    function updateState(DataTypes.InstrumentData memory instrument, address sighPayAggregator ) internal {
    ...
    **/
    function cumulateToLiquidityIndex( DataTypes.InstrumentData memory instrument, uint256 totalLiquidity, uint256 amount ) internal {
    ...
    **/
    function init( DataTypes.InstrumentData memory instrument, address iTokenAddress, address stableDebtTokenAddress, address variableDebtTokenAddress, address interestRateStrategyAddress) external {
    ...
    **/
    function updateInterestRates( DataTypes.InstrumentData memory instrument, address instrumentAddress, address iTokenAddress, uint256 liquidityAdded, uint256 liquidityTaken ) internal {
        UpdateInterestRatesLocalVars storage vars;
    ...
    **/
    function _mintToTreasury( DataTypes.InstrumentData memory instrument, address sighPayAggregator, uint256 scaledVariableDebt, uint256 previousVariableBorrowIndex, uint256 newLiquidityIndex, uint256 newVariableBorrowIndex, uint40 timestamp ) internal {
        MintToTreasuryLocalVars storage vars;
