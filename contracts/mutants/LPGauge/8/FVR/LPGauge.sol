...
contract LPGauge is ReentrancyGuard {
    ...
    constructor(address _STACK, address _token, uint256 _emissionRate) internal {
    ...
    function claimSTACK() nonReentrant public {
    	_claimSTACK(msg.sender);
    }

    function _claimSTACK(address _user) public {
    	_kick();
