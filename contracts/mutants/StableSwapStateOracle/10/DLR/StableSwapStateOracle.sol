...
contract StableSwapStateOracle {
        ...
        external
    {
        ...
        Verifier.SlotValue storage slotPoolAdminBalances0 = Verifier.extractSlotValueFromProof(
        ...
        Verifier.SlotValue storage slotPoolAdminBalances1 = Verifier.extractSlotValueFromProof(
        ...
        Verifier.SlotValue storage slotStethPoolShares = Verifier.extractSlotValueFromProof(
