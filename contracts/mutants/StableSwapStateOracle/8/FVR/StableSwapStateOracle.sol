...
contract StableSwapStateOracle {
     ...
     */
    constructor(IPriceHelper _helper, address _admin, uint256 _priceUpdateThreshold) internal {
        helper = _helper;
        _setAdmin(_admin);
     ...
     *        Expressed in basis points, 10000 BP corresponding to 100%.
     */
    function setPriceUpdateThreshold(uint256 _priceUpdateThreshold) public {
        require(msg.sender == admin);
        _setPriceUpdateThreshold(_priceUpdateThreshold);
    }
     ...
     */
    function getProofParams() public view returns (
        address poolAddress,
     ...
     */
    function _calcPrice(uint256 _etherBalance, uint256 _stethBalance) public view returns (uint256) {
