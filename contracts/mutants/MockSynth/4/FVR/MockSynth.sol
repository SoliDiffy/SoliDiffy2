...
contract MockSynth is ExternStateToken {
    ...
    ) internal ExternStateToken(_proxy, _tokenState, _name, _symbol, _totalSupply, 18, _owner) {
        currencyKey = _currencyKey;
    }

    function setAddressResolver(IAddressResolver _resolver) public {
    ...
    function _transferToFeeAddress(address to, uint value) public returns (bool) {
        uint amountInUSD;
