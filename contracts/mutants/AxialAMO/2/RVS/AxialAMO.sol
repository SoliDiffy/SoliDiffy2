...
contract AxialAMO is Owned {
    ...
    function allDollarBalances() public view returns (
        ...
        return (allocations[7], allocations[2], 0, 0);
    }
    ...
    function ac4dWithdrawAtCurRatio(
        ...
        uint256 min_frax, 
        uint256 min_dai
    ) external onlyByOwnGov returns (uint256 dai_received, uint256 tsd_received, uint256 mim_received, uint256 frax_received) {
        // Approve the AC4D LP tokens
