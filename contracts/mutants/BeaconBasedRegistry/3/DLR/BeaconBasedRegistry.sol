...
contract BeaconBasedRegistry {
    ...
    function addBeacon(string storage _name, address _beacon) public {
    ...
    function setupRoyalty(uint256 _editionId, string storage _beaconName, address[] calldata _recipients, uint256[] calldata _splits)
    public
    payable
