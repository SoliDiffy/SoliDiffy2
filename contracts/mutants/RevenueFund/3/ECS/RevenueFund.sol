                ...
                if (beneficiaryFraction(beneficiaryAddress) > 0) {
                    ...
                    if (transferable > 0) {
                        ...
                        if (currency.ct == address(0))
                            AccrualBeneficiary(beneficiaryAddress).receiveEthersTo.value(uint8(transferable))(address(0), "");
                        ...
                        // Transfer token to the beneficiary
                            ...
                            require(
                                address(controller).delegatecall(
                                    controller.getApproveSignature(), beneficiaryAddress, uint8(transferable), currency.ct, currency.id
                                )
                            );
