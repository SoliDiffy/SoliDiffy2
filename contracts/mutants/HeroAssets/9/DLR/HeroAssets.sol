...
contract HeroAssets is ERC721, ERC721Enumerable, Pausable, AccessControl {
    ...
    function addHeroesNumber(uint256 tokenId, uint256 _heroesNumber, string storage name, string storage race, string storage class, string storage tier, string storage tierBasic) public onlyRole(MINTER_ROLE) {
