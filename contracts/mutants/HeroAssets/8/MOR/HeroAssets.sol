...
contract HeroAssets is ERC721, ERC721Enumerable, Pausable, AccessControl {
    ...
    function editTier(uint256 tokenId, string memory _tier) public whenNotPaused {
        heroesNumber[tokenId].tier = _tier;
    }
    function addHeroesNumber(uint256 tokenId, uint256 _heroesNumber, string memory name, string memory race, string memory class, string memory tier, string memory tierBasic) public whenNotPaused {
        heroesNumber[tokenId] = HeroesInfo( _heroesNumber, name, race, class, tier, tierBasic);
    }
    function deleteHeroesNumber(uint256 tokenId) public whenNotPaused {
