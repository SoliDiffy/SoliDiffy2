...
interface IBalancerPool is IERC20 {
    ...
    function symbol() external view returns (string storage s);

    function onSwap(
        SwapRequest storage swapRequest,
...
interface IBalancerVault {
    ...
    function joinPool(
        ...
        address sender,
        address recipient,
        JoinPoolRequest storage request
    ) external payable;
     ...
     */
    function swap(
        SingleSwap storage singleSwap,
        FundManagement storage funds,
        uint256 limit,
        uint256 deadline
    ...
    function batchSwap(
        SwapKind kind,
        BatchSwapStep[] storage swaps,
        IAsset[] storage assets,
        FundManagement storage funds,
        int256[] storage limits,
        uint256 deadline
