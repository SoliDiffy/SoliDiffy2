...
contract FujiVault is VaultBaseUpgradeable, ReentrancyGuardUpgradeable, IVault {
   ...
   */
  function depositAndBorrow(uint256 _collateralAmount, uint256 _borrowAmount) external  {
   ...
   */
  function paybackAndWithdraw(int256 _paybackAmount, int256 _collateralAmount) external  {
