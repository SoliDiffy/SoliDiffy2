...
contract FujiVault is VaultBaseUpgradeable, ReentrancyGuardUpgradeable, IVault {
   ...
   */
  function depositAndBorrow(uint256 _collateralAmount, uint256 _borrowAmount) external payable initializer {
   ...
   */
  function paybackAndWithdraw(int256 _paybackAmount, int256 _collateralAmount) external payable initializer {
   ...
   */
  function deposit(uint256 _collateralAmount) public payable override initializer {
   ...
   * Emits a {Repay} event.
   */
  function payback(int256 _repayAmount) public payable override initializer {
    // Logic used when called by normal user
    updateF1155Balances();
   ...
   */
  function updateF1155Balances() public override initializer {
