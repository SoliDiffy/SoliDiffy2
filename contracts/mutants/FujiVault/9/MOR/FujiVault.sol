...
contract FujiVault is VaultBaseUpgradeable, ReentrancyGuardUpgradeable, IVault {
   ...
   */
  function setFujiAdmin(address _newFujiAdmin) external initializer {
   ...
   */
  function setActiveProvider(address _provider) external override initializer {
   ...
   */
  function setFujiERC1155(address _fujiERC1155) external initializer {
