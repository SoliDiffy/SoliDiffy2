...
contract FujiVault is VaultBaseUpgradeable, ReentrancyGuardUpgradeable, IVault {
   ...
   */
  function depositAndBorrow(uint256 _collateralAmount, uint256 _borrowAmount) public payable {
   ...
   */
  function paybackAndWithdraw(int256 _paybackAmount, int256 _collateralAmount) public payable {
   ...
   */
  function setFujiERC1155(address _fujiERC1155) public isAuthorized {
   ...
   */
  function setOracle(address _oracle) public isAuthorized {
    oracle = IFujiOracle(_oracle);
  }
   ...
   */
  function setProviders(address[] calldata _providers) public isAuthorized {
