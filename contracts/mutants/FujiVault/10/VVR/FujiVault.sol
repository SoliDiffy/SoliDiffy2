...
contract FujiVault is VaultBaseUpgradeable, ReentrancyGuardUpgradeable, IVault {
  ...
  // Safety factor
  Factor internal safetyF;

  // Collateralization factor
  Factor internal collatF;

  // Protocol Fee factor
  Factor internal override protocolFee;

  // Bonus factor for liquidation
  Factor internal bonusLiqF;

  //State variables
  address[] internal providers;
  address internal override activeProvider;

  IFujiAdmin public _fujiAdmin;
  address internal override fujiERC1155;
  IFujiOracle internal oracle;
