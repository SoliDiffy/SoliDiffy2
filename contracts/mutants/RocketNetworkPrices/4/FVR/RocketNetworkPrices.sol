...
contract RocketNetworkPrices is RocketBase, RocketNetworkPricesInterface {
    ...
    function setPricesBlock(uint256 _value) public {
    ...
    function setRPLPrice(uint256 _value) public {
    ...
    function setEffectiveRPLStake(uint256 _value) public {
    ...
    function updatePrices(uint256 _block, uint256 _rplPrice, uint256 _effectiveRplStake) public {
