...
contract RocketNetworkPrices is RocketBase, RocketNetworkPricesInterface {
    ...
    function setPricesBlock(uint256 _value) private onlyLatestNetworkContract {
    ...
    function setRPLPrice(uint256 _value) private onlyLatestNetworkContract {
    ...
    function setEffectiveRPLStake(uint256 _value) private onlyLatestNetworkContract {
    ...
    function updatePrices(uint256 _block, uint256 _rplPrice, uint256 _effectiveRplStake) private onlyLatestNetworkContract {
