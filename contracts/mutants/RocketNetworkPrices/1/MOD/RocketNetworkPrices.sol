...
contract RocketNetworkPrices is RocketBase, RocketNetworkPricesInterface {
    ...
    function submitPrices(uint256 _block, uint256 _rplPrice, uint256 _effectiveRplStake) override external onlyTrustedNode(msg.sender) onlyLatestContract("rocketNetworkPrices", address(this)) {
        // Check settings
