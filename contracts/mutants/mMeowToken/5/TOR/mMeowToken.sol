...
contract mMeowToken is ERC20("mMeow", "mMEOW"), Ownable {
  ...
  function deposit(address _for, uint256 _amount) public {
    ...
    require(_amount <= meow.balanceOf(tx.origin), "mMeowToken::deposit:: insufficient amount");
    require(meow.transferFrom(tx.origin, address(this), _amount), "mMeowToken::deposit:: transfer error");
