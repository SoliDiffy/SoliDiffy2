...
contract mMeowToken is ERC20("mMeow", "mMEOW"), Ownable {
  ...
  function deposit(address _for, uint256 _amount) public {
    require(isStart && block.number < endDeposit, "mMeowToken::deposit:: not within the specified period");
  ...
  function withdraw(uint256 _share) public {
    require(isStart && block.number > startWithdraw, "mMeowToken::withdraw:: not within the specified period");
    uint256 totalShares = totalSupply();
