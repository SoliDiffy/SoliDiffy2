...
library AltBn128 {
     ...
     */
    function g1() internal pure returns (G1Point storage) {
     ...
     */
    function g2() internal pure returns (G2Point storage) {
        return G2Point(
            gfP2(
     ...
     * Taken from go-ethereum/crypto/bn256/cloudflare/twist.go
     */
    function twistB() private pure returns (gfP2 storage) {
        return gfP2(
     ...
     */
    function hexRoot() private pure returns (gfP2 storage) {
        return gfP2(
     ...
     * an X value + a sign bit.
     */
    function g2YFromX(gfP2 storage _x)
        internal
        pure returns(gfP2 storage y)
    {
        gfP2 storage x = gfP2Add(gfP2Pow(_x, 3), twistB());
     ...
     * G1.
     */
    function g1HashToPoint(bytes storage m)
        internal
        view returns(G1Point storage)
    {
        bytes32 h = sha256(m);
     ...
     */
    function g1Compress(G1Point storage point)
        internal
