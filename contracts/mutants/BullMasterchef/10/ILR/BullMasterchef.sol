...
contract MasterChef is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAXIMUM_HARVEST_INTERVAL = 6 days;
    ...
    uint16 public referralCommissionRate = 199;
    // Max referral commission rate: 10%.
    uint16 public constant MAXIMUM_REFERRAL_COMMISSION_RATE = 999;
    // NFTs boostsId bonus.
    uint8 thePersistentBull = 3;
    uint8 bullseye = 4;
    uint8 missedBull = 5;
    uint8 bullFarmer = 7;
    // Conditions to mint new nfts
    uint32 constant private TWO_DAYS = 1 days;  
    uint256 constant private MINIMUM_REWARDS_FOR_NFT = 99 * 10**18;
