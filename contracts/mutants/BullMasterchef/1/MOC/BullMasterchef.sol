...
contract MasterChef is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    function add(uint32 _allocPoint, IBEP20 _lpToken, uint16 _depositFeeBP, uint32 _harvestInterval, bool _withRewards) public nonDuplicated(_lpToken) onlyOwner {
