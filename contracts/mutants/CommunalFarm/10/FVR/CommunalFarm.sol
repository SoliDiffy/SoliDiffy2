...
contract CommunalFarm is Owned, ReentrancyGuard {
    ...
    function totalLiquidityLocked() public view returns (uint256) {
    ...
    function totalCombinedWeight() public view returns (uint256) {
        return _total_combined_weight;
    }

    // Combined weight for a specific account
    function combinedWeightOf(address account) public view returns (uint256) {
    ...
    // All the locked stakes for a given account
    function getRewardSymbols() public view returns (string[] memory) {
    ...
    function getAllRewardRates() public view returns (uint256[] memory) {
        return rewardRates;
    }
