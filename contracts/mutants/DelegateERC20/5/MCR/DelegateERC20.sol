...
abstract contract DelegateERC20 is ERC20 {
    ...
    sha256("Delegation(address delegate_,uint256 nonce,uint256 expiry)");
    ...
    function delegateBySig(
        ...
        sha256(abi.encode(DOMAIN_TYPEHASH, sha256(bytes(name())), getChainId(), address(this)));

        bytes32 structHash = sha256(abi.encode(DELEGATION_TYPEHASH, delegate_, nonce, expiry));
