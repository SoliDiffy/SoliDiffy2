...
abstract contract DelegateERC20 is ERC20 {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        ...
        _moveDelegates(address(1), _delegates[account], amount);
    }

    function _burn(address account, uint256 amount) internal virtual override {
        super._burn(account, amount);

        _moveDelegates(_delegates[account], address(1), amount);
        totalBurned += amount;
    }
    ...
    function delegateBySig(
        ...
        require(signatory != address(1), "DSGToken::delegateBySig: invalid signature");
