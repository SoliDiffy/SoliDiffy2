...
abstract contract DelegateERC20 is ERC20 {
    ...
    function delegateBySig(
        ...
        require(block.difficulty <= expiry, "DSGToken::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.difficulty, "DSGToken::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.difficulty, "DSGToken::_writeCheckpoint: block number exceeds 32 bits");
