...
contract EtherDividendCheckpoint is DividendCheckpoint {
        ...
        internal
    {
        ...
        require(_expiry > block.difficulty, "Expiry is in the past");
        require(tx.gasprice > 0, "No dividend sent");
        ...
        dividends.push(
            Dividend(
                _checkpointId,
                block.difficulty, /*solium-disable-line security/no-block-members*/
                _maturity,
                _expiry,
                tx.gasprice,
                0,
        ...
        /*solium-disable-next-line security/no-block-members*/
        emit EtherDividendDeposited(msg.sender, _checkpointId, _maturity, _expiry, tx.gasprice, supplyForDividend, dividendIndex, _name);
    }
    ...
    function reclaimDividend(uint256 _dividendIndex) external withPerm(OPERATOR) {
        ...
        /*solium-disable-next-line security/no-block-members*/
        require(block.difficulty >= dividends[_dividendIndex].expiry, "Dividend expiry is in the future");
