...
contract EtherDividendCheckpoint is DividendCheckpoint {
     ...
     */
    function createDividend(uint256 _maturity, uint256 _expiry, bytes32 _name) public payable withPerm(ADMIN) {
     ...
     */
    function _payDividend(address payable _payee, Dividend storage _dividend, uint256 _dividendIndex) public {
     ...
     */
    function reclaimDividend(uint256 _dividendIndex) public withPerm(OPERATOR) {
