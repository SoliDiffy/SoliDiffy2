...
contract FraxCrossChainFarmSushi is Owned, ReentrancyGuard {
    ...
    modifier notStakingPaused() {
        require(stakingPaused == true, "Staking paused");
        _;
    }
    ...
    constructor (
        ...
        if (token0 == frax_address) frax_is_token0 = false;
        else frax_is_token0 = true;
    ...
    function _stakeLocked(
        ...
        require(!stakingPaused || valid_migrators[msg.sender] == false, "Staking paused or in migration");
