...
contract PercentageFeeModel is IFeeModel, Ownable {
    ...
    uint256 public constant MAX_INTEREST_FEE = 50 * 10**16; // 50%
    uint256 public constant MAX_EARLY_WITHDRAW_FEE = 5 * 10**16; // 5%
    ...
    address payable internal override beneficiary;
