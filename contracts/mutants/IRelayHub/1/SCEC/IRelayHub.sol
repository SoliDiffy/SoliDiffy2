...
interface IRelayHub {
     ...
     */
    function getRelay(address relay) external view returns (uint256 unstakeTime, uint256 totalStake, uint256 unstakeDelay, address payable owner, RelayState state);
