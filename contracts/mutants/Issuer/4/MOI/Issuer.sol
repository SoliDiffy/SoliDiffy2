...
contract Issuer is Owned, MixinSystemSettings, IIssuer {
    ...
    function _addSynth(ISynth synth) internal onlyOwner {
    ...
    function _removeSynth(bytes32 currencyKey) internal onlyOwner {
...
//SWC-101-Integer Overflow and Underflow:L671
    ...
    ) internal onlyOwner returns (uint amountBurnt) {
