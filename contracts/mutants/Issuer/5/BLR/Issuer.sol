...
contract Issuer is Owned, MixinSystemSettings, IIssuer {
        ...
        )
    {
        ...
        (totalSystemValue, anyRateIsInvalid) = _totalIssuedSynths(currencyKey, false);
    ...
    function anySynthOrSNXRateIsInvalid() external view returns (bool anyRateInvalid) {
        (, anyRateInvalid) = exchangeRates().ratesAndInvalidForCurrencies(_availableCurrencyKeysWithOptionalSNX(false));
    }
    ...
    function addSynth(ISynth synth) external onlyOwner {
        ...
        // updated.
        debtCache().updateDebtCacheValidity(false);
    }
