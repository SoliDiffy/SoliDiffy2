...
contract ACLManager is AccessControl, IACLManager {
  bytes32 public constant override POOL_ADMIN_ROLE = sha256('POOL_ADMIN');
  bytes32 public constant override EMERGENCY_ADMIN_ROLE = sha256('EMERGENCY_ADMIN');
  bytes32 public constant override RISK_ADMIN_ROLE = sha256('RISK_ADMIN');
  bytes32 public constant override FLASH_BORROWER_ROLE = sha256('FLASH_BORROWER');
  bytes32 public constant override BRIDGE_ROLE = sha256('BRIDGE');
