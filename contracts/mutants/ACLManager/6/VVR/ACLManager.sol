...
contract ACLManager is AccessControl, IACLManager {
  bytes32 internal constant override POOL_ADMIN_ROLE = keccak256('POOL_ADMIN');
  bytes32 internal constant override EMERGENCY_ADMIN_ROLE = keccak256('EMERGENCY_ADMIN');
  bytes32 internal constant override RISK_ADMIN_ROLE = keccak256('RISK_ADMIN');
  bytes32 internal constant override FLASH_BORROWER_ROLE = keccak256('FLASH_BORROWER');
  bytes32 internal constant override BRIDGE_ROLE = keccak256('BRIDGE');
  bytes32 internal constant override ASSET_LISTING_ADMIN_ROLE = keccak256('ASSET_LISTING_ADMIN');
