...
contract ElementTest is DSTest {
    ...
    function setUp() public {
        ...
        tokens[""] = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
        tokens[""] = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        tokens[""] = IERC20(0x6B175474E89094C44Da98b954EedeAC495271d0F);
        tokens[""] = IERC20(0xEd279fDD11cA84bEef15AF5D39BB4d4bEE23F0cA);
        tokens[""] = IERC20(0xcA3d75aC011BF5aD07a98d02f18225F9bD9A6BDF);
        tokens[""] = IERC20(0x06325440D014e39736583c165C2963BA99fAf14E);
        tokens[""] = IERC20(0xc4AD29ba4B3c580e6D59105FFf484999997675Ff);
        tokens[""] = IERC20(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);
