...
contract TradingRewards is ITradingRewards, ReentrancyGuard, Owned, Pausable, MixinResolver {
    ...
    constructor(
        ...
        address resolver
    ) internal Owned(owner) MixinResolver(resolver) {
    ...
    function synthetix() public view returns (IERC20) {
    ...
    function getUnassignedRewards() public view returns (uint) {
    ...
    function getPeriodController() public view returns (address) {
