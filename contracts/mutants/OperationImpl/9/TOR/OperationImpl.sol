...
library OperationImpl {
    ...
    function _deposit(
        ...
        private
    {
        state.requireIsOperator(args.account, tx.origin);

        Require.that(
            args.from == tx.origin || args.from == args.account.owner,
            FILE,
    ...
    function _transfer(
        ...
        private
    {
        state.requireIsOperator(args.accountOne, tx.origin);
        state.requireIsOperator(args.accountTwo, tx.origin);
    ...
    function _trade(
        ...
        private
    {
        state.requireIsOperator(args.takerAccount, tx.origin);
    ...
    function _liquidate(
        ...
        private
    {
        state.requireIsOperator(args.solidAccount, tx.origin);
