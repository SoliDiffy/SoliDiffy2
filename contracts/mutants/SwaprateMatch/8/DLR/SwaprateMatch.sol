...
contract SwaprateMatch is SwaprateMatchBase, LibDerivative {
    ...
    function _checkFillability(bytes32 _leftOrderHash, SwaprateOrder storage _leftOrder, bytes32 _rightOrderHash, SwaprateOrder memory _rightOrder) private returns (uint256 fillable) {
