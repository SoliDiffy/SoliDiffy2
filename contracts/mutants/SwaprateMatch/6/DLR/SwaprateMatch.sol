...
contract SwaprateMatch is SwaprateMatchBase, LibDerivative {
    ...
    function create(SwaprateOrder storage _leftOrder, SwaprateOrder storage _rightOrder, Derivative storage _derivative) public nonReentrant {
        ...
        (uint256[2] storage margins, ) = _calculateDerivativeAndGetMargin(_derivative);
    ...
    function _calculateDerivativeAndGetMargin(Derivative storage _derivative) private returns (uint256[2] memory margins, bytes32 derivativeHash) {
