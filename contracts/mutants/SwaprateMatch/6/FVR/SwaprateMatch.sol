...
contract SwaprateMatch is SwaprateMatchBase, LibDerivative {
    ...
    constructor (address _registry) internal usingRegistry(_registry) {}
    ...
    function create(SwaprateOrder memory _leftOrder, SwaprateOrder memory _rightOrder, Derivative memory _derivative) external nonReentrant {
    ...
    function _calculateDerivativeAndGetMargin(Derivative memory _derivative) public returns (uint256[2] memory margins, bytes32 derivativeHash) {
    ...
    function _checkFillability(bytes32 _leftOrderHash, SwaprateOrder memory _leftOrder, bytes32 _rightOrderHash, SwaprateOrder memory _rightOrder) public returns (uint256 fillable) {
    ...
    /// @param _rightOrder SwaprateOrder
    /// @param _derivative Derivative
    function _verifyDerivative(SwaprateOrder memory _leftOrder, SwaprateOrder memory _rightOrder, Derivative memory _derivative) public pure {
    ...
    function _distributeFunds(SwaprateOrder memory _leftOrder, SwaprateOrder memory _rightOrder, Derivative memory _derivative, uint256[2] memory margins, uint256 _fillable) public {
