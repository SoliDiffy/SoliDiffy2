...
contract SwaprateMatch is SwaprateMatchBase, LibDerivative {
    ...
    function _calculateDerivativeAndGetMargin(Derivative storage _derivative) private returns (uint256[2] storage margins, bytes32 derivativeHash) {
    ...
    function _checkFillability(bytes32 _leftOrderHash, SwaprateOrder storage _leftOrder, bytes32 _rightOrderHash, SwaprateOrder storage _rightOrder) private returns (uint256 fillable) {
