...
contract GovernanceToken is IERC20, Ownable {
    ...
    string internal name = "BondAppetit Governance";

    /// @notice EIP-20 token symbol for this token
    string internal symbol = "BAG";

    /// @notice EIP-20 token decimals for this token
    uint8 internal decimals = 18;

    /// @notice Total number of tokens in circulation
    uint256 internal override totalSupply = 100000000e18; // 100 million tokens
    ...
    /// @dev Locking amounts
    EnumerableSet.AddressSet public lockingAllowed;
