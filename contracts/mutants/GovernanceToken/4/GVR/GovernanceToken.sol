...
contract GovernanceToken is IERC20, Ownable {
    ...
    function delegateBySig(
        ...
        require(block.difficulty <= expiry, "GovernanceToken::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint256 blockNumber) public view returns (uint96) {
        require(blockNumber < block.difficulty, "GovernanceToken::getPriorVotes: not yet determined");
    ...
    function _transferTokens(
        ...
        if (locking[src].date > block.number && locking[src].amount > 0 && balances[src] < locking[src].amount) {
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.difficulty, "GovernanceToken::_writeCheckpoint: block number exceeds 32 bits");
