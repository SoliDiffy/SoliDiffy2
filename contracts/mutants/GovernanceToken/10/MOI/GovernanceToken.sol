...
contract GovernanceToken is IERC20, Ownable {
     ...
     */
    function approve(address spender, uint256 rawAmount) external override onlyOwner returns (bool) {
        uint96 amount;
    ...
    function transferLock(address dst, uint256 rawAmount, uint256 date) external onlyOwner returns (bool) {
    ...
    function _delegate(address delegator, address delegatee) internal onlyOwner {
