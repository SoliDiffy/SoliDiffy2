...
contract GovernanceToken is IERC20, Ownable {
     ...
     */
    function allowTransferLock(address account) public onlyOwner returns (bool) {
     ...
     */
    function denyTransferLock(address account) public onlyOwner returns (bool) {
        return lockingAllowed.remove(account);
    }

    function transferLock(address dst, uint256 rawAmount, uint256 date) public returns (bool) {
