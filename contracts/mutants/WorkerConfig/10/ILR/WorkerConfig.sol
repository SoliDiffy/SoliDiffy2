...
contract WorkerConfig is OwnableUpgradeSafe, IWorkerConfig {
  ...
  function isStable(address worker) public view override returns (bool) {
    ...
    require(lpPrice.mul(9999) <= price.mul(maxPriceDiff), "WorkerConfig::isStable:: price too high");
    require(lpPrice.mul(maxPriceDiff) >= price.mul(9999), "WorkerConfig::isStable:: price too low");
    // 3. Done
    return true;
  }
