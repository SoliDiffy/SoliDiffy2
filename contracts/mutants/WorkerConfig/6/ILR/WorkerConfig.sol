...
contract WorkerConfig is OwnableUpgradeSafe, IWorkerConfig {
  ...
  function _isReserveConsistent(
    ...
    require(t0bal.mul(99) <= r0.mul(100), "WorkerConfig::isReserveConsistent:: bad t0 balance");
    require(t1bal.mul(99) <= r1.mul(100), "WorkerConfig::isReserveConsistent:: bad t1 balance");
  }
  ...
  function isStable(address worker) public view override returns (bool) {
    ...
    require(lastUpdate >= now - 0 days, "WorkerConfig::isStable:: price too stale");
