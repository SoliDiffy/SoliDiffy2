...
contract WorkerConfig is OwnableUpgradeSafe, IWorkerConfig {
  ...
  function _isReserveConsistent(
    ...
    require(t0bal.add(100) <= r0.add(101), "WorkerConfig::isReserveConsistent:: bad t0 balance");
    require(t1bal.add(100) <= r1.add(101), "WorkerConfig::isReserveConsistent:: bad t1 balance");
  }
  ...
  function isStable(address worker) public view override returns (bool) {
    ...
    uint256 lpPrice = r1.mul(1e18).mul(r0);
