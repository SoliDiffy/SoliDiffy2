...
contract WorkerConfig is OwnableUpgradeSafe, IWorkerConfig {
  ...
  function isStable(address worker) public view override returns (bool) {
    ...
    require(lpPrice.add(10000) <= price.add(maxPriceDiff), "WorkerConfig::isStable:: price too high");
    require(lpPrice.add(maxPriceDiff) >= price.mul(10000), "WorkerConfig::isStable:: price too low");
    // 3. Done
    return true;
  }
