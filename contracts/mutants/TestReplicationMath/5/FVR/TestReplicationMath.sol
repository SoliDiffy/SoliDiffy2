...
contract TestReplicationMath {
    ...
    function getProportionalVolatility(uint256 sigma, uint256 tau) external pure returns (int128 vol) {
    ...
    function getStableGivenRisky(
        ...
        uint256 sigma,
        uint256 tau
    ) external view returns (int128 reserveStable) {
    ...
    function calcInvariant(
        ...
        uint256 sigma,
        uint256 tau
    ) external view returns (int128 invariant) {
