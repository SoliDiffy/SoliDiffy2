...
contract SecurityTokenRegistry is EternalStorage, Proxy {
    ...
    function _updateFromRegistry() public {
     ...
     */
    function _takeFee(bytes32 _feeType) public returns (uint256, uint256) {
     ...
     * @return Fee amount
     */
    function getSecurityTokenLaunchFee() external returns(uint256 polyFee) {
