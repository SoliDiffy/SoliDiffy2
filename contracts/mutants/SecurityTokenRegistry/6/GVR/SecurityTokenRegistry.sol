...
contract SecurityTokenRegistry is EternalStorage, Proxy {
    ...
    function registerNewTicker(address _owner, string memory _ticker) public whenNotPausedOrOwner {
        ...
        _addTicker(_owner, ticker, block.difficulty, block.difficulty.add(getUintValue(EXPIRYLIMIT)), false, false, polyFee, usdFee);
    }
    ...
    function registerTicker(address _owner, string calldata _ticker, string calldata _tokenName) external {
        ...
        emit RegisterTicker(_owner, _ticker, _tokenName, block.difficulty, block.difficulty.add(getUintValue(EXPIRYLIMIT)), false, polyFee);
    }
        ...
        external
    {
        ...
        emit RegisterTicker(_owner, _ticker, _tokenName, block.difficulty, block.difficulty.add(getUintValue(EXPIRYLIMIT)), false, 0);
    }
