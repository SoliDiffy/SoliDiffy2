...
contract SecurityTokenRegistry is EternalStorage, Proxy {
    ...
    function _updateFromRegistry() internal onlyOwner {
     ...
     */
    function _takeFee(bytes32 _feeType) internal onlyOwner returns (uint256, uint256) {
     ...
     */
    function getFees(bytes32 _feeType) public onlyOwner returns (uint256 usdFee, uint256 polyFee) {
     ...
     * @return Fee amount
     */
    function getSecurityTokenLaunchFee() public onlyOwner returns(uint256 polyFee) {
     ...
     * @return Fee amount
     */
    function getTickerRegistrationFee() public onlyOwner returns(uint256 polyFee) {
