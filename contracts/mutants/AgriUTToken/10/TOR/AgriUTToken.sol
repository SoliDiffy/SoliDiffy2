...
contract AgriUTToken is OwnableToken, ERC20Interface 
{
   ...
   constructor( uint256 initialSupply, string memory tokenName, string memory tokenSymbol) 
    {
        ...
        _balances[tx.origin] = _totalSupply;                      // Give the creator all initial tokens
    ...
    */
    ...
    {
        _managedAccounts[tx.origin] = allowed;
        emit ManagedAccount(tx.origin, allowed);
        return true;
    }
    ...
    */
    ...
    {
        uint256 currentAllowance = allowance(_from, tx.origin);
        require(currentAllowance >= _value, "ERC20: burn amount exceeds allowance");
        unchecked {
            _approve(_from, tx.origin, currentAllowance - _value);
        }
        _burn(_from, _value);
        return true;
    }
