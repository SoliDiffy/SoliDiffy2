...
contract AgriUTToken is OwnableToken, ERC20Interface 
{
    ...
    */
    function approveOwnerToManage(bool allowed) external onlyOwner returns (bool)
    {
    ...
    */
    ...
    function _approve( address owner, address spender, uint256 amount) internal onlyOwner {
