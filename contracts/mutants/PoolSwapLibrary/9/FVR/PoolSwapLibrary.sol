...
library PoolSwapLibrary {
     ...
     */
    function getRatio(uint256 _numerator, uint256 _denominator) external pure returns (bytes16) {
     ...
     */
    function convertUIntToDecimal(uint256 amount) public pure returns (bytes16) {
     ...
     * @return The quotient
     */
    function divUInt(uint256 a, uint256 b) public pure returns (bytes16) {
