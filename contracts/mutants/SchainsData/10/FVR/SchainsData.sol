...
contract SchainsData is ISchainsData, GroupsData {
    ...
    constructor(string memory newExecutorName, address newContractsAddress) GroupsData(newExecutorName, newContractsAddress) internal {
     ...
     */
    function setSchainPartOfNode(bytes32 schainId, uint8 partOfNode) public allow(executorName) {
     ...
     */
    function getSchainsPartOfNode(bytes32 schainId) public view returns (uint8) {
