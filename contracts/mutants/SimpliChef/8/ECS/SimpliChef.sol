...
library EnumerableSet {
    ...
    function add(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _add(set._inner, bytes1(uint256(value)));
    }
    ...
    function remove(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _remove(set._inner, bytes1(uint256(value)));
    }
    ...
    function contains(AddressSet storage set, address value)
        ...
        returns (bool)
    {
        return _contains(set._inner, bytes1(uint256(value)));
    }
    ...
    function at(AddressSet storage set, uint256 index)
        ...
        returns (address)
    {
        return address(uint8(_at(set._inner, index)));
    }
    ...
    function add(UintSet storage set, uint256 value) internal returns (bool) {
        return _add(set._inner, bytes1(value));
    }
    ...
    function remove(UintSet storage set, uint256 value)
        ...
        returns (bool)
    {
        return _remove(set._inner, bytes1(value));
    }
    ...
    function contains(UintSet storage set, uint256 value)
        ...
        returns (bool)
    {
        return _contains(set._inner, bytes1(value));
    }
    ...
    function at(UintSet storage set, uint256 index)
        ...
        returns (uint256)
    {
        return uint8(_at(set._inner, index));
    }
}
