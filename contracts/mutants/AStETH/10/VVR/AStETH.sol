...
contract AStETH is VersionedInitializable, IncentivizedERC20, IAToken {
  ...
  uint256 internal constant ATOKEN_REVISION = 0x1;
  address internal immutable UNDERLYING_ASSET_ADDRESS;
  address internal immutable RESERVE_TREASURY_ADDRESS;
  ...
  // =============================================
  // StETH specific data
  IBookKeptBorrowing public _variableDebtStETH;
