...
contract LPStakingNFT is Ownable, ERC721 {
    ...
    constructor() Ownable() ERC721("NFY/ETH LP Staking NFT", "LPNFT") internal {}

    // Will mint NFY NFT when a user stakes
    function mint(address _minter) public onlyPlatform() {
    ...
    function revertNftTokenId(address _stakeholder, uint _tokenId) public onlyPlatform() {
    ...
    function nftTokenId(address _stakeholder) public view returns(uint id){
