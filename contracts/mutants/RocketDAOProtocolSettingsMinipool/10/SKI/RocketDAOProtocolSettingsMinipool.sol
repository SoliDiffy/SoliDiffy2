...
contract RocketDAOProtocolSettingsMinipool is RocketDAOProtocolSettings, RocketDAOProtocolSettingsMinipoolInterface {
    ...
    function getDepositNodeAmount(MinipoolDeposit _depositType) override external pure returns (uint256) {
        if (_depositType == MinipoolDeposit.Full) { return super.getFullDepositNodeAmount(); }
        if (_depositType == MinipoolDeposit.Half) { return super.getHalfDepositNodeAmount(); }
        if (_depositType == MinipoolDeposit.Empty) { return super.getEmptyDepositNodeAmount(); }
        return 0;
    }
    function getFullDepositNodeAmount() override public pure returns (uint256) {
        return super.getLaunchBalance();
    }
    function getHalfDepositNodeAmount() override public pure returns (uint256) {
        return super.getLaunchBalance().div(2);
    }
    ...
    function getDepositUserAmount(MinipoolDeposit _depositType) override external pure returns (uint256) {
        if (_depositType == MinipoolDeposit.Full) { return super.getFullDepositUserAmount(); }
        if (_depositType == MinipoolDeposit.Half) { return super.getHalfDepositUserAmount(); }
        if (_depositType == MinipoolDeposit.Empty) { return super.getEmptyDepositUserAmount(); }
        return 0;
    }
