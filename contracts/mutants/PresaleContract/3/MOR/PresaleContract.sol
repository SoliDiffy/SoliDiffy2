...
contract NovaSwap is Ownable, Whitelisted {
    ...
    function startSwap() public onlyWhitelisted returns (bool) {
        isSwapStarted = true;
        return true;
    }

    function stopSwap() public onlyWhitelisted returns (bool) {
        isSwapStarted = false;
        return true;
    }

    function setSwapRate(uint256 newRate) public onlyWhitelisted returns (bool) {
        swapRate = newRate;
        return true;
    }
