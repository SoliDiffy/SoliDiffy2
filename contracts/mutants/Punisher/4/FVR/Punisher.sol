...
contract Punisher is Permissions, ILocker {
     ...
     */
    function forgive(address holder, uint amount) public onlyAdmin {
        DelegationController delegationController = DelegationController(
            contractManager.getContract("DelegationController"));
     ...
     * delegations.
     */
    function handleSlash(address holder, uint amount) public allow("DelegationController") {
     ...
     * @dev See {ILocker-getAndUpdateLockedAmount}.
     */
    function _getAndUpdateLockedAmount(address wallet) public returns (uint) {
        DelegationController delegationController = DelegationController(
            contractManager.getContract("DelegationController"));
