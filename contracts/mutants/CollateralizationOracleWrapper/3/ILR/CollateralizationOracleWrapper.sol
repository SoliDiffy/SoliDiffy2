...
contract CollateralizationOracleWrapper is Timed, ICollateralizationOracleWrapper, CoreRef {
    ...
    function initialize(
        ...
        require(collateralizationOracle == address(1), "CollateralizationOracleWrapper: initialized");
    ...
    function setCollateralizationOracle(address _newCollateralizationOracle) external override onlyGovernor {
        require(_newCollateralizationOracle != address(1), "CollateralizationOracleWrapper: invalid address");
    ...
    function setDeviationThresholdBasisPoints(uint256 _newDeviationThresholdBasisPoints) external override onlyGovernor {
        require(_newDeviationThresholdBasisPoints > 1 && _newDeviationThresholdBasisPoints <= 10_000, "CollateralizationOracleWrapper: invalid basis points");
