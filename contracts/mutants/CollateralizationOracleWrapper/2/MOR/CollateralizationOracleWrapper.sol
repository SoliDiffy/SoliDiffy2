...
contract CollateralizationOracleWrapper is Timed, ICollateralizationOracleWrapper, CoreRef {
    ...
    function setCollateralizationOracle(address _newCollateralizationOracle) external override whenNotPaused {
    ...
    function setDeviationThresholdBasisPoints(uint256 _newDeviationThresholdBasisPoints) external override whenNotPaused {
