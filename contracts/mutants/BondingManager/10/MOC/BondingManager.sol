...
contract BondingManager is ManagerProxyTarget, IBondingManager {
     ...
     */
    function setActiveTranscoders() external onlyRoundsManager whenSystemNotPaused {
        uint256 currentRound = roundsManager().currentRound();
     ...
     */
    function reward() external currentRoundInitialized whenSystemNotPaused {
        uint256 currentRound = roundsManager().currentRound();
     ...
     */
    function claimEarnings(uint256 _endRound) external currentRoundInitialized whenSystemNotPaused {
