...
contract BondingManager is ManagerProxyTarget, IBondingManager {
        ...
        onlyJobsManager
    {
        ...
        EarningsPool.Data memory earningsPool = t.earningsPoolPerRound[_round];
    ...
    function slashTranscoder(
        ...
        onlyJobsManager
    {
        Delegator memory del = delegators[_transcoder];
    ...
    function electActiveTranscoder(uint256 _maxPricePerSegment, bytes32 _blockHash, uint256 _round) external view returns (address) {
        ...
        address[] storage availableTranscoders = new address[](activeSetSize);
