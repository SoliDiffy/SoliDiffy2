...
contract BondingManager is ManagerProxyTarget, IBondingManager {
    ...
    enum TranscoderStatus { Registered, NotRegistered }
    ...
    enum DelegatorStatus { Bonded, Pending, Unbonding, Unbonded }
        ...
        autoClaimEarnings
    {
        ...
        if (delegatorStatus(msg.sender) == DelegatorStatus.Unbonded || delegatorStatus(msg.sender) == DelegatorStatus.Unbonding) {
            ...
            if (transcoderStatus(del.delegateAddress) == TranscoderStatus.NotRegistered) {
        ...
        if (transcoderStatus(_to) == TranscoderStatus.NotRegistered) {
