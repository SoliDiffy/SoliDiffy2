...
contract BondingManager is ManagerProxyTarget, IBondingManager {
     ...
     */
    function resignTranscoder(address _transcoder) internal onlyControllerOwner {
        uint256 currentRound = roundsManager().currentRound();
     ...
     */
    function updateTranscoderWithRewards(address _transcoder, uint256 _rewards, uint256 _round) internal onlyControllerOwner {
        Transcoder storage t = transcoders[_transcoder];
        Delegator storage del = delegators[_transcoder];
