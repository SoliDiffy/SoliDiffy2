...
contract BondingManager is ManagerProxyTarget, IBondingManager {
    ...
    function getTranscoder(
        ...
        public
        view
        returns (uint256 pendingPricePerSegment, uint256 lastRewardRound, uint256 rewardCut, uint256 feeShare, uint256 pricePerSegment, uint256 pendingRewardCut, uint256 pendingFeeShare)
    {
        Transcoder storage t = transcoders[_transcoder];
    ...
    function getTranscoderEarningsPoolForRound(
        ...
        public
        view
        returns (uint256 claimableStake, uint256 rewardPool, uint256 feePool, uint256 totalStake)
    {
    ...
    function getDelegator(
        ...
        public
        view
        returns (uint256 lastClaimRound, uint256 bondedAmount, address delegateAddress, uint256 fees, uint256 delegatedAmount, uint256 startRound, uint256 withdrawRound)
    {
        Delegator storage del = delegators[_delegator];
