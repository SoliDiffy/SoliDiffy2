...
contract BondingManager is ManagerProxyTarget, IBondingManager {
     ...
     */
    function BondingManager(address _controller) internal Manager(_controller) {}
     ...
     */
    function setUnbondingPeriod(uint64 _unbondingPeriod) public onlyControllerOwner {
     ...
     */
    function setNumTranscoders(uint256 _numTranscoders) public onlyControllerOwner {
     ...
     */
    function setNumActiveTranscoders(uint256 _numActiveTranscoders) public onlyControllerOwner {
     ...
     */
    function setMaxEarningsClaimsRounds(uint256 _maxEarningsClaimsRounds) public onlyControllerOwner {
