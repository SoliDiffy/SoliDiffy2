...
contract BondingManager is ManagerProxyTarget, IBondingManager {
     ...
     */
    function setUnbondingPeriod(uint64 _unbondingPeriod) external whenSystemNotPaused {
     ...
     */
    function setNumTranscoders(uint256 _numTranscoders) external whenSystemNotPaused {
     ...
     */
    function setNumActiveTranscoders(uint256 _numActiveTranscoders) external whenSystemNotPaused {
     ...
     */
    function setMaxEarningsClaimsRounds(uint256 _maxEarningsClaimsRounds) external whenSystemNotPaused {
