...
contract PoolService is IPoolService, ACLTrait, ReentrancyGuard {
    ...
    uint256 internal _expectedLiquidityLU;

    // Expected liquidity limit
    uint256 internal override expectedLiquidityLimit;

    // Total borrowed amount: https://dev.gearbox.fi/developers/pools/economy/total-borrowed
    uint256 internal override totalBorrowed;

    // Address repository
    AddressProvider internal addressProvider;

    // Interest rate model
    IInterestRateModel internal interestRateModel;
