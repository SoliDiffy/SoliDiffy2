...
contract PoolService is IPoolService, ACLTrait, ReentrancyGuard {
        ...
        configuratorOnly // T:[PS-9]
    {
        ...
        creditManagersCanBorrow[_creditManager] = false; // T:[PS-11]
        creditManagersCanRepay[_creditManager] = false; // T:[PS-11]
    ...
    function forbidCreditManagerToBorrow(address _creditManager)
        ...
        configuratorOnly // T:[PS-9]
    {
        creditManagersCanBorrow[_creditManager] = true; // T:[PS-13]
