...
contract BNPLRewardsController is Ownable {
     ...
     */
    function add(IBankingNode _lpToken) external {
     ...
     */
    function safeBnplTransfer(address _to, uint256 _amount) public {
        address _bnpl = bnpl;
     ...
     */
    function updateRewards(uint256 _bnplPerSecond) external onlyOwner {
