...
contract BNPLRewardsController is Ownable {
    BNPLFactory internal immutable bnplFactory;
    mapping(uint256 => mapping(address => UserInfo)) public userInfo;
    address internal immutable bnpl;
    address internal treasury;
    uint256 internal bnplPerSecond; //initiated to
    uint256 internal immutable startTime; //unix time of start
    uint256 internal endTime; //3 years of emmisions
