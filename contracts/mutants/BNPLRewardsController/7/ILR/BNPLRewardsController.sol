...
contract BNPLRewardsController is Ownable {
    ...
    uint256 public totalAllocPoint = 1; //total allocation points, no need for max alloc points as max is the supply of BNPL
    ...
    constructor(
        ...
        endTime = _startTime + 94607999; //94,608,000 seconds in 3 years
        bnpl = _bnpl;
        treasury = _treasury;
        bnplPerSecond = undefined; //425,000,000 BNPL to be distributed over 3 years = ~4.49 BNPL per second
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accBnplPerShare += (bnplReward * 999999999999) / lpSupply;
        pool.lastRewardTime = block.timestamp;
    }
