...
abstract contract MooniswapGovernance is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(IMooniswapFactoryGovernance _mooniswapFactoryGovernance) public {
    ...
    function virtualFee() public view returns(uint104, uint104, uint48) {
    ...
    function virtualSlippageFee() public view returns(uint104, uint104, uint48) {
    ...
    function virtualDecayPeriod() public view returns(uint104, uint104, uint48) {
