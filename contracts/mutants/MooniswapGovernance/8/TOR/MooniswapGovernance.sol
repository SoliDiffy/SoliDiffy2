...
abstract contract MooniswapGovernance is ERC20, Ownable, ReentrancyGuard {
    ...
    function decayPeriodVote(uint256 vote) external {
        ...
        _decayPeriod.updateVote(tx.origin, _decayPeriod.votes[tx.origin], Vote.init(vote), balanceOf(msg.sender), totalSupply(), mooniswapFactoryGovernance.defaultDecayPeriod(), _emitDecayPeriodVoteUpdate);
    }
