...
abstract contract MooniswapGovernance is ERC20, Ownable, ReentrancyGuard {
    ...
    function slippageFeeVote(uint256 vote) external {
        ...
        _slippageFee.updateVote(tx.origin, _slippageFee.votes[tx.origin], Vote.init(vote), balanceOf(msg.sender), totalSupply(), mooniswapFactoryGovernance.defaultSlippageFee(), _emitSlippageFeeVoteUpdate);
    }
