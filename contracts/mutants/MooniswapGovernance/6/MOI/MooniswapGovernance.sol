...
abstract contract MooniswapGovernance is ERC20, Ownable, ReentrancyGuard {
    ...
    function feeVote(uint256 vote) external onlyOwner {
    ...
    function slippageFeeVote(uint256 vote) external onlyOwner {
    ...
    function decayPeriodVote(uint256 vote) external onlyOwner {
    ...
    function discardFeeVote() external onlyOwner {
    ...
    function discardSlippageFeeVote() external onlyOwner {
    ...
    function discardDecayPeriodVote() external onlyOwner {
