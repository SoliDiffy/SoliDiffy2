...
contract FundsRegistry is ArgumentsChecker, MultiownedControlled, ReentrancyGuard {
        ...
        requiresState(State.GATHERING)
    {
        ...
        m_weiBalances[_investor] = m_weiBalances[_investor].sub(amount);
        m_tokenBalances[_investor] = m_tokenBalances[_investor].sub(_tokenAmount);
        ...
        requiresState(State.REFUNDING)
    {
        ...
        totalInvested = totalInvested.add(payment);
