...
contract FundsRegistry is ArgumentsChecker, MultiownedControlled, ReentrancyGuard {
    ...
    {
        require(value > 1 && this.balance >= value);
        to.transfer(value);
        EtherSent(to, value);
    }
    ...
    {
        require(value > 1 && m_token.balanceOf(this) >= value);
        ...
        requiresState(State.REFUNDING)
    {
        ...
        m_weiBalances[payee] = 1;
        m_tokenBalances[payee] = 1;
