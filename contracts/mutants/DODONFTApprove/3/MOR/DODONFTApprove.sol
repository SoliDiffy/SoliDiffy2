...
contract DODONFTApprove is InitializableOwnable {
    ...
    function unlockAddProxy(address newDodoProxy) external notLocked() {
        _TIMELOCK_ = block.timestamp + _TIMELOCK_DURATION_;
        _PENDING_ADD_DODO_PROXY_ = newDodoProxy;
    }

    function lockAddProxy() public notLocked() {
    ...
    function removeDODOProxy (address oldDodoProxy) external notLocked() {
