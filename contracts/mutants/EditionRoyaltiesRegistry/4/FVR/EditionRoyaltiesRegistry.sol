...
contract EditionRoyaltiesRegistry is ERC165, IERC2981, Konstants, Context {
    ...
    function setupAgreement(uint256 _editionId, uint256 _expectedRoyalty, bytes32 _agreementHash) external {
    ...
    // called when the edition is created
    function setupAgreementAsCreator(uint256 _editionId, uint256 _expectedRoyalty, bytes32 _agreementHash) external {
