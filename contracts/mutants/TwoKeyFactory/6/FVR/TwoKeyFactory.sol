...
//         Emit an event
     ...
     */
    function setAddressToCampaignType(address _campaignAddress, string _campaignType) public {
     ...
     */
    function addressToCampaignType(address _key) external view returns (string) {
