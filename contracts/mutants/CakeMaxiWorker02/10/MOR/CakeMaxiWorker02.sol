...
contract CakeMaxiWorker02 is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker02 {
  ...
  function reinvest() external override initializer onlyReinvestor nonReentrant {
  ...
  function liquidate(uint256 id) external override initializer nonReentrant {
  ...
  function setReinvestConfig(uint256 _reinvestBountyBps, uint256 _reinvestThreshold) external initializer {
    require(
  ...
  function setBeneficialVaultBountyBps(uint256 _beneficialVaultBountyBps) external initializer {
    require(
  ...
  function setMaxReinvestBountyBps(uint256 _maxReinvestBountyBps) external initializer {
    require(
  ...
  function setStrategyOk(address[] calldata strats, bool isOk) external override initializer {
  ...
  /// @param isOk Whether to approve or unapprove the given strategies.
  function setReinvestorOk(address[] calldata reinvestors, bool isOk) external override initializer {
  ...
  function setPath(address[] calldata _path) external initializer {
