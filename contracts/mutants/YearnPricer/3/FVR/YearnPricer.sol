...
contract YearnPricer is OpynPricerInterface {
     ...
     */
    function setExpiryPriceInOracle(uint256 _expiryTimestamp) public {
     ...
     * @return price of 1e8 yToken in USD, scaled by 1e8
     */
    function _underlyingPriceToYtokenPrice(uint256 _underlyingPrice) public view returns (uint256) {
