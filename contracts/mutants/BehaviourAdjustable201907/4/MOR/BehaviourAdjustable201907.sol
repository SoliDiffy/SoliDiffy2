...
contract BehaviourAdjustable201907 is Behaviour201907 {
    ...
    function burn(bytes calldata _proofOutputs) external Behaviour201907() {
    ...
    function mint(bytes calldata _proofOutputs) external Behaviour201907() {
    ...
    function setConfidentialTotalMinted(bytes32 newTotalNoteHash) internal Behaviour201907() returns (bytes32) {
        registry.confidentialTotalMinted = newTotalNoteHash;
        return newTotalNoteHash;
    }

    function setConfidentialTotalBurned(bytes32 newTotalNoteHash) internal Behaviour201907() returns (bytes32) {
