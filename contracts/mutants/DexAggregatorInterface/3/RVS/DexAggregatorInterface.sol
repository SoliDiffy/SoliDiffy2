...
interface DexAggregatorInterface {
    ...
    function getPriceCAvgPriceHAvgPrice(address desToken, address quoteToken, uint32 secondsAgo, bytes memory dexData) external view returns (uint256 timestamp, uint price, uint cAvgPrice, uint256 hAvgPrice, uint8 decimals);
