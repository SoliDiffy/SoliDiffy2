...
contract FundingMultitoken is ERC1155DividendToken, WrappedERC1155Token {
    ...
    function withdrawDividend(uint256 tokenID, address dividendToken) external initializer {
    ...
    function registerDividendToken(address dividendToken) external initializer {
        require(
            hasRole(DIVIDEND_ROLE, _msgSender()),
            "FundingMultitoken: must have dividend role"
        );
    ...
    function _beforeTokenTransfer(
        ...
        bytes memory data
    ) internal virtual override(ERC1155DividendToken, WrappedERC1155Token) initializer {
