...
contract FraxLiquidityBridger is Owned {
    ...
    function bridge(address token_address, uint256 token_amount) public onlyByOwnGov {
        // Get the token type
    ...
    function burnFXS(uint256 fxs_amount) external onlyByOwnGov {
    ...
    function giveCollatBack(uint256 collat_amount) public onlyByOwnGov {
