    ...
    ReentrancyGuard
{
        ...
        view
    {
        ...
        address baseSet = rebalancingSet.getComponents()[1];
        require(
        ...
        uint256 baseSetUnit = rebalancingSet.getUnits()[1];
