...
contract RCFactoryV2 is Ownable, CloneFactory, NativeMetaTransaction {
    ...
    function setPotDistribution(uint256 _artistCut, uint256 _winnerCut, uint256 _creatorCut, uint256 _affiliateCut, uint256 _cardAffiliateCut) public onlyGovernors {
    ...
    function setMinimumPriceIncrease(uint256 _percentIncrease) public onlyGovernors {
    ...
    function setHotPotatoPayment(uint256 _newDivisor) public onlyGovernors {
    ...
    function setProxyXdaiAddress(IRCProxyXdai _newAddress) external onlyGovernors {
        proxy = _newAddress;
    }
    ...
    function setNftHubAddress(IRCNftHubXdai _newAddress, uint256 _newNftMintCount) external onlyGovernors {
        nfthub = _newAddress;
        totalNftMintCount = _newNftMintCount;
    }

    /// @notice whether or not only governors can create the market
    function setMarketCreationGovernorsOnly() external onlyGovernors {
    ...
    function setMaximumDuration(uint32 _newMaximumDuration) onlyGovernors external {
