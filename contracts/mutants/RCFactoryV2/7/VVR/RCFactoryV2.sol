...
contract RCFactoryV2 is Ownable, CloneFactory, NativeMetaTransaction {
    ...
    IRCProxyXdai internal proxy;
    IRCNftHubXdai internal nfthub;

    ///// CONTRACT ADDRESSES /////
    /// @dev reference contract
    address internal referenceContractAddress; 
    /// @dev increments each time a new reference contract is added
    uint256 internal referenceContractVersion;
