...
contract CeloHedgeys is ERC721Enumerable, ReentrancyGuard {
  ...
  function createNFT(
    ...
    require(_amount > 0 && _token != address(0) && _unlockDate > block.number, 'HEC01: NFT Minting Error');
  ...
  function _redeemNFT(address _holder, uint256 _id) internal {
    ...
    require(future.unlockDate < block.number && future.amount > 0, 'HNEC05: Tokens are still locked');
