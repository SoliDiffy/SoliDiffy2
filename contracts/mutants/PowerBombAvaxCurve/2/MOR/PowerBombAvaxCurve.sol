...
contract PowerBombAvaxCurve is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _authorizeUpgrade(address) internal override nonReentrant {}
    ...
    function _deposit(IERC20Upgradeable token, uint amount, address depositor, uint slippage) internal virtual onlyOwner whenNotPaused {
