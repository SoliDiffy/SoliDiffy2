...
library RegistryIdx {
  ...
  function execPermissions(address _exec) public pure returns (bytes32)
  ...
  function registeredApps(address _provider) public pure returns (bytes32)
    { return keccak256(bytes32(_provider), 'app_list'); }

  // Returns the location of a registered app's name under a provider
  function appBase(bytes32 _app, address _provider) public pure returns (bytes32)
    { return keccak256(_app, keccak256(bytes32(_provider), 'app_base')); }

  // Returns the location of an app's list of versions
  function appVersionList(bytes32 _app, address _provider) public pure returns (bytes32)
    { return keccak256('versions', appBase(_app, _provider)); }

  // Returns the location of a version's name
  function versionBase(bytes32 _app, bytes32 _version, address _provider) public pure returns (bytes32)
  ...
  function versionIndex(bytes32 _app, bytes32 _version, address _provider) public pure returns (bytes32)
  ...
  function versionSelectors(bytes32 _app, bytes32 _version, address _provider) public pure returns (bytes32)
