...
library RegistryIdx {
  ...
  function versionAddresses(bytes32 _app, bytes32 _version, address _provider) public pure returns (bytes32)
  ...
  function getApplications(address _storage, bytes32 _exec_id, address _provider) public view returns (bytes32[] memory) {
