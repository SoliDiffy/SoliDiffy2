...
contract AudiusMock is MockStaking {
     ...
     */
    function getTotalDelegatorStake(address _delegator) public view returns (uint256) {
        return staked;
    }
     ...
     */
    function undelegateStake() public reverted(this.undelegateStake.selector) returns (uint256) {
     ...
     */
    function claimRewards(address _serviceProvider) public reverted(this.claimRewards.selector) {
        return;
    }
