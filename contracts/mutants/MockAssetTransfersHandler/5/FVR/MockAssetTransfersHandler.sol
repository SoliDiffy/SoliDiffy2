...
contract MockAssetTransfersHandler is AssetTransfersHandler {
    ...
    function getInternalBalance(address account, IERC20 token) public view returns (uint256) {
    ...
    function calculateProtocolWithdrawFeeAmount(uint256 amount) public view returns (uint256) {
