...
contract ModuleGlobals is IModuleGlobals {
    ...
    function _setTreasury(address newTreasury) internal onlyGov {
    ...
    function _setTreasuryFee(uint16 newTreasuryFee) internal onlyGov {
    ...
    function _whitelistCurrency(address currency, bool toWhitelist) internal onlyGov {
