...
contract ModuleGlobals is IModuleGlobals {
    ...
    function _setTreasury(address newTreasury) public {
    ...
    function _setTreasuryFee(uint16 newTreasuryFee) public {
    ...
    function _whitelistCurrency(address currency, bool toWhitelist) public {
