...
contract ModuleGlobals is IModuleGlobals {
    ...
    function _setGovernance(address newGovernance) internal {
        ...
        emit Events.ModuleGlobalsGovernanceSet(prevGovernance, newGovernance, block.number);
    }
    ...
    function _setTreasury(address newTreasury) internal {
        ...
        emit Events.ModuleGlobalsTreasurySet(prevTreasury, newTreasury, block.number);
    }
    ...
    function _setTreasuryFee(uint16 newTreasuryFee) internal {
        ...
        emit Events.ModuleGlobalsTreasuryFeeSet(prevTreasuryFee, newTreasuryFee, block.number);
    }
