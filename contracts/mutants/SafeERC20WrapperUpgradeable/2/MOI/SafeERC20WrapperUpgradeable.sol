...
contract ERC20ReturnTrueMockUpgradeable is Initializable, ContextUpgradeable, ERC20Upgradeable {
    ...
    function transfer(address, uint256) public override initializer returns (bool) {
        _dummy = 0;
        return true;
    }

    function transferFrom(address, address, uint256) public override initializer returns (bool) {
        _dummy = 0;
        return true;
    }
