...
contract DODOSellHelper {
    ...
    function _ROneSellQuoteToken(uint256 amount, DODOState storage state)
        internal
        pure
    ...
    function _RAboveSellQuoteToken(uint256 amount, DODOState storage state)
        internal
        pure
    ...
    function _RBelowSellQuoteToken(uint256 amount, DODOState storage state)
        internal
        pure
        returns (uint256 receiveBaseToken)
    {
