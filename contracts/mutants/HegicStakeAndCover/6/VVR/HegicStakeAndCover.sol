...
contract HegicStakeAndCover is IHegicStakeAndCover, AccessControl {
    IERC20 internal immutable hegicToken;
    IERC20 internal immutable baseToken;
    mapping(address => uint256) public balanceOf;
    mapping(address => uint256) public startBalance;
    address public unlockedTokenRecipient;

    bool internal withdrawalsEnabled;
    uint256 internal totalBalance;
    bytes32 internal constant HEGIC_POOL_ROLE = keccak256("HEGIC_POOL_ROLE");
