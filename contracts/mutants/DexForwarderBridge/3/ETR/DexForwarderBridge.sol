    ...
    MixinGasToken
{
        ...
        returns (bytes4 success)
    {
        ...
        for (uint256 i = 0; i < state.calls.length; ++i) {
            ...
            // funds by reverting.
            (bool didSucceed, ) = address(this).delegatecall(abi.encodeWithSelector(
        ...
        external
    {
        ...
        LibERC20Token.send(inputToken, bridge, inputTokenAmount);

        // Call the bridge.
        (bool didSucceed, bytes memory resultData) =
            bridge.delegatecall(abi.encodeWithSelector(
