...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    */
    ...
    function _reporterOnly() public view {
    ...
    // error message binary size optimization
    function _xTransfersAllowed() public view {
    ...
    // error message binary size optimization
    function _reportingAllowed() public view {
     ...
     */
    function setMaxLockLimit(uint256 _maxLockLimit) external ownerOnly greaterThanZero(_maxLockLimit) {
        maxLockLimit = _maxLockLimit;
    }
     ...
     */
    function setMaxReleaseLimit(uint256 _maxReleaseLimit) external ownerOnly greaterThanZero(_maxReleaseLimit) {
        maxReleaseLimit = _maxReleaseLimit;
    }
     ...
     */
    function setMinLimit(uint256 _minLimit) external ownerOnly greaterThanZero(_minLimit) {
        // validate input
     ...
     */
    function setLimitIncPerBlock(uint256 _limitIncPerBlock) external ownerOnly greaterThanZero(_limitIncPerBlock) {
        limitIncPerBlock = _limitIncPerBlock;
    }
     ...
     */
    function setMinRequiredReports(uint8 _minRequiredReports) external ownerOnly greaterThanZero(_minRequiredReports) {
        minRequiredReports = _minRequiredReports;
    }
     ...
     */
    function setReporter(address _reporter, bool _active) external ownerOnly {
