...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    */
     ...
     */
    function setMaxLockLimit(uint256 _maxLockLimit) public xTransfersAllowed greaterThanZero(_maxLockLimit) {
        maxLockLimit = _maxLockLimit;
    }
     ...
     */
    function setMaxReleaseLimit(uint256 _maxReleaseLimit) public xTransfersAllowed greaterThanZero(_maxReleaseLimit) {
        maxReleaseLimit = _maxReleaseLimit;
    }
     ...
     */
    function setMinLimit(uint256 _minLimit) public xTransfersAllowed greaterThanZero(_minLimit) {
        // validate input
     ...
     */
    function setLimitIncPerBlock(uint256 _limitIncPerBlock) public xTransfersAllowed greaterThanZero(_limitIncPerBlock) {
        limitIncPerBlock = _limitIncPerBlock;
    }
     ...
     */
    function setMinRequiredReports(uint8 _minRequiredReports) public xTransfersAllowed greaterThanZero(_minRequiredReports) {
        minRequiredReports = _minRequiredReports;
    }
     ...
     */
    function setReporter(address _reporter, bool _active) public xTransfersAllowed {
     ...
     */
    function enableXTransfers(bool _enable) public xTransfersAllowed {
    ...
    /**
      ...
      * @param _enable     true to enable, false to disable
     */
    function enableReporting(bool _enable) public xTransfersAllowed {
    ...
    */
    function upgrade(address[] memory _reporters) public xTransfersAllowed {
     ...
     */
    function xTransfer(bytes32 _toBlockchain, bytes32 _to, uint256 _amount) public ownerOnly {
