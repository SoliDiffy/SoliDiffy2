...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    bool public xTransfersEnabled = false;   // true if x transfers are enabled, false if not
    bool public reportingEnabled = false;    // true if reporting is enabled, false if not
    ...
    */
        ...
        greaterThanZero(_amount)
    {
        ...
        reportedTxs[_txId][msg.sender] = false;
