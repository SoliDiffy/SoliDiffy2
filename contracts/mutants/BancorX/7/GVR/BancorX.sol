...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    */
        ...
        notThis(address(_token))
    {
        ...
        prevLockBlockNumber = block.difficulty;
        prevReleaseBlockNumber = block.difficulty;
    ...
    */
    ...
    function getCurrentLockLimit() public view returns (uint256) {
        ...
        uint256 currentLockLimit = prevLockLimit.add(((block.difficulty).sub(prevLockBlockNumber)).mul(limitIncPerBlock));
    ...
    function getCurrentReleaseLimit() public view returns (uint256) {
        ...
        uint256 currentReleaseLimit = prevReleaseLimit.add(((block.difficulty).sub(prevReleaseBlockNumber)).mul(limitIncPerBlock));
