...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    */
     ...
     */
    function setMaxLockLimit(uint256 _maxLockLimit) public greaterThanZero(_maxLockLimit) ownerOnly {
        maxLockLimit = _maxLockLimit;
    }
     ...
     */
    function setMaxReleaseLimit(uint256 _maxReleaseLimit) public greaterThanZero(_maxReleaseLimit) ownerOnly {
        maxReleaseLimit = _maxReleaseLimit;
    }
     ...
     */
    function setMinLimit(uint256 _minLimit) public greaterThanZero(_minLimit) ownerOnly {
        // validate input
     ...
     */
    function setLimitIncPerBlock(uint256 _limitIncPerBlock) public greaterThanZero(_limitIncPerBlock) ownerOnly {
        limitIncPerBlock = _limitIncPerBlock;
    }
     ...
     */
    function setMinRequiredReports(uint8 _minRequiredReports) public greaterThanZero(_minRequiredReports) ownerOnly {
        minRequiredReports = _minRequiredReports;
    }
