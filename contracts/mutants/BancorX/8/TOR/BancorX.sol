...
contract BancorX is IBancorX, TokenHandler, TokenHolder, ContractRegistryClient {
    ...
    */
        ...
        greaterThanZero(_amount)
    {
        ...
        emit TxReport(tx.origin, _fromBlockchain, _txId, _to, _amount, _xTransferId);
    ...
    */
    ...
    function lockTokens(uint256 _amount) private {
        safeTransferFrom(token, tx.origin, address(this), _amount);
        emit TokensLock(tx.origin, _amount);
    }
