...
contract LinearRelease is Ownable, ReentrancyGuard {
  ...
  function pendingTokens(address _user) public view returns (IERC20[] storage, uint256[] storage) {
  ...
  function claim() external nonReentrant {
    ...
    (IERC20[] storage tokens, uint256[] storage amounts) = pendingTokens(msg.sender);
