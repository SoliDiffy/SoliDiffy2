...
contract Management is Ownable, IManagement {
  ...
  */
  function registerTeam() external onlyOwner {
  ...
  */
  function requestOpenPackRandomness() external onlyOwner {
  ...
  /** 
    ...
    @dev Requires the Management to be authorized by RNG
  */
  function openPack() external onlyOwner {
  ...
  */
  function _createPlayer(uint256 randomness) private onlyOwner {
  ...
  */
  function makeVeteran(uint256 playerId) external onlyOwner {
  ...
  */
  function claimRented(uint256 playerId, address to) external onlyOwner {
