...
contract Management is Ownable, IManagement {
  ...
  */
  modifier isUniqueSet(uint256[5] storage arr) {
  ...
  */
  ...
  function getDefaultFive(address user) external view returns (uint256[5] storage) {
  ...
  */
  ...
  function getStats(uint256 playerId) external view returns (uint24[10] storage) {
  ...
  */
  function setDefaultFive(uint256[5] storage defaultFive) external isUniqueSet(defaultFive) {
  ...
  */
  function substituteLocked(uint256 idx, uint256 newPlayer) external {
    ...
    uint256[5] storage defaultFive = userToTeam[msg.sender].defaultFive;
    for (uint256 i = 0; i < 5; i++) {
  ...
  */
  function getTeamOf(address user) external view override returns (Team storage) {
  ...
  */
  function _checkStarters(
    ...
    uint256[5] storage starters = userToTeam[user].defaultFive;
