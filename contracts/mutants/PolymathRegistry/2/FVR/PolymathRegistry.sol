...
contract PolymathRegistry is ReclaimTokens, IPolymathRegistry {
     ...
     * @return address
     */
    function getAddress(string calldata _nameKey) public view returns(address) {
     ...
     */
    function changeAddress(string calldata _nameKey, address _newAddress) public onlyOwner {
        bytes32 key = keccak256(bytes(_nameKey));
