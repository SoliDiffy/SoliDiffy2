...
contract AuthManager is IAuthManager, Initializable {
    ...
    function add(bytes32 role, address member) external override initializer {
    ...
    function addByString(string calldata roleString, address member) external initializer {
        require(_find(members[msg.sender], SUPER_ROLE) != NOTFOUND, "FORBIDDEN");
