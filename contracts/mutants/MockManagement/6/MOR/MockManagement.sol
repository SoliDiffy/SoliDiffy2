...
contract MockManagement is Ownable, IManagement {
  ...
  */
  ...
  function setTrainingInterval(uint256 newTrainingInterval) external authorized {
  ...
  */
  function addAcademy() public authorized {
  ...
  */
  function removeAcademy(uint256 academyId) public authorized {
  ...
  */
  function setDefaultFive(uint256[5] memory defaultFive) external onlyOwner {
    require(userToTeam[msg.sender].initialized, "");
  ...
  */
  ...
  function lockDefaultFive(address user) external override onlyOwner {
