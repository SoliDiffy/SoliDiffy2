...
contract MockManagement is Ownable, IManagement {
  ...
  */
  ...
  function setTrainingInterval(uint256 newTrainingInterval) public onlyOwner {
  ...
  */
  function addAcademy() external onlyOwner {
  ...
  */
  function removeAcademy(uint256 academyId) external onlyOwner {
  ...
  function getDefaultFive(address user) public view returns (uint256[5] memory) {
  ...
  */
  function requestOpenPackRandomness() public {
  ...
  */
  ...
  function getStats(uint256 playerId) public view returns (uint24[10] memory) {
  ...
  */
  function _createPlayer(uint256 randomness) public {
