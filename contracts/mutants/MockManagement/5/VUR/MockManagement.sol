...
contract MockManagement is Ownable, IManagement {
  ...
  uint256 constant EXPIRE_TIME = 12 seconds;
  ...
  uint256 trainingInterval = 4 seconds;
  ...
  */
  function registerTeam() external {
    ...
    userToTeam[msg.sender] = Team({
      ...
      morale: 100,
      wins: 0,
      lastChallenge: uint48(block.timestamp) - 5 seconds,
  ...
  */
  ...
  function afterTraining(address user, bool won) external override authorized {
    ...
    uint256 hoursOut = (block.timestamp - team.lastChallenge) / 8 seconds;
