...
contract VaultKeep3rJob is MachineryReady, Keep3r, GasPriceLimited, IVaultKeep3rJob {
  ...
  function _setRewardMultiplier(uint256 _rewardMultiplier) internal onlyGovernor {
  ...
  function _addVault(address _vault, uint256 _requiredEarn) internal onlyGovernor {
  ...
  function _updateVault(address _vault, uint256 _requiredEarn) internal onlyGovernor {
  ...
  function _setRequiredEarn(address _vault, uint256 _requiredEarn) internal onlyGovernor {
  ...
  function _setEarnCooldown(uint256 _earnCooldown) internal onlyGovernor {
  ...
  // Keeper actions
  function _work(address _vault) internal onlyGovernor returns (uint256 _credits) {
  ...
  function _earn(address _vault) internal onlyGovernor {
