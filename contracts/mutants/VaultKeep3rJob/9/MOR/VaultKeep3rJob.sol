...
contract VaultKeep3rJob is MachineryReady, Keep3r, GasPriceLimited, IVaultKeep3rJob {
  ...
  function updateVaults(address[] calldata _vaults, uint256[] calldata _requiredEarns) external override onlyGovernor {
  ...
  function updateVault(address _vault, uint256 _requiredEarn) external override onlyGovernor {
