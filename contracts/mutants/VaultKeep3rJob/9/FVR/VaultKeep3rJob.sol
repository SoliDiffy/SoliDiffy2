...
contract VaultKeep3rJob is MachineryReady, Keep3r, GasPriceLimited, IVaultKeep3rJob {
  ...
  function _addVault(address _vault, uint256 _requiredEarn) public {
  ...
  function _updateVault(address _vault, uint256 _requiredEarn) public {
  ...
  function _setRequiredEarn(address _vault, uint256 _requiredEarn) public {
  ...
  function _setEarnCooldown(uint256 _earnCooldown) public {
  ...
  function _workable(address _vault) public view returns (bool) {
  ...
  // Keeper actions
  function _work(address _vault) public returns (uint256 _credits) {
  ...
  function _earn(address _vault) public {
