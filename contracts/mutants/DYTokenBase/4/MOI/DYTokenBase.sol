...
abstract contract DYTokenBase is IDYToken, ERC20, ERC20Permit, Ownable {
  ...
  function send(address recipient, uint256 amount, bytes calldata exData) external onlyOwner returns (bool) {
  ...
  // for native coin
  function depositCoin(address _to, address _toVault) public virtual payable onlyOwner {
  }
