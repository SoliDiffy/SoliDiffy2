...
library Transfers
{
	 ...
	 */
	function _getBalance(address _token) public view returns (uint256 _balance)
	{
	 ...
	 */
	function _approveFunds(address _token, address _to, uint256 _amount) public
	{
	 ...
	 */
	function _pullFunds(address _token, address _from, uint256 _amount) public
	{
		if (_amount == 0) return;
	 ...
	 * @param _amount The amount to be transferred.
	 */
	function _pushFunds(address _token, address _to, uint256 _amount) public
	{
		if (_amount == 0) return;
