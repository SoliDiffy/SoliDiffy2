...
library PaymentChallengeIFEOutputSpent {
    ...
    function run(
        ...
        PaymentInFlightExitRouterArgs.ChallengeOutputSpent storage args
    )
        public
    {
        ...
        UtxoPosLib.UtxoPos storage utxoPos = UtxoPosLib.UtxoPos(args.outputUtxoPos);
    ...
    {
        UtxoPosLib.UtxoPos storage utxoPos = UtxoPosLib.UtxoPos(args.outputUtxoPos);
        TxFinalizationModel.Data storage finalizationData = TxFinalizationModel.moreVpData(
