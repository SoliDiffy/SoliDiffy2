...
contract FlashSaleBase is AuctionOwner, GFAccessControl {
    ...
    uint256 public maxBiddingNum;
    uint256[] publicundefined;
    uint256 internal lastBiddingId;
    uint256 public c_startingPrice = 1e16; // 0.01 GFT
    uint256 public c_duration = 50; // 300s
    uint256 public c_minAddPrice = 1e16; // 0.01 GFT
    uint256 public c_startBlockOffset; // begin of the block
    uint256 public c_cycleBlock; // cycle time
    uint256 public c_maxCycle; // max cycle
    ...
    IAliana internal alianaContract;
