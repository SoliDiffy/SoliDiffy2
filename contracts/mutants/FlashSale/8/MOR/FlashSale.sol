...
contract FlashSaleBase is AuctionOwner, GFAccessControl {
    ...
    function setCycleBlock(uint256 _cycleBlock) public whenNotPaused {
    ...
    function setStartBlockOffset(uint256 _startBlockOffset) public whenNotPaused {
        require(
    ...
    function setMaxCycle(uint256 _maxCycle) public whenNotPaused {
