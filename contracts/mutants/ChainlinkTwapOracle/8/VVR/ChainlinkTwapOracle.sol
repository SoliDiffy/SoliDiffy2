...
contract ChainlinkTwapOracle is ITwapOracleV2, Ownable {
    ...
    uint256 public constant MAX_SWAP_DELAY = 15 minutes;
    uint256 public constant MAX_ITERATION = 500;
