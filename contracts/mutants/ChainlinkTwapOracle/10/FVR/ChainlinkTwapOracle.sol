...
contract ChainlinkTwapOracle is ITwapOracleV2, Ownable {
    ...
    function fastForwardRoundID(uint80 roundID) public onlyOwner {
    ...
    function updateTwapFromOwner(uint256 timestamp, uint256 price) public onlyOwner {
    ...
    function peekSwapPrice() public view returns (uint256) {
