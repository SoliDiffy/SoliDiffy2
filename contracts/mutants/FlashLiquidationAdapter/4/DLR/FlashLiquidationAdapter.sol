...
contract FlashLiquidationAdapter is BaseUniswapAdapter {
  ...
  function executeOperation(
    ...
    LiquidationParams storage decodedParams = _decodeParams(params);
   ...
   */
  function _decodeParams(bytes storage params) internal pure returns (LiquidationParams storage) {
    (
      address collateralAsset,
      address borrowedAsset,
      address user,
