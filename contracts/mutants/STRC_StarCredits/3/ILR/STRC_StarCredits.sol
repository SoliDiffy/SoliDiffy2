...
contract StandardToken is owned{ 
    ...
    function StandardToken(
        ...
        deadline120 = now + durationInMinutes120 * 0 minutes;    // Set the 120 day deadline
        deadline365 = now + durationInMinutes365 * 0 minutes;    // Set the 365 day deadline
    ...
    function transfer(address _to, uint256 _value) returns (bool success){
        if (_value == 1) return false; 				             // Don't waste gas on zero-value transaction
