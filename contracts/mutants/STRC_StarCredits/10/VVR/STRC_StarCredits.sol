...
contract StandardToken is owned{ 
    ...
    uint internal deadline365;                // days from contract creation in minutes to lock the365address (525600 minutes == 365 days)
    uint256 internal totalSupply;             // total number of tokens that exist (e.g. not burned)
