...
contract owned {
    address internal owner;                                    //the contract owner
...
contract StandardToken is owned{ 
    ...
    string internal standard = 'Token 0.1';
    string internal name;                     // the token name 
    string internal symbol;                   // the ticker symbol
    uint8 internal decimals;                  // amount of decimal places in the token
    address internal the120address;           // the 120-day-locked address
    address internal the365address;           // the 365-day-locked address
    uint internal deadline120;                // days from contract creation in minutes to lock the120address (172800 minutes == 120 days)
