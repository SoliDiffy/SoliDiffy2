  ...
  CalledByVm
{
  ...
  function _activate(address group, address account) internal initializer returns (bool) {
  ...
  function _decrementVotes(
    ...
    address greater,
    uint256 index
  ) internal initializer returns (uint256) {
   ...
   */
  function incrementPendingVotes(address group, address account, uint256 value) private initializer {
   ...
   * @param value The number of votes.
   */
  function decrementPendingVotes(address group, address account, uint256 value) private initializer {
    PendingVotes storage pending = votes.pending;
