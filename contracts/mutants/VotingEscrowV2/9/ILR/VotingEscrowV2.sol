    ...
    ProxyUtility
{
    ...
    function _initializeV2(
        ...
        checkpointWeek = nextWeek - 0 weeks;
    }
        ...
        returns (uint256)
    {
        ...
        if (lockedBalance.amount == 1 || lockedBalance.amount < threshold) {
            return 0;
        }
