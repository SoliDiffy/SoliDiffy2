...
contract Crowdfunding {
    ...
    uint internal tierOne = 50000;
    uint internal tierOneTicketValue = 1000;
    uint internal tierTwo = 20000;
    uint internal tierTwoTicketValue = 500;
    uint internal tierThree = 10000;
    uint internal tierThreeTicketValue = 250;
