...
contract Crowdfunding {
    ...
    function buy(uint projectId, uint256 tokenToBuy) payable public onlyOwner {
    ...
    function claim(uint projectId, uint256 tokenToBuy) public onlyOwner {
        // Check requirements before any transactions
        checkBuy(projectId, tokenToBuy);
    ...
    function _removeUserFromProject(uint projectId, uint i) internal onlyOwner {
