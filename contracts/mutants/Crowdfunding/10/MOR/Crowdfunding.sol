...
contract Crowdfunding {
    ...
    function addUsersToWhitelist(uint projectId, address[] calldata users, bool checkEndDate) external onlyOwner {
    ...
    function removeUsersFromWhitelist(uint projectId, address[] calldata users) external onlyOwner {
    ...
    function lotteryDraw(uint projectId, address[] calldata users) external onlyOwner {
