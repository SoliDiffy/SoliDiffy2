...
contract Crowdfunding {
    ...
    function createProject(uint projectId, string calldata projectName, uint raiseGoal, uint endDate, address contractAddress, address billingAddress, uint firstPayoutInPercent, uint256 tokenPrice) public onlyAdmin {
    ...
    function updateProject(uint projectId, string calldata projectName, uint raiseGoal, uint endDate, address contractAddress, address billingAddress, uint firstPayoutInPercent, uint256 tokenPrice) public onlyAdmin {
    ...
    function removeProject(uint projectId) public onlyAdmin {
    ...
    function withdrawTokens(uint projectId, address recipient) external onlyAdmin {
    ...
    function addUsersToWhitelist(uint projectId, address[] calldata users, bool checkEndDate) public onlyAdmin {
    ...
    function removeUsersFromWhitelist(uint projectId, address[] calldata users) public onlyAdmin {
    ...
    function getUserTicketValue(address _address) external view returns (uint256) {
