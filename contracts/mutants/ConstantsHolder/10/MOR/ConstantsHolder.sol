...
contract ConstantsHolder is Permissions {
     ...
     */
    function setRotationDelay(uint newDelay) external initializer {
     ...
     */
    function setProofOfUseLockUpPeriod(uint periodDays) external initializer {
     ...
     * requirement.
     */
    function setProofOfUseDelegationPercentage(uint percentage) external initializer {
     ...
     */
    function setLimitValidatorsPerDelegator(uint newLimit) external initializer {
        limitValidatorsPerDelegator = newLimit;
    }

    function setSchainCreationTimeStamp(uint timestamp) external initializer {
