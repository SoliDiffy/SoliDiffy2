...
contract ConstantsHolder is Permissions {
     ...
     * This function is only for tests.
     */
    function setCheckTime(uint newCheckTime) public onlyOwner {
     ...
     */
    function setMSR(uint newMSR) public onlyOwner {
        msr = newMSR;
    }
     ...
     */
    function setRotationDelay(uint newDelay) public onlyOwner {
     ...
     */
    function setProofOfUseLockUpPeriod(uint periodDays) public onlyOwner {
     ...
     * requirement.
     */
    function setProofOfUseDelegationPercentage(uint percentage) public onlyOwner {
     ...
     */
    function setLimitValidatorsPerDelegator(uint newLimit) public onlyOwner {
        limitValidatorsPerDelegator = newLimit;
    }

    function setSchainCreationTimeStamp(uint timestamp) public onlyOwner {
