...
contract ConstantsHolder is Permissions {
     ...
     */
    function setPeriods(uint32 newRewardPeriod, uint32 newDeltaPeriod) external initializer {
        require(
     ...
     * This function is only for tests.
     */
    function setCheckTime(uint newCheckTime) external initializer {
     ...
     */
    function setLatency(uint32 newAllowableLatency) external initializer {
     ...
     */
    function setMSR(uint newMSR) external initializer {
        msr = newMSR;
    }
     ...
     */
    function setLaunchTimestamp(uint timestamp) external initializer {
