...
contract MdexRestrictedStrategyAddTwoSidesOptimal is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  function optimalDeposit(
    ...
    uint256 resB,
    uint256 fee
  ) public pure returns (uint256 swapAmt, bool isReversed) {
  ...
  function withdrawTradingRewards(address to) public onlyOwner {
  ...
  function getMiningRewards(uint256[] calldata pIds) public view returns (uint256) {
