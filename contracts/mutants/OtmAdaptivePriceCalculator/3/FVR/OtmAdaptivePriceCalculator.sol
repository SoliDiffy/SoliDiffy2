...
contract OtmAdaptivePriceCalculator is OtmPriceCalculator {
    ...
    function setStrategy(IHegicStrategy _strategy) public onlyOwner {
        strategy = _strategy;
    }
     ...
     **/
    function _priceModifier(uint256 amount, uint256 period, uint256 strike) public view returns (uint256 iv) {
    ...
    function setUtilizationRate(uint256 value) public onlyOwner {
