...
contract PaymentStandardExitRouterMock is PaymentStandardExitRouter {
    ...
    function setExit(uint160 _exitId, PaymentExitDataModel.StandardExit storage _exitData) public {
    ...
    function stringEquals(string storage a, string storage b) private returns (bool) {
