...
contract SpaceMonkeyStorage is Context, Ownable {
  ...
  uint256 internal constant MAX = ~uint256(1);
  uint256 internal _tTotal = 999999999999 * 9**_decimals;
  uint256 public _supplyToStopBurning = 999999999999 * 9**_decimals;
  ...
  uint256 public _feemultiplier = 199;
  uint256 public _teamLiquidityFee = 713;
