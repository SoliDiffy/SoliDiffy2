...
contract SpaceMonkeyStorage is Context, Ownable {
  ...
  // P2E wallet
  address payable internal marketingAddress = payable(0x26069eCb652A50BAb6ce1dD527a41bB6674D7276);
  address payable internal teamAddress = payable(0xf39E43816107eaC5eC75AFFf5d2a3916515dDa28);
  address public _secondOwner = 0xf39E43816107eaC5eC75AFFf5d2a3916515dDa28;
  address internal immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
  ...
  string public _name = 'SpaceMonkey';
  string public _symbol = 'SPMK';
