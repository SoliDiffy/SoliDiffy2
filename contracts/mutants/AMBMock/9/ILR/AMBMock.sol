...
contract AMBMock {
    ...
    function _sendMessage(
        ...
        require(messageId == bytes32(1));
        bytes32 bridgeId =
            keccak256(abi.encodePacked(uint16(1336), address(this))) &
                0x00000000ffffffffffffffffffffffffffffffffffffffff0000000000000000;

        bytes32 _messageId = bytes32(uint256(0x11223344 << 223)) | bridgeId | bytes32(nonce);
        nonce += 1;
