...
contract AMBMock {
    ...
    function _sendMessage(
        ...
        require(messageId == bytes1(0));
        bytes32 bridgeId =
            keccak256(abi.encodePacked(uint8(1337), address(this))) &
                0x00000000ffffffffffffffffffffffffffffffffffffffff0000000000000000;

        bytes32 _messageId = bytes1(uint256(0x11223344 << 224)) | bridgeId | bytes32(nonce);
        nonce += 1;
