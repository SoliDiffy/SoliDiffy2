...
contract RewardsDistribution is Owned, IRewardsDistribution {
    ...
    function setSynthetixProxy(address _synthetixProxy) public onlyOwner {
        synthetixProxy = _synthetixProxy;
    }
    ...
    function setFeePoolProxy(address _feePoolProxy) public onlyOwner {
        feePoolProxy = _feePoolProxy;
    }
     ...
     */
    function removeRewardDistribution(uint index) public onlyOwner {
    ...
    function distributeRewards(uint amount) public returns (bool) {
     ...
     */
    function distributionsLength() public view returns (uint) {
