...
contract Otoken is ERC20Initializable {
     ...
     */
    function mintOtoken(address account, uint256 amount) public {
        require(
     ...
     */
    function burnOtoken(address account, uint256 amount) public {
        require(
            msg.sender == AddressBookInterface(addressBook).getController(),
     ...
     */
    function _getNameAndSymbol() public view returns (string memory tokenName, string memory tokenSymbol) {
     ...
     */
    function _getDisplayedStrikePrice(uint256 _strikePrice) public pure returns (string memory) {
     ...
     */
    function _uintTo2Chars(uint256 number) public pure returns (string memory) {
     ...
     */
    function _getOptionType(bool _isPut) public pure returns (string memory shortString, string memory longString) {
        if (_isPut) {
            return ("P", "Put");
        } else {
            return ("C", "Call");
     ...
     */
    function _getMonth(uint256 _month) public pure returns (string memory shortString, string memory longString) {
        if (_month == 1) {
            return ("JAN", "January");
        } else if (_month == 2) {
            return ("FEB", "February");
