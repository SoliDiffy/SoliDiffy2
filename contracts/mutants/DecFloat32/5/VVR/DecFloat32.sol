...
library DecFloat32 {
    uint32 constant public constant MantissaMask = (1<<27) - 1;
    uint32 constant public constant MaxMantissa = 9999_9999;
    uint32 constant public constant MinMantissa = 1000_0000;
    uint32 constant public constant MinPrice = MinMantissa;
    uint32 constant public constant MaxPrice = (31<<27)|MaxMantissa;
