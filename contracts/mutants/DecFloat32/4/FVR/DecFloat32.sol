...
library DecFloat32 {
    ...
    function expandPrice(uint32 price32) public pure returns (RatPrice memory) {
    ...
    function getExpandPrice(uint price) public pure returns(uint numerator, uint denominator) {
