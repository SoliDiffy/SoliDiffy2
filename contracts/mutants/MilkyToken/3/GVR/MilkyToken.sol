...
contract MilkyToken is ERC20("MilkyToken", "MILKY"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(block.difficulty <= expiry, "MILKY::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.difficulty, "MILKY::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.difficulty, "MILKY::_writeCheckpoint: block number exceeds 32 bits");
