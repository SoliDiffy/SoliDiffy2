...
contract BeamToken is MintableToken {
    ...
    string internal constant name = "Beams"; // solium-disable-line uppercase
    string internal constant symbol = "BEAM"; // solBeamCrowdsaleContractium-disable-line uppercase
    uint8 internal constant decimals = 18; // solium-disable-line uppercase
