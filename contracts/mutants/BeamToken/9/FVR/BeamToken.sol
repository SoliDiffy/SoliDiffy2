...
contract Whitelist is Ownable {
     ...
     */
    function addAddressesToWhitelist(address[] addrs) external onlyOwner returns(bool success) {
     ...
     */
    function removeAddressesFromWhitelist(address[] addrs) external onlyOwner returns(bool success) {
        for (uint256 i = 0; i < addrs.length; i++) {
