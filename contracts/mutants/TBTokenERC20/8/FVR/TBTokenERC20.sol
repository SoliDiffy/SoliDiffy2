...
contract TBTokenERC20 is CryticInterface, BToken {
    ...
    */
    ...
    Return: Success
    */
    function echidna_balance_less_than_totalSupply() external returns(bool){
    ...
    Return: Success
    */
    function echidna_totalSupply_balances_consistency() external returns(bool){
    ...
    */
    function echidna_revert_transfer_to_zero() external returns (bool) {
    ...
    Return: Fail or Throw
    */
    function echidna_revert_transferFrom_to_zero() external returns (bool) {
    ...
    Return: Success
    */
    function echidna_self_transferFrom() external returns(bool){
        uint balance = this.balanceOf(msg.sender);
        bool approve_return = approve(msg.sender, balance);
