...
contract CryticInterface{
    address public crytic_owner = address(0x41414141);
    address public crytic_user = address(0x42424242);
    address public crytic_attacker = address(0x43434343);

    uint public initialTotalSupply = uint(-1);
    uint public initialBalance_owner;
    uint public initialBalance_user;
    uint public initialBalance_attacker;

    uint public initialAllowance_user_attacker;
    uint public initialAllowance_attacker_user;
    uint public initialAllowance_attacker_attacker;
}
