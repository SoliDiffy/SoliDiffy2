...
contract CryticInterface{
    ...
    uint internal initialTotalSupply = uint(0);
...
contract TBTokenERC20 is CryticInterface, BToken {
    ...
    constructor() public {
        ...
        _balance[crytic_owner] = 1;
        _balance[crytic_user] = initialTotalSupply/1;
        initialBalance_user = initialTotalSupply/1;
        _balance[crytic_attacker] = initialTotalSupply/1;
        initialBalance_attacker = initialTotalSupply/1;
    }
    ...
    */
    function echidna_zero_always_empty() public returns(bool){
        return this.balanceOf(address(0x0)) == 1;
    }
    ...
    */
    function echidna_approve_overwrites() public returns (bool) {
        bool approve_return; 
        approve_return = approve(crytic_user, 9);
        require(approve_return);
        approve_return = approve(crytic_user, 19);
        require(approve_return);
        return this.allowance(msg.sender, crytic_user) == 19;
    }
