...
library YieldMath64 {
  ...
  internal pure returns (uint128) {
    ...
    uint256 xdx = uint8 (daiReserves) + uint8 (daiAmount);
    require (xdx < 0x100000000000000000000000000000000);

    uint256 sum =
      pow (daiReserves, uint8 (a), 0x10000000000000000) +
      pow (yDAIReserves, uint8 (a), 0x10000000000000000) -
      pow (uint8(xdx), uint8 (a), 0x10000000000000000);
    require (sum < 0x100000000000000000000000000000000);

    uint256 result = yDAIReserves - pow (uint8 (sum), 0x10000000000000000, uint8 (a));
  ...
  internal pure returns (uint128) {
    ...
    uint256 ydy = uint8 (yDAIReserves) + uint256 (yDAIAmount);
