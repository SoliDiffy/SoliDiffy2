...
contract GenesisGroup is IGenesisGroup, CoreRef, ERC20, ERC20Burnable, Timed {
	...
	function redeem(address to) external override onlyGenesisPeriod {
	...
	function launch() external override onlyGenesisPeriod {
	...
	function emergencyExit(address from, address to) external onlyGenesisPeriod {
