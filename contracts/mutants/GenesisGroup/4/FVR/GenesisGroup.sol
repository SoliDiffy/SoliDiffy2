...
contract GenesisGroup is IGenesisGroup, CoreRef, ERC20, ERC20Burnable, Timed {
	...
	function getAmountsToRedeem(address to) external view postGenesis returns (uint feiAmount, uint genesisTribe, uint idoTribe) {
	...
	function emergencyExit(address from, address to) public {
	...
	function _feiTribeExchangeRate() external view returns (Decimal.D256 memory) {
