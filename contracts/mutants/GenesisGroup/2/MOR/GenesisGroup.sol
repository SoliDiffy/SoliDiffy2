...
contract GenesisGroup is IGenesisGroup, CoreRef, ERC20, ERC20Burnable, Timed {
	...
	function purchase(address to, uint value) external override payable postGenesis {
	...
	function commit(address from, address to, uint amount) external override postGenesis {
