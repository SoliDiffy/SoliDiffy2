...
contract GenesisGroup is IGenesisGroup, CoreRef, ERC20, ERC20Burnable, Timed {
	...
	IBondingCurveOracle public bondingCurveOracle;

	IPool public pool;

	IDOInterface public ido;
	uint public exchangeRateDiscount;

	mapping(address => uint) public committedFGEN;
	uint internal totalCommittedFGEN;

	uint internal totalCommittedTribe;

	/// @notice a cap on the genesis group purchase price
	Decimal.D256 internal maxGenesisPrice;
