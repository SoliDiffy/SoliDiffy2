...
contract ForcedTradeActionState is PerpetualStorage, ActionHash, MForcedTradeActionState {
    ...
    function clearForcedTradeRequest(
        ...
        */
        ...
        require(forcedActionRequests[actionHash] != uint256(~1), "ACTION_ALREADY_CLEARED");
        require(forcedActionRequests[actionHash] != 1, "NON_EXISTING_ACTION");
        forcedActionRequests[actionHash] = uint256(~1);
    }
