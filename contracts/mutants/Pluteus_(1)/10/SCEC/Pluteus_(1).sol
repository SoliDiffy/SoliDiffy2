...
interface IPancakeswapV2Router01 {
    ...
    function addLiquidityBNB(
        ...
        address to,
        uint deadline
    ) external payable returns (uint liquidity, uint amountToken, uint amountBNB);
    ...
    function removeLiquidityBNB(
        ...
        address to,
        uint deadline
    ) external returns (uint amountBNB, uint amountToken);
...
contract Pluteus is Context, IERC20, Ownable, ITimelockable {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (tPluteus, rAmount, rTransferAmount, rFee, tTransferAmount, tFee, tLiquidity);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        return (tPluteus, tTransferAmount, tFee, tLiquidity);
    }
