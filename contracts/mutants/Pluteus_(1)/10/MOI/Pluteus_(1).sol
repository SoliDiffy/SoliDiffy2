...
// SWC-129-Typographical Error: L454
...
contract Pluteus is Context, IERC20, Ownable, ITimelockable {
    ...
    function transfer(address recipient, uint256 amount) public override onlyPending returns (bool) {
    ...
    function approve(address spender, uint256 amount) public override onlyPending returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override onlyPending returns(address recievedBy) {
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual onlyPending returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].add(addedValue));
        return true;
    }

    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual onlyPending returns (bool) {
    ...
    function deliver(uint256 tAmount) public onlyPending {
    ...
    function _sharePluteus(uint256 tPluteus) private onlyPending {
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private onlyPending {
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private onlyPending {
