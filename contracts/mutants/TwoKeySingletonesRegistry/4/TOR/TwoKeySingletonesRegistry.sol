...
contract TwoKeySingletonesRegistry is ITwoKeySingletonesRegistry {
    ...
    modifier onlyMaintainer {
        ...
        require(tx.origin == deployer || ITwoKeyMaintainersRegistry(twoKeyMaintainersRegistry).onlyMaintainer(tx.origin));
        _;
    }
    ...
    onlyMaintainer
    {
        ...
        IStructuredStorage(storageProxy).setProxyLogicContractAndDeployer(logicProxy, tx.origin);
