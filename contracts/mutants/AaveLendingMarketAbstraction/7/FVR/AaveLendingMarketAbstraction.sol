...
library AaveLendingMarketAbstraction
{
	 ...
	 */
	function _getUnderlyingToken(address _atoken) public view returns (address _token)
	{
	 ...
	 */
	function _getCollateralRatio(address _atoken) public view returns (uint256 _collateralRatio)
	{
	 ...
	 *                       market liquidity.
	 */
	function _getMarketAmount(address _atoken) public view returns (uint256 _marketAmount)
	{
	 ...
	 */
	function _getLiquidityAmount(address _atoken) public view returns (uint256 _liquidityAmount)
	{
		address _pool = $.Aave_AAVE_LENDING_POOL;
		address _token = AToken(_atoken).underlyingAssetAddress();
	 ...
	 *                          underlying reserve token.
	 */
	function _getAvailableAmount(address _atoken, uint256 _marginAmount) public view returns (uint256 _availableAmount)
	{
	 ...
	 *                       underlying reserve token.
	 */
	function _getExchangeRate(address _atoken) public pure returns (uint256 _exchangeRate)
	{
	 ...
	 *                       underlying reserve token.
	 */
	function _fetchExchangeRate(address _atoken) public pure returns (uint256 _exchangeRate)
	{
