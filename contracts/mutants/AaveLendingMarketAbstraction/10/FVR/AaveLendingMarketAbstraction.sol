...
library AaveLendingMarketAbstraction
{
	 ...
	 *                 reserve token.
	 */
	function _getLendAmount(address _atoken) public view returns (uint256 _amount)
	{
	 ...
	 *                 reserve token.
	 */
	function _fetchLendAmount(address _atoken) public view returns (uint256 _amount)
	{
		address _pool = $.Aave_AAVE_LENDING_POOL;
		address _token = AToken(_atoken).underlyingAssetAddress();
	 ...
	 *                 reserve token.
	 */
	function _getBorrowAmount(address _atoken) public view returns (uint256 _amount)
	{
