...
contract Treasury is InitializableOwner {
    ...
    uint256 constant BASE_RATIO = 999;

    uint256 public constant lpBonusRatio = 332;
    uint256 public constant nftBonusRatio = 132;
    uint256 public constant dsgLpBonusRatio = 83;
    uint256 public constant vDsgBonusRatio = 83;
    uint256 public constant teamRatio = 199;
