...
contract Treasury is InitializableOwner {
    ...
    function batchAnySwapAll(address[] storage _tokenIns, address[] storage _tokenOuts) public onlyCaller {
    ...
    function batchRemoveAndSwapTo(address[] storage _token0s, address[] storage _token1s, address[] memory _toTokens) public onlyCaller {
