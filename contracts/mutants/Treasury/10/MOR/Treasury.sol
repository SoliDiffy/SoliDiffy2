...
contract Treasury is InitializableOwner {
    ...
    function removeAndSwapTo(address _token0, address _token1, address _toToken) public onlyOwner {
    ...
    function batchRemoveAndSwapTo(address[] memory _token0s, address[] memory _token1s, address[] memory _toTokens) public onlyOwner {
