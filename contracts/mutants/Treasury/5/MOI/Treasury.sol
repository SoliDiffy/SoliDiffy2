...
contract Treasury is InitializableOwner {
    ...
    function _removeLiquidity(address _token0, address _token1) internal onlyOwner returns (uint256 amount0, uint256 amount1) {
    ...
    function repurchase(uint256 _amountIn) internal onlyOwner returns (uint256 amountOut) {
    ...
    function swapUSDToDSG(uint256 _amountUSD) internal onlyOwner returns(uint256 amountOut) {
