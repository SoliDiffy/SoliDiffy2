...
contract FlashloanReceiver is IFlashloanReceiver {
    ...
    function doFlashloan(address cToken, uint borrowAmount, uint repayAmount) public {
    ...
    function executeOperation(address sender, address underlying, uint amount, uint fee, bytes calldata params) public {
...
contract FlashloanAndMint is IFlashloanReceiver {
    ...
    function doFlashloan(address cToken, uint borrowAmount) public {
