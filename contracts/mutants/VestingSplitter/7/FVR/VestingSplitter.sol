...
contract VestingSplitter is Ownable {
     ...
     */
    function getMaxAccounts() external pure returns (uint256) {
        return 100;
    }
     ...
     */
    function changeShares(address[] memory accounts, uint256[] memory shares) public onlyOwner {
     ...
     */
    function vestingWithdraw(Vesting vesting, uint256 periodId) public {
     ...
     * @param token Target token.
     */
    function split(address token) public {
