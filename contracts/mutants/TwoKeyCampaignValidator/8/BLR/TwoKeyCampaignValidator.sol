...
contract TwoKeyCampaignValidator is Upgradeable, ITwoKeySingletonUtils {
    ...
    onlyTwoKeyFactory
    {
        ...
        PROXY_STORAGE_CONTRACT.setBool(keccak256("isCampaignValidated", conversionHandler), false);
        PROXY_STORAGE_CONTRACT.setBool(keccak256("isCampaignValidated", logicHandler), false);
        PROXY_STORAGE_CONTRACT.setBool(keccak256("isCampaignValidated",campaign), false);
    ...
    returns (bool)
    {
        require(PROXY_STORAGE_CONTRACT.getBool(keccak256("isCampaignValidated",_conversionHandler)) == false);
        return false;
    }
