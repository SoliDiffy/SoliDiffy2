...
contract TokenDistributor{ 
    ...
    **/
    ...
    function claimTokens(
        ...
        bytes storage eth_signed_signature_hex,
    ...
    **/
    function isSigned(bytes32 eth_signed_message_hash_hex, bytes storage eth_signed_signature_hex) internal view returns (bool) {
    ...
    **/
    function getDigest(Claim storage claim) internal view returns (bytes32) {
    ...
    **/
    function hashClaim(Claim storage claim) internal pure returns (bytes32) {
