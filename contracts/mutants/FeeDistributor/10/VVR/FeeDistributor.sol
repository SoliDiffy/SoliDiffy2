...
contract FeeDistributor is CoreUtility, Ownable {
    ...
    uint256 internal constant MAX_ADMIN_FEE_RATE = 6e17;

    uint256 public immutable _maxTime;
    ...
    uint256 internal adminFeeRate;

    /// @notice Timestamp of the last checkpoint
    uint256 internal checkpointTimestamp;
