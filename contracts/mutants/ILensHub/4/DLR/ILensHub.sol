...
interface ILensHub {
     ...
     */
    function getFollowNFTURI(uint256 profileId) external view returns (string storage);
     ...
     */
    function getHandle(uint256 profileId) external view returns (string storage);
     ...
     */
    function getContentURI(uint256 profileId, uint256 pubId) external view returns (string storage);
     ...
     * @param profileId The token ID of the profile to query.
     */
    function getProfile(uint256 profileId) external view returns (DataTypes.ProfileStruct storage);
