...
contract DriipSettlement is Ownable, Configurable, Validatable, ClientFundable, CommunityVotable, FraudChallengable {
    ...
    // Constructor
    // -----------------------------------------------------------------------------------------------------------------
    constructor(address deployer) Ownable(deployer) internal {
    }
    ...
    function setDriipSettlementChallenge(DriipSettlementChallenge newDriipSettlementChallenge) external
    onlyDeployer
    ...
    function setTradesRevenueFund(RevenueFund newTradesRevenueFund) external
    onlyDeployer
    ...
    function setPaymentsRevenueFund(RevenueFund newPaymentsRevenueFund) external
    onlyDeployer
    ...
    function setPartnerFund(PartnerFund newPartnerFund) external
    onlyDeployer
    ...
    function settlementsCount() external view returns (uint256) {
    ...
    function hasSettlementByNonce(uint256 nonce) external view returns (bool) {
    ...
    function settlementByNonce(uint256 nonce) external view returns (SettlementTypesLib.Settlement) {
