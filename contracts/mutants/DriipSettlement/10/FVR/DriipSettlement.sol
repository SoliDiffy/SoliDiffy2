...
contract DriipSettlement is Ownable, Configurable, Validatable, ClientFundable, CommunityVotable, FraudChallengable {
    ...
    function settlementsCountByWallet(address wallet) external view returns (uint256) {
    ...
    function settlementByWalletAndIndex(address wallet, uint256 index) external view returns (SettlementTypesLib.Settlement) {
