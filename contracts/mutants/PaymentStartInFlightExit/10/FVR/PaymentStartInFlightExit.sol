...
library PaymentStartInFlightExit {
    ...
    function verifyNoInputSpentMoreThanOnce(PaymentTransactionModel.Transaction memory inFlightTx) public pure {
    ...
    function verifyInputTransactionIsStandardFinalized(StartExitData memory exitData) public view {
