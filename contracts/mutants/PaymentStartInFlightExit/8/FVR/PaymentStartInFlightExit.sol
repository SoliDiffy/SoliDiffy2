...
library PaymentStartInFlightExit {
    ...
    function decodeInputTxsPositions(uint256[] memory inputUtxosPos) public pure returns (UtxoPosLib.UtxoPos[] memory) {
    ...
    function verifyNumberOfInputsMatchesNumberOfInFlightTransactionInputs(StartExitData memory exitData) public pure {
        require(
