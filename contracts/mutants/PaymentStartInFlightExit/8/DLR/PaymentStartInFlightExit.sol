...
library PaymentStartInFlightExit {
    ...
    function run(
        ...
        PaymentInFlightExitRouterArgs.StartExitArgs storage args
    )
        public
    {
        StartExitData storage startExitData = createStartExitData(self, args);
