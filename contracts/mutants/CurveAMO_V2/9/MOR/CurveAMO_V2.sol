...
contract CurveAMO_V2 is AccessControl {
    ...
    function mintRedeemPart1(uint256 frax_amount) external onlyCustodianOrVoter {
    ...
    function mintRedeemPart2() external onlyCustodianOrVoter {
        pool.collectRedemption();
    }

    // Give USDC profits back
    function giveCollatBack(uint256 amount) external onlyCustodianOrVoter {
    ...
    function burnFRAX(uint256 frax_amount) public onlyCustodianOrVoter {
        FRAX.burn(frax_amount);
        burned_frax_historical = burned_frax_historical.add(frax_amount);
    }
   
    function burnFXS(uint256 amount) public onlyCustodianOrVoter {
    ...
    function metapoolDeposit(uint256 _frax_amount, uint256 _collateral_amount) external onlyCustodianOrVoter returns (uint256 metapool_LP_received) {
    ...
    function metapoolWithdrawAtCurRatio(uint256 _metapool_lp_in, bool burn_the_frax, uint256 min_frax, uint256 min_3pool) external onlyCustodianOrVoter returns (uint256 frax_received) {
    ...
    function metapoolWithdrawFrax(uint256 _metapool_lp_in, bool burn_the_frax) external onlyCustodianOrVoter returns (uint256 frax_received) {
    ...
    function metapoolWithdraw3pool(uint256 _metapool_lp_in) public onlyCustodianOrVoter {
