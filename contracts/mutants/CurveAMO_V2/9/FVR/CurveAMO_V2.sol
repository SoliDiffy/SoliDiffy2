...
contract CurveAMO_V2 is AccessControl {
    ...
    function showAllocations() external view returns (uint256[12] memory return_arr) {
        // ------------LP Balance------------
    ...
    // In FRAX
    function fraxBalance() external view returns (uint256) {
    ...
    function lentFRAX3CRV() external view returns (uint256) {
