...
library PaymentInFlightExitModelUtils {
    ...
    function isInFirstPhase(ExitModel.InFlightExit storage ife, uint256 minExitPeriod)
        internal
        view
        returns (bool)
    {
    ...
    function isFirstPiggybackOfTheToken(ExitModel.InFlightExit storage ife, address token)
        internal
        pure
        returns (bool)
    {
