...
contract CancelOrdersChallenge is Ownable, Challenge, Validatable {
    ...
    onlyOperationalModeNormal
    {
        ...
        walletOrderCancelledTimeoutMap[msg.sender] = block.number.add(configuration.cancelOrderChallengeTimeout());
    ...
    {
        require(block.number < walletOrderCancelledTimeoutMap[wallet]);
