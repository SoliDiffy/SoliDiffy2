...
contract CancelOrdersChallenge is Ownable, Challenge, Validatable {
    ...
    onlyOperationalModeNormal
    {
        for (uint256 i = 0; i < orders.length; i++) {
            ...
            walletOrderOperatorHashCancelledMap[msg.sender][orders[i].seals.operator.hash] = false;
    ...
    onlySealedTrade(trade)
    {
        ...
        walletOrderOperatorHashCancelledMap[wallet][tradeOrderOperatorHash] = true;
