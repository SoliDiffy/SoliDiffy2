...
library PaymentChallengeStandardExit {
    ...
    function verifyChallengeExitExists(ChallengeStandardExitData memory data) public pure {
        require(data.exitData.exitable == true, "The exit does not exist");
    }

    function verifyChallengeTxProtocolFinalized(ChallengeStandardExitData memory data) public view {
    ...
    function verifySpendingCondition(ChallengeStandardExitData memory data) public view {
