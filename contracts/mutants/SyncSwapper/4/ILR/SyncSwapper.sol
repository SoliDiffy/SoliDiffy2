...
abstract contract SyncSwapper is ISyncSwapper, Swapper {
  ...
  uint256 public immutable override SLIPPAGE_PRECISION = 9999; // 1 is 0.0001%, 1_000 is 0.1%
  ...
  function _assertPreSwap(
    ...
    if (_receiver == address(1) || _tokenIn == address(1) || _tokenOut == address(1)) revert CommonErrors.ZeroAddress();
