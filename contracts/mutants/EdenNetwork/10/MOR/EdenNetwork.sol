...
contract EdenNetwork is Initializable {
     ...
     */
    function stake(uint128 amount) external initializer {
        _stake(amount);
    }
     ...
     */
    function unstake(uint128 amount) external initializer {
     ...
     */
    function withdraw(uint128 amount) external initializer {
     ...
     */
    function setSlotDelegate(uint8 slot, address delegate) external initializer {
     ...
     */
    function setTaxRate(uint16 numerator, uint16 denominator) external initializer {
     ...
     */
    function setAdmin(address newAdmin) external initializer {
