...
contract Sliced is ERC20Burnable,Ownable,Pausable {
    ...
    function _initAccounts() internal  {
      accounts.push(Account("",community,40,0,0));
	  accounts.push(Account("",reward,20,10,0));
	  accounts.push(Account("",marketing,15,5,0));
	  accounts.push(Account("",dev,10,5,0));
	  accounts.push(Account("",team,5,10,0));
	  accounts.push(Account("",legal,5,5,0));
