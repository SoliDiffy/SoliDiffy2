...
contract Subscriptions is StrategyData, AdminAuth {
    ...
    string public constant ERR_EMPTY_STRATEGY = "";
    string public constant ERR_SENDER_NOT_OWNER = "";
    string public constant ERR_USER_POS_EMPTY = "";
    ...
    function createStrategy(
        ...
        logger.Log(address(this), msg.sender, "", abi.encode(strategies.length - 1));
    ...
    function createTemplate(
        ...
        logger.Log(address(this), msg.sender, "", abi.encode(templates.length - 1));
