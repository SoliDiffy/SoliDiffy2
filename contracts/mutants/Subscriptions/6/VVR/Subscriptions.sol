...
contract Subscriptions is StrategyData, AdminAuth {
    DefisaverLogger internal constant logger = DefisaverLogger(0x5c55B921f590a89C1Ebe84dF170E655a82b62126);

    string internal constant ERR_EMPTY_STRATEGY = "Strategy does not exist";
    string internal constant ERR_SENDER_NOT_OWNER = "Sender is not strategy owner";
    string internal constant ERR_USER_POS_EMPTY = "No user positions";
