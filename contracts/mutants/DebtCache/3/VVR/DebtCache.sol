...
contract DebtCache is BaseDebtCache {
    ...
    bytes32 internal constant CONTRACT_NAME = "DebtCache";

    constructor(address _owner, address _resolver) public BaseDebtCache(_owner, _resolver) {}

    bytes32 public constant EXCLUDED_DEBT_KEY = "EXCLUDED_DEBT";
    bytes32 public constant FUTURES_DEBT_KEY = "FUTURES_DEBT";
