...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
  ...
  function mint(
    ...
    vars.previousSupply = super.totalSupply();
  ...
  function burn(address user, uint256 amount) external override onlyLendingPool {
    ...
    uint256 previousSupply = super.totalSupply();
    ...
    )
  {
    ...
    uint256 balanceIncrease = super.balanceOf(user).sub(previousPrincipalBalance);
