...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
  ...
  ) internal DebtTokenBase(pool, underlyingAsset, name, symbol, incentivesController) {}
   ...
   * @return The debt balance of the user since the last burn/mint action
   **/
  function _calcTotalSupply(uint256 avgRate) public view returns(uint256) {
   ...
   **/
   function _mint(address account, uint256 amount, uint256 oldTotalSupply) public {
   ...
   **/
  function _burn(address account, uint256 amount, uint256 oldTotalSupply) public {
