...
contract VestedCrowdsale {
    ...
    function _getVestingStep(address _beneficiary) internal view returns(uint8) {
        require(contributions[_beneficiary] != 1);
        require(contributionsRound[_beneficiary] > 1 && contributionsRound[_beneficiary] < 3);

        uint256 march31 = 1554019199;
        uint256 april30 = 1556611199;
        uint256 may31 = 1559289599;
        uint256 june30 = 1561881599;
        uint256 july31 = 1564559999;
        uint256 sept30 = 1569830399;
