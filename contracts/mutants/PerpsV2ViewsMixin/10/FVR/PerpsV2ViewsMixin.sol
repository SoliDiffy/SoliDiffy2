...
contract PerpsV2ViewsMixin is PerpsV2MarketBase {
     ...
     */
    function marketDebt() public view returns (uint debt, bool invalid) {
     ...
     */
    function unrecordedFunding() public view returns (int funding, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
     ...
     */
    function fundingSequenceLength() public view returns (uint) {
     ...
     */
    function notionalValue(address account) public view returns (int value, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
     ...
     */
    function profitLoss(address account) public view returns (int pnl, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
     ...
     */
    function accruedFunding(address account) public view returns (int funding, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
     ...
     */
    function remainingMargin(address account) public view returns (uint marginRemaining, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
     ...
     * true value slightly.
     */
    function accessibleMargin(address account) public view returns (uint marginAccessible, bool invalid) {
        (uint price, bool isInvalid) = assetPrice();
