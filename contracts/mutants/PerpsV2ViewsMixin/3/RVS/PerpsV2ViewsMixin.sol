...
contract PerpsV2ViewsMixin is PerpsV2MarketBase {
    ...
    function marketSizes() public view returns (uint long, uint short) {
        ...
        int skew = marketSkew;
        return (_abs(size.sub(skew).div(2)), _abs(size.add(skew).div(2)));
    }
        ...
        )
    {
        ...
        return (liqFee, liqPrice, isInvalid);
    }
        ...
        )
    {
        ...
        return (fee_, newPosition.size, newPosition.margin, newPosition.lastPrice, liqPrice, status_);
    }
