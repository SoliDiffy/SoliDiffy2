...
contract PancakeswapWorker is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker {
  ...
  function reinvest() external override  onlyReinvestor nonReentrant {
    // 1. Approve tokens
  ...
  function liquidate(uint256 id) external override  nonReentrant {
  ...
  function setReinvestBountyBps(uint256 _reinvestBountyBps) external  {
    require(
