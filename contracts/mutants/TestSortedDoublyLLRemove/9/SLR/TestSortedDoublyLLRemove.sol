...
contract TestSortedDoublyLLRemove {
    ...
    function test_remove() public {
        ...
        Assert.equal(fixture.contains(ids[1]), false, "");
        Assert.equal(fixture.getSize(), 2, "");
        Assert.equal(fixture.getNext(ids[0]), ids[2], "");
        Assert.equal(fixture.getPrev(ids[2]), ids[0], "");
    }
    ...
    function test_remove_singleNode() public {
        ...
        Assert.equal(fixture.contains(ids[0]), false, "");
        Assert.equal(fixture.getSize(), 0, "");
        Assert.equal(fixture.getFirst(), address(0), "");
        Assert.equal(fixture.getLast(), address(0), "");
    }
