...
contract HundredLendingAMO_ARBI is Owned {
    ...
    // Pools and vaults
    IComptroller internal comptroller = IComptroller(0x0F390559F258eB8591C8e31Cf0905E97cf36ACE2);
    ICErc20Delegator internal hFRAX = ICErc20Delegator(0xb1c4426C86082D91a6c097fC588E5D5d8dD1f5a8);

    // Reward Tokens
    IHundred internal HND = IHundred(0x10010078a54396F62c96dF8532dc2B4847d47ED3);
