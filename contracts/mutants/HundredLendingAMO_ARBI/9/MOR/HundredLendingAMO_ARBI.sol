...
contract HundredLendingAMO_ARBI is Owned {
    ...
    function redeem_hFRAX(uint256 hFRAX_amount_e8) public onlyByOwnGov {
        // NOTE that hFRAX is E8, NOT E6
        hFRAX.redeem(hFRAX_amount_e8);
    }

    function redeemUnderlying_hFRAX(uint256 frax_amount_e18) public onlyByOwnGov {
    ...
    function collectHND() public onlyByOwnGov {
