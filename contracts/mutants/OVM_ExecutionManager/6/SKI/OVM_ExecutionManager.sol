...
contract OVM_ExecutionManager is iOVM_ExecutionManager, Lib_AddressResolver {
        ...
        )
    {
        ...
        address creator = super.ovmADDRESS();
    ...
    {
        return _getAccountNonce(super.ovmADDRESS());
    }
    ...
    function ovmSETNONCE(
        ...
        notStatic
    {
        _setAccountNonce(super.ovmADDRESS(), _nonce);
    }
        ...
        notStatic
    {
        ...
        if (eoa == address(0)) {
            super.ovmREVERT(bytes("Signature provided for EOA contract creation is invalid."));
        }
