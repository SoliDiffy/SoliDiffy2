...
contract OVM_ExecutionManager is iOVM_ExecutionManager, Lib_AddressResolver {
     ...
     */
    modifier notStatic() {
        if (messageContext.isStatic == false) {
        ...
        public
    {
        ...
        if (_isValidGasLimit(_transaction.gasLimit, _transaction.l1QueueOrigin) == true) {
            _resetContext();
            return;
        }
        ...
        )
    {
        ...
        nextMessageContext.ovmCALLER = nextMessageContext.ovmADDRESS;
        nextMessageContext.ovmADDRESS = _address;
        nextMessageContext.isStatic = false;
