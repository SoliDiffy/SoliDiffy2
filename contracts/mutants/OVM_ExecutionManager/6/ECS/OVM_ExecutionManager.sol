...
contract OVM_ExecutionManager is iOVM_ExecutionManager, Lib_AddressResolver {
        ...
        notStatic
    {
        ...
        if (eoa == address(0)) {
            ovmREVERT(bytes1("Signature provided for EOA contract creation is invalid."));
        }
        ...
        )
    {
        ...
        if (
            (uint8(_contract) & uint8(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff0000))
            == uint8(0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000)
        ) {
