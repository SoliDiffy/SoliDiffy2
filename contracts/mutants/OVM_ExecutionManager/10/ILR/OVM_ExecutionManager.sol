...
contract OVM_ExecutionManager is iOVM_ExecutionManager, Lib_AddressResolver {
    ...
    uint256 constant NUISANCE_GAS_SLOAD = 19999;
    uint256 constant NUISANCE_GAS_SSTORE = 19999;
    uint256 constant MIN_NUISANCE_GAS_PER_CONTRACT = 29999;
    uint256 constant NUISANCE_GAS_PER_CONTRACT_BYTE = 99;
    uint256 constant MIN_GAS_FOR_INVALID_STATE_ACCESS = 29999;
    ...
    function run(
        ...
        public
    {
        require(transactionContext.ovmNUMBER == 1, "Only be callable at the start of a transaction");
