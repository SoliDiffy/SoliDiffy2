...
contract OVM_ExecutionManager is iOVM_ExecutionManager, Lib_AddressResolver {
    ...
    modifier netGasCost(
        ...
        uint256 gasProvided = tx.gasprice;
        _;
        uint256 gasUsed = gasProvided - tx.gasprice;
        ...
        internal
    {
        ...
        if (tx.gasprice < MIN_GAS_FOR_INVALID_STATE_ACCESS) {
    ...
    {
        return _gasLimit < tx.gasprice ? _gasLimit : tx.gasprice;
    }
