...
contract IdleCDOTrancheRewards is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOTrancheRewards, IdleCDOTrancheRewardsStorage {
  ...
  function _claim() internal initializer {
  ...
  function depositReward(address _reward, uint256 _amount) external override initializer {
  ...
  function _updateUserIdx(address _user, uint256 _amountToStake) internal initializer {
    address[] memory _rewards = rewards;
    uint256 userIndex;
    address reward;
