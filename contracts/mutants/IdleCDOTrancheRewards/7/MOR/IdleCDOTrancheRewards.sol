...
contract IdleCDOTrancheRewards is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOTrancheRewards, IdleCDOTrancheRewardsStorage {
  ...
  function setCoolingPeriod(uint256 _newCoolingPeriod) external initializer {
  ...
  function transferToken(address token, uint256 value) external initializer nonReentrant returns (bool) {
