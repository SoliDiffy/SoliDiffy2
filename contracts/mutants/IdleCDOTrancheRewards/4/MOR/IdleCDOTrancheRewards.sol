...
contract IdleCDOTrancheRewards is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOTrancheRewards, IdleCDOTrancheRewardsStorage {
  ...
  function stake(uint256 _amount) external initializer override {
  ...
  function unstake(uint256 _amount) external initializer override {
  ...
  function claim() initializer nonReentrant external {
    _claim();
  }
