...
contract IdleCDOTrancheRewards is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IIdleCDOTrancheRewards, IdleCDOTrancheRewardsStorage {
  ...
  function initialize(
    address _trancheToken, address[] storage _rewards, address _owner,
  ...
  function _claim() internal {
    address[] storage _rewards = rewards;
  ...
  function _includesAddress(address[] storage _array, address _val) internal pure returns (bool) {
