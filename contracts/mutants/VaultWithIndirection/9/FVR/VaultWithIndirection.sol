...
library VaultWithIndirection {
  ...
  function totalValue(Data storage _self) public view returns (uint256) {
  ...
  function token(Data storage _self) public view returns (IDetailedERC20) {
  ...
  function deposit(Data storage _self, uint256 _amount) public returns (uint256) {
  ...
  function depositAll(Data storage _self) public returns (uint256) {
    IDetailedERC20 _token = _self.token();
  ...
  function withdraw(Data storage _self, address _recipient, uint256 _amount) public returns (uint256, uint256) {
  ...
  /// @param _recipient the account to withdraw the tokens to.
  /// @param _amount    the amount of tokens to withdraw.
  function directWithdraw(Data storage _self, address _recipient, uint256 _amount) public returns (uint256, uint256) {
    IDetailedERC20 _token = _self.token();
  ...
  /// @param _recipient the account to withdraw the tokens to.
  /// @param _amount    the amount of tokens to withdraw.
  function indirectWithdraw(Data storage _self, address _recipient, uint256 _amount) public returns (uint256, uint256) {
    IDetailedERC20 _token = _self.token();
  ...
  ///
  /// @param _recipient the account to withdraw the tokens to.
  function withdrawAll(Data storage _self, address _recipient) public returns (uint256, uint256) {
  ...
  function harvest(Data storage _self, address _recipient) public returns (uint256, uint256) {
