...
library VaultWithIndirection {
  ...
  ///
  /// @param _recipient the account to withdraw the tokens to.
  function withdrawAll(Data memory _self, address _recipient) internal returns (uint256, uint256) {
  ...
  function harvest(Data memory _self, address _recipient) internal returns (uint256, uint256) {
  ...
  function push(List memory _self, Data memory _element) internal {
