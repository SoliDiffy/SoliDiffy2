...
contract TwoKeyDonationCampaign is UpgradeableCampaign, TwoKeyCampaign, TwoKeyCampaignIncentiveModels {
    ...
    address internal twoKeyDonationConversionHandler; // Contract which will handle all donations
    address internal twoKeyDonationLogicHandler;

    bool public acceptsFiat; // Will determine if fiat conversion can be created or not
