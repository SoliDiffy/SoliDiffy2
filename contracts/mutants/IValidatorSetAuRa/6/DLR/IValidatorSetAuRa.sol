...
interface IValidatorSetAuRa {
    ...
    function getPendingValidators() external view returns(address[] storage);
    function getPendingValidatorsIds() external view returns(uint256[] storage);
    function getValidators() external view returns(address[] storage);
    function getValidatorsIds() external view returns(uint256[] storage);
    ...
    function validatorsToBeFinalized() external view returns(address[] storage, bool);
    function validatorsToBeFinalizedIds() external view returns(uint256[] storage);
}
