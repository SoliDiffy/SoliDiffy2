...
contract SkyRewardPool {
    ...
    uint256 internal poolStartTime;

    // The time when SKY mining ends.
    uint256 internal poolEndTime;

    uint256 internal rewardPerSecond = 0.00221968543 ether; // 70000 sky / (365 days * 24h * 60min * 60s)
    uint256 internal runningTime = 365 days; // 365 days
