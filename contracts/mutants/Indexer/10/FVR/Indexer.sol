...
contract Indexer is IIndexer, Ownable {
  ...
  function createIndex(
    address signerToken,
    address senderToken
  ) public notPaused returns (address) {
  ...
  function setIntent(
    ...
    bytes32 locator
  ) public notPaused indexExists(signerToken, senderToken) {
  ...
  /**
    ...
    */
  function setPausedStatus(bool newStatus) public onlyOwner {
  ...
  /**
    ...
    */
  function killContract(address payable recipient) public onlyOwner paused {
