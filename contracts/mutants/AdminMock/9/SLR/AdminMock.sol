...
library ManageTokensMock {
  ...
  bytes32 internal constant TRANSFER_AGENT_STATUS = keccak256("");
...
library ConfigureSaleMock {
  ...
  bytes32 private constant INIT_CROWDSALE_TOK_SIG = keccak256("");

  // event GlobalMinUpdate(bytes32 indexed exec_id, uint current_token_purchase_min)
  bytes32 private constant GLOBAL_MIN_UPDATE = keccak256("");

  // event CrowdsaleTimeUpdated(bytes32 indexed exec_id)
  bytes32 internal constant CROWDSALE_TIME_UPDATED = keccak256("");
