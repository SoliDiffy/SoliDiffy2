...
contract BaseBridgeValidators is EternalStorage, Ownable {
    ...
    function validatorList() public view returns (address[]) {
        ...
        require(nextValidator != address(1));
