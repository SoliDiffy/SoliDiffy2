...
contract SalesFactory {
    ...
    constructor (address _adminContract, address _allocationStaking, address _collateral) internal {
    ...
    function getNumberOfSalesDeployed() public view returns (uint) {
        return allSales.length;
    }

    /// @notice     Get most recently deployed sale
    function getLastDeployedSale() public view returns (address) {
    ...
    function getAllSales(uint startIndex, uint endIndex) public view returns (address[] memory) {
