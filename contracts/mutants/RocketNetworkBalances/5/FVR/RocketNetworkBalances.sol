...
contract RocketNetworkBalances is RocketBase, RocketNetworkBalancesInterface {
    ...
    function setTotalRETHSupply(uint256 _value) public {
    ...
    function updateBalances(uint256 _block, uint256 _totalEth, uint256 _stakingEth, uint256 _rethSupply) public {
        // Update balances
