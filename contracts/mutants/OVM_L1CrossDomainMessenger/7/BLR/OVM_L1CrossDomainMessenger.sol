...
contract OVM_L1CrossDomainMessenger is iOVM_L1CrossDomainMessenger, Abs_BaseCrossDomainMessenger, Lib_AddressResolver {
        ...
        public
    {
        ...
        require(
            sentMessages[keccak256(xDomainCalldata)] == false,
        ...
        )
    {
        ...
        return (
            ovmStateCommitmentChain.insideFraudProofWindow(_proof.stateRootBatchHeader) == true
