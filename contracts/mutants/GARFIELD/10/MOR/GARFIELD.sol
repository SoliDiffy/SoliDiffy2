...
contract GARFIELD is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function excludeFromReward(address account) public isHuman {
    ...
    function includeInReward(address account) external isHuman {
        require(_isExcluded[account], "Account is already excluded");
    ...
    function setTaxFeePercent(uint256 taxFee) external isHuman {
        _taxFee = taxFee;
    }

    function setLiquidityFeePercent(uint256 liquidityFee) external isHuman {
    ...
    function setMaxTxPercent(uint256 maxTxPercent) public isHuman {
    ...
    function claimBNBReward() onlyOwner() nonReentrant public {
