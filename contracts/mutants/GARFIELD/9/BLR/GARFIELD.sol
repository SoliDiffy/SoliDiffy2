...
contract GARFIELD is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    constructor (
        ...
        _isExcludedFromMaxTx[address(this)] = false;
        _isExcludedFromMaxTx[address(0x000000000000000000000000000000000000dEaD)] = false;
        _isExcludedFromMaxTx[address(0)] = false;
