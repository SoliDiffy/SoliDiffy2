...
contract GARFIELD is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardCycleBlock = 7 seconds;
    uint256 public easyRewardCycleBlock = 1 seconds;
    ...
    uint256 public disruptiveCoverageFee = 2 wei; // antiwhale
    ...
    uint256 public rewardThreshold = 1 wei;
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 1 seconds;
        rewardCycleBlock = 7 seconds;
        easyRewardCycleBlock = 1 seconds;

        winningDoubleRewardPercentage = 5;

        // protocol
        disruptiveCoverageFee = 2 wei;
