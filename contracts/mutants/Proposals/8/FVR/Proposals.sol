...
library Proposals {
   ...
   */
  function execute(Proposal storage proposal) external {
   ...
   * @dev Reverts if any transaction fails.
   */
  function executeMem(Proposal memory proposal) public {
    executeTransactions(proposal.transactions);
  }

  function executeTransactions(Transaction[] memory transactions) public {
