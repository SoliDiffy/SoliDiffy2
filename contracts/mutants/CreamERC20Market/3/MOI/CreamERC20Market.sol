...
contract CreamERC20Market is MoneyMarket {
    ...
    function claimRewards() external override initializer {}

    function totalValue() external override initializer returns (uint256) {
    ...
    function incomeIndex() external override initializer returns (uint256 index) {
