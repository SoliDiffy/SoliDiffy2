...
contract ProgramOutputOffsets {
    ...
    uint256 public constant PROG_OUT_GENERAL_CONFIG_HASH = 0;
    uint256 public constant PROG_OUT_N_ASSET_CONFIGS = 1;
    uint256 public constant PROG_OUT_ASSET_CONFIG_HASHES = 2;
    ...
    */
    uint256 public constant PROG_OUT_N_WORDS_MIN_SIZE = 8;

    uint256 public constant PROG_OUT_N_WORDS_PER_ASSET_CONFIG = 2;
    uint256 public constant PROG_OUT_N_WORDS_PER_MODIFICATION = 3;

    uint256 public constant ASSET_CONFIG_OFFSET_ASSET_ID = 0;
    uint256 public constant ASSET_CONFIG_OFFSET_CONFIG_HASH = 1;

    uint256 public constant MODIFICATIONS_OFFSET_STARKKEY = 0;
    uint256 public constant MODIFICATIONS_OFFSET_POS_ID = 1;
