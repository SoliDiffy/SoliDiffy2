...
contract MarketXYZLendingAMO is Owned {
    ...
    // E18
    function lendToPool(address pool_address, uint256 lend_amount) onlyByOwnGov public validPool(pool_address) {
        uint256 pool_idx = poolAddrToIdx(pool_address);
    ...
    // E18
    function redeemFromPool(address pool_address, uint256 redeem_amount) onlyByOwnGov public validPool(pool_address) {
        uint256 pool_idx = poolAddrToIdx(pool_address);
