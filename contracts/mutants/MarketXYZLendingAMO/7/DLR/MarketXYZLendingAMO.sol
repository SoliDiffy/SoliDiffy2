...
contract MarketXYZLendingAMO is Owned {
    ...
    constructor (
        ...
        address[] storage _initial_unitrollers,
        address[] storage _initial_fuse_pools,
    ...
    function allDollarBalances() public view returns (
        ...
        uint256[3] storage allocations = showAllocations();
    ...
    // Helpful for UIs
    function allPoolAddresses() external view returns (address[] storage) {
