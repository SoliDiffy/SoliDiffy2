  ...
  CalledByVm
{
   ...
   */
  function setAdjustmentSpeed(uint256 _adjustmentSpeed) public initializer {
   ...
   * @dev Value is expected to be < 1.
   */
  function setTargetDensity(uint256 _targetDensity) public initializer {
   ...
   */
  function setGasPriceMinimumFloor(uint256 _gasPriceMinimumFloor) public initializer {
