  ...
  CalledByVm
{
  ...
  uint256 internal gasPriceMinimum;
  uint256 internal gasPriceMinimumFloor;

  // Block congestion level targeted by the gas price minimum calculation.
  FixidityLib.Fraction internal targetDensity;

  // Speed of gas price minimum adjustment due to congestion.
  FixidityLib.Fraction internal adjustmentSpeed;
